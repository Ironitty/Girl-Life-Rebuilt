...
function enterMngFarm(s: GameState, scene: SceneBuilder): void {
  ...
  while (true) {
    ...
    if (((s as any).KGD ?? 0)['farm_' + (((s as any).i ?? 0))] === 1) {
      ((s as any).KGD = (s as any).KGD ?? {})['table'] = ((s as any).KGD['table'] ?? 0) + ('<tr><td>farm ' + ((s as any).i ?? 0) + '</td><td>Level: '+((s as any).KGD ?? 0)['farm_level_' + ((s as any).i ?? 0) + '']+'</td><td>Production: '+((s as any).KGD ?? 0)['farm_rate_' + ((s as any).i ?? 0) + '']*((s as any).KGD ?? 0)['farm_level_' + ((s as any).i ?? 0) + '']+' R/D</td></tr>');
      if (((s as any).KGD ?? 0)['farm_level_' + (((s as any).i ?? 0))] < 5  &&  ((s as any).KGD ?? 0)?.['money'] >= 100*((s as any).KGD ?? 0)['farm_level_' + (((s as any).i ?? 0))]) {
        ((s as any).KGD = (s as any).KGD ?? {})['table'] = ((s as any).KGD['table'] ?? 0) + ('<tr><td colspan="2"><a href="#" onclick="window.__gameStore.setState((s) => { (s.KGD ??= {})(\u0027farm_level_\u0027 + String((s as any).i ?? \u0027\u0027)) +=1; (s.KGD ??= {})(\u0027farm_rate_\u0027 + String((s as any).i ?? \u0027\u0027)) +=2; (s.KGD ??= {})\u0027money\u0027 -=100*KGD[\u0027farm_level_' + ((s as any).i ?? 0) + '\u0027]; return s; }); window.__gameStore.getState().doGoto(\u0027KGDgame\u0027, \u0027MngFarm\u0027); return false;">Upgrade farm (' + 100*((s as any).KGD ?? 0)['farm_level_' + ((s as any).i ?? 0) + ''] + ' resources)</a></td></tr>');
      } else {
        ((s as any).KGD = (s as any).KGD ?? {})['table'] = ((s as any).KGD['table'] ?? 0) + ('<tr><td colspan="2">' + qspFunc(s, 'wrap', 'neg', 'Upgrade farm (' + 100*((s as any).KGD ?? 0)[((s as any).farm_level_ ?? 0)((s as any).i ?? 0)] + ' resources)') + '</td></tr>');
      }
    }
    if (((s as any).i ?? 0) < 10) {
      (s as any).i = ((s as any).i ?? 0) + (1);

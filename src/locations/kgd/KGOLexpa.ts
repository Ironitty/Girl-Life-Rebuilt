...
function enterKGOLatk(s: GameState, scene: SceneBuilder): void {
  (s as any).KGOLzasV = ((s as any).rand ?? 0)(((s as any).KGOLspeedV ?? 0) / 4, ((s as any).KGOLspeedV ?? 0));
  (s as any).KGOLataka = ((s as any).rand ?? 0)(((s as any).KGOLspeed ?? 0) / 2, ((s as any).KGOLspeed ?? 0) * 2);
  if (((s as any).KGOLataka ?? 0) >= ((s as any).KGOLzasV ?? 0)) {
    if (((s as any).KGOLataka ?? 0) >= ((s as any).KGOLzasV ?? 0) * 2) {
      (s as any).KGHPnpow = ((s as any).rand ?? 0)(((s as any).KGOLpower ?? 0) / 2, ((s as any).KGOLpower ?? 0));
      (s as any).KGHPV = ((s as any).KGHPV ?? 0) - (((s as any).KGHPnpow ?? 0));
      scene.text(`You deal ${((s as any).KGHPnpow ?? 0)} damage`);
    } else {
      (s as any).KGHPnpow = ((s as any).rand ?? 0)(((s as any).KGOLpower ?? 0) / 10, ((s as any).KGOLpower ?? 0) / 4);
...
function enterKGOLatkV(s: GameState, scene: SceneBuilder): void {
  (s as any).KGOLzas = ((s as any).rand ?? 0)(((s as any).KGOLspeed ?? 0)/4, ((s as any).KGOLspeed ?? 0));
  (s as any).KGOLatakaV = ((s as any).rand ?? 0)(((s as any).KGOLspeedV ?? 0)/2, ((s as any).KGOLspeedV ?? 0) * 2);
  if (((s as any).KGOLatakaV ?? 0) >= ((s as any).KGOLzas ?? 0)) {
    if (((s as any).KGOLatakaV ?? 0) >= ((s as any).KGOLzas ?? 0) * 2) {
      (s as any).KGHPnpow = ((s as any).rand ?? 0)(((s as any).KGOLpowerV ?? 0) / 2, ((s as any).KGOLpowerV ?? 0));
      (s as any).KGHP = ((s as any).KGHP ?? 0) - (((s as any).KGHPnpow ?? 0));
      scene.text(`You receive ${((s as any).KGHPnpow ?? 0)} damage`);
    } else {
      (s as any).KGHPnpow = ((s as any).rand ?? 0)(((s as any).KGOLpowerV ?? 0)/10, ((s as any).KGOLpowerV ?? 0) / 4);

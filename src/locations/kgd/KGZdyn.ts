...
function enterKGZvihod6(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['copdoor'] === 0) {
    ...
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dead'] = ((s as any).KGZVars ?? {})?.['day'] * 10;
    qspCall(s, 'stat', '');
...
function enterKGZvihod16(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['gruzovik'] === 0) {
    ...
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dead'] = (Math.floor(Math.random() * (((s as any).KGZVars ?? {})?.['day'] * 100 - ((s as any).KGZVars ?? {})?.['day'] * 50 + 1)) + (((s as any).KGZVars ?? {})?.['day'] * 50));
...
function enterKGZfizatk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).KGZVars ?? 0)?.['dead'] > 0) {
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['uron'] = (Math.floor(Math.random() * (((s as any).KGZVars ?? {})?.['dead'] * 5 - ((s as any).KGZVars ?? {})?.['dead'] * 2 + 1)) + (((s as any).KGZVars ?? {})?.['dead'] * 2));

...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['weapon'] === 0) {
    ((s as any).KGZVars ?? {})['weapon_text'] = 'Fists';
    ((s as any).KGZVars ?? {})['weapon_texta'] = 'Fist';
  }
  if (((s as any).KGZVars ?? 0)?.['weapon'] === 1) {
    ((s as any).KGZVars ?? {})['weapon_text'] = 'Baton';
    ((s as any).KGZVars ?? {})['weapon_texta'] = 'Shillelagh';
  }
  if (((s as any).KGZVars ?? 0)?.['weapon'] === 2) {
    ((s as any).KGZVars ?? {})['weapon_text'] = 'Ax';
    ((s as any).KGZVars ?? {})['weapon_texta'] = 'Ax';
  }
  if (((s as any).KGZVars ?? 0)?.['gun'] > 0) {
    ((s as any).KGZVars ?? {})['gun_text'] = '' + qspUntranslated(s, "KGZVars['bullet']>", { location: "KGZdyn" }) + ' pistol bullets';
  }
  if (((s as any).KGZVars ?? 0)?.['gun2'] > 0) {
    ((s as any).KGZVars ?? {})['gun2_text'] = '' + qspUntranslated(s, "KGZVars['bullet2']>", { location: "KGZdyn" }) + ' shotgun cartridges';
  }
  if (((s as any).KGZVars ?? 0)?.['gun3'] > 0) {
    ((s as any).KGZVars ?? {})['gun3_text'] = '' + qspUntranslated(s, "KGZVars['bullet3']>", { location: "KGZdyn" }) + ' rifle bullets';
  }
  if (((s as any).KGZVars ?? 0)?.['hour'] >= 24) {
    ((s as any).KGZVars ?? {})['hour'] = (((s as any).KGZVars ?? {})['hour'] ?? 0) - (24);
    ((s as any).KGZVars ?? {})['day'] = (((s as any).KGZVars ?? {})['day'] ?? 0) + (1);
    if (((s as any).KGZVars ?? 0)?.['sup'] === 0) {
      ((s as any).KGZVars ?? {})['HP'] = (((s as any).KGZVars ?? {})['HP'] ?? 0) - (10);
    } else {
...
function enterKGZvihod(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).KGZVars ?? {})['place'] = 0;
    ((s as any).KGZVars ?? {})['batl'] = 0;
    qspCall(s, 'stat', '');
...
function enterKGZvihod2(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    ((s as any).KGZVars ?? {})['supoisk'] = Math.floor(Math.random() * 101) + 0;
...
function enterKGZvihod3(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    ((s as any).KGZVars ?? {})['supoisk'] = Math.floor(Math.random() * 101) + 0;
    if (((s as any).KGZVars ?? 0)?.['supoisk'] === 100) {
      ((s as any).KGZVars ?? {})['medkit'] = (((s as any).KGZVars ?? {})['medkit'] ?? 0) + (1);
...
function enterKGZvihod4(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['copcar'] === 0) {
    ...
    ((s as any).KGZVars ?? {})['copcar'] = 1;
    ((s as any).KGZVars ?? {})['bullet'] = (((s as any).KGZVars ?? {})['bullet'] ?? 0) + (10);
    qspCall(s, 'stat', '');
    scene.text('You search the police car for anything useful.');
    if (((s as any).KGZVars ?? 0)?.['gun'] === 0) {
      ((s as any).KGZVars ?? {})['gun'] = 1;
...
function enterKGZvihod5(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    ((s as any).KGZVars ?? {})['batl'] = 0;
    ((s as any).KGZVars ?? {})['bulletrand'] = Math.floor(Math.random() * 18) + 3;
    ((s as any).KGZVars ?? {})['bullet2'] = (((s as any).KGZVars ?? {})['bullet2'] ?? 0) + (((s as any).KGZVars ?? 0)?.['bulletrand']);
    qspCall(s, 'stat', '');
    scene.text('You search the store for anything useful.');
    if (((s as any).KGZVars ?? 0)?.['gun2'] === 0) {
      ((s as any).KGZVars ?? {})['gun2'] = 1;
...
function enterKGZvihod6(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['copdoor'] === 0) {
    ...
    ((s as any).KGZVars ?? {})['hour'] = (((s as any).KGZVars ?? {})['hour'] ?? 0) + (1);
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    ((s as any).KGZVars ?? {})['copdoor'] = 1;
    ((s as any).KGZVars ?? {})['batl'] = 0;
    ((s as any).KGZVars ?? {})['bullet3'] = (((s as any).KGZVars ?? {})['bullet3'] ?? 0) + (500);
    ((s as any).KGZVars ?? {})['dead'] = ((s as any).KGZVars ?? {})?.['day'] * 10;
    qspCall(s, 'stat', '');
  ...
  scene.actions([
    ...
    ((s as any).KGZVars ?? {})['batl'] = 0;
    ((s as any).KGZVars ?? {})['bulletrand'] = Math.floor(Math.random() * 18) + 3;
    ((s as any).KGZVars ?? {})['bullet'] = (((s as any).KGZVars ?? {})['bullet'] ?? 0) + (((s as any).KGZVars ?? 0)?.['bulletrand']);
    qspCall(s, 'stat', '');
...
function enterKGZvihod8(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['ratia'] > 0) {
    ...
    ((s as any).KGZVars ?? {})['hour'] = (((s as any).KGZVars ?? {})['hour'] ?? 0) + (1);
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    ((s as any).KGZVars ?? {})['place'] = 10;
    ((s as any).KGZVars ?? {})['placeA'] = 1;
    ((s as any).KGZVars ?? {})['batl'] = 0;
    qspCall(s, 'stat', '');
...
function enterKGZvihod10(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['placeA'] < 10) {
    ((s as any).KGZVars ?? {})['placeA_text'] = 'Fort Bragg';
    ((s as any).KGZVars ?? {})['placeB_text'] = 'the city';
  }
  if (((s as any).KGZVars ?? 0)?.['placeA'] > 10) {
    ((s as any).KGZVars ?? {})['placeA_text'] = 'the city';
    ((s as any).KGZVars ?? {})['placeB_text'] = 'Fort Bragg';
  }
  if (((s as any).KGZVars ?? 0)?.['placeA'] > 10) {
    scene.actions([
  ...
  scene.actions([
    ...
    ((s as any).KGZVars ?? {})['hour'] = (((s as any).KGZVars ?? {})['hour'] ?? 0) + (1);
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    ((s as any).KGZVars ?? {})['placeA'] = (((s as any).KGZVars ?? {})['placeA'] ?? 0) + (1);
    ((s as any).KGZVars ?? {})['batl'] = 0;
    qspCall(s, 'stat', '');
...
function enterKGZvihod11(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    if (((s as any).KGZVars ?? 0)?.['fortQW'] === 0) {
      ((s as any).KGZVars ?? {})['fortQW'] = 1;
    }
    ((s as any).KGZVars ?? {})['place'] = 12;
    ((s as any).KGZVars ?? {})['batl'] = 0;
    ((s as any).KGZVars ?? {})['dead'] = (Math.floor(Math.random() * (((s as any).KGZVars ?? {})?.['day'] * 30 - ((s as any).KGZVars ?? {})?.['day'] * 20 + 1)) + (((s as any).KGZVars ?? {})?.['day'] * 20));
    qspCall(s, 'stat', '');
...
function enterKGZvihod13(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    if (((s as any).udacharand ?? 0) === 1) {
      ((s as any).KGZVars ?? {})['suprand'] = Math.floor(Math.random() * 3) + 1;
      ((s as any).KGZVars ?? {})['sup'] = (((s as any).KGZVars ?? {})['sup'] ?? 0) + (((s as any).KGZVars ?? 0)?.['suprand']);
  ...
  scene.actions([
    ...
    if (((s as any).KGZVars ?? 0)?.['fortOru'] === 1) {
      ...
      if (((s as any).KGZVars ?? 0)?.['fortOru'] === 0) {
        ((s as any).KGZVars ?? {})['fortOru'] = 1;
        scene.text('You find 300 rounds of ammunition for your machine gun and 10 grenades.');
        ((s as any).KGZVars ?? {})['granade'] = (((s as any).KGZVars ?? {})['granade'] ?? 0) + (10);
        ((s as any).KGZVars ?? {})['bullet3'] = (((s as any).KGZVars ?? {})['bullet3'] ?? 0) + (300);
      }
    }
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
...
function enterKGZvihod16(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['gruzovik'] === 0) {
    ...
    ((s as any).KGZVars ?? {})['gruzovik'] = 3;
    ((s as any).KGZVars ?? {})['place'] = 10;
    ((s as any).KGZVars ?? {})['placeA'] = 7;
    ((s as any).KGZVars ?? {})['dead'] = (Math.floor(Math.random() * (((s as any).KGZVars ?? {})?.['day'] * 100 - ((s as any).KGZVars ?? {})?.['day'] * 50 + 1)) + (((s as any).KGZVars ?? {})?.['day'] * 50));
    ...
    ((s as any).KGZVars ?? {})['gruzovik'] = 2;
    ((s as any).KGZVars ?? {})['place'] = 10;
    ((s as any).KGZVars ?? {})['placeA'] = 11;
    ((s as any).KGZVars ?? {})['dead'] = (Math.floor(Math.random() * (((s as any).KGZVars ?? {})?.['day'] * 100 - ((s as any).KGZVars ?? {})?.['day'] * 50 + 1)) + (((s as any).KGZVars ?? {})?.['day'] * 50));
    ...
    ((s as any).KGZVars ?? {})['gruzovik'] = 4;
    ((s as any).KGZVars ?? {})['place'] = 10;
    ((s as any).KGZVars ?? {})['placeA'] = 13;
    ((s as any).KGZVars ?? {})['dead'] = (Math.floor(Math.random() * (((s as any).KGZVars ?? {})?.['day'] * 100 - ((s as any).KGZVars ?? {})?.['day'] * 50 + 1)) + (((s as any).KGZVars ?? {})?.['day'] * 50));
    ...
    // TODO-QSP: KGZVars['dist'] = rand(5, 10)
      ...
      ((s as any).KGZVars ?? {})['gruzBenzMark'] = 1;
...
function enterKGZvihod100(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).KGZVars ?? {})['locrand'] = Math.floor(Math.random() * 101) + 0;
    if (((s as any).KGZVars ?? 0)?.['locrand'] >= 90  &&  ((s as any).KGZVars ?? 0)?.['lok'] === 0) {
      ((s as any).KGZVars ?? {})['lok'] = 1;
...
function enterKGZfizatk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['weapon'] === 0) {
    ((s as any).KGZVars ?? {})['uspeh'] = Math.floor(Math.random() * 101) + 0;
  ...
  if (((s as any).KGZVars ?? 0)?.['dead'] > 0) {
    ((s as any).KGZVars ?? {})['uron'] = (Math.floor(Math.random() * (((s as any).KGZVars ?? {})?.['dead'] * 5 - ((s as any).KGZVars ?? {})?.['dead'] * 2 + 1)) + (((s as any).KGZVars ?? {})?.['dead'] * 2));
    ((s as any).KGZVars ?? {})['HP'] = (((s as any).KGZVars ?? {})['HP'] ?? 0) - (((s as any).KGZVars ?? 0)?.['uron']);
...
function enterKGZgunatk4(s: GameState, scene: SceneBuilder): void {
  // TODO-QSP: :KGZmarkgun
  ((s as any).KGZVars ?? {})['bulgun'] = (((s as any).KGZVars ?? {})['bulgun'] ?? 0) - (1);
  ((s as any).KGZVars ?? {})['uspeh'] = Math.floor(Math.random() * 101) + 0;
  if (((s as any).KGZVars ?? 0)?.['dead'] > 0) {
    if (((s as any).KGZVars ?? 0)?.['dist'] <= 5) {
      if (((s as any).KGZVars ?? 0)?.['uspeh'] <= 80) {
...
function enterKGZgranatk(s: GameState, scene: SceneBuilder): void {
  ((s as any).KGZVars ?? {})['uspeh'] = Math.floor(Math.random() * 101) + 0;
  ((s as any).KGZVars ?? {})['granade'] = (((s as any).KGZVars ?? {})['granade'] ?? 0) - (1);
  scene.text('You pull the pin on a grenade and throw it.');
  if (((s as any).KGZVars ?? 0)?.['dist'] <= 5) {
    ((s as any).KGZVars ?? {})['dist'] = (((s as any).KGZVars ?? {})['dist'] ?? 0) + (Math.floor(Math.random() * 5) + 1);
    ((s as any).KGZVars ?? {})['dead'] = (((s as any).KGZVars ?? {})['dead'] ?? 0) - (Math.floor(Math.random() * 16) + 5);
    ((s as any).KGZVars ?? {})['HP'] = (((s as any).KGZVars ?? {})['HP'] ?? 0) - (Math.floor(Math.random() * 16) + 5);
    scene.text('The powerful explosion blasts the dead away, but you\'re close enough to take damage yourself.');
  } else {
    if (((s as any).KGZVars ?? 0)?.['dist'] <= 10) {
      ((s as any).KGZVars ?? {})['dist'] = (((s as any).KGZVars ?? {})['dist'] ?? 0) + (Math.floor(Math.random() * 3) + 1);
      ((s as any).KGZVars ?? {})['dead'] = (((s as any).KGZVars ?? {})['dead'] ?? 0) - (Math.floor(Math.random() * 8) + 3);

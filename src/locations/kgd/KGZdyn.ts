...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['weapon'] === 0) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['weapon_text'] = 'Fists';
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['weapon_texta'] = 'Fist';
  }
  if (((s as any).KGZVars ?? 0)?.['weapon'] === 1) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['weapon_text'] = 'Baton';
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['weapon_texta'] = 'Shillelagh';
  }
  if (((s as any).KGZVars ?? 0)?.['weapon'] === 2) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['weapon_text'] = 'Ax';
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['weapon_texta'] = 'Ax';
  }
  if (((s as any).KGZVars ?? 0)?.['gun'] > 0) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['gun_text'] = '' + (((s as any).KGZVars ?? 0)?.['bullet']) + ' pistol bullets';
  }
  if (((s as any).KGZVars ?? 0)?.['gun2'] > 0) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['gun2_text'] = '' + (((s as any).KGZVars ?? 0)?.['bullet2']) + ' shotgun cartridges';
  }
  if (((s as any).KGZVars ?? 0)?.['gun3'] > 0) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['gun3_text'] = '' + (((s as any).KGZVars ?? 0)?.['bullet3']) + ' rifle bullets';
  }
  if (((s as any).KGZVars ?? 0)?.['hour'] >= 24) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['hour'] = ((s as any).KGZVars['hour'] ?? 0) - (24);
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['day'] = ((s as any).KGZVars['day'] ?? 0) + (1);
    if (((s as any).KGZVars ?? 0)?.['sup'] === 0) {
      ((s as any).KGZVars = (s as any).KGZVars ?? {})['HP'] = ((s as any).KGZVars['HP'] ?? 0) - (10);
    } else {
...
function enterKGZvihod(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['weapon'] === 0) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['weapon'] = 1;
...
function enterKGZvihod6(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['copdoor'] === 0) {
    ...
    ((st as any).KGZVars = (st as any).KGZVars ?? {})['dist'] = (Math.floor(Math.random() * 4) + 5);
  }, goto: ['KGZfight', ''] },
    ]);
  } },
      ]);
...
function enterKGZvihod10(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['placeA'] < 10) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['placeA_text'] = 'Fort Bragg';
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['placeB_text'] = 'the city';
  }
  if (((s as any).KGZVars ?? 0)?.['placeA'] > 10) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['placeA_text'] = 'the city';
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['placeB_text'] = 'Fort Bragg';
  }
  if (((s as any).KGZVars ?? 0)?.['placeA'] > 10) {
    scene.actions([
...
function enterKGZvihod11(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).KGZVars ?? 0)?.['fortQW'] === 2) {
    ...
    scene.actions([
      { label: 'Defend yourself', handler: (st: GameState) => {
    ((st as any).KGZVars = (st as any).KGZVars ?? {})['dist'] = (Math.floor(Math.random() * 8) + 5);
  }, goto: ['KGZfight', ''] },
    ]);
  } },
...
function enterKGZvincent(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['fortQW'] === 1) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['fortQW'] = 2;
...
function enterKGZgunatk4(s: GameState, scene: SceneBuilder): void {
  ...
  } while (((s as any).KGZVars ?? 0)?.['bulgun'] > 0);
  scene.build();
}
...
function enterKGZdeadmanatk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).KGZVars ?? 0)?.['dist'] > 0) {
    ((s as any).KGZVars = (s as any).KGZVars ?? {})['dist'] = ((s as any).KGZVars['dist'] ?? 0) - (1);
  }

...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).KGD) (s as any).KGD = {}; (s as any).KGD['BP_Lvl'] = ((((s as any).KGD ?? {})?.['lvl'] ?? 0) + (((s as any).KGD ?? {})?.['lvl_2'] ?? 0) + (((s as any).KGD ?? {})?.['lvl_3'] ?? 0) + (((s as any).KGD ?? {})?.['lvl_4'] ?? 0) + (((s as any).KGD ?? {})?.['lvl_5'] ?? 0) + (((s as any).KGD ?? {})?.['lvl_6'] ?? 0))/2;
  if (!(s as any).KGD) (s as any).KGD = {}; (s as any).KGD['BP_HP'] = ((((s as any).KGD ?? {})?.['HP'] ?? 0)+ (((s as any).KGD ?? {})?.['HP_2'] ?? 0) + (((s as any).KGD ?? {})?.['HP_3'] ?? 0) + (((s as any).KGD ?? {})?.['HP_4'] ?? 0) + (((s as any).KGD ?? {})?.['HP_5'] ?? 0) + (((s as any).KGD ?? {})?.['HP_6'] ?? 0)) * ((((((s as any).KGD ?? {})?.['Infantrie'] ?? 0)+1)/5)+(((((s as any).KGD ?? {})?.['Cavalry'] ?? 0)+1)/10)+(((((s as any).KGD ?? {})?.['Archers'] ?? 0)+1)/15));
  if (!(s as any).KGD) (s as any).KGD = {}; (s as any).KGD['BP_Damage'] = (((s as any).KGD ?? {})?.['HP'] ?? 0) + (((s as any).KGD ?? {})?.['damage_2'] ?? 0) + (((s as any).KGD ?? {})?.['damage_3'] ?? 0) + (((s as any).KGD ?? {})?.['damage_4'] ?? 0) + (((s as any).KGD ?? {})?.['damage_5'] ?? 0) + (((s as any).KGD ?? {})?.['damage_6'] ?? 0) * ((((((s as any).KGD ?? {})?.['Infantrie'] ?? 0)+1)/15)+(((((s as any).KGD ?? {})?.['Cavalry'] ?? 0)+1)/10)+(((((s as any).KGD ?? {})?.['Archers'] ?? 0)+1)/5));
  if (!(s as any).KGD) (s as any).KGD = {}; (s as any).KGD['BP'] = ((((s as any).KGD ?? {})?.['BP_HP'] ?? 0) + (((s as any).KGD ?? {})?.['BP_Damage'] ?? 0)) * (((s as any).KGD ?? {})?.['BP_Lvl'] ?? 0);
  scene.actions([

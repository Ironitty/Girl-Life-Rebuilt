...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  do {
    ...
    if (((s as any).KGD ?? 0)['sput_' + (((s as any).i ?? 0))] === 1) {
      scene.text(`<table><tr><td>${(((s as any).KGD ?? 0)?.['name_' + String(((s as any).i ?? 0))] ?? '')}:</td><td>Level: ${(((s as any).KGD ?? 0)?.['lvl_' + String(((s as any).i ?? 0))] ?? '')} </td><td>HP: ${(((s as any).KGD ?? 0)?.['HP_' + String(((s as any).i ?? 0))] ?? '')} </td><td>Damage: ${(((s as any).KGD ?? 0)?.['damage_' + String(((s as any).i ?? 0))] ?? '')}.</td></tr></table>`);

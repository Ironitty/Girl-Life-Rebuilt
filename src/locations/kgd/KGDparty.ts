...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).KGD ?? {})['BP_Lvl'] = (((s as any).KGD ?? {})?.['lvl'] + ((s as any).KGD ?? {})?.['lvl_2'] + ((s as any).KGD ?? {})?.['lvl_3'] + ((s as any).KGD ?? {})?.['lvl_4'] + ((s as any).KGD ?? {})?.['lvl_5'] + ((s as any).KGD ?? {})?.['lvl_6'])/2;
  ((s as any).KGD ?? {})['BP_HP'] = (((s as any).KGD ?? {})?.['HP']+ ((s as any).KGD ?? {})?.['HP_2'] + ((s as any).KGD ?? {})?.['HP_3'] + ((s as any).KGD ?? {})?.['HP_4'] + ((s as any).KGD ?? {})?.['HP_5'] + ((s as any).KGD ?? {})?.['HP_6']) * (((((s as any).KGD ?? {})?.['Infantrie']+1)/5)+((((s as any).KGD ?? {})?.['Cavalry']+1)/10)+((((s as any).KGD ?? {})?.['Archers']+1)/15));
  ((s as any).KGD ?? {})['BP_Damage'] = ((s as any).KGD ?? {})?.['HP'] + ((s as any).KGD ?? {})?.['damage_2'] + ((s as any).KGD ?? {})?.['damage_3'] + ((s as any).KGD ?? {})?.['damage_4'] + ((s as any).KGD ?? {})?.['damage_5'] + ((s as any).KGD ?? {})?.['damage_6'] * (((((s as any).KGD ?? {})?.['Infantrie']+1)/15)+((((s as any).KGD ?? {})?.['Cavalry']+1)/10)+((((s as any).KGD ?? {})?.['Archers']+1)/5));
  ((s as any).KGD ?? {})['BP'] = (((s as any).KGD ?? {})?.['BP_HP'] + ((s as any).KGD ?? {})?.['BP_Damage']) * ((s as any).KGD ?? {})?.['BP_Lvl'];
  scene.actions([

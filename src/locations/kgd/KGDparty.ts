...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).KGD ?? 0)?.['sput_' + String(((s as any).i ?? 0))] === 1) {
  ...
  (s as any).KGD['BP_Lvl'] = (((s as any).KGD ?? 0)?.['lvl'] + ((s as any).KGD ?? 0)?.['lvl_2'] + ((s as any).KGD ?? 0)?.['lvl_3'] + ((s as any).KGD ?? 0)?.['lvl_4'] + ((s as any).KGD ?? 0)?.['lvl_5'] + ((s as any).KGD ?? 0)?.['lvl_6'])/2;
  (s as any).KGD['BP_HP'] = (((s as any).KGD ?? 0)?.['HP']+ ((s as any).KGD ?? 0)?.['HP_2'] + ((s as any).KGD ?? 0)?.['HP_3'] + ((s as any).KGD ?? 0)?.['HP_4'] + ((s as any).KGD ?? 0)?.['HP_5'] + ((s as any).KGD ?? 0)?.['HP_6']) * (((((s as any).KGD ?? 0)?.['Infantrie']+1)/5)+((((s as any).KGD ?? 0)?.['Cavalry']+1)/10)+((((s as any).KGD ?? 0)?.['Archers']+1)/15));
  (s as any).KGD['BP_Damage'] = ((s as any).KGD ?? 0)?.['HP'] + ((s as any).KGD ?? 0)?.['damage_2'] + ((s as any).KGD ?? 0)?.['damage_3'] + ((s as any).KGD ?? 0)?.['damage_4'] + ((s as any).KGD ?? 0)?.['damage_5'] + ((s as any).KGD ?? 0)?.['damage_6'] * (((((s as any).KGD ?? 0)?.['Infantrie']+1)/15)+((((s as any).KGD ?? 0)?.['Cavalry']+1)/10)+((((s as any).KGD ?? 0)?.['Archers']+1)/5));
  (s as any).KGD['BP'] = (((s as any).KGD ?? 0)?.['BP_HP'] + ((s as any).KGD ?? 0)?.['BP_Damage']) * ((s as any).KGD ?? 0)?.['BP_Lvl'];
  scene.actions([

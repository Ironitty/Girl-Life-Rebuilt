...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['day'] = 1;
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['hour'] = 8;
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['sup'] = 3;
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['medkit'] = 1;
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['rec'] = 0;

...
{ label: 'Quit', goto: ['KGZstart', ''] },
  ...
  if (((s as any).KGZVars ?? 0)?.['place'] === 0) {
    ...
    if (((s as any).KGZVars ?? 0)?.['place'] === 1) {
      ((s as any).KGZVars = (s as any).KGZVars ?? {})['dead'] = (Math.floor(Math.random() * ((((s as any).KGZVars ?? {})?.['day'] ?? 0) * 2 - (((s as any).KGZVars ?? 0)?.['day']) + 1)) + ((((s as any).KGZVars ?? 0)?.['day'])));
    ...
    if (((st as any).KGZVars ?? 0)?.['svet'] === 1) {
      ((st as any).KGZVars = (st as any).KGZVars ?? {})['dist'] = (Math.floor(Math.random() * 26) + 5);
    }
    if (((st as any).KGZVars ?? 0)?.['svet'] === 2) {
    ...
    if (((st as any).KGZVars ?? 0)?.['svet'] === 2) {
      ((st as any).KGZVars = (st as any).KGZVars ?? {})['dist'] = (Math.floor(Math.random() * 7) + 2);
    }
    qspGoto(st, 'KGZfight', '');
  } },
            ]);
    ...
    ((st as any).KGZVars = (st as any).KGZVars ?? {})['dist'] = (Math.floor(Math.random() * 21) + 10);
                                            ...
                                            if (((s as any).KGZVars ?? 0)?.['place'] === 201) {
                                              ((s as any).KGZVars = (s as any).KGZVars ?? {})['dead'] = (Math.floor(Math.random() * ((((s as any).KGZVars ?? {})?.['day'] ?? 0) * 3 - (((s as any).KGZVars ?? 0)?.['day']) + 1)) + ((((s as any).KGZVars ?? 0)?.['day'])));

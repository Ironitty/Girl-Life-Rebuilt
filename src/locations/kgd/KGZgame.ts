...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).KGZVars ?? 0)?.['hour'] >= 6  &&  ((s as any).KGZVars ?? 0)?.['hour'] <= 21) {
    (s as any).KGZVars['svet'] = 1;
  } else {
    (s as any).KGZVars['svet'] = 0;
  }
  if (((s as any).KGZVars ?? 0)?.['last_xp_hour'] !== (((s as any).KGZVars ?? 0)?.['day'] - 1) * 24 + (((s as any).KGZVars ?? 0)?.['hour'] - 8)) {
    (s as any).KGZVars['last_xp_hour'] = (((s as any).KGZVars ?? 0)?.['day'] - 1) * 24 + (((s as any).KGZVars ?? 0)?.['hour'] - 8);
  ...
  if (((s as any).KGZVars ?? 0)?.['place'] === 0) {
    ...
    (s as any).KGZVars['dead'] = ((s as any).rand ?? 0)(((s as any).KGZVars ?? 0)?.['day'], ((s as any).KGZVars ?? 0)?.['day'] * 2);
    ...
    if (((s as any).KGZVars ?? 0)?.['batl'] === 0) {
      ...
      (s as any).KGZVars['agr'] = Math.floor(Math.random() * 11) + 0;
    ...
    if (((s as any).KGZVars ?? 0)?.['svet'] === 1) {
      (s as any).KGZVars['dist'] = Math.floor(Math.random() * 26) + 5;
    }
    if (((s as any).KGZVars ?? 0)?.['svet'] === 2) {
      (s as any).KGZVars['dist'] = Math.floor(Math.random() * 8) + 3;
    }
  }, goto: ['KGZfight', ''] },
        ]);
      } else {
    ...
    if (((s as any).KGZVars ?? 0)?.['svet'] === 2) {
      (s as any).KGZVars['dist'] = Math.floor(Math.random() * 7) + 2;
    }
  }, goto: ['KGZfight', ''] },
          ]);
        } else {
    ...
    // TODO-QSP: KGZVars['dist'] = rand(2, 5)
          ...
          if (((s as any).KGZVars ?? 0)?.['place'] === 8) {
            (s as any).KGZVars['dead'] = ((s as any).rand ?? 0)(((s as any).KGZVars ?? 0)?.['day'] * 2, ((s as any).KGZVars ?? 0)?.['day'] * 4);
    ...
    if (((s as any).KGZVars ?? 0)?.['svet'] === 2) {
      (s as any).KGZVars['dist'] = Math.floor(Math.random() * 8) + 3;
              ...
              (s as any).KGZVars['dead'] = ((s as any).rand ?? 0)(((s as any).KGZVars ?? 0)?.['day'] * 10, ((s as any).KGZVars ?? 0)?.['day'] * 20);
    ...
    // TODO-QSP: KGZVars['dist'] = rand(10, 30)
                        ...
                        (s as any).KGZVars['dead'] = ((s as any).rand ?? 0)(((s as any).KGZVars ?? 0)?.['day'], ((s as any).KGZVars ?? 0)?.['day'] * 3);

    ...
    dynamicGoto(st, 'curloc');
      ...
      if (((s as any).KGZVars ?? 0)?.['dedrandrun'] === 0) {
        ...
        if (((s as any).KGZVars ?? 0)?.['dedrandrun'] === 1) {
          if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dist'] = ((s as any).KGZVars['dist'] ?? 0) - (5);
          if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dead'] = ((s as any).KGZVars['dead'] ?? 0) + ((Math.floor(Math.random() * (((s as any).KGZVars ?? {})?.['dead'] * 5 - ((s as any).KGZVars ?? {})?.['dead'] + 1)) + (((s as any).KGZVars ?? {})?.['dead'])));

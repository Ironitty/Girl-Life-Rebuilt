...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).KGZVars ?? 0)?.['dist'] < 0) {
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dist'] = 0;
  }
  ...
  if (((s as any).KGZVars ?? 0)?.['gun'] > 0  &&  ((s as any).KGZVars ?? 0)?.['bullet'] > 0) {
    ...
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bullet'] = ((s as any).KGZVars['bullet'] ?? 0) - (1);
  ...
  if (((s as any).KGZVars ?? 0)?.['gun2'] > 0  &&  ((s as any).KGZVars ?? 0)?.['bullet2'] > 0) {
    ...
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bullet2'] = ((s as any).KGZVars['bullet2'] ?? 0) - (1);
  ...
  if (((s as any).KGZVars ?? 0)?.['gun3'] > 0  &&  ((s as any).KGZVars ?? 0)?.['bullet3'] > 0) {
    ...
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bullet3'] = ((s as any).KGZVars['bullet3'] ?? 0) - (3);
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bulgun'] = 3;
    ...
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bullet3'] = ((s as any).KGZVars['bullet3'] ?? 0) - (10);
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bulgun'] = 10;
    ...
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bullet3'] = ((s as any).KGZVars['bullet3'] ?? 0) - (1);
  ...
  if (((s as any).KGZVars ?? 0)?.['dist'] <= 2) {
    ...
    if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dist'] = ((s as any).KGZVars['dist'] ?? 0) - (2);
    dynamicGoto(st, 'curloc');
  } },
      { label: 'Scoot', handler: (st: GameState) => {
    if (((s as any).KGZVars ?? 0)?.['dead'] >= 10) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dist'] = ((s as any).KGZVars['dist'] ?? 0) - (5);
    ...
    dynamicGoto(st, 'curloc');
      ...
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dedrandrun'] = Math.floor(Math.random() * 2) + 0;
      if (((s as any).KGZVars ?? 0)?.['dedrandrun'] === 0) {
        ...
        if (((s as any).KGZVars ?? 0)?.['dedrandrun'] === 1) {
          if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dist'] = ((s as any).KGZVars['dist'] ?? 0) - (5);
          if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dead'] = ((s as any).KGZVars['dead'] ?? 0) + ((Math.floor(Math.random() * ((((s as any).KGZVars ?? {})?.['dead'] ?? 0) * 5 - (((s as any).KGZVars ?? {})?.['dead'] ?? 0) + 1)) + ((((s as any).KGZVars ?? {})?.['dead'] ?? 0))));

...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pavComplex_met_dealer ?? 0) >= 3  &&  ((s as any).hour ?? 0) > 20) {
    // TODO-QSP: '<br>You can see the <a href="exec:minut += 3
    // TODO-QSP: gt ''pav_aptcourtev'', ''dealer''">boy</a> who sells weed in the courtyard.'
  }
  if (((s as any).cfg_vars ?? 0)?.['tablemap'] === 0) {
    ...
    if (((s as any).ArtemBeInHome ?? 0) > 0  &&  ((s as any).artemQW ?? 0)?.['artemblok'] === 0) {
      // TODO-QSP: '<a href="exec:minut += 15
      // TODO-QSP: gt ''artemhome'', ''home''">Artem Chebotarev</a>, one of your classmates, lives in the same apartmen...
    }
    ...
    if (((s as any).NatbelQW ?? 0)?.['VisitedHome'] === 1) {
      // TODO-QSP: '<a href="exec:minut += 15
      // TODO-QSP: gt ''natbelapt'', ''home''">Natasha Belova</a>, one of your classmates, lives in the same apartment ...
    }
    if (((s as any).anushkaQW ?? 0)?.['first_visit'] !== 0) {
      // TODO-QSP: '<a href="exec:minut += 10
      // TODO-QSP: gt ''anushapt'', ''home''">Anushka Konstantinov</a>, a classmate, lives in one of the other apartmen...
    }
    if (((s as any).radomirQW ?? 0)?.['first_visit'] !== 0) {
      // TODO-QSP: '<a href="exec:minut += 10
      // TODO-QSP: gt ''radapt'', ''home''">Radomir Popov</a>, a classmate, lives in one of the other apartment blocks ...
    }
  } else {
    (s as any).st_count = 0;
    (s as any).show_table = '';
    ...
    if (((s as any).ArtemBeInHome ?? 0) > 0  &&  ((s as any).artemQW ?? 0)?.['artemblok'] === 0) {
      // TODO-QSP: gs 'show_table', 'Apartment of <a href="exec:minut += 15
      // TODO-QSP: gt ''artemhome'', ''home''">Artem Chebotarev</a>.', '3'
    }
    if (((s as any).juliaQW ?? 0)?.['home_unlocked'] === 1) {
      if ((((s as any).hour ?? 0) >= 15  &&  ((s as any).hour ?? 0) <= 20  &&  ((s as any).week ?? 0) < 6)  ||  (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) <= 20  &&  ((s as any).week ?? 0) >= 6)) {
    ...
    if (((s as any).NatbelQW ?? 0)?.['VisitedHome'] === 1) {
      // TODO-QSP: gs 'show_table', 'Apartment of <a href="exec:minut += 15
      // TODO-QSP: gt ''natbelapt'', ''home''">Natasha Belova</a>.', '3'
    }
    if (((s as any).anushkaQW ?? 0)?.['first_visit'] !== 0) {
      // TODO-QSP: gs 'show_table', 'Messy home of <a href="exec:minut += 10
      // TODO-QSP: gt ''anushapt'', ''home''">Anushka Konstantinov</a>.', '3'
    }
  ...
  if (((s as any).shared_apt ?? 0)?.['seenAd'] === 1  &&  ((s as any).shared_apt ?? 0)?.['enabled'] === 0) {
    // TODO-QSP: '<br>Some guys in one of the <a href="exec:minut += 5
    // TODO-QSP: gt ''pav_shared_apt'',''doorNo30''">apartments</a> are looking for a roommate.'
  }
  if (((s as any).rolanmeet ?? 0) === 8  &&  ((s as any).rolanblockhome ?? 0) !== 1) {
    // TODO-QSP: '<br>Mr. Matveev''s is living in an <a href="exec:minut += 5
    // TODO-QSP: gt ''rolanapt'',''home''">apartment</a> in the Five Eight Estate.'
  }
...
function enterGarages(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).start_type ?? 0)?.['loc'] === 'sg') {
    // TODO-QSP: 'Your <a href="exec:minut += 5
    // TODO-QSP: gt ''gargazel''">stepfather''s garage</a> is around here somewhere.'
  }
  if (((s as any).gopnikbandQW ?? 0)?.['practice_invite'] === 1) {
    // TODO-QSP: 'The converted <a href="exec:minut += 5
    // TODO-QSP: gt ''praiders_garage'', ''band_garage''">garage</a> the band uses to practice in is around here.'
  }

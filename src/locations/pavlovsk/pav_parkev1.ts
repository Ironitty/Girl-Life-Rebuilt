...
function enterFemaleGopnikBeer_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).park ?? 0)?.['girl_eatlera'] === 1) {
      ...
      // TODO-QSP: dynamic text: Before you can react or say anything, Lena speaks up. "I don''t think so Lera." ...
...
function enterNikoBeer(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: "Depends on how much you''re willing to pay," Niko replies. "<<$pcs_nickname>> d...
  ...
  if (((s as any).grupTipe ?? 0) === 4) {
    ...
    // TODO-QSP: dynamic text: Niko shakes his head. "I''m fine, <<$pcs_nickname>>. I don''t need to see a doct...
    ...
    // TODO-QSP: dynamic text: Niko then releases you. "It''s been a blast as always, <<$pcs_nickname>>, but I ...
    ...
    // TODO-QSP: dynamic text: "Whoa, <<$pcs_nickname>> can really suck, can''t she?" Lena comments. "Like she'...
...
function enterNikoBeerBoys(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: "Depends on how much you''re willing to pay," Niko jokingly replies. "<<$pcs_nic...
  ...
  // TODO-QSP: dynamic text: Arkadi dismissively shakes his head. "Is that so? Why don''t give us a demonstra...
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: "For <<$func(''money'', ''string_profit'', 200)>>, <<$pcs_nickname>> will give y...

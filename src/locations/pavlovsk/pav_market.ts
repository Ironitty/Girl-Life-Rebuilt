...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('Pavlovsk\'s modest train station is situated near the Pavlovsk Market Square. You can enter the central hall of the <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027pav_train_hall\u0027, \u0027\u0027); return false;">train station</a> from here. Down the street from the train station is the <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027gkafe\u0027, \u0027\u0027); return false;">Borislav\'s cafe</a>' + ((((s as any).start_type ?? 0)?.['loc'] === 'sg') ? (' where your mother works') : ('')) + '. Next to the train station is the <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027pav_station\u0027, \u0027station_outside\u0027); return false;">Pavlovsk police station</a>, where you can find Pavlovsk\'s finest.');
  scene.text('On the other side of the train station is a large square where you can find a <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=1; return s; }); window.__gameStore.getState().doGoto(\u0027pav_train_market\u0027, \u0027start\u0027); return false;">market</a> on most days.');
  scene.text(`A rather run-down <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=1; return s; }); window.__gameStore.getState().doGoto(/u0027pav_hotel/u0027, /u0027/u0027); return false;">hotel</a> is just across the square${((((s as any).job_hiring_step ?? 0)?.['pav_hotel_maid'] > 0) ? ('; the manager is always looking for maids among the local young girls') : (''))}. Due to its frequent use by local prostitutes, most people prefer to stay at the middle-class hotel by the main road.`);
  ...
  if (((s as any).prostitute ?? 0)?.['wl_block'] === 0  &&  ((s as any).prostitute ?? 0)?.['full_block'] === 0  &&  ((s as any).prostitute ?? 0)?.['gas_station'] === 1) {
    if (qspFunc(s, 'money', 'can_afford', 75) === 1) {
      scene.text('A bus terminal is situated next to the train station. Here you can catch the bus that will take you to <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=87; return s; }); window.__gameStore.getState().doGoto(\u0027money\u0027, \u0027pay\u0027, \u002775 & gt \u0027gas_station_gp_117\u0027\u0027); return false;">the gas station on the M11</a>.');
    } else {

...
function enterOutside(s: GameState, scene: SceneBuilder): void {
  ...
  if ((((s as any).gdk_nice_guy ?? 0) === 1  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 70)  ||  (((s as any).gdk_nice_guy ?? 0) === 0  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 30)) {
    ...
    scene.text(`${((s as any).npcdesc || '')} offers you a disarming smile. "Alright, no problem! We can just chat!"`);
    scene.actions([
    ...
    scene.text(`You spend some time getting to know ${((s as any).npcdesc || '')} a bit better before he checks his watch. "I have to get going, but I really enjoyed chatting with you!"`);
    ...
    scene.text(`"I hope I'll see you again soon, ${((s as any).pcs_firstname || '')}. I'll call you!" he says as he packs up his things. You get up and chat with him as you head back to the disco.`);
    scene.actions([
      ...
      scene.text(`${((s as any).npcdesc || '')} scoots over until he's right next to you and kisses you.`);
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterKissing(s, scene); (s as any).locArgs = __savedLocArgs; }
      scene.actions([
    ...
    scene.text(`You accept the beer and chat with ${((s as any).npcdesc || '')} as you drink it. He's amusing and tells you some hilarious stories.`);
    if (((s as any).alko ?? 0) >= 6) {
      (s as any).pcs_horny = ((s as any).pcs_horny ?? 0) + (20);
      // TODO-QSP: dynamic text: <<$npcdesc>> scoots over until he's right next to you and closes his arms around...
      scene.text(`${((s as any).npcdesc || '')} scoots over until he's right next to you and closes his arms around you. He pulls you in and kisses your lips passionately, making your heart flutter. Wow, he's a good kisser!`);
    ...
    scene.text(`He roughly undresses you, too horny and drunk to care about your feelings. Then, before you know it, you're naked on the ground before him as he stands over you with his ${((s as any).dick_girth || '')} cock hanging out of his pants.`);
    ...
    scene.actions([
      ...
      scene.text(`${((s as any).npcdesc || '')}'s head slumps for a moment, and his movements slow down, but he's unwilling to let go of your breasts.`);
    ...
    // TODO-QSP: dynamic text: "I hope I'll see you again soon, <<$pcs_firstname>>. I'll call you!" he says as ...
    scene.text(`"I hope I'll see you again soon, ${((s as any).pcs_firstname || '')}. I'll call you!" he says as he packs up his things. You get up as well, and chat with him as you head back to the disco.`);
    scene.actions([
      { label: 'Go back to the disco', goto: ['pav_disco', ''] },
    ]);
  } },
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', 70]; enterDecline(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterKissing(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ...
    scene.text(`You reject the beer and chat with ${((s as any).npcdesc || '')} as he drink's his. He's amusing and tells you some hilarious stories.`);
    scene.text('He then scoots next to you and kisses you on the lips.');
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', 70]; enterDecline(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterKissing(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
...
function enterKissing(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You ignore ${((s as any).npcdesc || '')}'s hands and kiss him, letting him pull your clothes aside, so your ${((s as any).titsize || '')} breasts fall out. He kneads them eagerly and continues to kiss and lick them, making your nipples poke out fiercely in the evening air.`);
    ...
    scene.text(`"How about mine instead?" you ask. With a sultry smirk, you lean in to whisper in ${((s as any).npcdesc || '')}'s ear.`);
    ...
    scene.text(`As soon as you pull your hand away from his groin, ${((s as any).npcdesc || '')} slips his hand underneath your clothes, rubbing two fingers against your pussy. You were already somewhat turned on and softly moaned when he slid his finger back and forth over your wet lips.`);
    ...
    scene.text(`Once the most intense part of your orgasm is over, you relax and moan softly with pleasure. In your daze, your legs can't support your weight, and you drop to your knees in front of ${((s as any).npcdesc || '')}.`);
    // TODO-QSP: dynamic text: When you catch your breath, you see <<$npcdesc>>'s erect cock directly in front ...
    scene.text(`When you catch your breath, you see ${((s as any).npcdesc || '')}'s erect cock directly in front of your face!`);
    ...
    scene.text(`You remain kneeling in front of ${((s as any).npcdesc || '')} as you stare at his erection, still softly panting as you recover from your orgasm. He then begins to jerk off in front of you.`);
    // TODO-QSP: dynamic text: In no time at all, his cock erupts, and a thick glob of his cum lands on your no...
    scene.text(`In no time at all, his cock erupts, and a thick glob of his cum lands on your nose. ${((s as any).npcdesc || '')} groans loudly as he shoots several more jets of his cum onto your face. You flinch, close your eyes, and don't dare open them again until you're sure he's finished.`);
    scene.actions([
      { label: 'Leave', goto: ['pav_commcenter', ''] },
    ]);
  } },
    ...
    scene.text(`${((s as any).npcdesc || '')} still has his hand on your head. "Look at me." he grunts.`);
    ...
    scene.text(`He gives you a blissful smile. "You're an amazing cocksucker, ${((s as any).pcs_nickname || '')}! That was great."`);
    ...
    scene.text(`You kiss ${((s as any).npcdesc || '')} again while you begin to stroke his cock through his pants, feeling the outline of it very clearly through the fabric.`);
...
function enterHandjob(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).npc_dirty_lover ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      scene.text(`${((s as any).npcdesc || '')} wants more and suddenly places his hands on your shoulder. Then, he firmly pushes downwards trying to force you to squat before him.`);
      qspCall(s, 'willpower', 'bj', 'resist');
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHandjobEnd(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        ]);
      }
    } else {
...
function enterBlowjob(s: GameState, scene: SceneBuilder): void {
  ...
  if ((Math.floor(Math.random() * 2) + 0) === 0  &&  ((s as any).gdk ?? 0)?.['fuck'] !== 2) {
    ...
    scene.text(`"Well, that was fun." You smile at ${((s as any).npcdesc || '')} as he tucks his cock inside his pants.`);
...
function enterInsert(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'compliance') {
    ...
    scene.text(`"Hang on," you pause, reaching into your bag and pulling out a condom. You tear the package open and gently roll it onto ${((s as any).npcdesc || '')}'s cock, giving him a few gentle tugs when you're finished. "Safety first."`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPcCondomFunc(s, scene); (s as any).locArgs = __savedLocArgs; }
    scene.actions([
...
function enterFuckPre1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locat ?? 0)?.['Fam_inGad'] === 1) {
    ...
    scene.text(`With a sultry smirk, you lean in to whisper in ${((s as any).npcdesc || '')}'s ear.`);
    scene.text('"<i>My parents aren\'t home tonight...</i>"');
    scene.text('The look in his eyes is all you need to know and the two of you rush back to the estate together.');
    scene.actions([
      { label: 'Continue', goto: ['sex_ev_start', 'pc_home_start', 'hookup'] },
  ...
  scene.actions([
    ...
    if (((s as any).pav_disco_bj ?? 0)?.[String((s as any).npcID ?? 0)] >= ((s as any).totminut ?? 0) - 20) {
      ...
      scene.text(`"Ugh, fine." ${((s as any).npcdesc || '')} grabs you by the shoulder and pushes you back down to your knees. "At least finish me off then."`);
    } else {
      // TODO-QSP: dynamic text: "Ugh, fine." <<$npcdesc>> grabs you by the shoulder and pushes you down to your ...
      scene.text(`"Ugh, fine." ${((s as any).npcdesc || '')} grabs you by the shoulder and pushes you down to your knees. "At least finish me off then."`);
    }
    scene.actions([
      { label: 'Refuse', handler: (st: GameState) => {
    qspCall(s, 'arousal', 'end');
    ...
    scene.text(`"Ugh, I don't want to deal with you." You quickly back away from ${((s as any).npcdesc || '')} and blueball him as you head back to the disco.`);
    scene.actions([
      { label: 'Go back to the disco', goto: ['pav_disco', ''] },
    ]);
  } },
    ...
    if (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      scene.text(`"Well..." ${((s as any).npcdesc || '')} scratches his head for a moment in confusion. "We don't have to do it in public. We could take this back to my place if you want..."`);
      scene.actions([
        { label: 'Refuse', handler: (st: GameState) => {
    ...
    scene.text(`"Oh. Well..." ${((s as any).npcdesc || '')} looks down at his still-hard cock. "Well, could you finish me off at least?"`);
...
function enterFuckPre2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['think_virgin'] === 0) {
    ...
    if (((s as any).npc_no_condoms ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      scene.text(`"No," ${((s as any).npcdesc || '')} grins back.`);
    ...
    scene.text(`"Good thing I do," you smile, reaching into your bag and pulling out a condom. You tear the package open and gently roll it onto ${((s as any).npcdesc || '')}'s cock, giving him a few gentle tugs when you're finished. "Safety first."`);
...
function enterDiscoMouthReact1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"No, but it explains a lot," ${((s as any).npcdesc || '')} grins. Your blush deepens.`);
    scene.actions([
      { label: 'Continue', goto: ['pav_disco_sex', 'disco_sex_end'] },
    ]);
  } },
    ...
    scene.text(`"Uh-huh..." ${((s as any).npcdesc || '')} eyes you knowingly, and your blush deepens, but you refuse to look him in the eye.`);
    scene.actions([
      { label: 'Continue', goto: ['pav_disco_sex', 'disco_sex_end'] },
    ]);
  } },
    ...
    scene.text(`"No, but it explains a lot," ${((s as any).npcdesc || '')} grins. Your blush deepens. Maybe you should have just told him his cum is disgusting after all...`);
    scene.actions([
      { label: 'Continue', goto: ['pav_disco_sex', 'disco_sex_end'] },
    ]);
  } },
    ...
    scene.text(`${((s as any).npcdesc || '')} recoils, looking somewhat offended, but doesn't say anything more.`);
    scene.actions([
      { label: 'Continue', goto: ['pav_disco_sex', 'disco_sex_end'] },
    ]);
  } },
...
function enterDiscoCumMouth(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Opening your mouth, you stick your tongue out and let ${((s as any).npcdesc || '')}'s cum dribble out onto the pavement.`);
    scene.actions([
      { label: 'Continue', goto: ['pav_disco_sex', 'disco_sex_end'] },
    ]);
  } },
...
function enterDiscoCreampie(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat ?? 0)?.['total_creampies'] > 0) {
    ...
    scene.text(`"I love getting creampied," you grin, closing your eyes and savouring the feeling of ${((s as any).npcdesc || '')}'s load oozing from your pussy.`);
    scene.actions([
      { label: 'Continue', goto: ['pav_disco_sex', 'disco_sex_end'] },
    ]);
  } },
...
function enterCreampieSurprise1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"What the fuck is your problem?" ${((s as any).npcdesc || '')} growls angrily.`);
    ...
    if (((s as any).gdk ?? 0)?.['virgin'] === 1  ||  ((s as any).mesec ?? 0) > 0) {
      ...
      scene.text(`${((s as any).npcdesc || '')} storms away from you, pulling up his pants as he goes. Before you know it, you're alone in the dark, a stranger's cum and blood dripping from your pussy, and feeling severely blue-balled.`);
    } else {
      // TODO-QSP: dynamic text: <<$npcdesc>> storms away from you, pulling up his pants as he goes. Before you k...
      scene.text(`${((s as any).npcdesc || '')} storms away from you, pulling up his pants as he goes. Before you know it, you're alone in the dark, a stranger's cum dripping from your pussy, and feeling severely blue-balled.`);
    }
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Continue', goto: ['pav_commcenter', ''] },
    ...
    scene.text(`"What the fuck!" you shout, causing ${((s as any).npcdesc || '')} to recoil backwards. "What made you think that was fucking okay?!"`);
    if (((s as any).gdk ?? 0)?.['virgin'] === 1  ||  ((s as any).mesec ?? 0) > 0) {
      // TODO-QSP: dynamic text: You stare at your pussy, horrified by the white liquid oozing inside. Before you...
      scene.text(`You stare at your pussy, horrified by the white liquid oozing inside. Before you can do anything else, ${((s as any).npcdesc || '')} hurries away from you, pulling up his pants and escaping back into the disco, leaving you alone in the dark with cum and blood dripping from your pussy.`);
    } else {
      // TODO-QSP: dynamic text: You stare at your pussy, horrified by the white liquid oozing inside. Before you...
      scene.text(`You stare at your pussy, horrified by the white liquid oozing inside. Before you can do anything else, ${((s as any).npcdesc || '')} hurries away from you, pulling up his pants and escaping back into the disco, leaving you alone in the dark with his cum still dripping from your pussy.`);
    }
    scene.actions([
      { label: 'Continue', goto: ['pav_commcenter', ''] },
    ]);
    ...
    scene.text(`"You look down at the white liquid dripping from your pussy. It fills you with stress, but you know it wouldn't be right to blame ${((s as any).npcdesc || '')}.`);
    ...
    scene.text(`A shiver of pleasure washes over your body. Knowing that ${((s as any).npcdesc || '')} blew his load inside you is enough to send heat coursing through your hips, and you can feel your nipples stiffen up again.`);
    scene.actions([
    ...
    scene.text(`"That felt so good," you smile tiredly. ${((s as any).npcdesc || '')} blinks at you, a look of surprise on his face as if he expected you to be mad about it.`);
    scene.actions([
      { label: 'Continue', goto: ['pav_disco_sex', 'disco_sex_end'] },
    ]);
  } },
    ...
    scene.text(`"What?" ${((s as any).npcdesc || '')} says, seemingly taken aback by your statement.`);
    ...
    if (((s as any).npc_insecure ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      scene.text(`${((s as any).npcdesc || '')} shouts at you one last time before storming back towards the disco, grumbling the whole time. Suddenly, you're alone in the dark with the load of a stranger inside your pussy.`);
      scene.actions([
        { label: 'Continue', goto: ['pav_commcenter', ''] },
      ]);
    } else {
...
function enterHotel(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).DPtipe ?? 0) !== 1) {
      ...
      scene.text(`As soon as you enter his hotel room, ${((s as any).npcdesc || '')} puts his hands on your hips and pulls you closer for a deep kiss. He slides his hands up and down your body, trying to find a way to get underneath your clothes.`);
      ...
      scene.text(`"Let's have a drink and toast to making new acquaintances! I'm very fortunate to have met a beautiful and wonderful girl such as yourself, ${((s as any).pcs_nickname || '')}", he toasts cheerfully.`);
      scene.actions([
    ...
    scene.text(`The two of you enjoy the drink and chat about small things, relaxing in each other's company. ${((s as any).npcdesc || '')} then stands up and walks up to you, places his hands on your shoulders and brings his lips to yours, giving you a warm kiss while slowly and confidently starting to take your clothes off.`);
    qspCall(s, 'arousal', 'kiss', 5);
    qspCall(s, 'stat', '');
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHeatingUp(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
...
function enterHeatingUp(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['think_virgin'] === 1) {
    ...
    if (((s as any).tiprandeom ?? 0) < 2) {
      ...
      scene.text(`${((s as any).npcdesc || '')} smiles reassuringly. "Oh wow, a virgin, huh? That's okay... we can still have fun without you losing your virginity! Maybe you could use your mouth?"`);
      // TODO-QSP: dynamic text: <<$npcdesc>> unbuttons his pants, letting his cock spring free.
      scene.text(`${((s as any).npcdesc || '')} unbuttons his pants, letting his cock spring free.`);
      qspCall(s, 'willpower', 'bj', 'resist');
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} gives his head a scratch, pondering the situation for a moment. "How about I pay you? I'll give you ${qspFunc(s, 'money', 'string_profit', 400)} for a blowjob?"`);
    ...
    qspGoto(s, 'pav_disco_sex', 'hotelsex', 'paid');
      ...
      scene.text(`${((s as any).npcdesc || '')}'s eyes grow a bit wider when you say the word "virgin".`);
    ...
    scene.text(`${((s as any).npcdesc || '')} gives his head a scratch, pondering the situation for a moment. "Well, in that case, how about a blowjob then? I'll give you ${qspFunc(s, 'money', 'string_profit', 400)}."`);
    ...
    scene.text(`${((s as any).npcdesc || '')} scratches his head, pondering for a moment. He looks somewhat disappointed. "Fair enough, I can respect that. I still want you, though, so how about a blowjob, then? I'll give you ${qspFunc(s, 'money', 'string_profit', 400)}?"`);
    scene.text('He\'s already counting the money out as he says it.');
    qspCall(s, 'willpower', 'prostitution', 'resist', 'hard');
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
    ...
    scene.text(`You wordlessly nod and extend your hand. ${((s as any).npcdesc || '')} readily gives you the money.`);
    ...
    scene.text(`He puts a large pile of money in your hand, and you quickly count it. It's all there, as promised. When you put the money away, ${((s as any).npcdesc || '')} eagerly pushes you down on the bed and starts taking off your top.`);
    qspCall(s, 'arousal', 'foreplay', 5, 'prostitution');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Continue', goto: ['pav_disco_sex', 'hotelsex', 'paid'] },
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    scene.text(`You look at the clock and fake a yawn. "Oh wow, is it that late already? It's been fun spending time with you, ${((s as any).npcdesc || '')}, but I should get going."`);
    // TODO-QSP: dynamic text: <<$npcdesc>> frowns and protests. "Already? But we were having such a nice time!...
    scene.text(`${((s as any).npcdesc || '')} frowns and protests. "Already? But we were having such a nice time!"`);
    ...
    scene.text(`${((s as any).npcdesc || '')} looks disappointed at first but chooses not to reject your offer.`);
    scene.actions([
    ...
    scene.text(`You wordlessly extend your hand, and ${((s as any).npcdesc || '')} readily gives you the money.`);
    qspCall(s, 'arousal', 'bj', 5, 'prostitution');
    qspCall(s, 'dinSex', 'std_trigger_oral');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`You smile at him and quickly put away the money he counted out for you. You barely finish the sentence before ${((s as any).npcdesc || '')} pushes you down on the bed and starts taking off your top.`);
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} pushes you down on the bed and starts taking off your top.`);
...
function enterHotelsex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`After he fucks your ass for a while, you look him in the eyes and say, "I want you to cum on my face." He grins and pulls his dick out of your hole before you slide off the bed and onto your knees. Not wasting any time, you start jerking him off and within seconds, his load bursts out. You smile up at him. Then, happily, eyes closed as the first jet of sperm lands on your forehead. It takes a surprisingly long time for him to cover your face with his load, which ${((s as any).npcdesc || '')} does with great enthusiasm.`);
    if (((s as any).temp_paid ?? 0) === 1) {
    ...
    scene.img('images/shared/sex/cum/facial/facial37.jpg');
    // TODO-QSP: dynamic text: After he fucks your ass for a while, you look him in the eyes and say, "I want y...
    scene.text(`After he fucks your ass for a while, you look him in the eyes and say, "I want you to cum on my face." He grins and pulls his dick out of your hole before you slide off the bed and onto your knees. Not wasting any time, you start jerking him off and within seconds, his load bursts out. You smile up at him. Happily, eyes closed as the first jet of sperm lands on your forehead. It takes a surprisingly long time for him to cover your face with his load, which ${((s as any).npcdesc || '')} does with great enthusiasm.`);
    if (((s as any).temp_paid ?? 0) === 1) {
      qspCall(s, 'arousal', 'hj', 10, 'prostitution');
    } else {
      qspCall(s, 'arousal', 'hj', 10);
    ...
    scene.text(`After sucking his dick, you stop, lie on the bed and spread your legs. ${((s as any).npcdesc || '')} watches you the whole time, taking his clothes off like a hawk. You barely have your legs spread before he's between them, already rubbing his slick cock along your pussy lips. He pushes forward gently, sliding his dick inside of your soaking pussy. He goes slow but quickly picks up the pace, soon pounding your balls deep.`);
    if (((s as any).temp_paid ?? 0) === 1) {
      qspCall(s, 'arousal', 'vaginal', 10, 'prostitution');
    } else {
      qspCall(s, 'arousal', 'vaginal', 10);
...
function enterDrugs(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    scene.text(`${((s as any).npcdesc || '')} stops for a moment, and you notice that he's clearly affected by the drugs. His eyes flare up as he leaps from the chair, shouting that you're just some whore that was after his drugs.`);
    // TODO-QSP: dynamic text: He grabs you and shoves you to the door, throwing you outside. You stand in shoc...
    scene.text(`He grabs you and shoves you to the door, throwing you outside. You stand in shock as the drugs take hold of you, and you feel yourself becoming incredibly aroused. You knock on the door, but ${((s as any).npcdesc || '')} refuses to open it. Finally, you decide to leave... maybe you'll get lucky somewhere else.`);
    scene.actions([
      { label: 'Leave the hotel', goto: ['pav_market', ''] },
    ]);
  } },
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} gets up from the chair and stands behind you. He starts roughly pawing at your breasts through the fabric - even his hamfisted groping is turning you on.`);
    ...
    scene.text(`Just as you're about to drift away and savour the fantastic orgasm you just had, ${((s as any).npcdesc || '')} grabs and tugs you over to the couch. Your legs are weak, and you barely manage to walk.`);
    // TODO-QSP: dynamic text: <<$npcdesc>> lays you down and smiles. "It's your lucky day. That was so hot tha...
    scene.text(`${((s as any).npcdesc || '')} lays you down and smiles. "It's your lucky day. That was so hot that there's no way I can fuck you right now. I'm way too horny, and if I do, I'll cum as soon as I stick my dick in you. So you just spread your beautiful legs again and let me have another taste."`);
    // TODO-QSP: dynamic text: <<$npcdesc>> lowers his head and begins sucking on your super-sensitive clit. Wh...
    scene.text(`${((s as any).npcdesc || '')} lowers his head and begins sucking on your super-sensitive clit. While doing that, he moves his hand between your ass cheeks and starts playing with your asshole, rubbing and massaging it lightly. You try to push his hand away, but he just tells you to relax.`);
    ...
    scene.text(`"Now, don't be like that, ${((s as any).pcs_firstname || '')}. It's time for you to return the favor," he says as he places himself in front of you with his cock hanging out freely.`);
    ...
    scene.text(`You immediately start sucking his dick, bobbing your head up and down his shaft roughly as your arousal takes over your actions. ${((s as any).npcdesc || '')}'s breathing starts getting faster and heavier. Finally, he tries to stop you, telling you to slow down and lick his shaft instead.`);
    ...
    scene.text(`You barely know what's happening as ${((s as any).npcdesc || '')} pulls out of you, pulls you up onto your knees and starts jerking off in front of you, your head still fuzzy from your orgasm. It doesn't take long before he shoots his load over your face and breasts.`);

...
function enterMarcus(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`As you suck him off, he places his hand on the back of your head and encourages you to take him as deep as you can into your mouth. He doesn't force you or gag you, but you can feel the pressure of his hand encouraging you to deep throat him. A few minutes later he speaks up between moans. "I really want to fuck you, ${((s as any).pcs_nickname ?? 0)}."`);
    qspCall(s, 'arousal', 'bj', 3);
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'bj', 3);
    qspCall(s, 'cum_call', 'mouth_swallow', 'A146', 1);
    qspCall(s, 'cum_call', 'face', 'A146', 1);
    ...
    scene.text('You crack open the stall door and peek around the corner. With nobody around, you make a dash for the sinks and look in the <a href="exec:gt \'mirror\', \'start\'">mirror</a> at your cum plastered face.');
    scene.actions([
...
function enterAndreyStasyaMarcus(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'npc_relationship', 'modify', 'A146', 'dislike');
    scene.img('images/locations/pavlovsk/resident/andreyhome/home.jpg');
    ...
    qspCall(s, 'npcStat', 'A147', 'b');
    qspCall(s, 'npcStat', 'A139', 'c');
    ...
    scene.text(`After a while, the boys pull you over to the couch and lay you down next to each other. Marcus moves between your legs and quickly slides his ${((s as any).dick1 ?? 0)}cm ${((s as any).dick_girth1 ?? 0)} dick inside you, stretching your pussy. You hear Stasya moaning and glance over to see Andrey starting to fuck her as well.`);
    ...
    scene.text(`Several minutes go by before Andrey again tells Marcus to switch. The boys pull out and sit on the couch before Andrey pulls you over to him while Marcus does the same with Stasya. You lower yourself down until you feel Andrey's ${((s as any).dick2 ?? 0)}cm ${((s as any).dick_girth2 ?? 0)} dick slide inside you. He grabs your hips and pulls you all the way down until he is balls deep inside you. You glance over at Stasya moaning as Marcus penetrates her pussy as well.`);
    ...
    scene.text(`A few minutes later, Stasya climbs off Marcus and Andrey lifts you off of him. He lays Stasya down on her back with her legs spread and pushes you onto all fours with your face between her legs. Andrey pushes your face down to her pussy and you start to lick it as you feel Marcus climb over you before feeling his ${((s as any).dick_girth1 ?? 0)} cock force it's way into your ass. You keep licking Stasya's pussy as Marcus starts fucking your ass.`);
    qspCall(s, 'arousal', 'anal', 3, ((s as any).npcID1 ?? 0), 'group', 'lube');
    ...
    qspCall(s, 'arousal', 'vaginal', 3, ((s as any).npcID1 ?? 0), 'group');
    qspCall(s, 'arousal', 'anal', (-3), ((s as any).npcID2 ?? 0), 'group', 'lube');
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterIgorPeg(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).strapNumber ?? 0) >= 5) {
    ...
    scene.text(`He blushes brightly, but gets down on his knees and puts his hands together. "Please fuck me with your strap-on, ${((s as any).pcs_nickname ?? 0)}."`);
    scene.actions([
...
function enterStraponIgorBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'foreplay', 3, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'foreplay', 1, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    ...
    scene.text(`You guide your cock to his asshole and slide your slick ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} fake dick deep into his ass, making him moan loudly. "I love feeling your cock inside of me." He moans out.`);
    qspCall(s, 'arousal', 'anal_strap_give', 2, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'anal_strap_give', 3, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    ...
    // TODO-QSP: dynamic text: "I'm sorry <<$pcs_nickname>>! Please punish me!" He moans and groans as you poun...
    scene.text(`"I'm sorry ${((s as any).pcs_nickname ?? 0)}! Please punish me!" He moans and groans as you pound his asshole, and after several minutes you're starting to feel a little tired from the exertion. You pull your cock out of his ass and stand up. He sighs loudly as you do.`);
    qspCall(s, 'arousal', 'anal_strap_give', 3, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`You guide your cock to his asshole and force the ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} fake dick deep into his ass, making him groan loudly. It takes a bit of effort to shove your fake cock all the way up his ass, with only his saliva for lube. "Tell me you love my cock in your ass!"`);
...
function enterStraponIgorMagic(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.img('images/characters/pavlovsk/school/boy/igor/sex/disco/disco_peg4.jpg');
    scene.text('You reach back, place a hand on the back of his head and start forcing him to take your dick deeper and deeper until you start gagging him as he deep throats you. He surprisingly doesn\'t gag much at all, and you\'re sure he\'s been practicing. "That\'s it, get my cock nice and wet!"');
    qspCall(s, 'arousal', 'magicd_bj', 3, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Turn him around', handler: (st: GameState) => {
    scene.img('images/characters/pavlovsk/school/boy/igor/sex/disco/disco_peg5.jpg');
    ...
    scene.img('images/characters/pavlovsk/school/boy/igor/sex/disco/disco_peg7.jpg');
    // TODO-QSP: dynamic text: You guide your cock to his asshole and slide your slick <<dick>>cm <<$dick_girth...
    scene.text(`You guide your cock to his asshole and slide your slick ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} fake dick deep into his ass, making him moan loudly, as your dick easily slides into his well-lubed asshole. "I love feeling your cock inside of me." He moans out. As his asshole grips your cock you can't help but moan in pleasure as well.`);
    ...
    qspCall(s, 'arousal', 'magicd_anal', 3, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    ...
    // TODO-QSP: dynamic text: "I'm sorry <<$pcs_nickname>>! Please punish me!" He moans and groans as you poun...
    scene.text(`"I'm sorry ${((s as any).pcs_nickname ?? 0)}! Please punish me!" He moans and groans as you pound his asshole, and after several minutes you feel your balls tighten and you can tell you are about to cum.`);
    qspCall(s, 'arousal', 'magicd_anal', 2, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`You push him forward before he reaches back, grabs his ass cheeks and spreads them for you. You guide your cock to his asshole and force the ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} fake dick into his ass. It takes a bit of effort to shove your fake cock all the way up his ass, with only his saliva for lube, he groans a little in pain and winces a bit as you do. "Tell me you love my cock in your ass!"`);
    scene.text('He groans loudly. "I love feeling your cock fucking my ass!"');
    qspCall(s, 'arousal', 'magicd_anal', 2, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterIgorDiscoBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: Feeling somewhat disappointed by his size, you gently wrap your <<$pc_desc['lips...
    scene.text(`Feeling somewhat disappointed by his size, you gently wrap your ${((s as any).pc_desc ?? 0)?.['lips']} lips around the small cock. Sucking on it like you would a normal penis doesn't work because you simply can't bob up and down its length when there's no length to begin with. Even sucking on it is hard because of its size, or lack thereof.`);
...
function enterIgorDimaDiscoBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'end');
    qspCall(s, 'cum_call', 'mouth_swallow', 'A4', 1);
    qspCall(s, 'cum_call', 'mouth_swallow', 'A1', 1);
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterGirlfriendAsk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: "You're such a pretty girl, <<$pcs_nickname>>. Every time I see you, my mood get...
    scene.text(`"You're such a pretty girl, ${((s as any).pcs_nickname ?? 0)}. Every time I see you, my mood gets better, even when I'm feeling down. I like you very much, ${((s as any).pcs_nickname ?? 0)}, and I'd really like to start a relationship with you."`);
    scene.actions([
    ...
    scene.text(`"${((s as any).pcs_nickname ?? 0)}, I beg you, on my knees, just one kiss! I'll do anything for you - I'll be your willing slave."`);
    ...
    qspCall(s, 'arousal', 'kiss', 5, 'dom', 'feet');
    qspCall(s, 'arousal', 'end');
    scene.actions([
...
function enterSonia(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Sonia nods and giggles before she kisses you and you both get dressed. Once you're done, she pulls you into another long kiss. "See you later, ${((s as any).pcs_nickname ?? 0)}."`);
    ...
    qspCall(s, 'arousal', 'trib', 3, 'lesbian');
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Leave', goto: ['pav_residential', ''] },
    ]);
...
function enterDan(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'bj', 3, 'sub', 'inhibition', 'deepthroat');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Suck him off', handler: (st: GameState) => {
    ...
    scene.text(`He nods happily. "Not bad, ${((s as any).pcs_nickname ?? 0)}. Your technique is still a bit lacking, but we'll work on that next time."`);
    ...
    qspCall(s, 'arousal', 'bj', 3, 'sub', 'inhibition');
    qspCall(s, 'cum_call', 'mouth_swallow', 'A10', 1);
    qspCall(s, 'cum_call', 'face', 'A10', 1);
    qspCall(s, 'arousal', 'end');
    scene.actions([
...
function enterDanFuck(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`He slides his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick into your pussy and begins to fuck you. He grabs hold of your hips with his hands to hold you in place as he slowly starts picking up speed and fucking you harder.`);
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'vaginal', 3, 'sub', 'inhibition', 'rough');
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterDanButtfuck(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).mc_inventory ?? 0)?.['lubricant'] > 0) {
    ...
    scene.text(`With the help of the lube, he easily slides his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick into your asshole and starts fucking you. He grabs hold of your hips and holds you in place as he slowly starts picking up speed, fucking you harder as he does.`);
  } else {
    // TODO-QSP: dynamic text: With only some spit and his precum as lube, it takes a bit of effort for him to ...
    scene.text(`With only some spit and his precum as lube, it takes a bit of effort for him to force his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick into your asshole, causing you to groan in pain as he forces himself up your ass.`);
    // TODO-QSP: dynamic text: He pushes deep before he grabs hold of your hips to hold you in place as he slow...
    scene.text(`He pushes deep before he grabs hold of your hips to hold you in place as he slowly starts fucking you. "Fuck ${((s as any).pcs_nickname ?? 0)}, your ass is so tight!"`);
  }
  qspCall(s, 'arousal', 'auto_lube', 'anal');
  ...
  scene.actions([
    ...
    scene.text(`He nods happily. "Not bad, ${((s as any).pcs_nickname ?? 0)}. Your technique is still a bit lacking, but we'll work on that next time."`);
    scene.text('With that, he turns around and walks down the stairs without looking back at you, leaving you with a mouthful of cum dribbling down your chin.');
    qspCall(s, 'arousal', 'anal', 3, 'sub', 'inhibition');
    qspCall(s, 'cum_call', 'mouth_swallow', 'A10', 1);
    qspCall(s, 'cum_call', 'face', 'A10', 1);
    qspCall(s, 'arousal', 'end');
    scene.actions([
...
function enterRadomir(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'hj', (-3), 'inhibition');
    qspCall(s, 'arousal', 'vaginal_finger', 3, 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'bj', 3, 'inhibition', 'deepthroat');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    ...
    qspCall(s, 'arousal', 'bj', 3, 'inhibition');
    qspCall(s, 'cum_call', 'mouth_swallow', 'A154', 1);
...
function enterValentin(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Fuck, I needed that!" Valentin grunts as he tucks his dick away and walks out of the stall. "That was great, ${((s as any).pcs_nickname ?? 0)}. We should do it again sometime."`);
    ...
    qspCall(s, 'arousal', 'bj', 3, 'inhibition');
    qspCall(s, 'cum_call', 'breasts', 'A158', 1);
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Leave the stall', handler: (st: GameState) => {
    ...
    scene.text('You crack open the stall door and peek around the corner. With nobody around, you make a dash for the sinks and look in the <a href="exec:gt \'mirror\', \'start\'">mirror</a> at your cum covered breasts.');
    scene.actions([
      { label: 'Leave', goto: ['gdktoilet', 'start'] },
    ]);
  } },
    ...
    scene.text(`"Fuck, I needed that!" he grunts as he tucks his dick away and walks out of the stall. "That was great, ${((s as any).pcs_nickname ?? 0)}. We should do it again sometime."`);
...
function enterValentinVag(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`He strips you from the waist down and turns you around before you feel his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick slide into your wet pussy, causing you to moan in pleasure as he starts slowly fucking you, picking up speed and going deeper the louder you moan.`);
  if (((s as any).watched ?? 0) === 1) {
...
function enterValentinAnal(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).watched ?? 0) === 1) {
    ...
    scene.text(`"Fuck ${((s as any).pcs_nickname ?? 0)}, your ass is so tight!"`);
  ...
  scene.actions([
    ...
    if (((s as any).watched ?? 0) === 1) {
      ...
      scene.text(`"Fuck, I needed that!" Once he finishes, he tucks his dick away and walks out of the stall. "That was great ${((s as any).pcs_nickname ?? 0)}. We should do it again sometime."`);
      scene.text('You nod in response and he grins before walking out of the restroom.');
    }
    qspCall(s, 'cum_call', 'breasts', 'A158', 1);
    qspCall(s, 'arousal', 'end');
...
function enterLera(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).pcs_hotcat ?? 0) >= 5  &&  ((s as any).npc_rel ?? 0)?.['A21'] >= 50) {
      ...
      qspCall(s, 'npc_relationship', 'modify', 'A21', 'dislike');
...
function enterLeraSex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'cuni', 3, 'inhibition', 'lesbian');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Turn around', handler: (st: GameState) => {
    ...
    qspCall(s, 'arousal', 'cuni_give', 3, 'inhibition', 'lesbian');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'vaginal_dildo', 3, 'inhibition', 'lesbian');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`Laying side by side on the restroom floor, basking in the afterglow, the two of you kiss on and off for several minutes before she gets up and starts getting dressed. "Thanks ${((s as any).pcs_nickname ?? 0)}, I needed that."`);
    ...
    scene.text('<center><b>Community Center - Women\'s Restroom</b></center>');
    scene.img('images/locations/pavlovsk/community/bathroom/womens/bathroom_women.jpg');
    scene.text('Now alone in the restroom, you check your makeup in the <a href="exec:gt \'mirror\', \'start\'">mirror</a> before leaving yourself.');
    scene.actions([
      { label: 'Leave', goto: ['gdktoilet', 'start'] },
    ]);
  } },
...
function enterAlyona(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).npc_rel ?? 0)?.['A143'] >= 50  &&  ((s as any).pcs_hotcat ?? 0) >= 5) {
      ...
      qspCall(s, 'npc_relationship', 'modify', 'A143', 'dislike');
      ...
      qspCall(s, 'arousal', 'kiss', 1, 'inhibition', 'lesbian');
      qspCall(s, 'arousal', 'end');
      scene.actions([
        { label: 'Leave', goto: ['gdktoilet', 'start'] },
      ]);
...
function enterAlyonaMakeout(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text('Once her orgasm has passed, she stands up and pulls her panties up and her dress back down. You quickly get dressed as well and you give each other a quick hug before she stumbles out of the restroom, leaving you alone standing in front of the <a href="exec:gt \'mirror\', \'start\'">mirror</a>.');
    scene.actions([
      { label: 'Leave', goto: ['gdktoilet', 'start'] },
    ]);
  } },
...
function enterMarcusKatjaDisco(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He rubs the tip of his dick against your wet slit, making you moan softly before he gently slides his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock into your pussy, filling and stretching it out.`);
    ...
    qspCall(s, 'arousal', 'voyeur_sex', 1, 'group');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'clit_finger', 3, 'group', 'masturbate');
    ...
    qspCall(s, 'arousal', 'bj', 1, ((s as any).npcID ?? 0), 'group');
    qspCall(s, 'arousal', 'clit_finger', (-1), 'group', 'masturbate');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Turn around', handler: (st: GameState) => {
    ...
    qspCall(s, 'arousal', 'kiss', 1, ((s as any).npcID1 ?? 0), 'group');
    qspCall(s, 'arousal', 'end');

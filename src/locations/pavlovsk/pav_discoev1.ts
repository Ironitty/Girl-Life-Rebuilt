...
function enterKatjaMarcusStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['marcus_disco'] === 0) {
    ...
    scene.text('You agree to her plan and Katja ' + ((((s as any).discoenable ?? 0)?.['A15'] === 1) ? (' tells Vicky that she\'s going to the toilet before heading home because she\'s tired. Vicky seems convinced.') : (' heads out without anyone stopping her on the way.')));
  } else {
    ...
    scene.text('Katja turns and leaves' + ((((s as any).discoenable ?? 0)?.['A15'] === 1) ? (', telling Vicky that she\'s going to the toilet before heading home because she\'s tired. Vicky seems convinced.') : (' with nobody stopping her on her way out.')));
  }
  scene.actions([

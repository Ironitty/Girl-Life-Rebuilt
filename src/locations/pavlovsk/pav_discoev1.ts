...
function enterMarcus(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`As you suck him off, he places his hand on the back of your head and encourages you to take him as deep as you can into your mouth. He doesn't force you or gag you, but you can feel the pressure of his hand encouraging you to deep throat him. A few minutes later he speaks up between moans. "I really want to fuck you, ${((s as any).pcs_nickname || '')}."`);
    qspCall(s, 'arousal', 'bj', 3);
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text('You crack open the stall door and peek around the corner. With nobody around, you make a dash for the sinks and look in the <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027mirror\\u0027, \\u0027start\\u0027); return false;">mirror</a> at your cum plastered face.');
    scene.actions([
...
function enterAndreyStasyaMarcus(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`After a while, the boys pull you over to the couch and lay you down next to each other. Marcus moves between your legs and quickly slides his ${((s as any).dick1 || '')}cm ${((s as any).dick_girth1 || '')} dick inside you, stretching your pussy. You hear Stasya moaning and glance over to see Andrey starting to fuck her as well.`);
    ...
    scene.text(`Several minutes go by before Andrey again tells Marcus to switch. The boys pull out and sit on the couch before Andrey pulls you over to him while Marcus does the same with Stasya. You lower yourself down until you feel Andrey's ${((s as any).dick2 || '')}cm ${((s as any).dick_girth2 || '')} dick slide inside you. He grabs your hips and pulls you all the way down until he is balls deep inside you. You glance over at Stasya moaning as Marcus penetrates her pussy as well.`);
...
function enterStraponIgorBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You guide your cock to his asshole and slide your slick ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} fake dick deep into his ass, making him moan loudly. "I love feeling your cock inside of me." He moans out.`);
    ...
    scene.text(`"I'm sorry ${((s as any).pcs_nickname || '')}! Please punish me!" He moans and groans as you pound his asshole, and after several minutes you're starting to feel a little tired from the exertion. You pull your cock out of his ass and stand up. He sighs loudly as you do.`);
    qspCall(s, 'arousal', 'anal_strap_give', 3, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`You guide your cock to his asshole and force the ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} fake dick deep into his ass, making him groan loudly. It takes a bit of effort to shove your fake cock all the way up his ass, with only his saliva for lube. "Tell me you love my cock in your ass!"`);
...
function enterStraponIgorMagic(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.img('images/characters/pavlovsk/school/boy/igor/sex/disco/disco_peg7.jpg');
    // TODO-QSP: dynamic text: You guide your cock to his asshole and slide your slick <<dick>>cm <<$dick_girth...
    scene.text(`You guide your cock to his asshole and slide your slick ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} fake dick deep into his ass, making him moan loudly, as your dick easily slides into his well-lubed asshole. "I love feeling your cock inside of me." He moans out. As his asshole grips your cock you can't help but moan in pleasure as well.`);
    ...
    // TODO-QSP: dynamic text: "I'm sorry <<$pcs_nickname>>! Please punish me!" He moans and groans as you poun...
    scene.text(`"I'm sorry ${((s as any).pcs_nickname || '')}! Please punish me!" He moans and groans as you pound his asshole, and after several minutes you feel your balls tighten and you can tell you are about to cum.`);
    qspCall(s, 'arousal', 'magicd_anal', 2, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`You push him forward before he reaches back, grabs his ass cheeks and spreads them for you. You guide your cock to his asshole and force the ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} fake dick into his ass. It takes a bit of effort to shove your fake cock all the way up his ass, with only his saliva for lube, he groans a little in pain and winces a bit as you do. "Tell me you love my cock in your ass!"`);
    scene.text('He groans loudly. "I love feeling your cock fucking my ass!"');
    qspCall(s, 'arousal', 'magicd_anal', 2, 'dom', 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterGirlfriendAsk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"You're such a pretty girl, ${((s as any).pcs_nickname || '')}. Every time I see you, my mood gets better, even when I'm feeling down. I like you very much, ${((s as any).pcs_nickname || '')}, and I'd really like to start a relationship with you."`);
    scene.actions([
    ...
    scene.text(`You agree to date Igor and a smile blossoms on his face as he hugs you tightly. "I'm so happy, ${((s as any).pcs_nickname || '')}! Now that we're a couple… Can we kiss?"`);
    ...
    ((s as any).IgorQW = (s as any).IgorQW ?? {})['Domina'] = 1;
    qspCall(s, 'stat', '');
    scene.img('images/characters/shared/headshots_main/big4.jpg');
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}, I beg you, on my knees, just one kiss! I'll do anything for you - I'll be your willing slave."`);
    ...
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
      ...
      scene.actions([
        { label: 'Make him submit', handler: (st: GameState) => {
    qspCall(s, 'willpower', 'pay', 'force');
    ((s as any).IgorQW = (s as any).IgorQW ?? {})['Love'] = ((s as any).IgorQW['Love'] ?? 0) + (20);
    ...
    ((s as any).IgorQW = (s as any).IgorQW ?? {})['Love'] = ((s as any).IgorQW['Love'] ?? 0) + (10);
    ...
    ((s as any).IgorQW = (s as any).IgorQW ?? {})['Love'] = ((s as any).IgorQW['Love'] ?? 0) + (5);
    qspCall(s, 'stat', '');
    scene.img('images/shared/sex/kiss/kiss.jpg');
...
function enterSonia(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Sonia nods and giggles before she kisses you and you both get dressed. Once you're done, she pulls you into another long kiss. "See you later, ${((s as any).pcs_nickname || '')}."`);
...
function enterDan(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((Math.floor(Math.random() * 4) + 1) === 1  &&  ((s as any).stat ?? 0)?.['vaginal'] > 0) {
      ...
      if ((Math.floor(Math.random() * 4) + 1) === 2) {
        if (((s as any).mc_inventory ?? 0)?.['lubricant'] > 0) {
          ...
          scene.text(`"Fuck, you're such a slut, ${((s as any).pcs_nickname || '')}! Carrying around a bottle of lube so guys can fuck you in the ass!" he says with a laugh.`);
          scene.actions([
    ...
    scene.text(`He nods happily. "Not bad, ${((s as any).pcs_nickname || '')}. Your technique is still a bit lacking, but we'll work on that next time."`);
...
function enterValentin(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Fuck, I needed that!" Valentin grunts as he tucks his dick away and walks out of the stall. "That was great, ${((s as any).pcs_nickname || '')}. We should do it again sometime."`);
    ...
    scene.text('You crack open the stall door and peek around the corner. With nobody around, you make a dash for the sinks and look in the <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027mirror\\u0027, \\u0027start\\u0027); return false;">mirror</a> at your cum covered breasts.');
    scene.actions([
      { label: 'Leave', goto: ['gdktoilet', 'start'] },
    ]);
  } },
    ...
    scene.text(`"Fuck, I needed that!" he grunts as he tucks his dick away and walks out of the stall. "That was great, ${((s as any).pcs_nickname || '')}. We should do it again sometime."`);
...
function enterValentinAnal(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).watched ?? 0) === 1) {
      ...
      scene.text(`"Fuck, I needed that!" Once he finishes, he tucks his dick away and walks out of the stall. "That was great ${((s as any).pcs_nickname || '')}. We should do it again sometime."`);
      scene.text('You nod in response and he grins before walking out of the restroom.');
    }
    qspCall(s, 'cum_call', 'breasts', 'A158', 1);
    qspCall(s, 'arousal', 'end');
...
function enterLeraSex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Laying side by side on the restroom floor, basking in the afterglow, the two of you kiss on and off for several minutes before she gets up and starts getting dressed. "Thanks ${((s as any).pcs_nickname || '')}, I needed that."`);
    ...
    scene.text('<center><b>Community Center - Women\'s Restroom</b></center>');
    scene.img('images/locations/pavlovsk/community/bathroom/womens/bathroom_women.jpg');
    scene.text('Now alone in the restroom, you check your makeup in the <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027mirror\\u0027, \\u0027start\\u0027); return false;">mirror</a> before leaving yourself.');
    scene.actions([
      { label: 'Leave', goto: ['gdktoilet', 'start'] },
    ]);
  } },
...
function enterDimkaSex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Once he's hard, you open your mouth and take his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick into your mouth. You wrap your lips around his shaft and start bobbing your head back and forth on his dick as you look up at him.`);
...
function enterKatjaMarcusStart(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).katjaQW ?? 0)?.['marcus_disco'] === 0) {
      ((s as any).katjaQW = (s as any).katjaQW ?? {})['marcus_disco'] = 1;
...
function enterMarcusKatjaDisco(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He rubs the tip of his dick against your wet slit, making you moan softly before he gently slides his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock into your pussy, filling and stretching it out.`);

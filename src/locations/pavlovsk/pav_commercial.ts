...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: <br>Centered along the main street is the <a href="exec:minut += 10 & gt 'pav_ma...
  ...
  if (((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) <= 18) {
    ...
    if (((s as any).week ?? 0) === 6  &&  ((s as any).hour ?? 0) >= 10  &&  ((s as any).hour ?? 0) <= 18) {
      ...
      (s as any).desc_txt4 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The post office, which is closed right now, will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 9, 0)+\\u0027 and at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 10, 0)+\\u0027 on Saturdays.\\u0027 */ return s; }); return false;">post office</a>';
    }
  }
  if ((((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) <= 16)  ||  (((s as any).week ?? 0) === 6  &&  ((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) <= 13)) {
    ...
    (s as any).desc_txt5 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027VTB Bank is closed right now. It opens Monday to Saturday at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 9, 0)+\\u0027\\u0027 */ return s; }); return false;">VTB Bank</a>';
  }
  // TODO-QSP: dynamic text: <br>Across from the station is a small <a href="exec:minut += 1 & gt 'pav_clinic...
  scene.text(`<br>Across from the station is a small <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=s.1; return s; }); window.__gameStore.getState().doGoto(\\u0027pav_clinic\\u0027, \\u0027\\u0027); return false;">Avicenna clinic</a>. ${((s as any).Pharmname || '')} The building next door is shared by the local ${((s as any).desc_txt4 || '')} and a ${((s as any).desc_txt5 || '')}.`);
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) <= 20) {
    ...
    (s as any).desc_txt3 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027Pyaterochka, which is closed right now. It will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027\\u0027 */ return s; }); return false;">Pyaterochka</a>, a popular discount supermarket chain';
  }
  ...
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) <= 17) {
    ...
    (s as any).desc_txt1 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027A Cut Above, which is closed right now. It will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027\\u0027 */ return s; }); return false;">A Cut Above</a>, the only barber shop in the area, <a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027Coco Carmen, which is closed right now. It will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027\\u0027 */ return s; }); return false;">Coco Carmen</a> the trendy clothes shop and <a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027Allure, which is closed right now. It will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027\\u0027 */ return s; }); return false;">Allure</a>, the swimwear chain';
  }
  ...
  if (((s as any).leonidSlave ?? 0) === 1) {
    // TODO-QSP: dynamic text: <br>Near the town hall is an old <a href="exec:minut += 15 & gt 'pav_commercial_...
  ...
  if (((s as any).hour ?? 0) >= 7  &&  ((s as any).hour ?? 0) <= 18) {
    ...
    (s as any).desc_txt2 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027vocational school, which is closed right now. It will reopen again at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 7, 0)+\\u0027\\u0027 */ return s; }); return false;">vocational school</a>.';
  }

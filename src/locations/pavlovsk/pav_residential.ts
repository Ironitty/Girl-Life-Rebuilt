...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).cfg_vars ?? 0)?.['tablemap'] === 0) {
    if (((s as any).DimaBeHomeOnce ?? 0) === 1  &&  (!((s as any).DimaRudeBlock ?? 0))) {
      ...
      scene.text('<a href="exec:minut += 10 & gt \'dimaHome\', \'home\'">Dimka</a> lives in one of the fancier houses in town.');
    }
    if (((s as any).fedorKozlovQW ?? 0) >= 20  &&  ((s as any).FedorKozHome ?? 0) === 1  ||  ((s as any).fedorKozlovQW ?? 0) === -15  &&  ((s as any).FedorKozHome ?? 0) === 1) {
      ...
      scene.text('<br><a href="exec: minut += 1 & gt \'FedorEv4\', \'Home Entrance\'">Fedor</a> lives in a house nearby.');
    }
    if ((((s as any).IgorQW ?? 0)?.['history'] === 1  ||  ((s as any).IgorQW ?? 0)?.['Lover'] > 0  ||  ((s as any).IgorQW ?? 0)?.['house_open'] === 1)  &&  ((s as any).IgorQW ?? 0)?.['block'] === 0) {
      ...
      scene.text('<a href="exec:minut += 10 & gt \'IgorHome\', \'home\'">Igor</a> lives in one of the fancier houses in town.');
    }
    if (((s as any).katjaQW ?? 0)?.['QWstage'] >= 2  ||  ((s as any).mey_vika ?? 0)?.['mey_vika_qw'] >= 27  ||  ((s as any).mey_vika ?? 0)?.['key'] === 1) {
      ...
      scene.text('Nearby is a large house where the <a href="exec:minut += 10 & gt\'mey_home\', \'door\'">Meynold twins</a> live.');
    }
    if (((s as any).LariskaQW ?? 0)?.['story'] >= 6) {
      // TODO-QSP: dynamic text: <a href="exec:minut += 10 & gt 'LariskaHome', 'front_door'">Lariska</a> lives ab...
      scene.text('<a href="exec:minut += 10 & gt \'LariskaHome\', \'front_door\'">Lariska</a> lives about 10 minutes away from here.');
    }
    ...
    if (((s as any).AlbinaQW ?? 0)?.['KnowsHouse'] === 1) {
      ...
      scene.text('<a href="exec:minut += 10 & gt \'albinahome\',\'door_bell\'">Albina</a> lives in one of the few luxurious mansions Pavlovsk has to offer.');
    }
    if (((s as any).soniaQW ?? 0)?.['homeinvite'] === 1) {
      ...
      scene.text('<a href="exec:minut += 10 & gt \'soniahome\',\'home\'">Sonia\'s</a> house is up through a garden pathway to a well cared for grey, wooden-clad house.');
    }
  } else {
    (s as any).st_count = 0;
    if (((s as any).DimaBeHomeOnce ?? 0) === 1  &&  (!((s as any).DimaRudeBlock ?? 0))) {

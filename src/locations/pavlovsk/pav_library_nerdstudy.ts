...
function enterNerdStudyNight2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).nerdstudynight ?? 0)?.['Feofan'] === 0) {
    ...
    ((st as any).nerdstudynight = (st as any).nerdstudynight ?? {})['Feofan'] = 1;
    qspCall(st, 'npc_relationship', 'modify', 'A152', 'like');
    qspCall(st, 'stat', '');
    scene.img('images/characters/shared/headshots_main/big152.jpg');
    if (((st as any).npc_rel ?? 0)?.['A152'] >= 60  &&  ((st as any).grupTipe ?? 0) === 3) {
      ...
      if (((st as any).npc_rel ?? 0)?.['A152'] <= 20  ||  ((st as any).fame ?? 0)?.['pav_slut'] >= 250) {
  ...
  if (((s as any).nerdstudynight ?? 0)?.['Artem'] === 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).nerdstudynight = (st as any).nerdstudynight ?? {})['Artem'] = 1;
  ...
  if (((s as any).nerdstudynight ?? 0)?.['Zinaida'] === 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).nerdstudynight = (st as any).nerdstudynight ?? {})['Zinaida'] = 1;
    qspCall(st, 'npc_relationship', 'modify', 'A142', 'like');
    qspCall(st, 'stat', '');
    scene.img('images/characters/shared/headshots_main/big142.jpg');
    if (((st as any).npc_rel ?? 0)?.['A142'] >= 60  &&  ((st as any).grupTipe ?? 0) === 3) {
      ...
      if (((st as any).npc_rel ?? 0)?.['A142'] <= 20  ||  ((st as any).fame ?? 0)?.['pav_slut'] >= 250) {
  ...
  if (((s as any).nerdstudynight ?? 0)?.['Gerasim'] === 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).nerdstudynight = (st as any).nerdstudynight ?? {})['Gerasim'] = 1;
  ...
  if (((s as any).nerdstudynight ?? 0)?.['Julia'] === 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).nerdstudynight = (st as any).nerdstudynight ?? {})['Julia'] = 1;
    qspCall(st, 'npc_relationship', 'modify', 'A12', 'like');
    qspCall(st, 'stat', '');
    scene.img('images/characters/shared/headshots_main/big12.jpg');
    if (((st as any).npc_rel ?? 0)?.['A12'] >= 60  &&  ((st as any).grupTipe ?? 0) === 3) {
      ...
      if (((st as any).npc_rel ?? 0)?.['A12'] <= 20  ||  ((st as any).fame ?? 0)?.['pav_slut'] >= 250) {
  ...
  if (((s as any).nerdstudynight ?? 0)?.['Petka'] === 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).nerdstudynight = (st as any).nerdstudynight ?? {})['Petka'] = 1;
  ...
  if (((s as any).nerdstudynight ?? 0)?.['Natasha'] === 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).nerdstudynight = (st as any).nerdstudynight ?? {})['Natasha'] = 1;
  ...
  if (((s as any).nerdstudynight ?? 0)?.['Evgeny'] === 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).nerdstudynight = (st as any).nerdstudynight ?? {})['Evgeny'] = 1;
    qspCall(st, 'npc_relationship', 'modify', 'A151', 'like');
    qspCall(st, 'stat', '');
    scene.img('images/characters/shared/headshots_main/big151.jpg');
    if (((st as any).npc_rel ?? 0)?.['A151'] >= 60  &&  ((st as any).grupTipe ?? 0) === 3) {
      ...
      if (((st as any).npc_rel ?? 0)?.['A151'] <= 20  ||  ((st as any).fame ?? 0)?.['pav_slut'] >= 250) {
  ...
  if (((s as any).nerdstudynight ?? 0)?.['Natalia'] === 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).nerdstudynight = (st as any).nerdstudynight ?? {})['Natalia'] = 1;
    qspCall(st, 'npc_relationship', 'modify', 'A240', 'like');
    qspCall(st, 'stat', '');

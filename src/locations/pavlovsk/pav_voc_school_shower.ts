...
function enterShowerEvent(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'clit_finger', 2, 'self');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'First shower guy', Math.floor(Math.random() * 4) + 17, 1, 1);
    qspCall(s, 'npcStat', '', ((s as any).npclastgenerated ?? 0));
    qspCall(s, 'npcgeneratec', '', 0, 'Second shower guy', Math.floor(Math.random() * 4) + 17, 1, 1);
    ...
    qspCall(s, 'arousal', 'hj', 3, ((s as any).npcID ?? 0), 'group', 'unknown');
    qspCall(s, 'arousal', 'hj', (-3), ((s as any).npcID1 ?? 0), 'group', 'unknown');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'bj', 5, ((s as any).npcID ?? 0), 'group', 'deepthroat', 'unknown', 'gangbang');
    qspCall(s, 'arousal', 'hj', (-5), ((s as any).npcID1 ?? 0), 'group', 'unknown', 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'pain', '', 3, 'asshole', 'pierce');
    qspCall(s, 'arousal', 'anal', 5, ((s as any).npcID1 ?? 0), 'rough', 'unknown');

...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hour ?? 0) > 8  &&  ((s as any).hour ?? 0) < 19) {
    scene.text('There\'s a small <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027pav_cinema\u0027, \u0027\u0027); return false;">movie theatre</a> in the park.');
  }
  scene.text('The newly opened cafe <a href="exec:gt\'cafe_parco\',\'start\'">"Del Parco"</a>, with an eye-catching facade, lots of tables and a summer terrace. Two paths lead out of the park. One brings you to the <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027pav_commercial\u0027, \u0027\u0027); return false;">commercial</a> area, the other to the <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027pav_residential\u0027, \u0027\u0027); return false;">residential</a> area.');
  if (((((s as any).month ?? 0) === 8  &&  ((s as any).day ?? 0) > 20)  ||  (((s as any).month ?? 0) === 9  &&  ((s as any).day ?? 0) < 16))  &&  ((s as any).week ?? 0) > 5  &&  ((s as any).hour ?? 0) > 8  &&  ((s as any).hour ?? 0) < 20  &&  ((s as any).AlbinaQW ?? 0)?.['ParkRally'] === 0) {
    scene.text('<br>You overhear someone speaking in front of a crowd. The crowd is quite rowdy, yelling and clapping throughout the <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=2; return s; }); window.__gameStore.getState().doGoto(\u0027pav_park\u0027, \u0027alb_father_meeting_1\u0027); return false;">meeting</a>.');
  } else {
    if (((((s as any).month ?? 0) === 9  &&  ((s as any).day ?? 0) > 20)  ||  (((s as any).month ?? 0) === 10  &&  ((s as any).day ?? 0) < 16))  &&  ((s as any).week ?? 0) > 5  &&  ((s as any).hour ?? 0) > 8  &&  ((s as any).hour ?? 0) < 20  &&  ((s as any).AlbinaQW ?? 0)?.['ParkRally'] === 1  &&  ((s as any).AlbinaQW ?? 0)?.['StarletsShutDown'] === 0) {
      scene.text('Once again, a large crowd has gathered in the town center. You can hear Albina\'s father holding a public <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=2; return s; }); window.__gameStore.getState().doGoto(\u0027pav_park\u0027, \u0027alb_father_meeting_2\u0027); return false;">meeting</a>.');
    } else {
      if (((((s as any).month ?? 0) === 10  &&  ((s as any).day ?? 0) > 20)  ||  (((s as any).month ?? 0) === 11  &&  ((s as any).day ?? 0) < 16))  &&  ((s as any).week ?? 0) > 5  &&  ((s as any).hour ?? 0) > 8  &&  ((s as any).hour ?? 0) < 20  &&  ((s as any).AlbinaQW ?? 0)?.['ParkRally'] === 2  &&  ((s as any).AlbinaQW ?? 0)?.['StarletsShutDown'] === 0  &&  ((s as any).AlbinaQW ?? 0)?.['StarletsJoined'] === 0) {
        scene.text('By this time, you\'re well aware that Albina\'s father is holding a <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=2; return s; }); window.__gameStore.getState().doGoto(\u0027pav_park\u0027, \u0027alb_father_meeting_3\u0027); return false;">meeting</a>, though they have erected a big stage.');
      }
    }
  }
  ...
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 22) {
    scene.actions([
      { label: '', labelFn: (s: GameState) => 'Distribute flyers to earn money (' + String(qspFunc(s, 'money', 'string_profit', 50) ?? '') + ') (1:00)', handler: (st: GameState) => {
  ...
  if (qspFunc(s, 'jobs', 'is_work_day', 'pav_tour_guide') === 1) {
    if (((s as any).job_status ?? 0)?.['pav_tour_guide'] === ''  ||  ((s as any).job_status ?? 0)?.['pav_tour_guide'] === 'terminated') {
      scene.actions([
        { label: '', labelFn: (s: GameState) => 'Apply for the Tour Guide job (' + String(qspFunc(s, 'time', 'get_time_string', 0, 30) ?? '') + ')', handler: (st: GameState) => {
    qspGoto(st, 'tour_guide', 'apply_for_job');
  } },
      ]);
    } else {
      if (((s as any).job_status ?? 0)?.['pav_tour_guide'] === 'employed') {
        if (qspFunc(s, 'jobs', 'is_arrival_time', 'pav_tour_guide') === 1) {
          scene.actions([
            { label: '', labelFn: (s: GameState) => 'Work as Tour Guide (' + String(qspFunc(s, 'time', 'get_time_string', 8, 0) ?? '') + ')', handler: (st: GameState) => {
    qspGoto(st, 'tour_guide', 'tourstart');
  } },
          ]);
        }
      }
  ...
  if (((s as any).mey_vika ?? 0)?.['mey_vika_qw'] > 0  &&  ((s as any).mey_vika ?? 0)?.['mey_vika_qw'] < 27  &&  ((s as any).mey_vika ?? 0)?.['qw_day'] !== ((s as any).daystart ?? 0)) {
    ...
    qspCall(st, 'mey_vika_events', 'park_meet');
    qspCall(st, 'stat', '');
  } },
      ]);
    }
  ...
  scene.actions([
    ...
    if (((st as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((st as any).gschoolVars ?? 0)?.['school_diploma'] === 0  &&  ((st as any).mey_vika ?? 0)?.['mey_vika_qw'] > 0  &&  ((st as any).mey_vika ?? 0)?.['mey_vika_qw'] < 27  &&  ((st as any).mey_vika ?? 0)?.['qw_day'] !== ((st as any).daystart ?? 0)  &&  ((st as any).locat ?? 0)?.['Vicky'] === 11) {
      qspCall(st, 'mey_vika_events', 'park_meet');
      qspCall(st, 'stat', '');
    } else {
      qspCall(st, 'pav_parkev', 'go_for_walk1');
    }
  } },
...
function enterDeeperPark(s: GameState, scene: SceneBuilder): void {
  ...
  if ((((s as any).sunWeather ?? 0) === 1  &&  ((s as any).temper ?? 0) > 0)) {
    ...
    if (((s as any).gopniksev ?? 0)?.['rand'] === 1  &&  ((s as any).gopniksev ?? 0)?.['gopgirls'] !== ((s as any).daystart ?? 0)  &&  ((s as any).locat ?? 0)?.['A144'] === 23  &&  ((((s as any).week ?? 0) >= 6  &&  ((s as any).hour ?? 0) >= 12  &&  ((s as any).hour ?? 0) < 18)  ||  (((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) >= 16  &&  ((s as any).hour ?? 0) < 18))) {
      scene.text('You see your classmates <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027pav_parkev\u0027, \u0027gopgirls\u0027); return false;">Lena, Lera, Anushka and Alyona</a> sitting at a picnic table, drinking beer and hanging out.');
    } else {
      if (((s as any).gopniksev ?? 0)?.['rand'] === 2  &&  ((s as any).gopniksev ?? 0)?.['gopboys'] !== ((s as any).daystart ?? 0)  &&  ((s as any).locat ?? 0)?.['A156'] === 23  &&  ((((s as any).week ?? 0) >= 6  &&  ((s as any).hour ?? 0) >= 12  &&  ((s as any).hour ?? 0) < 18)  ||  (((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) >= 16  &&  ((s as any).hour ?? 0) < 18))) {
        scene.text('You see your classmates <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027pav_parkev\u0027, \u0027gopboys\u0027); return false;">Vitek, Dan, Lavrenti, Roman, Arkadi, Vasily and Pauline</a> sitting at a picnic table, drinking beer and hanging out.');
      } else {
        if (((s as any).gopniksev ?? 0)?.['rand'] === 3  &&  ((s as any).gopniksev ?? 0)?.['gopniks'] !== ((s as any).daystart ?? 0)  &&  ((s as any).locat ?? 0)?.['A144'] === 23  &&  ((s as any).locat ?? 0)?.['A154'] === 23  &&  ((s as any).locat ?? 0)?.['A156'] === 23  &&  ((s as any).locat ?? 0)?.['A158'] === 23  &&  ((((s as any).week ?? 0) >= 6  &&  ((s as any).hour ?? 0) >= 12  &&  ((s as any).hour ?? 0) < 18)  ||  (((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) >= 16  &&  ((s as any).hour ?? 0) < 18))) {
          ...
          if (((s as any).gopniksev ?? 0)?.['rand'] === 4  &&  ((s as any).gopniksev ?? 0)?.['gopskver'] !== ((s as any).daystart ?? 0)  &&  ((((s as any).week ?? 0) >= 6  &&  ((((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) < 12)  ||  (((s as any).hour ?? 0) >= 16  &&  ((s as any).hour ?? 0) < 20)))  ||  (((s as any).week ?? 0) < 6  &&  (((s as any).hour ?? 0) >= 18  &&  ((s as any).hour ?? 0) < 20)))) {
            scene.text('You see your classmates <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027gopskver\u0027, \u0027\u0027); return false;">Vitek, Dan and Vasily</a> sitting on a park bench, drinking beer.');
          } else {
            ((s as any).gopniksev = (s as any).gopniksev ?? {})['rand'] = (Math.floor(Math.random() * 4) + 1);
  ...
  scene.actions([
    ...
    { label: 'Go for a walk (0:15)', handler: (st: GameState) => {
    if (((st as any).start_type ?? 0)?.['magic'] !== 'nomagic'  &&  (Math.floor(Math.random() * 4) + 0) === 0  &&  (Math.floor(Math.random() * 4) + 1) <= ((st as any).pcs_magik ?? 0)  &&  (((st as any).hour ?? 0) <= 6  ||  ((st as any).hour ?? 0) >= 19)) {
      (st as any).minut = ((st as any).minut ?? 0) + 15;
      qspCall(st, 'stat', '');
      qspGoto(st, 'MagEncounterFairy', '');
    } else {
      (st as any).minut = ((st as any).minut ?? 0) + 15;
      qspCall(st, 'stat', '');
      qspCall(st, 'pav_parkev', 'go_for_walk2');
    }
  } },
...
function enterSleepingParkBench(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).pantyworntype ?? 0) === 'none'  &&  ((st as any).PCloSkirt ?? 0) > 0) {
      ...
      if (((st as any).PCloSkirt ?? 0) > 0  &&  (Math.floor(Math.random() * 10) + 1) <= 9) {
    ...
    if ((Math.floor(Math.random() * 10) + 0) < 6  &&  ((st as any).money ?? 0) > 0) {

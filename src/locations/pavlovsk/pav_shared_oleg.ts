...
function enterOleg(s: GameState, scene: SceneBuilder): void {
  ...
  if ((((s as any).totminut ?? 0) - ((s as any).Oleg ?? 0)?.['served']) < 180) {
    ...
    if (((s as any).shared_apt ?? 0)?.['servitudeLvl'] === 2) {
      ((s as any).Oleg = (s as any).Oleg ?? {})['serve'] = 1;
    }
  }
  if (((s as any).cumloc ?? 0)[13] > 0  ||  ((s as any).cumloc ?? 0)[11] > 0  ||  ((s as any).cumloc ?? 0)[16] > 0  ||  ((s as any).cumloc ?? 0)[10] >0  ||  ((s as any).cumloc ?? 0)[9] >0) {
    ...
    ((st as any).Oleg = (st as any).Oleg ?? {})['served'] = ((st as any).totminut ?? 0);
  } },
          ]);
        }
        scene.actions([
...
function enterOleg_Chat(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hour ?? 0) >= ((s as any).Oleg ?? 0)?.['leaves']  &&  ((s as any).hour ?? 0) < ((s as any).Oleg ?? 0)?.['comes']) {
    ...
    qspGoto(s, 'pav_shared_apt', 'Oleg_Room');
  } else {
  ...
  if (((s as any).shared_apt ?? 0)?.['chatLvl'] === 0) {
    ...
    ((st as any).Oleg = (st as any).Oleg ?? {})['doPiss'] = (-1);
  }, goto: ['pav_shared_oleg', 'Oleg_Chat'] },
  ...
  if (((s as any).shared_apt ?? 0)?.['step'] === 0) {
    ...
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['step'] = 4;
            ...
            if (((s as any).shared_apt ?? 0)?.['step'] === 5) {
              ...
              if (((s as any).shared_apt ?? 0)?.['cumCh'] <= 70) {
                ...
                ((s as any).Oleg = (s as any).Oleg ?? {})['lastCum'] = ((s as any).daystart ?? 0);
    ...
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['step'] = 4;
              ...
              if (((s as any).shared_apt ?? 0)?.['step'] === 6) {
                ...
                ((s as any).shared_apt = (s as any).shared_apt ?? {})['step'] = 0;
                ((s as any).Oleg = (s as any).Oleg ?? {})['bjFail'] = ((s as any).Oleg['bjFail'] ?? 0) + (1);
                scene.actions([
                  { label: 'Leave', goto: ['pav_shared_apt', 'start'] },
                ]);
              } else {
                if (((s as any).shared_apt ?? 0)?.['step'] === 7) {
                  ...
                  ((s as any).shared_apt = (s as any).shared_apt ?? {})['step'] = 0;
                  ((s as any).Oleg = (s as any).Oleg ?? {})['bjFail'] = ((s as any).Oleg['bjFail'] ?? 0) + (1);
                  ((s as any).Oleg = (s as any).Oleg ?? {})['bjFailPuke'] = ((s as any).Oleg['bjFailPuke'] ?? 0) + (1);
                  scene.actions([
                    { label: 'Leave', goto: ['pav_shared_apt', 'start'] },
                  ]);
                } else {
                  if (((s as any).shared_apt ?? 0)?.['step'] === 8) {
                    ...
                    ((s as any).shared_apt = (s as any).shared_apt ?? {})['step'] = 0;
                    ((s as any).Oleg = (s as any).Oleg ?? {})['bjFail'] = ((s as any).Oleg['bjFail'] ?? 0) + (1);
                    ((s as any).Oleg = (s as any).Oleg ?? {})['bjFailFaint'] = ((s as any).Oleg['bjFailFaint'] ?? 0) + (1);
                    scene.actions([
...
function enterOleg_Sex_Vag(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).shared_apt ?? 0)?.['step'] === 0) {
    ...
    qspGoto(st, 'pav_shared_oleg', 'Oleg_Sex_Vag');
          ...
          if (((s as any).shared_apt ?? 0)?.['step'] === 4) {
            if (((s as any).Oleg ?? 0)?.['pornPos'] < 1) {
              ((s as any).Oleg = (s as any).Oleg ?? {})['pornPos'] = 1;
            }
            if (((s as any).shared_apt ?? 0)?.['subStep'] === 0) {
    ...
    qspGoto(st, 'pav_shared_oleg', 'Oleg_Sex_Vag');
            ...
            if (((s as any).shared_apt ?? 0)?.['step'] === 5) {
              if (((s as any).Oleg ?? 0)?.['pornPos'] < 2) {
                ((s as any).Oleg = (s as any).Oleg ?? {})['pornPos'] = 2;
              }
              if (((s as any).shared_apt ?? 0)?.['subStep'] === 0) {
    ...
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['subStep'] = (((st as any).shared_apt ?? 0)?.['cumOutL']);
                  ...
                  if (((s as any).shared_apt ?? 0)?.['subStep'] === 1) {
                    ...
                    ((s as any).Oleg = (s as any).Oleg ?? {})['vagCumInside'] = ((s as any).Oleg['vagCumInside'] ?? 0) + (1);
                    ((s as any).Oleg = (s as any).Oleg ?? {})['cumVag'] = ((s as any).Oleg['cumVag'] ?? 0) + (1);
                    ((s as any).Oleg = (s as any).Oleg ?? {})['lastCum'] = ((s as any).daystart ?? 0);
    ...
    qspCall(st, 'pav_shared_apt', '');
                          ...
                          if (((s as any).shared_apt ?? 0)?.['subStep'] === 5) {
                            ...
                            ((s as any).Oleg = (s as any).Oleg ?? {})['lastCum'] = ((s as any).daystart ?? 0);
                            ((s as any).Oleg = (s as any).Oleg ?? {})['cumVag'] = ((s as any).Oleg['cumVag'] ?? 0) + (1);
                            ((s as any).Oleg = (s as any).Oleg ?? {})['vagCumInsideUnwanted'] = ((s as any).Oleg['vagCumInsideUnwanted'] ?? 0) + (1);
                            qspCall(s, 'cum_call', '', ((s as any).boy ?? 0), 1);
    ...
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['subStep'] = 30;
                              ...
                              if (((s as any).shared_apt ?? 0)?.['subStep'] === 20) {
                                ...
                                ((s as any).Oleg = (s as any).Oleg ?? {})['lastCum'] = ((s as any).daystart ?? 0);
                                ((s as any).Oleg = (s as any).Oleg ?? {})['swall'] = ((s as any).Oleg['swall'] ?? 0) + (1);
                                qspCall(s, 'npc_relationship', 'modify', 'A266', 1);
                                (s as any).minut = ((s as any).minut ?? 0) + 5;
                                qspCall(s, 'cum_call', 'mouth', ((s as any).boy ?? 0), 1);
                                qspCall(s, 'arousal', 'end');
  ...
  if (((s as any).shared_apt ?? 0)?.['step'] === 0) {
    ...
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['subStep'] = (((st as any).shared_apt ?? 0)?.['cumOutL']);
                  ...
                  if (((s as any).shared_apt ?? 0)?.['subStep'] === 1) {
                    ...
                    ((s as any).Oleg = (s as any).Oleg ?? {})['analCumInside'] = ((s as any).Oleg['analCumInside'] ?? 0) + (1);
                    ((s as any).Oleg = (s as any).Oleg ?? {})['lastCum'] = ((s as any).daystart ?? 0);
                    ((s as any).Oleg = (s as any).Oleg ?? {})['cumAnal'] = ((s as any).Oleg['cumAnal'] ?? 0) + (1);
...
function enterOleg_SexPiss(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).loc_arg = 'Oleg_Sex_piss';
  ...
  if (((s as any).shared_apt ?? 0)?.['step'] === 0) {
    ...
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['step'] = 60;
  }, goto: ['pav_shared_oleg', 'Oleg_Sex_piss'] },
              ]);
            } else {
    ...
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['step'] = 110;
                      ...
                      if (((s as any).shared_apt ?? 0)?.['step'] === 100) {
                        if (((s as any).pissLike ?? 0) === -1) {
                          ...
                          scene.actions([
                            { label: 'Leave', handler: (st: GameState) => {
    ((st as any).Oleg = (st as any).Oleg ?? {})['piss'] = (-3);
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['step'] = 110;
  }, goto: ['pav_shared_oleg', 'Oleg_Sex_piss'] },
                          ]);
                        } else {
    ...
    ((st as any).Oleg = (st as any).Oleg ?? {})['piss'] = (-2);
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['step'] = 110;
  }, goto: ['pav_shared_oleg', 'Oleg_Sex_piss'] },
                            ]);
                          } else {
                            if (((s as any).pissLike ?? 0) === 1) {
                              ...
                              scene.actions([
                                { label: 'Yes', handler: (st: GameState) => {
    ((st as any).Oleg = (st as any).Oleg ?? {})['piss'] = 1;
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['step'] = 110;
  }, goto: ['pav_shared_oleg', 'Oleg_Sex_piss'] },
    ...
    ((st as any).shared_apt = (st as any).shared_apt ?? {})['step'] = 110;
                        ...
                        if (((s as any).shared_apt ?? 0)?.['step'] === 110) {
                          qspCall(s, 'arousal', 'end');
                          ((s as any).Oleg = (s as any).Oleg ?? {})['piss'] = ((s as any).Oleg['piss'] ?? 0) + (1);
                          ((s as any).shared_apt = (s as any).shared_apt ?? {})['step'] = 0;

...
function enterHousemates(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('Floor 1 - Apartment number 1: Rolan Matveev');
  scene.text('Floor 2 - Apartment number');
  scene.text('Floor 3 - Apartment number');
  scene.text('Floor 4 - Apartment number 30: Shared');
  scene.text('Floor 5 - Apartment number');
  scene.actions([
    { label: 'Leave', goto: ['pav_complexb3', 'etaj_1'] },
  ]);
  scene.build();
}
...
function enterEtaj_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: gt 'pav_complexb3', 'lift', 'etaj_1'
  } },
  ]);
  scene.build();
}
...
function enterEtaj_3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'Take the elevator', handler: (st: GameState) => {
    // TODO-QSP: gt 'pav_complexb3', 'lift', 'etaj_3'
  } },
  ]);
  scene.build();
}
...
function enterEtaj_4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'Take the elevator', handler: (st: GameState) => {
    // TODO-QSP: gt 'pav_complexb3', 'lift', 'etaj_4'
  } },
  ]);
  scene.build();
}
...
function enterEtaj_5(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'Take the elevator', handler: (st: GameState) => {
    // TODO-QSP: gt 'pav_complexb3', 'lift', 'etaj_5'
  } },
  ]);
  scene.build();
}
...
function enterRoof(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temper ?? 0) >= 15  &&  ((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 21) {
    ...
    scene.actions([
      { label: 'Get Up', goto: ['pav_complexb3', 'roof'] },
    ]);
  } },
      ]);
    }
...
function enterLift(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'Push button: Floor 2', goto: ['pav_complexb3', 'etaj_2'] },
    { label: 'Push button: Floor 3', goto: ['pav_complexb3', 'etaj_3'] },
    { label: 'Push button: Floor 4', goto: ['pav_complexb3', 'etaj_4'] },
    { label: 'Push button: Floor 5', goto: ['pav_complexb3', 'etaj_5'] },
  ]);
  scene.build();
}
...
export const pav_complexb3: LocationDef = {
  name: 'pav_complexb3',
  title: 'Ground floor of the apartment building',
  region: 'pavlovsk',
  locationType: 'public_outdoors',
  description: ['Floor 1 - Apartment number 1: Rolan Matveev'],
  enter: enter,
};

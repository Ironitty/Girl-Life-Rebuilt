...
function enterCityOfficeSecretary(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).job_card_hidden) (s as any).job_card_hidden = {}; (s as any).job_card_hidden[String((s as any).temp_job_id ?? 0)] = 1;
  ...
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 1500;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
  // TODO-QSP: end
  scene.build();
}
...
function enterCityCafeWaitress(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: job_shift[$temp_job_id + ', 0'] = 480 & !! 8 hours
  // TODO-QSP: $job_pay_interval_def[$temp_job_id] = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 600;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterCityDinerDishwasher(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 70;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
  return;
  // TODO-QSP: end
  scene.build();
...
function enterCityOfficeCleaner(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: job_shift[$temp_job_id + ', 0']      = 1 * 60 + 0    & !! 1 hour (60 min)
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]  = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 65;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterCityDinerSecretary(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 1250;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterCityStripBargirl(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_pay_interval_def[$temp_job_id] = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 1125;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 1;
  // TODO-QSP: end
  scene.build();
}
...
function enterCityStripStripper(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).job_booking_window_days) (s as any).job_booking_window_days = {}; (s as any).job_booking_window_days[String((s as any).temp_job_id ?? 0)] = 14;
  if (!(s as any).job_booking_slots_per_day) (s as any).job_booking_slots_per_day = {}; (s as any).job_booking_slots_per_day[String((s as any).temp_job_id ?? 0)] = 2;
  if (!(s as any).job_booking_max_concurrent) (s as any).job_booking_max_concurrent = {}; (s as any).job_booking_max_concurrent[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_booking_min_gap_days) (s as any).job_booking_min_gap_days = {}; (s as any).job_booking_min_gap_days[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_arrival_start) (s as any).job_arrival_start = {}; (s as any).job_arrival_start[String((s as any).temp_job_id ?? 0)] = 1020;
  if (!(s as any).job_arrival_end) (s as any).job_arrival_end = {}; (s as any).job_arrival_end[String((s as any).temp_job_id ?? 0)] = 1080;
  ...
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_penalty_per_miss) (s as any).job_penalty_per_miss = {}; (s as any).job_penalty_per_miss[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_penalty_max_debt) (s as any).job_penalty_max_debt = {}; (s as any).job_penalty_max_debt[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterCityPussycatsClerk(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 205;
  if (!(s as any).job_penalty_per_miss) (s as any).job_penalty_per_miss = {}; (s as any).job_penalty_per_miss[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_penalty_max_debt) (s as any).job_penalty_max_debt = {}; (s as any).job_penalty_max_debt[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
...
function enterCityPornstudioActress(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_schedule_mode[$temp_job_id]    = 'booking'
  if (!(s as any).job_booking_window_days) (s as any).job_booking_window_days = {}; (s as any).job_booking_window_days[String((s as any).temp_job_id ?? 0)] = 42;
  if (!(s as any).job_booking_slots_per_day) (s as any).job_booking_slots_per_day = {}; (s as any).job_booking_slots_per_day[String((s as any).temp_job_id ?? 0)] = 4;
  if (!(s as any).job_booking_max_concurrent) (s as any).job_booking_max_concurrent = {}; (s as any).job_booking_max_concurrent[String((s as any).temp_job_id ?? 0)] = 5;
  if (!(s as any).job_booking_min_gap_days) (s as any).job_booking_min_gap_days = {}; (s as any).job_booking_min_gap_days[String((s as any).temp_job_id ?? 0)] = 6;
  ...
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_penalty_per_miss) (s as any).job_penalty_per_miss = {}; (s as any).job_penalty_per_miss[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_penalty_max_debt) (s as any).job_penalty_max_debt = {}; (s as any).job_penalty_max_debt[String((s as any).temp_job_id ?? 0)] = 20000;
  ...
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_refresh_desc) (s as any).job_refresh_desc = {}; (s as any).job_refresh_desc[String((s as any).temp_job_id ?? 0)] = 1;
  return;
  // TODO-QSP: end
  scene.build();
}
...
function enterCityPornstudioDelivery(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).job_available_start) (s as any).job_available_start = {}; (s as any).job_available_start[String((s as any).temp_job_id ?? 0)] = 9 * 60;
  if (!(s as any).job_available_end) (s as any).job_available_end = {}; (s as any).job_available_end[String((s as any).temp_job_id ?? 0)] = 22 * 60;
  if (!(s as any).job_create_availability_events) (s as any).job_create_availability_events = {}; (s as any).job_create_availability_events[String((s as any).temp_job_id ?? 0)] = 1;
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'none'
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
...
function enterCityAphroditeModel(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).job_available_start) (s as any).job_available_start = {}; (s as any).job_available_start[String((s as any).temp_job_id ?? 0)] = 7 * 60;
  if (!(s as any).job_available_end) (s as any).job_available_end = {}; (s as any).job_available_end[String((s as any).temp_job_id ?? 0)] = 21 * 60;
  if (!(s as any).job_create_availability_events) (s as any).job_create_availability_events = {}; (s as any).job_create_availability_events[String((s as any).temp_job_id ?? 0)] = 0;
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'none'
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
...
function enterPavHotelMaid(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 375;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterPavClinicCleaner(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: job_shift[$temp_job_id + ', 0']      = 1 * 60 + 0    & !! 1 hour (60 min)
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 100;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterPavFactory(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'hourly'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 150;
  if (!(s as any).job_penalty_per_miss) (s as any).job_penalty_per_miss = {}; (s as any).job_penalty_per_miss[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_penalty_max_debt) (s as any).job_penalty_max_debt = {}; (s as any).job_penalty_max_debt[String((s as any).temp_job_id ?? 0)] = 3;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 1;
...
function enterPavMailgirl(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 450;
  if (!(s as any).job_penalty_per_miss) (s as any).job_penalty_per_miss = {}; (s as any).job_penalty_per_miss[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_penalty_max_debt) (s as any).job_penalty_max_debt = {}; (s as any).job_penalty_max_debt[String((s as any).temp_job_id ?? 0)] = 4;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterPavTourGuide(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 1000;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterPavBarbershopCleaner(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: job_shift[$temp_job_id + ', 0']      = 1 * 60 + 0    & !! 1 hour (60 min)
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 125;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterPavTrainCleaner(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_schedule_mode[$temp_job_id]    = 'on_demand'
  // TODO-QSP: $job_available_days[$temp_job_id]    = '1 2 3 4 5 6 7'  & !! All week
  if (!(s as any).job_available_start) (s as any).job_available_start = {}; (s as any).job_available_start[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_available_end) (s as any).job_available_end = {}; (s as any).job_available_end[String((s as any).temp_job_id ?? 0)] = 23 * 60 + 59;
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'shift'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 250;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterHighwayBrothelProstitute(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).job_available_end) (s as any).job_available_end = {}; (s as any).job_available_end[String((s as any).temp_job_id ?? 0)] = 23 * 60 + 59;
  // TODO-QSP: $job_pay_interval_def[$temp_job_id]    = 'hourly'
  if (!(s as any).job_pay_rate_def) (s as any).job_pay_rate_def = {}; (s as any).job_pay_rate_def[String((s as any).temp_job_id ?? 0)] = 500;
  if (!(s as any).job_blocking) (s as any).job_blocking = {}; (s as any).job_blocking[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_add_to_calendar) (s as any).job_add_to_calendar = {}; (s as any).job_add_to_calendar[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_show_stat_icon) (s as any).job_show_stat_icon = {}; (s as any).job_show_stat_icon[String((s as any).temp_job_id ?? 0)] = 0;
  if (!(s as any).job_schedule_switchable) (s as any).job_schedule_switchable = {}; (s as any).job_schedule_switchable[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterCitySalonMasseuse(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_schedule_mode[$temp_job_id]  = 'booking'
  if (!(s as any).job_booking_window_days) (s as any).job_booking_window_days = {}; (s as any).job_booking_window_days[String((s as any).temp_job_id ?? 0)] = 14;
  if (!(s as any).job_booking_slots_per_day) (s as any).job_booking_slots_per_day = {}; (s as any).job_booking_slots_per_day[String((s as any).temp_job_id ?? 0)] = 3;
  if (!(s as any).job_booking_max_concurrent) (s as any).job_booking_max_concurrent = {}; (s as any).job_booking_max_concurrent[String((s as any).temp_job_id ?? 0)] = 21;
  if (!(s as any).job_booking_min_gap_days) (s as any).job_booking_min_gap_days = {}; (s as any).job_booking_min_gap_days[String((s as any).temp_job_id ?? 0)] = 0;
...
function enterPavLeonidSlave(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: $job_schedule_mode[$temp_job_id] = 'booking'
  if (!(s as any).job_booking_window_days) (s as any).job_booking_window_days = {}; (s as any).job_booking_window_days[String((s as any).temp_job_id ?? 0)] = 7;
  if (!(s as any).job_booking_slots_per_day) (s as any).job_booking_slots_per_day = {}; (s as any).job_booking_slots_per_day[String((s as any).temp_job_id ?? 0)] = 1;
  if (!(s as any).job_booking_max_concurrent) (s as any).job_booking_max_concurrent = {}; (s as any).job_booking_max_concurrent[String((s as any).temp_job_id ?? 0)] = 7;
  if (!(s as any).job_booking_min_gap_days) (s as any).job_booking_min_gap_days = {}; (s as any).job_booking_min_gap_days[String((s as any).temp_job_id ?? 0)] = 0;

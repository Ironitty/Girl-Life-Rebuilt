...
function enterIraLenaRex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).boydesc || '')} takes advantage of Ira's position and slides his cock inside of her and begins to fuck her roughly.`);
    // TODO-QSP: dynamic text: Ira bouncing her hips back and forth, fucking him as much as he was fucking her ...
    scene.text(`Ira bouncing her hips back and forth, fucking him as much as he was fucking her as she keeps licking your pussy, Lena starts kissing ${((s as any).boydesc || '')}, while her hand caress his balls.`);
    // TODO-QSP: dynamic text: Time flies fast, Ira, Lena and yourself have all switched positions many times, ...
    scene.text(`Time flies fast, Ira, Lena and yourself have all switched positions many times, letting him fuck all three of you, ${((s as any).boydesc || '')} can take no more.`);
    ...
    scene.text(`You bend over in front of him, Lena and Ira obediently bend over in front of ${((s as any).boydesc || '')} as well. One of them to each side of you, giving him a lovely view of all three of your asses.`);
    // TODO-QSP: dynamic text: <<$boydesc>> enjoys the spectacular view of your graceful asses. He fucks you fi...
    scene.text(`${((s as any).boydesc || '')} enjoys the spectacular view of your graceful asses. He fucks you first, while he slaps the girls on the ass, as he pounds into you.`);
...
function enterSisterFun(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Mmm ${((s as any).pcs_nickname || '')}, you taste so sweet," Anya murmurs. You can't help but smile at the skill of her tongue and again silently question her claims that she isn't into girls.`);
...
function enterDjSuck(s: GameState, scene: SceneBuilder): void {
  ...
  if ((!((s as any).rex_love ?? 0))) {
    ...
    scene.text(`You find you don't want to stop and passionately start sucking his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick right there in front of everyone.`);
    ...
    scene.text(`He abruptly pushes his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick inside of you and starts fucking you with a fast pace.`);
...
function enterToiletBoysBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).i ?? 0) === 1) {
      ...
      scene.text(`<center><video autoplay loop ${((s as any).set_imgh || '')} src="images/locations/pavlovsk/resident/rekshome/party/party_girls_party_gost_12_1.mp4"></video></center>`);
    }
    if (((s as any).i ?? 0) === 2) {
      // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/locations/pavlovsk/resident/rekshome/part...
      scene.text(`<center><img ${((s as any).set_imgh || '')} src="images/locations/pavlovsk/resident/rekshome/party/party_girls_party_gost_12_3.jpg"></center>`);
    }
...
function enterGangbangOutdoor(s: GameState, scene: SceneBuilder): void {
  ...
  if ((!((s as any).temp_rand ?? 0))) {
    ...
    scene.text(`"Bend over, ${((s as any).pcs_nickname || '')}, and show us your tight, wet hole." You get in a comfortable position and the guys take turns fucking your wet pussy. You really enjoy yourself as you move your hips towards their rock-hard members, making them glide in and out of your pussy, not wanting to wait their turn they start to fuck your ass as well. The guys finish on your ass and back, except the last one who groans and tells you: "Ah, ${((s as any).pcs_nickname || '')}, open up, I want to cum in your mouth!"`);
    ...
    scene.text(`You turn around and kneel in front of him, playfully sticking out your tongue. The drunk guy gives a little jerk and sprays of sperm jets into your mouth. "Ah, ${((s as any).pcs_nickname || '')}, you are truly the best bitch at this party!" the guys all laugh. You try to join in, but your laughter is stifled by the mouthful of sperm.`);
...
function enterBoobsYes(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You gladly kneel in front of him to take a closer look at his erect member. "Come on ${((s as any).pcs_nickname || '')}, don't be shy."`);
    scene.actions([
...
function enterToiletSexEvents(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp ?? 0) === 1) {
    ...
    scene.text(`As you jerk him off, he moans and sperm starts squirting all over your hands. "Ooh ${((s as any).pcs_nickname || '')}, you saved me. But next time, use your mouth." he says with a wink.`);
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Move away', goto: ['rex_party', 'Toilet'] },
    ]);
    ...
    scene.text(`You feel Rex's hands on your shoulders gently pushing you down. You instantly obey and drop to your knees. Once you're level with Rex's ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick, you take his head into your mouth and wrap your lips tightly around his shaft as you begin to suck him off.`);
    ...
    if (((s as any).i ?? 0) === 11) {
      scene.img(`images/locations/pavlovsk/resident/rekshome/party/reksparty_party_toilet_5_${((s as any).i || '')}.mp4`);
    } else {
      scene.img(`images/locations/pavlovsk/resident/rekshome/party/reksparty_party_toilet_5_${((s as any).i || '')}.jpg`);
    }
    ...
    if (((s as any).i ?? 0) === 2  ||  ((s as any).i ?? 0) === 4) {
      scene.img(`images/locations/pavlovsk/resident/rekshome/party/reksparty_party_toilet_6_${((s as any).i || '')}.mp4`);
    } else {
      scene.img(`images/locations/pavlovsk/resident/rekshome/party/reksparty_party_toilet_6_${((s as any).i || '')}.jpg`);
    }
    ...
    scene.text(`"Oh, it's you ${((s as any).pcs_nickname || '')}. Glad it is not some guy. We do not know what we would have done with him."`);
    ...
    scene.text(`"Well ${((s as any).pcs_nickname || '')}, did you like it?"`);

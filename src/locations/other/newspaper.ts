...
function enterCikl(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).newspaperVars = (s as any).newspaperVars ?? {})['page_' + String((s as any).i || '') + ''] = ((s as any).np_front_pages ?? 0)?.[String((s as any).idx ?? 0)];
  ...
  ((s as any).newspaperVars = (s as any).newspaperVars ?? {})['page_' + String((s as any).i || '') + ''] = ((s as any).np_pages ?? 0)?.[String((s as any).idx ?? 0)];
  (s as any).i = ((s as any).i ?? 0) + (1);
...
function enterView(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).newspaperVars ?? 0)?.['dbag'] === 0) {
      ...
      ((s as any).newspaperVars = (s as any).newspaperVars ?? {})['dbag'] = 0;

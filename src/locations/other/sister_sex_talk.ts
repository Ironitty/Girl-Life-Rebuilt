...
function enterSexTalk1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp ?? 0) === 1) {
            ...
            if (((s as any).temp ?? 0) === 6) {
              ...
              if (((s as any).temp ?? 0) === 7) {
                ...
                if (((s as any).temp ?? 0) === 8) {
                  qspGoto(s, 'sister_sex_talk', 'black_sex');
                } else {
    ...
    if (((st as any).trait_vars ?? 0)?.['panty_preference'] > 1) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSexTalkContinue(st, scene); (st as any).locArgs = __savedLocArgs; }
                      ...
                      if (((s as any).temp ?? 0) === 11) {
                        ...
                        if (((s as any).temp ?? 0) === 12) {
                          { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPenetrationCum(s, scene); (s as any).locArgs = __savedLocArgs; }
                        } else {
                          if (((s as any).temp ?? 0) === 13) {
                            { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterAnalVirginity(s, scene); (s as any).locArgs = __savedLocArgs; }
                          }
                        }
                      }
                    }
...
function enterVirginAsk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).virgin_stats ?? 0)?.['taker_ID'] === 'A16') {
    ...
    if ((!((st as any).sisterknowslut ?? 0))) {
      (st as any).sisterknowslut = 1;
    }
    ((st as any).sisterQW = (st as any).sisterQW ?? {})['virgin_chat'] = 1;
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSexTalkContinue(st, scene); (st as any).locArgs = __savedLocArgs; }
        ...
        ((s as any).sisterQW = (s as any).sisterQW ?? {})['virgin_chat'] = 1;
        scene.actions([
...
function enterFirstTime(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).virgin_stats ?? 0)?.['cock_size'] >= 15) {
    ...
    if (((st as any).virgin_stats ?? 0)?.['cock_size'] <= 19) {
    ...
    scene.img('images/characters/pavlovsk/resident/anya/home/sister_chat.jpg');
    if (((st as any).virgin_stats ?? 0)?.['day_lost'] > ((st as any).daystart ?? 0) - 7  &&  ((st as any).pain ?? 0)?.['vaginal'] > 0) {
...
function enterShaveTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat ?? 0)?.['think_virgin'] === 1) {
    ...
    if (((st as any).pube_style ?? 0)?.['word'] === 'bush'  ||  ((st as any).pube_style ?? 0)?.['word'] === 'untrimmed') {
      scene.actions([
    ...
    if (((st as any).brotherQW ?? 0)?.['Sex'] >= 7) {
      scene.text('$OpenInnerThought + \'One boy in particular…\' + $CloseInnerThought + \' you add to yourself silently, thinking of Kolka. It\'s not like you can tell your sister about that though…\'');
    }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSexTalkContinue(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterBlackSex(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).DjibrilQW ?? 0)?.['anya_gangbang_count'] !== 0) {
    ...
    ((st as any).OluQW = (st as any).OluQW ?? {})['anya_inv'] = 1;
    scene.img('images/characters/pavlovsk/resident/anya/home/sister_chat.jpg');
...
function enterStylePreference(s: GameState, scene: SceneBuilder): void {
  ((s as any).sisterQW = (s as any).sisterQW ?? {})['sexstyletalk'] = 1;
  scene.img('images/characters/pavlovsk/resident/anya/home/sister_chat.jpg');
...
function enterSpitOrSwallow(s: GameState, scene: SceneBuilder): void {
  ((s as any).sisterQW = (s as any).sisterQW ?? {})['spitswallowtalk'] = 1;
  scene.img('images/characters/pavlovsk/resident/anya/home/sister_chat.jpg');

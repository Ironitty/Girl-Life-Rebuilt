...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You arrive at the restaurant and sit at a table. ${((s as any).npcdesc ?? 0)} orders a meal and good wine. You have to wait a little until the food arrives.`);

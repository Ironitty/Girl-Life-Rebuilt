...
function enterWineInvite(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).AlbinaQW ?? 0)?.['wine_caught'] === 0) {
      ...
      scene.text(`"Ugh! You're such a bore, ${((s as any).pcs_nickname || '')}!" she says while rolling her eyes. "Fine, you go shower. <i>I'm</i> getting drunk. Don't bother hanging around if you don't plan on joining me."`);
    ...
    scene.actions([
      ...
      scene.text(`"Ugh! You're such a pussy, ${((s as any).pcs_nickname || '')}!" she replies while rolling her eyes. "Fine, you go shower. <i>I'm</i> getting drunk again."`);
      scene.text('She pads off into the kitchen, leaving you and a trail of wet footprints behind.');
    }
    scene.actions([
      { label: 'Go and shower', handler: (st: GameState) => {
...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine'] = ((s as any).AlbinaQW['wine'] ?? 0) + (1);
  // TODO-QSP: end
  scene.build();
}
...
function enterWineChat1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).AlbinaQW ?? 0)?.['wine_date'] !== ((s as any).daystart ?? 0)) {
    ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_date'] = ((s as any).daystart ?? 0);
    ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_limit'] = Math.floor(Math.random() * 5) + 4;
  }
  ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_convo'] = Math.floor(Math.random() * 8) + 1;
  ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_count'] = ((s as any).AlbinaQW['wine_count'] ?? 0) + (1);
  if (((s as any).AlbinaQW ?? 0)?.['wine_count'] >= ((s as any).AlbinaQW ?? 0)?.['wine_limit']) {
    ...
    if (((s as any).AlbinaQW ?? 0)?.['wine_convo'] === 1) {
      if (((s as any).AlbinaQW ?? 0)?.['wine_convo_1'] === ((s as any).daystart ?? 0)) {
        qspGoto(s, 'albina_wine_event', 'wine_chat1');
      } else {
        ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_convo_1'] = ((s as any).daystart ?? 0);
      }
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPussyTaste(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      if (((s as any).AlbinaQW ?? 0)?.['wine_convo'] === 2) {
        if (((s as any).AlbinaQW ?? 0)?.['wine_convo_2'] === ((s as any).daystart ?? 0)) {
          qspGoto(s, 'albina_wine_event', 'wine_chat1');
        } else {
          ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_convo_2'] = ((s as any).daystart ?? 0);
        }
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShaveTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
      } else {
        if (((s as any).AlbinaQW ?? 0)?.['wine_convo'] === 3) {
          if (((s as any).AlbinaQW ?? 0)?.['wine_convo_3'] === ((s as any).daystart ?? 0)) {
            qspGoto(s, 'albina_wine_event', 'wine_chat1');
          } else {
            ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_convo_3'] = ((s as any).daystart ?? 0);
          }
          { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDominateAlbina(s, scene); (s as any).locArgs = __savedLocArgs; }
        } else {
          if (((s as any).AlbinaQW ?? 0)?.['wine_convo'] === 4) {
            if (((s as any).AlbinaQW ?? 0)?.['wine_convo_4'] === ((s as any).daystart ?? 0)) {
              qspGoto(s, 'albina_wine_event', 'wine_chat1');
            } else {
              ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_convo_4'] = ((s as any).daystart ?? 0);
            }
            { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMasturbationTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
          } else {
            if (((s as any).AlbinaQW ?? 0)?.['wine_convo'] === 5) {
              if (((s as any).AlbinaQW ?? 0)?.['wine_convo_5'] === ((s as any).daystart ?? 0)) {
                qspGoto(s, 'albina_wine_event', 'wine_chat1');
              } else {
                ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_convo_5'] = ((s as any).daystart ?? 0);
              }
              { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
            } else {
              if (((s as any).AlbinaQW ?? 0)?.['wine_convo'] === 6) {
                if (((s as any).AlbinaQW ?? 0)?.['wine_convo_6'] === ((s as any).daystart ?? 0)) {
                  qspGoto(s, 'albina_wine_event', 'wine_chat1');
                } else {
                  ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_convo_6'] = ((s as any).daystart ?? 0);
                }
                { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBoobSizeTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
              } else {
                if (((s as any).AlbinaQW ?? 0)?.['wine_convo'] === 7) {
                  ...
                  if (((s as any).AlbinaQW ?? 0)?.['wine_convo_7'] === ((s as any).daystart ?? 0)) {
                    ...
                    ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_convo_7'] = ((s as any).daystart ?? 0);
                  }
                  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCommandoTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
                } else {
                  if (((s as any).AlbinaQW ?? 0)?.['wine_convo'] === 8) {
                    if (((s as any).AlbinaQW ?? 0)?.['wine_convo_8'] === ((s as any).daystart ?? 0)) {
                      qspGoto(s, 'albina_wine_event', 'wine_chat1');
                    } else {
                      ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_convo_8'] = ((s as any).daystart ?? 0);
                    }
                    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterStripperTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
                  }
                }
              }
            }
...
function enterPussyTaste(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat ?? 0)?.['mast'] > 0) {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterWineChat2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  if (qspFunc(s, 'pcs_has_attr', 'sex_virgin') === 0) {
    ...
    scene.text(`"You're a fuckin' slut, ${((s as any).pcs_nickname || '')}!" she replies and you nearly choke on your wine as you both burst into laughter.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterWineChat2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
...
function enterShaveTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pubestyle ?? 0) === 1  &&  ((s as any).pcs_pubes ?? 0) <= 3) {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShaveAnswer1(s, scene); (s as any).locArgs = __savedLocArgs; }
  } else {
    if (((s as any).pcs_pubes ?? 0) <= 15) {
      ...
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShaveAnswer2(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
...
function enterMasturbationTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat ?? 0)?.['mast'] === 0) {
    ...
    if (((s as any).brotherQW ?? 0)?.['shower_talk'] > 0) {
      ...
      scene.text(`"You need to start thinking with your dick, ${((s as any).pcs_nickname || '')}," she giggles giddily as she takes another sloppy slurp of wine.`);
    } else {
      ...
      // TODO-QSP: dynamic text: "You need to start thinking with your dick, <<$pcs_nickname>>," she giggles gidd...
      scene.text(`"You need to start thinking with your dick, ${((s as any).pcs_nickname || '')}," she giggles giddily as she takes another sip of wine.`);
    }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterWineChat2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMasturbateAnswer2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ...
  scene.actions([
    ...
    scene.text(`"Oh please! Don't be such a prude, ${((s as any).pcs_nickname || '')}!" she says as she rolls her eyes. "I know you do it, everyone does. I have to get off when I feel the urge or I just can't concentrate. Even if you don't do it <i>every</i> day, I know you do."`);
...
function enterPornTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat ?? 0)?.['porn'] === 0) {
    ...
    ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['incest_porn'] = 1;
...
function enterBoobSizeTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pcs_cupsize ?? 0) <= 15) {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSmallTits(s, scene); (s as any).locArgs = __savedLocArgs; }
  } else {
    if (((s as any).pcs_cupsize ?? 0) <= 20) {
      ...
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMediumTits(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      if (((s as any).pcs_cupsize ?? 0) <= 30) {
        ...
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLargeTits(s, scene); (s as any).locArgs = __savedLocArgs; }
      } else {
        ...
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHugeTits(s, scene); (s as any).locArgs = __savedLocArgs; }
      }
    }
  }
  // TODO-QSP: end
...
function enterCommandoTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).trait_vars ?? 0)?.['panty_preference'] === 3) {
    ...
    scene.text(`"Only sluts forget to wear panties ${((s as any).pcs_nickname || '')}."`);
    scene.text('"Shut up!"');
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterWineChat2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
      ]);
...
function enterShaveAnswer1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShaveElaborate(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
...
function enterShaveElaborate(s: GameState, scene: SceneBuilder): void {
  ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['shave_story'] = 1;
...
function enterSmallTits(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pcs_cupsize ?? 0) <= 5) {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMomBoobs(s, scene); (s as any).locArgs = __savedLocArgs; }
    scene.actions([
  ...
  scene.actions([
    ...
    if (((s as any).pcs_cupsize ?? 0) >= 5) {
      ...
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLikeYourBoobs(s, scene); (s as any).locArgs = __savedLocArgs; }
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMomBoobs(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      if (((s as any).pcs_cupsize ?? 0) <= 10) {
        scene.text('"Does it really bother you that much?" you ask, your brow scrunched with incomprehension.');
...
function enterMediumTits(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterEachTheirOwn(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMomBoobs(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
...
function enterBoobPlay(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`She gives you a confused stare. "Seriously, ${((s as any).pcs_nickname || '')}? Why turn into a prude all of a sudden?"`);
    ...
    if (((s as any).pregChem ?? 0) >= 4380) {
      ...
      scene.text(`"Calm down ${((s as any).pcs_nickname || '')}, it wasn't your fault. I should've expected it considering your… condition," she replies before a grin appears on her lips. "It was actually kind of hot."`);
...
function enterCaught(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).AlbinaQW ?? 0)?.['wine_caught'] === 0) {
    ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['wine_caught'] = 1;
  }
  ...
  scene.actions([
    ...
    scene.text(`She calls back down towards you. "Put your clothes on, ${((s as any).pcs_firstname || '')}!"`);
    scene.actions([

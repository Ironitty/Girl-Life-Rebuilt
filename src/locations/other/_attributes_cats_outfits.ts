...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: 4: 5400
  // TODO-QSP: 5: 5600
  // TODO-QSP: CloQuality ranges from 2 to 5, please avoid adding too many 2s and 5s
...
export const _attributes_cats_outfits: LocationDef = {
  name: '_attributes_cats_outfits',
  region: 'other',
  enter: enter,
};

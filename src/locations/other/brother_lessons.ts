...
function enterHomework(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_QW ?? 0)?.['A34'] >= 2  &&  ((s as any).npc_rel ?? 0)?.['A34'] >= 60  &&  ((s as any).ivrand ?? 0) === 1) {
    ...
    (st as any).motherhw = (Math.floor(Math.random() * 5) + 1);
    if (((st as any).motherhw ?? 0) === 5) {
    ...
    scene.text(`"${((st as any).pcs_firstname ?? '')}!" your mother calls again. "What are you doing right now? I need your help in the kitchen! Are you busy?"`);
    ...
    scene.text(`"I think we'll have to call the session early if that's alright with you," you say, purposefully looking down at the sticky cum covering your hands. "I'm gonna go get cleaned up. You should soon too unless you want ${(((st as any).npc_nickname ?? 0)?.['A29'] ?? '')} to catch you with your dick out like that."`);
    ...
    (st as any).ivrand = (Math.floor(Math.random() * 3) + 1);
    if (((st as any).ivrand ?? 0) === 1  &&  ((st as any).brotherQW ?? 0)?.['last_sex_day_evening'] !== ((st as any).daystart ?? 0)) {
      if ((((st as any).sub ?? 0) > 0  &&  ((st as any).brotherQW ?? 0)?.['know_slut'] === 1)  ||  ((st as any).fame ?? 0)?.['pav_slut'] >= 150  ||  ((st as any).brotherQW ?? 0)?.['know_slut'] === 2) {
        scene.text('Kolka boldly slides his hands further upwards, continuing to stroke the insides of your leg, while he tells you:');
        scene.text(`"${((st as any).pcs_nickname ?? '')}, help me with another matter now!"`);
    ...
    qspCall(st, 'brother', '');
        ...
        scene.text(`"${((st as any).pcs_nickname ?? '')}, Can you help me out here now?"`);
    ...
    if (((st as any).npc_QW ?? 0)?.['A34'] < 3) {
      ((st as any).npc_QW = (st as any).npc_QW ?? {})['A34'] = 3;
    }
    qspCall(st, 'npc_relationship', 'modify', 'A34', 2);
    (st as any).pcs_horny = ((st as any).pcs_horny ?? 0) + ((Math.floor(Math.random() * 6) + 5));
...
function enterShowbody(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).brotherQW ?? 0)?.['sex_ed'] < 1) {
    ...
    scene.text(`"${((st as any).pcs_nickname ?? '')}, I promise not a word to anyone!"`);
    ...
    scene.text(`"I'm sorry ${((st as any).pcs_firstname ?? '')}…" he whimpers. "I shouldn't have asked…"`);
    scene.actions([
      { label: 'Finish', handler: (st: GameState) => {
    dynamicGoto(st, 'prevLoc', 'prevArg');
  } },
    ...
    qspCall(st, 'npc_relationship', 'modify', 'A34', (Math.floor(Math.random() * 2) + 2));
    scene.actions([
    ...
    scene.text(`"Thanks ${((st as any).pcs_nickname ?? '')}! So, before I told you I was having trouble understanding the pictures and diagrams," he says, holding out the book to you. "Is there anything you can do to help me understand it better?" You take the book and flip through the pages he's supposed to be studying. Looks like basic anatomy right now, but later on it seems to move into sexual reproduction and general sex ed.`);
...
function enterAnatomylesson1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).brotherQW ?? 0)?.['sex_ed'] > 0) {
    qspGoto(s, 'brother_lessons', 'anatomylesson2');
  }
  ((s as any).brotherQW = (s as any).brotherQW ?? {})['sex_ed'] = ((s as any).brotherQW['sex_ed'] ?? 0) + (1);
  ...
  scene.actions([
    ...
    scene.text(`"Yeah!" he says excitedly. "I think I get it now! You really helped me out ${((st as any).pcs_nickname ?? '')}!" He unexpectedly wraps his arms around you, giving you a big hug. You're surprised by this, mostly because you weren't expecting him to do something like this while you were still naked.`);
...
function enterAnatomylesson2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).brothersexed ?? 0) === 2) {
    qspGoto(s, 'brother_lessons', 'anatomylesson_conception1');
  }
  ...
  scene.actions([
    ...
    if (((st as any).lactation ?? 0)?.['active'] > 0  &&  ((st as any).kid ?? 0) <= 0) {
      ...
      if (((st as any).lactation ?? 0)?.['active'] > 0  &&  ((st as any).kid ?? 0) > 0) {
        if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 1  ||  ((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 2) {
    ...
    if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 1  ||  ((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 2) {
      if (((st as any).brotherQW ?? 0)?.['breastfeed_by_pc'] >= 1  &&  ((st as any).kid ?? 0) >= 0) {
        ...
        if (((st as any).brotherQW ?? 0)?.['breastfeed_by_pc'] <= 0  &&  ((st as any).kid ?? 0) >= 1) {
    ...
    qspCall(st, 'stat', '');
    (st as any).temp_var = qspFunc(s, 'lact_lib', '$get_breastmilk', 0, 1);
    (st as any).milkedvolume = ((st as any).temp_var ?? 0)/6;
    if (((st as any).lactation ?? 0)?.['active'] > 0  &&  ((st as any).milkedvolume ?? 0) >=5) {
      scene.img('images/characters/pavlovsk/resident/kolka/event/homework/anatomylesson/7.jpg');
      ...
      if (((st as any).brotherQW ?? 0)?.['breastfeed_by_pc'] <= 0) {
      ...
      scene.text(`"Oh." he says very matter of factly. "Right. You did just say that. I forgot. I'm sorry ${((st as any).pcs_nickname ?? '')}."`);
      ...
      if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 0  &&  ((st as any).brotherQW ?? 0)?.['know_pc_milk_taste'] <= 0) {
        scene.text('During writing Kolka licks his lips "I didn\'t know you had milk in your breasts. It tastes good!"');
      } else {
        if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 0  &&  ((st as any).brotherQW ?? 0)?.['know_pc_milk_taste'] >= 1) {
          scene.text('During writing Kolka licks his lips "Wow… I didn\'t know you had milk in your breasts… and it tastes familiar…"');
        } else {
          if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 1  &&  ((st as any).brotherQW ?? 0)?.['know_pc_milk_taste'] >= 1) {
            scene.text('During writing Kolka licks his lips and adds "Your milk tastes way better from the source…".');
          } else {
            if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 1  &&  ((st as any).brotherQW ?? 0)?.['know_pc_milk_taste'] <= 0) {
              scene.text('During writing Kolka licks his lips and adds "Hmm - I didn\'t think your milk would taste so good…".');
            } else {
              if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 2  &&  ((st as any).brotherQW ?? 0)?.['know_pc_milk_taste'] >= 1) {
                scene.text('During writing Kolka licks his lips and adds "I didn\'t know you had milk again…"');
                ((st as any).brotherQW = (st as any).brotherQW ?? {})['know_pc_lact'] = 1;
              } else {
                if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 2  &&  ((st as any).brotherQW ?? 0)?.['know_pc_milk_taste'] <= 0) {
      ...
      ((st as any).brotherQW = (st as any).brotherQW ?? {})['know_pc_milk_taste'] = 1;
    } else {
      if (((st as any).lactation ?? 0)?.['active'] > 0  &&  ((st as any).milkedvolume ?? 0) < 5) {
        scene.img('images/characters/pavlovsk/resident/kolka/event/homework/anatomylesson/7.jpg');
        scene.text('You push him back immediately. "Hey! What do you think you\'re doing?! You can\'t just do that to a girl!"');
        ...
        if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] <= 0) {
          ...
          if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 1  &&  ((st as any).brotherQW ?? 0)?.['breastfeed_by_pc'] <= 0) {
            ...
            if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 2) {
        ...
        scene.text('"No!" you say with a stern smile. "I mean… I\'ll think about it. But expect the answer to be more likely no than yes okay?"');
        scene.text('"Mkay," he says, while writing down some things in his notebook.');
        if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 1) {
          ...
          ((st as any).brotherQW = (st as any).brotherQW ?? {})['know_pc_lact'] = 2;
        }
        scene.text('<i><b>sigh</b> Boys…</i>');
        scene.text('Looking at the next part of the homework it talks about the anatomy of the vulva but doesn\'t go on to the internals. At least you\'ll be able to use your arousal for the lesson now…');
      }
    ...
    qspCall(st, 'stat', '');
    if (((st as any).lactation ?? 0)?.['active'] > 0) {
      (st as any).milkedvolume = qspFunc(s, 'lact_lib', '$get_breastmilk', 0, 5);
      (st as any).milkedvolume = ((st as any).milkedvolume ?? 0) + (qspFunc(s, 'lact_lib', '$get_breastmilk', 5, 5));
      if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] <= 0) {
        scene.img('images/characters/pavlovsk/resident/kolka/event/homework/anatomylesson/8.jpg');
        ...
        scene.text(`After 5 minutes of sucking and squirming, your brother finally stops. "${((st as any).pcs_nickname ?? '')}, I didn't know you had milk - and it is so delicious!"`);
        if (((st as any).milkedvolume ?? 0) >= 500) {
        ...
        ((st as any).brotherQW = (st as any).brotherQW ?? {})['know_pc_lact'] = 1;
        ((st as any).brotherQW = (st as any).brotherQW ?? {})['breastfeed_by_pc'] = 1;
      } else {
        if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 1  &&  ((st as any).brotherQW ?? 0)?.['breastfeed_by_pc'] <= 0) {
          scene.img('images/characters/pavlovsk/resident/kolka/event/homework/anatomylesson/8.jpg');
          scene.text('"Kolk-! Ahh~! Wai- Uh~! Sto-… Ohh~!" you try to voice protests but they get lost in your stifled moans.');
          ...
          scene.text('"Ahh~!" A cry briefly escapes your lips before you clamp your own hand over them to make sure the rest of your family doesn\'t overhear you. You can only imagine your mother\'s reaction if she came in to find your brother sucking on your tits like this.');
          scene.text(`After 5 minutes of sucking and squirming, your brother finally stops. "${((st as any).pcs_nickname ?? '')}, it is so delicious, I want seconds!"`);
          if (((st as any).milkedvolume ?? 0) >= 500) {
    ...
    scene.text(`"Okay ${((st as any).pcs_nickname ?? '')}," he says, writing some things down in his notebook.`);
    if (((st as any).kid ?? 0) <= 0  &&  ((st as any).brotherQW ?? 0)?.['know_pc_lact'] <= 0) {
    ...
    scene.actions([
      ...
      (st as any).milkedvolume = qspFunc(s, 'lact_lib', '$get_breastmilk', 0, 2);
      (st as any).milkedvolume = ((st as any).milkedvolume ?? 0) + (qspFunc(s, 'lact_lib', '$get_breastmilk', 5, 2));
      (st as any).milkedvolume = 0;
      if (((st as any).brotherQW ?? 0)?.['know_pc_lact'] === 1) {
        scene.img('images/characters/pavlovsk/resident/kolka/event/homework/anatomylesson/8.jpg');
        scene.text('"Kolk-! Ahh~! Wai- Uh~! Sto-… Ohh~!" you try to voice protests but they get lost in your stifled moans.');
        ...
        scene.text('"Ahh~!" A cry briefly escapes your lips before you clamp your own hand over them to make sure the rest of your family doesn\'t overhear you. You can only imagine your mother\'s reaction if she came in to find your brother sucking on your tits like this.');
        scene.text(`After another minute of sucking and squirming, your brother finally relents. "${((st as any).pcs_nickname ?? '')}, I thought your milk will come out. I've been sucking all this time and nothing's come out. Why's that?" Then he notices your heavy breathing. "Hey, are you okay? Is there something wrong with you?"`);
        ((st as any).brotherQW = (st as any).brotherQW ?? {})['know_pc_lact'] = 2;
        scene.actions([
          { label: 'Continue', handler: (st: GameState) => {
    scene.img('images/characters/pavlovsk/resident/kolka/event/homework/anatomylesson/7.jpg');
    ...
    scene.actions([
      { label: 'Continue the lesson', goto: ['brother_lessons', 'anatomylesson3'] },
        ...
        scene.text('He pulls his lips off with a pop. "Huh. Why isn\'t any milk coming out?" he asks. At last! A respite! You start to catch your breath and just as you\'re about to tell him not to do that again, he leans forward and starts sucking again.');
        scene.text('"Ahh~!" A cry briefly escapes your lips before you clamp your own hand over them to make sure the rest of your family doesn\'t overhear you. You can only imagine your mother\'s reaction if she came in to find your brother sucking on your tits like this.');
        scene.text(`After another minute of sucking and squirming, your brother finally relents. "${((st as any).pcs_nickname ?? '')}, I thought you said milk came out. I've been sucking all this time and nothing's come out. Why's that?" Then he notices your heavy breathing. "Hey, are you okay? Is there something wrong with you?"`);
        scene.actions([
          { label: 'Continue', handler: (st: GameState) => {
    scene.img('images/characters/pavlovsk/resident/kolka/event/homework/anatomylesson/7.jpg');
...
function enterAnatomylesson2_1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_QW ?? 0)?.['A34'] <= 4) {
    ((s as any).npc_QW = (s as any).npc_QW ?? {})['A34'] = 4;
...
function enterAnatomylesson2_4(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_QW ?? 0)?.['A34'] === 4) {
    ((s as any).npc_QW = (s as any).npc_QW ?? {})['A34'] = 5;
    ...
    qspCall(st, 'arousal', 'vaginal_finger', 5, 'incest', 'masturbate');
    qspCall(st, 'arousal', 'clit_finger', 5, 'incest', 'masturbate');
...
function enterAnatomylesson2_5(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'npc_relationship', 'modify', 'A34', (Math.floor(Math.random() * 2) + 2));
  (s as any).ivrand = (Math.floor(Math.random() * 2) + 1);
  ((s as any).brotherQW = (s as any).brotherQW ?? {})['confidence'] = ((s as any).brotherQW['confidence'] ?? 0) + (4);
  if (((s as any).brotherQW ?? 0)?.['confidence'] < 10  &&  ((s as any).brotherQW ?? 0)?.['Sex'] < 4) {
    ...
    scene.img(`images/characters/pavlovsk/resident/kolka/event/homework/f (7.${((st as any).picrand ?? '')}).jpg`);
    if (((st as any).npc_QW ?? 0)?.['A34'] === 5) {
      if (((st as any).npc_QW ?? 0)?.['A34'] === 5) {
        ((st as any).npc_QW = (st as any).npc_QW ?? {})['A34'] = 6;
      }
      ...
      scene.text(`"Kolka, keep your voice down. Do you want ${(((st as any).npc_nickname ?? 0)?.['A29'] ?? '')} to hear you?" you chide him.`);
      ...
      if (((st as any).npc_QW ?? 0)?.['A34'] > 5) {
        ...
        scene.text(`He pulls his pants back up and starts reaching for your clothes, "Come on, ${((st as any).pcs_nickname ?? '')}… that was fun!" He tosses your stuff at you, careful to miss the mess he's left on you.`);
      }
    }
    qspCall(st, 'arousal', 'end');
    scene.actions([
    ...
    if (((s as any).brotherQW ?? 0)?.['Sex'] >= 4) {
      ...
      ((s as any).brotherQW = (s as any).brotherQW ?? {})['sex_count_today'] = ((s as any).brotherQW['sex_count_today'] ?? 0) - (1);
      ((s as any).brotherQW = (s as any).brotherQW ?? {})['last_sex_day_evening'] = ((s as any).daystart ?? 0);
      qspCall(s, 'stat', '');
      (s as any).picrand = (Math.floor(Math.random() * 2) + 1);
      scene.img(`images/characters/pavlovsk/resident/kolka/event/homework/f (6.${((s as any).picrand ?? '')}).jpg`);
      scene.text('You get off the chair and lie down on the carpet. Overcome with lust, you instinctively begin to rub your pussy and breast.');
    ...
    scene.text(`Kolka catches his breath and looks down at you, "Nice one, ${((st as any).pcs_nickname ?? '')}! Good job! Just remember: this is our little secret!" He stands and pulls his pants up before going over to the couch.`);
...
function enterAnatomylesson3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).brotherQW ?? 0)?.['Sex'] === 7) {
      ...
      if ((((st as any).vagtype ?? 0) === 2  ||  ((st as any).vagtype ?? 0) === 3)  &&  ((st as any).stat ?? 0)?.['men_fucked'] > 0) {
        scene.actions([
...
function enterAnatomylesson4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Thanks ${((st as any).pcs_nickname ?? '')}, you're the best!" You smile back at him before going to get dressed.`);
    scene.actions([
    ...
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    (st as any).brother_lesson_oral = 1;
    (st as any).orgasm_or = 'yes';
    qspCall(st, 'arousal', 'cuni', 10, 'no_orgasm_msg');
    ...
    scene.text(`"Ohhh! Kolka~!" you say, pushing his head away with more than a small amount of regret. "As much as I'd love to let you keep going, we have to stop now. We don't want ${(((st as any).npc_nickname ?? 0)?.['A29'] ?? '')} or dad to catch us."`);
...
function enterAnatomylessonConception1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspGoto(st, 'brother_lessons', 'anatomylesson_conception_sex_bc');
  } },
  ]);
  scene.build();
}
...
function enterAnatomylessonConceptionSexBc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).birth_control ?? 0)?.['think_safe'] === 1) {
    ...
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['creampie_allowance'] = ((st as any).daystart ?? 0);
    scene.text(`"Don't worry," you coo. "I'm on the ${(((st as any).birth_control ?? 0)?.['type'] ?? '')}."`);
    scene.actions([
    ...
    qspCall(st, 'npcStat', 'A34', 0, 'normal');
    ...
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['pullout_day'] = ((st as any).daystart ?? 0);
...
function enterAnatomylessonConceptionSex2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    { label: 'Enjoy it', goto: ['brother_lessons', 'anatomylesson_conception_enjoy'] },
    { label: 'Read from the textbook', goto: ['brother_lessons', 'anatomylesson_conception_tutor'] },
    { label: 'Coach him on sex', goto: ['brother_lessons', 'anatomylesson_conception_coach'] },
  ]);
  scene.build();
}
...
function enterAnatomylessonConceptionCum(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).brotherQW ?? 0)?.['creampie_allowance'] === ((s as any).daystart ?? 0)) {
    ...
    scene.actions([
      { label: 'Let him cum inside you', goto: ['brother_lessons', 'anatomylesson_conception_creampie'] },
    ]);
  } else {
    ...
    if ((Math.floor(Math.random() * 10) + 1) >= 7) {
      qspGoto(st, 'brother_lessons', 'anatomylesson_conception_pullout_fail');
    } else {
      qspGoto(st, 'brother_lessons', 'anatomylesson_conception_pullout');
    }
  } },
      ]);
    } else {
      ...
      scene.actions([
        { label: 'Let him cum in the condom', goto: ['brother_lessons', 'anatomylesson_conception_condom_cum'] },
      ]);
    }
  }
  scene.build();
...
function enterAnatomylessonConceptionCreampie(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.actions([
      { label: 'Pull apart', goto: ['brother_lessons', 'anatomylesson_conception_creampie_spill'] },
    ]);
  } },
...
function enterAnatomylessonConceptionPulloutFail(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.actions([
      { label: 'Pull apart', goto: ['brother_lessons', 'anatomylesson_conception_pullout_fail_end'] },
    ]);
  } },
...
function enterAnatomylessonConceptionCondomCum(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((!((st as any).condom_break ?? 0))) {
      qspGoto(st, 'brother_lessons', 'anatomylesson_conception_condom_pull_apart');
    } else {
      qspGoto(st, 'brother_lessons', 'anatomylesson_conception_condom_break');
    }
  } },
  ]);
  scene.build();
...
function enterAnatomylessonConceptionCondomBreak(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Uhh, ${((st as any).pcs_nickname ?? '')}? What happened?"`);
    scene.text('"I think… the condom broke…?"');
    scene.actions([
      { label: 'Pull apart', goto: ['brother_lessons', 'anatomylesson_conception_condom_break2'] },
    ]);
  } },
  ]);
  scene.build();

...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_gentle ?? 0)?.[String((s as any).boy ?? 0)] === 1) {
    ...
    scene.text(`${((s as any).boydesc ?? 0)} closes his eyes in pleasure as he enjoys the caress of your soft lips.`);
    ...
    if (((s as any).npc_rough ?? 0)?.[String((s as any).boy ?? 0)] === 1) {
      ...
      scene.text(`${((s as any).boydesc ?? 0)} grabs you by the hair and begins to mouth fuck you, the beating your throat takes causes tears to flow from your eyes.`);
      ...
      scene.text(`${((s as any).boydesc ?? 0)} stares you in the eyes while you wrap your lips around his rock-hard cock.`);
      qspCall(s, 'arousal', 'bj', ((s as any).tmpl ?? 0), ((s as any).locArgs?.[2] ?? 0), ((s as any).locArgs?.[3] ?? 0), ((s as any).locArgs?.[4] ?? 0), ((s as any).locArgs?.[5] ?? 0), 'sub');
    }
  }

...
function enterLeavingDialogueChoices(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['mad'] === 1  ||  ((s as any).sex_ev ?? 0)?.['angry_after']) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLeavingAction(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
        ]);
      } else {
        scene.actions([
...
function enterLeavingAction(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLeavingEnd(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ...
  if (((s as any).sex_ev ?? 0)?.['sugar_daddy_paid'] === 0  &&  ((s as any).sex_ev ?? 0)?.['prostitution_paid'] === 0) {
    if (((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'sugar_daddy'  &&  ((s as any).sex_ev ?? 0)?.['sugar_daddy_paid'] === 0) {
      if (((s as any).npc_prostitution_tab ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  ((s as any).sex_ev ?? 0)?.['prostitution_bonus'] > 0) {
        // TODO-QSP: dynamic text: Just before you go, <<$npcdesc>> hands you <<$func(''money'', ''string_profit'',...
      ...
      if (((s as any).sex_ev ?? 0)?.['prostitution'] === 1  &&  ((s as any).sex_ev ?? 0)?.['prostitution_paid'] === 0) {
        if (((s as any).npc_prostitution_tab ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  ((s as any).sex_ev ?? 0)?.['prostitution_bonus'] > 0) {
          // TODO-QSP: dynamic text: Before you leave, you make sure to collect the <<$func(''money'', ''string_profi...
...
function enterNpcLeave(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npcID ?? 0) === 'A34') {
    ...
    if (((st as any).sex_ev ?? 0)?.['angry_after'] === 1  ||  ((st as any).sex_ev ?? 0)?.['annoyed'] > 0) {
      ...
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterNpcLeavingAction(s, scene); (st as any).locArgs = __savedLocArgs; }
    }
  } },
    ]);
  } },
...
function enterNpcLeavingAction(s: GameState, scene: SceneBuilder): void {
  if (((s as any).clothingworntype ?? 0) === 'nude') {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterNpcLeavingDialogue(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterNpcLeavingDialogue(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] === '') {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterNpcLeavingEnd(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  } else {
    scene.actions([
...
function enterNpcLeavingEnd(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['invite_today'] === 0  &&  ((s as any).sex_ev ?? 0)?.['invite_tomorrow'] === 0) {
    // TODO-QSP: dynamic text: <<$sex_ev[''leave_action1'']>> <<$sex_ev[''leave_dialogue'']>> <<$sex_ev[''leave...
...
function enterHurryLeave(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['type'] === 'hookup') {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterHurryLeave2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterHurryLeave2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterHurryLeaveFinish(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterBreakupStart(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] !== 'husband'  &&  ((s as any).sex_ev ?? 0)?.['type'] !== 'hookup') {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBreakupMid(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterUnsatisfiedBreakup(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text('"Wait but-"');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterIsntGoingToWork(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    } else {
...
function enterSneakOut1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pantyworntype ?? 0) !== 'none') {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSneakOutNote1(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
...
function enterProstitutionWakeup1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterProstitutionWakeup2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    { label: 'Be transactional', handler: (st: GameState) => {
    qspCall(st, 'npc_relationship', 'modify', ((st as any).npcID ?? 0), 'dislike');
    // TODO-QSP: $sex_ev['bed_room']
    // TODO-QSP: dynamic text: Without any particular courtesy or care, you shake <<$npcdesc>>''s shoulder unti...
...
function enterSneakOutNote1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['fuck_count'] > 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSneakOutNote2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  if (((s as any).sex_ev ?? 0)?.['prostitution'] === 1  &&  ((s as any).sex_ev ?? 0)?.['prostitution_paid'] === 0) {
...
function enterSneakOutNote2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['type'] === 'hookup') {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSneakOutNote3(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterSneakOutNote3(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_makeup ?? 0) > 2) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSneakOutNoteEnd(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterNotLeaving(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['type'] !== 'hookup') {
    ...
    // TODO-QSP: dynamic text: "Not yet," you say, <<$sex_ev[''dress_describe'']>>. "Just tired of hanging out ...
...
function enterGoingDisco(s: GameState, scene: SceneBuilder): void {
  if (((s as any).hour ?? 0) >= 18  &&  (((s as any).week ?? 0) === 5  ||  ((s as any).week ?? 0) === 6)) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDressing2(s, scene); (st as any).locArgs = __savedLocArgs; }
    if (((st as any).sex_ev ?? 0)?.['hookup_continuation_check'] === 0  &&  ((st as any).sex_ev ?? 0)?.['type'] === 'hookup') {
      qspCall(st, 'sex_ev_hookup_leave', 'hookup_continuation');
    }
  } },
...
function enterMomLate(s: GameState, scene: SceneBuilder): void {
  if (((s as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((s as any).hour ?? 0) >= 20  &&  ((s as any).sex_ev ?? 0)?.['loc'] !== 'pc_home') {
    ...
    if (((st as any).hour ?? 0) < 3) {
      // TODO-QSP: dynamic text: "Yeah," you say, <<$sex_ev[''dress_describe'']>>. "I''m already going to be in t...
      ...
      // TODO-QSP: dynamic text: "Yeah," you say, <<$sex_ev[''dress_describe'']>>. "My mom will kill me if I don'...
...
function enterNeedHomework(s: GameState, scene: SceneBuilder): void {
  if (((s as any).lernHome ?? 0) > 0) {
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "I want to go to uni," you say, <<$sex_ev[''dress_describe'']>>. "Can''t do that...
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "Don''t be an asshole," you glare, <<$sex_ev[''dress_describe'']>>. "My grades a...
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "Thanks," you say, <<$sex_ev[''dress_describe'']>>. "It means a lot to me that y...
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "I really want to go to uni," you say, <<$sex_ev[''dress_describe'']>>. "So keep...
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "Damn straight it is," you say, <<$sex_ev[''dress_describe'']>>. "Skipping schoo...
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "No hard feelings, right?" you ask, <<$sex_ev[''dress_describe'']>>. "I really l...
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPantyGift(s, scene); (st as any).locArgs = __savedLocArgs; }
    if (((st as any).sex_ev ?? 0)?.['hookup_continuation_check'] === 0  &&  ((st as any).sex_ev ?? 0)?.['type'] === 'hookup') {
      qspCall(st, 'sex_ev_hookup_leave', 'hookup_continuation');
    }
  } },
...
function enterAnotherFuckbuddy(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['fuckbuddies_current'] > 1) {
    ...
    if (((st as any).sex_ev ?? 0)?.['type'] === 'hookup') {
      ...
      // TODO-QSP: dynamic text: "Yeah," you say, <<$sex_ev[''dress_describe'']>>. "Got another booty call to ans...
    ...
    if (((st as any).sex_ev ?? 0)?.['loc'] === 'pc_home') {
      if (((st as any).sex_ev ?? 0)?.['late_for_school'] === 1  &&  ((st as any).hour ?? 0) >= 8) {
        ...
        if (((st as any).sex_ev ?? 0)?.['late_for_school'] === 1) {
          // TODO-QSP: dynamic text: "I already told you, I''m gonna be late for school," you say, <<$sex_ev[''dress_...
          ...
          if (((st as any).hour ?? 0) === 7) {
            // TODO-QSP: dynamic text: "Gotta get to school," you say, <<$sex_ev[''dress_describe'']>>. "And you gotta ...
            scene.text(`"Gotta get to school," you say, ${((st as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "And you gotta get out of here so I can lock up."`);
          } else {
            // TODO-QSP: dynamic text: "Gotta get ready for school," you say, <<$sex_ev[''dress_describe'']>>. "And you...
...
function enterSchoolNight(s: GameState, scene: SceneBuilder): void {
  if (((s as any).kanikuli ?? 0) === 0  &&  ((s as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((s as any).gschoolVars ?? 0)?.['school_diploma'] === 0  &&  ((s as any).gschoolVars ?? 0)?.['block'] === 0  &&  (((s as any).week ?? 0) < 5  ||  ((s as any).week ?? 0) === 7)  &&  (((s as any).hour ?? 0) > 19  ||  ((s as any).hour ?? 0) < 5)) {
    ...
    scene.text(`"You heading out?" ${((st as any).npcdesc || '')} asks.`);
    if (((st as any).sex_ev ?? 0)?.['loc'] === 'pc_home') {
      // TODO-QSP: dynamic text: "It''s a school night," you say, <<$sex_ev[''dress_describe'']>>. "You gotta go ...
      ...
      // TODO-QSP: dynamic text: "It''s a school night," you say, <<$sex_ev[''dress_describe'']>>. "Gotta get hom...
...
function enterGoChurch1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).week ?? 0) === 6  &&  ((s as any).hour ?? 0) >= 17  &&  ((s as any).hour ?? 0) <= 22  &&  ((s as any).churchday ?? 0) !== ((s as any).daystart ?? 0)) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterGoChurch2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  } else {
    ...
    if (((st as any).hour ?? 0) < 9) {
      // TODO-QSP: dynamic text: "I need to get ready for liturgy this morning," you say, <<$sex_ev[''dress_descr...
...
function enterGoChurchReply(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['fuck_count'] === 0  &&  ((s as any).sex_ev ?? 0)?.['anal_count'] === 0) {
    ...
    if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted') {
      // TODO-QSP: dynamic text: "I love religious girls like you," <<$npc_usedname[$npcID]>> grins. "You''re alw...
      ...
      // TODO-QSP: dynamic text: "You don''t really strike me as the religious type," <<$npc_usedname[$npcID]>> c...
...
function enterGoChurch2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterGoChurchReply(s, scene); (st as any).locArgs = __savedLocArgs; }
    if (((st as any).sex_ev ?? 0)?.['anal_count'] > 0) {
      // TODO-QSP: dynamic text: "It''s only a sin if you do it in the pussy," you explain, <<$sex_ev[''dress_des...
  ...
  scene.actions([
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterGoChurchReply(s, scene); (st as any).locArgs = __savedLocArgs; }
    // TODO-QSP: dynamic text: "I need to keep up appearances or everybody will know I''m a slut," you smirk jo...
    ...
    if (((st as any).sex_ev ?? 0)?.['fuck_count'] === 0  &&  ((st as any).sex_ev ?? 0)?.['anal_count'] === 0) {
      // TODO-QSP: dynamic text: "It''s not that," you add, <<$sex_ev[''dress_describe'']>>. "It''s my mother. Th...
      ...
      // TODO-QSP: dynamic text: "I''m <i>not</i> religious," you huff, <<$sex_ev[''dress_describe'']>>. "I just ...
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterGoChurchReply(s, scene); (st as any).locArgs = __savedLocArgs; }
    // TODO-QSP: dynamic text: "Well, after I sin, I need to repent, don''t I?" you say, <<$sex_ev[''dress_desc...
...
function enterPantyGift2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "To remember my virginity," you smile, <<$sex_ev[''dress_describe'']>>. "And tha...
  ...
  if (((s as any).sex_ev ?? 0)?.['orgasm_count'] > 0) {
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "For making me come," you smile, <<$sex_ev[''dress_describe'']>>. "That deserves...
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    if (((st as any).npc_panty_give ?? 0)?.[String((st as any).npcID ?? 0)] <= 1) {
      // TODO-QSP: dynamic text: "For making me come," you smile, <<$sex_ev[''dress_describe'']>>. "I always give...
      ...
      // TODO-QSP: dynamic text: "Cause you made me come," you smile, <<$sex_ev[''dress_describe'']>>. "You know ...
  ...
  scene.actions([
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "You did a good job," you smile, <<$sex_ev[''dress_describe'']>>. "Consider that...
    ...
    if (((st as any).daystage ?? 0) > 3) {
      // TODO-QSP: dynamic text: "Something to remember the night," you smile, <<$sex_ev[''dress_describe'']>>. "...
      scene.text(`"Something to remember the night," you smile, ${((st as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "Keep the good times in mind."`);
    } else {
      // TODO-QSP: dynamic text: "Something to remember the day," you smile, <<$sex_ev[''dress_describe'']>>. "Ke...
    ...
    qspCall(st, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "A trophy," you smile, <<$sex_ev[''dress_describe'']>>. "Consider it proof of co...
...
function enterPantyGiftGirlfriend(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: "Just hide them," you say, <<$sex_ev[''dress_describe'']>>. "If you can hide a f...
    ...
    // TODO-QSP: dynamic text: "Tell her they''re yours," you shrug with a wry smirk, <<$sex_ev[''dress_describ...
    ...
    // TODO-QSP: dynamic text: You move to <<$sex_ev[''dress_describe'']>> but <<$npcdesc>> continues to glare ...
    ...
    // TODO-QSP: dynamic text: You start <<$sex_ev[''dress_describe'']>> but <<$npcdesc>> continues to glare at...
    ...
    // TODO-QSP: dynamic text: "Gift them to her," you say mischievously, <<$sex_ev[''dress_describe'']>>. "May...
    ...
    // TODO-QSP: dynamic text: "Throw them away then," you shrug, <<$sex_ev[''dress_describe'']>>. "I don''t ca...
    scene.text(`"Throw them away then," you shrug, ${((st as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "I don't care. Do whatever you want with them.`);
    qspCall(st, 'sex_ev_clothing', 'dress_loop_code');
    // TODO-QSP: dynamic text: "After all, they''re your panties now," you add with a smirk, <<$sex_ev[''dress_...

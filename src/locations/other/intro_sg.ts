...
function enterIntroPavlovsk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: You tiredly open your eyes and see your <<$npc_nickname[''A29'']>> standing over...
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname[''A29'']>> lets out a loud sigh before she yanks the covers...
    ...
    scene.text('<center><b>Your Bedroom</b></center>');
    scene.img('images/characters/pavlovsk/resident/mom/prost4.jpg');
    // TODO-QSP: dynamic text: As soon as you get off your now coverless bed, your <<$npc_nickname[''A29'']>> i...
...
function enterIntroGadukino(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text('<center><h4>Your Grandparents\' Cottage</h4></center>');
    scene.img('images/characters/pavlovsk/resident/mom/prost5.jpg');
    // TODO-QSP: dynamic text: You tiredly open your eyes, seeing your <<$npc_nickname[''A29'']>> standing over...
    scene.text(`You tiredly open your eyes, seeing your ${((st as any).npc_nickname ?? 0)?.['A29'] ?? ''} standing over you. "Fifteen more minutes…"`);
    // TODO-QSP: dynamic text: Your <<$npc_nickname[''A29'']>> lets out a loud sigh before she yanks the covers...
    scene.text(`Your ${((st as any).npc_nickname ?? 0)?.['A29'] ?? ''} lets out a loud sigh before she yanks the covers off. "No. Up, now!"`);
    // TODO-QSP: dynamic text: "<<$npc_nickname[''A29'']>>!" you exclaim as you feel a slight cold breeze hit y...
...
function enterIntroPushkin(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: You realise you didn''t even have a chance to thank him for helping, but then ag...
...
function enterIntroSharing(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname[''A29'']>> shoots you a sharp look and you know there''s no...

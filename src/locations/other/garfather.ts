...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_horny ?? 0) > 50  &&  ((s as any).npc_had_sex ?? 0)?.['A28']) {
    ...
    scene.text(`You continue to suck your stepfather's dick as it continues throbbing. Suddenly, he arches his back and you feel cum begin to pour into your mouth. Although you try your best, the amount of cum flowing from your stepfathers dick is simply too much for you, and some of it instead flows out of your mouth and down your chin. Soon your ${((s as any).boydesc || '')} finishes and you pull his cock out of your sperm-smelling mouth. You can feel the taste of sperm in your mouth, and your ${((s as any).pc_desc ?? 0)?.['lips'] ?? ''} lips are wet with cum.`);
    ...
    if (((s as any).gar_rand1 ?? 0) < 49) {
      ...
      scene.text(`<center><img ${((s as any).set_imgh || '')} src="images/shared/sex/cum/facial/facial0,${Math.floor(Math.random() * 9) + 0}.jpg"></center>`);
    }
  ...
  scene.actions([
    ...
    if (((s as any).npc_rel ?? 0)?.['A28'] < 20) {
      ...
      scene.text(`You offer to help your stepfather out in the garage. He waves you away and grumpily says "Get out of the way ${((s as any).pcs_nickname || '')}, can't you see I'm busy? Besides, why would I want to be around you?"`);
      if (((s as any).sorryday ?? 0) !== ((s as any).daystart ?? 0)) {
        qspCall(s, 'willpower', 'misc', 'self');
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          scene.actions([
    ...
    if (((s as any).fatherLust ?? 0) >=2) {
      ...
      if (((s as any).pantyworntype ?? 0) !== 'none') {
        // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/characters/pavlovsk/resident/vladimir/sex...
        scene.text(`<center><img ${((s as any).set_imgh || '')} src="images/characters/pavlovsk/resident/vladimir/sex/fatherim29.jpg"></center>`);
      ...
      if (((s as any).pantyworntype ?? 0) === 'none') {
        // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/characters/pavlovsk/resident/vladimir/sex...
        scene.text(`<center><img ${((s as any).set_imgh || '')} src="images/characters/pavlovsk/resident/vladimir/sex/fatherim27.jpg"></center>`);

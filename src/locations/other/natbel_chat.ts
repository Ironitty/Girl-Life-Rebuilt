  ...
  scene.actions([
    ...
    if (((s as any).NatbelQW ?? 0)?.['homework'] < 5) {
      ...
      if (((s as any).NatbelQW ?? 0)?.['FriendLover'] === 0) {
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLoanEventsChat(s, scene); (s as any).locArgs = __savedLocArgs; }
      } else {
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLoverEventsChat(s, scene); (s as any).locArgs = __savedLocArgs; }
      }
    }
  } },
  ]);
...
function enterLoanEventsChat(s: GameState, scene: SceneBuilder): void {
  if (((s as any).NatbelQW ?? 0)?.['Debt'] > 0) {
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['Debt'] = 5000;
    ((s as any).NatashaQW = (s as any).NatashaQW ?? {})['demand_repayment'] = 0;
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['DebtDay'] = ((s as any).daystart ?? 0) + 30;
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['MoneyGivenTimes'] = ((s as any).NatbelQW['MoneyGivenTimes'] ?? 0) + (1);
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['QWstage'] = 2;
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/school/girl/natasha/bedtalk.jpg');
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['Debt'] = 2000;
    ((s as any).NatashaQW = (s as any).NatashaQW ?? {})['demand_repayment'] = 0;
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['DebtDay'] = ((s as any).daystart ?? 0) + 14;
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['MoneyGivenTimes'] = ((s as any).NatbelQW['MoneyGivenTimes'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/school/girl/natasha/bedtalk.jpg');
    if (((s as any).NatbelQW ?? 0)?.['MoneyGivenTimes'] < 4) {
      ...
      scene.text(`"Thank you ${((s as any).pcs_nickname || '')}, you're the best. I promise you'll have it back within two weeks."`);
      scene.actions([
        { label: 'Keep talking', goto: ['natbel_chat', 'chat'] },
        { label: 'Stop talking', goto: ['natbelapt', 'natroom'] },
      ]);
      ...
      if (((s as any).NatbelQW ?? 0)?.['MoneyGivenTimes'] < 7) {
        ...
        scene.text(`"Thank you ${((s as any).pcs_nickname || '')}, you're the best. I promise you won't regret it."`);
        scene.actions([
          { label: 'Keep talking', goto: ['natbel_chat', 'chat'] },
          { label: 'Stop talking', goto: ['natbelapt', 'natroom'] },
        ]);
...
function enterDemandDebtRepayment(s: GameState, scene: SceneBuilder): void {
  if (((s as any).NatbelQW ?? 0)?.['QWstage'] === 2) {
    ...
    ((s as any).NatashaQW = (s as any).NatashaQW ?? {})['demand_repayment'] = 1;
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['QWstage'] = 3;
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/school/girl/natasha/bedtalk.jpg');
    // TODO-QSP: dynamic text: You decide not to reduce Natasha's debt. You angrily confront her, demanding tha...
    scene.text(`You decide not to reduce Natasha's debt. You angrily confront her, demanding that she return the money to you, one way or another. Natasha curls up into a ball on her bed: "${((s as any).pcs_nickname || '')}, I'm so sorry! I will do anything you say! Anything!"`);
...
function enterForgiveChat(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).NatbelQW ?? 0)?.['QWstage'] < 3) {
    ...
    qspGoto(s, 'natbel_chat', 'debt_forgive2');
  } },
    ]);
  }
  // TODO-QSP: end
  scene.actions([
    ...
    scene.text(`Natasha smiles and nods her acceptance and says. "Of course ${((s as any).pcs_nickname || '')}, but you know with the homework, whilst I can do it for you if we did it together I can also show you how to do the parts you don't understand."`);
...
function enterForgiveChat2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`She pauses then shakes her head slowly. "No ${((s as any).pcs_nickname || '')} I should be okay."`);
...
function enterDebtForgive(s: GameState, scene: SceneBuilder): void {
  if (((s as any).NatbelQW ?? 0)?.['Debt'] > 0  &&  ((s as any).daystart ?? 0) >= ((s as any).NatbelQW ?? 0)?.['DebtDay']) {
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['DebtDay'] = 0;
    ((s as any).NatashaQW = (s as any).NatashaQW ?? {})['demand_repayment'] = 0;
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['DebtForgiven'] = ((s as any).NatbelQW['DebtForgiven'] ?? 0) + (1);
...
function enterDebtForgive2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['chrispaid'] = 1;
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['chrispaid'] = 2;
...
function enterChrisChatSub(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['chrispaid'] = 7;
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'stat', '');
    ...
    scene.text(`Natasha turns to you with a weak smile and gives you a sweet kiss. "Well, I guess we're both in the same boat here, ${((s as any).pcs_nickname || '')}. Let's just support each other as best we can."`);
...
function enterChrisChat(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['chrispaid'] = 6;
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/school/girl/natasha/events/bullied/natasha3.jpg');
    ...
    scene.text(`Natasha turns to you and gives you a sweet kiss. "Thank you, ${((s as any).pcs_nickname || '')}."`);
    ...
    scene.text(`"You know, ${((s as any).pcs_nickname || '')}, I like hearing you call me that."`);
    ...
    scene.text(`Natasha turns to you and gives you a sweet kiss. "Okay, I guess I don't need to know everything but thank you, ${((s as any).pcs_nickname || '')}."`);
...
function enterLoverEventsChat(s: GameState, scene: SceneBuilder): void {
  if (((s as any).NatbelQW ?? 0)?.['chrispaid'] === 1  &&  (((s as any).NatbelQW ?? 0)?.['evt_day'] + 1) <= ((s as any).daystart ?? 0)) {
    ...
    scene.text(`Natasha looks at you with a weak smile, "Don't worry, ${((s as any).pcs_nickname || '')}. I've learned my lesson! And thank you for helping me clear all my debts; it was such a worry."`);
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['chrispaid'] = 4;
    scene.actions([
      { label: 'Return to her room', goto: ['natbelapt', 'natroom'] },
    ]);
  } },
    ...
    scene.text(`Natasha sees your expression, "Yes, yes, ${((s as any).pcs_nickname || '')}, I swear! I just ran out of money; I was so worried as I had loads of little debts and couldn't keep track anymore and I was getting pressured for repayment. I repaid all but Christina's. I was going to do it but Mum needed some help and once I'd done that, I ran out of cash." She continues, "Did… umm, did she say anything?"`);
    scene.actions([
    ...
    scene.text(`"Okay, ${((s as any).pcs_nickname || '')}," she sniffles. "Thanks!"`);
    ...
    scene.text(`"Yes, okay, ${((s as any).pcs_nickname || '')}. I'm just not used to this."`);
    scene.actions([
      { label: 'Keep talking', goto: ['natbel_chat', 'chat'] },
    ]);
  } },
...
function enterFirstKiss(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['FriendLover'] = 2;
    qspCall(s, 'npc_relationship', 'modify', 'A16', 'like');
    scene.img('images/characters/pavlovsk/school/girl/natasha/events/bullied/natasha5.jpg');
...
function enterLoverChat(s: GameState, scene: SceneBuilder): void {
  if (((s as any).NatbelQW ?? 0)?.['FriendLover'] === 3) {
    ...
    if (qspFunc(s, 'money', 'can_afford', 2550) === 0) {
      ...
      qspGoto(s, 'natbel_friend', 'shopping_trip');
    }
  } },
        ]);
      }
    ...
    if (qspFunc(s, 'money', 'can_afford', 4350) === 0) {
      ...
      qspGoto(s, 'natbel_friend', 'shopping_trip2');
    }
  } },
            ]);
          }
    ...
    if (qspFunc(s, 'money', 'can_afford', 2100) === 0) {
      ...
      qspGoto(s, 'natbel_friend', 'city_date1');
    }
  } },
                ]);
              }
...
function enterArrangeShopTrip1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['FriendLover'] = 4;
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['evt_day'] = ((s as any).daystart ?? 0);
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'stat', '');
    ...
    scene.text(`"Oh, ${((s as any).pcs_nickname || '')}, that would be lovely. But…"`);
    scene.actions([
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}, that would be lovely and I'll earn some money too so we can go and get something to eat after."`);
...
function enterArrangeShopTrip2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['FriendLover'] = 6;
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['evt_day'] = ((s as any).daystart ?? 0);
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/school/girl/natasha/events/bullied/natasha6.jpg');
    ...
    scene.text(`You smile at her, "Like I said earlier, I want to get you a general outfit for going out and about. I was thinking we could head off to Coco and Flamingos to see what they've got. Oh and before you reply, the only answer I'll accept is 'Yes, ${((s as any).pcs_nickname || '')}'!`);
    // TODO-QSP: dynamic text: "Oh, yes, <<$pcs_nickname>>! That would be lovely! Thank you. I'll look forward ...
    scene.text(`"Oh, yes, ${((s as any).pcs_nickname || '')}! That would be lovely! Thank you. I'll look forward to it."`);
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    ...
    scene.text(`She looks at you still smiling and says. "So no smacks then, ${((s as any).pcs_nickname || '')}?"`);
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}, you know that you don't have to keep spoiling me! I'm just happy you want to be my friend and now my girlfriend," she says with a broad grin."`);
...
function enterJobQuestions(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Erm… ${((s as any).pcs_nickname || '')}…"`);
    ...
    scene.text(`Natasha looks a little embarrassed. "Look ${((s as any).pcs_nickname || '')} if you don't want to I guess that's fine at least for now. I'm just interested and if you need any help with anything you know I'll be here for you."`);
    scene.actions([
    ...
    scene.text(`"No, ${((s as any).pcs_nickname || '')} I guess that's fine. I'm just curious as I want to know more about you." She pauses. "I guess it really doesn't matter."`);
    ...
    scene.text(`"Of course I won't ${((s as any).pcs_nickname || '')}. I'm just asking because I care about you."`);
    ...
    if (Object.keys((s as any).temp_pav_work ?? {}).length > 0) {
      (s as any).temp_text = '"Right, well I work in Pav as ';
      ...
      scene.text(`${((s as any).temp_text || '')} You pause then giggle. "Happy little Miss nosey?" You say tapping her gently on the nose."`);
      // TODO-QSP: dynamic text: "Thank you <<$pcs_nickname>>." Natasha smiles at you. "I was just curious as I t...
      scene.text(`"Thank you ${((s as any).pcs_nickname || '')}." Natasha smiles at you. "I was just curious as I thought you might work in St. Petersburg.`);
    }
    if (Object.keys((s as any).temp_city_work ?? {}).length === 0  &&  Object.keys((s as any).temp_pav_work ?? {}).length > 0) {
      ...
      if (Object.keys((s as any).temp_city_work ?? {}).length > 0) {
        ...
        scene.text(`"Okay ${((s as any).pcs_nickname || '')} that's fine and umm…"`);
    ...
    scene.text(`"One second ${((s as any).pcs_nickname || '')}, I'l be back in a moment. Just need to go to the kitchen quickly. I left something on the stove…"`);
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['StP_trip_daystart'] = ((s as any).daystart ?? 0) + 14 + (13 - ((s as any).week ?? 0)) % 7;
    ((s as any).NatbelQW = (s as any).NatbelQW ?? {})['shopping'] = 3;
    if (((s as any).temp_runner ?? 0) === 1) {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterJobQuestionsRunner(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterJobQuestionsNatbelReturns(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
  } },
    ]);
  } },
...
function enterJobQuestionsRunner(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Natasha looks at you a bit confused. "Eh?! Why's that ${((s as any).pcs_nickname || '')}?"`);
    ...
    scene.text(`"Oh! Shit sorry ${((s as any).pcs_nickname || '')} I got a bit sidetracked!"`);
    ...
    scene.text(`"Okay ${((s as any).pcs_nickname || '')} I won't be a sec."`);
    ...
    scene.text(`"Pant… Pant… Are you trying to kill me ${((s as any).pcs_nickname || '')}?!"`);
    ...
    scene.text(`"Oh ${((s as any).pcs_nickname || '')} I desperately need a shower after that… Erm… Join me?"`);
    ...
    scene.text(`Oh! Fuck! ${((s as any).pcs_nickname || '')}! I'm going to…"`);
    ...
    scene.text(`"Yes… ${((s as any).pcs_nickname || '')}." She looks confused; probably because of your choice of post passion topic.`);
    ...
    scene.text(`Natasha continues to look confused and the expression on her face is an absolute picture. "Sorry ${((s as any).pcs_nickname || '')}; you mean…" She stops, goes bright red and turns to you looking worried and somewhat horrified.`);
    ...
    scene.text(`"Sorry! Wow! Fuck! Sorry Umm… Sorry I didn't know! You must think I'm a really shitty girlfriend not to have known that! I'm really sorry ${((s as any).pcs_nickname || '')}!"`);
    ...
    scene.text(`Natasha slowly regains her composure. "Oh yes ${((s as any).pcs_nickname || '')}! I'd love that! Thank you so much." She pauses then gives you a big hug then jumps up.`);
    // TODO-QSP: dynamic text: "One second <<$pcs_nickname>>, I'll be back in a moment. Just need to go to the ...
    scene.text(`"One second ${((s as any).pcs_nickname || '')}, I'll be back in a moment. Just need to go to the kitchen quickly. I left something on the stove and it should be cooked by now…"`);
    ...
    scene.text(`Natasha's smile widens. "Oh yes ${((s as any).pcs_nickname || '')}! That'll be lovely. Umm… However, you need to give me a couple of weeks as I want to arrange a small surprise for you as a thank you for all your help."`);
    ...
    scene.text(`"Yes I know ${((s as any).pcs_nickname || '')} but I want to. I'll need a couple of weeks if that's okay?"`);
    ...
    scene.text(`"Sorry! Wow! Oh yes ${((s as any).pcs_nickname || '')} I'd love that! Thank you so much."`);
...
function enterPregChat(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_pregtalk ?? 0)?.['A16'] === 0  &&  (!((s as any).kid ?? 0))) {
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}, you're," she pauses momentarily before continuing in a tone of shock mixed with disgust, "pregnant? Have you been sleeping around? This will definitely impact your studies."`);
    scene.actions([
      { label: 'Continue', goto: ['natbelapt', 'natroom'] },
    ]);
  } },
    ...
    if (((s as any).wombthfath ?? 0) === ''  ||  ((s as any).wombthfathID ?? 0) === 'unknown') {
      ...
      scene.text(`You tell her that ${((s as any).wombthfath || '')} is the father and then give her brief details as to how you got pregnant, without getting too explicit.`);
      scene.text('"Really? That\'s crazy." Natasha whispers, rubbing her midriff longingly.');
      scene.actions([
        { label: 'Continue', goto: ['natbelapt', 'natroom'] },
      ]);

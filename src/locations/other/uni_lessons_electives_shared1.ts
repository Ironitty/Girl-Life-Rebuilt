...
function enterObeyKendra(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'BDSM', 1, ((s as any).npcID1 ?? 0), 'humiliation', 'sub', 'lesbian');
    qspCall(s, 'arousal', 'hj', (-1), ((s as any).npcID ?? 0), 'humiliation', 'sub');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Suck his cock', handler: (st: GameState) => {
    if (!(s as any).kendraQW) (s as any).kendraQW = {}; (s as any).kendraQW['classroom_sex'] = ((s as any).kendraQW['classroom_sex'] ?? 0) + (0);
    ...
    scene.text(`You open your mouth while grabbing his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick with your hand and guiding it into your mouth. You stroke the shaft of his cock with one hand while you close your lips around and start sucking on it. You can hear him softly moan as you do.`);
    ...
    qspCall(s, 'arousal', 'BDSM', (-1), ((s as any).npcID1 ?? 0), 'humiliation', 'sub', 'lesbian');
    qspCall(s, 'arousal', 'bj', 1, ((s as any).npcID ?? 0), 'humiliation', 'sub', 'deepthroat');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'BDSM', (-1), ((s as any).npcID1 ?? 0), 'humiliation', 'sub', 'lesbian');
    qspCall(s, 'arousal', 'bj', 1, ((s as any).npcID ?? 0), 'humiliation', 'sub', 'deepthroat', 'rough');
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterObeyKendraLaydown(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'BDSM', (-1), ((s as any).npcID1 ?? 0), 'humiliation', 'sub', 'lesbian');
    qspCall(s, 'arousal', 'vaginal', 2, ((s as any).npcID ?? 0), 'humiliation', 'sub');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'vaginal', 2, ((s as any).npcID ?? 0), 'humiliation', 'sub', 'rough');
    qspCall(s, 'arousal', 'cuni_give', (-2), ((s as any).npcID1 ?? 0), 'humiliation', 'sub', 'rough', 'lesbian');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Get fucked', handler: (st: GameState) => {
    ...
    qspCall(s, 'arousal', 'vaginal', 2, ((s as any).npcID ?? 0), 'humiliation', 'sub', 'rough');
    qspCall(s, 'arousal', 'clit_finger', (-2), ((s as any).npcID ?? 0), 'humiliation', 'sub', 'rough');
    qspCall(s, 'arousal', 'cuni_give', (-2), ((s as any).npcID1 ?? 0), 'humiliation', 'sub', 'rough', 'lesbian');
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterObeyKendraOffdesk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: When you don't say anything, he moves up behind you and rubs the tip of his cock...
    scene.text(`When you don't say anything, he moves up behind you and rubs the tip of his cock against your asshole. He pushes hard until the head of his cock pops painfully into your ass, causing you to gasp and whine in pain. "Go on, shove that big black cock of yours into that tiny tight asshole and rip it up!" Kendra barks as you close your eyes against the growing pain. You let out a pained yelp as his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick is shoved deeper into your unlubed asshole.`);
    qspCall(s, 'arousal', 'BDSM', (-1), ((s as any).npcID1 ?? 0), 'humiliation', 'sub');
    qspCall(s, 'arousal', 'anal', 2, ((s as any).npcID ?? 0), 'humiliation', 'sub');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'anal', 2, ((s as any).npcID ?? 0), 'humiliation', 'sub', 'rough');
    qspCall(s, 'arousal', 'rimming', (-2), ((s as any).npcID1 ?? 0), 'humiliation', 'sub', 'rough', 'lesbian');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'anal', 2, ((s as any).npcID ?? 0), 'humiliation', 'sub', 'rough');
    qspCall(s, 'arousal', 'rimming', (-2), ((s as any).npcID1 ?? 0), 'humiliation', 'sub', 'lesbian');

...
export const nichApartment: LocationDef = {
  ...
  region: 'other',
  locationType: 'event',
  description: ['The address you have been given leads you to a very expensive looking apartment building. A porter stands at the door, inspecting you while you come closer.'],
  enter: enter,
};

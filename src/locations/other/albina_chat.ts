...
function enterTopicMenu(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMaidConversation(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLazarConversation(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterZoyaConversation(s, scene); (st as any).locArgs = __savedLocArgs; }
    if (((st as any).NikoPayback ?? 0) === 2  &&  ((st as any).AlbinaQW ?? 0)?.['niko_help'] === 0) {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterNikoHelpTalk(s, scene); (st as any).locArgs = __savedLocArgs; }
    }
    scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterFunTalk(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterExerciseTalk(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDietTalk(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPajamaTalk(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterClothingConversation(s, scene); (st as any).locArgs = __savedLocArgs; }
    scene.actions([
      { label: 'Talk about something else', handler: (st: GameState) => {
    qspCall(st, 'albina_chat', 'topic_menu');
  } },
...
function enterJobTalk1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).job_status ?? 0)?.['city_strip_stripper'] === 'employed') {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterStripperTalk1(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
...
function enterPornstarTalk1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).AlbinaQW ?? 0)?.['porno'] > 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
        { label: 'Casual', handler: (st: GameState) => {
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['porn_talk'] = 'casual';
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
...
function enterPornstarTalk2_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk3_1(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk3_2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterPornstarTalk2_2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterAlbinaPornRant1(s, scene); (st as any).locArgs = __savedLocArgs; }
...
function enterPornstarTalk2_4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterAlbinaPornRant2(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk3_1(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk3_2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
...
function enterPornstarTalk4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4_1(s, scene); (st as any).locArgs = __savedLocArgs; }
    if (((st as any).AlbinaQW ?? 0)?.['porn_talk'] !== 'embarrassed') {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4_2(s, scene); (st as any).locArgs = __savedLocArgs; }
    }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4_3(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4_4(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterPornstarTalk4_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4_5(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterCommandoTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).trait_vars ?? 0)?.['panty_preference'] > 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCommandoReply(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterPubeTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).region ?? 0) === 'pav') {
      ...
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPubeTalk2(s, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
...
function enterGrowPubesChat1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterGrowPubesChat2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterLazarConversation(s: GameState, scene: SceneBuilder): void {
  if (((s as any).AlbinaQW ?? 0)?.['Lazar_Sex'] === 1) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLoverConversation(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterLoverConversation(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).rex_love ?? 0) === 1  ||  ((s as any).artemQW ?? 0)?.['bf'] === 1  ||  ((s as any).kotovLoveQW ?? 0) === 1  ||  ((s as any).fedorKozlovQW ?? 0)  ||  ((s as any).NikoVolkovQW ?? 0) >= 5  ||  ((s as any).stat ?? 0)?.['boyfriends_current'] > 0) {
    ...
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    scene.text('She grins at you. "Right, so who are you dating again?"');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLoverNikoTalk(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLoverFedorTalk(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLoverArtemTalk(s, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLoverRexTalk(s, scene); (st as any).locArgs = __savedLocArgs; }
    (st as any).i = 0;
...
function enterExerciseTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterExerciseReply(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}

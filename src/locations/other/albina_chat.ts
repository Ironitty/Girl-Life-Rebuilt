...
function enterTopicMenu(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMaidConversation(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLazarConversation(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterZoyaConversation(st, scene); (st as any).locArgs = __savedLocArgs; }
    if (((st as any).NikoPayback ?? 0) === 2  &&  ((st as any).AlbinaQW ?? 0)?.['niko_help'] === 0) {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterNikoHelpTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    }
    scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterFunTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterExerciseTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDietTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPajamaTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
...
function enterJobTalk1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).region ?? 0) === 'city') {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSmallTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
  ...
  if (((s as any).job_status ?? 0)?.['city_strip_stripper'] === 'employed') {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterStripperTalk1(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  if (((s as any).job_status ?? 0)?.['city_strip_bargirl'] === 'employed') {
    ...
    qspCall(st, 'albina_chat', 'bargirl_talk1');
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterStripperTalk1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).region ?? 0) === 'city') {
    ...
    if (((st as any).age ?? 0) < 18) {
      ...
      if (((st as any).start_type ?? 0)?.['group'] === 'gopnik') {
    ...
    if (((st as any).age ?? 0) < 18) {
      ...
      if (((st as any).start_type ?? 0)?.['group'] === 'gopnik') {
        ...
        // TODO-QSP: dynamic text: "I got a fake passport," you admit with a shrug. "It wasn''t easy, but it gets m...
...
function enterPornstarTalk1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).AlbinaQW ?? 0)?.['porno'] > 0) {
    scene.actions([
      { label: 'Embarrassed', handler: (st: GameState) => {
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['porn_talk'] = 'embarrassed';
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      { label: 'Casual', handler: (st: GameState) => {
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['porn_talk'] = 'casual';
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    ...
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['porn_talk'] = 'happy';
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
        { label: 'Casual', handler: (st: GameState) => {
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['porn_talk'] = 'casual';
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
...
function enterPornstarTalk2_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).AlbinaQW ?? 0)?.['porn_talk'] === 'embarrassed') {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk3_1(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk3_2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterPornstarTalk2_2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterAlbinaPornRant1(st, scene); (st as any).locArgs = __savedLocArgs; }
...
function enterPornstarTalk2_4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterAlbinaPornRant2(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk3_1(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk3_2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
...
function enterPornstarTalk3_2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['porn_fight'] = 1;
...
function enterPornstarTalk4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4_1(st, scene); (st as any).locArgs = __savedLocArgs; }
    if (((st as any).AlbinaQW ?? 0)?.['porn_talk'] !== 'embarrassed') {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4_2(st, scene); (st as any).locArgs = __savedLocArgs; }
    }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4_3(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4_4(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterPornstarTalk4_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPornstarTalk4_5(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterUnderwearTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).trait_vars ?? 0)?.['panty_preference'] === 3) {
    ...
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['commando_know'] = 3;
    scene.actions([
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: "I''ll have you know I get all my thongs from a seedy sex shop in the red light ...
...
function enterCommandoTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).trait_vars ?? 0)?.['panty_preference'] > 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCommandoReply(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterCommandoReply(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).trait_vars ?? 0)?.['panty_preference'] === 3) {
      ...
      if (((st as any).trait_vars ?? 0)?.['panty_preference'] === 2) {
...
function enterPubeTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).region ?? 0) === 'pav') {
      ...
      if (((st as any).AlbinaQW ?? 0)?.['shower_caught'] === 0) {
        ...
        if (((st as any).AlbinaQW ?? 0)?.['shower_caught'] === 1) {
      ...
      if ((Math.floor(Math.random() * 100) + 1) < ((st as any).pcs_prcptn ?? 0)) {
        ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['pube_hint'] = 1;
      ...
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPubeTalk2(st, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
...
function enterPubeTalk2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pube_style ?? 0)?.['word'] === 'shaved') {
    ...
    if (((st as any).AlbinaQW ?? 0)?.['pube_hint'] === 1) {
...
function enterGrowPubesChat1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterGrowPubesChat2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterLazarConversation(s: GameState, scene: SceneBuilder): void {
  if (((s as any).AlbinaQW ?? 0)?.['Lazar_Sex'] === 1) {
    ...
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['Lazar_Sex'] = 2;
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    if (((st as any).AlbinaQW ?? 0)?.['Lazar_Threesome'] >= 1) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLoverConversation(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterLoverConversation(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).rex_love ?? 0) === 1  ||  ((s as any).artemQW ?? 0)?.['bf'] === 1  ||  ((s as any).kotovLoveQW ?? 0) === 1  ||  ((s as any).fedorKozlovQW ?? 0)  ||  ((s as any).NikoVolkovQW ?? 0) >= 5  ||  ((s as any).stat ?? 0)?.['boyfriends_current'] > 0) {
    ...
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    scene.text('She grins at you. "Right, so who are you dating again?"');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLoverNikoTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLoverFedorTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLoverArtemTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLoverRexTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    (st as any).i = 0;
...
function enterLoverKolkaTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).brotherQW ?? 0)?.['Sex'] > 0) {
    ...
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    if (((st as any).AlbinaQW ?? 0)?.['kolka_know'] === 0) {
      ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['kolka_know'] = 1;
    ...
    if (((st as any).brotherwakeup ?? 0) > 0) {
    ...
    scene.actions([
      ...
      if (((st as any).brotherQW ?? 0)?.['Sex'] === 9) {
        scene.actions([
    ...
    scene.actions([
      ...
      if (((st as any).brotherQW ?? 0)?.['Sex'] === 10) {
        scene.actions([
...
function enterZoyaConversation(s: GameState, scene: SceneBuilder): void {
  if (((s as any).AlbinaQW ?? 0)?.['Mom_Future'] === 0) {
    ...
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['Mom_Future'] = 1;
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
...
function enterExerciseTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterExerciseReply(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterNikoHelpTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['niko_help'] = 1;

...
function enterSmallTalk2(s: GameState, scene: SceneBuilder): void {
  ...
  if ((Math.floor(Math.random() * 2) + 1) === 1) {
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterTopicMenu(s, scene); (s as any).locArgs = __savedLocArgs; }
  } else {
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['chat_rand'] = Math.floor(Math.random() * 3) + 1;
    if (((s as any).AlbinaQW ?? 0)?.['chat_rand'] === 1) {
      ...
      if (((s as any).AlbinaQW ?? 0)?.['chat_rand'] === 2) {
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterUnderwearTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
      } else {
        if (((s as any).AlbinaQW ?? 0)?.['chat_rand'] === 3  &&  ((s as any).AlbinaQW ?? 0)?.['porn_talk'] !== '') {
          ...
          if (((s as any).AlbinaQW ?? 0)?.['chat_rand'] === 4) {
            { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPubeTalk2(s, scene); (s as any).locArgs = __savedLocArgs; }
          } else {
            { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSmallTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
          }
        }
      }
    }
...
function enterTopicMenu(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMaidConversation(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLazarConversation(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterZoyaConversation(s, scene); (s as any).locArgs = __savedLocArgs; }
    if (((s as any).NikoPayback ?? 0) === 2  &&  ((s as any).AlbinaQW ?? 0)?.['niko_help'] === 0) {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNikoHelpTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
    scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterFunTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterExerciseTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDietTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPajamaTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterClothingConversation(s, scene); (s as any).locArgs = __savedLocArgs; }
    scene.actions([
      { label: 'Talk about something else', handler: (st: GameState) => {
    qspCall(st, 'albina_chat', 'topic_menu');
  } },
...
function enterJobTalk1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).job_status ?? 0)?.['city_strip_stripper'] === 'employed') {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterStripperTalk1(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
...
function enterStripperTalk1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).region ?? 0) === 'city') {
    ...
    scene.text(`"Damn ${((s as any).pcs_nickname || '')}, remind me not to get on your bad side!"`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSmallTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
      ]);
    } else {
    ...
    scene.text(`"Don't be so embarrassed, ${((s as any).pcs_nickname || '')}. I'm a stripper too."`);
    ...
    if (((s as any).age ?? 0) < 18) {
      ...
      if (((s as any).start_type ?? 0)?.['group'] === 'gopnik') {
        ...
        scene.text(`"Don't panic, ${((s as any).pcs_nickname || '')}, I'm just kidding!"`);
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSmallTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
      }
    } else {
      scene.text('Her jaw drops. "You\'re a stripper?!"');
...
function enterPornstarTalk1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).AlbinaQW ?? 0)?.['porno'] > 0) {
    scene.actions([
      { label: 'Embarrassed', handler: (st: GameState) => {
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['porn_talk'] = 'embarrassed';
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk4(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
      { label: 'Casual', handler: (st: GameState) => {
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['porn_talk'] = 'casual';
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    ...
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['porn_talk'] = 'happy';
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        { label: 'Casual', handler: (st: GameState) => {
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['porn_talk'] = 'casual';
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
...
function enterPornstarTalk2(s: GameState, scene: SceneBuilder): void {
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk2_1(s, scene); (s as any).locArgs = __savedLocArgs; }
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk2_2(s, scene); (s as any).locArgs = __savedLocArgs; }
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk2_3(s, scene); (s as any).locArgs = __savedLocArgs; }
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk2_4(s, scene); (s as any).locArgs = __savedLocArgs; }
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk2_5(s, scene); (s as any).locArgs = __savedLocArgs; }
  // TODO-QSP: end
  scene.build();
}
...
function enterPornstarTalk2_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk3_1(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk3_2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterPornstarTalk2_2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterAlbinaPornRant1(s, scene); (s as any).locArgs = __savedLocArgs; }
...
function enterPornstarTalk2_4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterAlbinaPornRant2(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk3_1(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk3_2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ]);
...
function enterPornstarTalk3_2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['porn_fight'] = 1;
...
function enterPornstarTalk4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk4_1(s, scene); (s as any).locArgs = __savedLocArgs; }
    if (((s as any).AlbinaQW ?? 0)?.['porn_talk'] !== 'embarrassed') {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk4_2(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk4_3(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk4_4(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterPornstarTalk4_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPornstarTalk4_5(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterUnderwearTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).trait_vars ?? 0)?.['panty_preference'] === 3) {
    ...
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['commando_know'] = 3;
    scene.actions([
...
function enterCommandoTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).trait_vars ?? 0)?.['panty_preference'] > 0) {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCommandoReply(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ...
  scene.actions([
    ...
    if (((s as any).region ?? 0) === 'pav') {
      ...
      if ((Math.floor(Math.random() * 100) + 1) < ((s as any).pcs_prcptn ?? 0)) {
        if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['pube_hint'] = 1;
...
function enterPubeTalk2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pube_style ?? 0)?.['word'] === 'shaved') {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterGrowPubesChat1(s, scene); (s as any).locArgs = __savedLocArgs; }
    scene.actions([
    ...
    scene.text(`"Bush is so unfashionable," you say while rolling your eyes. "So 20th century. It's ${((s as any).year || '')} for goodness' sake! Who the hell still has bush?"`);
    ...
    scene.text(`"That's old fashioned thinking," she insists. "Plenty of women go full Brazilian and it doesn't make them any girlier. You need to get with the times. It's ${((s as any).year || '')}, bitch!"`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSmallTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        ]);
      } else {
    ...
    // TODO-QSP: dynamic text: "That's old fashioned thinking," she insists. "Plenty of women go full Brazilian...
    scene.text(`"That's old fashioned thinking," she insists. "Plenty of women go full Brazilian. You need to get with the times. It's ${((s as any).year || '')}, bitch!"`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSmallTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
          ]);
        } else {
...
function enterGrowPubesChat1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterGrowPubesChat2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
...
function enterMaidConversation(s: GameState, scene: SceneBuilder): void {
  if (((s as any).AlbinaQW ?? 0)?.['Maid'] === 0) {
    ...
    scene.text(`She gives you a hard stare. "It's not funny, ${((s as any).pcs_nickname || '')}! She's already been disowned by her parents for coming out as a lesbian and she doesn't want anyone else, <i>especially</i> her boss, finding out. I shouldn't have even outed her like that, especially not behind her back."`);
    scene.text('You blush as you apologize before she changes the subject.');
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['Maid'] = 1;
    scene.actions([
      { label: 'Stop talking', goto: ['albina_chat', 'chat_exit'] },
      { label: 'Change the subject', goto: ['albina_chat', 'chat'] },
    ]);
...
function enterLazarConversation(s: GameState, scene: SceneBuilder): void {
  if (((s as any).AlbinaQW ?? 0)?.['Lazar_Sex'] === 1) {
    ...
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['Lazar_Sex'] = 2;
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLoverConversation(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterLoverConversation(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['fuckbuddies_current'] > 0) {
    ...
    if (((s as any).stat ?? 0)?.['fuckbuddies_current'] <= 10) {
      ...
      scene.text(`"Hmmm…" You start counting off your various lovers on your fingers. "${(((s as any).stat ?? {})?.['fuckbuddies_current'] ?? 0) - 1}? No wait, ${((s as any).stat ?? 0)?.['fuckbuddies_current'] ?? ''}. I just wait for them to text me if they want to fuck."`);
    } else {
  ...
  if (((s as any).rex_love ?? 0) === 1  ||  ((s as any).artemQW ?? 0)?.['bf'] === 1  ||  ((s as any).kotovLoveQW ?? 0) === 1  ||  ((s as any).fedorKozlovQW ?? 0)  ||  ((s as any).NikoVolkovQW ?? 0) >= 5  ||  ((s as any).stat ?? 0)?.['boyfriends_current'] > 0) {
    ...
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    scene.text('She grins at you. "Right, so who are you dating again?"');
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLoverNikoTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLoverFedorTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLoverArtemTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLoverRexTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
    (s as any).i = 0;
  ...
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterLoverKolkaTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
  // TODO-QSP: end
  scene.actions([
...
function enterLoverNikoTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).NikoVolkovQW ?? 0) >= 5) {
    ...
    scene.text(`She gives you a concerned look. "${((s as any).pcs_nickname || '')}, he's bad news. He isn't what he seems, so just… Just be careful with him, okay?"`);
...
function enterLoverVitekTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).kotovLoveQW ?? 0) === 1) {
    ...
    scene.text(`She's taken aback in surprise. "Really ${((s as any).pcs_nickname || '')}, <i>really</i>? Of all the boys in school, you go for the wannabe tough guy with tiny dick syndrome? With the amount of steroids he's probably jacked up on, I'd be surprised if his dick hasn't shrivelled back up inside him yet!"`);
...
function enterLoverKolkaTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).brotherQW ?? 0)?.['Sex'] > 0) {
    ...
    if (((s as any).AlbinaQW ?? 0)?.['kolka_know'] === 0) {
      if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['kolka_know'] = 1;
    ...
    scene.text(`"TMI ${((s as any).pcs_nickname || '')}," she says, grimacing. "Way TMI. Keep your weird family business to yourself."`);
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}," she says, grimacing. "That's fucking disgusting."`);
    scene.text('"But you aske-"');
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}," she grimaces. "That's fucking disgusting."`);
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}," she says, firmly interrupting you again. "I'm going to pretend you never said that. And I don't want to hear about it ever again."`);
    scene.text('"Bu-"');
...
function enterZoyaConversation(s: GameState, scene: SceneBuilder): void {
  if (((s as any).AlbinaQW ?? 0)?.['Mom_Future'] === 0) {
    ...
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['Mom_Future'] = 1;
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
...
function enterExerciseTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterExerciseReply(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}
...
function enterNikoHelpTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['niko_help'] = 1;
    (s as any).minut = ((s as any).minut ?? 0) + 2;
    scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
    // TODO-QSP: dynamic text: You feel her wrap an arm around you. "What's up, <<$pcs_nickname>>? You're looki...
    scene.text(`You feel her wrap an arm around you. "What's up, ${((s as any).pcs_nickname || '')}? You're looking pretty glum."`);
...
function enterArtemThreesome(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['alb3some_ask'] = 2;
  if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['artem_invite'] = 1;
  qspCall(s, 'stat', '');
  scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
...
function enterArtemThreesome1(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['alb3some_again'] = 2;
  qspCall(s, 'stat', '');
  scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
...
function enterBlackGuy(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['know_ermias_sex'] = 2;
  qspCall(s, 'stat', '');
  scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');
...
function enterClubBj(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['saw_club_bj'] = 2;
  qspCall(s, 'stat', '');
  scene.img('images/characters/pavlovsk/school/girl/albina/albinatalk.jpg');

  ...
  if ((!(Math.floor(Math.random() * 4) + 0))) {
    ...
    if (((s as any).AlbinaQW ?? 0)?.['know_albina_uni'] === 0  &&  ((s as any).start_type ?? 0)?.['loc'] !== 'sg'  &&  ((s as any).start_type ?? 0)?.['magic'] === 'tg') {
      ...
      if (((s as any).AlbinaQW ?? 0)?.['know_ermias_sex'] === 0) {
        ((s as any).AlbinaQW ?? {})['know_ermias_sex'] = 1;
        // TODO-QSP: dynamic text: You turn the handle and gently push the door open just wide enough to look insid...
...
function enterUniCafe(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).AlbinaQW ?? 0)?.['Friends'] === 2  ||  ((s as any).npc_rel ?? 0)?.['A23'] >= 70) {
    if (((s as any).fame ?? 0)?.['city_slut'] >= 250  ||  ((s as any).fame ?? 0)?.['pav_slut'] >= 250) {
      ...
      scene.text(`She looks up from her phone and smiles. "Oh hey ${((s as any).pcs_nickname ?? 0)}."`);
...
function enterCoffeeHole1(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  ((s as any).AlbinaQW ?? {})['coffee_meet'] = ((s as any).daystart ?? 0);
  qspCall(s, 'stat', '');
  ...
  if (((s as any).npc_rel ?? 0)?.['A23'] >= 70) {
    if (((s as any).AlbinaQW ?? 0)?.['Friends'] === 2) {
      ...
      scene.text(`"Oh hello ${((s as any).pcs_firstname ?? 0)}. I wasn't expecting to meet you here," she smiles.`);
      ...
      scene.text(`"Tell me, ${((s as any).pcs_firstname ?? 0)}. Are you studying at the university as well?"`);
      if (((s as any).university ?? 0)?.['student'] === 1  &&  ((s as any).university ?? 0)?.['enrolled_in'] === 'nursing') {
        ...
        if (((s as any).university ?? 0)?.['student'] === 1) {
          ...
          scene.text(`"That's nothing to be ashamed about, ${((s as any).pcs_firstname ?? 0)}," she says with a smile. "You can do plenty of things in life without a university degree. You just need to work hard for it."`);
        }
      }
      ...
      scene.text(`"Again, there's no need to feel awkward, ${((s as any).pcs_firstname ?? 0)}," Zoya replies. "You're welcome any time."`);
      ...
      if (((s as any).AlbinaQW ?? 0)?.['meet_zoya'] === 0) {
        ...
        scene.text(`"Yes Mama," Albina replies. "This is ${((s as any).pcs_firstname ?? 0)}, but most people just call her ${((s as any).pcs_nickname ?? 0)}."`);
        // TODO-QSP: dynamic text: "It's nice to meet you, <<$pcs_firstname>>," the woman replies. "I'm Zoya, Albin...
        scene.text(`"It's nice to meet you, ${((s as any).pcs_firstname ?? 0)}," the woman replies. "I'm Zoya, Albina's mother."`);
        ...
        scene.text(`"Hello again, ${((s as any).pcs_firstname ?? 0)}," Zoya says with a smile.`);
        ...
        scene.text(`"Just call me Zoya. Tell me, ${((s as any).pcs_firstname ?? 0)}. Are you studying at the university as well?"`);
        if (((s as any).university ?? 0)?.['student'] === 1  &&  ((s as any).university ?? 0)?.['enrolled_in'] === 'nursing') {
          scene.text('"Yes. Albina and I are in the same class as each other, actually," you reply.');
          scene.text('"You\'re also choosing to study medicine? My Albina here must have rubbed off on you, no?"');
          if (((s as any).npc_had_sex ?? 0)?.['A23']) {
...
function enterMoncheri(s: GameState, scene: SceneBuilder): void {
  ((s as any).AlbinaQW ?? {})['boutique'] = ((s as any).daystart ?? 0);
  qspCall(s, 'stat', '');

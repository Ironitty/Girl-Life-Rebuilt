  ...
  if (((s as any).numnpc ?? 0) === 9  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 200  &&  ((s as any).kotovLoveQW ?? 0) >= 0  &&  (((s as any).npc_rel ?? 0)?.['A9'] >= 80  ||  ((s as any).pcs_hotcat ?? 0) >= 5)) {
    ...
    dynamicGoto(st, 'prevLoc', 'prevArg');
        ...
        if (((s as any).kotovQW ?? 0) >= 5  &&  ((s as any).npc_rel ?? 0)?.['A9'] !== 0) {
          ...
          scene.text(`The dance ended and Vitek took you by the hand, steering you to the wall. "Hey ${((s as any).pcs_nickname || '')}, wanna go out with me, be my chick? I'll wring any guy's neck for you."`);
          scene.actions([
            { label: 'Refuse', handler: (st: GameState) => {
    ...
    dynamicGoto(st, 'prevLoc', 'prevArg');
      ...
      if (((s as any).kotovLoveQW ?? 0) > 0) {
        ...
        scene.text(`The dance ends and Vitek hugged you "${((s as any).pcs_nickname || '')}, lets go to my house, where I can have my way with you." He says in his best seductive tone.`);

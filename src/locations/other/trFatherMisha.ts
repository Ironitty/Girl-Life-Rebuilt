...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).trfatherMishaQW ?? 0) === 1) {
    ...
    qspCall(s, 'arousal', 'foreplay_give', 10, 'incest');
    qspCall(s, 'stat', '');
    ...
    qspCall(s, 'arousal', 'foreplay_give', 5, 'incest');
    ...
    qspCall(s, 'cum_call', 'mouth', 'A35', 1, 0, 12500, Math.floor(Math.random() * 21) + 30);

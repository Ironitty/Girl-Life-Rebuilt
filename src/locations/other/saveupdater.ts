...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_current_save_version ?? 0) < 80504) {
    ((s as any).npcGoSchool ?? {})['A18'] = '<a href="exec:gt \'gschool_jock_chats\', \'\' + $lcase($npc_usedname[\'A18\']) + \'\'">' + qspUntranslated(s, "npc_usedname[\"A18\"]>", { location: "saveupdater" }) + '</a>';
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90200) {
    ...
    if (((s as any).salo ?? 0) !== 0) {
      ...
      ((s as any).pcs_mass ?? {})['bust'] = (((s as any).temp_totmass ?? 0) * ((s as any).pcs_mass ?? {})?.['bust_gen']) / ((s as any).temp_totgenmass ?? 0);
      ((s as any).pcs_mass ?? {})['butt'] = (((s as any).temp_totmass ?? 0) * ((s as any).pcs_mass ?? {})?.['butt_gen']) / ((s as any).temp_totgenmass ?? 0);
      ((s as any).pcs_mass ?? {})['body'] = ((s as any).temp_totmass ?? 0) - ((s as any).pcs_mass ?? {})?.['bust'] - ((s as any).pcs_mass ?? {})?.['butt'];
    }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90204) {
    ...
    if (((s as any).lact_ev ?? 0)?.['poli_totaldonatemoney'] <= 0  &&  ((s as any).lact_ev ?? 0)?.['poli_totalmilkdonated'] >= 5) {
      ((s as any).lact_ev ?? {})['poli_totaldonatemoney'] = (((s as any).lact_ev ?? {})?.['poli_totalmilkdonated'] / 5) * 10;
    }
    ...
    if (((s as any).blackmailQW ?? 0)?.['init_flashimage'] !== ''  &&  ((((s as any).blackmailQW ?? 0)?.['init_flashimage']).indexOf(('.jpg'))) + 1 === 0) {
      ((s as any).blackmailQW ?? {})['init_flashimage'] = ((s as any).blackmailQW ?? {})?.['init_flashimage'] + '.jpg';
    }
    ...
    if (Object.keys((s as any).bodimgsets ?? {}).length / 10 > 4) {
      ...
      if (((s as any).su_j ?? 0) < 9) {
        ...
        if ((((s as any).su_j ?? 0) >= 1  &&  ((s as any).su_j ?? 0) <= 5)  ||  (!(0 as any))) {
          ((s as any).cheatVars ?? {})['fix_biset_' + String((s as any).su_i-4 || '') + '_img_' + String((s as any).su_j || '') + ''] = '' + qspUntranslated(s, "su_j>", { location: "saveupdater" }) + '';
        }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90400) {
    ...
    if (((s as any).husID ?? 0) !== '') {
      ...
      ((s as any).npc_weight ?? {})[String((s as any).husID ?? 0)] = ((s as any).saveupdaterVars ?? {})?.['bmi'] * ((s as any).npc_height ?? 0)?.[String((s as any).husID ?? 0)] * ((s as any).npc_height ?? 0)?.[String((s as any).husID ?? 0)] / 10000;
    ...
    if (((s as any).npc_usedname ?? 0)[((s as any).saveupdaterVars ?? 0)?.['npcID']] !== '') {
      ...
      if (((s as any).npc_weight_desc ?? 0)[((s as any).saveupdaterVars ?? 0)?.['npcID']] === '') {
        ((s as any).saveupdaterVars ?? {})['bmi'] = 100000 * ((s as any).npc_weight ?? 0)[((s as any).saveupdaterVars ?? {})?.['npcID']] / (((s as any).npc_height ?? 0)[((s as any).saveupdaterVars ?? {})?.['npcID']] * ((s as any).npc_height ?? 0)[((s as any).saveupdaterVars ?? {})?.['npcID']]);
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90500) {
    ...
    if (((s as any).shared_apt ?? 0)?.['enabled'] === 1  &&  (!((s as any).dothisonlyonce ?? 0))) {
      if (((s as any).daystart ?? 0) - ((s as any).shared_apt ?? 0)?.['intro_daystart'] > 6) {
        ((s as any).shared_apt ?? {})['weekNum'] = (((s as any).daystart ?? 0) - ((s as any).shared_apt ?? {})?.['intro_daystart']) / 7;
      } else {
        ((s as any).shared_apt ?? {})['weekNum'] = 0;
      }
      ((s as any).shared_apt ?? {})['rentWeekNum'] = ((s as any).shared_apt ?? {})?.['weekNum'] + 1;
    ...
    if (((s as any).npc_girth ?? 0)?.['A1'] === 0) {
      ...
      ((s as any).saveupdaterVars ?? {})['npcID'] = 'A' + ((s as any).saveupdaterVars ?? {})?.['i'];
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90700) {
    ...
    if ((!((s as any).npcupdate09070 ?? 0))) {
      ...
      ((s as any).saveupdaterVars ?? {})['ID'] = 'A' + ((s as any).saveupdaterVars ?? {})?.['i'];
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90800) {
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_diner_dishwasher_v4'] === 0) {
      ...
      if (((s as any).BurgerQW ?? 0)?.['WashDishesCount'] > 1) {
        ((s as any).job_shifts_total ?? {})['city_diner_dishwasher'] = ((s as any).BurgerQW ?? {})?.['WashDishesCount'] - 1;
      }
          ...
          if (((s as any).cheatVars ?? 0)?.['deg_speed'] === 0) {
            ...
            if (((s as any).cheatVars ?? 0)?.['deg_speed'] === 50) {
              ...
              if (((s as any).cheatVars ?? 0)?.['deg_speed'] === 100) {
                ...
                ((s as any).cheatVars ?? {})['deg_speed_custom'] = 100 + ((s as any).cheatVars ?? {})?.['deg_speed'];
              }
            }
          }
        }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90900) {
    ...
    if (((s as any).temp_saveupdater_guard ?? 0)?.['traits_and_archetypes_migrated'] === 0) {
      ...
      ((s as any).trait_vars ?? {})['creampie_fetish_exp_prev'] = ((s as any).stat ?? {})?.['creampies_safe_known'] + (((s as any).stat ?? {})?.['creampies_notsafe_known'] + ((s as any).stat ?? {})?.['creampies_risky_known'] * 2) * 2;
      ((s as any).trait_vars ?? {})['creampie_fetish_exp_risky_prev'] = ((s as any).stat ?? {})?.['creampies_notsafe_known'] + ((s as any).stat ?? {})?.['creampies_risky_known'] * 2;
      ...
      ((s as any).trait_vars ?? {})['addictive_personality_prev'] = ((s as any).drugVars ?? {})?.['cigarettes_exp'] + ((s as any).drugVars ?? {})?.['weed_exp'] + ((s as any).drugVars ?? {})?.['heroin_exp'] + ((s as any).drugVars ?? {})?.['cocaine_exp'] + ((s as any).drugVars ?? {})?.['alcohol_exp'] + ((s as any).drugVars ?? {})?.['amphetamine_exp'] + ((s as any).drugVars ?? {})?.['painkiller_exp'];
      ...
      ((s as any).trait_vars ?? {})['panty_preference_exp'] = ((s as any).pcs_traits ?? {})?.['commando_exp'] * 15 + (15000 * ((s as any).trait_vars ?? {})?.['panty_preference']);
      ...
      if (((s as any).trait_vars ?? 0)?.['academic'] === 1) {
        ...
        if (((s as any).trait_vars ?? 0)?.['academic'] === 2) {
          ...
          if (((s as any).trait_vars ?? 0)?.['academic'] === 3) {
            ...
            ((s as any).trait_vars ?? {})['academic_exp'] = ((s as any).pcs_traits ?? {})?.['nerd_points'] * 5;
          }
        }
      }
      ...
      if (((s as any).pcs_traits ?? 0)?.['bambis_first_steps'] > 0) {
        ...
        ((s as any).trait_vars ?? {})['heel_preference_exp'] = -(((s as any).pcs_traits ?? {})?.['bambis_first_steps_time'] * 120);
        ((s as any).trait_vars ?? {})['heel_preference_daily_limit'] = ((s as any).pcs_traits ?? {})?.['bambis_first_steps_counter'] * 60;
      }
      ...
      if (((s as any).pcs_traits ?? 0)?.['bimbo_lvl'] === 1) {
        ((s as any).arch_vars ?? {})['bimbo_points'] = ((s as any).arch_const ?? {})?.['points_full_effect'] / 8;
      } else {
        if (((s as any).pcs_traits ?? 0)?.['bimbo_lvl'] === 2) {
          ((s as any).arch_vars ?? {})['bimbo_points'] = ((s as any).arch_const ?? {})?.['points_full_effect'] / 4;
        } else {
          if (((s as any).pcs_traits ?? 0)?.['bimbo_lvl'] === 3) {
            ((s as any).arch_vars ?? {})['bimbo_points'] = ((s as any).arch_const ?? {})?.['points_full_effect'] / 3;
          }
        }
      }
      if (((s as any).pcs_traits ?? 0)?.['punk_lvl'] === 1) {
        ((s as any).arch_vars ?? {})['punk_points'] = ((s as any).arch_const ?? {})?.['points_full_effect'] / 8;
      } else {
        if (((s as any).pcs_traits ?? 0)?.['punk_lvl'] === 2) {
          ((s as any).arch_vars ?? {})['punk_points'] = ((s as any).arch_const ?? {})?.['points_full_effect'] / 4;
        } else {
          if (((s as any).pcs_traits ?? 0)?.['punk_lvl'] === 3) {
            ((s as any).arch_vars ?? {})['punk_points'] = ((s as any).arch_const ?? {})?.['points_full_effect'] / 3;
          }
        }
      }
      if (((s as any).pcs_traits ?? 0)?.['goth_lvl'] === 1) {
        ((s as any).arch_vars ?? {})['goth_points'] = ((s as any).arch_const ?? {})?.['points_full_effect'] / 8;
      } else {
        if (((s as any).pcs_traits ?? 0)?.['goth_lvl'] === 2) {
          ((s as any).arch_vars ?? {})['goth_points'] = ((s as any).arch_const ?? {})?.['points_full_effect'] / 4;
        } else {
          if (((s as any).pcs_traits ?? 0)?.['goth_lvl'] === 3) {
            ((s as any).arch_vars ?? {})['goth_points'] = ((s as any).arch_const ?? {})?.['points_full_effect'] / 3;
          }
        }
      }
    }
      ...
      if (((s as any).masseuse ?? 0)?.['jobtype'] !== 0  &&  ((s as any).job_status ?? 0)?.['city_salon_masseuse'] === '') {
        if (((s as any).masseuse ?? 0)?.['jobtype'] > 0) {
          ...
          if (((s as any).masseuse ?? 0)?.['jobtype'] === -6) {
            ...
            ((s as any).masseuse ?? {})['last_rank'] = ((((s as any).masseuse ?? 0)?.['jobtype'] >= 0) ? (((s as any).masseuse ?? 0)?.['jobtype']) : (-((s as any).masseuse ?? {})?.['jobtype']));
    ...
    ((s as any).temp_mig_g ?? {})[0] = 'mental';
    ((s as any).temp_mig_g ?? {})[1] = 'sport';
    ((s as any).temp_mig_g ?? {})[2] = 'combat';
    ((s as any).temp_mig_g ?? {})[3] = 'beauty';
    ((s as any).temp_mig_g ?? {})[4] = 'artistic';
    ((s as any).temp_mig_g ?? {})[5] = 'job';
    ...
    ((s as any).temp_mig_g ?? {})[0] = 'family';
    ((s as any).temp_mig_g ?? {})[1] = 'coolkid';
    ((s as any).temp_mig_g ?? {})[2] = 'jock';
    ((s as any).temp_mig_g ?? {})[3] = 'nerd';
    ((s as any).temp_mig_g ?? {})[4] = 'gopnik';
    ((s as any).temp_mig_g ?? {})[5] = 'staff';
    ((s as any).temp_mig_g ?? {})[6] = 'pavlovsk';
    ((s as any).temp_mig_g ?? {})[7] = 'city';
    (s as any).temp_mig_gi = 0;

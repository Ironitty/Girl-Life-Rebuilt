...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_current_save_version ?? 0) < 80403) {
    if (((s as any).meynoldQW ?? 0) === 1  ||  ((s as any).meynoldQW ?? 0) === 2) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['QWstage'] = ((s as any).meynoldQW ?? 0);
    }
    ...
    if (((s as any).katjaTanga ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['pantiesQWstage'] = ((s as any).katjaTanga ?? 0);
      // TODO-QSP: killvar 'katjaTanga'
    }
    if (((s as any).katja_tanga_end ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['pantiesQWstage'] = 5;
      // TODO-QSP: killvar 'katja_tanga_end'
    }
    if (((s as any).katjaSlut ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['slut'] = ((s as any).katjaSlut ?? 0);
      // TODO-QSP: killvar 'katjaSlut'
    }
    if (((s as any).katjaHorny ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = ((s as any).katjaHorny ?? 0);
    ...
    if (((s as any).KatjaMastr ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['masturbates'] = ((s as any).KatjaMastr ?? 0);
      // TODO-QSP: killvar 'KatjaMastr'
    }
    if (((s as any).KatjaThroat ?? 0) > 0) {
      if (!(s as any).npc_throat) (s as any).npc_throat = {}; (s as any).npc_throat['A14'] = ((s as any).KatjaThroat ?? 0);
      // TODO-QSP: killvar 'KatjaThroat'
    }
    if (((s as any).KatjaAnus ?? 0) > 0) {
      if (!(s as any).npc_ass) (s as any).npc_ass = {}; (s as any).npc_ass['A14'] = ((s as any).KatjaAnus ?? 0);
      // TODO-QSP: killvar 'KatjaAnus'
    }
    if (((s as any).KatjaOrgasm ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['orgasm_day'] = ((s as any).KatjaOrgasm ?? 0);
      // TODO-QSP: killvar 'KatjaOrgasm'
    }
    if (((s as any).katjaMeynoldday ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['afterschool_hangout_day'] = ((s as any).katjaMeynoldday ?? 0);
      // TODO-QSP: killvar 'katjaMeynoldday'
    }
    if (((s as any).tangaday ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['no_panties_day'] = ((s as any).tangaday ?? 0);
      // TODO-QSP: killvar 'tangaday'
    }
    if (((s as any).KatjaKnowMastr ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['knows_masterbation'] = 1;
    ...
    if (((s as any).katja_disco_Foto ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['disco_Foto'] = 1;
    ...
    if (((s as any).katja_disco_end ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['no_panties_at_disco'] = 1;
      // TODO-QSP: killvar 'katja_disco_end'
    }
    if (((s as any).KatjaOhrenet ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['sex_in_the_park_comment'] = ((s as any).KatjaOhrenet ?? 0);
      // TODO-QSP: killvar 'KatjaOhrenet'
    }
    if (((s as any).flag_start_parc ?? 0) > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['school_kiss'] = ((s as any).flag_start_parc ?? 0);
  ...
  if (((s as any).temp_current_save_version ?? 0) < 80500) {
    ...
    if (((s as any).danilovich ?? 0)?.[String((s as any).i ?? 0)] === 1) {
      if (!(s as any).danilovich_outfits) (s as any).danilovich_outfits = {}; (s as any).danilovich_outfits[String((s as any).i ?? 0)] = 1;
      if (!(s as any).danilovich_outfits_s) (s as any).danilovich_outfits_s = {}; (s as any).danilovich_outfits_s[String((s as any).i ?? 0)] = ((s as any).danilovich_s ?? 0)?.[String((s as any).i ?? 0)];
      if (!(s as any).danilovich_outfits_h) (s as any).danilovich_outfits_h = {}; (s as any).danilovich_outfits_h[String((s as any).i ?? 0)] = ((s as any).danilovich_h ?? 0)?.[String((s as any).i ?? 0)];
      if (!(s as any).danilovich_outfits_b) (s as any).danilovich_outfits_b = {}; (s as any).danilovich_outfits_b[String((s as any).i ?? 0)] = ((s as any).danilovich_b ?? 0)?.[String((s as any).i ?? 0)];
    }
    (s as any).i = ((s as any).i ?? 0) + (1);
    if (((s as any).i ?? 0) <= 170) {
    ...
    if (((s as any).agape ?? 0)[4] === 0) {
      if (!(s as any).agape) (s as any).agape = {}; (s as any).agape[4] = 10;
    }
    if (((s as any).vgape ?? 0)[4] === 0) {
      if (!(s as any).vgape) (s as any).vgape = {}; (s as any).vgape[4] = 10;
    }
  }
  if (((s as any).temp_current_save_version ?? 0) < 80502) {
    ...
    if (((s as any).temp1 ?? 0) >= 0) {
      if (!(s as any).npc_index) (s as any).npc_index = {}; (s as any).npc_index[String((s as any).text ?? 0)] = ((s as any).text ?? 0);
    }
    (s as any).i = ((s as any).i ?? 0) + (1);
  ...
  if (((s as any).temp_current_save_version ?? 0) < 80503) {
    ...
    if (((s as any).hotelroom1day ?? 0) !== 0) {
      if (!(s as any).hotelRoomDays) (s as any).hotelRoomDays = {}; (s as any).hotelRoomDays['pav'] = ((s as any).hotelroom1day ?? 0);
      if (!(s as any).HotelRoom) (s as any).HotelRoom = {}; (s as any).HotelRoom['pav'] = ((s as any).HotelRoom ?? 0);
      (s as any).HotelRoom = 0;
    }
  }
  if (((s as any).temp_current_save_version ?? 0) < 80504) {
    if (!(s as any).npcGoSchool) (s as any).npcGoSchool = {}; (s as any).npcGoSchool['A18'] = '<a href="exec:gt \'gschool_jock_chats\', \'\' + $lcase($npc_usedname[\'A18\']) + \'\'">' + qspUntranslated(s, "npc_usedname[\"A18\"]>", { location: "saveupdater" }) + '</a>';
  ...
  if (((s as any).temp_current_save_version ?? 0) < 80700) {
    ...
    if (((s as any).kats_bras ?? 0)?.[String((s as any).i ?? 0)] === 1) {
      if (!(s as any).cats_brasS) (s as any).cats_brasS = {}; (s as any).cats_brasS[String((s as any).i ?? 0)] = ((s as any).kats_brasS ?? 0)?.[String((s as any).i ?? 0)];
      if (!(s as any).cats_bras) (s as any).cats_bras = {}; (s as any).cats_bras[String((s as any).i ?? 0)] = ((s as any).kats_bras ?? 0)?.[String((s as any).i ?? 0)];
    }
    (s as any).i = ((s as any).i ?? 0) + (1);
    ...
    if (((s as any).kats_panties ?? 0)?.[String((s as any).i ?? 0)] === 1) {
      if (!(s as any).cats_pantiesS) (s as any).cats_pantiesS = {}; (s as any).cats_pantiesS[String((s as any).i ?? 0)] = ((s as any).kats_pantiesS ?? 0)?.[String((s as any).i ?? 0)];
      if (!(s as any).cats_panties) (s as any).cats_panties = {}; (s as any).cats_panties[String((s as any).i ?? 0)] = ((s as any).kats_panties ?? 0)?.[String((s as any).i ?? 0)];
    }
    (s as any).i = ((s as any).i ?? 0) + (1);
    ...
    if (((s as any).AvelinaQW ?? 0)?.['encourage'] === 1) {
      if (!(s as any).AvelinaQW) (s as any).AvelinaQW = {}; (s as any).AvelinaQW['encourage'] = 0;
    }
    ...
    if (((s as any).LariskaQW ?? 0)?.['LariskaHelp'] < 0  ||  ((s as any).LariskaQW ?? 0)?.['LariskaHelp'] > 0) {
      if (!(s as any).LariskaQW) (s as any).LariskaQW = {}; (s as any).LariskaQW['LariskaHelp'] = 0;
    }
    if (((s as any).LariskaQW ?? 0)?.['LariskaHelpEnd'] === 1) {
      if (!(s as any).LariskaQW) (s as any).LariskaQW = {}; (s as any).LariskaQW['LariskaHelpEnd'] = 0;
    }
    if (((s as any).npc_grupTipe ?? 0)?.['A18'] === 5) {
      if (!(s as any).npc_grupTipe) (s as any).npc_grupTipe = {}; (s as any).npc_grupTipe['A18'] = 2;
    }
    if (((s as any).christinaQW ?? 0)?.['dompath'] >= 1) {
      if (((s as any).christinaQW ?? 0)?.['dompath'] >= 6) {
        ...
        if (!(s as any).christinaQW) (s as any).christinaQW = {}; (s as any).christinaQW['dompath'] = 0;
      } else {
        if (!(s as any).christinaQW) (s as any).christinaQW = {}; (s as any).christinaQW['dompath'] = 0;
      }
    }
    if (((s as any).christinaQW ?? 0)?.['set_bully'] === 0) {
      if ((((s as any).christinaQW ?? 0)?.['blackmail'] > 0  ||  ((s as any).christinaQW ?? 0)?.['pre_bm'] > 0  ||  ((s as any).christinaQW ?? 0)?.['pre_fight'] > 0  ||  ((s as any).christinaQW ?? 0)?.['fight'] > 0)  &&  ((s as any).christinaQW ?? 0)?.['set_bully'] === 0) {
        if (!(s as any).christinaQW) (s as any).christinaQW = {}; (s as any).christinaQW['set_bully'] = 1;
        if (!(s as any).christinaQW) (s as any).christinaQW = {}; (s as any).christinaQW['bully'] = 40;
      }
      if (((s as any).christinaQW ?? 0)?.['subpath'] > 0) {
        if (!(s as any).christinaQW) (s as any).christinaQW = {}; (s as any).christinaQW['set_bully'] = 1;
        if (!(s as any).christinaQW) (s as any).christinaQW = {}; (s as any).christinaQW['bully'] = 60;
      }
    }
    if (((s as any).mother_go ?? 0) > 0) {
      if (!(s as any).locat) (s as any).locat = {}; (s as any).locat['Mom_cafe_sex'] = ((s as any).mother_go ?? 0);
    }
    if (((s as any).indorf ?? 0) > 0) {
      if (!(s as any).locat) (s as any).locat = {}; (s as any).locat['Fam_inGad'] = ((s as any).indorf ?? 0);
    }
    if (((s as any).indorf_month ?? 0) === ((s as any).month ?? 0)) {
      if (!(s as any).locat) (s as any).locat = {}; (s as any).locat['Fam_month_inGad'] = ((s as any).indorf_month ?? 0);
    }
    if (((s as any).dostupindorf ?? 0) > 0) {
      if (!(s as any).locat) (s as any).locat = {}; (s as any).locat['Fam_set_month_inGad'] = ((s as any).dostupindorf ?? 0);
    }
    if (((s as any).sister_indorf ?? 0) > 0) {
      if (!(s as any).locat) (s as any).locat = {}; (s as any).locat['Anya_Gad'] = ((s as any).sister_indorf ?? 0);
    }
    if (((s as any).sister_opr_indorf ?? 0) > 0) {
      if (!(s as any).locat) (s as any).locat = {}; (s as any).locat['Anya_check_Gad'] = ((s as any).sister_opr_indorf ?? 0);
    }
    if (((s as any).workKafe ?? 0) === 1) {
      (s as any).workKafe = 0;
      if (!(s as any).workKafe) (s as any).workKafe = {}; (s as any).workKafe['job'] = 1;
    }
    if (((s as any).moisturiser ?? 0)?.['time'] > 0) {
      (s as any).moisturiser_time = ((s as any).moisturiser ?? 0)?.['time'];
      qspCall(s, 'array', 'remove_element', '' + qspUntranslated(s, "moisturiser>", { location: "saveupdater" }) + '', 'time');
    }
  }
  if (((s as any).temp_current_save_version ?? 0) < 80800) {
    ...
    if (((s as any).artembj ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['bj'] = ((s as any).artembj ?? 0);
      // TODO-QSP: killvar 'artembj'
    }
    if (((s as any).artemsex ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['sex'] = ((s as any).artemsex ?? 0);
      // TODO-QSP: killvar 'artemsex'
    }
    if (((s as any).artemanal ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['anal'] = ((s as any).artemanal ?? 0);
      // TODO-QSP: killvar 'artemanal'
    }
    if (((s as any).artemhj ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['hj'] = ((s as any).artemhj ?? 0);
      // TODO-QSP: killvar 'artemhj'
    }
    if (((s as any).artembrokenheart ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['brokenheart'] = ((s as any).artembrokenheart ?? 0);
      // TODO-QSP: killvar 'artembrokenheart'
    }
    if (((s as any).artemStripSee ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['stripsee'] = ((s as any).artemStripSee ?? 0);
      // TODO-QSP: killvar 'artemStripSee'
    }
    if (((s as any).artemlove ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['artemlove'] = ((s as any).artemlove ?? 0);
      // TODO-QSP: killvar 'artemlove'
    }
    if (((s as any).artemblok ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['artemblok'] = ((s as any).artemblok ?? 0);
      // TODO-QSP: killvar 'artemblok'
    }
    if (((s as any).artembf ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['bf'] = ((s as any).artembf ?? 0);
      // TODO-QSP: killvar 'artembf'
    }
    if (((s as any).artdryhump ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['dryhump'] = ((s as any).artdryhump ?? 0);
      // TODO-QSP: killvar 'artdryhump'
    }
    if (((s as any).artlie ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['artlie'] = ((s as any).artlie ?? 0);
      // TODO-QSP: killvar 'artlie'
    }
    if (((s as any).artfall ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['artfall'] = ((s as any).artfall ?? 0);
      // TODO-QSP: killvar 'artfall'
    }
    if (((s as any).artdate ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['date'] = ((s as any).artdate ?? 0);
      // TODO-QSP: killvar 'artdate'
    }
    if (((s as any).artdim ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['dimka'] = ((s as any).artdim ?? 0);
      // TODO-QSP: killvar 'artdim'
    }
    if (((s as any).artslutlove ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['slutlove'] = ((s as any).artslutlove ?? 0);
      // TODO-QSP: killvar 'artslutlove'
    }
    if (((s as any).artsveslut ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['sveslut'] = ((s as any).artsveslut ?? 0);
      // TODO-QSP: killvar 'artsveslut'
    }
    if (((s as any).metArtemMom ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['metArtemMom'] = ((s as any).metArtemMom ?? 0);
      // TODO-QSP: killvar 'metArtemMom'
    }
    if (((s as any).artdimhelp ?? 0) > 0) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['dimkahelp'] = ((s as any).artdimhelp ?? 0);
      // TODO-QSP: killvar 'artdimhelp'
    }
    if (((s as any).JulMilBestFrend ?? 0) > 0) {
      if (!(s as any).juliaQW) (s as any).juliaQW = {}; (s as any).juliaQW['JulMilBestFrend'] = ((s as any).JulMilBestFrend ?? 0);
      // TODO-QSP: killvar 'JulMilBestFrend'
    }
    if (((s as any).eatJulMilDay ?? 0)) {
      if (!(s as any).juliaQW) (s as any).juliaQW = {}; (s as any).juliaQW['eatJulMilDay'] = ((s as any).eatJulMilDay ?? 0);
      // TODO-QSP: killvar 'eatJulMilDay'
    }
    if (((s as any).SexTalkJulia ?? 0)) {
      if (!(s as any).juliaQW) (s as any).juliaQW = {}; (s as any).juliaQW['SexTalkJulia'] = ((s as any).SexTalkJulia ?? 0);
      // TODO-QSP: killvar 'SexTalkJulia'
    }
    if (((s as any).BeInJulMilHome ?? 0)) {
      if (!(s as any).juliaQW) (s as any).juliaQW = {}; (s as any).juliaQW['home_unlocked'] = ((s as any).BeInJulMilHome ?? 0);
      // TODO-QSP: killvar 'BeInJulMilHome'
    }
    if (((s as any).JuliaMilLernQW ?? 0)) {
      if (!(s as any).juliaQW) (s as any).juliaQW = {}; (s as any).juliaQW['study_unlocked'] = ((s as any).JuliaMilLernQW ?? 0);
  ...
  if (((s as any).temp_current_save_version ?? 0) < 80802) {
    ...
    if (((s as any).anushkaFirstvisit ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['first_visit'] = ((s as any).anushkaFirstvisit ?? 0);
      // TODO-QSP: killvar 'anushkaFirstvisit'
    }
    if (((s as any).Anush_lunch ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['lunch'] = ((s as any).Anush_lunch ?? 0);
      // TODO-QSP: killvar 'Anush_lunch'
    }
    if (((s as any).nush_model ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['model'] = ((s as any).nush_model ?? 0);
      // TODO-QSP: killvar 'nush_model'
    }
    if (((s as any).foto_anush_referral ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['model_referral'] = ((s as any).foto_anush_referral ?? 0);
      // TODO-QSP: killvar 'foto_anush_referral'
    }
    if (((s as any).AnushkaCompUse ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['computer_use'] = ((s as any).AnushkaCompUse ?? 0);
      // TODO-QSP: killvar 'AnushkaCompUse'
    }
    if (((s as any).marspyknow ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['marspyknow'] = ((s as any).marspyknow ?? 0);
      // TODO-QSP: killvar 'marspyknow'
    }
    if (((s as any).nushstrapanalpain ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['strapon_anal_pain'] = ((s as any).nushstrapanalpain ?? 0);
      // TODO-QSP: killvar 'nushstrapanalpain'
    }
    if (((s as any).nushstrapon ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['strapon'] = ((s as any).nushstrapon ?? 0);
      // TODO-QSP: killvar 'nushstrapon'
    }
    if (((s as any).domnush ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['dom_nush'] = ((s as any).domnush ?? 0);
      // TODO-QSP: killvar 'domnush'
    }
    if (((s as any).seenEd ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['seen_ed'] = ((s as any).seenEd ?? 0);
      // TODO-QSP: killvar 'seenEd'
    }
    if (((s as any).valeriaIntroduced ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['valeria_introduced'] = ((s as any).valeriaIntroduced ?? 0);
      // TODO-QSP: killvar 'valeriaIntroduced'
    }
    if (((s as any).showerphotos ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['shower_photos'] = ((s as any).showerphotos ?? 0);
      // TODO-QSP: killvar 'showerphotos'
    }
    if (((s as any).anushka_tv_day ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['tv_day'] = ((s as any).anushka_tv_day ?? 0);
      // TODO-QSP: killvar 'anushka_tv_day'
    }
    if (((s as any).anushka_shower_day ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['shower_day'] = ((s as any).anushka_shower_day ?? 0);
      // TODO-QSP: killvar 'anushka_shower_day'
    }
    if (((s as any).AnushkaHomeDay ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['home_day'] = ((s as any).AnushkaHomeDay ?? 0);
      // TODO-QSP: killvar 'AnushkaHomeDay'
    }
    if (((s as any).nush_photoshoot ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['photoshoot'] = ((s as any).nush_photoshoot ?? 0);
      // TODO-QSP: killvar 'nush_photoshoot'
    }
    if (((s as any).NushVsNiko ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['vs_niko'] = ((s as any).NushVsNiko ?? 0);
      // TODO-QSP: killvar 'NushVsNiko'
    }
    if (((s as any).nushaboutalyona ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['about_alyona'] = ((s as any).nushaboutalyona ?? 0);
      // TODO-QSP: killvar 'nushaboutalyona'
    }
    if (((s as any).valspy ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['valspy'] = ((s as any).valspy ?? 0);
      // TODO-QSP: killvar 'valspy'
    }
    if (((s as any).radnushdate ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['rad_date'] = ((s as any).radnushdate ?? 0);
      // TODO-QSP: killvar 'radnushdate'
    }
    if (((s as any).radspy ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['radspy'] = ((s as any).radspy ?? 0);
      // TODO-QSP: killvar ' radspy'
    }
    if (((s as any).nushfedor3s ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['fedor_3some'] = ((s as any).nushfedor3s ?? 0);
      // TODO-QSP: killvar 'nushfedor3s'
    }
    if (((s as any).Anush_sex ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['sex'] = ((s as any).Anush_sex ?? 0);
      // TODO-QSP: killvar 'Anush_sex'
    }
    if (((s as any).Anush_dolls ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['dolls'] = ((s as any).Anush_dolls ?? 0);
      // TODO-QSP: killvar 'Anush_dolls'
    }
    if (((s as any).anushka_toilet ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['toilet'] = ((s as any).anushka_toilet ?? 0);
      // TODO-QSP: killvar 'anushka_toilet'
    }
    if (((s as any).marspy ?? 0) > 0) {
      if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['marspy'] = ((s as any).marspy ?? 0);
      // TODO-QSP: killvar 'marspy'
    }
    if (((s as any).bandpracticeinvite ?? 0) > 0) {
      if (!(s as any).gopnikbandQW) (s as any).gopnikbandQW = {}; (s as any).gopnikbandQW['practice_invite'] = ((s as any).bandpracticeinvite ?? 0);
  ...
  if (((s as any).temp_current_save_version ?? 0) < 80804) {
    ...
    if (((s as any).curr_home ?? 0) > 0  &&  ((s as any).home ?? 0)?.['current'] === '') {
      qspCall(s, 'homes_properties', 'set_home', '', qspUntranslated(s, "str(curr_home)", { location: "saveupdater" }));
    }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 80900) {
    ...
    if (((s as any).nichTanyaKnown ?? 0) === 1) {
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['Known'] = ((s as any).nichTanyaKnown ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['Relationship'] = ((s as any).nichTanyaRelationship ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['RelationshipState'] = ((s as any).nichTanyaRelationshipState ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['RelationshipBreakup'] = ((s as any).nichTanyaRelationshipBreakup ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['BF'] = ((s as any).nichTanyaBF ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['Date'] = ((s as any).nichTanyaDate ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['DateCounter'] = ((s as any).nichTanyaDateCounter ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['DateLast'] = ((s as any).nichTanyaDateLast ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['DateShopping'] = ((s as any).nichTanyaDateShopping ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['FuckCounter'] = ((s as any).nichTanyaFuckCounter ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['FuckLast'] = ((s as any).nichTanyaFuckLast ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['FuckToday'] = ((s as any).nichTanyaFuckToday ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['FuckPositions'] = ((s as any).nichTanyaFuckPositions ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['Strapon'] = ((s as any).nichTanyaStrapon ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['Dominance'] = ((s as any).nichTanyaDominance ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['Uni'] = ((s as any).nichTanyaUni ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['UniStart'] = ((s as any).nichTanyaUniStart ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['Room'] = ((s as any).nichTanyaRoom ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['PropSex'] = ((s as any).nichTanyaPropSex ?? 0);
      if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['PropDate'] = ((s as any).nichTanyaPropDate ?? 0);
    }
  }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 80903) {
    ...
    if (((s as any).teh ?? 0) > 0) {
      if (!(s as any).car) (s as any).car = {}; (s as any).car['new_condition'] = ((s as any).tehcar ?? 0);
      if (!(s as any).car) (s as any).car = {}; (s as any).car['current_condition'] = ((s as any).teh ?? 0);
    }
    (s as any).i = 0;
    // TODO-QSP: :loopboys
    if (((s as any).npc_rel_type ?? 0)?.[String((s as any).i ?? 0)] !== '') {
      if (!(s as any).npc_rel_type) (s as any).npc_rel_type = {}; (s as any).npc_rel_type[String((s as any).i ?? 0)] = 'fuckbuddy';
    }
    (s as any).i = ((s as any).i ?? 0) + (1);
    ...
    if (((s as any).traits ?? 0) > 0  ||  ((s as any).trait ?? 0) > 0) {
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['nerd_status'] = ((s as any).traits ?? 0)?.['nerd_status'];
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['alko_status'] = ((s as any).traits ?? 0)?.['alko_status'];
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['alko_points'] = ((s as any).traits ?? 0)?.['alko_points'];
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['buttslut_lvl'] = ((s as any).traits ?? 0)?.['buttslut_lvl'];
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['buttslut_exp'] = ((s as any).traits ?? 0)?.['buttslut_exp'];
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['nerd_lernHome'] = ((s as any).traits ?? 0)?.['nerd_lernHome'];
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['nerd_points'] = ((s as any).traits ?? 0)?.['nerd_points'];
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['nerd_lessons'] = ((s as any).traits ?? 0)?.['nerd_lessons'];
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['cumeater'] = ((s as any).trait ?? 0)?.['cumeater'];
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['commando_lvl'] = ((s as any).trait ?? 0)?.['commando_lvl'];
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['commando_exp'] = ((s as any).trait ?? 0)?.['commando_exp'];
    }
  }
  if (((s as any).temp_current_save_version ?? 0) < 90000) {
    if (((s as any).photography_job ?? 0) > 0) {
      if (!(s as any).photography) (s as any).photography = {}; (s as any).photography['experience'] = ((s as any).photography_job ?? 0);
    }
    ...
    if (((s as any).stat ?? 0)?.['virgin'] > 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['think_virgin'] = ((s as any).stat ?? 0)?.['virgin'];
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90003) {
    ...
    if (((s as any).temp_makeup_routine ?? 0) !== '') {
      if (!(s as any).makeup) (s as any).makeup = {}; (s as any).makeup['routine_' + String((s as any).makeup_routine_update_index || '') + '_makeup'] = 0;
      if (!(s as any).makeup) (s as any).makeup = {}; (s as any).makeup['routine_' + String((s as any).makeup_routine_update_index || '') + '_lipbalm'] = 0;
      if (!(s as any).makeup) (s as any).makeup = {}; (s as any).makeup['routine_' + String((s as any).makeup_routine_update_index || '') + '_lashes'] = 0;
      if (!(s as any).makeup) (s as any).makeup = {}; (s as any).makeup['routine_' + String((s as any).makeup_routine_update_index || '') + ''] = ((s as any).temp_makeup_routine ?? 0);
      if (!(s as any).makeup) (s as any).makeup = {}; (s as any).makeup['routine_' + String((s as any).makeup_routine_update_index || '') + '_name'] = ((s as any).temp_makeup_routine_name ?? 0);
    }
    ...
    if (((s as any).kosmetica ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['cosmetics'] = ((s as any).kosmetica ?? 0);
      // TODO-QSP: killvar 'kosmetica'
    }
    if (((s as any).item_moisturizer ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['moisturiser'] = ((s as any).item_moisturizer ?? 0);
      // TODO-QSP: killvar 'item_moisturizer'
    }
    if (((s as any).lipbalm ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['lipbalm'] = ((s as any).lipbalm ?? 0);
      // TODO-QSP: killvar 'lipbalm'
    }
    if (((s as any).falselashesplain ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['eyelash_fake'] = ((s as any).falselashesplain ?? 0);
      // TODO-QSP: killvar 'falselashesplain'
    }
    if (((s as any).falselashesmink ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['eyelash_mink'] = ((s as any).falselashesmink ?? 0);
      // TODO-QSP: killvar 'falselashesmink'
    }
    if (((s as any).stanok ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['razor'] = ((s as any).stanok ?? 0);
      // TODO-QSP: killvar 'stanok'
    }
    if (((s as any).krem ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['suncream'] = ((s as any).krem ?? 0);
      // TODO-QSP: killvar 'krem'
    }
    if (((s as any).deodorant ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['deodorant'] = ((s as any).deodorant ?? 0);
      // TODO-QSP: killvar 'deodorant'
    }
    if (((s as any).tampon ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['tampons'] = ((s as any).tampon ?? 0);
      // TODO-QSP: killvar 'tampon'
    }
    if (((s as any).sanpad ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['sanitary_pads'] = ((s as any).sanpad ?? 0);
      // TODO-QSP: killvar 'sanpad'
    }
    if (((s as any).shampoo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['shampoo'] = ((s as any).shampoo ?? 0);
      // TODO-QSP: killvar 'shampoo'
    }
    if (((s as any).hscrunch ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['scrunchies'] = ((s as any).hscrunch ?? 0);
      // TODO-QSP: killvar 'hscrunch'
    }
    if (((s as any).hpingrip ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['kirbygrips'] = ((s as any).hpingrip ?? 0);
      // TODO-QSP: killvar 'hpingrip'
    }
    if (((s as any).salfetka ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['makeup_wipes'] = ((s as any).salfetka ?? 0);
      // TODO-QSP: killvar 'salfetka'
    }
    if (((s as any).mouthwash ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['mouthwash'] = ((s as any).mouthwash ?? 0);
      // TODO-QSP: killvar 'mouthwash'
    }
    if (((s as any).greben ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['comb'] = ((s as any).greben ?? 0);
      // TODO-QSP: killvar 'greben'
    }
    if (((s as any).kosmetitka ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['travel_makeup'] = ((s as any).kosmetitka ?? 0);
      // TODO-QSP: killvar 'kosmetitka'
    }
    if (((s as any).compact_mirror ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['travel_mirror'] = ((s as any).compact_mirror ?? 0);
      // TODO-QSP: killvar 'compact_mirror'
    }
    if (((s as any).eda ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['food_basic'] = ((s as any).eda ?? 0);
      // TODO-QSP: killvar 'eda'
    }
    if (((s as any).edaD ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['food_diet'] = ((s as any).edaD ?? 0);
      // TODO-QSP: killvar 'edaD'
    }
    if (((s as any).pranik ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['food_biscuits'] = ((s as any).pranik ?? 0);
      // TODO-QSP: killvar 'pranik'
    }
    if (((s as any).buterbrod ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['food_sandwich'] = ((s as any).buterbrod ?? 0);
      // TODO-QSP: killvar 'buterbrod'
    }
    if (((s as any).wine ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['food_wine'] = ((s as any).wine ?? 0);
      // TODO-QSP: killvar 'wine'
    }
    if (((s as any).bottle ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['food_water'] = ((s as any).bottle ?? 0);
      // TODO-QSP: killvar 'bottle'
    }
    if (((s as any).pregtest ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['pregnancy_test'] = ((s as any).pregtest ?? 0);
      // TODO-QSP: killvar 'pregtest'
    }
    if (((s as any).lekarstvo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['antibiotics'] = ((s as any).lekarstvo ?? 0);
      // TODO-QSP: killvar 'lekarstvo'
    }
    if (((s as any).vitamin ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['vitamins'] = ((s as any).vitamin ?? 0);
      // TODO-QSP: killvar 'vitamin'
    }
    if (((s as any).painkiller ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['painkillers'] = ((s as any).painkiller ?? 0);
      // TODO-QSP: killvar 'painkiller'
    }
    if (((s as any).mosolmaz ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['chafing_cream'] = ((s as any).mosolmaz ?? 0);
      // TODO-QSP: killvar 'mosolmaz'
    }
    if (((s as any).lubri ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['lubricant'] = ((s as any).lubri ?? 0);
      // TODO-QSP: killvar 'lubri'
    }
    if (((s as any).klisma ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['enema_kit'] = ((s as any).klisma ?? 0);
      // TODO-QSP: killvar 'klisma'
    }
    if (((s as any).breastpump ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['breast_pump'] = ((s as any).breastpump ?? 0);
      // TODO-QSP: killvar 'breastpump'
    }
    if (((s as any).bpbottles ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['bottle_s'] = ((s as any).bpbottles ?? 0);
      // TODO-QSP: killvar 'bpbottles'
    }
    if (((s as any).bpbottlem ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['bottle_m'] = ((s as any).bpbottlem ?? 0);
      // TODO-QSP: killvar 'bpbottlem'
    }
    if (((s as any).bpnipplebalm ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['nipple_cream'] = ((s as any).bpnipplebalm ?? 0);
      // TODO-QSP: killvar 'bpnipplebalm'
    }
    if (((s as any).fatdel ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['weight_loss_pill'] = ((s as any).fatdel ?? 0);
      // TODO-QSP: killvar 'fatdel'
    }
    if (((s as any).morning_after_pill ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['morning_after_pill'] = ((s as any).morning_after_pill ?? 0);
      // TODO-QSP: killvar 'morning_after_pill'
    }
    if (((s as any).prezik ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['equipped_condoms'] = ((s as any).prezik ?? 0);
      // TODO-QSP: killvar 'prezik'
    }
    if (((s as any).prezikcount ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['normal_condoms'] = ((s as any).prezikcount ?? 0);
      // TODO-QSP: killvar 'prezikcount'
    }
    if (((s as any).preziksabo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['sabotaged_condoms'] = ((s as any).preziksabo ?? 0);
      // TODO-QSP: killvar 'preziksabo'
    }
    if (((s as any).badprezik ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['bad_condoms'] = ((s as any).badprezik ?? 0);
      // TODO-QSP: killvar 'badprezik'
    }
    if (((s as any).tabletki ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['contraceptive_pill'] = ((s as any).tabletki ?? 0);
      // TODO-QSP: killvar 'tabletki'
    }
    if (((s as any).siga ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['cigarettes'] = ((s as any).siga ?? 0);
      // TODO-QSP: killvar 'siga'
    }
    if (((s as any).fashmag ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['mag_fashion'] = ((s as any).fashmag ?? 0);
      // TODO-QSP: killvar 'fashmag'
    }
    if (((s as any).compmag ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['mag_computer'] = ((s as any).compmag ?? 0);
      // TODO-QSP: killvar 'compmag'
    }
    if (((s as any).biomag ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['mag_biography'] = ((s as any).biomag ?? 0);
      // TODO-QSP: killvar 'biomag'
    }
    if (((s as any).cookmag ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['mag_cooking'] = ((s as any).cookmag ?? 0);
      // TODO-QSP: killvar 'cookmag'
    }
    if (((s as any).knitmag ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['mag_knitting'] = ((s as any).knitmag ?? 0);
      // TODO-QSP: killvar 'knitmag'
    }
    if (((s as any).fitmag ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['mag_fitness'] = ((s as any).fitmag ?? 0);
      // TODO-QSP: killvar 'fitmag'
    }
    if (((s as any).umbrella ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['umbrella'] = ((s as any).umbrella ?? 0);
      // TODO-QSP: killvar 'umbrella'
    }
    if (((s as any).pornMagazine ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['mag_porn'] = ((s as any).pornMagazine ?? 0);
      // TODO-QSP: killvar 'pornMagazine'
    }
    if (((s as any).vibrator ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['vibe'] = ((s as any).vibrator ?? 0);
      // TODO-QSP: killvar 'vibrator'
    }
    if (((s as any).analplug ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['buttplug'] = ((s as any).analplug ?? 0);
      // TODO-QSP: killvar 'analplug'
    }
    if (((s as any).suction_dildo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['dildo_suction'] = ((s as any).suction_dildo ?? 0);
      // TODO-QSP: killvar 'suction_dildo'
    }
    if (((s as any).strapon ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['strapon'] = ((s as any).strapon ?? 0);
      // TODO-QSP: killvar 'strapon'
    }
    if (((s as any).dildo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['dildo_small'] = ((s as any).dildo ?? 0);
      // TODO-QSP: killvar 'dildo'
    }
    if (((s as any).middildo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['dildo_normal'] = ((s as any).middildo ?? 0);
      // TODO-QSP: killvar 'middildo'
    }
    if (((s as any).largedildo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['dildo_big'] = ((s as any).largedildo ?? 0);
      // TODO-QSP: killvar 'largedildo'
    }
    if (((s as any).bigdildo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['dildo_large'] = ((s as any).bigdildo ?? 0);
      // TODO-QSP: killvar 'bigdildo'
    }
    if (((s as any).extradildo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['dildo_huge'] = ((s as any).extradildo ?? 0);
      // TODO-QSP: killvar 'extradildo'
    }
    if (((s as any).superdildo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['dildo_enormous'] = ((s as any).superdildo ?? 0);
      // TODO-QSP: killvar 'superdildo'
    }
    if (((s as any).maddildo ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['dildo_gigantic'] = ((s as any).maddildo ?? 0);
      // TODO-QSP: killvar 'maddildo'
    }
    if (((s as any).skak ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['skipping_rope'] = ((s as any).skak ?? 0);
      // TODO-QSP: killvar 'skak'
    }
    if (((s as any).obruch ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['hula_hoop'] = ((s as any).obruch ?? 0);
      // TODO-QSP: killvar 'obruch'
    }
    if (((s as any).bookyog ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['book_yoga'] = ((s as any).bookyog ?? 0);
      // TODO-QSP: killvar 'bookyog'
    }
    if (((s as any).konki ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['ice_skates'] = ((s as any).konki ?? 0);
      // TODO-QSP: killvar 'konki'
    }
    if (((s as any).pcs_ski_owned ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['ski'] = ((s as any).pcs_ski_owned ?? 0);
      // TODO-QSP: killvar 'pcs_ski_owned'
    }
    if (((s as any).refillable_bottle ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['refill_bottle'] = ((s as any).refillable_bottle ?? 0);
      // TODO-QSP: killvar 'refillable_bottle'
    }
    if (((s as any).fairy ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['dish_soap'] = ((s as any).fairy ?? 0);
      // TODO-QSP: killvar 'fairy'
    }
    if (((s as any).poroshok ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['laundry_soap'] = ((s as any).poroshok ?? 0);
      // TODO-QSP: killvar 'poroshok'
    }
    if (((s as any).cltarelka ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['dish_plates'] = ((s as any).cltarelka ?? 0);
      // TODO-QSP: killvar 'cltarelka'
    }
    if (((s as any).tkan ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['sewing_fabric'] = ((s as any).tkan ?? 0);
      // TODO-QSP: killvar 'tkan'
    }
    if (((s as any).sewing_kit ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['sewing_kit'] = ((s as any).sewing_kit ?? 0);
      // TODO-QSP: killvar 'sewing_kit'
    }
    if (((s as any).TV ?? 0) === 1) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['tech_tv'] = 1;
      // TODO-QSP: killvar 'TV'
    }
    if (((s as any).TV ?? 0) >= 2) {
    ...
    if (((s as any).komp ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['tech_computer'] = ((s as any).komp ?? 0);
      // TODO-QSP: killvar 'komp'
    }
    if (((s as any).GameCD2 ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['tech_game_ds'] = ((s as any).GameCD2 ?? 0);
      // TODO-QSP: killvar 'GameCD2'
    }
    if (((s as any).posudomashina ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['tech_dishwasher'] = ((s as any).posudomashina ?? 0);
      // TODO-QSP: killvar 'posudomashina'
    }
    if (((s as any).stiralka ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['tech_washing_machine'] = ((s as any).stiralka ?? 0);
      // TODO-QSP: killvar 'stiralka'
    }
    if (((s as any).zenit ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['tech_camera'] = ((s as any).zenit ?? 0);
      // TODO-QSP: killvar 'zenit'
    }
    if (((s as any).minifoto ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['tech_hidden_cam'] = ((s as any).minifoto ?? 0);
      // TODO-QSP: killvar 'minifoto'
    }
    if (((s as any).webcamera ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['tech_webcam'] = ((s as any).webcamera ?? 0);
      // TODO-QSP: killvar 'webcamera'
    }
    if (((s as any).ms_pill ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['meds_morning_sick'] = ((s as any).ms_pill ?? 0);
      // TODO-QSP: killvar 'ms_pill'
    }
    if (((s as any).preg_ball ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['preg_ball'] = ((s as any).preg_ball ?? 0);
      // TODO-QSP: killvar 'preg_ball'
    }
    if (((s as any).preg_brace ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['preg_brace'] = ((s as any).preg_brace ?? 0);
      // TODO-QSP: killvar 'preg_brace'
    }
    if (((s as any).preg_pillow ?? 0) > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['preg_pillow'] = ((s as any).preg_pillow ?? 0);
      // TODO-QSP: killvar 'preg_pillow'
    }
    (s as any).pref_update_index = 1;
    // TODO-QSP: :update_standard_preferences_loop
    qspCall(s, 'npc_standard_preferences', 'A<<pref_update_index>>');
    ...
    if (((s as any).shplft_booked ?? 0)    > 0) {
      if (!(s as any).policeQW) (s as any).policeQW = {}; (s as any).policeQW['shoplift_booked'] = ((s as any).shplft_booked ?? 0);
      // TODO-QSP: killvar 'shplft_booked'
    }
    if (((s as any).prst_booked ?? 0)      > 0) {
      if (!(s as any).policeQW) (s as any).policeQW = {}; (s as any).policeQW['prostitution_booked'] = ((s as any).prst_booked ?? 0);
      // TODO-QSP: killvar 'prst_booked'
    }
    if (((s as any).shplft_counter ?? 0)    > 0) {
      if (!(s as any).policeQW) (s as any).policeQW = {}; (s as any).policeQW['shoplift_counter'] = ((s as any).shplft_counter ?? 0);
      // TODO-QSP: killvar 'shplft_counter'
    }
    if (((s as any).prst_counter ?? 0)      > 0) {
      if (!(s as any).policeQW) (s as any).policeQW = {}; (s as any).policeQW['prostitution_counter'] = ((s as any).prost_counter ?? 0);
      // TODO-QSP: killvar 'prst_counter'
    }
    if (((s as any).prst_bribe ?? 0)      > 0) {
      if (!(s as any).policeQW) (s as any).policeQW = {}; (s as any).policeQW['prostitution_bribe'] = ((s as any).prst_bribe ?? 0);
      // TODO-QSP: killvar 'prst_bribe'
    }
    if (((s as any).shplft_value ?? 0)      > 0) {
      if (!(s as any).policeQW) (s as any).policeQW = {}; (s as any).policeQW['shoplift_value'] = ((s as any).shplft_value ?? 0);
      // TODO-QSP: killvar 'shplft_value'
    }
    if (((s as any).bookingofficer_rel ?? 0)  > 0) {
      if (!(s as any).policeQW) (s as any).policeQW = {}; (s as any).policeQW['bookingofficer_rel'] = ((s as any).bookingofficer_rel ?? 0);
      // TODO-QSP: killvar 'bookingofficer_rel'
    }
    if (((s as any).toldonguard ?? 0)      > 0) {
      if (!(s as any).policeQW) (s as any).policeQW = {}; (s as any).policeQW['toldonguard'] = ((s as any).toldonguard ?? 0);
      // TODO-QSP: killvar 'toldonguard'
    }
    if (((s as any).courtletter_date ?? 0) > 0) {
      if (!(s as any).policeQW_courtletter_dates) (s as any).policeQW_courtletter_dates = {}; (s as any).policeQW_courtletter_dates[0] = ((s as any).courtletter_date ?? 0);
    ...
    if (((s as any).courthearing_date ?? 0) > 0) {
      if (!(s as any).policeQW_courthearing_dates) (s as any).policeQW_courthearing_dates = {}; (s as any).policeQW_courthearing_dates[0] = ((s as any).courthearing_date ?? 0);
    ...
    if (((s as any).legal_fine ?? 0) > 0) {
      if (!(s as any).policeQW) (s as any).policeQW = {}; (s as any).policeQW['legal_fine'] = ((s as any).legal_fine ?? 0);
      // TODO-QSP: killvar 'legal_fine'
    }
    if (((s as any).bedPanty ?? 0)       > 0) {
      if (!(s as any).sleepVars) (s as any).sleepVars = {}; (s as any).sleepVars['bedPanty'] = ((s as any).bedPanty ?? 0);
      // TODO-QSP: killvar 'bedPanty'
    }
    if (((s as any).bedAnal ?? 0)        > 0) {
      if (!(s as any).sleepVars) (s as any).sleepVars = {}; (s as any).sleepVars['bedAnal'] = ((s as any).bedAnal ?? 0);
      // TODO-QSP: killvar 'bedAnal'
    }
    if (((s as any).bedVibrator ?? 0)    > 0) {
      if (!(s as any).sleepVars) (s as any).sleepVars = {}; (s as any).sleepVars['bedVibrator'] = ((s as any).bedVibrator ?? 0);
      // TODO-QSP: killvar 'bedVibrator'
    }
    if (((s as any).cheatVib ?? 0)       > 0) {
      if (!(s as any).sleepVars) (s as any).sleepVars = {}; (s as any).sleepVars['cheatVib'] = ((s as any).cheatVib ?? 0);
      // TODO-QSP: killvar 'cheatVib'
    }
    if (((s as any).notathomesleep ?? 0) > 0) {
      if (!(s as any).sleepVars) (s as any).sleepVars = {}; (s as any).sleepVars['notathomesleep'] = ((s as any).notathomesleep ?? 0);
      // TODO-QSP: killvar 'notathomesleep'
    }
    if (((s as any).Enable_nodream ?? 0) > 0) {
      if (!(s as any).sleepVars) (s as any).sleepVars = {}; (s as any).sleepVars['cheat_nodream_chance'] = ((s as any).Enable_nodream ?? 0);
    ...
    if (((s as any).budilnikOn ?? 0)       > 0) {
      if (!(s as any).alarmVars) (s as any).alarmVars = {}; (s as any).alarmVars['alarmOn'] = ((s as any).budilnikOn ?? 0);
      // TODO-QSP: killvar 'budilnikOn'
    }
    if (((s as any).timer ?? 0)            > 0) {
      if (!(s as any).alarmVars) (s as any).alarmVars = {}; (s as any).alarmVars['timerH'] = ((s as any).timer ?? 0);
      // TODO-QSP: killvar 'timer'
    }
    if (((s as any).timerM ?? 0)           > 0) {
      if (!(s as any).alarmVars) (s as any).alarmVars = {}; (s as any).alarmVars['timerM'] = ((s as any).timerM ?? 0);
      // TODO-QSP: killvar 'timerM'
    }
    if (((s as any).timerEnd ?? 0)         > 0) {
      if (!(s as any).alarmVars) (s as any).alarmVars = {}; (s as any).alarmVars['timerEndH'] = ((s as any).timerEnd ?? 0);
      // TODO-QSP: killvar 'timerEnd'
    }
    if (((s as any).timerEndM ?? 0)        > 0) {
      if (!(s as any).alarmVars) (s as any).alarmVars = {}; (s as any).alarmVars['timerEndM'] = ((s as any).timerEndM ?? 0);
      // TODO-QSP: killvar 'timerEndM'
    }
    if (((s as any).alarm_holiday ?? 0)    > 0) {
      if (!(s as any).alarmVars) (s as any).alarmVars = {}; (s as any).alarmVars['alarm_holiday'] = ((s as any).alarm_holiday ?? 0);
      // TODO-QSP: killvar 'alarm_holiday'
    }
    (s as any).npctemp = 264;
    if (!(s as any).npc_dna) (s as any).npc_dna = {}; (s as any).npc_dna['A' + String((s as any).npctemp || '') + ''] = '1290130369 1043654233 5049908515 3153411713 0721993774 2486220839 0288719745';
    if (!(s as any).npc_firstname) (s as any).npc_firstname = {}; (s as any).npc_firstname['A' + String((s as any).npctemp || '') + ''] = 'Yakov';
    if (!(s as any).npc_nickname) (s as any).npc_nickname = {}; (s as any).npc_nickname['A' + String((s as any).npctemp || '') + ''] = 'Yakov';
    if (!(s as any).npc_lastname) (s as any).npc_lastname = {}; (s as any).npc_lastname['A' + String((s as any).npctemp || '') + ''] = '';
    if (!(s as any).npc_usedname) (s as any).npc_usedname = {}; (s as any).npc_usedname['A' + String((s as any).npctemp || '') + ''] = 'Yakov';
    if (!(s as any).npc_dob) (s as any).npc_dob = {}; (s as any).npc_dob['A' + String((s as any).npctemp || '') + ''] = 19961215;
    if (!(s as any).npc_notes) (s as any).npc_notes = {}; (s as any).npc_notes['A' + String((s as any).npctemp || '') + ''] = 'Yakov is a fitness-focused sports enthusiast with blond hair and a tanned complexion.';
    ...
    if (!(s as any).npc_occupation) (s as any).npc_occupation = {}; (s as any).npc_occupation['A' + String((s as any).npctemp || '') + ''] = 'personal_trainer';
    if (!(s as any).npc_style) (s as any).npc_style = {}; (s as any).npc_style['A' + String((s as any).npctemp || '') + ''] = 5;
    (s as any).npctemp = 265;
    if (!(s as any).npc_dna) (s as any).npc_dna = {}; (s as any).npc_dna['A' + String((s as any).npctemp || '') + ''] = '1085950303 4348731991 6618084127 9067996922 8669859044 9431283301 0673267503';
    if (!(s as any).npc_firstname) (s as any).npc_firstname = {}; (s as any).npc_firstname['A' + String((s as any).npctemp || '') + ''] = 'Nestor';
    if (!(s as any).npc_nickname) (s as any).npc_nickname = {}; (s as any).npc_nickname['A' + String((s as any).npctemp || '') + ''] = 'Nestor';
    if (!(s as any).npc_lastname) (s as any).npc_lastname = {}; (s as any).npc_lastname['A' + String((s as any).npctemp || '') + ''] = '';
    if (!(s as any).npc_usedname) (s as any).npc_usedname = {}; (s as any).npc_usedname['A' + String((s as any).npctemp || '') + ''] = 'Nestor';
    if (!(s as any).npc_dob) (s as any).npc_dob = {}; (s as any).npc_dob['A' + String((s as any).npctemp || '') + ''] = 19930127;
    if (!(s as any).npc_notes) (s as any).npc_notes = {}; (s as any).npc_notes['A' + String((s as any).npctemp || '') + ''] = 'Nestor is a gopnik with a reputation for being rude and aggressive. His motto seems to be "the younger, the better," which can be concerning. He has a tough demeanor, with dark hair and dark skin, giving off an intimidating presence.';
    if (!(s as any).npc_gender) (s as any).npc_gender = {}; (s as any).npc_gender['A' + String((s as any).npctemp || '') + ''] = 0;
    qspCall(s, 'npcstaticdefaults', 'defaults');
    ...
    if (!(s as any).npc_sexskill) (s as any).npc_sexskill = {}; (s as any).npc_sexskill['A' + String((s as any).npctemp || '') + ''] = 1;
    if (!(s as any).npc_style) (s as any).npc_style = {}; (s as any).npc_style['A' + String((s as any).npctemp || '') + ''] = 2;
    (s as any).npctemp = 266;
    if (!(s as any).npc_dna) (s as any).npc_dna = {}; (s as any).npc_dna['A' + String((s as any).npctemp || '') + ''] = '5654106058 6395942483 3363408422 7113656738 1111862818 8859290040 7960339191';
    if (!(s as any).npc_firstname) (s as any).npc_firstname = {}; (s as any).npc_firstname['A' + String((s as any).npctemp || '') + ''] = 'Oleg';
    if (!(s as any).npc_nickname) (s as any).npc_nickname = {}; (s as any).npc_nickname['A' + String((s as any).npctemp || '') + ''] = 'Oleg';
    if (!(s as any).npc_lastname) (s as any).npc_lastname = {}; (s as any).npc_lastname['A' + String((s as any).npctemp || '') + ''] = '';
    if (!(s as any).npc_usedname) (s as any).npc_usedname = {}; (s as any).npc_usedname['A' + String((s as any).npctemp || '') + ''] = 'Oleg';
    if (!(s as any).npc_dob) (s as any).npc_dob = {}; (s as any).npc_dob['A' + String((s as any).npctemp || '') + ''] = 19950712;
    if (!(s as any).npc_notes) (s as any).npc_notes = {}; (s as any).npc_notes['A' + String((s as any).npctemp || '') + ''] = 'Oleg is a shy, young-looking guy with thick glasses, a slim frame, and very pale skin.';
    if (!(s as any).npc_gender) (s as any).npc_gender = {}; (s as any).npc_gender['A' + String((s as any).npctemp || '') + ''] = 0;
    qspCall(s, 'npcstaticdefaults', 'defaults');
    ...
    if (!(s as any).npc_sexskill) (s as any).npc_sexskill = {}; (s as any).npc_sexskill['A' + String((s as any).npctemp || '') + ''] = 1;
    if (!(s as any).npc_occupation) (s as any).npc_occupation = {}; (s as any).npc_occupation['A' + String((s as any).npctemp || '') + ''] = 'programmer';
    if (!(s as any).npc_style) (s as any).npc_style = {}; (s as any).npc_style['A' + String((s as any).npctemp || '') + ''] = 3;
    if (((s as any).sp_rel ?? 0)                  > 0) {
      if (!(s as any).npc_rel) (s as any).npc_rel = {}; (s as any).npc_rel['A264'] = ((s as any).sp_rel ?? 0);
      // TODO-QSP: killvar 'sp_rel'
    }
    if (((s as any).gp_rel ?? 0)                  > 0) {
      if (!(s as any).npc_rel) (s as any).npc_rel = {}; (s as any).npc_rel['A265'] = ((s as any).gp_rel ?? 0);
      // TODO-QSP: killvar 'gp_rel'
    }
    if (((s as any).nd_rel ?? 0)                  > 0) {
      if (!(s as any).npc_rel) (s as any).npc_rel = {}; (s as any).npc_rel['A266'] = ((s as any).nd_rel ?? 0);
    ...
    if (!(s as any).prostitute) (s as any).prostitute = {}; (s as any).prostitute['wl_block'] = ((s as any).prostitute ?? 0)?.['blocked'];
    if (!(s as any).prostitute) (s as any).prostitute = {}; (s as any).prostitute['full_block'] = 0;
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90200) {
    if (((s as any).genbsize ?? 0)      !== 0) {
      if (!(s as any).pcs_mass) (s as any).pcs_mass = {}; (s as any).pcs_mass['bust_gen'] = ((s as any).genbsize ?? 0);
      // TODO-QSP: killvar 'genbsize'
    }
    if (((s as any).nbsize ?? 0)      !== 0) {
      if (!(s as any).pcs_mass) (s as any).pcs_mass = {}; (s as any).pcs_mass['bust'] = ((s as any).nbsize ?? 0);
    ...
    if (((s as any).vhips ?? 0)      !== 0) {
      if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['vhips'] = ((s as any).vhips ?? 0);
      // TODO-QSP: killvar 'vhips'
    }
    if (((s as any).wratio ?? 0)      !== 0) {
      if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['wratio'] = ((s as any).wratio ?? 0);
      // TODO-QSP: killvar 'wratio'
    }
    if (((s as any).bratio ?? 0)      !== 0) {
      if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['bratio'] = ((s as any).bratio ?? 0);
      // TODO-QSP: killvar 'bratio'
    }
    if (((s as any).hratio ?? 0)      !== 0) {
      if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['hratio'] = ((s as any).hratio ?? 0);
      // TODO-QSP: killvar 'hratio'
    }
    if (((s as any).magicf2b ?? 0)      !== 0) {
      if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['bust_magic'] = ((s as any).magicf2b ?? 0);
      // TODO-QSP: killvar 'magicf2b'
    }
    if (((s as any).silicone_butt ?? 0)  !== 0) {
      if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['butt_silicone'] = ((s as any).silicone_butt ?? 0);
      // TODO-QSP: killvar 'silicone_butt'
    }
    if (((s as any).silicone ?? 0)      !== 0) {
      if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['bust_silicone'] = ((s as any).silicone ?? 0);
      // TODO-QSP: killvar 'silicone'
    }
    if (((s as any).butt_cheat ?? 0)    !== 0) {
      if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['butt_cheat'] = ((s as any).butt_cheat ?? 0);
    ...
    if (((s as any).katjaQW ?? 0)?.['knows_masterbation'] > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['knows_masturbation'] = ((s as any).katjaQW ?? 0)?.['knows_masterbation'];
      qspCall(s, 'array', 'remove_element', 'katjaQW', 'knows_masterbation');
    }
    if (((s as any).bmi_desc ?? 0)  !== '') {
      if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['bmi_desc'] = ((s as any).bmi_desc ?? 0);
    ...
    if (((s as any).temp_st ?? 0)[1] === '') {
      if (!(s as any).temp_st) (s as any).temp_st = {}; (s as any).temp_st[1] = 'magic';
    }
    ...
    if (!(s as any).start_type) (s as any).start_type = {}; (s as any).start_type['loc'] = qspUntranslated(s, "temp_st[0]", { location: "saveupdater" });
    if (!(s as any).start_type) (s as any).start_type = {}; (s as any).start_type['magic'] = qspUntranslated(s, "temp_st[1]", { location: "saveupdater" });
    if (!(s as any).start_type) (s as any).start_type = {}; (s as any).start_type['group'] = qspUntranslated(s, "temp_st[2]", { location: "saveupdater" });
    if (!(s as any).start_type) (s as any).start_type = {}; (s as any).start_type['cat'] = qspUntranslated(s, "temp_st[3]", { location: "saveupdater" });
    if (((s as any).start_type ?? 0)?.['loc']  === '') {
      if (!(s as any).start_type) (s as any).start_type = {}; (s as any).start_type['loc'] = 'city';
    }
    if (((s as any).start_type ?? 0)?.['magic']  === '') {
      if (!(s as any).start_type) (s as any).start_type = {}; (s as any).start_type['magic'] = 'magic';
    }
    ...
    if (Object.keys((s as any).fashionista ?? {}).length > 0) {
      ...
      if (((s as any).fashionista ?? 0)?.[String((s as any).i ?? 0)] === 1) {
        if (!(s as any).fashionista_dress) (s as any).fashionista_dress = {}; (s as any).fashionista_dress[String((s as any).i ?? 0)] = 1;
        if (!(s as any).fashionista_dress_h) (s as any).fashionista_dress_h = {}; (s as any).fashionista_dress_h[String((s as any).i ?? 0)] = ((s as any).fashionista_h ?? 0)?.[String((s as any).i ?? 0)];
        if (!(s as any).fashionista_dress_b) (s as any).fashionista_dress_b = {}; (s as any).fashionista_dress_b[String((s as any).i ?? 0)] = ((s as any).fashionista_b ?? 0)?.[String((s as any).i ?? 0)];
        if (!(s as any).fashionista_dress_s) (s as any).fashionista_dress_s = {}; (s as any).fashionista_dress_s[String((s as any).i ?? 0)] = ((s as any).fashionista_s ?? 0)?.[String((s as any).i ?? 0)];
      }
    ...
    if (((s as any).Trainpass_day ?? 0) !== 0) {
      if (!(s as any).transportVars) (s as any).transportVars = {}; (s as any).transportVars['trainpass_day'] = ((s as any).Trainpass_day ?? 0);
      // TODO-QSP: killvar 'Trainpass_day'
    }
    if (((s as any).therapist_key ?? 0)[1] > 0) {
      if (!(s as any).therapistQW) (s as any).therapistQW = {}; (s as any).therapistQW['hotel_day'] = qspUntranslated(s, "therapist_key[1]", { location: "saveupdater" });
      // TODO-QSP: killvar 'therapist_key', 1
    }
    if (((s as any).therapist_key ?? 0) > 0) {
      if (!(s as any).therapistQW) (s as any).therapistQW = {}; (s as any).therapistQW['hotel_key'] = ((s as any).therapist_key ?? 0);
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90201) {
    if (((s as any).btwarn ?? 0) > 0) {
      if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['weight_warning'] = ((s as any).btwarn ?? 0);
      // TODO-QSP: killvar 'btwarn'
    }
    if (((s as any).pcs_mass ?? 0)?.['body_message'] === 0) {
      if (!(s as any).pcs_mass) (s as any).pcs_mass = {}; (s as any).pcs_mass['body_message'] = ((s as any).pcs_masss ?? 0)?.['body'];
    }
    (s as any).rej_idx = 0;
    (s as any).rej_sz = 0;
    // TODO-QSP: :lutcycloop
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90202) {
    if (((s as any).BDSMtaxi ?? 0) === 1) {
      ...
      if (((s as any).BDSMClubIn ?? 0) === 1) {
        ...
        if (!(s as any).bdsmclub) (s as any).bdsmclub = {}; (s as any).bdsmclub['payday'] = ((s as any).BDSMpayDay ?? 0);
      }
    }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90203) {
    ...
    // TODO-QSP: dynamic "
    if (((s as any).attskltmp ?? 0)((s as any)._lvl ?? 0) > 0) {
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90204) {
    if (((s as any).oleg_hj ?? 0)            > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['hj'] = ((s as any).oleg_hj ?? 0);
      // TODO-QSP: killvar 'oleg_hj'
    }
    if (((s as any).oleg_bj ?? 0)            > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['bj'] = ((s as any).oleg_bj ?? 0);
      // TODO-QSP: killvar 'oleg_bj'
    }
    if (((s as any).oleg_bjFail ?? 0)          > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['bjFail'] = ((s as any).oleg_bjFail ?? 0);
      // TODO-QSP: killvar 'oleg_bjFail'
    }
    if (((s as any).oleg_bjDeep ?? 0)          > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['bjDeep'] = ((s as any).oleg_bjDeep ?? 0);
      // TODO-QSP: killvar 'oleg_bjDeep'
    }
    if (((s as any).oleg_bjFailPuke ?? 0)        > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['bjFailPuke'] = ((s as any).oleg_bjFailPuke ?? 0);
      // TODO-QSP: killvar 'oleg_bjFailPuke'
    }
    if (((s as any).oleg_bjFailFaint ?? 0)        > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['bjFailFaint'] = ((s as any).oleg_bjFailFaint ?? 0);
      // TODO-QSP: killvar 'oleg_bjFailFaint'
    }
    if (((s as any).oleg_swall ?? 0)          > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['swall'] = ((s as any).oleg_swall ?? 0);
      // TODO-QSP: killvar 'oleg_swall'
    }
    if (((s as any).oleg_vagCumInsideUnwanted ?? 0)  > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['vagCumInsideUnwanted'] = ((s as any).oleg_vagCumInsideUnwanted ?? 0);
      // TODO-QSP: killvar 'oleg_vagCumInsideUnwanted'
    }
    if (((s as any).oleg_vag ?? 0)            > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['vag'] = ((s as any).oleg_vag ?? 0);
      // TODO-QSP: killvar 'oleg_vag'
    }
    if (((s as any).oleg_vagCumInside ?? 0)      > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['vagCumInside'] = ((s as any).oleg_vagCumInside ?? 0);
      // TODO-QSP: killvar 'oleg_vagCumInside'
    }
    if (((s as any).oleg_anal ?? 0)          > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['anal'] = ((s as any).oleg_anal ?? 0);
      // TODO-QSP: killvar 'oleg_anal'
    }
    if (((s as any).oleg_analCumInside ?? 0)      > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['analCumInside'] = ((s as any).oleg_analCumInside ?? 0);
    ...
    if (((s as any).oleg_piss ?? 0)          > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['piss'] = ((s as any).oleg_piss ?? 0);
      // TODO-QSP: killvar 'oleg_piss'
    }
    if (((s as any).oleg_doPornpos ?? 0)        > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['doPornpos'] = ((s as any).oleg_doPornpos ?? 0);
      // TODO-QSP: killvar 'oleg_doPornpos'
    }
    if (((s as any).oleg_pornPos ?? 0)          > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['pornPos'] = ((s as any).oleg_pornPos ?? 0);
      // TODO-QSP: killvar 'oleg_pornPos'
    }
    if (((s as any).nestor_bj ?? 0)          > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['bj'] = ((s as any).nestor_bj ?? 0);
      // TODO-QSP: killvar 'nestor_bj'
    }
    if (((s as any).nestor_bjFail ?? 0)        > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['bjFail'] = ((s as any).nestor_bjFail ?? 0);
      // TODO-QSP: killvar 'nestor_bjFail'
    }
    if (((s as any).nestor_bjDeep ?? 0)        > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['bjDeep'] = ((s as any).nestor_bjDeep ?? 0);
      // TODO-QSP: killvar 'nestor_bjDeep'
    }
    if (((s as any).nestor_bjFailPuke ?? 0)      > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['bjFailPuke'] = ((s as any).nestor_bjFailPuke ?? 0);
      // TODO-QSP: killvar 'nestor_bjFailPuke'
    }
    if (((s as any).nestor_bjFailFaint ?? 0)      > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['bjFailFaint'] = ((s as any).nestor_bjFailFaint ?? 0);
      // TODO-QSP: killvar 'nestor_bjFailFaint'
    }
    if (((s as any).nestor_swall ?? 0)          > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['swall'] = ((s as any).nestor_swall ?? 0);
      // TODO-QSP: killvar 'nestor_swall'
    }
    if (((s as any).nestor_vagCumInsideUnwanted ?? 0)  > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['vagCumInsideUnwanted'] = ((s as any).nestor_vagCumInsideUnwanted ?? 0);
      // TODO-QSP: killvar 'nestor_vagCumInsideUnwanted'
    }
    if (((s as any).nestor_vag ?? 0)          > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['vag'] = ((s as any).nestor_vag ?? 0);
      // TODO-QSP: killvar 'nestor_vag'
    }
    if (((s as any).nestor_vagCumInside ?? 0)      > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['vagCumInside'] = ((s as any).nestor_vagCumInside ?? 0);
      // TODO-QSP: killvar 'nestor_vagCumInside'
    }
    if (((s as any).nestor_anal ?? 0)          > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['anal'] = ((s as any).nestor_anal ?? 0);
      // TODO-QSP: killvar 'nestor_anal'
    }
    if (((s as any).nestor_analCumInside ?? 0)      > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['analCumInside'] = ((s as any).nestor_analCumInside ?? 0);
    ...
    if (((s as any).nestor_doPornpos ?? 0)        > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['doPornpos'] = ((s as any).nestor_doPornpos ?? 0);
      // TODO-QSP: killvar 'nestor_doPornpos'
    }
    if (((s as any).nestor_pornPos ?? 0)        > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['pornPos'] = ((s as any).nestor_pornPos ?? 0);
      // TODO-QSP: killvar 'nestor_pornPos'
    }
    if (((s as any).yakov_bj ?? 0)            > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['bj'] = ((s as any).yakov_bj ?? 0);
      // TODO-QSP: killvar 'yakov_bj'
    }
    if (((s as any).yakov_bjFail ?? 0)          > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['bjFail'] = ((s as any).yakov_bjFail ?? 0);
      // TODO-QSP: killvar 'yakov_bjFail'
    }
    if (((s as any).yakov_bjDeep ?? 0)          > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['bjDeep'] = ((s as any).yakov_bjDeep ?? 0);
      // TODO-QSP: killvar 'yakov_bjDeep'
    }
    if (((s as any).yakov_bjFailPuke ?? 0)        > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['bjFailPuke'] = ((s as any).yakov_bjFailPuke ?? 0);
      // TODO-QSP: killvar 'yakov_bjFailPuke'
    }
    if (((s as any).yakov_bjFailFaint ?? 0)      > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['bjFailFaint'] = ((s as any).yakov_bjFailFaint ?? 0);
      // TODO-QSP: killvar 'yakov_bjFailFaint'
    }
    if (((s as any).yakov_swall ?? 0)          > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['swall'] = ((s as any).yakov_swall ?? 0);
      // TODO-QSP: killvar 'yakov_swall'
    }
    if (((s as any).yakov_vagCumInsideUnwanted ?? 0)  > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['vagCumInsideUnwanted'] = ((s as any).yakov_vagCumInsideUnwanted ?? 0);
      // TODO-QSP: killvar 'yakov_vagCumInsideUnwanted'
    }
    if (((s as any).yakov_vag ?? 0)          > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['vag'] = ((s as any).yakov_vag ?? 0);
      // TODO-QSP: killvar 'yakov_vag'
    }
    if (((s as any).yakov_vagCumInside ?? 0)      > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['vagCumInside'] = ((s as any).yakov_vagCumInside ?? 0);
      // TODO-QSP: killvar 'yakov_vagCumInside'
    }
    if (((s as any).yakov_anal ?? 0)          > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['anal'] = ((s as any).yakov_anal ?? 0);
      // TODO-QSP: killvar 'yakov_anal'
    }
    if (((s as any).yakov_analCumInside ?? 0)      > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['analCumInside'] = ((s as any).yakov_analCumInside ?? 0);
    ...
    if (((s as any).yakov_doPornpos ?? 0)        > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['doPornpos'] = ((s as any).yakov_doPornpos ?? 0);
      // TODO-QSP: killvar 'yakov_doPornpos'
    }
    if (((s as any).yakov_pornPos ?? 0)        > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['pornPos'] = ((s as any).yakov_pornPos ?? 0);
      // TODO-QSP: killvar 'yakov_pornPos'
    }
    if (((s as any).yakov_hj ?? 0)            > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['hj'] = ((s as any).yakov_hj ?? 0);
      // TODO-QSP: killvar 'yakov_hj'
    }
    if (((s as any).yakov_dildo ?? 0)          > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['dildo'] = ((s as any).yakov_dildo ?? 0);
      // TODO-QSP: killvar 'yakov_dildo'
    }
    if (((s as any).rentLeft ?? 0)            > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['rentLeft'] = ((s as any).rentLeft ?? 0);
      // TODO-QSP: killvar 'rentLeft'
    }
    if (((s as any).weekNum ?? 0)            > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['weekNum'] = ((s as any).weekNum ?? 0);
      // TODO-QSP: killvar 'weekNum'
    }
    if (((s as any).rentWeekNum ?? 0)          > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['rentWeekNum'] = ((s as any).rentWeekNum ?? 0);
      // TODO-QSP: killvar 'rentWeekNum'
    }
    if (((s as any).servitudeLvl ?? 0)          > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['servitudeLvl'] = ((s as any).servitudeLvl ?? 0);
      // TODO-QSP: killvar 'servitudeLvl'
    }
    if (((s as any).servicePaid ?? 0)          > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['servicePaid'] = ((s as any).servicePaid ?? 0);
      // TODO-QSP: killvar 'servicePaid'
    }
    if (((s as any).cashPaid ?? 0)            > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['cashPaid'] = ((s as any).cashPaid ?? 0);
      // TODO-QSP: killvar 'cashPaid'
    }
    if (((s as any).pavSharedAptEnabled ?? 0)      > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['enabled'] = ((s as any).pavSharedAptEnabled ?? 0);
      // TODO-QSP: killvar 'pavSharedAptEnabled'
    }
    if (((s as any).pavIntroStep ?? 0)          > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['pavIntroStep'] = ((s as any).pavIntroStep ?? 0);
      // TODO-QSP: killvar 'pavIntroStep'
    }
    if (((s as any).rentWeekly ?? 0)          > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['rentWeekly'] = ((s as any).rentWeekly ?? 0);
      // TODO-QSP: killvar 'rentWeekly'
    }
    if (((s as any).price ?? 0)            > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['price'] = ((s as any).price ?? 0);
      // TODO-QSP: killvar 'price'
    }
    if (((s as any).vcard ?? 0)            > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['vintage_card'] = ((s as any).vcard ?? 0);
      // TODO-QSP: killvar 'vcard'
    }
    if (((s as any).card ?? 0)              > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['card'] = ((s as any).card ?? 0);
      // TODO-QSP: killvar 'card'
    }
    if (((s as any).sexCh ?? 0)            > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['sexCh'] = ((s as any).sexCh ?? 0);
      // TODO-QSP: killvar 'sexCh'
    }
    if (((s as any).actionR ?? 0)            > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['actionR'] = ((s as any).actionR ?? 0);
      // TODO-QSP: killvar 'actionR'
    }
    if (((s as any).seenAd ?? 0)            > 0) {
      if (!(s as any).shared_apt) (s as any).shared_apt = {}; (s as any).shared_apt['seenAd'] = ((s as any).seenAd ?? 0);
      // TODO-QSP: killvar 'seenAd'
    }
    if (((s as any).gobelen ?? 0)            > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['tapestry'] = ((s as any).gobelen ?? 0);
      // TODO-QSP: killvar 'gobelen'
    }
    if (((s as any).GarTorgItem ?? 0)          > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['trinkets_garage'] = ((s as any).GarTorgItem ?? 0);
      // TODO-QSP: killvar 'GarTorgItem'
    }
    if (((s as any).TovarL ?? 0)            > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['trinkets_home'] = ((s as any).TovarL ?? 0);
    ...
    if (((s as any).mc_inventory ?? 0)?.['refill_bottle'] > 0  &&  ((s as any).mc_inventory ?? 0)?.['refill_bottle_water'] === 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['refill_bottle_water'] = ((s as any).mc_inventory ?? 0)?.['refill_bottle'];
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['refill_bottle'] = 1;
    }
    if (((s as any).Oleg ?? 0)?.['analCumInside']      > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['cumAnal'] = ((s as any).Oleg ?? 0)?.['analCumInside'];
    }
    if (((s as any).Oleg ?? 0)?.['analCumInside']      > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['analCumInside'] = ((s as any).Oleg['analCumInside'] ?? 0) - (((s as any).Oleg ?? 0)?.['analCumInsideUnwanted']);
    }
    if (((s as any).Oleg ?? 0)?.['analCumInsideUnwanted']  > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['analCumInsideUnwanted'] = ((s as any).Oleg['analCumInsideUnwanted'] ?? 0) - (((s as any).Oleg ?? 0)?.['analCumInside']);
    }
    if (((s as any).Nestor ?? 0)?.['analCumInside']      > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['cumAnal'] = ((s as any).Nestor ?? 0)?.['analCumInside'];
    }
    if (((s as any).Nestor ?? 0)?.['analCumInside']      > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['analCumInside'] = ((s as any).Nestor['analCumInside'] ?? 0) - (((s as any).Nestor ?? 0)?.['analCumInsideUnwanted']);
    }
    if (((s as any).Nestor ?? 0)?.['analCumInsideUnwanted']  > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['analCumInsideUnwanted'] = ((s as any).Nestor['analCumInsideUnwanted'] ?? 0) - (((s as any).Nestor ?? 0)?.['analCumInside']);
    }
    if (((s as any).Yakov ?? 0)?.['analCumInside']      > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['cumAnal'] = ((s as any).Yakov ?? 0)?.['analCumInside'];
    }
    if (((s as any).Yakov ?? 0)?.['analCumInside']      > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['analCumInside'] = ((s as any).Yakov['analCumInside'] ?? 0) - (((s as any).Yakov ?? 0)?.['analCumInsideUnwanted']);
    }
    if (((s as any).Yakov ?? 0)?.['analCumInsideUnwanted']  > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['analCumInsideUnwanted'] = ((s as any).Yakov['analCumInsideUnwanted'] ?? 0) - (((s as any).Yakov ?? 0)?.['analCumInside']);
    }
    if (((s as any).Oleg ?? 0)?.['vagCumInside']        > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['cumVag'] = ((s as any).Oleg ?? 0)?.['vagCumInside'];
    }
    if (((s as any).Oleg ?? 0)?.['vagCumInside']        > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['vagCumInside'] = ((s as any).Oleg['vagCumInside'] ?? 0) - (((s as any).Oleg ?? 0)?.['vagCumInsideUnwanted']);
    }
    if (((s as any).Oleg ?? 0)?.['vagCumInsideUnwanted']    > 0) {
      if (!(s as any).Oleg) (s as any).Oleg = {}; (s as any).Oleg['vagCumInsideUnwanted'] = ((s as any).Oleg['vagCumInsideUnwanted'] ?? 0) - (((s as any).Oleg ?? 0)?.['vagCumInside']);
    }
    if (((s as any).Nestor ?? 0)?.['vagCumInside']      > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['cumVag'] = ((s as any).Nestor ?? 0)?.['vagCumInside'];
    }
    if (((s as any).Nestor ?? 0)?.['vagCumInside']      > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['vagCumInside'] = ((s as any).Nestor['vagCumInside'] ?? 0) - (((s as any).Nestor ?? 0)?.['vagCumInsideUnwanted']);
    }
    if (((s as any).Nestor ?? 0)?.['vagCumInsideUnwanted']  > 0) {
      if (!(s as any).Nestor) (s as any).Nestor = {}; (s as any).Nestor['vagCumInsideUnwanted'] = ((s as any).Nestor['vagCumInsideUnwanted'] ?? 0) - (((s as any).Nestor ?? 0)?.['vagCumInside']);
    }
    if (((s as any).Yakov ?? 0)?.['vagCumInside']      > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['cumVag'] = ((s as any).Yakov ?? 0)?.['vagCumInside'];
    }
    if (((s as any).Yakov ?? 0)?.['vagCumInside']      > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['vagCumInside'] = ((s as any).Yakov['vagCumInside'] ?? 0) - (((s as any).Yakov ?? 0)?.['vagCumInsideUnwanted']);
    }
    if (((s as any).Yakov ?? 0)?.['vagCumInsideUnwanted']  > 0) {
      if (!(s as any).Yakov) (s as any).Yakov = {}; (s as any).Yakov['vagCumInsideUnwanted'] = ((s as any).Yakov['vagCumInsideUnwanted'] ?? 0) - (((s as any).Yakov ?? 0)?.['vagCumInside']);
    }
    if (((s as any).NarkImmune ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cheat_immune'] = ((s as any).NarkImmune ?? 0);
      // TODO-QSP: killvar 'NarkImmune'
    }
    if (((s as any).SNarkPriton ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['city_drugden'] = ((s as any).SNarkPriton ?? 0);
      // TODO-QSP: killvar 'SNarkPriton'
    }
    if (((s as any).snarkozak ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['pav_dropoff'] = ((s as any).snarkozak ?? 0);
      // TODO-QSP: killvar 'snarkozak'
    }
    if (((s as any).siga_bum ?? 0)          > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['cigarettes'] = ((s as any).mc_inventory['cigarettes'] ?? 0) + (1);
      // TODO-QSP: killvar 'siga_bum'
    }
    if (((s as any).smoker ?? 0)          > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cigarettes_used'] = ((s as any).smoker ?? 0);
      // TODO-QSP: killvar 'smoker'
    }
    if (((s as any).smoke_exp ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cigarettes_exp'] = ((s as any).smoke_exp ?? 0);
      // TODO-QSP: killvar 'smoke_exp'
    }
    if (((s as any).smokerneed ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cigarettes_need'] = ((s as any).smokerneed ?? 0);
      // TODO-QSP: killvar 'smokerneed'
    }
    if (((s as any).smokeDay ?? 0)          > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cigarettes_day'] = ((s as any).smokeDay ?? 0);
      // TODO-QSP: killvar 'smokeDay'
    }
    if (((s as any).smokeHour ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cigarettes_hour'] = ((s as any).smokeHour ?? 0);
      // TODO-QSP: killvar 'smokeHour'
    }
    if (((s as any).smokeminut ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cigarettes_minute'] = ((s as any).smokeminut ?? 0);
    ...
    if (((s as any).joint ?? 0)          > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['joints'] = ((s as any).joint ?? 0);
      // TODO-QSP: killvar 'joint'
    }
    if (((s as any).jointhigh ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['weed_high'] = ((s as any).jointhigh ?? 0);
      // TODO-QSP: killvar 'jointhigh'
    }
    if (((s as any).joint_smoked ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['weed_used'] = ((s as any).joint_smoked ?? 0);
      // TODO-QSP: killvar 'joint_smoked'
    }
    if (((s as any).joint_exp ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['weed_exp'] = ((s as any).joint_exp ?? 0);
      // TODO-QSP: killvar 'joint_exp'
    }
    if (((s as any).jointday ?? 0)          > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['weed_day'] = ((s as any).jointday ?? 0);
      // TODO-QSP: killvar 'jointday'
    }
    if (((s as any).jointhour ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['weed_hour'] = ((s as any).jointhour ?? 0);
      // TODO-QSP: killvar 'jointhour'
    }
    if (((s as any).jointminut ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['weed_minute'] = ((s as any).jointminut ?? 0);
      // TODO-QSP: killvar 'jointminut'
    }
    if (((s as any).SNarkTimes ?? 0)?.['inject']    > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['heroin_inject'] = ((s as any).SNarkTimes ?? 0)?.['inject'];
    }
    if (((s as any).StrongNarkota ?? 0)      > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['heroin_high'] = ((s as any).StrongNarkota ?? 0);
      // TODO-QSP: killvar 'StrongNarkota'
    }
    if (((s as any).SNarkTimes ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['heroin_used'] = ((s as any).SNarkTimes ?? 0);
      // TODO-QSP: killvar 'SNarkTimes'
    }
    if (((s as any).heroin_exp ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['heroin_exp'] = ((s as any).heroin_exp ?? 0);
      // TODO-QSP: killvar 'heroin_exp'
    }
    if (((s as any).SLomka ?? 0)          > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['heroin_need'] = ((s as any).SLomka ?? 0);
      // TODO-QSP: killvar 'SLomka'
    }
    if (((s as any).narkozakday ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['heroin_day'] = ((s as any).narkozakday ?? 0);
      // TODO-QSP: killvar 'narkozakday'
    }
    if (((s as any).NarkShmaraTimes ?? 0)      > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['heroin_whore'] = ((s as any).NarkShmaraTimes ?? 0);
      // TODO-QSP: killvar 'NarkShmaraTimes'
    }
    if (((s as any).SNarkvnesh ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['heroin_penalty'] = ((s as any).SNarkvnesh ?? 0);
      // TODO-QSP: killvar 'SNarkvnesh'
    }
    if (((s as any).dur ?? 0)            > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['cocaine'] = ((s as any).dur ?? 0);
      // TODO-QSP: killvar 'dur'
    }
    if (((s as any).nark ?? 0)            > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cocaine_system'] = ((s as any).nark ?? 0);
      // TODO-QSP: killvar 'nark'
    }
    if (((s as any).cocaine_count ?? 0)      > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cocaine_used'] = ((s as any).cocaine_count ?? 0);
      // TODO-QSP: killvar 'cocaine_count'
    }
    if (((s as any).cocaine_exp ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cocaine_exp'] = ((s as any).cocaine_exp ?? 0);
      // TODO-QSP: killvar 'cocaine_exp'
    }
    if (((s as any).narkday ?? 0)          > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cocaine_day'] = ((s as any).narkday ?? 0);
      // TODO-QSP: killvar 'narkday'
    }
    if (((s as any).narkoman ?? 0)          > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cocaine_addict'] = ((s as any).narkoman ?? 0);
      // TODO-QSP: killvar 'narkoman'
    }
    if (((s as any).willday_cocaine ?? 0)      > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cocaine_willday'] = ((s as any).willday_cocaine ?? 0);
      // TODO-QSP: killvar 'willday_cocaine'
    }
    if (((s as any).amphetamine ?? 0)        > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['amphetamine'] = ((s as any).amphetamine ?? 0);
      // TODO-QSP: killvar 'amphetamine'
    }
    if (((s as any).amphHigh ?? 0)          > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['amphetamine_high'] = ((s as any).amphHigh ?? 0);
      // TODO-QSP: killvar 'amphHigh'
    }
    if (((s as any).amphetamine_count ?? 0)    > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['amphetamine_used'] = ((s as any).amphetamine_count ?? 0);
      // TODO-QSP: killvar 'amphetamine_count'
    }
    if (((s as any).amphetamine_exp ?? 0)      > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['amphetamine_exp'] = ((s as any).amphetamine_exp ?? 0);
      // TODO-QSP: killvar 'amphetamine_exp'
    }
    if (((s as any).amphIntake ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['amphetamine_intake'] = ((s as any).amphIntake ?? 0);
      // TODO-QSP: killvar 'amphIntake'
    }
    if (((s as any).amphWithdrawl ?? 0)      > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['amphetamine_withdrawl'] = ((s as any).amphWithdrawl ?? 0);
      // TODO-QSP: killvar 'amphWithdrawl'
    }
    if (((s as any).amphetamineBonus ?? 0)      > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['amphetamine_bonus'] = ((s as any).amphetamineBonus ?? 0);
      // TODO-QSP: killvar 'amphetamineBonus'
    }
    if (((s as any).mentats_have ?? 0)        > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['mentats'] = ((s as any).mentats_have ?? 0);
      // TODO-QSP: killvar 'mentats_have'
    }
    if (((s as any).mentats_dose ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['mentats_dose'] = ((s as any).mentats_dose ?? 0);
      // TODO-QSP: killvar 'mentats_dose'
    }
    if (((s as any).alcohol_count ?? 0)      > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['alcohol_used'] = ((s as any).alcohol_count ?? 0);
      // TODO-QSP: killvar 'alcohol_count'
    }
    if (((s as any).alcohol_exp ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['alcohol_exp'] = ((s as any).alcohol_exp ?? 0);
      // TODO-QSP: killvar 'alcohol_exp'
    }
    if (((s as any).aphrodisiac_have ?? 0)      > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['aphrodisiac'] = ((s as any).aphrodisiac_have ?? 0);
      // TODO-QSP: killvar 'aphrodisiac_have'
    }
    if (((s as any).aphrodisiac_addiction ?? 0)  > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['aphrodisiac_addict'] = ((s as any).aphrodisiac_addiction ?? 0);
      // TODO-QSP: killvar 'aphrodisiac_addiction'
    }
    if (((s as any).aphrodisiac_timer ?? 0)    > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['aphrodisiac_timer'] = ((s as any).aphrodisiac_timer ?? 0);
      // TODO-QSP: killvar 'aphrodisiac_timer'
    }
    if (((s as any).aphrodisiac_overdose ?? 0)    > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['aphrodisiac_overdose'] = ((s as any).aphrodisiac_overdose ?? 0);
      // TODO-QSP: killvar 'aphrodisiac_overdose'
    }
    if (((s as any).aphrodisiac_msg ?? 0)      !== '') {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['aphrodisiac_msg'] = ((s as any).aphrodisiac_msg ?? 0);
      // TODO-QSP: killvar 'aphrodisiac_msg'
    }
    if (((s as any).steroid_have ?? 0)        > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['steroids'] = ((s as any).steroid_have ?? 0);
      // TODO-QSP: killvar 'steroid_have'
    }
    if (((s as any).steroid_counter ?? 0)      > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['steroids_used'] = ((s as any).steroid_counter ?? 0);
      // TODO-QSP: killvar 'steroid_counter'
    }
    if (((s as any).steroid_dose ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['steroids_dose'] = ((s as any).steroid_dose ?? 0);
      // TODO-QSP: killvar 'steroid_dose'
    }
    if (((s as any).bcream_have ?? 0)        > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['breastcream'] = ((s as any).bcream_have ?? 0);
      // TODO-QSP: killvar 'bcream_have'
    }
    if (((s as any).bcream_used ?? 0)        > 0) {
      if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['breastcream_dose'] = ((s as any).bcream_used ?? 0);
    ...
    if (((s as any).begsec ?? 0)    > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['joined_team'] = ((s as any).begsec ?? 0);
      // TODO-QSP: killvar 'begsec'
    }
    if (((s as any).run_comp_day ?? 0)  > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['comp_day'] = ((s as any).run_comp_day ?? 0);
      // TODO-QSP: killvar 'run_comp_day'
    }
    if (((s as any).kolsorev ?? 0)    > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['races_ran'] = ((s as any).kolsorev ?? 0);
      // TODO-QSP: killvar 'kolsorev'
    }
    if (((s as any).razradbeg ?? 0)  > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['prof_stage'] = ((s as any).razradbeg ?? 0);
      // TODO-QSP: killvar 'razradbeg'
    }
    if (((s as any).bronzebeg ?? 0)  > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['bronze_medals'] = ((s as any).bronzebeg ?? 0);
      // TODO-QSP: killvar 'bronzebeg'
    }
    if (((s as any).silverbeg ?? 0)  > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['silver_medals'] = ((s as any).silverbeg ?? 0);
      // TODO-QSP: killvar 'silverbeg'
    }
    if (((s as any).goldbeg ?? 0)    > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['gold_medals'] = ((s as any).goldbeg ?? 0);
      // TODO-QSP: killvar 'goldbeg'
    }
    if (((s as any).razradbegK ?? 0)  > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['qualifiers'] = ((s as any).razradbegK ?? 0);
      // TODO-QSP: killvar 'razradbegK'
    }
    if (((s as any).razradbegEB ?? 0)  > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['champ_bronze'] = ((s as any).razradbegEB ?? 0);
      // TODO-QSP: killvar 'razradbegEB'
    }
    if (((s as any).razradbegES ?? 0)  > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['champ_silver'] = ((s as any).razradbegES ?? 0);
      // TODO-QSP: killvar 'razradbegES'
    }
    if (((s as any).razradbegEG ?? 0)  > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['champ_gold'] = ((s as any).razradbegEG ?? 0);
      // TODO-QSP: killvar 'razradbegEG'
    }
    if (((s as any).SchoolSorev ?? 0)  > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['pav_racetype'] = ((s as any).SchoolSorev ?? 0);
      // TODO-QSP: killvar 'SchoolSorev'
    }
    if (((s as any).LocalRun ?? 0)    > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['pav_stage'] = ((s as any).LocalRun ?? 0);
      // TODO-QSP: killvar 'LocalRun'
    }
    if (((s as any).swinbeg ?? 0)    > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['pav_wins1'] = ((s as any).swinbeg ?? 0);
      // TODO-QSP: killvar 'swinbeg'
    }
    if (((s as any).swinbeggor ?? 0)  > 0) {
      if (!(s as any).runnerQW) (s as any).runnerQW = {}; (s as any).runnerQW['pav_wins2'] = ((s as any).swinbeggor ?? 0);
    ...
    if (((s as any).vladimirday ?? 0) > 0  ||  ((s as any).vladimirQW ?? 0) > 0  &&  ((s as any).vladimirQW ?? 0)?.['stage'] === 0) {
      ...
      if (!(s as any).vladimirQW) (s as any).vladimirQW = {}; (s as any).vladimirQW['stage'] = ((s as any).temp_var1 ?? 0);
      if (((s as any).vladimirday ?? 0) > 0) {
        if (!(s as any).vladimirQW) (s as any).vladimirQW = {}; (s as any).vladimirQW['day'] = ((s as any).vladimirday ?? 0);
      }
    }
    ...
    if (Object.keys((s as any).transportVars ?? {}).length > 4) {
      ...
      if (!(s as any).transportVars) (s as any).transportVars = {}; (s as any).transportVars['trainpass_day'] = ((s as any).temp_transportVars ?? 0)?.['trainpass_day'];
      if (!(s as any).transportVars) (s as any).transportVars = {}; (s as any).transportVars['buspass_day'] = ((s as any).temp_transportVars ?? 0)?.['buspass_day'];
      if (!(s as any).transportVars) (s as any).transportVars = {}; (s as any).transportVars['train_event_day'] = ((s as any).temp_transportVars ?? 0)?.['train_event_day'];
      if (!(s as any).transportVars) (s as any).transportVars = {}; (s as any).transportVars['bus_event_day'] = ((s as any).temp_transportVars ?? 0)?.['bus_event_day'];
    }
    if (((s as any).bodyVars ?? 0)?.['cheat_staticAssets'] !== 0) {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['body_staticAssets'] = ((s as any).bodyVars ?? 0)?.['cheat_staticAssets'];
    ...
    if (((s as any).drugVars ?? 0)?.['cheat_immune'] !== 0) {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['drugs_immune'] = ((s as any).drugVars ?? 0)?.['cheat_immune'];
    ...
    if (((s as any).sleepVars ?? 0)?.['cheatVib'] !== 0) {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['sleep_vib'] = ((s as any).sleepVars ?? 0)?.['cheatVib'];
    }
    qspCall(s, 'array', 'remove_element', '$sleepVars', 'cheatVib');
    if (((s as any).sleepVars ?? 0)?.['cheat_nodream_chance'] !== 0) {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['no_dream_chance'] = ((s as any).sleepVars ?? 0)?.['cheat_nodream_chance'];
    }
    qspCall(s, 'array', 'remove_element', '$sleepVars', 'cheat_nodream_chance');
    if (((s as any).cheatConsole ?? 0)        !== 0  ||  ((s as any).cheatConsole ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['console'] = ((s as any).cheatConsole ?? 0);
      // TODO-QSP: killvar 'cheatConsole'
    }
    if (((s as any).cheatwork ?? 0)        !== 0  ||  ((s as any).cheatwork ?? 0)        !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['work'] = ((s as any).cheatwork ?? 0);
      // TODO-QSP: killvar 'cheatwork'
    }
    if (((s as any).cheatWillpower ?? 0)      !== 0  ||  ((s as any).cheatWillpower ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['willpower'] = ((s as any).cheatWillpower ?? 0);
      // TODO-QSP: killvar 'cheatWillpower'
    }
    if (((s as any).InfWillpwer ?? 0)        !== 0  ||  ((s as any).InfWillpwer ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['inf_willpower'] = ((s as any).InfWillpwer ?? 0);
      // TODO-QSP: killvar 'InfWillpwer'
    }
    if (((s as any).cheatHapri ?? 0)        !== 0  ||  ((s as any).cheatHapri ?? 0)        !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['always_brushed'] = ((s as any).cheatHapri ?? 0);
      // TODO-QSP: killvar 'cheatHapri'
    }
    if (((s as any).autohairbrush ?? 0)      !== 0  ||  ((s as any).autohairbrush ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['auto_brush'] = ((s as any).autohairbrush ?? 0);
      // TODO-QSP: killvar 'autohairbrush'
    }
    if (((s as any).no_cum_leak ?? 0)        !== 0  ||  ((s as any).no_cum_leak ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['no_cum_leak'] = ((s as any).no_cum_leak ?? 0);
      // TODO-QSP: killvar 'no_cum_leak'
    }
    if (((s as any).cyccustom ?? 0)        !== 0  ||  ((s as any).cyccustom ?? 0)        !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['track_period'] = ((s as any).cyccustom ?? 0);
      // TODO-QSP: killvar 'cyccustom'
    }
    if (((s as any).cheatNomakeup ?? 0)      !== 0  ||  ((s as any).cheatNomakeup ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['makeup_smear'] = ((s as any).cheatNomakeup ?? 0);
      // TODO-QSP: killvar 'cheatNomakeup'
    }
    if (((s as any).cheatNoSweat ?? 0)        !== 0  ||  ((s as any).cheatNoSweat ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['no_sweat'] = ((s as any).cheatNoSweat ?? 0);
      // TODO-QSP: killvar 'cheatNoSweat'
    }
    if (((s as any).cheatNoEat ?? 0)        !== 0  ||  ((s as any).cheatNoEat ?? 0)        !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['hunger'] = ((s as any).cheatNoEat ?? 0);
      // TODO-QSP: killvar 'cheatNoEat'
    }
    if (((s as any).cheatNoDrink ?? 0)        !== 0  ||  ((s as any).cheatNoDrink ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['thirst'] = ((s as any).cheatNoDrink ?? 0);
      // TODO-QSP: killvar 'cheatNoDrink'
    }
    if (((s as any).cheatNoSleep ?? 0)        !== 0  ||  ((s as any).cheatNoSleep ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['sleep'] = ((s as any).cheatNoSleep ?? 0);
      // TODO-QSP: killvar 'cheatNoSleep'
    }
    if (((s as any).cheatNoMood ?? 0)        !== 0  ||  ((s as any).cheatNoMood ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['mood'] = ((s as any).cheatNoMood ?? 0);
      // TODO-QSP: killvar 'cheatNoMood'
    }
    if (((s as any).cheatNoFat ?? 0)        !== 0  ||  ((s as any).cheatNoFat ?? 0)        !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['fat'] = ((s as any).cheatNoFat ?? 0);
      // TODO-QSP: killvar 'cheatNoFat'
    }
    if (((s as any).cheatHealth ?? 0)        !== 0  ||  ((s as any).cheatHealth ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['std'] = ((s as any).cheatHealth ?? 0);
      // TODO-QSP: killvar 'cheatHealth'
    }
    if (((s as any).cheatPee ?? 0)          !== 0  ||  ((s as any).cheatPee ?? 0)        !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['pee'] = ((s as any).cheatPee ?? 0);
      // TODO-QSP: killvar 'cheatPee'
    }
    if (((s as any).cheatSlut ?? 0)        !== 0  ||  ((s as any).cheatSlut ?? 0)        !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['no_periods'] = ((s as any).cheatSlut ?? 0);
      // TODO-QSP: killvar 'cheatSlut'
    }
    if (((s as any).cheatHorny ?? 0)        !== 0  ||  ((s as any).cheatHorny ?? 0)        !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['always_horny'] = ((s as any).cheatHorny ?? 0);
      // TODO-QSP: killvar 'cheatHorny'
    }
    if (((s as any).fight_cheat ?? 0)        !== 0  ||  ((s as any).fight_cheat ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['win_fights'] = ((s as any).fight_cheat ?? 0);
      // TODO-QSP: killvar 'fight_cheat'
    }
    if (((s as any).autocombat_cheat ?? 0)      !== 0  ||  ((s as any).autocombat_cheat ?? 0)    !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['auto_combat'] = ((s as any).autocombat_cheat ?? 0);
      // TODO-QSP: killvar 'autocombat_cheat'
    }
    if (((s as any).cheat_NoPregnancy ?? 0)    !== 0  ||  ((s as any).cheat_NoPregnancy ?? 0)    !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['no_pregnancy'] = ((s as any).cheat_NoPregnancy ?? 0);
      // TODO-QSP: killvar 'cheat_NoPregnancy'
    }
    if (((s as any).pregspeedcheat ?? 0)      !== 0  ||  ((s as any).pregspeedcheat ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['preg_speed'] = ((s as any).pregspeedcheat ?? 0);
      // TODO-QSP: killvar 'pregspeedcheat'
    }
    if (((s as any).cheat_NoLactation ?? 0)    !== 0  ||  ((s as any).cheat_NoLactation ?? 0)    !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['no_lactation'] = ((s as any).cheat_NoLactation ?? 0);
      // TODO-QSP: killvar 'cheat_NoLactation'
    }
    if (((s as any).cheatBimbo ?? 0)        !== 0  ||  ((s as any).cheatBimbo ?? 0)        !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['bimbo'] = ((s as any).cheatBimbo ?? 0);
      // TODO-QSP: killvar 'cheatBimbo'
    }
    if (((s as any).cheatBimbo2 ?? 0)        !== 0  ||  ((s as any).cheatBimbo2 ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['smart_bimbo'] = ((s as any).cheatBimbo2 ?? 0);
      // TODO-QSP: killvar 'cheatBimbo2'
    }
    if (((s as any).cheatBimbo3 ?? 0)        !== 0  ||  ((s as any).cheatBimbo3 ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['suc_bimbo'] = ((s as any).cheatBimbo3 ?? 0);
      // TODO-QSP: killvar 'cheatBimbo3'
    }
    if (((s as any).cheatTime ?? 0)        !== 0  ||  ((s as any).cheatTime ?? 0)        !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['time'] = ((s as any).cheatTime ?? 0);
      // TODO-QSP: killvar 'cheatTime'
    }
    if (((s as any).random_bf_gf_cheat ?? 0)    !== 0  ||  ((s as any).random_bf_gf_cheat ?? 0)    !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['random_lovers'] = ((s as any).random_bf_gf_cheat ?? 0);
      // TODO-QSP: killvar 'random_bf_gf_cheat'
    }
    if (((s as any).cheat_street_robbers ?? 0)    !== 0  ||  ((s as any).cheat_street_robbers ?? 0)  !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['random_robbers'] = ((s as any).cheat_street_robbers ?? 0);
      // TODO-QSP: killvar 'cheat_street_robbers'
    }
    if (((s as any).cheat_street_rapists ?? 0)    !== 0  ||  ((s as any).cheat_street_rapists ?? 0)  !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['random_rapists'] = ((s as any).cheat_street_rapists ?? 0);
      // TODO-QSP: killvar 'cheat_street_rapists'
    }
    if (((s as any).Enable_nogameover ?? 0)    !== 0  ||  ((s as any).Enable_nogameover ?? 0)    !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['gameover'] = ((s as any).Enable_nogameover ?? 0);
      // TODO-QSP: killvar 'Enable_nogameover'
    }
    if (((s as any).cheatShaveLegs ?? 0)      !== 0  ||  ((s as any).cheatShaveLegs ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['no_leghair'] = ((s as any).cheatShaveLegs ?? 0);
      // TODO-QSP: killvar 'cheatShaveLegs'
    }
    if (((s as any).editpornname ?? 0)        !== 0  ||  ((s as any).editpornname ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['rename_porn'] = ((s as any).editpornname ?? 0);
      // TODO-QSP: killvar 'editpornname'
    }
    if (((s as any).enfullmorrout ?? 0)      !== 0  ||  ((s as any).enfullmorrout ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['full_morning_rout'] = ((s as any).enfullmorrout ?? 0);
      // TODO-QSP: killvar 'enfullmorrout'
    }
    if (((s as any).Enable_sforma ?? 0)      !== 0  ||  ((s as any).Enable_sforma ?? 0)      !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['school_clothing'] = ((s as any).Enable_sforma ?? 0);
      // TODO-QSP: killvar 'Enable_sforma'
    }
    if (((s as any).therapist_weekly_cheat ?? 0)  !== 0  ||  ((s as any).therapist_weekly_cheat ?? 0)  !== '') {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['therapist_schedule'] = ((s as any).therapist_weekly_cheat ?? 0);
    ...
    if (((s as any).addictive_cheat ?? 0)  !== 0  ||  ((s as any).addictive_cheat ?? 0)  !== ''  ||  ((s as any).cheataddictive ?? 0)  !== ''  ||  ((s as any).cheataddictive ?? 0) !== 0) {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['no_trait_addictive'] = ((s as any).addictive_cheat ?? 0);
    }
    if (((s as any).cumeater_cheat ?? 0)  !== 0  ||  ((s as any).cumeater_cheat ?? 0)    !== ''  ||  ((s as any).cheatcumtrait ?? 0)    !== ''  ||  ((s as any).cheatcumtrait ?? 0)  !== 0) {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['no_trait_cumeater'] = ((s as any).cumeater_cheat ?? 0);
    }
    if (((s as any).exhib_cheat ?? 0)    !== 0  ||  ((s as any).exhib_cheat ?? 0)    !== ''  ||  ((s as any).cheatexhib ?? 0)    !== ''  ||  ((s as any).cheatexhib ?? 0)    !== 0) {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['no_trait_exhib'] = ((s as any).exhib_cheat ?? 0);
    }
    ...
    if (((s as any).npc_QW ?? 0)?.['A60'] !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['QW'] = ((s as any).npc_QW ?? 0)?.['A60'];
      qspCall(s, 'array', 'remove_element', 'npc_QW', 'A60');
    }
    if (((s as any).miraprost ?? 0)    !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['prostitute'] = ((s as any).miraprost ?? 0);
      // TODO-QSP: killvar 'miraprost'
    }
    if (((s as any).mirasex ?? 0)      !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['had_sex'] = ((s as any).mirasex ?? 0);
      // TODO-QSP: killvar 'mirasex'
    }
    if (((s as any).mirasextimes ?? 0)    !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['Mitka_fucks'] = ((s as any).mirasextimes ?? 0);
      // TODO-QSP: killvar 'mirasextimes'
    }
    if (((s as any).mira_no ?? 0)      !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['emb_day'] = ((s as any).daystart ?? 0) + ((s as any).mira_no ?? 0);
      // TODO-QSP: killvar 'mira_no'
    }
    if (((s as any).miraday ?? 0)      !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['event_day'] = ((s as any).miraday ?? 0);
      // TODO-QSP: killvar 'miraday'
    }
    if (((s as any).mirahorny ?? 0)    !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['arousal'] = ((s as any).mirahorny ?? 0);
      // TODO-QSP: killvar 'mirahorny'
    }
    if (((s as any).miralick ?? 0)      !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['cuni_given'] = ((s as any).miralick ?? 0);
    ...
    if (((s as any).mira_go_blok ?? 0)    !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['follow_time'] = ((s as any).mira_go_blok ?? 0);
    ...
    if (((s as any).mira_guestday ?? 0)  !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['guestday'] = ((s as any).mira_guestday ?? 0);
      // TODO-QSP: killvar 'mira_guestday'
    }
    if (((s as any).miratalkday ?? 0)    !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['talkday'] = ((s as any).miratalkday ?? 0);
      // TODO-QSP: killvar 'miratalkday'
    }
    if (((s as any).miranudetalk ?? 0)    !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['nudetalk'] = ((s as any).miranudetalk ?? 0);
      // TODO-QSP: killvar 'miranudetalk'
    }
    if (((s as any).mirapickingtalk ?? 0)  !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['pickingtalk'] = ((s as any).mirapickingtalk ?? 0);
      // TODO-QSP: killvar 'mirapickingtalk'
    }
    if (((s as any).mirapimp ?? 0)      !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['pimp'] = ((s as any).mirapimp ?? 0);
      // TODO-QSP: killvar 'mirapimp'
    }
    if (((s as any).Miraswimday ?? 0)    !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['swimday'] = ((s as any).Miraswimday ?? 0);
      // TODO-QSP: killvar 'Miraswimday'
    }
    if (((s as any).meadow ?? 0) > 0) {
      (s as any).gad_meadow_found = 1;
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['meadow'] = ((s as any).meadow ?? 0) - 1;
    }
    ...
    if (Object.keys((s as any).mitkabuhday ?? {}).length    !== 0) {
      if (!(s as any).GadBoy) (s as any).GadBoy = {}; (s as any).GadBoy['drunk_event'] = ((s as any).mitkabuhday ?? 0);
      // TODO-QSP: killvar 'mitkabuhday'
    }
    if (Object.keys((s as any).mitkabuhmiraday ?? {}).length  !== 0) {
      if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['drunk_event'] = ((s as any).mitkabuhmiraday ?? 0);
      // TODO-QSP: killvar 'mitkabuhmiraday'
    }
    if (((s as any).mitkaday ?? 0)            !== 0) {
      if (!(s as any).GadBoy) (s as any).GadBoy = {}; (s as any).GadBoy['mitka_day'] = ((s as any).mitkaday ?? 0);
      // TODO-QSP: killvar 'mitkaday'
    }
    if (((s as any).kolyambaday ?? 0)          !== 0) {
      if (!(s as any).GadBoy) (s as any).GadBoy = {}; (s as any).GadBoy['kolyamba_day'] = ((s as any).kolyambaday ?? 0);
      // TODO-QSP: killvar 'kolyambaday'
    }
    if (((s as any).vasyanday ?? 0)          !== 0) {
      if (!(s as any).GadBoy) (s as any).GadBoy = {}; (s as any).GadBoy['vasyan_day'] = ((s as any).vasyanday ?? 0);
      // TODO-QSP: killvar 'vasyanday'
    }
    if (((s as any).mitkaguysriver ?? 0)        !== 0) {
      if (!(s as any).GadBoy) (s as any).GadBoy = {}; (s as any).GadBoy['river_day'] = ((s as any).mitkaguysriver ?? 0);
      // TODO-QSP: killvar 'mitkaguysriver'
    }
    if (((s as any).mitka_first_drink ?? 0)      !== 0) {
      if (!(s as any).GadBoy) (s as any).GadBoy = {}; (s as any).GadBoy['first_drink'] = ((s as any).mitka_first_drink ?? 0);
      // TODO-QSP: killvar 'mitka_first_drink'
    }
    if (((s as any).mitkadrinkday ?? 0)        !== 0) {
      if (!(s as any).GadBoy) (s as any).GadBoy = {}; (s as any).GadBoy['drinkday'] = ((s as any).mitkadrinkday ?? 0);
      // TODO-QSP: killvar 'mitkadrinkday'
    }
    if (((s as any).gadriver_gang ?? 0)        !== 0) {
      if (!(s as any).GadBoy) (s as any).GadBoy = {}; (s as any).GadBoy['river_gang'] = ((s as any).gadriver_gang ?? 0);
      // TODO-QSP: killvar 'gadriver_gang'
    }
    if (((s as any).tpKnown ?? 0)?.['gadforest'] !== 0) {
      if (!(s as any).tpKnown) (s as any).tpKnown = {}; (s as any).tpKnown['gad_forest'] = ((s as any).tpKnown ?? 0)?.['gadforest'];
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90300) {
    ...
    if (((s as any).HotelRoom ?? 0)?.['pav_hotel'] !== 0) {
      if (!(s as any).HotelRoom) (s as any).HotelRoom = {}; (s as any).HotelRoom['pav'] = ((s as any).HotelRoom ?? 0)?.['pav_hotel'];
      qspCall(s, 'array', 'remove_element', 'HotelRoom', 'pav_hotel');
    }
    if (((s as any).hotelRoomDays ?? 0)?.['pav_hotel'] !== 0) {
      if (!(s as any).hotelRoomDays) (s as any).hotelRoomDays = {}; (s as any).hotelRoomDays['pav'] = ((s as any).hotelRoomDays ?? 0)?.['pav_hotel'];
      qspCall(s, 'array', 'remove_element', 'hotelRoomDays', 'pav_hotel');
    }
    if (((s as any).HotelRoom ?? 0)?.['city_hotel'] !== 0) {
      if (!(s as any).HotelRoom) (s as any).HotelRoom = {}; (s as any).HotelRoom['city'] = ((s as any).HotelRoom ?? 0)?.['city_hotel'];
      qspCall(s, 'array', 'remove_element', 'HotelRoom', 'city_hotel');
    }
    if (((s as any).hotelRoomDays ?? 0)?.['city_hotel'] !== 0) {
      if (!(s as any).hotelRoomDays) (s as any).hotelRoomDays = {}; (s as any).hotelRoomDays['city'] = ((s as any).hotelRoomDays ?? 0)?.['city_hotel'];
      qspCall(s, 'array', 'remove_element', 'HotelRoom', 'city_hotel');
    }
    if (((s as any).hotel ?? 0) !== '') {
    ...
    if (((s as any).avatar_hair ?? 0) === 1) {
      if (!(s as any).face_style) (s as any).face_style = {}; (s as any).face_style['avatar_hair'] = ((s as any).av_hair ?? 0);
    }
  }
  if (((s as any).temp_current_save_version ?? 0) < 90301) {
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_cyan_taken'])   > ((s as any).experimentQW ?? 0)?.['pill_cyan_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_cyan_taken'] = qspUntranslated(s, "val(experimentQW['pill_cyan_taken'])", { location: "saveupdater" });
    }
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_red_taken'])    > ((s as any).experimentQW ?? 0)?.['pill_red_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_red_taken'] = qspUntranslated(s, "val(experimentQW['pill_red_taken'])", { location: "saveupdater" });
    }
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_blue_taken'])   > ((s as any).experimentQW ?? 0)?.['pill_blue_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_blue_taken'] = qspUntranslated(s, "val(experimentQW['pill_blue_taken'])", { location: "saveupdater" });
    }
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_yellow_taken']) > ((s as any).experimentQW ?? 0)?.['pill_yellow_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_yellow_taken'] = qspUntranslated(s, "val(experimentQW['pill_yellow_taken'])", { location: "saveupdater" });
    }
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_orange_taken']) > ((s as any).experimentQW ?? 0)?.['pill_orange_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_orange_taken'] = qspUntranslated(s, "val(experimentQW['pill_orange_taken'])", { location: "saveupdater" });
    }
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_violet_taken']) > ((s as any).experimentQW ?? 0)?.['pill_violet_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_violet_taken'] = qspUntranslated(s, "val(experimentQW['pill_violet_taken'])", { location: "saveupdater" });
    }
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_brown_taken'])  > ((s as any).experimentQW ?? 0)?.['pill_brown_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_brown_taken'] = qspUntranslated(s, "val(experimentQW['pill_brown_taken'])", { location: "saveupdater" });
    }
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_purple_taken']) > ((s as any).experimentQW ?? 0)?.['pill_purple_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_purple_taken'] = qspUntranslated(s, "val(experimentQW['pill_purple_taken'])", { location: "saveupdater" });
    }
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_green_taken'])  > ((s as any).experimentQW ?? 0)?.['pill_green_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_green_taken'] = qspUntranslated(s, "val(experimentQW['pill_green_taken'])", { location: "saveupdater" });
    }
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_gray_taken'])   > ((s as any).experimentQW ?? 0)?.['pill_gray_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_gray_taken'] = qspUntranslated(s, "val(experimentQW['pill_gray_taken'])", { location: "saveupdater" });
    }
    if (parseFloat(((s as any).experimentQW ?? 0)?.['pill_pink_taken'])   > ((s as any).experimentQW ?? 0)?.['pill_pink_taken']) {
      if (!(s as any).experimentQW) (s as any).experimentQW = {}; (s as any).experimentQW['pill_pink_taken'] = qspUntranslated(s, "val(experimentQW['pill_pink_taken'])", { location: "saveupdater" });
    }
  }
  if (((s as any).temp_current_save_version ?? 0) < 90302) {
    if (Object.keys((s as any).npc_pref_values ?? {}).length > 0) {
      ...
      if (Object.keys((s as any).npc_pref_traits ?? {}).length > 0) {
        qspCall(s, 'npc_set_preference', 'rebuild_preferences', 'A' + qspUntranslated(s, "su_i>", { location: "saveupdater" }) + '');
      }
    ...
    if (((s as any).mc_inventory ?? 0)?.['chaffing_cream'] > 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['chafing_cream'] = ((s as any).mc_inventory ?? 0)?.['chaffing_cream'];
    ...
    if (((s as any).f_book ?? 0)    !== 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['fantasy_books'] = ((s as any).f_book ?? 0);
      // TODO-QSP: killvar 'f_book'
    }
    if (((s as any).sf_book ?? 0)    !== 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['scifi_books'] = ((s as any).sf_book ?? 0);
      // TODO-QSP: killvar 'sf_book'
    }
    if (((s as any).w_book ?? 0)    !== 0) {
      if (!(s as any).mc_inventory) (s as any).mc_inventory = {}; (s as any).mc_inventory['romance_books'] = ((s as any).w_book ?? 0);
      // TODO-QSP: killvar 'w_book'
    }
    if (((s as any).fantasybook ?? 0)  !== 0) {
      if (!(s as any).BookVars) (s as any).BookVars = {}; (s as any).BookVars['fantasy_pages'] = ((s as any).fantasybook ?? 0) * 100;
      // TODO-QSP: killvar 'fantasybook'
    }
    if (((s as any).womanbook ?? 0)  !== 0) {
      if (!(s as any).BookVars) (s as any).BookVars = {}; (s as any).BookVars['romance_pages'] = ((s as any).womanbook ?? 0) * 100;
      // TODO-QSP: killvar 'womanbook'
    }
    if (((s as any).artembook ?? 0)  !== 0) {
      if (!(s as any).BookVars) (s as any).BookVars = {}; (s as any).BookVars['artem_pages'] = ((s as any).artembook ?? 0) * 100;
      // TODO-QSP: killvar 'artembook'
    }
    if (((s as any).pointKik ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['pcs_points'] = ((s as any).pointKik ?? 0);
      // TODO-QSP: killvar 'pointKik'
    }
    if (((s as any).pointKikV ?? 0)  !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_points'] = ((s as any).pointKikV ?? 0);
      // TODO-QSP: killvar 'pointKikV'
    }
    if (((s as any).formula ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['max_rounds'] = ((s as any).formula ?? 0);
      // TODO-QSP: killvar 'formula'
    }
    if (((s as any).round ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['round'] = ((s as any).round ?? 0);
      // TODO-QSP: killvar 'round'
    }
    if (((s as any).minround ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['time'] = ((s as any).minround ?? 0);
      // TODO-QSP: killvar 'minround'
    }
    if (((s as any).strenV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_stren'] = ((s as any).strenV ?? 0);
      // TODO-QSP: killvar 'strenV'
    }
    if (((s as any).speedV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_speed'] = ((s as any).speedV ?? 0);
      // TODO-QSP: killvar 'speedV'
    }
    if (((s as any).agilV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_agil'] = ((s as any).agilV ?? 0);
      // TODO-QSP: killvar 'agilV'
    }
    if (((s as any).reactV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_react'] = ((s as any).reactV ?? 0);
      // TODO-QSP: killvar 'reactV'
    }
    if (((s as any).vitalV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_vital'] = ((s as any).vitalV ?? 0);
      // TODO-QSP: killvar 'vitalV'
    }
    if (((s as any).intelV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_intel'] = ((s as any).intelV ?? 0);
      // TODO-QSP: killvar 'intelV'
    }
    if (((s as any).willV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_will'] = ((s as any).willV ?? 0);
      // TODO-QSP: killvar 'willV'
    }
    if (((s as any).JabV ?? 0)      !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_jab'] = ((s as any).JabV ?? 0);
      // TODO-QSP: killvar 'JabV'
    }
    if (((s as any).PunchV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_punch'] = ((s as any).PunchV ?? 0);
      // TODO-QSP: killvar 'PunchV'
    }
    if (((s as any).KikV ?? 0)      !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_kick'] = ((s as any).KikV ?? 0);
      // TODO-QSP: killvar 'KikV'
    }
    if (((s as any).KikDefV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_def'] = ((s as any).KikDefV ?? 0);
    ...
    if (((s as any).initi ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['pcs_init_true'] = ((s as any).initi ?? 0);
      // TODO-QSP: killvar 'initi'
    }
    if (((s as any).initV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_init'] = ((s as any).initV ?? 0);
    ...
    if (((s as any).initiV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_init_true'] = ((s as any).initiV ?? 0);
      // TODO-QSP: killvar 'initiV'
    }
    if (((s as any).ionce ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['set_init'] = ((s as any).ionce ?? 0);
    ...
    if (((s as any).hod ?? 0)      !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['active_init'] = ((s as any).hod ?? 0);
      // TODO-QSP: killvar 'home_day'
    }
    if (((s as any).hodtime ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['pcs_inittime'] = ((s as any).hodtime ?? 0);
      // TODO-QSP: killvar 'hodtime'
    }
    if (((s as any).hodtimeV ?? 0)    !== 0) {
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_inittime'] = ((s as any).hodtimeV ?? 0);
    ...
    if (((s as any).KikWinPro ?? 0)  !== 0) {
      if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['proWin'] = ((s as any).KikWinPro ?? 0);
      // TODO-QSP: killvar 'KikWinPro'
    }
    if (((s as any).KikWinProKO ?? 0)  !== 0) {
      if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['proWinKO'] = ((s as any).KikWinProKO ?? 0);
      // TODO-QSP: killvar 'KikWinProKO'
    }
    if (((s as any).KikLossPro ?? 0)  !== 0) {
      if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['proLoss'] = ((s as any).KikLossPro ?? 0);
      // TODO-QSP: killvar 'KikLossPro'
    }
    if (((s as any).KikLossProKO ?? 0)  !== 0) {
      if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['proLossKO'] = ((s as any).KikLossProKO ?? 0);
      // TODO-QSP: killvar 'KikLossProKO'
    }
    if (((s as any).KikDrawPro ?? 0)  !== 0) {
      if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['proDraw'] = ((s as any).KikDrawPro ?? 0);
      // TODO-QSP: killvar 'KikDrawPro'
    }
    if (((s as any).First_time_3some_with_Lazar ?? 0)      !== 0) {
      if (!(s as any).cheerleadingQW) (s as any).cheerleadingQW = {}; (s as any).cheerleadingQW['lazar_threesome'] = ((s as any).First_time_3some_with_Lazar ?? 0);
      // TODO-QSP: killvar 'First_time_3some_with_Lazar'
    }
    if (((s as any).first_time_outside_in_cold_weather ?? 0)  !== 0) {
      if (!(s as any).cheerleadingQW) (s as any).cheerleadingQW = {}; (s as any).cheerleadingQW['cold_weather'] = ((s as any).first_time_outside_in_cold_weather ?? 0);
      // TODO-QSP: killvar 'first_time_outside_in_cold_weather'
    }
    if (((s as any).first_time_doing_basketball ?? 0)      !== 0) {
      if (!(s as any).cheerleadingQW) (s as any).cheerleadingQW = {}; (s as any).cheerleadingQW['basketball'] = ((s as any).first_time_doing_basketball ?? 0);
      // TODO-QSP: killvar 'first_time_doing_basketball'
    }
    if (((s as any).first_time_spring_football_match ?? 0)    !== 0) {
      if (!(s as any).cheerleadingQW) (s as any).cheerleadingQW = {}; (s as any).cheerleadingQW['spring_match'] = ((s as any).first_time_spring_football_match ?? 0);
      // TODO-QSP: killvar 'first_time_spring_football_match'
    }
    if (((s as any).blackmailQW ?? 0)?.['stage'] === 10) {
      if (!(s as any).blackmailQW) (s as any).blackmailQW = {}; (s as any).blackmailQW['package'] = 1;
    }
    (s as any).appearance_update_932 = 1;
    (s as any).su_i = 0;
    // TODO-QSP: :appearance_update_loop
    if (((s as any).npc_apprnc ?? 0)?.[String((s as any).su_i ?? 0)] > 0) {
      if (!(s as any).npc_apprnc) (s as any).npc_apprnc = {}; (s as any).npc_apprnc[String((s as any).su_i ?? 0)] = 3 * ((s as any).npc_apprnc ?? 0)?.[String((s as any).su_i ?? 0)];
      if (((s as any).npc_apprnc ?? 0)?.[String((s as any).su_i ?? 0)] > 190) {
        if (!(s as any).npc_apprnc) (s as any).npc_apprnc = {}; (s as any).npc_apprnc[String((s as any).su_i ?? 0)] = 190;
      }
    }
    (s as any).su_i = ((s as any).su_i ?? 0) + (1);
    ...
    if (((s as any).ds_diff ?? 0) > 0) {
      ...
      if (((s as any).acting ?? 0)?.['shoot_day']            !== 0) {
        if (!(s as any).acting) (s as any).acting = {}; (s as any).acting['shoot_day'] = ((s as any).acting['shoot_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).AlbinaQW ?? 0)?.['startletsday']          !== 0) {
        if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['startletsday'] = ((s as any).AlbinaQW['startletsday'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).anushkaQW ?? 0)?.['tour_SMS_send']        !== 0) {
        if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['tour_SMS_send'] = ((s as any).anushkaQW['tour_SMS_send'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).audition ?? 0)?.['day']              !== 0) {
        if (!(s as any).audition) (s as any).audition = {}; (s as any).audition['day'] = ((s as any).audition['day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).balletqw ?? 0)?.['membership']          !== 0) {
        if (!(s as any).balletqw) (s as any).balletqw = {}; (s as any).balletqw['membership'] = ((s as any).balletqw['membership'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).blackmailQW ?? 0)?.['day']            !== 0) {
        if (!(s as any).blackmailQW) (s as any).blackmailQW = {}; (s as any).blackmailQW['day'] = ((s as any).blackmailQW['day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).blackmailQW ?? 0)?.['dream_day']          !== 0) {
        if (!(s as any).blackmailQW) (s as any).blackmailQW = {}; (s as any).blackmailQW['dream_day'] = ((s as any).blackmailQW['dream_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).BurgerQW ?? 0)?.['IlyQWDay']            !== 0) {
        if (!(s as any).BurgerQW) (s as any).BurgerQW = {}; (s as any).BurgerQW['IlyQWDay'] = ((s as any).BurgerQW['IlyQWDay'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).cheerleadingQW ?? 0)?.['day']          !== 0) {
        if (!(s as any).cheerleadingQW) (s as any).cheerleadingQW = {}; (s as any).cheerleadingQW['day'] = ((s as any).cheerleadingQW['day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).drugVars ?? 0)?.['cigarettes_day']        !== 0) {
        if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cigarettes_day'] = ((s as any).drugVars['cigarettes_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).drugVars ?? 0)?.['cocain_day']          !== 0) {
        if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cocain_day'] = ((s as any).drugVars['cocain_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).drugVars ?? 0)?.['cocain_willday']        !== 0) {
        if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['cocain_willday'] = ((s as any).drugVars['cocain_willday'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).drugVars ?? 0)?.['heroin_day']          !== 0) {
        if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['heroin_day'] = ((s as any).drugVars['heroin_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).drugVars ?? 0)?.['weed_day']            !== 0) {
        if (!(s as any).drugVars) (s as any).drugVars = {}; (s as any).drugVars['weed_day'] = ((s as any).drugVars['weed_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).grandmaQW ?? 0)?.['last_day_helped']        !== 0) {
        if (!(s as any).grandmaQW) (s as any).grandmaQW = {}; (s as any).grandmaQW['last_day_helped'] = ((s as any).grandmaQW['last_day_helped'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).grandpaQW ?? 0)?.['last_day_helped']        !== 0) {
        if (!(s as any).grandpaQW) (s as any).grandpaQW = {}; (s as any).grandpaQW['last_day_helped'] = ((s as any).grandpaQW['last_day_helped'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).hotelRoomDays ?? 0)?.['city']          !== 0) {
        if (!(s as any).hotelRoomDays) (s as any).hotelRoomDays = {}; (s as any).hotelRoomDays['city'] = ((s as any).hotelRoomDays['city'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).hotelRoomDays ?? 0)?.['pav']            !== 0) {
        if (!(s as any).hotelRoomDays) (s as any).hotelRoomDays = {}; (s as any).hotelRoomDays['pav'] = ((s as any).hotelRoomDays['pav'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).katjaQW ?? 0)?.['birth_control_start_day']    !== 0) {
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['birth_control_start_day'] = ((s as any).katjaQW['birth_control_start_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).katjaQW ?? 0)?.['coke_day']            !== 0) {
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_day'] = ((s as any).katjaQW['coke_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).katjaQW ?? 0)?.['relationship_count_start']    !== 0) {
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['relationship_count_start'] = ((s as any).katjaQW['relationship_count_start'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).krystal ?? 0)?.['porn_card_day']          !== 0) {
        if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['porn_card_day'] = ((s as any).krystal['porn_card_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).lactation ?? 0)?.['milkgrowday']          !== 0) {
        if (!(s as any).lactation) (s as any).lactation = {}; (s as any).lactation['milkgrowday'] = ((s as any).lactation['milkgrowday'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).locat ?? 0)?.['katja_rand1']            !== 0) {
        if (!(s as any).locat) (s as any).locat = {}; (s as any).locat['katja_rand1'] = ((s as any).locat['katja_rand1'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).locat ?? 0)?.['katja_rand2']            !== 0) {
        if (!(s as any).locat) (s as any).locat = {}; (s as any).locat['katja_rand2'] = ((s as any).locat['katja_rand2'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).locat ?? 0)?.['katja_rand3']            !== 0) {
        if (!(s as any).locat) (s as any).locat = {}; (s as any).locat['katja_rand3'] = ((s as any).locat['katja_rand3'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).masseuse ?? 0)?.['last_worked_day']        !== 0) {
        if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['last_worked_day'] = ((s as any).masseuse['last_worked_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).masseuse ?? 0)?.['schedule_update']        !== 0) {
        if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['schedule_update'] = ((s as any).masseuse['schedule_update'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).MiraVars ?? 0)?.['emb_day']            !== 0) {
        if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['emb_day'] = ((s as any).MiraVars['emb_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).MiraVars ?? 0)?.['event_day']          !== 0) {
        if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['event_day'] = ((s as any).MiraVars['event_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).ml_delparcoQW ?? 0)?.['Next Date']        !== 0) {
        if (!(s as any).ml_delparcoQW) (s as any).ml_delparcoQW = {}; (s as any).ml_delparcoQW['Next Date'] = ((s as any).ml_delparcoQW['Next Date'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).ml_guitarlesson ?? 0)?.['nextlesson']      !== 0) {
        if (!(s as any).ml_guitarlesson) (s as any).ml_guitarlesson = {}; (s as any).ml_guitarlesson['nextlesson'] = ((s as any).ml_guitarlesson['nextlesson'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).ml_performance ?? 0)?.['set_lastpracticeday']  !== 0) {
        if (!(s as any).ml_performance) (s as any).ml_performance = {}; (s as any).ml_performance['set_lastpracticeday'] = ((s as any).ml_performance['set_lastpracticeday'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).mother ?? 0)?.['kickedout_timer']        !== 0) {
        if (!(s as any).mother) (s as any).mother = {}; (s as any).mother['kickedout_timer'] = ((s as any).mother['kickedout_timer'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).NatbelQW ?? 0)?.['DebtDay']            !== 0) {
        if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['DebtDay'] = ((s as any).NatbelQW['DebtDay'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).NatbelQW ?? 0)?.['evt_day']            !== 0) {
        if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['evt_day'] = ((s as any).NatbelQW['evt_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).NatbelQW ?? 0)?.['pregday']            !== 0) {
        if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['pregday'] = ((s as any).NatbelQW['pregday'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).NatbelQW ?? 0)?.['StP_trip_daystart']      !== 0) {
        if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['StP_trip_daystart'] = ((s as any).NatbelQW['StP_trip_daystart'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).nerd_game ?? 0)?.['game_day']          !== 0) {
        if (!(s as any).nerd_game) (s as any).nerd_game = {}; (s as any).nerd_game['game_day'] = ((s as any).nerd_game['game_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).nerd_game ?? 0)?.['invite_day']          !== 0) {
        if (!(s as any).nerd_game) (s as any).nerd_game = {}; (s as any).nerd_game['invite_day'] = ((s as any).nerd_game['invite_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).nichTanya ?? 0)?.['FuckLast']          !== 0) {
        if (!(s as any).nichTanya) (s as any).nichTanya = {}; (s as any).nichTanya['FuckLast'] = ((s as any).nichTanya['FuckLast'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).ParrotQW ?? 0)?.['BuyDate']            !== 0) {
        if (!(s as any).ParrotQW) (s as any).ParrotQW = {}; (s as any).ParrotQW['BuyDate'] = ((s as any).ParrotQW['BuyDate'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).ParrotQW ?? 0)?.['SisterReleaseParrotDay']    !== 0) {
        if (!(s as any).ParrotQW) (s as any).ParrotQW = {}; (s as any).ParrotQW['SisterReleaseParrotDay'] = ((s as any).ParrotQW['SisterReleaseParrotDay'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).pav_swimpool ?? 0)?.['entrancepaid']        !== 0) {
        if (!(s as any).pav_swimpool) (s as any).pav_swimpool = {}; (s as any).pav_swimpool['entrancepaid'] = ((s as any).pav_swimpool['entrancepaid'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).parkday ?? 0)                  !== 0) {
        (s as any).parkday = ((s as any).parkday ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).photography ?? 0)?.['datecheck']          !== 0) {
        if (!(s as any).photography) (s as any).photography = {}; (s as any).photography['datecheck'] = ((s as any).photography['datecheck'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).policeQW ?? 0)?.['fine_deadline']        !== 0) {
        if (!(s as any).policeQW) (s as any).policeQW = {}; (s as any).policeQW['fine_deadline'] = ((s as any).policeQW['fine_deadline'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).pornstar ?? 0)?.['icon_disable']          !== 0) {
        if (!(s as any).pornstar) (s as any).pornstar = {}; (s as any).pornstar['icon_disable'] = ((s as any).pornstar['icon_disable'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).rex ?? 0)?.['timer_day']              !== 0) {
        if (!(s as any).rex) (s as any).rex = {}; (s as any).rex['timer_day'] = ((s as any).rex['timer_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).rex ?? 0)?.['gadukino_day']            !== 0) {
        if (!(s as any).rex) (s as any).rex = {}; (s as any).rex['gadukino_day'] = ((s as any).rex['gadukino_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).sisterQW ?? 0)?.['partyday']            !== 0) {
        if (!(s as any).sisterQW) (s as any).sisterQW = {}; (s as any).sisterQW['partyday'] = ((s as any).sisterQW['partyday'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).sleepVars ?? 0)?.['sleep_reflection_day']    !== 0) {
        if (!(s as any).sleepVars) (s as any).sleepVars = {}; (s as any).sleepVars['sleep_reflection_day'] = ((s as any).sleepVars['sleep_reflection_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).social_check ?? 0)?.['disco']          !== 0) {
        if (!(s as any).social_check) (s as any).social_check = {}; (s as any).social_check['disco'] = ((s as any).social_check['disco'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).stat ?? 0)?.['last_broken_condom']        !== 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_broken_condom'] = ((s as any).stat['last_broken_condom'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).stat ?? 0)?.['last_creampie']          !== 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_creampie'] = ((s as any).stat['last_creampie'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).stat ?? 0)?.['last_dance_class']          !== 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_dance_class'] = ((s as any).stat['last_dance_class'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).stat ?? 0)?.['last_morning_after_pill']      !== 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_morning_after_pill'] = ((s as any).stat['last_morning_after_pill'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).suspended ?? 0)?.['day']              !== 0) {
        if (!(s as any).suspended) (s as any).suspended = {}; (s as any).suspended['day'] = ((s as any).suspended['day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      ...
      if (((s as any).transportVars ?? 0)?.['buspass_day']        !== 0) {
        if (!(s as any).transportVars) (s as any).transportVars = {}; (s as any).transportVars['buspass_day'] = ((s as any).transportVars['buspass_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).transportVars ?? 0)?.['trainpass_day']      !== 0) {
        if (!(s as any).transportVars) (s as any).transportVars = {}; (s as any).transportVars['trainpass_day'] = ((s as any).transportVars['trainpass_day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).uni_period ?? 0)?.['first']            !== 0) {
        if (!(s as any).uni_period) (s as any).uni_period = {}; (s as any).uni_period['first'] = ((s as any).uni_period['first'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).uni_period ?? 0)?.['second']            !== 0) {
        if (!(s as any).uni_period) (s as any).uni_period = {}; (s as any).uni_period['second'] = ((s as any).uni_period['second'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).uni_period ?? 0)?.['third']            !== 0) {
        if (!(s as any).uni_period) (s as any).uni_period = {}; (s as any).uni_period['third'] = ((s as any).uni_period['third'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).uni_period ?? 0)?.['exam']            !== 0) {
        if (!(s as any).uni_period) (s as any).uni_period = {}; (s as any).uni_period['exam'] = ((s as any).uni_period['exam'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).vladimirQW ?? 0)?.['day']            !== 0) {
        if (!(s as any).vladimirQW) (s as any).vladimirQW = {}; (s as any).vladimirQW['day'] = ((s as any).vladimirQW['day'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).volkomday ?? 0)                !== 0) {
        (s as any).volkomday = ((s as any).volkomday ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).virgin_stats ?? 0)?.['day_lost']          !== 0) {
        if (!(s as any).virgin_stats) (s as any).virgin_stats = {}; (s as any).virgin_stats['day_lost'] = ((s as any).virgin_stats['day_lost'] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      (s as any).su_ds_i = 0;
      // TODO-QSP: :daystart_fix_loops
      if (((s as any).booty_call_invite ?? 0)?.[String((s as any).su_ds_i ?? 0)]      !== 0) {
        if (!(s as any).booty_call_invite) (s as any).booty_call_invite = {}; (s as any).booty_call_invite[String((s as any).isu_ds_i ?? 0)] = ((s as any).booty_call_invite[String((s as any).isu_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).loverday ?? 0)?.[String((s as any).su_ds_i ?? 0)]          !== 0) {
        if (!(s as any).loverday) (s as any).loverday = {}; (s as any).loverday[String((s as any).su_ds_i ?? 0)] = ((s as any).loverday[String((s as any).su_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).meetday ?? 0)?.[String((s as any).su_ds_ii ?? 0)]          !== 0) {
        if (!(s as any).meetday) (s as any).meetday = {}; (s as any).meetday[String((s as any).su_ds_i ?? 0)] = ((s as any).meetday[String((s as any).su_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).npc_sugar_daddy_timer ?? 0)?.[String((s as any).su_ds_i ?? 0)]    !== 0) {
        if (!(s as any).npc_sugar_daddy_timer) (s as any).npc_sugar_daddy_timer = {}; (s as any).npc_sugar_daddy_timer[String((s as any).su_ds_i ?? 0)] = ((s as any).npc_sugar_daddy_timer[String((s as any).su_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).npc_no_booty_call ?? 0)?.[String((s as any).su_ds_i ?? 0)]      !== 0) {
        if (!(s as any).npc_no_booty_call) (s as any).npc_no_booty_call = {}; (s as any).npc_no_booty_call[String((s as any).su_ds_i ?? 0)] = ((s as any).npc_no_booty_call[String((s as any).su_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).npc_booty_call_date ?? 0)?.[String((s as any).su_ds_i ?? 0)]      !== 0) {
        if (!(s as any).npc_booty_call_date) (s as any).npc_booty_call_date = {}; (s as any).npc_booty_call_date[String((s as any).su_ds_i ?? 0)] = ((s as any).npc_booty_call_date[String((s as any).su_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).npc_bc_promise ?? 0)?.[String((s as any).su_ds_i ?? 0)]        !== 0) {
        if (!(s as any).npc_bc_promise) (s as any).npc_bc_promise = {}; (s as any).npc_bc_promise[String((s as any).su_ds_i ?? 0)] = ((s as any).npc_bc_promise[String((s as any).su_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).npc_last_booty_call ?? 0)?.[String((s as any).su_ds_i ?? 0)]      !== 0) {
        if (!(s as any).npc_last_booty_call) (s as any).npc_last_booty_call = {}; (s as any).npc_last_booty_call[String((s as any).su_ds_i ?? 0)] = ((s as any).npc_last_booty_call[String((s as any).su_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).policeQW_courthearing_dates ?? 0)?.[String((s as any).su_ds_i ?? 0)]  !== 0) {
        if (!(s as any).policeQW_courthearing_dates) (s as any).policeQW_courthearing_dates = {}; (s as any).policeQW_courthearing_dates[String((s as any).su_ds_i ?? 0)] = ((s as any).policeQW_courthearing_dates[String((s as any).su_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).policeQW_courtletter_dates ?? 0)?.[String((s as any).su_ds_i ?? 0)]  !== 0) {
        if (!(s as any).policeQW_courtletter_dates) (s as any).policeQW_courtletter_dates = {}; (s as any).policeQW_courtletter_dates[String((s as any).su_ds_i ?? 0)] = ((s as any).policeQW_courtletter_dates[String((s as any).su_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
      if (((s as any).porndaystart ?? 0)?.[String((s as any).su_ds_i ?? 0)]        !== 0) {
        if (!(s as any).porndaystart) (s as any).porndaystart = {}; (s as any).porndaystart[String((s as any).su_ds_i ?? 0)] = ((s as any).porndaystart[String((s as any).su_ds_i ?? 0)] ?? 0) + (((s as any).ds_diff ?? 0));
      }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90303) {
    if (((s as any).pcs_traits ?? 0)?.['easy_orgams'] !== 0) {
      if (((s as any).pcs_traits ?? 0)?.['easy_orgasms'] < ((s as any).pcs_traits ?? 0)?.['easy_orgams']) {
        if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['easy_orgasms'] = ((s as any).pcs_traits ?? 0)?.['easy_orgams'];
      }
      qspCall(s, 'array', 'remove_element', 'pcs_traits', 'easy_orgams');
    }
    if (((s as any).soniafall ?? 0)      !== 0) {
      if (!(s as any).soniaQW) (s as any).soniaQW = {}; (s as any).soniaQW['soniafall'] = ((s as any).soniafall ?? 0);
      // TODO-QSP: killvar 'soniafall'
    }
    if (((s as any).soniaPS ?? 0)        !== 0) {
      if (!(s as any).soniaQW) (s as any).soniaQW = {}; (s as any).soniaQW['slut'] = ((s as any).soniaPS ?? 0);
      // TODO-QSP: killvar 'soniaPS'
    }
    if (((s as any).soniafallDay ?? 0)      !== 0) {
      if (!(s as any).soniaQW) (s as any).soniaQW = {}; (s as any).soniaQW['fallDay'] = ((s as any).soniafallDay ?? 0);
      // TODO-QSP: killvar 'soniafallDay'
    }
    if (((s as any).soniaPSdays ?? 0)      !== 0) {
      if (!(s as any).soniaQW) (s as any).soniaQW = {}; (s as any).soniaQW['slutdays'] = ((s as any).soniaPSdays ?? 0);
      // TODO-QSP: killvar 'soniaPSdays'
    }
    if (((s as any).soniahelp ?? 0)      !== 0) {
      if (!(s as any).soniaQW) (s as any).soniaQW = {}; (s as any).soniaQW['help'] = ((s as any).soniahelp ?? 0);
      // TODO-QSP: killvar 'soniahelp'
    }
    if (((s as any).soniaencourage ?? 0)    !== 0) {
      if (!(s as any).soniaQW) (s as any).soniaQW = {}; (s as any).soniaQW['encourage'] = ((s as any).soniaencourage ?? 0);
      // TODO-QSP: killvar 'soniaencourage'
    }
    if (((s as any).soniasex ?? 0)        !== 0) {
      if (!(s as any).soniaQW) (s as any).soniaQW = {}; (s as any).soniaQW['sex'] = ((s as any).soniasex ?? 0);
      // TODO-QSP: killvar 'soniasex'
    }
    if (((s as any).soniasextime ?? 0)      !== 0) {
      if (!(s as any).soniaQW) (s as any).soniaQW = {}; (s as any).soniaQW['sextime'] = ((s as any).soniasextime ?? 0);
      // TODO-QSP: killvar 'soniasextime'
    }
    if (((s as any).ivankosup_count ?? 0)    !== 0) {
      if (!(s as any).ivanko) (s as any).ivanko = {}; (s as any).ivanko['soup'] = ((s as any).ivankosup_count ?? 0);
      // TODO-QSP: killvar 'ivankosup_count'
    }
    if (((s as any).ivankowater_count ?? 0)  !== 0) {
      if (!(s as any).ivanko) (s as any).ivanko = {}; (s as any).ivanko['water'] = ((s as any).ivankowater_count ?? 0);
      // TODO-QSP: killvar 'ivankowater_count'
    }
    if (((s as any).ivankolefto_count ?? 0)  !== 0) {
      if (!(s as any).ivanko) (s as any).ivanko = {}; (s as any).ivanko['leftovers'] = ((s as any).ivankolefto_count ?? 0);
      // TODO-QSP: killvar 'ivankolefto_count'
    }
    if (((s as any).ivankosanw_count ?? 0)    !== 0) {
      if (!(s as any).ivanko) (s as any).ivanko = {}; (s as any).ivanko['sandwich'] = ((s as any).ivankosanw_count ?? 0);
      // TODO-QSP: killvar 'ivankosanw_count'
    }
    if (((s as any).ivankofood_day ?? 0)    !== 0) {
      if (!(s as any).ivanko) (s as any).ivanko = {}; (s as any).ivanko['food_day'] = ((s as any).ivankofood_day ?? 0);
      // TODO-QSP: killvar 'ivankofood_day'
    }
    if (((s as any).ivanko_lefto ?? 0)    !== '') {
      if (!(s as any).ivanko) (s as any).ivanko = {}; (s as any).ivanko['leftover_txt'] = ((s as any).ivanko_lefto ?? 0);
      // TODO-QSP: killvar 'ivanko_lefto'
    }
    if (((s as any).ivanko_sup ?? 0)      !== '') {
      if (!(s as any).ivanko) (s as any).ivanko = {}; (s as any).ivanko['soup_txt'] = ((s as any).ivanko_sup ?? 0);
      // TODO-QSP: killvar 'ivanko_sup'
    }
    if (((s as any).ivanko_water ?? 0)    !== '') {
      if (!(s as any).ivanko) (s as any).ivanko = {}; (s as any).ivanko['water_txt'] = ((s as any).ivanko_water ?? 0);
      // TODO-QSP: killvar 'ivanko_water'
    }
    if (((s as any).ivanko_sanw ?? 0)      !== '') {
      if (!(s as any).ivanko) (s as any).ivanko = {}; (s as any).ivanko['sandwich_txt'] = ((s as any).ivanko_sanw ?? 0);
    ...
    if (Object.keys((s as any).bodimgsets ?? {}).length / 10 > 4) {
      ...
      if (((s as any).su_j ?? 0) < 9) {
        if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['fix_biset_' + String((s as any).su_i-4 || '') + '_desc_' + String((s as any).su_j || '') + ''] = qspFunc(s, 'body_structure', 'body_desc_from_class', ((s as any).su_j ?? 0));
        if ((((s as any).su_j ?? 0) >= 1  &&  ((s as any).su_j ?? 0) <= 5)  ||  (!(0 as any))) {
          if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['fix_biset_' + String((s as any).su_i-4 || '') + '_img_' + String((s as any).su_j || '') + ''] = '' + qspUntranslated(s, "su_j>", { location: "saveupdater" }) + '';
        }
        (s as any).su_j = ((s as any).su_j ?? 0) + (1);
      } else {
        if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['fix_biset_' + String((s as any).su_i-4 || '') + '_folder'] = ((s as any).bodimgsets ?? 0)?.[10 * ((s as any).su_i ?? 0) + ((s as any).su_j ?? 0)];
        (s as any).su_j = 0;
        (s as any).su_i = ((s as any).su_i ?? 0) + (1);
      }
    ...
    if (((s as any).bdsetlock ?? 0)  !== 0) {
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['fix_bodyimg'] = 1;
      if (((s as any).fixbodset ?? 0) >= 4) {
        if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['fix_bi_set'] = ((s as any).fixbodset ?? 0) - 4;
      } else {
        if (((s as any).fixbodset ?? 0) >= 1) {
          if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['fix_bi_set'] = 190 + (((s as any).fixbodset ?? 0) - 1);
        } else {
          if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['fix_bi_set'] = 0;
          if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['fix_bodyimg'] = 0;
        }
      }
    }
    if (!(s as any).bodyVars) (s as any).bodyVars = {}; (s as any).bodyVars['butt_other'] = 0;
    if (((s as any).lip ?? 0)      !== '') {
      if (!(s as any).pc_descFull) (s as any).pc_descFull = {}; (s as any).pc_descFull['lip'] = ((s as any).lip ?? 0);
      // TODO-QSP: killvar 'lip'
    }
    if (((s as any).pcs_throat ?? 0)  !== '') {
      if (!(s as any).pc_descFull) (s as any).pc_descFull = {}; (s as any).pc_descFull['throat'] = ((s as any).pcs_throat ?? 0);
    }
    if (((s as any).skin ?? 0)    !== '') {
      if (!(s as any).pc_descFull) (s as any).pc_descFull = {}; (s as any).pc_descFull['skin'] = ((s as any).skin ?? 0);
      // TODO-QSP: killvar 'skin'
    }
    if (((s as any).glaza ?? 0)    !== '') {
      if (!(s as any).pc_descFull) (s as any).pc_descFull = {}; (s as any).pc_descFull['eyes'] = ((s as any).glaza ?? 0);
      // TODO-QSP: killvar 'glaza'
    }
    if (((s as any).pcs_makeup ?? 0)  !== '') {
      if (!(s as any).pc_descFull) (s as any).pc_descFull = {}; (s as any).pc_descFull['makeup'] = ((s as any).pcs_makeup ?? 0);
    }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90400) {
    if (((s as any).artemQW ?? 0)?.['strapon_count'] === 0  &&  ((s as any).artemQW ?? 0)?.['strapon'] >= 1  ||  ((s as any).artemQW ?? 0)?.['strapon'] === -1) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['strapon_count'] = 1;
    }
    if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['total'] = 0;
    if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['wearing'] = 0;
    if (((s as any).pirsC ?? 0) > 0) {
      if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['total'] = ((s as any).pcs_piercings['total'] ?? 0) + (1);
      if (((s as any).pirsC ?? 0) >= 10000) {
        if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['ears'] = (-1);
      } else {
        if (((s as any).pirsC ?? 0) > 0) {
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['wearing'] = ((s as any).pcs_piercings['wearing'] ?? 0) + (1);
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['ears'] = ((s as any).pirsC ?? 0);
        }
      }
    }
    if (((s as any).pirsD ?? 0) > 0) {
      ...
      if (((s as any).pirsD ?? 0) >= 10000) {
        if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['nose'] = (-1);
      } else {
        if (((s as any).pirsD ?? 0) > 0) {
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['wearing'] = ((s as any).pcs_piercings['wearing'] ?? 0) + (1);
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['nose'] = ((s as any).pirsD ?? 0);
        }
      }
    }
    if (((s as any).pirsE ?? 0) > 0) {
      ...
      if (((s as any).pirsE ?? 0) >= 10000) {
        if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['brow'] = (-1);
      } else {
        if (((s as any).pirsE ?? 0) > 0) {
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['wearing'] = ((s as any).pcs_piercings['wearing'] ?? 0) + (1);
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['brow'] = ((s as any).pirsE ?? 0);
        }
      }
    }
    if (((s as any).pirsB ?? 0) > 0) {
      ...
      if (((s as any).pirsB ?? 0) >= 10000) {
        if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['lip'] = (-1);
      } else {
        if (((s as any).pirsB ?? 0) > 0) {
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['wearing'] = ((s as any).pcs_piercings['wearing'] ?? 0) + (1);
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['lip'] = ((s as any).pirsB ?? 0);
        }
      }
    }
    if (((s as any).pirsA ?? 0) > 0) {
      ...
      if (((s as any).pirsA ?? 0) >= 10000) {
        if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['tongue'] = (-1);
      } else {
        if (((s as any).pirsA ?? 0) > 0) {
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['wearing'] = ((s as any).pcs_piercings['wearing'] ?? 0) + (1);
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['tongue'] = ((s as any).pirsA ?? 0);
        }
      }
    }
    if (((s as any).pirsN ?? 0) > 0) {
      ...
      if (((s as any).pirsN ?? 0) >= 10000) {
        if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['navel'] = (-1);
      } else {
        if (((s as any).pirsN ?? 0) > 0) {
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['wearing'] = ((s as any).pcs_piercings['wearing'] ?? 0) + (1);
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['navel'] = ((s as any).pirsN ?? 0);
        }
      }
    }
    if (((s as any).pirsF ?? 0) > 0) {
      ...
      if (((s as any).pirsF ?? 0) >= 10000) {
        if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['nipples'] = (-1);
      } else {
        if (((s as any).pirsF ?? 0) > 0) {
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['wearing'] = ((s as any).pcs_piercings['wearing'] ?? 0) + (1);
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['nipples'] = ((s as any).pirsF ?? 0);
        }
      }
    }
    if (((s as any).pirsG ?? 0) > 0) {
      ...
      if (((s as any).pirsG ?? 0) >= 10000) {
        if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['pussy'] = (-1);
      } else {
        if (((s as any).pirsG ?? 0) > 0) {
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['wearing'] = ((s as any).pcs_piercings['wearing'] ?? 0) + (1);
          if (!(s as any).pcs_piercings) (s as any).pcs_piercings = {}; (s as any).pcs_piercings['pussy'] = ((s as any).pirsG ?? 0);
        }
      }
    }
    (s as any).su_i = 0;
    ...
    if (((s as any).tattCount ?? 0)    > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['total'] = ((s as any).tattCount ?? 0);
      // TODO-QSP: killvar 'tattCount'
    }
    if (((s as any).tatarm ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['arm'] = ((s as any).tatarm ?? 0);
      // TODO-QSP: killvar 'tatarm'
    }
    if (((s as any).tatass ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['ass'] = ((s as any).tatass ?? 0);
      // TODO-QSP: killvar 'tatass'
    }
    if (((s as any).tatback ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['back'] = ((s as any).tatback ?? 0);
      // TODO-QSP: killvar 'tatback'
    }
    if (((s as any).tatblly ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['belly'] = ((s as any).tatblly ?? 0);
      // TODO-QSP: killvar 'tatblly'
    }
    if (((s as any).tatbrst ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['breast'] = ((s as any).tatbrst ?? 0);
      // TODO-QSP: killvar 'tatbrst'
    }
    if (((s as any).tatchst ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['chest'] = ((s as any).tatchst ?? 0);
      // TODO-QSP: killvar 'tatchst'
    }
    if (((s as any).tatfce ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['face'] = ((s as any).tatfce ?? 0);
      // TODO-QSP: killvar 'tatfce'
    }
    if (((s as any).tatankle ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['ankle'] = ((s as any).tatankle ?? 0);
      // TODO-QSP: killvar 'tatankle'
    }
    if (((s as any).tatleg ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['leg'] = ((s as any).tatleg ?? 0);
      // TODO-QSP: killvar 'tatleg'
    }
    if (((s as any).tatlip ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['lip'] = ((s as any).tatlip ?? 0);
      // TODO-QSP: killvar 'tatlip'
    }
    if (((s as any).tatneck ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['neck'] = ((s as any).tatneck ?? 0);
      // TODO-QSP: killvar 'tatneck'
    }
    if (((s as any).tatvag ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['pussy'] = ((s as any).tatvag ?? 0);
      // TODO-QSP: killvar 'tatvag'
    }
    if (((s as any).tatlech ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['shoulder'] = ((s as any).tatlech ?? 0);
      // TODO-QSP: killvar 'tatlech'
    }
    if (((s as any).tatside ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['side'] = ((s as any).tatside ?? 0);
      // TODO-QSP: killvar 'tatside'
    }
    if (((s as any).tatupb ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['tramp'] = ((s as any).tatupb ?? 0);
      // TODO-QSP: killvar 'tatupb'
    }
    if (((s as any).tatunder ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['under'] = ((s as any).tatunder ?? 0);
      // TODO-QSP: killvar 'tatunder'
    }
    if (((s as any).tatwrist ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['wrist'] = ((s as any).tatwrist ?? 0);
      // TODO-QSP: killvar 'tatwrist'
    }
    if (((s as any).tathand ?? 0)      > 0) {
      if (!(s as any).pcs_tattoos) (s as any).pcs_tattoos = {}; (s as any).pcs_tattoos['hand'] = ((s as any).tathand ?? 0);
    ...
    if (((s as any).sisterpirsadaytalk ?? 0)  > 0) {
      if (!(s as any).sisterQW) (s as any).sisterQW = {}; (s as any).sisterQW['piercing_daystart'] = ((s as any).sisterpirsadaytalk ?? 0);
      // TODO-QSP: killvar 'sisterpirsadaytalk'
    }
    if (((s as any).brothersawpirsF ?? 0)    > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['piercing_nipples'] = 1;
      // TODO-QSP: killvar 'brothersawpirsF'
    }
    if (((s as any).pirsadaytalk ?? 0)      > 0) {
      if (!(s as any).stepfatherQW) (s as any).stepfatherQW = {}; (s as any).stepfatherQW['piercing_talkday'] = ((s as any).pirsadaytalk ?? 0);
    ...
    if (((s as any).motherpirsadaytalk ?? 0)  > 0) {
      if (!(s as any).motherQW) (s as any).motherQW = {}; (s as any).motherQW['piercing_talkday'] = ((s as any).motherpirsadaytalk ?? 0);
    ...
    if (((s as any).KotovKnowPirsA ?? 0)    > 0) {
      if (!(s as any).VitekQW) (s as any).VitekQW = {}; (s as any).VitekQW['piercing_tongue'] = 1;
      // TODO-QSP: killvar 'KotovKnowPirsA'
    }
    if (((s as any).IgorBlock ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['Block'] = ((s as any).IgorBlock ?? 0);
      // TODO-QSP: killvar 'IgorBlock'
    }
    if (((s as any).IgorDominaQW ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['Domina'] = ((s as any).IgorDominaQW ?? 0);
      // TODO-QSP: killvar 'IgorDominaQW'
    }
    if (((s as any).IgorHorny ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['Horny'] = ((s as any).IgorHorny ?? 0);
      // TODO-QSP: killvar 'IgorHorny'
    }
    if (((s as any).IgorLove ?? 0)        !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['Love'] = ((s as any).IgorLove ?? 0);
      // TODO-QSP: killvar 'IgorLove'
    }
    if (((s as any).IgorLoverQW ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['Lover'] = ((s as any).IgorLoverQW ?? 0);
      // TODO-QSP: killvar 'IgorLoverQW'
    }
    if (((s as any).igor_with ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['with'] = ((s as any).igor_with ?? 0);
      // TODO-QSP: killvar 'igor_with'
    }
    if (((s as any).Igorsex ?? 0)        !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['sex'] = ((s as any).Igorsex ?? 0);
      // TODO-QSP: killvar 'Igorsex'
    }
    if (((s as any).igor_DimaNos ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['DimaNos'] = ((s as any).igor_DimaNos ?? 0);
      // TODO-QSP: killvar 'igor_DimaNos'
    }
    if (((s as any).igor_DimaNos_day ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['DimaNos_day'] = ((s as any).igor_DimaNos_day ?? 0);
      // TODO-QSP: killvar 'igor_DimaNos_day'
    }
    if (((s as any).igor_bi_curious ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['bi_curious'] = ((s as any).igor_bi_curious ?? 0);
      // TODO-QSP: killvar 'igor_bi_curious'
    }
    if (((s as any).igor_blackmail ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['blackmail'] = ((s as any).igor_blackmail ?? 0);
      // TODO-QSP: killvar 'igor_blackmail'
    }
    if (((s as any).igor_eqwtday ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['eqwtday'] = ((s as any).igor_eqwtday ?? 0);
      // TODO-QSP: killvar 'igor_eqwtday'
    }
    if (((s as any).igor_history ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['history'] = ((s as any).igor_history ?? 0);
      // TODO-QSP: killvar 'igor_history'
    }
    if (((s as any).igor_htday ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['htday'] = ((s as any).igor_htday ?? 0);
      // TODO-QSP: killvar 'igor_htday'
    }
    if (((s as any).igor_kdprogulka ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['kdwalk'] = ((s as any).igor_kdprogulka ?? 0);
      // TODO-QSP: killvar 'igor_kdprogulka'
    }
    if (((s as any).igor_kdsexday ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['kdsexday'] = ((s as any).igor_kdsexday ?? 0);
      // TODO-QSP: killvar 'igor_kdsexday'
    }
    if (((s as any).igor_krossdress ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['crossdress'] = ((s as any).igor_krossdress ?? 0);
      // TODO-QSP: killvar 'igor_krossdress'
    }
    if (((s as any).igor_krossdresssex ?? 0)  !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['crossdressSex'] = ((s as any).igor_krossdresssex ?? 0);
      // TODO-QSP: killvar 'igor_krossdresssex'
    }
    if (((s as any).igor_likethis ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['likethis'] = ((s as any).igor_likethis ?? 0);
      // TODO-QSP: killvar 'igor_likethis'
    }
    if (((s as any).igor_listen ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['listen'] = ((s as any).igor_listen ?? 0);
      // TODO-QSP: killvar 'igor_listen'
    }
    if (((s as any).igor_napoit ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['napoit'] = ((s as any).igor_napoit ?? 0);
      // TODO-QSP: killvar 'igor_napoit'
    }
    if (((s as any).igor_net ?? 0)        !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['net'] = ((s as any).igor_net ?? 0);
      // TODO-QSP: killvar 'igor_net'
    }
    if (((s as any).igor_nomore ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['nomore'] = ((s as any).igor_nomore ?? 0);
      // TODO-QSP: killvar 'igor_nomore'
    }
    if (((s as any).igor_progulkaday ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['walkday'] = ((s as any).igor_progulkaday ?? 0);
      // TODO-QSP: killvar 'igor_progulkaday'
    }
    if (((s as any).igor_qwday ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['qwday'] = ((s as any).igor_qwday ?? 0);
      // TODO-QSP: killvar 'igor_qwday'
    }
    if (((s as any).igor_sexstrapon ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['sexstrapon'] = ((s as any).igor_sexstrapon ?? 0);
      // TODO-QSP: killvar 'igor_sexstrapon'
    }
    if (((s as any).igor_strapday ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['strapday'] = ((s as any).igor_strapday ?? 0);
    ...
    if (((s as any).igorevent1 ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['event1'] = ((s as any).igorevent1 ?? 0);
      // TODO-QSP: killvar 'igorevent1'
    }
    if (((s as any).igorkuni ?? 0)        !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['kuni'] = ((s as any).igorkuni ?? 0);
      // TODO-QSP: killvar 'igorkuni'
    }
    if (((s as any).igorstrap ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['strap'] = ((s as any).igorstrap ?? 0);
      // TODO-QSP: killvar 'igorstrap'
    }
    if (((s as any).igorsub ?? 0)        !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['sub'] = ((s as any).igorsub ?? 0);
      // TODO-QSP: killvar 'igorsub'
    }
    if (((s as any).met_IgorMother ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['met_mother'] = ((s as any).met_IgorMother ?? 0);
      // TODO-QSP: killvar 'met_IgorMother'
    }
    if (((s as any).sis_meet ?? 0)        !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['sis_meet'] = ((s as any).sis_meet ?? 0);
      // TODO-QSP: killvar 'sis_meet'
    }
    if (((s as any).met_IgorDad ?? 0)      !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['met_dad'] = ((s as any).met_IgorDad ?? 0);
      // TODO-QSP: killvar 'met_IgorDad'
    }
    if (((s as any).igorkruglovday ?? 0)    !== 0) {
      if (!(s as any).IgorQW) (s as any).IgorQW = {}; (s as any).IgorQW['daystart'] = ((s as any).igorkruglovday ?? 0);
    ...
    if (((s as any).npc_selfie ?? 0)['A' + ((s as any).su_i ?? 0)] !== '') {
      if (!(s as any).npc_selfie) (s as any).npc_selfie = {}; (s as any).npc_selfie['A' + String((s as any).su_i || '') + ''] = qspUntranslated(s, "replace(su_temp_str, 'numnpc = ', ' gt 'phone_selfies', 'listretrieve2', 'A')", { location: "saveupdater" });
    }
    (s as any).su_i = ((s as any).su_i ?? 0) + (1);
    ...
    if (Object.keys((s as any).lover ?? {}).length > 0) {
      if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['lover_number'] = 0;
      // TODO-QSP: :su_lover_to_npcgeneratec_loop
      if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['npcID'] = qspUntranslated(s, "lover[saveupdaterVars['lover_number']]", { location: "saveupdater" });
      ...
      if (((s as any).npc_gender ?? 0)[((s as any).saveupdaterVars ?? 0)?.['npcID']] === 0) {
        if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['av_height'] = 175;
      } else {
        if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['av_height'] = 165;
      }
      ...
      if (((s as any).loverbodrand ?? 0)[((s as any).saveupdaterVars ?? 0)?.['lover_number']] === 1) {
        if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['bmi'] = 17;
      } else {
        if (((s as any).loverbodrand ?? 0)[((s as any).saveupdaterVars ?? 0)?.['lover_number']] === 2) {
          if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['bmi'] = 20;
        } else {
          if (((s as any).loverbodrand ?? 0)[((s as any).saveupdaterVars ?? 0)?.['lover_number']] === 3) {
            if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['bmi'] = 23;
          } else {
            if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['bmi'] = 27;
          }
        }
      }
      ...
      if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['lover_number'] = ((s as any).saveupdaterVars['lover_number'] ?? 0) + (1);
    ...
    if (((s as any).husID ?? 0) !== '') {
      ...
      if (!(s as any).npc_rel) (s as any).npc_rel = {}; (s as any).npc_rel[String((s as any).husID ?? 0)] = ((s as any).husband ?? 0);
      // TODO-QSP: $npc_rel_type[$husID]  = 'husband'
      // TODO-QSP: $npc_usedname[$husID]  = $husname
      if (((s as any).husHair ?? 0) === 'black') {
        if (!(s as any).npc_haircol) (s as any).npc_haircol = {}; (s as any).npc_haircol[String((s as any).husID ?? 0)] = 0;
      } else {
        if (((s as any).husHair ?? 0) === 'brown'  ||  ((s as any).husHair ?? 0) === 'brunette') {
          if (!(s as any).npc_haircol) (s as any).npc_haircol = {}; (s as any).npc_haircol[String((s as any).husID ?? 0)] = 1;
        } else {
          if (((s as any).husHair ?? 0) === 'red') {
            if (!(s as any).npc_haircol) (s as any).npc_haircol = {}; (s as any).npc_haircol[String((s as any).husID ?? 0)] = 2;
          } else {
            if (!(s as any).npc_haircol) (s as any).npc_haircol = {}; (s as any).npc_haircol[String((s as any).husID ?? 0)] = 3;
          }
        }
      }
      if (((s as any).husBody ?? 0) === 'short') {
        if (!(s as any).npc_height) (s as any).npc_height = {}; (s as any).npc_height[String((s as any).husID ?? 0)] = Math.floor(Math.random() * 10) + 160;
      } else {
        if (((s as any).husBody ?? 0) === 'average') {
          if (!(s as any).npc_height) (s as any).npc_height = {}; (s as any).npc_height[String((s as any).husID ?? 0)] = Math.floor(Math.random() * 9) + 171;
        } else {
          if (!(s as any).npc_height) (s as any).npc_height = {}; (s as any).npc_height[String((s as any).husID ?? 0)] = Math.floor(Math.random() * 10) + 181;
        }
      }
      if (((s as any).husFat ?? 0) === 'thin') {
        ...
        if (((s as any).husFat ?? 0) === 'athletic') {
          if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['bmi'] = 21;
        } else {
      ...
      if ((!((s as any).harakHusb ?? 0))) {
        if (!(s as any).npc_gentle) (s as any).npc_gentle = {}; (s as any).npc_gentle[String((s as any).husID ?? 0)] = 1;
      } else {
        if (((s as any).harakHusb ?? 0) === 2) {
          if (!(s as any).npc_rough) (s as any).npc_rough = {}; (s as any).npc_rough[String((s as any).husID ?? 0)] = 1;
        }
      }
      if (((s as any).izvratH ?? 0) > 0) {
        if (!(s as any).npc_pervert) (s as any).npc_pervert = {}; (s as any).npc_pervert[String((s as any).husID ?? 0)] = 1;
      }
      if (!(s as any).npc_sexskill) (s as any).npc_sexskill = {}; (s as any).npc_sexskill[String((s as any).husID ?? 0)] = ((s as any).silavagH ?? 0);
      if (!(s as any).npc_finance) (s as any).npc_finance = {}; (s as any).npc_finance[String((s as any).husID ?? 0)] = ((s as any).husbFin ?? 0);
      (s as any).PRinStyle = 1;
      (s as any).PRinStyle2 = 1;
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['marry_day'] = ((s as any).daystart ?? 0) - ((s as any).husbanday ?? 0);
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['eat_day'] = ((s as any).huseatday ?? 0);
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['drunk_day'] = ((s as any).husbandrinkday ?? 0);
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['drink'] = ((s as any).husbandrink ?? 0);
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['hus_strapon'] = ((s as any).husbanstrapon ?? 0);
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['houseslut'] = ((s as any).houseslut ?? 0);
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['pervert_add'] = ((s as any).husbizvradd ?? 0);
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['gentle_add'] = ((s as any).husbharmin ?? 0);
    }
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['fuckbuddies_current'] = 0;
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['ex_fuckbuddies'] = 0;
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['sugardaddies_current'] = 0;
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['ex_sugardaddies'] = 0;
    if (Object.keys((s as any).fuckbuddy ?? {}).length > 0) {
      (s as any).su_i = 0;
      (s as any).su_max_i = 0;
      // TODO-QSP: :su_fuckbuddy_to_lover_loop
      // TODO-QSP: $lover[] = $fuckbuddy[su_i]
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['fuckbuddies_current'] = ((s as any).stat['fuckbuddies_current'] ?? 0) + (1);
    ...
    if (Object.keys((s as any).sugar_daddy ?? {}).length > 0) {
      ...
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['sugardaddies_current'] = ((s as any).stat['sugardaddies_current'] ?? 0) + (1);
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['total_lovers_current'] = ((s as any).stat['total_lovers_current'] ?? 0) + (1);
      (s as any).su_i = ((s as any).su_i ?? 0) + (1);
      if (((s as any).su_i ?? 0) < ((s as any).su_max_i ?? 0)) {
    ...
    if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['npcID'] = ((s as any).npc_index ?? 0)?.[String((s as any).su_i ?? 0)];
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90401) {
    if (((s as any).npc_lastname ?? 0)?.['A29'] === '') {
      if (!(s as any).npc_lastname) (s as any).npc_lastname = {}; (s as any).npc_lastname['A28'] = ((s as any).pcs_lastname ?? 0);
      if (!(s as any).npc_lastname) (s as any).npc_lastname = {}; (s as any).npc_lastname['A29'] = ((s as any).pcs_lastname ?? 0);
      if (!(s as any).npc_lastname) (s as any).npc_lastname = {}; (s as any).npc_lastname['A33'] = ((s as any).pcs_lastname ?? 0);
      if (!(s as any).npc_lastname) (s as any).npc_lastname = {}; (s as any).npc_lastname['A34'] = ((s as any).pcs_lastname ?? 0);
    }
  }
  if (((s as any).temp_current_save_version ?? 0) < 90402) {
    if (!(s as any).npc_nickname) (s as any).npc_nickname = {}; (s as any).npc_nickname['A191'] = 'Isabella';
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90500) {
    ...
    if (((s as any).blackmailQW ?? 0)?.['last_su'] < 1) {
      if (!(s as any).blackmailQW) (s as any).blackmailQW = {}; (s as any).blackmailQW['last_su'] = 1;
          ...
          if (((s as any).blackmailQW ?? 0)?.['stage'] >= 8) {
            ...
            if (((s as any).blackmailQW ?? 0)?.['stage'] === 8) {
              ...
              if (((s as any).blackmailQW ?? 0)?.['stage'] === 9) {
                ...
                if (((s as any).blackmailQW ?? 0)?.['stage'] >= 10) {
                  if (!(s as any).blackmailQW) (s as any).blackmailQW = {}; (s as any).blackmailQW['stage'] = 7;
                  if (!(s as any).blackmailQW) (s as any).blackmailQW = {}; (s as any).blackmailQW['inventory'] = 7;
    ...
    if (((s as any).camwhore ?? 0) === 1) {
      ...
      if (((s as any).pcs_webcamname ?? 0) !== '') {
        if (!(s as any).camGirl) (s as any).camGirl = {}; (s as any).camGirl['MFC_camname'] = ((s as any).pcs_webcamname ?? 0);
        // TODO-QSP: killvar 'pcs_webcamname'
      }
      if (((s as any).camclients ?? 0) > 0) {
        if (!(s as any).camGirl) (s as any).camGirl = {}; (s as any).camGirl['MFC_Viewers'] = ((s as any).camclients ?? 0);
        // TODO-QSP: killvar 'camclients'
      }
      if (((s as any).regview ?? 0) > 0) {
        if (!(s as any).camGirl) (s as any).camGirl = {}; (s as any).camGirl['MFC_Followers'] = ((s as any).regview ?? 0);
        // TODO-QSP: killvar 'regview'
      }
      if (((s as any).webpopular ?? 0) > 0) {
        if (!(s as any).camGirl) (s as any).camGirl = {}; (s as any).camGirl['fame'] = ((s as any).webpopular ?? 0);
        // TODO-QSP: killvar 'webpopular'
      }
      if (((s as any).tokens_made ?? 0) > 0) {
        if (!(s as any).camGirl) (s as any).camGirl = {}; (s as any).camGirl['MFC_tokens'] = ((s as any).tokens_made ?? 0);
    ...
    if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['npcID'] = qspUntranslated(s, "npc_index[saveupdaterVars['i']]", { location: "saveupdater" });
    if (((s as any).npc_usedname ?? 0)[((s as any).saveupdaterVars ?? 0)?.['npcID']] !== '') {
    ...
    if (((s as any).KGZHP ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['HP'] = ((s as any).KGZHP ?? 0);
      // TODO-QSP: killvar 'KGZHP'
    }
    if (((s as any).KGZday ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['day'] = ((s as any).KGZday ?? 0);
      // TODO-QSP: killvar 'KGZday'
    }
    if (((s as any).KGZhour ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['hour'] = ((s as any).KGZhour ?? 0);
      // TODO-QSP: killvar 'KGZhour'
    }
    if (((s as any).KGZsup ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['sup'] = ((s as any).KGZsup ?? 0);
      // TODO-QSP: killvar 'KGZsup'
    }
    if (((s as any).KGZmedkit ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['medkit'] = ((s as any).KGZmedkit ?? 0);
      // TODO-QSP: killvar 'KGZmedkit'
    }
    if (((s as any).KGZrec ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['rec'] = ((s as any).KGZrec ?? 0);
      // TODO-QSP: killvar 'KGZrec'
    }
    if (((s as any).KGZplace ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['place'] = ((s as any).KGZplace ?? 0);
      // TODO-QSP: killvar 'KGZplace'
    }
    if (((s as any).KGZcopcar ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['copcar'] = ((s as any).KGZcopcar ?? 0);
      // TODO-QSP: killvar 'KGZcopcar'
    }
    if (((s as any).KGZgun ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['gun'] = ((s as any).KGZgun ?? 0);
      // TODO-QSP: killvar 'KGZgun'
    }
    if (((s as any).bullet ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bullet'] = ((s as any).bullet ?? 0);
      // TODO-QSP: killvar 'bullet'
    }
    if (((s as any).KGZgun2 ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['gun2'] = ((s as any).KGZgun2 ?? 0);
      // TODO-QSP: killvar 'KGZgun2'
    }
    if (((s as any).bullet2 ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bullet2'] = ((s as any).bullet2 ?? 0);
      // TODO-QSP: killvar 'bullet2'
    }
    if (((s as any).KGZgun3 ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['gun3'] = ((s as any).KGZgun3 ?? 0);
      // TODO-QSP: killvar 'KGZgun3'
    }
    if (((s as any).bullet3 ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bullet3'] = ((s as any).bullet3 ?? 0);
      // TODO-QSP: killvar 'bullet3'
    }
    if (((s as any).KGZgenerator ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['generator'] = ((s as any).KGZgenerator ?? 0);
      // TODO-QSP: killvar 'KGZgenerator'
    }
    if (((s as any).KGZbenzin ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['benzin'] = ((s as any).KGZbenzin ?? 0);
      // TODO-QSP: killvar 'KGZbenzin'
    }
    if (((s as any).KGZbolgarka ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bolgarka'] = ((s as any).KGZbolgarka ?? 0);
      // TODO-QSP: killvar 'KGZbolgarka'
    }
    if (((s as any).KGZcopdoor ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['copdoor'] = ((s as any).KGZcopdoor ?? 0);
      // TODO-QSP: killvar 'KGZcopdoor'
    }
    if (((s as any).KGZratia ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['ratia'] = ((s as any).KGZratia ?? 0);
      // TODO-QSP: killvar 'KGZratia'
    }
    if (((s as any).KGZfortQW ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['fortQW'] = ((s as any).KGZfortQW ?? 0);
      // TODO-QSP: killvar 'KGZfortQW'
    }
    if (((s as any).KGZfortOru ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['fortOru'] = ((s as any).KGZfortOru ?? 0);
      // TODO-QSP: killvar 'KGZfortOru'
    }
    if (((s as any).KGZgranade ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['granade'] = ((s as any).KGZgranade ?? 0);
      // TODO-QSP: killvar 'KGZgranade'
    }
    if (((s as any).KGZdost ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dost'] = ((s as any).KGZdost ?? 0);
      // TODO-QSP: killvar 'KGZdost'
    }
    if (((s as any).KGZgruzBenz ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['gruzBenz'] = ((s as any).KGZgruzBenz ?? 0);
      // TODO-QSP: killvar 'KGZgruzBenz'
    }
    if (((s as any).KGZgruzBenzMark ?? 0)  !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['gruzBenzMark'] = ((s as any).KGZgruzBenzMark ?? 0);
      // TODO-QSP: killvar 'KGZgruzBenzMark'
    }
    if (((s as any).KGZgruzovik ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['gruzovik'] = ((s as any).KGZgruzovik ?? 0);
      // TODO-QSP: killvar 'KGZgruzovik'
    }
    if (((s as any).KGZlok ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['lok'] = ((s as any).KGZlok ?? 0);
      // TODO-QSP: killvar 'KGZlok'
    }
    if (((s as any).KGZlok2 ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['lok2'] = ((s as any).KGZlok2 ?? 0);
      // TODO-QSP: killvar 'KGZlok2'
    }
    if (((s as any).KGZweapon ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['weapon'] = ((s as any).KGZweapon ?? 0);
      // TODO-QSP: killvar 'KGZweapon'
    }
    if (((s as any).KGZplaceA ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['placeA'] = ((s as any).KGZplaceA ?? 0);
      // TODO-QSP: killvar 'KGZplaceA'
    }
    if (((s as any).KGZdead ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dead'] = ((s as any).KGZdead ?? 0);
      // TODO-QSP: killvar 'KGZdead'
    }
    if (((s as any).KGZbulgun ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['bulgun'] = ((s as any).KGZbulgun ?? 0);
      // TODO-QSP: killvar 'KGZbulgun'
    }
    if (((s as any).KGZbatl ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['batl'] = ((s as any).KGZbatl ?? 0);
      // TODO-QSP: killvar 'KGZbatl'
    }
    if (((s as any).KGZrecord ?? 0)    !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['record'] = ((s as any).KGZrecord ?? 0);
      // TODO-QSP: killvar 'KGZrecord'
    }
    if (((s as any).KGZsvet ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['svet'] = ((s as any).KGZsvet ?? 0);
      // TODO-QSP: killvar 'KGZsvet'
    }
    if (((s as any).KGZagr ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['agr'] = ((s as any).KGZagr ?? 0);
      // TODO-QSP: killvar 'KGZagr'
    }
    if (((s as any).KGZdist ?? 0)      !== 0) {
      if (!(s as any).KGZVars) (s as any).KGZVars = {}; (s as any).KGZVars['dist'] = ((s as any).KGZdist ?? 0);
    ...
    if (((s as any).lesbian ?? 0)      > 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['lesbian_count'] = ((s as any).stat['lesbian_count'] ?? 0) + (((s as any).lesbian ?? 0));
      // TODO-QSP: killvar 'lesbian'
    }
    if (((s as any).hidden_lesbian ?? 0)  > 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['lesbian_unaware_count'] = ((s as any).stat['lesbian_unaware_count'] ?? 0) + (((s as any).hidden_lesbian ?? 0));
      // TODO-QSP: killvar 'hidden_lesbian'
    }
    if (((s as any).gang ?? 0)        > 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['gangbang_count'] = ((s as any).stat['gangbang_count'] ?? 0) + (((s as any).gang ?? 0));
      // TODO-QSP: killvar 'gang'
    }
    if (((s as any).hidden_gang ?? 0)    > 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['gangbang_unaware_count'] = ((s as any).stat['gangbang_unaware_count'] ?? 0) + (((s as any).hidden_gang ?? 0));
      // TODO-QSP: killvar 'hidden_gang'
    }
    if (((s as any).rape ?? 0)        > 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['rape_count'] = ((s as any).stat['rape_count'] ?? 0) + (((s as any).rape ?? 0));
      // TODO-QSP: killvar 'rape'
    }
    if (((s as any).hidden_rape ?? 0)    > 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['rape_unaware_count'] = ((s as any).stat['rape_unaware_count'] ?? 0) + (((s as any).hidden_rape ?? 0));
      // TODO-QSP: killvar 'hidden_rape'
    }
    if (((s as any).shemale ?? 0)      > 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['shemale_count'] = ((s as any).stat['shemale_count'] ?? 0) + (((s as any).shemale ?? 0));
      // TODO-QSP: killvar 'shemale'
    }
    if (((s as any).sex_ev ?? 0) > 0) {
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['sex_stamina'] = ((s as any).npc_sex_stamina ?? 0)?.[String((s as any).npcID ?? 0)];
    }
    if (((s as any).bimbo_flag ?? 0)    > 0) {
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['bimbo_flag'] = ((s as any).bimbo_flag ?? 0);
      // TODO-QSP: killvar 'bimbo_flag'
    }
    if (((s as any).bimbo ?? 0)      > 0) {
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['bimbo_exp'] = ((s as any).bimbo ?? 0);
      // TODO-QSP: killvar 'bimbo'
    }
    if (((s as any).bimbolevel ?? 0)    > 0) {
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['bimbo_lvl'] = ((s as any).bimbolevel ?? 0);
      // TODO-QSP: killvar 'bimbolevel'
    }
    if (((s as any).bimbowithdrawal ?? 0)  > 0) {
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['bimbo_deg'] = ((s as any).bimbowithdrawal ?? 0);
      // TODO-QSP: killvar 'bimbowithdrawal'
    }
    if (((s as any).bimbostupidity ?? 0)  > 0) {
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['bimbo_stupid'] = ((s as any).bimbostupidity ?? 0);
      // TODO-QSP: killvar 'bimbostupidity'
    }
    if (((s as any).goth_flag ?? 0)    > 0) {
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['goth_flag'] = ((s as any).goth_flag ?? 0);
      // TODO-QSP: killvar 'goth_flag'
    }
    if (((s as any).punk_flag ?? 0)    > 0) {
      if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['punk_flag'] = ((s as any).punk_flag ?? 0);
      // TODO-QSP: killvar 'punk_flag'
    }
    if (((s as any).supnatvnesh ?? 0)    > 0) {
      if (((s as any).pcs_traits ?? 0)?.['bimbo_lvl'] > 0) {
        if (!(s as any).pcs_traits) (s as any).pcs_traits = {}; (s as any).pcs_traits['bimbo_pretty'] = ((s as any).supnatvnesh ?? 0);
      } else {
    ...
    if (((s as any).gsAboVolley ?? 0) > 0) {
      if (!(s as any).vballVars) (s as any).vballVars = {}; (s as any).vballVars['lessons_remaining'] = ((s as any).gsAboVolley ?? 0);
      (s as any).gsAboVolley = 0;
    }
    if (!(s as any).emp_job_summerjob) (s as any).emp_job_summerjob = {}; (s as any).emp_job_summerjob[1] = 1;
    (s as any).adv_init = 0;
    if (((s as any).virgin_stats ?? 0)?.['lost_cause'] === '') {
      if (((s as any).stat ?? 0)?.['vaginal'] > 0  ||  ((s as any).stat ?? 0)?.['vaginal_fist'] > 0  ||  ((s as any).stat ?? 0)?.['hidden_vaginal'] > 0) {
        if (!(s as any).virgin_stats) (s as any).virgin_stats = {}; (s as any).virgin_stats['lost_cause'] = 'vaginal';
      } else {
        if (((s as any).stat ?? 0)?.['vaginal_dildo'] > 0) {
          if (!(s as any).virgin_stats) (s as any).virgin_stats = {}; (s as any).virgin_stats['lost_cause'] = 'dildo';
        } else {
          if (((s as any).stat ?? 0)?.['vaginal_strap'] > 0) {
            if (!(s as any).virgin_stats) (s as any).virgin_stats = {}; (s as any).virgin_stats['lost_cause'] = 'strapon';
          }
        }
      }
    }
    ...
    if (((s as any).camGirl ?? 0)?.['last_su'] < 1) {
      ...
      if (!(s as any).camGirl) (s as any).camGirl = {}; (s as any).camGirl['last_su'] = 1;
    ...
    if (((s as any).petka ?? 0)?.['sub']      > 0) {
      if (!(s as any).petkaQW) (s as any).petkaQW = {}; (s as any).petkaQW['sub'] = ((s as any).petka ?? 0)?.['sub'];
    }
    if (((s as any).petka ?? 0)?.['blackmail']  > 0) {
      if (!(s as any).petkaQW) (s as any).petkaQW = {}; (s as any).petkaQW['blackmail'] = ((s as any).petka ?? 0)?.['blackmail'];
    }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90501) {
    if (((s as any).brotherSex ?? 0)        > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['Sex'] = ((s as any).brotherSex ?? 0);
      // TODO-QSP: killvar 'brotherSex'
    }
    if (((s as any).brotherAge ?? 0)        > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['Age'] = ((s as any).brotherAge ?? 0);
      // TODO-QSP: killvar 'brotherAge'
    }
    if (((s as any).brotherknowslut ?? 0)      > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['know_slut'] = ((s as any).brotherknowslut ?? 0);
      // TODO-QSP: killvar 'brotherknowslut'
    }
    if (((s as any).brotherDay ?? 0)        > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day'] = ((s as any).brotherDay ?? 0);
      // TODO-QSP: killvar 'brotherDay'
    }
    if (((s as any).brotherSexCount ?? 0)      > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['sex_count_today'] = ((s as any).brotherSexCount ?? 0);
      // TODO-QSP: killvar 'brotherSexCount'
    }
    if (((s as any).brotherMorningSex ?? 0)    > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day_morning'] = ((s as any).brotherMorningSex ?? 0);
      // TODO-QSP: killvar 'brotherMorningSex'
    }
    if (((s as any).brotherNightSex ?? 0)      > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day_night'] = ((s as any).brotherNightSex ?? 0);
      // TODO-QSP: killvar 'brotherNightSex'
    }
    if (((s as any).brotherEvSex ?? 0)        > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day_evening'] = ((s as any).brotherEvSex ?? 0);
      // TODO-QSP: killvar 'brotherEvSex'
    }
    if (((s as any).brother_homework ?? 0)      > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_day_homework'] = ((s as any).brother_homework ?? 0);
      // TODO-QSP: killvar 'brother_homework'
    }
    if (((s as any).brother_saw_analplug ?? 0)    > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['saw_analplug'] = ((s as any).brother_saw_analplug ?? 0);
    ...
    if (((s as any).brother_knows_not_virgin ?? 0)  > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['know_not_virgin'] = ((s as any).brother_knows_not_virgin ?? 0);
    ...
    if (((s as any).BrotherNo ?? 0)        > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['refused_seeporn_bj'] = ((s as any).BrotherNo ?? 0);
      // TODO-QSP: killvar 'BrotherNo'
    }
    if (((s as any).BrotherNoDay ?? 0)        > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['refused_seeporn_bj_day'] = ((s as any).BrotherNoDay ?? 0);
      // TODO-QSP: killvar 'BrotherNoDay'
    }
    if (((s as any).brother_ev1 ?? 0)        > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['bath_voyeur_day'] = ((s as any).brother_ev1 ?? 0);
      // TODO-QSP: killvar 'brother_ev1'
    }
    if (((s as any).brotherConfidence ?? 0)    > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['confidence'] = ((s as any).brotherConfidence ?? 0);
      // TODO-QSP: killvar 'brotherConfidence'
    }
    if (((s as any).npc_know_sveta_lact ?? 0)?.['A34']    > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['know_pc_lact'] = ((s as any).npc_know_sveta_lact ?? 0)?.['A34'];
      // TODO-QSP: killvar 'npc_know_sveta_lact'
    }
    if (((s as any).npc_breastfeed_by_sveta ?? 0)?.['A34']  > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['breastfeed_by_pc'] = ((s as any).npc_breastfeed_by_sveta ?? 0)?.['A34'];
      // TODO-QSP: killvar 'npc_breastfeed_by_sveta'
    }
    if (((s as any).npc_tasted_sveta_milk ?? 0)?.['A34']    > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['know_pc_milk_taste'] = ((s as any).npc_tasted_sveta_milk ?? 0)?.['A34'];
      // TODO-QSP: killvar 'npc_tasted_sveta_milk'
    }
    if (((s as any).brotherSexed ?? 0)        > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['sex_ed'] = ((s as any).brotherSexed ?? 0);
      // TODO-QSP: killvar 'brotherSexed'
    }
    if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['i'] = 0;
    if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['maxi'] = 0;
    ...
    if (((s as any).virgin_stats ?? 0)?.['cock_desc'] === 'monster') {
      if (!(s as any).virgin_stats) (s as any).virgin_stats = {}; (s as any).virgin_stats['cock_desc'] = 'monstrous';
    }
    if (((s as any).stat ?? 0)?.['biggest_cock_desc'] === 'monster') {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['biggest_cock_desc'] = 'monstrous';
    }
    if (((s as any).stat ?? 0)?.['biggest_cock_anal_desc'] === 'monster') {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['biggest_cock_anal_desc'] = 'monstrous';
    }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90600) {
    if (((s as any).ObjektBil ?? 0) !== 0) {
      if (!(s as any).obekt) (s as any).obekt = {}; (s as any).obekt['bil'] = ((s as any).ObjektBil ?? 0);
    ...
    if (((s as any).car ?? 0)?.['ID'] !== 0) {
      ...
      if ((!((s as any).car ?? 0))) {
        ...
        if (((s as any).car ?? 0) !== 0  &&  ((s as any).car ?? 0) !== ''  &&  ((s as any).car ?? 0)?.['ID'] === 0  &&  ((s as any).car ?? 0)?.['name'] === '') {
          ...
          if (!(s as any).car) (s as any).car = {}; (s as any).car['ID'] = ((s as any).temp_carnum ?? 0);
          if (!(s as any).car) (s as any).car = {}; (s as any).car['name'] = ((s as any).temp_carname ?? 0);
          if (!(s as any).car) (s as any).car = {}; (s as any).car['fuel'] = ((s as any).benz ?? 0);
          if (!(s as any).car) (s as any).car = {}; (s as any).car['tank'] = 50;
          if (!(s as any).car) (s as any).car = {}; (s as any).car['new_condition'] = ((s as any).temp_newcond ?? 0);
          if (!(s as any).car) (s as any).car = {}; (s as any).car['current_condition'] = ((s as any).temp_curcond ?? 0);
          if (!(s as any).car) (s as any).car = {}; (s as any).car['wreck'] = ((s as any).wrek ?? 0);
                                          ...
                                          if (((s as any).cardrive ?? 0) === 20) {
                                            ...
                                            if (((s as any).cardrive ?? 0) === 21) {
                                              ...
                                              if (((s as any).cardrive ?? 0) === 22) {
                                                qspCall(s, 'car_funcs', 'setloc', 'road', '' + qspUntranslated(s, "ncarroad>", { location: "saveupdater" }) + '', 'other');
                                              } else {
    ...
    if (((s as any).husbandsexday ?? 0)  > 0) {
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['sexday'] = ((s as any).husbandsexday ?? 0);
      // TODO-QSP: killvar 'husbandsexday'
    }
    if (((s as any).husbdolg ?? 0)      > 0) {
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['husb_debt_event'] = ((s as any).husbdolg ?? 0);
      // TODO-QSP: killvar 'husbdolg'
    }
    if (((s as any).before_h_guy ?? 0) > 0) {
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['men_fucked_before'] = ((s as any).before_h_guy ?? 0) - ((s as any).guy_cheat ?? 0);
    }
    if (((s as any).before_h_girl ?? 0) > 0) {
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['women_fucked_before'] = ((s as any).before_h_girl ?? 0) - ((s as any).girl_cheat ?? 0);
    }
    ...
    if (((s as any).subscription ?? 0)?.['metered_mobile-date'] > 28) {
      if (!(s as any).subscription) (s as any).subscription = {}; (s as any).subscription['metered_mobile-date'] = 1;
    }
    if (((s as any).subscription ?? 0)?.['mobile-date'] > 28) {
      if (!(s as any).subscription) (s as any).subscription = {}; (s as any).subscription['mobile-date'] = 1;
    }
    if (((s as any).subscription ?? 0)?.['mobile-suspension_day'] > 0) {
      if (!(s as any).subscription) (s as any).subscription = {}; (s as any).subscription['mobile-suspension_day'] = ((s as any).subscription['mobile-suspension_day'] ?? 0) + (((s as any).daystart ?? 0) - ((s as any).day ?? 0));
    }
    qspCall(s, 'array', 'remove_element', 'subscription', 'mobile-suspension_month');
    if (((s as any).subscription ?? 0)?.['metered_calls-date'] > 28) {
      if (!(s as any).subscription) (s as any).subscription = {}; (s as any).subscription['metered_calls-date'] = 1;
    }
    if (((s as any).subscription ?? 0)?.['monthly_calls-date'] > 28) {
      if (!(s as any).subscription) (s as any).subscription = {}; (s as any).subscription['monthly_calls-date'] = 1;
    }
    if (((s as any).subscription ?? 0)?.['monthly_calls-suspension_day'] > 0) {
      if (!(s as any).subscription) (s as any).subscription = {}; (s as any).subscription['monthly_calls-suspension_day'] = ((s as any).subscription['monthly_calls-suspension_day'] ?? 0) + (((s as any).daystart ?? 0) - ((s as any).day ?? 0));
    }
    qspCall(s, 'array', 'remove_element', 'subscription', 'monthly_calls-suspension_month');
    if (((s as any).SchoolAtestat ?? 0)  !== 0) {
      if (!(s as any).gschoolVars) (s as any).gschoolVars = {}; (s as any).gschoolVars['school_diploma'] = ((s as any).SchoolAtestat ?? 0);
      // TODO-QSP: killvar 'SchoolAtestat'
    }
    if (((s as any).school_check_day ?? 0)  !== 0) {
      if (!(s as any).gschoolVars) (s as any).gschoolVars = {}; (s as any).gschoolVars['last_attendance'] = ((s as any).school_check_day ?? 0);
      // TODO-QSP: killvar 'school_check_day'
    }
    if (((s as any).schoolProgulDay ?? 0)  !== 0) {
      if (!(s as any).gschoolVars) (s as any).gschoolVars = {}; (s as any).gschoolVars['last_absence'] = ((s as any).schoolProgulDay ?? 0);
      // TODO-QSP: killvar 'schoolProgulDay'
    }
    if (((s as any).schoolprogul ?? 0)    !== 0) {
      if (!(s as any).gschoolVars) (s as any).gschoolVars = {}; (s as any).gschoolVars['absence_count'] = ((s as any).schoolprogul ?? 0);
      // TODO-QSP: killvar 'schoolprogul'
    }
    if (((s as any).BeInSchool ?? 0)    !== 0) {
      if (!(s as any).gschoolVars) (s as any).gschoolVars = {}; (s as any).gschoolVars['attendance_count'] = ((s as any).BeInSchool ?? 0);
      // TODO-QSP: killvar 'BeInSchool'
    }
    if (((s as any).schoolBlock ?? 0)    !== 0) {
      if (!(s as any).gschoolVars) (s as any).gschoolVars = {}; (s as any).gschoolVars['block'] = ((s as any).schoolBlock ?? 0);
      // TODO-QSP: killvar 'schoolBlock'
    }
    if (((s as any).schoolPredupr ?? 0)  !== 0) {
      if (!(s as any).gschoolVars) (s as any).gschoolVars = {}; (s as any).gschoolVars['expell_stage'] = ((s as any).schoolPredupr ?? 0);
      // TODO-QSP: killvar 'schoolPredupr'
    }
    if (((s as any).camGirl ?? 0)?.['MFC_account'] === 1) {
      if (((s as any).camGirl ?? 0)?.['MFC_last_online'] === 0) {
        if (!(s as any).camGirl) (s as any).camGirl = {}; (s as any).camGirl['MFC_last_online'] = ((s as any).daystart ?? 0);
      }
      if (((s as any).camGirl ?? 0)?.['MFC_maxFollowers'] < ((s as any).camGirl ?? 0)?.['MFC_Followers']) {
        if (!(s as any).camGirl) (s as any).camGirl = {}; (s as any).camGirl['MFC_maxFollowers'] = ((s as any).camGirl ?? 0)?.['MFC_Followers'];
      }
    }
    if (!(s as any).npc_dob) (s as any).npc_dob = {}; (s as any).npc_dob['A64'] = 19650523;
    if (((s as any).huntersAndreiLove ?? 0)      !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['AndreiLove'] = ((s as any).huntersAndreiLove ?? 0);
      // TODO-QSP: killvar 'huntersAndreiLove'
    }
    if (((s as any).huntersAndreiQw ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['AndreiQw'] = ((s as any).huntersAndreiQw ?? 0);
      // TODO-QSP: killvar 'huntersAndreiQw'
    }
    if (((s as any).huntersAndreisex ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['Andreisex'] = ((s as any).huntersAndreisex ?? 0);
      // TODO-QSP: killvar 'huntersAndreisex'
    }
    if (((s as any).huntersIgorLove ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['IgorLove'] = ((s as any).huntersIgorLove ?? 0);
      // TODO-QSP: killvar 'huntersIgorLove'
    }
    if (((s as any).huntersIgorQW ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['IgorQW'] = ((s as any).huntersIgorQW ?? 0);
      // TODO-QSP: killvar 'huntersIgorQW'
    }
    if (((s as any).huntersIgorsex ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['Igorsex'] = ((s as any).huntersIgorsex ?? 0);
      // TODO-QSP: killvar 'huntersIgorsex'
    }
    if (((s as any).huntersKnowSlut ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['KnowSlut'] = ((s as any).huntersKnowSlut ?? 0);
      // TODO-QSP: killvar 'huntersKnowSlut'
    }
    if (((s as any).huntersRape ?? 0)          !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['Rape'] = ((s as any).huntersRape ?? 0);
      // TODO-QSP: killvar 'huntersRape'
    }
    if (((s as any).huntersSergeiLove ?? 0)      !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['SergeiLove'] = ((s as any).huntersSergeiLove ?? 0);
      // TODO-QSP: killvar 'huntersSergeiLove'
    }
    if (((s as any).huntersSergeiQw ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['SergeiQw'] = ((s as any).huntersSergeiQw ?? 0);
      // TODO-QSP: killvar 'huntersSergeiQw'
    }
    if (((s as any).huntersSergeisex ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['Sergeisex'] = ((s as any).huntersSergeisex ?? 0);
      // TODO-QSP: killvar 'huntersSergeisex'
    }
    if (((s as any).huntersVagSex ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['VagSex'] = ((s as any).huntersVagSex ?? 0);
      // TODO-QSP: killvar 'huntersVagSex'
    }
    if (((s as any).hunters_available ?? 0)      !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['available'] = ((s as any).hunters_available ?? 0);
      // TODO-QSP: killvar 'hunters_available'
    }
    if (((s as any).hunters_bj_times ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['bj_times'] = ((s as any).hunters_bj_times ?? 0);
      // TODO-QSP: killvar 'hunters_bj_times'
    }
    if (((s as any).hunters_breakfast ?? 0)      !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['breakfast'] = ((s as any).hunters_breakfast ?? 0);
      // TODO-QSP: killvar 'hunters_breakfast'
    }
    if (((s as any).hunters_chattime ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['chattime'] = ((s as any).hunters_chattime ?? 0);
      // TODO-QSP: killvar 'hunters_chattime'
    }
    if (((s as any).hunters_check ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['check'] = ((s as any).hunters_check ?? 0);
      // TODO-QSP: killvar 'hunters_check'
    }
    if (((s as any).hunters_dinner ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['dinner'] = ((s as any).hunters_dinner ?? 0);
      // TODO-QSP: killvar 'hunters_dinner'
    }
    if (((s as any).hunters_drink ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['drink'] = ((s as any).hunters_drink ?? 0);
      // TODO-QSP: killvar 'hunters_drink'
    }
    if (((s as any).hunters_evening ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['evening'] = ((s as any).hunters_evening ?? 0);
      // TODO-QSP: killvar 'hunters_evening'
    }
    if (((s as any).hunters_hunting ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['hunting'] = ((s as any).hunters_hunting ?? 0);
      // TODO-QSP: killvar 'hunters_hunting'
    }
    if (((s as any).hunters_inside ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['inside'] = ((s as any).hunters_inside ?? 0);
      // TODO-QSP: killvar 'hunters_inside'
    }
    if (((s as any).hunters_kuni ?? 0)          !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['kuni'] = ((s as any).hunters_kuni ?? 0);
      // TODO-QSP: killvar 'hunters_kuni'
    }
    if (((s as any).hunters_lunch ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['lunch'] = ((s as any).hunters_lunch ?? 0);
      // TODO-QSP: killvar 'hunters_lunch'
    }
    if (((s as any).hunters_outside ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['outside'] = ((s as any).hunters_outside ?? 0);
      // TODO-QSP: killvar 'hunters_outside'
    }
    if (((s as any).hunters_sleep ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['sleep'] = ((s as any).hunters_sleep ?? 0);
      // TODO-QSP: killvar 'hunters_sleep'
    }
    if (((s as any).hunters_violent ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['violent'] = ((s as any).hunters_violent ?? 0);
      // TODO-QSP: killvar 'hunters_violent'
    }
    if (((s as any).hunters_were_met ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['were_met'] = ((s as any).hunters_were_met ?? 0);
      // TODO-QSP: killvar 'hunters_were_met'
    }
    if (((s as any).huntersbreakfast ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['breakfastday'] = ((s as any).huntersbreakfast ?? 0);
      // TODO-QSP: killvar 'huntersbreakfast'
    }
    if (((s as any).hunterscabin ?? 0)          !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['cabin'] = ((s as any).hunterscabin ?? 0);
      // TODO-QSP: killvar 'hunterscabin'
    }
    if (((s as any).huntersdrinking ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['drinking'] = ((s as any).huntersdrinking ?? 0);
      // TODO-QSP: killvar 'huntersdrinking'
    }
    if (((s as any).huntersexnude ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['sexnude'] = ((s as any).huntersexnude ?? 0);
      // TODO-QSP: killvar 'huntersexnude'
    }
    if (((s as any).huntersknowfilm ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['knowfilm'] = ((s as any).huntersknowfilm ?? 0);
      // TODO-QSP: killvar 'huntersknowfilm'
    }
    if (((s as any).huntersknowfoto ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['knowfoto'] = ((s as any).huntersknowfoto ?? 0);
      // TODO-QSP: killvar 'huntersknowfoto'
    }
    if (((s as any).huntersknowstrip ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['knowstrip'] = ((s as any).huntersknowstrip ?? 0);
      // TODO-QSP: killvar 'huntersknowstrip'
    }
    if (((s as any).hunterslut ?? 0)          !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['slut'] = ((s as any).hunterslut ?? 0);
      // TODO-QSP: killvar 'hunterslut'
    }
    if (((s as any).huntersmokBJ ?? 0)          !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['smokeBJ'] = ((s as any).huntersmokBJ ?? 0);
      // TODO-QSP: killvar 'huntersmokBJ'
    }
    if (((s as any).hunterstableBJ ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['tableBJ'] = ((s as any).hunterstableBJ ?? 0);
      // TODO-QSP: killvar 'hunterstableBJ'
    }
    if (((s as any).hunterstableBJA ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['tableBJA'] = ((s as any).hunterstableBJA ?? 0);
      // TODO-QSP: killvar 'hunterstableBJA'
    }
    if (((s as any).hunterstableBJI ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['tableBJI'] = ((s as any).hunterstableBJI ?? 0);
      // TODO-QSP: killvar 'hunterstableBJI'
    }
    if (((s as any).hunterstableBJS ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['tableBJS'] = ((s as any).hunterstableBJS ?? 0);
      // TODO-QSP: killvar 'hunterstableBJS'
    }
    if (((s as any).hunter_refuse ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['refuse'] = ((s as any).hunter_refuse ?? 0);
      // TODO-QSP: killvar 'hunter_refuse'
    }
    if (((s as any).hunterknowday ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['knowday'] = ((s as any).hunterknowday ?? 0);
      // TODO-QSP: killvar 'hunterknowday'
    }
    if (((s as any).forest_huntersex ?? 0)        !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['forest_sex'] = ((s as any).forest_huntersex ?? 0);
      // TODO-QSP: killvar 'forest_huntersex'
    }
    if (((s as any).hunter_sexual_comfort ?? 0)    !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['sexual_comfort'] = ((s as any).hunter_sexual_comfort ?? 0);
      // TODO-QSP: killvar 'hunter_sexual_comfort'
    }
    if (((s as any).hunter_collective_opinion ?? 0)  !== 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['collective_opinion'] = ((s as any).hunter_collective_opinion ?? 0);
    ...
    if (((s as any).sosedKnowWork ?? 0)  !== 0) {
      if (!(s as any).neighborQW) (s as any).neighborQW = {}; (s as any).neighborQW['knows_work'] = ((s as any).sosedKnowWork ?? 0);
      // TODO-QSP: killvar 'sosedKnowWork'
    }
    if (((s as any).sosedQW ?? 0)      !== 0) {
      if (!(s as any).neighborQW) (s as any).neighborQW = {}; (s as any).neighborQW['state'] = ((s as any).sosedQW ?? 0);
      // TODO-QSP: killvar 'sosedQW'
    }
    if (((s as any).workPTU ?? 0)      !== 0) {
      if (!(s as any).teacher) (s as any).teacher = {}; (s as any).teacher['job'] = ((s as any).workPTU ?? 0);
      // TODO-QSP: killvar 'workPTU'
    }
    if (((s as any).teachlevel ?? 0)    !== 0) {
      if (!(s as any).teacher) (s as any).teacher = {}; (s as any).teacher['level'] = ((s as any).teachlevel ?? 0);
      // TODO-QSP: killvar 'teachlevel'
    }
    if (((s as any).izvad ?? 0)      !== 0) {
      if (!(s as any).teacher) (s as any).teacher = {}; (s as any).teacher['apology'] = ((s as any).izvad ?? 0);
      // TODO-QSP: killvar 'izvad'
    }
    if (((s as any).gor_dorm ?? 0)      !== 0) {
      if (!(s as any).hostel) (s as any).hostel = {}; (s as any).hostel['status'] = ((s as any).gor_dorm ?? 0);
      // TODO-QSP: killvar 'gor_dorm'
    }
    if (((s as any).pzptu ?? 0)      !== 0) {
      if (!(s as any).teacher) (s as any).teacher = {}; (s as any).teacher['class_state'] = ((s as any).pzptu ?? 0);
      // TODO-QSP: killvar 'pzptu'
    }
    if (((s as any).etoexhib ?? 0)      !== 0) {
      if (!(s as any).exhib) (s as any).exhib = {}; (s as any).exhib['status'] = ((s as any).etoexhib ?? 0);
      // TODO-QSP: killvar 'etoexhib'
    }
    if (((s as any).stolcigarettes ?? 0) !== 0) {
      if (!(s as any).stolcigarettes) (s as any).stolcigarettes = {}; (s as any).stolcigarettes[String((s as any).temp_stol ?? 0)] = ((s as any).stolcigarettes ?? 0);
    ...
    if (((s as any).stat ?? 0)?.['hj'] > 0) {
      if (((s as any).stat ?? 0)?.['men_jerked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_jerked_times'] = ((s as any).stat ?? 0)?.['hj'];
      }
      if (((s as any).stat ?? 0)?.['men_jerked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_jerked'] = ((s as any).stat ?? 0)?.['hj'];
      }
    }
    if (((s as any).stat ?? 0)?.['hidden_hj'] > 0) {
      if (((s as any).stat ?? 0)?.['men_hidden_jerked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_jerked_times'] = ((s as any).stat ?? 0)?.['hidden_hj'];
      }
      if (((s as any).stat ?? 0)?.['men_hidden_jerked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_jerked'] = ((s as any).stat ?? 0)?.['hidden_hj'];
      }
    }
    if (((s as any).stat ?? 0)?.['footjob'] > 0) {
      if (((s as any).stat ?? 0)?.['men_feetfucked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_feetfucked_times'] = ((s as any).stat ?? 0)?.['footjob'];
      }
      if (((s as any).stat ?? 0)?.['men_feetfucked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_feetfucked'] = ((s as any).stat ?? 0)?.['footjob'];
      }
    }
    if (((s as any).stat ?? 0)?.['hidden_footjob'] > 0) {
      if (((s as any).stat ?? 0)?.['men_hidden_feetfucked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_feetfucked_times'] = ((s as any).stat ?? 0)?.['hidden_footjob'];
      }
      if (((s as any).stat ?? 0)?.['men_hidden_feetfucked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_feetfucked'] = ((s as any).stat ?? 0)?.['hidden_footjob'];
      }
    }
    if (((s as any).stat ?? 0)?.['titjob'] > 0) {
      if (((s as any).stat ?? 0)?.['men_titfucked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_titfucked_times'] = ((s as any).stat ?? 0)?.['titjob'];
      }
      if (((s as any).stat ?? 0)?.['men_titfucked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_titfucked'] = ((s as any).stat ?? 0)?.['titjob'];
      }
    }
    if (((s as any).stat ?? 0)?.['hidden_titjob'] > 0) {
      if (((s as any).stat ?? 0)?.['men_hidden_titfucked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_titfucked_times'] = ((s as any).stat ?? 0)?.['hidden_titjob'];
      }
      if (((s as any).stat ?? 0)?.['men_hidden_titfucked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_titfucked'] = ((s as any).stat ?? 0)?.['hidden_titjob'];
      }
    }
    if (((s as any).stat ?? 0)?.['bj'] > 0) {
      if (((s as any).stat ?? 0)?.['men_blown_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_blown_times'] = ((s as any).stat ?? 0)?.['bj'];
      }
      if (((s as any).stat ?? 0)?.['men_blown'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_blown'] = ((s as any).stat ?? 0)?.['bj'];
      }
    }
    if (((s as any).stat ?? 0)?.['hidden_bj'] > 0) {
      if (((s as any).stat ?? 0)?.['men_hidden_blown_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_blown_times'] = ((s as any).stat ?? 0)?.['hidden_bj'];
      }
      if (((s as any).stat ?? 0)?.['men_hidden_blown'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_blown'] = ((s as any).stat ?? 0)?.['hidden_bj'];
      }
    }
    if (((s as any).stat ?? 0)?.['cuni_give'] > 0) {
      if (((s as any).stat ?? 0)?.['women_munched_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['women_munched_times'] = ((s as any).stat ?? 0)?.['cuni_give'];
      }
      if (((s as any).stat ?? 0)?.['women_munched'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['women_munched'] = ((s as any).stat ?? 0)?.['cuni_give'];
      }
    }
    if (((s as any).stat ?? 0)?.['hidden_cuni_give'] > 0) {
      if (((s as any).stat ?? 0)?.['women_hidden_munched_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['women_hidden_munched_times'] = ((s as any).stat ?? 0)?.['hidden_cuni_give'];
      }
      if (((s as any).stat ?? 0)?.['women_hidden_munched'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['women_hidden_munched'] = ((s as any).stat ?? 0)?.['hidden_cuni_give'];
      }
    }
    if (((s as any).stat ?? 0)?.['vaginal'] > 0) {
      if (((s as any).stat ?? 0)?.['men_vaginal_fucked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_vaginal_fucked_times'] = ((s as any).stat ?? 0)?.['vaginal'];
      }
      if (((s as any).stat ?? 0)?.['men_vaginal_fucked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_vaginal_fucked'] = ((s as any).stat ?? 0)?.['vaginal'];
      }
    }
    if (((s as any).stat ?? 0)?.['hidden_vaginal'] > 0) {
      if (((s as any).stat ?? 0)?.['men_hidden_vaginal_fucked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_vaginal_fucked_times'] = ((s as any).stat ?? 0)?.['hidden_vaginal'];
      }
      if (((s as any).stat ?? 0)?.['men_hidden_vaginal_fucked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_vaginal_fucked'] = ((s as any).stat ?? 0)?.['hidden_vaginal'];
      }
    }
    if (((s as any).stat ?? 0)?.['trib'] > 0) {
      if (((s as any).stat ?? 0)?.['women_vaginal_fucked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['women_vaginal_fucked_times'] = ((s as any).stat ?? 0)?.['trib'];
      }
      if (((s as any).stat ?? 0)?.['women_vaginal_fucked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['women_vaginal_fucked'] = ((s as any).stat ?? 0)?.['trib'];
      }
    }
    if (((s as any).stat ?? 0)?.['hidden_trib'] > 0) {
      if (((s as any).stat ?? 0)?.['women_hidden_vaginal_fucked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['women_hidden_vaginal_fucked_times'] = ((s as any).stat ?? 0)?.['hidden_trib'];
      }
      if (((s as any).stat ?? 0)?.['women_hidden_vaginal_fucked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['women_hidden_vaginal_fucked'] = ((s as any).stat ?? 0)?.['hidden_trib'];
      }
    }
    if (((s as any).stat ?? 0)?.['anal'] > 0) {
      if (((s as any).stat ?? 0)?.['men_anal_fucked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_anal_fucked_times'] = ((s as any).stat ?? 0)?.['anal'];
      }
      if (((s as any).stat ?? 0)?.['men_anal_fucked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_anal_fucked'] = ((s as any).stat ?? 0)?.['anal'];
      }
    }
    if (((s as any).stat ?? 0)?.['hidden_anal'] > 0) {
      if (((s as any).stat ?? 0)?.['men_hidden_anal_fucked_times'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_anal_fucked_times'] = ((s as any).stat ?? 0)?.['hidden_anal'];
      }
      if (((s as any).stat ?? 0)?.['men_hidden_anal_fucked'] === 0) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['men_hidden_anal_fucked'] = ((s as any).stat ?? 0)?.['hidden_anal'];
      }
    }
    if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['maxi'] = 0;
    if (((s as any).saveupdaterVars ?? 0)?.['maxi'] > 0) {
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90601) {
    if (((s as any).NatbelQW ?? 0)?.['FriendLover'] === 8  &&  ((s as any).NatbelQW ?? 0)?.['shopping'] === 4) {
      if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['shopping'] = 3;
    }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90700) {
    ...
    if (((s as any).stat ?? 0)?.['women_vag_fucked'] > 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['women_vaginal_fucked'] = ((s as any).stat['women_vaginal_fucked'] ?? 0) + (((s as any).stat ?? 0)?.['women_vag_fucked']);
      qspCall(s, 'array', 'remove_element', 'stat', 'women_vag_fucked');
    }
    if (((s as any).stat ?? 0)?.['herm_vag_fucked'] > 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['herm_vaginal_fucked'] = ((s as any).stat['herm_vaginal_fucked'] ?? 0) + (((s as any).stat ?? 0)?.['herm_vag_fucked']);
    ...
    if (((s as any).addictive_trait_lvl ?? 0)  > 0) {
      if (!(s as any).traits) (s as any).traits = {}; (s as any).traits['addictive_personality'] = ((s as any).addictive_trait_lvl ?? 0);
      // TODO-QSP: killvar 'addictive_trait_lvl'
    }
    if (((s as any).add_trait_msg_1 ?? 0)    > 0) {
      if (!(s as any).traits) (s as any).traits = {}; (s as any).traits['addictive_personality_msg_1'] = ((s as any).add_trait_msg_1 ?? 0);
      // TODO-QSP: killvar 'add_trait_msg_1'
    }
    if (((s as any).add_trait_msg_2 ?? 0)    > 0) {
      if (!(s as any).traits) (s as any).traits = {}; (s as any).traits['addictive_personality_msg_2'] = ((s as any).add_trait_msg_2 ?? 0);
      // TODO-QSP: killvar 'add_trait_msg_1'
    }
    if (((s as any).add_trait_msg_3 ?? 0)    > 0) {
      if (!(s as any).traits) (s as any).traits = {}; (s as any).traits['addictive_personality_msg_3'] = ((s as any).add_trait_msg_3 ?? 0);
      // TODO-QSP: killvar 'add_trait_msg_1'
    }
    ...
    if (((s as any).phone_loc ?? 0) !== ''  &&  ((s as any).phone_loc ?? 0)?.['class'] === '') {
      if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['phone_loc0'] = ((s as any).phone_loc ?? 0);
      if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['phone_loc1'] = qspUntranslated(s, "phone_loc[1]", { location: "saveupdater" });
      if (!(s as any).phone_loc) (s as any).phone_loc = {}; (s as any).phone_loc['class'] = ((s as any).saveupdaterVars ?? 0)?.['phone_loc0'];
      if (!(s as any).phone_loc) (s as any).phone_loc = {}; (s as any).phone_loc['type'] = ((s as any).saveupdaterVars ?? 0)?.['phone_loc1'];
    }
    ...
    if (((s as any).telefon ?? 0)?.['SMSid'] > 0) {
      if (!(s as any).telefon) (s as any).telefon = {}; (s as any).telefon['SMSIndex'] = ((s as any).telefon ?? 0)?.['SMSid'];
    ...
    if ((!((s as any).npcupdate09070 ?? 0))) {
      ...
      if (Object.keys((s as any).npc_index ?? {}).length > 0) {
        ...
        if (!(s as any).saveupdaterVars) (s as any).saveupdaterVars = {}; (s as any).saveupdaterVars['ID'] = qspUntranslated(s, "npc_index[saveupdaterVars['i']]", { location: "saveupdater" });
        if (((s as any).npc_gender ?? 0)[((s as any).saveupdaterVars ?? 0)?.['ID']] === 0) {
          // TODO-QSP: npc_spermvol[$saveupdaterVars['ID']] = 40
        } else {
          // TODO-QSP: npc_spermvol[$saveupdaterVars['ID']] = -1
    ...
    if (Object.keys((s as any).weatherGrM ?? {}).length > 0) {
      ...
      if (!(s as any).sunWeather) (s as any).sunWeather = {}; (s as any).sunWeather[1] = ((s as any).totminut ?? 0) + 60;
    }
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90800) {
    ...
    if (!(s as any).cheatmenu) (s as any).cheatmenu = {}; (s as any).cheatmenu['std_cure'] = '';
    ...
    if (Object.keys((s as any).music_on ?? {}).length > 0) {
      if (((s as any).music_on ?? 0) === 0  &&  Object.keys((s as any).sound_settings ?? {}).length === 0) {
        if (!(s as any).sound_settings) (s as any).sound_settings = {}; (s as any).sound_settings['music_off'] = 1;
      }
    }
    if (((s as any).prava ?? 0)       !== 0) {
      if (!(s as any).license) (s as any).license = {}; (s as any).license['drive'] = ((s as any).prava ?? 0);
      // TODO-QSP: killvar 'prava'
    }
    if (((s as any).skulday ?? 0)       !== 0) {
      if (!(s as any).license) (s as any).license = {}; (s as any).license['drive_lastday'] = ((s as any).skulday ?? 0);
      // TODO-QSP: killvar 'skulday'
    }
    if (((s as any).masseuse_lesson ?? 0)   !== 0) {
      if (!(s as any).license) (s as any).license = {}; (s as any).license['masseuse_lastday'] = ((s as any).masseuse_lesson ?? 0);
      // TODO-QSP: killvar 'masseuse_lesson'
    }
    if (((s as any).vokalday ?? 0)     !== 0) {
      if (!(s as any).license) (s as any).license = {}; (s as any).license['singing_lastday'] = ((s as any).vokalday ?? 0);
      // TODO-QSP: killvar 'vokalday'
    }
    if (((s as any).secrday ?? 0)       !== 0) {
      if (!(s as any).license) (s as any).license = {}; (s as any).license['secretary_lastday'] = ((s as any).secrday ?? 0);
      // TODO-QSP: killvar 'secrday'
    }
    if (((s as any).secretary ?? 0)?.['certification'] >= 12) {
      if (!(s as any).license) (s as any).license = {}; (s as any).license['secretary'] = 1;
      // TODO-QSP: killvar 'secretary'
    }
    if (((s as any).secretary ?? 0)?.['certification'] > 1) {
      if (!(s as any).license) (s as any).license = {}; (s as any).license['secretary_enrolled'] = 1;
      if (!(s as any).license) (s as any).license = {}; (s as any).license['secretary_lessons'] = ((s as any).secretary ?? 0)?.['certification'];
    }
    if (((s as any).avtoskul ?? 0) !== 0) {
      if (!(s as any).license) (s as any).license = {}; (s as any).license['drive_enrolled'] = 1;
      if (!(s as any).license) (s as any).license = {}; (s as any).license['drive_lessons'] = ((s as any).avtoskul ?? 0);
      // TODO-QSP: killvar 'avtoskul'
    }
    if (((s as any).masseuse ?? 0)?.['certification'] >= 10) {
      if (!(s as any).license) (s as any).license = {}; (s as any).license['masseuse'] = 1;
      qspCall(s, 'array', 'remove_element', 'masseuse', 'certification');
    }
    if (((s as any).masseuse ?? 0)?.['certification'] > 0) {
      if (!(s as any).license) (s as any).license = {}; (s as any).license['masseuse_enrolled'] = 1;
      if (!(s as any).license) (s as any).license = {}; (s as any).license['masseuse_lessons'] = ((s as any).masseuse ?? 0)?.['certification'];
      qspCall(s, 'array', 'remove_element', 'masseuse', 'certification');
    } else {
      if (((s as any).masseuse ?? 0)?.['certification'] < 0) {
        if (!(s as any).license) (s as any).license = {}; (s as any).license['masseuse_enrolled'] = 1;
        if (!(s as any).license) (s as any).license = {}; (s as any).license['masseuse_lessons'] = 0;
        qspCall(s, 'array', 'remove_element', 'masseuse', 'certification');
      }
    }
    ...
    if (((s as any).bed ?? 0)?.['shoetype'] !== ''  &&  ((s as any).lastwornshoetype ?? 0)?.['bed'] === '') {
      if (!(s as any).lastwornshoetype) (s as any).lastwornshoetype = {}; (s as any).lastwornshoetype['bed'] = ((s as any).bed ?? 0)?.['shoetype'];
      if (!(s as any).lastwornshoenumber) (s as any).lastwornshoenumber = {}; (s as any).lastwornshoenumber['bed'] = ((s as any).bed ?? 0)?.['shoenumber'];
    }
    if (((s as any).lastworncoattype ?? 0)?.['bed'] === '') {
      if (!(s as any).lastworncoattype) (s as any).lastworncoattype = {}; (s as any).lastworncoattype['bed'] = ((s as any).coatworntype ?? 0);
      if (!(s as any).lastworncoatnumber) (s as any).lastworncoatnumber = {}; (s as any).lastworncoatnumber['bed'] = ((s as any).coatwornnumber ?? 0);
    }
    if (((s as any).lastworncoattype ?? 0)?.['bed'] === '') {
      if (!(s as any).lastworncoattype) (s as any).lastworncoattype = {}; (s as any).lastworncoattype['bed'] = ((s as any).coatworntype ?? 0);
      if (!(s as any).lastworncoatnumber) (s as any).lastworncoatnumber = {}; (s as any).lastworncoatnumber['bed'] = ((s as any).coatwornnumber ?? 0);
    ...
    if (((s as any).lastwornpursetype ?? 0)?.['bed'] === '') {
      if (!(s as any).lastwornpursetype) (s as any).lastwornpursetype = {}; (s as any).lastwornpursetype['bed'] = ((s as any).currentpursetype ?? 0);
      if (!(s as any).lastwornpursenumber) (s as any).lastwornpursenumber = {}; (s as any).lastwornpursenumber['bed'] = ((s as any).currentpursenumber ?? 0);
    }
    qspCall(s, 'stat_sklattrib', 'init_vars');
    if (((s as any).checkoutalbina ?? 0)        !== 0) {
      if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['voyeur'] = ((s as any).checkoutalbina ?? 0);
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['pav_clinic_cleaner_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['pav_clinic_cleaner_v4'] = 1;
      if (((s as any).job_status ?? 0)?.['pav_clinic_cleaner'] === 'employed') {
        ...
        qspCall(s, 'jobs', 'set_employed', 'pav_clinic_cleaner');
        if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['pav_clinic_cleaner'] = ((s as any).temp_cleaner_worked ?? 0);
      } else {
        if (((s as any).job_status ?? 0)?.['pav_clinic_cleaner'] === 'preemployed') {
          if (!(s as any).job_status) (s as any).job_status = {}; (s as any).job_status['pav_clinic_cleaner'] = '';
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_office_cleaner_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_office_cleaner_v4'] = 1;
      if (((s as any).job_status ?? 0)?.['city_office_cleaner'] === '') {
        if (((s as any).clener ?? 0) >= 2) {
          ...
          if (((s as any).temp_office_shifts ?? 0) > 0) {
            if (!(s as any).job_shifts_total) (s as any).job_shifts_total = {}; (s as any).job_shifts_total['city_office_cleaner'] = ((s as any).temp_office_shifts ?? 0);
          }
        } else {
      ...
      if (((s as any).clenday ?? 0) > 0) {
        if (!(s as any).job_last_work_day) (s as any).job_last_work_day = {}; (s as any).job_last_work_day['city_office_cleaner'] = ((s as any).clenday ?? 0);
      }
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_office_toilet_cleaner_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_office_toilet_cleaner_v4'] = 1;
      if (((s as any).job_status ?? 0)?.['city_office_toilet_cleaner'] === '') {
        if (((s as any).clenerT ?? 0) >= 1) {
          ...
          if (((s as any).temp_toilet_shifts ?? 0) > 0) {
            if (!(s as any).job_shifts_total) (s as any).job_shifts_total = {}; (s as any).job_shifts_total['city_office_toilet_cleaner'] = ((s as any).temp_toilet_shifts ?? 0);
          }
        }
      }
      if (((s as any).clendayT ?? 0) > 0) {
        if (!(s as any).job_last_work_day) (s as any).job_last_work_day = {}; (s as any).job_last_work_day['city_office_toilet_cleaner'] = ((s as any).clendayT ?? 0);
      }
    }
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['pav_hotel_maid_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['pav_hotel_maid_v4'] = 1;
      if (((s as any).job_hiring_step ?? 0)?.['pav_hotel_maid'] >= 3  ||  ((s as any).maidqw ?? 0) === 1) {
        if (((s as any).job_status ?? 0)?.['pav_hotel_maid'] === 'employed') {
          ...
          if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['pav_hotel_maid'] = ((s as any).temp_maid_worked ?? 0);
        } else {
          qspCall(s, 'jobs', 'set_employed', 'pav_hotel_maid');
        }
      }
      if (((s as any).maidstat ?? 0) > 0) {
        if (!(s as any).job_rank) (s as any).job_rank = {}; (s as any).job_rank['pav_hotel_maid'] = ((s as any).maidstat ?? 0);
      }
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['pav_mailgirl_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['pav_mailgirl_v4'] = 1;
      if (((s as any).job_status ?? 0)?.['pav_mailgirl'] === ''  &&  ((s as any).postjobQW ?? 0) !== 0) {
        if (((s as any).postjobQW ?? 0) === 4) {
          ...
          if (((s as any).postjobQW ?? 0) === 1  ||  ((s as any).postjobQW ?? 0) === 2  ||  ((s as any).postjobQW ?? 0) === 3) {
            if (!(s as any).job_hiring_step) (s as any).job_hiring_step = {}; (s as any).job_hiring_step['pav_mailgirl'] = ((s as any).postjobQW ?? 0);
          } else {
      ...
      if (((s as any).job_status ?? 0)?.['pav_mailgirl'] === 'preemployed') {
        if (!(s as any).job_hiring_step) (s as any).job_hiring_step = {}; (s as any).job_hiring_step['pav_mailgirl'] = ((s as any).job_rank ?? 0)?.['pav_mailgirl'];
        if (!(s as any).job_status) (s as any).job_status = {}; (s as any).job_status['pav_mailgirl'] = '';
        if (!(s as any).job_rank) (s as any).job_rank = {}; (s as any).job_rank['pav_mailgirl'] = 0;
      } else {
    ...
    if (((s as any).emp_job_status ?? 0)[1] === 1) {
      ...
      if (!(s as any).emp_job_status) (s as any).emp_job_status = {}; (s as any).emp_job_status[1] = 0;
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['pav_tour_guide_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['pav_tour_guide_v4'] = 1;
      if (((s as any).job_status ?? 0)?.['pav_tour_guide'] === 'employed') {
        ...
        qspCall(s, 'jobs', 'set_employed', 'pav_tour_guide');
        if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['pav_tour_guide'] = ((s as any).temp_tg_worked ?? 0);
      }
    }
    if (((s as any).workmaid ?? 0) > 0) {
      if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['pav_hotel_maid'] = ((s as any).job_worked_count['pav_hotel_maid'] ?? 0) + (((s as any).workmaid ?? 0));
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['pav_barbershop_cleaner_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['pav_barbershop_cleaner_v4'] = 1;
      if (((s as any).job_status ?? 0)?.['pav_barbershop_cleaner'] === 'employed') {
        ...
        qspCall(s, 'jobs', 'set_employed', 'pav_barbershop_cleaner');
        if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['pav_barbershop_cleaner'] = ((s as any).temp_bs_worked ?? 0);
      }
    }
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['highway_brothel_prostitute_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['highway_brothel_prostitute_v4'] = 1;
      if (((s as any).job_status ?? 0)?.['highway_brothel_prostitute'] === 'employed') {
        ...
        qspCall(s, 'jobs', 'set_employed', 'highway_brothel_prostitute');
        if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['highway_brothel_prostitute'] = ((s as any).temp_br_worked ?? 0);
      }
    }
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['pav_train_cleaner_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['pav_train_cleaner_v4'] = 1;
      if (((s as any).job_status ?? 0)?.['pav_train_cleaner'] === 'employed') {
        ...
        qspCall(s, 'jobs', 'set_employed', 'pav_train_cleaner');
        if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['pav_train_cleaner'] = ((s as any).temp_tc_worked ?? 0);
      }
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_diner_dishwasher_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_diner_dishwasher_v4'] = 1;
      ...
      if (!(s as any).BurgerQW) (s as any).BurgerQW = {}; (s as any).BurgerQW['WashDishesCount'] = 0;
      if (!(s as any).BurgerQW) (s as any).BurgerQW = {}; (s as any).BurgerQW['WashFloorCount'] = 0;
      if (!(s as any).BurgerQW) (s as any).BurgerQW = {}; (s as any).BurgerQW['WashedDishesLastDay'] = 0;
      if (!(s as any).BurgerQW) (s as any).BurgerQW = {}; (s as any).BurgerQW['WashFloorLastDay'] = 0;
      if (!(s as any).BurgerQW) (s as any).BurgerQW = {}; (s as any).BurgerQW['WorkBlocked'] = 0;
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_diner_secretary_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_diner_secretary_v4'] = 1;
      if (((s as any).BurgerQW ?? 0)?.['Secretary'] === 1  &&  ((s as any).job_status ?? 0)?.['city_diner_secretary'] === '') {
        ...
        if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['city_diner_secretary'] = ((s as any).BurgerQW ?? 0)?.['SecretaryTimesWorked'];
      }
      ...
      if (!(s as any).BurgerQW) (s as any).BurgerQW = {}; (s as any).BurgerQW['Secretary'] = 0;
      if (!(s as any).BurgerQW) (s as any).BurgerQW = {}; (s as any).BurgerQW['SecretaryTimesWorked'] = 0;
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_hospital_nurse_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_hospital_nurse_v4'] = 1;
      if (((s as any).workhosp ?? 0) === 1  &&  ((s as any).job_status ?? 0)?.['city_hospital_nurse'] === '') {
        qspCall(s, 'jobs', 'set_employed', 'city_hospital_nurse');
        if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['city_hospital_nurse'] = ((s as any).smena ?? 0);
      }
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_cafe_waitress_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_cafe_waitress_v4'] = 1;
      if (((s as any).workKafe ?? 0)?.['job'] === 1  &&  ((s as any).job_status ?? 0)?.['city_cafe_waitress'] === '') {
        qspCall(s, 'jobs', 'set_employed', 'city_cafe_waitress');
        if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['city_cafe_waitress'] = ((s as any).smenaKafe ?? 0);
        if (!(s as any).job_shifts_total) (s as any).job_shifts_total = {}; (s as any).job_shifts_total['city_cafe_waitress'] = ((s as any).smenaKafe ?? 0);
      }
      if (((s as any).workKafe ?? 0)?.['job'] === -1  &&  ((s as any).job_status ?? 0)?.['city_cafe_waitress'] === '') {
        qspCall(s, 'jobs', 'set_employed', 'city_cafe_waitress');
        qspCall(s, 'jobs', 'set_terminated', 'city_cafe_waitress');
      }
      if (!(s as any).workKafe) (s as any).workKafe = {}; (s as any).workKafe['job'] = 0;
      if (!(s as any).workKafe) (s as any).workKafe = {}; (s as any).workKafe['at_work'] = 0;
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_office_secretary_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_office_secretary_v4'] = 1;
      if (((s as any).workSec ?? 0) === 1  &&  ((s as any).job_status ?? 0)?.['city_office_secretary'] === '') {
        ...
        if (((s as any).sekDay ?? 0) > 0) {
          if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['city_office_secretary'] = ((s as any).sekDay ?? 0);
          if (!(s as any).job_shifts_total) (s as any).job_shifts_total = {}; (s as any).job_shifts_total['city_office_secretary'] = ((s as any).sekDay ?? 0);
        }
      }
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['pav_factory_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['pav_factory_v4'] = 1;
      if (((s as any).workFabrika ?? 0) === 1  &&  ((s as any).job_status ?? 0)?.['pav_factory'] === '') {
        ...
        if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['pav_factory'] = ((s as any).smenaFabrika ?? 0) * 240;
      }
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_pussycats_clerk_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_pussycats_clerk_v4'] = 1;
      if (((s as any).job_status ?? 0)?.['city_pussycats_clerk'] === '') {
        if (((s as any).young_shop_work ?? 0) === 1) {
          ...
          if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['city_pussycats_clerk'] = ((s as any).young_shop_salary ?? 0) * 60;
          if (((s as any).young_shop_bonus ?? 0) > 0) {
            // TODO-QSP: gs 'jobs', 'bonus_pay', 'city_pussycats_clerk', young_shop_bonus * 205
          }
          if (!(s as any).job_booking_debt) (s as any).job_booking_debt = {}; (s as any).job_booking_debt['city_pussycats_clerk'] = ((s as any).young_shop_miss ?? 0);
          if (!(s as any).job_missed_total) (s as any).job_missed_total = {}; (s as any).job_missed_total['city_pussycats_clerk'] = ((s as any).young_shop_miss ?? 0);
          if (!(s as any).job_miss_acknowledged) (s as any).job_miss_acknowledged = {}; (s as any).job_miss_acknowledged['city_pussycats_clerk'] = ((s as any).young_shop_warned ?? 0);
        } else {
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_strip_bargirl_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_strip_bargirl_v4'] = 1;
      if (((s as any).job_status ?? 0)?.['city_strip_bargirl'] === '') {
        if (((s as any).strip_club ?? 0)?.['stripbarwork'] === 1  ||  ((s as any).strip_club ?? 0)?.['stripbarwork1'] === 1) {
          ...
          if (((s as any).strip_club ?? 0)?.['bar_shifts'] > 0) {
            if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['city_strip_bargirl'] = ((s as any).strip_club ?? 0)?.['bar_shifts'];
            if (!(s as any).job_shifts_total) (s as any).job_shifts_total = {}; (s as any).job_shifts_total['city_strip_bargirl'] = ((s as any).strip_club ?? 0)?.['bar_shifts'];
          }
        }
      }
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['stripbarwork'] = 0;
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['stripbarwork1'] = 0;
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['bar_shifts'] = 0;
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_strip_stripper_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_strip_stripper_v4'] = 1;
      ...
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['stripwork'] = 0;
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['strip_schedule_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['strip_schedule_v4'] = 1;
      ...
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['schedule_update'] = 0;
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['shifts_required'] = 0;
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['last_worked_day'] = 0;
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['missed_shift2'] = 0;
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['pornstudio_actress_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['pornstudio_actress_v4'] = 1;
      if (((s as any).firstkasting ?? 0) === 1  &&  ((s as any).job_status ?? 0)?.['city_pornstudio_actress'] === '') {
        if (((s as any).pfilmSTOP ?? 0) === 1) {
          ...
          if (!(s as any).job_termination_reason) (s as any).job_termination_reason = {}; (s as any).job_termination_reason['city_pornstudio_actress'] = 'retired';
          ...
          if (((s as any).pfilmNO ?? 0) === 1  &&  ((s as any).pfilmNoVenera ?? 0) === 1) {
            ...
            if (((s as any).pfilmNO ?? 0) === 1) {
              qspCall(s, 'jobs', 'set_employed', 'city_pornstudio_actress');
              if (!(s as any).job_termination_reason) (s as any).job_termination_reason = {}; (s as any).job_termination_reason['city_pornstudio_actress'] = 'blacklisted';
        ...
        if (((s as any).prodcosttrue ?? 0) > 0) {
          if (!(s as any).job_booking_debt) (s as any).job_booking_debt = {}; (s as any).job_booking_debt['city_pornstudio_actress'] = ((s as any).prodcosttrue ?? 0);
        }
        if (((s as any).pornstack ?? 0) > 0) {
          if (!(s as any).job_bookings_active) (s as any).job_bookings_active = {}; (s as any).job_bookings_active['city_pornstudio_actress'] = ((s as any).pornstack ?? 0);
        }
        ...
        if (((s as any).film ?? 0) > 0) {
          if (!(s as any).job_shifts_total) (s as any).job_shifts_total = {}; (s as any).job_shifts_total['city_pornstudio_actress'] = ((s as any).film ?? 0);
        }
      }
    }
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_pornstudio_actress_rename'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_pornstudio_actress_rename'] = 1;
      if (((s as any).job_status ?? 0)?.['pornstudio_actress'] !== '') {
        if (!(s as any).job_status) (s as any).job_status = {}; (s as any).job_status['city_pornstudio_actress'] = ((s as any).job_status ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_rank) (s as any).job_rank = {}; (s as any).job_rank['city_pornstudio_actress'] = ((s as any).job_rank ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_added) (s as any).job_added = {}; (s as any).job_added['city_pornstudio_actress'] = ((s as any).job_added ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_termination_day) (s as any).job_termination_day = {}; (s as any).job_termination_day['city_pornstudio_actress'] = ((s as any).job_termination_day ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_termination_reason) (s as any).job_termination_reason = {}; (s as any).job_termination_reason['city_pornstudio_actress'] = ((s as any).job_termination_reason ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_pay_rate) (s as any).job_pay_rate = {}; (s as any).job_pay_rate['city_pornstudio_actress'] = ((s as any).job_pay_rate ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_pay_interval) (s as any).job_pay_interval = {}; (s as any).job_pay_interval['city_pornstudio_actress'] = ((s as any).job_pay_interval ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_worked_count) (s as any).job_worked_count = {}; (s as any).job_worked_count['city_pornstudio_actress'] = ((s as any).job_worked_count ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_bonus_pay) (s as any).job_bonus_pay = {}; (s as any).job_bonus_pay['city_pornstudio_actress'] = ((s as any).job_bonus_pay ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_docked_pay) (s as any).job_docked_pay = {}; (s as any).job_docked_pay['city_pornstudio_actress'] = ((s as any).job_docked_pay ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_shifts_total) (s as any).job_shifts_total = {}; (s as any).job_shifts_total['city_pornstudio_actress'] = ((s as any).job_shifts_total ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_last_work_day) (s as any).job_last_work_day = {}; (s as any).job_last_work_day['city_pornstudio_actress'] = ((s as any).job_last_work_day ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_clocked_in) (s as any).job_clocked_in = {}; (s as any).job_clocked_in['city_pornstudio_actress'] = ((s as any).job_clocked_in ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_missed_total) (s as any).job_missed_total = {}; (s as any).job_missed_total['city_pornstudio_actress'] = ((s as any).job_missed_total ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_miss_acknowledged) (s as any).job_miss_acknowledged = {}; (s as any).job_miss_acknowledged['city_pornstudio_actress'] = ((s as any).job_miss_acknowledged ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_suspended) (s as any).job_suspended = {}; (s as any).job_suspended['city_pornstudio_actress'] = ((s as any).job_suspended ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_event_id) (s as any).job_event_id = {}; (s as any).job_event_id['city_pornstudio_actress'] = ((s as any).job_event_id ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_active_schedule) (s as any).job_active_schedule = {}; (s as any).job_active_schedule['city_pornstudio_actress'] = ((s as any).job_active_schedule ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_bookings_active) (s as any).job_bookings_active = {}; (s as any).job_bookings_active['city_pornstudio_actress'] = ((s as any).job_bookings_active ?? 0)?.['pornstudio_actress'];
        if (!(s as any).job_booking_debt) (s as any).job_booking_debt = {}; (s as any).job_booking_debt['city_pornstudio_actress'] = ((s as any).job_booking_debt ?? 0)?.['pornstudio_actress'];
        ...
        if (((s as any).job_event_id ?? 0)?.['city_pornstudio_actress'] === 'job_pornstudio_actress') {
          ...
          if (!(s as any).job_event_id) (s as any).job_event_id = {}; (s as any).job_event_id['city_pornstudio_actress'] = '';
    ...
    if (((s as any).brothershowertalk ?? 0)  > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['shower_talk'] = ((s as any).brothershowertalk ?? 0);
      // TODO-QSP: killvar 'brothershowertalk'
    }
    if (((s as any).brothershowerlook ?? 0)  > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['shower_look'] = ((s as any).brothershowerlook ?? 0);
      // TODO-QSP: killvar 'brothershowerlook'
    }
    if (((s as any).brothershave ?? 0) > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['shave'] = ((s as any).brothershave ?? 0);
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['shave_day'] = qspUntranslated(s, "brothershave[1]", { location: "saveupdater" });
    }
    if (((s as any).brotherkiss ?? 0)      > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['kiss'] = ((s as any).brotherkiss ?? 0);
      // TODO-QSP: killvar 'brotherkiss'
    }
    if (((s as any).brotherbj ?? 0)      > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['bj'] = ((s as any).brotherbj ?? 0);
      // TODO-QSP: killvar 'brotherbj'
    }
    if (((s as any).brotherfuck ?? 0)      > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['fuck'] = ((s as any).brotherfuck ?? 0);
      // TODO-QSP: killvar 'brotherfuck'
    }
    if (((s as any).brotheranal ?? 0)      > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['anal'] = ((s as any).brotheranal ?? 0);
      // TODO-QSP: killvar 'brotheranal'
    }
    if (((s as any).brotherclub ?? 0)      > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['club'] = ((s as any).brotherclub ?? 0);
      // TODO-QSP: killvar 'brotherclub'
    }
    if (((s as any).brothervirginlie ?? 0)    > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['virgin_lie'] = ((s as any).brothervirginlie ?? 0);
      // TODO-QSP: killvar 'brothervirginlie'
    }
    if (((s as any).brother_virgin_talk ?? 0)  > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['virgin_talk'] = ((s as any).brother_virgin_talk ?? 0);
      // TODO-QSP: killvar 'brother_virgin_talk'
    }
    if (((s as any).brother_shower_times ?? 0)  > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['shower_times'] = ((s as any).brother_shower_times ?? 0);
      // TODO-QSP: killvar 'brother_shower_times'
    }
    if (((s as any).brothershowerbj ?? 0)    > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['shower_bj_day'] = ((s as any).brothershowerbj ?? 0);
      // TODO-QSP: killvar 'brothershowerbj'
    }
    if (((s as any).broshowerfuck ?? 0)    > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['shower_fuck_day'] = ((s as any).broshowerfuck ?? 0);
      // TODO-QSP: killvar 'broshowerfuck'
    }
    if (((s as any).broshowerorgasm ?? 0)    > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['shower_orgasm_day'] = ((s as any).broshowerorgasm ?? 0);
      // TODO-QSP: killvar 'broshowerorgasm'
    }
    if (((s as any).anatomyhomeworkhelp ?? 0)  > 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['anatomy_help'] = ((s as any).anatomyhomeworkhelp ?? 0);
      // TODO-QSP: killvar 'anatomyhomeworkhelp'
    }
    if (((s as any).menu_loc ?? 0) === 'changingroom') {
      if (((s as any).ignore_inhib ?? 0)    > 0) {
        if (!(s as any).temp_changingroomVars) (s as any).temp_changingroomVars = {}; (s as any).temp_changingroomVars['ignore_inhib'] = ((s as any).ignore_inhib ?? 0);
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90801) {
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['pornstudio_booking_slot_fix'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['pornstudio_booking_slot_fix'] = 1;
    ...
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['male_sexual_partners'] = qspUntranslated(s, "max(stat['male_sexual_partners'],    stat['men_jerked'],        stat['men_feetfucked'],      stat['men_titfucked'],      stat['men_blown'],        stat['men_fucked'])", { location: "saveupdater" });
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['male_sexual_times'] = qspUntranslated(s, "max(stat['male_sexual_times'],    stat['men_jerked_times'],    stat['men_feetfucked_times'],  stat['men_titfucked_times'],  stat['men_blown_times'],    stat['men_fucked_times'])", { location: "saveupdater" });
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['female_sexual_partners'] = qspUntranslated(s, "max(stat['female_sexual_partners'],  stat['women_fingered'],      stat['women_feetfucked'],    stat['women_titfucked'],    stat['women_munched'],      stat['women_fucked'])", { location: "saveupdater" });
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['female_sexual_times'] = qspUntranslated(s, "max(stat['female_sexual_times'],    stat['women_fingered_times'],  stat['women_feetfucked_times'],  stat['women_titfucked_times'],  stat['women_munched_times'],  stat['women_fucked_times'])", { location: "saveupdater" });
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['herm_sexual_partners'] = qspUntranslated(s, "max(stat['herm_sexual_partners'],    stat['herm_jerked'],      stat['herm_feetfucked'],    stat['herm_titfucked'],      stat['herm_blown'],        stat['herm_fucked'])", { location: "saveupdater" });
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['herm_sexual_times'] = qspUntranslated(s, "max(stat['herm_sexual_times'],    stat['herm_jerked_times'],    stat['herm_feetfucked_times'],  stat['herm_titfucked_times'],  stat['herm_blown_times'],    stat['herm_fucked_times'])", { location: "saveupdater" });
    ...
    if (((s as any).sex_ev ?? 0)?.['cum_choice']    !== 0) {
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_choice_int'] = ((s as any).sex_ev ?? 0)?.['cum_choice'];
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_choice'] = 0;
    }
    ...
    if (((s as any).ParrotQW ?? 0)?.['Name']    !== '') {
      if (!(s as any).ParrotQW) (s as any).ParrotQW = {}; (s as any).ParrotQW['Name2'] = ((s as any).ParrotQW ?? 0)?.['Name'];
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90802) {
    if (((s as any).prodcost ?? 0) > 0  &&  ((s as any).job_status ?? 0)?.['city_pornstudio_actress'] === 'employed') {
      if (!(s as any).job_last_miss_cost) (s as any).job_last_miss_cost = {}; (s as any).job_last_miss_cost['city_pornstudio_actress'] = ((s as any).prodcost ?? 0);
    }
    if (((s as any).temp_saveupdater_guard ?? 0)?.['diff_opts_migrated'] === 0) {
      if (!(s as any).temp_saveupdater_guard) (s as any).temp_saveupdater_guard = {}; (s as any).temp_saveupdater_guard['diff_opts_migrated'] = 1;
      ...
      if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['deg_speed'] = 0;
      if (((s as any).money_vars ?? 0)?.['pos_mult_opt'] === -1) {
        if (!(s as any).money_vars) (s as any).money_vars = {}; (s as any).money_vars['pos_mult_opt'] = 99;
      } else {
        if (((s as any).money_vars ?? 0)?.['pos_mult_opt'] === 1) {
          if (!(s as any).money_vars) (s as any).money_vars = {}; (s as any).money_vars['pos_mult_opt'] = (-3);
        } else {
          if (((s as any).money_vars ?? 0)?.['pos_mult_opt'] === 2) {
            if (!(s as any).money_vars) (s as any).money_vars = {}; (s as any).money_vars['pos_mult_opt'] = (-1);
          } else {
            if (((s as any).money_vars ?? 0)?.['pos_mult_opt'] === 3) {
              if (!(s as any).money_vars) (s as any).money_vars = {}; (s as any).money_vars['pos_mult_opt'] = 2;
            } else {
      ...
      if (((s as any).money_vars ?? 0)?.['neg_mult_opt'] === -1) {
        if (!(s as any).money_vars) (s as any).money_vars = {}; (s as any).money_vars['neg_mult_opt'] = 99;
      } else {
        if (((s as any).money_vars ?? 0)?.['neg_mult_opt'] === 1) {
          if (!(s as any).money_vars) (s as any).money_vars = {}; (s as any).money_vars['neg_mult_opt'] = (-3);
        } else {
          if (((s as any).money_vars ?? 0)?.['neg_mult_opt'] === 2) {
            if (!(s as any).money_vars) (s as any).money_vars = {}; (s as any).money_vars['neg_mult_opt'] = (-1);
          } else {
            if (((s as any).money_vars ?? 0)?.['neg_mult_opt'] === 3) {
              if (!(s as any).money_vars) (s as any).money_vars = {}; (s as any).money_vars['neg_mult_opt'] = 2;
            } else {
      ...
      if (((s as any).cheatVars ?? 0)?.['pos_mood_opt'] === -1) {
        if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['pos_mood_opt'] = 99;
      } else {
        if (((s as any).cheatVars ?? 0)?.['pos_mood_opt'] === 1) {
      ...
      if (((s as any).cheatVars ?? 0)?.['neg_mood_opt'] === -1) {
        if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['neg_mood_opt'] = 99;
      } else {
        if (((s as any).cheatVars ?? 0)?.['neg_mood_opt'] === 1) {
      ...
      if (((s as any).cheatVars ?? 0)?.['wp_cost_opt'] === -1) {
        if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['wp_cost_opt'] = 99;
      } else {
        if (((s as any).cheatVars ?? 0)?.['wp_cost_opt'] === 1) {
      ...
      if (((s as any).cheatVars ?? 0)?.['preg_chance'] === -1) {
        if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['preg_chance'] = 99;
      } else {
        if (((s as any).cheatVars ?? 0)?.['preg_chance'] === 1) {
      ...
      if (((s as any).cheatVars ?? 0)?.['preg_speed'] === -1) {
        if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['preg_speed'] = 99;
      } else {
        if (((s as any).cheatVars ?? 0)?.['preg_speed'] === 1) {
          if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['preg_speed'] = (-3);
        } else {
          if (((s as any).cheatVars ?? 0)?.['preg_speed'] === 2) {
            if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['preg_speed'] = (-2);
          } else {
      ...
      if (((s as any).difficulty ?? 0) !== 0) {
        if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['skill_gain'] = ((s as any).difficulty ?? 0);
      }
    }
    if (((s as any).temp_saveupdater_guard ?? 0)?.['progressbar_migrated'] === 0) {
      if (!(s as any).temp_saveupdater_guard) (s as any).temp_saveupdater_guard = {}; (s as any).temp_saveupdater_guard['progressbar_migrated'] = 1;
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90900) {
    ...
    if (((s as any).succubus ?? 0)?.['succubusQW'] === 4) {
      if (!(s as any).succubus) (s as any).succubus = {}; (s as any).succubus['succubusQW'] = 11;
    }
    if (((s as any).succubus ?? 0)?.['succubusQW'] === 5) {
      if (!(s as any).succubus) (s as any).succubus = {}; (s as any).succubus['succubusQW'] = 14;
    }
    ...
    if (((s as any).temp_saveupdater_guard ?? 0)?.['pornstudio_booking_data_fix'] === 0) {
      if (!(s as any).temp_saveupdater_guard) (s as any).temp_saveupdater_guard = {}; (s as any).temp_saveupdater_guard['pornstudio_booking_data_fix'] = 1;
    ...
    if (((s as any).strpos ?? 0)(((s as any).clothingworntype ?? 0), '_bikinis') > 0  ||  ((s as any).strpos ?? 0)(((s as any).clothingworntype ?? 0), '_swimsuit')) {
      (s as any).PCloSwim = 1;
    }
    ...
    if (((s as any).temp_saveupdater_guard ?? 0)?.['sd_defaults_set'] === 0) {
      if (!(s as any).temp_saveupdater_guard) (s as any).temp_saveupdater_guard = {}; (s as any).temp_saveupdater_guard['sd_defaults_set'] = 1;
      if (((s as any).ETOmenu ?? 0) === 1) {
        ...
        if (((s as any).enable_scalepic ?? 0) === 1) {
          if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['render_mode'] = 1;
        }
      }
      if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['render_mode_status'] = ((s as any).stat_cfg ?? 0)?.['render_mode'];
      if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['render_mode_attrs'] = ((s as any).stat_cfg ?? 0)?.['render_mode'];
      if (((s as any).stat_cfg ?? 0)?.['skills_mode'] === 1) {
        if (((s as any).stat_cfg ?? 0)?.['render_mode_skills'] === 1) {
          if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['skills_mode'] = 2;
        } else {
          if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['skills_mode'] = 1;
        }
      }
      if (((s as any).stat_cfg ?? 0)?.['relations_mode'] === 1) {
        if (((s as any).stat_cfg ?? 0)?.['render_mode_relations'] === 1) {
          if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['relations_mode'] = 2;
        } else {
          if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['relations_mode'] = 1;
        }
      }
      if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['name_side_status'] = ((s as any).progressbar_name_side ?? 0);
      if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['name_side_attrs'] = ((s as any).progressbar_name_side ?? 0);
      if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['name_side_skills'] = ((s as any).progressbar_name_side ?? 0);
      if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['name_side_relations'] = ((s as any).progressbar_name_side ?? 0);
      if (((s as any).stat_nums ?? 0)?.['enable_concise'] === 1) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['newline_texts'] = 2;
      }
      if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['temp_scale'] = ((s as any).TempUnit ?? 0);
      if (((s as any).disable_LoadSave ?? 0) === 2) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['loadsave_mode'] = 1;
      }
      ...
      if (((s as any).stat_cfg ?? 0)?.['show_sec_headers'] === 1  &&  ((s as any).stat_cfg ?? 0)?.['sec_headers'] === 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['sec_headers'] = 1;
      }
      if (((s as any).cheatStatusBars ?? 0) !== 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['bar_size'] = ((s as any).cheatStatusBars ?? 0);
        // TODO-QSP: killvar 'cheatStatusBars'
      }
      if (((s as any).progressbar_bar_width ?? 0) !== 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['bar_width'] = ((s as any).progressbar_bar_width ?? 0);
        // TODO-QSP: killvar 'progressbar_bar_width'
      }
      if (((s as any).stat_disp_overlay ?? 0) !== 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['overlay'] = ((s as any).stat_disp_overlay ?? 0);
        // TODO-QSP: killvar 'stat_disp_overlay'
      }
      if (((s as any).Enable_statfsize ?? 0) !== 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['font_size'] = ((s as any).Enable_statfsize ?? 0);
        // TODO-QSP: killvar 'Enable_statfsize'
      }
      if (((s as any).Enable_Android ?? 0) !== 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['android'] = ((s as any).Enable_Android ?? 0);
        // TODO-QSP: killvar 'Enable_Android'
      }
      if (((s as any).default_status_icons ?? 0) !== 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['icon_height'] = ((s as any).set_siconht ?? 0);
        // TODO-QSP: killvar 'default_status_icons'
        // TODO-QSP: killvar 'set_siconht'
      }
      if (((s as any).default_menu_icons ?? 0) !== 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['menu_icon_height'] = ((s as any).set_miconht ?? 0);
        // TODO-QSP: killvar 'default_menu_icons'
        // TODO-QSP: killvar 'set_miconht'
      }
      if (((s as any).default_wbanner ?? 0) !== 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['weather_height'] = ((s as any).set_weatherht ?? 0);
        // TODO-QSP: killvar 'default_wbanner'
        // TODO-QSP: killvar 'set_weatherht'
      }
      if (((s as any).timeHidden ?? 0) !== 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['time_hidden'] = ((s as any).timeHidden ?? 0);
      ...
      if (((s as any).stat_imgh ?? 0) > 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['image_size'] = 2;
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['image_size_px'] = ((s as any).stat_imgh ?? 0);
      } else {
        if (((s as any).set_statimgw ?? 0) > 0  &&  ((s as any).set_statimgw ?? 0) !== 220) {
          if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['image_size'] = 3;
          if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['image_size_px'] = ((s as any).set_statimgw ?? 0);
        }
      }
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Weather'] = 'weather';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Time'] = 'time';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Main Menu'] = 'menu_bar';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Money'] = 'money';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Icons'] = 'icons';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Status'] = 'status';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Important Texts'] = 'important_texts';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Attributes'] = 'attributes';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Skills'] = 'skills';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Relationships'] = 'relations';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Images'] = 'images';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Normal Texts'] = 'normal_texts';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Status Texts'] = 'texts';
      if (!(s as any).stat_vars) (s as any).stat_vars = {}; (s as any).stat_vars['Save / Load Buttons'] = 'loadsave';
      (s as any).temp_i = 0;
    ...
    if (((s as any).temp_saveupdater_guard ?? 0)?.['msg_sep_migrated'] === 0) {
      if (!(s as any).temp_saveupdater_guard) (s as any).temp_saveupdater_guard = {}; (s as any).temp_saveupdater_guard['msg_sep_migrated'] = 1;
      if (((s as any).stat_cfg ?? 0)?.['newline_important_texts'] !== 0  ||  ((s as any).stat_cfg ?? 0)?.['newline_normal_texts'] !== 0) {
        if (((s as any).stat_cfg ?? 0)?.['newline_texts'] === 0) {
          if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['newline_texts'] = ((((s as any).stat_cfg ?? 0)?.['newline_normal_texts'] !== 0) ? (((s as any).stat_cfg ?? 0)?.['newline_normal_texts']) : (((s as any).stat_cfg ?? 0)?.['newline_important_texts']));
        }
      }
      if (((s as any).stat_cfg ?? 0)?.['msg_separator'] === 1) {
        if (((s as any).stat_cfg ?? 0)?.['newline_important_texts'] === 0) {
          if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['newline_important_texts'] = 2;
        }
        if (((s as any).stat_cfg ?? 0)?.['newline_normal_texts']    === 0) {
          if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['newline_normal_texts'] = 2;
        }
      }
    }
    if (((s as any).temp_saveupdater_guard ?? 0)?.['alerts_section_added'] === 0) {
      if (!(s as any).temp_saveupdater_guard) (s as any).temp_saveupdater_guard = {}; (s as any).temp_saveupdater_guard['alerts_section_added'] = 1;
    ...
    if (((s as any).temp_saveupdater_guard ?? 0)?.['texts_section_migrated'] === 0) {
      if (!(s as any).temp_saveupdater_guard) (s as any).temp_saveupdater_guard = {}; (s as any).temp_saveupdater_guard['texts_section_migrated'] = 1;
      if (((s as any).stat_cfg ?? 0)?.['newline_texts'] === 0  &&  ((s as any).stat_cfg ?? 0)?.['newline_normal_texts'] !== 0) {
        if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['newline_texts'] = ((s as any).stat_cfg ?? 0)?.['newline_normal_texts'];
      }
      (s as any).sd_su_max = 0;
      (s as any).sd_su_i = 0;
    ...
    if (((s as any).temp_saveupdater_guard ?? 0)?.['traits_and_archetypes_migrated'] === 0) {
      ...
      if (((s as any).trait_vars ?? 0)?.['cumeater'] === 0) {
        ...
        if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['cumeater_exp'] = ((s as any).temp_su_cumeater_known ?? 0);
      }
      ...
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['alko_today'] = ((s as any).pcs_traits ?? 0)?.['alko_day'];
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['academic'] = ((s as any).pcs_traits ?? 0)?.['nerd_status'];
      if (((s as any).trait_vars ?? 0)?.['academic'] === 1) {
        if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['academic_exp'] = 250;
      } else {
        if (((s as any).trait_vars ?? 0)?.['academic'] === 2) {
          if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['academic_exp'] = 350;
        } else {
      ...
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['academic_started'] = ((s as any).pcs_traits ?? 0)?.['nerd_point_gain_start'];
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['academic_lessons'] = ((s as any).pcs_traits ?? 0)?.['nerd_lessons'];
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['nerd_learn_home'] = ((s as any).pcs_traits ?? 0)?.['nerd_lernHome'];
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['bookworm_exp'] = ((s as any).pcs_nerd ?? 0);
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['bookworm'] = ((((s as any).trait_vars ?? 0)?.['bookworm_exp'] >= 5) ? (1) : (0));
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['doormat_exp'] = ((s as any).hypnoOutcast ?? 0);
      if (((s as any).pcs_traits ?? 0)?.['fitness_freak'] === 1) {
        if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['fitness_freak'] = 1;
        if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['fitness_freak_exp'] = 60;
      }
    ...
    if (((s as any).chrmng ?? 0) + ((s as any).meantrt ?? 0)  !== 0) {
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['charming'] = ((s as any).chrmng ?? 0) - ((s as any).meantrt ?? 0);
      // TODO-QSP: killvar 'chrmng'
      // TODO-QSP: killvar 'meantrt'
    }
    if (((s as any).flexible ?? 0)      !== 0) {
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['flexible'] = ((s as any).flexible ?? 0);
      // TODO-QSP: killvar 'flexible'
    }
    if (((s as any).logictrt ?? 0)      !== 0) {
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['logical'] = ((s as any).logictrt ?? 0);
      // TODO-QSP: killvar 'logictrt'
    }
    if (((s as any).nat_athlete ?? 0)    !== 0) {
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['nat_athlete'] = ((s as any).nat_athlete ?? 0);
      // TODO-QSP: killvar 'nat_athlete'
    }
    if (((s as any).nat_dancer ?? 0)    !== 0) {
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['nat_dancer'] = ((s as any).nat_dancer ?? 0);
      // TODO-QSP: killvar 'nat_dancer'
    }
    if (((s as any).schlrly ?? 0)      !== 0) {
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['scholarly'] = ((s as any).schlrly ?? 0);
    ...
    if (((s as any).temp_saveupdater_guard ?? 0)?.['general_var_migrated'] === 0) {
      if (!(s as any).temp_saveupdater_guard) (s as any).temp_saveupdater_guard = {}; (s as any).temp_saveupdater_guard['general_var_migrated'] = 1;
      qspCall(s, 'array', 'remove_element', 'cheatVars', 'full_morning_rout');
      if (!(s as any).arousalVars) (s as any).arousalVars = {}; (s as any).arousalVars['pcs_vag_backup'] = ((s as any).sucvagorg ?? 0);
      if (!(s as any).arousalVars) (s as any).arousalVars = {}; (s as any).arousalVars['pcs_ass_backup'] = ((s as any).sucanusorg ?? 0);
      if (!(s as any).arousalVars) (s as any).arousalVars = {}; (s as any).arousalVars['pcs_throat_backup'] = ((s as any).sucthroorg ?? 0);
      ...
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['disable_autosave'] = ((s as any).disable_autosave ?? 0);
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['use_popups'] = ((s as any).usePopUps ?? 0);
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['imgw'] = ((s as any).imgw ?? 0);
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['imgh'] = ((s as any).imgh ?? 0);
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['tablemap'] = ((s as any).Enable_tablemap ?? 0);
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['debug'] = ((s as any).loadg_show_debug ?? 0);
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['faceturn'] = ((s as any).Enable_faceturn ?? 0);
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['themetype'] = ((s as any).themetype ?? 0);
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['theme_main_name'] = ((s as any).theme_main_name ?? 0);
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['pay_opt'] = ((s as any).money_vars ?? 0)?.['pay_opt'];
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['pay_opt_backup'] = ((s as any).money_vars ?? 0)?.['pay_opt_backup'];
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['income_opt'] = ((s as any).money_vars ?? 0)?.['income_opt'];
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['allow_overdraft'] = ((s as any).money_vars ?? 0)?.['allow_overdraft'];
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['pos_mult_opt'] = ((s as any).money_vars ?? 0)?.['pos_mult_opt'];
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['pos_mult'] = ((s as any).money_vars ?? 0)?.['pos_mult'];
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['neg_mult_opt'] = ((s as any).money_vars ?? 0)?.['neg_mult_opt'];
      if (!(s as any).cfg_vars) (s as any).cfg_vars = {}; (s as any).cfg_vars['neg_mult'] = ((s as any).money_vars ?? 0)?.['neg_mult'];
      if (((s as any).trait_vars ?? 0)?.['fertility_from_bc'] === 1) {
        if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['fertility_bc_conditioning'] = 50;
      }
      qspCall(s, 'array', 'remove_element', 'trait_vars', 'fertility_from_bc');
      qspCall(s, 'array', 'remove_element', 'trait_vars', 'fertility_exp');
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['body_hair_attitude_exp'] = ((s as any).trait_vars ?? 0)?.['body_hair_exp'];
      ...
      if ((Array.isArray((s as any).events_list) ? ((s as any).events_list as any[]).indexOf('job_pav_tour_guide') : -1) >= 0) {
        if (!(s as any).event_recur) (s as any).event_recur = {}; (s as any).event_recur['job_pav_tour_guide'] = 'yearly-0601-0831';
      }
    }
    if (((s as any).temp_saveupdater_guard ?? 0)?.['intro_templates_migrated'] === 0) {
      if (!(s as any).temp_saveupdater_guard) (s as any).temp_saveupdater_guard = {}; (s as any).temp_saveupdater_guard['intro_templates_migrated'] = 1;
    ...
    if (((s as any).pav_swimpool ?? 0)?.['lifeguard_job'] > 0  &&  ((s as any).job_status ?? 0)?.['pav_pool_lifeguard'] !== 'employed') {
      ...
      if (!(s as any).job_last_work_day) (s as any).job_last_work_day = {}; (s as any).job_last_work_day['pav_pool_lifeguard'] = ((s as any).pav_swimpool ?? 0)?.['lifeguard_last_workday'];
      ...
      if (((s as any).pav_swimpool ?? 0)?.['lifeguard_applied'] > 0  &&  ((s as any).pav_swimpool ?? 0)?.['lifeguard_applied'] < 3  &&  ((s as any).job_hiring_step ?? 0)?.['pav_pool_lifeguard'] === 0) {
        if (!(s as any).job_hiring_step) (s as any).job_hiring_step = {}; (s as any).job_hiring_step['pav_pool_lifeguard'] = ((s as any).pav_swimpool ?? 0)?.['lifeguard_applied'];
      }
    }
    ...
    if (((s as any).teacher ?? 0)?.['job'] >= 3  &&  ((s as any).job_status ?? 0)?.['pav_voc_school_teacher'] !== 'employed') {
      ...
      if (((s as any).teacher ?? 0)?.['job'] === 2  &&  ((s as any).job_status ?? 0)?.['pav_voc_school_teacher'] !== 'employed') {
        ...
        if (!(s as any).teacher) (s as any).teacher = {}; (s as any).teacher['on_notice'] = 1;
      } else {
        if (((s as any).teacher ?? 0)?.['job'] === 1  &&  ((s as any).job_status ?? 0)?.['pav_voc_school_teacher'] === '') {
          if (!(s as any).job_status) (s as any).job_status = {}; (s as any).job_status['pav_voc_school_teacher'] = 'fired';
        }
      }
    }
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['city_salon_masseuse_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['city_salon_masseuse_v4'] = 1;
      if (((s as any).masseuse ?? 0)?.['jobtype'] !== 0  &&  ((s as any).job_status ?? 0)?.['city_salon_masseuse'] === '') {
        if (((s as any).masseuse ?? 0)?.['jobtype'] > 0) {
          ...
          if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['salon_state'] = '';
          if (((s as any).masseuse ?? 0)?.['hired_day'] === 0) {
            if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hired_day'] = ((s as any).daystart ?? 0) - 7;
          }
          if (((s as any).masseuse ?? 0)?.['jobtype'] === 2) {
            ...
            if (((s as any).masseuse ?? 0)?.['jobtype'] === 3) {
              if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hourly'] = 150;
            } else {
              if (((s as any).masseuse ?? 0)?.['jobtype'] === 4) {
                if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hourly'] = 175;
              } else {
                if (((s as any).masseuse ?? 0)?.['jobtype'] === 5) {
                  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hourly'] = 250;
                } else {
                  if (((s as any).masseuse ?? 0)?.['jobtype'] === 6) {
                    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hourly'] = 150;
                  } else {
                    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hourly'] = 100;
                  }
                }
              }
            }
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['pav_leonid_slave_v4'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['pav_leonid_slave_v4'] = 1;
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['fixed_cal_tournament'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['fixed_cal_tournament'] = 1;
    ...
    if (((s as any).calendar_temp_new_flag ?? 0)?.['fixed_starlets_friday_anchor'] === 0) {
      if (!(s as any).calendar_temp_new_flag) (s as any).calendar_temp_new_flag = {}; (s as any).calendar_temp_new_flag['fixed_starlets_friday_anchor'] = 1;
    ...
    if (((s as any).slutty ?? 0) !== 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['prostitution_count'] = ((s as any).slutty ?? 0);
      // TODO-QSP: killvar'slutty'
    }
    if (((s as any).hidden_slutty ?? 0) !== 0) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['hidden_prostitution_count'] = ((s as any).hidden_slutty ?? 0);
    ...
    if (((s as any).postamountrand ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['load'] = ((s as any).postamountrand ?? 0);
      // TODO-QSP: killvar 'postamountrand'
    }
    if (((s as any).posteventcounter ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['round'] = ((s as any).posteventcounter ?? 0);
      // TODO-QSP: killvar 'posteventcounter'
    }
    if (((s as any).posteventQW1 ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['qw_1'] = ((s as any).posteventQW1 ?? 0);
      // TODO-QSP: killvar 'posteventQW1'
    }
    if (((s as any).posteventQW3 ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['qw_3'] = ((s as any).posteventQW3 ?? 0);
      // TODO-QSP: killvar 'posteventQW3'
    }
    if (((s as any).posteventQW2 ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['qw_2'] = ((s as any).posteventQW2 ?? 0);
      // TODO-QSP: killvar 'posteventQW2'
    }
    if (((s as any).posteventQW4 ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['qw_4'] = ((s as any).posteventQW4 ?? 0);
      // TODO-QSP: killvar 'posteventQW4'
    }
    if (((s as any).posteventQW5 ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['qw_5'] = ((s as any).posteventQW5 ?? 0);
      // TODO-QSP: killvar 'posteventQW5'
    }
    if (((s as any).poststreets ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['danger'] = ((s as any).poststreets ?? 0);
      // TODO-QSP: killvar 'poststreets'
    }
    if (((s as any).postbandQW ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['bandit'] = ((s as any).postbandQW ?? 0);
      // TODO-QSP: killvar 'postbandQW'
    }
    if (((s as any).postexhibi ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['exhib'] = ((s as any).postexhibi ?? 0);
      // TODO-QSP: killvar 'postexhibi'
    }
    if (((s as any).posthj ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['hj'] = ((s as any).posthj ?? 0);
      // TODO-QSP: killvar 'posthj'
    }
    if (((s as any).postbj ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['bj'] = ((s as any).postbj ?? 0);
      // TODO-QSP: killvar 'postbj'
    }
    if (((s as any).postlate ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['late'] = ((s as any).postlate ?? 0);
      // TODO-QSP: killvar 'postlate'
    }
    if (((s as any).postburn ?? 0) !== 0) {
      if (!(s as any).post_vars) (s as any).post_vars = {}; (s as any).post_vars['burn'] = ((s as any).postburn ?? 0);
      // TODO-QSP: killvar 'postburn'
    }
    if (((s as any).succubus ?? 0)?.['succubusQW'] === 3) {
      if (!(s as any).succubus) (s as any).succubus = {}; (s as any).succubus['succubusQW'] = 12;
    }
    if (((s as any).succubus ?? 0)?.['succubusQW'] === 4) {
      if (!(s as any).succubus) (s as any).succubus = {}; (s as any).succubus['succubusQW'] = 11;
    }
    ...
    if (((s as any).temp_saveupdater_guard ?? 0)?.['show_0.9.9.0_features'] === 0) {
      if (!(s as any).temp_saveupdater_guard) (s as any).temp_saveupdater_guard = {}; (s as any).temp_saveupdater_guard['show_0.9.9.0_features'] = 1;
      (s as any).update_report_last = 97;
      (s as any).update_report_new = 99;
    }
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[0] = 'mental';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[1] = 'sport';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[2] = 'combat';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[3] = 'beauty';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[4] = 'artistic';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[5] = 'job';
    ...
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[0] = 'family';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[1] = 'coolkid';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[2] = 'jock';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[3] = 'nerd';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[4] = 'gopnik';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[5] = 'staff';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[6] = 'pavlovsk';
    if (!(s as any).temp_mig_g) (s as any).temp_mig_g = {}; (s as any).temp_mig_g[7] = 'city';
    (s as any).temp_mig_gi = 0;
  ...
  if (((s as any).temp_current_save_version ?? 0) < 90901) {
      ...
      if (((s as any).npc_usedname ?? 0)?.[String((s as any).su0991_npcID ?? 0)] !== '') {
        ...
        if (((s as any).npc_fidelity ?? 0)?.[String((s as any).su0991_npcID ?? 0)] === '') {
          if (((s as any).npc_fidelity ?? 0)?.[String((s as any).su0991_npcID ?? 0)] <= 4) {
            if (!(s as any).npc_fidelity_num) (s as any).npc_fidelity_num = {}; (s as any).npc_fidelity_num[String((s as any).su0991_npcID ?? 0)] = ((s as any).npc_fidelity ?? 0)?.[String((s as any).su0991_npcID ?? 0)];
          ...
          if (!(s as any).npc_fidelity_num) (s as any).npc_fidelity_num = {}; (s as any).npc_fidelity_num[String((s as any).su0991_npcID ?? 0)] = ((s as any).npc_fidelity ?? 0)?.[String((s as any).su0991_npcID ?? 0)];
          if (!(s as any).npc_fidelity) (s as any).npc_fidelity = {}; (s as any).npc_fidelity[String((s as any).su0991_npcID ?? 0)] = 0;
        } else {
    ...
    if (((s as any).stat ?? 0)?.['last_sex_day_strap'] > ((s as any).stat ?? 0)?.['last_sex_day_vaginal']) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_sex_day_vaginal'] = ((s as any).stat ?? 0)?.['last_sex_day_strap'];
    }
    if (((s as any).stat ?? 0)?.['last_sex_day_strap'] > ((s as any).stat ?? 0)?.['last_sex_day']) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_sex_day'] = ((s as any).stat ?? 0)?.['last_sex_day_strap'];
    }
    qspCall(s, 'array', 'remove_element', 'stat', 'last_sex_day_strap');
    if (((s as any).stat ?? 0)?.['last_rape_day'] > ((s as any).stat ?? 0)?.['last_sex_day_rape']) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_sex_day_rape'] = ((s as any).stat ?? 0)?.['last_rape_day'];
    }
    if (((s as any).stat ?? 0)?.['last_rape_day'] > ((s as any).stat ?? 0)?.['last_sex_day_rape_known']) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_sex_day_rape_known'] = ((s as any).stat ?? 0)?.['last_rape_day'];
    }
    if (((s as any).stat ?? 0)?.['last_rape_day'] > ((s as any).stat ?? 0)?.['last_sex_day']) {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_sex_day'] = ((s as any).stat ?? 0)?.['last_rape_day'];
    }

...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_camVars ?? 0)?.['anal_available']) {
    ...
    if (((s as any).temp_camVars ?? 0)?.['anal_vibe_available']) {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSetVibrAct(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
  ...
  scene.actions([
    ...
    if (((s as any).pcs_ass ?? 0) < 10) {
      ...
      if (((s as any).pcs_horny ?? 0) < 100) {
        ...
        (s as any).orgasm_txt = 'Mere seconds later, you\'re unable to resist the urge any longer and eagerly rub your clit while you fuck yourself with your brush, moaning loudly into the microphone when you orgasm. Who knew using a hair brush could be so much fun!?';
      ...
      if (((s as any).pcs_ass ?? 0) < 15) {
        ...
        if (((s as any).pcs_horny ?? 0) < 100) {
          ...
          (s as any).orgasm_txt = 'You were already quite horny, and the extra sensation of your anus being stretched by those sharpies puts you over the edge. You rub your clit without even really realizing it, and gasp in surprise when an orgasm suddenly hits you! ';
    ...
    if (((s as any).pcs_ass ?? 0) < 10) {
      ...
      if (((s as any).pcs_horny ?? 0) < 100) {
        ...
        (s as any).orgasm_txt = 'You\'re carried away so much by the sudden sensations, you\'re almost forgetting that there\'s a camera pointed at you! Your free hand quickly finds its way to your clit and rubs it eagerly, making you orgasm in front of your ' + ((s as any).camGirl ?? 0)?.['MFC_Viewers'] + ' viewers.';
        (s as any).orgasm_or = 'custom';
      }
    } else {
      if (((s as any).pcs_ass ?? 0) < 15) {

...
function enterCardGameDurakPlay(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).cgdp_pc_state = undefined;
  (s as any).cgdp_A11_state = undefined;
  (s as any).cgdp_A10_state = undefined;
  (s as any).cgdp_A9_state = undefined;
  if (((s as any).cgd_clothes ?? 0) === '') {
    ...
    if (((s as any).cgd_clothes ?? 0)?.['A11'] === ''  ||  ((s as any).cgd_clothes ?? 0)?.['A10'] === ''  ||  ((s as any).cgd_clothes ?? 0)?.['A9'] === '') {
      ...
      (s as any).temp_alko = undefined;
      (s as any).temp_durak_trying = undefined;
      ...
      if (((s as any).temp_durak_result ?? 0) <= ((s as any).temp_durak_win_chance ?? 0)) {
        ...
        if (((String((((s as any).cgd_clothes ?? 0)?.[String((s as any).cgd_name_npc ?? 0)] ?? 0)).indexOf(String('socks'))) + 1) > 0) {
          (s as any).clo_str = ' socks';
          ((s as any).cgd_clothes = (s as any).cgd_clothes ?? {})[String((s as any).cgd_name_npc ?? 0)] = (String((((s as any).cgd_clothes ?? 0)?.[String((s as any).cgd_name_npc ?? 0)] ?? 0)).split(' socks,').join(''));
        } else {
          if (((String((((s as any).cgd_clothes ?? 0)?.[String((s as any).cgd_name_npc ?? 0)] ?? 0)).indexOf(String(','))) + 1) > 0) {
            (s as any).clo_str = (String((((s as any).cgd_clothes ?? 0)?.[String((s as any).cgd_name_npc ?? 0)] ?? 0)).slice((1)-1, ((1)-1)+(((String(qspUntranslated(s, "$\u00000\u0000", { location: "cardgame_durak" })).indexOf(String(','))) + 1) - 1)));
            ((s as any).cgd_clothes = (s as any).cgd_clothes ?? {})[String((s as any).cgd_name_npc ?? 0)] = (String((((s as any).cgd_clothes ?? 0)?.[String((s as any).cgd_name_npc ?? 0)] ?? 0)).split('' + ((s as any).clo_str ?? 0) + ',').join(''));
          } else {
            (s as any).clo_str = (((s as any).cgd_clothes ?? 0)?.[String((s as any).cgd_name_npc ?? 0)] ?? 0);
            ((s as any).cgd_clothes = (s as any).cgd_clothes ?? {})[String((s as any).cgd_name_npc ?? 0)] = '';
          }
        }
      ...
      (s as any).temp_durak_win_chance = undefined;
      (s as any).temp_durak_not_lose_chance = undefined;
      (s as any).temp_durak_result = undefined;
    ...
    qspGoto(st, 'cardgame_durak', 'card_game_durak_play', '1');
        ...
        (s as any).temp_will_difficulty = undefined;
        scene.actions([
          { label: 'Deal and take it easy', goto: ['cardgame_durak', 'card_game_durak_play', '-1'] },
...
function enterCardGameNosex(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).boy ?? 0) === 'A11') {
    ...
    scene.text('' + qspFunc(s, 'gopsex', 'hide', 'Shulga_var_name') + ` ponders for a second, and says: "${((s as any).card_game_texta ?? '')}"`);
    ...
    scene.text('' + qspFunc(s, 'gopsex', 'hide', 'Shulga_var_name') + ` thinks long and hard, and carefully suggests: "${((s as any).pcs_nickname ?? '')}, how about you perform a little dance for us? You know… shake your boobs, show off your body a little?"`);
  ...
  (s as any).temp_rand = undefined;
  (s as any).card_game_texta = undefined;
  scene.actions([
...
function enterCardGameNosexDance(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  scene.text(`<center><video autoplay loop ${((s as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom/card/gif/dance` + (Math.floor(Math.random() * 9) + 1) + '.mp4"></video></center>');
...
function enterCardGameGroupSex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'hj', (-2), (((st as any).npcID ?? 0)?.[1] ?? 0), 'gangbang');
    qspCall(st, 'arousal', 'hj', (-2), (((st as any).npcID ?? 0)?.[2] ?? 0), 'gangbang');
    qspCall(st, 'arousal', 'vaginal_finger', (-6), (((st as any).npcID ?? 0)?.[3] ?? 0), ' gangbang');
    qspCall(st, 'stat', '');
    ...
    if (((st as any).pcs_horny ?? 0) >= 70) {
      ...
      qspCall(st, 'arousal', 'vaginal_finger', 6, (((st as any).npcID ?? 0)?.[3] ?? 0), 'gangbang', 'exhibitionism');
    ...
    qspCall(st, 'arousal', 'bj', (-5), (((st as any).npcID ?? 0)?.[3] ?? 0), 'gangbang');
    qspCall(st, 'stat', '');
    ...
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(st, 'arousal', 'hj', 5, (((st as any).npcID ?? 0)?.[1] ?? 0), 'gangbang');
    qspCall(st, 'arousal', 'vaginal', (-5), (((st as any).npcID ?? 0)?.[2] ?? 0), 'gangbang');
    ...
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(st, 'arousal', 'vaginal', 5, (((st as any).npcID ?? 0)?.[2] ?? 0), 'gangbang');
    qspCall(st, 'arousal', 'bj', (-5), (((st as any).npcID ?? 0)?.[3] ?? 0), 'deepthroat');
    qspCall(st, 'stat', '');
    ...
    qspCall(st, 'cum_call', 'face', (((st as any).boy ?? 0)?.[2] ?? 0), 1, '', '', 30);
    qspCall(st, 'cum_call', 'hair', (((st as any).boy ?? 0)?.[2] ?? 0), 1, '', '', 10);
    qspCall(st, 'cum_call', 'face', (((st as any).boy ?? 0)?.[1] ?? 0), 1, '', '', 10);
    qspCall(st, 'cum_call', 'hair', (((st as any).boy ?? 0)?.[1] ?? 0), 1, '', '', 30);
    qspCall(st, 'cum_call', 'face', (((st as any).boy ?? 0)?.[3] ?? 0), 1, '', '', 30);
    qspCall(st, 'cum_call', 'breasts', (((st as any).boy ?? 0)?.[3] ?? 0), 1, '', '', 10);
...
function enterCardGameRoughSex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`<center><video autoplay loop ${((s as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom/card/sexrough/bj` + (Math.floor(Math.random() * 10) + 1) + '.mp4"></video></center>');
  ...
  scene.actions([
    ...
    qspCall(st, 'stat', '');
    scene.text(`<center><video autoplay loop ${((st as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom/card/sexrough/sex1_` + (Math.floor(Math.random() * 10) + 1) + '.mp4"></video></center>');
    ...
    qspCall(st, 'npcStat', '$boy', 'c');
    if (((st as any).boy ?? 0) === 'A9') {
      qspCall(st, 'npcStat', 'A10', 'a');
    } else {
      qspCall(st, 'npcStat', 'A9', 'a');
    }
    ...
    if (((st as any).boy ?? 0) === 'A11') {
      qspCall(st, 'npcStat', 'A10', 'b');
    } else {
      qspCall(st, 'npcStat', 'A11', 'b');
    }
    ...
    scene.text(`<center><video autoplay loop ${((st as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom/card/sexrough/sex2_` + (Math.floor(Math.random() * 10) + 1) + '.mp4"></video></center>');
    ...
    qspCall(st, 'arousal', 'end');
    scene.text(`<center><img ${((st as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom/card/sexrough/ass` + (Math.floor(Math.random() * 9) + 1) + '.jpg"></center>');
...
function enterCardGameWonExposeGirl(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`<center><video autoplay loop ${((st as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom/card/street_event/j` + (Math.floor(Math.random() * 12) + 1) + '.mp4"></video></center>');
...
function enterCardGameWonExposePenis(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text('A few minutes later, he returns to you. His face is all red from the running, and he\'s still out of breath when he says: "There… happy? She looked like she wanted to kill me!"');
    scene.text('You grin, and show him the video you shot with your mobile phone:');
    scene.text(`<center><video autoplay loop ${((st as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom/card/street_event/p` + (Math.floor(Math.random() * 3) + 1) + '.mp4"></video></center>');
    scene.text(`"Why is the camera shaking so much!? This looks like shit!" ${((st as any).loss_npc_name ?? '')} asks, clearly frustrated now.`);
    scene.text('His friends are also nearly out of breath, but it\'s from laughing so hard. Finally, one of them manages to say: "I\'m sorry, man! It just looked hilarious! None of us could hold our cameras still, we were laughing so hard!"');
    scene.actions([
      { label: 'Finish', goto: ['vasilyhome', 'livingroom'] },
...
function enterCardGameWonCumOnGirl(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`<center><video autoplay loop ${((st as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom/card/street_event/bj` + (Math.floor(Math.random() * 2) + 1) + '.mp4"></video></center>');
    scene.text(`When you lick ${((st as any).loss_npc_name ?? '')} close to his orgasm, he runs to his victim.`);
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    qspCall(st, 'stat', '');
    scene.text(`<center><video autoplay loop ${((st as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom/card/street_event/cum` + (Math.floor(Math.random() * 2) + 1) + '.mp4"></video></center>');
...
function enterCardGameWonLickMyPussy(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`<center><img ${((st as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom/card/sex/lick` + (Math.floor(Math.random() * 6) + 1) + '.jpg"></center>');

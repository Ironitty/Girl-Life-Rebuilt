...
function enterAfterAnal(s: GameState, scene: SceneBuilder): void {
  if (((s as any).analPlugOut ?? 0) === 1) {
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 'boy') {
      // TODO-QSP: dynamic text: <<$ARGS[2]>> takes your butt plug and he puts it back into your anus. He grins: ...
      scene.text(`${((s as any).locArgs?.[2] ?? 0)} takes your butt plug and he puts it back into your anus. He grins: "Continue your training"`);
    } else {
      if (((s as any).locArgs?.[1] ?? 0) === 'girl') {
        // TODO-QSP: dynamic text: <<$ARGS[2]>> takes your butt plug and she puts it back into your anus. She grins...
        scene.text(`${((s as any).locArgs?.[2] ?? 0)} takes your butt plug and she puts it back into your anus. She grins: "Continue your training"`);
      } else {
        if (((s as any).locArgs?.[1] ?? 0) === 'pc') {
          ...
          if (((s as any).locArgs?.[1] ?? 0) === 'no_plug'  ||  ((s as any).pain ?? 0)?.['asshole'] > 10) {
            (s as any).analPlugIn = 0;
...
function enterAnalsex(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff'] >= (Math.floor(Math.random() * 11) + 25)) {
    ...
    scene.text(`You cry and bite your lip when the ${((s as any).penis_desc ?? 0)} begins to thrust in and out of your ass. Your anus feels like it is going to tear apart and all you want is for this torture to be over quickly.`);
  } else {
    if (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff'] < (Math.floor(Math.random() * 11) + 15)) {
      ...
      scene.text(`You savor ${((s as any).xyr ?? 0)} cock moving inside you, lightly moaning in rhythm.`);
    }
  }
  ...
  if (((s as any).sexcontra ?? 0) === 4) {
    ...
    scene.text(`Pulling out of you and looking at ${((s as any).xyr ?? 0)} dick, ${((s as any).boydesc ?? 0)} said "Hmm, the condom burst."`);
  }
  ...
  if (((s as any).protect ?? 0) !== 1) {
    if ((Math.floor(Math.random() * 2) + 0) === 0  ||  ((s as any).pose ?? 0) === 3) {
      ...
      if ((!((s as any).cumvag_text ?? 0))) {
        ...
        scene.text(`${((s as any).xyrc13 ?? 0)} movements speed up and ${((s as any).xe13 ?? 0)} drives ${((s as any).xyr13 ?? 0)} cock balls deep into you. With a beatific smile, ${((s as any).xe13 ?? 0)} cums deep inside you. You feel a warm jet pour into your womb.`);
      }
      if (((s as any).cumvag_text ?? 0) === 1) {
        // TODO-QSP: dynamic text: <<$xec13>> does not pull out and instead pulls you tightly against <<$xem13>> an...
        scene.text(`${((s as any).xec13 ?? 0)} does not pull out and instead pulls you tightly against ${((s as any).xem13 ?? 0)} and your pussy is filled with splashes of semen.`);
      }
      if (((s as any).cumvag_text ?? 0) === 2) {
        // TODO-QSP: dynamic text: <<$xec13>> groans, and you feel a jet of sperm hit you inside your body.
        scene.text(`${((s as any).xec13 ?? 0)} groans, and you feel a jet of sperm hit you inside your body.`);
      }
      ...
      if ((!((s as any).pose ?? 0))) {
        ...
        scene.text(`${((s as any).npcdesc13 ?? 0)} groans and after pulling out ${((s as any).xyr13 ?? 0)} dick, ${((s as any).xe13 ?? 0)} came on your stomach.`);
        qspCall(s, 'cum_call', 'stomach', ((s as any).npcID13 ?? 0), 1);
      } else {
        if (((s as any).pose ?? 0) === 1) {
          // TODO-QSP: dynamic text: <<$npcdesc13>> groans and after pulling out <<$xyr13>> dick, <<$xe13>> came on y...
          scene.text(`${((s as any).npcdesc13 ?? 0)} groans and after pulling out ${((s as any).xyr13 ?? 0)} dick, ${((s as any).xe13 ?? 0)} came on your ass.`);
    ...
    scene.text(`${((s as any).npcdesc13 ?? 0)} groans and you realized that ${((s as any).xe13 ?? 0)} ejaculated in the ${((s as any).tmp ?? 0)}condom.`);
    if (((s as any).sexcontra ?? 0) === 4) {
      // TODO-QSP: dynamic text: Pulling out of you and looking at <<$xyr13>> dick, <<$boydesc13>> said "Hmm, the...
      scene.text(`Pulling out of you and looking at ${((s as any).xyr13 ?? 0)} dick, ${((s as any).boydesc13 ?? 0)} said "Hmm, the condom burst."`);
    } else {
      if (((s as any).sexcontra ?? 0) === 5) {
        // TODO-QSP: dynamic text: Pulling out of you and looking at <<$xyr13>> dick, <<$boydesc13>> said "Fuck! Th...
        scene.text(`Pulling out of you and looking at ${((s as any).xyr13 ?? 0)} dick, ${((s as any).boydesc13 ?? 0)} said "Fuck! The condom is missing."`);
      }
    }
...
function enterBjRandom(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat ?? 0)?.['bj'] <= 10) {
    ...
    scene.text(`Hesitantly bringing your face to ${((s as any).boydesc ?? 0)}'s crotch, you lightly press your ${((s as any).pc_desc ?? 0)?.['lips']} lips against ${((s as any).xyr ?? 0)} dick, tasting the slight saltiness.`);
    ...
    if (((s as any).stat ?? 0)?.['bj'] <= 25) {
      ...
      scene.text(`You lightly put ${((s as any).boydesc ?? 0)}'s cock into your mouth, rolling your tongue around the head as you rhythmically stroke the shaft.`);
      ...
      if (((s as any).stat ?? 0)?.['bj'] <= 40) {
        // TODO-QSP: dynamic text: You wrap your <<$pc_desc['lips']>> lips around the <<$penis_desc>> in front of y...
        scene.text(`You wrap your ${((s as any).pc_desc ?? 0)?.['lips']} lips around the ${((s as any).penis_desc ?? 0)} in front of you. You give ${((s as any).boydesc ?? 0)} a moment to adjust to the warmthness with more than half his cock resting in your mouth`);
        // TODO-QSP: dynamic text: Then you greedily lean forwards, taking <<$xyr>> dick deeper in your mouth and s...
        scene.text(`Then you greedily lean forwards, taking ${((s as any).xyr ?? 0)} dick deeper in your mouth and start to bob your head back and forth along ${((s as any).xyr ?? 0)} ${((s as any).penis_desc ?? 0)}`);
      } else {
        if (((s as any).stat ?? 0)?.['bj'] <= 60) {
          ...
          scene.text(`You lock eyes with ${((s as any).boydesc ?? 0)} and relax your throat as you swallow ${((s as any).xyr ?? 0)} ${((s as any).penis_desc ?? 0)} in one move like the veteran cocksucker you are, milking ${((s as any).xyr ?? 0)} cock with just your throat.`);
        }
      }
    }
  }

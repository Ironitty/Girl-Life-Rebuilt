...
function enterVariant(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).npcdesc ?? 0)} looks at you and waits for you to say something.`);
  ...
  if (((s as any).npc_vaginal_count ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  ((s as any).npc_gentle ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).npc_pervert ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).mc_inventory ?? 0)?.['strapon'] > 0) {
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Fuck him with your strapon [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
...
function enterMinet(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You wrap your lips around ${((s as any).npcdesc ?? 0)} 's dick.`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    scene.actions([
      { label: 'Remove his cock before he cums [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
    ]);
  } else {
    ...
    if (((s as any).npc_gentle ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      scene.text(`You remove his dick from your mouth and finish off ${((s as any).npcdesc ?? 0)} with your hand.`);
    } else {
      if (((s as any).npc_rough ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
        ...
        if (((s as any).tiprand ?? 0) < 3) {
          ...
          scene.text(`You take his dick out of your mouth and point it right at your face. You are now covered with ${((s as any).npcdesc ?? 0)}'s warm and sticky cum.`);
        }
      } else {
        (s as any).spafinloc = 11;
        qspCall(s, 'cum_manage', '');
        ...
        scene.text(`${((s as any).npcdesc ?? 0)} holds you by your hair. He takes his dick out of your mouth and cums on your face, covering it with warm and sticky cum.`);
      }
    }
    scene.actions([
  ...
  scene.actions([
    ...
    scene.text(`A hot jet of sperm hits you in the mouth. You start to swallow his cum while ${((s as any).npcdesc ?? 0)} continues to cum in your mouth. Finally, the flow of hot liquid with a pungent taste stops.`);
    scene.actions([
      { label: 'Leave', goto: ['sexm', 'endsex'] },
    ]);
  } },
...
function enterStrapon(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You go to the drawer and put on your strapon. ${((s as any).npcdesc ?? 0)} gets ready on all fours on the bed.`);
...
function enterAnal(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).analPlugIn ?? 0) === 1) {
    ...
    if (((s as any).pcs_ass ?? 0) + ((s as any).analPlugInbonus ?? 0) < ((s as any).dick ?? 0)) {
      ...
      scene.text(`You scream and bite your lip from the sharp pain you suddenly feel when his ${((s as any).dick_desc ?? 0)} penis rips apart your ass when it enters.`);
    } else {
      if (((s as any).pcs_ass ?? 0) + ((s as any).analPlugInbonus ?? 0) >= ((s as any).dick ?? 0)) {
        // TODO-QSP: dynamic text: You groan slightly when you feel his <<$dick_desc>> dick enter your ass.
        scene.text(`You groan slightly when you feel his ${((s as any).dick_desc ?? 0)} dick enter your ass.`);
      }
    }
    // TODO-QSP: dynamic text: Finally, <<$npcdesc>> grabs your tight ass and starts slamming inside you fierce...
    scene.text(`Finally, ${((s as any).npcdesc ?? 0)} grabs your tight ass and starts slamming inside you fiercely. With one final thrust, he finishes balls deep inside you.`);
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} puts you on your stomach on the bed and begins to massage your buttocks and your anus with his fingers. First one, then two.`);
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} pulls his fingers out of your buttocks, and you feel his hard cock resting on your ass.`);
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} stops for a moment to give your ass some time to adapt to the big dick inside. Then he starts moving again with a lot more force than before.`);
    if (((s as any).pcs_ass ?? 0) + ((s as any).lubonus ?? 0) + 2 < ((s as any).dick_length ?? 0)) {
      ...
      scene.text(`You cry and bite into the pillow when his ${((s as any).dick_desc ?? 0)} cock begins to fuck your ass in full force.`);
    } else {
      if (((s as any).pcs_ass ?? 0) + ((s as any).lubonus ?? 0) + 2 >= ((s as any).dick_length ?? 0)) {
    ...
    scene.text(`Finally, ${((s as any).npcdesc ?? 0)} grabs your tight ass and starts slamming inside you with all his might. With one final thrust, he finishes balls deep inside you.`);
    ...
    if (((s as any).klismaday ?? 0) !== ((s as any).daystart ?? 0)) {
      ...
      scene.text(`${((s as any).npcdesc ?? 0)} takes his dick out of your ass and sees some traces of excrement. He says, "Baby, I did not come here to watch Charlie and the Chocolate Factory. You should use an enema before we start."`);
    } else {
      if (((s as any).klismaday ?? 0) === ((s as any).daystart ?? 0)) {
        qspCall(s, 'npc_relationship', 'modify', ((s as any).npcID ?? 0), Math.floor(Math.random() * 2) + 2);
        (s as any).spafinloc = 3;
        ...
        scene.text(`${((s as any).npcdesc ?? 0)} takes his dick out of you and gives you a kiss. You get up and use the bathroom.`);
      }
    }
...
function enterMiss(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).npcdesc ?? 0)} spreads your legs and begins to fondle your pussy with his fingers. Once he is satisfied that you are ready, he takes you vigorously.`);
...
function enterStartPod(s: GameState, scene: SceneBuilder): void {
  if ((!(Math.floor(Math.random() * 2) + 0))) {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} whispers to you, "Take it in your mouth."`);
    qspCall(s, 'willpower', 'bj', 'resist', 'medium');
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Fuck off! [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} begins to strip off your clothes.`);
...
function enterBlow(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Remove from mouth [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
...
function enterPopala(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_gentle ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    if (((s as any).npc_pervert ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
      ...
      if (((s as any).npc_gentle ?? 0)?.[String((s as any).npcID1 ?? 0)] === 1) {
        ...
        if (((s as any).npc_rough ?? 0)?.[String((s as any).npcID1 ?? 0)] === 0) {
          ...
          scene.text(`"Well, I see you are not only for me, so perhaps I'll go, but if you want, I can stay and comfort you " says ${((s as any).npcdesc1 ?? 0)}.`);
          scene.actions([
    ...
    if (((s as any).popolaini ?? 0) === 3) {
      ...
      scene.text(`"You really only love me?" asks ${((s as any).npcdesc ?? 0)}.`);
      // TODO-QSP: dynamic text: "Yes, I will do everything with you I did with him, but it will be with love, an...
      scene.text(`"Yes, I will do everything with you I did with him, but it will be with love, and you will understand the difference," you reply. You are amazed he believes this nonsense. ${((s as any).npcdesc ?? 0)} comes up to you, and you unbutton his pants to reveal his dick.`);
      if (((s as any).npc_gentle ?? 0)?.[String((s as any).npcID1 ?? 0)] === 1) {
        ...
        if (((s as any).npc_rough ?? 0)?.[String((s as any).npcID1 ?? 0)] === 0) {
          ...
          scene.text(`${((s as any).npcdesc1 ?? 0)} stands by you and watches as you fuck your husband. "Wow, you seem to really enjoy sex with your husband. This really can't compare to what we did. Well maybe you can use your mouth, and I can still be useful," he says.`);
    ...
    scene.text(`"Mmm ${((s as any).pcs_nickname ?? 0)}, I have never seen you so enthusiastic when we were together. Maybe we should try some other positions," proposes ${((s as any).npcdesc1 ?? 0)}, and your husband agreed.`);
    ...
    if (((s as any).popolaini ?? 0) === 1) {
      ...
      if (((s as any).popolaini ?? 0) === 2) {
        ...
        if (((s as any).popolaini ?? 0) === 3) {
          ...
          scene.text(`"That's right, her mouth is great, but her ass is even better. You fuck her ass, and I'll fuck her mouth. With her ass, she can show you if she really loves you or not," says ${((s as any).npcdesc1 ?? 0)}, explicitly directed at your husband.`);
    ...
    scene.text(`"If you remove your dick from her ass now, then she can really show you how much she loves you," proposes ${((s as any).npcdesc1 ?? 0)}, and your husband agreed.`);
    ...
    if (((s as any).npc_rough ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      if (((s as any).npc_pervert ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
        ...
        scene.text(`${((s as any).npcdesc ?? 0)} looks at you. "Here… you… whore… cock… and pussy… and ass… and in your mouth," he says putting a strong emphasis on every word. At the end of the last word, he kicks you in the face, rendering you unconscious. You wake up two hours later. Your husband is gone and so is all of his stuff. Some of your stuff is missing too.`);
        qspCall(s, 'lover_love', 'divorce');
        qspCall(s, 'lover', 'remove_boyfriend', ((s as any).npcID1 ?? 0));
        scene.actions([
          { label: 'Leave', goto: ['homes_properties', 'go_straight_home'] },
        ...
        if (((s as any).npc_gentle ?? 0)?.[String((s as any).npcID1 ?? 0)] === 1) {
          ...
          scene.text(`${((s as any).npcdesc1 ?? 0)} tries to protest, but after seeing your husband's face contorted with rage, he agrees`);
        } else {
          if (((s as any).npc_rough ?? 0)?.[String((s as any).npcID1 ?? 0)] === 0) {
            // TODO-QSP: dynamic text: <<$npcdesc1>> silently complies with your husband's request.
            scene.text(`${((s as any).npcdesc1 ?? 0)} silently complies with your husband's request.`);
          } else {
            // TODO-QSP: dynamic text: <<$npcdesc1>> gladly accepts
            scene.text(`${((s as any).npcdesc1 ?? 0)} gladly accepts`);
          }
        }
        scene.actions([
          { label: 'Continue', handler: (st: GameState) => {
    if (((s as any).popolaini ?? 0) === 1) {
      ...
      scene.text(`"What the hell is going on here? " says ${((s as any).npcdesc ?? 0)} while looking at you.`);
      // TODO-QSP: dynamic text: "<<$npcdesc>> it's not what you think. It's just sex, no feelings, I only love y...
      scene.text(`"${((s as any).npcdesc ?? 0)} it's not what you think. It's just sex, no feelings, I only love you. He does not mean anything. Come to me, I'll show you how much I love you," you answer him. You know you are caught red-handed, so you make up some excuse on the spot, but you don't really think he will believe this.`);
      qspCall(s, 'lover_love', 'divorce');
      if (((s as any).npc_pervert ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
        ...
        if (((s as any).npc_gentle ?? 0)?.[String((s as any).npcID1 ?? 0)] === 1) {
          ...
          if (((s as any).npc_rough ?? 0)?.[String((s as any).npcID1 ?? 0)] === 0) {
            ...
            scene.text(`"Well, I see I am not the only one for you, so perhaps I'll go, but if you want, I can stay and comfort you" says ${((s as any).npcdesc1 ?? 0)}.`);
            scene.actions([
              { label: 'Let him go', goto: ['homes_properties', 'go_straight_home'] },
              { label: 'Let him stay', handler: (st: GameState) => {
    qspCall(s, 'npc_relationship', 'modify', ((s as any).npcID ?? 0), Math.floor(Math.random() * 2) + 0);
    ...
    if (((s as any).popolaini ?? 0) === 3) {
      (s as any).picrand = 84;
        ...
        scene.text(`"Can you even hear yourself while you are talking nonsense?" asks ${((s as any).npcdesc ?? 0)}.`);
        ...
        scene.text(`${((s as any).npcdesc ?? 0)} comes up to you. "I'll leave today and will file for divorce, but first, I will punish you," he says while unzipping his pants and pulling out his penis. "Well, what are you waiting for? Suck, whore!"`);
        if (((s as any).npc_gentle ?? 0)?.[String((s as any).npcID1 ?? 0)] === 1) {
          scene.actions([
            { label: 'Take by mouth', handler: (st: GameState) => {
    (s as any).spafinloc = 12;
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} does not pay any attention to him. He puts his dick in your mouth and grabs your head. He literally starts to fuck you in the mouth with each thrust pushing it deeper. You frantically gasp, trying to breathe, desperately trying not to choke as he continues. Suddenly, he makes an abrupt movement, and his cock pops into your throat. You try to pull away, but he sternly tells you to take it. He gives you a couple of seconds to get used to the dick in your throat and begins to thrust. You are still not getting enough air, and you frantically begin to beat him to get free, but this only makes ${((s as any).npcdesc ?? 0)} tighten his grip on your head. When you're starting to lose consciousness, he finally finishes. You feel his sperm go down your throat. After a couple of strong aftershocks, he lets you go. You collapse on the floor, coughing up sperm mixed with your saliva and wheezing air. ${((s as any).npcdesc ?? 0)} looks at you as you writhe on the floor. He spits on the floor next to you and leaves the room.`);
    ...
    qspCall(s, 'arousal', 'end');
          ...
          if (((s as any).npc_rough ?? 0)?.[String((s as any).npcID1 ?? 0)] === 0) {
            ...
            scene.text(`${((s as any).npcdesc1 ?? 0)} stands and watches as you get fucked by your husband. "Well, I should probably go," he says.`);
            // TODO-QSP: dynamic text: "Wait! This whore can handle two cocks. You can join us if you want," offers <<$...
            scene.text(`"Wait! This whore can handle two cocks. You can join us if you want," offers ${((s as any).npcdesc ?? 0)}.`);
            // TODO-QSP: dynamic text: "Thanks for the offer, I do believe she will be able to handle me," replies <<$n...
            scene.text(`"Thanks for the offer, I do believe she will be able to handle me," replies ${((s as any).npcdesc1 ?? 0)}.`);
            scene.actions([
    ...
    scene.text(`"I could not agree more," replies ${((s as any).npcdesc1 ?? 0)}.`);
      ...
      if (((s as any).popolaini ?? 0) === 2) {
        ...
        if (((s as any).popolaini ?? 0) === 3) {
          (s as any).picrand = 42;
            ...
            scene.text(`"That's right, this whore should be punished. If you want to let me help, we can do it together, and she will not be able to sit down for a week," says ${((s as any).npcdesc1 ?? 0)}, explicitly riling up your husband.`);
            // TODO-QSP: dynamic text: "Yes, let's punish the bitch, and then I can go to the authorities to initiate m...
            scene.text(`"Yes, let's punish the bitch, and then I can go to the authorities to initiate my divorce and remove this whore from my life," says ${((s as any).npcdesc ?? 0)}.`);
            scene.actions([
              { label: 'Lie on the bed', handler: (st: GameState) => {
    scene.img('images/characters/city/husband/sex/p2.jpg');
    // TODO-QSP: dynamic text: You lie down on the bed, and <<$npcdesc>> enters your anus while <<$npcdesc1>> l...
    scene.text(`You lie down on the bed, and ${((s as any).npcdesc ?? 0)} enters your anus while ${((s as any).npcdesc1 ?? 0)} lies before you, presenting his cock to your mouth. You diligently work your husband's cock in your ass while not forgetting your lover's cock in your mouth.`);
    // TODO-QSP: dynamic text: "Wow, even now she knows how to work that ass," says <<$npcdesc>>.
    scene.text(`"Wow, even now she knows how to work that ass," says ${((s as any).npcdesc ?? 0)}.`);
    // TODO-QSP: dynamic text: "Yeah, please leave some for me," replies <<$npcdesc1>>.
    scene.text(`"Yeah, please leave some for me," replies ${((s as any).npcdesc1 ?? 0)}.`);

...
function enterCikl(s: GameState, scene: SceneBuilder): void {
  if (((s as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((s as any).week ?? 0) === 7  &&  ((s as any).soniaQW ?? 0)?.['slut'] === 0  &&  ((s as any).month ?? 0) > 9  &&  ((s as any).daystart ?? 0) >= ((s as any).soniaQW ?? 0)?.['fallday'] + 6) {
    if (((s as any).soniaQW ?? 0)?.['soniafall'] < 7) {
      ((s as any).soniaQW = (s as any).soniaQW ?? {})['fallday'] = ((s as any).daystart ?? 0) -1;
      ((s as any).soniaQW = (s as any).soniaQW ?? {})['soniafall'] = ((s as any).soniaQW['soniafall'] ?? 0) + (1);
    } else {
      ((s as any).soniaQW = (s as any).soniaQW ?? {})['slut'] = 1;
      ((s as any).soniaQW = (s as any).soniaQW ?? {})['fallenangel'] = 1;
      ...
      ((s as any).npcGoSchool = (s as any).npcGoSchool ?? {})['A25'] = '<a href="#" onclick="window.__gameStore.getState().doGoto(\u0027gschool_outcast_chats\u0027, \u0027\u0027 + $lcase($npc_usedname[\u0027A25\u0027]) + \u0027\u0027); return false;">' + (((s as any).npc_usedname ?? 0)?.['A25']) + '</a>';
    }
  }
  scene.build();
}
...
function enterStart(s: GameState, scene: SceneBuilder): void {
  if (((s as any).daystart ?? 0) >= ((s as any).soniaQW ?? 0)?.['fallday'] + 6) {
    ...
    if (((s as any).soniaQW ?? 0)?.['soniafall'] <= 0) {
      qspGoto(s, 'soniadisco', 'disco0');
    } else {
      qspGoto(s, 'soniadisco', 'disco');
    }
  } else {
    qspGoto(s, 'soniadisco', 'disco0');
  }
...
function enterDisco0(s: GameState, scene: SceneBuilder): void {
  if (((s as any).soniaQW ?? 0)?.['soniafall'] === 0) {
    ((s as any).soniaQW = (s as any).soniaQW ?? {})['soniafall'] = 1;
  }
...
function enterJoinThem(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).soniarushout ?? 0) === 1) {
    (s as any).soniarushout = undefined;
...
function enterSoniadrinkmore(s: GameState, scene: SceneBuilder): void {
  ((s as any).soniaQW = (s as any).soniaQW ?? {})['soniafall'] = ((s as any).soniaQW['soniafall'] ?? 0) + (1);
  ((s as any).soniaQW = (s as any).soniaQW ?? {})['encourage'] = ((s as any).soniaQW['encourage'] ?? 0) + (1);
  qspCall(s, 'npc_relationship', 'modify', 'A9', 'like');
  qspCall(s, 'npc_relationship', 'modify', 'A10', 'like');
  qspCall(s, 'npc_relationship', 'modify', 'A11', 'like');
  qspCall(s, 'npc_relationship', 'modify', 'A24', 'like');
...
function enterPeerpressure(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).soniaQW ?? 0)?.['soniafall'] <= 2) {
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNotpressured(s, scene); (s as any).locArgs = __savedLocArgs; }
  } else {
    if (((s as any).soniaQW ?? 0)?.['soniafall'] === 3) {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPressuredforpanties(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      if (((s as any).soniaQW ?? 0)?.['soniafall'] === 4) {
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPressuredfortits(s, scene); (s as any).locArgs = __savedLocArgs; }
      } else {
        if (((s as any).soniaQW ?? 0)?.['soniafall'] === 5) {
          { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPressuredforpussy(s, scene); (s as any).locArgs = __savedLocArgs; }
        } else {
          if (((s as any).soniaQW ?? 0)?.['soniafall'] === 6) {
            { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPressuredforblowjob(s, scene); (s as any).locArgs = __savedLocArgs; }
          } else {
            { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterPressuredforgangbang(s, scene); (s as any).locArgs = __savedLocArgs; }
          }
        }
      }
    }
...
function enterNotpressured(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).soniadisco_peerpressuretrigger = undefined;
  scene.actions([
...
function enterPressuredforpanties(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_hotcat ?? 0) < 6  ||  ((s as any).grupTipe ?? 0) === 4) {
    ...
    (st as any).soniadisco_peerpressuretrigger = undefined;
    scene.actions([
      { label: 'Go back to the disco', goto: ['soniadisco', 'dance', 'staytoend'] },
    ]);
  } },

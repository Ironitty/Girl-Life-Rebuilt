      ...
      if (((s as any).clothingworntype ?? 0) === 'nude'  &&  ((s as any).pantyworntype ?? 0) !== 'none') {
        ...
        if (((s as any).clothingworntype ?? 0) === 'nude'  &&  ((s as any).pantyworntype ?? 0) === 'none') {
          ...
          if (((s as any).clothingworntype ?? 0) === 'misc_outfits'  &&  ((s as any).clothingwornnumber ?? 0) === 1) {
            (s as any).result = qspFunc(s, '$clothing_image', '$clothingworntype', ((s as any).clothingwornnumber ?? 0));
            (s as any).body_image_msg = 'You are wearing a hessian sack the hunters gave you.';
          } else {
            (s as any).result = qspFunc(s, '$clothing_image', '$clothingworntype', ((s as any).clothingwornnumber ?? 0));
            (s as any).body_image_msg = 'You are wearing ' + qspFunc(s, '$short_description', '$clothingworntype', ((s as any).clothingwornnumber ?? 0));
...
function enterPanties(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pantyworntype ?? 0) === 'none') {
    ...
    (s as any).result = qspFunc(s, '$panty_image', '$pantyworntype', ((s as any).pantywornnumber ?? 0));
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterBra(s: GameState, scene: SceneBuilder): void {
  if (((s as any).braworntype ?? 0) === 'none') {
    ...
    (s as any).result = qspFunc(s, '$bra_image', '$braworntype', ((s as any).brawornnumber ?? 0));
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterBodysuit(s: GameState, scene: SceneBuilder): void {
  if (((s as any).braworntype ?? 0) === 'none') {
    ...
    (s as any).result = qspFunc(s, '$pcs_outfit_image', '$bodysuitworntype + \'_bodysuits', ((s as any).bodysuitwornnumber ?? 0));
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterShoes(s: GameState, scene: SceneBuilder): void {
  if (((s as any).shoeworntype ?? 0) === 'none') {
    ...
    (s as any).result = qspFunc(s, '$shoe_image', '$shoeworntype', ((s as any).shoewornnumber ?? 0));
  }
  // TODO-QSP: end
  scene.build();
}

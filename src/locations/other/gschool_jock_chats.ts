...
function enterLazar(s: GameState, scene: SceneBuilder): void {
  ...
  if ((Math.floor(Math.random() * 4) + 1) === 1  &&  ((s as any).npc_had_sex ?? 0)?.['A149']) {
    ...
    scene.text(qspFunc(s, 'npc_reactions', 'general', 'A149'));
  } else {
...
function enterSvyatoslav(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] > 225) {
    ...
    if (((s as any).npc_rel ?? 0)?.['A8'] >= 50) {
      ...
      scene.text(qspFunc(s, 'npc_reactions', 'general', 'A8'));
    } else {
...
function enterVanya(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_rel ?? 0)?.['A165'] >= 50  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 225) {
    ...
    scene.text(qspFunc(s, 'npc_reactions', 'general', 'A165'));
  } else {
  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] > 225) {
    ...
    if (((s as any).grupTipe ?? 0) === 1) {
      if (((s as any).npc_rel ?? 0)?.['A150'] >= 50) {
        ...
        scene.text(qspFunc(s, 'npc_reactions', 'general', 'A150'));
...
function enterChristina(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).NatbelQW ?? 0)?.['chrispaid'] === 2) {
    ...
    if (((s as any).christinaQW ?? 0)?.['subpath'] >= 2) {
      if (((s as any).christinaQW ?? 0)?.['subpath'] >= 3) {
        ...
        scene.text(qspFunc(s, 'npc_reactions', 'general', 'A18'));
  ...
  if (((s as any).mesec ?? 0) > 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterChristinaTampon(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
    scene.actions([
...
function enterAlbina(s: GameState, scene: SceneBuilder): void {
      ...
      if (((s as any).AlbinaQW ?? 0)?.['Friends'] === 1) {
        ...
        if (((s as any).fame ?? 0)?.['pav_slut'] >= 250) {
          if (((s as any).AlbinaQW ?? 0)?.['Friends'] === 2) {
            ...
            scene.text(qspFunc(s, 'npc_reactions', 'general', 'A23'));
  ...
  if (((s as any).mesec ?? 0) > 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterAlbinaTampon(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
    scene.actions([
...
function enterVeronika(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] > 225) {
    if (((s as any).npc_rel ?? 0)?.['A141'] >= 50) {
      ...
      scene.text(qspFunc(s, 'npc_reactions', 'general', 'A141'));
  ...
  if (((s as any).mesec ?? 0) > 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterVeronikaTampon(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
    scene.actions([
...
function enterLina(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] >= 225) {
    if (((s as any).npc_rel ?? 0)?.['A19'] >= 60) {
      ...
      scene.text(qspFunc(s, 'npc_reactions', 'general', 'A19'));
    } else {
    ...
    if (((s as any).grupTipe ?? 0) === 1) {
      ...
      if (((s as any).grupTipe ?? 0) === 2) {
        if (((s as any).npc_rel ?? 0)?.['A19'] >= 60) {
          ...
          scene.text('$OpenInnerThought + \'There she goes again, worshipping Christina!\' + $CloseInnerThought');
          scene.text(qspFunc(s, 'npc_reactions', 'general', 'A19'));
        } else {
          if (((s as any).npc_rel ?? 0)?.['A19'] <= 20) {
        ...
        if (((s as any).grupTipe ?? 0) === 3) {
          if (((s as any).npc_rel ?? 0)?.['A19'] >= 60) {
            ...
            scene.text('$OpenInnerThought + \'Yeah right. She probably wanted to make sure she\'s wearing something better than you!\' + $CloseInnerThought');
  ...
  if (((s as any).mesec ?? 0) > 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLinaTampon(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
    scene.actions([
...
function enterLariska(s: GameState, scene: SceneBuilder): void {
    ...
    if (((s as any).LariskaQW ?? 0)?.['story'] === 2) {
      ...
      if (((s as any).LariskaQW ?? 0)?.['story'] === 3) {
        ...
        if (((s as any).christinaQW ?? 0)?.['blackmail'] >= 2  ||  ((s as any).christinaQW ?? 0)?.['subpath'] >= 2  ||  ((s as any).christinaQW ?? 0)?.['fight'] === 1) {
          ...
          scene.text(qspFunc(s, 'npc_reactions', 'general', 'A13'));
        } else {
            ...
            if (((s as any).grupTipe ?? 0) === 4) {
              if (((s as any).npc_rel ?? 0)?.['A13'] >= 50) {
                ...
                if (((s as any).npc_rel ?? 0)?.['A13'] <= 20) {
                  ...
                  scene.text('$OpenInnerThought + \'Well that was rude, bitch!\' + $CloseInnerThought');
                } else {
                  scene.text('Lariska sees you walking towards her and stands up, looking nervous.');
                  scene.text('"Hey Lariska."');
  ...
  if (((s as any).mesec ?? 0) > 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLariskaTampon(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
    scene.actions([

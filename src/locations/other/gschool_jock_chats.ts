  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] > 225) {
    ...
    if (((s as any).grupTipe ?? 0) === 1) {
      if (((s as any).npc_rel ?? 0)?.['A8'] >= 50) {
        ...
        scene.text(`"Thanks ${((s as any).pcs_nickname ?? 0)}! I'll be sure to win this time!" he boastfully replies.`);
...
function enterVanya(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_rel ?? 0)?.['A165'] >= 50  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 225) {
    if (((s as any).grupTipe ?? 0) === 2) {
      ...
      scene.text(`Vanya is having a hard time stopping himself from laughing. "${((s as any).pcs_nickname ?? 0)}, did you hear about the prank I pulled on the football coach?"`);
      ...
      scene.text(`"${((s as any).pcs_nickname ?? 0)}! You need to help me hide!" Vanya says alarmingly as he looks around.`);
    ...
    if (((s as any).npc_rel ?? 0)?.['A165'] <= 20  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 225) {
      ...
      if (((s as any).mey_vika ?? 0)?.['mey_vika_qw'] >= 20) {
        ...
        if (((s as any).fame ?? 0)?.['pav_slut'] >= 225) {
          ...
          scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}! Check this out!" Vanya yells as he throws a crumbled paper ball at Vitek's head.`);
...
function enterErast(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] > 225) {
    if (((s as any).npc_rel ?? 0)?.['A150'] >= 50) {
      ...
      scene.text(`You approach Erast and tap his shoulder. "Oh… Hello ${((s as any).pcs_nickname ?? 0)}," he says gently.`);
      ...
      // TODO-QSP: dynamic text: "<<$pcs_nickname>>, I…" He starts saying something, but you can't hear the end o...
      scene.text(`"${((s as any).pcs_nickname ?? 0)}, I…" He starts saying something, but you can't hear the end of it.`);
    } else {
      if (((s as any).npc_rel ?? 0)?.['A150'] <= 20) {
        ...
        scene.text(`"Hi, ${((s as any).pcs_nickname ?? 0)}. Sorry, but I was about to leave and do some important things…" he mutters.`);
        ...
        scene.text(`You approach Erast and tap his shoulder. "Oh hi, ${((s as any).pcs_nickname ?? 0)}. Am I in your way?" he asks.`);
    ...
    if (((s as any).grupTipe ?? 0) === 1) {
      if (((s as any).npc_rel ?? 0)?.['A150'] >= 50) {
        ...
        scene.text(`You can see him blushing when he looks up and notices you. "Hello ${((s as any).pcs_nickname ?? 0)}, how are you doing today?"`);
        ...
        scene.text(`"You already look good ${((s as any).pcs_nickname ?? 0)}," he says politely, but his face turns red. Before you can react, he starts talking about aerobic and anaerobic techniques which he thinks would help you with your goal.`);
        ...
        if (((s as any).npc_rel ?? 0)?.['A150'] <= 20) {
          ...
          // TODO-QSP: dynamic text: "Oh.. Hello <<$pcs_nickname>>. Sorry, I didn't notice you were talking to me." H...
          scene.text(`"Oh.. Hello ${((s as any).pcs_nickname ?? 0)}. Sorry, I didn't notice you were talking to me." He glances at you before immediately staring at the screen again.`);
          ...
          scene.text(`"See you later, ${((s as any).pcs_nickname ?? 0)}," he says before putting his phone in his pocket and leaving.`);
        } else {
          scene.text('"I can\'t believe it!" you say when you approach Erast, who is watching something on his phone.');
          // TODO-QSP: dynamic text: "Whoa, what's wrong <<$pcs_nickname>>?" he asks. You can see by his expression t...
          scene.text(`"Whoa, what's wrong ${((s as any).pcs_nickname ?? 0)}?" he asks. You can see by his expression that he doesn't understand what your problem is.`);
      ...
      if (((s as any).grupTipe ?? 0) === 2) {
        if (((s as any).npc_rel ?? 0)?.['A150'] >= 50) {
          ...
          scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}…" Erast greets you with a smile when you approach him.`);
          ...
          scene.text(`"Gladly," he replies. "You know ${((s as any).pcs_nickname ?? 0)}, you should try to increase your training volume and decrease between-set rest intervals."`);
          ...
          if (((s as any).npc_rel ?? 0)?.['A150'] <= 20) {
            ...
            scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}, what's up?" Erast asks as you approach him.`);
            ...
            // TODO-QSP: dynamic text: "Oh, hello <<$pcs_nickname>>. Sorry I didn't notice you," he replies. "I'm tryin...
            scene.text(`"Oh, hello ${((s as any).pcs_nickname ?? 0)}. Sorry I didn't notice you," he replies. "I'm trying to improve my training plan and make it more varied," he says and shows you his notes.`);
            ...
            scene.text(`"Look, ${((s as any).pcs_nickname ?? 0)}, I still have to do some things before the next lesson. Talk to you later," he says and gives you a little wave while he's leaving.`);
        ...
        if (((s as any).grupTipe ?? 0) === 3) {
          if (((s as any).npc_rel ?? 0)?.['A150'] >= 50) {
            // TODO-QSP: dynamic text: "Hello <<$pcs_nickname>>," Erast politely greets when he notices you. "How've yo...
            scene.text(`"Hello ${((s as any).pcs_nickname ?? 0)}," Erast politely greets when he notices you. "How've you been doing?"`);
            ...
            if (((s as any).npc_rel ?? 0)?.['A150'] <= 20) {
              ...
              scene.text(`"Hello ${((s as any).pcs_nickname ?? 0)}… Is there anything I can help with?" Erast asks when he notices you approaching him.`);
              ...
              // TODO-QSP: dynamic text: "Okay <<$pcs_nickname>>, yeah, do that… Now if you'll excuse me…" he says polite...
              scene.text(`"Okay ${((s as any).pcs_nickname ?? 0)}, yeah, do that… Now if you'll excuse me…" he says politely but firmly and goes about his own business.`);
              ...
              // TODO-QSP: dynamic text: "Hello <<$pcs_nickname>>… What's up?" Erast asks when he notices you approaching...
              scene.text(`"Hello ${((s as any).pcs_nickname ?? 0)}… What's up?" Erast asks when he notices you approaching him.`);
              ...
              scene.text(`He looks surprised, but eventually starts to talk about his training routines. "You know ${((s as any).pcs_nickname ?? 0)}, it's very important to do something for your body every single day."`);
              ...
              scene.text(`Before the break is over, he grabs his things. "Alright ${((s as any).pcs_nickname ?? 0)}, I have a few things I need to do before the lesson. Thanks for the chat."`);
          ...
          if (((s as any).grupTipe ?? 0) === 4) {
            if (((s as any).npc_rel ?? 0)?.['A150'] >= 50) {
              ...
              if (((s as any).npc_rel ?? 0)?.['A150'] <= 20) {
                ...
                scene.text(`"What do you want ${((s as any).pcs_nickname ?? 0)}?" He doesn't seem amused.`);
                ...
                scene.text(`"Whatever ${((s as any).pcs_nickname ?? 0)}. Have your fun," He says before turning and leaving. You giggle at your victory before leaving to do something else until the bell rings.`);
              } else {
                // TODO-QSP: dynamic text: "Hi <<$pcs_nickname>>, what's up?" Erast asks when he notices you.
                scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}, what's up?" Erast asks when he notices you.`);
            ...
            if (((s as any).npc_rel ?? 0)?.['A150'] >= 50) {
              ...
              scene.text(`Erast politely greets you. "Hello ${((s as any).pcs_nickname ?? 0)}, what's up?"`);
              ...
              scene.text(`"See you later ${((s as any).pcs_nickname ?? 0)}," he replies before heading to the toilet. You grab your things and go to your classroom to wait for the bell.`);
            } else {
              if (((s as any).npc_rel ?? 0)?.['A150'] <= 20) {
                scene.text('"Hello Erast, how\'re you doing today?" you ask as you approach him.');
                // TODO-QSP: dynamic text: "Oh, hello <<$pcs_nickname>>… Sorry I don't want to be rude, but I was just abou...
                scene.text(`"Oh, hello ${((s as any).pcs_nickname ?? 0)}… Sorry I don't want to be rude, but I was just about to go to the toilet." You get the feeling he's just using this as an excuse and is trying to avoid talking to you.`);
                ...
                scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}, what's up?"`);
...
function enterChristina(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).NatbelQW ?? 0)?.['chrispaid'] === 2) {
    scene.actions([
      { label: 'Pay off Natasha\'s debt [+$func(\'money\', \'get_cost_string\', 500)]', handler: (st: GameState) => {
    if (qspFunc(s, 'money', 'can_afford', 500) === 0) {
      s.scene = { ...s.scene, mainText: String((s as any).noMoney || ''), curActs: [] };
    } else {
      qspCall(s, 'money', 'pay', 500);
      if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['chrispaid'] = 3;
      ...
      // TODO-QSP: dynamic text: You ignore her attitude. "Natasha owes you money, right? <<$func('money', 'strin...
    ...
    if (((s as any).christinaQW ?? 0)?.['subpath'] >= 2) {
      ...
      if (((s as any).christinaQW ?? 0)?.['blackmail'] === 1) {
        if (((s as any).LariskaQW ?? 0)?.['story'] === 3) {
          ...
          if (!(s as any).christinaQW) (s as any).christinaQW = {}; (s as any).christinaQW['blackmail'] = 2;
          ...
          // TODO-QSP: dynamic text: Surprised, she finally looks at you. "No, <<$pcs_nickname>>. She's mine, and I d...
          scene.text(`Surprised, she finally looks at you. "No, ${((s as any).pcs_nickname ?? 0)}. She's mine, and I don't want you filling her head with nonsense."`);
  ...
  if (((s as any).NatbelQW ?? 0)?.['chrispaid'] < 5  &&  ((s as any).NatbelQW ?? 0)?.['FriendLover'] === 3) {
    ...
    if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['chrispaid'] = 5;
  ...
  if (((s as any).mesec ?? 0) > 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
    ...
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"My… my period started and I don\'t have a pad. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'christina_tampon');
  } },
      ]);
    }
    scene.actions([
      { label: 'Ask for a tampon', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"My… my period started and I don\'t have a tampon. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'christina_tampon');
  } },
    ]);
  } else {
    if (((s as any).placebopart ?? 0) > 0  &&  ((s as any).lutH ?? 0) > 0  &&  ((s as any).knowpreg ?? 0) === 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
      if (((s as any).pantyworntype ?? 0) !== 'none') {
        scene.actions([
          { label: 'Ask for a pad', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"My period is starting soon and I don\'t have a pad. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'christina_tampon');
  } },
        ]);
      }
      scene.actions([
        { label: 'Ask for a tampon', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"My period is starting soon and I don\'t have a tampon. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'christina_tampon');
  } },
      ]);
    }
...
function enterAlbina(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).AlbinaQW ?? 0)?.['Friends'] === 2  &&  ((s as any).npc_had_sex ?? 0)?.['A23']  &&  ((s as any).albina_schoolsex ?? 0) !== ((s as any).daystart ?? 0)  &&  (Math.floor(Math.random() * 4) + 1) === 4) {
    ...
    if (((s as any).school_period ?? 0) === 3) {
      scene.actions([{ label: 'Continue', goto: ['albina_school_sex', 'break_fun_1'] }]);
    } else {
      scene.actions([{ label: 'Continue', goto: ['albina_school_sex', 'lunch_fun_1'] }]);
    }
  } else {
    ...
    if (((s as any).AlbinaQW ?? 0)?.['StarletsJoined'] > 0  &&  ((s as any).AlbinaQW ?? 0)?.['StarletsShutDown'] === 0) {
      if ((Math.floor(Math.random() * 2) + 1) === 1) {
        ...
        scene.text(`You approach Albina and she gives you a small smile. "Hey ${((s as any).pcs_nickname ?? 0)}, how are you enjoying the Starlets?"`);
        ...
        scene.text(`You approach Albina, who is lost in her thoughts. "Oh hey ${((s as any).pcs_nickname ?? 0)}…" she says glumly when she notices you.`);
      ...
      if (((s as any).AlbinaQW ?? 0)?.['Friends'] === 1) {
        ...
        if (((s as any).npc_had_sex ?? 0)?.['A23']) {
          ...
          scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}," Albina smiles at you. "I wanted to thank you again for what you did. I don't want to get into any mushy bullshit, but I just wanted to let you know I… <i>appreciated</i> it."`);
          scene.text('Her eyes drift down between your legs and she winks at you while giving her lips a subtle lick. "It meant a lot."');
        } else {
          // TODO-QSP: dynamic text: "Hey <<$pcs_nickname>>," Albina smiles at you. "I wanted to thank you again for ...
          scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}," Albina smiles at you. "I wanted to thank you again for what you did. I don't want to get into any mushy bullshit, but I just wanted to let you know I appreciated it. It meant a lot."`);
        }
        ...
        if (((s as any).fame ?? 0)?.['pav_slut'] >= 250) {
          ...
          if (((s as any).fame ?? 0)?.['pav_slut'] >= 150) {
            if (((s as any).AlbinaQW ?? 0)?.['Friends'] === 2) {
              ...
              scene.text(`"${((s as any).pcs_nickname ?? 0)}!" she hisses in a hushed tone. "There are some <i>nasty</i> fucking rumors going around about you! Everything from cock hungry slut to a straight up hooker!"`);
              ...
              scene.text(`"They don't sound like <i>just</i> rumors ${((s as any).pcs_nickname ?? 0)}…" She glares at you for a moment before sighing. "Look, I'm not trying to slut shame you or anything like that. I know I'm not one to talk. But seriously, be careful okay?"`);
              // TODO-QSP: $func('npc_reactions', 'general', 'A23')
            ...
            if (((s as any).fame ?? 0)?.['pav_slut'] >= 75) {
              if (((s as any).AlbinaQW ?? 0)?.['Friends'] === 2) {
                // TODO-QSP: dynamic text: "Hey <<$pcs_nickname>>, I've been hearing some weird rumors about you lately," s...
                scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}, I've been hearing some weird rumors about you lately," she says with a bemused look. "Everyone's saying you're 'easy' and suck dick in the boys bathroom! I don't know what's going on, but… be careful, okay?"`);
                scene.text('"They\'re just rumors, Albina," you try to reassure her.');
                // TODO-QSP: $func('npc_reactions', 'general', 'A23')
                ...
                if (((s as any).grupTipe ?? 0) === 1  ||  ((s as any).grupTipe ?? 0) === 2) {
                  ...
                  if (((s as any).grupTipe ?? 0) === 3) {
                    ...
                    if (((s as any).grupTipe ?? 0) === 4) {
                      ...
                      scene.text(`"What's up? You used to be cool ${((s as any).pcs_nickname ?? 0)}, but then you started hanging out with <i>them</i>."`);
                  ...
                  if (((s as any).grupTipe ?? 0) === 2) {
                    ...
                    if (((s as any).grupTipe ?? 0) === 3) {
                      if (((s as any).npc_rel ?? 0)?.['A23'] >= 70) {
                        ...
                        scene.text(`Before you can explain, she puts a finger against your lips and shushes you. "I don't play any of that dumb geeky shit, ${((s as any).pcs_nickname ?? 0)}. I only play fighting games like Tekken and Mortal Kombat."`);
                        scene.text('You nod and end up chatting about fighting games instead, comparing your favorite characters and moves.');
                        // TODO-QSP: $func('npc_reactions', 'general', 'A23')
                      } else {
                        if (((s as any).npc_rel ?? 0)?.['A23'] <= 20) {
                          // TODO-QSP: dynamic text: Albina rolls her eyes and crosses her arms. "This isn't your stop, <<$pcs_nickna...
                          scene.text(`Albina rolls her eyes and crosses her arms. "This isn't your stop, ${((s as any).pcs_nickname ?? 0)}. The train to Geeksville terminates over there."`);
  ...
  if (((s as any).mesec ?? 0) > 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
    if (((s as any).pantyworntype ?? 0) !== 'none') {
      scene.actions([
        { label: 'Ask for a pad', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Albina," you whisper. "My period just started and I don\'t have a pad. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'albina_tampon');
  } },
      ]);
    }
    scene.actions([
      { label: 'Ask for a tampon', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Albina," you whisper. "My period just started and I don\'t have a tampon. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'albina_tampon');
  } },
    ]);
  } else {
    if (((s as any).placebopart ?? 0) > 0  &&  ((s as any).lutH ?? 0) > 0  &&  ((s as any).knowpreg ?? 0) === 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
      if (((s as any).pantyworntype ?? 0) !== 'none') {
        scene.actions([
          { label: 'Ask for a pad', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Albina," you whisper. "My period is starting soon and I don\'t have a pad. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'albina_tampon');
  } },
        ]);
      }
      scene.actions([
        { label: 'Ask for a tampon', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Albina," you whisper. "My period is starting soon and I don\'t have a tampon. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'albina_tampon');
  } },
      ]);
    }
...
function enterAlbinaTampon(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp ?? 0)?.['tampon_ask'] === '"Albina," you whisper. "My period just started  &&  I don\'t have a tampon. Can I borrow one?"'  ||  ((s as any).temp ?? 0)?.['tampon_ask'] === '"Albina," you whisper. "My period is starting soon  &&  I don\'t have a tampon. Can I borrow one?"') {
    if (((s as any).AlbinaQW ?? 0)?.['Friends'] === 2  ||  ((s as any).npc_rel ?? 0)?.['A23'] >= 70) {
      // TODO-QSP: dynamic text: She gives you a sympathetic look. "Sorry <<$pcs_nickname>>, but I don't have any...
      scene.text(`She gives you a sympathetic look. "Sorry ${((s as any).pcs_nickname ?? 0)}, but I don't have any. I'm on birth control and don't get periods…"`);
...
function enterVeronika(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] > 225) {
    if (((s as any).npc_rel ?? 0)?.['A141'] >= 50) {
      ...
      if (((s as any).npc_rel ?? 0)?.['A141'] <= 20) {
        ...
        // TODO-QSP: dynamic text: "Hey <<$pcs_nickname>>…" she greets you indifferently. "As a matter of fact, I'm...
        scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}…" she greets you indifferently. "As a matter of fact, I'm busy now so if you'll excuse me…"`);
    ...
    if (((s as any).grupTipe ?? 0) === 1) {
      if (((s as any).npc_rel ?? 0)?.['A141'] >= 50) {
        ...
        if (((s as any).npc_rel ?? 0)?.['A141'] <= 20) {
          ...
          // TODO-QSP: dynamic text: She pretends she didn't hear you. After a while, when she realizes it's getting ...
          scene.text(`She pretends she didn't hear you. After a while, when she realizes it's getting awkward, she finally replies. "Oh, sorry ${((s as any).pcs_nickname ?? 0)}. I was lost in my thoughts and I didn't notice you…" she says rigidly.`);
          ...
          scene.text(`"Hello ${((s as any).pcs_nickname ?? 0)}, do you want something?" she asks in her cold voice when she sees you approaching.`);
      ...
      if (((s as any).grupTipe ?? 0) === 2) {
        if (((s as any).npc_rel ?? 0)?.['A141'] >= 50) {
          ...
          scene.text(`"Hello ${((s as any).pcs_nickname ?? 0)}, I was hoping we would talk today," Veronika says when she sees you.`);
          ...
          // TODO-QSP: dynamic text: "You too, <<$pcs_nickname>>?" She rolls her eyes, but smiles. She knows you're j...
          scene.text(`"You too, ${((s as any).pcs_nickname ?? 0)}?" She rolls her eyes, but smiles. She knows you're just joking, unlike many of the other students who regularly mock her with it.`);
          ...
          if (((s as any).npc_rel ?? 0)?.['A141'] <= 20) {
            ...
            // TODO-QSP: dynamic text: "Look, <<$pcs_nickname>>… I have to do something important, so if you don't mind...
            scene.text(`"Look, ${((s as any).pcs_nickname ?? 0)}… I have to do something important, so if you don't mind…" She doesn't even finish the sentence before she starts walking away.`);
            ...
            scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}, I'm trying to find some new moves and figures I could do on the ice," she says as she draws a skating figure in her notepad.`);
        ...
        if (((s as any).grupTipe ?? 0) === 3) {
          if (((s as any).npc_rel ?? 0)?.['A141'] >= 50) {
            ...
            scene.text(`"Hello ${((s as any).pcs_nickname ?? 0)}," Veronika greets you with a slight wave when she sees you approaching.`);
          ...
          if (((s as any).grupTipe ?? 0) === 4) {
            if (((s as any).npc_rel ?? 0)?.['A141'] >= 50) {
              ...
              scene.text(`"Hello ${((s as any).pcs_nickname ?? 0)}, I see you have nothing better to do so you came to talk to me?" she asks with a little smile.`);
              ...
              if (((s as any).npc_rel ?? 0)?.['A141'] <= 20) {
                ...
                scene.text(`She looks up and notices you. "What do you want, ${((s as any).pcs_firstname ?? 0)}?" she asks with a cold, almost freezing tone in her voice. "Shouldn't you be somewhere else? Like drinking in a stairway, smoking in the park or whatever it is you gopniks do these days?"`);
                ...
                scene.text(`She rolls her eyes, but you must admit that she takes your mockery quite well. However, she isn't amused at all. "You know ${((s as any).pcs_nickname ?? 0)}, I could insult you too. But that's what mirrors are for…" she says as she turns around and joins the other jocks.`);
                ...
                scene.text(`She listens to you for some time before finally speaking up. "Hey ${((s as any).pcs_nickname ?? 0)}, why do you tell me these things? We're barely on speaking terms anyway and what you're talking about is something I'm not interested in at all…" she says with a cold tone.`);
            ...
            if (((s as any).npc_rel ?? 0)?.['A141'] >= 50) {
              ...
              scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}…" Veronika greets you as you walk towards her. "Are you looking for me?"`);
              ...
              if (((s as any).npc_rel ?? 0)?.['A141'] <= 20) {
                ...
                scene.text(`"Oh… Hi ${((s as any).pcs_nickname ?? 0)}…" she replies indifferently.`);
  ...
  if (((s as any).mesec ?? 0) > 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
    if (((s as any).pantyworntype ?? 0) !== 'none') {
      scene.actions([
        { label: 'Ask for a pad', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Veronika," you whisper. "My period just started and I don\'t have a pad. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'veronika_tampon');
  } },
      ]);
    }
    scene.actions([
      { label: 'Ask for a tampon', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Veronika," you whisper. "My period just started and I don\'t have a tampon. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'veronika_tampon');
  } },
    ]);
  } else {
    if (((s as any).placebopart ?? 0) > 0  &&  ((s as any).lutH ?? 0) > 0  &&  ((s as any).knowpreg ?? 0) === 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
      if (((s as any).pantyworntype ?? 0) !== 'none') {
        scene.actions([
          { label: 'Ask for a pad', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Veronika," you whisper. "My period is starting soon and I don\'t have a pad. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'veronika_tampon');
  } },
        ]);
      }
      scene.actions([
        { label: 'Ask for a tampon', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Veronika," you whisper. "My period is starting soon and I don\'t have a tampon. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'veronika_tampon');
  } },
      ]);
    }
...
function enterLina(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] >= 225) {
    ...
    if (((s as any).grupTipe ?? 0) === 1) {
      if (((s as any).npc_rel ?? 0)?.['A19'] >= 60) {
        ...
        scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}," she greets you.`);
        ...
        if (((s as any).npc_rel ?? 0)?.['A19'] <= 20) {
          ...
          scene.text(`"Hey, ${((s as any).pcs_nickname ?? 0)}. Did you see the last track race?"`);
          ...
          if (((s as any).grupTipe ?? 0) === 4) {
            if (((s as any).npc_rel ?? 0)?.['A19'] >= 60) {
              if (((s as any).pcs_tattoos ?? 0)?.['total'] === 0) {
                ...
                scene.text(`"Why don't you have any tattoos, ${((s as any).pcs_nickname ?? 0)}?"`);
                ...
                scene.text(`"Hell no. Christina would beat my ass if I did. She says…" She goes on a tirade about Christina's views on tattoos and the people who get them when she remembers who she's talking to. "Err… sorry ${((s as any).pcs_nickname ?? 0)}."`);
  ...
  if (((s as any).mesec ?? 0) > 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
    if (((s as any).pantyworntype ?? 0) !== 'none') {
      scene.actions([
        { label: 'Ask for a pad', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Lina," you whisper. "My period just started and I don\'t have a pad. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'lina_tampon');
  } },
      ]);
    }
    scene.actions([
      { label: 'Ask for a tampon', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Lina," you whisper. "My period just started and I don\'t have a tampon. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'lina_tampon');
  } },
    ]);
  } else {
    if (((s as any).placebopart ?? 0) > 0  &&  ((s as any).lutH ?? 0) > 0  &&  ((s as any).knowpreg ?? 0) === 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
      if (((s as any).pantyworntype ?? 0) !== 'none') {
        scene.actions([
          { label: 'Ask for a pad', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Lina," you whisper. "My period is starting soon and I don\'t have a pad. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'lina_tampon');
  } },
        ]);
      }
      scene.actions([
        { label: 'Ask for a tampon', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Lina," you whisper. "My period is starting soon and I don\'t have a tampon. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'lina_tampon');
  } },
      ]);
    }
...
function enterLariska(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).LariskaQW ?? 0)?.['story'] >= 2) {
    if (((s as any).LariskaQW ?? 0)?.['story'] === 2) {
      if (((s as any).christinaQW ?? 0)?.['fight'] === 1) {
        ...
        // TODO-QSP: dynamic text: "I'm sorry, <<$pcs_nickname>>. If Christina finds out I was there instead of the...
        scene.text(`"I'm sorry, ${((s as any).pcs_nickname ?? 0)}. If Christina finds out I was there instead of the sports center like I told her I would be…"`);
        ...
        if (((s as any).christinaQW ?? 0)?.['blackmail'] >= 2  ||  ((s as any).christinaQW ?? 0)?.['subpath'] >= 2) {
          ...
          if (!(s as any).LariskaQW) (s as any).LariskaQW = {}; (s as any).LariskaQW['story'] = 3;
          qspCall(s, 'npc_relationship', 'modify', 'A13', 'like');
          scene.text('Pulling out the volleyball she dropped outside your parents apartment the other day, you hand it to her. "You dropped this, Lariska."');
          ...
          // TODO-QSP: dynamic text: Her eyes grow wide. "Just be careful, <<$pcs_nickname>>. I don't want her to hur...
          scene.text(`Her eyes grow wide. "Just be careful, ${((s as any).pcs_nickname ?? 0)}. I don't want her to hurt you because of me."`);
      ...
      if (((s as any).LariskaQW ?? 0)?.['story'] === 3) {
        ...
        if (((s as any).christinaQW ?? 0)?.['blackmail'] >= 2  ||  ((s as any).christinaQW ?? 0)?.['subpath'] >= 2  ||  ((s as any).christinaQW ?? 0)?.['fight'] === 1) {
          if (!(s as any).LariskaQW) (s as any).LariskaQW = {}; (s as any).LariskaQW['story'] = 5;
          qspCall(s, 'npc_relationship', 'modify', 'A13', 'like');
          // TODO-QSP: dynamic text: "Okay, <<$pcs_nickname>>. I guess Christina won't stop me from hanging out with ...
          scene.text(`"Okay, ${((s as any).pcs_nickname ?? 0)}. I guess Christina won't stop me from hanging out with you now," she smiles shyly. "Do you want to come over after school and work on our homework together?"`);
          ...
          // TODO-QSP: dynamic text: "I'm sorry <<$pcs_nickname>>, but I already told you that Christina doesn't want...
          scene.text(`"I'm sorry ${((s as any).pcs_nickname ?? 0)}, but I already told you that Christina doesn't want me hanging out with you."`);
        ...
        if (((s as any).LariskaQW ?? 0)?.['story'] === 4) {
          if (!(s as any).LariskaQW) (s as any).LariskaQW = {}; (s as any).LariskaQW['story'] = 5;
          qspCall(s, 'npc_relationship', 'modify', 'A13', 'like');
          // TODO-QSP: dynamic text: "Okay <<$pcs_nickname>>. I guess Christina won't stop me from hanging out with y...
          scene.text(`"Okay ${((s as any).pcs_nickname ?? 0)}. I guess Christina won't stop me from hanging out with you now," she smiles shyly. "Do you want to come over after school and work on our homework together?"`);
    ...
    if (((s as any).fame ?? 0)?.['pav_slut'] >= 225) {
      if (((s as any).npc_rel ?? 0)?.['A13'] >= 50) {
        ...
        if (((s as any).npc_rel ?? 0)?.['A13'] <= 20) {
          ...
          scene.text(`She gives you a shocked look as her face turns bright red. "Go away, ${((s as any).pcs_nickname ?? 0)}!"`);
        }
      }
    } else {
      if (((s as any).grupTipe ?? 0) === 1) {
        if (((s as any).npc_rel ?? 0)?.['A13'] >= 50) {
          ...
          scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}, have you seen Christina around?" Lariska asks.`);
          ...
          if (((s as any).npc_rel ?? 0)?.['A13'] <= 20) {
            ...
            scene.text(`Lariska smiles. "Hey ${((s as any).pcs_nickname ?? 0)}! I need help with a thing and I think you're the perfect person that can help me out."`);
        ...
        if (((s as any).grupTipe ?? 0) === 2) {
          ...
          if (((s as any).grupTipe ?? 0) === 3) {
            if (((s as any).npc_rel ?? 0)?.['A13'] >= 50) {
              ...
              scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}. When are you going to stop staring at books and come play some sports with us?"`);
              ...
              if (((s as any).npc_rel ?? 0)?.['A13'] <= 20) {
                ...
                scene.text(`"Huh? What are you talking about, ${((s as any).pcs_nickname ?? 0)}?"`);
            ...
            if (((s as any).grupTipe ?? 0) === 4) {
              if (((s as any).npc_rel ?? 0)?.['A13'] >= 50) {
                ...
                scene.text(`"Hi, ${((s as any).pcs_nickname ?? 0)}. You know Christina will throw a fit if she sees you talking to me."`);
                ...
                if (((s as any).npc_rel ?? 0)?.['A13'] <= 20) {
                  ...
                  scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}. Sorry, can't chat. Christina needs me."`);
                  scene.text('She then runs off, looking for her idol.');
                  // TODO-QSP: $OpenInnerThought + 'Well that was rude, bitch!' + $CloseInnerThought
                } else {
                  scene.text('Lariska sees you walking towards her and stands up, looking nervous.');
                  scene.text('"Hey Lariska."');
                  // TODO-QSP: dynamic text: "Hi <<$pcs_nickname>>. Sorry, I don't think you're supposed to be here." She loo...
                  scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}. Sorry, I don't think you're supposed to be here." She looks around, like she's afraid and needs protection.`);
              ...
              if (((s as any).npc_rel ?? 0)?.['A13'] >= 50) {
                ...
                if (((s as any).npc_rel ?? 0)?.['A13'] <= 20) {
                  ...
                  scene.text(`"What are you doing here, ${((s as any).pcs_nickname ?? 0)}? You don't have friends here."`);
  ...
  if (((s as any).mesec ?? 0) > 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
    if (((s as any).pantyworntype ?? 0) !== 'none') {
      scene.actions([
        { label: 'Ask for a pad', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Lariska," you whisper. "My period just started and I don\'t have a pad. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'lariska_tampon');
  } },
      ]);
    }
    scene.actions([
      { label: 'Ask for a tampon', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Lariska," you whisper. "My period just started and I don\'t have a tampon. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'lariska_tampon');
  } },
    ]);
  } else {
    if (((s as any).placebopart ?? 0) > 0  &&  ((s as any).lutH ?? 0) > 0  &&  ((s as any).knowpreg ?? 0) === 0  &&  ((s as any).isprok ?? 0) === 0  &&  (!((s as any).isprokp ?? 0))) {
      if (((s as any).pantyworntype ?? 0) !== 'none') {
        scene.actions([
          { label: 'Ask for a pad', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Lariska," you whisper. "My period is starting soon and I don\'t have a pad. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'lariska_tampon');
  } },
        ]);
      }
      scene.actions([
        { label: 'Ask for a tampon', handler: (st: GameState) => {
    if (!(s as any).temp) (s as any).temp = {}; (s as any).temp['tampon_ask'] = '"Lariska," you whisper. "My period is starting soon and I don\'t have a tampon. Can I borrow one?"';
    qspCall(s, 'gschool_jock_chats', 'lariska_tampon');
  } },
      ]);
    }
...
function enterIvan(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] < 225  &&  ((s as any).IvanShowerQW ?? 0) === 1) {
    ...
    scene.text(`Ivan thinks for a second before he speaks. "${((s as any).pcs_nickname ?? 0)}, I'd like to talk to you about what happened in the shower. You're a great girl, and I had a great time, but I'm not ready for a relationship."`);
    ...
    if (((s as any).fame ?? 0)?.['pav_slut'] >= 225) {
      if (((s as any).npc_rel ?? 0)?.['A3'] >= 60) {
        ...
        if (((s as any).npc_rel ?? 0)?.['A3'] <= 20) {
          ...
          scene.text(`"What do you want ${((s as any).pcs_nickname ?? 0)}?" he asks, barely looking at you. "Whatever it is, I'm not interested," he adds in a cold tone.`);
      ...
      if (((s as any).grupTipe ?? 0) === 1) {
        if (((s as any).npc_rel ?? 0)?.['A3'] >= 60) {
          ...
          scene.text(`"Oh, hi ${((s as any).pcs_nickname ?? 0)}. Are you volunteering?" he replies with a friendly smile on his face. "Maybe I should, but I don't have that luxury."`);
          ...
          if (((s as any).IvanShowerQW ?? 0) === 11  &&  ((s as any).IvanShowerYes ?? 0) === 1) {
            ...
            scene.text(`As you walk away Ivan suddenly jogs up beside you and leans over as he whispers in your ear. "Tell me you're bored, ${((s as any).pcs_nickname ?? 0)}."`);
            scene.actions([
    ...
    scene.actions([
      { label: 'Time for the next class', goto: ['gschool_lessons', 'short_break'] },
            ...
            if (((s as any).IvanShowerYes ?? 0) === 0  &&  ((s as any).IvanShowerQW ?? 0) === 11  &&  ((s as any).ShowerIvan ?? 0) < 3) {
              ...
              scene.text(`"Well, I guess that means no more fun," you sigh and start walking towards the classroom together, Ivan suddenly stops you. "${((s as any).pcs_nickname ?? 0)}, want to meet up with me in the showers after school?"`);
              scene.actions([
    ...
    if (!(s as any).ivanQW) (s as any).ivanQW = {}; (s as any).ivanQW['ivan_boxing_invite'] = 1;
    scene.img('images/characters/shared/headshots_main/big3.jpg');
    ...
    scene.actions([
      { label: 'Time for the next class', goto: ['gschool_lessons', 'short_break'] },
          ...
          if (((s as any).npc_rel ?? 0)?.['A3'] <= 20) {
            ...
            // TODO-QSP: dynamic text: As he turns around, he notices it's you talking to him. "Hi <<$pcs_nickname>>. I...
            scene.text(`As he turns around, he notices it's you talking to him. "Hi ${((s as any).pcs_nickname ?? 0)}. Is it important? Fedor and I are discussing an important thing," he says before turning back to Fedor.`);
            ...
            // TODO-QSP: dynamic text: "Hi <<$pcs_nickname>>, I'm looking for Fedor…" he says, then looks around the ha...
            scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}, I'm looking for Fedor…" he says, then looks around the hallway with a searching eye, but doesn't see him anywhere.`);
        ...
        if (((s as any).grupTipe ?? 0) === 2) {
          if (((s as any).npc_rel ?? 0)?.['A3'] >= 60) {
            ...
            scene.text(`"Hello ${((s as any).pcs_nickname ?? 0)}, I hope you're looking for me?" Ivan asks when he sees you approaching.`);
    ...
    scene.actions([
      { label: 'Time for the next class', goto: ['gschool_lessons', 'short_break'] },
            ...
            if (((s as any).npc_rel ?? 0)?.['A3'] <= 20) {
              ...
              // TODO-QSP: dynamic text: Ivan closes the locker door and turns to you. "Listen, <<$pcs_nickname>>, I'm so...
              scene.text(`Ivan closes the locker door and turns to you. "Listen, ${((s as any).pcs_nickname ?? 0)}, I'm sorry, but I don't have time right now. Maybe you should ask someone else," he replies indifferently before turning and walking towards the others.`);
              ...
              scene.text(`He turns to you as he closes the locker door. "Oh, hello ${((s as any).pcs_nickname ?? 0)}. Nothing special. I was just putting away my boxing gear and wondering if I should practice my fist pumping today or go for a run."`);
          ...
          if (((s as any).grupTipe ?? 0) === 3) {
            if (((s as any).npc_rel ?? 0)?.['A3'] >= 60) {
              ...
              scene.text(`"Look at that! Little ${((s as any).pcs_nickname ?? 0)} is starting to box?" he laughs while jokingly punching you on the shoulder. "Who would think that physics and maths would make someone a boxing coach?"`);
              ...
              if (((s as any).IvanShowerQW ?? 0) === 11  &&  ((s as any).IvanShowerYes ?? 0) === 1) {
                ...
                scene.text(`"Ah, you never change," you reply while rolling your eyes before grabbing your stuff and heading to the classroom together, with Ivan when he leans toward you and whispers in your ear. "Tell me you're bored, ${((s as any).pcs_nickname ?? 0)}."`);
                scene.actions([
                  { label: 'Tell Ivan you\'re bored', goto: ['IvanEv', 'ivan_bored'] },
                  { label: 'Tell him not today', handler: (st: GameState) => {
    scene.text(`<center><b>${'Ivan Prokhorov'}</b></center>`);
    ...
    scene.actions([
      { label: 'Time for the next class', goto: ['gschool_lessons', 'short_break'] },
              ...
              if (((s as any).npc_rel ?? 0)?.['A3'] <= 20) {
                ...
                scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}, fine…" he replies as he looks around. When he sees that everyone is busy or talking to someone, he sits on the floor and gestures for you to sit next to him.`);
            ...
            if (((s as any).grupTipe ?? 0) === 4) {
              if (((s as any).npc_rel ?? 0)?.['A3'] >= 60) {
                ...
                scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}," Ivan greets you as you walk towards him.`);
                ...
                if (((s as any).IvanShowerQW ?? 0) === 11  &&  ((s as any).IvanShowerYes ?? 0) === 1) {
                  ...
                  scene.img('images/characters/pavlovsk/school/boy/ivan/School/ivan2.jpg');
                  // TODO-QSP: dynamic text: "Well, I guess that means no more fun," you sigh and start walking towards the c...
                  scene.text(`"Well, I guess that means no more fun," you sigh and start walking towards the classroom together, with Ivan when he leans toward you and whispers in your ear. "Tell me you're bored, ${((s as any).pcs_nickname ?? 0)}."`);
                  scene.actions([
                    { label: 'Tell Ivan you\'re bored', goto: ['IvanEv', 'ivan_bored'] },
                    { label: 'Tell him not today', handler: (st: GameState) => {
    scene.text(`<center><b>${'Ivan Prokhorov'}</b></center>`);
    ...
    scene.actions([
      { label: 'Time for the next class', goto: ['gschool_lessons', 'short_break'] },
                ...
                if (((s as any).npc_rel ?? 0)?.['A3'] <= 20) {
                  ...
                  scene.text(`"You thought wrong, ${((s as any).pcs_nickname ?? 0)}. We have nothing to talk about anyway. We don't really have much in common, in case you haven't noticed," he replies without even looking back.`);
              ...
              if (((s as any).npc_rel ?? 0)?.['A3'] >= 60) {
                ...
                scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}," Ivan greets you as you approach him.`);
                ...
                if (((s as any).npc_rel ?? 0)?.['A3'] <= 20) {
                  ...
                  scene.text(`"Oh, hello ${((s as any).pcs_nickname ?? 0)}, nothing important. I'm looking at some new boxing gear. You know, it's very important to have the right grip so you don't get hurt."`);

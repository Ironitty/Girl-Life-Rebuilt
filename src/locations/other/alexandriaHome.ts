...
function enterIntercom(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).succubusQW ?? 0) > 1  &&  ((s as any).succubusQW ?? 0) < 5  &&  (!((s as any).AlexSuc ?? 0))) {
      ...
      scene.text(`"${((s as any).pcs_lastname || '')}?" He sounds… intrigued, and signals towards his study. Taking his cue, you make your way inside, feeling his gaze on your back the whole way.`);
      // TODO-QSP: dynamic text: "Why are you doing that, <<$pcs_lastname>>?"
      scene.text(`"Why are you doing that, ${((s as any).pcs_lastname || '')}?"`);
      ...
      scene.text(`"Fascinating, ${((s as any).pcs_lastname || '')}. Hmm… you seem to be pupating… changing on a magical level… hmm… Can you explain how?"`);
      ...
      scene.text(`"You need to look for specialized help in the form of a flesh crafter wizard, ${((s as any).pcs_lastname || '')}. I am loath to say this, but the nearest one with the proper training is that trickster who has already inserted herself into your life. I urge you to go to her for help."`);
      ...
      if (qspFunc(s, 'succubus', 'active', 5)  &&  ((s as any).AlexSuc ?? 0) === 1) {
        ...
        if (((s as any).npc_rel ?? 0)?.['A241'] === 1) {
          ...
          scene.text(`"Interesting, ${((s as any).pcs_lastname || '')}. You seem to be fitting in well to your new incarnation as a Succubus."`);
          ...
          scene.text(`"If I must be sincere ${((s as any).pcs_lastname || '')}, I'm not exactly happy with your chosen path, but I have hope that it will not be a hindrance to your magic development."`);
          ...
          scene.text(`"${((s as any).pcs_lastname || '')}, I am disappointed that you have submitted to the Succubae siren call."`);
          ...
          scene.text(`"If I must be sincere ${((s as any).pcs_lastname || '')}, I'm not surprised that you chose a decadent and hedonistic lifepath over your magical studies."`);
        ...
        scene.text(`It only takes a minute for Aleksei to open the door and greet you with a short, polite "${((s as any).pcs_lastname || '')}," before turning and walking back inside towards his study.`);
        ...
        scene.text(`"Well, ${((s as any).pcs_lastname || '')}, what can I do for you?"`);

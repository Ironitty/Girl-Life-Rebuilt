...
function enterHourly(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['drinks'] > 0) {
    if ((((s as any).locat ?? 0)?.['katja'] > 0  &&  ((s as any).locat ?? 0)?.['katja'] < 4)  ||  (((s as any).locat ?? 0)?.['katja'] > 19  &&  ((s as any).locat ?? 0)?.['katja'] < 24)) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['drinks'] = ((s as any).katjaQW['drinks'] ?? 0) - (2);
      if (((s as any).katjaQW ?? 0)?.['drinks'] < 0) {
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['drinks'] = 0;
      }
    } else {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['drinks'] = ((s as any).katjaQW['drinks'] ?? 0) - (Math.floor(Math.random() * 2) + 0);
    }
  }
  if (((s as any).katjaQW ?? 0)?.['under_influnece_of_cocaine'] > 0) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['under_influnece_of_cocaine'] = ((s as any).katjaQW['under_influnece_of_cocaine'] ?? 0) - (1);
  }
  ...
  if (((s as any).katjaQW ?? 0)?.['nightclub_private_room_boy'] === 1  &&  ((s as any).katjaQW ?? 0)?.['disco_loc'] !== 7) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['nightclub_private_room_boy'] = 0;
  ...
  if (((s as any).katjaQW ?? 0)?.['nightclub_private_room_girls'] === 1  &&  ((s as any).katjaQW ?? 0)?.['disco_loc'] !== 9) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['nightclub_private_room_girls'] = 0;
    if ((Math.floor(Math.random() * (((s as any).katjaQW ?? 0)?.['slut']/25 - 0 + 1)) + (0)) > 0) {
...
function enterCikl(s: GameState, scene: SceneBuilder): void {
  if (((s as any).katjaQW ?? 0)?.['QWstage'] > 2) {
    if (((s as any).katjaQW ?? 0)?.['horny'] >= 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = ((s as any).katjaQW['horny'] ?? 0) + (((((s as any).katjaQW ?? {})?.['slut'] ?? 0) - (Math.floor(Math.random() * 50) + 1))/10);
    }
    if (((s as any).katjaQW ?? 0)?.['horny'] < 0) {
    ...
    if (((s as any).katjaQW ?? 0)?.['horny'] >= 100) {
      if ((Math.floor(Math.random() * 3) + 0) === 0  &&  ((s as any).week ?? 0) < 6) {
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = Math.max((((s as any).katjaQW ?? {})?.['slut'] ?? 0)/2, 50);
        if (((s as any).katjaQW ?? 0)?.['masturbates'] === 0) {
          if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['masturbates'] = 1;
        }
      } else {
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = 100;
      }
    }
  } else {
  ...
  if (((s as any).yearstart ?? 0) > 1  &&  ((s as any).npc_had_sex ?? 0)?.['A14']  &&  ((s as any).katjaQW ?? 0)?.['relationship_count_start'] === 0) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['relationship_count_start'] = ((s as any).daystart ?? 0);
  }
  if (((s as any).yearstart ?? 0) > 1  &&  ((s as any).katjaQW ?? 0)?.['QWstage'] >= 6  &&  ((s as any).katjaQW ?? 0)?.['birth_control_start_day'] === 0) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['birth_control_start_day'] = ((s as any).daystart ?? 0);
  }
  ...
  if (((s as any).katjaQW ?? 0)?.['no_panties_at_disco'] > 0) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['no_panties_at_disco'] = 0;
  }
  ...
  if (((s as any).katjaQW ?? 0)?.['slut'] > 50  &&  ((s as any).katjaQW ?? 0)?.['preference_change'] === 0) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['preference_change'] = 1;
    qspCall(s, 'npc_set_preference', 'A14', 'short_skirt', 'like');
  } else {
    if (((s as any).katjaQW ?? 0)?.['slut'] > 100  &&  ((s as any).katjaQW ?? 0)?.['preference_change'] === 1) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['preference_change'] = 2;
  ...
  if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] > 0  &&  ((s as any).katjaQW ?? 0)?.['preference_change_pantQW'] === 0) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['preference_change_pantQW'] = 1;
    ...
    if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] > 4  &&  ((s as any).katjaQW ?? 0)?.['preference_change_pantQW'] === 1) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['preference_change_pantQW'] = 2;
  ...
  if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 1  &&  ((s as any).katjaQW ?? 0)?.['coke_point'] > 3) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_stage'] = 2;
  } else {
    if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 2  &&  ((s as any).katjaQW ?? 0)?.['coke_point'] > 8) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_stage'] = 3;
    } else {
      if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 3  &&  ((s as any).katjaQW ?? 0)?.['coke_point'] > 15) {
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_stage'] = 4;
      } else {
        if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 4) {
          if (((s as any).katjaQW ?? 0)?.['coke_point'] > 25) {
            if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_stage'] = 5;
          } else {
          ...
          if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 5) {
            if (((s as any).katjaQW ?? 0)?.['coke_point'] > 35) {
              if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_stage'] = 6;
            } else {
              if (((s as any).katjaQW ?? 0)?.['coke_point'] < 25) {
                if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_stage'] = 5;
              }
            ...
            if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 6) {
              if (((s as any).katjaQW ?? 0)?.['coke_point'] > 50) {
                if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_stage'] = 7;
              } else {
                if (((s as any).katjaQW ?? 0)?.['coke_point'] < 35) {
                  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_stage'] = 5;
                }
              ...
              if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 7) {
                ...
                if (((s as any).katjaQW ?? 0)?.['coke_point'] > 70) {
                  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_stage'] = 8;
                } else {
                ...
                if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 8) {
                  if (((s as any).katjaQW ?? 0)?.['coke_day'] + 1 < ((s as any).daystart ?? 0)) {
                    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['financial_strain'] = ((s as any).katjaQW['financial_strain'] ?? 0) + (Math.floor(Math.random() * 2) + 0);
                    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', 1, 1]; enterTakeCocaine(s, scene); (s as any).locArgs = __savedLocArgs; }
                  }
  ...
  if (((s as any).katjaQW ?? 0)?.['coke_day'] + 7 < ((s as any).daystart ?? 0)  &&  ((s as any).katjaQW ?? 0)?.['coke_day_lapse'] === 1) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_day_lapse'] = 0;
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_point'] = ((s as any).katjaQW['coke_point'] ?? 0) - (1);
  }
  if (((s as any).katjaQW ?? 0)?.['coke_point'] < 0) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_point'] = 0;
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterTakeCocaine(s: GameState, scene: SceneBuilder): void {
  if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 0) {
    ...
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_stage'] = 1;
  } else {
    if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 1) {
      ...
      if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 2) {
        ...
        if (((s as any).katjaQW ?? 0)?.['coke_stage'] === 3) {
          if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['slut'] = ((s as any).katjaQW['slut'] ?? 0) + (Math.floor(Math.random() * 2) + 0);
        }
      }
    }
  }
  ...
  if ((!((s as any).locArgs?.[1] ?? 0))) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['under_influnece_of_cocaine'] = ((s as any).katjaQW['under_influnece_of_cocaine'] ?? 0) + (2);
    if (((s as any).katjaQW ?? 0)?.['coke_stage'] > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = ((s as any).katjaQW['horny'] ?? 0) + (4*(11-(((s as any).katjaQW ?? {})?.['coke_stage'] ?? 0)));
    } else {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = ((s as any).katjaQW['horny'] ?? 0) + (40);
    }
  }
  if (((s as any).katjaQW ?? 0)?.['coke_stage'] < 3) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_point'] = ((s as any).katjaQW['coke_point'] ?? 0) + (1);
  ...
  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_day'] = ((s as any).daystart ?? 0) - ((s as any).ARGS ?? 0)[2];
  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['coke_day_lapse'] = 1;
  // TODO-QSP: end
  scene.build();
}
...
function enterSexSet(s: GameState, scene: SceneBuilder): void {
    ...
    if (((s as any).katjaQW ?? 0)?.['simultanous_boys'] === 0  &&  (Math.floor(Math.random() * 5) + 0) <= ((s as any).katjaQW ?? 0)?.['slut']/25) {
      if (((s as any).npc_vag ?? 0)?.['A14'] === 0  &&  ((s as any).npc_ass ?? 0)?.['A14'] === 0) {
        if ((!(Math.floor(Math.random() * 5) + 0))) {
          if (!(s as any).npc_ass) (s as any).npc_ass = {}; (s as any).npc_ass['A14'] = ((s as any).npc_ass['A14'] ?? 0) + (2);
          if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['anal_sex'] = 1;
        } else {
          if (!(s as any).npc_vag) (s as any).npc_vag = {}; (s as any).npc_vag['A14'] = 20;
          if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['pussy_sex'] = 1;
        }
      } else {
        if (((s as any).npc_vag ?? 0)?.['A14'] > 0  &&  (Math.floor(Math.random() * 4) + 0) > 0) {
          ...
          if (((s as any).npc_vag ?? 0)?.['A14'] < (Math.floor(Math.random() * 6) + 5)) {
            if (!(s as any).npc_vag) (s as any).npc_vag = {}; (s as any).npc_vag['A14'] = ((s as any).npc_vag['A14'] ?? 0) + (2);
          } else {
      ...
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['simultanous_boys'] = 0;
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['slut'] = ((s as any).katjaQW['slut'] ?? 0) + ((((s as any).katjaQW ?? {})?.['simultanous_boys'] ?? 0)*5);
    } else {
      if (((s as any).katjaQW ?? 0)?.['simultanous_boys'] > 0  &&  (Math.floor(Math.random() * 3) + 0) <= ((s as any).katjaQW ?? 0)?.['slut']/50) {
        if (((s as any).npc_vag ?? 0)?.['A14'] > 0  &&  (Math.floor(Math.random() * 4) + 0) > 0) {
          ...
          if (((s as any).katjaQW ?? 0)?.['creampie'] > 0  &&  (!(Math.floor(Math.random() * 6) + 0))) {
            if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['creampie'] = ((s as any).katjaQW['creampie'] ?? 0) + (1);
          }
        } else {
          if ((!(Math.floor(Math.random() * 6) + 0))) {
            if (!(s as any).npc_vag) (s as any).npc_vag = {}; (s as any).npc_vag['A14'] = 20;
        ...
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['simultanous_boys'] = ((s as any).katjaQW['simultanous_boys'] ?? 0) + (Math.max(0, (Math.floor(Math.random() * (((s as any).ARGS ?? 0)[1] - (((s as any).katjaQW ?? {})?.['simultanous_boys'] ?? 0) - 0 + 1)) + (0))));
  ...
  if (((s as any).locArgs?.[2] ?? 0) > 0) {
    if (((s as any).katjaQW ?? 0)?.['simultanous_girls'] === 0  &&  (Math.floor(Math.random() * 4) + 0) <= ((s as any).katjaQW ?? 0)?.['slut']/33) {
      ...
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['simultanous_girls'] = 0;
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['slut'] = ((s as any).katjaQW['slut'] ?? 0) + ((((s as any).katjaQW ?? {})?.['simultanous_girls'] ?? 0)*4);
    } else {
      if (((s as any).katjaQW ?? 0)?.['simultanous_girls'] > 0  &&  (Math.floor(Math.random() * 2) + 0) <= ((s as any).katjaQW ?? 0)?.['slut']/50) {
        ...
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['simultanous_girls'] = ((s as any).katjaQW['simultanous_girls'] ?? 0) + (Math.max(0, (Math.floor(Math.random() * (((s as any).ARGS ?? 0)[2] - (((s as any).katjaQW ?? {})?.['simultanous_girls'] ?? 0) - 0 + 1)) + (0))));

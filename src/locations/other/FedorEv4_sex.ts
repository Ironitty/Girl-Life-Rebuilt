...
function enterHallSex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Fedor looks at you with a very pleased expression. "You know just what I like." then rubs your forehead, before getting dressed. When you are both dressed Fedor asks "So ${((s as any).pcs_firstname || '')}, are you still up for that movie?`);
    qspCall(s, 'stat', '');
    scene.actions([
...
function enter3Way(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You scold Fedor and as you state "I'm not that kind of girl Fedor!" He stammers as he responds, "I didn't mean to imply that you… I'm sorry ${((s as any).pcs_firstname || '')}." Ivan then responds, "Don't worry ${((s as any).pcs_firstname || '')}. It was just a joke. I wouldn't want to come in between you… or would I?" he then laughs as he walks away. You get dressed then grab Fedor by the hand. "It's alright Fedor, I know you care for me, so I'm willing to look past this." as you give Fedor a sweet smile while leading him to the livingroom.`);
    qspCall(s, 'arousal', 'end');
    scene.actions([
...
function enter3way2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: You turn to Ivan, letting Fedor's dick slide out of your mouth but then extend y...
    scene.text(`You turn to Ivan, letting Fedor's dick slide out of your mouth but then extend your hand to jerk him off as you respond, "I want you both to fill me up." Ivan grins. "Hell yeah ${((s as any).pcs_firstname || '')} I'll fill you up real good." he then rapidly increases his pace and soon Ivan grabs your hips tightly as he pumps his load into your ass, doing his best to fill your ass to the brim with his seed. Soon after Fedor groans as he shoots his load down your throat which you swallow obediently, savoring every drop. When they both finish with you, they begin chatting with each other. "${((s as any).pcs_nickname || '')} is a great catch. You need to hold onto this one Fey."`);
...
function enter3way3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Ivan responds, "Yeah, I guess I did get a bit carried away, Sorry ${((s as any).pcs_firstname || '')}. I'll slow down for you." and true to his word he slows his pace allowing your ass to adjust for his dick before slowly increasing his pace. You are beginning to enjoy Ivan's dick in your ass as Fedor sits down in front of you watching you get fucked which turns you on. While Ivan continues pounding your ass, Fedor gets up and tells Ivan. "Hey Ivan, don't go hogging my girl now."`);
    qspCall(s, 'boyStat', 'A3');
    (s as any).anal_slip = ((s as any).anal_slip ?? 0) + (4);
    qspCall(s, 'arousal', 'anal', (-5), 'sub');
    qspCall(s, 'stat', '');
...
function enterLivingroom1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You continue thrusting faster, riding Fedor's cock as fast as you can as you stare into his eyes. Fedor's head tilts back and he lets out a loud groan as he begins filling you with his seed. You push down on his dick making sure that he is as far inside you as possible. After Fedor finishes filling you up he looks you in the eyes "${((s as any).pcs_firstname || '')} you're so perfect. I can't think of anyone who could make me happier than you." Which you respond, "I'll always be here to keep you happy and fully satisfied, my love." Fedor leans forward and gives you a passionate kiss before getting dressed and leaving the room.`);
...
function enterBathroomCam(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Fedor responds, "C'mon ${((s as any).pcs_nickname || '')} no one outside of this room will ever see it."`);
...
function enterKitchen2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You wrap your legs around Fedor as he thrust his dick further inside you, Fedor then lets out a groan as he begins pumping his seed into your womb. You can feel his penis throbbing inside you, filling you up with his seed. Fedor looks down to you "Your such a great fuck ${((s as any).pcs_nickname || '')}." you respond, "Well that's only one of my many talents." to which Fedor replies, "You'll have to show me those other talents sometime." Fedor then gets dressed then walks out of the room.`);
    scene.img('images/characters/pavlovsk/school/boy/fedor/fedorev2/home/bedroom/cum/cum5.mp4');
    qspCall(s, 'cum_call', '', '', ((s as any).boy ?? 0), 1);
    qspCall(s, 'arousal', 'vaginal', 5);
    qspCall(s, 'arousal', 'end');
...
function enterBedroomCam(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You push Fedor onto the bed, then begin unbuttoning his pants. You take Fedor's penis out of his pants, then begin slowly stroking it, as you stare at the camera. Fedor asks "How do you like my dick ${((s as any).pcs_nickname || '')}?" You reply, "I love it. So warm, soft and hard." Fedor gives you a very pleased smile as he lightly moans. You begin rubbing the base of his penis while enjoying how soft and warm his dick is until you hear Fedor say, "I'm gonna cum."`);
    ...
    scene.text(`You pull Fedor's penis out of your mouth then begin licking the shaft firmly. Fedor groans then begins spraying his load in the air which shoots across the room. You begin firmly stroking Fedor's dick, milking every drop out of it while staring into the camera with a seductive grin. Fedor takes a second to catch his breath then says, "Damn ${((s as any).pcs_firstname || '')}, You really know how work your tongue." as he packs up the camera then gets dressed.`);
    ...
    scene.text(`You look back at Fedor then say, "Paint my ass with your cum." Fedor gives you a wink then increases his pace before pulling his penis out of your ass and painting your ass with his warm seed. You stare directly at the camera as Fedor sprays his cum all over your ass. Fedor gives your lower ass a smack before saying "You have such a tight firm ass ${((s as any).pcs_nickname || '')}. I love it." You give Fedor a wink as he gets dressed.`);
    scene.img('images/shared/sex/cum/cum5.mp4');
    qspCall(s, 'cum_call', 'butt', ((s as any).boy ?? 0), 1);
    qspCall(s, 'arousal', 'anal', 5, 'sub', 'exhibitionism');
    qspCall(s, 'arousal', 'end');
    ...
    scene.text(`Fedor gives your ass a firm smack as he thrust his hips a few more times before groaning. You can feel Fedor's warm cum covering your ass and back as you bite your lips, enjoying the warmth of Fedor's cum on your back. Fedor rubs your legs as he says, "You're so sexy ${((s as any).pcs_firstname || '')}." You slowly look up to Fedor and give him a wink. Fedor then pans his camera up your body, recording the cum dripping off your body before turning off the camera then getting dressed.`);
    scene.img('images/shared/sex/cum/cum5.mp4');
    qspCall(s, 'cum_call', 'back', ((s as any).boy ?? 0), 1);
    qspCall(s, 'cum_call', 'butt', ((s as any).boy ?? 0), 1);
    qspCall(s, 'arousal', 'vaginal', 5, 'sub', 'exhibitionism');
    ...
    scene.text(`"Sorry Fedor but I can't risk a video like that getting out." Fedor gives you a smile as he replies, "Don't worry ${((s as any).pcs_firstname || '')}, I understand." Fedor then puts the camera away then walks up to you and gives you a soft kiss.`);
    scene.actions([
...
function enterBedroom1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You continue jerking him off and Fedor realizes that you want him to cum, so he leans back and begins lightly grunting as he nears closer to climax. You continue stroking his penis, enjoying the fact you are in complete control of his pleasure at the same time happy that you are able to give your man the release he deserves. Fedor's breathing grows more rapid then stops as his penis begins throbing in your hand. Fedor's penis erupts with his warm cum which you can feel pouring down your hand. You continue milking him until Fedor sits up. "Thank you for that ${((s as any).pcs_firstname || '')}. It's your turn now."`);
    qspCall(s, 'cum_call', 'hands', ((s as any).boy ?? 0), 1);
    qspCall(s, 'arousal', 'hj', 5, 'dom');
    qspCall(s, 'arousal', 'end');
    scene.actions([
    ...
    scene.text(`You stare into Fedor's eyes as you begin licking the tip of his penis. Fedor lets out a moan as your tongue hits the very tip of his penis which reveals to you just how sensitive that spot is, so you continue licking his penis in a circular motion, enjoying his body flinch every time your tongue hits his tip. Fedor looks down at you and says, "${((s as any).pcs_nickname || '')} you're… driving me crazy doing that. I can't hold on much longer"`);
    qspCall(s, 'arousal', 'rimming', 5, 'dom');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Make him cum', handler: (st: GameState) => {
    ...
    scene.text(`You greatly increase the pace of your strokes as Fedor raises up to his knees while pushing his chest forward as his pleasure builds up fast. After a few more strokes, Fedor groans and you feel his penis begins throbbing as he sprays his load all over your chest and one drop almost gets in your eye as he covers you in his cum. After Fedor is fully spent, he looks down at you and says, "${((s as any).pcs_firstname || '')} how did you get so good with your feet. I didn't know a footjob could be that amazing." You respond, "I guess all those gym classes had to be good for something right?" Fedor chuckles as he gets dressed and walks out of the room.`);
    qspCall(s, 'cum_call', 'face', ((s as any).boy ?? 0), 1);
    qspCall(s, 'cum_call', 'breasts', ((s as any).boy ?? 0), 1);
    qspCall(s, 'arousal', 'footjob', 5, 'dom');
    qspCall(s, 'arousal', 'end');
...
function enterBedroom2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Fedor responds, "I'll fuck you real good ${((s as any).pcs_firstname || '')}." as he shoves his dick into your pussy causing a loud moan to escape your mouth. You wrap your legs around Fedor's waist as he continues thrusting his dick further inside your pussy. You begin kissing Fedor's neck as he fucks you.`);
    qspCall(s, 'arousal', 'vaginal', 5, 'sub');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    ...
    scene.text(`You look Fedor in the eyes as you reply, "Fill me with your seed, my love." Fedor gives you a passionate kiss as you both increase the pace. You soon feel Fedor's arms tighten around you as he groans. You can feel Fedor's warm seed quickly filling your womb and you continue riding him, trying to keep his dick as far inside you as possible. You let out a loud moan as Fedor finishes pumping your pussy with his seed. Fedor catches his breath before looking you in the eyes "You are the most precious thing in my life. I love you ${((s as any).pcs_firstname || '')}." You can feel tears begin to form in your eyes as you reply, "I love you too Fyodor, with all my heart." Fedor leans forward then gives you a long passionate kiss before getting dressed and leaving the room.`);
    scene.img('images/characters/pavlovsk/school/boy/fedor/fedorev/home/vagkiss.mp4');
    qspCall(s, 'cum_call', '', '', ((s as any).boy ?? 0), 1);
    ...
    scene.text(`Fedor catches his breath before looking you in the eyes "You are the most precious thing in my life. I love you ${((s as any).pcs_firstname || '')}." You can feel tears begin to form in your eyes as you reply, "I love you too Fyodor, with all my heart." Fedor leans forward then gives you a long passionate kiss before getting dressed and leaving the room.`);
    scene.img('images/shared/sex/cum/cum81.mp4');
    qspCall(s, 'cum_call', '', '', ((s as any).boy ?? 0), 1);
    ...
    scene.text(`"Pull out babe." Fedor nods as he quickens his pace then he lightly pulls out of you then groans and begins spraying his warm cum on your back and feet as you stroke his penis, trying to get every last drop out of it. After Fedor finishes catching his breath he looks you in the eyes. "${((s as any).pcs_nickname || '')} I could fuck you for days straight." You give Fedor a mischievous grin as you respond, "Be careful or I might end up holding you to that." Fedor chuckles as he gets dressed and leaves the room.`);
...
function enterShower2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You turn to face Fedor and give him a passionate kiss before he says, "You are so perfect ${((s as any).pcs_firstname || '')}. I want to spend my whole life with you." You give Fedor a warm smile as you respond, "I feel the same way Fyodor. Maybe one day we will be ready to take that step." Fedor replies, "That day will come ${((s as any).pcs_firstname || '')}. I promise you." Fedor gets dressed then leaves the room.`);
    scene.img('images/shared/sex/cum/cum81.mp4');
    qspCall(s, 'cum_call', '', '', ((s as any).boy ?? 0), 1);
    qspCall(s, 'arousal', 'vaginal', 5);
    qspCall(s, 'arousal', 'end');

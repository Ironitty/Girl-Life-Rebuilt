...
function enterAss(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).picrand ?? 0) === 12) {
    ...
    scene.img(`images/locations/shared/sex/pod/uanal${((s as any).picrand ?? 0)}.jpg`);
  }
...
function enterVoy(s: GameState, scene: SceneBuilder): void {
  ...
  if ((!(Math.floor(Math.random() * 2) + 0))) {
    ...
    (s as any).pos = 5;
    scene.img(`images/locations/shared/sex/pod/anal${((s as any).picrand ?? 0)}.jpg`);
...
function enterEnd(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).sexstart = 0;
  if (((s as any).pos ?? 0) === 1) {
    scene.img(`images/locations/shared/sex/pod/cum${((s as any).picrand ?? 0)}.jpg`);

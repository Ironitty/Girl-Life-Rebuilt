...
function enter(s: GameState, scene: SceneBuilder): void {
  (s as any).GvstreBoyAfter[numnpc] = 0;
  (s as any).GvstreBoy = 0;
  (s as any).boyvstre[numnpc] = ((s as any).boyvstre[numnpc] ?? 0) + (1);
  qspCall(s, 'stat', '');
  ...
  if (((s as any).boytimes ?? 0)?.[String((s as any).numnpc ?? 0)] === 0) {
                          ...
                          if (((s as any).otnBoyFrend ?? 0)?.[String((s as any).numnpc ?? 0)] < 80  &&  ((s as any).gnpcSex ?? 0)?.[String((s as any).numnpc ?? 0)] === 0) {
                            ...
                            if (((s as any).otnBoyFrend ?? 0)?.[String((s as any).numnpc ?? 0)] < 120  &&  ((s as any).gnpcSex ?? 0)?.[String((s as any).numnpc ?? 0)] === 0) {
                              ...
                              if (((s as any).preg ?? 0) === 1  &&  ((s as any).pregChem ?? 0) <= 1920  &&  ((s as any).npc_pregtalk ?? 0)?.[String((s as any).numnpc ?? 0)] === 0  &&  ((s as any).gnpcSex ?? 0)?.[String((s as any).numnpc ?? 0)] > 0  &&  ((s as any).knowpreg ?? 0) === 1) {
                                if (((s as any).npc_usedname ?? 0)[((s as any).ChildFath ?? 0)[((s as any).arrsize ?? 0)('ChildFath') - 1]] !== ((s as any).nameBoyfrend ?? 0)?.[String((s as any).numnpc ?? 0)]) {
                                }
                                scene.actions([
    ...
    if (((s as any).npc_usedname ?? 0)[((s as any).ChildFath ?? 0)[((s as any).arrsize ?? 0)('ChildFath') - 1]] === ((s as any).nameBoyfrend ?? 0)?.[String((s as any).numnpc ?? 0)]  ||  (((s as any).npc_usedname ?? 0)[((s as any).ChildFath ?? 0)[((s as any).arrsize ?? 0)('ChildFath') - 1]] !== ((s as any).nameBoyfrend ?? 0)?.[String((s as any).numnpc ?? 0)]  &&  ((s as any).pregLieRand ?? 0) >= 4)) {
    ...
    (s as any).npc_pregtalk[numnpc] = 1;
    (s as any).otnBoyFrend[numnpc] = 0;
    ...
    if (((s as any).boytimes ?? 0)?.[String((s as any).numnpc ?? 0)] > 4  &&  ((s as any).otnBoyFrend ?? 0)?.[String((s as any).numnpc ?? 0)] >= 80  &&  ((s as any).temprand ?? 0) === 0) {
      (s as any).otnBoyFrend[numnpc] = ((s as any).otnBoyFrend[numnpc] ?? 0) - (40);
      (s as any).gnpcSex[numnpc] = 0;
      qspCall(s, 'stat', '');
    ...
    if (((s as any).pcs_hairbsh ?? 0) === 1) {
      (s as any).otnBoyFrend[numnpc] = ((s as any).otnBoyFrend[numnpc] ?? 0) + (1);
    }
    if (((s as any).pcs_makeup ?? 0) === 2) {
      (s as any).otnBoyFrend[numnpc] = ((s as any).otnBoyFrend[numnpc] ?? 0) + (1);
    }
    if (((s as any).pcs_makeup ?? 0) === 3) {
      (s as any).otnBoyFrend[numnpc] = ((s as any).otnBoyFrend[numnpc] ?? 0) + (2);
    }
    ...
    if (((s as any).PCloSkirt ?? 0) > 2) {
      (s as any).otnBoyFrend[numnpc] = ((s as any).otnBoyFrend[numnpc] ?? 0) + (3);
    }
    if (((s as any).PCloPants ?? 0) > 3) {
      (s as any).otnBoyFrend[numnpc] = ((s as any).otnBoyFrend[numnpc] ?? 0) + (2);
    }
    (s as any).minut = ((s as any).minut ?? 0) + 15;
    (s as any).boytimes[numnpc] = ((s as any).boytimes[numnpc] ?? 0) + (1);

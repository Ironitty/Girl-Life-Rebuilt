                            ...
                            if (((s as any).katjaQW ?? 0)?.['slut'] >= 60  &&  ((s as any).katjaQW ?? 0)?.['horny'] >= 40  &&  (((s as any).katjaQW ?? 0)?.['knows_BJ'] + ((s as any).katjaQW ?? 0)?.['knows_anal']) >= 2  &&  ((s as any).npc_had_sex ?? 0)?.['A14']  &&  ((s as any).katjaQW ?? 0)?.['boy_block'] === 0  &&  ((s as any).katjaQW ?? 0)?.['anal_quest'] === 0  &&  ((s as any).katjaQW ?? 0)?.['QWstage'] !== 4  &&  ((s as any).katjaQW ?? 0)?.['sex_clossedness'] === 0  &&  ((s as any).katjaQW ?? 0)?.['anal_sex'] === 0) {
                              ...
                              if (Math.min(((s as any).katjaQW ?? 0)?.['horny'], 100) > (Math.floor(Math.random() * 361) + 40)  ||  (((s as any).katjaQW ?? 0)?.['QWstage'] === 2  &&  Math.min(((s as any).katjaQW ?? 0)?.['horny'], 100) > (Math.floor(Math.random() * 121) + 40))  &&  ((s as any).katjaQW ?? 0)?.['sex_clossedness'] < 2) {
                                if (((s as any).katjaQW ?? 0)?.['QWstage'] >= 6  &&  ((s as any).week ?? 0) < 6  &&  ((s as any).katjaQW ?? 0)?.['boy_block'] === 0  &&  (((s as any).locat ?? 0)?.['Vicky'] !== 8  &&  ((s as any).locat ?? 0)?.['Vicky'] !== 9  &&  ((s as any).locat ?? 0)?.['Vicky'] !== 12  &&  ((s as any).locat ?? 0)?.['Vicky'] !== 13)  &&  (Math.floor(Math.random() * 7) + 0) ===0  &&  ((s as any).katjaQW ?? 0)?.['Marcus_day'] !== ((s as any).daystart ?? 0)  &&  ((s as any).katjaQW ?? 0)?.['sex_clossedness'] === 0  &&  ((s as any).katjaQW ?? 0)?.['marcus_pussy'] > 0) {
                                  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['Marcus_day'] = ((s as any).daystart ?? 0);
...
function enterChat(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['QWstage'] >= 7  &&  ((s as any).katjaQW ?? 0)?.['birth_control_start_day'] < ((s as any).daystart ?? 0)  &&  ((s as any).katjaQW ?? 0)?.['birth_control_start_day'] > 0  &&  ((s as any).katjaQW ?? 0)?.['horny'] > 60  &&  ((s as any).katjaQW ?? 0)?.['sex_clossedness'] === 0  &&  ((s as any).katjaQW ?? 0)?.['boy_block'] === 0) {
    scene.actions([
      { label: 'Look for boys in the park', goto: ['KatjaHomeTalk', 'go_to_park'] },
    ]);
  }
  ...
  scene.actions([
    ...
    scene.actions([
      ...
      if (((s as any).KatjaPreg ?? 0) !== 0  &&  (!((s as any).knowKatjaPreg ?? 0))) {
        // TODO-QSP: dynamic text: Katja bites her lip and, without looking you in the eye, finally plucks up the c...
        scene.text(`Katja bites her lip and, without looking you in the eye, finally plucks up the courage "${((s as any).pcs_nickname ?? 0)}, I'm pregnant…"`);
        scene.actions([
          { label: 'Who\'s the father?', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    (s as any).knowKatjaPreg = 1;
    qspCall(s, 'stat', '');
    ...
    if (((s as any).katjaQW ?? 0)?.['QWstage'] > 1  &&  ((s as any).pcs_makeup ?? 0) <= 1) {
      // TODO-QSP: dynamic text: "Hey! Wait a minute, <<$pcs_nickname>>! I bet you'd look great with a little mak...
      scene.text(`"Hey! Wait a minute, ${((s as any).pcs_nickname ?? 0)}! I bet you'd look great with a little make-up on you! What do you say?"`);
      scene.actions([
...
function enterKatjaknows(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).npc_pregtalk) (s as any).npc_pregtalk = {}; (s as any).npc_pregtalk['A14'] = 1;
    ...
    if (((s as any).katjaQW ?? 0)?.['slut'] < 60  &&  ((s as any).wombthfathID ?? 0) === 'A28') {
      ...
      if (((s as any).katjaQW ?? 0)?.['slut'] < 60  &&  ((s as any).wombthfathID ?? 0) === 'A35') {
        ...
        if (((s as any).katjaQW ?? 0)?.['slut'] < 60  &&  (((s as any).wombthfath ?? 0) === ''  ||  ((s as any).wombthfathID ?? 0) === 'unknown')) {
          ...
          scene.text(`Katja places a hand on your shoulder "${((s as any).pcs_nickname ?? 0)}, if I can do anything to make your life a little easier, please let me know."`);
          ...
          if (((s as any).katjaQW ?? 0)?.['slut'] >= 60  &&  ((s as any).wombthfathID ?? 0) === 'A34') {
            ...
            // TODO-QSP: dynamic text: As your <<$pc_desc['lips']>> lips separate from hers, you look into her eyes. "I...
            ...
            if (((s as any).katjaQW ?? 0)?.['slut'] >= 60  &&  ((s as any).wombthfathID ?? 0) === 'A28') {
              ...
              if (((s as any).katjaQW ?? 0)?.['slut'] >= 60  &&  ((s as any).wombthfathID ?? 0) === 'A35') {
                ...
                if (((s as any).katjaQW ?? 0)?.['slut'] >= 60  &&  (((s as any).wombthfath ?? 0) === ''  ||  ((s as any).wombthfathID ?? 0) === 'unknown')) {
                  ...
                  // TODO-QSP: dynamic text: "<<$pcs_nickname>>, I would never judge you. Plus, if I'm being honest, I'm a li...
                  scene.text(`"${((s as any).pcs_nickname ?? 0)}, I would never judge you. Plus, if I'm being honest, I'm a little jealous. I wish I could let myself have that much fun."`);
                  scene.text('You find yourself questioning what you did to deserve such a wonderful woman in your life.');
                } else {
                  (s as any).minut = ((s as any).minut ?? 0) + 10;
                  scene.text('"So, who\'s the baby-daddy?" she teases.');
  ...
  if ((((s as any).wombthfathID ?? 0) === 'A34'  &&  ((s as any).npc_rel ?? 0)?.['A34'] > 50)  ||  (((s as any).wombthfathID ?? 0) === 'A28'  &&  ((s as any).npc_rel ?? 0)?.['A28'] > 50)  ||  (((s as any).wombthfathID ?? 0) === 'A29'  &&  ((s as any).npc_rel ?? 0)?.['A29'] > 50)) {
    if (((s as any).wombthfathID ?? 0) === ((s as any).ChildThFath ?? 0)[((s as any).kid ?? 0)-1]) {
      if (((s as any).katjaQW ?? 0)?.['slut'] >= 60) {
        ...
        scene.text(`You tell Katja that ${((s as any).wombthfath ?? 0)} got you pregnant again.`);
      ...
      if (((s as any).katjaQW ?? 0)?.['slut'] >= 60) {
        ...
        scene.text(`Blushing, you tell Katja that a member of your family impregnated you, but this time it was ${((s as any).wombthfath ?? 0)}.`);
    ...
    if (((s as any).wombthfathID ?? 0) === ((s as any).ChildThFath ?? 0)[((s as any).kid ?? 0)-1]) {
      ...
      scene.text(`You tell Katja that ${((s as any).wombthfath ?? 0)} is the father again.`);
      ...
      if (((s as any).wombthfath ?? 0) === ''  ||  ((s as any).wombthfathID ?? 0) === 'unknown') {
        ...
        scene.text(`You tell Katja that the father is ${((s as any).wombthfath ?? 0)}.`);
...
function enterTenderKiss(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['boy_lie'] = 1;
  // TODO-QSP: end
  scene.actions([
    ...
    scene.text(`You refuse and she looks at you with pleading eyes. "Please ${((s as any).pcs_nickname ?? 0)}, you don't want me to be bad at kissing, do you?"`);
    ...
    scene.text(`You refuse and she looks at you with pleading eyes. "Please ${((s as any).pcs_nickname ?? 0)}, it'll help us both so we're better when we finally kiss a boy!"`);
    qspCall(s, 'willpower', 'kiss', 'resist', 'medium');
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Stand firm [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
...
function enterTamVal(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['QWstage'] = 2;
    scene.text(`<center><b>${((s as any).npc_firstname ?? 0)?.['A14']} ${((s as any).npc_lastname ?? 0)?.['A14']}</b></center>`);
    scene.img('images/characters/shared/headshots_main/big14.jpg');
    ...
    scene.text(`"${((s as any).pcs_nickname ?? 0)}, you saw that didn't you? I mean… they were… oh God!"`);
    ...
    // TODO-QSP: dynamic text: "I don't know… maybe? I never thought about something like that. Ehm… <<$pcs_nic...
    scene.text(`"I don't know… maybe? I never thought about something like that. Ehm… ${((s as any).pcs_nickname ?? 0)}… What would you think, if I… I mean… ehm… Behaved like Valentina and… tried to kiss you?"`);
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'stat', '');
    qspCall(s, 'willpower', 'kiss', 'force', 'hard');
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: '"What if I\'m the one that wants to kiss you?" [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    ...
    scene.text(`"That was… woah. Hmmm… <i>Something</i> ${((s as any).pcs_nickname ?? 0)}… "`);
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: '"Want to try it?" [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    // TODO-QSP: msg $noWillpower
  } },
      ]);
    } else {
    ...
    scene.text(`"That was. Woah. Hm. <i>Something</i> ${((s as any).pcs_nickname ?? 0)}…"`);
    qspCall(s, 'npc_relationship', 'modify', 'A14', 1);
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['slut'] = ((s as any).katjaQW['slut'] ?? 0) + (5);
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['QWstage'] = 3;
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    ...
    scene.text(`"${((s as any).pcs_nickname ?? 0)}! I wasn't joking! This is a hard moment for me!"`);
    ...
    scene.text(`"Eh… what? ${((s as any).pcs_nickname ?? 0)}, is this a joke?"`);
    scene.actions([
    ...
    scene.text(`"Okay ${((s as any).pcs_nickname ?? 0)}… What… What are you planning to do?"`);
    ...
    scene.text(`"${((s as any).pcs_nickname ?? 0)}! Ouch!"`);
    ...
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['slut'] = ((s as any).katjaQW['slut'] ?? 0) + (20);
    ...
    scene.text(`"Sorry ${((s as any).pcs_nickname ?? 0)}! I wasn't insinuating… I mean… I didn't want to… Ehm…"`);
...
function enterTamVal_2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}! I… This is going to sound awkward, especially… Ehm… Taking into consideration what just happened, but I was thinking about this before, well, you know. Do you want to… Come home to study? I'm not trying to… Ehm… Fuck!"`);
  ...
  scene.actions([
    ...
    if (((s as any).zz_stage ?? 0) >= 1) {
      ...
      scene.text(`"${((s as any).pcs_nickname ?? 0)} isn't it? I'm Tamara Meynold, my pleasure."`);
...
function enterBoyDiscussion(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).Marcus_sextype ?? 0) > 0) {
    ...
    scene.text(`Katja looks at you, pleading with her big eyes. "Please ${((s as any).pcs_nickname ?? 0)}. I really want my first time to be good, so could you please test him for me?"`);
...
function enterAnalDiscussion(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).IvanShowerQW ?? 0) === 11) {
    ...
    scene.text('"We could try to see if he is up for something next time he watches us kiss at school\'+iif(month > 4 and month < 10, \', or if we ran into him on the beach\', \'.\')+\'" you answer and Katja throws her arms around you and goes in for a kiss.');
    scene.actions([
      { label: 'Kiss her back', goto: ['katjaEvDin', 'kiss'] },
    ]);
  } else {
...
function enterPreventationTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('"If you want to \'+iif( katjaQW[\'QWstage\'] = 7, \'have sex with boys in the park\', \'continue having sex with boys around here\')+\', you should get on birth control," you tell Katja. "Most of the boys around here don\'t want to use condoms, and don\'t care if they get the girls pregnant."');
...
function enterRandomParkSexTalk(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['QWstage'] = 7;
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  qspCall(s, 'stat', '');
  scene.img('images/characters/shared/headshots_main/big14.jpg');
  ...
  scene.actions([
    ...
    if (((s as any).katjaQW ?? 0)?.['birth_control_start_day'] < ((s as any).daystart ?? 0)  &&  ((s as any).katjaQW ?? 0)?.['birth_control_start_day'] > 0) {
      scene.actions([
        { label: 'Agree', goto: ['KatjaHomeTalk', 'go_to_park'] },
...
function enterSexWithBoyAsk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['anal_quest'] > 1) {
    ...
    // TODO-QSP: dynamic text: "Yes <<$pcs_nickname>>. You know so many guys, so I'm sure you can arrange my fi...
    scene.text(`"Yes ${((s as any).pcs_nickname ?? 0)}. You know so many guys, so I'm sure you can arrange my first time to be perfect!" she says in her most persuasive voice.`);
  } else {
...
function enterMarcusAnswerTalk(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['marcus_asked'] = 2;
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['Marcus_day'] = ((s as any).daystart ?? 0);
  qspCall(s, 'stat', '');
  scene.img('images/characters/shared/headshots_main/big14.jpg');
...
function enterAnalSexWithBoyAsk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['QWstage'] >= 6) {
    ...
    scene.text(`"Yes, ${((s as any).pcs_nickname ?? 0)}. You know so many guys, so I'm sure you can arrange my first anal sex to be perfect!" she says in her most persuasive voice.`);
  } else {
    scene.text('"Okay, so why don\'t you?" you ask.');
...
function enterUniTell(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).university ?? 0)?.['enrolled_in'] === 'teaching_studies') {
    ...
    if (((s as any).katjaQW ?? 0)?.['know_katja_uni'] === 0) {
      // TODO-QSP: dynamic text: You tell Katja that you have enrolled at the university to study <<$func('uni_pr...
      ...
      // TODO-QSP: dynamic text: You tell Katja that you have also enrolled to study <<$func('uni_programs', 'get...
...
function enterKatjaUniTell(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['QWstage'] >= 2) {
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['knows_dorm_room_number'] = 1;
  }
  qspCall(s, 'stat', '');
  scene.img('images/characters/shared/headshots_main/big14.jpg');
  if (((s as any).katjaQW ?? 0)?.['know_going_to_teaching_degree'] === 0) {
    ...
    scene.text('Katja excitedly tells you that she has also been accepted into the university to study teaching and that it will be fun studying at the university together.\'+iif(katjaQW[\'QWstage\'] = 2, \'She also tells you that she is going to move into room 206 at the university dorm at the beginning of August.\', \')+\'');
...
function enterGoToPark(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).placerStringParameter) (s as any).placerStringParameter = {}; (s as any).placerStringParameter['ev_name'] = 'Katja';
  if (!(s as any).placerStringParameter) (s as any).placerStringParameter = {}; (s as any).placerStringParameter['ev_name_a'] = 'Katja';
  if (!(s as any).placerStringParameter) (s as any).placerStringParameter = {}; (s as any).placerStringParameter['ev_name_om'] = 'Katja';
  if (!(s as any).placerParameter) (s as any).placerParameter = {}; (s as any).placerParameter['friend_index'] = 14;
  if (!(s as any).placerParameter) (s as any).placerParameter = {}; (s as any).placerParameter['friend_horny'] = ((s as any).katjaQW ?? 0)?.['horny'];
  if (!(s as any).placerParameter) (s as any).placerParameter = {}; (s as any).placerParameter['friend_dom'] = ((s as any).katjaQW ?? {})?.['dom'] + 50;
  if (!(s as any).placerParameter) (s as any).placerParameter = {}; (s as any).placerParameter['friend_slut'] = ((s as any).katjaQW ?? 0)?.['slut'];
...
function enterArtemThreesomePlanning(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['katja_threesome'] = 1;
  qspCall(s, 'stat', '');
  scene.img('images/characters/shared/headshots_main/big14.jpg');
...
function enterArtemBreakUpTalk(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['knows_artem_is_boyfreind'] = 2;
  (s as any).minut = ((s as any).minut ?? 0) + 2;
  qspCall(s, 'stat', '');
  scene.img('images/characters/shared/headshots_main/big14.jpg');
  ...
  scene.actions([
    ...
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = qspUntranslated(s, "min(20, katjaQW['horny'])", { location: "KatjaHomeTalk" });
    if (((s as any).katjaQW ?? 0)?.['marcus_pussy'] > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['Marcus_day'] = ((s as any).daystart ?? 0);
    }
    qspCall(s, 'stat', '');
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 6;
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = qspUntranslated(s, "min(40, katjaQW['horny'])", { location: "KatjaHomeTalk" });
    qspCall(s, 'stat', '');
    ...
    // TODO-QSP: dynamic text: "Okay…" she replies, still not sounding really convinced. "As long as you're fin...
    scene.text('"Okay…" she replies, still not sounding really convinced. "As long as you\'re fine with it. I liked Artem, but there are other boys out there. \'+iif(katjaQW[\'QWstage\'] >= 6, \'Maybe even others we could try together?\', \'You will be fine,\')+\'" she ends in a more cheerful note.');
    if (((s as any).loc ?? 0) === 'katja_dorm') {
      scene.actions([
        { label: 'Stop talking', goto: ['katja_dorm', 'start'] },
      ]);
    ...
    if (((s as any).katjaQW ?? 0)?.['QWstage'] >= 6) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = ((s as any).katjaQW['horny'] ?? 0) + (Math.floor(Math.random() * 21) + 10);
      ...
      scene.text('"There are plenty of other guys around, so\'+iif(pcs_hotcat > 6, \' with your gorgeous looks \', \' \')+\'you will find somebody else," she continues.');
    ...
    scene.actions([
      { label: 'Talk about something else', handler: (st: GameState) => {
    if (((s as any).katjaQW ?? 0)?.['horny'] > (Math.floor(Math.random() * 31) + 70)) {
      if (((s as any).katjaQW ?? 0)?.['QWstage'] > 2) {
        scene.actions([{ label: 'Continue', goto: ['KatjaHomeTalk', 'hornykiss'] }]);
      } else {
        scene.actions([{ label: 'Continue', goto: ['KatjaHomeTalk', 'tender_kiss'] }]);
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 6;
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = -(Math.floor(Math.random() * 11) + 20);
    if (((s as any).katjaQW ?? 0)?.['marcus_pussy'] > 0) {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['Marcus_day'] = ((s as any).daystart ?? 0);
    }
    ...
    // TODO-QSP: dynamic text: "I don't care how many boys you sleep with," she continues. '+iif(katjaQW['QWsta...
    scene.text('"I don\'t care how many boys you sleep with," she continues. \'+iif(katjaQW[\'QWstage\'] >= 6, \'"As long as you share some with me,"\', \'"It gives you good stories to tell me,"\')+\' she says in a very low voice.');
    scene.text('You can\'t quite get her tone. Is it a hint of jealousy you detect, and if so, jealous of <i>who?</i> You or the boys she mentioned?');
    if (((s as any).loc ?? 0) === 'katja_dorm') {
      scene.actions([
        { label: 'Stop talking', goto: ['katja_dorm', 'start'] },
...
function enterArtemOpneRelationship(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['park_sex'] > 0) {
    ...
    scene.text('"No. I meant that we could start going to the park again looking for \'+iif(katjaQW[\'park_sex\'] > 1, \'boys\', \'a boy\')+\' to have fun with," she explains.');
  } else {
    ...
    if (((s as any).loc ?? 0) === 'katja_dorm') {
      if (((s as any).katjaQW ?? 0)?.['lazar_uni_meet'] === 1) {
...
function enterMarcusDiscussion(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['knows_artem_is_boyfreind'] === 2) {
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 0  &&  ((s as any).katjaQW ?? 0)?.['knows_artem_is_boyfreind'] === 1) {
  ...
  if (((s as any).Marcus_sextype ?? 0) > 0) {
    ...
    scene.text(`Katja looks at you pleadingly with her big eyes. "Please ${((s as any).pcs_nickname ?? 0)}. I don't know how to seduce a boy. You are much better at such things, couldn't you seduce him first?"`);

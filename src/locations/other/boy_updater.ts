...
function enterHomeImgUpdate(s: GameState, scene: SceneBuilder): void {
  if (((s as any).home_img_update ?? 0)?.[String((s as any).npcID ?? 0)] !== 21062026) {
    ...
    if (((s as any).npc_apt_guest_bathroom ?? 0)?.[String((s as any).npcID ?? 0)] !== '') {
      ((s as any).npc_apt_guest_bathroom ?? {})[String((s as any).npcID ?? 0)] = '<img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="images/shared/romance/lovers/homes/<<$temp[\'update_folder\']>>/<<npc_apt_number[$npcID]>>/bathg.jpg">';
    }
    if (((s as any).npc_apt_office ?? 0)?.[String((s as any).npcID ?? 0)] !== '') {
      ((s as any).npc_apt_office ?? {})[String((s as any).npcID ?? 0)] = '<img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="images/shared/romance/lovers/homes/<<$temp[\'update_folder\']>>/<<npc_apt_number[$npcID]>>/office.jpg">';
    }
    if (((s as any).npc_apt_pool ?? 0)?.[String((s as any).npcID ?? 0)] !== '') {
      ((s as any).npc_apt_pool ?? {})[String((s as any).npcID ?? 0)] = '<img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="images/shared/romance/lovers/homes/<<$temp[\'update_folder\']>>/<<npc_apt_number[$npcID]>>/pool.jpg">';
    }
    if (((s as any).npc_apt_sauna ?? 0)?.[String((s as any).npcID ?? 0)] !== '') {
      ((s as any).npc_apt_sauna ?? {})[String((s as any).npcID ?? 0)] = '<img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="images/shared/romance/lovers/homes/<<$temp[\'update_folder\']>>/<<npc_apt_number[$npcID]>>/sauna.jpg">';
    }
    if (((s as any).npc_apt_spare ?? 0)?.[String((s as any).npcID ?? 0)] !== '') {
      ((s as any).npc_apt_spare ?? {})[String((s as any).npcID ?? 0)] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="<<$npcgeneratecVars[\'home_path\']>>/<<$temp[\'update_folder\']>>/<<npc_apt_number[$ARGS[1]]>>/<<$npc_apt_sparetype[$ARGS[1]]>>.jpg"></center>';
    }
  }
  scene.build();
}
...
function enterScheduleUpdate(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_start_free_time ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    if (((s as any).npc_finance ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
      if ((Math.floor(Math.random() * 3) + 1) === 1) {
        ((s as any).npc_start_free_time ?? {})[String((s as any).npcID ?? 0)] = 8;
        ((s as any).npc_end_free_time ?? {})[String((s as any).npcID ?? 0)] = 12;
        ((s as any).npc_work_start ?? {})[String((s as any).npcID ?? 0)] = 13;
        ((s as any).npc_work_end ?? {})[String((s as any).npcID ?? 0)] = 21;
      } else {
        if ((Math.floor(Math.random() * 2) + 1) === 1) {
          ((s as any).npc_start_free_time ?? {})[String((s as any).npcID ?? 0)] = 15;
          ((s as any).npc_end_free_time ?? {})[String((s as any).npcID ?? 0)] = 20;
          ((s as any).npc_work_start ?? {})[String((s as any).npcID ?? 0)] = 6;
          ((s as any).npc_work_end ?? {})[String((s as any).npcID ?? 0)] = 14;
        } else {
          ((s as any).npc_start_free_time ?? {})[String((s as any).npcID ?? 0)] = 18;
          ((s as any).npc_end_free_time ?? {})[String((s as any).npcID ?? 0)] = 22;
          ((s as any).npc_work_start ?? {})[String((s as any).npcID ?? 0)] = 9;
          ((s as any).npc_work_end ?? {})[String((s as any).npcID ?? 0)] = 17;
        }
      }
      ((s as any).npc_day_off ?? {})[String((s as any).npcID ?? 0)] = Math.floor(Math.random() * 7) + 1;
    } else {
...
function enterKolkaSeed(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_sex_ev_seeded ?? 0)?.['A134'] !== 1) {
    ((s as any).npc_sex_ev_seeded ?? {})['A134'] = 1;
    ((s as any).npc_rel_type ?? {})['A134'] = 'fuckbuddy';
    ((s as any).npc_apt_bedroom ?? {})['A134'] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="images/locations/pavlovsk/resident/apartment/home/bedrpar.jpg"></center>';
    ((s as any).npc_humor ?? {})['A134'] = 'perverted';
    ((s as any).npc_smoker ?? {})['A134'] = 0;
    ((s as any).npc_latesleeper ?? {})['A134'] = 1;
    ((s as any).npc_risktaker ?? {})['A134'] = 1;
    ((s as any).npc_no_condoms ?? {})[String((s as any).npcID ?? 0)] = 2;
    ((s as any).npc_messy ?? {})['A134'] = 1;
    ((s as any).npc_arrogant ?? {})['A134'] = 1;
    ((s as any).npc_fav_pos ?? {})['A134'] = 'miss';
    ((s as any).npc_sex_speed ?? {})['A134'] = 2;
    ((s as any).npc_dirty_lover ?? {})['A134'] = 1;
    ((s as any).npc_cum_pref ?? {})['A134'] = 'creampie';
    ((s as any).npc_tit_pref ?? {})['A134'] = 3;
    ((s as any).npc_bush_pref ?? {})['A134'] = 1;
    ((s as any).npc_fav_body_part ?? {})['A134'] = 'tits';
    ((s as any).npc_sexdrive ?? {})['A134'] = 4;
...
function enterVasilySeed(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_sex_ev_seeded ?? 0)?.['A11'] !== 1) {
    ((s as any).npc_sex_ev_seeded ?? {})['A11'] = 1;
    ((s as any).npc_rel_type ?? {})['A11'] = 'fuckbuddy';
    ((s as any).npc_apt_bedroom ?? {})['A11'] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="images/locations/pavlovsk/resident/apartment/shulginhome/vasily_room.jpg"></center>';
    ((s as any).npc_apt_kitchen ?? {})['A11'] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="images/locations/pavlovsk/resident/apartment/shulginhome/kuh.jpg"></center>';
    ((s as any).npc_apt_livingroom ?? {})['A11'] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="images/locations/pavlovsk/resident/apartment/shulginhome/bigroom.jpg"></center>';
    ((s as any).npc_apt_bathroom ?? {})['A11'] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="images/locations/pavlovsk/resident/apartment/shulginhome/vanna.jpg"></center>';
    ((s as any).npc_apt_hall ?? {})['A11'] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "boy_updater" }) + ' src="images/locations/pavlovsk/resident/apartment/shulginhome/korr.jpg"></center>';
    ((s as any).npc_humor ?? {})['A11'] = 'perverted';
    ((s as any).npc_smoker ?? {})['A11'] = 2;
    ((s as any).npc_latesleeper ?? {})['A11'] = 1;
    ((s as any).npc_risktaker ?? {})['A11'] = 1;
    ((s as any).npc_messy ?? {})['A11'] = 1;
    ((s as any).npc_arrogant ?? {})['A11'] = 1;
    ((s as any).npc_fav_pos ?? {})['A11'] = 'doggy';
    ((s as any).npc_sex_speed ?? {})['A11'] = 2;
    ((s as any).npc_dirty_lover ?? {})['A11'] = 1;
    ((s as any).npc_cum_pref ?? {})['A11'] = 'creampie';
    qspCall(s, 'npc_set_preference', 'A11', 'body_tits_big', 'like');
    qspCall(s, 'npc_set_preference', 'A11', 'hair_pubes_shaven', 'like');
    ((s as any).npc_fav_body_part ?? {})['A11'] = 'tits';

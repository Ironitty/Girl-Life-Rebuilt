...
function enterChat(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).dimaFilm ?? 0) > 0  &&  ((s as any).artemQW ?? 0)?.['artlie'] === 0  &&  ((s as any).artemQW ?? 0)?.['dimkahelp'] !== ((s as any).daystart ?? 0)) {
    ...
    ((s as any).artemQW = (s as any).artemQW ?? {})['artlie'] = 1;
    ((s as any).artemQW = (s as any).artemQW ?? {})['dimkahelp'] = ((s as any).daystart ?? 0);
    scene.img('images/characters/shared/headshots_main/big2.jpg');
    ...
    if (((s as any).artemQW ?? 0)?.['artlie'] === 1  &&  ((s as any).artemQW ?? 0)?.['dimkahelp'] !== ((s as any).daystart ?? 0)  &&  ((s as any).dimaRevChoice ?? 0) !== 6) {
      ...
      ((s as any).artemQW = (s as any).artemQW ?? {})['artlie'] = 2;
      ...
      if (((s as any).artemQW ?? 0)?.['artlie'] === -1  &&  ((s as any).artemQW ?? 0)?.['dimka'] !== 1  &&  ((s as any).artemQW ?? 0)?.['dimkahelp'] !== ((s as any).daystart ?? 0)) {
        ((s as any).artemQW = (s as any).artemQW ?? {})['dimka'] = 1;
        (s as any).DimaRudeBlock = 1;
        scene.img('images/characters/shared/headshots_main/big2.jpg');
    ...
    scene.actions([
      ...
      { label: 'Stop talking', goto: ['artemhome', 'artemroom'] },
        ...
        if (((s as any).artemQW ?? 0)?.['slutlove'] === 0  &&  ((s as any).artemQW ?? 0)?.['sveslut'] === 0  &&  ((s as any).artemQW ?? 0)?.['artemlove'] === 1  &&  ((s as any).fame ?? 0)?.['pav_slut'] >= 250  &&  ((s as any).grupTipe ?? 0) === 5) {
          ...
          scene.text(`Artem looks at you questioningly. "${((s as any).pcs_nickname || '')}…"`);
          ...
          scene.text(`Artem keeps hugging you. "${((s as any).pcs_nickname || '')}, I…"`);
          // TODO-QSP: dynamic text: You break away from him and shout hysterically. "What do you mean, '<<$pcs_nickn...
          scene.text(`You break away from him and shout hysterically. "What do you mean, '${((s as any).pcs_nickname || '')}'?! No one calls me that anymore! It's just '${((s as any).gnikname || '')}' now…"`);
          ...
          scene.text(`You hear his voice crack when he tries to reassure you. "${((s as any).pcs_nickname || '')}, please calm down! We'll figure something out! Just give it some time…"`);
    ...
    ((s as any).artemQW = (s as any).artemQW ?? {})['slutlove'] = 1;
    ...
    scene.text(`"I love you too, ${((s as any).pcs_nickname || '')}," he replies.`);
    ...
    ((s as any).artemQW = (s as any).artemQW ?? {})['sveslut'] = 1;
    ...
    scene.text(`Artem looks at you questioningly. "${((s as any).pcs_nickname || '')}, what are you doing?"`);
    ...
    // TODO-QSP: artemQW['artemblok'] = 1
          ...
          if (((s as any).artemQW ?? 0)?.['date'] === 0  &&  ((s as any).artemQW ?? 0)?.['artfall'] >= 10  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 150  &&  ((s as any).artemQW ?? 0)?.['dateask'] !== ((s as any).daystart ?? 0)) {
            ...
            scene.text(`Artem smiles at you. "${((s as any).pcs_nickname || '')}, do you want to go for a walk in the park?"`);
            scene.actions([
              { label: 'Stay here', handler: (st: GameState) => {
    ((s as any).artemQW = (s as any).artemQW ?? {})['artfall'] = ((s as any).artemQW['artfall'] ?? 0) - (4);
    ...
    scene.actions([
      { label: 'Walk in the park', goto: ['artem_date_events', 'firstdate'] },
            ...
            if (((s as any).artemQW ?? 0)?.['date'] > 0  &&  ((s as any).artemQW ?? 0)?.['date'] <= 3  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 150  &&  ((s as any).artemQW ?? 0)?.['dateask'] !== ((s as any).daystart ?? 0)) {
              ...
              scene.text(`Artem smiles at you. "${((s as any).pcs_nickname || '')}, would you like to go out on a date?"`);
              scene.actions([
                { label: 'Stay here', handler: (st: GameState) => {
    ...
    scene.text(`He leans in and kisses you before you can pull away and gently caresses your ${((s as any).titsize || '')} breasts through your clothes.`);
    (s as any).minut = ((s as any).minut ?? 0) + 2;
    qspCall(s, 'stat', '');
      ...
      { label: 'Go on a date', goto: ['artem_date_events', 'artem_date'] },
                    ...
                    if (((s as any).artemQW ?? 0)?.['date'] >= 9  &&  ((s as any).artemQW ?? 0)?.['dateask'] !== ((s as any).daystart ?? 0)  &&  ((s as any).artemQW ?? 0)?.['bf'] === 0) {
                      ...
                      if (((s as any).fame ?? 0)?.['pav_slut'] >= 200  ||  ((s as any).grupTipe ?? 0) === 4) {
                        ...
                        scene.text(`Artem reassures you. "Relax, ${((s as any).pcs_nickname || '')}. My parents are leaving to see a friend and I got the wine from my uncle. So please… Let's just sit down and chat?"`);
                      } else {
                        // TODO-QSP: dynamic text: Artem reassures you. "Relax, <<$pcs_nickname>>. My parents are leaving to see a ...
                        scene.text(`Artem reassures you. "Relax, ${((s as any).pcs_nickname || '')}. My parents are leaving to see a friend to give us some privacy. And my mom gave me that wine, to share with you! My parents are very happy I met you, and my mother picked the wine. So please… Let's just sit down and chat?"`);
                      }
                      ...
                      scene.text(`After you've drank most of the wine and talked for a while, Artem is silent for a few seconds before he nervously works up his courage. "${((s as any).pcs_nickname || '')}… Will you be my girlfriend?"`);
    ...
    ((s as any).artemQW = (s as any).artemQW ?? {})['artembrokenheart'] = 1;
    ...
    ((s as any).artemQW = (s as any).artemQW ?? {})['bf'] = 1;
    qspCall(s, 'npc_relationship', 'modify', 'A2', 'adore');
    ...
    scene.text(`"You just made me the happiest guy in the world! I love you, ${((s as any).pcs_nickname || '')}!"`);
    scene.actions([
      { label: 'Tell him you love him too', handler: (st: GameState) => {
    qspCall(s, 'npc_relationship', 'modify', 'A2', 'adore');
    ((s as any).artemQW = (s as any).artemQW ?? {})['artemlove'] = 1;
    scene.img('images/characters/pavlovsk/school/boy/artem/hugging.jpg');
    ...
    if (((s as any).artemQW ?? 0)?.['confidence'] + Math.max(5*(((s as any).artemQW ?? 0)?.['nush3some'] + ((s as any).artemQW ?? 0)?.['katja_threesome'] -3), Math.min(5, ((s as any).artemQW ?? 0)?.['artem_dom']/4)) >= 20) {
      ((s as any).artemQW = (s as any).artemQW ?? {})['artem_open_relationship'] = 1;
      ...
      if (((s as any).artemQW ?? 0)?.['confidence'] < 10) {
        if (((s as any).artemQW ?? 0)?.['strapon_count'] < 10) {
          ...
          ((s as any).artemQW = (s as any).artemQW ?? {})['artem_sub'] = 1;
          ((s as any).artemQW = (s as any).artemQW ?? {})['artem_open_relationship'] = 1;
          ((s as any).artemQW = (s as any).artemQW ?? {})['artem_dom'] = (-1);
    ...
    ((s as any).artemQW = (s as any).artemQW ?? {})['bf'] = 0;
    ((s as any).artemQW = (s as any).artemQW ?? {})['artembrokenheart'] = 1;
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    ((s as any).artemQW = (s as any).artemQW ?? {})['4some_kat_nush'] = 1;
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/school/boy/artem/talk.jpg');
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    ((s as any).artemQW = (s as any).artemQW ?? {})['katja_threesome_talk'] = 1;
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/school/boy/artem/talk.jpg');
    ...
    ((s as any).artemQW = (s as any).artemQW ?? {})['nush3some'] = ((s as any).artemQW['nush3some'] ?? 0) + (1);
    ...
    scene.actions([
      { label: 'Wait for Anushka', goto: ['artem_nush_sex', 'anushka_3some2'] },
                        ...
                        if (((s as any).artemQW ?? 0)?.['nush_bully_payback'] === -1  &&  ((s as any).artemQW ?? 0)?.['nush_bully_payback_block'] !== ((s as any).daystart ?? 0)) {
                          (s as any).minut = ((s as any).minut ?? 0) + 15;
                          ((s as any).artemQW = (s as any).artemQW ?? {})['nush_bully_payback_block'] = ((s as any).daystart ?? 0);
                          qspCall(s, 'stat', '');
                          scene.img('images/characters/pavlovsk/school/boy/artem/talk.jpg');
    ...
    if (((s as any).rex_love ?? 0) === 1) {
      (s as any).boyfriend_temp = 'Rex';
    } else {
      if (((s as any).kotovLoveQW ?? 0) === 1) {
        (s as any).boyfriend_temp = 'Vitek';
      } else {
        if (((s as any).fedorKozlovQW ?? 0) >= 5) {
          (s as any).boyfriend_temp = 'Fedor';
        } else {
          if (((s as any).NikoVolkovQW ?? 0) >= 5) {
            (s as any).boyfriend_temp = 'Niko';
          } else {
            if (((s as any).juliaQW ?? 0)?.['date'] === 1) {
              (s as any).boyfriend_temp = 'Julia';
            } else {
              (s as any).boyfriend_temp = ((s as any).boyfriend ?? 0);
            }
          }
        }
      }
    ...
    ((s as any).artemQW = (s as any).artemQW ?? {})['artfall'] = 0;
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/school/boy/artem/talk.jpg');
    if (((s as any).boyfriend_temp ?? 0) !== 'Julia') {
      ...
      scene.text(`You sigh in a way only those in love can sigh. "Hopefully ${((s as any).boyfriend_temp || '')} and I can get married soon and get our own place."`);
      scene.text('He frowns and shrugs. "Well, I hope you guys are happy."');
    } else {
      // TODO-QSP: dynamic text: You sigh in a way only those in love can sigh. "Hopefully <<$boyfriend_temp>> an...
      scene.text(`You sigh in a way only those in love can sigh. "Hopefully ${((s as any).boyfriend_temp || '')} and I can get a place of our own soon."`);
      // TODO-QSP: dynamic text: "Wait, you're dating <<$boyfriend_temp>>?"
      scene.text(`"Wait, you're dating ${((s as any).boyfriend_temp || '')}?"`);

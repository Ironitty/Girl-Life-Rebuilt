...
function enterToysPaddle(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  s.scene = { ...s.scene, mainText: String((s as any).anna_toys_image5 || ''), curActs: [] };
  ...
  scene.actions([
    ...
    qspCall(st, 'stat', '');
    s.scene = { ...s.scene, mainText: String((st as any).anna_toys_image2 || ''), curActs: [] };
...
function enterToysPaddleOptions(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (st as any).BDSM_Knowledge = ((st as any).BDSM_Knowledge ?? 0) + (1);
    s.scene = { ...s.scene, mainText: String((st as any).anna_toys_image6 || ''), curActs: [] };
    ...
    qspCall(st, 'stat', '');
    s.scene = { ...s.scene, mainText: String((st as any).anna_toys_image7 || ''), curActs: [] };
...
function enterToysVacuum(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'stat', '');
    s.scene = { ...s.scene, mainText: String((st as any).anna_toys_image5 || ''), curActs: [] };
    ...
    ((st as any).AnnaQW = (st as any).AnnaQW ?? {})['sub'] = (((st as any).AnnaQW = (st as any).AnnaQW ?? {})['sub'] ?? 0) + (1);
    ...
    scene.actions([
      { label: 'OK', handler: (st: GameState) => {
    ((st as any).AnnaQW = (st as any).AnnaQW ?? {})['dom'] = (((st as any).AnnaQW = (st as any).AnnaQW ?? {})['dom'] ?? 0) + (1);
...
function enterToysWheel(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'stat', '');
    s.scene = { ...s.scene, mainText: String((st as any).anna_toys_image4 || ''), curActs: [] };
    ...
    scene.actions([
      { label: 'Arousing…', handler: (st: GameState) => {
    qspCall(st, 'stat', '');
    s.scene = { ...s.scene, mainText: String((st as any).anna_toys_image3 || ''), curActs: [] };
    scene.text('"I-i… mmmh… emmmh… good?"');
...
function enterToysImagesClear(s: GameState, scene: SceneBuilder): void {
  (s as any).anna_toys_image2 = undefined;
  (s as any).anna_toys_image3 = undefined;
  (s as any).anna_toys_image4 = undefined;
  (s as any).anna_toys_image5 = undefined;
  (s as any).anna_toys_image6 = undefined;
  (s as any).anna_toys_image7 = undefined;
  scene.build();
}

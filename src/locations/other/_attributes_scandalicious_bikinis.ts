                                                                                                                                        ...
                                                                                                                                        if (String((s as any).locArgs?.[0] ?? '') === 68) {
                                                                                                                                          ...
                                                                                                                                          if (String((s as any).locArgs?.[0] ?? '') === 69) {
                                                                                                                                            ...
                                                                                                                                            if (String((s as any).locArgs?.[0] ?? '') === 70) {
                                                                                                                                              ...
                                                                                                                                              (s as any).CloSwim = 1;
                                                                                                                                              (s as any).CloPrice = 2850;
                                                                                                                                              (s as any).swimwear_description = 'A string bikini set that is perfect for slut wannabes!';
                                                                                                                                            }
                                                                                                                                          }
                                                                                                                                        }
                                                                                                                                      }
...
export const _attributes_scandalicious_bikinis: LocationDef = {
  name: '_attributes_scandalicious_bikinis',
  region: 'other',
  enter: enter,
};

...
function enterAbdCustomerEndPunishment(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(((((s as any).buyout ?? 0) === 1) ? (((s as any).bName ?? '')) : ('The customer')) + ' tells your master how unruly you were and that further training should be applied to you before he leaves.');

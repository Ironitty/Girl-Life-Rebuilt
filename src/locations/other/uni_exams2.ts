...
function enterGeneralEducation_102(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).class = (s as any).class ?? {})['uni_teaching_studies_semester_2_general education 102_exam_done'] = 1;
    if (((s as any).class ?? 0)?.['uni_teaching_studies_semester_2_general education 102_grade'] < 40) {
      ...
      if (((s as any).class ?? 0)?.['uni_teaching_studies_semester_2_general education 102_grade'] < 70) {
        // TODO-QSP: dynamic text: You think that you did good enough to pass, and are probably going to get a <<$c...
        scene.text(`You think that you did good enough to pass, and are probably going to get a ${((s as any).class_grade_desc ?? 0)?.['uni_teaching_studies_semester_1_general education 102_grade'] ?? ''}.`);
      } else {
        if (((s as any).class ?? 0)?.['uni_teaching_studies_semester_2_general education 102_grade'] < 90) {
          // TODO-QSP: dynamic text: You think you did pretty well and are going to get an <<$class_grade_desc['uni_t...
          scene.text(`You think you did pretty well and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_teaching_studies_semester_1_general education 102_grade'] ?? ''}.`);
        } else {
          // TODO-QSP: dynamic text: You're sure you did extremely well on the exam and are going to get an <<$class_...
          scene.text(`You're sure you did extremely well on the exam and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_teaching_studies_semester_1_general education 102_grade'] ?? ''}.`);
        }
      }
    }
    scene.actions([
...
function enterTeachingMethods_102(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.img(`images/locations/city/island/university/classroom/exam${Math.floor(Math.random() * 3) + 1}.jpg`);
    qspCall(s, 'grades', 'assign_grade_description', 'uni_teaching_studies_semester_1');
    ((s as any).class = (s as any).class ?? {})['uni_teaching_studies_semester_2_teaching methods 102_exam_done'] = 1;
    if (((s as any).class ?? 0)?.['uni_teaching_studies_semester_2_teaching methods 102_grade'] < 40) {
      ...
      if (((s as any).class ?? 0)?.['uni_teaching_studies_semester_2_teaching methods 102_grade'] < 70) {
        // TODO-QSP: dynamic text: You think that you did good enough to pass, and are probably going to get a <<$c...
        scene.text(`You think that you did good enough to pass, and are probably going to get a ${((s as any).class_grade_desc ?? 0)?.['uni_teaching_studies_semester_1_teaching methods 102_grade'] ?? ''}.`);
      } else {
        if (((s as any).class ?? 0)?.['uni_teaching_studies_semester_2_teaching methods 102_grade'] < 90) {
          // TODO-QSP: dynamic text: You think you did pretty well and are going to get an <<$class_grade_desc['uni_t...
          scene.text(`You think you did pretty well and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_teaching_studies_semester_1_teaching methods 102_grade'] ?? ''}.`);
        } else {
          // TODO-QSP: dynamic text: You're sure you did extremely well on the exam and are going to get an <<$class_...
          scene.text(`You're sure you did extremely well on the exam and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_teaching_studies_semester_1_teaching methods 102_grade'] ?? ''}.`);
        }
      }
    }
    scene.actions([
...
function enterPsychologyOfAStudent_101(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.img(`images/locations/city/island/university/classroom/exam${Math.floor(Math.random() * 3) + 1}.jpg`);
    qspCall(s, 'grades', 'assign_grade_description', 'uni_teaching_studies_semester_1');
    ((s as any).class = (s as any).class ?? {})['uni_teaching_studies_semester_2_psychology of a student 101_exam_done'] = 1;
    if (((s as any).class ?? 0)?.['uni_teaching_studies_semester_2_psychology of a student 101_grade'] < 40) {
      ...
      if (((s as any).class ?? 0)?.['uni_teaching_studies_semester_2_psychology of a student 101_grade'] < 70) {
        // TODO-QSP: dynamic text: You think that you did good enough to pass, and are probably going to get a <<$c...
        ...
        if (((s as any).class ?? 0)?.['uni_teaching_studies_semester_2_psychology of a student 101_grade'] < 90) {
          // TODO-QSP: dynamic text: You think you did pretty well and are going to get an <<$class_grade_desc['uni_t...
          ...
          scene.text(`You're sure you did extremely well and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_teaching_studies_semester_1_learning theories 101_grade'] ?? ''}.`);
        }
      }
    }
    scene.actions([
...
function enterPatientCare_102(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).class = (s as any).class ?? {})['uni_nursing_semester_2_patient care 102_exam_done'] = 1;
    if (((s as any).class ?? 0)?.['uni_nursing_semester_2_patient care 102_grade'] < 40) {
      ...
      if (((s as any).class ?? 0)?.['uni_nursing_semester_2_patient_care 102_grade'] < 70) {
        // TODO-QSP: dynamic text: You think that you did good enough to pass, and are probably going to get a <<$c...
        scene.text(`You think that you did good enough to pass, and are probably going to get a ${((s as any).class_grade_desc ?? 0)?.['uni_nursing_semester_2_patient care 102_grade'] ?? ''}.`);
      } else {
        if (((s as any).class ?? 0)?.['uni_nursing_semester_2_patient_care 102_grade'] < 90) {
          // TODO-QSP: dynamic text: You think you did pretty well and are going to get an <<$class_grade_desc['uni_n...
          scene.text(`You think you did pretty well and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_nursing_semester_2_patient care 102_grade'] ?? ''}.`);
        } else {
          // TODO-QSP: dynamic text: You're sure you did extremely well on the exam and are going to get an <<$class_...
          scene.text(`You're sure you did extremely well on the exam and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_nursing_semester_2_patient care 102_grade'] ?? ''}.`);
        }
      }
    }
    scene.actions([
...
function enterAnatomyAndPhysiology_102(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.img(`images/locations/city/island/university/classroom/exam${Math.floor(Math.random() * 3) + 1}.jpg`);
    qspCall(s, 'grades', 'assign_grade_description', 'uni_nursing_semester_2');
    ((s as any).class = (s as any).class ?? {})['uni_nursing_semester_2_anatomy and physiology 102_exam_done'] = 1;
    if (((s as any).class ?? 0)?.['uni_nursing_semester_2_anatomy  &&  physiology 102_grade'] < 40) {
      ...
      if (((s as any).class ?? 0)?.['uni_nursing_semester_2_anatomy  &&  physiology 102_grade'] < 70) {
        // TODO-QSP: dynamic text: You think that you did good enough to pass, and are probably going to get a <<$c...
        scene.text(`You think that you did good enough to pass, and are probably going to get a ${((s as any).class_grade_desc ?? 0)?.['uni_nursing_semester_2_anatomy and physiology 102_grade'] ?? ''}.`);
      } else {
        if (((s as any).class ?? 0)?.['uni_nursing_semester_2_anatomy  &&  physiology 102_grade'] < 90) {
          // TODO-QSP: dynamic text: You think you did pretty well and are going to get an <<$class_grade_desc['uni_n...
          scene.text(`You think you did pretty well and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_nursing_semester_2_anatomy and physiology 102_grade'] ?? ''}.`);
        } else {
          // TODO-QSP: dynamic text: You're sure you did extremely well on the exam and are going to get an <<$class_...
          scene.text(`You're sure you did extremely well on the exam and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_nursing_semester_2_anatomy and physiology 102_grade'] ?? ''}.`);
        }
      }
    }
    scene.actions([
...
function enterExaminationAndTreatment_102(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.img(`images/locations/city/island/university/classroom/exam${Math.floor(Math.random() * 3) + 1}.jpg`);
    qspCall(s, 'grades', 'assign_grade_description', 'uni_nursing_semester_2');
    ((s as any).class = (s as any).class ?? {})['uni_nursing_semester_2_examination and treatment 102_exam_done'] = 1;
    if (((s as any).class ?? 0)?.['uni_nursing_semester_2_examination  &&  treatment 102_grade'] < 40) {
      ...
      if (((s as any).class ?? 0)?.['uni_nursing_semester_2_examination  &&  treatment 102_grade'] < 70) {
        // TODO-QSP: dynamic text: You think that you did good enough to pass, and are probably going to get a <<$c...
        scene.text(`You think that you did good enough to pass, and are probably going to get a ${((s as any).class_grade_desc ?? 0)?.['uni_nursing_semester_2_examination and treatment 102_grade'] ?? ''}.`);
      } else {
        if (((s as any).class ?? 0)?.['uni_nursing_semester_2_examination  &&  treatment 102_grade'] < 90) {
          // TODO-QSP: dynamic text: You think you did pretty well and are going to get an <<$class_grade_desc['uni_n...
          scene.text(`You think you did pretty well and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_nursing_semester_2_examination and treatment 102_grade'] ?? ''}.`);
        } else {
          // TODO-QSP: dynamic text: You're sure you did extremely well and are going to get an <<$class_grade_desc['...
          scene.text(`You're sure you did extremely well and are going to get an ${((s as any).class_grade_desc ?? 0)?.['uni_nursing_semester_2_examination and treatment 102_grade'] ?? ''}.`);
        }
      }
    }
    scene.actions([

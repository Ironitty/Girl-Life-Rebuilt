...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'stat', '');
    // TODO-QSP: dynamic text: Seeing that <<$boydesc>> brought you to his crappy hostel, you''re not so sure a...
    scene.text(`Seeing that ${((st as any).boydesc || '')} brought you to his crappy hostel, you're not so sure about this any more. You've heard lots of stories about girls being taken to this place… none of them good. On the other hand, ${((st as any).boydesc || '')} is kind of cute. What's the worst that could happen? You can always leave, if you don't like what's happening in there.`);

...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? 0)} leads you towards the shabby hostel in Pavlovsk, and smiles at you: "Come on, let's go to my room."`);
  scene.actions([
    ...
    scene.text(`Seeing that ${((s as any).boydesc ?? 0)} brought you to his crappy hostel, you're not so sure about this any more. You've heard lots of stories about girls being taken to this place… none of them good. On the other hand, ${((s as any).boydesc ?? 0)} is kind of cute. What's the worst that could happen? You can always leave, if you don't like what's happening in there.`);

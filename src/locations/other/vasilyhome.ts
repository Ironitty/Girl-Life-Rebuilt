...
function enterVasilyBeer(s: GameState, scene: SceneBuilder): void {
  if (((s as any).alko ?? 0) < 6) {
    ...
    scene.text(String(qspFunc(s, 'gopsex', 'hide', "gop_text_beer2") || ''));

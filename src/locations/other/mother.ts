...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hour ?? 0) > 5) {
    ...
    if (((s as any).gschoolVars ?? 0)?.['school_diploma'] === 0) {
      if (((s as any).motherPayDay ?? 0) === ((s as any).daystart ?? 0)) {
        ...
        if (((s as any).npc_rel ?? 0)?.['A29'] >= 40) {
          ...
          if (((s as any).class ?? 0)?.['school_grade_average'] >= 90) {
            ...
            scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} smiles and gives you ${qspFunc(s, 'money', 'string_profit', ((s as any).moneyfrommom90 || ''))}. "Okay ${((s as any).pcs_nickname || '')}, you've earned it. I'm glad you're doing such a good job in school."`);
            scene.actions([
              { label: 'Thank her', goto: ['mother', ''] },
            ]);
          } else {
            if (((s as any).class ?? 0)?.['school_grade_average'] >= 70) {
              ...
              scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} reluctantly gives you ${qspFunc(s, 'money', 'string_profit', ((s as any).moneyfrommom70 || ''))}. "When you do better in school, I'll give you more. In the meantime, this is all you deserve!"`);
              scene.actions([
                { label: 'Thank her', goto: ['mother', ''] },
              ]);
            } else {
      ...
      scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} shakes her head. "You're old enough to earn your own money, ${((s as any).pcs_nickname || '')}! You can't keep depending on me forever, so go and get a job."`);
      scene.actions([
        { label: 'Continue', goto: ['mother', ''] },
      ]);
    }
    ...
    dynamicGoto(st, 'loc', 'loc_arg');
      ...
      if (((s as any).gschoolVars ?? 0)?.['school_diploma']) {
        ...
        if (((s as any).npc_rel ?? 0)?.['A29'] < 80) {
          ...
          scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} shakes her head. "Sorry ${((s as any).pcs_nickname || '')}, but money is tight right now. We just can't afford it."`);
          scene.actions([
            { label: 'Continue', goto: ['mother', ''] },
          ]);
        } else {
          if (((s as any).motherClotheMonth ?? 0) === ((s as any).month ?? 0)) {
            ...
            scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} shakes her head. "Sorry ${((s as any).pcs_nickname || '')}, our budget is limited and we already went clothes shopping this month. You'll have to manage with what you have in your closet for a little while. Maybe we can go again next month."`);
            scene.actions([
              { label: 'Continue', goto: ['mother', ''] },
            ]);
          } else {
            ...
            scene.text(`You both laugh. "Alright then ${((s as any).pcs_nickname || '')}, let's go see if we can find something."`);
            scene.actions([
    ...
    if (((s as any).loop_counter ?? 0) === 10) {
      ...
      if ((!(Math.floor(Math.random() * 2) + 0))) {
        ...
        scene.img(`images/pc/items/gm/dress/${((s as any).numrand || '')}.jpg`);
      } else {
        (s as any).numrand = Math.floor(Math.random() * 150) + 1;
        ...
        scene.img(`images/pc/items/gm/outfits/${((s as any).numrand || '')}.jpg`);
      }
              ...
              if (((s as any).MomPom ?? 0) === 6) {
                ...
                if (((s as any).MomPom ?? 0) === 7) {
                  if (((s as any).hour ?? 0) < 19) {
                    ...
                    scene.text(`When you enter the pharmacy, you see her behind the counter and she smiles when she sees you. "Hello ${((s as any).pcs_nickname || '')}, how are you? I hope everything is okay?"`);
                    ...
                    scene.text(`She quickly gathers the items into a paper bag and hands it over to you. "Here you go, ${((s as any).pcs_nickname || '')}. Have a nice day and tell your mother I said hello!"`);
    ...
    if (((s as any).loc ?? 0) === 'kuhrPar') {
      if (((s as any).npc_rel ?? 0)?.['A29'] < 80) {
        ...
        scene.text(`You seem to have struck a sore spot. Your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''}'s face saddens, and it takes her some time to reply. "${((s as any).pcs_nickname || '')}, I don't want to talk about him, it brings back too many bad memories. Just know that Vladimir raised you and Anya as if you were his own daughters."`);
      } else {
        // TODO-QSP: dynamic text: You have no memories of your real father, and are curious about him. When you se...
        scene.text(`You have no memories of your real father, and are curious about him. When you see your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} in the kitchen, you decide to ask. "${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''}… About my real father… What was he like? What happened between you two?"`);
        // TODO-QSP: dynamic text: You seem to have struck a sore spot. Your <<$npc_nickname['A29']>>'s face sadden...
...
function enterHypnoPregReact(s: GameState, scene: SceneBuilder): void {
  if (qspFunc(s, 'body_din', 'pregnancyVisibility') === 1) {
    ...
    scene.text(`Tears are slowly forming in her eyes. "${((s as any).pcs_nickname || '')}… Oh no… I was afraid this would happen… Why did this happen…"`);
    // TODO-QSP: dynamic text: She stares at you through her tears, trying to think of what to say next before ...
    scene.text(`She stares at you through her tears, trying to think of what to say next before she realizes that you need her to be on your side. "I know it will be difficult, but you <i>must</i> have this child, ${((s as any).pcs_nickname || '')}. If you have an abortion now, it will be much more difficult to have children in the future. You can't risk ending up barren, do you understand?"`);
...
function enterPregreact(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pregTalkFamily ?? 0) === 0  &&  ((s as any).npc_pregtalk ?? 0)?.['A29'] === 0  &&  (!((s as any).kid ?? 0))) {
    ...
    // TODO-QSP: dynamic text: She stares at you through her tears, trying to think of what to say next before ...
    scene.text(`She stares at you through her tears, trying to think of what to say next before she realizes that you need her to be on your side. "You <i>must</i> have this child, ${((s as any).pcs_nickname || '')}. If you have an abortion now, it will be much more difficult to have children in the future. This has to be the last though, do you understand?"`);
    // TODO-QSP: dynamic text: You're not quite sure about that just yet, but you see the concern on her face a...
    ...
    scene.text(`She stares at you for a good ten seconds through her tears, trying to think of what to say next before she realizes that you need her to be on your side. "You <i>must</i> have this child, ${((s as any).pcs_nickname || '')}. If you have an abortion now, it will be much more difficult to have children in the future. This has to be the last though, do you understand?"`);
    // TODO-QSP: dynamic text: You're not quite sure about that just yet, but you see the concern on her face a...
    scene.text(`You're not quite sure about that just yet, but you see the concern on her face and figure the best thing you can do right now is just nod and give her a hug. "I understand, ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''}…"`);
    scene.text('"We\'ll get through this together," she reassures you while returning your hug. Despite her supportive attitude, you can tell she\'s very disappointed in you. You\'ll have to put in some work if you want to get back on her good side.');
    scene.text('"Go and put on some clothes and then come back to talk to me. I need you to tell me who the father is."');
...
function enterAbortionTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} immediately stops what she's doing and comes over to you. "Oh ${((s as any).pcs_nickname || '')}! Are you sure? Abortions can be dangerous…"`);
    ...
    scene.text(`Once you've stopped crying, she sits down with you. "${((s as any).pcs_nickname || '')}, you know I love you. I'm here for you and will support you if you go through with this."`);
    ...
    scene.text(`"Well I'm glad you did, ${((s as any).pcs_nickname || '')}. It's too big a burden to keep to yourself. Just please know that I'm here for you. If you change your mind and want me to go with you, just let me know."`);
...
function enterAbortionTalkPreg(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} is torn between her anger and her love for you. After a deep sigh, she comes over to you. "Oh ${((s as any).pcs_nickname || '')}! Are you sure? Abortions can be dangerous…"`);
...
function enterMotherQW_2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"${((s as any).pcs_firstname || '')} ${((s as any).pcs_lastname || '')}!"`);
    ...
    if (((s as any).age ?? 0) === 16) {
      ...
      scene.text(`"I'm not an idiot, ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''}! You're ${((s as any).motherAge || '')} and Anya is ${((s as any).sisterAge || '')}. That means you were the same age as me when you got pregnant with her!"`);
    } else {
      // TODO-QSP: dynamic text: "I'm not an idiot, <<$npc_nickname['A29']>>! You're <<motherAge>> and Anya is <<...
      scene.text(`"I'm not an idiot, ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''}! You're ${((s as any).motherAge || '')} and Anya is ${((s as any).sisterAge || '')}. That means you were even younger than me when you got pregnant with her!"`);
    }
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}! Do not swear!"`);
    ...
    scene.text(`Just as you're about to leave the kitchen, your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} calls out for you. "${((s as any).pcs_nickname || '')}, wait!"`);
...
function enterCondomFind(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).motherKnowSpravka ?? 0) === 1  ||  ((s as any).motherKnowWhore ?? 0) === 1) {
    ...
    scene.text(`Seeing you react strongly, your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} eases up. "I'm sorry ${((s as any).pcs_nickname || '')}, I just thought the worst when I seen them… It still doesn't explain why you would steal them in the first place though."`);
    ...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} eyes widen and go dark. "What the hell, ${((s as any).pcs_nickname || '')}?! How many times have we talked about this? I don't know what to even say to you right now, I'm so mad!"`);
    ...
    scene.text('"Absolutely not! I\'m still a virgin! How could you even accuse me of something like that?!" you shout back, clearly upset.');
    // TODO-QSP: dynamic text: Seeing you react strongly, your <<$npc_nickname['A29']>> eases up. "I'm sorry <<...
    scene.text(`Seeing you react strongly, your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} eases up. "I'm sorry ${((s as any).pcs_nickname || '')}, I just thought the worst when I seen them… It still doesn't explain why you had them in the first place, though!"`);
      ...
      if (((s as any).mc_inventory ?? 0)?.['dildo_small'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_normal'] === 1) {
        ...
        if (((s as any).mc_inventory ?? 0)?.['dildo_big'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_large'] === 1) {
          ...
          if (((s as any).mc_inventory ?? 0)?.['dildo_huge'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_enormous'] === 1) {
            ...
            scene.text(`"What were you thinking, ${((s as any).pcs_nickname || '')}?! This would ruin you forever! I forbid you from even trying to use this!"`);
          }
        }
      }
      ...
      if (((s as any).mc_inventory ?? 0)?.['dildo_small'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_normal'] === 1) {
        ...
        if (((s as any).mc_inventory ?? 0)?.['dildo_big'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_large'] === 1) {
          ...
          if (((s as any).mc_inventory ?? 0)?.['dildo_huge'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_enormous'] === 1) {
            ...
            scene.text(`"What was your friend thinking, ${((s as any).pcs_nickname || '')}?! This would ruin anyone's lady parts forever! I forbid you from even trying to use this! Which friend gave you this? I need to call and tell her mother too…"`);
          }
        }
      }
      scene.text('You quickly yank the dildo out of her hand. "I don\'t want to talk about it! God, this is so awkward!" you yell as you start blushing.');
...
function enterPlugFind(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_ass ?? 0) > 0) {
    ...
    scene.text(`"Feel what?! How to have something shoved up your butt?!" Your ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} is clearly getting more and more upset. "I expected better than this, ${((s as any).pcs_nickname || '')}! I'm quite disappointed to be honest."`);

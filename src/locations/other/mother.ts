...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hour ?? 0) > 5) {
    ...
    dynamicGoto(st, 'loc', 'loc_arg');
      ...
      if (((s as any).mqwtRand ?? 0) > 2  &&  ((s as any).mqwtRand ?? 0) <= 8) {
...
function enterReferral(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).GspravkaT ?? 0) === 0  &&  ((s as any).GspravkaTimes ?? 0) >= 3  &&  ((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) <= 21) {
    ...
    if (((s as any).GspravkaTimes ?? 0) === 3) {
      ...
      scene.text(`"${((s as any).pcs_nickname ?? 0)}, this is your last chance to go to the clinic and get a written referral from the gynecologist. If you don't go straight away, we'll go together as soon as I have time."`);
      scene.actions([
        { label: 'Continue', goto: ['mother', ''] },
      ]);
    } else {
      if (((s as any).clothingworntype ?? 0) !== 'nude') {
        // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> frowns and gets her handbag. "<<$pcs_nickname>>, w...
        scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} frowns and gets her handbag. "${((s as any).pcs_nickname ?? 0)}, why haven't you been to the gynecologist like I asked? You don't have anything to hide, do you? Come on, we're going there right now."`);
        ...
        // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> frowns and gets her handbag. "<<$pcs_nickname>>, w...
        scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} frowns and gets her handbag. "${((s as any).pcs_nickname ?? 0)}, why haven't you been to the gynecologist like I asked? You don't have anything to hide, do you? Come on, we're going there right now, so get yourself dressed!"`);
        scene.actions([
    ...
    // TODO-QSP: dynamic text: You rush to your room and get dressed, ready to go with your <<$npc_nickname['A2...
    scene.text(`You rush to your room and get dressed, ready to go with your ${((s as any).npc_nickname ?? 0)?.['A29']} to the gynecologist.`);
    ...
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> takes you by the hand and leads you to the clinic,...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} takes you by the hand and leads you to the clinic, ushering you into the gynecologist's office.`);
    scene.actions([
      { label: 'Get a referral from the gynecologist', goto: ['pav_clinic', 'referral'] },
    ]);
  } },
    ...
    if (((s as any).GspravkaT ?? 0) === 0  &&  ((s as any).GspravkaTimes ?? 0) < 3  &&  ((s as any).GspravkaTalked ?? 0) !== ((s as any).daystart ?? 0)  &&  ((s as any).motherKnowDildo ?? 0) !== 1) {
      ...
      scene.text(`"${((s as any).pcs_nickname ?? 0)}, you need to go to the clinic. We need a written referral from the gynecologist for school."`);
      scene.actions([
        { label: 'Continue', goto: ['mother', ''] },
      ]);
    } else {
      if (((s as any).GspravkaT ?? 0) === 0  &&  ((s as any).GspravkaTimes ?? 0) < 3  &&  ((s as any).GspravkaTalked ?? 0) !== ((s as any).daystart ?? 0)  &&  ((s as any).motherKnowDildo ?? 0) === 1) {
        (s as any).GspravkaTalked = ((s as any).daystart ?? 0);
        (s as any).GspravkaTimes = ((s as any).GspravkaTimes ?? 0) + (1);
        // TODO-QSP: dynamic text: "<<$pcs_nickname>>, you need to go to the clinic. I doubt that you're still a vi...
        scene.text(`"${((s as any).pcs_nickname ?? 0)}, you need to go to the clinic. I doubt that you're still a virgin, but we need a written referral from the gynecologist for school anyway."`);
        scene.actions([
          { label: 'Continue', goto: ['mother', ''] },
        ]);
      } else {
...
function enterAmbushReferralPass(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`"${((s as any).pcs_nickname ?? 0)}, I was told you went to the clinic. Let me see your referral."`);
  // TODO-QSP: end
  scene.actions([
...
function enterReferralFail(s: GameState, scene: SceneBuilder): void {
  ...
  if ((!((s as any).motherKnowWhore ?? 0))) {
    ...
    if (((s as any).momslut ?? 0) < 2) {
      (s as any).delin_beh = ((s as any).delin_beh ?? 0) + (1);
      // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> is furious and grabs you by the ear, pulling you o...
    ...
    scene.actions([
      ...
      // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> shakes her head when she reads the referral. "Well...
...
function enterReferralFail1(s: GameState, scene: SceneBuilder): void {
  ...
  if ((!((s as any).motherKnowWhore ?? 0))) {
    ...
    if (((s as any).momslut ?? 0) < 2) {
      (s as any).delin_beh = ((s as any).delin_beh ?? 0) + (1);
      // TODO-QSP: dynamic text: You hand your <<$npc_nickname['A29']>> the referral. She opens it and starts rea...
...
function enterReferralPass(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'npc_relationship', 'modify', 'A29', 10);
  scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
  // TODO-QSP: dynamic text: You hand your <<$npc_nickname['A29']>> the referral. She opens it, closes her ey...
  scene.text(`You hand your ${((s as any).npc_nickname ?? 0)?.['A29']} the referral. She opens it, closes her eyes for a second, and breathes a sigh of relief. "I'm not surprised. You're a good girl ${((s as any).pcs_nickname ?? 0)}, just as I raised you to be."`);
  // TODO-QSP: end
  scene.actions([
    { label: 'Continue', goto: ['mother', ''] },
  ]);
...
function enterDildoGynoFail(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'npc_relationship', 'set', 'A29', 0);
  scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
  // TODO-QSP: dynamic text: You hand your <<$npc_nickname['A29']>> the referral. She opens and reads it, her...
  ...
  // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> continues to babble, not paying any heed to what y...
...
function enterDildoGynoPass(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).Gspassed = 0;
  scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
  // TODO-QSP: dynamic text: You hand your <<$npc_nickname['A29']>> the referral. She opens and reads it befo...
...
function enterHypnoPregReact(s: GameState, scene: SceneBuilder): void {
  if (qspFunc(s, 'body_din', 'pregnancyVisibility') === 1) {
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> looks at your belly, which is clearly visible now....
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} looks at your belly, which is clearly visible now. She's upset, but supportive.`);
    // TODO-QSP: dynamic text: "Oh no <<$pcs_nickname>>, you're pregnant? How far along are you? I know this is...
    scene.text(`"Oh no ${((s as any).pcs_nickname ?? 0)}, you're pregnant? How far along are you? I know this is a difficult time for you, but please don't have an abortion, okay? We'll figure this out."`);
    if (((s as any).clothingworntype ?? 0) !== 'nude') {
    ...
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    // TODO-QSP: dynamic text: You tell your <<$npc_nickname['A29']>> that you're pregnant. She gasps and nearl...
    scene.text(`You tell your ${((s as any).npc_nickname ?? 0)?.['A29']} that you're pregnant. She gasps and nearly falls on the ground, but manages to sit on a stool on time.`);
    // TODO-QSP: dynamic text: Tears are slowly forming in her eyes. "<<$pcs_nickname>>… Oh no… I was afraid th...
    scene.text(`Tears are slowly forming in her eyes. "${((s as any).pcs_nickname ?? 0)}… Oh no… I was afraid this would happen… Why did this happen…"`);
    // TODO-QSP: dynamic text: She stares at you through her tears, trying to think of what to say next before ...
    scene.text(`She stares at you through her tears, trying to think of what to say next before she realizes that you need her to be on your side. "I know it will be difficult, but you <i>must</i> have this child, ${((s as any).pcs_nickname ?? 0)}. If you have an abortion now, it will be much more difficult to have children in the future. You can't risk ending up barren, do you understand?"`);
...
function enterPregreact(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pregTalkFamily ?? 0) === 0  &&  ((s as any).npc_pregtalk ?? 0)?.['A29'] === 0  &&  (!((s as any).kid ?? 0))) {
    if (qspFunc(s, 'body_din', 'pregnancyVisibility') === 1) {
      ...
      // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> looks at your belly, which is clearly visible now....
      scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} looks at your belly, which is clearly visible now. She's upset, but supportive. "Oh no ${((s as any).pcs_nickname ?? 0)}, you're pregnant? How far along are you? I know this is a difficult time for you, but please don't have an abortion, okay? We'll figure this out."`);
      if (((s as any).clothingworntype ?? 0) !== 'nude') {
        scene.text('"I do want to know who the father is, though."');
        scene.actions([
          { label: 'Tell her', handler: (st: GameState) => {
    ...
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    // TODO-QSP: dynamic text: You tell your <<$npc_nickname['A29']>> you're pregnant. She gasps and nearly fal...
    scene.text(`You tell your ${((s as any).npc_nickname ?? 0)?.['A29']} you're pregnant. She gasps and nearly falls on the ground, but manages to sit on a stool right on time.`);
    // TODO-QSP: dynamic text: Tears are slowly forming in her eyes. "<<$pcs_nickname>>… Oh no… I was afraid th...
    scene.text(`Tears are slowly forming in her eyes. "${((s as any).pcs_nickname ?? 0)}… Oh no… I was afraid this would happen… Why did this happen…"`);
    // TODO-QSP: dynamic text: She stares at you through her tears, trying to think of what to say next before ...
    scene.text(`She stares at you through her tears, trying to think of what to say next before she realizes that you need her to be on your side. "I know it will be difficult, but you <i>must</i> have this child ${((s as any).pcs_nickname ?? 0)}. If you have an abortion now, it will be much more difficult to have children in the future. You can't risk ending up barren, do you understand?"`);
    // TODO-QSP: dynamic text: You're not quite sure about that just yet, but you see the concern on her face a...
    scene.text(`You're not quite sure about that just yet, but you see the concern on her face and figure the best thing you can do right now is just nod and give her a hug. "I understand, ${((s as any).npc_nickname ?? 0)?.['A29']}… Is it okay if I come to you for advice from time to time?"`);
    ...
    if (((s as any).pregTalkFamily ?? 0) === 0  &&  ((s as any).npc_pregtalk ?? 0)?.['A29'] === 0  &&  ((s as any).kid ?? 0) > 0) {
      if (qspFunc(s, 'body_din', 'pregnancyVisibility') === 1) {
        ...
        // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> looks at your belly, which is clearly visible now....
        scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} looks at your belly, which is clearly visible now. She's upset, but supportive: "Oh no ${((s as any).pcs_nickname ?? 0)}, you're pregnant again? How far along are you? I know this is a difficult time for you, but please don't have an abortion okay? We'll figure this out."`);
        if (((s as any).clothingworntype ?? 0) !== 'nude') {
          scene.text('"I do want to know who the father is, though."');
          scene.actions([
            { label: 'Tell her', handler: (st: GameState) => {
    ...
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    // TODO-QSP: dynamic text: You tell your <<$npc_nickname['A29']>> you're pregnant. Her eyes widen and tears...
    scene.text(`You tell your ${((s as any).npc_nickname ?? 0)?.['A29']} you're pregnant. Her eyes widen and tears slowly form in her eyes. "<i>Again</i>? You'll ruin your life! Why…"`);
    // TODO-QSP: dynamic text: She stares at you through her tears, trying to think of what to say next before ...
    scene.text(`She stares at you through her tears, trying to think of what to say next before she realizes that you need her to be on your side. "You <i>must</i> have this child, ${((s as any).pcs_nickname ?? 0)}. If you have an abortion now, it will be much more difficult to have children in the future. This has to be the last though, do you understand?"`);
    // TODO-QSP: dynamic text: You're not quite sure about that just yet, but you see the concern on her face a...
    scene.text(`You're not quite sure about that just yet, but you see the concern on her face and figure the best thing you can do right now is just nod and give her a hug. "I understand, ${((s as any).npc_nickname ?? 0)?.['A29']}…"`);
    ...
    scene.text(`She stares at you for a good ten seconds through her tears, trying to think of what to say next before she realizes that you need her to be on your side. "You <i>must</i> have this child, ${((s as any).pcs_nickname ?? 0)}. If you have an abortion now, it will be much more difficult to have children in the future. This has to be the last though, do you understand?"`);
    // TODO-QSP: dynamic text: You're not quite sure about that just yet, but you see the concern on her face a...
    scene.text(`You're not quite sure about that just yet, but you see the concern on her face and figure the best thing you can do right now is just nod and give her a hug. "I understand, ${((s as any).npc_nickname ?? 0)?.['A29']}…"`);
    scene.text('"We\'ll get through this together," she reassures you while returning your hug. Despite her supportive attitude, you can tell she\'s very disappointed in you. You\'ll have to put in some work if you want to get back on her good side.');
    scene.text('"Go and put on some clothes and then come back to talk to me. I need you to tell me who the father is."');
  ...
  if (((s as any).knowpreg ?? 0) === 1  &&  qspFunc(s, 'body_din', 'pregnancyVisibility') === 0) {
    qspCall(s, 'mother', 'abortion_talk_preg');
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterPregreact1Hypno(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_rel ?? 0)?.['A29'] < 60  &&  ((s as any).npc_pregtalk ?? 0)?.['A28'] === 1) {
    ...
    qspCall(s, 'mother', 'kickedout', 'stepdad');
  } else {
    if (((s as any).npc_rel ?? 0)?.['A29'] >= 60  &&  ((s as any).npc_rel ?? 0)?.['A29'] <= 80) {
      ...
      if (((s as any).npc_rel ?? 0)?.['A29'] > 80  &&  (((s as any).npc_pregtalk ?? 0)?.['A28'] === 0  ||  ((s as any).stepdadSecret ?? 0) === 1)) {
        // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> stares at you in stunned silence as you utter Vlad...
        ...
        // TODO-QSP: dynamic text: You weren't going to reply, but your <<$npc_nickname['A29']>> quickly speaks aga...
...
function enterPregreact1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).wombthfathID ?? 0) === 'A34'  &&  ((s as any).npc_rel ?? 0)?.['A34'] > 50  &&  ((s as any).brotherSecret ?? 0) === 1  &&  (!((s as any).momKnowsKolka ?? 0))) {
    ...
    // TODO-QSP: dynamic text: "No, it's not your fault!" your <<$npc_nickname['A29']>> says as she tries her b...
    ...
    if (((s as any).pcs_intel ?? 0) < 40  ||  ((s as any).arch_vars ?? 0)?.['main_active'] === 'bimbo') {
      ...
      // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> looks at you in stunned silence as you realize wha...
      ...
      // TODO-QSP: dynamic text: You continue with the act. "I'm so glad I can always count on you, <<$npc_nickna...
        ...
        if (((s as any).wombthfathID ?? 0) === 'A28'  &&  ((s as any).npc_rel ?? 0)?.['A28'] > 50  &&  ((s as any).stepdadSecret ?? 0) === 0  &&  (!((s as any).momKnowsVladimir ?? 0))) {
          ...
          if (((s as any).wombthfath ?? 0) === ''  ||  ((s as any).wombthfathID ?? 0) === 'unknown') {
            if (((s as any).stat ?? 0)?.['think_virgin'] === 1) {
              ...
              // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> looks at you skeptically, but seeing as you're act...
              ...
              // TODO-QSP: dynamic text: "<<$npc_nickname['A29']>>!!!" you yell with a bit of a hysterical laugh in your ...
    ...
    // TODO-QSP: dynamic text: "Oh honey," your <<$npc_nickname['A29']>> whispers, hugging you tight against he...
    scene.text(`"Oh honey," your ${((s as any).npc_nickname ?? 0)?.['A29']} whispers, hugging you tight against her breast. "These things fail sometimes. It can happen. Maybe I should have taught you better. This is all my fault… But I'll help you now. You're not alone in this."`);
    scene.actions([
      { label: 'Continue', goto: ['mother', ''] },
    ]);
  } },
    ...
    // TODO-QSP: dynamic text: "Oh honey," your <<$npc_nickname['A29']>> whispers, hugging you tight against he...
    scene.text(`"Oh honey," your ${((s as any).npc_nickname ?? 0)?.['A29']} whispers, hugging you tight against her breast. "This is all my fault! Maybe I should have taught you better… But I'll help you now. You're not alone in this."`);
    scene.actions([
      { label: 'Continue', goto: ['mother', ''] },
    ]);
  } },
    ...
    // TODO-QSP: dynamic text: "Oh honey," your <<$npc_nickname['A29']>> whispers, hugging you tight against he...
    scene.text(`"Oh honey," your ${((s as any).npc_nickname ?? 0)?.['A29']} whispers, hugging you tight against her breast. "You can become pregnant a lot of different ways. It can happen. Maybe I should have taught you better. This is all my fault… I'll help you, you know. You're not alone in this."`);
    scene.actions([
      { label: 'Continue', goto: ['mother', ''] },
    ]);
  } },
    ...
    scene.text('"What?! Are you okay?! Why did\'t you tell me sooner?!"');
    scene.text('"I was scared and ashamed and I didn\'t know how you would react…" Your lip quivers as tears begin to flow down your face. "I\'m sorry! I should have said something."');
    // TODO-QSP: dynamic text: "No, it's not your fault!" Your <<$npc_nickname['A29']>> tries her best to comfo...
    scene.text(`"No, it's not your fault!" Your ${((s as any).npc_nickname ?? 0)?.['A29']} tries her best to comfort you, giving you a hug and speaking in the most calming voice she can manage. "I know it's difficult, but please try to tell me what happened."`);
    // TODO-QSP: dynamic text: Through your tears, you recount the events of your rape to your <<$npc_nickname[...
    scene.text(`Through your tears, you recount the events of your rape to your ${((s as any).npc_nickname ?? 0)?.['A29']}, stopping several times as your sobbing prevented you from speaking. Every time you pause, your ${((s as any).npc_nickname ?? 0)?.['A29']} does her best to comfort you before encouraging to continue. After some time, you finally manage to finish your story.`);
    ...
    scene.actions([
      { label: 'Continue', goto: ['mother', ''] },
            ...
            scene.text(`You tell her that the father is ${((s as any).wombthfath ?? 0)} and give her some brief details about how you met and the events that led up to your pregnancy. She reassures you that she'll help you get through this.`);
            scene.actions([
              { label: 'Continue', goto: ['mother', ''] },
            ]);
          }
...
function enterPregreactbrother(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_rel ?? 0)?.['A29'] < 60  &&  ((s as any).npc_pregtalk ?? 0)?.['A34'] === 1  &&  (!((s as any).brothersecret ?? 0))) {
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>>'s face visibly reddens and her mouth curls into a ...
    ...
    scene.text(`Kolka tries to speak up. "${((s as any).npc_nickname ?? 0)?.['A29']}, ${((s as any).pcs_nickname ?? 0)}-"`);
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> quickly cuts him off. "Shut the fuck up and go to ...
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> releases your hair as tears begin to stream down y...
    ...
    qspCall(s, 'mother', 'kickedout', 'kolka');
  } else {
    if ((((s as any).npc_rel ?? 0)?.['A29'] >= 60  &&  ((s as any).npc_rel ?? 0)?.['A29'] <= 80)  &&  ((s as any).npc_pregtalk ?? 0)?.['A34'] === 1  &&  (!((s as any).brothersecret ?? 0))) {
      // TODO-QSP: dynamic text: You see the rage building in your <<$npc_nickname['A29']>>'s face as she balls h...
      ...
      if (((s as any).npc_rel ?? 0)?.['A29'] > 80  &&  ((s as any).npc_pregtalk ?? 0)?.['A34'] === 1  &&  (!((s as any).brothersecret ?? 0))) {
        // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>>'s knees seem to give out and she barely manages to...
        ...
        // TODO-QSP: dynamic text: You stare at the floor, only giving your <<$npc_nickname['A29']>> the smallest n...
        ...
        // TODO-QSP: dynamic text: Your brother grabs your hand before rising to your defense. "<<$npc_nickname['A2...
        scene.text(`Your brother grabs your hand before rising to your defense. "${((s as any).npc_nickname ?? 0)?.['A29']}, that's not fair! You can’t just kick ${((s as any).pcs_nickname ?? 0)} out!"`);
        ...
        // TODO-QSP: dynamic text: "I don't know, but you can't stay here," your <<$npc_nickname['A29']>> replies.
        ...
        // TODO-QSP: dynamic text: "Why not?!" your <<$npc_nickname['A29']>> repeats indignantly, the anger rising ...
        ...
        if (((s as any).npc_rel ?? 0)?.['A29'] < 60  &&  (((s as any).npc_pregtalk ?? 0)?.['A34'] === 0  ||  ((s as any).brothersecret ?? 0) === 1)) {
          ...
          if ((((s as any).npc_rel ?? 0)?.['A29'] >= 60  &&  ((s as any).npc_rel ?? 0)?.['A29'] <= 80)  &&  (((s as any).npc_pregtalk ?? 0)?.['A34'] === 0  ||  ((s as any).brothersecret ?? 0) === 1)) {
            ...
            if (((s as any).npc_rel ?? 0)?.['A29'] > 80  &&  (((s as any).npc_pregtalk ?? 0)?.['A34'] === 0  ||  ((s as any).brothersecret ?? 0) === 1)) {
              // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>>'s knees seem to give out, and she barely manages t...
              scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']}'s knees seem to give out, and she barely manages to hold herself up by leaning on the counter.`);
...
function enterPregreactstepdad(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_rel ?? 0)?.['A29'] < 60  &&  ((s as any).npc_pregtalk ?? 0)?.['A28'] === 1  &&  (!((s as any).stepdadSecret ?? 0))) {
    ...
    scene.text(`Vladimir clears his throat. "Honey, ${((s as any).pcs_nickname ?? 0)} and I-"`);
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> furiously cuts him off. "Shut the fuck up, Vladimi...
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> lets go of your hair as tears begin to stream down...
    ...
    if ((((s as any).npc_rel ?? 0)?.['A29'] >= 60  &&  ((s as any).npc_rel ?? 0)?.['A29'] <= 80)  &&  ((s as any).npc_pregtalk ?? 0)?.['A34'] === 1  &&  (!((s as any).brothersecret ?? 0))) {
      // TODO-QSP: dynamic text: Before you're able to finish the second syllable of your stepfather's name, you ...
      ...
      if (((s as any).npc_rel ?? 0)?.['A29'] > 80  &&  ((s as any).npc_pregtalk ?? 0)?.['A28'] === 1  &&  (!((s as any).stepdadSecret ?? 0))) {
        ...
        // TODO-QSP: dynamic text: You stare shamefully at the floor, only giving your <<$npc_nickname['A29']>> the...
        ...
        scene.text(`Vladimir grabs your hand before rising to your defense. "Honey, that's not fair! You can’t just kick ${((s as any).pcs_nickname ?? 0)} out! We'll figure out something…"`);
        // TODO-QSP: dynamic text: "Vladimir, you're close to getting thrown out yourself, so I suggest you let go ...
        scene.text(`"Vladimir, you're close to getting thrown out yourself, so I suggest you let go of ${((s as any).pcs_nickname ?? 0)}'s hand right now and shut the fuck up. I still haven't decided what to do with your sorry ass…"`);
        ...
        // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> shurgs her shoulders. "I don't know and to be hone...
        ...
        // TODO-QSP: dynamic text: "Why not?!" your <<$npc_nickname['A29']>> repeats indignantly. You feel her gett...
        ...
        if (((s as any).npc_rel ?? 0)?.['A29'] < 60  &&  (((s as any).npc_pregtalk ?? 0)?.['A28'] === 0  ||  ((s as any).stepdadSecret ?? 0) === 1)) {
          ...
          if ((((s as any).npc_rel ?? 0)?.['A29'] >= 60  &&  ((s as any).npc_rel ?? 0)?.['A29'] <= 80)  &&  (((s as any).npc_pregtalk ?? 0)?.['A28'] === 0  ||  ((s as any).stepdadSecret ?? 0) === 1)) {
            // TODO-QSP: dynamic text: Before you're able to finish the second syllable of your step-father's name, you...
...
function enterAbortionTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: "<<$npc_nickname['A29']>>…" you say to get her attention. Before she turns to lo...
    scene.text(`"${((s as any).npc_nickname ?? 0)?.['A29']}…" you say to get her attention. Before she turns to look at you, however, your emotions take over. "I want an abortion!" you blurt out.`);
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> immediately stops what she's doing and comes over ...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} immediately stops what she's doing and comes over to you. "Oh ${((s as any).pcs_nickname ?? 0)}! Are you sure? Abortions can be dangerous…"`);
    scene.text('You simply nod. "Yeah, I\'ve decided." You don\'t trust yourself to say any more.');
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> wraps you in her arms. She doesn't say anything an...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} wraps you in her arms. She doesn't say anything and just holds you tight against her until your tears subside.`);
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    scene.img('images/characters/pavlovsk/resident/mom/hug_sad2.jpg');
    // TODO-QSP: dynamic text: Once you've stopped crying, she sits down with you. "<<$pcs_nickname>>, you know...
    scene.text(`Once you've stopped crying, she sits down with you. "${((s as any).pcs_nickname ?? 0)}, you know I love you. I'm here for you and will support you if you go through with this."`);
    scene.text('She then sighs. "If you\'re sure about this, then I can go with you if you want?"');
    // TODO-QSP: dynamic text: You shake your head and wipe your eyes. "Thanks <<$npc_nickname['A29']>>, but no...
    scene.text(`You shake your head and wipe your eyes. "Thanks ${((s as any).npc_nickname ?? 0)?.['A29']}, but no. I can do this on my own. I just needed to tell you."`);
    // TODO-QSP: dynamic text: "Well I'm glad you did, <<$pcs_nickname>>. It's too big a burden to keep to your...
    scene.text(`"Well I'm glad you did, ${((s as any).pcs_nickname ?? 0)}. It's too big a burden to keep to yourself. Just please know that I'm here for you. If you change your mind and want me to go with you, just let me know."`);
...
function enterAbortionTalkPreg(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    scene.img('images/characters/pavlovsk/resident/mom/hug_sad1.jpg');
    // TODO-QSP: dynamic text: "<<$npc_nickname['A29']>>…" you say to get her attention. "I need to tell you so...
    scene.text(`"${((s as any).npc_nickname ?? 0)?.['A29']}…" you say to get her attention. "I need to tell you something important. Please don't get mad."`);
    ...
    // TODO-QSP: dynamic text: "<<$npc_nickname['A29']>>, please let me finish! I'm already finding this very d...
    scene.text(`"${((s as any).npc_nickname ?? 0)?.['A29']}, please let me finish! I'm already finding this very difficult."`);
    ...
    // TODO-QSP: dynamic text: After a quick pause for breath and to gather your thoughts, you continue. "I'm s...
    scene.text(`After a quick pause for breath and to gather your thoughts, you continue. "I'm sorry ${((s as any).npc_nickname ?? 0)?.['A29']}; I'm not going to go into the details and I've already made my decision. I'm too young to have a baby and I can't see any other way out."`);
    scene.text('You barely manage to finish before you start crying in front of her.');
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> is torn between her anger and her love for you. Af...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} is torn between her anger and her love for you. After a deep sigh, she comes over to you. "Oh ${((s as any).pcs_nickname ?? 0)}! Are you sure? Abortions can be dangerous…"`);
    ...
    scene.text(`You shake your head and wipe your eyes before continuing. "Thanks ${((s as any).npc_nickname ?? 0)?.['A29']}, but no. I can do this on my own. I just wanted to tell you as keeping it a secret was becoming too much for me."`);
...
function enterKickedout(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'kolka') {
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 'stepdad') {
...
function enterGetBelongings(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stolcigarettes ?? 0)?.['bedrPar'] > 0) {
    ((s as any).mc_inventory ?? {})['cigarettes'] = (((s as any).mc_inventory ?? {})['cigarettes'] ?? 0) + (((s as any).stolcigarettes ?? 0)?.['bedrPar']);
    ((s as any).stolcigarettes ?? {})['bedrPar'] = 0;
...
function enterMotherQW_2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    // TODO-QSP: dynamic text: You defiantly look her in the eyes once she's done with her rant. "What you're s...
    scene.text(`You defiantly look her in the eyes once she's done with her rant. "What you're saying might be true ${((s as any).npc_nickname ?? 0)?.['A29']}, but you're in no position to be lecturing me about this sort of thing!"`);
    ...
    scene.text(`Tired of her hypocritical attitude, you bluntly cut her off. "What I'm saying, ${((s as any).npc_nickname ?? 0)?.['A29']}, is that you done even worse things than me!"`);
    ...
    // TODO-QSP: dynamic text: "No, <<$npc_nickname['A29']>>, now it's <i>you</i> who needs to stop interruptin...
    scene.text(`"No, ${((s as any).npc_nickname ?? 0)?.['A29']}, now it's <i>you</i> who needs to stop interrupting <i>me</i>! I just listened to a 30 minute rant on how a girl should behave… from <i>you</i>!"`);
    // TODO-QSP: dynamic text: "<<$pcs_firstname>> <<$pcs_lastname>>!"
    scene.text(`"${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}!"`);
    (s as any).sisterAge = ((s as any).year ?? 0) - ((((s as any).npc_dob ?? {})?.['A33'] - (((s as any).npc_dob ?? {})?.['A33'] % 10000)) / 10000);
    if (((s as any).age ?? 0) === 16) {
      // TODO-QSP: dynamic text: "I'm not an idiot, <<$npc_nickname['A29']>>! You're <<motherAge>> and Anya is <<...
      scene.text(`"I'm not an idiot, ${((s as any).npc_nickname ?? 0)?.['A29']}! You're ${((s as any).motherAge ?? 0)} and Anya is ${((s as any).sisterAge ?? 0)}. That means you were the same age as me when you got pregnant with her!"`);
    } else {
      // TODO-QSP: dynamic text: "I'm not an idiot, <<$npc_nickname['A29']>>! You're <<motherAge>> and Anya is <<...
      scene.text(`"I'm not an idiot, ${((s as any).npc_nickname ?? 0)?.['A29']}! You're ${((s as any).motherAge ?? 0)} and Anya is ${((s as any).sisterAge ?? 0)}. That means you were even younger than me when you got pregnant with her!"`);
    }
    ...
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    // TODO-QSP: dynamic text: "Everything, <<$npc_nickname['A29']>>!" you exclaim. "I don't believe for a <i>s...
    scene.text(`"Everything, ${((s as any).npc_nickname ?? 0)?.['A29']}!" you exclaim. "I don't believe for a <i>second</i> that you only did it out love for my father. You <i>loved</i> getting fucked by him!"`);
    // TODO-QSP: dynamic text: "<<$pcs_nickname>>! Do not swear!"
    scene.text(`"${((s as any).pcs_nickname ?? 0)}! Do not swear!"`);
    ...
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    // TODO-QSP: dynamic text: Just as you're about to leave the kitchen, your <<$npc_nickname['A29']>> calls o...
    scene.text(`Just as you're about to leave the kitchen, your ${((s as any).npc_nickname ?? 0)?.['A29']} calls out for you. "${((s as any).pcs_nickname ?? 0)}, wait!"`);
    ...
    scene.text(`"${((s as any).npc_nickname ?? 0)?.['A29']}, we <i>just</i> talked about this!"`);
    // TODO-QSP: dynamic text: Your mother looks serious as she raises her hand, motioning you to not interrupt...
    scene.text(`Your mother looks serious as she raises her hand, motioning you to not interrupt. Since her attitude towards you is not as demeaning anymore, you decide to listen. "Hear me out please, ${((s as any).pcs_nickname ?? 0)}. I just don't want you to get pregnant, you know? When you have a baby, it should be with the man you're going to stay with, and when you can support it."`);
    if (((s as any).mc_inventory ?? 0)?.['equipped_condoms'] > 0  ||  ((s as any).mc_inventory ?? 0)?.['contraceptive_pill'] > 0) {
      // TODO-QSP: dynamic text: "Don't worry <<$npc_nickname['A29']>>, I've taken precautions. I went and bought...
      scene.text(`"Don't worry ${((s as any).npc_nickname ?? 0)?.['A29']}, I've taken precautions. I went and bought things. When they run out, I'll get more, I promise."`);
    } else {
      if (((s as any).tabletkicheck ?? 0) === 2) {
        // TODO-QSP: dynamic text: "Don't worry <<$npc_nickname['A29']>>, I've taken precautions. I went to the cli...
        scene.text(`"Don't worry ${((s as any).npc_nickname ?? 0)?.['A29']}, I've taken precautions. I went to the clinic and got a birth control shot. When it runs out, I'll get another one, I promise."`);
      } else {
        // TODO-QSP: dynamic text: "You're right, <<$npc_nickname['A29']>>. I'll go to the pharmacy and get the pil...
        scene.text(`"You're right, ${((s as any).npc_nickname ?? 0)?.['A29']}. I'll go to the pharmacy and get the pill there. I'll buy some condoms too."`);
      }
    }
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> looks furious before she deflates and nods. "She's...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} looks furious before she deflates and nods. "She's right. We can't stop you and it's better if you use protection. I wish she had told me, but I understand. I just wish… I had been the one to talk to you about this instead," she says as she looks at you sadly.`);
...
function enterCloReact(s: GameState, scene: SceneBuilder): void {
  ((s as any).motherQW ?? {})['clo_react'] = ((s as any).daystart ?? 0);
  (s as any).minut = ((s as any).minut ?? 0) + 2;
  scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
  if (((s as any).locArgs?.[1] ?? 0) === 'apartment') {
    ...
    qspCall(s, 'stat', '');
    if (((s as any).npc_rel ?? 0)?.['A29'] >= 80) {
      // TODO-QSP: dynamic text: As soon as your <<$npc_nickname['A29']>> sees you, her eyes widen and she stops ...
      scene.text(`As soon as your ${((s as any).npc_nickname ?? 0)?.['A29']} sees you, her eyes widen and she stops what she's doing to gawk at you. "What are you wearing, ${((s as any).pcs_nickname ?? 0)}?! I've never seen these kinds of clothes on you!"`);
      ...
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Lie [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> is silent for what feels like an eternity before s...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} is silent for what feels like an eternity before she shakes her head. "Of course Anya is the one to come up with something like that. Well, it's not funny. Now go change."`);
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Refuse to change [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
    ...
    // TODO-QSP: dynamic text: Just as suddenly as she started laughing, your <<$npc_nickname['A29']>> abruptly...
    scene.text(`Just as suddenly as she started laughing, your ${((s as any).npc_nickname ?? 0)?.['A29']} abruptly stops. With her arms now crossed, she glares down at you. "You're going back to your room and-"`);
    ...
    scene.actions([
      ...
      if (((s as any).npc_rel ?? 0)?.['A29'] >= 40) {
        ...
        scene.text(`"Why are you dressed like that, ${((s as any).pcs_nickname ?? 0)}?" your ${((s as any).npc_nickname ?? 0)?.['A29']} asks when she sees you. "Is this how girls are dressing these days?"`);
    ...
    scene.actions([
      { label: 'Go back to your room', goto: ['bedrPar', ''] },
        ...
        // TODO-QSP: dynamic text: "What the hell are you thinking wearing <i>that</i>?!" your <<$npc_nickname['A29...
        ...
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          scene.actions([
            { label: 'Argue back [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
          ]);
        } else {
          scene.actions([
            { label: 'Argue back [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    qspCall(s, 'willpower', 'pay', 'self');
    qspCall(s, 'npc_relationship', 'modify', 'A29', 'hate');
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    ...
    scene.text(`She suddenly raises her hand to slap you, but quickly composes herself. "You… are such a disappointment to me, ${((s as any).pcs_firstname ?? 0)}… I thought you would have a bright future ahead of you," she says calmly. Her face is blank, no longer scowling like she was before, and it makes you feel a bit uneasy. "You'll have your beauty and all the attention, sure, but after that? No one will want to touch the town whore…"`);
    scene.actions([
      { label: 'Walk away', handler: (st: GameState) => {
    dynamicGoto(st, 'loc', 'loc_arg');
  } },
    ...
    qspCall(s, 'stat', '');
    if (((s as any).npc_rel ?? 0)?.['A29'] >= 80) {
      // TODO-QSP: dynamic text: As soon as your <<$npc_nickname['A29']>> sees you, she stops and stares with a l...
      ...
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Proudly tell the truth [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
        ]);
      } else {
    ...
    // TODO-QSP: dynamic text: Whether it's because she's angry, embarrassed or both, you watch with a pleased ...
    ...
    // TODO-QSP: dynamic text: As if it all suddenly makes sense, your <<$npc_nickname['A29']>> throws her hand...
    scene.text(`As if it all suddenly makes sense, your ${((s as any).npc_nickname ?? 0)?.['A29']} throws her hands up and sighs. "Anya! Of course it's hers. She probably borrowed it from one of her friends."`);
    ...
    dynamicGoto(st, 'loc', 'loc_arg');
      ...
      if (((s as any).npc_rel ?? 0)?.['A29'] >= 40) {
        // TODO-QSP: dynamic text: When your <<$npc_nickname['A29']>> catches sight of you, she slowly shakes her h...
        scene.text(`When your ${((s as any).npc_nickname ?? 0)?.['A29']} catches sight of you, she slowly shakes her head. "Is that you, ${((s as any).pcs_nickname ?? 0)}? I almost couldn't tell. I thought you were just some cheap prostitute…" She looks you up and down, not bothering to hide the repulsed look on her face. "You really don't have any shame, do you?"`);
        ...
        if (((s as any).momslut ?? 0) >= 1) {
          ...
          if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
            scene.actions([
              { label: 'Call her out for cheating [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
            ]);
          } else {
...
function enterCondomSteal(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'hear') {
    ((s as any).motherQW ?? {})['con_steal_hear'] = ((s as any).daystart ?? 0);
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 'talk') {
      ((s as any).motherQW ?? {})['con_steal_talk'] = ((s as any).daystart ?? 0);
      (s as any).minut = ((s as any).minut ?? 0) + 3;
      qspCall(s, 'stat', '');
      scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
...
function enterCondomFind(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).mom ?? {})['condoms'] = 1;
  qspCall(s, 'stat', '');
  scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
  if (((s as any).motherKnowSpravka ?? 0) === 1  ||  ((s as any).motherKnowWhore ?? 0) === 1) {
    if (((s as any).npc_QW ?? 0)?.['A29'] === 1) {
      // TODO-QSP: dynamic text: You're in your room when your <<$npc_nickname['A29']>> walks in and shuts the do...
      ...
      // TODO-QSP: dynamic text: You're in your room when your <<$npc_nickname['A29']>> walks in and shuts the do...
      scene.text(`You're in your room when your ${((s as any).npc_nickname ?? 0)?.['A29']} walks in and shuts the door behind her. Without saying a word, she walks over to the desk, pulls out one of the drawers and takes out some condoms.`);
      // TODO-QSP: dynamic text: "<<$pcs_nickname>>, I'm glad you're using protection, but you should be hiding t...
      scene.text(`"${((s as any).pcs_nickname ?? 0)}, I'm glad you're using protection, but you should be hiding these somewhere other than your desk drawer! What if Kolka came in and found them?"`);
      ...
      // TODO-QSP: dynamic text: "Yes <<$npc_nickname['A29']>>!" you reply as you roll your eyes and she shows he...
    ...
    scene.text(`"${((s as any).pcs_nickname ?? 0)}, why do you have these in your desk?!"`);
    ...
    qspCall(s, 'npc_relationship', 'modify', 'A29', 30);
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    ...
    scene.text(`Seeing you react strongly, your ${((s as any).npc_nickname ?? 0)?.['A29']} eases up. "I'm sorry ${((s as any).pcs_nickname ?? 0)}, I just thought the worst when I seen them… It still doesn't explain why you would steal them in the first place though."`);
    ...
    scene.text(`The two of you have a long conversation about how important it is that you remain a virgin and that you need to keep aware of the boys approaches towards you. In the end, the two of you hug and your ${((s as any).npc_nickname ?? 0)?.['A29']} leaves the room.`);
    scene.actions([
      { label: 'Continue', goto: ['bedrPar', ''] },
    ]);
  } },
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> looks at you, talling you up from head to toe. "I ...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} looks at you, talling you up from head to toe. "I don't buy it, but if it really is your sister that's been stealing them, then you won't mind going to the doctor for a check up?"`);
    ...
    // TODO-QSP: dynamic text: "Oh you'll get an apology if you pass the test…" your <<$npc_nickname['A29']>> r...
    scene.text(`"Oh you'll get an apology if you pass the test…" your ${((s as any).npc_nickname ?? 0)?.['A29']} replies. "Until then, I'm keeping you on a short leash…"`);
    // TODO-QSP: dynamic text: The two of you go back and forth as you decide the details before your <<$npc_ni...
    scene.text(`The two of you go back and forth as you decide the details before your ${((s as any).npc_nickname ?? 0)?.['A29']} leaves the room.`);
    scene.actions([
      { label: 'Continue', goto: ['bedrPar', ''] },
    ]);
  } },
      ...
      scene.actions([
        { label: 'Tell the truth', handler: (st: GameState) => {
    qspCall(s, 'npc_relationship', 'modify', 'A29', (-50));
    if ((!((s as any).motherKnowSpravka ?? 0))) {
      (s as any).motherKnowSpravka = 1;
    }
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    // TODO-QSP: dynamic text: You anxiously look around for a cop out, but your <<$npc_nickname['A29']>> is qu...
    scene.text(`You anxiously look around for a cop out, but your ${((s as any).npc_nickname ?? 0)?.['A29']} is quite insistant. "Well?! Let's hear it!"`);
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> eyes widen and go dark. "What the hell, <<$pcs_nic...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} eyes widen and go dark. "What the hell, ${((s as any).pcs_nickname ?? 0)}?! How many times have we talked about this? I don't know what to even say to you right now, I'm so mad!"`);
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> reacts as expected. "For safety?! What safety?! Yo...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} reacts as expected. "For safety?! What safety?! You're not supposed to be having sex! Wait, are you telling me that you're having sex?!"`);
    if (((s as any).stat ?? 0)?.['think_virgin'] === 1) {
      scene.actions([
        { label: 'I\'m still a virgin!', handler: (st: GameState) => {
    qspCall(s, 'npc_relationship', 'modify', 'A29', 30);
    ...
    scene.text('"Absolutely not! I\'m still a virgin! How could you even accuse me of something like that?!" you shout back, clearly upset.');
    // TODO-QSP: dynamic text: Seeing you react strongly, your <<$npc_nickname['A29']>> eases up. "I'm sorry <<...
    scene.text(`Seeing you react strongly, your ${((s as any).npc_nickname ?? 0)?.['A29']} eases up. "I'm sorry ${((s as any).pcs_nickname ?? 0)}, I just thought the worst when I seen them… It still doesn't explain why you had them in the first place, though!"`);
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> looks at you, tallying you up from head to toe. "W...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} looks at you, tallying you up from head to toe. "Well since you're so confident, you won't mind going to the doctor for a check up then?"`);
    ...
    scene.text(`"You'll get an apology <i>if</i> you pass the test…" your ${((s as any).npc_nickname ?? 0)?.['A29']} replies. "Until then, I'm keeping you on a short leash…"`);
    // TODO-QSP: dynamic text: The two of you go back and forth as you decide the details before your <<$npc_ni...
    scene.text(`The two of you go back and forth as you decide the details before your ${((s as any).npc_nickname ?? 0)?.['A29']} leaves the room.`);
    scene.actions([
      { label: 'Continue', goto: ['bedrPar', ''] },
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    scene.actions([
      { label: 'They\'re not mine [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
    ]);
  } else {
    scene.actions([
      { label: 'They\'re not mine [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    qspCall(s, 'stat', '');
    qspCall(s, 'npc_relationship', 'modify', 'A29', 'loathe');
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> looking at you suspiciously, but since she can't p...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} looking at you suspiciously, but since she can't prove otherwise she puts the condoms back. "I'll talk to Anya, but I really hope you're not lying to me young lady, otherwise there'll be consequences. Understand?!"`);
    // TODO-QSP: dynamic text: You nod and let out a silent sigh of relief. Hopefully, Anya will cover for you ...
    scene.text(`You nod and let out a silent sigh of relief. Hopefully, Anya will cover for you when ${((s as any).npc_nickname ?? 0)?.['A29']} asks her about it…`);
    scene.actions([
      { label: 'Continue', goto: ['bedrPar', ''] },
    ]);
  } },
...
function enterDildoFind(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
  // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> walks into the room and closes the door. You're a ...
  ...
  if (((s as any).motherKnowSpravka ?? 0) === 1  ||  ((s as any).motherKnowWhore ?? 0) === 1) {
    if (((s as any).npc_QW ?? 0)?.['A29'] === 1) {
      ...
      // TODO-QSP: dynamic text: "<<$pcs_nickname>>, I understand your need for some... 'alone time', but you sho...
      scene.text(`"${((s as any).pcs_nickname ?? 0)}, I understand your need for some... 'alone time', but you should find a better place to hide this sort of thing. What if Kolka came in and found it?"`);
      scene.text('"Then you should be giving him into trouble for snooping through the room his sisters share!" you scowl. "He has no business being in here."');
      if (((s as any).mc_inventory ?? 0)?.['dildo_small'] + ((s as any).mc_inventory ?? 0)?.['dildo_normal'] + ((s as any).mc_inventory ?? 0)?.['dildo_big'] + ((s as any).mc_inventory ?? 0)?.['dildo_large'] + ((s as any).mc_inventory ?? 0)?.['dildo_huge'] + ((s as any).mc_inventory ?? 0)?.['dildo_enormous'] + ((s as any).mc_inventory ?? 0)?.['dildo_gigantic'] > 1) {
        ...
        if (((s as any).mc_inventory ?? 0)?.['dildo_small'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_normal'] === 1) {
          ...
          if (((s as any).mc_inventory ?? 0)?.['dildo_big'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_large'] === 1) {
            ...
            if (((s as any).mc_inventory ?? 0)?.['dildo_huge'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_enormous'] === 1) {
              ...
              scene.text(`"What were you thinking, ${((s as any).pcs_nickname ?? 0)}?! This would ruin you forever!"`);
            }
          }
        }
    ...
    scene.text(`She crosses her arms while still holding the dildo. "I know what it is ${((s as any).pcs_nickname ?? 0)}, but why do <i>you</i> have it? When did you get it?"`);
    scene.actions([
    ...
    if (((s as any).selfmomtoyplay ?? 0) === 1) {
      scene.text('"I don\'t know, I saw that you had one and wanted to have one of my own…" you try to explain.');
      // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> walks up to you and starts brushing your hair. "Yo...
      scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} walks up to you and starts brushing your hair. "You're aware this is for adults only, right? It's not something that you should be owning. You're still too young for this…"`);
    } else {
      qspCall(s, 'npc_relationship', 'modify', 'A29', 'dislike');
    ...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} starts laughing. "If you say so, honey."`);
    if (((s as any).mc_inventory ?? 0)?.['dildo_small'] + ((s as any).mc_inventory ?? 0)?.['dildo_normal'] + ((s as any).mc_inventory ?? 0)?.['dildo_big'] + ((s as any).mc_inventory ?? 0)?.['dildo_large'] + ((s as any).mc_inventory ?? 0)?.['dildo_huge'] + ((s as any).mc_inventory ?? 0)?.['dildo_enormous'] + ((s as any).mc_inventory ?? 0)?.['dildo_gigantic'] > 1) {
      ...
      if (((s as any).mc_inventory ?? 0)?.['dildo_small'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_normal'] === 1) {
        ...
        if (((s as any).mc_inventory ?? 0)?.['dildo_big'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_large'] === 1) {
          ...
          if (((s as any).mc_inventory ?? 0)?.['dildo_huge'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_enormous'] === 1) {
            // TODO-QSP: dynamic text: <<$npc_nickname['A29']>> starts laughing. "Well, you certainly didn't buy the co...
            scene.text(`${((s as any).npc_nickname ?? 0)?.['A29']} starts laughing. "Well, you certainly didn't buy the correct one! There's no way this will fit-"`);
          } else {
            // TODO-QSP: dynamic text: "What were you thinking, <<$pcs_nickname>>?! This would ruin you forever! I forb...
            scene.text(`"What were you thinking, ${((s as any).pcs_nickname ?? 0)}?! This would ruin you forever! I forbid you from even trying to use this!"`);
          }
        }
      }
      ...
      scene.text(`"${((s as any).npc_nickname ?? 0)?.['A29']}! Leave! Now!" you shout.`);
    }
    scene.actions([
      { label: 'Put the dildo away [+iif(mc_inventory[\'dildo_small\'] + mc_inv...]', goto: ['bedrPar', ''] },
    ]);
    ...
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
    // TODO-QSP: dynamic text: You keep quiet, hoping that your <<$npc_nickname['A29']>> will let it pass, but ...
    scene.text(`You keep quiet, hoping that your ${((s as any).npc_nickname ?? 0)?.['A29']} will let it pass, but she's adamant and asks you once again.`);
    ...
    scene.text(`"A gift, huh?" Your ${((s as any).npc_nickname ?? 0)?.['A29']} is hesitant to believe you.`);
    if (((s as any).mc_inventory ?? 0)?.['dildo_small'] + ((s as any).mc_inventory ?? 0)?.['dildo_normal'] + ((s as any).mc_inventory ?? 0)?.['dildo_big'] + ((s as any).mc_inventory ?? 0)?.['dildo_large'] + ((s as any).mc_inventory ?? 0)?.['dildo_huge'] + ((s as any).mc_inventory ?? 0)?.['dildo_enormous'] + ((s as any).mc_inventory ?? 0)?.['dildo_gigantic'] > 1) {
      ...
      if (((s as any).mc_inventory ?? 0)?.['dildo_small'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_normal'] === 1) {
        ...
        if (((s as any).mc_inventory ?? 0)?.['dildo_big'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_large'] === 1) {
          ...
          if (((s as any).mc_inventory ?? 0)?.['dildo_huge'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_enormous'] === 1) {
            // TODO-QSP: dynamic text: <<$npc_nickname['A29']>> starts laughing. "Well, I understand why your friend ga...
            scene.text(`${((s as any).npc_nickname ?? 0)?.['A29']} starts laughing. "Well, I understand why your friend gave it away! There's no way this will fit-"`);
          } else {
            // TODO-QSP: dynamic text: "What was your friend thinking, <<$pcs_nickname>>?! This would ruin anyone's lad...
            scene.text(`"What was your friend thinking, ${((s as any).pcs_nickname ?? 0)}?! This would ruin anyone's lady parts forever! I forbid you from even trying to use this! Which friend gave you this? I need to call and tell her mother too…"`);
          }
        }
      }
      scene.text('You quickly yank the dildo out of her hand. "I don\'t want to talk about it! God, this is so awkward!" you yell as you start blushing.');
    ...
    if (((s as any).mc_inventory ?? 0)?.['dildo_small'] + ((s as any).mc_inventory ?? 0)?.['dildo_normal'] + ((s as any).mc_inventory ?? 0)?.['dildo_big'] + ((s as any).mc_inventory ?? 0)?.['dildo_large'] + ((s as any).mc_inventory ?? 0)?.['dildo_huge'] + ((s as any).mc_inventory ?? 0)?.['dildo_enormous'] + ((s as any).mc_inventory ?? 0)?.['dildo_gigantic'] > 1) {
      ...
      if (((s as any).mc_inventory ?? 0)?.['dildo_small'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_normal'] === 1) {
        ...
        if (((s as any).mc_inventory ?? 0)?.['dildo_big'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_large'] === 1) {
          ...
          if (((s as any).mc_inventory ?? 0)?.['dildo_huge'] === 1  ||  ((s as any).mc_inventory ?? 0)?.['dildo_enormous'] === 1) {
            // TODO-QSP: dynamic text: <<$npc_nickname['A29']>> starts laughing, "Well, I understand why your friend ga...
            scene.text(`${((s as any).npc_nickname ?? 0)?.['A29']} starts laughing, "Well, I understand why your friend gave it away! There is now way this will fit-"`);
            scene.text('You quickly yank the dildo out of her hand. "I don\'t want to talk with you about this! This is so awkward!" you yell as you start blushing.');
            scene.text('"Okay, okay. Just so you know I\'m not too fond of you owning a dildo, but it\'s better than having you running around having sex with boys."');
            // TODO-QSP: dynamic text: "<<$npc_nickname['A29']>>! Leave! Now!" you shout.
            scene.text(`"${((s as any).npc_nickname ?? 0)?.['A29']}! Leave! Now!" you shout.`);
...
function enterPlugFind(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: Not even batting an eye, your <<$npc_nickname['A29']>> scowls. "I was cleaning y...
  scene.text(`Not even batting an eye, your ${((s as any).npc_nickname ?? 0)?.['A29']} scowls. "I was cleaning your room and I found this. What the hell, ${((s as any).pcs_nickname ?? 0)}?!"`);
  ...
  if (((s as any).pcs_ass ?? 0) > 0) {
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> sighs deeply. "Why the hell would you- Are you hav...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} sighs deeply. "Why the hell would you- Are you having anal sex?!"`);
    ...
    scene.text(`"Feel what?! How to have something shoved up your butt?!" Your ${((s as any).npc_nickname ?? 0)?.['A29']} is clearly getting more and more upset. "I expected better than this, ${((s as any).pcs_nickname ?? 0)}! I'm quite disappointed to be honest."`);
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> frowns in disgust as she drops the butt plug. "I h...
...
function enterAskMotherWorkout(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_rel ?? 0)?.['A29'] >= 60) {
    ...
    scene.text(`"No thanks, ${((s as any).pcs_nickname ?? 0)}. I'll leave all that to people younger than me."`);
...
function enterMotherWorkoutPav(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).motherQW ?? {})['workout_day'] = ((s as any).daystart ?? 0);
  qspCall(s, 'stat', '');
  scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
  scene.text('"You ready to work out?" you ask.');
  // TODO-QSP: dynamic text: "Okay <<$pcs_nickname>>, I'll get ready and meet you outside."
  scene.text(`"Okay ${((s as any).pcs_nickname ?? 0)}, I'll get ready and meet you outside."`);
...
function enterMotherJogPav(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> soon appears from around the corner. She does a fe...
  ...
  scene.actions([
    ...
    scene.text(`You and your ${((s as any).npc_nickname ?? 0)?.['A29']} start jogging down one of the park paths. It's not particularly taxing, but you're glad to spend time with her. Running through the park is quite refreshing overall, especially with company.`);
    scene.actions([
      { label: 'Return home', handler: (st: GameState) => {
    qspCall(s, 'npc_relationship', 'modify', 'A29', Math.floor(Math.random() * 2) + 2);
    (s as any).minut = ((s as any).minut ?? 0) + 30;
    qspCall(s, 'stat', '');
    ...
    scene.text(`With your joint jogging session drawing to a close, you congratulate your ${((s as any).npc_nickname ?? 0)?.['A29']} on a good work out. She might not be as perky as you are afterwards, but you get the impression she enjoyed spending time with you.`);
...
function enterMotherYogaPav(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  scene.img('images/characters/pavlovsk/resident/mom/mother.jpg');
  // TODO-QSP: dynamic text: You ask your <<$npc_nickname['A29']>> if she would like to do some yoga up at th...
  ...
  scene.actions([
    ...
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/mom/pavrun1.jpg');
    // TODO-QSP: dynamic text: You see your <<$npc_nickname['A29']>> has put on some very light clothing as you...
    scene.text(`You see your ${((s as any).npc_nickname ?? 0)?.['A29']} has put on some very light clothing as you head off towards the park, chatting as you go. It's not long before you arrive, so you quickly get ready to start your routine.`);
    scene.actions([
      { label: 'Do some yoga', handler: (st: GameState) => {
    (s as any).timemult = 6;
    // TODO-QSP: gs 'exercise', 'tier2', (timemult*5), 'sprt', 'agil'
    (s as any).pcs_willpwr = ((s as any).pcs_willpwr ?? 0) + (Math.floor(Math.random() * 7) + 6);
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/mom/pavyoga2.jpg');
    // TODO-QSP: dynamic text: You and your <<$npc_nickname['A29']>> do some simple yoga routines together. It ...
    scene.text(`You and your ${((s as any).npc_nickname ?? 0)?.['A29']} do some simple yoga routines together. It isn't as pressing as when you do them by yourself, but you enjoy being able to spend time with her. Sometimes men walk by and leer at you both for a while, seeming to enjoy the free show.`);
    scene.actions([
      { label: 'Check on her', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + (Math.floor(Math.random() * 3) + 2);
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/mom/pavyoga3.jpg');
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> is more flexible than you gave her credit for. "Wh...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} is more flexible than you gave her credit for. "What? Just because I'm older doesn't mean I don't try and take care of myself! Don't look so surprised!"`);
...
function enterMotherJogGad(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  scene.img('images/characters/pavlovsk/resident/mom/ready_run.jpg');
  // TODO-QSP: dynamic text: You head outside to wait for your <<$npc_nickname['A29']>> and do a little stret...
  scene.text(`You head outside to wait for your ${((s as any).npc_nickname ?? 0)?.['A29']} and do a little stretching while you wait.`);
  // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> is ready very quickly, and she's showing quite a l...
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> leads you out of the house and into the countrysid...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} leads you out of the house and into the countryside. You let her take the lead since she knows the area well. This also gives you the chance to chat with her as you jog along.`);
    // TODO-QSP: dynamic text: You talk about a variety of topics and enjoy spending time with her, as well as ...
    scene.text(`You talk about a variety of topics and enjoy spending time with her, as well as getting the chance to jog around the countryside and see all the interesting routes your ${((s as any).npc_nickname ?? 0)?.['A29']} knows about and enjoys taking.`);
    scene.actions([
      { label: 'Return home', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 30;
    qspCall(s, 'npc_relationship', 'modify', 'A29', Math.floor(Math.random() * 2) + 2);
    ...
    // TODO-QSP: dynamic text: With your run going very smoothly, it doesn't take too long until you circle bac...
...
function enterMotherYogaGad(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: You see your <<$npc_nickname['A29']>> has put on some very light clothing and yo...
    scene.text(`You see your ${((s as any).npc_nickname ?? 0)?.['A29']} has put on some very light clothing and you both head off towards the meadow, chatting as you go. It's not long before you arrive and you quickly get ready to start your routine.`);
    scene.actions([
      { label: 'Do some yoga', handler: (st: GameState) => {
    ...
    // TODO-QSP: dynamic text: You and your <<$npc_nickname['A29']>> do some simple yoga routines together. It ...
    scene.text(`You and your ${((s as any).npc_nickname ?? 0)?.['A29']} do some simple yoga routines together. It isn't as pressing as when you do them by yourself, but you enjoy being able to spend time with her.`);
    // TODO-QSP: dynamic text: The area is quite secluded and private, and you and your <<$npc_nickname['A29']>...
    scene.text(`The area is quite secluded and private, and you and your ${((s as any).npc_nickname ?? 0)?.['A29']} are left to run your routine in peace and quiet. It's a nice experience and gives you plenty of time to talk whilst going through your poses and stretches.`);
    scene.actions([
      { label: 'Check on her', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + (Math.floor(Math.random() * 3) + 2);
    qspCall(s, 'stat', '');
    ...
    // TODO-QSP: dynamic text: Your <<$npc_nickname['A29']>> is more flexible than you gave her credit for. "Wh...
    scene.text(`Your ${((s as any).npc_nickname ?? 0)?.['A29']} is more flexible than you gave her credit for. "What? Just because I am older doesn't mean I don't try and take care of myself! Don't look so surprised!"`);

...
function enterBj2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You look at ${((s as any).boydesc ?? 0)} with lust in your eyes. Dropping down on your knees without being asked, you unbutton his pants, exposing his fully erect cock. Wrapping your ${((s as any).pc_desc ?? 0)?.['lips']} lips around his strong and warm cock, you quickly begin by sucking the head, caressing it with your tongue and lips.`);
  // TODO-QSP: dynamic text: <<$boydesc>> lets out a small groan, clearly enjoying himself. Turned on by seei...
  scene.text(`${((s as any).boydesc ?? 0)} lets out a small groan, clearly enjoying himself. Turned on by seeing ${((s as any).boydesc ?? 0)} enjoying the blowjob, you start sucking his cock while caressing his balls.`);
  ...
  if (((s as any).belact ?? 0) <= 0) {
    ...
    scene.text(`Redoubling your efforts, you reach the base of his wet cock with your ${((s as any).pc_desc ?? 0)?.['lips']} lips. ${((s as any).boydesc ?? 0)} stares you in the face while your lips glide up and down on his hard dick. You know he must be close now.`);
...
function enterBj3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`"Get down on your knees!" he commands. Unfazed by his boldness, you kneel down in front of him and lick up and down his length a few times before you take his ${((s as any).dick ?? 0)} cm cock into your mouth. As his cock enters, a rank odor enters your nostrils. You disregard the nasty aroma and begin moving your tongue around the head and you suck his dick as you start bobbing your head up and down while your hands take turns playing with his hairy balls. It's hard for you to decide whether you want to move slowly and tease him, or speed up to avoid getting caught, but what you are doing seems to be to his liking.`);
  ...
  if (((s as any).belact ?? 0) <= 0) {
    ...
    scene.text(`${((s as any).boydesc ?? 0)} is grimacing, enjoying himself. He is sitting down, letting you do all the work. Encouraged, you take his cock deeper, trying to hold it down as long as possible.`);
    ...
    scene.text(`Instead, ${((s as any).boydesc ?? 0)} starts jerking off, telling you "I'll be done soon, ${((s as any).pcs_nickname ?? 0)}. I want you to swallow every little drop." He doesn't last much longer and cums all over your face.`);
...
function enterVaginal1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.img(`images/characters/pavlovsk/vadim/sex/mitka${((s as any).picrand ?? 0)}.mp4`);
  // TODO-QSP: dynamic text: <<$boydesc>> lifts you up, grabs you by the hair, and shoves you onto the bed. Y...
  scene.text(`${((s as any).boydesc ?? 0)} lifts you up, grabs you by the hair, and shoves you onto the bed. You land on your back, as he quickly moves in, you spread your legs. He starts touching your pussy lips with his fat fingers, you let out a moan as he penetrates you with his finger.`);
  ...
  scene.text(`Hanging over you, looking into your eyes he starts to build up quite a bit of speed. "You're a pretty good fuck ${((s as any).pcs_nickname ?? 0)}, but I've had better." he says as his sweat drips all over you.`);
  ...
  if (((s as any).belact ?? 0) <= 0) {
    ...
    scene.text(`${((s as any).boydesc ?? 0)}'s movements speed up as he keeps pounding you balls deep without showing any signs of slowing down. You think this will go on for a while, but suddenly you hear ${((s as any).boydesc ?? 0)} grunting while cumming deep inside you.`);
    scene.actions([
      { label: 'Take a shower', goto: ['BelSex', 'shower'] },
    ]);
  }
  if (((s as any).belact ?? 0) > 0) {
    ...
    if ((!((s as any).belanal ?? 0))) {
      ...
      scene.text(`${((s as any).boydesc ?? 0)}'s sweat is dripping all over your body. He is huffing and puffing as he pulls out. "Give me a second to catch my breath and then I'll finish this. Give me your sweet little ass," he says, breathing heavily`);
      scene.actions([
      ...
      if (((s as any).belanal ?? 0) === 1) {
        ...
        scene.text(`${((s as any).boydesc ?? 0)} wipes the sweat off his forehead, clearly worked up from fucking you. Nevertheless, he's not done with you and tells you that he wants your ass next.`);
        scene.actions([
        ...
        scene.text(`${((s as any).boydesc ?? 0)} pulls out of your pussy as the sensations make you moan; "Oh don't worry sweetheart, I'm not done yet. It's your asshole next. Assume the position."`);
        scene.actions([
...
function enterVaginal2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? 0)} lifts you up, grabs you by the hair, and shoves you onto the bed. His cock, well greased from the blowjob, easily slides into your pussy.`);
  ...
  if (((s as any).belact ?? 0) <= 0) {
    ...
    scene.text(`${((s as any).boydesc ?? 0)} groans loudly. His cock stiffens as you feel a jet of warm sperm hitting deep inside your womb.`);
    scene.actions([
      { label: 'Take a shower', goto: ['BelSex', 'shower'] },
    ]);
  }
  if (((s as any).belact ?? 0) > 0) {
    ...
    if ((!((s as any).belanal ?? 0))) {
      ...
      if (((s as any).belanal ?? 0) === 1) {
        // TODO-QSP: dynamic text: <<$boydesc>> wipes the sweat off his forehead, clearly worked up from fucking yo...
        scene.text(`${((s as any).boydesc ?? 0)} wipes the sweat off his forehead, clearly worked up from fucking you. Nevertheless, he's not done with you and tells you to that he wants your ass next.`);
        scene.actions([
          { label: 'Present your ass', goto: ['BelSex', 'anal2'] },
        ]);
      } else {
...
function enterDoggy(s: GameState, scene: SceneBuilder): void {
  ...
  scene.img(`images/shared/sex/vag/doggy/vagdog${((s as any).picrand ?? 0)}.jpg`);
  ...
  if (((s as any).belact ?? 0) <= 0) {
    ...
    scene.text(`${((s as any).boydesc ?? 0)} keeps on pounding you from behind. You feel his cock getting stiffer and twitching inside of you. You turn your head and look him in the eyes, pleading that he pulls out and cums on your ass instead. But ${((s as any).boydesc ?? 0)} isn't budging. He keeps on going, pulling your hips towards him, filling your womb with splashes of semen.`);
    scene.actions([
      { label: 'Take a shower', goto: ['BelSex', 'shower'] },
    ]);
  }
...
function enterCowgirl(s: GameState, scene: SceneBuilder): void {
  ...
  scene.img(`images/shared/sex/vag/cowgirl/vagcow${((s as any).picrand ?? 0)}.jpg`);
  // TODO-QSP: dynamic text: <<$boydesc>> lies on the bed. He smirks as he tells you that you'll be doing all...
  scene.text(`${((s as any).boydesc ?? 0)} lies on the bed. He smirks as he tells you that you'll be doing all the work today. You look at him, still a bit confused after the blowjob you've given him. Wasn't that enough? "Don't waste my time ${((s as any).pcs_nickname ?? 0)}. Come here!" Not daring to upset him even more, you crawl on top of ${((s as any).boydesc ?? 0)} and guide his cock inside your vagina.`);
  ...
  scene.text(`Unable to think of anything but the pleasure, you moan so loudly that you are almost screaming. Wanting to ride out this intense feeling, you completely forget that you're supposed to please ${((s as any).boydesc ?? 0)} as you orgasm while riding him.`);
  qspCall(s, 'arousal', 'vaginal', 15, 'sub', 'prostitution');
  qspCall(s, 'stat', '');
  if (((s as any).belact ?? 0) <= 0) {
    qspCall(s, 'cum_call', '', '', 'A113', 1);
    ...
    scene.text(`You keep switching the tempo as you ride ${((s as any).boydesc ?? 0)}, from the looks on his face he's ready to explode. You speed up even more wanting him to finish as soon as possible. As you're thinking about pulling out not wanting him to cum inside you, you realize that you are too late. ${((s as any).boydesc ?? 0)} suddenly explodes inside of you.`);
    scene.actions([
      { label: 'Take a shower', goto: ['BelSex', 'shower'] },
    ]);
  }
...
function enterAnal1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? 0)} begins rubbing the tip of his dick against your anus. Before you can even protest, his ${((s as any).dick ?? 0)} cm cock has already painfully penetrated your ass. You instinctively want to flinch away, but he grabs your hips with surprising strength and forces his dick as far into your ass as he can… before he starts hammering away.`);
...
function enterAnal2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.img(`images/shared/sex/anal/cowgirl/kotovsexanal${((s as any).picrand ?? 0)}.mp4`);
  ...
  scene.text(`${((s as any).boydesc ?? 0)} lies on the bed, as you climb on top of him. ${((s as any).boydesc ?? 0)} grabs hold of his cock, guiding his cock inside your tight anus.`);
...
function enterAnaldoggy(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).anal_temp = ((s as any).anal_temp ?? 0) + (1);
  (s as any).picrand = Math.floor(Math.random() * 13) + 0;
  scene.img(`images/shared/sex/anal/doggy/anal${((s as any).picrand ?? 0)}.mp4`);
  // TODO-QSP: dynamic text: <<$boydesc>> pulls his cock out of your pussy and begins to slowly rub against y...
  scene.text(`${((s as any).boydesc ?? 0)} pulls his cock out of your pussy and begins to slowly rub against your asshole. "Don't worry, ${((s as any).pcs_nickname ?? 0)}. I'll be gentle," he says grinning as he has you on all fours, wide spread.`);
  qspCall(s, 'arousal', 'auto_lube', 'anal');
  // TODO-QSP: dynamic text: "Enough foreplay. Your ass is ready me!" he shouts as <<$boydesc>> starts poundi...
  scene.text(`"Enough foreplay. Your ass is ready me!" he shouts as ${((s as any).boydesc ?? 0)} starts pounding himself balls deep into you immediately. You bury your face into a pillow as he pounds your asshole roughly. The pain is unbearable and you flop with your legs trying to get away, but it only encourages ${((s as any).boydesc ?? 0)} on as he keeps pummeling your anus.`);
  qspCall(s, 'arousal', 'anal', 15, 'sub', 'prostitution');
  qspCall(s, 'stat', '');
  if (((s as any).belact ?? 0) <= 0) {
    qspCall(s, 'cum_call', 'anus', 'A113', 1);
...
function enterShower(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).belgangPay ?? 0) <= 0) {
      ...
      scene.text(`Vadim looks at you and says, "That was a good fuck, ${((s as any).pcs_nickname ?? 0)}. Here, this is for you," and with those words he hands you ' + $func('money', 'string_profit', belsexpayment) + '.`);
    } else {

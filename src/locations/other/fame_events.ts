...
function enterBoy(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat_visible_cum ?? 0) === 1) {
    ...
    scene.text(`"Excuse me! ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}?" you hear from behind you. Turning around, you see an excited boy few years younger than yourself coming towards you. "${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}! The ${((s as any).fame ?? 0)?.['noun']}? It is you, isn't it! You're so… uhh…" his voice falters as he notices the cum on you. He then gathers his courage and continues "so… uhh… cool!"`);
  } else {
    if (((s as any).PCloThinness ?? 0) === 6  &&  (((s as any).braworntype ?? 0) === 'salacious'  ||  ((s as any).braworntype ?? 0) === 'none')) {
      // TODO-QSP: dynamic text: "Excuse me! <<$pcs_firstname>> <<$pcs_lastname>>?" you hear from behind you. Tur...
      scene.text(`"Excuse me! ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}?" you hear from behind you. Turning around, you see an excited boy few years younger than yourself coming towards you. "${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}! The ${((s as any).fame ?? 0)?.['noun']}? It is you, isn't it! You're so… uhh…" He trails off when he realizes that he can practically see straight through your top to your your breasts. His cheeks flush and he gulps heavily before managing to continue on in a stammer. "Uhh… great at, uh, ${((s as any).fame ?? 0)?.['activity']}…"`);
      ...
      if (((s as any).PCloThinness ?? 0) === 5  &&  (((s as any).braworntype ?? 0) === 'salacious'  ||  ((s as any).braworntype ?? 0) === 'none')) {
        // TODO-QSP: dynamic text: "Excuse me! <<$pcs_firstname>> <<$pcs_lastname>>?" you hear from behind you. Tur...
        scene.text(`"Excuse me! ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}?" you hear from behind you. Turning around, you see an excited boy few years younger than yourself coming towards you. "${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}! The ${((s as any).fame ?? 0)?.['noun']}? It is you, isn't it! You're so…" He trails off for a brief moment and you see his eyes flicker downward for a moment before snapping back up. It was just a small twitch, but you suddenly feel very aware of how thin your top is and how certain things might be "poking" out.`);
        ...
        if (((s as any).PCloThinness ?? 0) === 6) {
          // TODO-QSP: dynamic text: "Excuse me! <<$pcs_firstname>> <<$pcs_lastname>>?" you hear from behind you. Tur...
          scene.text(`"Excuse me! ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}?" you hear from behind you. Turning around, you see an excited boy few years younger than yourself coming towards you. "${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}! The ${((s as any).fame ?? 0)?.['noun']}? It is you, isn't it! You're so cool!"`);
  ...
  scene.actions([
    ...
    scene.text(`"I'm not ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}" you lie. "But, you look just like her?" he says confused.`);
...
function enterGirl(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat_visible_cum ?? 0) === 1) {
    // TODO-QSP: dynamic text: "Excuse me! <<$pcs_firstname>> <<$pcs_lastname>>?" you hear from behind you. Tur...
    scene.text(`"Excuse me! ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}?" you hear from behind you. Turning around, you see an excited girl few years younger than yourself coming towards you. "${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}! The ${((s as any).fame ?? 0)?.['noun']}? It is you, isn't it! You're so… uhh…" her voice falters as she notices the cum on you. She then gathers her courage and continues "so… uhh… cool…"`);
  } else {
    if (((s as any).PCloThinness ?? 0) === 6  &&  (((s as any).braworntype ?? 0) === 'salacious'  ||  ((s as any).braworntype ?? 0) === 'none')) {
      // TODO-QSP: dynamic text: "Excuse me! <<$pcs_firstname>> <<$pcs_lastname>>?" you hear from behind you. Tur...
      scene.text(`"Excuse me! ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}?" you hear from behind you. Turning around, you see an excited girl few years younger than yourself coming towards you. "${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}! The ${((s as any).fame ?? 0)?.['noun']}? It is you, isn't it! You're so… uhh…" She trails off when she realizes that she can practically see straight through your top. Her cheeks flush and she gulps heavily before managing to continue on in a stammer. "Uhh… great at, uh, ${((s as any).fame ?? 0)?.['activity']}…"`);
      ...
      if (((s as any).PCloThinness ?? 0) === 5  &&  (((s as any).braworntype ?? 0) === 'salacious'  ||  ((s as any).braworntype ?? 0) === 'none')) {
        // TODO-QSP: dynamic text: "Excuse me! <<$pcs_firstname>> <<$pcs_lastname>>?" you hear from behind you. Tur...
        scene.text(`"Excuse me! ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}?" you hear from behind you. Turning around, you see an excited girl few years younger than yourself coming towards you. "${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}! The ${((s as any).fame ?? 0)?.['noun']}? It is you, isn't it! You're so…" She trails off for a brief moment and you see her eyes flicker downward for a moment before snapping back up. It was just a small twitch, but you suddenly feel very aware of how thin your top is and how certain things might be "poking" out.`);
        ...
        if (((s as any).PCloThinness ?? 0) === 6) {
          // TODO-QSP: dynamic text: "Excuse me! <<$pcs_firstname>> <<$pcs_lastname>>?" you hear from behind you. Tur...
          scene.text(`"Excuse me! ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}?" you hear from behind you. Turning around, you see an excited girl few years younger than yourself coming towards you. "${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}! The ${((s as any).fame ?? 0)?.['noun']}? It is you, isn't it! You're so cool!"`);
  ...
  scene.actions([
    ...
    qspCall(s, 'stat', '');
    // TODO-QSP: dynamic text: "I'm not <<$pcs_firstname>> <<$pcs_lastname>>" you lie. "But, you look just like...
    scene.text(`"I'm not ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)}" you lie. "But, you look just like her?" she says confused.`);

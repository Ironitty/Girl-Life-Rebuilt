...
function enterStart1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin'] = 1;
...
function enterStartOptions(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['orgasm_count'] = ((s as any).orgasm ?? 0);
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_fuck'] = 1;
...
function enterSavingVirginity(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).know_virgin ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    if (!(s as any).know_virgin) (s as any).know_virgin = {}; (s as any).know_virgin[String((s as any).npcID ?? 0)] = 1;
  ...
  if (((s as any).npc_finance ?? 0)?.[String((s as any).npcID ?? 0)] === 2  &&  ((((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] !== 1  &&  ((s as any).npc_assertive ?? 0)?.[String((s as any).npcID ?? 0)] !== -1)  ||  ((s as any).npc_pushy ?? 0)?.[String((s as any).npcID ?? 0)] > 0)  &&  ((s as any).sex_ev ?? 0)?.['virgin_deny'] === 0) {
    ...
    if (((s as any).npc_condom_conscious ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['no_sex'] = 1;
...
function enterLoverWait(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).WIP_enabled ?? 0) > 0  &&  (Math.floor(Math.random() * 10) + 1) < ((s as any).npc_sexdrive ?? 0)?.[String((s as any).npcID ?? 0)]  &&  ((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['rape_ev'] = 1;
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_deny'] = ((s as any).sex_ev['virgin_deny'] ?? 0) + (1);
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['no_sex'] = 1;
    // TODO-QSP: $sex_ev['bed_room']
...
function enterAnalInstead(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_allowed'] = 1;
...
function enterVirginForceStop(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).npc_rel_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 'sex'  &&  (((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] > 0  ||  ((s as any).npc_misogynist ?? 0)?.[String((s as any).npcID ?? 0)] > 0  ||  ((s as any).npc_womanizer ?? 0)?.[String((s as any).npcID ?? 0)] > 0)) {
      ...
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['fuck_locked'] = 1;
...
function enterVirginForceHappen(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_pushed'] = 1;
  ...
  scene.text(`${((s as any).npcdesc ?? 0)} thrusts his full length inside you and the next word of whatever you were going to say is choked off by a <i>stab</i> of pain in between your thighs. Your mouth is frozen in a silent gasp of both pain and shock and when you look down, you see a glistening red coating ${((s as any).npcdesc ?? 0)}'s shaft and with it, a realization.`);
  ...
  scene.actions([
    ...
    qspCall(s, 'stat', '');
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_media'] = '<center><video autoplay loop ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_virgin" }) + ' src="images/shared/sex/vag/miss/med4.mp4"></video></center>';
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} starts pumping his cock in and out of you at a steady pace, causing squelching from your bloodied pussy with every thrust. After a minute or two, you think...`);
  }, goto: ['sex_ev_virgin', 'virgin_enjoyment'] },
  ]);
  scene.build();
}
...
function enterVirginForcePanic(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`Your voice increases in pitch as your eyes increase in size, watching ${((s as any).npcdesc ?? 0)} penetrates your pussy. It's as if you can feel each and every millimeter of his cock as it slides in until-`);
  // TODO-QSP: end
  scene.actions([
...
function enterBuyVirginity1(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['buy_virginity'] = 5;
  ...
  // TODO-QSP: dynamic text: "<<$func('money', 'string_profit', 5000)>>," he says. "<<$func('money', 'string_...
  scene.text(`"${qspFunc(s, 'money', 'string_profit', 5000)}," he says. "${qspFunc(s, 'money', 'string_profit', 5000)} to let me take your virginity."`);
  qspCall(s, 'sex_ev_virgin', 'buy_virginity_consider');
  // TODO-QSP: end
  scene.actions([
    { label: 'No way!', handler: (st: GameState) => {
    // TODO-QSP: $sex_ev['bed_room']
    // TODO-QSP: dynamic text: "What?! No way!" You gape at <<$npcdesc>> in horror, snapping your legs closed. ...
    scene.text(`"What?! No way!" You gape at ${((s as any).npcdesc ?? 0)} in horror, snapping your legs closed. "What on earth kind of offer is that?"`);
  }, goto: ['sex_ev_virgin', 'buy_virginity_bigger_offer'] },
    { label: 'I\'m not a hooker!', handler: (st: GameState) => {
    // TODO-QSP: $sex_ev['bed_room']
    // TODO-QSP: dynamic text: "What the fuck?" You snap your legs closed as you gape at <<$npcdesc>>'s audacit...
    scene.text(`"What the fuck?" You snap your legs closed as you gape at ${((s as any).npcdesc ?? 0)}'s audacity. "What do you think I am? Some kind of hooker?"`);
    scene.text('"Only if you say yes," he smirks.');
    qspCall(s, 'sex_ev_virgin', 'not_for_sale');
    qspCall(s, 'sex_ev_virgin', 'buy_virginity_consider');
  } },
    { label: 'Try to haggle', handler: (st: GameState) => {
    // TODO-QSP: dynamic text: "<i>Only</i> <<$func('money', 'string_profit', 5000)>>?" you ask. "Surely my fir...
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['buy_virginity'] = 10;
    // TODO-QSP: dynamic text: "You make a good point," <<$npcdesc>> grins. "How about <<$func('money', 'string...
    scene.text(`"You make a good point," ${((s as any).npcdesc ?? 0)} grins. "How about ${qspFunc(s, 'money', 'string_profit', 10000)} then?"`);
    ...
    scene.text(`"Well, let me know if you change your mind," ${((s as any).npcdesc ?? 0)} smirks as he moves the cash to a bedside table. "But that's fine. We can still have fun without losing your virginity. Why don't we just do this instead?"`);
    ...
    qspCall(st, 'sex_ev_foreplay', 'pussy_lick_start');
      ...
      scene.text(`He puts a firm hand on your shoulder and pushes you to your knees. His ${((s as any).dick_desc ?? 0)} cock dangles before you as he moves his hand to your head and pulls your face toward it.`);
      scene.actions([
...
function enterNotForSale(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).npc_pushy ?? 0)?.[String((s as any).npcID ?? 0)] + ((s as any).npc_misogynist ?? 0)?.[String((s as any).npcID ?? 0)] + ((s as any).npc_womanizer ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  ((s as any).sex_ev ?? 0)?.['not_for_sale'] !== ((s as any).totminut ?? 0)) {
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['not_for_sale'] = ((s as any).totminut ?? 0);
      // TODO-QSP: dynamic text: "Fine. <<$func('money', 'string_profit', 10000)>> then."
      scene.text(`"Fine. ${qspFunc(s, 'money', 'string_profit', 10000)} then."`);
      scene.text('He counts out twice as many notes and casually tosses them on the bed.');
      // TODO-QSP: dynamic text: "Let me fuck you and <<$func('money', 'string_profit', 10000)>> are yours right ...
...
function enterBuyVirginityConsider(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: <i><<$func('money', 'string_profit', sex_ev['buy_virginity'] * 1000, 1)>> is a l...
    scene.text(`<i>${qspFunc(s, 'money', 'string_profit', ((s as any).sex_ev ?? {})?.['buy_virginity'] * 1000, 1)} is a lot of money...</i>`);
    qspCall(s, 'sex_ev_virgin', 'not_for_sale');
    qspCall(s, 'sex_ev_virgin', 'buy_virginity_accept');
  } },
  ]);
  scene.build();
}
...
function enterBuyVirginityAccept(s: GameState, scene: SceneBuilder): void {
  ...
  }, goto: ['sex_ev_virgin', 'buy_virginity_accept2'] },
...
function enterBuyVirginityAccept2(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['must_fuck_vag'] = 1;
  ...
  scene.text(`No sooner have you finished than ${((s as any).npcdesc ?? 0)} firmly grabs you by the shoulders and pushes you onto the bed.`);
...
function enterNoCondomOffer(s: GameState, scene: SceneBuilder): void {
  // TODO-QSP: dynamic text: "I'll throw in another <<$func('money', 'string_profit', 5000)>> right now if we...
  ...
  scene.actions([
    ...
    qspCall(s, 'sex_ev_stats', 'prostitution_pay_code', 5000);
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['paid_no_condom'] = 1;
    ...
    scene.text(`"O-okay," you stammer. ${((s as any).npcdesc ?? 0)} doesn't even hesitate and immediately pulls out another ${qspFunc(s, 'money', 'string_profit', 5000)} and slaps it on the bedside table.`);
    ...
    // TODO-QSP: dynamic text: <<$npcdesc>> doesn't even hesitate and immediately pulls out another <<$func('mo...
    scene.text(`${((s as any).npcdesc ?? 0)} doesn't even hesitate and immediately pulls out another ${qspFunc(s, 'money', 'string_profit', 5000)} and slaps it on the bedside table.`);
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['paid_no_condom'] = 1;
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['no_condom'] = 1;
    // TODO-QSP: dynamic text: "Only if you pay me up front," you say. <<$npcdesc>> doesn't even hesitate and i...
    scene.text(`"Only if you pay me up front," you say. ${((s as any).npcdesc ?? 0)} doesn't even hesitate and immediately pulls out another ${qspFunc(s, 'money', 'string_profit', 5000)} and slaps it on the bedside table.`);
    ...
    if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] !== 'creampie') {
      ...
      scene.text(`"Only if you promise not to come inside me," you say. ${((s as any).npcdesc ?? 0)} doesn't even hesitate and immediately pulls out another ${qspFunc(s, 'money', 'string_profit', 5000)} and slaps it on the bedside table.`);
      scene.text('"This is gonna feel so good," he grins as he gets into position.');
      scene.actions([
        { label: 'Continue', goto: ['sex_ev_virgin', 'his_choice'] },
      ]);
    } else {
      qspCall(s, 'sex_ev_virgin', 'paid_creampie_offer');
    }
  } },
  ]);
  scene.build();
...
function enterPaidCreampieOffer(s: GameState, scene: SceneBuilder): void {
  // TODO-QSP: dynamic text: "But that's the best part," he grins back. "Fine. Another <<$func('money', 'stri...
  scene.text(`"But that's the best part," he grins back. "Fine. Another ${qspFunc(s, 'money', 'string_profit', 10000)} if you let me come inside you. ${qspFunc(s, 'money', 'string_profit', (((s as any).sex_ev ?? {})?.['buy_virginity'] + 10) * 1000, 1)} in total."`);
  // TODO-QSP: end
  scene.actions([
    { label: 'Too far', handler: (st: GameState) => {
    ...
    { label: 'Agree (hesitant)', handler: (st: GameState) => {
    qspCall(s, 'sex_ev_stats', 'prostitution_pay_code', 10000);
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['paid_free_creampies'] = 1;
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['creampie_allowance'] = 1;
    // TODO-QSP: dynamic text: "I can't believe I'm letting you do this..." you say reluctantly and <<$npcdesc>...
    scene.text(`"I can't believe I'm letting you do this..." you say reluctantly and ${((s as any).npcdesc ?? 0)} doesn't even hesitate, immediately pulling out another ${qspFunc(s, 'money', 'string_profit', 10000)} and slaps it on the bedside table.`);
    scene.text('"This is gonna feel so good," he grins.');
    if (((s as any).stat ?? 0)?.['preg_risk'] === 'safe') {
    ...
    // TODO-QSP: dynamic text: <<$npcdesc>> doesn't even hesitate, immediately pulling out another <<$func('mon...
    scene.text(`${((s as any).npcdesc ?? 0)} doesn't even hesitate, immediately pulling out another ${qspFunc(s, 'money', 'string_profit', 10000)} and slaps it on the bedside table.`);
    scene.text('"This is gonna feel so good," he grins.');
    if (((s as any).stat ?? 0)?.['preg_risk'] === 'safe') {
    ...
    // TODO-QSP: dynamic text: <<$npcdesc>> doesn't even hesitate and immediately pulls out another <<$func('mo...
    scene.text(`${((s as any).npcdesc ?? 0)} doesn't even hesitate and immediately pulls out another ${qspFunc(s, 'money', 'string_profit', 10000)} and slaps it on the bedside table.`);
    scene.text('"This is gonna feel so good," he grins as he gets into position.');
    if (((s as any).stat ?? 0)?.['preg_risk'] === 'safe') {
      scene.text('<i>It should be a safe day anyways...</i> you think to yourself nervously as you put the money in your bag.');
    } else {
...
function enterHisChoice(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['his_choice_virg'] = 1;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_fuck'] = 1;
  ...
  scene.actions([{ label: 'Continue', goto: ['sex_ev_virgin', 'insertion_pre'] }]);
  // TODO-QSP: end
  scene.build();
}
...
function enterInsertionPre(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['position'] === 'miss'  ||  ((s as any).sex_ev ?? 0)?.['position'] === '') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} lays you down on your back and spreads your legs, placing the head of his ${((s as any).npc_dick_noun ?? 0)?.[String((s as any).npcID ?? 0)]} across the folds of your virgin pussy.`);
  } else {
    if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
      scene.img('images/shared/sex/foreplay/doggy1.jpg');
      // TODO-QSP: dynamic text: <<$npcdesc>> rolls you onto your knees, spreading them apart slightly as he posi...
      scene.text(`${((s as any).npcdesc ?? 0)} rolls you onto your knees, spreading them apart slightly as he positions himself behind you. You can feel him thumbing the folds of your pussy as you look over your shoulder towards him.`);
    } else {
      if (((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
        scene.img('images/shared/sex/foreplay/cowgirl1.jpg');
        // TODO-QSP: dynamic text: "It might be better if you do this yourself," <<$npcdesc>> says and lays back on...
        scene.text(`"It might be better if you do this yourself," ${((s as any).npcdesc ?? 0)} says and lays back on the bed, motioning for you to climb on top of him. You do as he says, throwing your legs over his until his ${((s as any).npc_dick_noun ?? 0)?.[String((s as any).npcID ?? 0)]} is upright between your thighs, flat against your belly and giving you a <i>very vivid</i> image of exactly how far this thing is going to go into you.`);
      }
    }
  }
  ...
  if (((s as any).sex_ev ?? 0)?.['position'] !== '') {
    if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
      ...
      if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
        ...
        scene.actions([{ label: 'Continue', goto: ['sex_ev_virgin', 'cowgirl_virg_norm1'] }]);
      }
    }
  } else {
    if (((s as any).sex_ev ?? 0)?.['speed'] < 3  ||  ((s as any).npc_generous ?? 0)?.[String((s as any).npcID ?? 0)] === 1  ||  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
...
function enterChangeMind(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['reluctant_bj'] = 1;
...
function enterMissVirgNorm1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).dick_desc ?? 0) === 'long'  ||  ((s as any).dick_desc ?? 0) === 'huge'  ||  ((s as any).dick_desc ?? 0) === 'enormous'  ||  ((s as any).dick_desc ?? 0) === 'lengthy'  ||  ((s as any).dick_desc ?? 0) === 'gigantic'  ||  ((s as any).dick_desc ?? 0) === 'monstrous') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['big_cock_virgin'] = 1;
...
function enterMissVirgNorm1_1(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'sex_ev_virgin', '', '' + qspUntranslated(s, "sex_ev['virgin_react']>", { location: "sex_ev_virgin" }) + '_react1');
  // TODO-QSP: end
  scene.actions([
    { label: 'Continue', handler: (st: GameState) => {
    if (((s as any).sex_ev ?? 0)?.['condom'] === 1) {
    ...
    qspCall(s, 'sex_ev_virgin', '', '' + qspUntranslated(s, "sex_ev['virgin_react']>", { location: "sex_ev_virgin" }) + '_react2');
    ...
    qspCall(s, 'stat', '');
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_media'] = '<center><video autoplay loop ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_virgin" }) + ' src="images/shared/sex/vag/miss/slow1.mp4"></video></center>';
    // TODO-QSP: $sex_ev['virgin_media']
    // TODO-QSP: dynamic text: As promised, <<$npcdesc>> fucks you very gently, slowly pumping his cock in and ...
    scene.text(`As promised, ${((s as any).npcdesc ?? 0)} fucks you very gently, slowly pumping his cock in and out of you. He displays what you can only imagine is incredible patience, as he maintains this slow and gentle pace for several minutes, at which point you think...`);
  }, goto: ['sex_ev_virgin', 'virgin_enjoyment'] },
    ]);
  } },
  ]);
...
function enterMissVirgKiss(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_no_kiss ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    scene.text(`Unable to contain yourself, you forget your rules and reach up, pulling ${((s as any).npcdesc ?? 0)}'s face down to press it against yours. Your eyes roll back in your head, feeling the thrust of his cock in your pussy and the invasion of his tongue in your mouth. You moan into his mouth and he moans back.`);
  } else {
    // TODO-QSP: dynamic text: Caught up in the moment, you reach up and grab <<$npcdesc>>'s face, pulling it d...
    scene.text(`Caught up in the moment, you reach up and grab ${((s as any).npcdesc ?? 0)}'s face, pulling it down to kiss him. Your eyes roll back in your head, feeling the thrust of his cock in your pussy and the invasion of his tongue in your mouth. You moan into his mouth and he moans back.`);
  }
...
function enterMissVirgHard1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You half gasp half shriek as ${((s as any).npcdesc ?? 0)} slams his cock inside you, tearing straight through your hymen in one thrust and your eyes water at the intense stab of pain.`);
  if (((s as any).know_virgin ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    // TODO-QSP: dynamic text: Despite telling <<$npcdesc>> how important your first time is to you, he doesn't...
    scene.text(`Despite telling ${((s as any).npcdesc ?? 0)} how important your first time is to you, he doesn't seem to care about taking it easy on you. You scream in pain as he rams his cock in and out of you with tremendous force, pistoning with jackhammer like intensity.`);
  } else {
    // TODO-QSP: dynamic text: If you thought that <<$npcdesc>> was going to take it easy on you for your first...
    scene.text(`If you thought that ${((s as any).npcdesc ?? 0)} was going to take it easy on you for your first time, you were sorely mistaken. Literally. You scream in pain as he rams his cock in and out of you with tremendous force, pistoning with jackhammer like intensity.`);
  }
  // TODO-QSP: end
  scene.actions([
    ...
    // TODO-QSP: dynamic text: "Can we-! Slow down-! A little-?" you whimper under <<$npcdesc>>'s relentless po...
    scene.text(`"Can we-! Slow down-! A little-?" you whimper under ${((s as any).npcdesc ?? 0)}'s relentless pounding. "This is-! A bit-! Rough-!"`);
    if (((Math.floor(Math.random() * 10) + 1) >= 7  ||  ((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1  ||  ((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] === 1)  &&  ((s as any).npc_generous ?? 0)?.[String((s as any).npcID ?? 0)] !== 1) {
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['fuck_enjoyment'] = 'painful';
...
function enterMissVirgHard2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).npcdesc ?? 0)} picks up the pace as you command and you instinctively arch your back, getting him to thrust deeper into you. The heightened pace feels even better than it did when he was being gentle and you moan loudly with intense pleasure.`);
...
function enterDoggyVirgNorm1(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['speed'] = 1;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin'] = 1;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'doggy1';
  // TODO-QSP: gs 'arousal', 'vaginal', 1, 'no_orgasm_msg', $sex_ev['prostitution_flag']
  qspCall(s, 'stat', '');
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['position'] = 'doggy';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'doggy1';
  ...
  scene.text(`${((s as any).npcdesc ?? 0)} slowly presses his cock inside you from behind. It fills you up, stretching your walls before bumping against your hymen. After a brief pause, he pushes through, tearing your maidenhood and causing you to gasp. Whether in excitement or pain, you aren't really sure yet.`);
  scene.text('"You okay?"');
  // TODO-QSP: end
  scene.actions([
    { label: 'It hurts', handler: (st: GameState) => {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_react'] = 'hurt';
    qspCall(s, 'sex_ev_virgin', 'doggy_virg_norm1.1');
  } },
    { label: 'I\'m fine', handler: (st: GameState) => {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_react'] = 'fine';
    qspCall(s, 'sex_ev_virgin', 'doggy_virg_norm1.1');
...
function enterDoggyVirgNorm1_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'doggy1';
    qspCall(s, 'stat', '');
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_media'] = '<center><video autoplay loop ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_virgin" }) + ' src="images/shared/sex/vag/doggy/slow1.mp4"></video></center>';
    // TODO-QSP: $sex_ev['virgin_media']
    // TODO-QSP: dynamic text: As promised, <<$npcdesc>> fucks you very gently, slowly pumping his cock in and ...
    scene.text(`As promised, ${((s as any).npcdesc ?? 0)} fucks you very gently, slowly pumping his cock in and out of you. He displays what you can only imagine is incredible patience, as he maintains this slow and gentle pace for several minutes, at which point you think...`);
    qspCall(s, 'sex_ev_virgin', 'virgin_enjoyment');
...
function enterDoggyVirgHard1(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['position'] = 'doggy';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'doggy3';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['speed'] = 3;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['fuck_enjoyment'] = 'painful';
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} fucks you roughly and without mercy or restraint. It hurts so much. Every time his cock slams back in to you, you feel like you're going to die. It's like your pussy is being torn in half and you wonder if you're going to piss blood after this. He lets all of his weight rest on top of you, driving the breath from your lungs. You can't even scream. All you can do is squirm beneath ${((s as any).npcdesc ?? 0)} as he pounds your virgin pussy over and over again.`);
    scene.actions([
      { label: 'Endure it', handler: (st: GameState) => {
    ...
    scene.text(`"Can we-! Slow down-! A little-?" you manage to gasp under ${((s as any).npcdesc ?? 0)}'s relentless pounding. "This is-! Too-! Rough-!"`);
...
function enterCowgirlVirgNorm1(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: Grabbing hold of <<$npcdesc>>'s cock, you try to guide it in with your hand as y...
  scene.text(`Grabbing hold of ${((s as any).npcdesc ?? 0)}'s cock, you try to guide it in with your hand as you ease yourself down onto it. It's kind of awkward to do and you have a lot of difficulty getting it to enter your pussy straight.`);
  if (((s as any).npc_generous ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    // TODO-QSP: dynamic text: "It's okay, take your time," <<$npcdesc>> assures you. "Hard to get it in, isn't...
    scene.text(`"It's okay, take your time," ${((s as any).npcdesc ?? 0)} assures you. "Hard to get it in, isn't it?"`);
    ...
    scene.text(`"Ready?" ${((s as any).npcdesc ?? 0)} asks gently.`);
    ...
    // TODO-QSP: dynamic text: The pain of <<$npcdesc>>'s cock ripping through your hymen is enough to make you...
    scene.text(`The pain of ${((s as any).npcdesc ?? 0)}'s cock ripping through your hymen is enough to make your eyes water.`);
    scene.text('"Fuck!" you involuntarily squeak. "Fuckfuckfuckfuckfuckfuckfuck! That hurts!"');
    // TODO-QSP: dynamic text: "It's okay," <<$npcdesc>> says, assuring you, putting his hands on your hips. "T...
    scene.text(`"It's okay," ${((s as any).npcdesc ?? 0)} says, assuring you, putting his hands on your hips. "Take it slow, alright?"`);
    scene.actions([
    ...
    scene.text(`You soldier onwards, continuing to ride ${((s as any).npcdesc ?? 0)}. A few minutes pass and you work yourself up to a slow but steady rhythm, bouncing up and down on his cock. And soon, you realize you...`);
    qspCall(s, 'sex_ev_virgin', 'virgin_enjoyment');
  } },
    ...
    scene.text(`You soldier onwards, continuing to fuck ${((s as any).npcdesc ?? 0)} with relentless fervor, riding him like your life depends on it. Soon, you realize...`);
    qspCall(s, 'sex_ev_virgin', 'virgin_enjoyment');
  } },
    ]);
  } },
    ...
    if (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      scene.text(`"Come on, hurry up," ${((s as any).npcdesc ?? 0)} complains loudly.`);
      ...
      // TODO-QSP: dynamic text: "Come on already!" <<$npcdesc>> doesn't wait for a response and thrusts his hips...
      scene.text(`"Come on already!" ${((s as any).npcdesc ?? 0)} doesn't wait for a response and thrusts his hips up, sending his cock tearing through your virginity.`);
      scene.actions([
        { label: '<b>!!!!</b>', handler: (st: GameState) => {
    // TODO-QSP: gs 'arousal', 'vaginal', 1, 'no_orgasm_msg', $sex_ev['prostitution_flag']
    qspCall(s, 'stat', '');
    ...
    // TODO-QSP: dynamic text: Deciding you're already this far, you let him, slowly lifting yourself up and sl...
    scene.text(`Deciding you're already this far, you let him, slowly lifting yourself up and sliding back down on his cock. And then again. And again. And again. A few minutes pass and you've worked yourself up to a steady rhythm, bouncing up and down on ${((s as any).npcdesc ?? 0)}'s cock. And soon, you realize you...`);
    qspCall(s, 'sex_ev_virgin', 'virgin_enjoyment');
  } },
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} grins back at you and pulls you back down with equal eagerness, and soon you're riding ${((s as any).npcdesc ?? 0)} with relentless fervor, fucking him like there's no tomorrow. Somewhere in the back of your mind, you realize your first time is turning into some kind of hate fuck but the anger that burns within refuses to let you back down. Soon, you realize...`);
    qspCall(s, 'sex_ev_virgin', 'virgin_enjoyment');
  } },
    ]);
  } },
      ...
      scene.text(`"You okay up there?" ${((s as any).npcdesc ?? 0)} asks, a quizzical look on his face.`);
      ...
      scene.text(`"Whenever you're ready," ${((s as any).npcdesc ?? 0)} says.`);
    ...
    scene.text(`The pain of ${((s as any).npcdesc ?? 0)}'s cock ripping through your hymen is enough to make your eyes water.`);
    scene.text('"Fuck!" you involuntarily squeak. "Fuckfuckfuckfuckfuckfuckfuck! That hurts!"');
    // TODO-QSP: dynamic text: "Keep moving, it'll get better," <<$npcdesc>> says, assuring you, putting his ha...
    scene.text(`"Keep moving, it'll get better," ${((s as any).npcdesc ?? 0)} says, assuring you, putting his hands on your hips.`);
    scene.actions([
      { label: 'Take his advice', handler: (st: GameState) => {
    qspCall(s, 'sex_ev_sex', 'fuck_arousal_code');
    qspCall(s, 'stat', '');
    ...
    // TODO-QSP: dynamic text: You pound yourself down on <<$npcdesc>>'s cock, fucking him with reckless abando...
    scene.text(`You pound yourself down on ${((s as any).npcdesc ?? 0)}'s cock, fucking him with reckless abandon, riding him like your life depends on it, trying to plow your way past the hard part to the "good part." <i>Whatever that's supposed to feel like,</i> you think to yourself with gritted teeth. Soon, you realize...`);
    qspCall(s, 'sex_ev_virgin', 'virgin_enjoyment');
  } },
    ]);
  } },
...
function enterCowgirlVirgHard1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`Feeling good, you pick up the pace, bouncing up and down on ${((s as any).npcdesc ?? 0)}'s cock with giddy excitement. Going a little harder feels even better than before and without warning you begin bursting into giggles.`);
...
function enterVirgContinueHarder(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
    if (((s as any).sex_ev ?? 0)?.['virgin_pain_good'] !== 1) {
      scene.actions([{ label: 'Continue', goto: ['sex_ev_virgin', 'miss_virg_hard2'] }]);
    } else {
      scene.actions([{ label: 'Continue', goto: ['sex_ev_virgin', 'miss_virg_hard2_2'] }]);
    }
  } else {
    if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
      if (((s as any).sex_ev ?? 0)?.['virgin_pain_good'] !== 1) {
        scene.actions([{ label: 'Continue', goto: ['sex_ev_virgin', 'doggy_virg_hard2'] }]);
      } else {
        scene.actions([{ label: 'Continue', goto: ['sex_ev_virgin', 'doggy_virg_hard2_2'] }]);
      }
    }
  }
  // TODO-QSP: end
...
function enterFuckCum(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['cum_choice'] === 'warn') {
    ...
    if (((Math.floor(Math.random() * 2) + 0) === 1  ||  ((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1)  &&  (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] === 'creampie'  &&  ((s as any).sex_ev ?? 0)?.['condom'] !== 1)  &&  ((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] !== 'pullout'  &&  ((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] !== '') {
      ...
      if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] === 'creampie') {
        ...
        if (((s as any).sex_ev ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
          ...
          scene.text(`"Let's come together," ${((s as any).npcdesc ?? 0)} says, smiling at you.`);
        } else {
          // TODO-QSP: dynamic text: "I wanna come inside you so bad," <<$npcdesc>> says, grunting with the effort of...
          scene.text(`"I wanna come inside you so bad," ${((s as any).npcdesc ?? 0)} says, grunting with the effort of holding himself back from blowing his load inside you right now.`);
        }
      } else {
        if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] === 'mouth') {
          ...
          scene.text(`"Let me come in your mouth," ${((s as any).npcdesc ?? 0)} says, grunting with the effort of holding himself back from blowing his load right now.`);
        } else {
          if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] === 'face') {
            ...
            scene.text(`"I wanna come on your face," ${((s as any).npcdesc ?? 0)} says, grunting with the effort of holding himself back from blowing his load right now. "I want to see my cum all over you."`);
          } else {
            if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] === 'tits') {
              ...
              scene.text(`"I wanna come on your tits," ${((s as any).npcdesc ?? 0)} says, grunting with the effort of holding himself back from blowing his load right now.`);
            }
          }
        }
      }
    ...
    if (!(s as any).npc_creampie_okay) (s as any).npc_creampie_okay = {}; (s as any).npc_creampie_okay[String((s as any).npcID ?? 0)] = 1;
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
        ...
        if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'enjoy') {
          if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
            ...
            scene.text(`You turn your head over your shoulder to look at ${((s as any).npcdesc ?? 0)}.`);
          }
...
function enterGirlCum(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['orgasm'] = ((s as any).orgasm ?? 0);
  if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
    scene.actions([{ label: 'Continue', goto: ['sex_ev_virgin', 'miss_cum'] }]);
  } else {
    if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
      scene.actions([{ label: 'Continue', goto: ['sex_ev_virgin', 'doggy_cum'] }]);
    } else {
      if (((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
        scene.actions([{ label: 'Continue', goto: ['sex_ev_virgin', 'cowgirl_cum'] }]);
      }
    }
  }
  // TODO-QSP: end
...
function enterMissCum(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'miss3') {
    ...
    if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'miss2') {
      ...
      scene.img('images/shared/sex/vag/miss/med1.mp4');
      // TODO-QSP: dynamic text: The feeling of <<$npcdesc>>'s cock inside you is so wonderful, your pussy tighte...
      scene.text(`The feeling of ${((s as any).npcdesc ?? 0)}'s cock inside you is so wonderful, your pussy tightens on him with every gentle thrust. The feeling is so sublime and the experience is so new, you don't realize you're about to orgasm until right before it happens. The pleasure that was building inside you suddenly releases and you find yourself caught in the throes of it, shuddering uncontrollably beneath ${((s as any).npcdesc ?? 0)} with his cock in a vice grip inside you.`);
    }
  }
  // TODO-QSP: end
  scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'miss3') {
      ...
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_media'] = '<center><video autoplay loop ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_virgin" }) + ' src="images/shared/sex/vag/miss/rough1.mp4"></video></center>';
    } else {
      if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'miss2') {
        scene.img('images/shared/sex/vag/miss/med1.mp4');
        if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_media'] = '<center><video autoplay loop ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_virgin" }) + ' src="images/shared/sex/vag/miss/med1.mp4"></video></center>';
      } else {
        scene.img('images/shared/sex/vag/miss/med1.mp4');
        scene.text('Eventually, your orgasm fades and you\'re left panting heavily, trying to catch your breath.');
        if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_media'] = '<center><video autoplay loop ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_virgin" }) + ' src="images/shared/sex/vag/miss/slow2.mp4"></video></center>';
      }
    }
    // TODO-QSP: dynamic text: <i>Woah... Orgasming from real sex is... really different...</i> you think, groa...
    scene.text(`<i>Woah... Orgasming from real sex is... really different...</i> you think, groans coming from your mouth as ${((s as any).npcdesc ?? 0)} continues fucking your still-sensitive pussy.`);
    scene.actions([
...
function enterHurtReact2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['position'] === 'anal') {
    ...
    scene.text(`"Let's just take a minute. Give you some time to adjust," ${((s as any).npcdesc ?? 0)} says.`);
  } else {
    // TODO-QSP: dynamic text: "Let's just take a minute. Give you some time to adjust," <<$npcdesc>> says. Jus...
    scene.text(`"Let's just take a minute. Give you some time to adjust," ${((s as any).npcdesc ?? 0)} says. Just after he says that, you feel something running down the curve of your thigh. <i>What is tha-</i> you start to wonder before it hits you; it's blood from your torn hymen. You've officially lost your virginity.`);
  }
  // TODO-QSP: dynamic text: After a minute or two of letting <<$npcdesc>>'s cock stretch your ' + iif($sex_e...
  scene.text(`After a minute or two of letting ${((s as any).npcdesc ?? 0)}'s cock stretch your ' + iif($sex_ev['position'] = 'anal', 'ass,', 'pussy,') + ' you nod for him to move again.`);
...
function enterFineReact2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('He keeps pushing inside, eliciting more grunts of discomfort from you, until he finally stops moving and you think he\'s fully inside you. Having a penis inside you is a decidedly strange experience. You can feel his cock bulging inside your \' + iif($sex_ev[\'position\'] = \'anal\', \'ass,\', \'pussy,\') + \' stretching it to its limits and straining against them. You feel "full", and you can\'t think of another way to describe it at the moment.');
  if (((s as any).sex_ev ?? 0)?.['position'] === 'anal') {
    // TODO-QSP: dynamic text: "Let's just take a minute. Give you some time to adjust," <<$npcdesc>> says.
    scene.text(`"Let's just take a minute. Give you some time to adjust," ${((s as any).npcdesc ?? 0)} says.`);
  } else {
  ...
  // TODO-QSP: dynamic text: After a minute or two of letting <<$npcdesc>>'s cock stretch your ' + iif($sex_e...
  scene.text(`After a minute or two of letting ${((s as any).npcdesc ?? 0)}'s cock stretch your ' + iif($sex_ev['position'] = 'anal', 'ass,', 'pussy,') + ' you signal for him to move again.`);
...
function enterBigReact1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'extra_big') {
    ...
    scene.text(`"<i>Ahh~!</i>" you gasp, feeling breathless as ${((s as any).npcdesc ?? 0)} begins to penetrate you. "You're really <i>-eep-!</i>!" Your next word is cut short as the entirety of his head pushes into you, stretching your entrance, and causing you to squeal. "<i>Ohmygod</i>, your dick is huge-!"`);
  } else {
    // TODO-QSP: dynamic text: "<i>Ahh~!</i>" you gasp, feeling breathless as <<$npcdesc>> begins to penetrate ...
    scene.text(`"<i>Ahh~!</i>" you gasp, feeling breathless as ${((s as any).npcdesc ?? 0)} begins to penetrate you. "You're really <i>-ah-</i> big-!"`);
  }
  if (((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    // TODO-QSP: dynamic text: "Sorry about that," he mumbles shyly. "Maybe not the best guy to lose your ' + i...
    scene.text('"Sorry about that," he mumbles shyly. "Maybe not the best guy to lose your \' + iif($sex_ev[\'position\'] = \'anal\', \'anal virginity,\', \'virginity\') + \' to. Just hold on a little longer. I\'m almost all the way in."');
  } else {
    if (((s as any).npc_arrogant ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      scene.text(`"You picked a great cock to lose your virginity to," he grins, forcing more of his ${((s as any).dick_desc ?? 0)} shaft inside you.`);
    } else {
...
function enterBigReact2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You barely stifle another gasp as ${((s as any).npcdesc ?? 0)} finishes pushing the entire length of his ${((s as any).dick_desc ?? 0)} cock into your ' + iif($sex_ev['position'] = 'anal', 'ass.', 'pussy.') + ' It makes you feel stuffed, like your stomach is <i>bulging</i> with it inside you. Your ' + iif($sex_ev['position'] = 'anal', 'ass', 'pussy') + ' is crying in protest and sharp pains lance through your uncomfortably stretched sex.`);
  if (((s as any).sex_ev ?? 0)?.['position'] === 'anal') {
    // TODO-QSP: dynamic text: "Let's just take a minute. Give you some time to adjust," <<$npcdesc>> says.
    scene.text(`"Let's just take a minute. Give you some time to adjust," ${((s as any).npcdesc ?? 0)} says.`);
  } else {
...
function enterVirginEnjoyment(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['speed_change'] === 1) {
    ...
    if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'cowgirl3') {
      ...
      scene.text(`This was a fucking terrible idea! Why did you think that you could lose your virginity like this? Why are you even trying? Tears well up in your eyes as you continue to impale yourself on ${((s as any).npcdesc ?? 0)}'s cock, wondering to yourself why you're so fucking stupid.`);
    } else {
      if (((s as any).sex_ev ?? 0)?.['virgin_react'] === 'hurt') {
        ...
        scene.text(`What initially started as a painful experience continues to be one. Every time ${((s as any).npcdesc ?? 0)}'s cock moves inside you, it feels like your vagina is going to split in half. Everything about it hurts. Your insides hurt, your vulva hurts, your cervix hurts, it feels like your pussy is literally being stabbed. You spend each moment praying he'll just cum already and your agony can end.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['virgin_react'] === 'fine') {
          ...
          scene.text(`It wasn't so bad when he first entered you, but what started as mild discomfort has become full blown agony. Every time ${((s as any).npcdesc ?? 0)}'s cock moves inside you, it feels like your vagina is going to split in half. Everything about it hurts. Your insides hurt, your vulva hurts, your cervix hurts, it feels like your pussy is literally being stabbed. You keep expecting it to get better, for the pain to go away and the enjoyment to start, but it never does. All you can do is clench your teeth, squeeze your eyes shut, and keep enduring until it's over.`);
        } else {
    ...
    if (((s as any).sex_ev ?? 0)?.['virgin_react'] === 'hurt') {
      ...
      if (((s as any).sex_ev ?? 0)?.['virgin_react'] === 'fine') {
        ...
        scene.text(`That "fullness" you remarked upon earlier has somehow become even more full as ${((s as any).npcdesc ?? 0)} has continued to fuck you. Your arousal flows like water from your pussy and his cock is slick with your blood and juices. It reaches deep inside you and it feels <i>so good</i>, causing you to openly moan.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['virgin_react'] === 'mmm') {
          // TODO-QSP: dynamic text: That "fullness" you remarked upon earlier has somehow become even more full as <...
          scene.text(`That "fullness" you remarked upon earlier has somehow become even more full as ${((s as any).npcdesc ?? 0)} has continued to fuck you. Your arousal flows like water from your pussy and his cock is slick with your blood and juices. It reaches deep inside you and it feels <i>so good</i>, causing you to openly moan.`);
...
function enterFirstTimeTalk(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_talk'] = 1;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['good_for_you'] = 1;
  ...
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_enjoyment_share'] = (-1);
    ...
    scene.text(`"Yeah, really," ${((s as any).npcdesc ?? 0)} laughs back. "Some girls I know said their first time hurt. But those same girls love it now."`);
    ...
    scene.text(`"I hope so," you groan, throwing your head back as ${((s as any).npcdesc ?? 0)} laughs.`);
    scene.text('"If it\'s any consolation, your pussy felt great."');
    scene.text('"It\'s not," you harumph, crossing your arms and he laughs again.');
    qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} laughs in reply but holds his hands up in surrender.`);
    qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ]);
  } },
    ...
    if (((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      // TODO-QSP: dynamic text: "Sorry I couldn't live up to expectation," <<$npcdesc>> says with a rueful smile...
      scene.text(`"Sorry I couldn't live up to expectation," ${((s as any).npcdesc ?? 0)} says with a rueful smile.`);
      scene.text('You blush at how sweet he\'s being, but you don\'t say anything else and leave it there.');
    } else {
      // TODO-QSP: dynamic text: "This is why first times suck," <<$npcdesc>> shrugs. "You'll feel better next ti...
      scene.text(`"This is why first times suck," ${((s as any).npcdesc ?? 0)} shrugs. "You'll feel better next time, now that you're not a virgin."`);
      scene.text('"I hope so," you say, not really sure how else to respond.');
    }
    qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_enjoyment_share'] = 2;
    scene.img(`images/shared/sex/after/pillow_talk${Math.floor(Math.random() * 2) + 1}.jpg`);
    ...
    if (((s as any).npc_generous ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      // TODO-QSP: dynamic text: "I'm glad I was able to give you a good first time," <<$npcdesc>> smiles back, l...
      scene.text(`"I'm glad I was able to give you a good first time," ${((s as any).npcdesc ?? 0)} smiles back, leaning in to kiss you.`);
      qspCall(s, 'sex_ev_virgin', 'kiss_turn_head');
      scene.actions([
    ...
    qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
      ...
      scene.text(`"Yeah," ${((s as any).npcdesc ?? 0)} grins. "Might not always be that way though. Not every guy's as good a lay as I am."`);
      qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
    }
  } },
        { label: 'It was amazing', handler: (st: GameState) => {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_enjoyment_share'] = 3;
    scene.img(`images/shared/sex/after/pillow_talk${Math.floor(Math.random() * 2) + 1}.jpg`);
    ...
    if (((s as any).npc_generous ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      scene.text(`Perhaps spurred by your words, ${((s as any).npcdesc ?? 0)} quickly moves in to kiss you.`);
      qspCall(s, 'sex_ev_virgin', 'kiss_turn_head');
      scene.actions([
        { label: 'Kiss him back', handler: (st: GameState) => {
  ...
  qspCall(s, 'sex_ev_virgin', 'hurt_then_good');
  qspCall(s, 'sex_ev_virgin', 'numb_then_good');
  qspCall(s, 'sex_ev_virgin', 'big_cock_virgin');
  // TODO-QSP: end
  scene.build();
}
...
function enterNiceLie1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_enjoyment_share'] = 3;
    if (!(s as any).first_time_nice_lie1) (s as any).first_time_nice_lie1 = {}; (s as any).first_time_nice_lie1[String((s as any).npcID ?? 0)] = 1;
    scene.img(`images/shared/sex/after/pillow_talk${Math.floor(Math.random() * 2) + 1}.jpg`);
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
...
function enterNiceLie2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You smile and let ${((s as any).npcdesc ?? 0)} press his lips against yours, gasping into his mouth when you feel his fingers thumb over your clit again before pulling away. Unlike the experience you just had, this <i>does</i> feel nice.`);
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
      scene.text('Losing your virginity was painful, but at least he\'s sweet.');
    } else {
      if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
    ...
    qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
      ...
      scene.text(`"Yeah," ${((s as any).npcdesc ?? 0)} grins, giving your clit a hard rub before pulling away. "Might not always be that way though. Not every guy's as good a lay as I am."`);
      if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
        scene.text('<i>Fuck, I hope so,</i> you think to yourself. <i>That was fucking torture!</i>');
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
...
function enterAmazingLie1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).first_time_nice_amazing) (s as any).first_time_nice_amazing = {}; (s as any).first_time_nice_amazing[String((s as any).npcID ?? 0)] = 1;
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_enjoyment_share'] = 3;
    scene.img('images/shared/sex/after/pillow_talk1.jpg');
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
        ...
        scene.text(`Losing your virginity didn't feel like much in the end, but at least ${((s as any).npcdesc ?? 0)} is sweet.`);
      }
    }
    qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
  } },
      ...
      // TODO-QSP: dynamic text: "Better hope you don't," <<$npcdesc>> grins. "Not every guy's as good a lay as I...
      scene.text(`"Better hope you don't," ${((s as any).npcdesc ?? 0)} grins. "Not every guy's as good a lay as I am. Could be hard for you to get your fix."`);
      if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
        scene.text('<i>Fuck, I hope so,</i> you think to yourself. <i>That was fucking torture!</i>');
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
...
function enterNumbThenGood(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['virgin_numb'] === 1) {
    ...
    scene.text(`You smile gratefully at ${((s as any).npcdesc ?? 0)}.`);
    qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
  } },
      ]);
    }
...
function enterBigCockVirgin(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['big_cock_virgin'] === 1  &&  ((s as any).pain ?? 0)?.['vaginal'] > 10) {
    ...
    if (!(s as any).npc_rel) (s as any).npc_rel = {}; (s as any).npc_rel[String((s as any).npcID ?? 0)] = ((s as any).npc_rel[String((s as any).npcID ?? 0)] ?? 0) + (1);
    ...
    scene.text(`"Next time...?" ${((s as any).npcdesc ?? 0)} raises an amused eyebrow.`);
    qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
  } },
      ]);
    } else {
      if (((s as any).npc_arrogant ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        // TODO-QSP: dynamic text: "You'll be grateful one day," he grins back, stopping to seemingly admire his ow...
        scene.text(`"You'll be grateful one day," he grins back, stopping to seemingly admire his own ${((s as any).dick_desc ?? 0)} cock. "After a bunch of tiny limp dick dudes with micro penises, you'll look back and remember me."`);
        scene.actions([
    ...
    qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
        ...
        scene.text(`"It <i>is</i> a pretty big one," he replies with a small smile, looking down at his own ${((s as any).dick_desc ?? 0)} cock. "Not much I can do about the size of my own dick though."`);
        scene.actions([
          { label: 'Agree', handler: (st: GameState) => {
    ...
    scene.text(`"Okay, maybe I do," ${((s as any).npcdesc ?? 0)} chuckles.`);
    qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
  } },
        ]);
      }

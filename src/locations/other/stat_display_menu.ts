...
function enterRenderCellOpt(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).rco ?? 0)?.['i'] < ((s as any).rco ?? 0)?.['size']) {
    ...
    if (((s as any).rco ?? 0)?.['pipe'] > 0) {
      (s as any).rco['entry_val'] = ((qspUntranslated(s, "temp_values[rco['i']]", { location: "stat_display_menu" })).slice((1)-1, ((1)-1)+(((s as any).rco ?? 0)?.['pipe'] - 1)));
      (s as any).rco['entry_lbl'] = ((qspUntranslated(s, "temp_values[rco['i']]", { location: "stat_display_menu" })).slice((((s as any).rco ?? 0)?.['pipe'] + 1)-1));
    } else {
  ...
  if (((s as any).rco ?? 0)?.['pipe'] > 0) {
    (s as any).rco['entry_val'] = ((qspUntranslated(s, "temp_values[rco['idx']]", { location: "stat_display_menu" })).slice((1)-1, ((1)-1)+(((s as any).rco ?? 0)?.['pipe'] - 1)));
    (s as any).rco['entry_lbl'] = ((qspUntranslated(s, "temp_values[rco['idx']]", { location: "stat_display_menu" })).slice((((s as any).rco ?? 0)?.['pipe'] + 1)-1));
  } else {
...
function enterRenderCellNum(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).rcn['act_left'] = ((s as any).locArgs?.[2] ?? 0) + ' = ((s as any).max ?? 0)(' + String(((s as any).rcn ?? 0)?.['min']) + ', ' + ((s as any).locArgs?.[2] ?? 0) + ' - 1)';
  (s as any).rcn['act_right'] = ((s as any).locArgs?.[2] ?? 0) + ' = ((s as any).min ?? 0)(' + String(((s as any).rcn ?? 0)?.['max']) + ', ' + ((s as any).locArgs?.[2] ?? 0) + ' + 1)';
...
function enterReorderFlat(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).ro['html'] = '<tr><td align="center" colspan="3" style="padding:6px 10px 2px 10px; text-align:center;"><b>Order &amp; Visibility</b>&nbsp; <a href="exec: killvar \'$<<$ARGS[1]>>\' & gt \'$menu_settings\', \'<<$ARGS[3]>>\'">[Reset]</a></td></tr>';
  ...
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: gs \'$menu_settings\', \'swap\', \'<<$ARGS[1]>>\', <<ro[\'i\']>>, \'up\' & gt \'$menu_settings\', \'<<$ARGS[3]>>\'"><img height="18" src="<<$ro[\'up\']>>"></a>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: gs \'$menu_settings\', \'swap\', \'<<$ARGS[1]>>\', <<ro[\'i\']>>, \'down\' & gt \'$menu_settings\', \'<<$ARGS[3]>>\'"><img height="18" src="<<$ro[\'down\']>>"></a>');
  ...
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="display:block; text-decoration:none; color:inherit;" href="exec: <<$ARGS[2]>>[\'<<$ro[\'key\']>>\'] = 1 - <<$ARGS[2]>>[\'<<$ro[\'key\']>>\'] & gt \'$menu_settings\', \'<<$ARGS[3]>>\'">\' + $ro[\'label\'] + \'</a>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 0 0 3px;">');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: <<$ARGS[2]>>[\'<<$ro[\'key\']>>\'] = 1 - <<$ARGS[2]>>[\'<<$ro[\'key\']>>\'] & gt \'$menu_settings\', \'<<$ARGS[3]>>\'"><img height="18" src="<<$ro[\'hide_icon\']>>"></a>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
...
function enterReorderNestedSkills(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="vertical-align:middle;">');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 3px 0 0;">');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: gs \'$menu_settings\', \'swap\', \'skill_group_order\', <<ro[\'gi\']>>, \'up\' & gt \'$menu_settings\', \'status\'"><img height="18" src="<<$ro[\'up\']>>"></a>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: gs \'$menu_settings\', \'swap\', \'skill_group_order\', <<ro[\'gi\']>>, \'down\' & gt \'$menu_settings\', \'status\'"><img height="18" src="<<$ro[\'down\']>>"></a>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td align="center" style="text-align:center; padding:0 4px;">');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="display:block; text-decoration:none; color:inherit;" href="exec: stat_cfg[\'show_skills_<<$ro[\'gkey\']>>\'] = 1 - stat_cfg[\'show_skills_<<$ro[\'gkey\']>>\'] & gt \'$menu_settings\', \'status\'">\' + $ro[\'glbl\'] + \'</a>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 0 0 3px;">');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: stat_hide[\'<<$ro[\'gkey\']>>\'] = 1 - stat_hide[\'<<$ro[\'gkey\']>>\'] & gt \'$menu_settings\', \'status\'"><img height="18" src="<<$ro[\'ghi_ic\']>>"></a>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: stat_cfg[\'show_skills_<<$ro[\'gkey\']>>\'] = 1 - stat_cfg[\'show_skills_<<$ro[\'gkey\']>>\'] & gt \'$menu_settings\', \'status\'"><img height="18" src="<<$ro[\'gex_ic\']>>"></a>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  ...
  if (((s as any).ro ?? 0)?.['gexp'] === 1) {
    ...
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="vertical-align:middle;">');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 3px 0 0;">');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: gs \'$menu_settings\', \'swap_grp_member\', \'skill_grp\', \'<<$ro[\'gkey\']>>\', <<ro[\'mi\']>>, \'up\' & gt \'$menu_settings\', \'status\'"><img height="14" src="<<$ro[\'up\']>>"></a>');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: gs \'$menu_settings\', \'swap_grp_member\', \'skill_grp\', \'<<$ro[\'gkey\']>>\', <<ro[\'mi\']>>, \'down\' & gt \'$menu_settings\', \'status\'"><img height="14" src="<<$ro[\'down\']>>"></a>');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td align="center" style="text-align:center; padding:0 4px;">');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="display:block; text-decoration:none; color:inherit;" href="exec: stat_hide_skill[\'<<$ro[\'mkey\']>>\'] = 1 - stat_hide_skill[\'<<$ro[\'mkey\']>>\'] & gt \'$menu_settings\', \'status\'">\' + $ro[\'mlbl\'] + \'</a>');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 0 0 3px;">');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: stat_hide_skill[\'<<$ro[\'mkey\']>>\'] = 1 - stat_hide_skill[\'<<$ro[\'mkey\']>>\'] & gt \'$menu_settings\', \'status\'"><img height="14" src="<<$ro[\'mhi_ic\']>>"></a>');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</tr></table></td></tr>');
...
function enterReorderNestedRelations(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="vertical-align:middle;">');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 3px 0 0;">');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: gs \'$menu_settings\', \'swap\', \'rel_group_order\', <<ro[\'gi\']>>, \'up\' & gt \'$menu_settings\', \'status\'"><img height="18" src="<<$ro[\'up\']>>"></a>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: gs \'$menu_settings\', \'swap\', \'rel_group_order\', <<ro[\'gi\']>>, \'down\' & gt \'$menu_settings\', \'status\'"><img height="18" src="<<$ro[\'down\']>>"></a>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td align="center" style="text-align:center; padding:0 4px;">');
  if (((s as any).ro ?? 0)?.['gkey'] !== 'lovers') {
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="display:block; text-decoration:none; color:inherit;" href="exec: stat_cfg[\'show_rels_<<$ro[\'gkey\']>>\'] = 1 - stat_cfg[\'show_rels_<<$ro[\'gkey\']>>\'] & gt \'$menu_settings\', \'status\'">\' + $ro[\'glbl\'] + \'</a>');
  } else {
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + (((s as any).ro ?? 0)?.['glbl']);
  }
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 0 0 3px;">');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: stat_hide_rel_grp[\'<<$ro[\'gkey\']>>\'] = 1 - stat_hide_rel_grp[\'<<$ro[\'gkey\']>>\'] & gt \'$menu_settings\', \'status\'"><img height="18" src="<<$ro[\'ghi_ic\']>>"></a>');
  if (((s as any).ro ?? 0)?.['gkey'] !== 'lovers') {
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: stat_cfg[\'show_rels_<<$ro[\'gkey\']>>\'] = 1 - stat_cfg[\'show_rels_<<$ro[\'gkey\']>>\'] & gt \'$menu_settings\', \'status\'"><img height="18" src="<<$ro[\'gex_ic\']>>"></a>');
  } else {
    (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<span style="<<$ro[\'ibdr\']>>; visibility:hidden;"><img height="18" src="<<$ro[\'up\']>>"></span>');
  }
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</tr></table>');
  if (((s as any).ro ?? 0)?.['gkey'] !== 'lovers'  &&  ((s as any).ro ?? 0)?.['gexp'] === 1) {
    ...
    if (((s as any).ro ?? 0)?.['eff_nm'] === 1) {
      ...
      if (((s as any).ro ?? 0)?.['nmo'] === 1) {
        ...
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="vertical-align:middle;">');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 3px 0 0;">');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: gs \'$menu_settings\', \'swap_grp_member\', \'rel_grp\', \'<<$ro[\'gkey\']>>\', <<ro[\'mi\']>>, \'up\' & gt \'$menu_settings\', \'status\'"><img height="14" src="<<$ro[\'up\']>>"></a>');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: gs \'$menu_settings\', \'swap_grp_member\', \'rel_grp\', \'<<$ro[\'gkey\']>>\', <<ro[\'mi\']>>, \'down\' & gt \'$menu_settings\', \'status\'"><img height="14" src="<<$ro[\'down\']>>"></a>');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td align="center" style="text-align:center; padding:0 4px;">');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="display:block; text-decoration:none; color:inherit;" href="exec: stat_hide_rel[\'<<$ro[\'mkey\']>>\'] = 1 - stat_hide_rel[\'<<$ro[\'mkey\']>>\'] & gt \'$menu_settings\', \'status\'">\' + $ro[\'mlbl\'] + \'</a>');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 0 0 3px;">');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: stat_hide_rel[\'<<$ro[\'mkey\']>>\'] = 1 - stat_hide_rel[\'<<$ro[\'mkey\']>>\'] & gt \'$menu_settings\', \'status\'"><img height="14" src="<<$ro[\'mhi_ic\']>>"></a>');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<a style="<<$ro[\'ibdr\']>>" href="exec: sd_rel_name_override[\'<<$ro[\'mkey\']>>\'] = (sd_rel_name_override[\'<<$ro[\'mkey\']>>\'] + 1) mod 4 & gt \'$menu_settings\', \'status\'"><img height="14" src="<<$ro[\'nmo_ic\']>>"></a>');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
        (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</tr></table></td></tr>');
        (s as any).ro['mi'] = ((s as any).ro['mi'] ?? 0) + (1);

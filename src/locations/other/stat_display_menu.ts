...
function enterRenderCellOpt(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).rco) (s as any).rco = {}; (s as any).rco['size'] = 0;
  if (!(s as any).rco) (s as any).rco = {}; (s as any).rco['idx'] = (-1);
  if (!(s as any).rco) (s as any).rco = {}; (s as any).rco['custom_idx'] = (-1);
  if (!(s as any).rco) (s as any).rco = {}; (s as any).rco['i'] = 0;
  // TODO-QSP: :rco_search
  if (((s as any).rco ?? 0)?.['i'] < ((s as any).rco ?? 0)?.['size']) {
    ...
    if (((s as any).rco ?? 0)?.['entry_val'] === 'custom') {
      if (!(s as any).rco) (s as any).rco = {}; (s as any).rco['custom_idx'] = ((s as any).rco ?? 0)?.['i'];
    } else {
      if (((s as any).rco ?? 0)?.['entry_val'] === ((s as any).rco ?? 0)?.['cur_str']  ||  parseFloat(((s as any).rco ?? 0)?.['entry_val']) === ((s as any).rco ?? 0)?.['cur_num']) {
        if (!(s as any).rco) (s as any).rco = {}; (s as any).rco['idx'] = ((s as any).rco ?? 0)?.['i'];
      }
    }
    if (!(s as any).rco) (s as any).rco = {}; (s as any).rco['i'] = ((s as any).rco['i'] ?? 0) + (1);
    // TODO-QSP: jump 'rco_search'
  }
  if (((s as any).rco ?? 0)?.['idx'] === -1) {
    if (((s as any).rco ?? 0)?.['custom_idx'] >= 0) {
      if (!(s as any).rco) (s as any).rco = {}; (s as any).rco['idx'] = ((s as any).rco ?? 0)?.['custom_idx'];
    } else {
      if (!(s as any).rco) (s as any).rco = {}; (s as any).rco['idx'] = 0;
    }
  }
...
function enterRenderCellNum(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).rcn) (s as any).rcn = {}; (s as any).rcn['def'] = qspUntranslated(s, "ARGS[3]", { location: "stat_display_menu" });
  if (!(s as any).rcn) (s as any).rcn = {}; (s as any).rcn['min'] = qspUntranslated(s, "ARGS[4]", { location: "stat_display_menu" });
  if (!(s as any).rcn) (s as any).rcn = {}; (s as any).rcn['max'] = qspUntranslated(s, "ARGS[5]", { location: "stat_display_menu" });
  if (!(s as any).rcn) (s as any).rcn = {}; (s as any).rcn['act_left'] = ((s as any).locArgs?.[2] ?? 0) + ' = ax(' + String(((s as any).rcn ?? 0)?.['min']) + ', ' + ((s as any).locArgs?.[2] ?? 0) + ' - 1)';
  if (!(s as any).rcn) (s as any).rcn = {}; (s as any).rcn['act_right'] = ((s as any).locArgs?.[2] ?? 0) + ' = in(' + String(((s as any).rcn ?? 0)?.['max']) + ', ' + ((s as any).locArgs?.[2] ?? 0) + ' + 1)';
  if (!(s as any).rcn) (s as any).rcn = {}; (s as any).rcn['act_input'] = '$rcn_inp = input(\'\' + $ARGS[1] + \' [default: \' + $str(rcn[\'def\']) + \', Min: \' + $str(rcn[\'min\']) + \', Max: \' + $str(rcn[\'max\']) + \']\')';
  if (!(s as any).rcn) (s as any).rcn = {}; (s as any).rcn['act_input'] = ((s as any).rcn['act_input'] ?? 0) + (' & \' + $ARGS[2] + \' = iif($rcn_inp = \'\' or val($rcn_inp) = 0 and $rcn_inp <> \'0\', \' + $str(rcn[\'def\']) + \', min(\' + $str(rcn[\'max\']) + \', max(\' + $str(rcn[\'min\']) + \', val($rcn_inp))))');
  if (!(s as any).rcn) (s as any).rcn = {}; (s as any).rcn['act_input'] = ((s as any).rcn['act_input'] ?? 0) + (' & killvar \'rcn_inp\'');
  // TODO-QSP: $result +=    '<tr>'
  // TODO-QSP: $result +=      '<td align="center" valign="middle" width="1%" nowrap rowspan="3" style="text-align:...
...
function enterSectionTable(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).temp_st_icon) (s as any).temp_st_icon = {}; (s as any).temp_st_icon['raise'] = 'images/system/ui/angle_up_\' + $temp_st_icon_color + \'.png';
  if (!(s as any).temp_st_icon) (s as any).temp_st_icon = {}; (s as any).temp_st_icon['lower'] = 'images/system/ui/angle_down_\' + $temp_st_icon_color + \'.png';
  if (!(s as any).temp_st_icon) (s as any).temp_st_icon = {}; (s as any).temp_st_icon['hide'] = 'images/system/ui/\' + iif(stat_hide[$temp_st_key] = 1, \'hide_\', \'show_\') + $temp_st_icon_color + \'.png';
  if (!(s as any).temp_st_icon) (s as any).temp_st_icon = {}; (s as any).temp_st_icon['expand'] = 'images/system/ui/\' + iif(stat_collapse[$temp_st_key] = 0, \'expand_\', \'collapse_\') + $temp_st_icon_color + \'.png';
  ...
  if (!(s as any).temp_st_icon) (s as any).temp_st_icon = {}; (s as any).temp_st_icon['align'] = 'images/system/ui/align_\' + $temp_st_align_icon_name[temp_st_align_eff] + \'_\' + $temp_st_icon_color + \'.png';
  // TODO-QSP: $temp_st_align_label[0] = 'Left'
  // TODO-QSP: $temp_st_align_label[1] = 'Center'
  // TODO-QSP: $temp_st_align_label[2] = 'Right'
  if ((!((s as any).temp_st_align_val ?? 0))) {
    if (!(s as any).temp_st_title) (s as any).temp_st_title = {}; (s as any).temp_st_title['align'] = 'Global Alignment (\' + $temp_st_align_label[temp_st_align_eff] + \') — click to set explicitly';
  } else {
    if (!(s as any).temp_st_title) (s as any).temp_st_title = {}; (s as any).temp_st_title['align'] = 'Aligned \' + $temp_st_align_label[temp_st_align_eff] + \' — click to cycle';
  }
  if (!(s as any).temp_st_title) (s as any).temp_st_title = {}; (s as any).temp_st_title['hide'] = ((((s as any).stat_hide ?? 0)?.[String((s as any).temp_st_key ?? 0)] === 1) ? ('Show Section') : ('Hide Section'));
  if (!(s as any).temp_st_title) (s as any).temp_st_title = {}; (s as any).temp_st_title['expand'] = ((((s as any).stat_collapse ?? 0)?.[String((s as any).temp_st_key ?? 0)] === 0) ? ('Collapse Options') : ('Expand Options'));
  if (!(s as any).temp_st_td) (s as any).temp_st_td = {}; (s as any).temp_st_td['icon'] = '<td align="center" width="1%" style="text-align:center; padding:3px;">';
  if (!(s as any).temp_st_td) (s as any).temp_st_td = {}; (s as any).temp_st_td['spacer'] = '<td align="center" width="1%" style="text-align:center; padding:3px;"><span style="display:inline-block; padding:2px; line-height:0; border:1px solid transparent; border-radius:6px;"><img height="32" src="' + qspUntranslated(s, "temp_st_icon['raise']>", { location: "stat_display_menu" }) + '" style="visibility:hidden"></span></td>';
...
function enterReorderFlat(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['c'] = ((((s as any).theme ?? 0)?.['is_dark'] === 1) ? ('w') : ('b'));
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['up'] = 'images/system/ui/angle_up_\'   + $ro[\'c\'] + \'.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['down'] = 'images/system/ui/angle_down_\' + $ro[\'c\'] + \'.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['bdr'] = '1px solid ' + qspUntranslated(s, "theme_hex['goth']>", { location: "stat_display_menu" }) + '';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ibdr'] = 'display:inline-block; padding:4px; line-height:0; border:1px solid \' + $func(\'shortgs\', \'rgb_to_hex\', theme[\'fcolor\']) + \'; border-radius:4px;';
  ...
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<tr><td colspan="3" style="padding:2px 10px 8px 10px;"><center><table width="90%" cellspacing="3" cellpadding="0" border="0" style="width:90%;">');
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['i'] = 0;
  // TODO-QSP: :_rfl_loop
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['key'] = 0;
  ...
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['hidden'] = 0;
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['hide_icon'] = 'images/system/ui/\' + iif(ro[\'hidden\'] = 1, \'hide_\', \'show_\') + $ro[\'c\'] + \'.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['label'] = ((((s as any).ro ?? 0)?.['hidden'] === 1) ? ('<font color="gray">\' + $sd_dn[$ro[\'key\']] + \'</font>') : (((s as any).sd_dn ?? 0)?.[((s as any).ro ?? 0)?.['key']]));
  ...
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="vertical-align:middle;">');
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 3px 0 0;">');
  ...
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td align="center" style="text-align:center; padding:0 4px;">');
  ...
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 0 0 3px;">');
...
function enterReorderNestedSkills(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['bdr'] = '1px solid ' + qspUntranslated(s, "theme_hex['goth']>", { location: "stat_display_menu" }) + '';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ibdr'] = 'display:inline-block; padding:4px; line-height:0; border:1px solid \' + $func(\'shortgs\', \'rgb_to_hex\', theme[\'fcolor\']) + \'; border-radius:4px;';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = '<tr><td align="center" colspan="3" style="padding:6px 10px 2px 10px; text-align:center;"><b>Order &amp; Visibility</b>&nbsp; <a href="exec: gs \'$menu_settings\', \'reset_skills\' & gt \'$menu_settings\', \'status\'">[Reset]</a></td></tr>';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<tr><td colspan="3" style="padding:2px 10px 8px 10px;"><center><table width="90%" cellspacing="3" cellpadding="0" border="0" style="width:90%;">');
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['gi'] = 0;
  // TODO-QSP: :_rns_gloop
  ...
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</tr></table>');
  if (((s as any).ro ?? 0)?.['gexp'] === 1) {
    ...
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mhid'] = ((s as any).stat_hide_skill ?? 0)?.[((s as any).ro ?? 0)?.['mkey']];
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mhi_ic'] = 'images/system/ui/\' + iif(ro[\'mhid\'] = 1, \'hide_\', \'show_\') + $ro[\'c\'] + \'.png';
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mlbl'] = ((((s as any).ro ?? 0)?.['mhid'] === 1) ? ('<font color="gray">\' + $sd_dn[$ro[\'mkey\']] + \'</font>') : (((s as any).sd_dn ?? 0)?.[((s as any).ro ?? 0)?.['mkey']]));
    ...
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</tr></table></td></tr>');
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mi'] = ((s as any).ro['mi'] ?? 0) + (1);
    // TODO-QSP: jump '_rns_mloop'
    // TODO-QSP: :_rns_mdone
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</table>');
  }
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td></tr>');
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['gi'] = ((s as any).ro['gi'] ?? 0) + (1);
...
function enterReorderNestedRelations(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['bdr'] = '1px solid ' + qspUntranslated(s, "theme_hex['goth']>", { location: "stat_display_menu" }) + '';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ibdr'] = 'display:inline-block; padding:4px; line-height:0; border:1px solid \' + $func(\'shortgs\', \'rgb_to_hex\', theme[\'fcolor\']) + \'; border-radius:4px;';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = '<tr><td align="center" colspan="3" style="padding:6px 10px 2px 10px; text-align:center;"><b>Order &amp; Visibility</b>&nbsp; <a href="exec: gs \'$menu_settings\', \'reset_rels\' & gt \'$menu_settings\', \'status\'">[Reset]</a></td></tr>';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<tr><td colspan="3" style="padding:2px 10px 8px 10px;"><center><table width="90%" cellspacing="3" cellpadding="0" border="0" style="width:90%;">');
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['gi'] = 0;
  // TODO-QSP: :_rnr_gloop
  ...
  if (((s as any).ro ?? 0)?.['gkey'] !== 'lovers') {
    ...
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + (((s as any).ro ?? 0)?.['glbl']);
  }
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('</td>');
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['html'] = ((s as any).ro['html'] ?? 0) + ('<td width="1%" nowrap style="padding:0 0 0 3px;">');
  ...
  if (((s as any).ro ?? 0)?.['gkey'] !== 'lovers'  &&  ((s as any).ro ?? 0)?.['gexp'] === 1) {
    ...
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mhid'] = ((s as any).stat_hide_rel ?? 0)?.[((s as any).ro ?? 0)?.['mkey']];
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mhi_ic'] = 'images/system/ui/\' + iif(ro[\'mhid\'] = 1, \'hide_\', \'show_\') + $ro[\'c\'] + \'.png';
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['eff_nm'] = ((((s as any).ro ?? 0)?.['mkey'] !== ''  &&  ((s as any).sd_rel_name_override ?? 0)[((s as any).ro ?? 0)?.['mkey']] > 0) ? (((s as any).sd_rel_name_override ?? 0)?.[((s as any).ro ?? 0)?.['mkey']]) : (((s as any).ro ?? 0)?.['nm']));
    if (((s as any).ro ?? 0)?.['eff_nm'] === 1) {
      if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mname'] = ((s as any).npc_firstname ?? 0)?.[((s as any).ro ?? 0)?.['mkey']];
    } else {
      if (((s as any).ro ?? 0)?.['eff_nm'] === 2) {
        if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mname'] = ((s as any).npc_lastname ?? 0)?.[((s as any).ro ?? 0)?.['mkey']];
        if (((s as any).ro ?? 0)?.['mname'] === '') {
          if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mname'] = ((s as any).npc_firstname ?? 0)?.[((s as any).ro ?? 0)?.['mkey']];
        }
      } else {
        if (((s as any).ro ?? 0)?.['eff_nm'] === 3) {
          if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mname'] = ((s as any).npc_nickname ?? 0)?.[((s as any).ro ?? 0)?.['mkey']];
          if (((s as any).ro ?? 0)?.['mname'] === '') {
            if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mname'] = ((s as any).npc_firstname ?? 0)?.[((s as any).ro ?? 0)?.['mkey']];
          }
        } else {
          if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mname'] = ((s as any).npc_usedname ?? 0)?.[((s as any).ro ?? 0)?.['mkey']];
        }
      }
    }
    if (((s as any).ro ?? 0)?.['mname'] === '') {
    ...
    if (((s as any).ro ?? 0)?.['mname'] === '') {
      if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mname'] = ((s as any).ro ?? 0)?.['mkey'];
    }
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['mlbl'] = ((((s as any).ro ?? 0)?.['mhid'] === 1) ? ('<font color="gray">\' + $ro[\'mname\'] + \'</font>') : (((s as any).ro ?? 0)?.['mname']));
    if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['nmo'] = ((s as any).sd_rel_name_override ?? 0)?.[((s as any).ro ?? 0)?.['mkey']];
    if (((s as any).ro ?? 0)?.['nmo'] === 1) {
      if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['nmo_ic'] = 'images/system/ui/name_first_\'    + $ro[\'c\'] + \'.png';
    } else {
      if (((s as any).ro ?? 0)?.['nmo'] === 2) {
        if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['nmo_ic'] = 'images/system/ui/name_family_\'   + $ro[\'c\'] + \'.png';
      } else {
        if (((s as any).ro ?? 0)?.['nmo'] === 3) {
          if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['nmo_ic'] = 'images/system/ui/name_nickname_\' + $ro[\'c\'] + \'.png';
        } else {
          if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['nmo_ic'] = 'images/system/ui/name_default_\'  + $ro[\'c\'] + \'.png';
        }
      }
    }
    // TODO-QSP: $ro['html'] += '<tr><td bgcolor="<<$theme_hex[''table_bg_alt'']>>" style="border:<<$ro[''bdr'']>>; background-color:<<$theme_hex[''table_bg_alt'']>>; padding:4px 6px;">'
...
function enterReorderMenuBar(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ri_character'] = 'icon_character.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ri_looks'] = 'icon_lookself.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ri_purse'] = 'icon_purse.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ri_phone'] = 'icon_phone.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ri_journal'] = 'journal_norm.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ri_magic'] = 'journal_magic.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ri_clock'] = 'clock.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ri_settings'] = 'icon_menu.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['ri_help'] = 'icon_help_color.png';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['imgbase'] = 'images/system/icons/menu/';
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['bdr'] = '1px solid ' + qspUntranslated(s, "theme_hex['goth']>", { location: "stat_display_menu" }) + '';
  // TODO-QSP: $result += '<tr><td colspan="3" style="padding:2px 10px 8px 10px;"><center><table cellspacing="6" ce...
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['i'] = 0;
  // TODO-QSP: :_rmb_loop
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['key'] = qspUntranslated(s, "menu_bar_order[ro['i']]", { location: "stat_display_menu" });
  ...
  if (!(s as any).ro) (s as any).ro = {}; (s as any).ro['imgfile'] = 0;

...
function enterEnquiry(s: GameState, scene: SceneBuilder): void {
  if (((s as any).age ?? 0) < 18) {
    ((s as any).ml_guitarlesson = (s as any).ml_guitarlesson ?? {})['lessoncost'] = 300;
  } else {
    ((s as any).ml_guitarlesson = (s as any).ml_guitarlesson ?? {})['lessoncost'] = 500;
  }
  ...
  scene.actions([
    ...
    scene.text('<a href="#" onclick="window.__gameStore.setState((s) => { (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = 1; (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = \u0027Monday\u0027; return s; }); window.__gameStore.getState().doGoto(\u0027music_guitarlesson\u0027, \u0027goodbye\u0027); return false;">Monday</a>');
    scene.text('<a href="#" onclick="window.__gameStore.setState((s) => { (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = 2; (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = \u0027Tuesday\u0027; return s; }); window.__gameStore.getState().doGoto(\u0027music_guitarlesson\u0027, \u0027goodbye\u0027); return false;">Tuesday</a>');
    scene.text('<a href="#" onclick="window.__gameStore.setState((s) => { (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = 3; (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = \u0027Wednesday\u0027; return s; }); window.__gameStore.getState().doGoto(\u0027music_guitarlesson\u0027, \u0027goodbye\u0027); return false;">Wednesday</a>');
    scene.text('<a href="#" onclick="window.__gameStore.setState((s) => { (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = 4; (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = \u0027Thursday\u0027; return s; }); window.__gameStore.getState().doGoto(\u0027music_guitarlesson\u0027, \u0027goodbye\u0027); return false;">Thursday</a>');
    scene.text('<a href="#" onclick="window.__gameStore.setState((s) => { (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = 5; (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = \u0027Friday\u0027; return s; }); window.__gameStore.getState().doGoto(\u0027music_guitarlesson\u0027, \u0027goodbye\u0027); return false;">Friday</a>');
    scene.text('<a href="#" onclick="window.__gameStore.setState((s) => { (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = 6; (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = \u0027Saturday\u0027; return s; }); window.__gameStore.getState().doGoto(\u0027music_guitarlesson\u0027, \u0027goodbye\u0027); return false;">Saturday</a>');
    scene.text('<a href="#" onclick="window.__gameStore.setState((s) => { (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = 8; (s.ml_guitarlesson ??= {})\u0027lessonday\u0027 = \u0027None\u0027; return s; }); window.__gameStore.getState().doGoto(\u0027music_guitarlesson\u0027, \u0027goodbye\u0027); return false;">You don\'t know yet</a>');
  } },
...
function enterGoodbye(s: GameState, scene: SceneBuilder): void {
  ((s as any).ml_guitarlesson = (s as any).ml_guitarlesson ?? {})['nextlesson'] = ((s as any).daystart ?? 0) + ((((s as any).ml_guitarlesson ?? {})?.['lessonday'] ?? 0) + 7 - ((s as any).week ?? 0));

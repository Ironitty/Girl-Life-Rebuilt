...
function enterMath(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).dimaRevenge ?? 0) === 1) {
      ...
      { label: 'Leave class', goto: ['gschool_lessons', 'short_break'] },
        ...
        if (((s as any).VK ?? 0) > 6) {
          ...
          if ((((s as any).VKrand ?? 0) === 1  &&  ((s as any).npc_rel ?? 0)?.['A2'] >= 80)  ||  (((s as any).VKrand ?? 0) === 1  &&  ((s as any).grupTipe ?? 0) === 3)) {
            ...
            if ((((s as any).VKrand ?? 0) === 2  &&  ((s as any).npc_rel ?? 0)?.['A12'] >= 80)  ||  (((s as any).VKrand ?? 0) === 2  &&  ((s as any).grupTipe ?? 0) === 3)) {
              ...
              if (((s as any).VKrand ?? 0) === 3  &&  ((s as any).NikoLuv ?? 0) >= 2  &&  ((s as any).npc_grupTipe ?? 0)?.['A189'] === 4) {
                ...
                if (((s as any).class ?? 0)?.['school_math_grade'] >= 80) {
    ...
    if (((s as any).VK ?? 0) === 1  &&  (((s as any).christinaQW ?? 0)?.['fight'] === -1  ||  ((s as any).christinaQW ?? 0)?.['subpath'] >= 2)  &&  ((s as any).pcs_bmi ?? 0) >= 25) {
      ...
      if (((s as any).VK ?? 0) === 2  &&  ((s as any).NataliaPavlovaQW ?? 0) >= 10) {
        ...
        if (((s as any).VK ?? 0) === 3  &&  ((s as any).NikoVolkovQW ?? 0) >= 5  &&  ((s as any).npc_grupTipe ?? 0)?.['A189'] === 4) {
          ...
          if (((s as any).VK ?? 0) === 4  &&  ((s as any).npc_rel ?? 0)?.['A25'] >= 80) {
...
function enterMathLate(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"So good of you to join us, Miss ${((s as any).pcs_lastname ?? 0)}," Mr. Tsarev says as several of your classmates smirk, while a few look annoyed that you interrupted the class.`);
    scene.actions([
    ...
    // TODO-QSP: dynamic text: He shakes his head slightly and frowns. "I'll have to report this, Miss <<$pcs_l...
    scene.text(`He shakes his head slightly and frowns. "I'll have to report this, Miss ${((s as any).pcs_lastname ?? 0)}. Now please take your seat. You've interrupted my class enough."`);
    scene.actions([
      { label: 'Take your seat', goto: ['gschool_lessons4', 'math'] },
    ]);
  } },
...
function enterEnglish(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).dimaRevenge ?? 0) === 1) {
    ...
    scene.img('images/locations/pavlovsk/school/classroom/talkgirl\' + rand(1, 3) + \'.jpg');
    ...
    scene.img('images/locations/pavlovsk/school/classroom/talkboy\' + rand(1, 3) + \'.jpg');
    ...
    scene.actions([
      ...
      if (((s as any).daydream ?? 0) === 2) {
        (s as any).pcs_sleep = ((s as any).pcs_sleep ?? 0) + (Math.floor(Math.random() * 3) + 1);
        if (((s as any).class ?? 0)?.['school_eng_grade'] >= 80) {
          scene.img('images/locations/pavlovsk/school/classroom/sleeping.jpg');
    ...
    qspCall(st, 'gschool_lessonsev3', 'english');
      ...
      scene.text(`"Miss ${((s as any).pcs_lastname ?? 0)}, are you playing on your phone during class?" Ms. Braakman asks as she makes her way towards you.`);
      qspCall(s, 'willpower', 'misc', 'self', 'medium');
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Keep using your phone [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
...
function enterPe(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).week ?? 0) === 5  &&  ((s as any).runnerQW ?? 0)?.['pav_stage'] === 0) {
    if (((s as any).runnerQW ?? 0)?.['pav_racetype'] === 0) {
      ((s as any).runnerQW ?? {})['pav_racetype'] = 1;
    }
    ...
    if (((s as any).week ?? 0) === 5  &&  ((s as any).runnerQW ?? 0)?.['pav_stage'] === 1) {
      if (((s as any).runnerQW ?? 0)?.['pav_racetype'] === 0) {
        ((s as any).runnerQW ?? {})['pav_racetype'] = 2;
      }
      // TODO-QSP: dynamic text: Coach Pavlovich announces that the inter-school running competition will be held...
      scene.text('Coach Pavlovich announces that the inter-school running competition will be held this Saturday at \' + func(\'time\', \'get_time_string\', 11, 0) + \'. If you want to participate, you should come to school between \' + func(\'time\', \'get_time_string\', 10, 0) + \' and \' + func(\'time\', \'get_time_string\', 11, 0) + \'.');
    }
  ...
  scene.actions([
    ...
    if (((s as any).fizrarand ?? 0) === 1) {
      ...
      qspCall(s, 'exp_gain', 'run', Math.floor(Math.random() * 2) + 1);
      qspCall(s, 'grades', 'class_activity_skill', 'school', 'pe', ((s as any).pcs_run ?? 0));
      qspCall(s, 'exercise', 'tier2', 15, 'vital', 'agil');
      scene.img('images/locations/pavlovsk/school/gym/fizra.jpg');
      scene.text('After the roll call, Coach Pavlovich gets everyone\'s attention.');
      if (((s as any).temper ?? 0) >= 10  &&  ((s as any).sunWeather ?? 0) === 1) {
        scene.actions([
          { label: 'Run', handler: (st: GameState) => {
    (s as any).runoutside = Math.floor(Math.random() * 6) + 1;
    if (((s as any).runoutside ?? 0) === 1) {
    ...
    if (((s as any).pcs_hotcat ?? 0) >= 6) {
      ...
      scene.text(`Making sure no one else is nearby, you pull up your shirt and reveal your ${((s as any).titsize ?? 0)} breasts to Ivan. You almost immediately notice the erection growing in his tight shorts, and he awkwardly tries to hide it. As you pull your shirt back down, you give him a sweet smile. "Try hiding that while you're running past everyone!"`);
      ...
      if (((s as any).pcs_hotcat ?? 0) >= 4) {
        // TODO-QSP: dynamic text: Making sure no one else is nearby, you pull up your shirt and reveal your <<$tit...
        scene.text(`Making sure no one else is nearby, you pull up your shirt and reveal your ${((s as any).titsize ?? 0)} breasts to Ivan. He smiles and shakes his head as he sprints away and you slow down a little to get everything back in place.`);
        scene.text('At the end of the class, Ivan puts in the fastest time. Again.');
      } else {
        // TODO-QSP: dynamic text: Making sure no one else is nearby, you pull up your shirt and reveal your <<$tit...
        scene.text(`Making sure no one else is nearby, you pull up your shirt and reveal your ${((s as any).titsize ?? 0)} breasts to Ivan. He gives you a disgusted look and shakes his head as he sprints away. You slow down a little to get everything back in place.`);
        scene.text('At the end of the class, Ivan puts in the fastest time. Again.');
      }
    }
    scene.actions([
    ...
    scene.actions([
      { label: 'Finish your run', goto: ['gschool_lessons4', 'postphys'] },
        ...
        scene.actions([
          { label: 'Run', handler: (st: GameState) => {
    (s as any).runinside = Math.floor(Math.random() * 5) + 1;
    if (((s as any).runinside ?? 0) === 1) {
    ...
    scene.actions([
      { label: 'End of lesson', goto: ['gschool_lessons4', 'postphys'] },
        ...
        if (((s as any).fizrarand ?? 0) === 3) {
          qspCall(s, 'grades', 'class_activity_attributes', 'school', 'pe', ((s as any).pcs_stren ?? 0));
          qspCall(s, 'exercise', 'tier2', 15, 'stren');
          qspCall(s, 'stat', '');
          (s as any).pullup = 0;
          if (((s as any).pullup ?? 0) === 1  &&  ((s as any).pantyworntype ?? 0) === 'none') {
            qspCall(s, 'mood', 'lower', 'small');
            qspCall(s, 'arousal', 'flash', (-5));
            qspCall(s, 'stat', '');
    ...
    scene.actions([
      { label: 'End of lesson', goto: ['gschool_lessons4', 'postphys'] },
            ...
            if (((s as any).fizrarand ?? 0) === 5) {
              qspCall(s, 'grades', 'class_activity_attributes', 'school', 'pe', ((s as any).pcs_vital ?? 0));
              qspCall(s, 'exercise', 'tier2', 15, 'vital');
              ...
              if (((s as any).fizrarand ?? 0) === 6) {
                ...
                if (((s as any).pcs_horny ?? 0) < 50) {
                  ...
                  if (((s as any).pcs_horny ?? 0) < 100) {
                    ...
                    scene.text(`The coach looks up to you. "Why are you shaking, ${((s as any).pcs_lastname ?? 0)}? Are you scared of heights? Go ahead and come down then."`);
                  }
                }
                scene.actions([
                  { label: 'Continue', handler: (st: GameState) => {
...
function enterPostphys(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).christinaQW ?? 0)?.['pre_bm'] === 1) {
    ...
    ((s as any).christinaQW ?? {})['blackmail'] = 1;
    ((s as any).christinaQW ?? {})['pre_bm'] = 0;
    (s as any).pcs_horny = ((s as any).pcs_horny ?? 0) + (10);
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterShower2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).gymshower ?? 0) === 1) {
    ...
    qspCall(s, 'gschool_lessons4', 'shower_options');
  } else {
    ...
    qspCall(s, 'npcStat', 'A24', 'b');
    qspCall(s, 'npcgeneratec', '', 1, 'A girl in the shower', ((s as any).age ?? 0), 1, 1);
    ...
    qspCall(s, 'arousal', 'cuni_give', (-2), ((s as any).npcID ?? 0), 'lesbian', 'sub', 'group', 'humiliation');
    qspCall(s, 'arousal', 'cuni_give', (-2), ((s as any).npcID1 ?? 0), 'lesbian', 'sub', 'group', 'humiliation');
    qspCall(s, 'arousal', 'cuni_give', (-2), ((s as any).npcID2 ?? 0), 'lesbian', 'sub', 'group', 'humiliation');
    qspCall(s, 'arousal', 'cuni_give', (-2), ((s as any).npcID3 ?? 0), 'lesbian', 'sub', 'group', 'humiliation');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'cuni', (-8), 'lesbian', 'dom');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Finish dressing', handler: (st: GameState) => {
    qspCall(s, 'arousal', 'end');
...
function enterPubeBully(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).grupvalue ?? {})[2] = (((s as any).grupvalue ?? {})[2] ?? 0) - (2);
  ((s as any).pcs_memory ?? {})['school_shower_bully_pubes'] = ((s as any).daystart ?? 0);
  ...
  if (((s as any).grupTipe ?? 0) === 3) {
    ...
    // TODO-QSP: dynamic text: "Seriously <<$pcs_nickname>>?" Bella scoffs. "Waxing isn't just for floors you k...
    scene.text(`"Seriously ${((s as any).pcs_nickname ?? 0)}?" Bella scoffs. "Waxing isn't just for floors you know!"`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    scene.text(`"Tell me ${((s as any).pcs_nickname ?? 0)}, do you need a vacuum cleaner to wash that rug?" Irina giggles.`);
  ...
  scene.actions([
    ...
    if (((s as any).grupTipe ?? 0) === 3  ||  ((s as any).grupTipe ?? 0) === 5) {
      ...
      if (((s as any).grupTipe ?? 0) === 4  ||  ((s as any).grupTipe ?? 0) === 2) {
...
function enterPubeCompliment(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pube_style ?? 0)?.['word'] === 'shaved') {
    // TODO-QSP: dynamic text: "Ugh, I'm so jealous <<$pcs_nickname>>!" Bella says. "You have <i>such</i> a nic...
    scene.text(`"Ugh, I'm so jealous ${((s as any).pcs_nickname ?? 0)}!" Bella says. "You have <i>such</i> a nice pussy!"`);
    ...
    if (((s as any).pube_style ?? 0)?.['word'] === 'stubble') {
      ...
      if (((s as any).pube_style ?? 0)?.['word'] === 'patch') {
        ...
        scene.text(`"Oh my gosh, ${((s as any).pcs_nickname ?? 0)}!" Bella squeals. All eyes in the room follow her gaze to home in on the tidy patch of hair between your legs. "Your pubes are <i>so cute!</i>"`);
...
function enterWhoreBully(s: GameState, scene: SceneBuilder): void {
  ((s as any).pcs_memory ?? {})['school_shower_bully_whore'] = ((s as any).daystart ?? 0);
...
function enterLongShower(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'stat', '');
    (s as any).longshower = Math.floor(Math.random() * 10) + 1;
    if (((s as any).longshower ?? 0) === 1  &&  ((s as any).pcs_hotcat ?? 0) >= 6  &&  ((s as any).fame ?? 0)?.['pav_slut'] >= 150) {
    ...
    scene.text(`You look back and see Lazar standing there with his hard cock in his hand, stroking it while he watches you shower with a big grin on his face. "Hey ${((s as any).pcs_nickname ?? 0)}! Looking good."`);
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Tell him to get out [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
    ...
    scene.actions([
      ...
      if (((s as any).longshower ?? 0) === 2  &&  ((s as any).pcs_hotcat ?? 0) >= 5  &&  ((s as any).fame ?? 0)?.['pav_slut'] >= 100  &&  ((s as any).kotovLoveQW ?? 0) !== 1) {
        (s as any).minut = ((s as any).minut ?? 0) + 5;
        qspCall(s, 'mood', 'raise', 'tiny');
        qspCall(s, 'stat', '');
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Tell them to get out [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
    ...
    scene.actions([
      { label: 'Get on your knees', goto: ['gschool_sex', 'vd_lockerroom'] },
        ...
        if (((s as any).longshower ?? 0) === 3  &&  ((s as any).pcs_hotcat ?? 0) >= 5) {
          (s as any).minut = ((s as any).minut ?? 0) + 10;
          qspCall(s, 'mood', 'raise', 'small');
          scene.img('images/locations/pavlovsk/school/gym/shower/watch.jpg');
    ...
    scene.actions([
      { label: 'Finish dressing', goto: ['gschool_lessons4', 'post_dress'] },
          ...
          if (((s as any).longshower ?? 0) === 4  &&  ((s as any).pcs_hotcat ?? 0) >= 6  &&  ((s as any).npc_rel ?? 0)?.['A23'] >= 70) {
            (s as any).minut = ((s as any).minut ?? 0) + 10;
            qspCall(s, 'mood', 'raise', 'small');
            scene.img('images/locations/pavlovsk/school/gym/shower/watch.jpg');
            ...
            scene.actions([
              { label: 'Go to your locker', handler: (st: GameState) => {
    qspCall(s, 'stat', '');
    if (((s as any).AlbinaQW ?? 0)?.['voyeur'] === 1) {
      scene.img('images/characters/pavlovsk/school/girl/albina/sex/school/lockerroom/lockerflirt.jpg');
      // TODO-QSP: dynamic text: As you walk into the locker room, you can tell that it's Albina. ' + iif(AlbinaQ...
      scene.text('As you walk into the locker room, you can tell that it\'s Albina. \' + iif(AlbinaQW[\'StarletsShutDown\'] = 0, \'She doesn\'t sound very happy as she argues on the phone with her father.\', \'She\'s happily speaking on the phone with someone.\') + \' Once you start drying your hair, you can\'t hear what she\'s saying anymore.');
    ...
    scene.text(`You nod and rub your ass as she starts getting dressed. Once she finishes, she gives you a wink and a smile. "Until next time, ${((s as any).pcs_nickname ?? 0)}."`);
    ...
    qspCall(s, 'pain', 'asscheeks', 'spank', 2);
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'npc_relationship', 'modify', 'A23', 3);
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/school/girl/albina/sex/school/lockerroom/spank.jpg');
    ...
    // TODO-QSP: dynamic text: You nod and rub your ass as she starts getting dressed. Once she finishes, she g...
    scene.text(`You nod and rub your ass as she starts getting dressed. Once she finishes, she gives you a wink and a smile. "Until next time, ${((s as any).pcs_nickname ?? 0)}." She then walks out the door, leaving you alone to finish getting dressed. You can't help but think that she was more than a little aroused.`);
    qspCall(s, 'arousal', 'foreplay', 2);
    qspCall(s, 'pain', 'asscheeks', 'spank', 2);
    qspCall(s, 'stat', '');
    scene.actions([
      ...
      if (((s as any).AlbinaQW ?? 0)?.['voyeur'] === 1  &&  ((s as any).npc_had_sex ?? 0)?.['A23']) {
        scene.img('images/characters/pavlovsk/school/girl/albina/sex/school/lockerroom/lockerflirt.jpg');
        // TODO-QSP: dynamic text: As you walk into the locker room, you can tell that it's Albina. ' + iif(AlbinaQ...
        scene.text('As you walk into the locker room, you can tell that it\'s Albina. \' + iif(AlbinaQW[\'StarletsShutDown\'] = 0, \'She doesn\'t sound very happy as she argues on the phone with her father.\', \'She\'s happily speaking on the phone with someone.\') + \' Once you start drying your hair, you can\'t hear what she\'s saying anymore.');
        scene.text('As you finish drying your hair, she comes around to your side of the lockers wearing only a towel. She smiles at you before dropping the towel, revealing her naked, toned body to you. She then turns around, giving you an even better view of her ass.');
      ...
      { label: 'Give in', goto: ['gschool_sex', 'albina_lockerroom'] },
        ...
        scene.actions([
          { label: 'Finish dressing', goto: ['gschool_lessons4', 'post_dress'] },
            ...
            if (((s as any).longshower ?? 0) === 5  &&  ((s as any).pcs_hotcat ?? 0) >= 5  &&  ((s as any).fame ?? 0)?.['pav_slut'] >= 150) {
              (s as any).minut = ((s as any).minut ?? 0) + 10;
              qspCall(s, 'mood', 'raise', 'small');
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Ask him to leave [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
      ...
      { label: 'Continue', goto: ['gschool_lessons4', 'post_dress'] },
                                ...
                                if ((((s as any).NatbelQW ?? 0)?.['chrispaid'] !== 5  &&  ((s as any).NatbelQW ?? 0)?.['chrispaid'] !== 6  &&  ((s as any).christinaQW ?? 0)?.['blackmail'] < 2  &&  ((s as any).christinaQW ?? 0)?.['fight'] === 0)  ||  ((s as any).NatbelQW ?? 0)?.['chrispaid'] === 7) {
                                  ...
                                  scene.actions([
                                    { label: 'Ignore it', goto: ['gschool_lessons4', 'post_dress'] },
                                    { label: 'Avoid eye contact', handler: (st: GameState) => {
    ((s as any).christinaQW ?? {})['bully'] = (((s as any).christinaQW ?? {})['bully'] ?? 0) + (1);
    scene.img('images/locations/pavlovsk/school/gym/locker/change.jpg');

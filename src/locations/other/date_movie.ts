...
function enterWhatToWatchPav(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Well?" you ask, turning to look at ${((s as any).npcdesc || '')}. "Feel like watching that?"`);
    if (((s as any).npc_fav_date ?? 0)?.[String((s as any).npcID ?? 0)] === 'movie_date') {
      ...
      scene.text(`"I've heard really good things about it," ${((s as any).npcdesc || '')} says, excitement sparkling in his eyes. "Let's go buy tickets."`);
    ...
    // TODO-QSP: xgt 'date_movie', 'buy_tickets'
        ...
        if (((s as any).npc_assertive ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
          if ((!(Math.floor(Math.random() * 1) + 0))) {
            ...
            scene.text(`"We're already here, we might as well," ${((s as any).npcdesc || '')} shrugs and moves forward to buy tickets. You follow his lead, you go up to the counter where a bored teenager tells you its ${qspFunc(s, 'money', 'string_price', ((s as any).date_ev ?? 0)?.['ticket_cost'] ?? '')} per ticket.`);
            scene.actions([
              { label: 'Continue', handler: (st: GameState) => {
    // TODO-QSP: xgt 'date_movie', 'buy_tickets'
  } },
            ...
            scene.text(`"Looks kind of boring," ${((s as any).npcdesc || '')} shrugs. "Let's go do something else."`);
    ...
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
        ...
        scene.actions([
          { label: 'Insist you do something else',  },
        ]);
      }
      scene.actions([
...
function enterCityCinema(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Well?" you ask, turning to look at ${((s as any).npcdesc || '')}. "What do you think we should watch?"`);
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['film_suggest2'] = 'action_movie';
    scene.text('"How about that one instead?" you say, pointing at the action movie.');
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSuggestFilm3(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
    if (((s as any).date_ev ?? 0)?.['film_suggest'] !== 'horror') {
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['film_suggest2'] = 'horror_movie';
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['film_suggest2'] = 'comedy_movie';
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['film_suggest2'] = 'raunchy_movie';
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['film_suggest2'] = 'drama_movie';
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['film_suggest2'] = 'romance_movie';
    ...
    scene.text(`"Do you wanna do something else?" you ask ${((s as any).npcdesc || '')}.`);
...
function enterSuggestFilm1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    { label: 'Let\'s watch the action film', handler: (st: GameState) => {
    ((s as any).date_ev = (s as any).date_ev ?? {})['film_suggest'] = 'action';
    qspGoto(s, 'date_movie', 'suggest_film2');
  } },
    { label: 'Horror', handler: (st: GameState) => {
    ((s as any).date_ev = (s as any).date_ev ?? {})['film_suggest'] = 'horror';
    scene.text('"Let\'s watch the horror movie."');
...
function enterBoyFilmSuggestReact(s: GameState, scene: SceneBuilder): void {
  if (((s as any).date_ev ?? 0)?.['film_suggest'] !== '') {
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['film_fight'] = 1;
    qspCall(s, 'npc_relationship', 'modify', ((s as any).npcID ?? 0), 'dislike');
    // TODO-QSP: $date_ev['cinema_pic']
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['pc_snack_buy'] = 1;
...
function enterAskedToPay(s: GameState, scene: SceneBuilder): void {
  ...
  if (qspFunc(s, 'money', 'can_afford', ((s as any).date_ev ?? 0)?.['ticket_cost']) === 1) {
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['pc_ticket_buy'] = 1;
    if (((s as any).date_ev ?? 0)?.['wants_pc_pay'] === 1) {
      ((s as any).npc_money_owed = (s as any).npc_money_owed ?? {})[String((s as any).npcID ?? 0)] = ((s as any).npc_money_owed[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).date_ev ?? 0)?.['ticket_cost']);
    }
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['no_money'] = 1;
...
function enterBuyTicketsPayment(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (qspFunc(s, 'money', 'can_afford', ((s as any).date_ev ?? 0)?.['pay_cost']) === 0) {
      ...
      ((s as any).date_ev = (s as any).date_ev ?? {})['total_cost'] = ((s as any).date_ev['total_cost'] ?? 0) + (((s as any).date_ev ?? 0)?.['pay_cost']);
      ((s as any).date_ev = (s as any).date_ev ?? {})['pay_cost'] = 0;
...
function enterNoMoneyTickets(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).date_ev ?? 0)?.['wants_pc_pay'] === 1  &&  ((s as any).npc_finance ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    ...
    qspGoto(s, 'date_movie', 'no_money_tickets_selfish');
  } },
        ]);
      } else {
        if (((s as any).npc_generous ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
  ...
  scene.actions([
    ...
    if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted'  ||  ((s as any).npc_misogynist ?? 0)?.[String((s as any).npcID ?? 0)] > 0  ||  ((s as any).npc_rel_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 'sex'  ||  ((s as any).npc_sexdrive ?? 0)?.[String((s as any).npcID ?? 0)] > (Math.floor(Math.random() * 6) + 5)) {
      if (((s as any).npc_fav_pos ?? 0)?.[String((s as any).npcID ?? 0)] === 'blowjob') {
        ...
        scene.text(`"Oh yeah?" ${((s as any).npcdesc || '')}'s attention suddenly seems more focused on you as he grins wickedly. "Think you could… give me a blowjob later as payment?"`);
      } else {
        if (((s as any).npc_fav_pos ?? 0)?.[String((s as any).npcID ?? 0)] === 'anal') {
          // TODO-QSP: dynamic text: "Oh yeah?" <<$npcdesc>>'s attention suddenly seems more focused on you as he gri...
          scene.text(`"Oh yeah?" ${((s as any).npcdesc || '')}'s attention suddenly seems more focused on you as he grins wickedly. "How about after this you let me fuck your ass?"`);
        } else {
          // TODO-QSP: dynamic text: "Oh yeah?" <<$npcdesc>>'s attention suddenly seems more focused on you as he gri...
          scene.text(`"Oh yeah?" ${((s as any).npcdesc || '')}'s attention suddenly seems more focused on you as he grins wickedly. "How about after we head back to my place to let you 'make it up to me?'"`);
        }
      }
      scene.actions([
    ...
    if (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      scene.text(`${((s as any).npcdesc || '')}'s scowl returns. "Then what's the point?!"`);
    } else {
...
function enterSnackMenu(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).date_ev ?? 0)?.['popcorn_buy'] === 0) {
    ...
    if (qspFunc(s, 'money', 'can_afford', ((s as any).date_ev ?? 0)?.['snack_cost'] + 200) === 0) {
      ...
      ((s as any).date_ev = (s as any).date_ev ?? {})['popcorn_buy'] = 1;
      ((s as any).date_ev = (s as any).date_ev ?? {})['snack_cost'] = ((s as any).date_ev['snack_cost'] ?? 0) + (200);
  ...
  if (((s as any).date_ev ?? 0)?.['soda_buy'] === 0) {
    ...
    if (qspFunc(s, 'money', 'can_afford', ((s as any).date_ev ?? 0)?.['snack_cost'] + 200) === 0) {
      ...
      ((s as any).date_ev = (s as any).date_ev ?? {})['soda_buy'] = 1;
      ((s as any).date_ev = (s as any).date_ev ?? {})['snack_cost'] = ((s as any).date_ev['snack_cost'] ?? 0) + (200);
  ...
  if (((s as any).date_ev ?? 0)?.['candy_buy'] === 0) {
    ...
    if (qspFunc(s, 'money', 'can_afford', ((s as any).date_ev ?? 0)?.['snack_cost'] + 200) === 0) {
      ...
      ((s as any).date_ev = (s as any).date_ev ?? {})['candy_buy'] = 1;
      ((s as any).date_ev = (s as any).date_ev ?? {})['snack_cost'] = ((s as any).date_ev['snack_cost'] ?? 0) + (200);
...
function enterBuySnacks(s: GameState, scene: SceneBuilder): void {
  if (((s as any).date_ev ?? 0)?.['pc_snack_buy'] === 1) {
    ...
    qspGoto(s, 'date_movie', 'buy_snacks_payment');
  } },
          ]);
        }
        scene.actions([
    ...
    if (((s as any).npc_generous ?? 0)?.[String((s as any).npcID ?? 0)] > 0  ||  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] <= 0  &&  (!(Math.floor(Math.random() * 2) + 0))) {
      ((s as any).date_ev = (s as any).date_ev ?? {})['npc_snack_buy'] = 1;
      scene.text('He says no and insists he pays for it instead.');
      scene.actions([
        { label: 'Let him pay', handler: (st: GameState) => {
    scene.img('images/locations/shared/cinema/snack_bar.jpg');
...
function enterBuySnacksPayment(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (qspFunc(s, 'money', 'can_afford', ((s as any).date_ev ?? 0)?.['snack_cost']) === 0) {
      ...
      ((s as any).date_ev = (s as any).date_ev ?? {})['total_cost'] = ((s as any).date_ev['total_cost'] ?? 0) + (((s as any).date_ev ?? 0)?.['snack_cost']);
...
function enterWatchHorrorMovie1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You scream and grab ${((s as any).npcdesc || '')}'s arm.`);
    qspGoto(s, 'date_movie', 'movie_interlude');
  } },
  ]);
  scene.build();
...
function enterMovieInterlude(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_fav_date ?? 0)?.[String((s as any).npcID ?? 0)] !== 'movie_date'  &&  (Math.floor(Math.random() * 11) + 0) < ((s as any).npc_sexdrive ?? 0)?.[String((s as any).npcID ?? 0)]) {
    ...
    scene.text(`You swat ${((s as any).npcdesc || '')}, finally forcing him to retreat with a grumble.`);
    scene.actions([
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['theater_frisky'] = 'reluctant';
    scene.text('"Ugh, fine," you sigh, rolling your eyes and bend over to wrap your lips around his cock.');
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterTheaterBjMenu(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
      ]);
    } else {
  ...
  scene.actions([
    ...
    qspGoto(s, 'date_movie', 'theater_bj_menu');
  } },
...
function enterBoredWatching(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['movie_bored'] = 1;
  ...
  scene.actions([
    ...
    if (((s as any).npc_fav_date ?? 0)?.[String((s as any).npcID ?? 0)] === 'movie_date') {
      ...
      if ((Math.floor(Math.random() * 11) + 0) < ((s as any).npc_sexdrive ?? 0)?.[String((s as any).npcID ?? 0)]) {
        ...
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMovieInterludeEnd(s, scene); (s as any).locArgs = __savedLocArgs; }
      }
    } else {
...
function enterTheaterBjDistracted(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['cinema_bj'] = 1;
    ...
    if (((s as any).date_ev ?? 0)?.['theater_frisky'] === 'reluctant') {
      ...
      scene.text(`Whatever ${((s as any).npcdesc || '')} wants, you still want to see the movie too. You end up glancing sideways at the screen with one eye while you halfheartedly bob your head up and down ${((s as any).npcdesc || '')}'s cock.`);
    } else {
      // TODO-QSP: dynamic text: Despite how it started, your attention starts getting drawn back to the movie. Y...
      scene.text(`Despite how it started, your attention starts getting drawn back to the movie. You end up glancing sideways at the screen with one eye while distractedly bobbing your head on ${((s as any).npcdesc || '')}'s cock.`);
    }
    ...
    if (((s as any).sub ?? 0) > 10  ||  qspFunc(s, 'fetish', 'get_exp', 'sub') > 10) {
      ...
      scene.text(`With an internal grumble, you turn your attention away from the screen and towards blowing ${((s as any).npcdesc || '')}. You put effort into sucking, keeping your lips fastened around his shaft, going as deep as you can, and making sure to include plenty of tongue.`);
      scene.text('<i>Maybe he\'ll cum faster and I can get back to the movie,</i> you sigh.');
    }
    qspGoto(s, 'date_movie', 'theater_bj_cum_pre');
  } },
    ...
    qspGoto(s, 'date_movie', 'theater_bj_cum_pre');
      ...
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterTheaterBjCumPre(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
  } },
  ]);
  scene.build();
...
function enterTheaterBjEnjoy(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).npc_fav_date ?? 0)?.[String((s as any).npcID ?? 0)] === 'movie_date') {
      ...
      scene.text(`${((s as any).npcdesc || '')} keeps watching the film while you suck his cock.`);
    } else {
      if (((s as any).date_ev ?? 0)?.['theater_frisky'] === 'reluctant') {
        // TODO-QSP: dynamic text: Despite how it started, you soon find yourself getting more and more into it. Th...
        scene.text(`Despite how it started, you soon find yourself getting more and more into it. The film fades into the background and your blowjob takes the forefront. The texture of ${((s as any).npcdesc || '')}'s foreskin, slipping up and down between your lips. The scent of him filling your nostrils. The salty taste of his cock on your tongue.`);
      } else {
        // TODO-QSP: dynamic text: Both of you completely stop watching the film and turn all attention to you suck...
        scene.text(`Both of you completely stop watching the film and turn all attention to you sucking his cock.  The texture of ${((s as any).npcdesc || '')}'s foreskin, slipping up and down between your lips. The scent of him filling your nostrils. The salty taste of his cock on your tongue.`);
      }
    }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterTheaterBjCumPre(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
...
function enterMovieInterludeEnd(s: GameState, scene: SceneBuilder): void {
  if (((s as any).date_ev ?? 0)?.['cinema_bj'] === 1) {
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 10;
    qspCall(s, 'stat', '');
    qspGoto(s, 'sex_ev_start', 'pc_home_start');
  } },
      ]);
    }
  } },
...
function enterFilmTalkPc(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).date_ev = (s as any).date_ev ?? {})['pc_opinion'] = 'nice';
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterFilmTalkBoy(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    { label: 'That was okay', handler: (st: GameState) => {
    scene.text('"That was okay."');
    ((s as any).date_ev = (s as any).date_ev ?? {})['pc_opinion'] = 'okay';
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterFilmTalkBoy(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    { label: 'That was boring', handler: (st: GameState) => {
    scene.text('"That was kinda boring."');
    ((s as any).date_ev = (s as any).date_ev ?? {})['pc_opinion'] = 'boring';
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterFilmTalkBoy(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();

...
function enter(s: GameState, scene: SceneBuilder): void {
  (s as any).frost = 0;
  if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['RideDaystart'] = 0;
  if (!(s as any).AlbinaQW) (s as any).AlbinaQW = {}; (s as any).AlbinaQW['albride'] = 1;
  qspCall(s, 'stat', '');
  ...
  scene.actions([
    ...
    if (((s as any).AlbinaQW ?? 0)?.['Chernov'] === 1) {
      ...
      scene.text(`She stops at a red light and turns to you, looking rather happy. "You don't know what good you've done, ${((s as any).pcs_nickname ?? 0)}. I didn't think Chernov would have acted this fast with those leads."`);
    ...
    if (((s as any).AlbinaQW ?? 0)?.['Chernov'] === 2) {
      ...
      scene.text(`She stops at a red light and turns to you. "I really wish you had told that man everything he was asking for ${((s as any).pcs_nickname ?? 0)}," she says It would have been very helpful to me."`);

...
function enterCikl(s: GameState, scene: SceneBuilder): void {
  if (((s as any).husID ?? 0) !== '') {
    ...
    if (((s as any).npc_rel ?? 0)?.[String((s as any).husID ?? 0)] > 0  &&  ((s as any).spouseVars ?? 0)?.['drink'] !== 11) {
      if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['drink'] = Math.floor(Math.random() * 11) + 0;
    }
    if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['sexday'] = 0;
  ...
  if (((s as any).wifID ?? 0) !== '') {
    ...
    if (!(s as any).spouseVars) (s as any).spouseVars = {}; (s as any).spouseVars['sexday'] = 0;
    if (((s as any).spouseVars ?? 0)?.['pervert_add'] > 5) {
      if (!(s as any).npc_pervert) (s as any).npc_pervert = {}; (s as any).npc_pervert[String((s as any).wifID ?? 0)] = 1;
    }
    if (((s as any).spouseVars ?? 0)?.['gentle_add'] > 10) {
      if (!(s as any).npc_gentle) (s as any).npc_gentle = {}; (s as any).npc_gentle[String((s as any).wifID ?? 0)] = 1;
      if (!(s as any).npc_rough) (s as any).npc_rough = {}; (s as any).npc_rough[String((s as any).wifID ?? 0)] = 0;
    }
    if (((s as any).npc_rel ?? 0)?.[String((s as any).wifID ?? 0)] <= 10) {
      qspCall(s, 'lover_love', 'divorce');
  ...
  if (((s as any).sd_cm ?? 0)?.['lover_max'] > 0) {
    ...
    if (!(s as any).sd_cm) (s as any).sd_cm = {}; (s as any).sd_cm['npcid'] = qspUntranslated(s, "lover[sd_cm['li']]", { location: "lover" });
...
function enterRemove(s: GameState, scene: SceneBuilder): void {
  ...
  if ((String(((s as any).locArgs?.[1] ?? 0)).slice((1)-1, ((1)-1)+(1))) === 'B'  &&  (String(((s as any).locArgs?.[1] ?? 0)).length) > 1  &&  !isNaN((String(((s as any).locArgs?.[1] ?? 0)).slice((2)-1))) && (String(((s as any).locArgs?.[1] ?? 0)).slice((2)-1)) !== '') {
    ...
    if (((s as any).telefon_index ?? 0) >= 0) {
      if (!(s as any).contactAnon) (s as any).contactAnon = {}; (s as any).contactAnon[String((s as any).telefon_index ?? 0)] = 1;
    }
  }
  return;
  // TODO-QSP: end
...
function enterAddDating(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['dating_current'] = ((s as any).stat['dating_current'] ?? 0) + (1);
...
function enterAddHusband(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['husbands_current'] = ((s as any).stat['husbands_current'] ?? 0) + (1);
  if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['total_lovers_current'] = ((s as any).stat['total_lovers_current'] ?? 0) + (1);
  return;
  scene.build();
}
...
function enterAddWife(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['wifes_current'] = ((s as any).stat['wifes_current'] ?? 0) + (1);
  if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['total_lovers_current'] = ((s as any).stat['total_lovers_current'] ?? 0) + (1);
  return;
  // TODO-QSP: end
  scene.build();

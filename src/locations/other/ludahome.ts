    ...
    (st as any).OluLoc = 5;
      ...
      { label: 'I should go', goto: ['pod_ezd', 'etaj_4'] },
                    ...
                    if (((s as any).OluQW ?? 0)?.['met'] === 0) {
                      ((s as any).OluQW = (s as any).OluQW ?? {})['met'] = 1;
...
function enterTextanya(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locat ?? 0)?.['Anya'] < 9  ||  ((s as any).locat ?? 0)?.['Anya'] > 15) {
    ((s as any).OluQW = (s as any).OluQW ?? {})['anya_busy'] = ((s as any).daystart ?? 0);
  }
  if (((s as any).OluQW ?? 0)?.['anya_busy'] === ((s as any).daystart ?? 0)) {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterInvite(s, scene); (s as any).locArgs = __savedLocArgs; }
    scene.actions([
      { label: 'Say you would rather talk', handler: (st: GameState) => {
    scene.img('images/characters/shared/headshots_main/big55.jpg');
...
function enterTextnush(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hour ?? 0) < 8  ||  (((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) < 14)  ||  ((s as any).week ?? 0) === 3  ||  ((s as any).week ?? 0) === 5  ||  (((s as any).week ?? 0) === 6  &&  ((s as any).hour ?? 0) >= 18)  ||  (Math.floor(Math.random() * 4) + 0) > 0) {
    ((s as any).OluQW = (s as any).OluQW ?? {})['nush_busy'] = ((s as any).daystart ?? 0);
  }
...
function enterTextnatasha(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hour ?? 0) < 8  ||  (((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) < 14)  ||  (((s as any).week ?? 0) === 2  &&  ((s as any).hour ?? 0) >= 18)  ||  (Math.floor(Math.random() * 4) + 0) > 0) {
    ((s as any).OluQW = (s as any).OluQW ?? {})['nat_busy'] = ((s as any).daystart ?? 0);
  }
...
function enterLudaroom(s: GameState, scene: SceneBuilder): void {
  (s as any).menu_loc = 'ludahome';
  (s as any).menu_arg = 'ludaroom';
  (s as any).locM_arg = 'ludaroom';
  (s as any).locM = 'ludahome';
  (s as any).loc_arg = 'ludaroom';
  (s as any).loc = 'ludahome';
  (s as any).location_type = 'public_indoors';
...
function enterFridge(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).LudaQW ?? 0)?.['food_day'] !== ((s as any).daystart ?? 0)) {
    ((s as any).LudaQW = (s as any).LudaQW ?? {})['soup_count'] = 1;
    ((s as any).LudaQW = (s as any).LudaQW ?? {})['leftover_count'] = 1;
    ((s as any).LudaQW = (s as any).LudaQW ?? {})['water_count'] = 1;
    ((s as any).LudaQW = (s as any).LudaQW ?? {})['tea_count'] = 1;
    ((s as any).LudaQW = (s as any).LudaQW ?? {})['sandwich_count'] = 1;
  }
  qspCall(s, 'stat', '');
  ...
  if (((s as any).LudaQW ?? 0)?.['leftover_count'] > 0) {
    ...
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['food_day'] = ((st as any).daystart ?? 0);
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['leftover_count'] = ((st as any).LudaQW['leftover_count'] ?? 0) - (1);
    qspCall(st, 'stat', '');
  ...
  if (((s as any).LudaQW ?? 0)?.['tea_count'] > 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['food_day'] = ((st as any).daystart ?? 0);
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['tea_count'] = ((st as any).LudaQW['tea_count'] ?? 0) - (1);
    qspCall(st, 'stat', '');
    ...
    if (((st as any).pcs_hydra ?? 0) >= 100) {
      (st as any).pcs_hydra = ((st as any).pcs_hydra ?? 0) + (35);
    } else {
      (st as any).pcs_hydra = ((st as any).pcs_hydra ?? 0) + (70);
    }
    (st as any).cumspclnt = 2;
    qspCall(st, 'cum_cleanup', '');
    (st as any).pcs_breath = 0;
  ...
  if (((s as any).LudaQW ?? 0)?.['water_count'] > 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['food_day'] = ((st as any).daystart ?? 0);
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['water_count'] = ((st as any).LudaQW['water_count'] ?? 0) - (1);
    qspCall(st, 'stat', '');
  ...
  if (((s as any).LudaQW ?? 0)?.['soup_count'] > 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['food_day'] = ((st as any).daystart ?? 0);
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['soup_count'] = ((st as any).LudaQW['soup_count'] ?? 0) - (1);
    qspCall(st, 'stat', '');
  ...
  if (((s as any).LudaQW ?? 0)?.['sandwich_count'] > 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['food_day'] = ((st as any).daystart ?? 0);
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['sandwich_count'] = ((st as any).LudaQW['sandwich_count'] ?? 0) - (1);
    qspCall(st, 'stat', '');
...
function enterChatLuda(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).LudaQW ?? 0)?.['olu_offer'] === 1  &&  ((s as any).LudaQW ?? 0)?.['olu_offer_day'] !== ((s as any).daystart ?? 0)) {
    ((s as any).LudaQW = (s as any).LudaQW ?? {})['olu_offer_day'] = ((s as any).daystart ?? 0);
    ...
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['olu_offer'] = 2;
    scene.img('images/characters/pavlovsk/resident/luda/talk.jpg');
    ...
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['olu_offer'] = (-1);
    scene.img('images/characters/pavlovsk/resident/luda/talk.jpg');
    ...
    if (((s as any).LudaQW ?? 0)?.['olu_offer'] === 2  &&  ((s as any).OluQW ?? 0)?.['sex'] === 1) {
      (s as any).minut = ((s as any).minut ?? 0) + 10;
      ((s as any).LudaQW = (s as any).LudaQW ?? {})['olu_offer'] = 3;
      qspCall(s, 'stat', '');
      scene.img('images/characters/pavlovsk/resident/luda/talk.jpg');
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['open_rel'] = 1;
    qspCall(st, 'npc_relationship', 'modify', 'A30', 'like');
    qspCall(st, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/luda/talk.jpg');
    ...
    if ((((st as any).fame ?? 0)?.['pav_slut'] >= 100  ||  ((st as any).LudaQW ?? 0)?.['KnowsSexActive'] >= 10)  &&  ((st as any).LudaQW ?? 0)?.['olu_offer'] === 0  &&  ((st as any).stat ?? 0)?.['think_virgin'] === 0) {
    ...
    scene.actions([
      ...
      { label: 'Stop talking', goto: ['ludahome', 'livingroom'] },
        ...
        { label: '', labelFn: (s: GameState) => 'Talk about your ' + String(((s as any).npc_nickname ?? 0)?.['A29'] ?? '' ?? ''), handler: (st: GameState) => {
    (st as any).minut = ((st as any).minut ?? 0) + 2;
    qspCall(st, 'npc_relationship', 'modify', 'A30', 'like');
    qspCall(st, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/luda/talk.jpg');
    ...
    if (((st as any).momslut ?? 0) >= 1) {
      scene.actions([
        { label: '', labelFn: (s: GameState) => String(((st as any).npc_nickname ?? 0)?.['A29'] ?? '' ?? '') + ' is a slut', handler: (st: GameState) => {
    ...
    scene.actions([
      ...
      if (((st as any).motherrumor ?? 0) === 1) {
        scene.actions([
          { label: '', labelFn: (s: GameState) => 'Rumors about your ' + String(((st as any).npc_nickname ?? 0)?.['A29'] ?? '' ?? ''), handler: (st: GameState) => {
    (st as any).minut = ((st as any).minut ?? 0) + 3;
    qspCall(st, 'npc_relationship', 'modify', 'A30', 'like');
    qspCall(st, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/luda/talk.jpg');
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).LudaQW = (st as any).LudaQW ?? {})['boytalk'] = 1;
    qspCall(st, 'npc_relationship', 'modify', 'A30', 'like');
    qspCall(st, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/luda/talk.jpg');
    ...
    if (((st as any).NikoVolkovQW ?? 0) >= 5  ||  ((st as any).fedorKozlovQW ?? 0) >= 5  ||  ((st as any).kotovLoveQW ?? 0) === 1  ||  ((st as any).artemQW ?? 0)?.['bf'] === 1  ||  ((st as any).rex_love ?? 0) === 1  ||  ((st as any).IgorQW ?? 0)?.['Lover'] === 1  ||  ((st as any).stat ?? 0)?.['boyfriends_current'] > 0) {
      scene.actions([
...
function enterChatOlu(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 2;
  ((s as any).OluQW = (s as any).OluQW ?? {})['talked'] = 1;
  qspCall(s, 'stat', '');
  scene.img('images/characters/shared/headshots_main/big55.jpg');
  ...
  if (((s as any).LudaQW ?? 0)?.['open_rel'] === 1) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 3;
    qspCall(st, 'npc_relationship', 'modify', 'A55', 'like');
    qspCall(st, 'stat', '');
    ...
    if (((st as any).LudaQW ?? 0)?.['olu_offer'] >= 2) {
      scene.actions([
    ...
    qspCall(st, 'stat', '');
    scene.img('images/characters/pavlovsk/resident/olu/flirttalk.jpg');
    if (((st as any).LudaQW ?? 0)?.['olu_offer'] === 1) {

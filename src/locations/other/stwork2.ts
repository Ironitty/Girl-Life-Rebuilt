...
function enterStripShowStart(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['cust_boos'] = 0;
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = 0;
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['dancing_rounds'] = 3;
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['bra_type'] = ((s as any).braworntype ?? 0);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['bra_number'] = ((s as any).brawornnumber ?? 0);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['panty_type'] = ((s as any).pantyworntype ?? 0);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['panty_number'] = ((s as any).pantywornnumber ?? 0);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['clothing_type'] = ((s as any).clothingworntype ?? 0);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['clothing_number'] = ((s as any).clothingwornnumber ?? 0);
...
function enterStripHub2(s: GameState, scene: SceneBuilder): void {
  ...
  if ((((s as any).hour ?? 0) > 2  ||  ((s as any).hour ?? 0) === 2  &&  ((s as any).minut ?? 0) > 45)  &&  (((s as any).hour ?? 0) < 17  ||  (((s as any).hour ?? 0) === 17  &&  ((s as any).minut ?? 0) < 30))) {
    ...
    if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['total_stripshows'] = ((s as any).strip_club['total_stripshows'] ?? 0) + (1);
    ...
    if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['lapdance_chance'] = 0;
...
function enterSetCustomerMood(s: GameState, scene: SceneBuilder): void {
  if (qspFunc(s, 'pcs_has_attr', ' || ', 'body_bmi_overweight', 'body_bmi_obese')) {
    if ((Math.floor(Math.random() * 101) + 0) >= 60) {
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) - (Math.floor(Math.random() * 6) + 5);
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['cust_angry'] = 1;
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['cust_boos'] = ((s as any).strip_club['cust_boos'] ?? 0) + (1);
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['rand'] = Math.floor(Math.random() * 4) + 0;
      ...
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['cust_angry'] = 0;
...
function enterSetCustomerMoodPole(s: GameState, scene: SceneBuilder): void {
  if (qspFunc(s, 'pcs_has_attr', ' || ', 'body_bmi_overweight', 'body_bmi_obese')) {
    if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['rand'] = Math.floor(Math.random() * 100) + 0;
    if (((s as any).strip_club ?? 0)?.['rand'] < 25) {
      ...
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['cust_boos'] = ((s as any).strip_club['cust_boos'] ?? 0) + (1);
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) - (40);
      ...
      if (((s as any).strip_club ?? 0)?.['rand'] < 50) {
        if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['cust_boos'] = ((s as any).strip_club['cust_boos'] ?? 0) + (1);
        if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) - (Math.floor(Math.random() * 16) + 15);
        scene.text('You overhear some of the customers sitting next to the stage.');
        scene.text('"Look at her fat hanging out. Her gut and ass are shaking like jelly!"');
      }
    }
...
function enterDanceClothed(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) + ((Math.floor(Math.random() * (5 * ((s as any).pcs_dancero ?? 0) - ((s as any).pcs_dancero ?? 0) + 1)) + (((s as any).pcs_dancero ?? 0))) / 10);
  qspCall(s, 'stat', '');
...
function enterStripClothes(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) + ((Math.floor(Math.random() * (5 * ((s as any).pcs_dancero ?? 0) - ((s as any).pcs_dancero ?? 0) + 1)) + (((s as any).pcs_dancero ?? 0))) / 7);
  qspCall(s, 'stat', '');
  scene.img('images/locations/city/redlight/stripclub/sveta_clothed1.jpg');
  ...
  scene.actions([
    ...
    if (((s as any).strip_club ?? 0)?.['cust_angry'] === 0) {
    ...
    if (((s as any).PCloSkirt ?? 0) > 0) {
      // TODO-QSP: $temp_bottom_desc[1] = 'it'
    } else {
      // TODO-QSP: $temp_bottom_desc[1] = 'them'
    }
    scene.actions([
      { label: 'Take off your <<$temp_bottom_desc>>', handler: (st: GameState) => {
    ...
    if (((s as any).strip_club ?? 0)?.['cust_angry'] === 0) {
      ...
      scene.text(`The positive responses make you smile as you unzip your ${((s as any).temp_bottom_desc ?? 0)} and let ${qspUntranslated(s, "temp_bottom_desc[1]", { location: "stwork2" })} drop to your ankles before kicking ${qspUntranslated(s, "temp_bottom_desc[1]", { location: "stwork2" })} off and looking several customers straight in the eye as you roll around on the stage in your underwear. Some of them throw some bills your way, so you make sure to some extra attention to them.`);
    } else {
      qspCall(s, 'mood', 'lower', 'tiny');
      // TODO-QSP: dynamic text: The negative comments make you feel a bit uncomfortable as you unzip your <<$tem...
      scene.text(`The negative comments make you feel a bit uncomfortable as you unzip your ${((s as any).temp_bottom_desc ?? 0)} and let ${qspUntranslated(s, "temp_bottom_desc[1]", { location: "stwork2" })} drop to your ankles before kicking ${qspUntranslated(s, "temp_bottom_desc[1]", { location: "stwork2" })} off, looking several customers straight in the eye as you roll around on the stage in your underwear.`);
    }
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterStripBra(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'fame', 'city', 'stripping', Math.floor(Math.random() * 2) + 1);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) + ((Math.floor(Math.random() * (5 * ((s as any).pcs_dancero ?? 0) - ((s as any).pcs_dancero ?? 0) + 1)) + (((s as any).pcs_dancero ?? 0))) / 5);
  qspCall(s, 'stat', '');
...
function enterDanceNude(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'exp_gain', 'inhib', Math.floor(Math.random() * 2) + 1);
  qspCall(s, 'fame', 'city', 'stripping', Math.floor(Math.random() * 2) + 1);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) + ((Math.floor(Math.random() * (5 * ((s as any).pcs_dancero ?? 0) - ((s as any).pcs_dancero ?? 0) + 1)) + (((s as any).pcs_dancero ?? 0))) / 3);
  qspCall(s, 'stat', '');
  ...
  if (((s as any).strip_club ?? 0)?.['cust_boos'] < 2) {
    ...
    if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['lapdance_chance'] = 1;
    (s as any).pcs_hairbsh = 0;
    if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['total_stripshows'] = ((s as any).strip_club['total_stripshows'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterPoleUnderwear(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['dancing_rounds'] = ((s as any).strip_club['dancing_rounds'] ?? 0) - (1);
  qspCall(s, 'sweat', 'add', 5);
  ...
  qspCall(s, 'exp_gain', 'inhib', Math.floor(Math.random() * 2) + 1);
  qspCall(s, 'fame', 'city', 'stripping', Math.floor(Math.random() * 2) + 1);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) + ((Math.floor(Math.random() * (5 * ((s as any).pcs_dancpol ?? 0) - ((s as any).pcs_dancpol ?? 0) + 1)) + (((s as any).pcs_dancpol ?? 0))) / 3);
  qspCall(s, 'stat', '');
...
function enterManagerBonus(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).strip_club ?? 0)?.['manager_bonus'] === 0) {
    // TODO-QSP: dynamic text: "I heard that you've had a pretty good night, <<$pcs_strippername>>. How about a...
    scene.text(`"I heard that you've had a pretty good night, ${((s as any).pcs_strippername ?? 0)}. How about a little bonus to top it off?" he asks.`);
    ...
    // TODO-QSP: dynamic text: "Nice work, <<$pcs_strippername>>. Good to see you aren't afraid of performing i...
    scene.text(`"Nice work, ${((s as any).pcs_strippername ?? 0)}. Good to see you aren't afraid of performing in front of an audience. Maybe a career in porn is in your future?"`);
    ...
    scene.img('images/shared/sex/cum/mouth/cum13.jpg');
    scene.text('He finally finishes and releases his grip on your head, allowing you pull yourself off of his cock. You gasp for air and wipe the saliva from your mouth before looking up to see him grinning down at you as he counts your money.');
    // TODO-QSP: dynamic text: "Nice work, <<$pcs_strippername>>. It's nice to see young girls with a good work...
    scene.text(`"Nice work, ${((s as any).pcs_strippername ?? 0)}. It's nice to see young girls with a good work ethic," he laughs.`);
    scene.text('You just smile at him before getting up and taking the money. Heading out into the hallway, the security guard flashes you a knowing smile as you hurry back to the dressing room.');
    scene.actions([
      { label: 'Return to the dressing room', goto: ['stwork2', 'strip_show_end'] },
    ]);
...
function enterPrivatdance(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['rand'] = Math.floor(Math.random() * 26) + 0;
  if (((s as any).strip_club ?? 0)?.['rand'] === 0) {
    scene.actions([{ label: 'Continue', goto: ['stwork2', 'pr1'] }]);
  } else {
    if (((s as any).strip_club ?? 0)?.['rand'] === 1) {
      scene.actions([{ label: 'Continue', goto: ['stwork2', 'pr2'] }]);
    } else {
      if (((s as any).strip_club ?? 0)?.['rand'] === 2) {
        scene.actions([{ label: 'Continue', goto: ['stwork2', 'pr3'] }]);
      } else {
        if (((s as any).strip_club ?? 0)?.['rand'] === 3) {
          scene.actions([{ label: 'Continue', goto: ['stwork2', 'pr4'] }]);
        } else {
          if (((s as any).strip_club ?? 0)?.['rand'] === 4) {
            scene.actions([{ label: 'Continue', goto: ['stwork2', 'pr5'] }]);
          } else {
            if (((s as any).strip_club ?? 0)?.['rand'] === 5) {
              scene.actions([{ label: 'Continue', goto: ['stwork2', 'pr6'] }]);
            } else {
              if (((s as any).strip_club ?? 0)?.['rand'] === 6) {
                scene.actions([{ label: 'Continue', goto: ['stwork2', 'pr7'] }]);
              } else {
                if (((s as any).strip_club ?? 0)?.['rand'] === 7) {
                  scene.actions([{ label: 'Continue', goto: ['stwork2', 'pr8'] }]);
                }
              }
            }
          }
...
function enterPr1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: "Great show, girl. So great in fact, that you left our friend rather 'tensed up'...
    ...
    qspCall(s, 'arousal', 'bj', (-2));
    qspCall(s, 'cum_call', 'mouth_swallow', 'Private dance client', 0, 0, 10000, 40);
    qspCall(s, 'arousal', 'end');
    qspCall(s, 'stwork2', 'privatdance_end');
  } },
...
function enterPr2(s: GameState, scene: SceneBuilder): void {
  scene.img('images/locations/city/redlight/stripclub/private_grind.mp4');
  // TODO-QSP: dynamic text: The man you're dancing for is mesmerized by you and you feel his rock hard cock ...
  ...
  scene.actions([
    ...
    qspCall(s, 'money', 'earn', 1000);
    qspCall(s, 'stat', '');
    qspCall(s, 'npcgeneratec', '', 0, 'Private dance client', Math.floor(Math.random() * 36) + 20);
    ...
    qspCall(s, 'cum_call', 'face', 'Private dance client', 0, 0, 10000, 40);
    qspCall(s, 'stwork2', 'privatdance_end');
  } },
  ]);
  scene.build();
...
function enterPr3(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: It's a bit different dancing for a woman. It's not often you have the pleasure o...
...
function enterPr5(s: GameState, scene: SceneBuilder): void {
  ...
  if ((Math.floor(Math.random() * 3) + 0) === 0  &&  ((s as any).locat ?? 0)?.['A23'] === 22  &&  ((s as any).AlbinaQW ?? 0)?.['working_stripclub'] === 1  &&  ((s as any).npc_rel ?? 0)?.['A23'] >= 60) {
    ...
    if (((s as any).strip_club ?? 0)?.['jade_intro'] === 0) {
      ...
      // TODO-QSP: dynamic text: "Hi <<$pcs_strippername>>! I'm <i>soooo</i> happy that we get to dance together!...
      scene.text(`"Hi ${((s as any).pcs_strippername ?? 0)}! I'm <i>soooo</i> happy that we get to dance together! This man is <i>sooo nice</i>! He gives me <i>ssoooo</i> much money just for being <i>me</i>!"`);
...
function enterPr7(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'Private dance client', Math.floor(Math.random() * 16) + 25);
    ...
    // TODO-QSP: dynamic text: "<<$func('money', 'string_profit', 2000)>>," you reply and bite your lip seducti...
...
function enterPr8(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).film ?? 0) > 0) {
    ...
    // TODO-QSP: dynamic text: "Oh. Hello <<$pfname>>," he smiles. "Or do you prefer <<$pcs_strippername>> when...
    scene.text(`"Oh. Hello ${((s as any).pfname ?? 0)}," he smiles. "Or do you prefer ${((s as any).pcs_strippername ?? 0)} when working here?"`);
    ...
    if (((s as any).strip_club ?? 0)?.['porn_scout'] === 0  &&  (!((s as any).film ?? 0))) {
      ...
      if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['porn_scout'] = 1;
      qspCall(s, 'stat', '');
    } else {
      if (((s as any).strip_club ?? 0)?.['porn_scout'] === 1  &&  ((s as any).strip_club ?? 0)?.['porn_scout_pickup'] === 0  &&  (((s as any).week ?? 0) === 5  ||  ((s as any).week ?? 0) === 6)) {
        ...
        // TODO-QSP: dynamic text: He frowns. "I know you might be reluctant to do it, and for good reason, but I'l...
    ...
    qspCall(s, 'willpower', 'pay', 'resist');
    qspCall(s, 'money', 'earn', 1000);
    if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['porn_scout_pickup'] = (-1);
    qspCall(s, 'stat', '');
    scene.img('images/locations/city/redlight/stripclub/private_room.jpg');

...
function enterDanceClothed(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) + ((Math.floor(Math.random() * (5 * pcs_dancero - pcs_dancero + 1)) + (pcs_dancero)) / 10);
  qspCall(s, 'stat', '');
...
function enterStripClothes(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) + ((Math.floor(Math.random() * (5 * pcs_dancero - pcs_dancero + 1)) + (pcs_dancero)) / 7);
  qspCall(s, 'stat', '');
  scene.img('images/locations/city/redlight/stripclub/sveta_clothed1.jpg');
...
function enterStripBra(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'fame', 'city', 'stripping', Math.floor(Math.random() * 2) + 1);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) + ((Math.floor(Math.random() * (5 * pcs_dancero - pcs_dancero + 1)) + (pcs_dancero)) / 5);
  qspCall(s, 'stat', '');
...
function enterDanceNude(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'exp_gain', 'inhib', Math.floor(Math.random() * 2) + 1);
  qspCall(s, 'fame', 'city', 'stripping', Math.floor(Math.random() * 2) + 1);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) + ((Math.floor(Math.random() * (5 * pcs_dancero - pcs_dancero + 1)) + (pcs_dancero)) / 3);
  qspCall(s, 'stat', '');
...
function enterPoleUnderwear(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'exp_gain', 'inhib', Math.floor(Math.random() * 2) + 1);
  qspCall(s, 'fame', 'city', 'stripping', Math.floor(Math.random() * 2) + 1);
  if (!(s as any).strip_club) (s as any).strip_club = {}; (s as any).strip_club['strip_tips'] = ((s as any).strip_club['strip_tips'] ?? 0) + ((Math.floor(Math.random() * (5 * pcs_dancpol - pcs_dancpol + 1)) + (pcs_dancpol)) / 3);
  qspCall(s, 'stat', '');

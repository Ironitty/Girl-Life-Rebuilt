...
export const mey_home: LocationDef = {
  ...
  locclass: 'bedroom',
  description: ['A large and bright hall, this "hallway" stretches for quite a bit. You\'ve never seen anything like this before! There is a mirror covering half of one of the walls. You see the kitchen from the hallway. There\'s a big oval dining table.'],
  enter: enter,
};

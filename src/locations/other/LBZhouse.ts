...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).boydesc ?? 0)} continues kissing you as he begins unzipping his pants, revealing his bulge. He proceeds to run his hand across your body, feeling your breasts, all the way down to your ass. Looking down, you see his cock is rock-hard.`);
    ...
    scene.text(`${((s as any).boydesc ?? 0)} forces you down on your knees in front of him. You can't avert your gaze from his cock as you slowly lean forward and lightly lick the tip of his penis. Looking up, you make sure to maintain eye contact with him, making him shiver in anticipation of you sucking his cock.`);
    qspCall(s, 'arousal', 'foreplay', 5);
    ...
    scene.text(`${((s as any).boydesc ?? 0)} continues kissing you as his hands wander over your body, slowly removing clothes while kissing you. Once naked, he starts teasing your nipples, sending tingles all through your body.`);
    qspCall(s, 'arousal', 'kiss', 5);
    qspCall(s, 'arousal', 'foreplay', (-5));
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterBJ(s: GameState, scene: SceneBuilder): void {
  ...
  scene.img(`images/shared/sex/blowjob/bj${((s as any).VK ?? 0)}.mp4`);
  ...
  scene.actions([
    ...
    scene.text(`You keep his cock inside your mouth as ${((s as any).boydesc ?? 0)} fills your mouth with his hot cum. You never break eye contact as you fully milk his cock until he's totally drained. "That was a great blowjob…" As he pulls out his cock you make sure to swallow every single drop.`);
    qspCall(s, 'arousal', 'bj', 5);
...
function enterVaginal(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: <<$boydesc>> reaches down, helping you to your feet before grabbing onto your hi...
  ...
  if (((s as any).mc_inventory ?? 0)?.['equipped_condoms'] >= 1  &&  (!((s as any).preziktype ?? 0))) {
    ...
    scene.text(`In between your moans, you sense he's about to cum, and tell him to pull out. ${((s as any).boydesc ?? 0)} thrusts a couple more times and just manages to pull out as he cums all over your stomach, emptying his balls.`);
    qspCall(s, 'arousal', 'vaginal', 5);
...
function enterAnal(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: <<$boydesc>> has you get on your hands and knees as he prepares you asshole by p...
  scene.text(`${((s as any).boydesc ?? 0)} has you get on your hands and knees as he prepares you asshole by putting a finger in first. You feel him pull it out and then feel his cock pressing against your asshole, before he slowly pushes inside, causing a jolt of pleasure. He waits a bit for you to get used to his size before he starts thrusting in you.`);
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).boydesc ?? 0)} is enjoying himself as he pounds your ass before ramming his dick completely inside of your ass, filling you up. Even as he's emptied, you can still feel his cock throb inside of you. He slowly pulls out, giving you one last sensation as he leaves your ass.`);
    qspCall(s, 'arousal', 'anal', 5);
...
function enterEnd(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).LBZhouseShower ?? 0) === 1) {
    // TODO-QSP: dynamic text: As you leave the bathroom, <<$boydesc>> is waiting by the bathroom door. He give...
    scene.text(`As you leave the bathroom, ${((s as any).boydesc ?? 0)} is waiting by the bathroom door. He gives you a kiss on the cheek, "I've enjoyed your visit, ${((s as any).pcs_nickname ?? 0)}." You smile back and the two of you have a short conversation before you leave.`);
  } else {

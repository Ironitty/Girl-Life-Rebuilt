...
function enterSetTalkActs(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['talked_about_gadukino'] === 0) {
    ...
    ((s as any).grandmaQW = (s as any).grandmaQW ?? {})['talked_about_gadukino'] = 1;
    ...
    scene.text(`"Don't you remember ${((s as any).pcs_nickname || '')}? You've visited us many times," said grandma.`);
  ...
  if (24 * (((s as any).daystart ?? 0) - ((s as any).grandmaQW ?? 0)?.['last_day_talked']) + (((s as any).hour ?? 0) - ((s as any).grandmaQW ?? 0)?.['last_hour_talked']) >= 3) {
    ...
    ((s as any).grandmaQW = (s as any).grandmaQW ?? {})['last_hour_talked'] = ((s as any).hour ?? 0);
    ((s as any).grandmaQW = (s as any).grandmaQW ?? {})['last_day_talked'] = ((s as any).daystart ?? 0);
    (s as any).minut = ((s as any).minut ?? 0) + 10;
  ...
  if (((s as any).grandmaQW ?? 0)?.['last_day_asked_for_story'] !== ((s as any).daystart ?? 0)) {
    ...
    ((s as any).grandmaQW = (s as any).grandmaQW ?? {})['last_day_asked_for_story'] = ((s as any).daystart ?? 0);
    ...
    if ((!((s as any).temp ?? 0))) {
      ...
      if (((s as any).temp ?? 0) === 1) {
        ...
        scene.text(`"She was terrified! She quickly left her house and only returned when I promised to go with her… but of course, we found nothing. Do you believe in ghosts, ${((s as any).pcs_nickname || '')}? Because ever since then, I do…"`);
      } else {
        if (((s as any).temp ?? 0) === 2) {
          ...
          scene.text(`"Death is not to be trifled with, ${((s as any).pcs_nickname || '')}… her parents were smart to hide her. Otherwise, she might've died instead!"`);
        } else {
            ...
            if (((s as any).temp ?? 0) === 4) {
              ...
              if (((s as any).temp ?? 0) === 5) {
                ...
                if (((s as any).temp ?? 0) === 6) {
                  ...
                  scene.text(`"You don't get it, ${((s as any).pcs_nickname || '')}. The matches today are not as good as those made long ago. I miss those matches we had during the Great Patriotic War before they had to move the factory to the far east… Those matches were magical, not like this crap we have now… Ugh…"`);
                } else {
...
function enterGetRandomChoreAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).daystart ?? 0) !== ((s as any).grandmaQW ?? 0)?.['last_day_helped']) {
    ...
    ((s as any).grandmaQW = (s as any).grandmaQW ?? {})['last_day_helped'] = ((s as any).daystart ?? 0);
    (s as any).frost = 0;
    qspCall(s, 'stat', '');
    ...
    scene.text(`"There is nothing to do today, ${((s as any).pcs_nickname || '')}. Take the day off.`);
    scene.actions([
      { label: 'Continue', goto: ['gp_elene', 'talk'] },
    ]);
  } },
...
function enterCheckForChores(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'livingroom') {
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 'garden') {
      ...
      if (((s as any).locArgs?.[1] ?? 0) === 'chickens') {
        ...
        if (((s as any).locArgs?.[1] ?? 0) === 'strawberry') {
          ...
          if (((s as any).locArgs?.[1] ?? 0) === 'fruit_garden') {
...
function enterEventWashclothes(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'archetypes', 'gain', 'prude', 'tiny', 'Helping grandma: wash clothes', 7);
    scene.actions([
...
function enterSetReportWashclothesAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_wash_clothes'] === 2) {
    ...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}. I have no idea how that man gets so dirty!"`);
...
function enterSetReportMilkcowAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_milk_cow'] === 2) {
    ...
    // TODO-QSP: dynamic text: "Thank you, <<$pcs_nickname>>. She's such a sweet thing, isn't she?" your grandm...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}. She's such a sweet thing, isn't she?" your grandmother asks fondly.`);
...
function enterSetReportGroceriesAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_groceries'] === 2) {
    ...
    // TODO-QSP: dynamic text: "Thank you, <<$pcs_nickname>>. He's a nice young man. I've known him since he wa...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}. He's a nice young man. I've known him since he was a child, you know."`);
    ...
    scene.text(`"No, that is all, ${((s as any).pcs_nickname || '')}," she says and gives you a gentle pat on the back.`);
    scene.actions([
      { label: 'Continue', goto: ['gp_elene', 'talk'] },
    ]);
  } },
...
function enterSetHelpCanMushroomsAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_can_mushrooms'] === 1) {
    ...
    (s as any).boletus_stored = ((s as any).boletus_stored ?? 0) - (5);
    qspCall(s, 'stat', '');
    ...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}," she says. "It is important to save food up for the hard winter months. Sure, now you can walk to the store and get whatever you want, but it wasn't always that way!"`);
    scene.actions([
...
function enterSetHelpCanBerriesAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_can_berries'] === 1) {
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 45;
    (s as any).bilberry_stored = ((s as any).bilberry_stored ?? 0) - (5);
    qspCall(s, 'stat', '');
...
function enterSetHelpCanVeggiesAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_can_veggies'] === 1) {
    ...
    qspCall(s, 'stat', '');
    ((s as any).grandmaQW = (s as any).grandmaQW ?? {})['chore_harvest_done'] = 0;
    ...
    ((s as any).grandmaQW = (s as any).grandmaQW ?? {})['help_amount'] = ((s as any).grandmaQW['help_amount'] ?? 0) + (3);
    ...
    scene.text(`"You know, ${((s as any).pcs_nickname || '')}, if you know how to can your own food, you can survive years of poor harvests," she says.`);
...
function enterSetReportFeedchickensAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_feed_chickens'] === 2) {
    ...
    scene.text(`"Good, thank you, ${((s as any).pcs_nickname || '')}," she says. "A fat chicken is a happy chicken, and happy chickens lay the best eggs."`);
...
function enterEventCheckplants(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  scene.img('images/locations/gadukino/village/work_garden\'+rand(1, 5)+\'.jpg');
...
function enterSetReportCheckplantsAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_work_in_garden'] === 2) {
    ...
    scene.text(`"Good, thank you, ${((s as any).pcs_nickname || '')}," she says. "Did you pull out all the weeds?"`);
    ...
    scene.text(`"Good, good," she nods. "It is crucial to take care of your garden, ${((s as any).pcs_nickname || '')}. It is how we provide for ourselves when no one else will."`);
    ...
    if (((s as any).npc_QW ?? 0)?.['A29'] < 2) {
      ...
      // TODO-QSP: dynamic text: You struggle to contain your laughter. "Oh yeah, <<$npc_nickname['A29']>> has to...
      scene.text(`You struggle to contain your laughter. "Oh yeah, ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} has told me all about the 'garden', Grandma. Like mother, like daughter, I guess!"`);
    ...
    scene.text(`You grin, thinking of how ${((s as any).npc_nickname ?? 0)?.['A29'] ?? ''} must have been at your age.`);
    // TODO-QSP: dynamic text: "Anyway," she continues, "thank you for doing that for me, <<$pcs_nickname>>. My...
    scene.text(`"Anyway," she continues, "thank you for doing that for me, ${((s as any).pcs_nickname || '')}. My old bones complain when I do it."`);
...
function enterSetReportWaterplantsAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_water_garden'] === 2) {
    ...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}," she says. "A healthy plant is always thirsty. So you should have some water, too, if you want to be a healthy girl."`);
...
function enterSetReportCollectstrawberriesAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_collect_strawberries'] === 2) {
    ...
    // TODO-QSP: dynamic text: "Oh, <<$pcs_nickname>>," she exclaims, "don't these just look wonderful? They ar...
    scene.text(`"Oh, ${((s as any).pcs_nickname || '')}," she exclaims, "don't these just look wonderful? They are plump and juicy this year."`);
...
function enterSetReportCollectfruitAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_collect_fruit'] === 2) {
    ...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}," she says. "I cannot reach or bend like I used to, so you have done me a great favor."`);
...
function enterEventHarvestgarden(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'exp_gain', 'hndiwrk', Math.floor(Math.random() * 7) + 3);
  qspCall(s, 'stat', '');
  scene.img('images/locations/gadukino/village/harvest_garden\'+rand(1, 5)+\'.jpg');
...
function enterSetReportHarvestgardenAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_harvest_garden'] === 2) {
    ...
    ((s as any).grandmaQW = (s as any).grandmaQW ?? {})['chore_harvest_done'] = 1;
    qspCall(s, 'stat', '');
    scene.img('images/locations/gadukino/grandparents/grandma.jpg');
    ...
    // TODO-QSP: dynamic text: "Oh, don't worry yourself, little <<$pcs_nickname>>," she says, cupping your che...
    scene.text(`"Oh, don't worry yourself, little ${((s as any).pcs_nickname || '')}," she says, cupping your cheek with her hand. "Forgive an old woman of her thoughtful ways. We are lucky to have such a kind granddaughter to help us bring in the harvest."`);
...
function enterChoreGathermushrooms(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: "Oh, I would say you should be able to find at least <<grandmaQW['chore_mushroom...
...
function enterSetReportGathermushroomsAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_gather_mushrooms'] === 2  &&  ((s as any).boletus ?? 0) >= ((s as any).grandmaQW ?? 0)?.['chore_mushroom_quantity']  &&  ((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) < 20) {
    ...
    ((s as any).grandmaQW = (s as any).grandmaQW ?? {})['disappointment'] = 0;
    qspCall(s, 'stat', '');
    scene.img('images/locations/gadukino/grandparents/grandma.jpg');
...
function enterChoreGatherberries(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: "<<grandmaQW['chore_berry_quantity']>> kilos will be a good start," Grandma repl...
...
function enterSetReportGatherberriesAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_gather_berries'] === 2  &&  ((s as any).bilberry ?? 0) >= ((s as any).grandmaQW ?? 0)?.['chore_berry_quantity']  &&  ((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) < 20) {
    ...
    scene.text(`"Oh, thank you, ${((s as any).pcs_nickname || '')}," Grandma replied. "Those look fine if a little late. They will have to go down in the root cellar until we are ready to can them."`);
    ...
    scene.text(`"Oh, thank you, ${((s as any).pcs_nickname || '')}," Grandma replied. "Those look perfect. They will have to go down in the root cellar until we are ready to can them."`);
...
function enterChoreGatherboth(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: "If you could, try to find <<grandmaQW['chore_mushroom_quantity']>> kilos of mus...
...
function enterSetReportGatherbothAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandmaQW ?? 0)?.['chore_gather_both'] === 2  &&  ((s as any).boletus ?? 0) >= ((s as any).grandmaQW ?? 0)?.['chore_mushroom_quantity']  &&  ((s as any).bilberry ?? 0) >= ((s as any).grandmaQW ?? 0)?.['chore_berry_quantity']  &&  ((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) < 20) {
    ...
    scene.text(`"Oh, thank you, ${((s as any).pcs_nickname || '')}. I was starting to think you had forgotten about me. They will have to go down in the root cellar until we are ready to can them," your Grandma replied.`);
    ...
    scene.text(`"Oh, thank you very much, ${((s as any).pcs_nickname || '')}. They will have to go down in the root cellar until we are ready to can them," your Grandma replied.`);
    scene.text('"Do I need to go out on another run, or do you think that\'s enough?"');
    scene.text('"Well, little one," your Grandma says, "There is a difference between enough and enough for today."');
    scene.text('"Oh…" you say, unsure what to make of her response.');
    scene.text('She smiles gently and pats your head. "You\'ve done enough for today, child."');

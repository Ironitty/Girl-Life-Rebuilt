...
function enter1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"That's interesting, but do you think he is wearing anything under his skirt?" said ${((s as any).telsob || '')}.`);
    ...
    scene.text(`"I'm not going to ask him, you ask him." said ${((s as any).telsob || '')}, making plaintive eyes.`);
    scene.actions([
    ...
    scene.text(`${((s as any).telsob || '')} and you walk up to the guy, she leans against you and whispers in your ear. "Well ask."`);
    ...
    scene.text(`"Do you want to take a look ${((s as any).pcs_nickname || '')}?" asks ${((s as any).telsob || '')}`);
    ...
    scene.text(`"Fine, I'll look." Says ${((s as any).telsob || '')} defiantly pouting and squatting down.`);
    ...
    scene.text(`Emboldened ${((s as any).telsob || '')} immediately kneels, clasps her lips around his cock and begins to suck his dick. You crouch down behind her and start sliding her panties down, so you can lick and tongue fuck her pussy.`);

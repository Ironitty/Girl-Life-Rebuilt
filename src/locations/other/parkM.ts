...
function enterA(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_gentle ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    scene.text(`${((s as any).npcdesc || '')} does not look happy as you pull away from his kiss, "Okay, ${((s as any).pcs_nickname || '')}, lets keep on trekking."`);
    scene.actions([
...
function enterKiss(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} does not look happy as you push his hand away, "Okay, ${((s as any).pcs_nickname || '')}, Let's keep on going."`);
    scene.actions([
      { label: 'Further', goto: ['parkM', 'aa'] },
    ]);
  } },
...
function enterSexrand(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You sidestep and cover your chest, ${((s as any).npcdesc || '')} looks annoyed, "Okay, ${((s as any).pcs_nickname || '')}, Let's go."`);
    scene.actions([
      { label: 'Further', goto: ['parkM', 'aa'] },
    ]);
  } },
...
function enterSexrand1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You backed away from him and began to dress, ${((s as any).npcdesc || '')} does not look happy, "Okay, ${((s as any).pcs_nickname || '')}, Let's go."`);
    scene.actions([
      { label: 'Next', goto: ['parkM', 'aa'] },
    ]);
  } },
...
function enterAa(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_rel ?? 0)?.[String((s as any).npcID ?? 0)] < 55) {
    ...
    scene.img(`images/locations/pavlovsk/park/hugging_park_${((s as any).temp || '')}.jpg`);
    ...
    scene.img(`images/locations/pavlovsk/park/kissing_park_${((s as any).temp || '')}.jpg`);
    ...
    if (((s as any).temploverrand ?? 0) < 3) {
      ...
      (s as any).temp = Math.floor(Math.random() * 3) + 1;
      scene.img(`images/locations/pavlovsk/park/making_out_park_bench_${((s as any).temp || '')}.jpg`);
    }

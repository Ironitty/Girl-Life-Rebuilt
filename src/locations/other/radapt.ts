...
function enterBathroom(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'stat', '');
    (s as any).temp = Math.floor(Math.random() * 7) + 0;
    if (((s as any).temp ?? 0) === 0  &&  ((s as any).pcs_hotcat ?? 0) >= 6  &&  ((((s as any).hour ?? 0) >= 20  &&  ((s as any).hour ?? 0) < 23)  ||  (((s as any).week ?? 0) > 5  &&  ((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 16)  ||  (((s as any).week ?? 0) > 5  &&  ((s as any).hour ?? 0) >= 18  &&  ((s as any).hour ?? 0) < 23))) {
    ...
    scene.text(`"Now look what you've done, " he says as he unzips his pants and pulls out his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock.`);
    ...
    scene.actions([
      ...
      if (((s as any).temp ?? 0) <= 2  &&  ((s as any).pcs_hotcat ?? 0) >= 6) {
        (s as any).inhib_exp = ((s as any).inhib_exp ?? 0) + (1);
        ...
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          scene.actions([
            { label: 'Cover up and tell him to leave [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
          ]);
        } else {
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Refuse and cover up [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
...
function enterFridge(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You open the fridge and see:${((s as any).rad_vodka ?? 0)}${((s as any).rad_beer ?? 0)}${((s as any).rad_sup ?? 0)}${((s as any).r_pusto ?? 0)}`);
  if (((s as any).radbeer_count ?? 0) > 0) {
    scene.actions([
      { label: 'Have a beer', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'drugs', 'alcohol', 'beer');
    (s as any).radfood_day = ((s as any).daystart ?? 0);
    (s as any).radbeer_count = ((s as any).radbeer_count ?? 0) - (1);
    qspCall(s, 'stat', '');
  ...
  if (((s as any).radvodka_count ?? 0) > 0) {
    ...
    (s as any).radfood_day = ((s as any).daystart ?? 0);
    (s as any).radvodka_count = ((s as any).radvodka_count ?? 0) - (1);
    qspCall(s, 'stat', '');
  ...
  if (((s as any).radsup_count ?? 0) > 0) {
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    (s as any).radfood_day = ((s as any).daystart ?? 0);
    (s as any).radsup_count = ((s as any).radsup_count ?? 0) - (1);
    qspCall(s, 'stat', '');
...
function enterFirstvisit(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).pcs_hotcat ?? 0) >= 9) {
      ...
      scene.text(`Radomir's older brother looks like an older, more masculine jock version of him. "${((s as any).pcs_nickname ?? 0)}…" you reply.`);

...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pantyworntype ?? 0) !== 'none'  &&  ((s as any).pcs_inhib ?? 0) < 60  &&  ((s as any).studio_strip ?? 0) <= 1  &&  ((s as any).underwear ?? 0)?.['type'] !== 2) {
    ...
    ((s as any).lastwornpantytype = (s as any).lastwornpantytype ?? {})['foto'] = ((s as any).pantyworntype ?? 0);
    ((s as any).lastwornpantynumber = (s as any).lastwornpantynumber ?? {})['foto'] = ((s as any).pantywornnumber ?? 0);
    ((s as any).lastwornbratype = (s as any).lastwornbratype ?? {})['foto'] = ((s as any).braworntype ?? 0);
    ((s as any).lastwornbranumber = (s as any).lastwornbranumber ?? {})['foto'] = ((s as any).brawornnumber ?? 0);
    (s as any).inhib_exp = ((s as any).inhib_exp ?? 0) + (2);
    if ((!((s as any).studio_strip_talk ?? 0))) {
      qspGoto(s, 'foto_events', 'studio_strip_talk1');
    } else {
      if (((s as any).studio_underwear ?? 0) > 0) {
    ...
    if (((s as any).studio_strip_talk ?? 0) === 1  &&  ((s as any).studio_underwear ?? 0) <= ((s as any).daystart ?? 0)) {
      qspGoto(s, 'foto_events', 'studio_strip_talk2');
    } else {
      if (((s as any).studio_strip_talk ?? 0) === 2  &&  ((s as any).studio_underwear ?? 0) <= ((s as any).daystart ?? 0)) {
        qspGoto(s, 'foto_events', 'studio_strip_talk3');
      } else {
        qspGoto(s, 'foto', 'studio');
      }
    }
  ...
  scene.actions([
    ...
    if (((s as any).pcs_inhib ?? 0) >= 60) {
      ...
      if (((s as any).pcs_inhib ?? 0) < 20) {
        ...
        if (((s as any).pcs_inhib ?? 0) < 30  &&  ((s as any).studio_inhib ?? 0) === 1) {
          ...
          if (((s as any).pcs_inhib ?? 0) < 30) {
            ...
            if (((s as any).pcs_inhib ?? 0) < 40  &&  ((s as any).studio_inhib ?? 0) === 2) {
              ...
              if (((s as any).pcs_inhib ?? 0) < 40) {
                ...
                if (((s as any).pcs_inhib ?? 0) < 60  &&  ((s as any).studio_inhib ?? 0) === 3) {
...
function enterStudio(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).job_status ?? 0)?.['city_aphrodite_model'] !== 'employed') {
    ...
    scene.text('Farther along, you can see what appear to be <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027foto_albums\\u0027, \\u0027model_portraits\\u0027); return false;">photo albums</a> that sit on a shelf.');
  } else {
    scene.text('You step onto the main floor of the studio, standing amongst the various sets and photographers who are working those sets. Sitting by the door is a <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027shortgs\\u0027, \\u0027img msg\\u0027, \\u0027images/locations/city/citycenter/photo/dress_code.jpg\\u0027); return false;">sign</a> to remind models of the dress code.');
    scene.text('Farther along are the studio\'s collection of <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027foto_albums\\u0027, \\u0027model_portraits\\u0027); return false;">photo albums</a> of their top 10 models. ');
  ...
  scene.actions([
    ...
    if (((s as any).temp_rand ?? 0) < 6) {
      (s as any).temp_name = ((s as any).model ?? 0)?.['nickname'];
    } else {
      if (((s as any).temp_rand ?? 0) < 8) {
        (s as any).temp_name = ((s as any).model ?? 0)?.['firstname'];
      } else {
        (s as any).temp_name = ((s as any).model ?? 0)?.['firstname'] + ' ' + ((s as any).model ?? 0)?.['lastname'];
      }
    }
    (s as any).temp_ok_to_shoot = 1;
    if (((s as any).Venera ?? 0) > 2) {
      (s as any).temp_ok_to_shoot = 0;
      // TODO-QSP: dynamic text: <<$temp_name>>! There is no way anyone is going to want to see pictures of you w...
      scene.text(`${((s as any).temp_name || '')}! There is no way anyone is going to want to see pictures of you while your STD is so obvious, you should see a doctor.`);
    }
    if (qspFunc(s, 'body_din', 'pregnancyVisibility') === 1) {
      (s as any).temp_ok_to_shoot = 0;
      // TODO-QSP: dynamic text: "<<$temp_name>>! Who knocked you up!? Didn't we pay you enough to use contracept...
      scene.text(`"${((s as any).temp_name || '')}! Who knocked you up!? Didn't we pay you enough to use contraception? Sorry, but we don't specialize in this type of shots."`);
    }
    ...
    if (((s as any).cumsumbod ?? 0) - ((s as any).cumsumvag ?? 0) - ((s as any).cumsumass ?? 0) > (Math.floor(Math.random() * 6) + 0)) {
      (s as any).temp_ok_to_shoot = 0;
      // TODO-QSP: dynamic text: "Ugh, <<$temp_name>>, what the hell is that?" he looks at you and the cum on you...
      scene.text(`"Ugh, ${((s as any).temp_name || '')}, what the hell is that?" he looks at you and the cum on you with disgust. "We don't care what your sexual habits are outside of work, but we're not shooting Japanese porn here. At least take a shower after getting laid."`);
    }
    ...
    if (((s as any).mesec ?? 0) > 0  &&  (!((s as any).isprok ?? 0))) {
      ...
      scene.text(`"What the hell ${((s as any).temp_name || '')}!"`);
    ...
    if ((!((s as any).pcs_makeup ?? 0))) {
      ...
      scene.text(`"Your makeup is smeared all over your face ${((s as any).temp_name || '')}. Go clean up and see the makeup artists first."`);
    }
    if (((s as any).pcs_makeup ?? 0) === 1) {
      (s as any).temp_ok_to_shoot = 0;
      // TODO-QSP: dynamic text: "<<$temp_name>>, you forget to do your makeup. Hurry up! We don't have all day."
      scene.text(`"${((s as any).temp_name || '')}, you forget to do your makeup. Hurry up! We don't have all day."`);
    }
    if (((s as any).temp_ok_to_shoot ?? 0)) {
      if (((s as any).model ?? 0)?.['spcial_job_day'] !== ((s as any).daystart ?? 0)) {
        ((s as any).model = (s as any).model ?? {})['spcial_job_day'] = ((s as any).daystart ?? 0);
        if (((s as any).special_model ?? 0)?.['roll'] < Math.min(((s as any).fame ?? 0)?.['city_modelling'], 700)  &&  ((s as any).modelfoto ?? 0)?.['topless'] > 0  &&  ((s as any).hour ?? 0) < 15) {
          qspGoto(s, 'foto_events', 'fame');
        }
        if (((s as any).special_skill_model ?? 0)?.['roll'] < ((s as any).pcs_mdlng ?? 0)  &&  ((s as any).modelfoto ?? 0)?.['nip'] > 0) {
          qspGoto(s, 'foto_events', 'skill');
        }
        if (((s as any).foto ?? 0)?.['documentary'] >= 95  &&  ((s as any).pantyworntype ?? 0) === 'none'  &&  ((s as any).modelfoto ?? 0)?.['shoots']>= ((s as any).foto ?? 0)?.['documentary_timer']) {
          qspGoto(s, 'foto_model_documentary', '1st_documentary');
        }
      }
      // TODO-QSP: dynamic text: "Hello <<$temp_name>>. Are you here to work?"
      scene.text(`"Hello ${((s as any).temp_name || '')}. Are you here to work?"`);
    ...
    if (((s as any).model_job_week ?? 0) >= 2) {
      qspGoto(s, 'foto_practice', 'start');
    } else {
      qspGoto(s, 'foto_shoot', 'model');
    }
  } },
    ...
    { label: 'Leave studio', handler: (st: GameState) => {
    if (((s as any).studio_underwear_steal ?? 0) > 0) {
      qspCall(s, 'outfit', 'restore', 'foto');
      qspCall(s, 'stat', '');
...
function enterBathroom(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('A gaggle of models crowd the <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027mirror\\u0027, \\u0027start\\u0027); return false;">mirrors</a> and sinks, loudly chatting, giggling, and generally gossiping about life in the city and the studio.');
...
function enterShowers(s: GameState, scene: SceneBuilder): void {
    ...
    if (((s as any).trait_vars ?? 0)?.['cum_addict'] > 0) {
      ...
      if (((s as any).pcs_horny ?? 0) >= 70) {
        ...
        if (((s as any).trait_vars ?? 0)?.['exhibitionist'] > 0) {
          (s as any).orgasm_txt = 'Soon you feel a warm wave spreading over your entire body and you shudder as an orgasm overtakes you. You quickly look around hoping no one noticed your public masturbation session.';
        } else {
          (s as any).orgasm_txt = 'You loudly groan as you shudder in orgasm, uncaring if anyone notices what you\'re up to. In fact, it kind of turns you on and makes you want to keep going…';
        }
        qspCall(s, 'arousal', 'clit_vibe', 5, 'masturbate', 'exhibitionism');
      } else {
        ...
        (s as any).orgasm_or = 'no';
        qspCall(s, 'arousal', 'masturbate', 5, 'exhibitionism');
  ...
  scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027din_van\\u0027, \\u0027shave_options\\u0027); return false;">Shave Options</a>');
  if (((s as any).mesec ?? 0) > 0  &&  (!((s as any).isprok ?? 0))) {
    scene.actions([
      { label: 'Use a tampon', handler: (st: GameState) => {
    (s as any).modeltampon = Math.floor(Math.random() * 2) + 0;
    (s as any).isprok = 1;
    (s as any).minut = ((s as any).minut ?? 0) + 2;
    if (((s as any).modeltampon ?? 0) === 1) {
...
function enterManagerTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).modelfoto = (s as any).modelfoto ?? {})['change_name'] = ((s as any).modelfoto['change_name'] ?? 0) + (1);
...
function enterHiringAsk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 1;
        ...
        if (((s as any).pcs_bmi ?? 0) >= ((s as any).foto_weight ?? 0)  &&  ((s as any).foto_weight ?? 0) > 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 1;
          ...
          if (((s as any).pcs_bmi ?? 0) < ((s as any).foto_weight ?? 0)  &&  ((s as any).foto_weight ?? 0) > 0) {
            qspGoto(s, 'foto', 'interview2');
          } else {
            if (((s as any).fotofakepassport ?? 0) === 1  &&  ((s as any).age ?? 0) < 18) {
    ...
    // TODO-QSP: dynamic text: "Okay, here's the truth. I'm not the age I said I was. I'm <<$func('string', 'pa...
    scene.text(`"Okay, here's the truth. I'm not the age I said I was. I'm ${qspFunc(s, 'string', 'parse_number', ((s as any).age || ''))}. But I still want to work here. Isn't there some way we can work this out?"`);
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 1;
              ...
              if (((s as any).fotofakepassport ?? 0) >= 2  &&  ((s as any).age ?? 0) < 18) {
                ...
                if (((s as any).fakepassport ?? 0) !== 1) {
                  ...
                  if (((s as any).fakepassport ?? 0) === 1  &&  ((s as any).fotofakepassport ?? 0) === 2) {
                    ...
                    if (((s as any).fakepassport ?? 0) === 1  &&  ((s as any).fotofakepassport ?? 0) === 3) {
                      scene.text('"Yup," you smile back, handing him your new fake passport.');
                      ...
                      if (((s as any).fakepassport ?? 0) === 1  &&  ((s as any).fotofakepassport ?? 0) === 4) {
...
function enterInterview2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_inhib ?? 0) >= 40) {
    ...
    scene.img('images/locations/city/citycenter/photo/strip1.mp4');
    if (((s as any).pcs_bmi ?? 0) < ((s as any).foto_weight ?? 0)  &&  ((s as any).foto_weight ?? 0) > 0) {
      (s as any).foto_weight = ((s as any).pcs_bmi ?? 0);
      ...
      if (((s as any).foto_cupsize ?? 0) > ((s as any).tits ?? 0)) {
      ...
      scene.actions([
        { label: 'Continue', handler: (st: GameState) => {
    if (((s as any).pcs_bmi ?? 0) < 25  ||  ((s as any).pcs_hotcat ?? 0) >= 6) {
      qspGoto(s, 'foto', 'job_offer');
    } else {
      qspGoto(s, 'foto', 'job_decline');
    }
  } },
      ]);
    } else {
      if (((s as any).undress_ask ?? 0) === 0  &&  (!((s as any).why_here ?? 0))) {
      ...
      scene.text(`He circles you slowly, occasionally asking you to adjust your pose slightly, carefully inspecting every aspect of your nude body. Your ${((s as any).pcs_eyecolor || '')} eyes framed by your ${((s as any).pcs_haircolor || '')} hair, your ${((s as any).pc_desc ?? 0)?.['lip size'] ?? ''} lips, your ${((s as any).titsize || '')} breasts, your ${((s as any).pc_desc ?? 0)?.['skin'] ?? ''} ${((s as any).pcs_tanstate || '')} skin, your thighs, even your ${((s as any).pc_desc ?? 0)?.['pubes'] ?? ''} pussy…`);
    ...
    // TODO-QSP: dynamic text: He circles you slowly, occasionally asking you to adjust your pose slightly, car...
    scene.text(`He circles you slowly, occasionally asking you to adjust your pose slightly, carefully inspecting every aspect of your nude body. Your ${((s as any).pcs_eyecolor || '')} eyes framed by your ${((s as any).pcs_haircolor || '')} hair, your ${((s as any).pc_desc ?? 0)?.['lips'] ?? ''} lips, your ${((s as any).titsize || '')} breasts, your ${((s as any).pc_desc ?? 0)?.['skin'] ?? ''} ${((s as any).pcs_tanstate || '')} skin, your thighs, even your ${((s as any).pc_desc ?? 0)?.['pubes'] ?? ''} pussy…`);
    scene.text('He spends several minutes doing this without saying anything. Several people walk by while he does, including several beautiful and nude women who glance at you, whispering to each other before moving on.');
...
function enterJobDecline(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).foto_weight ?? 0) >= 25) {
    ...
    (s as any).foto_weight = ((s as any).pcs_bmi ?? 0);
    (s as any).foto_cupsize = ((s as any).tits ?? 0);
    qspCall(s, 'outfit', 'restore', 'foto');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Leave', handler: (st: GameState) => {
...
function enterJobOffer(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).foto_weight ?? 0) < 25  &&  ((s as any).foto_weight ?? 0) > 0) {
    ...
    if (((s as any).age ?? 0) >= 18  ||  ((s as any).fakepassport ?? 0) === 1  ||  ((s as any).age_lie ?? 0) === 1) {
      ...
      scene.text('When he\'s finished, he stands in front of you and says,\' + iif(pcs_mdlng >= 20, \'"You\'re a natural. You already move like you\'ve been trained. \', \'"You fit the criteria for the kind of images we want to produce. \') + \'I just need to see your passport to confirm your age and put your info into our database," holding out his hand.');
    } else {
      if (((s as any).age_truth ?? 0) === 1) {
        // TODO-QSP: dynamic text: After several minutes, he stands in front of you and says,' + iif(pcs_mdlng >= 2...
        scene.text('After several minutes, he stands in front of you and says,\' + iif(pcs_mdlng >= 20, \'"You\'re a natural. You already move like you\'ve been trained. \', \'"You fit the criteria for the kind of images we want to produce. \') + \'However, you need to be 18 to work here. If you come back then, we\'ll be happy to have you." He smiles at you and starts heading back to his computer.');
      }
    }
  }
  if (((s as any).age ?? 0) >= 18) {
    ...
    (s as any).pcs_horny = ((s as any).pcs_horny ?? 0) + (90);
    scene.img('images/locations/city/citycenter/photo/fotograph.jpg');
    (s as any).fakepassport = 2;
    (s as any).fotofakepassport = 3;
    // TODO-QSP: dynamic text: "Oh please!" you shout abruptly. "The truth is, I'm only <<age>>. But it just ma...
    scene.text(`"Oh please!" you shout abruptly. "The truth is, I'm only ${((s as any).age || '')}. But it just makes me so fucking horny to know that strange men I'll never meet could be out there looking at pictures of my naked body!"`);
    ...
    scene.text('…');
    // TODO-QSP: dynamic text: "Great, I can work here. Now all I have to do is find a passport that says I'm 1...
    scene.text(`"Great, I can work here. Now all I have to do is find a passport that says I'm 18 instead of ${((s as any).age || '')}…" you mutter dejectedly as you get dressed.`);
    qspCall(s, 'outfit', 'restore', 'foto');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Leave', handler: (st: GameState) => {
    ...
    scene.text(`You take a deep breath and step closer to him to say, "Okay, the truth is that I'm not really 18. I'm ${((s as any).age || '')} okay? But I really need the money! Can't we work something out?"`);
    if (((s as any).pcs_inhib ?? 0) < 40) {
    ...
    if (((s as any).fotofit ?? 0) === 1) {
      ...
      if (((s as any).reluctant_undress ?? 0) === 1) {
        ...
        if ((!((s as any).reluctant_undress ?? 0))) {
    ...
    if (((s as any).fotofit ?? 0) !== 1) {
      ...
      // TODO-QSP: dynamic text: "I'm not going to work for some pervert who forces <<age>> year old girls to get...
      scene.text(`"I'm not going to work for some pervert who forces ${((s as any).age || '')} year old girls to get naked and jerk off to them."`);
    } else {
...
function enterModelName2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).model = (s as any).model ?? {})['firstname'] = ((s as any).pcs_firstname ?? 0);
    ((s as any).model = (s as any).model ?? {})['nickname'] = ((s as any).pcs_nickname ?? 0);
    ((s as any).model = (s as any).model ?? {})['lastname'] = ((s as any).pcs_lastname ?? 0);
...
function enterModelName3(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: <i><<$model['firstname']>> "<<$model['nickname']>>" <<$model['lastname']>></i>
...
function enterModelProfile(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    { label: 'Continue', handler: (st: GameState) => {
    ((s as any).model = (s as any).model ?? {})['likes1'] = 0;
    ((s as any).model = (s as any).model ?? {})['likes2'] = 0;
    ((s as any).model = (s as any).model ?? {})['likes3'] = 0;
    ((s as any).model = (s as any).model ?? {})['dislikes1'] = 0;
    ((s as any).model = (s as any).model ?? {})['dislikes2'] = 0;
    ((s as any).model = (s as any).model ?? {})['dislikes3'] = 0;
    scene.actions([
    ...
    if (((s as any).anastasia ?? 0)?.['busy_cooldown_day'] !== ((s as any).daystart ?? 0)  ||  ((s as any).anastasia ?? 0)?.['busy_cooldown'] <= ((s as any).hour ?? 0)) {
      if (((s as any).anastasia ?? 0)?.['status'] > 0) {
        if (((s as any).anastasia_in ?? 0) === 1) {
          scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027model_anastasia\\u0027, \\u0027anastasia1\\u0027); return false;">Anastasia</a>');
        }
      } else {
        if (((s as any).anastasia_in ?? 0) === 1) {
          scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027model_anastasia\\u0027, \\u0027anastasia1\\u0027); return false;">unknown model</a>');
        }
      }
    }
    if (((s as any).emily ?? 0)?.['busy_cooldown_day'] !== ((s as any).daystart ?? 0)  ||  ((s as any).emily ?? 0)?.['busy_cooldown'] <= ((s as any).hour ?? 0)) {
      if (((s as any).emily ?? 0)?.['status'] >= 2) {
        if (((s as any).emily_in ?? 0) === 1) {
          scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027model_emily1\\u0027, \\u0027emily_1\\u0027); return false;">Emily</a>');
        }
      } else {
        if (((s as any).emily_in ?? 0) === 1) {
          scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027model_emily1\\u0027, \\u0027emily_1\\u0027); return false;">unknown model</a>');
        }
      }
    }
    if (((s as any).jeff ?? 0)?.['busy_cooldown_day'] !== ((s as any).daystart ?? 0)  ||  ((s as any).jeff ?? 0)?.['busy_cooldown'] <= ((s as any).hour ?? 0)) {
      if (((s as any).jeff ?? 0)?.['status'] > 0) {
        if (((s as any).jeff_in ?? 0) === 1) {
          scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027model_jeff1\\u0027, \\u0027jeff_1\\u0027); return false;">Jeff</a>');
        }
      } else {
        if (((s as any).jeff_in ?? 0) === 1) {
          scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027model_jeff1\\u0027, \\u0027jeff_1\\u0027); return false;">unknown model</a>');
        }
      }
    }
    ...
    if (((s as any).krystal ?? 0)?.['busy_cooldown_day'] !== ((s as any).daystart ?? 0)  ||  ((s as any).krystal ?? 0)?.['busy_cooldown'] <= ((s as any).hour ?? 0)) {
      if (((s as any).krystal ?? 0)?.['status'] > 0) {
        if (((s as any).krystal_in ?? 0) === 1) {
          scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027model_krystal\\u0027, \\u0027krystal1\\u0027); return false;">Krystal</a>');
        }
      } else {
        if (((s as any).krystal_in ?? 0) === 1) {
          scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027model_krystal\\u0027, \\u0027krystal1\\u0027); return false;">unknown model</a>');
        }
      }
    }
    if ((((s as any).mari ?? 0)?.['busy_cooldown_day'] !== ((s as any).daystart ?? 0)  ||  ((s as any).mari ?? 0)?.['busy_cooldown'] <= ((s as any).hour ?? 0))  &&  ((s as any).mari ?? 0)?.['weekend_gone'] < ((s as any).daystart ?? 0)) {
      if (((s as any).mari ?? 0)?.['status'] > 0) {
        if (((s as any).mari_in ?? 0) === 1) {
          scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027model_mari\\u0027, \\u0027mari_1\\u0027); return false;">Mari</a>');
        }
      } else {
        if (((s as any).mari_in ?? 0) === 1) {
          scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027model_mari\\u0027, \\u0027mari_1\\u0027); return false;">unknown model</a>');
        }
      }
    }
    if (((s as any).locat ?? 0)?.['A144'] === 11) {
      scene.text('<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027foto_models2\\u0027, \\u0027anushka_1\\u0027); return false;">Anushka</a>');
    }
  } else {
...
function enterMicrocameraAsk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).artemIzdev ?? 0) === 2  ||  ((s as any).artemIzdev ?? 0) === 3) {
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    qspCall(s, 'money', 'pay', 70000);
    (s as any).artemIzdev = 4;
    (s as any).microcamera = 1;
    qspCall(s, 'stat', '');
...
function enterBlackm(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).parkblackmail ?? 0) === 2) {
    ...
    // TODO-QSP: dynamic text: "Nothing special <<$model['nickname']>>. Just do what you appear to enjoy." he n...
    scene.text(`"Nothing special ${((s as any).model ?? 0)?.['nickname'] ?? ''}. Just do what you appear to enjoy." he nods at the pictures.`);
    scene.actions([
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'Brunette', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0), 'a');
    qspCall(s, 'npcgeneratec', '', 0, 'blond', Math.floor(Math.random() * 27) + 19);
    ...
    qspCall(s, 'boyStat', '', ((s as any).boy1 ?? 0));
    qspCall(s, 'arousal', 'vaginal', 15, 'rough');
    qspCall(s, 'boyStat', '', ((s as any).boy2 ?? 0));
    qspCall(s, 'arousal', 'bj', 15, 'rough');
    ...
    scene.text(`"Not bad, tears always look cool." says Victor having finally finished filming you and with the camcorder by his side. "You should clean yourself up ${((s as any).model ?? 0)?.['nickname'] ?? ''}, the boys really enjoyed themselves."`);
    scene.actions([
    ...
    qspCall(s, 'boyStat', '', ((s as any).boy1 ?? 0));
    qspCall(s, 'arousal', 'anal', 15, 'rough');
    if (((s as any).deodorant_on ?? 0) === 1) {
      qspCall(s, 'sweat', 'remove_deo');
      scene.text('<br>Your deodorant gets washed away in the shower.');
    }
    ...
    qspCall(s, 'arousal', 'vaginal', 15, 'rough');
    qspCall(s, 'arousal', 'end');
    (s as any).parkblackmail = 4;
    (s as any).studiaday = 7;

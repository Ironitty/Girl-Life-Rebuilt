...
function enterHomesex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'cuni', 2, 'lesbian');
    qspCall(st, 'stat', '');
    if (((st as any).mc_inventory ?? 0)?.['strapon'] === 1  &&  ((st as any).soniaQW ?? 0)?.['sex'] === 1) {
      scene.actions([
    ...
    if (((st as any).spellKnown ?? 0)?.['penisenvy'] === 1  &&  ((st as any).mc_inventory ?? 0)?.['strapon'] === 1  &&  ((st as any).strapNumber ?? 0) > 0) {
      scene.actions([
    ...
    qspCall(st, 'arousal', 'vaginal_finger', 2, 'lesbian', 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'cuni', 2, 'lesbian', 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Go down on her', goto: ['soniaev1', 'eatsonia'] },
    ]);
...
function enterEatsonia(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (st as any).orgasm_txt = 'You soon feel your body start to spasm as well as your own orgasm rocks your body. It feels like an eternity before it fades.';
    qspCall(st, 'arousal', 'cuni', (-2), 'lesbian');
    qspCall(st, 'arousal', 'cuni_give', 2, 'lesbian');
    ...
    qspCall(st, 'stat', '');
    ((st as any).soniaQW = (st as any).soniaQW ?? {})['sex'] = 1;
...
function enterStraponFucked(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'vaginal_strap', 3, ((st as any).npcID1 ?? 0), 'lesbian');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterStraponPussy(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'vaginal_strap_give', 2, ((st as any).npcID1 ?? 0), 'lesbian');
    qspCall(st, 'stat', '');
    qspCall(st, 'willpower', 'anal', 'force');
    if (((st as any).pcs_willpwr ?? 0) < ((st as any).will_cost ?? 0)) {
      scene.actions([
...
function enterStraponAnal(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'anal_strap_give', 2, ((st as any).npcID1 ?? 0), 'lesbian', 'dom', 'rough');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Make her eat you out', goto: ['soniaev1', 'strapon_eaten'] },
    ]);
...
function enterStraponEaten(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (st as any).orgasm_or = undefined;
    (st as any).orgasm_txt = 'As she starts to orgasm, it\'s too much for you. You feel your own body shake and rock as an orgasm courses through it.';
    qspCall(st, 'arousal', 'cuni', (-2), 'lesbian');
    qspCall(st, 'arousal', 'cuni_give', 2, 'lesbian');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterShowerSex(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'npcStat', 'A25');
  (s as any).showerSexTemp = undefined;
...
function enterShowerSexCuni(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'npcStat', 'A25');
  ((s as any).showerSexTemp = (s as any).showerSexTemp ?? {})['cuni'] = 1;
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'cuni', 2, 'lesbian');
    qspCall(st, 'stat', '');
    if (((st as any).showerSexTemp ?? 0)?.['cuni_give'] === 0) {
      scene.actions([
...
function enterShowerSexCuniGive(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'npcStat', 'A25');
  ((s as any).showerSexTemp = (s as any).showerSexTemp ?? {})['cuni_give'] = 1;
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'cuni_give', 2, 'lesbian');
    qspCall(st, 'stat', '');
    if (((st as any).showerSexTemp ?? 0)?.['cuni'] === 0) {
      scene.actions([
...
function enterStraponMagicBedroom(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'magic_bj', 2, 'lesbian');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'magic_bj', 3, 'lesbian');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterStraponMagicBedroomPussy(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'magic_vaginal', 2, ((st as any).npcID1 ?? 0), 'lesbian');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterStraponMagicBedroomAnal(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'magic_anal', 2, ((st as any).npcID1 ?? 0), 'lesbian', 'dom', 'rough');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Cum on her stomach', goto: ['soniaev1', 'strapon_magic_bedroom_tummy'] },
      { label: 'Cum on her face', goto: ['soniaev1', 'strapon_magic_bedroom_face1'] },
...
function enterStraponMagicBedroomMouth(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'kiss', 1);
    qspCall(st, 'cum_call', 'mouth_swallow', 'A#', 1);
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Get cleaned up', goto: ['soniaev1', 'strapon_magic_bedroom_afterglow'] },
    ]);
...
function enterStraponMagicBedroomAfterglow(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'npcStat', 'A25');
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  ((s as any).soniaQW = (s as any).soniaQW ?? {})['sex'] = 1;
  qspCall(s, 'stat', '');
  scene.img('images/characters/pavlovsk/school/girl/sonia/sex/home/bedroom/strapon/selfie.jpg');

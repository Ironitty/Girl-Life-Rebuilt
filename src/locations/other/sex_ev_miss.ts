...
function enterMissSwitch(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['last_position'] === 'doggy') {
    // TODO-QSP: dynamic text: You lean forward, letting <<$npcdesc>>''s cock slip from your pussy. You flip ov...
...
function enterMissInsertReact(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).npc_dick_class ?? 0)[Number((st as any).locArgs?.[1] ?? 0)] === 'big'  ||  ((st as any).npc_dick_class ?? 0)[Number((st as any).locArgs?.[1] ?? 0)] === 'extra_big') {
      scene.actions([
...
function enterMissionaryChangePosition(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: "I''m not really feeling missionary right now," you say, looking up at <<$npcdes...
...
function enterMissPain1(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 20) + 1) >= ((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)]) {
    ...
    // TODO-QSP: dynamic text: Every time <<$npcdesc>> moves it''s like a knife in your pussy, stabbing your in...
  ...
  if (((s as any).dick_desc ?? 0) === 'long'  ||  ((s as any).dick_desc ?? 0) === 'huge'  ||  ((s as any).dick_desc ?? 0) === 'enormous'  ||  ((s as any).dick_desc ?? 0) === 'lengthy'  ||  ((s as any).dick_desc ?? 0) === 'gigantic'  ||  ((s as any).dick_desc ?? 0) === 'monstrous') {
    ...
    // TODO-QSP: dynamic text: Every thrust of <<$npcdesc>>''s hips elicits a gasp of pain from your lips. His ...
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMissPain2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterMiss1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 75) {
    ...
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
      // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips as <<$npcdesc>>''s hips meet yours in t...
  ...
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 50) {
    ...
    if (((st as any).npc_dick_class ?? 0)?.[String((st as any).npcID ?? 0)] === 'short') {
      ...
      if (((st as any).npc_dick_class ?? 0)?.[String((st as any).npcID ?? 0)] === 'average') {
        // TODO-QSP: dynamic text: He''s good, but not good enough for you. You can''t exactly put your finger on i...
        ...
        if (((st as any).npc_dick_class ?? 0)?.[String((st as any).npcID ?? 0)] === 'big') {
          // TODO-QSP: dynamic text: He''s good, but not good enough for you. Something about his timing is just <i>o...
          scene.text('He\'s good, but not good enough for you. Something about his timing is just <i>off</i>. His movements just aren\'t syncing up with yours\' + iif(npc_fuck_times[$npcID] > 0, \' today \', \' \') + \'and you find yourself stifling yelps of discomfort as his ' + ((st as any).dick_desc || '') + ' cock keeps hitting awkward and painful spots inside your pussy. Every time you think it\'s getting good, he hits another awkward spot and deflates your pleasure like a balloon. Maybe this would get another girl off, but certainly not you...');
        } else {
          if (((st as any).npc_dick_class ?? 0)?.[String((st as any).npcID ?? 0)] === 'extra_big') {
            ...
            scene.text('He\'s good, but not good enough for you. Half the problem is his cock is just <i>too damn big!</i> His movements just aren\'t syncing up with yours\' + iif(npc_fuck_times[$npcID] > 0, \' today \', \' \') + \'and you find yourself stifling yelps of discomfort as his ' + ((st as any).dick_desc || '') + ' cock keeps hitting awkward and painful spots inside your pussy. Maybe this would get another girl off, but certainly not you...');
          }
        }
      }
    }
    ...
    if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 25) {
      // TODO-QSP: dynamic text: An grunt of surprise escapes your lips as <<$npcdesc>>''s hips meet yours in a c...
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          ...
          { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMiss1BoyTalk1(s, scene); (s as any).locArgs = __savedLocArgs; }
          { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMiss1BoyTalk2(s, scene); (s as any).locArgs = __savedLocArgs; }
          // TODO-QSP: dynamic text: You widen your legs and try to roll your hips in time with <<$npcdesc>>''s, tryi...
...
function enterMiss2_bored(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: You moan along with <<$npcdesc>>''s thrusts, putting on your best oh-face and ho...
...
function enterMiss3(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['rough_enjoy'] !== 1) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMiss3EnjoyDesc(s, scene); (st as any).locArgs = __savedLocArgs; }
    qspCall(st, 'sex_ev_cum', 'fuck_cum');
    qspCall(st, 'sex_ev_sex', 'fuck_continue');
  } },
      ]);
...
function enterMiss3_1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (((s as any).npc_knows_pc_likes_rough ?? 0)?.[String((s as any).npcID ?? 0)] === 0  ||  ((s as any).sex_ev ?? 0)?.['rough_enjoy'] !== 1)) {
    ...
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['rough_enjoy'] = 1;
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMiss3_1Desc(s, scene); (st as any).locArgs = __savedLocArgs; }
    qspCall(st, 'sex_ev_cum', 'fuck_cum');
    qspCall(st, 'sex_ev_sex', 'fuck_continue');
  } },
  ...
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ((s as any).sex_ev = (s as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
        (s as any).orgasm_or = '';
        // TODO-QSP: dynamic text: Your breath hitches as <<$npcdesc>> continues to pound your pussy. You aren''t s...
...
function enterMiss3_bored(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'sex_ev_sex', 'fuck_rough_no_cum_code');
  scene.img('images/shared/sex/vag/miss/med3.mp4');
  // TODO-QSP: dynamic text: You half fake moan, half groan in pain in time with <<$npcdesc>>''s thrusts. You...
  ...
  scene.actions([
    ...
    if (((st as any).sex_ev ?? 0)?.['cuni_count'] > 0) {
      ...
      if (((st as any).npc_smoker ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
        ...
        // TODO-QSP: dynamic text: You let his <<$npcdesc>>''s touch yours and feel his tongue snake into your mout...
        ...
        if (((st as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
          ...
          if (((st as any).sex_ev ?? 0)?.['moan'] === 1) {
            ...
            if (((st as any).sex_ev ?? 0)?.['moan'] === 2) {
              // TODO-QSP: dynamic text: You moan softly into <<$npcdesc>>''s mouth as he kisses you while continuing to ...
                  ...
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    ...
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      if (((s as any).pcs_vag ?? 0) <= 15) {
                        ...
                        if (((s as any).pcs_vag ?? 0) <= 25) {
                          // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly with his gigantic cock. You''re obviously no virgi...
...
function enterMiss2EnjoyDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he''s fucking you, ...
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            ...
            if (((s as any).dick_desc ?? 0) === 'long') {
              ...
              if (((s as any).dick_desc ?? 0) === 'huge') {
                ...
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he''s fucking you a...
...
function enterMiss2_2MoanDesc(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      ...
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You moan <<$sex_ev[''moan_describe'']>> as <<$npcdesc>> keeps fucking you, pound...
            ...
            if (((s as any).dick_desc ?? 0) === 'long') {
              ...
              if (((s as any).dick_desc ?? 0) === 'huge') {
                ...
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  ...
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You groan <<$sex_ev[''moan_describe'']>> as <<$npcdesc>> keeps fucking you, poun...

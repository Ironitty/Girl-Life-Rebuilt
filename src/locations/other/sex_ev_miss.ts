    ...
    // TODO-QSP: xgt 'sex_ev_miss', 'miss_spread'
            ...
            if (((s as any).sex_ev ?? 0)?.['cock_inserted'] === 0) {
              ...
              if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] !== ''  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] > 0) {
                ...
                if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'miss' + qspUntranslated(s, "sex_ev['speed']>", { location: "sex_ev_miss" }) + '';
...
function enterMissSwitch(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['initiative'] === 'boy') {
    scene.actions([{ label: 'Continue', goto: ['sex_ev_miss', 'miss_switch2'] }]);
  }
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cock_inserted'] = 1;
  scene.img('images/shared/sex/foreplay/miss2.jpg');
  if (((s as any).sex_ev ?? 0)?.['last_position'] === 'doggy') {
    ...
    scene.text(`You lean forward, letting ${((s as any).npcdesc ?? 0)}'s cock slip from your pussy. You flip over onto your back, spreading your legs, giving him a sultry look.`);
  } else {
    if (((s as any).sex_ev ?? 0)?.['last_position'] === 'cowgirl') {
      ...
      scene.text(`You lean forward, letting ${((s as any).npcdesc ?? 0)}'s cock slip from your pussy beneath you. With a sultry smile, you slowly lean back, lowering yourself down to the bed.`);
    }
  }
...
function enterMissSwitch2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['cock_inserted'] === 1) {
    if (((s as any).sex_ev ?? 0)?.['last_position'] === 'doggy') {
      ...
      scene.text(`${((s as any).npcdesc ?? 0)} pulls his cock from your pussy and flips you onto your back. Grabbing your thighs, he pulls you closer and spreads your legs, laying his cock across your snatch.`);
    } else {
      if (((s as any).sex_ev ?? 0)?.['last_position'] === 'cowgirl') {
        ...
        scene.text(`${((s as any).npcdesc ?? 0)} wraps his arms around you and rolls the both of you so that suddenly you're on your back and he's between your legs.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['last_position'] === 'anal') {
          ...
          scene.text(`${((s as any).npcdesc ?? 0)} pulls his cock from your ass and flips you onto your back. Grabbing your thighs, he pulls you closer and spreads your legs, laying his cock across your snatch.`);
        }
      }
    }
  } else {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} pushes you down onto your back and grabs your thighs, pulling you close with legs spread, and lays his cock across your snatch.`);
  }
...
function enterMissInsertSlow(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['cock_inserted'] === 1) {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} carefully pushes the head of his ${((s as any).dick_desc ?? 0)} cock into the folds of your pussy, followed by the rest of his length.`);
    ...
    scene.actions([{ label: 'Continue', goto: ['sex_ev_miss', 'miss_insert_react'] }]);
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterMissInsertReact(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'sex_ev_miss', 'miss_pain1');
  qspCall(s, 'sex_ev_miss', 'miss_insert_orgasm');
  // TODO-QSP: end
  scene.actions([
    ...
    if (((s as any).npc_last_sex ?? 0)?.[String((s as any).npcID ?? 0)] > ((s as any).daystart ?? 0) - 7) {
      if (((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'big'  ||  ((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'extra_big') {
        ...
        scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile, squeezing yourself around his shaft. "<i>There's</i> my favorite big boy..."`);
      } else {
        // TODO-QSP: dynamic text: "Ah~!" you moan, legs kipping as he finishes inserting his <<$dick_desc>> cock i...
        scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile, squeezing yourself around his shaft. "<i>There's</i> my favorite boy's toy..."`);
      }
    } else {
      if (((s as any).npc_last_sex ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        if (((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'big'  ||  ((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'extra_big') {
          // TODO-QSP: dynamic text: "Ah~!" you moan, legs kipping as he finishes inserting his <<$dick_desc>> cock i...
          scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile. "I've missed having this big boy inside me..."`);
        } else {
          // TODO-QSP: dynamic text: "Ah~!" you moan, legs kipping as he finishes inserting his <<$dick_desc>> cock i...
          scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile. "I've missed having your cock inside me..."`);
        }
      } else {
        if (((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'big'  ||  ((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'extra_big') {
          if (((s as any).stat ?? 0)?.['biggest_cock'] < ((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]) {
            // TODO-QSP: dynamic text: "Ah~!" you moan, legs kipping as he finishes inserting his <<$dick_desc>> cock i...
            scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile. "I've never had a cock this big inside me before..."`);
          } else {
            // TODO-QSP: dynamic text: "Ah~!" you moan, legs kipping as he finishes inserting his <<$dick_desc>> cock i...
            scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile. "I love big cocks..."`);
          }
        } else {
          // TODO-QSP: dynamic text: "Ah~!" you moan, legs kipping as he finishes inserting his <<$dick_desc>> cock i...
          scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile. "You're a perfect fit for my pussy..."`);
        }
      }
    }
  }, goto: ['sex_ev_miss', 'miss_goto2'] },
    ...
    scene.text(`Your legs kip up in discomfort as ${((s as any).npcdesc ?? 0)} rests his weight on top of you, immediately hitting an awkward angle that causes you to gasp as pain lances through your pussy.`);
  }, goto: ['sex_ev_miss', 'miss_goto2'] },
    ]);
  } },
  ]);
...
function enterMissionaryChangePosition(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"I'm not really feeling missionary right now," you say, looking up at ${((s as any).npcdesc ?? 0)}. "Could we try another position for now?"`);
...
function enterMissPain1(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 20) + 1) >= ((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)]) {
    ...
    scene.text(`Every time ${((s as any).npcdesc ?? 0)} moves it's like a knife in your pussy, stabbing your insides like the villain in a slasher flick.`);
  }, goto: ['sex_ev_miss', 'miss_pain2'] },
    ]);
  }
  if (((s as any).dick_desc ?? 0) === 'long'  ||  ((s as any).dick_desc ?? 0) === 'huge'  ||  ((s as any).dick_desc ?? 0) === 'enormous'  ||  ((s as any).dick_desc ?? 0) === 'lengthy'  ||  ((s as any).dick_desc ?? 0) === 'gigantic'  ||  ((s as any).dick_desc ?? 0) === 'monstrous') {
    scene.actions([
    ...
    scene.text(`Every thrust of ${((s as any).npcdesc ?? 0)}'s hips elicits a gasp of pain from your lips. His cock is too much for your poor pussy and it's hard to enjoy.`);
    qspCall(s, 'sex_ev_miss', 'miss_pain2');
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterMissPain2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`As much as you want the pain to stop, the idea of speaking up and ruining the mood makes you cringe. Instead, you grit your teeth and grunt in time with ${((s as any).npcdesc ?? 0)}'s thrusts and hope that the pain is not too audible in your voice.`);
    ...
    if (((((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).npc_fav_pos ?? 0)?.[String((s as any).npcID ?? 0)] === 'miss')  ||  ((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] === 1)  &&  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] !== 1) {
      ...
      scene.text(`"No way," ${((s as any).npcdesc ?? 0)} grunts back. "I'm enjoying this."`);
      ...
      scene.text(`${((s as any).npcdesc ?? 0)} pauses, his cock halfway inside you.`);
...
function enterMissPain3(s: GameState, scene: SceneBuilder): void {
  if ((((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] > 0  ||  (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 3) + 1) >= 2))  &&  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] !== 1) {
    ...
    scene.text(`"OH WOAH!" you yelp, trying to push ${((s as any).npcdesc ?? 0)} out of your pussy. He fails to take the hint and painfully jabs you with his cock again, causing more yelps. "Ow!Ow!Ow!Wait!"`);
    ...
    if (((s as any).sex_ev ?? 0)?.['dick_too_big'] === 1) {
      ...
      scene.text(`You spend a couple minutes with ${((s as any).npcdesc ?? 0)}'s entire length inside you, taking deep breaths as you slowly let it stretch your pussy. Eventually the pain fades to nothing more than a dull ache and even maybe feels a little good.`);
...
function enterMiss1(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['position'] = 'miss';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'miss1';
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] !== '') {
    scene.actions([{ label: 'Continue', goto: ['sex_ev_miss', 'miss1.2'] }]);
  }
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['missionary_fuck'] = 1;
  ...
  qspCall(s, 'sex_ev_miss', 'miss_vid');
  if (((s as any).mesec ?? 0) > 0) {
    qspCall(s, 'sex_ev_miss', 'miss1_start_period_desc');
  } else {
    qspCall(s, 'sex_ev_miss', 'miss1_start_desc');
  }
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 75) {
    ...
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
      ...
      scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips meet yours in the next thrust. You can feel how his movements react to yours, paying attention to your body's nonverbal signals, and making each thrust feeling better than the last. His dick may be small but <i>damn</i>, does he know how to use it.`);
    } else {
      if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'average') {
        // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips as <<$npcdesc>>'s hips meet yours in th...
        scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips meet yours in the next thrust. You can feel how his movements react to yours, paying attention to your body's nonverbal signals, and making each thrust feeling better than the last. <i>Damn</i>, does he know how to use his dick!`);
      } else {
        if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'big') {
          // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips as <<$npcdesc>>'s hips meet yours in th...
          scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips meet yours in the next thrust. He doesn't just have a big cock, he knows how to use it too. You can feel how his movements react to yours, paying attention to your body's nonverbal signals, and making each thrust feeling better than the last. If it hits an awkward spot, you feel him adjust. If it hits you just right, he makes sure to thrust it again just like that when your pussy can't help but squeeze him.`);
          scene.text('Oh <i>fuck</i>. He\'s good at this.');
        } else {
          if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'extra_big') {
            // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips as <<$npcdesc>>'s hips meet yours in th...
            scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips meet yours in the next thrust. He doesn't just have a gigantic cock, he knows how to use it too. You would think that being fucked with such a giant dick would hurt, and it occasionally does, but not as often as you expected. You can feel how his movements react to yours, paying attention to your body's nonverbal signals, and making each thrust feeling better than the last. If it hits an awkward spot, you feel him adjust his angle on top of you. If it hits you just right, he makes sure to thrust it again just like that when your pussy can't help but squeeze him, minimizing pain and maximizing pleasure.`);
            scene.text('Oh <i>fuck</i>. He\'s good at this.');
          }
        }
      }
  ...
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 50) {
    ...
    if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 25) {
      ...
      scene.text(`An grunt of surprise escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips meet yours in a clumsy thrust. That last one was a little bit awkward. <i>Oof.</i> And that one too. Oh, that one wasn't too bad- And we're back to awkward again.`);
    ...
    scene.text(`"<i>Hnn~!</i> Not like that, ${((s as any).npcdesc ?? 0)}," you coo, smiling and putting your hands on his sides and guiding him. "Like <i>this</i>."`);
    // TODO-QSP: dynamic text: You spread your thighs a little wider as he pushes his <<$dick_desc>> cock into ...
    scene.text(`You spread your thighs a little wider as he pushes his ${((s as any).dick_desc ?? 0)} cock into you again, encouraging the movements you want from him. It takes a few minutes of trying, but eventually he starts to get the hang of it.`);
  ...
  // TODO-QSP: end
  qspCall(s, 'sex_ev_miss', 'missionary_change_position');
  // TODO-QSP: end
  scene.actions([
    ...
    scene.text(`Closing your eyes, you try to focus on the sensations, ${((s as any).npcdesc ?? 0)} on top of you, his cock slowly moving inside you, going in and out... in and out... in and ou-`);
    ...
    scene.text(`As much as you want ${((s as any).npcdesc ?? 0)} to pick up the pace, you don't want to be a bitch about it so you bite your tongue, going back to trying to get off on this or at least derive some kind of enjoyment out of it, ultimately failing on both counts.`);
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
    ...
    scene.text(`"This is boring," you say, staring up at ${((s as any).npcdesc ?? 0)} with a bored look on your face. "Can you go faster? I'm never going to get off at this rate."`);
    ...
    scene.text(`"Hey," you say, looking ${((s as any).npcdesc ?? 0)} right in the eyes. "I didn't come here for you to hump me like a Disney princess. I came here to <b>fuck.</b> Now fuck me like you mean it already!"`);
    if ((Math.floor(Math.random() * 2) + 0) === 1) {
...
function enterMiss1_1(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'sex_ev_miss', 'miss_vid');
  qspCall(s, 'sex_ev_miss', 'miss1.1_desc');
  qspCall(s, 'sex_ev_cum', 'fuck_cum');
  qspCall(s, 'sex_ev_sex', 'fuck_continue');
  // TODO-QSP: end
  scene.build();
  ...
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['fuck_enjoyment'] = 'unsatisfying';
        qspCall(s, 'sex_ev_miss', 'miss1_boy_talk1');
        ...
        scene.text(`You take deep breaths as ${((s as any).npcdesc ?? 0)} keeps slowly fucking you. Finally, the stabbing pain between your legs is starting to go away. It seems your virgin pussy is starting to adjust to having a cock inside it.`);
      } else {
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          ...
          qspCall(s, 'sex_ev_miss', 'miss1_boy_talk2');
          // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips in time wi...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips in time with ${((s as any).npcdesc ?? 0)}'s thrusts. It still hurts like hell, but you don't say anything, trying your best not to let it show.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            qspCall(s, 'sex_ev_miss', 'miss1_boy_talk1');
            qspCall(s, 'sex_ev_miss', 'miss1_boy_talk2');
    ...
    if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
      ...
      scene.text(`Nevertheless, you try to move your hips in time with his, rolling them and doing your best to make ${((s as any).npcdesc ?? 0)} feel good, hoping he'll come quickly.`);
    }
  } else {
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
          ...
          scene.text(`Your breath hitches as ${((s as any).npcdesc ?? 0)} continues to slowly thrust into your pussy. You aren't sure what changed, but it's like your body is waking up from a deep sleep. His cock stretches your walls, every thrust <i>fills</i> you in a way you didn't know you needed to be, and even now you can feel yourself get wetter and wetter, slicking up his cock and making it easier to reach the deepest parts of your pussy.`);
        } else {
          // TODO-QSP: dynamic text: Your breath hitches as <<$npcdesc>> continues to slowly thrust into your pussy. ...
          scene.text(`Your breath hitches as ${((s as any).npcdesc ?? 0)} continues to slowly thrust into your pussy. You aren't sure what changed, but somewhere along the line everything started feeling <i>really good</i>. When his cock stretches your pussy, you want to be stretched <i>more</i>. Your pussy clamps down on him, gripping his cock in the hopes it will never need to let go. But the juices flowing from your snatch make that impossible and every thrust that fills you leaves you tantalized for more. You <i>ache</i> for him to fill you, and every new thrust grants that wish again and again.`);
        }
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_speed_up'] = 0;
        ...
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          ...
          scene.text(`You widen your legs and try to roll your hips in time with ${((s as any).npcdesc ?? 0)}'s, trying to make him come faster.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            ...
            scene.text(`You grunt passively as ${((s as any).npcdesc ?? 0)} continues to pump his cock between your legs. His manhood drives into you, filling you with this weird sort of "pressure." This doesn't feel "good" exactly, but it doesn't feel bad either.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              ...
              scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his cock between your legs. It still basically feels numb to your pussy other than the occasional bump, but you don't want him to feel bad about it either so you play along, pretending it feels good.`);
            } else {
              if (((s as any).sex_ev ?? 0)?.['dirty_talk_count'] > 0) {
                qspCall(s, 'sex_ev_miss', 'miss1.2_dirty_talk');
                qspCall(s, 'sex_ev_miss', 'miss1_boy_talk1');
                qspCall(s, 'sex_ev_miss', 'miss1_boy_talk2');
      ...
      if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
        ...
        scene.text(`You widen your legs and eagerly throw your hips back towards ${((s as any).npcdesc ?? 0)} in time with his. Maybe if you time it right, you can come together.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['moan'] <= 2  &&  ((s as any).sex_ev ?? 0)?.['moan'] > 0) {
          ...
          qspCall(s, 'sex_ev_miss', 'miss1_boy_talk1');
          qspCall(s, 'sex_ev_miss', 'miss1_boy_talk2');
          qspCall(s, 'sex_ev_miss', 'miss1.2_moan_desc');
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 3) {
            ...
            scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to pump his cock between your legs. His manhood drives slowly in and out of you, his movements leaving you <b>absolutely bored</b>.`);
            ...
            if (((s as any).sex_ev ?? 0)?.['dirty_talk_count'] > 0) {
              ...
              if (((s as any).sex_ev ?? 0)?.['casual_talk'] > 0) {
                ...
                scene.text(`You close your eyes, letting ${((s as any).npcdesc ?? 0)} take care of the rest, focusing on his lovemaking.`);
                qspCall(s, 'sex_ev_miss', 'miss1.2_sensation_desc');
              }
            }
          }
        }
...
function enterMiss1_bored(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).npcdesc ?? 0)} keeps fucking you <i>excruciatingly</i> slowly and you keep having to stifle sighs of frustration, made twice worse by knowing your face is right beneath his. You smile at him, hoping he doesn't realize how fake it is.`);
  qspCall(s, 'sex_ev_cum', 'fuck_cum');
  qspCall(s, 'sex_ev_sex', 'fuck_continue');
  // TODO-QSP: end
  scene.build();
...
function enterMiss2(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['kiss'] = 0;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['position'] = 'miss';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'miss2';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['missionary_fuck'] = 1;
  if (qspFunc(s, 'pcs_has_attr', 'sex_virgin')  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
    scene.actions([{ label: 'Continue', goto: ['sex_ev_virgin', 'miss_virg_norm1'] }]);
  }
  ...
  if (((s as any).mesec ?? 0) > 0) {
    qspCall(s, 'sex_ev_miss', 'miss2_start_period_desc');
  } else {
    qspCall(s, 'sex_ev_miss', 'miss2_start_desc');
  }
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 75) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['fuck_enjoyment'] = 'enjoy';
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
...
function enterMiss2_1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'miss1') {
    ...
    if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'miss3') {
      ...
      scene.text(`${((s as any).npcdesc ?? 0)} ramps down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more.`);
    }
  }
  qspCall(s, 'sex_ev_miss', 'miss2.1_desc');
  qspCall(s, 'sex_ev_cum', 'fuck_cum');
  qspCall(s, 'sex_ev_sex', 'fuck_continue');
  // TODO-QSP: end
  scene.build();
  ...
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['fuck_enjoyment'] = 'unsatisfying';
        qspCall(s, 'sex_ev_miss', 'miss2_boy_talk1');
        ...
        scene.text(`You take deep breaths as ${((s as any).npcdesc ?? 0)} keeps steadily fucking you. Finally, the stabbing pain between your legs is starting to go away. It seems your virgin pussy is starting to adjust to having a cock inside it.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          scene.text('"<i>Nn-! Nngh-! Ngh-!</i>"');
          qspCall(s, 'sex_ev_miss', 'miss2_boy_talk1');
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          ...
          qspCall(s, 'sex_ev_miss', 'miss2_boy_talk2');
          // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips in time wi...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips in time with the sound of ${((s as any).npcdesc ?? 0)}'s hips clapping against your's. It hurts like hell, but you don't say anything, trying your best not to let it show.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            qspCall(s, 'sex_ev_miss', 'miss2_boy_talk1');
            qspCall(s, 'sex_ev_miss', 'miss2_boy_talk2');
            // TODO-QSP: dynamic text: You whimper softly, clenching your teeth as hard as you can, trying with all you...
            scene.text(`You whimper softly, clenching your teeth as hard as you can, trying with all your might to prevent yourself from bursting into tears every time ${((s as any).npcdesc ?? 0)}'s hips loudly clap into your's and pain lances through your pussy. It hurts <i>so much</i>, but you can't bring yourself to tell him to stop.`);
          }
        }
      }
    }
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ...
        scene.text(`Your breath hitches as ${((s as any).npcdesc ?? 0)} continues to steadily thrust into your pussy. You aren't sure what changed, but it's like your body is waking up from a deep sleep. His cock stretches your walls, every thrust <i>fills</i> you in a way you didn't know you needed to be, and even now you can feel yourself get wetter and wetter, slicking up his cock and making it slide in and out of you with much greater, and pleasurable, force.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_speed_up'] = 0;
          qspCall(s, 'sex_ev_miss', 'miss2_boy_talk1');
          ...
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            ...
            qspCall(s, 'sex_ev_miss', 'miss2_boy_talk2');
            // TODO-QSP: dynamic text: You grunt passively as <<$npcdesc>> continues to pump his cock between your legs...
            scene.text(`You grunt passively as ${((s as any).npcdesc ?? 0)} continues to pump his cock between your legs. His manhood hammers deep inside you, filling you with this weird sort of "pressure." This doesn't feel "good" exactly, but it doesn't feel bad either.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              scene.text('"<i>Ah~! Ahh~! Ahhh~!</i>"');
              qspCall(s, 'sex_ev_miss', 'miss2_boy_talk1');
              qspCall(s, 'sex_ev_miss', 'miss2_boy_talk2');
              // TODO-QSP: dynamic text: You moan softly as <<$npcdesc>> continues to pump his cock between your legs. It...
              scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his cock between your legs. It still basically feels numb to your pussy other than the slapping of his hips against yours, but you don't want him to feel bad about it either so you play along, trying to pretend it feels good.`);
            } else {
              if (((s as any).sex_ev ?? 0)?.['dirty_talk_count'] > 0) {
                qspCall(s, 'sex_ev_miss', 'miss2.2_dirty_talk');
                qspCall(s, 'sex_ev_miss', 'miss2_boy_talk1');
                qspCall(s, 'sex_ev_miss', 'miss2_boy_talk2');
      ...
      if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['moan'] >= 1) {
          ...
          qspCall(s, 'sex_ev_miss', 'miss2_boy_talk1');
          qspCall(s, 'sex_ev_miss', 'miss2_boy_talk2');
          qspCall(s, 'sex_ev_miss', 'miss2.2_moan_desc');
        } else {
          if (((s as any).sex_ev ?? 0)?.['dirty_talk_count'] === 1) {
            ...
            if (((s as any).sex_ev ?? 0)?.['casual_talk'] > 0) {
              ...
              // TODO-QSP: dynamic text: You close your eyes, letting <<$npcdesc>> take care of the rest, focusing on his...
              scene.text(`You close your eyes, letting ${((s as any).npcdesc ?? 0)} take care of the rest, focusing on his lovemaking.`);
              qspCall(s, 'sex_ev_miss', 'miss2.2_sensation_desc');
            }
          }
        }
      }
...
function enterMiss2_bored(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You moan along with ${((s as any).npcdesc ?? 0)}'s thrusts, putting on your best oh-face and hoping that he doesn't see through it, just waiting for him to come already.`);
  qspCall(s, 'sex_ev_cum', 'fuck_cum');
  qspCall(s, 'sex_ev_sex', 'fuck_continue');
  // TODO-QSP: end
  scene.build();
...
function enterMiss3(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['position'] = 'miss';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'miss3';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['missionary_fuck'] = 1;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['kiss'] = 0;
  if (qspFunc(s, 'pcs_has_attr', 'sex_virgin')  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
  ...
  qspCall(s, 'sex_ev_miss', 'miss3_start_desc');
  if (((s as any).mesec ?? 0) > 0) {
    qspCall(s, 'sex_ev_miss', 'miss3_start_period_desc');
  } else {
  ...
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] < 75) {
    ...
    scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips pound into yours over and over again. He's incessant, smashing into your pussy over.`);
    ...
    scene.text(`Your eyes roll back in your head as ${((s as any).npcdesc ?? 0)} incessantly pounds into you with his ${((s as any).dick_desc ?? 0)} cock. Not every thrust is clean and every once in a while he bangs into you in a way that causes a sharp jab of pain inside you. But that's just part of going rough and you focus on the good ones, letting the bad ones roll on past.`);
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
        { label: 'Fake enjoyment', handler: (st: GameState) => {
  ...
  if (((s as any).sex_ev ?? 0)?.['rough_enjoy'] !== 1) {
    ...
    scene.text(`You scream another cry of agonizing pleasure and glare at ${((s as any).npcdesc ?? 0)}.`);
    ...
    qspCall(s, 'sex_ev_miss', 'miss3_enjoy_desc');
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
      ]);
      ...
      scene.text(`"Oh fuck! It hurts!" you moan and ${((s as any).npcdesc ?? 0)} stops abruptly.`);
      if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
...
function enterMiss3_1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (((s as any).npc_knows_pc_likes_rough ?? 0)?.[String((s as any).npcID ?? 0)] === 0  ||  ((s as any).sex_ev ?? 0)?.['rough_enjoy'] !== 1)) {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} suddenly grabs your head, causing sharp pain at the back of your scalp.`);
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['rough_enjoy'] = 1;
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['fuck_enjoyment'] = 'enjoy';
    qspCall(s, 'sex_ev_miss', 'miss3.1_desc');
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
...
function enterMiss3_2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['rough_check'] === 0) {
    scene.actions([{ label: 'Continue', goto: ['sex_ev_miss', 'miss3'] }]);
  }
  qspCall(s, 'sex_ev_stats', 'position_tracker', 'miss', 3);
  qspCall(s, 'sex_ev_miss', 'miss_vid');
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    ...
    if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        scene.text(`You take deep breaths as ${((s as any).npcdesc ?? 0)} keeps pounding his cock into you. Somehow, the stabbing pain between your legs is starting to go away. It seems your virgin pussy is starting to adjust to getting jackhammered.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          scene.text('"<i>Nn-! Nngh-! Ngh-!</i>"');
          // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips in time wi...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips in time with ${((s as any).npcdesc ?? 0)}'s hips colliding with yours. The agony induced by his rough fucking is nearly unbearable, but you're pridefully determined not to let a little pain cause you to pussy out of your first time.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            // TODO-QSP: dynamic text: You whimper pathetically as <<$npcdesc>> keeps slamming into you with his cock, ...
            scene.text(`You whimper pathetically as ${((s as any).npcdesc ?? 0)} keeps slamming into you with his cock, clenching your teeth as hard as you can, trying with all your might to prevent yourself from bursting into tears. Despite your best efforts, the pain is too great and wet drops roll down your cheeks as ${((s as any).npcdesc ?? 0)} continues to pound you.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 4) {
              ...
              scene.text(`You sob openly as ${((s as any).npcdesc ?? 0)} smashes his cock into you. It hurts so much you think you're going to die, but you can't manage to tell him to stop. The only thing you can do is cry wordlessly as he stabs into your pussy over and over again.`);
            }
          }
        }
      }
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        scene.text(`You take deep breaths as ${((s as any).npcdesc ?? 0)} keeps pounding his cock into you. You focus hard, trying with all your might to squeeze <i>some</i> kind of pleasure from this. Anything to make the pain go away. And somehow, after several minutes, it does. ${((s as any).npcdesc ?? 0)} continues to jackhammer your pussy with his cock, but suddenly you feel able to tolerate it, even if it doesn't feel very good either.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          scene.text('"<i>Nn-! Nngh-! Ngh-!</i>"');
          // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips in time wi...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips in time with ${((s as any).npcdesc ?? 0)}'s hips colliding with yours. The agony induced by his rough fucking is nearly unbearable, but you're pridefully determined not to let the pain show.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            // TODO-QSP: dynamic text: You whimper pathetically as <<$npcdesc>> keeps slamming into you with his cock, ...
            scene.text(`You whimper pathetically as ${((s as any).npcdesc ?? 0)} keeps slamming into you with his cock, clenching your teeth as hard as you can, trying with all your might to prevent yourself from bursting into tears. Despite your best efforts, the pain is too great and tiny drops of moisture leak from your eyes and roll down your cheeks as ${((s as any).npcdesc ?? 0)} continues to pound you.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 4) {
              // TODO-QSP: dynamic text: You sob openly as <<$npcdesc>> smashes his cock into you. It hurts so much you t...
              scene.text(`You sob openly as ${((s as any).npcdesc ?? 0)} smashes his cock into you. It hurts so much you think you're going to die, but you can't manage to tell him to stop. The only thing you can do is cry wordlessly as he stabs into your pussy over and over again.`);
    ...
    if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_speed_up'] = 0;
      // TODO-QSP: dynamic text: Nevertheless, you try to move your hips in time with his, rolling them and doing...
      scene.text(`Nevertheless, you try to move your hips in time with his, rolling them and doing your best to make ${((s as any).npcdesc ?? 0)} feel good. Maybe you can make him come soon and put an end to this agony...`);
    }
  } else {
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      qspCall(s, 'sex_ev_sex', 'fuck_rough_no_cum_code');
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ...
        scene.text(`Your breath hitches as ${((s as any).npcdesc ?? 0)} continues to pound your pussy. You aren't sure what changed, but it's like your body is coming alive. His cock stretches your walls, <i>filling</i> you in a way you didn't know you needed to be, and even now you can feel yourself get wetter and wetter, slicking up his cock and making it slam harder into you with every thrust.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_speed_up'] = 0;
          // TODO-QSP: dynamic text: You widen your legs and try to roll your hips in time with <<$npcdesc>>'s as he ...
          scene.text(`You widen your legs and try to roll your hips in time with ${((s as any).npcdesc ?? 0)}'s as he pounds you, trying to make him come faster.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            scene.text('"<i>Mm-! Mmm-! Mm-! Mmm-!</i>"');
            // TODO-QSP: dynamic text: You grunt in time with <<$npcdesc>>'s thrusts as he continues to pound his cock ...
            scene.text(`You grunt in time with ${((s as any).npcdesc ?? 0)}'s thrusts as he continues to pound his cock between your legs. His manhood hammers deep inside you, slamming into you in a way that doesn't exactly feel "good", but it doesn't feel bad either.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              scene.text('"<i>Ah~! Ahh~! Ahhh~!</i>"');
              ...
              if (((s as any).sex_ev ?? 0)?.['dirty_talk_count'] === 1) {
                qspCall(s, 'sex_ev_miss', 'miss3.2_dirty_talk');
      ...
      if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
        ...
        scene.text(`You widen your legs and eagerly throw your hips back towards ${((s as any).npcdesc ?? 0)} as he pounds your pussy. Maybe if you time it right, you can come together.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['moan'] <= 2  &&  ((s as any).sex_ev ?? 0)?.['moan'] > 0) {
          qspCall(s, 'sex_ev_miss', 'miss3.2_moan_desc');
        } else {
          if (((s as any).sex_ev ?? 0)?.['dirty_talk_count'] === 1) {
            qspCall(s, 'sex_ev_miss', 'miss3.2_dirty_talk');
          } else {
            qspCall(s, 'sex_ev_miss', 'miss3.2_sensation_desc');
          }
        }
      }
    }
...
function enterMiss3_bored(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You half fake moan, half groan in pain in time with ${((s as any).npcdesc ?? 0)}'s thrusts. Your face contorts in agony and you hope that he is mistaking it for pleasure, just waiting for him to come already while he continues to relentlessly jackhammer your poor pussy.`);
  qspCall(s, 'sex_ev_cum', 'fuck_cum');
  qspCall(s, 'sex_ev_sex', 'fuck_continue');
  // TODO-QSP: end
  scene.build();
...
function enterMissKiss(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['kiss_skip'] = 1;
    if (((s as any).npc_no_kiss ?? 0)?.[String((s as any).npcID ?? 0)] === 2) {
      ...
      if (((s as any).npc_no_kiss ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
        ...
        if (!(s as any).npc_no_kiss) (s as any).npc_no_kiss = {}; (s as any).npc_no_kiss[String((s as any).npcID ?? 0)] = 1;
    ...
    if (!(s as any).npc_like) (s as any).npc_like = {}; (s as any).npc_like[String((s as any).npcID ?? 0)] = ((s as any).npc_like[String((s as any).npcID ?? 0)] ?? 0) + (2);
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['kiss'] = 1;
    ...
    if (((s as any).sex_ev ?? 0)?.['cuni_count'] > 0) {
      ...
      scene.text(`You let ${((s as any).npcdesc ?? 0)}'s lips touch yours and feel his tongue snake into your mouth and start to wrestle against your own, accompanied by an additional salty flavour that you recognize as the taste of your own pussy.`);
    } else {
      if (((s as any).npc_smoker ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        // TODO-QSP: dynamic text: You let <<$npcdesc>>'s lips touch yours and feel his tongue snake into your mout...
        scene.text(`You let ${((s as any).npcdesc ?? 0)}'s lips touch yours and feel his tongue snake into your mouth and start to wrestle against your own.`);
      } else {
        // TODO-QSP: dynamic text: You let his <<$npcdesc>>'s touch yours and feel his tongue snake into your mouth...
        scene.text(`You let his ${((s as any).npcdesc ?? 0)}'s touch yours and feel his tongue snake into your mouth and start to wrestle against your own.`);
      }
    }
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
      if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
          ...
          scene.text(`You kiss ${((s as any).npcdesc ?? 0)} back with all your might, trying to find something to distract yourself from the pain. All your focus is on the kiss and his lips and his tongue and the taste. It comes to you with a start that after the kiss breaks, you're not in as much pain as you were before.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
            // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips as you kis...
            scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips as you kiss ${((s as any).npcdesc ?? 0)} back. The pain of your virgin pussy getting fucked is still overwhelming, but try not to let it show, hoping to distract both ${((s as any).npcdesc ?? 0)} and yourself by returning the kiss.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
              // TODO-QSP: dynamic text: Your attempts to kiss <<$npcdesc>> back are clumsy at best, as opening your mout...
              scene.text(`Your attempts to kiss ${((s as any).npcdesc ?? 0)} back are clumsy at best, as opening your mouth at all puts you in danger of screaming in pain and bursting into tears. He continues fucking your virgin pussy and you nearly sob directly into his mouth as he kisses you.`);
            }
          }
        }
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
          ...
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
            // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips as you kis...
            scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips as you kiss ${((s as any).npcdesc ?? 0)} back. The pain in your pussy is still overwhelming, but try not to let it show, hoping to distract both ${((s as any).npcdesc ?? 0)} and yourself by returning the kiss.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
              // TODO-QSP: dynamic text: Your attempts to kiss <<$npcdesc>> back are clumsy at best, as opening your mout...
              scene.text(`Your attempts to kiss ${((s as any).npcdesc ?? 0)} back are clumsy at best, as opening your mouth at all puts you in danger of screaming in pain and bursting into tears. He continues fucking your pussy in the most painful way possible and you nearly sob directly into his mouth as he kisses you.`);
            }
          }
        }
      }
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
          ...
          scene.text(`A spark fires off somewhere inside you and suddenly find yourself kissing ${((s as any).npcdesc ?? 0)} back with passion as heat spreads through your hips. Your arousal has been awakened and wetness spreads between your legs as you force your tongue into ${((s as any).npcdesc ?? 0)}'s mouth.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            // TODO-QSP: dynamic text: You grunt passively into <<$npcdesc>>'s mouth as he kisses you while continuing ...
            scene.text(`You grunt passively into ${((s as any).npcdesc ?? 0)}'s mouth as he kisses you while continuing to fuck you. The kiss isn't really helping much, but it could be worse you guess.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              // TODO-QSP: dynamic text: You moan softly into <<$npcdesc>>'s mouth as he kisses you while continuing to f...
              scene.text(`You moan softly into ${((s as any).npcdesc ?? 0)}'s mouth as he kisses you while continuing to fuck you and hope with every fibre of your being that it's convincing because neither the kiss nor his cock between your legs is doing anything for you.`);
            }
          }
        }
      } else {
        if (((s as any).sex_ev ?? 0)?.['bored'] === 1) {
          ...
          if (((s as any).sex_ev ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
            if (((s as any).sex_ev ?? 0)?.['cuni_count'] > 0) {
              ...
              scene.text(`You smile up at ${((s as any).npcdesc ?? 0)} as his lips meet yours. They taste slightly... salty... and you realize with a start that it's the flavour of your own pussy, being passed back into your mouth. His tongue pushes up against yours, gently complimenting the pleasure of his cock inside you. You close your eyes, letting them roll back in your head, knowing that he's about to make you come.`);
            } else {
              if (((s as any).npc_smoker ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
                // TODO-QSP: dynamic text: You smile up at <<$npcdesc>> as his lips meet yours. His tongue, tasting vaguely...
                scene.text(`You smile up at ${((s as any).npcdesc ?? 0)} as his lips meet yours. His tongue, tasting vaguely of smoke and tobacco, pushes up against yours, gently complimenting the pleasure of his cock inside you. You close your eyes, letting them roll back in your head, knowing that he's about to make you come.`);
              } else {
                // TODO-QSP: dynamic text: You smile up at <<$npcdesc>> as his lips meet yours. They press softly together ...
                scene.text(`You smile up at ${((s as any).npcdesc ?? 0)} as his lips meet yours. They press softly together and his tongue spreads them apart to push up against yours, gently complimenting the pleasure of his cock inside you. You close your eyes, letting them roll back in your head, knowing that he's about to make you come.`);
              }
            }
          } else {
            if (((s as any).npc_smoker ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
              // TODO-QSP: dynamic text: You smile up at <<$npcdesc>> as his lips meet yours. His tongue, tasting vaguely...
              scene.text(`You smile up at ${((s as any).npcdesc ?? 0)} as his lips meet yours. His tongue, tasting vaguely of smoke and tobacco, spreads them apart to push up against yours, gently complimenting the pleasure of his cock inside you.`);
            } else {
              // TODO-QSP: dynamic text: You smile up at <<$npcdesc>> as his lips meet yours. They press softly together ...
...
function enterMiss1StartPeriodDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} pumps his tiny dick in and out of you slowly, focusing more on technique than speed. Soft squelching comes from between your legs, a little wetter sounding than usual, probably on account of your period. But the added lubrication is welcome and his modest manhood slips in and out of you with ease.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
...
function enterMiss1StartDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    // TODO-QSP: dynamic text: <<$npcdesc>> pumps his tiny dick in and out of you slowly, focusing more on tech...
    scene.text(`${((s as any).npcdesc ?? 0)} pumps his tiny dick in and out of you slowly, focusing more on technique than speed, driving as deep inside you as he can with every thrust (which admittedly isn't very far).`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> pumps his chodey dick in and out of you slowly, focusing more on te...
      scene.text(`${((s as any).npcdesc ?? 0)} pumps his chodey dick in and out of you slowly, focusing more on technique than speed and driving as deep inside you as he can with every thrust (which mostly serves to stretch your pussy's lips).`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> pumps his skinny dick in and out of you slowly, focusing more on te...
        scene.text(`${((s as any).npcdesc ?? 0)} pumps his skinny dick in and out of you slowly, focusing more on technique than speed, driving as deep inside you as he can with every thrust.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> pumps his cock in and out of you slowly, focusing more on technique...
          scene.text(`${((s as any).npcdesc ?? 0)} pumps his cock in and out of you slowly, focusing more on technique than speed, driving as deep inside you as he can with every thrust.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).pcs_vag ?? 0) <= 10) {
              // TODO-QSP: dynamic text: <<$npcdesc>> pumps his thick cock in and out of you slowly, focusing more on tec...
              scene.text(`${((s as any).npcdesc ?? 0)} pumps his thick cock in and out of you slowly, focusing more on technique than speed. He drives as deep inside you, straining tight against the walls of your snug pussy with every thrust.`);
            } else {
              // TODO-QSP: dynamic text: <<$npcdesc>> pumps his cock in and out of you slowly, focusing more on technique...
              scene.text(`${((s as any).npcdesc ?? 0)} pumps his cock in and out of you slowly, focusing more on technique than speed. He drives as deep inside you as he can, pleasantly filling you with every thrust.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              if (((s as any).pcs_vag ?? 0) <= 15) {
                // TODO-QSP: dynamic text: <<$npcdesc>> pumps his long cock in and out of you slowly, focusing more on tech...
                scene.text(`${((s as any).npcdesc ?? 0)} pumps his long cock in and out of you slowly, focusing more on technique than speed. He drives deep inside you, barely managing to fit his entire length inside you with every thrust.`);
              } else {
                // TODO-QSP: dynamic text: <<$npcdesc>> pumps his long cock in and out of you slowly, focusing more on tech...
                scene.text(`${((s as any).npcdesc ?? 0)} pumps his long cock in and out of you slowly, focusing more on technique than speed. He drives deep inside you and his lengthy manhood comfortably fills you with every thrust.`);
              }
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                if (((s as any).pcs_vag ?? 0) <= 15) {
                  // TODO-QSP: dynamic text: <<$npcdesc>> pumps his huge cock in and out of you slowly, focusing more on tech...
                  scene.text(`${((s as any).npcdesc ?? 0)} pumps his huge cock in and out of you slowly, focusing more on technique than speed. It fills you completely and then some, straining tight against the walls of your snug pussy with every thrust.`);
                } else {
                  // TODO-QSP: dynamic text: <<$npcdesc>> pumps his cock in and out of you slowly, focusing more on technique...
                  scene.text(`${((s as any).npcdesc ?? 0)} pumps his cock in and out of you slowly, focusing more on technique than speed. He drives as deep inside you as he can, filling you completely with every thrust.`);
                }
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  if (((s as any).pcs_vag ?? 0) <= 15) {
                    // TODO-QSP: dynamic text: <<$npcdesc>> pumps his cock in and out of you slowly, focusing more on technique...
                    scene.text(`${((s as any).npcdesc ?? 0)} pumps his cock in and out of you slowly, focusing more on technique than speed. It fills you completely and then some, causing you to gasp with every thrust as its enormous length and girth stretch your snug pussy to the limits.`);
                  } else {
                    // TODO-QSP: dynamic text: <<$npcdesc>> pumps his cock in and out of you slowly, focusing more on technique...
                    scene.text(`${((s as any).npcdesc ?? 0)} pumps his cock in and out of you slowly, focusing more on technique than speed. It fills you completely and then some, causing you to gasp with every thrust as its enormous length and girth strain against the walls of your pussy.`);
                  }
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    if (((s as any).pcs_vag ?? 0) <= 20) {
                      // TODO-QSP: dynamic text: <<$npcdesc>> pumps his lengthy cock in and out of you slowly, focusing more on t...
                      scene.text(`${((s as any).npcdesc ?? 0)} pumps his lengthy cock in and out of you slowly, focusing more on technique than speed. He drives deep inside you, so far that it bumps against your cervix with every thrust and still has shaft to spare that he can't fit inside you.`);
                    } else {
                      // TODO-QSP: dynamic text: <<$npcdesc>> pumps his lengthy cock in and out of you slowly, focusing more on t...
                      scene.text(`${((s as any).npcdesc ?? 0)} pumps his lengthy cock in and out of you slowly, focusing more on technique than speed. He drives deep inside you, so far that it bumps against your cervix with every thrust and still has shaft to spare that he can't fit inside you.`);
                    }
                    ...
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      if (((s as any).pcs_vag ?? 0) <= 15) {
                        ...
                        scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly with his gigantic cock. Calling it a tight fit would be putting it lightly as he struggles to fit himself inside you and his manhood both bumps against your cervix and strains against your walls with every thrust.`);
                      } else {
                        if (((s as any).pcs_vag ?? 0) <= 25) {
                          // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly with his gigantic cock. You're obviously no virgin...
                          scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly with his gigantic cock. You're obviously no virgin, but he still struggles to fit himself inside you and his manhood both bumps against your cervix and strains against your walls with every thrust.`);
                        } else {
                          // TODO-QSP: dynamic text: <<$npcdesc>> pumps his lengthy cock in and out of you slowly, focusing more on t...
                          scene.text(`${((s as any).npcdesc ?? 0)} pumps his lengthy cock in and out of you slowly, focusing more on technique than speed. He drives deep inside you, so far that it bumps against your cervix with every thrust and still has shaft to spare that he can't fit inside you.`);
                        }
                      ...
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        if (((s as any).pcs_vag ?? 0) <= 10) {
                          ...
                          scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly with his monstrous cock. The size difference is almost comical as his manhood strains against both your pussy's depths and flexibility, nearly splitting you in half with every thrust.`);
                        } else {
                          if (((s as any).pcs_vag ?? 0) <= 25) {
                            // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly with his gigantic cock. You're obviously no virgin...
                            scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly with his gigantic cock. You're obviously no virgin, but his manhood barely fits inside you, it's like fucking a baseball bat.`);
                          } else {
                            // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly, focusing more on technique than speed. He drives ...
                            scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly, focusing more on technique than speed. He drives deep inside you, and his monstrous cock is so big that even your experienced pussy is stretched with every thrust.`);
                          }
                        }
                      }
                    }
...
function enterMiss1EnjoyDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. His dick may be laughably small, but he knows how to use it and your hips buck every time he draws his away.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. He may ha...
      scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. He may have a chode, but he knows how to use its girth well, and your hips buck every time he draws his away.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. You love ...
        scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. You love how easily his cock slips in and out of you, the slippery wetness heightened by his skinny dick, and your hips buck every time he draws his away.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. You love ...
          scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. You love the way he moves his cock, how it makes you feel <i>full</i> when he's inside you, and your hips buck every time he draws his away.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).pcs_vag ?? 0) <= 10) {
              // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. You love ...
              scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. You love the way his cock stretches you out, how tightly your pussy grips it, and your hips buck every time he draws his away.`);
            } else {
              // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. You love ...
              scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. You love the way he moves, the thickness of his cock, how <i>full</i> it makes you feel, and your hips buck every time he draws his away.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              if (((s as any).pcs_vag ?? 0) <= 15) {
                // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. You love ...
                scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. You love his cock slipping in and out of you, the ease at which he can slide his extensive length nearly to its base, and your hips buck every time he draws his away.`);
              } else {
                // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. You love ...
                scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. You love his cock slipping in and out of you, the ease at which he can slide his extensive length all the way to its base, and your hips buck every time he draws his away.`);
              }
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                if (((s as any).pcs_vag ?? 0) <= 15) {
                  // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. You love ...
                  scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. You love the way his cock stretches you out, how deep it goes inside you, how tightly your pussy grips it, and your hips buck every time he draws his away.`);
                } else {
                  // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. You love ...
                  scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. You love the way he moves, the great length and thickness of his cock <i>filling</i> you, and your hips buck every time he draws his away.`);
                }
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  if (((s as any).pcs_vag ?? 0) <= 15) {
                    // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, gasping with every thrust. His enormous cock is d...
                    scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, gasping with every thrust. His enormous cock is driving you insane, filling you until it hurts, trapping you in the place between pain and pleasure, before leaving you feeling empty and vacant as it withdraws. Your hips buck every time he pulls away, begging to be impaled by it once again.`);
                  } else {
                    // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. His enorm...
                    scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. His enormous cock <i>fills</i> you to bursting and your hips buck every time he draws his away.`);
                  }
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    if (((s as any).pcs_vag ?? 0) <= 20) {
                      // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, gasping with every thrust as the tip of his lengt...
                      scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, gasping with every thrust as the tip of his lengthy cock touches your most secret place. You love his cock slipping in and out of you, the way he pushes for greater depths that your pussy just can't give and you grind your hips against him, trying to push it even deeper.`);
                    } else {
                      // TODO-QSP: dynamic text: You moan beneath <<$npcdesc>>, your breath hitching with every thrust. You love ...
                      scene.text(`You moan beneath ${((s as any).npcdesc ?? 0)}, your breath hitching with every thrust. You love his cock slipping in and out of you, the deep impact inside you bringing out a pain that feels more like ecstasy.`);
                    }
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      if (((s as any).pcs_vag ?? 0) <= 25) {
                      ...
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        if (((s as any).pcs_vag ?? 0) <= 25) {
                          ...
                          scene.text(`You groan beneath ${((s as any).npcdesc ?? 0)}, getting wetter with every thrust. His monster cock fills is way too big for you in both girth and length, pummelling your insides and stretching your pussy to the point of pain, and you are <i><b>loving every second of it.</b></i>`);
                        } else {
                          // TODO-QSP: dynamic text: You groan beneath <<$npcdesc>>, getting wetter with every thrust. His monster co...
                          scene.text(`You groan beneath ${((s as any).npcdesc ?? 0)}, getting wetter with every thrust. His monster cock is destroying your pussy with size alone, smashing into your cunt like the most gentle jackhammer in the world. But it doesn't feel bad. Far from it. The pain is euphoric and you can't get enough of his cock.`);
                        }
                      }
                    }
                  }
...
function enterMiss1_1Desc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently with his small dick. The result is gratifying, allowing you to feel more of his meager length, no longer lost in the pounding of your hips together.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently with his small dick. The result...
      scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently with his small dick. The result is gratifying, allowing you to savour the way his thick chode stretches your pussy, rather than getting lost in constant pounding.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently with his skinny dick. The resul...
        scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently with his skinny dick. The result is gratifying, allowing you concentrate on his length instead of slipping in and out of you like a hotdog in a hallway.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently with his dick. At the reduced p...
          scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently with his dick. At the reduced pace, you can feel every contour of him inside you, and you moan with every thrust.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).pcs_vag ?? 0) <= 10) {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently. It immediately feels much bett...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently. It immediately feels much better and allows your snug pussy to enjoy the thick girth of his cock instead of being hurt by it.`);
            } else {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently with his dick. At the reduced p...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently with his dick. At the reduced pace, you better savour the nice thickness of his cock, breathing in deep pleasure with every thrust.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently. It immediately feels better an...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently. It immediately feels better and you enjoy his sizeable length now that it's less "punchy".`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                if (((s as any).pcs_vag ?? 0) <= 15) {
                  // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently. Relief and pleasure wash throu...
                  scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently. Relief and pleasure wash through you, his dick no longer feeling quite so "punchy" inside you, and your snug pussy grips his huge cock with wet desire.`);
                } else {
                  // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently. Relief and pleasure wash throu...
                  scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently. Relief and pleasure wash through you, his dick no longer feeling quite so "punchy" inside you, and your pussy swallows up his huge cock with wet desire.`);
                }
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  if (((s as any).pcs_vag ?? 0) <= 15) {
                    // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently. Relief and pleasure wash throu...
                    scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently. Relief and pleasure wash through you, his dick no longer feeling quite so "punchy" inside you, and your snug pussy grips the enormous length and girth of his cock with wet desire.`);
                  } else {
                    // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently. Relief and pleasure wash throu...
                    scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently. Relief and pleasure wash through you, his dick no longer feeling quite so "punchy" inside you, and your pussy swallows up the enormous length and girth of his cock with wet desire.`);
                  }
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently. It immediately feels better an...
                    scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently. It immediately feels better and you are able to fully enjoy his incredible length now that it's less "punchy-stabby".`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently. Relief and pleasure wash throu...
                      scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently. Relief and pleasure wash through you, his gigantic cock no longer smashing your insides and your pussy swallows up his great size wet desire.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently. Relief and pleasure wash throu...
                        scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently. Relief and pleasure wash through you, his monstrous cock no longer destroying your insides and your pussy swallows up his incredible length and girth wet desire.`);
                      }
                    }
                  }
                }
...
function enterMiss1_2MoanDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his tiny cock between your legs. Slowly. Gently. His manhood moves perfectly inside you, hitting the perfect spots with it's short length. Your breath hitches with every thrust and it feels wonderful.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You moan softly as <<$npcdesc>> continues to pump his short cock between your le...
      scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his short cock between your legs. Slowly. Gently. His manhood moves perfectly inside you, somehow stretching you out in just the right ways with its wide girth. Your breath hitches with every thrust and it feels wonderful.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You moan softly as <<$npcdesc>> continues to pump his skinny cock between your l...
        scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his skinny cock between your legs. Slowly. Gently. His manhood moves perfectly inside you rubbing right up against your g-spot. Your breath hitches with every thrust and it feels wonderful.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You moan softly as <<$npcdesc>> continues to pump his cock between your legs. Sl...
          scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his cock between your legs. Slowly. Gently. His manhood fits you perfectly, filling you up just right. Your breath hitches with every thrust and it feels wonderful.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).pcs_vag ?? 0) <= 10) {
              // TODO-QSP: dynamic text: You moan softly as <<$npcdesc>> continues to pump his thick cock between your le...
              scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his thick cock between your legs. Slowly. Gently. Stretching your tight pussy in all the best ways. Your breath hitches with every thrust and it feels wonderful.`);
            } else {
              // TODO-QSP: dynamic text: You moan softly as <<$npcdesc>> continues to pump his thick cock between your le...
              scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his thick cock between your legs. Slowly. Gently. Filling you up with his girth. Your breath hitches with every thrust and it feels wonderful.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You moan softly as <<$npcdesc>> continues to pump his cock between your legs. Sl...
              scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his cock between your legs. Slowly. Gently. It reaches deep inside you, hitting pleasure points you didn't even know could be hit with a dick. Your breath hitches with every thrust and it feels wonderful.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                if (((s as any).pcs_vag ?? 0) <= 15) {
                  // TODO-QSP: dynamic text: You moan softly as <<$npcdesc>> continues to pump his huge cock between your leg...
                  scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his huge cock between your legs. Slowly. Gently. Stretching your snug pussy in all the best ways and <i>filling</i> you with it. It's so tight inside you that you literally <i>squeeze</i> pleasure from it and your breath hitches with every thrust.`);
                } else {
                  // TODO-QSP: dynamic text: You moan softly as <<$npcdesc>> continues to pump his huge cock between your leg...
                  scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his huge cock between your legs. Slowly. Gently. It <i>fills</i> you time and time again and you can't get enough, your breath hitching with every thrust.`);
                }
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  if (((s as any).pcs_vag ?? 0) <= 15) {
                    // TODO-QSP: dynamic text: You groan softly as <<$npcdesc>> continues to pump his enormous cock between you...
                    scene.text(`You groan softly as ${((s as any).npcdesc ?? 0)} continues to pump his enormous cock between your legs. Slowly. Gently. Its magnificent girth threatens to split you in half with every thrust and if it did, you'd die happy.`);
                  } else {
                    // TODO-QSP: dynamic text: You groan softly as <<$npcdesc>> continues to pump his enormous cock between you...
                    scene.text(`You groan softly as ${((s as any).npcdesc ?? 0)} continues to pump his enormous cock between your legs. Slowly. Gently. It pummels you with its magnificent girth, filling up every single corner of your pussy with every single thrust.`);
                  }
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You moan softly as <<$npcdesc>> continues to pump his cock between your legs. Sl...
                    scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his cock between your legs. Slowly. Gently. It reaches deep inside you with its exceptional length, sending shocks of pleasurable pain through your uterus with every collision.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You groan softly as <<$npcdesc>> continues to pump his gigantic cock between you...
                      scene.text(`You groan softly as ${((s as any).npcdesc ?? 0)} continues to pump his gigantic cock between your legs. Slowly. Gently. Its exceptional length reaches deep inside you, sending shocks of pleasurable pain through your uterus even as your pussy clenches hard around its thick shaft.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: You groan as <<$npcdesc>> continues to pump his monstrous cock between your legs...
                        scene.text(`You groan as ${((s as any).npcdesc ?? 0)} continues to pump his monstrous cock between your legs. It threatens to split you in half its oversized girth while simultaneously attempting to impale you like a heretic slut, his cock the spear of your execution. If it did, you'd die happy. Agony has never felt so good.`);
                      }
                    }
                  }
                }
...
function enterMiss1_2DirtyTalk(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['dirty_talk_count'] = ((s as any).sex_ev['dirty_talk_count'] ?? 0) + (1);
  ...
  if (((s as any).sex_ev ?? 0)?.['dirty_talk_count'] > 1) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['dirty_talk_count'] = 0;
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterMiss2StartPeriodDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with yours, the sloppy sounds of your period leaking around his tiny dick.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
      scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with yours, the sloppy sounds of your period squelching around his thick chode.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
        ...
        if (((s as any).dick_desc ?? 0) === 'normal') {
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            ...
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
              scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his long dick hammers deep inside you. Wet slaps echo around the room as his hips collide with yours, the sloppy sounds of your period squelching around his long shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his dick hammers deep inside you. Wet slaps echo around the room as his hips collide with yours, the huge size of his cock forcing squelches from your bleeding cunt.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
...
function enterMiss2StartDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
    scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with yours, unceasingly thrusting into you with his tiny dick.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
      scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with yours, unceasingly thrusting into you with his thick chode.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
        scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with yours, unceasingly thrusting into you with his skinny dick.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
            scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with yours, the sloppy squelching sounds of your pussy fucked by his thick shaft.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
              scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his long dick hammers deep inside you. Wet slaps echo around the room as his hips collide with yours, the sloppy sounds of your pussy squelching around his long shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his dick hammers deep inside you. Wet slaps echo around the room as his hips collide with yours, the huge size of his cock forcing squelches from your cunt.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                  scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his enormous dick fills you to the brim. Wet slaps echo around the room as his hips collide with yours, forcing loud squelches from your snatch with his long girthy cock.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
...
function enterMiss2EnjoyDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`You groan in pleasure beneath ${((s as any).npcdesc ?? 0)}. You love the way he's fucking you, with just enough force that shocks of pleasure reverberate through your entire body, more than making up for his tiny dick.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he's fucking you, w...
      scene.text(`You groan in pleasure beneath ${((s as any).npcdesc ?? 0)}. You love the way he's fucking you, with just enough force that uses his thick chode to his advantage, stretching your lips and sending shocks of pleasure through your entire body.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he's fucking you, w...
        scene.text(`You groan in pleasure beneath ${((s as any).npcdesc ?? 0)}. You love the way he's fucking you, with just enough force that uses his skinny dick to his advantage, reaching spots deep inside you and sending shocks of pleasure through your entire body.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he's fucking you, w...
          scene.text(`You groan in pleasure beneath ${((s as any).npcdesc ?? 0)}. You love the way he's fucking you, with just the right amount of force that every thrust reverberates through your entire body, but not so hard it hurts.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he's fucking you, w...
            scene.text(`You groan in pleasure beneath ${((s as any).npcdesc ?? 0)}. You love the way he's fucking you, with just enough force that sends shocks of pleasure through your entire body while still allowing you to enjoy the exceptional thickness of his shaft inside you.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he's fucking you, w...
              scene.text(`You groan in pleasure beneath ${((s as any).npcdesc ?? 0)}. You love the way he's fucking you, with just enough force that sends shocks of pleasure through your entire body, pleasantly pounding your insides with his long cock.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he's fucking you, s...
                scene.text(`You groan in pleasure beneath ${((s as any).npcdesc ?? 0)}. You love the way he's fucking you, sending shocks of pleasure through your entire body with his huge cock.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he's fucking you an...
                  scene.text(`You groan in pleasure beneath ${((s as any).npcdesc ?? 0)}. You love the way he's fucking you and the way his enormous cock fills you from labia to cervix, stretching you out with his sizeable girth the whole way.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he's fucking you an...
                    scene.text(`You groan in pleasure beneath ${((s as any).npcdesc ?? 0)}. You love the way he's fucking you and the way his exceptionally lengthy cock bounces off your cervix, a strangely pleasurable soreness building with every collision.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You groan in pleasure beneath <<$npcdesc>>. You love the way he's fucking you an...
...
function enterMiss2_1Desc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'miss1') {
    if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
      ...
      scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into yours, unceasingly thrusting into you with his tiny dick. Wet slapping sounds fill the room and you can't help but giggle at how good it feels.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'chode') {
        // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
        ...
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          ...
          if (((s as any).dick_desc ?? 0) === 'normal') {
            // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
            scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room with every thrust and ${((s as any).npcdesc ?? 0)} drives his cock deep as deep as he can every time.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'thick') {
              // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
              scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into yours, the sloppy squelching sounds of your pussy fucked by his thick shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'long') {
                // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust and ${((s as any).npcdesc ?? 0)}'s long dick hammers deep inside you. Wet slaps echo around the room as his hips collide with yours, the sloppy sounds of your pussy squelching around his long shaft.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'huge') {
                  // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                  ...
                  if (((s as any).dick_desc ?? 0) === 'enormous') {
                    // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                    scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust and ${((s as any).npcdesc ?? 0)}'s enormous dick fills you to the brim. Wet slaps echo around the room as his hips collide with yours, forcing loud squelches from your snatch with his long girthy cock.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'lengthy') {
                      // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                      scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust and his dick batters your insides with its exceptional length. Wet slaps echo around the room as his hips collide with yours, the sloppy sounds of your pussy squelching around ${((s as any).npcdesc ?? 0)}'s lengthy shaft.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'gigantic') {
                        // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                        scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust and his gigantic dick fills you to the brim. Sloppy wet slaps echo around the room as ${((s as any).npcdesc ?? 0)} batters your pussy with his long hard cock.`);
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'monstrous') {
                          // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
    ...
    if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'miss3') {
      if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
        ...
        scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into yours, unceasingly thrusting into you with his tiny dick. Wet slapping sounds fill the room and you can't help but giggle at how good it feels.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'chode') {
          // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
          scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into yours, unceasingly thrusting into you with his thick chode.`);
          ...
          if (((s as any).dick_desc ?? 0) === 'skinny') {
            ...
            if (((s as any).dick_desc ?? 0) === 'normal') {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room with every thrust and ${((s as any).npcdesc ?? 0)} drives his cock deep as deep as he can every time.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'thick') {
                // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into yours, the sloppy squelching sounds of your pussy fucked by his thick shaft.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'long') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                  scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust and ${((s as any).npcdesc ?? 0)}'s long dick hammers deep inside you. Wet slaps echo around the room as his hips collide with yours, the sloppy sounds of your pussy squelching around his long shaft.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'huge') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                    ...
                    if (((s as any).dick_desc ?? 0) === 'enormous') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                      scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust and ${((s as any).npcdesc ?? 0)}'s enormous dick fills you to the brim. Wet slaps echo around the room as his hips collide with yours, forcing loud squelches from your snatch with his long girthy cock.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'lengthy') {
                        // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                        ...
                        if (((s as any).dick_desc ?? 0) === 'gigantic') {
                          // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                          scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust and his gigantic dick fills you to the brim. Sloppy wet slaps echo around the room as ${((s as any).npcdesc ?? 0)} batters your pussy with his long hard cock.`);
                        } else {
                          if (((s as any).dick_desc ?? 0) === 'monstrous') {
                            // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
...
function enterMiss2_2MoanDesc(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you. His tiny dick pounds into you with perfect pressure, like a hard finger fucking for your pussy, but better.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you. His thi...
      scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you. His thick chode pounds into you with perfect pressure, like a hard three-finger fucking for your pussy, but better.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you, poundin...
        scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you, pounding into you with perfect pressure, his skinny dick massaging your insides wonderfully.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you, poundin...
          scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you, pounding into you with perfect pressure, his dick filling you up, drawing pleasure from your pussy with every thrust.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you, poundin...
            scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you, pounding into you with perfect pressure, his thick cock stretching you out, squeezing pleasure from your pussy with every thrust.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you, poundin...
              scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you, pounding into you with perfect pressure, his long dick hitting spots you didn't know could be reached.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you, poundin...
                scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you, pounding into you with perfect pressure, his huge dick filling you up and hitting spots inside you that you didn't know could be reached.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you, poundin...
                  scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you, pounding into you with perfect pressure, his enormous cock stretching you out and hitting the deepest parts of your pussy.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You groan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you, poundi...
                    scene.text(`You groan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you, pounding into you with perfect pressure that sends shocks of pain and pleasure through your insides every time his exceptionally lengthy cock bounces off your cervix.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You groan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you, poundi...
                      scene.text(`You groan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you, pounding into you with perfect pressure that fills you completely and sends shocks of pain and pleasure through your insides every time his gigantic cock bounces off your cervix.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: You groan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you, poundi...
                        scene.text(`You groan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you, pounding into you with his cock that stretches you in every way imaginable. Your eyes water with tears, joy and pain mixing together into an insatiable desire that begs for more and more of ${((s as any).npcdesc ?? 0)}'s monstrous cock.`);
                      }
                    }
                  }
                }
      ...
      if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'technique') {
        ...
        if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'dirty_girl') {
          if (((s as any).npc_dirty_lover ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
            ...
            scene.text(`"Who's pussy is this?" ${((s as any).npcdesc ?? 0)} growls as he slowly withdraws his cock before ramming it hard back into your cunt.`);
            scene.text('"Yours~!" you whimper, squirming beneath him.');
          } else {
            if (((s as any).pcs_horny ?? 0) >= 70) {
              if ((Math.floor(Math.random() * 1) + 1) === 1) {
...
function enterMiss2_2SensationDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like a perfect massage for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)}'s tiny dick slips in and out of it with ease.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> pounds your insides like a perfect massage for your pussy. Your bre...
      scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like a perfect massage for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)}'s fat chode slips in and out of it with ease.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> pounds your insides like a perfect massage for your pussy. Your bre...
        scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like a perfect massage for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)}'s skinny dick slips in and out of it with ease.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> pounds your insides like a perfect massage for your pussy. Your bre...
          scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like a perfect massage for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)}'s dick slips in and out of it with ease.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: <<$npcdesc>> pounds your insides like a perfect massage for your pussy. Your bre...
            scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like a perfect massage for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)}'s thick cock slips in and out of it with ease.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> pounds your insides like a perfect massage for your pussy. Your bre...
              scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like a perfect massage for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)}'s long cock penetrates you to your depths with ease.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> pounds your insides like a perfect massage for your pussy. Your bre...
                scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like a perfect massage for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)}'s huge cock penetrates you to your depths with ease, filling you completely with every thrust.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> pounds your insides like a perfect massage for your pussy. Your bre...
                  scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like a perfect massage for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)}'s cock penetrates you to your depths, forcing his enormous length and girth into you on every thrust.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> pounds your insides like the most painfully perfect massage for you...
                    scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like the most painfully perfect massage for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)}'s cock penetrates you to your depths and then some, forcing his enormous length up against your cervix with every thrust.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> pounds your insides like the most painfully perfect for your pussy....
                      scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like the most painfully perfect for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)} fills you up completely and then some, forcing his gigantic cock up against your cervix with every thrust.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: <<$npcdesc>> pounds your insides like the most painfully perfect for your pussy....
                        scene.text(`${((s as any).npcdesc ?? 0)} pounds your insides like the most painfully perfect for your pussy. Your breasts jiggle with every thrust, your stiff nipples quiver in the air, and loud squelching emanates from your dripping snatch as ${((s as any).npcdesc ?? 0)}'s monstrous cock practically splits you in half with every thrust, battering your insides in a way that only leaves you aching for more.`);
                      }
                    }
                  }
                }
...
function enterMiss3StartPeriodDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} drives himself in and out of your pussy with tremendous strength and the sound of your cheeks getting clapped echoes off the walls. His tiny dick slams into you with such power that you can feel your period spattering across the inside of your thighs.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
      scene.text(`${((s as any).npcdesc ?? 0)} drives himself in and out of your pussy with tremendous strength and the sound of your cheeks getting clapped echoes off the walls. His tiny dick slams into you with such power that you can feel your period spattering across the inside of your thighs.`);
      ...
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
        scene.text(`${((s as any).npcdesc ?? 0)} drives himself in and out of your pussy with tremendous strength and the sound of your cheeks getting clapped echoes off the walls. His skinny dick slams into you with such power that you can feel your period spattering across the inside of your thighs.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
          scene.text(`${((s as any).npcdesc ?? 0)} drives himself in and out of your pussy with tremendous strength and the sound of your cheeks getting clapped echoes off the walls. His dick slams into you with such power that you can feel your period spattering across the inside of your thighs.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
            scene.text(`${((s as any).npcdesc ?? 0)} drives himself in and out of your pussy with tremendous strength and the sound of your cheeks getting clapped echoes off the walls. His thick cock slams into you with such power that you can feel your period spattering across the inside of your thighs.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
              scene.text(`${((s as any).npcdesc ?? 0)} drives himself in and out of your pussy with tremendous strength and the sound of your cheeks getting clapped echoes off the walls. His long cock slams into you with such power that you can feel your period spattering across the inside of your thighs.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
                scene.text(`${((s as any).npcdesc ?? 0)} drives himself in and out of your pussy with tremendous strength and the sound of your cheeks getting clapped echoes off the walls. His huge cock slams into you with such power that you can feel your period spattering across the inside of your thighs.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
                  ...
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
                    scene.text(`${((s as any).npcdesc ?? 0)} drives himself in and out of your pussy with tremendous strength and the sound of your cheeks getting clapped echoes off the walls. His cock is so long that it slams into your cervix, battering the blood from your uterus and sending flecks of red spatter across the sheets.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
...
function enterMiss3StartDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his hips into you. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to pull you harder onto his tiny dick. You can barely feel him inside you, but the impact of his body leaves you breathless.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You gasp as <<$npcdesc>> slams his hips into you, impact rippling through your e...
      scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his hips into you, impact rippling through your entire body. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to pull you harder onto his fat chode.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You gasp as <<$npcdesc>> slams his cock into you and the impact ripples through ...
        scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his cock into you and the impact ripples through your entire body. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to pull you harder onto his skinny dick.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You gasp as <<$npcdesc>> slams his cock into you and the impact ripples through ...
          scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his cock into you and the impact ripples through your entire body. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to pull you harder onto his cock.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You gasp as <<$npcdesc>> slams his cock into you and the impact ripples through ...
            scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his cock into you and the impact ripples through your entire body. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to pull you harder onto his thick shaft.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You gasp as <<$npcdesc>> slams his cock into you and the impact ripples through ...
              scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his cock into you and the impact ripples through your entire body. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to pull you harder onto his long shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You gasp as <<$npcdesc>> slams his cock into you and the impact ripples through ...
                scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his cock into you and the impact ripples through your entire body. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to force his huge cock deeper inside you.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You gasp as <<$npcdesc>> slams his cock into you and the impact ripples through ...
                  scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his cock into you and the impact ripples through your entire body. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to force his enormous cock deeper inside you.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You gasp as <<$npcdesc>> slams his cock into you and the impact ripples through ...
                    scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his cock into you and the impact ripples through your entire body. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to force his lengthy shaft as deep as it can go inside you.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You gasp as <<$npcdesc>> slams his cock into you and the impact ripples through ...
                      scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his cock into you and the impact ripples through your entire body. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to force as much of his gigantic cock inside you as he can.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: You gasp as <<$npcdesc>> slams his cock into you and the impact ripples through ...
                        scene.text(`You gasp as ${((s as any).npcdesc ?? 0)} slams his cock into you and the impact ripples through your entire body. As your head jerks forward, ${((s as any).npcdesc ?? 0)}'s hand grabs hold of your hair, yanking on it to force as much of his monstrously huge cock inside you as he can.`);
                      }
                    }
                  }
                }

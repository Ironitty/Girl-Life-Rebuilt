  ...
  if (((s as any).stat ?? 0)?.['think_virgin'] === 1  &&  ((s as any).sex_ev ?? 0)?.['virgin_fuck'] === 0  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
    ...
    if (((s as any).sex_ev ?? 0)?.['first_insertion'] === 0) {
      ...
      if (((s as any).sex_ev ?? 0)?.['initiative'] === 'girl') {
        scene.actions([
          { label: 'Spread your legs', goto: ['sex_ev_miss', 'miss_spread'] },
        ]);
      } else {
        if (((s as any).sex_ev ?? 0)?.['last_position'] !== ((s as any).sex_ev ?? 0)?.['position']) {
          scene.actions([
            { label: 'Continue', goto: ['sex_ev_miss', 'miss_switch'] },
          ]);
        } else {
...
function enterMissGoto2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['fuck_count'] !== 0  ||  ((s as any).sex_ev ?? 0)?.['first_insertion'] === 1) {
    ...
    if (((s as any).sex_ev ?? 0)?.['mood_type'] === 'romantic'  &&  ((s as any).sex_ev ?? 0)?.['speed'] < 3) {
      scene.actions([
        { label: '', labelFn: (s: GameState) => 'Make love to ' + String(((s as any).npcdesc ?? '') ?? ''), goto: ['sex_ev_miss', 'miss' + String((((s as any).sex_ev ?? {})['speed'])) + '.2'] },
      ]);
    } else {
      scene.actions([
        { label: '', labelFn: (s: GameState) => 'Let ' + String(((s as any).npcdesc ?? '') ?? '') + ' fuck you', goto: ['sex_ev_miss', 'miss' + String((((s as any).sex_ev ?? {})['speed'])) + '.2'] },
      ]);
    }
  } else {
...
function enterMissionaryStart(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['think_virgin'] === 1  &&  ((s as any).sex_ev ?? 0)?.['virgin_fuck'] === 0  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
    ...
    if (((st as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
      scene.text(`${((st as any).npcdesc ?? '')} pushes you down onto the bed and puts his hands on your knees and spreads your legs apart, preparing to fuck you.`);
    } else {
      if (((st as any).sex_ev ?? 0)?.['position'] === 'miss') {
        scene.text(`${((st as any).npcdesc ?? '')} grabs you by the hips and pulls you back towards him, quickly sliding his cock back into your waiting pussy.`);
      } else {
        scene.text(`${((st as any).npcdesc ?? '')} pushes you down onto the bed and puts his hands on your knees and spreads your legs apart, preparing to fuck you.`);
        scene.text('"I get to be on top this time," he grins.');
      }
    }
    qspCall(st, 'sex_ev_anal', 'no_ass_to_pussy1');
    scene.actions([
      { label: 'Insertion', goto: ['sex_ev_miss', 'miss_insert_slow'] },
    ]);
  } },
    ...
    if (((st as any).sex_ev ?? 0)?.['condom'] === 0) {
      ((st as any).sex_ev = (st as any).sex_ev ?? {})['no_condom'] = 1;
    }
    scene.img('images/shared/sex/foreplay/miss2.jpg');
    if (((st as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
      scene.text(`You lean back, spreading your legs and pussy wide for ${((st as any).npcdesc ?? '')}.`);
    } else {
      if (((st as any).sex_ev ?? 0)?.['position'] === 'miss') {
        scene.text('You lean back and spread your legs, beckoning him back between them.');
      } else {
        if (((st as any).sex_ev ?? 0)?.['position'] === 'doggy'  ||  ((st as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
          scene.text('"I want you on top this time," you whisper huskily.');
        } else {
          scene.text(`"I need you inside me again," you whisper, spreading your legs and pussy wide for ${((st as any).npcdesc ?? '')}.`);
        }
      }
    }
    scene.actions([
...
function enterMissSwitch(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['change_pos'] === 0) {
    ...
    scene.actions([
      { label: 'Fuck in missionary', goto: ['sex_ev_miss', 'miss' + String((((s as any).sex_ev ?? {})['speed'])) + '.2'] },
    ]);
  }
  scene.build();
}
...
function enterMissInsertReact(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).npc_vaginal_count ?? 0)?.[String((st as any).npcID ?? 0)] === 0) {
      if (((st as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
    ...
    qspGoto(st, 'sex_ev_miss', 'miss_goto2');
  } },
      ]);
    }
    scene.actions([
    ...
    if (((st as any).npc_last_sex ?? 0)?.[String((st as any).npcID ?? 0)] > ((st as any).daystart ?? 0) - 7) {
      if (((st as any).npc_dick_class ?? 0)[String((st as any).locArgs?.[1] ?? '')] === 'big'  ||  ((st as any).npc_dick_class ?? 0)[String((st as any).locArgs?.[1] ?? '')] === 'extra_big') {
        scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((st as any).dick_desc ?? '')} cock into your pussy, and give him a lascivious smile, squeezing yourself around his shaft. "<i>There's</i> my favorite big boy..."`);
      } else {
        scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((st as any).dick_desc ?? '')} cock into your pussy, and give him a lascivious smile, squeezing yourself around his shaft. "<i>There's</i> my favorite boy's toy..."`);
      }
    } else {
      if (((st as any).npc_last_sex ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
        if (((st as any).npc_dick_class ?? 0)[String((st as any).locArgs?.[1] ?? '')] === 'big'  ||  ((st as any).npc_dick_class ?? 0)[String((st as any).locArgs?.[1] ?? '')] === 'extra_big') {
          scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((st as any).dick_desc ?? '')} cock into your pussy, and give him a lascivious smile. "I've missed having this big boy inside me..."`);
        } else {
          scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((st as any).dick_desc ?? '')} cock into your pussy, and give him a lascivious smile. "I've missed having your cock inside me..."`);
        }
      } else {
        if (((st as any).npc_dick_class ?? 0)[String((st as any).locArgs?.[1] ?? '')] === 'big'  ||  ((st as any).npc_dick_class ?? 0)[String((st as any).locArgs?.[1] ?? '')] === 'extra_big') {
          if (((st as any).stat ?? 0)?.['biggest_cock'] < ((st as any).npc_dick ?? 0)?.[String((st as any).npcID ?? 0)]) {
            scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((st as any).dick_desc ?? '')} cock into your pussy, and give him a lascivious smile. "I've never had a cock this big inside me before..."`);
          } else {
            scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((st as any).dick_desc ?? '')} cock into your pussy, and give him a lascivious smile. "I love big cocks..."`);
          }
        } else {
          scene.text(`"Ah~!" you moan, legs kipping as he finishes inserting his ${((st as any).dick_desc ?? '')} cock into your pussy, and give him a lascivious smile. "You're a perfect fit for my pussy..."`);
        }
      }
    }
    qspGoto(st, 'sex_ev_miss', 'miss_goto2');
    ...
    scene.actions([
      { label: 'Gasp', handler: (st: GameState) => {
    scene.text(`Your legs kip up in discomfort as ${((st as any).npcdesc ?? '')} rests his weight on top of you, immediately hitting an awkward angle that causes you to gasp as pain lances through your pussy.`);
    qspGoto(st, 'sex_ev_miss', 'miss_goto2');
  } },
    ]);
  } },
...
function enterMissInsertOrgasm(s: GameState, scene: SceneBuilder): void {
  if (((s as any).trait_vars ?? 0)?.['sensitivity'] > 0  ||  (((s as any).orgasm_buildup ?? 0) >= 100  &&  (((s as any).trait_vars ?? 0)?.['sensitivity'] >= 0  ||  ((s as any).trait_vars ?? 0)?.['sensitivity_override'] === 1))) {
    ...
    if (((st as any).trait_vars ?? 0)?.['sensitive_pussy'] > 0) {
      scene.actions([
...
function enterMissionaryChangePosition(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    scene.text(`"I'm not really feeling missionary right now," you say, looking up at ${((st as any).npcdesc ?? '')}. "Could we try another position for now?"`);
...
function enterMissPain1(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 20) + 1) >= ((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)]) {
    ...
    scene.text(`Every time ${((st as any).npcdesc ?? '')} moves it's like a knife in your pussy, stabbing your insides like the villain in a slasher flick.`);
    qspGoto(st, 'sex_ev_miss', 'miss_pain2');
  } },
    ]);
  }
  if (((s as any).dick_desc ?? 0) === 'long'  ||  ((s as any).dick_desc ?? 0) === 'huge'  ||  ((s as any).dick_desc ?? 0) === 'enormous'  ||  ((s as any).dick_desc ?? 0) === 'lengthy'  ||  ((s as any).dick_desc ?? 0) === 'gigantic'  ||  ((s as any).dick_desc ?? 0) === 'monstrous') {
    ...
    scene.text(`Every thrust of ${((st as any).npcdesc ?? '')}'s hips elicits a gasp of pain from your lips. His cock is too much for your poor pussy and it's hard to enjoy.`);
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMissPain2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  scene.build();
...
function enterMissPain2(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    scene.img('images/shared/sex/vag/miss/3.jpg');
    scene.text(`As much as you want the pain to stop, the idea of speaking up and ruining the mood makes you cringe. Instead, you grit your teeth and grunt in time with ${((st as any).npcdesc ?? '')}'s thrusts and hope that the pain is not too audible in your voice.`);
    qspCall(st, 'sex_ev_cum', 'fuck_cum');
    qspCall(st, 'sex_ev_sex', 'fuck_continue');
  } },
    { label: '', labelFn: (s: GameState) => 'Tell ' + String(((s as any).npcdesc ?? '') ?? '') + ' it hurts', goto: ['sex_ev_miss', 'miss_pain3'] },
    ...
    if (((((st as any).npc_selfish ?? 0)?.[String((st as any).npcID ?? 0)] === 1  &&  ((st as any).npc_fav_pos ?? 0)?.[String((st as any).npcID ?? 0)] === 'miss')  ||  ((st as any).npc_abusive ?? 0)?.[String((st as any).npcID ?? 0)] === 1)  &&  ((st as any).npc_caretaker ?? 0)?.[String((st as any).npcID ?? 0)] !== 1) {
      qspCall(st, 'sex_ev_sex', 'fuck_no_cum_code');
      scene.text(`"No way," ${((st as any).npcdesc ?? '')} grunts back. "I'm enjoying this."`);
      ...
      scene.text(`${((st as any).npcdesc ?? '')} pauses, his cock halfway inside you.`);
...
function enterMissPain3(s: GameState, scene: SceneBuilder): void {
  if ((((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] > 0  ||  (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 3) + 1) >= 2))  &&  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] !== 1) {
    ...
    if (((st as any).sex_ev ?? 0)?.['dick_too_big'] === 1) {
      ...
      scene.text(`You spend a couple minutes with ${((st as any).npcdesc ?? '')}'s entire length inside you, taking deep breaths as you slowly let it stretch your pussy. Eventually the pain fades to nothing more than a dull ache and even maybe feels a little good.`);
...
function enterMiss1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['orgasm'] = ((st as any).orgasm ?? 0);
    scene.text(`Closing your eyes, you try to focus on the sensations, ${((st as any).npcdesc ?? '')} on top of you, his cock slowly moving inside you, going in and out... in and out... in and ou-`);
    ...
    scene.text(`As much as you want ${((st as any).npcdesc ?? '')} to pick up the pace, you don't want to be a bitch about it so you bite your tongue, going back to trying to get off on this or at least derive some kind of enjoyment out of it, ultimately failing on both counts.`);
    qspCall(st, 'sex_ev_cum', 'fuck_cum');
    qspCall(st, 'sex_ev_sex', 'fuck_continue');
  } },
      { label: 'Can you fuck me faster?', handler: (st: GameState) => {
    scene.img('images/shared/sex/vag/miss/slow2.mp4');
    scene.text(`"This is boring," you say, staring up at ${((st as any).npcdesc ?? '')} with a bored look on your face. "Can you go faster? I'm never going to get off at this rate."`);
    ...
    scene.img('images/shared/sex/vag/miss/slow2.mp4');
    scene.text(`"Hey," you say, looking ${((st as any).npcdesc ?? '')} right in the eyes. "I didn't come here for you to hump me like a Disney princess. I came here to <b>fuck.</b> Now fuck me like you mean it already!"`);
    if ((Math.floor(Math.random() * 2) + 0) === 1) {
...
function enterMiss3(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] < 75) {
    ...
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
    scene.text(`An uncontrollable gasp escapes your lips as ${((st as any).npcdesc ?? '')}'s hips pound into yours over and over again. He's incessant, smashing into your pussy over.`);
    ...
    if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 50) {
      scene.actions([
        { label: 'Enjoy it', handler: (st: GameState) => {
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
    scene.text(`Your eyes roll back in your head as ${((st as any).npcdesc ?? '')} incessantly pounds into you with his ${((st as any).dick_desc ?? '')} cock. Not every thrust is clean and every once in a while he bangs into you in a way that causes a sharp jab of pain inside you. But that's just part of going rough and you focus on the good ones, letting the bad ones roll on past.`);
    qspCall(st, 'sex_ev_cum', 'fuck_cum');
    qspCall(st, 'sex_ev_sex', 'fuck_continue');
  } },
        { label: 'Fake enjoyment', handler: (st: GameState) => {
  ...
  if (((s as any).sex_ev ?? 0)?.['rough_enjoy'] !== 1) {
    ...
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
    scene.text(`You scream another cry of agonizing pleasure and glare at ${((st as any).npcdesc ?? '')}.`);
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMiss3EnjoyDesc(st, scene); (st as any).locArgs = __savedLocArgs; }
    qspCall(st, 'sex_ev_cum', 'fuck_cum');
    qspCall(st, 'sex_ev_sex', 'fuck_continue');
  } },
      ]);
      ...
      scene.img('images/shared/sex/vag/miss/1.jpg');
      scene.text(`"Oh fuck! It hurts!" you moan and ${((st as any).npcdesc ?? '')} stops abruptly.`);
...
function enterMiss3_1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (((s as any).npc_knows_pc_likes_rough ?? 0)?.[String((s as any).npcID ?? 0)] === 0  ||  ((s as any).sex_ev ?? 0)?.['rough_enjoy'] !== 1)) {
    ...
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['rough_enjoy'] = 1;
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMiss3_1Desc(st, scene); (st as any).locArgs = __savedLocArgs; }
    qspCall(st, 'sex_ev_cum', 'fuck_cum');
    qspCall(st, 'sex_ev_sex', 'fuck_continue');
  } },
...
function enterMissKiss(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['kiss_skip'] = 1;
    if (((st as any).npc_no_kiss ?? 0)?.[String((st as any).npcID ?? 0)] === 2) {
    ...
    if (((st as any).sex_ev ?? 0)?.['cuni_count'] > 0) {
      scene.text(`You let ${((st as any).npcdesc ?? '')}'s lips touch yours and feel his tongue snake into your mouth and start to wrestle against your own, accompanied by an additional salty flavour that you recognize as the taste of your own pussy.`);
    } else {
      if (((st as any).npc_smoker ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
        scene.text(`You let ${((st as any).npcdesc ?? '')}'s lips touch yours and feel his tongue snake into your mouth and start to wrestle against your own.`);
      } else {
        scene.text(`You let his ${((st as any).npcdesc ?? '')}'s touch yours and feel his tongue snake into your mouth and start to wrestle against your own.`);
      }
    }
    if (((st as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
      if (((st as any).sex_ev ?? 0)?.['virgin'] === 1) {
        if (((st as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
          ((st as any).sex_ev = (st as any).sex_ev ?? {})['fuck_pain'] = 0;
          ((st as any).sex_ev = (st as any).sex_ev ?? {})['fuck_enjoyment'] = 'unsatisfying';
          scene.text(`You kiss ${((st as any).npcdesc ?? '')} back with all your might, trying to find something to distract yourself from the pain. All your focus is on the kiss and his lips and his tongue and the taste. It comes to you with a start that after the kiss breaks, you're not in as much pain as you were before.`);
        } else {
          if (((st as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
            scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips as you kiss ${((st as any).npcdesc ?? '')} back. The pain of your virgin pussy getting fucked is still overwhelming, but try not to let it show, hoping to distract both ${((st as any).npcdesc ?? '')} and yourself by returning the kiss.`);
          } else {
            if (((st as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
              scene.text(`Your attempts to kiss ${((st as any).npcdesc ?? '')} back are clumsy at best, as opening your mouth at all puts you in danger of screaming in pain and bursting into tears. He continues fucking your virgin pussy and you nearly sob directly into his mouth as he kisses you.`);
            }
          }
        }
      } else {
        if (((st as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
          ...
          if (((st as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
            scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips as you kiss ${((st as any).npcdesc ?? '')} back. The pain in your pussy is still overwhelming, but try not to let it show, hoping to distract both ${((st as any).npcdesc ?? '')} and yourself by returning the kiss.`);
          } else {
            if (((st as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
              scene.text(`Your attempts to kiss ${((st as any).npcdesc ?? '')} back are clumsy at best, as opening your mouth at all puts you in danger of screaming in pain and bursting into tears. He continues fucking your pussy in the most painful way possible and you nearly sob directly into his mouth as he kisses you.`);
            }
          }
        }
      }
      ...
      if (((st as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
        if (((st as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
          ((st as any).sex_ev = (st as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
          scene.text(`A spark fires off somewhere inside you and suddenly find yourself kissing ${((st as any).npcdesc ?? '')} back with passion as heat spreads through your hips. Your arousal has been awakened and wetness spreads between your legs as you force your tongue into ${((st as any).npcdesc ?? '')}'s mouth.`);
        } else {
          if (((st as any).sex_ev ?? 0)?.['moan'] === 1) {
            scene.text(`You grunt passively into ${((st as any).npcdesc ?? '')}'s mouth as he kisses you while continuing to fuck you. The kiss isn't really helping much, but it could be worse you guess.`);
          } else {
            if (((st as any).sex_ev ?? 0)?.['moan'] === 2) {
              scene.text(`You moan softly into ${((st as any).npcdesc ?? '')}'s mouth as he kisses you while continuing to fuck you and hope with every fibre of your being that it's convincing because neither the kiss nor his cock between your legs is doing anything for you.`);
            }
          }
        }
      } else {
        if (((st as any).sex_ev ?? 0)?.['bored'] === 1) {
          scene.text('<i>At least this part feels good,</i> you think to yourself, allowing a small smile to break through.');
        } else {
          if (((st as any).sex_ev ?? 0)?.['orgasm'] < ((st as any).orgasm ?? 0)) {
            if (((st as any).sex_ev ?? 0)?.['cuni_count'] > 0) {
              scene.text(`You smile up at ${((st as any).npcdesc ?? '')} as his lips meet yours. They taste slightly... salty... and you realize with a start that it's the flavour of your own pussy, being passed back into your mouth. His tongue pushes up against yours, gently complimenting the pleasure of his cock inside you. You close your eyes, letting them roll back in your head, knowing that he's about to make you come.`);
            } else {
              if (((st as any).npc_smoker ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
                scene.text(`You smile up at ${((st as any).npcdesc ?? '')} as his lips meet yours. His tongue, tasting vaguely of smoke and tobacco, pushes up against yours, gently complimenting the pleasure of his cock inside you. You close your eyes, letting them roll back in your head, knowing that he's about to make you come.`);
              } else {
                scene.text(`You smile up at ${((st as any).npcdesc ?? '')} as his lips meet yours. They press softly together and his tongue spreads them apart to push up against yours, gently complimenting the pleasure of his cock inside you. You close your eyes, letting them roll back in your head, knowing that he's about to make you come.`);
              }
            }
          } else {
            if (((st as any).npc_smoker ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
              scene.text(`You smile up at ${((st as any).npcdesc ?? '')} as his lips meet yours. His tongue, tasting vaguely of smoke and tobacco, spreads them apart to push up against yours, gently complimenting the pleasure of his cock inside you.`);
            } else {
...
function enterMiss1_2DirtyTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'cock') {
    if ((Math.floor(Math.random() * 3) + 1) === 1) {
      scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Fuck~!" you pant. "Your cock is so fucking hard inside me~! Oh fuck~! Oh fuck~!"\', \'<i>"Nngh~!"</i> you groan. "You\'re so hard inside me~! <i>Mmph~!</i> It feels so good~!"\')');
    } else {
      if ((Math.floor(Math.random() * 2) + 1) === 1) {
        if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Fuck~! Yes~! Just like that~!" you moan. "Fuck me with your tiny dick!"\', \'"Fuck~! Yes~! Just like that~!" you moan. "Your tiny dick feels so good~!"\')');
        } else {
          if (((s as any).dick_desc ?? 0) === 'chode') {
            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Fuck~! Yes~! Just like that~!" you moan. "Don\'t stop! Fuck me with your fat chode!"\', \'"Ah~! You\'re so <i>thick</i>~!" you moan. "You feel so good~!"\')');
          } else {
            if (((s as any).dick_desc ?? 0) === 'skinny') {
              scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Fuck~! Yes~! Just like that~!" you moan. "Fuck me with your skinny dick~!"\', \'"Ah~! You slide in so easily~!" you moan. "Ahh~! Your skinny dick feels so good~!"\')');
            } else {
              if (((s as any).dick_desc ?? 0) === 'normal') {
                scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Fuck~! Yes~! Just like that~!" you moan. "Nngh~! So good~!"\', \'"Ah~! Your cock feels so good~!" you moan. "Nngh~! So good~!"\')');
              } else {
                if (((s as any).dick_desc ?? 0) === 'thick') {
                  scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Oh fuck~! You\'re so <i>thick</i>!" you moan. "Ungh~! Fuck me with your big cock~!"\', \'"Ah~! You\'re so <i>thick</i>!" you moan. "Ungh~! You\'re stretching me out! It\'s so good!"\')');
                } else {
                  if (((s as any).dick_desc ?? 0) === 'long') {
                    scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! Fuck~! You\'re so deep~!" you groan. "Nngh~! Right there! Right fucking there~!"\', \'"Ungh~! You\'re so deep~!" you groan. "Nngh~! It\'s so deep inside me~! Ah~!"\')');
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'huge') {
                      scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ahh~! Yes~! Just like that~!" you groan. "Ungh~! Fuck me with your huge cock~!"\', \'"Ungh~! You\'re so <i>big</i>!" you groan. "Ohmygoodness~! It\'s driving me crazy~!"\')');
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'enormous') {
                        scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! You\'re cock is <i>enormous</i>~!" you groan. "Ahhn~! It\'s amazing~!"\', \'"Ungh~! You\'re <i>enormous</i>~!" you groan. "It\'s filling me up~! It\'s stretching me out~! Unngh~! I can barely breathe~!"\')');
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'lengthy') {
                          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~!" you groan, your voice a hoarse with arousal. "Oh <i>fuck!</i> Your cock is so fucking long! I feel you in my stomach~!"\', \'"Ungh~! <i>Icanfeelyouinmystomach~!</i>" you groan, your voice a hoarse with arousal. "Oh <i>sugar~!</i> It\'s <i>so</i> deep inside me~!"\')');
                        } else {
                          if (((s as any).dick_desc ?? 0) === 'gigantic') {
                            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! <i>Fuck!</i>" you groan, your voice a hoarse with arousal. "Oh <i>fuck!</i> You\'re so <i>fucking big</i>! I can feel you in my stomach~!"\', \'"Ungh~! Your cock is <i>gigantic!</i>" you groan, your voice a hoarse with arousal. "Ah~! <i>Icanfeelyouinmystomach~!</i> Mmph~! <i>Ohyouresobig~!</i>"\')');
                          } else {
                            if (((s as any).dick_desc ?? 0) === 'monstrous') {
                              scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! <i>Fuck!</i>" you groan, your voice a hoarse with arousal. "Oh <i>fuck!</i> You\'re so <i>fucking big</i>! You\'re gonna rip me in half~!"\', \'"Ungh~! Oh <i>sugar!</i>" you groan, your voice a hoarse with arousal. "Your cock is insane~! It\'s gonna tear me in half~! I\'m gonna go crazy~!"\')');
                            }
                          }
                        }
                      }
        ...
        if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Haa~! Ahh~!" you moan. "I\'m addicted to your tiny dick!"\', \'"Haa~! Ahh~!" you moan. "I\'m addicted to your tiny dick!"\')');
        } else {
          if (((s as any).dick_desc ?? 0) === 'chode') {
            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah~! Your cock feels so good!" you moan. "Don\'t stop! Fuck me with your fat chode!"\', \'"Ahh~!" you moan. "Your chode is so thick~! It feels so good~!"\')');
          } else {
            if (((s as any).dick_desc ?? 0) === 'skinny') {
              scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah~! Your cock feels so good!" you moan.\', \'"Ah~! Your cock feels so good!" you moan.\')');
            } else {
              if (((s as any).dick_desc ?? 0) === 'normal') {
                scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah~! I fucking love your cock~!" you moan. "Iloveit!Iloveit!Iloveit!Iloveit!"\', \'"You\'re a perfect fit for my pussy," you moan.\')');
              } else {
                if (((s as any).dick_desc ?? 0) === 'thick') {
                  scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah~! You\'re so big!" you moan. "Ungh~! You\'re stretching me out! It\'s so good!"\', \'"Ah~! You\'re so big!" you moan. "Ungh~! You\'re stretching me out! It\'s so good!\')');
                } else {
                  if (((s as any).dick_desc ?? 0) === 'long') {
                    scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~!" you groan. "You\'re so deep! Nngh~! Right there! Right there~!"\', \')');
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'huge') {
                      scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~!" you groan. "Your cock is so <i>big</i>! You\'re so huge!"\', \')');
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'enormous') {
                        scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~!" you groan. "I love your <i>big fucking cock</i>~! Nngh~! It\'s driving me crazy~!"\', \')');
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'lengthy') {
                          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! <i>Fuck!</i>" you groan, your voice a hoarse with arousal. "I can feel you in my stomach~!"\', \')');
                        } else {
                          if (((s as any).dick_desc ?? 0) === 'gigantic') {
                            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! <i>Fuck!</i>" you groan, your voice a hoarse with arousal. "Oh <i>fuck!</i> You\'re so <i>fucking big</i>! I can feel you in my stomach~!"\', \')');
                          } else {
                            if (((s as any).dick_desc ?? 0) === 'monstrous') {
                              scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! <i>Fuck!</i>" you groan, your voice a hoarse with arousal. "Oh <i>fuck!</i> You\'re so <i>fucking big</i>! You\'re gonna rip me in half~!"\', \')');
                            }
                          }
                        }
                      }
    ...
    if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'arousal') {
      if (((s as any).pcs_horny ?? 0) >= 70) {
        if ((Math.floor(Math.random() * 2) + 0) === 1) {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! Yes~! Fuck~!" you moan softly, barely louder than a whisper. "You\'re gonna make me come~!"\', \')');
        } else {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Oh <i>fuck</i>~! OhshitImgonnacum~!" you moan. "I\'m gonna cum~!"\', \')');
        }
      } else {
        if ((Math.floor(Math.random() * 2) + 0) === 1) {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! I\'m <i>so</i> wet..." you mew softly. "You feel so good inside me~!"\', \')');
        } else {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah~! That feels <i>so good</i>," you moan quietly. "I\'m gonna go crazy~!"\', \')');
        }
      }
    } else {
      if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'technique') {
        if ((Math.floor(Math.random() * 2) + 0) === 1) {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Yes~! Just like that~!" you moan. "You\'re so good~! Don\'t stop~! Don\'t stop~!"\', \')');
        } else {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Right there~! Right there~!" you moan hoarsely. "Keep going~!"\', \')');
        }
      } else {
...
function enterMiss2_2DirtyTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'cock') {
    if ((Math.floor(Math.random() * 3) + 1) === 1) {
      ...
      if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
        scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i> Just like that!" you moan loudly. "Fuck my pussy with your tiny dick! Oh fuck! Oh fuck!"\', \')');
      } else {
        if (((s as any).dick_desc ?? 0) === 'chode') {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i> Just like that!" you moan loudly. "Fuck my pussy with your fat chode! Oh fuck! You\'re so thick!"\', \')');
        } else {
          if (((s as any).dick_desc ?? 0) === 'skinny') {
            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i>" you moan loudly. "Fuck my pussy with your skinny dick! Right there! Right there!"\', \')');
          } else {
            if (((s as any).dick_desc ?? 0) === 'normal') {
              scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i>" you moan loudly. "You fill me up so perfectly! Fuck! It\'s so good!"\', \')');
            } else {
              if (((s as any).dick_desc ?? 0) === 'thick') {
                if (((s as any).pcs_vag ?? 0) <= 10) {
                  scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i> Just like that!" you moan loudly. "Fuck! You\'re stretching me out! You\'re stretching me out! It\'s so good! Fuck my pussy with your fat cock!"\', \')');
                } else {
                  scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i> Yes!" you moan loudly. "Fuck! You\'re so big! Fuck my pussy with your fat cock! It\'s so good!"\', \')');
                }
              } else {
                if (((s as any).dick_desc ?? 0) === 'long') {
                  scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i> Just like that!" you moan loudly. "Ungh~! You\'re <i>so</i> deep! Ah~! It\'s so good!"\', \')');
                } else {
                  if (((s as any).dick_desc ?? 0) === 'huge') {
                    scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i> Just like that!" you moan loudly. "Fuck~! You\'re so big~! Fuck my pussy with your huge cock! Ungh~! You\'re <i>so</i> deep!"\', \')');
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'enormous') {
                      scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i> Just like that!" you moan loudly. "Fuck~! You\'re so big~! You\'re <i>so</i> deep! You\'re <i>so big!</i>"\', \')');
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'lengthy') {
                        scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i> Just like that!" you moan loudly. "Oh <i>fuck!</i> You\'re so big~! I can feel you in my stomach~! It\'s so good!"\', \')');
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'gigantic') {
                          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah! <i>Fuck!</i> Just like that!" you moan loudly. "Oh <i>fuck!</i> You\'re so <i>fucking big</i>! I can feel you in my stomach~! It feels so good!"\', \')');
                        } else {
                          if (((s as any).dick_desc ?? 0) === 'monstrous') {
                            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! <i>Fuck!</i> Just like that!" you moan loudly. "Fuck me with your monster cock~! Oh <i>fuck!</i> You\'re so <i>fucking big</i>! You\'re tearing me in half! Don\'t stop~! Don\'t stop~! Don\'t stop~!"\', \')');
                          }
                        }
                      }
                    }
    ...
    if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'arousal') {
      if (((s as any).pcs_horny ?? 0) >= 70) {
        if ((Math.floor(Math.random() * 2) + 0) === 1) {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! Yes~! Fuck~!" you pant. "You\'re gonna make me come~!"\', \')');
        } else {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Oh fuck~! <i>I\'m gonna come~! I\'m gonna come~! I\'m gonna come~!</i>" you moan. "Don\'t stop!"\', \')');
        }
      } else {
        if ((Math.floor(Math.random() * 2) + 0) === 1) {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! I\'m <i>so</i> wet..." you moan. "You feel so good inside me~!"\', \')');
        } else {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"My pussy can\'t get enough of you," you moan. "You\'re making me so wet~!"\', \')');
        }
      }
    } else {
      if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'technique') {
        if ((Math.floor(Math.random() * 2) + 0) === 1) {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Yes~! Just like that~!" you moan. "You\'re so fucking good~! Don\'t stop~! Don\'t stop~!"\', \')');
        } else {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ah~! You\'re so good~!" you moan. "You\'re driving me crazy~!"\', \')');
        }
      } else {
        if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'dirty_girl') {
          if (((s as any).npc_dirty_lover ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
...
function enterMiss3_2DirtyTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'cock') {
    if ((Math.floor(Math.random() * 3) + 1) === 1) {
      ...
      if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
        scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Yes! Yes! Just like that!" you scream at the top of your lungs. "Fuck me with your tiny cock! Pound my pussy with your pencil dick!"\', \')');
      } else {
        if (((s as any).dick_desc ?? 0) === 'chode') {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Yes! Yes! Just like that!" you scream at the top of your lungs. "Fuck me with your fat chode! Pound my pussy!"\', \')');
        } else {
          if (((s as any).dick_desc ?? 0) === 'skinny') {
            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Yes! Yes! Just like that!" you scream at the top of your lungs. "Fuck me with your skinny dick! Pound my pussy!"\', \')');
          } else {
            if (((s as any).dick_desc ?? 0) === 'normal') {
              scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Yes! Yes! Just like that!" you scream at the top of your lungs. "Fuck me with your cock! Pound my pussy!"\', \')');
            } else {
              if (((s as any).dick_desc ?? 0) === 'thick') {
                if (((s as any).pcs_vag ?? 0) <= 10) {
                  scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"OH FUCK!" you scream at the top of your lungs. "<i>Fuck!</i> You\'re gonna tear me in half! Don\'t stop! Don\'t stop!"\', \')');
                } else {
                  scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"OH FUCK!" you scream at the top of your lungs. "<i>Fuck!</i> Your cock is so big! Don\'t stop! Don\'t stop! Pound my pussy!"\', \')');
                }
              } else {
                if (((s as any).dick_desc ?? 0) === 'long') {
                  scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"OH FUCK!" you scream at the top of your lungs. "<i>Fuck!</i> You\'re <i>so</i> deep! Don\'t stop! Don\'t stop! Pound my pussy!"\', \')');
                } else {
                  if (((s as any).dick_desc ?? 0) === 'huge') {
                    scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"OH FUCK!" you scream at the top of your lungs. "You\'re so big! You\'re <i>so</i> big! Don\'t stop! Pound my pussy with your huge cock!"\', \')');
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'enormous') {
                      if (((s as any).pcs_vag ?? 0) <= 10) {
                        scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"OH FUCK!" you scream at the top of your lungs. "<i>Fuck!</i> You\'re <i>so</i> big! You\'re gonna tear me in half! Don\'t stop! Don\'t stop!"\', \')');
                      } else {
                        scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"OH FUCK!" you scream at the top of your lungs. "<i>Fuck!</i> You\'re so big! You\'re <i>so</i> big! Oh fuck! Don\'t stop! Don\'t stop! Don\'t fucking stop!"\', \')');
                      }
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'lengthy') {
                        scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"OH FUCK!" you scream at the top of your lungs. "<i>Fuck!</i> I feel you in my stomach~! It\'s so good!!"\', \')');
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'gigantic') {
                          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"OH FUCK!" you scream at the top of your lungs. "Oh <i>fuck!</i> You\'re <i>so</i> deep! You\'re so <i>fucking big</i>! I can feel you in my stomach~! Don\'t stop~!"\', \')');
                        } else {
                          if (((s as any).dick_desc ?? 0) === 'monstrous') {
                            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"OH FUCK!" you scream at the top of your lungs. "<i>Fuck!</i> I feel you in my stomach~! Oh <i>fuck!</i> You\'re so big! You\'re <i>so</i> big! You\'re so <i>fucking big</i>! You\'re gonna tear me in half! Don\'t fucking stop!"\', \')');
                          }
                        }
                      }
                    }
    ...
    if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'arousal') {
      if (((s as any).pcs_horny ?? 0) >= 70) {
        if ((Math.floor(Math.random() * 2) + 0) === 1) {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Yes~! Fuck~! Yes~!" you scream. "I love getting pounded~! You\'re gonna make me come~!"\', \')');
        } else {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Oh <i>fuck</i>~!" you scream. "I\'m so fucking wet~! I\'m gonna come~! I\'m gonna come all over your cock~!"\', \')');
        }
      } else {
        if ((Math.floor(Math.random() * 2) + 0) === 1) {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! Don\'t stop~!" you scream. "Smash my sloppy wet pussy~!"\', \')');
        } else {
          scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"My pussy can\'t get enough of you~!" you scream. "I need more~! More~! It\'s so good~!"\', \')');
        }
      }
    } else {
      if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'technique') {
        if (((s as any).pcs_horny ?? 0) >= 70) {
          if ((Math.floor(Math.random() * 2) + 0) === 1) {
            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Yes~! Fuck~! Yes~!" you scream. "Pound my fucking pussy~! Don\'t stop~! You\'re gonna make me come~!"\', \')');
          } else {
            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Oh <i>fuck</i>~!" you scream. "I\'m so fucking wet~! I\'m gonna come all over your cock~! You\'re driving me crazy~!"\', \')');
          }
        } else {
          if ((Math.floor(Math.random() * 2) + 0) === 1) {
            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"Ungh~! Don\'t stop~!" you scream. "Fuck my fucking brains out~!"\', \')');
          } else {
            scene.text('iif(stat[\'no_sex_swearing\'] = 0, \'"I love having you between my legs," you moan. "You\'re making me so wet~!"\', \')');
          }
        }
      } else {
        if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'dirty_girl') {

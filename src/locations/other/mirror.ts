...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).newstylemirror ?? 0) === 1) {
    ...
    if (((s as any).mc_inventory ?? 0)?.['lipbalm'] > 0  &&  ((s as any).pcs_lipbalm ?? 0) <= 0) {
      ((s as any).serv = (s as any).serv ?? {})['lipbalm'] = '<a href="#" onclick="window.__gameStore.setState((s) => {  /* TODO-QSP: act \u0027View results\u0027:gt \u0027mirror\u0027, \u0027start\u0027 */ return s; }); window.__gameStore.getState().doGoto(\u0027mirror\u0027, \u0027applyLipbalm\u0027 & act \u0027View results\u0027:gt \u0027mirror\u0027, \u0027start\u0027); return false;"><img src="images/system/icons/action/lipbalm.png"></a>';
    }
    if (((s as any).mc_inventory ?? 0)?.['eyelash_fake'] > 0  &&  ((s as any).pcs_lashes ?? 0) < 3  &&  ((s as any).lashextensionstyle ?? 0) <= 0) {
      ((s as any).serv = (s as any).serv ?? {})['falselashes'] = '<a href="#" onclick="window.__gameStore.setState((s) => {  /* TODO-QSP: act \u0027View results\u0027:gt \u0027mirror\u0027, \u0027start\u0027 */ return s; }); window.__gameStore.getState().doGoto(\u0027mirror\u0027, \u0027applyLashesplain\u0027 & act \u0027View results\u0027:gt \u0027mirror\u0027, \u0027start\u0027); return false;"><img src="images/system/icons/action/falselashes.png"></a>';
    }
    if (((s as any).mc_inventory ?? 0)?.['eyelash_mink'] > 0  &&  ((s as any).pcs_lashes ?? 0) < 4  &&  ((s as any).lashextensionstyle ?? 0) <= 0) {
      ((s as any).serv = (s as any).serv ?? {})['minklashes'] = '<a href="#" onclick="window.__gameStore.setState((s) => {  /* TODO-QSP: act \u0027View results\u0027:gt \u0027mirror\u0027, \u0027start\u0027 */ return s; }); window.__gameStore.getState().doGoto(\u0027mirror\u0027, \u0027applyLashesmink\u0027 & act \u0027View results\u0027:gt \u0027mirror\u0027, \u0027start\u0027); return false;"><img src="images/system/icons/action/minklashes.png"></a>';
    }
    if (((s as any).pcs_makeup ?? 0) === ((s as any).makeup ?? 0)?.['base']  &&  ((s as any).mc_inventory ?? 0)?.['cosmetics'] > 0) {
      ...
      ((s as any).serv = (s as any).serv ?? {})['makeup'] = '<a href="#" onclick="window.__gameStore.setState((s) => { dynamicGoto(s, String((s as any).serv4 || \u0027\u0027)); return s; }); return false;"><img src="images/system/icons/action/makeup.png"></a>';
    }

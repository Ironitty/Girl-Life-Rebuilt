...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).newstylemirror ?? 0) === 1) {
    (s as any).serv['avatar'] = '<center><img <<$set_imgh>> src="<<func(\'$face_image\')>>"></center>';
    if (((s as any).cheatVars ?? 0)?.['auto_brush'] === 1  &&  ((s as any).pcs_hairbsh ?? 0) === 0) {
    ...
    if (((s as any).pcs_hairbsh ?? 0) < 1) {
      ...
      if (((s as any).pcs_hairlng ?? 0) > 80  &&  ((s as any).hbraids ?? 0) === 0) {
        if (((s as any).mc_inventory ?? 0)?.['scrunchies'] >= 1  &&  ((s as any).hscrunchw ?? 0) + ((s as any).hpingripw ?? 0) === 0) {
          ...
          (s as any).serv['ponytail desc'] = 'As you have a scrunchy, you can arrange your hair into a <a href="exec:hscrunchw = 1 & gs \'mirror\', \'start\'">ponytail</a>. You have <b><<mc_inventory[\'scrunchies\']>></b> scrunchies left.';
        }
        if (((s as any).pcs_hairlng ?? 0) <= 400  &&  ((s as any).mc_inventory ?? 0)?.['kirbygrips'] >= 1  &&  ((s as any).hscrunchw ?? 0) + ((s as any).hpingripw ?? 0) === 0) {
          ...
          (s as any).serv['bun desc'] = 'You have several clips, pins and grips for you hair. Hence, you can <a href="exec:hpingripw = 1 & gs \'mirror\', \'start\'">updo your hair</a>. You have <b><<mc_inventory[\'kirbygrips\']>></b> hair accessories at your disposal.';
        }
        if (((s as any).pcs_hairlng ?? 0) <= 800  &&  ((s as any).mc_inventory ?? 0)?.['scrunchies'] >= 1) {
          ...
          if (((s as any).canBraidHair ?? 0) === 1  &&  ((s as any).hscrunchw ?? 0) + ((s as any).hpingripw ?? 0) + ((s as any).hpigtail ?? 0) === 0) {
            ...
            (s as any).serv['braid desc'] = 'You can spend <<pcs_hairlng/10>> minutes <a href="exec:minut += pcs_hairlng/10 & hbraids = 15 & gs \'mirror\', \'start\'">braiding</a> your hair, just the way your sister taught you.';
          }
        }
      }
    }
    ...
    if (((s as any).hbraids ?? 0) > 0) {
      ...
      (s as any).serv['braid desc'] = 'Take <<hbraids*2+pcs_hairlng/50>> minutes removing your <a href="exec:minut += hbraids*2+pcs_hairlng/50 & hbraids = 0 & gs \'mirror\', \'start\'">braid</a>.';
    }
    ...
    if (((s as any).curly ?? 0) > 0  &&  ((s as any).defcurly ?? 0) === 0) {
      (s as any).serv['hhair'] = 'Your curly hair will last for another <b><<curly>></b> days.';
    }
    if (((s as any).straight ?? 0) > 0  &&  ((s as any).defcurly ?? 0) === 1) {
      (s as any).serv['hhair'] = 'Your straightened hair will last for another <b><<straight>></b> days.';
    }
    if (((s as any).hbraids ?? 0) > 0) {
      (s as any).serv['hbraids'] = 'Your braided hair will last for another <b><<hbraids>></b> days.';
    }
    ...
    if (((s as any).hscrunchw ?? 0) === 1) {
      ...
      // TODO-QSP: gs ''mirror'', ''start''">scrunchie</a> to get rid of the ponytail.'
    }
    if (((s as any).hscrunchw ?? 0) === 2) {
      // TODO-QSP: '<a href="exec:hpigtail = 0
      (s as any).hscrunchw = 0;
      // TODO-QSP: gs ''mirror'', ''start''">Remove</a> your scrunchies and let your hair flow free again.'
    }
    if (((s as any).hpingripw ?? 0) === 1) {
      // TODO-QSP: 'Let your hair <a href="exec:hpingripw = 0
      // TODO-QSP: gs ''mirror'', ''start''">flow free</a>.'
    }
    if (((s as any).hbraids ?? 0) > 0) {
      // TODO-QSP: 'Take <<hbraids*2+pcs_hairlng/50>> minutes removing your <a href="exec:minut += hbraids*2+pcs_hairln...
      (s as any).hbraids = 0;
      // TODO-QSP: gs ''mirror'', ''start''">braid</a>.'
    }
  }
  ...
  if (((s as any).makeup ?? 0)?.['routine_' + String(((s as any).temp_routine_index ?? 0))] !== '') {
...
function enterRoutineManage(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_routine_index = ((s as any).temp_routine_index ?? 0) + (1);
  if (((s as any).temp_routine_index ?? 0) <= ((s as any).temp_max_cosmetic_routines ?? 0)  &&  ((s as any).makeup ?? 0)?.['routine_' + String(((s as any).temp_routine_index ?? 0))] !== '') {
  ...
  scene.actions([
    ...
    (s as any).makeup['routine_' + String((s as any).temp_routine_index ?? '') + '_name'] = 'routine <<temp_routine_index>>';
    qspCall(s, 'mirror', 'routine_manage');
  } },
    { label: '<<temp_routine_index>>. Remove ""<<$temp_routine_name>>""', handler: (st: GameState) => {
    qspCall(s, 'array', 'remove_element', 'makeup', 'routine_<<temp_routine_index>>');
    qspCall(s, 'array', 'remove_element', 'makeup', 'routine_<<temp_routine_index>>_name');
    qspCall(s, 'mirror', 'routine_manage');
  } },
    { label: '<<temp_routine_index>>. Rename ""<<$temp_routine_name>>""', handler: (st: GameState) => {
    (s as any).makeup['routine_' + String((s as any).temp_routine_index ?? '') + '_name'] = qspUntranslated(s, "input ('Name the routine')", { location: "mirror" });
    qspCall(s, 'mirror', 'routine_manage');
  } },
  ]);
  scene.build();
...
function enterRoutineDescription(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_makeup'] > 0) {
    if (((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_makeup'] === 4) {
      if (((s as any).locArgs?.[2] ?? 0) === ''  &&  ((s as any).pcs_makeup ?? 0) !== 0) {
        if (((s as any).mc_inventory ?? 0)?.['cosmetics'] >= 3) {
        }
      }
    } else {
      if (((s as any).mc_inventory ?? 0)?.['cosmetics'] >= ((s as any).min ?? 0)(((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_makeup'], 3)) {
      }
    }
    if (((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_makeup'] === 1) {
      ...
      if (((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_makeup'] === 3) {
        ...
        if (((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_makeup'] === 5) {
      ...
      if (((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_lipbalm'] > 0) {
        if (((s as any).locArgs?.[2] ?? 0) === ''  &&  ((s as any).pcs_lipbalm ?? 0) < ((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_lipbalm']) {
          if (((s as any).mc_inventory ?? 0)?.['lipbalm'] > 0) {
          }
        }
      ...
      if (((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_lashes'] > 0) {
        if (((s as any).locArgs?.[2] ?? 0) === ''  &&  ((s as any).lashextensionstyle ?? 0) <= 0  &&  ((s as any).pcs_lashes ?? 0) < ((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_lashes'] + 2) {
          if ((((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_lashes'] === 1  &&  ((s as any).mc_inventory ?? 0)?.['eyelash_fake'] >= 1)  ||  (((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_lashes'] === 2  &&  ((s as any).mc_inventory ?? 0)?.['eyelash_mink'] >= 1)) {
          }
        }
        if (((s as any).makeup ?? 0)?.['routine_' + String(qspUntranslated(s, "ARGS[1]", { location: "mirror" })) + '_lashes'] === 1) {

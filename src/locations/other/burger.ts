...
function enterOffice(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).BurgerQW ?? 0)?.['IlyQWEvidence'] === 1) {
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['IlyQW'] = 6;
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['IlyQWTatianaHelp'] = 0;
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['IlyQWEvidence'] = 0;
    qspCall(s, 'stat', '');
  ...
  scene.actions([
    ...
    if (qspFunc(s, 'money', 'can_afford', 650000) === 0) {
      ...
      ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['IlyQW'] = 5;
      qspCall(s, 'stat', '');
...
function enterManager(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['sergeyQWServiced1'] = 0;
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['sergeyQWServiced2'] = 0;
    scene.text('You agree to work.');
    scene.actions([
      { label: 'Leave', goto: ['burger', 'start'] },
    ]);
...
function enterDishes(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_apprnc ?? 0) >= 80  &&  (((s as any).job_shifts_total ?? 0)?.['city_diner_dishwasher'] + ((s as any).job_shifts_total ?? 0)?.['city_diner_floor_washer']) >= 7  &&  ((s as any).BurgerQW ?? 0)?.['Level'] < 10) {
    ...
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 10;
    ...
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 20;
    qspCall(s, 'stat', '');
    ...
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 50;
    ...
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 57;
    qspCall(s, 'stat', '');
    ...
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 111;
    qspCall(s, 'stat', '');
    ...
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['IlySecurityCamDesc'] = 'You look into the envelope. Then you close the safe and head to the exit.';
    qspCall(s, 'stat', '');
    ...
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['IlyQWDay'] = ((s as any).daystart ?? 0);
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['IlyQW'] = 1;
    ...
    scene.actions([
      ...
      { label: 'Take the envelope to Ilyushkin', handler: (st: GameState) => {
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['IlySecurityCamDesc'] = 'You take the envelope, close the safe and head out.';
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['IlyQWDay'] = ((s as any).daystart ?? 0);
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['IlyQW'] = 1;
    qspCall(s, 'jobs', 'set_fired', 'city_diner_dishwasher');
    if (((s as any).job_status ?? 0)?.['city_diner_floor_washer'] === 'employed') {
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 15;
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 55;
    ...
    qspCall(s, 'willpower', 'pay', 'resist');
    qspCall(s, 'stat', '');
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 56;
    scene.img('images/locations/city/citycenter/diner/sex/bj1.jpg');
    ...
    scene.actions([
      { label: 'Leave', goto: ['burger', 'start'] },
          ...
          if (((s as any).BurgerQW ?? 0)?.['Level'] === 55) {
            ...
            scene.actions([
              { label: 'Go to the manager\'s office', handler: (st: GameState) => {
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 60;
    ...
    scene.actions([
      { label: 'Leave', goto: ['burger', 'start'] },
            ...
            if (((s as any).BurgerQW ?? 0)?.['Level'] === 60) {
              ...
              scene.actions([
                { label: 'Go to the manager\'s office', handler: (st: GameState) => {
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 65;
    ...
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
      ...
      scene.actions([
        { label: 'Refuse', handler: (st: GameState) => {
    qspCall(s, 'willpower', 'pay', 'resist');
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 61;
    qspGoto(s, 'burger', 'start');
  } },
      ]);
    }
    scene.actions([
      { label: 'Yes', handler: (st: GameState) => {
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['Level'] = 70;
    ...
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['GroupSex1'] = ((s as any).npclastgenerated ?? 0);
    // TODO-QSP: gs 'npcStat', $BurgerQW['GroupSex1'], 'b'
    qspCall(s, 'npcgeneratec', '', 0, 'Second Moving Man', Math.floor(Math.random() * 23) + 18);
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['GroupSex2'] = ((s as any).npclastgenerated ?? 0);
    ...
    ((s as any).stat = (s as any).stat ?? {})['facial'] = ((s as any).stat['facial'] ?? 0) + (3);
    ...
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['sergeyQWServiced2'] = ((s as any).BurgerQW['sergeyQWServiced2'] ?? 0) + (1);
    if (((s as any).BurgerQW ?? 0)?.['sergeyQWServiced2'] === 10) {
      ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['sergeyQWServiced1'] = 3;
    }
...
function enterBossSlut_01(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['BossSlut'] = 10;
    qspCall(s, 'stat', '');
    if (((s as any).BurgerQW ?? 0)?.['Level'] === 57) {
      ((s as any).mc_inventory = (s as any).mc_inventory ?? {})['cosmetics'] = ((s as any).mc_inventory['cosmetics'] ?? 0) + (200);
    ...
    qspGoto(s, 'burger', 'start');
        ...
        scene.actions([
          { label: 'Get on your knees', handler: (st: GameState) => {
    qspCall(s, 'money', 'earn', 300);
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['BossSlut'] = 2;
    ((s as any).BurgerQW = (s as any).BurgerQW ?? {})['BossSlutLastServed'] = ((s as any).daystart ?? 0);
    scene.img('images/characters/city/anatoly/sex/bj2.jpg');
    scene.text('You kneel down and take the money from the floor. Anatoly Borisovich pulls his already hard member out and holds it in front of your face. You wrap your lips around it and begin to suck as the hard cock fills your mouth. Anatoly Borisovich grits his teeth with pleasure "Suck it slut and don\'t forget to swallow every last drop!" You feel his sperm hit the inside of your mouth and begin to quickly swallow his cum to prevent yourself from choking. After you finish, Anatoly Borisovich puts his dick back in his pants. "Now get out."');
    qspCall(s, 'npcStat', 'A74');

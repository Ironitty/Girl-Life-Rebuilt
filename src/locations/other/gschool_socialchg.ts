...
function enterTest(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grupvalue ?? 0)[1] > 450  &&  ((s as any).grupwarning ?? 0)[1] === 1) {
    if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[1] = 0;
  } else {
    if (((s as any).grupvalue ?? 0)[1] < 400  &&  ((s as any).grupvalue ?? 0)[1] > 350  &&  ((s as any).grupwarning ?? 0)[1] > 1) {
      if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[1] = 1;
    } else {
      if (((s as any).grupvalue ?? 0)[2] > 450  &&  ((s as any).grupwarning ?? 0)[2] === 1) {
        if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[2] = 0;
      } else {
        if (((s as any).grupvalue ?? 0)[2] < 400  &&  ((s as any).grupvalue ?? 0)[2] > 350  &&  ((s as any).grupwarning ?? 0)[1] > 1) {
          if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[2] = 1;
        } else {
          if (((s as any).grupvalue ?? 0)[3] > 450  &&  ((s as any).grupwarning ?? 0)[3] === 1) {
            if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[3] = 0;
          } else {
            if (((s as any).grupvalue ?? 0)[3] < 400  &&  ((s as any).grupvalue ?? 0)[3] > 350  &&  ((s as any).grupwarning ?? 0)[1] > 1) {
              if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[3] = 1;
            } else {
              if (((s as any).grupvalue ?? 0)[4] > 450  &&  ((s as any).grupwarning ?? 0)[4] === 1) {
                if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[4] = 0;
              } else {
                if (((s as any).grupvalue ?? 0)[4] < 400  &&  ((s as any).grupvalue ?? 0)[4] > 350  &&  ((s as any).grupwarning ?? 0)[1] > 1) {
                  if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[4] = 1;
                }
              }
            }
          }
...
function enterPavlovskSlut(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).grupslutwarning) (s as any).grupslutwarning = {}; (s as any).grupslutwarning[1] = 0;
...
function enterCoolkid(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).grupTipe ?? 0) === 4) {
      if (!(s as any).grupvalue) (s as any).grupvalue = {}; (s as any).grupvalue[4] = Math.floor(Math.random() * 101) + 500;
    }
    if (!(s as any).old_grupvalue) (s as any).old_grupvalue = {}; (s as any).old_grupvalue[1] = qspUntranslated(s, "grupvalue[1]", { location: "gschool_socialchg" });
    if (!(s as any).old_grupvalue) (s as any).old_grupvalue = {}; (s as any).old_grupvalue[2] = qspUntranslated(s, "grupvalue[2]", { location: "gschool_socialchg" });
    if (!(s as any).old_grupvalue) (s as any).old_grupvalue = {}; (s as any).old_grupvalue[3] = qspUntranslated(s, "grupvalue[3]", { location: "gschool_socialchg" });
...
function enterCoolkidWarn2(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[1] = 2;
  qspCall(s, 'stat', '');
  scene.img('images/locations/pavlovsk/school/events/joincool.jpg');
...
function enterCoolkidSlutWarn(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).grupslutwarning) (s as any).grupslutwarning = {}; (s as any).grupslutwarning[1] = 1;
  qspCall(s, 'stat', '');
  scene.img('images/locations/pavlovsk/school/events/joincool.jpg');
  // TODO-QSP: dynamic text: You walk down the hallway and stop at your locker. You sense someone standing ne...
...
function enterJockWarn2(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[2] = 2;
  qspCall(s, 'stat', '');
  scene.img('images/locations/pavlovsk/school/events/joincool.jpg');
  // TODO-QSP: dynamic text: You walk down the hallway and stop at your locker. You sense someone standing ne...
...
function enterJockSlutWarn(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).grupslutwarning) (s as any).grupslutwarning = {}; (s as any).grupslutwarning[2] = 1;
  qspCall(s, 'stat', '');
  scene.img('images/locations/pavlovsk/school/events/joincool.jpg');
  // TODO-QSP: dynamic text: You walk down the hallway and stop at your locker. You sense someone standing ne...
...
function enterNerdWarn2(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[3] = 2;
  qspCall(s, 'stat', '');
  scene.img('images/locations/pavlovsk/school/events/joincool.jpg');
  // TODO-QSP: dynamic text: You walk down the hallway and stop at your locker. You sense someone standing ne...
...
function enterNerdSlutWarn(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).grupslutwarning) (s as any).grupslutwarning = {}; (s as any).grupslutwarning[3] = 1;
  qspCall(s, 'stat', '');
  scene.img('images/locations/pavlovsk/school/events/joincool.jpg');
  // TODO-QSP: dynamic text: You walk down the hallway and stop at your locker. You sense someone standing ne...
...
function enterGopnikWarn2(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).grupwarning) (s as any).grupwarning = {}; (s as any).grupwarning[4] = 2;
  qspCall(s, 'stat', '');
  scene.img('images/locations/pavlovsk/school/events/joincool.jpg');
...
function enterGopnikSlutWarn(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).grupslutwarning) (s as any).grupslutwarning = {}; (s as any).grupslutwarning[4] = 1;
  qspCall(s, 'stat', '');
  scene.img('images/locations/pavlovsk/school/events/joincool.jpg');
...
function enterGopnikMiss(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).grupvalue) (s as any).grupvalue = {}; (s as any).grupvalue[4] = Math.floor(Math.random() * 51) + 675;
  if (!(s as any).old_grupvalue) (s as any).old_grupvalue = {}; (s as any).old_grupvalue[4] = qspUntranslated(s, "grupvalue[4]", { location: "gschool_socialchg" });
  qspCall(s, 'stat', '');
  // TODO-QSP: end
  scene.actions([
...
function enterGroupRelChange(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['group'] = 0;
  if (((s as any).locArgs?.[1] ?? 0) === '') {
    if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['group'] = qspUntranslated(s, "ARGS[1]", { location: "gschool_socialchg" });
  } else {
    if (((s as any).locArgs?.[1] ?? 0) === 'cool kids') {
      if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['group'] = 1;
    } else {
      if (((s as any).locArgs?.[1] ?? 0) === 'jocks') {
        if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['group'] = 2;
      } else {
        if (((s as any).locArgs?.[1] ?? 0) === 'nerds') {
          if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['group'] = 3;
        } else {
          if (((s as any).locArgs?.[1] ?? 0) === 'gopniks') {
            if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['group'] = 4;
          } else {
            if (((s as any).locArgs?.[1] ?? 0) === 'outcasts') {
              if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['group'] = 5;
            } else {
              if (((s as any).locArgs?.[1] ?? 0) === 'teachers') {
                if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['group'] = 6;
              }
            }
          }
        }
  ...
  if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['change'] = qspUntranslated(s, "ARGS[2]", { location: "gschool_socialchg" });
  if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['gender'] = 0;
  if (((s as any).locArgs?.[3] ?? 0) === 'male'  ||  ((s as any).locArgs?.[3] ?? 0) === 'boy') {
    if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['gender'] = 1;
  } else {
    if (((s as any).locArgs?.[3] ?? 0) === 'female'  ||  ((s as any).locArgs?.[3] ?? 0) === 'girl') {
      if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['gender'] = 2;
    }
  }
  if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['i'] = 1;
  // TODO-QSP: :gs_socloop
  ...
  if (!(s as any).temp_gsc_grl) (s as any).temp_gsc_grl = {}; (s as any).temp_gsc_grl['i'] = ((s as any).temp_gsc_grl['i'] ?? 0) + (1);
...
function enterGroupStudentRelChange(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grupvalue_student_day ?? 0) !== ((s as any).daystart ?? 0)) {
    if (((s as any).npc_rel ?? 0)?.['A1'] >= 60) {
      if (!(s as any).grupvalue_temp) (s as any).grupvalue_temp = {}; (s as any).grupvalue_temp[1] = ((s as any).grupvalue_temp[1] ?? 0) + (1);
    }
    if (((s as any).npc_rel ?? 0)?.['A1'] <= 20) {
      if (!(s as any).grupvalue_temp) (s as any).grupvalue_temp = {}; (s as any).grupvalue_temp[1] = ((s as any).grupvalue_temp[1] ?? 0) - (1);
    }
    if (((s as any).npc_rel ?? 0)?.['A2'] >= 60) {
      if (!(s as any).grupvalue_temp) (s as any).grupvalue_temp = {}; (s as any).grupvalue_temp[3] = ((s as any).grupvalue_temp[3] ?? 0) + (1);
    }
    if (((s as any).npc_rel ?? 0)?.['A2'] <= 20) {
      if (!(s as any).grupvalue_temp) (s as any).grupvalue_temp = {}; (s as any).grupvalue_temp[3] = ((s as any).grupvalue_temp[3] ?? 0) - (1);
    }
    if (((s as any).npc_rel ?? 0)?.['A3'] >= 60) {
      if (!(s as any).grupvalue_temp) (s as any).grupvalue_temp = {}; (s as any).grupvalue_temp[2] = ((s as any).grupvalue_temp[2] ?? 0) + (1);
    }
    ...
    if (((s as any).npc_rel ?? 0)?.['A7'] >= 60) {
      if (!(s as any).grupvalue_temp) (s as any).grupvalue_temp = {}; (s as any).grupvalue_temp[5] = ((s as any).grupvalue_temp[5] ?? 0) + (1);
    }
    ...
    if (((s as any).npc_rel ?? 0)?.['A9'] >= 60) {
      if (!(s as any).grupvalue_temp) (s as any).grupvalue_temp = {}; (s as any).grupvalue_temp[4] = ((s as any).grupvalue_temp[4] ?? 0) + (1);
    }
    ...
    if (!(s as any).grupvalue) (s as any).grupvalue = {}; (s as any).grupvalue[1] = ((s as any).grupvalue[1] ?? 0) + (Math.min(Math.max((-5), qspUntranslated(s, "grupvalue_temp[1]", { location: "gschool_socialchg" })), 5));
    if (!(s as any).grupvalue) (s as any).grupvalue = {}; (s as any).grupvalue[2] = ((s as any).grupvalue[2] ?? 0) + (Math.min(Math.max((-5), qspUntranslated(s, "grupvalue_temp[2]", { location: "gschool_socialchg" })), 5));
    if (!(s as any).grupvalue) (s as any).grupvalue = {}; (s as any).grupvalue[3] = ((s as any).grupvalue[3] ?? 0) + (Math.min(Math.max((-5), qspUntranslated(s, "grupvalue_temp[3]", { location: "gschool_socialchg" })), 5));
    if (!(s as any).grupvalue) (s as any).grupvalue = {}; (s as any).grupvalue[4] = ((s as any).grupvalue[4] ?? 0) + (Math.min(Math.max((-5), qspUntranslated(s, "grupvalue_temp[4]", { location: "gschool_socialchg" })), 5));

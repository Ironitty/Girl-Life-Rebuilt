...
function enterScreen(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).over ?? 0) === 1  ||  String((s as any).locArgs?.[1] ?? '') === '1') {
    ...
    if (((s as any).over ?? 0) === 2  ||  String((s as any).locArgs?.[1] ?? '') === '2') {
      ...
      if (((s as any).over ?? 0) === 3  ||  String((s as any).locArgs?.[1] ?? '') === '3') {
        scene.img('images/system/2_endings/deadgirl.jpg');
        ...
        if (((s as any).over ?? 0) === 4  ||  String((s as any).locArgs?.[1] ?? '') === '4') {
          ...
          if (((s as any).over ?? 0) === 5  ||  String((s as any).locArgs?.[1] ?? '') === '5') {
            ...
            if (((s as any).over ?? 0) === 6  ||  String((s as any).locArgs?.[1] ?? '') === '6') {
              ...
              if (((s as any).over ?? 0) === 7  ||  String((s as any).locArgs?.[1] ?? '') === '7') {
                scene.img('images/system/2_endings/deadgirl.jpg');
                ...
                if (((s as any).over ?? 0) === 8  ||  String((s as any).locArgs?.[1] ?? '') === '8') {
                  ...
                  if (((s as any).over ?? 0) === 9  ||  String((s as any).locArgs?.[1] ?? '') === '9') {
                    ...
                    if (((s as any).over ?? 0) === 10  ||  String((s as any).locArgs?.[1] ?? '') === '10') {
                      ...
                      if (((s as any).over ?? 0) === 11  ||  String((s as any).locArgs?.[1] ?? '') === '11') {
                        ...
                        if (((s as any).over ?? 0) === 12  ||  String((s as any).locArgs?.[1] ?? '') === '12') {

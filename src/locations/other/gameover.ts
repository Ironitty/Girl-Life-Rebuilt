...
function enterScreen(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).over ?? 0) === 1  ||  ((s as any).locArgs?.[1] ?? 0) === '1') {
    ...
    if (((s as any).over ?? 0) === 2  ||  ((s as any).locArgs?.[1] ?? 0) === '2') {
      ...
      if (((s as any).over ?? 0) === 3  ||  ((s as any).locArgs?.[1] ?? 0) === '3') {
        ...
        if (((s as any).over ?? 0) === 4  ||  ((s as any).locArgs?.[1] ?? 0) === '4') {
          ...
          if (((s as any).over ?? 0) === 5  ||  ((s as any).locArgs?.[1] ?? 0) === '5') {
            ...
            if (((s as any).over ?? 0) === 6  ||  ((s as any).locArgs?.[1] ?? 0) === '6') {
              ...
              if (((s as any).over ?? 0) === 7  ||  ((s as any).locArgs?.[1] ?? 0) === '7') {
                scene.img('images/system/2_endings/deadgirl.jpg');
                ...
                if (((s as any).over ?? 0) === 8  ||  ((s as any).locArgs?.[1] ?? 0) === '8') {
                  ...
                  if (((s as any).over ?? 0) === 9  ||  ((s as any).locArgs?.[1] ?? 0) === '9') {
                    ...
                    if (((s as any).over ?? 0) === 10  ||  ((s as any).locArgs?.[1] ?? 0) === '10') {
                      ...
                      if (((s as any).over ?? 0) === 11  ||  ((s as any).locArgs?.[1] ?? 0) === '11') {
                        ...
                        if (((s as any).over ?? 0) === 12  ||  ((s as any).locArgs?.[1] ?? 0) === '12') {
                          ...
                          if (((s as any).over ?? 0) === 13  ||  ((s as any).locArgs?.[1] ?? 0) === '13') {
                            ...
                            if (((s as any).over ?? 0) === 14  ||  ((s as any).locArgs?.[1] ?? 0) === '14') {
                              ...
                              if (((s as any).over ?? 0) === 15  ||  ((s as any).locArgs?.[1] ?? 0) === '15') {
                                scene.img('images/system/2_endings/deadgirl.jpg');
                                ...
                                if (((s as any).over ?? 0) === 16  ||  ((s as any).locArgs?.[1] ?? 0) === '16') {
                                  scene.img('images/system/2_endings/deadgirl.jpg');
                                  ...
                                  if (((s as any).over ?? 0) === 17  ||  ((s as any).locArgs?.[1] ?? 0) === '17') {
                                    scene.img('images/system/2_endings/deadgirl.jpg');

...
function enterCreeksideGangbangRequest(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'hunter_interactions', 'creekside_rape');
    qspCall(st, 'stat', '');
  } },
    ]);
  } else {
  ...
  scene.actions([
    ...
    qspCall(st, 'outfit', 'backup', 'hunters');
...
function enterYardBondage(s: GameState, scene: SceneBuilder): void {
  ...
  if (Number((s as any).locArgs?.[1] ?? 0) === 'lost_bet') {
  ...
  if (Number((s as any).locArgs?.[1] ?? 0) === 'passing_bj') {
    ...
    qspCall(st, 'arousal', 'bj', 5, 'sub', 'bound', 'deepthroat');
    ...
    qspCall(st, 'arousal', 'bj', 10, 'rough', 'bound', 'deepthroat');
    qspCall(st, 'arousal', 'end');
  ...
  if (Number((s as any).locArgs?.[1] ?? 0) === 'passing_fuck') {
    ...
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['collective_opinion'] = ((st as any).hunterVars['collective_opinion'] ?? 0) - (2);
    qspCall(st, 'arousal', 'vaginal', 5, 'sub', 'bound');
    qspCall(st, 'arousal', 'end');
    ...
    scene.actions([
      ...
      { label: 'Let him have his way', handler: (st: GameState) => {
    qspCall(st, 'arousal', 'vaginal', 10, 'rough', 'bound');
    qspCall(st, 'arousal', 'end');
    (st as any).spafinloc = 1;
    qspCall(st, 'cum_manage', '');
    (st as any).spafinloc = 4;
    qspCall(st, 'cum_manage', '');
    (st as any).spafinloc = 9;
    qspCall(st, 'cum_manage', '');
    qspCall(st, 'stat', '');
  ...
  if (Number((s as any).locArgs?.[1] ?? 0) === 'clamp_fuck') {
    ...
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['collective_opinion'] = ((st as any).hunterVars['collective_opinion'] ?? 0) - (5);
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['sexual_comfort'] = ((st as any).hunterVars['sexual_comfort'] ?? 0) + (25);
    qspCall(st, 'dinsex', 'vaginal_sex', 10, 'sub', 'bound', 'masochism', 'humiliation');
    qspCall(st, 'arousal', 'vaginal', 5, 'sub', 'bound', 'masochism', 'humiliation');
  ...
  if (Number((s as any).locArgs?.[1] ?? 0) === 'unbound_fuck') {
    ((s as any).hunterVars = (s as any).hunterVars ?? {})['sexual_comfort'] = ((s as any).hunterVars['sexual_comfort'] ?? 0) + (15);
    ...
    qspCall(st, 'dinsex', 'vaginal_sex', 10, 'exhibitonism');
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
    ...
    qspCall(st, 'dinsex', 'vaginal_sex', 10, 'exhibitonism', 'rough', 'humiliation');
    (st as any).spafinloc = 4;
    qspCall(st, 'cum_manage', '');
    (st as any).spafinloc = 8;
    qspCall(st, 'cum_manage', '');
    qspCall(st, 'stat', '');
    ...
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['sexual_comfort'] = ((st as any).hunterVars['sexual_comfort'] ?? 0) + (30);
...
function enterNighttimeEntertainment(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'hj', (-7), 'gangbang');
    qspCall(st, 'stat', '');
    ...
    qspCall(st, 'arousal', 'bj', (-10), 'gangbang');
    qspCall(st, 'stat', '');
    ...
    qspCall(st, 'arousal', 'bj', (-7), 'gangbang');
    qspCall(st, 'stat', '');
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 3;
    qspCall(st, 'arousal', 'bj', (-8), 'gangbang', 'deepthroat');
    qspCall(st, 'stat', '');
    ...
    qspCall(st, 'cum_call', 'mouth', 'A173', 1);
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    (st as any).minut = ((st as any).minut ?? 0) + 2;
    qspCall(st, 'arousal', 'foreplay', (-4));
    qspCall(st, 'arousal', 'flash', (-3));
    qspCall(st, 'stat', '');
    ...
    qspCall(st, 'cum_call', 'face', 'A172', 1);
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    (st as any).minut = ((st as any).minut ?? 0) + 2;
    qspCall(st, 'arousal', 'flash', (-7));
    qspCall(st, 'stat', '');
    ...
    qspCall(st, 'cum_call', 'mouth', 'A174', 1);
    scene.actions([

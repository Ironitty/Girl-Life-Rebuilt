...
function enterFbInvitedStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sweat ?? 0) > 29) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['dont_ruin_makeup'] = 1;
    // TODO-QSP: $sex_ev['hall_way']
    ...
    // TODO-QSP: $sex_ev['hall_way']
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['date_soon'] = 1;
    if (((s as any).npc_apt_type ?? 0)?.[String((s as any).npcID ?? 0)] < 3) {
    ...
    ((s as any).pc_buy_condoms = (s as any).pc_buy_condoms ?? {})[String((s as any).npcID ?? 0)] = 2;
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['skip_condom'] = 1;
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['commando'] = 1;
    // TODO-QSP: $sex_ev['hall_way']

...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).kotovLoveQW ?? 0) > 0  &&  (!((s as any).artemVitokQW ?? 0))) {
    ...
    scene.text(`"You're lucky, four-eyes. If I even suspect that you've laid a finger on ${((s as any).pcs_nickname || '')}, I'll put you in a wheelchair and have you pissing blood for the rest of your life! Got that?"`);
    ...
    scene.text(`Vitek leans over Artem's prone body and scoffs. "Walk away, now. If I ever see you near ${((s as any).pcs_nickname || '')} again, I'm knocking your teeth out! Got that?"`);
...
function enterLearn(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] > 200) {
    ...
    scene.text(`"Look ${((s as any).pcs_nickname || '')}, I spent a lot of time and effort helping you out. Meanwhile, you… you suck off or fuck pretty much everyone who asks! But you won't touch me when I need it? That's so not fair! We're done… Find someone else to help you. Good luck with that attitude."`);
    ...
    scene.text(`You decline, and he's very offended by that. "Look ${((s as any).pcs_nickname || '')}, you've already let me fuck you. Meanwhile, you… fuck pretty much everyone who asks! But now I can't fuck your ass and you turn into a prude? That's so not fair! We're done… Find someone else to help you. Good luck with that attitude."`);
    scene.text('You can tell Artem is seriously offended by your refusal, and won\'t help you any further. Hopefully someone else can help you with your homework.');
    scene.actions([
      { label: 'Refuse', goto: ['artem_events', 'finalrefuse'] },
      { label: 'Let him fuck your ass', goto: ['artem_sex', 'slut_anal'] },
    ...
    scene.img('images/characters/pavlovsk/school/boy/artem/sex/bj1.jpg');
    // TODO-QSP: dynamic text: You decline, and he's very offended by that: "Look <<$pcs_nickname>>, you've alr...
    scene.text(`You decline, and he's very offended by that: "Look ${((s as any).pcs_nickname || '')}, you've already sucked my dick. Meanwhile, you… fuck pretty much everyone who asks! But now I can't fuck you? That's so not fair! We're done… Find someone else to help you. Good luck with that attitude."`);
    scene.text('You can tell Artem is seriously offended by your refusal, and won\'t help you any further. Hopefully someone else can help you with your homework.');
    scene.actions([
      { label: 'Refuse', goto: ['artem_events', 'finalrefuse'] },
...
function enterArtemdryhump(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Mere moments later, you see him cum over your ass, on your clothes! Once he finishes, you can tell he's embarrassed. "I'm sorry ${((s as any).pcs_nickname || '')}, I didn't mean to soil your clothes. It felt so good, I just couldn't stop!" He blushes so hard that he turns red.`);
...
function enterArtemdryhump1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Mere moments later, you see him cum over your panties; you can feel the sticky wetness through them as his cum soaks into them. He seems pleased once he finishes. "That was great ${((s as any).pcs_nickname || '')}, it felt so good!"`);
    scene.text('You then hear his mother\'s voice out in the hall, just outside his door. "Artem, I need you to run an errand into town for me."');
    scene.text('Artem freaks out and starts to panic. "Um yes mom, I will!" He looks at you with a panicked stare, his mother having almost caught him dry humping a girl in his room. "I should really go do what my mom wants. See you tomorrow?"');
    scene.text('You smile at him. "Maybe. I\'ll have to see what\'s going on." With that, you gather up your stuff and leave.');
    qspCall(s, 'arousal', 'foreplay', 2);
...
function enterArtemdryhump2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Mere moments later, you see him cum over your naked ass and lower back. He seems pleased once he finishes. "That was great ${((s as any).pcs_nickname || '')}, it felt so good!"`);
    scene.text('You then hear his mother\'s voice out in the hall, just outside his door. "Artem, I need you to run an errand into town for me."');

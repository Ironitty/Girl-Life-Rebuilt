...
function enterAnushka_3some2DomBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).grupTipe ?? 0) === 3) {
      ...
      scene.text(`Once you're all dressed, Anushka finishes her makeup and gets up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname || '')}. Later nerds."`);
    } else {
      // TODO-QSP: dynamic text: Once you're all dressed, Anushka finishes her makeup before she gets up. "Okay, ...
      scene.text(`Once you're all dressed, Anushka finishes her makeup before she gets up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname || '')}. Later losers."`);
    }
    scene.actions([
      { label: 'You need to leave too', handler: (st: GameState) => {
    scene.img('images/characters/shared/headshots_main/big2.jpg');
...
function enterAnushka_3some2DomStrapon(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).grupTipe ?? 0) === 3) {
      ...
      scene.text(`Once you're all dressed and Anushka is done touching up her makeup, she gets up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname || '')}. Later nerds."`);
    } else {
      // TODO-QSP: dynamic text: Once you're all dressed and Anushka is done touching up her makeup, she gets up....
      scene.text(`Once you're all dressed and Anushka is done touching up her makeup, she gets up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname || '')}. Later losers."`);
    }
    scene.actions([
      { label: 'You need to leave too', handler: (st: GameState) => {
    scene.img('images/characters/shared/headshots_main/big2.jpg');
...
function enterArtemNushStrip(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).grupTipe ?? 0) === 3) {
      ...
      scene.text(`Once they're both dressed, Anushka gets ready to leave. ""Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname || '')}. Later nerds."`);
    } else {
      // TODO-QSP: dynamic text: Once they're both dressed, Anushka gets ready to leave. ""Okay, I need to get go...
      scene.text(`Once they're both dressed, Anushka gets ready to leave. ""Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname || '')}. Later losers."`);
    }
    scene.actions([
      { label: 'You need to leave too', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
...
function enterArtemSveta(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).grupTipe ?? 0) === 3) {
      ...
      scene.text(`"Thanks for the show guys, but I need to get going," Anushka says. "I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname || '')}. Later nerds."`);
    } else {
      // TODO-QSP: dynamic text: "Thanks for the show guys, but I need to get going," Anushka says. "I guess I'll...
      scene.text(`"Thanks for the show guys, but I need to get going," Anushka says. "I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname || '')}. Later losers."`);
    }
    scene.actions([
      { label: 'You need to leave too', handler: (st: GameState) => {
    (s as any).cumspclnt = 12;
...
function enterCoffeeHole1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`While stroking his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick with one hand, she starts to suck on the head with her mouth. As she does, she turns her head slightly and gives you a side glance. Likely making sure you're okay with this, you give her a very slight nod and a smile.`);
    ...
    scene.text(`You watch as Anushka takes his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock about half way into her mouth, which causes Artem to moan louder. "Oh fuck Nush, you're so good at this!"`);
    ...
    scene.text(`Artem roughly grabs her by the hair and forces his dick into her mouth. She's only too happy to oblige him and you watch as he forces her head to bob back and forth as she sucks his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick, his hand firmly gripping her by the hair and guiding her head.`);
    ...
    scene.text(`Artem pulls her head forward by her hair while forcing his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock balls deep down her throat, which causes him to moan louder. "Oh fuck Nush, you're so good at this!"`);

...
function enterAnushka_3some1Bj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He grabs hold of Anushka's head and pulls her off as he looks at you. "I need to fuck you, ${((s as any).pcs_nickname ?? 0)}."`);
...
function enterAnushka_3some1Doggy(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'cuni_give', 5, ((s as any).npcID1 ?? 0), 'lesbian');
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterAnushka_3some1Cleanup(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).artemQW ?? 0)?.['nush3some_again'] === 3) {
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['nush3some_again'] = 4;
  }
  ...
  scene.text(`He grins ear from ear, apparently never expecting to hear all the praise he's getting. "Yeah, sure." Then he glances at you. "I mean if ${((s as any).pcs_nickname ?? 0)} is okay with it."`);
  ...
  if (((s as any).grupTipe ?? 0) === 3) {
    ...
    scene.text(`Once you're all dressed, Anushka touches up her makeup using her compact mirror. Once she's done, she stands up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later nerds."`);
  } else {
    // TODO-QSP: dynamic text: Once you're all dressed, Anushka touches up her makeup using her compact mirror....
    scene.text(`Once you're all dressed, Anushka touches up her makeup using her compact mirror. Once she's done, she stands up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later losers."`);
  }
  // TODO-QSP: end
  scene.actions([
...
function enterNush3some1HowHeFeels(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).anushkaQW ?? 0)?.['artem_dom'] === 1) {
    ...
    scene.actions([
      { label: 'We\'ll see', handler: (st: GameState) => {
    if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['artem_dom'] = 1;
    scene.img('images/characters/shared/headshots_main/big2.jpg');
    scene.text('You smile at him. "We\'ll see. Maybe I\'ll save it for special rewards for you."');
    scene.text('You talk for a few minutes before you tell him you need to get going. He kisses you before walking you to the door. As you leave, you think about what just happened. You\'ve set it up so your boyfriend and best friend are interested in having more threesomes. As you head out the door and Artem closes it behind you, you wonder if this was a mistake or the smartest thing you\'ve ever done. You suppose only time will tell…');
    scene.actions([
...
function enterAnushka_3some2DomBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Artem buries your face in Anushka's pussy and you start licking. She's already wet and moans loudly as you feel Artem let go of you. "That's it. Get her nice and wet for me, ${((s as any).pcs_nickname ?? 0)}."`);
    ...
    scene.text(`Artem stands up and smacks his dick against Anushka's ass cheeks a few times before he rubs the tip against her soaking wet pussy, causing her to moan. You watch as he slides his dick into her, her pussy easily swallowing up ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock as he starts fucking her. Listening to her moaning with each thrust is arousing you, so you slide your hand down to your own wet pussy and start rubbing your clit, masturbating as you watch them fuck.`);
    qspCall(s, 'arousal', 'voyeur_sex', 2);
    ...
    if (((s as any).artemQW ?? 0)?.['nush3some_again'] === 5) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['nush3some_again'] = 6;
    }
    if (((s as any).artemQW ?? 0)?.['confidence'] < 9) {
      if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['confidence'] = ((s as any).artemQW['confidence'] ?? 0) + (2);
    } else {
    ...
    if (((s as any).grupTipe ?? 0) === 3) {
      ...
      scene.text(`Once you're all dressed, Anushka finishes her makeup and gets up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later nerds."`);
    } else {
      // TODO-QSP: dynamic text: Once you're all dressed, Anushka finishes her makeup before she gets up. "Okay, ...
      scene.text(`Once you're all dressed, Anushka finishes her makeup before she gets up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later losers."`);
    }
    scene.actions([
      { label: 'You need to leave too', handler: (st: GameState) => {
    scene.img('images/characters/shared/headshots_main/big2.jpg');
...
function enterAnushka_3some2Bj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He grabs hold of Anushka's head and pulls her off before he looks at you. "I need to fuck you, ${((s as any).pcs_nickname ?? 0)}."`);
    // TODO-QSP: dynamic text: You straddle him and line his dick up with your pussy before slowly lowering you...
    scene.text(`You straddle him and line his dick up with your pussy before slowly lowering yourself down onto it, taking his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick inside you. As you start riding him, Anushka moves up to his head, straddles his face and lowers herself down, grinding her crotch into his face as you ride him. You both moan from the pleasure of the act.`);
...
function enterAnushka_3some2Cleanup(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).grupTipe ?? 0) === 3) {
    // TODO-QSP: dynamic text: Once you're all dressed, Anushka touches up her makeup using her compact mirror....
    scene.text(`Once you're all dressed, Anushka touches up her makeup using her compact mirror. Once she's done, she gets up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later nerds."`);
  } else {
    // TODO-QSP: dynamic text: Once you're all dressed, Anushka touches up her makeup using her compact mirror....
    scene.text(`Once you're all dressed, Anushka touches up her makeup using her compact mirror. Once she's done, she gets up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later losers."`);
  }
  // TODO-QSP: end
  scene.actions([
    { label: 'You need to leave too', handler: (st: GameState) => {
...
function enterAnushka_3some2DomStrapon(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`Anushka rolls over onto her back and spreads her legs before you scoot up on your knees and slide the dildo into her. Your ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dildo slides easily into her wet pussy, making her moan loudly as you start fucking her.`);
  ...
  scene.actions([
    ...
    if (((s as any).grupTipe ?? 0) === 3) {
      ...
      scene.text(`Once you're all dressed and Anushka is done touching up her makeup, she gets up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later nerds."`);
    } else {
      // TODO-QSP: dynamic text: Once you're all dressed and Anushka is done touching up her makeup, she gets up....
      scene.text(`Once you're all dressed and Anushka is done touching up her makeup, she gets up. "Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later losers."`);
    }
    scene.actions([
      { label: 'You need to leave too', handler: (st: GameState) => {
    scene.img('images/characters/shared/headshots_main/big2.jpg');
...
function enterAnushka_3some2DomStraponAnal(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`She moans loudly as the ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dildo easily slides into her lubed asshole and you fuck her for a few minutes before Artem starts crowding against you, wanting another go himself.`);
...
function enterArtemNush(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`She reaches into his underwear and pulls out his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick. Once it's free, he reaches over and pulls her head down into his lap. "You made it hard, so now you got to suck it," you say with a smirk.`);
...
function enterArtemNushStrip(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He moves forward and she suddenly moans loudly as he shoves his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock inside her pussy and starts fucking her as you lean in and start kissing her.`);
    ...
    if (((s as any).grupTipe ?? 0) === 3) {
      // TODO-QSP: dynamic text: Once they're both dressed, Anushka gets ready to leave. ""Okay, I need to get go...
      scene.text(`Once they're both dressed, Anushka gets ready to leave. ""Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later nerds."`);
    } else {
      // TODO-QSP: dynamic text: Once they're both dressed, Anushka gets ready to leave. ""Okay, I need to get go...
      scene.text(`Once they're both dressed, Anushka gets ready to leave. ""Okay, I need to get going, but I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later losers."`);
    }
    scene.actions([
      { label: 'You need to leave too', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
...
function enterArtemSveta(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You lean forward and take his dick into your mouth and start sucking it while stroking his shaft. "Damn ${((s as any).pcs_nickname ?? 0)}, you're getting good at that!" Anushka says.`);
    ...
    qspCall(s, 'arousal', 'end');
    if (((s as any).grupTipe ?? 0) === 3) {
      // TODO-QSP: dynamic text: "Thanks for the show guys, but I need to get going," Anushka says. "I guess I'll...
      scene.text(`"Thanks for the show guys, but I need to get going," Anushka says. "I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later nerds."`);
    } else {
      // TODO-QSP: dynamic text: "Thanks for the show guys, but I need to get going," Anushka says. "I guess I'll...
      scene.text(`"Thanks for the show guys, but I need to get going," Anushka says. "I guess I'll see you at the Coffee Hole for your nerd night," she says to Artem before she turns to you. "I'll see you around, ${((s as any).pcs_nickname ?? 0)}. Later losers."`);
    }
    scene.actions([
      { label: 'You need to leave too', handler: (st: GameState) => {
    (s as any).cumspclnt = 12;
...
function enterArtemSvetaVag(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`He just grins and gets up as Anushka helps you get naked from the waist down while he strips out of his pants and underwear. Once you're both ready, you lay on your back and spread your legs wide before he lays down between your legs and slides his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock into your already wet pussy.`);
  qspCall(s, 'arousal', 'vaginal', 2);
  qspCall(s, 'stat', '');
  // TODO-QSP: end
  scene.actions([
...
function enterCoffeeHole1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['artem_dom'] = ((s as any).artemQW['artem_dom'] ?? 0) + (1);
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['nush_bully_payback_uni'] = ((s as any).artemQW['nush_bully_payback_uni'] ?? 0) + (1);
    ...
    scene.text(`While stroking his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick with one hand, she starts to suck on the head with her mouth. As she does, she turns her head slightly and gives you a side glance. Likely making sure you're okay with this, you give her a very slight nod and a smile.`);
    ...
    scene.text(`You watch as Anushka takes his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock about half way into her mouth, which causes Artem to moan louder. "Oh fuck Nush, you're so good at this!"`);
    ...
    // TODO-QSP: dynamic text: Artem roughly grabs her by the hair and forces his dick into her mouth. She's on...
    scene.text(`Artem roughly grabs her by the hair and forces his dick into her mouth. She's only too happy to oblige him and you watch as he forces her head to bob back and forth as she sucks his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick, his hand firmly gripping her by the hair and guiding her head.`);
    ...
    scene.text(`Artem pulls her head forward by her hair while forcing his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock balls deep down her throat, which causes him to moan louder. "Oh fuck Nush, you're so good at this!"`);
    ...
    if (((s as any).artemQW ?? 0)?.['nush_bully_payback_uni'] >= 2) {

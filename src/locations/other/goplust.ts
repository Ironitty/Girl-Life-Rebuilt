...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).BerezaLust ?? 0) >= 60  &&  ((s as any).BerezaTut ?? 0) === 1) {
    ...
    if (!(s as any).namgop_flag) (s as any).namgop_flag = {}; (s as any).namgop_flag[2] = 1;
    (s as any).gopB = 1;
  ...
  if (((s as any).VitekLust ?? 0) >= 60  &&  ((s as any).VitekTut ?? 0) === 1) {
    ...
    if (!(s as any).namgop_flag) (s as any).namgop_flag = {}; (s as any).namgop_flag[3] = 1;
    (s as any).gopVi = 1;
    (s as any).VitekTut = 2;
  } else {
  ...
  if (((s as any).KotilLust ?? 0) >= 70  &&  ((s as any).KostilTut ?? 0) === 1) {
    ...
    if (!(s as any).namgop_flag) (s as any).namgop_flag = {}; (s as any).namgop_flag[4] = 1;
    (s as any).gopK = 1;
  ...
  if (((s as any).UdmurtLust ?? 0) >= 80  &&  ((s as any).UdmurtTut ?? 0) === 1) {
    ...
    if (!(s as any).namgop_flag) (s as any).namgop_flag = {}; (s as any).namgop_flag[5] = 1;
    (s as any).gopU = 1;
  ...
  if (((s as any).SeriLust ?? 0) >= 90  &&  ((s as any).SeriTut ?? 0) === 1) {
    ...
    if (!(s as any).namgop_flag) (s as any).namgop_flag = {}; (s as any).namgop_flag[6] = 1;
    (s as any).gopS = 1;
    (s as any).SeriTut = 2;
  } else {
  ...
  if (((s as any).namgop ?? 0)[6] !== '') {
    if (!(s as any).namgop) (s as any).namgop = {}; (s as any).namgop[0] = ((s as any).namgop[0] ?? 0) + (qspUntranslated(s, "namgop[6]", { location: "goplust" }));
  }

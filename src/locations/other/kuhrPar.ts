...
{ label: 'Set the table for breakfast', goto: ['kuhrPar', ''] },
          ...
          if (((s as any).locat ?? 0)?.['Mom_kitchen_action'] === 4) {
            ...
            (s as any).mombreak = ', <a href="exec:gt\'mother\'">mother</a>';
          }
        }
      }
    }
  ...
  if (((s as any).locat ?? 0)?.['Mother'] === 11) {
    ...
    if (((s as any).locat ?? 0)?.['Mother'] === 13) {
      if (((s as any).locat ?? 0)?.['Anya'] === 23) {
        scene.text(`Your <a href="exec:gt'mother'">${(((s as any).npc_nickname ?? 0)?.['A29'] ?? '')}</a> and <a href="#" onclick="window.__gameStore.getState().doGoto(/u0027sister_chat/u0027, /u0027talking/u0027); return false;">Anya</a> are cleaning up after dinner.`);
      } else {

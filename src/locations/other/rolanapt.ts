...
function enterHolodil(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).guavacoco_count ?? 0) > 0) {
    ...
    (s as any).guavacoco_day = ((s as any).daystart ?? 0);
    (s as any).guavacoco_count = ((s as any).guavacoco_count ?? 0) - (1);
    qspCall(s, 'stat', '');
    scene.img('images/locations/pavlovsk/resident/apartment/aptrolan/guavacoco\' + rand(0, 2) + \'.jpg');
  ...
  if (((s as any).kvass_count ?? 0) > 0) {
    ...
    (s as any).pcs_breath = 0;
    (s as any).pcs_hydra = 100;
    (s as any).kvass_day = ((s as any).daystart ?? 0);
    (s as any).kvass_count = ((s as any).kvass_count ?? 0) - (1);
    qspCall(s, 'stat', '');
    scene.img('images/locations/pavlovsk/resident/apartment/aptrolan/kvass\' + rand(0, 2) + \'.jpg');
    if ((!((s as any).rolancooklesson ?? 0))) {
...
function enterKuhBuh(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'npc_relationship', 'modify', 'A133', 1);
    qspCall(s, 'stat', '');
...
function enterBend(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).rollrolan ?? 0) === 1) {
      qspCall(s, 'npc_relationship', 'modify', 'A133', 1);
      qspCall(s, 'stat', '');
      scene.img('images/locations/pavlovsk/resident/apartment/aptrolan/kitch/bread\' + rand(0, 3) + \'.jpg');
...
function enterDrawer(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 2;
  qspCall(s, 'stat', '');
  scene.img('images/locations/pavlovsk/resident/apartment/aptrolan/drawer/private\' + rand(0, 1) + \'.jpg');
...
function enterMypanty(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pcs_inhib ?? 0) > 35  &&  ((s as any).pcs_intel ?? 0) > 35  &&  ((s as any).rolanpantyconfession ?? 0) !== 1) {
    ...
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    (s as any).rolanpantyconfession = 1;
    scene.text('<center><b>I want my panties back</b></center>');
    ...
    qspCall(s, 'npc_relationship', 'modify', 'A133', 20);
    (s as any).rolancooklesson = 0;
    (s as any).rolangift = 1;
...
function enterChef(s: GameState, scene: SceneBuilder): void {
  if (((s as any).rolancooklesson ?? 0) === 1) {
    ...
    if (((s as any).pcs_agil ?? 0) >= 40  &&  ((s as any).pcs_agil ?? 0) < 60) {
    ...
    if (((s as any).pcs_inhib ?? 0) > 50  &&  ((s as any).pantyworntype ?? 0) !== 'none') {
      scene.actions([

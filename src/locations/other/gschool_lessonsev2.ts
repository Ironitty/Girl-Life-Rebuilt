...
function enterMath(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 6) + 0) > 0) {
    ...
    if (((s as any).scooltiperand ?? 0) === 1) {
      ...
      if (((s as any).pantyworntype ?? 0) === 'none'  &&  ((s as any).analPlugIn ?? 0) === 0  &&  (((s as any).cum_loc ?? 0)?.['vagina'] > 0  ||  ((s as any).cum_loc ?? 0)?.['anus'] > 0)) {
        ...
        if (((s as any).pantyworntype ?? 0) === 'none'  &&  ((s as any).analPlugIn ?? 0) === 1) {
          ...
          scene.text(`"Damn ${((s as any).pcs_nickname ?? 0)}, you getting that ass loose for later?" Dimka laughs.`);
          // TODO-QSP: dynamic text: "Yeah, you have some nice holes there, <<$pcs_nickname>>," Igor adds.
          scene.text(`"Yeah, you have some nice holes there, ${((s as any).pcs_nickname ?? 0)}," Igor adds.`);
          if (((s as any).npc_grupTipe ?? 0)?.['A189'] === 4  &&  ((s as any).NikoVolkovQW ?? 0) >= 5  &&  (!((s as any).NikoPayback ?? 0))) {
            ...
            if (((s as any).npc_grupTipe ?? 0)?.['A189'] === 4  &&  ((s as any).NikoPayback ?? 0) > 0) {
              ...
              if (((s as any).npc_grupTipe ?? 0)?.['A189'] === 4) {
                ...
                scene.text(`"Looking good, ${((s as any).pcs_nickname ?? 0)}," Niko grins.`);
              }
            }
          }
          // TODO-QSP: dynamic text: You look around the classroom, confused as to what they're talking about when yo...
          scene.text(`You look around the classroom, confused as to what they're talking about when you hear Julia whisper while pointing at your ass. "Psst, ${((s as any).pcs_firstname ?? 0)}… Your skirt!"`);
          ...
          if (((s as any).pantyworntype ?? 0) === 'none'  &&  (!((s as any).analPlugIn ?? 0))) {
            ...
            scene.text(`"Damn ${((s as any).pcs_nickname ?? 0)}, you certainly know how how to put on a show!" Dimka laughs.`);
            // TODO-QSP: dynamic text: "Yeah, you have some nice holes there, <<$pcs_nickname>>!" Igor adds.
            scene.text(`"Yeah, you have some nice holes there, ${((s as any).pcs_nickname ?? 0)}!" Igor adds.`);
            if (((s as any).npc_grupTipe ?? 0)?.['A189'] === 4  &&  ((s as any).NikoVolkovQW ?? 0) >= 5  &&  (!((s as any).NikoPayback ?? 0))) {
              scene.text('"That\'s my girl right there," Niko says with a smirk.');
              ...
              if (((s as any).npc_grupTipe ?? 0)?.['A189'] === 4  &&  ((s as any).NikoPayback ?? 0) > 0) {
                ...
                if (((s as any).npc_grupTipe ?? 0)?.['A189'] === 4) {
                  ...
                  scene.text(`"You're looking good, ${((s as any).pcs_nickname ?? 0)}," Niko grins.`);
                }
              }
            }
            // TODO-QSP: dynamic text: You look around the classroom, confused as to what they're talking about when yo...
            scene.text(`You look around the classroom, confused as to what they're talking about when you hear Julia whisper while pointing at your ass. "Psst, ${((s as any).pcs_nickname ?? 0)}… Your skirt!"`);
            scene.text('You suddenly feel your face grow red when you realize what she meant. You quickly solve the problem on the board and return to your seat with your head held down as Mr. Tsarev tries to calm the class, unaware of what has them all riled up.');
          } else {
            qspCall(s, 'arousal', 'flash', (-5));
            qspCall(s, 'fame', 'pav', 'sex', 1);
    ...
    scene.text(`"What is the meaning of this, Miss ${((s as any).pcs_lastname ?? 0)}!?" he angrily scowls.`);
    ...
    scene.text(`He looks slightly nervous now, knowing that you caught him staring at you and tries to compose himself. "Miss ${((s as any).pcs_lastname ?? 0)}, get out of my class!"`);
    ...
    ((s as any).stat_memory ?? {})['lariska_pussy_shot'] = 1;
...
function enterHelp(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You notice a small shiver roll down his spine. "Thank you ${((s as any).pcs_firstname ?? 0)}… I mean Miss ${((s as any).pcs_lastname ?? 0)}, but I should let you get back to work." He then quickly walks back to his desk while occasionally glancing back at you.`);
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
    ]);
  } },
    ...
    scene.text(`He nods his head slowly. "You make a really good point. Maybe if I just speak with her without second guessing myself, I can actually make some progress? Thank you Miss… ${((s as any).pcs_firstname ?? 0)}, for your advice. You seem to have a great understanding of people in general." He gives your shoulder a light squeeze before returning to his desk.`);
  } },
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
    ]);
  } },
...
function enterHistory(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 6) + 0) > 0) {
      ...
      if (((s as any).scooltiperand ?? 0) === 2) {
        ...
        if (((s as any).scooltiperand ?? 0) === 3) {
          ...
          if (((s as any).scooltiperand ?? 0) === 4) {
            ...
            scene.text(`"Is there a problem, Miss ${((s as any).pcs_lastname ?? 0)}?" Mrs. Sokoloff asks and you glance around and notice everyone is staring at you as Roman snickers behind you. Mrs. Sokoloff looks at you curiously.`);
            qspCall(s, 'willpower', 'misc', 'self', 'medium');
            if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
              scene.actions([
    ...
    qspCall(s, 'npc_relationship', 'modify', 'A157', (-10));
    scene.img('images/locations/pavlovsk/school/classroom/class1.jpg');
    ...
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
            ...
            if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
              scene.actions([
                { label: 'Slap Roman [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
              ]);
            } else {
    ...
    // TODO-QSP: dynamic text: Mrs. Sokoloff's voice cuts through the noise. "That's enough of that, Miss <<$pc...
    scene.text(`Mrs. Sokoloff's voice cuts through the noise. "That's enough of that, Miss ${((s as any).pcs_lastname ?? 0)}! Go to the principal's office!"`);
    scene.actions([
    ...
    // TODO-QSP: dynamic text: "Is there a problem, Miss <<$pcs_lastname>>?" Mrs. Sokoloff asks and you glance ...
    scene.text(`"Is there a problem, Miss ${((s as any).pcs_lastname ?? 0)}?" Mrs. Sokoloff asks and you glance around and notice everyone is staring at you as Roman snickes behind you.`);
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
    ]);
  } },
    ...
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
            ...
            if (((s as any).scooltiperand ?? 0) === 5  &&  ((s as any).braworntype ?? 0) !== 'none') {
              ...
              // TODO-QSP: dynamic text: "Is there a problem, Miss <<$pcs_lastname>>?" Mrs. Sokoloff asks and you glance ...
              scene.text(`"Is there a problem, Miss ${((s as any).pcs_lastname ?? 0)}?" Mrs. Sokoloff asks and you glance around and notice everyone is staring at you as Roman snickers behind you. Mrs. Sokoloff looks at you accusingly.`);
              qspCall(s, 'willpower', 'misc', 'self', 'medium');
              if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
                scene.actions([
                  { label: 'Tell on him [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
...
function enterShop(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 6) + 0) > 0) {
        ...
        if (((s as any).scooltiperand ?? 0) === 3) {
          ...
          if (((s as any).scooltiperand ?? 0) === 4) {
            ...
            if (((s as any).scooltiperand ?? 0) === 5) {
              ...
              scene.text(`"Is there a problem, Miss ${((s as any).pcs_lastname ?? 0)}?" Mr. Kuznetsov asks and you glance around and notice everyone is staring at you as Dan snickers behind you. Mr. Kuznetsov looks at you curiously.`);
              qspCall(s, 'willpower', 'misc', 'self', 'medium');
              if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
                scene.actions([
                  { label: 'Tell on him [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    ...
    // TODO-QSP: dynamic text: Mr. Kuznetsov's voice cuts through the noise. "That's enough of that, Miss <<$pc...
    scene.text(`Mr. Kuznetsov's voice cuts through the noise. "That's enough of that, Miss ${((s as any).pcs_lastname ?? 0)}! Go to the principal's office!"`);
    scene.actions([
      { label: 'Go to the principal\'s office', goto: ['gschool_office', 'principal'] },
    ]);
  } },
    ...
    scene.text('You squeak loudly as his fingers quickly pinch your sensitive nipple and your hand quickly flies to your breast to shield it from further attack.');
    // TODO-QSP: dynamic text: "Is there a problem, Miss <<$pcs_lastname>>?" Mr. Kuznetsov asks and you glance ...
    scene.text(`"Is there a problem, Miss ${((s as any).pcs_lastname ?? 0)}?" Mr. Kuznetsov asks and you glance around and notice everyone is staring at you as Dan snickers behind you.`);
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
    ]);
  } },
    ...
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
              ...
              if (((s as any).scooltiperand ?? 0) === 6  &&  ((s as any).braworntype ?? 0) !== 'none') {
                ...
                // TODO-QSP: dynamic text: "Is there a problem, Miss <<$pcs_lastname>>?" Mr. Kuznetsov asks and you glance ...
                scene.text(`"Is there a problem, Miss ${((s as any).pcs_lastname ?? 0)}?" Mr. Kuznetsov asks and you glance around and notice everyone is staring at you as Dan snickers behind you. Mr. Kuznetsov looks at you accusingly.`);
                qspCall(s, 'willpower', 'misc', 'self', 'medium');
                if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
                  scene.actions([
                    { label: 'Tell on him [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    ...
    ((s as any).grupvalue ?? {})[3] = (((s as any).grupvalue ?? {})[3] ?? 0) - (1);
    ((s as any).grupvalue ?? {})[4] = (((s as any).grupvalue ?? {})[4] ?? 0) + (1);
    qspCall(s, 'npc_relationship', 'modify', 'A' + qspUntranslated(s, "r>", { location: "gschool_lessonsev2" }) + '', (-1));
    scene.img('images/locations/pavlovsk/school/events/rand_scoolboy1.jpg');
    scene.text('You ignore Mr. Kuznetsov and turn around and slap Dan with all your force. Dan recoils, his hand going to his cheek as students start murmuring about what happened and some laugh.');
    // TODO-QSP: dynamic text: Mr. Kuznetsov's voice cuts through the noise. "That's enough of that, Miss <<$pc...
    scene.text(`Mr. Kuznetsov's voice cuts through the noise. "That's enough of that, Miss ${((s as any).pcs_lastname ?? 0)}! Come and see me after school."`);
    scene.actions([
      { label: 'Go to the principal\'s office', goto: ['gschool_office', 'principal'] },
    ]);
  } },
    ...
    if (((s as any).fame ?? 0)?.['pav_slut'] >= 150) {
      ...
      scene.text(`As you walk into class, you look around and to your despair find that the only seat left is next to Petia, everyone else having given the fat, smelly loser a wide berth. Your nostrils are assaulted as soon as you sit down, the ordeal made worse by Petia leaning in and asking if he can get a blowjob since you're such a slut. You reply by sticking your fingers in your mouth and gagging. "When will you realize that you're such a fat and smelly loser that not even ${((s as any).pcs_nickname ?? 0)} will suck your tiny dick?" Arkadi chimes in, causing the gopniks to gang up on him and free you from his horrible attempts at hitting on you.`);
    } else {
...
function enterShopPunishment(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).grupTipe ?? 0) === 3  ||  ((s as any).Kuznetsov_punishment_count ?? 0) < 5) {
    ...
    if (((s as any).pcs_hotcat ?? 0) >= 6  &&  ((s as any).fame ?? 0)?.['pav_slut'] >= 150) {
      if (((s as any).pantyworntype ?? 0) !== 'none') {
      ...
      qspCall(s, 'arousal', 'foreplay', 5, 'rough');
      qspCall(s, 'stat', '');
      scene.actions([
    ...
    qspCall(s, 'arousal', 'anal_dildo', 5, 'rough', 'maso');
    qspCall(s, 'pain', 'asshole', 1, 'stretch');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'anal_dildo', 5, 'rough', 'maso');
    qspCall(s, 'pain', 'asscheeks', 2, 'spank');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'foreplay', 5, 'rough', 'bound');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Blowjob', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'boyStat', 'A132');
    ...
    scene.text(`With you fully secured, he removes his shirt and tie before pulling his dick out of his pants. "Open your fucking mouth, slut!" he says as he painfully grips the back of your neck, applying more pressure until you open your mouth. You barely get your mouth open wide enough before he shoves his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock in and you start gagging as he shoves it down your throat. "You best get my cock nice and wet if you know what's good for you."`);
    qspCall(s, 'arousal', 'bj', 5, 'rough', 'bound');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'bj', 5, 'rough', 'bound', 'deepthroat');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'anal', 5, 'rough', 'bound');
    qspCall(s, 'pain', 'asshole', 1, 'stretch');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'cum_call', 'mouth', 'A132', 1);
    qspCall(s, 'arousal', 'bj', 5, 'rough', 'bound');
    qspCall(s, 'arousal', 'end');
    scene.actions([

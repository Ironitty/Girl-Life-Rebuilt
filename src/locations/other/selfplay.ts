...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_horny ?? 0) > 10) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSisProv(st, scene); (st as any).locArgs = __savedLocArgs; }
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterVagmastDildoStart(st, scene); (st as any).locArgs = __savedLocArgs; }
    qspCall(st, 'stat', '');
...
function enterBrushplay(s: GameState, scene: SceneBuilder): void {
  ...
  if (String((s as any).locArgs?.[1] ?? '') === 'brush_keepgoing') {
...
function enterVagmastDildoStart(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'arousal', 'vaginal_dildo', 5, 'masturbate');
  qspCall(s, 'stat', '');
  (s as any).entrymessage = undefined;
  (s as any).temp_mens = undefined;
  if (((s as any).pcs_horny ?? 0) > 0) {
    if (((s as any).org_temp ?? 0) < ((s as any).orgasm ?? 0)) {
      scene.actions([
{ label: 'Stop masturbating', goto: ['selfplay', 'stop'] },
  ...
  (s as any).lubemessage = undefined;
  scene.build();
}
...
function enterPussyDildoMast(s: GameState, scene: SceneBuilder): void {
  ...
  if (String((s as any).locArgs?.[1] ?? '') === 'vag_keepgoing') {
...
function enterAnalDildoStart(s: GameState, scene: SceneBuilder): void {
  ...
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSisProv(s, scene); (s as any).locArgs = __savedLocArgs; }
  scene.text(`${((s as any).AnyaMsg ?? '')}`);
  (s as any).virginmessage = undefined;
  (s as any).plugmessage = undefined;
  (s as any).lubemessage = undefined;
  (s as any).warmupmessage = undefined;
  (s as any).assslutmessage = undefined;
  (s as any).entrymessage = undefined;
...
function enterAnalDildoMast(s: GameState, scene: SceneBuilder): void {
  ...
  if (String((s as any).locArgs?.[1] ?? '') === 'anal_keepgoing') {
    if (((s as any).pcs_horny ?? 0) >= 85) {
      if (((s as any).dildonumber ?? 0) < 3) {
...
function enterSuctionDildo(s: GameState, scene: SceneBuilder): void {
  if ((0 as any) === 1) {
    scene.text('Your <a href="#" onclick="window.__gameStore.getState().doGoto(\u0027selfplay\u0027, \u0027bath_suction_dildo\u0027); return false;">suction dildo</a> is stuck to the bath tub.');
  } else {
    if (((s as any).mc_inventory ?? 0)?.['dildo_suction'] > 0) {
      scene.text('You can stick your suction dildo to the <a href="#" onclick="window.__gameStore.getState().doGoto(\u0027selfplay\u0027, \u0027\u0027bathtub_suction_dildo_apply\u0027 & gt $loc\u0027, window.__gameStore.getState().prevArg); return false;">bath tub</a> to play with.');
    }
  }
  if ((0 as any) === 1  ||  (0 as any) === 1) {
    scene.text('Your suction dildo is <a href="#" onclick="window.__gameStore.getState().doGoto(\u0027selfplay\u0027, \u0027shower_suction_dildo\u0027); return false;">inside the shower</a>.');
  } else {
    if (((s as any).mc_inventory ?? 0)?.['dildo_suction'] > 0) {
      scene.text('You can also stick a suction dildo inside <a href="#" onclick="window.__gameStore.getState().doGoto(\u0027selfplay\u0027, \u0027\u0027shower_suction_dildo_apply\u0027 & gt $loc\u0027, window.__gameStore.getState().prevArg); return false;">the shower</a>.');
    }
  }
  scene.build();
}
...
function enterBathtubSuctionDildoApply(s: GameState, scene: SceneBuilder): void {
  scene.text('' + ((s as any).loc ?? 0) + '_bathtub_dildo = 1');
...
function enterBathtubSuctionDildoRemove(s: GameState, scene: SceneBuilder): void {
  scene.text('' + ((s as any).loc ?? 0) + '_bathtub_dildo = 0');
  scene.text('' + ((s as any).loc ?? 0) + '_suction_dildo -= 1');
  ((s as any).mc_inventory = (s as any).mc_inventory ?? {})['dildo_suction'] = ((s as any).mc_inventory['dildo_suction'] ?? 0) + (1);
  scene.build();
}
...
function enterDildoMasturbateOptions(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).dildo_type ?? 0) === 1) {
    ...
    (st as any).dildo_type = undefined;
  ...
  scene.actions([
    ...
    if (((st as any).dildo_type ?? 0) >= 1  &&  ((st as any).dildo_type ?? 0) < 4) {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBathtubSuctionDildoRemove(st, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterShowerSuctionDildoRemove(st, scene); (st as any).locArgs = __savedLocArgs; }
    }
    qspCall(st, 'arousal', 'end');
    if (((st as any).dildo_type ?? 0) !== 1) {
      (st as any).mirror_steam = ((st as any).hour ?? 0);
...
function enterFingering2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).org_temp ?? 0) === ((s as any).orgasm ?? 0)) {
    ...
    qspCall(st, 'stat', '');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterFingering3(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
        ]);
      }
    } else {
...
function enterFingering4(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).org_temp ?? 0) === ((s as any).orgasm ?? 0)) {
    ...
    qspCall(st, 'willpower', 'pay', 'self');
    qspCall(st, 'stat', '');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSelfFisting_1(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
          ]);
        }
      }
...
function enterStop(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).ass_temp = undefined;
  (s as any).vag_temp = undefined;
  (s as any).mast_vag = undefined;
  (s as any).mast_anal = undefined;

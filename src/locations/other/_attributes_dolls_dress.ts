...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: 5: 6550
  // TODO-QSP: 6: 6800
  // TODO-QSP: CloQuality ranges from 3 to 6, please avoid adding too many 5s and 6s.
...
export const _attributes_dolls_dress: LocationDef = {
  name: '_attributes_dolls_dress',
  region: 'other',
  enter: enter,
};

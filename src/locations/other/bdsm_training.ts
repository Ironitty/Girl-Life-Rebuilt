...
function enterSub_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'foreplay', 10, 'sub', 'lesbian', 'maso', 'bound');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'vaginal_finger', 10, 'sub', 'lesbian', 'maso', 'bound');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'foreplay', 10, 'sub', 'lesbian', 'maso', 'bound');
    qspCall(st, 'arousal', 'vaginal_finger', (-10), 'sub', 'lesbian', 'bound');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterSub_2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'cuni_give', 10, 'sub', 'lesbian', 'maso', 'bound');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
    ...
    (st as any).orgasm_or = 'no';
    qspCall(st, 'arousal', 'vaginal_vibe', 10, 'sub', 'lesbian', 'maso', 'bound');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
    ...
    qspCall(st, 'arousal', 'vaginal_strap', 10, 'sub', 'lesbian', 'maso', 'bound');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
    ...
    qspCall(st, 'arousal', 'vaginal_dildo', 10, 'sub', 'lesbian', 'maso', 'bound', 'rough');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'foreplay', 10, 'sub', 'lesbian', 'maso', 'bound', 'feet');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    (st as any).orgasm_or = 'yes';
    qspCall(st, 'arousal', 'anal_strap', 10, 'sub', 'lesbian', 'maso', 'bound');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterSub_3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'foreplay', 10, 'sub', 'lesbian', 'bound', 'feet');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
    ...
    qspCall(st, 'arousal', 'vaginal_vibe', 10, 'sub', 'lesbian', 'bound');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
    ...
    qspCall(st, 'arousal', 'vaginal', 10, 'sub', 'maso');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    (st as any).orgasm_or = 'yes';
    qspCall(st, 'arousal', 'vaginal', 10, 'sub', 'maso');
    qspCall(st, 'arousal', 'vaginal_finger', 10, 'sub', 'maso');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Breathe', handler: (st: GameState) => {
    (st as any).minut = ((st as any).minut ?? 0) + 10;
...
function enterDom(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'vaginal_vibe_give', 10, 'dom', 'lesbian');

...
function enterDStraponVag(s: GameState, scene: SceneBuilder): void {
  ...
  if (qspFunc(s, 'pcs_has_attr', 'sex_virgin') === 0) {
    ...
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 30) {
      ...
      scene.text(`You groan in pain when ${((s as any).boydesc ?? 0)} penetrates you. Tears flow from your eyes and it feels like someone drove a red-hot rod into your vagina. You cry and moan while ${((s as any).xyr ?? 0)} fake ${((s as any).dick ?? 0)} centimeter dick fucks your pussy${((s as any).temp_mens ?? 0)}.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 20  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 30) {
      ...
      scene.text(`You bite your lip in pain when ${((s as any).boydesc ?? 0)} enters you. It is very painful. You frown and moan in pain while ${((s as any).xyr ?? 0)} fake ${((s as any).dick ?? 0)} centimeter dick fucks your pussy${((s as any).temp_mens ?? 0)}.`);
    }
    ...
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 12  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 20) {
      ...
      scene.text(`You wince at the sudden pain when ${((s as any).boydesc ?? 0)} enters you, it hurts but gradually becomes quite tolerable. You are trying to get aroused while fake ${((s as any).xyr ?? 0)} ${((s as any).dick ?? 0)} centimeter dick fucks your pussy${((s as any).temp_mens ?? 0)}, but you do not succeed.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 7  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 12) {
      ...
      scene.text(`You are startled by the feeling that your pussy is stretching when ${((s as any).boydesc ?? 0)} enters you. It feels good when rubber ${((s as any).xyr ?? 0)} ${((s as any).dick ?? 0)} centimeter dick fucks your pussy${((s as any).temp_mens ?? 0)}.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >=  2  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 7) {
      ...
      scene.text(`You are startled by the feeling that your pussy is stretching as ${((s as any).boydesc ?? 0)} enters you. It feels good when ${((s as any).xyr ?? 0)} ${((s as any).dick ?? 0)} centimeter rubber dick fucks your pussy. Gradually, a pleasant warmth and some pulsations start building up in your stomach, then the feeling decreases a little and remains like that until the end${((s as any).temp_mens ?? 0)}.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= -3  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 2) {
      ...
      scene.text(`You flinch from a pleasant feeling when your pussy is stretched by ${((s as any).xyr ?? 0)} dick. It feels good when ${((s as any).xyr ?? 0)} ${((s as any).dick ?? 0)} centimeter fake dick fucks your pussy${((s as any).temp_mens ?? 0)}. Gradually, a pleasant warmth and some pulsations start building up in your stomach, then the feeling becomes unbearable and your entire body is covered with hot waves of orgasm as you scream with pleasure.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) <  -3) {
      ...
      scene.text(`You feel ${((s as any).xyr ?? 0)} fake penis enter your pussy. This gives you a nice tingling feeling between your legs, but ${((s as any).xyr ?? 0)} ${((s as any).dick ?? 0)} cm rubber dick is significantly less than what your pussy needs. It is not big enough for you. Gradually a pleasant warmth and some pulsations start building up in your stomach. Then the feeling decreases a little and remains like that until the end${((s as any).temp_mens ?? 0)}.`);
    }
...
function enterDVagSexBottle(s: GameState, scene: SceneBuilder): void {
  ...
  if (qspFunc(s, 'pcs_has_attr', 'sex_virgin') === 0) {
    ...
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 30) {
      ...
      scene.text(`You groan in pain when the ${((s as any).dick ?? 0)} cm dildo enters your pussy. Tears flow from your eyes and between your legs feels as if you drove in a red-hot rod${((s as any).temp_mens ?? 0)}.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 20  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 30) {
      // TODO-QSP: dynamic text: You bite your lip in pain when the <<dick>> cm dildo enters your pussy. You feel...
      scene.text(`You bite your lip in pain when the ${((s as any).dick ?? 0)} cm dildo enters your pussy. You feel pain between your legs${((s as any).temp_mens ?? 0)}.`);
    }
    if (((s as any).cycle ?? 0) <= 0) {
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 12  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 20) {
      // TODO-QSP: dynamic text: You flinch at the sudden pain when the <<dick>>cm dildo enters your pussy, but t...
      scene.text(`You flinch at the sudden pain when the ${((s as any).dick ?? 0)}cm dildo enters your pussy, but the pain between your legs slowly calms down and becomes quite tolerable. You are trying to be excited while moving the ${((s as any).dick ?? 0)} cm dildo inside your pussy ${((s as any).temp_mens ?? 0)}, you don't want it to go out.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 7  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 12) {
      // TODO-QSP: dynamic text: You flinch, from feeling your pussy being stretched, with a thrust from a <<dick...
      scene.text(`You flinch, from feeling your pussy being stretched, with a thrust from a ${((s as any).dick ?? 0)}cm dildo. Between your legs feels a little nice, when you fuck yourself with the dildo${((s as any).temp_mens ?? 0)}.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >=  2  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 7) {
      // TODO-QSP: dynamic text: You flinch, from feeling your pussy being stretched, with a thrust from a <<dick...
      scene.text(`You flinch, from feeling your pussy being stretched, with a thrust from a ${((s as any).dick ?? 0)}cm dildo. Between your legs feels a little nice, when you fuck yourself with the dildo. Gradually, a warm and throbbing feeling grows in your lower abdomen, then the feeling subsides and feels nice until the end of${((s as any).temp_mens ?? 0)}.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= -3  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 2) {
      // TODO-QSP: dynamic text: You're startled by a pleasant sensation, when your pussy ravishly starts taking ...
      scene.text(`You're startled by a pleasant sensation, when your pussy ravishly starts taking the dildo. Between your legs becomes very warm, and you feel a pleasant sensation, when a strong ${((s as any).dick ?? 0)} cm dildo moves back and forth in your wet pussy${((s as any).temp_mens ?? 0)}. Gradually, a warm and throbbing feeling grows in your lower abdomen, then the feeling descends on you and your entire body is covered in hot waves of orgasm. You start giving out involuntarily shouts of pleasure while ravishing the dildo.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) <  -3) {
      // TODO-QSP: dynamic text: You feel the dildo penetrating your pussy. Between your legs feels nice, but the...
      scene.text(`You feel the dildo penetrating your pussy. Between your legs feels nice, but the ${((s as any).dick ?? 0)}cm dildo is a bit too small for your pussy. Gradually, a warm and throbbing feeling grows in your lower abdomen, then the feeling slightly subsides and remains steady until the end of${((s as any).temp_mens ?? 0)}.`);
    }
...
function enterDStraponAnal(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_ass ?? 0) < 10) {
    ...
    scene.text(`When ${((s as any).xec ?? 0)} inserts three fingers into your ass you groan in pain.`);
  }
  if (((s as any).pcs_ass ?? 0) >= 10) {
  ...
  if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 20) {
    ...
    scene.text(`You scream and bite your lip from a sharp pain when ${((s as any).xyr ?? 0)} fake ${((s as any).dick ?? 0)} centimeter dick enters your ass.`);
  }
  if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) <  20) {
    // TODO-QSP: dynamic text: You moan when <<$xyr>> <<dick>>cm rubber dick enters your ass.
    scene.text(`You moan when ${((s as any).xyr ?? 0)} ${((s as any).dick ?? 0)}cm rubber dick enters your ass.`);
  }
  // TODO-QSP: dynamic text: <<$boydesc>> stops for a moment, giving your ass time to adjust to <<$xyr>> cock...
  scene.text(`${((s as any).boydesc ?? 0)} stops for a moment, giving your ass time to adjust to ${((s as any).xyr ?? 0)} cock inside it. Then ${((s as any).xe ?? 0)} starts to slowly move, stretching your anus.`);
  if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 30) {
...
function enterDoublepenetration(s: GameState, scene: SceneBuilder): void {
  ...
  if (qspFunc(s, 'pcs_has_attr', 'sex_virgin') === 0) {
    ...
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 30) {
      ...
      scene.text(`You groan in pain when ${((s as any).boydesc1 ?? 0)} penetrates you, tears flow from your eyes and it feels like someone drove a red-hot rod into your vagina.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 20  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 30) {
      ...
      scene.text(`You bite your lip in pain when ${((s as any).boydesc1 ?? 0)} enters you, it is very painful.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 12  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 20) {
      ...
      scene.text(`You wince at the sudden pain when ${((s as any).boydesc1 ?? 0)} enters, it hurts but gradually it becomes quite tolerable.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 7  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 12) {
      ...
      scene.text(`You are startled by the feeling of your pussy stretching when ${((s as any).boydesc1 ?? 0)} enters you.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >=  2  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 7) {
      // TODO-QSP: dynamic text: You are startled by the feeling of your pussy stretching as <<$boydesc1>> enters...
      scene.text(`You are startled by the feeling of your pussy stretching as ${((s as any).boydesc1 ?? 0)} enters you.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= -3  &&  (((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) < 2) {
      // TODO-QSP: dynamic text: You flinch from a pleasant feeling when your pussy is stretched by <<$xyr1>> dic...
      scene.text(`You flinch from a pleasant feeling when your pussy is stretched by ${((s as any).xyr1 ?? 0)} dick.`);
    }
    if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) <  -3) {
      // TODO-QSP: dynamic text: You feel <<$xyr1>> penis entering your pussy. This gives you a nice tingling fee...
      scene.text(`You feel ${((s as any).xyr1 ?? 0)} penis entering your pussy. This gives you a nice tingling feeling between your legs, but ${((s as any).xyr ?? 0)} ${((s as any).dick ?? 0)} cm dick is significantly smaller than what your pussy needs.`);
    }
  } else {
    (s as any).pcs_horny = 0;
    qspCall(s, 'mood', 'lower', 'medium');
    ...
    scene.text(`You bite your ${((s as any).pc_desc ?? 0)?.['lips']} lips in pain and tears start to flow from your eyes when ${((s as any).boydesc1 ?? 0)} penetrates you, breaking your hymen.`);
  }
  (s as any).grange = 0;
  if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 20) {
    (s as any).totPain = ((s as any).totPain ?? 0) + (1);
    // TODO-QSP: dynamic text: You scream and bite your lip from a sharp pain when <<$xyr2>> <<dick2>> centimet...
    scene.text(`You scream and bite your lip from a sharp pain when ${((s as any).xyr2 ?? 0)} ${((s as any).dick2 ?? 0)} centimeter dick enters your ass.`);
  }
  if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) <  20) {
    // TODO-QSP: dynamic text: You moan when <<$xyr2>> <<dick2>> centimeter dick enters your ass.
    scene.text(`You moan when ${((s as any).xyr2 ?? 0)} ${((s as any).dick2 ?? 0)} centimeter dick enters your ass.`);
  }
  // TODO-QSP: dynamic text: <<$boydesc2>> stops for a moment, giving your ass time to adjust to <<$xyr2>> co...
  scene.text(`${((s as any).boydesc2 ?? 0)} stops for a moment, giving your ass time to adjust to ${((s as any).xyr2 ?? 0)} cock inside it. He then starts to slowly move, stretching your anus.`);
  if ((((s as any).arousalVars ?? 0)?.['girth_diff'] + ((s as any).arousalVars ?? 0)?.['length_diff']) >= 30) {
    if (((s as any).pcs_makeup ?? 0) > ((s as any).makeup ?? 0)?.['base']) {
      (s as any).pcs_makeup = 0;
    }

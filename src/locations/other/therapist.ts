...
function enterTherapyOptions(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hypnoAskFuck ?? 0) === 1  &&  (!((s as any).succubusflag ?? 0))) {
    ...
    // TODO-QSP: gt 'therapist', 'fuck', 'kneel'
  } },
      ]);
    } else {
      if (((s as any).temp_rand ?? 0) === 1) {
        ...
        scene.actions([
          { label: 'Get fucked by Dr. Pavlov', handler: (st: GameState) => {
    // TODO-QSP: gt 'therapist', 'fuck', 'back'
  } },
        ]);
      } else {
        ...
        scene.actions([
          { label: 'Get fucked by Dr. Pavlov', handler: (st: GameState) => {
    // TODO-QSP: gt 'therapist', 'fuck', 'ride'
  } },
        ]);
      }
    }
...
function enterTherapyMethod(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hypnoStage ?? 0) < 2  ||  ((s as any).succubusflag ?? 0)?.['therapist'] === 1) {
    ...
    if (((s as any).therapy ?? 0) === 'mood') {
      qspCall(s, 'mood', 'raise', Math.floor(Math.random() * 31) + 20);
      qspCall(s, 'mood', 'raise_disposition', Math.floor(Math.random() * 2) + 0);
    } else {
    ...
    if (((s as any).therapy ?? 0) === 'mood') {
      ...
      if (((s as any).therapy ?? 0) === 'confidence'  ||  ((s as any).therapy ?? 0) === 'school troubles') {
        if (((s as any).willpowermax ?? 0) < 150) {
          (s as any).willpowermax = ((s as any).willpowermax ?? 0) + (Math.floor(Math.random() * 3) + 0);
        }
      } else {
        if (((s as any).therapy ?? 0) === 'charm') {
          qspCall(s, 'exp_gain', 'chrsm', Math.floor(Math.random() * 2) + 1);
  ...
  if (((s as any).succubusflag ?? 0) === 1) {
    ...
    if (((s as any).therapy ?? 0) === 'school troubles') {
      ...
      if ((!((s as any).hypnoStage ?? 0))) {
        ((s as any).trait_vars ?? {})['doormat_exp'] = (((s as any).trait_vars ?? {})['doormat_exp'] ?? 0) + (Math.floor(Math.random() * 2) + 0);
      } else {
        ((s as any).trait_vars ?? {})['doormat_exp'] = (((s as any).trait_vars ?? {})['doormat_exp'] ?? 0) + (((s as any).hypnoStage ?? 0));
      }
    } else {
          ...
          if (((s as any).hypnoTime ?? 0) < 5) {
            ...
            if (((s as any).hypnoTime ?? 0) < 10) {
              ...
              if (((s as any).hypnoTime ?? 0) < 15) {
                ...
                (s as any).willpowermax = ((s as any).willpowermax ?? 0) - (Math.floor(Math.random() * 3) + 8);
              }
            }
          }
        } else {
    ...
    if (qspFunc(s, 'body_din', 'pregnancyVisibility', 0, 'nude') === 1  &&  (!((s as any).HypnoPregNoticed ?? 0))) {
      (s as any).HypnoPregNoticed = 1;
    ...
    scene.img(`images/locations/pavlovsk/clinic/therapist/waiting${Math.floor(Math.random() * 2) + 1}.jpg`);
    // TODO-QSP: dynamic text: "No, Master, It belongs to (Brother/Fedor/Boyfriend) "That's upsetting." he says...
...
function enterSuccubus(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).succubusflag ?? {})['therapist'] = 1;
...
function enterFirstHypnoStage(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'willpower', 'pay', 'resist');
    qspCall(s, 'stat', '');
    // TODO-QSP: gt 'therapist', 'hypnoResist', 'remove your clothing'
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterSecondHypnoStage(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).hypnoTimesResistedStage ?? 0) > 0) {
    ...
    qspCall(s, 'willpower', 'pay', 'resist');
    qspCall(s, 'stat', '');
    // TODO-QSP: gt 'therapist', 'hypnoResist', 'kiss him'
  } },
      ]);
    }
    scene.actions([
...
function enterThirdHypnoStage(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'willpower', 'pay', 'resist');
    qspCall(s, 'stat', '');
    // TODO-QSP: gt 'therapist', 'hypnoResist', 'suck his cock'
  } },
      ]);
    }
    scene.actions([
...
function enterSleepProblems(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    scene.img(`images/locations/pavlovsk/clinic/therapist/hypnotism${Math.floor(Math.random() * 4) + 1}.jpg`);
    (s as any).var1 = 10 - (((s as any).willpowermax ?? 0)/20);
    if (((s as any).var1 ?? 0) <= 1) {
      (s as any).var1 = 2;
    } else {
      if (((s as any).var1 ?? 0) >= 9) {
        (s as any).var1 = 9;
      }
    }
    (s as any).hypnoStrength = ((s as any).hypnoStrength ?? 0) + ((Math.floor(Math.random() * (10 - var1 + 1)) + (var1)) + 3);
    ...
    if (((s as any).pcs_hotcat ?? 0) > (6 - ((s as any).thingsTheTherapistLikes ?? 0))) {
    ...
    // TODO-QSP: dynamic text: You dutifully sit on his cock and begin riding it. <<$func('wrap', 'hypno', '"De...
...
function enterHypnoSitSuck(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text('');
    // TODO-QSP: dynamic text: <<$func('wrap', 'hypno', '"Come on, <i>Cunt</i>, cum now!"')>> he groans, still ...
...
function enterHypnoFuck(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).therapistFuckedPussyStage ?? 0) < 1) {
      (s as any).therapistFuckedPussyStage = 1;
    }
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(s, 'orgasm', 'hypno');
...
function enterHypnoAnal(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: <<$func('wrap', 'hypno', '"Cum, little <i>Cunt</i>, suck all of my seed deep int...
    scene.text(`${qspFunc(s, 'wrap', 'hypno', '"Cum, little <i>Cunt</i>, suck all of my seed deep into your body!"')}`);
    // TODO-QSP: dynamic text: He groans, and you feel his cock contracting inside of you. <<$func('wrap', 'hyp...
...
function enterHypnoEnd(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.img('images/locations/pavlovsk/clinic/therapist/room.jpg');
    if (((s as any).hypnoTxt0 ?? 0) !== '') {
      // TODO-QSP: $hypnoTxt0
    }
    if (((s as any).hypnoTxt1 ?? 0) !== '') {
      // TODO-QSP: $hypnoTxt1
    }
    if (((s as any).hypnoKissGoodbye ?? 0) === 1) {
      scene.actions([
    ...
    if (((s as any).hypnoTxt2 ?? 0) !== '') {
      // TODO-QSP: $hypnoTxt2
    }
    if (((s as any).hypnoTxt3 ?? 0) !== '') {
      // TODO-QSP: $hypnoTxt3
    }
    if (((s as any).therapistFuckedPussy ?? 0) > 0  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
...
function enterHypnoRandom(s: GameState, scene: SceneBuilder): void {
  if ((((s as any).therapistFuckedPussy ?? 0) === 1  ||  ((s as any).therapistFuckedAss ?? 0) === 1)  &&  (Math.floor(Math.random() * 4) + 1) === 1) {
    ...
    if (((s as any).therapistQW ?? 0)?.['hotel_key'] === 0  &&  ((s as any).trait_vars ?? 0)?.['panty_preference'] === 3) {
      scene.actions([
        { label: 'Continue', handler: (st: GameState) => {
    scene.img('images/locations/pavlovsk/clinic/therapist/sittingClothed.jpg');
    ((s as any).therapistQW ?? {})['hotel_key'] = 1;
    ...
    scene.img('images/locations/pavlovsk/clinic/therapist/sittingClothed.jpg');
    ((s as any).therapistQW ?? {})['hotel_key'] = 2;
    ...
    scene.actions([
      ...
      if (((s as any).therapistQW ?? 0)?.['hotel_key'] === 1) {
    ...
    scene.actions([
      { label: 'Continue', goto: ['therapist', 'hypnoEnd'] },
        ...
        if (((s as any).therapistFuckedPussyStage ?? 0) === 1) {
          ...
          ((s as any).pillsleft ?? {})[0] = 0;
          ((s as any).pillsleft ?? {})[1] = 0;
          ((s as any).pillsleft ?? {})[2] = 0;
          ((s as any).pillsleft ?? {})[3] = 0;
          ((s as any).pillsleft ?? {})[4] = 0;
          ((s as any).pillsleft ?? {})[5] = 0;
          ((s as any).mc_inventory ?? {})['contraceptive_pill'] = 1;
          (s as any).tabletkiold = 0;
          (s as any).tabletkifert = 1;
          (s as any).tabletkirej = 0;
          ...
          if (((s as any).hypnoPanty ?? 0) !== 1) {
            ...
            if (((s as any).trait_vars ?? 0)?.['body_hair_attitude'] !== -2) {
              ...
              // TODO-QSP: dynamic text: <<$func('wrap', 'hypno', '"I noticed that you have some stubble on your pussy an...
    ...
    if (((s as any).trait_vars ?? 0)?.['panty_preference'] < 3) {
      ((s as any).trait_vars ?? {})['panty_preference_exp'] = 40000;
      ...
      scene.actions([{ label: 'Continue', goto: ['therapist', 'hypnoEnd'] }]);
                ...
                if (((s as any).hypnoCheckPanties ?? 0) !== 1  &&  (Math.floor(Math.random() * 2) + 1) === 1  &&  ((s as any).hypnoPanty ?? 0) === 1) {
                  scene.img('images/locations/pavlovsk/clinic/therapist/sittingClothed.jpg');
                  // TODO-QSP: dynamic text: <br><<$func('wrap', 'hypno', '"From now on, when you come in for therapy you wil...
                  ...
                  if (((s as any).hypnoCheckPanties ?? 0) === 1  &&  ((s as any).hypnoFlashGreet ?? 0) !== 1  &&  (Math.floor(Math.random() * 2) + 1) === 1  &&  ((s as any).hypnoPanty ?? 0) === 1) {
                    ...
                    if (((s as any).hypnoPanty ?? 0) === 1  &&  ((s as any).hypnoBra ?? 0) === 1  &&  (!((s as any).hypnoClothes ?? 0))) {
                      ...
                      // TODO-QSP: dynamic text: <<$func('wrap', 'hypno', '"Lastly, if they do not have any school clothes, wear ...
                      ...
                      if (((s as any).hypnoTouchWhenever ?? 0) !== 1  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
                        ...
                        if (((s as any).hypnoKissGoodbye ?? 0) !== 1  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
                          ...
                          if (((s as any).trait_vars ?? 0)?.['sensitivity'] > -2) {
                            ...
                            (s as any).hypnoRandomCounter = 0;
                            scene.img('images/locations/pavlovsk/clinic/therapist/sittingClothed.jpg');
                            // TODO-QSP: dynamic text: <<$func('wrap', 'hypno', """From now on, you will have difficulty orgasming if I...
                            ...
                            if (((s as any).hypnoAskFuck ?? 0) !== 1  &&  ((s as any).trait_vars ?? 0)?.['sensitivity'] === -2  &&  ((s as any).hypnoKissGoodbye ?? 0) === 1  &&  ((s as any).hypnoTouchWhenever ?? 0) === 1  &&  ((s as any).hypnoFlashGreet ?? 0) === 1  &&  ((s as any).hypnoBra ?? 0) === 1) {
                              ...
                              (s as any).hypnoRandomCounter = 0;
                              scene.img('images/locations/pavlovsk/clinic/therapist/sittingClothed.jpg');
                              // TODO-QSP: dynamic text: <<$func('wrap', 'hypno', '"From now on, you will feel that it is perfectly norma...
...
function enterHypnoProstitute(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).foundGuy ?? 0) > 0) {
    ...
    if (((s as any).hypnoProstRand ?? 0) === 1) {
      if (((s as any).hypnoProstDates ?? 0)[1] === ((s as any).daystart ?? 0)) {
        ...
        if (((s as any).hypnoProstGuyFlag ?? 0)[1] === 0) {
          ((s as any).hypnoProstDates ?? {})[1] = ((s as any).daystart ?? 0);
          ((s as any).hypnoProstRubles ?? {})[1] = 1300;
    ...
    (s as any).hypnoMoney = ((s as any).hypnoMoney ?? 0) + (qspUntranslated(s, "hypnoProstRubles[1]", { location: "therapist" }));
    scene.actions([
    ...
    ((s as any).hypnoProstGuyFlag ?? {})[1] = 1;
    scene.actions([
      { label: 'Continue waiting', goto: ['therapist', 'hypnoProstitute'] },
          ...
          if (((s as any).hypnoProstRubles ?? 0)[1] > 100) {
            ((s as any).hypnoProstRubles ?? {})[1] = (((s as any).hypnoProstRubles ?? {})[1] ?? 0) - (200);
          }
          if (((s as any).hypnoProstRubles ?? 0)[1] < 100) {
            ((s as any).hypnoProstRubles ?? {})[1] = 100;
          }
          scene.actions([
            { label: 'Follow him to his car', handler: (st: GameState) => {
    scene.text('The inside of his car is a mess. There\'s trash everywhere and it looks like he hasn\'t cleaned the inside or outside for several years.');
    ...
    scene.actions([
      { label: 'Continue.', handler: (st: GameState) => {
    if (((s as any).hypnoProstRubles ?? 0)[1] > 1000) {
      (s as any).minut = ((s as any).minut ?? 0) + 1;
      scene.text('He just started, yet he\'s already cuming inside you. You feel his cum pump into you, then he pulls out and wipes his dick on your thigh.');
    } else {
      if (((s as any).hypnoProstRubles ?? 0)[1] > 800) {
        (s as any).minut = ((s as any).minut ?? 0) + 3;
        ...
        if (((s as any).hypnoProstRubles ?? 0)[1] > 600) {
          (s as any).minut = ((s as any).minut ?? 0) + 5;
          ...
          if (((s as any).hypnoProstRubles ?? 0)[1] > 400) {
            (s as any).minut = ((s as any).minut ?? 0) + 10;
            ...
            if (((s as any).hypnoProstRubles ?? 0)[1] > 200) {
              ...
              if (((s as any).hypnoProstRubles ?? 0)[1] > 0) {
      ...
      if (((s as any).hypnoProstRand ?? 0) === 2) {
        if (((s as any).hypnoProstDates ?? 0)[2] === ((s as any).daystart ?? 0)) {
          ...
          if (((s as any).hypnoProstGuyFlag ?? 0)[2] === 0) {
            ((s as any).hypnoProstDates ?? {})[2] = ((s as any).daystart ?? 0);
        ...
        if (((s as any).hypnoProstRand ?? 0) === 3) {
          if (((s as any).hypnoProstDates ?? 0)[3] === ((s as any).daystart ?? 0)) {
            ...
            if (((s as any).hypnoProstGuyFlag ?? 0)[3] === 0) {
              ((s as any).hypnoProstDates ?? {})[3] = ((s as any).daystart ?? 0);
              ((s as any).hypnoProstRubles ?? {})[3] = 1300;
          ...
          if (((s as any).hypnoProstRand ?? 0) === 4) {
            if (((s as any).hypnoProstDates ?? 0)[4] === ((s as any).daystart ?? 0)  ||  ((s as any).hypnoProstTimes ?? 0) < 50) {
              ...
              if (((s as any).hypnoProstGuyFlag ?? 0)[4] === 0) {
                ((s as any).hypnoProstDates ?? {})[4] = ((s as any).daystart ?? 0);
                ((s as any).hypnoProstRubles ?? {})[4] = 1300;
            ...
            if (((s as any).hypnoProstRand ?? 0) === 5) {
              if (((s as any).hypnoProstDates ?? 0)[5] === ((s as any).daystart ?? 0)) {
                ...
                ((s as any).hypnoProstDates ?? {})[5] = ((s as any).daystart ?? 0);
                if (((s as any).hypnoProstGuyFlag ?? 0)[5] === 0) {
                  ((s as any).hypnoProstGuyFlag ?? {})[5] = 1;
                  ...
                  if (((s as any).hypnoProstGuyFlag ?? 0)[5] === 1) {
                    ((s as any).hypnoProstGuyFlag ?? {})[5] = 2;
    ...
    ((s as any).hypnoProstRubles ?? {})[5] = 6000;
    scene.actions([
    ...
    scene.text(`"I'm ${((s as any).age ?? 0)} years old."`);
    if (((s as any).age ?? 0) < 18) {
      ((s as any).hypnoProstGuyFlag ?? {})[5] = 3;
    ...
    ((s as any).hypnoProstRubles ?? {})[5] = 2000;
        ...
        scene.actions([
          { label: 'Continue waiting', goto: ['therapist', 'hypnoProstitute'] },
                    ...
                    if (((s as any).hypnoProstRubles ?? 0)[5] > 300) {
                      ((s as any).hypnoProstRubles ?? {})[5] = (((s as any).hypnoProstRubles ?? {})[5] ?? 0) - (500);
                    }
                    if (((s as any).hypnoProstRubles ?? 0)[5] < 300) {
                      ((s as any).hypnoProstRubles ?? {})[5] = 300;
                    }
                    ...
                    scene.actions([
                      { label: 'Get fucked', handler: (st: GameState) => {
    if (((s as any).hypnoProstGuyFlag ?? 0)[5] === 3) {
    ...
    scene.actions([
      ...
      if (((s as any).hypnoProstRubles ?? 0)[5] > 500) {
        ((s as any).hypnoProstRubles ?? {})[5] = (((s as any).hypnoProstRubles ?? {})[5] ?? 0) - (200);
      }
      if (((s as any).hypnoProstRubles ?? 0)[5] < 500) {
        ((s as any).hypnoProstRubles ?? {})[5] = 500;
      }
              ...
              if (((s as any).hypnoProstRand ?? 0) === 6) {
                if (((s as any).hypnoProstDates ?? 0)[6] === ((s as any).daystart ?? 0)) {
                  ...
                  if (((s as any).hypnoProstGuyFlag ?? 0)[6] === 0) {
                    ((s as any).hypnoProstDates ?? {})[6] = ((s as any).daystart ?? 0);
                    ((s as any).hypnoProstRubles ?? {})[6] = 1300;
                ...
                if (((s as any).hypnoProstRand ?? 0) === 7) {
                  if (((s as any).hypnoProstDates ?? 0)[7] === ((s as any).daystart ?? 0)) {
                    ...
                    if (((s as any).hypnoProstGuyFlag ?? 0)[7] === 0) {
                      ((s as any).hypnoProstDates ?? {})[7] = ((s as any).daystart ?? 0);
                      ((s as any).hypnoProstRubles ?? {})[7] = 1300;
                  ...
                  if (((s as any).hypnoProstRand ?? 0) === 8) {
                    ...
                    ((s as any).hypnoProstRubles ?? {})[7] = Math.floor(Math.random() * 1201) + 800;
    ...
    (s as any).randomResponse = Math.floor(Math.random() * 2) + 1;
    if (((s as any).randomResponse ?? 0) === 1) {
    ...
    (s as any).hypnoMoney = ((s as any).hypnoMoney ?? 0) + (20);
  } },
    ]);
  } },
    ]);

...
function enterGame(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).chess_move ?? 0) === 1) {
    scene.img('images/locations/pavlovsk/community/chess/board' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
  ...
  if (((s as any).chess_GG ?? 0) <= 0  &&  ((s as any).chess_com ?? 0) <= 0) {
    scene.img('images/locations/pavlovsk/community/chess/stalemate' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
    ...
    if (((s as any).chess_GG ?? 0) <= 0) {
      scene.img('images/locations/pavlovsk/community/chess/lose' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
      ...
      if (((s as any).chess_com ?? 0) <= 0) {
        ...
        scene.img('images/locations/pavlovsk/community/chess/win' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
...
function enterMoves(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).chessM ?? 0) <= 1) {
      scene.img('images/locations/pavlovsk/community/chess/conservative' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
      ...
      if (((st as any).chessM ?? 0) <= 3) {
        scene.img('images/locations/pavlovsk/community/chess/defensive' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
        // TODO-QSP: $chess_name+' plays defensively and is now in a better position than you.'
        { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'conservative', 'bad']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
      } else {
        if (((st as any).chessM ?? 0) <= 5) {
          scene.img('images/locations/pavlovsk/community/chess/tactical' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
          // TODO-QSP: $chess_name+' plays tactically and is able to deftly pick apart your conservative defenses.'
          { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'conservative', 'bad']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
        } else {
          if (((st as any).chessM ?? 0) <= 7) {
            scene.img('images/locations/pavlovsk/community/chess/trap' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
            // TODO-QSP: $chess_name+' tries to trap you, but you encircle it with your defenses.'
            { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'conservative', 'good']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
          } else {
            if (((st as any).chessM ?? 0) <= 9) {
              scene.img('images/locations/pavlovsk/community/chess/offensive' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
              // TODO-QSP: $chess_name+' plays offensively, but your defense repulses his attacks.'
              { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'conservative', 'good']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
            } else {
              if (((st as any).chessM ?? 0) <= 11) {
                scene.img('images/locations/pavlovsk/community/chess/aggressive' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterGame(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ...
    if (((st as any).chessM ?? 0) <= 1) {
      ...
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'defense', 'good']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
      if (((st as any).chessM ?? 0) <= 3) {
        scene.img('images/locations/pavlovsk/community/chess/defensive' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
        ...
        if (((st as any).chessM ?? 0) <= 5) {
          ...
          { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'defense', 'bad']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
        } else {
          if (((st as any).chessM ?? 0) <= 7) {
            scene.img('images/locations/pavlovsk/community/chess/trap' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
    ...
    if (((st as any).chessM ?? 0) <= 1) {
      ...
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'tactical', 'good']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
      if (((st as any).chessM ?? 0) <= 3) {
        scene.img('images/locations/pavlovsk/community/chess/defensive' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
        ...
        if (((st as any).chessM ?? 0) <= 5) {
          ...
          if (((st as any).chessM ?? 0) <= 7) {
            ...
            if (((st as any).chessM ?? 0) <= 9) {
              ...
              { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'tactical', 'bad']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
            } else {
              if (((st as any).chessM ?? 0) <= 11) {
                scene.img('images/locations/pavlovsk/community/chess/aggressive' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
    ...
    if (((st as any).chessM ?? 0) <= 1) {
      ...
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'trap', 'bad']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
      if (((st as any).chessM ?? 0) <= 3) {
        scene.img('images/locations/pavlovsk/community/chess/defensive' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
        ...
        if (((st as any).chessM ?? 0) <= 5) {
          ...
          if (((st as any).chessM ?? 0) <= 7) {
            ...
            if (((st as any).chessM ?? 0) <= 9) {
              ...
              { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'trap', 'good']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
            } else {
              if (((st as any).chessM ?? 0) <= 11) {
                scene.img('images/locations/pavlovsk/community/chess/aggressive' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
    ...
    if (((st as any).chessM ?? 0) <= 1) {
      ...
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'offense', 'bad']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
      if (((st as any).chessM ?? 0) <= 3) {
        scene.img('images/locations/pavlovsk/community/chess/defensive' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
        ...
        if (((st as any).chessM ?? 0) <= 5) {
          ...
          { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'offense', 'good']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
        } else {
          if (((st as any).chessM ?? 0) <= 7) {
            scene.img('images/locations/pavlovsk/community/chess/trap' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
    ...
    if (((st as any).chessM ?? 0) <= 1) {
      ...
      if (((st as any).chessM ?? 0) <= 3) {
        ...
        { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'aggressive', 'good']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
      } else {
        if (((st as any).chessM ?? 0) <= 5) {
          scene.img('images/locations/pavlovsk/community/chess/tactical' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
          ...
          if (((st as any).chessM ?? 0) <= 7) {
            ...
            { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', 'aggressive', 'bad']; enterAdvantage(s, scene); (st as any).locArgs = __savedLocArgs; }
          } else {
            if (((st as any).chessM ?? 0) <= 9) {
              scene.img('images/locations/pavlovsk/community/chess/offensive' + (Math.floor(Math.random() * 1) + 1) + '.jpg');
...
function enterAdvantage(s: GameState, scene: SceneBuilder): void {
  if (Number((s as any).locArgs?.[1] ?? 0) === 'conservative'  ||  Number((s as any).locArgs?.[1] ?? 0) === 'aggressive') {
    (s as any).chess_pos = 4;
    (s as any).chess_neg = (-4);
    (s as any).chess_adv = 4;
  } else {
    if (Number((s as any).locArgs?.[1] ?? 0) === 'defense'  ||  Number((s as any).locArgs?.[1] ?? 0) === 'offense') {
      (s as any).chess_pos = 2;
      (s as any).chess_neg = (-2);
      (s as any).chess_adv = 2;
    } else {
      if (Number((s as any).locArgs?.[1] ?? 0) === 'tactical'  ||  Number((s as any).locArgs?.[1] ?? 0) === 'trap') {
  ...
  if (Number((s as any).locArgs?.[2] ?? 0) === 'good') {
    ...
    if (Number((s as any).locArgs?.[2] ?? 0) === 'bad') {
      if (((s as any).chess_ind ?? 0) > ((s as any).chess_pos ?? 0)) {

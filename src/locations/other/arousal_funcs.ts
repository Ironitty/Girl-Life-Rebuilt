...
function enterStretch(s: GameState, scene: SceneBuilder): void {
  (s as any).temp_amount = ((Number((s as any).locArgs?.[2] ?? 0) === 0) ? (1) : (((s as any).locArgs?.[2] ?? 0)));
  if (Number((s as any).locArgs?.[1] ?? 0) === 'vaginal') {
    ...
    if (Number((s as any).locArgs?.[1] ?? 0) === 'anal') {
      ...
      if (Number((s as any).locArgs?.[1] ?? 0) === 'oral') {
        if (((s as any).trait_vars ?? 0)?.['elasticity'] >= 0  ||  (!(Math.floor(Math.random() * 4) + 0))) {
...
function enterGetHolePain(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_arousalVars ?? 0)?.['pain'] < ((s as any).arousalVars ?? 0)?.['max_sex_pain']  &&  ((s as any).temp_arousalVars ?? 0)?.['stim_time'] > 0) {
    ...
    if ((Math.floor(Math.random() * 3) + 0) < ((s as any).pain_coeff ?? 0)) {
      ((s as any).temp_arousalVars = (s as any).temp_arousalVars ?? {})['ltdif'] = ((s as any).temp_arousalVars['ltdif'] ?? 0) + ((Math.floor(Math.random() * (((s as any).pain_coeff ?? 0) - ((s as any).pain_coeff ?? 0) / 2 + 1)) + (((s as any).pain_coeff ?? 0) / 2)) * 1000);
      ((s as any).temp_arousalVars = (s as any).temp_arousalVars ?? {})['grdif'] = ((s as any).temp_arousalVars['grdif'] ?? 0) + ((Math.floor(Math.random() * (((s as any).pain_coeff ?? 0) - ((s as any).pain_coeff ?? 0) / 2 + 1)) + (((s as any).pain_coeff ?? 0) / 2)) * 1000);
    }
    if (((s as any).temp_arousalVars ?? 0)?.['pain'] > 0) {
      if ((Math.floor(Math.random() * (((s as any).temp_arousalVars ?? 0)?.['hole_slip'] - ((s as any).temp_arousalVars ?? 0)?.['hole_slip'] / 2 + 1)) + (((s as any).temp_arousalVars ?? 0)?.['hole_slip'] / 2)) < ((s as any).temp_arousalVars ?? 0)?.['pain']) {
        ((s as any).temp_arousalVars = (s as any).temp_arousalVars ?? {})['ltdif'] = ((s as any).temp_arousalVars['ltdif'] ?? 0) + ((Math.floor(Math.random() * ((((s as any).temp_arousalVars ?? {})?.['pain'] ?? 0) / Math.max(1, (((s as any).temp_arousalVars ?? {})?.['hole_slip'] ?? 0) / 4) - (((s as any).temp_arousalVars ?? {})?.['pain'] ?? 0) / Math.max(1, (((s as any).temp_arousalVars ?? {})?.['hole_slip'] ?? 0) / 2) + 1)) + ((((s as any).temp_arousalVars ?? {})?.['pain'] ?? 0) / Math.max(1, (((s as any).temp_arousalVars ?? {})?.['hole_slip'] ?? 0) / 2))) * 1000);
      }
      if ((Math.floor(Math.random() * (((s as any).temp_arousalVars ?? 0)?.['hole_slip'] - ((s as any).temp_arousalVars ?? 0)?.['hole_slip'] / 2 + 1)) + (((s as any).temp_arousalVars ?? 0)?.['hole_slip'] / 2)) < ((s as any).temp_arousalVars ?? 0)?.['pain']) {
        ((s as any).temp_arousalVars = (s as any).temp_arousalVars ?? {})['grdif'] = ((s as any).temp_arousalVars['grdif'] ?? 0) + ((Math.floor(Math.random() * ((((s as any).temp_arousalVars ?? {})?.['pain'] ?? 0) / Math.max(1, (((s as any).temp_arousalVars ?? {})?.['hole_slip'] ?? 0) / 4) - (((s as any).temp_arousalVars ?? {})?.['pain'] ?? 0) / Math.max(1, (((s as any).temp_arousalVars ?? {})?.['hole_slip'] ?? 0) / 2) + 1)) + ((((s as any).temp_arousalVars ?? {})?.['pain'] ?? 0) / Math.max(1, (((s as any).temp_arousalVars ?? {})?.['hole_slip'] ?? 0) / 2))) * 1000);
      }
    }
...
function enterInAnal(s: GameState, scene: SceneBuilder): void {
  ...
  if (Number((s as any).locArgs?.[1] ?? 0) > 0  &&  ((s as any).cumvol ?? 0)[3] > (Math.floor(Math.random() * (((s as any).pcs_ass ?? 0) - ((s as any).pcs_ass ?? 0) / 2 + 1)) + (((s as any).pcs_ass ?? 0) / 2))) {
    // TODO-QSP: gs 'cum_manage', 'cum_decay', ((dick_length11 + arousalVars['girth_range']) / 2) * max(1, stim['time...
  }
  // TODO-QSP: end
  scene.build();
...
function enterSetVirginityStats(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).arousalVars ?? 0)?.['self']  ||  Number((s as any).locArgs?.[1] ?? 0) === 'birth') {
  ...
  if (((String(((s as any).locArgs?.[1] ?? 0)).indexOf(String('fist'))) + 1)) {
    ...
    if (Number((s as any).locArgs?.[1] ?? 0) === 'birth') {
...
function enterCount(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).count ?? 0)[Number((s as any).locArgs?.[1] ?? 0)] === 1  ||  ((s as any).count ?? 0)['hidden_' + Number((s as any).locArgs?.[1] ?? 0)] === 1) {
...
function enterCount2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).count ?? 0)[Number((s as any).locArgs?.[1] ?? 0)] === 1) {
    // TODO-QSP: count[$ARGS[1]] = 0
    // TODO-QSP: stat[$ARGS[1]] += 1
  }
  if (((s as any).count ?? 0)['hidden_' + Number((s as any).locArgs?.[1] ?? 0)] === 1) {
...
function enterChecks(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stim ?? 0)[Number((s as any).locArgs?.[1] ?? 0)] === 1) {
...
function enterAutoLube(s: GameState, scene: SceneBuilder): void {
  if (Number((s as any).locArgs?.[1] ?? 0) === 'anal'  &&  ((s as any).auto_anal_lube ?? 0) === 1  &&  ((s as any).anal_slip ?? 0) < 8 + ((s as any).pain ?? 0)?.['asshole'] / 2 - ((s as any).pcs_ass ?? 0)) {
    if (((s as any).mc_inventory ?? 0)?.['lubricant'] > 0) {
      ...
      if (Number((s as any).locArgs?.[2] ?? 0) !== 'custom') {
      ...
      if (Number((s as any).locArgs?.[2] ?? 0) !== 'custom'  ||  (Number((s as any).locArgs?.[2] ?? 0) === 'custom'  &&  ((s as any).lube_txt ?? 0) !== '')) {
        scene.text('You do not have any lube left so cannot use it during this sex act.');
      }
    }
  } else {
    if (Number((s as any).locArgs?.[1] ?? 0) === 'vag'  &&  ((s as any).auto_vag_lube ?? 0) === 1  &&  ((s as any).vaginal_slip ?? 0) < 8 + ((s as any).pain ?? 0)?.['vaginal'] / 2 - ((s as any).pcs_vag ?? 0)) {
      if (((s as any).mc_inventory ?? 0)?.['lubricant'] > 0) {
        (s as any).minut = ((s as any).minut ?? 0) + 1;

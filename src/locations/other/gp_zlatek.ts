...
function enterReturn(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locat ?? 0)?.['A32_loc'] !== 'gad_gphouse') {
    // TODO-QSP: gt $locat['A32_loc'], $locat['A32_arg']
  } else {
...
function enterSetTalkActs(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['talked_about_forest'] === 0) {
    ...
    scene.text(`"Well, I think that's everything, ${((s as any).pcs_nickname || '')}, run along now and remember what I've told you."`);
    scene.actions([
  ...
  if (24 * (((s as any).daystart ?? 0) - ((s as any).grandpaQW ?? 0)?.['last_day_talked']) + (((s as any).hour ?? 0) - ((s as any).grandpaQW ?? 0)?.['last_hour_talked']) >= 3) {
    ...
    ((s as any).grandpaQW = (s as any).grandpaQW ?? {})['last_hour_talked'] = ((s as any).hour ?? 0);
    ((s as any).grandpaQW = (s as any).grandpaQW ?? {})['last_day_talked'] = ((s as any).daystart ?? 0);
    (s as any).minut = ((s as any).minut ?? 0) + 10;
...
function enterGetRandomChoreAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['last_day_helped'] !== ((s as any).daystart ?? 0)) {
    ...
    ((s as any).grandpaQW = (s as any).grandpaQW ?? {})['last_day_helped'] = ((s as any).daystart ?? 0);
    (s as any).frost = 0;
    qspCall(s, 'stat', '');
    scene.img('images/characters/shared/headshots_main/big31.jpg');
    ...
    if (((s as any).month ?? 0) <= 4  ||  ((s as any).month ?? 0) >= 10) {
      ((s as any).grandpaQW = (s as any).grandpaQW ?? {})['chore_type'] = Math.floor(Math.random() * 6) + 0;
    } else {
      if (((s as any).month ?? 0) === 5) {
        ((s as any).grandpaQW = (s as any).grandpaQW ?? {})['chore_type'] = Math.floor(Math.random() * 6) + 3;
      } else {
        if (((s as any).month ?? 0) >= 6  &&  ((s as any).month ?? 0) <= 9) {
          ((s as any).grandpaQW = (s as any).grandpaQW ?? {})['chore_type'] = Math.floor(Math.random() * 12) + 3;
        }
      }
    }
    if (((s as any).grandpaQW ?? 0)?.['chore_type'] === 0) {
      qspGoto(s, 'gp_zlatek', 'chore_fetchfirewood');
    } else {
      if (((s as any).grandpaQW ?? 0)?.['chore_type'] === 1) {
        qspGoto(s, 'gp_zlatek', 'chore_feedhorse');
      } else {
        if (((s as any).grandpaQW ?? 0)?.['chore_type'] === 2) {
          qspGoto(s, 'gp_zlatek', 'chore_feedcow');
        } else {
          if (((s as any).grandpaQW ?? 0)?.['chore_type'] === 3) {
            qspGoto(s, 'gp_zlatek', 'chore_cleanyard');
          } else {
            if (((s as any).grandpaQW ?? 0)?.['chore_type'] === 4) {
              qspGoto(s, 'gp_zlatek', 'chore_brushhorse');
            } else {
              if (((s as any).grandpaQW ?? 0)?.['chore_type'] === 5) {
                qspGoto(s, 'gp_zlatek', 'chore_feedboar');
              } else {
                if (((s as any).grandpaQW ?? 0)?.['chore_type'] === 6  &&  ((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) < 9) {
                  qspGoto(s, 'gp_zlatek', 'chore_leadhorsetofield');
                } else {
                  if (((s as any).grandpaQW ?? 0)?.['chore_type'] === 7  &&  ((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) < 9) {
                    qspGoto(s, 'gp_zlatek', 'chore_leadcowtofield');
                  } else {
                    if (((s as any).grandpaQW ?? 0)?.['chore_type'] === 8  &&  ((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) < 9) {
                      qspGoto(s, 'gp_zlatek', 'chore_herdcattle');
                    } else {
    ...
    if (((s as any).hour ?? 0) >= 9) {
      (s as any).randmsg = Math.floor(Math.random() * 6) + 0;
      if ((!((s as any).randmsg ?? 0))) {
        // TODO-QSP: dynamic text: "You can rest today <<$pcs_nickname>>, you don't need to help me today."
        scene.text(`"You can rest today ${((s as any).pcs_nickname || '')}, you don't need to help me today."`);
      } else {
        if (((s as any).randmsg ?? 0) === 1) {
          scene.text('"You can rest today child, there is nothing to do."');
        } else {
          if (((s as any).randmsg ?? 0) === 2) {
            // TODO-QSP: dynamic text: "You can rest today <<$pcs_nickname>>, there is nothing to do."
            scene.text(`"You can rest today ${((s as any).pcs_nickname || '')}, there is nothing to do."`);
          } else {
            if (((s as any).randmsg ?? 0) === 3) {
              // TODO-QSP: dynamic text: "There's no work today <<$pcs_nickname>>, go and rest up."
              scene.text(`"There's no work today ${((s as any).pcs_nickname || '')}, go and rest up."`);
            } else {
              if (((s as any).randmsg ?? 0) === 4) {
      ...
      (s as any).randmsg = Math.floor(Math.random() * 2) + 0;
      if ((!((s as any).randmsg ?? 0))) {
        // TODO-QSP: dynamic text: "You don't need to help out today, <<$pcs_nickname>>."
        scene.text(`"You don't need to help out today, ${((s as any).pcs_nickname || '')}."`);
      } else {
...
function enterCheckForChores(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'barn') {
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 'barn_horse') {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 3;
      ...
      if (((s as any).locArgs?.[1] ?? 0) === 'barn_cow') {
        ...
        if (((s as any).locArgs?.[1] ?? 0) === 'boar') {
          ...
          if (((s as any).locArgs?.[1] ?? 0) === 'beach') {
            ...
            if (((s as any).locArgs?.[1] ?? 0) === 'field') {
              if (((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) < 20  &&  ((s as any).week ?? 0) < 6) {
                scene.text('Grandfather\'s horse <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027gad_field\\u0027, \\u0027horse\\u0027); return false;">Desperado</a> is grazing the field.');
              }
              if (((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) < 20  &&  ((s as any).grandpaQW ?? 0)?.['chore_herd_cattle'] === 0) {
                scene.text('You notice a large <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027gad_field\\u0027, \\u0027cow\\u0027); return false;">herd of cows</a> in the middle of the field.');
              }
              if (((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) < 21  &&  ((s as any).grandpaQW ?? 0)?.['chore_herd_cattle'] === 1) {
                scene.text('You see the <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027gad_field\\u0027, \\u0027cow\\u0027); return false;">herd of cows</a> out in the middle of the field.');
              }
              ...
              if (((s as any).locArgs?.[1] ?? 0) === 'field_horse') {
...
function enterChoreFetchfirewood(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"You are very quick, ${((s as any).pcs_nickname || '')}," he replies with a smile. "That's today's youth for ya. There is no more work today."`);
    scene.actions([
...
function enterSetReportFetchfirewoodAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_fetch_firewood'] === 2) {
    ...
    scene.text(`"Thank you very much, ${((s as any).pcs_nickname || '')}," he replies with a smile. "Just set it down over there."`);
...
function enterSetReportFeedhorseAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_feed_horse'] === 2) {
    ...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}," he says. "It is imperative to make sure a horse is well fed. They are hard workers and deserve their meals."`);
...
function enterSetReportLeadhorsetofieldAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_lead_horse_to_field'] === 2) {
    ...
    scene.text(`Your grandfather smiles at that. "Thank you, ${((s as any).pcs_nickname || '')}. You can rest for now."`);
    scene.actions([
      { label: 'Continue', goto: ['gp_zlatek', 'talk'] },
    ]);
  } },
...
function enterEventBathehorse2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).PSwim ?? 0) === 0  &&  ((s as any).clothingworntype ?? 0) !== 'nude') {
    ...
    ((s as any).grandpaQW = (s as any).grandpaQW ?? {})['chore_bathe_horse_prog'] = 2;
    qspCall(s, 'stat', '');
    if (((s as any).clothingworntype ?? 0) === 'nude') {
...
function enterSetReportBathehorseAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_bathe_horse'] === 2) {
    ...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}," he says. "Grooming him is all well and good, but sometimes it's not enough."`);
...
function enterSetReportBrushhorseAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_brush_horse'] === 2) {
    ...
    // TODO-QSP: dynamic text: "Don't sass me, <<$pcs_firstname>>," your grandfather says with a scowl. "Proper...
    scene.text(`"Don't sass me, ${((s as any).pcs_firstname || '')}," your grandfather says with a scowl. "Properly brushing a horse is very important for their health."`);
    scene.text('The rebuke stings a little. "Sorry, Grandpa."');
    // TODO-QSP: dynamic text: His face softens when he sees he upset you. "…no, child, I'm sorry. You did me a...
    scene.text(`His face softens when he sees he upset you. "…no, child, I'm sorry. You did me a favor, and here I am berating you for it. Thank you for brushing the horse, ${((s as any).pcs_nickname || '')}."`);
...
function enterSetReportFeedcowAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_feed_cow'] === 2) {
    ...
    scene.text(`"Excellent, ${((s as any).pcs_nickname || '')}," he says. "I presume she acted like we were starving her to death?"`);
...
function enterSetReportCleanyardAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_clean_yard'] === 2) {
    ...
    scene.text(`"No, that is all for today, ${((s as any).pcs_nickname || '')}."`);
    scene.actions([
      { label: 'Continue', goto: ['gp_zlatek', 'talk'] },
    ]);
  } },
...
function enterSetReportFeedboarAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_feed_boar'] === 2) {
    ...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}," he says.`);
...
function enterChoreGathermushrooms(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: "<<grandpaQW['chore_mushroom_quantity']>> kilos will be enough," grandfather rep...
...
function enterSetReportGathermushroomsAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_gather_mushrooms'] === 2  &&  ((s as any).boletus ?? 0) >= ((s as any).grandpaQW ?? 0)?.['chore_mushroom_quantity']  &&  ((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) < 20) {
    ...
    ((s as any).grandpaQW = (s as any).grandpaQW ?? {})['disappointment'] = 0;
    ((s as any).grandmaQW = (s as any).grandmaQW ?? {})['help_amount'] = ((s as any).grandmaQW['help_amount'] ?? 0) + (1);
    ...
    // TODO-QSP: dynamic text: "Thank you, <<$pcs_nickname>>, you've made an old man happy," your grandfather r...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}, you've made an old man happy," your grandfather replies with a smile. "The mushrooms are in a part of the forest that is difficult to reach, so no wonder it took you so long."`);
    ...
    scene.text(`"There's no need ${((s as any).pcs_nickname || '')}," said your grandfather. "But if I need some help, I'll let you know. They will have to go down in the root cellar until your grandmother is ready to can them."`);
    ...
    scene.text('You walk up to Grandpa with your basket.');
    scene.text('"Grandpa, here are the mushrooms!"');
    // TODO-QSP: dynamic text: "Thank you, <<$pcs_nickname>>, you've made an old man very happy," your grandfat...
    scene.text(`"Thank you, ${((s as any).pcs_nickname || '')}, you've made an old man very happy," your grandfather replies with a smile. "The mushrooms are in a part of the forest that is difficult to reach."`);
    scene.text('"I can still go and gather more mushrooms if you want?"');
    // TODO-QSP: dynamic text: "There's no need, <<$pcs_nickname>>," said your grandfather. "But if I need some...
    scene.text(`"There's no need, ${((s as any).pcs_nickname || '')}," said your grandfather. "But if I need some help, I'll let you know. They will have to go down in the root cellar until your grandmother is ready to can them."`);
    scene.text('You kiss your grandfather on the cheek and get on with your day.');
...
function enterChoreGatherberries(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('"How much should I pick, grandpa?" you ask.');
  // TODO-QSP: dynamic text: "<<grandpaQW['chore_berry_quantity']>> kilos will be enough," grandfather replie...
...
function enterSetReportGatherberriesAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_gather_berries'] === 2  &&  ((s as any).bilberry ?? 0) >= ((s as any).grandpaQW ?? 0)?.['chore_berry_quantity']  &&  ((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) < 20) {
    ...
    // TODO-QSP: dynamic text: There's no need, <<$pcs_nickname>>," your grandfather said. "But if your grandma...
    scene.text(`There's no need, ${((s as any).pcs_nickname || '')}," your grandfather said. "But if your grandma needs some more berries, I'll let you know. They will have to go down in the root cellar until your grandmother is ready to can them."`);
...
function enterChoreGatherboth(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: "<<grandpaQW['chore_mushroom_quantity']>> kilos of mushrooms and <<grandpaQW['ch...
...
function enterSetReportGatherbothAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_gather_both'] === 2  &&  ((s as any).boletus ?? 0) >= ((s as any).grandpaQW ?? 0)?.['chore_mushroom_quantity']  &&  ((s as any).bilberry ?? 0) >= ((s as any).grandpaQW ?? 0)?.['chore_berry_quantity']  &&  ((s as any).hour ?? 0) >= 6  &&  ((s as any).hour ?? 0) < 20) {
    ...
    scene.text(`"Oh, thank you, ${((s as any).pcs_nickname || '')}, better late than never," your grandfather replied.`);
    scene.text('"If you want, I can go out for another run."');
    // TODO-QSP: dynamic text: "You don't need to do that, <<$pcs_nickname>>," your grandfather said. "But I'll...
    scene.text(`"You don't need to do that, ${((s as any).pcs_nickname || '')}," your grandfather said. "But I'll let you know if something comes up. They will have to go down in the root cellar until your grandmother is ready to can them."`);
    ...
    scene.text(`"Oh, thank you, ${((s as any).pcs_nickname || '')}," your grandfather replied.`);
    scene.text('"If you want, I can go out for another run."');
    // TODO-QSP: dynamic text: "You don't need to do that, <<$pcs_nickname>>," your grandfather said. "But I'll...
    scene.text(`"You don't need to do that, ${((s as any).pcs_nickname || '')}," your grandfather said. "But I'll let you know if something comes up. They will have to go down in the root cellar until your grandmother is ready to can them."`);
    scene.text('You give him a smooch on the cheek and go on with your day.');
...
function enterSetReportBalehayAct(s: GameState, scene: SceneBuilder): void {
  if (((s as any).grandpaQW ?? 0)?.['chore_bale_hay'] === 2) {
    ...
    scene.text(`He smiles proudly at you and says, "Yes, I was there too, ${((s as any).pcs_nickname || '')}. I saw you working hard."`);

...
function enterMetro(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspGoto(s, 'katja_city', 'metro_ride');
  } },
  ]);
  scene.build();
}
...
function enterMetroRide(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).katjaQW ?? 0)?.['drinks'] > (Math.floor(Math.random() * 5) + 10)) {
      ...
      qspGoto(s, 'katja_city', 'metro_get_off');
    }
  } },
  ]);
  scene.build();
...
function enterMetroGetOff(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspGoto(s, 'katja_city', 'metro_destination');
  } },
  ]);
  scene.build();
}
...
function enterMetroDestination(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locat ?? 0)?.['katja'] === 44) {
    ...
    (s as any).frost = 0;
    qspCall(s, 'themes', 'indoors');
    qspGoto(s, 'katja_nightclub', 'dance');
  } },
        ]);
      } else {
    ...
    (s as any).frost = 0;
    qspCall(s, 'themes', 'indoors');
    qspGoto(s, 'katja_nightclub', 'bar_arrive');
  } },
        ]);
      }
    } else {
...
function enterClothesStart1(s: GameState, scene: SceneBuilder): void {
  ...
  if ((Math.floor(Math.random() * 2) + 0) ===1) {
    ...
    scene.actions([
      { label: '', labelFn: (s: GameState) => 'Go to ' + String(((s as any).store_choice || '') ?? ''), goto: ['katja_city', 'store_choice'] },
    ]);
  } else {
...
function enterPussyCatOutfit1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'stat', '');
    qspGoto(s, 'katja_city', 'pussy_cat_outfit1_strip');
  } },
            ]);
          }
        }
...
function enterPussyCatOutfit1Strip(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_had_sex ?? 0)?.['A14'] === 0) {
    ...
    qspCall(s, 'willpower', 'pay', 'force');
    qspCall(s, 'stat', '');
    qspGoto(s, 'katja_city', 'pussy_cat_outfit1_play');
  } },
        ]);
      }
      scene.actions([
...
function enterPussyCatOutfit1Play(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).npc_ass ?? 0)?.['A14'] === 0) {
      ((s as any).npc_ass = (s as any).npc_ass ?? {})['A14'] = 1;
    ...
    qspCall(s, 'arousal', 'end');
    if (((s as any).katjaQW ?? 0)?.['know_butt_plug'] === 0) {
      ((s as any).katjaQW = (s as any).katjaQW ?? {})['know_butt_plug'] = 1;
    }
...
function enterPussyCatOutfit2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    dynamicGoto(st, 'prevLoc', 'prevArg');
      ...
      if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] >= 5) {
        ...
        if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] < 4) {
          ((s as any).katjaQW = (s as any).katjaQW ?? {})['pantiesQWstage'] = ((s as any).katjaQW['pantiesQWstage'] ?? 0) + (1);
        }
    ...
    qspCall(s, 'stat', '');
    qspGoto(s, 'katja_city', 'pussy_cat_outfit2_strip');
  } },
              ]);
            }
          }
...
function enterPussyCatOutfit2Strip(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_had_sex ?? 0)?.['A14'] === 0) {
    ...
    qspCall(s, 'willpower', 'pay', 'force');
    qspCall(s, 'stat', '');
    qspGoto(s, 'katja_city', 'pussy_cat_outfit2_play');
  } },
        ]);
      }
      scene.actions([

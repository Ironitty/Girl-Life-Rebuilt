...
function enterDressTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['plans_later_talk'] === 0  &&  ((((s as any).hour ?? 0) < 16  &&  ((s as any).hour ?? 0) > 4)  ||  ((s as any).sex_ev ?? 0)?.['sleepover'] === 1)) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDressTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    if (((st as any).npc_day_off ?? 0)?.[String((st as any).npcID ?? 0)] === ((st as any).week ?? 0)) {
      ...
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPcSexEvInvite(st, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
      scene.text(`"I have to go to work," ${((st as any).npcdesc ?? '')} replies.`);
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterWhenDoYouGetOff(st, scene); (st as any).locArgs = __savedLocArgs; }
    }
  } },
    ]);
  }
  ...
  if (((s as any).sex_ev ?? 0)?.['spend_night_thanks'] === 0  &&  ((s as any).sex_ev ?? 0)?.['sleepover'] === 1) {
    scene.actions([
      { label: 'Thanks for letting me stay over', goto: ['sex_ev_dress_talking', 'stay_over_thanks'] },
    ]);
  }
  if (((s as any).sex_ev ?? 0)?.['fuck_count'] > 5  &&  ((s as any).sex_ev ?? 0)?.['walk_funny_talk'] === ''  &&  ((s as any).pain ?? 0)?.['vaginal'] > 10) {
    scene.actions([
      { label: 'I\'m gonna walk funny because of you', goto: ['sex_ev_dress_talking', 'walk_funny'] },
    ]);
  }
  if (((s as any).cum_loc ?? 0)?.['vagina'] > 0  &&  ((s as any).cum_vol ?? 0)?.['vagina'] > 100  &&  ((s as any).sex_ev ?? 0)?.['cum_leak_talk'] === ''  &&  ((s as any).hour ?? 0) < 10) {
    scene.actions([
      { label: 'Gonna be leaking cum all day', goto: ['sex_ev_dress_talking', 'leak_all_day'] },
    ]);
  }
  if (((s as any).sex_ev ?? 0)?.['sex_ev_ask'] === 0) {
    if ((Array.isArray((s as any).lover) ? ((s as any).lover as any[]).indexOf(((s as any).npcID ?? 0)) : -1) < 0) {
      ...
      if (((s as any).sex_ev ?? 0)?.['sleepover'] === 1  ||  ((s as any).hour ?? 0) < 5) {
        scene.actions([
          { label: 'Ask to come over later', goto: ['sex_ev_dress_talking', 'pc_sex_ev_invite'] },
        ]);
      } else {
        if (((s as any).npc_living_together ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] !== 'hookup'  &&  ((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] !== '') {
          scene.actions([
            { label: 'Ask to come over tomorrow', goto: ['sex_ev_dress_talking', 'pc_sex_ev_invite'] },
          ]);
        }
      }
    }
  ...
  if (((s as any).sex_ev ?? 0)?.['ma_pill_money'] === 0  &&  ((s as any).birth_control ?? 0)?.['think_safe'] === 0  &&  ((s as any).birth_control ?? 0)?.['using_bc'] <= 0  &&  ((s as any).sex_ev ?? 0)?.['creampie_count'] > 0  &&  ((s as any).npc_pay_for_ma_pill ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    scene.actions([
      { label: 'Ask for money for plan B', goto: ['sex_ev_dress_talking', 'ma_pill_ask_money1'] },
    ]);
  }
...
function enterStayOverThanks(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['spend_night_thanks'] === 0  &&  ((s as any).sex_ev ?? 0)?.['sleepover'] === 1) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDressTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterHadAGoodTime(st, scene); (st as any).locArgs = __savedLocArgs; }
...
function enterWalkFunny(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterWalkFunny2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterLeakAllDay(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLeakAllDay2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    { label: 'Annoyed', handler: (st: GameState) => {
  ...
  scene.actions([
    ...
    while (true) {
      ...
      if (((st as any).npc_booty_call_time ?? 0)?.[String((st as any).npcID ?? 0)] > 22) {
        ...
        { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterPcSexEvInvite2(st, scene); (st as any).locArgs = __savedLocArgs; }
      }
    }
  } },
  ]);
...
function enterNpcSexEvInvite(s: GameState, scene: SceneBuilder): void {
  if ((((Math.floor(Math.random() * 10) + 1) < ((s as any).npc_sexdrive ?? 0)?.[String((s as any).npcID ?? 0)]  ||  (Math.floor(Math.random() * 200) + 1) < ((s as any).npc_rel ?? 0)?.[String((s as any).npcID ?? 0)])  &&  ((s as any).sex_ev ?? 0)?.['sex_ev_ask'] === 0  &&  ((s as any).sex_ev ?? 0)?.['sex_ev_he_ask'] === 0)  &&  (((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] !== 'sugar_daddy'  ||  (((s as any).npc_sugar_daddy_timer ?? 0)?.[String((s as any).npcID ?? 0)] - (((s as any).npc_rel ?? 0)?.[String((s as any).npcID ?? 0)] / 10) < ((s as any).daystart ?? 0)))) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBusyLater(st, scene); (st as any).locArgs = __savedLocArgs; }
    scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBusyTime(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSexEvPlan(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  } },
    ]);
...
function enterSexEvInviteLater(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    if (((st as any).npc_day_off ?? 0)?.[String((st as any).npcID ?? 0)] === ((st as any).week ?? 0)  &&  ((st as any).sex_ev ?? 0)?.['sleepover'] === 1) {
      ((st as any).sex_ev_plan_loc = (st as any).sex_ev_plan_loc ?? {})[String((st as any).npcID ?? 0)] = 'lover_home';
      ((st as any).sex_ev = (st as any).sex_ev ?? {})['invite_today'] = 1;
...
function enterSexEvPlan(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    while (true) {
      ((st as any).npc_booty_call_time = (st as any).npc_booty_call_time ?? {})[String((st as any).npcID ?? 0)] = window.prompt("When do you want to come over to " + (((st as any).npcdesc ?? 0)) + "'s? (Pick an hour 1 - 22.)") ?? '';
      if (((st as any).npc_booty_call_time ?? 0)?.[String((st as any).npcID ?? 0)] > 22) {
        alert('Invalid input. Pick an hour between 1 and 22.');
        break;
      } else {
        { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSexEvPlan2(st, scene); (st as any).locArgs = __savedLocArgs; }
      }
    }
  } },
    ]);
...
function enterMaPillAskMoney2(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMaPillAskMoney3(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterSugarMoney(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'money', 'earn', (((s as any).npc_sugar_daddy_price ?? 0)?.[String((s as any).npcID ?? 0)] ?? 0));
  scene.actions([
...
function enterBreakUpEv(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'sex_ev_clothing', 'dress_loop');
  scene.text(`iif($sex_ev['loc'] ! 'pc_home', '"This is the last time I'm coming over," you say abruptly while ${(((s as any).sex_ev ?? 0)?.['dress_describe'] ?? '')}.', '"This is the last time you can come over," you say abruptly.')`);
...
function enterBreakupExplain(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'You don\'t satisfy me', goto: ['sex_ev_dress_talking', 'unsatisfied_breakup'] },
  ]);
  scene.build();
}
...
function enterUnsatisfiedBreakup(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_sexdrive ?? 0)?.[String((s as any).npcID ?? 0)] === 1  ||  ((s as any).npc_two_pump ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    scene.text('"Wait but-"');
    scene.actions([
      { label: 'Grab your things', goto: ['sex_ev_dress_talking', 'grab_things_leave'] },
    ]);
  } },
    ]);
  } else {
  ...
  scene.actions([
    ...
    scene.actions([
      { label: '', labelFn: (s: GameState) => 'End things with ' + String(((st as any).npcdesc ?? '') ?? ''), goto: ['sex_ev_dress_talking', 'break_up_ev'] },
    ]);
  } },
  ]);
  scene.build();

...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).kameraKPZ ?? 0) < 3) {
    ...
    scene.text(`By lattice policeman came and Anatoly Borisovich. The policeman immediately stepped aside and host bystroezhki said. "${((s as any).pcs_nickname ?? 0)}, ${((s as any).pcs_nickname ?? 0)}, well, how could you?"`);
    scene.actions([
    ...
    scene.text(`You were telling Ilyushkin tried to persuade you to have sex and you refused him as he naplel you tales about your raise and gave you the keys. As you took the envelope and gave it to Ilyushkin. Anatoly Borisovich sad you looked through the bars. "${((s as any).pcs_nickname ?? 0)}. Ilyushkin showed himself a true professional and honest person. He made his way to the main managers of the lower classes. And you mean to tell me that he was tempted by what is 650000? Risking all, his position, his career, reputation, only to have that would steal the money and annoy you? You just dishwasher. What sense would he do that? Besides Ilyushkin decent salary and maybe soon it will become director of the branch. "`);
    scene.actions([
    ...
    if (!(s as any).BurgerQW) (s as any).BurgerQW = {}; (s as any).BurgerQW['IlyQWPoliceDayCount'] = 1;
    if (!(s as any).BurgerQW) (s as any).BurgerQW = {}; (s as any).BurgerQW['IlyQWTatianaHelp'] = 1;
    qspCall(s, 'stat', '');

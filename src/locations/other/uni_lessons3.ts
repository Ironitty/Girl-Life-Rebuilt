...
function enterGeneralEducation_201(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_3', 'general education 201', ((st as any).pcs_intel ?? 0));
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_3', 'general education 201', ((st as any).pcs_chrsm ?? 0));
...
function enterAssessment_201(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_teaching_studies_semester_3', 'assessment 201');
  qspCall(s, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
  qspCall(s, 'stat', '');
  scene.img(`images/locations/city/island/university/classroom/lecture${(Math.floor(Math.random() * 5) + 1)}.jpg`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_3', 'assessment 201', ((st as any).pcs_intel ?? 0));
    ((st as any).trait_vars = (st as any).trait_vars ?? {})['academic_lessons'] = ((st as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(st, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${(Math.floor(Math.random() * 4) + 1)}.jpg`);
...
function enterLearningTheories_201(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_teaching_studies_semester_3', 'learning theories 201');
  qspCall(s, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
  qspCall(s, 'stat', '');
  scene.img(`images/locations/city/island/university/classroom/lecture${(Math.floor(Math.random() * 5) + 1)}.jpg`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_3', 'learning theories 201', ((st as any).pcs_intel ?? 0));
    ((st as any).trait_vars = (st as any).trait_vars ?? {})['academic_lessons'] = ((st as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(st, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${(Math.floor(Math.random() * 4) + 1)}.jpg`);
...
function enterPatientCare_201(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_nursing_semester_3', 'patient care 201');
  qspCall(s, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_3', 'patient care 201', ((st as any).pcs_intel ?? 0));
    qspCall(st, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
    ((st as any).trait_vars = (st as any).trait_vars ?? {})['academic_lessons'] = ((st as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(st, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${(Math.floor(Math.random() * 4) + 1)}.jpg`);
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_3', 'patient care 201', ((st as any).pcs_chrsm ?? 0));
    qspCall(st, 'exp_gain', 'chrsm', (Math.floor(Math.random() * 2) + 1));
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
  ...
  scene.actions([
    ...
    if ((Math.floor(Math.random() * 2) + 0) > 0) {
      ...
      scene.text('You hear Professor Kudelina clear her throat and glance up to see her sternly looking at you.');
      qspCall(st, 'willpower', 'misc', 'self', 'medium');
      if (((st as any).pcs_willpwr ?? 0) < ((st as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Keep using your phone', handler: (st: GameState) => {
...
function enterAnatomyAndPhysiology_201(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_nursing_semester_3', 'anatomy and physiology 201');
  qspCall(s, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
  qspCall(s, 'exp_gain', 'medcn', 5);
  qspCall(s, 'stat', '');
  scene.img(`images/locations/city/island/university/classroom/lecture${(Math.floor(Math.random() * 5) + 1)}.jpg`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_3', 'anatomy and physiology 201', ((st as any).pcs_intel ?? 0));
    qspCall(st, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
    ((st as any).trait_vars = (st as any).trait_vars ?? {})['academic_lessons'] = ((st as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(st, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${(Math.floor(Math.random() * 4) + 1)}.jpg`);
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_3', 'anatomy and physiology 201', ((st as any).pcs_chrsm ?? 0));
    qspCall(st, 'exp_gain', 'chrsm', (Math.floor(Math.random() * 2) + 1));
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
...
function enterDosagesAndPharmaceuticals_101(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_nursing_semester_3', 'dosages and pharmaceuticals 101');
  qspCall(s, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
  qspCall(s, 'exp_gain', 'medcn', 5);
  qspCall(s, 'stat', '');
  scene.img(`images/locations/city/island/university/classroom/lecture${(Math.floor(Math.random() * 5) + 1)}.jpg`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_3', 'dosages and pharmaceuticals 101', ((st as any).pcs_intel ?? 0));
    qspCall(st, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
    ((st as any).trait_vars = (st as any).trait_vars ?? {})['academic_lessons'] = ((st as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(st, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${(Math.floor(Math.random() * 4) + 1)}.jpg`);
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_3', 'dosages and pharmaceuticals 101', ((st as any).pcs_chrsm ?? 0));
    qspCall(st, 'exp_gain', 'chrsm', (Math.floor(Math.random() * 2) + 1));
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
...
export const uni_lessons3: LocationDef = {
  name: 'uni_lessons3',

...
function enterGeneralEducation_201(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_3', 'general education 201', ((s as any).pcs_chrsm ?? 0));
...
function enterPatientCare_201(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_3', 'patient care 201', ((s as any).pcs_chrsm ?? 0));
    qspCall(s, 'exp_gain', 'chrsm', Math.floor(Math.random() * 2) + 1);
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
...
function enterAnatomyAndPhysiology_201(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_3', 'anatomy and physiology 201', ((s as any).pcs_chrsm ?? 0));
    qspCall(s, 'exp_gain', 'chrsm', Math.floor(Math.random() * 2) + 1);
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
...
function enterDosagesAndPharmaceuticals_101(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_3', 'dosages and pharmaceuticals 101', ((s as any).pcs_chrsm ?? 0));
    qspCall(s, 'exp_gain', 'chrsm', Math.floor(Math.random() * 2) + 1);
    scene.img('images/locations/city/island/university/classroom/question1.jpg');

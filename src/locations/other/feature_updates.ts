...
function enterShow(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).update_report_last ?? 0) < 98) {
    ...
    (s as any).temp_icon_today = '<img src="images/system/icons/jobs/city_cafe_waitress.png" height="80">';
    (s as any).temp_icon_blue = '<span style="display:inline-block;background:' + ((s as any).theme_hex ?? 0)?.['accent'] + ';border-radius:12px;height:80px;padding:5%;box-sizing:border-box;"><img src="images/system/icons/jobs/city_cafe_waitress.png" style="width:100%;height:100%;display:block;"></span>';

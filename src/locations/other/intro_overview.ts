...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('</table>');
  scene.text('</center>');
  (s as any).temp_cell_td_1 = undefined;
  (s as any).temp_cell_td_1_end = undefined;
  (s as any).temp_cell_td_3 = undefined;
  (s as any).temp_cell_td_3_end = undefined;
  (s as any).temp_header = undefined;
  s.viewImage = String(qspFunc(s, '$face_image', '') || '');
  scene.actions([
...
function enterLeave(s: GameState, scene: SceneBuilder): void {
  (s as any).overview_show_body_options = undefined;
  (s as any).overview_show_archetype_options = undefined;
  (s as any).overview_show_trait_options = undefined;
  (s as any).overview_show_document_options = undefined;
  (s as any).overview_show_item_options = undefined;
...
function enterRenderCell(s: GameState, scene: SceneBuilder): void {
  ...
  if (String((s as any).locArgs?.[3] ?? '') === 0) {
    ...
    (s as any).result = ((s as any).result ?? 0) + ('<td width="1%" nowrap rowspan="3" align="center" valign="middle" style="text-align: center; vertical-align:middle">');
    (s as any).result = ((s as any).result ?? 0) + ('<a style="text-decoration: none" href="exec:' + ((s as any).locArgs?.[4] ?? 0) + ' & gt \'intro_overview\'">');
    (s as any).result = ((s as any).result ?? 0) + ('<big>◀</big>');
    (s as any).result = ((s as any).result ?? 0) + ('</a>');
    (s as any).result = ((s as any).result ?? 0) + ('</td>');
    (s as any).result = ((s as any).result ?? 0) + ('<td width="98%" align="center" valign="middle" style="text-align: center; vertical-align:middle">');
    (s as any).result = ((s as any).result ?? 0) + ('<b>' + ((s as any).temp_header ?? 0) + '</b>');
    (s as any).result = ((s as any).result ?? 0) + ('</td>');
    (s as any).result = ((s as any).result ?? 0) + ('<td width="1%" nowrap rowspan="3" align="center" valign="middle" style="text-align: center; vertical-align:middle">');
    (s as any).result = ((s as any).result ?? 0) + ('<a style="text-decoration: none" href="exec:' + ((s as any).locArgs?.[5] ?? 0) + ' & gt \'intro_overview\'">');
    (s as any).result = ((s as any).result ?? 0) + ('<big>▶</big>');
    (s as any).result = ((s as any).result ?? 0) + ('</a>');
    (s as any).result = ((s as any).result ?? 0) + ('</td>');
    (s as any).result = ((s as any).result ?? 0) + ('</tr>');
    (s as any).result = ((s as any).result ?? 0) + ('<tr>');
    (s as any).result = ((s as any).result ?? 0) + ('<td rowspan="2" align="center" valign="middle" style="text-align: center; vertical-align:middle">');
    (s as any).result = ((s as any).result ?? 0) + (((s as any).temp_value ?? 0));
    (s as any).result = ((s as any).result ?? 0) + ('</td>');
    (s as any).result = ((s as any).result ?? 0) + ('</tr>');
    ...
    if (String((s as any).locArgs?.[3] ?? '') === 1) {
      ...
      (s as any).result = ((s as any).result ?? 0) + ('<tr>');
      (s as any).result = ((s as any).result ?? 0) + ('<td align="center" valign="middle" style="text-align: center; vertical-align:middle; color: inherit;">');
      (s as any).result = ((s as any).result ?? 0) + ('<b>' + ((s as any).temp_header ?? 0) + '</b>');
      (s as any).result = ((s as any).result ?? 0) + ('</td>');
      (s as any).result = ((s as any).result ?? 0) + ('</tr>');
      (s as any).result = ((s as any).result ?? 0) + ('<tr style="height:67%">');
      (s as any).result = ((s as any).result ?? 0) + ('<td align="center" valign="middle" style="text-align: center; vertical-align:middle; color: ' + (((s as any).theme_hex ?? 0)?.['accent']) + ';">');
      (s as any).result = ((s as any).result ?? 0) + (((s as any).temp_value ?? 0));
      (s as any).result = ((s as any).result ?? 0) + ('</td>');
      (s as any).result = ((s as any).result ?? 0) + ('</tr>');
      (s as any).result = ((s as any).result ?? 0) + ('</table>');
      ...
      if (String((s as any).locArgs?.[3] ?? '') === 2) {
        (s as any).result = '<table width="100%" cellpadding="0" cellspacing="0" border="0">';
        (s as any).result = ((s as any).result ?? 0) + ('<tr>');
        (s as any).result = ((s as any).result ?? 0) + ('<td align="center" valign="middle" style="text-align: center; vertical-align:middle">');
        (s as any).result = ((s as any).result ?? 0) + ('<b>' + ((s as any).temp_header ?? 0) + '</b>');
        (s as any).result = ((s as any).result ?? 0) + ('</td>');
        (s as any).result = ((s as any).result ?? 0) + ('</tr>');
        (s as any).result = ((s as any).result ?? 0) + ('<tr style="height:67%">');
...
function enterGetFirstnameSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_action_firstname = undefined;
  return;
  scene.build();
}
...
function enterGetNicknameSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_action_nickname = undefined;
  return;
  scene.build();
}
...
function enterGetLastnameSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_action_lastname = undefined;
  return;
  scene.build();
}
...
function enterGetBirthdaySetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_action_right_day = undefined;
  (s as any).temp_value_day = undefined;
  return;
  scene.build();
}
...
function enterGetBirthmonthSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_action_left_month = undefined;
  (s as any).temp_action_right_month = undefined;
  return;
  scene.build();
}
...
function enterGetBirthyearSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_age_start = undefined;
  return;
  scene.build();
}
...
function enterGetHaircolorSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_value_hair = undefined;
  (s as any).temp_action_left_hair = undefined;
  (s as any).temp_action_right_hair = undefined;
  return;
  scene.build();
}
...
function enterGetHairlengthSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_action_left_hair_length = undefined;
  (s as any).temp_action_right_hair_length = undefined;
  (s as any).temp_value_hair_length = undefined;
  return;
  scene.build();
}
...
function enterGetHairtypeSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_action_hair_type = undefined;
  (s as any).temp_value_hair_type = undefined;
  return;
  scene.build();
}
...
function enterGetEyecolorSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_value_eye_color = undefined;
  (s as any).temp_action_left_eye_color = undefined;
  (s as any).temp_action_right_eye_color = undefined;
  return;
  scene.build();
}
...
function enterGetEyesizeSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_value_eye_size = undefined;
  (s as any).temp_action_left_eye_size = undefined;
  (s as any).temp_action_right_eye_size = undefined;
  return;
  scene.build();
}
...
function enterGetEyelashesSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_value_lashes = undefined;
  (s as any).temp_action_left_lashes = undefined;
  (s as any).temp_action_right_lashes = undefined;
  return;
  scene.build();
}
...
function enterGetEyesightSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_action_sight = undefined;
  (s as any).temp_value_sight = undefined;
  return;
  scene.build();
}
...
function enterGetLipsizeSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_action_left_lipsize = undefined;
  (s as any).temp_action_right_lipsize = undefined;
  (s as any).temp_value_lipsize = undefined;
  return;
  scene.build();
}
...
function enterGetTeethSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_action_left_teeth = undefined;
  (s as any).temp_action_right_teeth = undefined;
  (s as any).temp_value_teeth = undefined;
  return;
  scene.build();
}
...
function enterGetHeightSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_inches = undefined;
  (s as any).temp_value_height = undefined;
  (s as any).temp_action_left_height = undefined;
  (s as any).temp_action_right_height = undefined;
  return;
  scene.build();
}
...
function enterGetPortraitSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_value_portrait = undefined;
  (s as any).temp_action_left_portrait = undefined;
  (s as any).temp_action_right_portrait = undefined;
  return;
  scene.build();
}
...
function enterGetBodyweightSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_est_weight_bw = undefined;
  (s as any).temp_lbs = undefined;
  ...
  (s as any).temp_value_bodyweight = undefined;
  (s as any).temp_action_left_bodyweight = undefined;
  (s as any).temp_action_right_bodyweight = undefined;
  return;
  scene.build();
}
...
function enterGetBustSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_value_bust = undefined;
  (s as any).temp_action_left_bust = undefined;
  (s as any).temp_action_right_bust = undefined;
  return;
  scene.build();
}
...
function enterGetButtSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_value_butt = undefined;
  (s as any).temp_action_left_butt = undefined;
  (s as any).temp_action_right_butt = undefined;
  return;
  scene.build();
}
...
function enterGetEstBmi(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_est_weight = undefined;
  (s as any).temp_est_bmi2 = undefined;
  (s as any).temp_est_bmi_str = undefined;
  (s as any).temp_est_bmi_cat = undefined;
  scene.build();
}
...
function enterGetStartTypeLocSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_template_call = undefined;
  ...
  (s as any).temp_value_setting = undefined;
  (s as any).temp_action_left_setting = undefined;
  (s as any).temp_action_right_setting = undefined;
  return;
  scene.build();
}
...
function enterGetStartTypeMagicSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_value_type = undefined;
  (s as any).temp_action_left_type = undefined;
  (s as any).temp_action_right_type = undefined;
  return;
  scene.build();
}
...
function enterGetStartTypeGroupSetter(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_value_group = undefined;
  return;
  scene.build();
}
...
function enterGetStartTypeCatSetter(s: GameState, scene: SceneBuilder): void {
  if (((s as any).start_type ?? 0)?.['cat'] === 'custom') {
    ...
    (s as any).temp_value_cat = undefined;
    (s as any).temp_action_left_cat = undefined;
    (s as any).temp_action_right_cat = undefined;
  }
  return;
  scene.build();
}
...
function enterGetStartLocationSetter(s: GameState, scene: SceneBuilder): void {
  if (((s as any).start_type ?? 0)?.['loc'] === 'sg') {
    ...
    (s as any).temp_value_loc = undefined;
    (s as any).temp_action_left_loc = undefined;
    (s as any).temp_action_right_loc = undefined;
  } else {
    if (((s as any).start_type ?? 0)?.['loc'] === 'uni') {
...
function enterGetStartTimeSetter(s: GameState, scene: SceneBuilder): void {
  if (((s as any).start_type ?? 0)?.['loc'] === 'sg') {
    ...
    (s as any).temp_value_starttime = undefined;
    (s as any).temp_action_left_starttime = undefined;
    (s as any).temp_action_right_starttime = undefined;
  } else {
...
function enterGetArchetypes(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_tr_val_label = ((s as any).temp_tr_val_label ?? 0) + (' (\' + arch_vars[$temp_tr_name + \'_points\'] / 250 + \')');
  ...
  (s as any).temp_tr_name = undefined;
  (s as any).temp_tr_display = undefined;
  (s as any).temp_tr_val_label = undefined;
  (s as any).temp_tr_left = undefined;
  (s as any).temp_tr_right = undefined;
  return;
  scene.build();
}
...
function enterCycleGroup(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_group_idx = undefined;
  return;
  scene.build();
}
...
function enterCycleSgTime(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_sg_idx = undefined;
  return;
  scene.build();
}

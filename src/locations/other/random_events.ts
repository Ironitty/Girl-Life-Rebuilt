...
function enterRegister(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).shantpopala ?? 0) > 0) {
    ...
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_' + ((((s as any).rand_events_area ?? 0) === 'city') ? ('city') : ('general'));
    ((s as any).rand_events_temp ?? {})['name'] = 'failed_celeb_blackmail';
    ((s as any).rand_events_temp ?? {})['freq'] = 100;
    ((s as any).rand_events_temp ?? {})['cooldown'] = 12;
  ...
  if (((s as any).nichGalaTarasPlan ?? 0) >= 110  &&  ((s as any).nichGalaTarasPlan ?? 0) < 120  &&  (Math.floor(Math.random() * 2) + 1) === 1  &&  ((s as any).nichDebug ?? 0) === 1) {
    (s as any).rand_events_must_happen = 1;
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'nich_taras_abduct';
    ((s as any).rand_events_temp ?? {})['freq'] = 100;
    qspCall(s, 'random_events', 'register');
  }
  if (((s as any).workDolgDay ?? 0) <= 0  &&  ((s as any).workDolg ?? 0) > 0) {
    (s as any).rand_events_must_happen = 1;
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_home';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_debt_payoff';
    ((s as any).rand_events_temp ?? {})['freq'] = 100;
    qspCall(s, 'random_events', 'register');
  }
  if (((s as any).workDiskAtkPlayer ?? 0) === 1) {
    (s as any).rand_events_must_happen = 1;
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_home';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_didnt_deliver_disk';
    ((s as any).rand_events_temp ?? {})['freq'] = 100;
    qspCall(s, 'random_events', 'register');
  }
  if (((s as any).pcs_magik ?? 0) >= 1  &&  ((s as any).mainQW ?? 0) === 0  &&  ((s as any).start_type ?? 0)?.['loc'] === 'city') {
    (s as any).rand_events_must_happen = 1;
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_home';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_tatiana_unlock_magic';
    ((s as any).rand_events_temp ?? {})['freq'] = 100;
    qspCall(s, 'random_events', 'register');
  }
  ...
  if (((s as any).cheatVars ?? 0)?.['random_rapists'] !== 1  &&  ((s as any).DayStage ?? 0) >= 4) {
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'random_rape';
    ((s as any).rand_events_temp ?? {})['freq'] = 2;
    ...
    if (((s as any).PCloCoverFront ?? 0) >= 3  &&  ((s as any).PCloPanties ?? 0) === 0  &&  ((s as any).pantyworntype ?? 0) === 'none') {
      ((s as any).rand_events_temp ?? {})['freq'] = (((s as any).rand_events_temp ?? {})?.['freq'] * 3) / 2;
    }
    ...
    if (((s as any).cheatVars ?? 0)?.['random_rapists'] === 2  &&  ((s as any).rand_events_temp ?? 0)?.['freq'] > 0) {
      ((s as any).rand_events_temp ?? {})['freq'] = Math.max(1, ((s as any).rand_events_temp ?? {})?.['freq'] / 2);
      ((s as any).rand_events_temp ?? {})['cooldown'] = 24 * 14;
    } else {
      if (((s as any).cheatVars ?? 0)?.['random_rapists'] === 3) {
        ((s as any).rand_events_temp ?? {})['freq'] = ((s as any).rand_events_temp ?? {})?.['freq'] * 2;
        ((s as any).rand_events_temp ?? {})['cooldown'] = 24 * 6;
      } else {
        if (((s as any).cheatVars ?? 0)?.['random_rapists'] === 4) {
          ((s as any).rand_events_temp ?? {})['freq'] = ((s as any).rand_events_temp ?? {})?.['freq'] * 3;
          ((s as any).rand_events_temp ?? {})['cooldown'] = 24 * 3;
        } else {
          ((s as any).rand_events_temp ?? {})['cooldown'] = 24 * 10;
        }
      }
    }
    qspCall(s, 'random_events', 'register');
  ...
  if (((s as any).cheatVars ?? 0)?.['random_robbers'] !== 1  &&  ((s as any).bag ?? 0) === 1  &&  ((s as any).daystart ?? 0) >= 10  &&  ((s as any).DayStage ?? 0) >= 4) {
    ...
    if (((s as any).currentpursetype ?? 0) === 'fashionista') {
      ((s as any).rand_events_temp ?? {})['freq'] = ((((s as any).rand_events_temp ?? {})?.['freq'] + 1) * 3) / 2;
    } else {
      if (((s as any).currentpursetype ?? 0) === 'moncheri') {
        ((s as any).rand_events_temp ?? {})['freq'] = (((s as any).rand_events_temp ?? {})?.['freq'] + 1) * 2;
      }
    }
  ...
  if (((s as any).cheatVars ?? 0)?.['random_snatchers'] !== 1  &&  ((s as any).bag ?? 0) === 1  &&  ((s as any).daystart ?? 0) >= 10  &&  ((s as any).DayStage ?? 0) < 4) {
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'random_snatching';
    if (((s as any).loc ?? 0) === 'city_industrial'  ||  ((s as any).loc ?? 0) === 'pav_industrial') {
      ((s as any).rand_events_temp ?? {})['freq'] = 0;
    } else {
      if (((s as any).loc ?? 0) === 'city_center'  ||  ((s as any).loc ?? 0) === 'pav_commercial'  ||  ((s as any).loc ?? 0) === 'city_island') {
  ...
  if (((s as any).lesbiday ?? 0) + 21 <= ((s as any).daystart ?? 0)  &&  ((s as any).lesbiQW ?? 0) >= 11  &&  (((s as any).DayStage ?? 0) <= 4  &&  ((s as any).month ?? 0) >= 3  &&  ((s as any).month ?? 0) !== 12)  &&  ((s as any).pantyworntype ?? 0) !== 'none') {
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'mistmeet';
    if (((s as any).loc ?? 0) === 'city_center'  ||  ((s as any).loc ?? 0) === 'pav_commercial'  ||  ((s as any).loc ?? 0) === 'city_island') {
      ((s as any).rand_events_temp ?? {})['freq'] = 10;
    } else {
      if (((s as any).loc ?? 0) === 'city_residential'  ||  ((s as any).loc ?? 0) === 'pav_residential') {
        ((s as any).rand_events_temp ?? {})['freq'] = 7;
      } else {
        if (((s as any).loc ?? 0) === 'city_industrial'  ||  ((s as any).loc ?? 0) === 'pav_industrial') {
          ((s as any).rand_events_temp ?? {})['freq'] = 2;
        }
  ...
  if ((((s as any).weatherFall ?? 0) < 60  ||  ((s as any).sunWeather ?? 0) === 1)  &&  ((s as any).cheatVars ?? 0)?.['random_lovers'] !== 1) {
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'random_lover';
    ((s as any).rand_events_temp ?? {})['freq'] = 5;
    if (((s as any).loc ?? 0) === 'city_center'  ||  ((s as any).loc ?? 0) === 'pav_commercial'  ||  ((s as any).loc ?? 0) === 'city_island') {
      // TODO-QSP: rand_events_temp['freq'] *= 3
    } else {
      if (((s as any).loc ?? 0) === 'city_industrial'  ||  ((s as any).loc ?? 0) === 'pav_industrial') {
    ...
    ((s as any).rand_events_temp ?? {})['cooldown'] = 1;
    qspCall(s, 'random_events', 'register');
  }
  if (((s as any).DayStage ?? 0) <= 3) {
    if (((s as any).sunWeather ?? 0) === 1  &&  ((s as any).weatherFall ?? 0) < 60) {
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_guitar_man';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_guitar_girl';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_violin_man';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_violin_girl';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_portraits';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_naked_woman';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_motorcycle_naked';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_girl_split';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_girl_flashing';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_handout_flyers';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_girls_gossiping';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
    } else {
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_woman_flashing';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
    }
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_hetero_couple';
    ((s as any).rand_events_temp ?? {})['freq'] = 2;
    qspCall(s, 'random_events', 'register');
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_lesbian_couple';
    ((s as any).rand_events_temp ?? {})['freq'] = 2;
    qspCall(s, 'random_events', 'register');
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_guys_fighting';
    ((s as any).rand_events_temp ?? {})['freq'] = 2;
    qspCall(s, 'random_events', 'register');
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_girls_fighting';
    ((s as any).rand_events_temp ?? {})['freq'] = 2;
    qspCall(s, 'random_events', 'register');
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_woman_window';
    ((s as any).rand_events_temp ?? {})['freq'] = 2;
    qspCall(s, 'random_events', 'register');
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_girl_beggar';
    ((s as any).rand_events_temp ?? {})['freq'] = 2;
    qspCall(s, 'random_events', 'register');
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_unconscious';
    ((s as any).rand_events_temp ?? {})['freq'] = 2;
    qspCall(s, 'random_events', 'register');
    ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
    ((s as any).rand_events_temp ?? {})['name'] = 'minor_clothes_grabbed';
    ((s as any).rand_events_temp ?? {})['freq'] = 2;
    qspCall(s, 'random_events', 'register');
  } else {
    if (((s as any).sunWeather ?? 0) === 1  &&  ((s as any).weatherFall ?? 0) < 60) {
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_boys_beer';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
    }
    if (((s as any).loc ?? 0) !== 'pav_industrial'  &&  ((s as any).loc ?? 0) !== 'city_industrial'  &&  ((s as any).divorce_party ?? 0) < 2  &&  ((s as any).pcs_hotcat ?? 0) > 4) {
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_general';
      ((s as any).rand_events_temp ?? {})['name'] = 'divorce_party';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
    }
  }
  ...
  if (((s as any).rand_events_area ?? 0) === 'city') {
    ...
    if ((((s as any).weatherFall ?? 0) < 60  ||  ((s as any).sunWeather ?? 0) === 1)  &&  ((s as any).fame ?? 0)?.['event_day'] !== ((s as any).daystart ?? 0)  &&  ((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) <= 21  &&  ((s as any).loc ?? 0) === 'city_center') {
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_city';
      ((s as any).rand_events_temp ?? {})['name'] = 'fame_events';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
    }
  }
  if (((s as any).rand_events_area ?? 0) === 'pav'  ||  ((s as any).rand_events_area ?? 0) === 'pushkin') {
    if (((s as any).hour ?? 0) >= 12  ||  ((s as any).hour ?? 0) <= 3) {
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_pav';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_prostitutes';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
    }
    if ((((s as any).month ?? 0) >= 11  ||  ((s as any).month ?? 0) <= 3)  &&  ((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) <= 17) {
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_pav';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_naked_hawker';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
    }
    if (((s as any).sunWeather ?? 0) === 1  &&  ((s as any).weatherFall ?? 0) < 60  &&  ((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) <= 17) {
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_pav';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_improvised_market';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
    }
  }
  if (((s as any).rand_events_area ?? 0) === 'pav') {
    if (((s as any).sunWeather ?? 0) === 1  &&  ((s as any).weatherFall ?? 0) < 60  &&  ((s as any).pantyworntype ?? 0) === 'none'  &&  ((s as any).PCloSkirt ?? 0) > 2  &&  ((s as any).hour ?? 0) > 6  &&  ((s as any).hour ?? 0) <= 20) {
      ((s as any).rand_events_temp ?? {})['loc'] = 'street_events_pav';
      ((s as any).rand_events_temp ?? {})['name'] = 'minor_older_women_shaming';
      ((s as any).rand_events_temp ?? {})['freq'] = 2;
      qspCall(s, 'random_events', 'register');
    }

...
function enterRegister(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).cheatVars ?? 0)?.['random_rapists'] !== 1  &&  ((s as any).DayStage ?? 0) >= 4) {
    ...
    if (((s as any).PCloCoverFront ?? 0) >= 3  &&  ((s as any).PCloPanties ?? 0) === 0  &&  ((s as any).pantyworntype ?? 0) === 'none') {
      if (!(s as any).rand_events_temp) (s as any).rand_events_temp = {}; (s as any).rand_events_temp['freq'] = ((((s as any).rand_events_temp ?? {})?.['freq'] ?? 0) * 3) / 2;
    }
    ...
    if (((s as any).cheatVars ?? 0)?.['random_rapists'] === 2  &&  ((s as any).rand_events_temp ?? 0)?.['freq'] > 0) {
      if (!(s as any).rand_events_temp) (s as any).rand_events_temp = {}; (s as any).rand_events_temp['freq'] = Math.max(1, (((s as any).rand_events_temp ?? {})?.['freq'] ?? 0) / 2);
      ...
      if (((s as any).cheatVars ?? 0)?.['random_rapists'] === 3) {
        if (!(s as any).rand_events_temp) (s as any).rand_events_temp = {}; (s as any).rand_events_temp['freq'] = (((s as any).rand_events_temp ?? {})?.['freq'] ?? 0) * 2;
        ...
        if (((s as any).cheatVars ?? 0)?.['random_rapists'] === 4) {
          if (!(s as any).rand_events_temp) (s as any).rand_events_temp = {}; (s as any).rand_events_temp['freq'] = (((s as any).rand_events_temp ?? {})?.['freq'] ?? 0) * 3;
  ...
  if (((s as any).cheatVars ?? 0)?.['random_robbers'] !== 1  &&  ((s as any).bag ?? 0) === 1  &&  ((s as any).daystart ?? 0) >= 10  &&  ((s as any).DayStage ?? 0) >= 4) {
    ...
    if (((s as any).currentpursetype ?? 0) === 'fashionista') {
      if (!(s as any).rand_events_temp) (s as any).rand_events_temp = {}; (s as any).rand_events_temp['freq'] = (((((s as any).rand_events_temp ?? {})?.['freq'] ?? 0) + 1) * 3) / 2;
    } else {
      if (((s as any).currentpursetype ?? 0) === 'moncheri') {
        if (!(s as any).rand_events_temp) (s as any).rand_events_temp = {}; (s as any).rand_events_temp['freq'] = ((((s as any).rand_events_temp ?? {})?.['freq'] ?? 0) + 1) * 2;
      }
    }

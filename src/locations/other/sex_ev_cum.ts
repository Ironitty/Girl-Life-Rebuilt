...
function enterGirlCum(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['girl_orgasm'] === 1) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterFuckCum(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
  }
...
function enterMissCum(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['boy_cum'] > 0) {
    ...
    if (((st as any).sex_ev ?? 0)?.['cum_choice'] === 'creampie_surprise') {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSurpriseCumTogether(st, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterFuckCum2(st, scene); (st as any).locArgs = __savedLocArgs; }
    }
  } },
    ]);
  } else {
...
function enterFuckCum2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['cum_warn'] === 1  &&  ((s as any).sex_ev ?? 0)?.['his_choice'] === 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCumFacial(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
    ...
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['his_choice'] = 0;
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['mouth_ask'] = 1;
    qspCall(st, 'sex_ev_cum', '');
  } },
      ]);
    }
    ...
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['tits_ask'] = 1;
    qspCall(st, 'sex_ev_cum', '');
  } },
      ]);
    }
    ...
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['pullout_ask'] = 1;
  }, goto: ['sex_ev_cum', 'cum_pullout'] },
        { label: 'Not yet!', handler: (st: GameState) => {
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['not_yet_ask'] = 1;
    ...
    qspCall(st, 'sex_ev_cum', '');
      ...
      ((st as any).sex_ev = (st as any).sex_ev ?? {})['his_choice'] = 2;
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCumWherever(st, scene); (st as any).locArgs = __savedLocArgs; }
    }
  } },
    ...
    qspCall(st, 'sex_ev_cum', '');
          ...
          if (((s as any).sex_ev ?? 0)?.['boy_cum'] < 1) {
            ...
            if (((s as any).sex_ev ?? 0)?.['boy_cum'] > 0) {
              scene.actions([
                { label: 'Continue', goto: ['sex_ev_cum', 'cum_his_choice2'] },
              ]);
            }
          }
        }
...
function enterFacialCloseEyes(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterFacialWipeEyes(st, scene); (st as any).locArgs = __savedLocArgs; }
...
function enterFacialTongueCum(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCumMouth2(st, scene); (st as any).locArgs = __savedLocArgs; }
    scene.actions([
  ...
  scene.actions([
    ...
    scene.actions([
      { label: 'Continue', goto: ['sex_ev_cum', 'cum_inside'] },
        ...
        { label: 'Fake a simultaneous orgasm', goto: ['sex_ev_cum', 'cum_together_fake'] },
      ]);
    }
...
function enterMissCreampie(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCumInsidePullAway(st, scene); (st as any).locArgs = __savedLocArgs; }
    qspCall(st, 'sex_ev_reactions', 'cum_react');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_sex', '');
    ...
    if (((st as any).trait_vars ?? 0)?.['sensitivity'] >= 0  ||  ((st as any).trait_vars ?? 0)?.['sensitivity_override'] === 1) {
      ...
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterHypnoCreampieOrgasmFail(st, scene); (st as any).locArgs = __savedLocArgs; }
    }
  } },
...
function enterCumForce(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['condom'] === 1  &&  ((s as any).sex_ev ?? 0)?.['no_condom'] === 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCumForce2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    } else {
      scene.img('images/shared/sex/cum/vagcreampie/cowgirl2.mp4');
...
function enterCumPullout(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['pullout_ask'] === 1) {
    if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
      ...
      scene.text('"Pull out!" ' + ((((s as any).sex_ev ?? 0)?.['speed'] < 3) ? ('you cry.') : ('you scream.')));
  ...
  if (((s as any).sex_ev ?? 0)?.['accidental_creampie'] === 2  ||  (((s as any).sex_ev ?? 0)?.['last_cum'] !== 'creampie'  &&  ((s as any).sex_ev ?? 0)?.['last_cum'] !== 'broken_condom')  ||  ((s as any).sex_ev ?? 0)?.['he_ask_creampie_yes'] > 0  ||  ((s as any).npc_know_bc ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    qspCall(st, 'sex_ev_after', 'after_sex1');
      ...
      if ((((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1  ||  ((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] > 0)  &&  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
        ...
        if ((Math.floor(Math.random() * 10) + 1) >= ((s as any).npc_sexdrive ?? 0)?.[String((s as any).npcID ?? 0)]  ||  ((s as any).sex_ev ?? 0)?.['cum_count'] >= 5 + ((s as any).sex_ev ?? 0)?.['extra_cum']) {
          ((s as any).sex_ev = (s as any).sex_ev ?? {})['sex_over'] = 1;
          scene.text(`"Uhh... I think that was my last shot..." ${((s as any).npcdesc ?? '')} says awkwardly. ` + ((((s as any).sex_ev ?? 0)?.['cock_inserted'] === 1) ? ('As he says it, his cock is already softening inside you.') : ('As he says it, his cock is already losing stiffness right before your eyes.')));
        } else {
...
function enterCumNotYet(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['speed'] === 1) {
    scene.text('"Not yet!" you gasp. ' + ((((s as any).orgasm_buildup ?? 0) >= 100) ? ('"I\'m so close! Just a little longer!"') : ('"Just hold out a little longer!"')));
  } else {
    if (((s as any).sex_ev ?? 0)?.['speed'] === 2) {
      scene.text('"Not yet!" you pant. ' + ((((s as any).orgasm_buildup ?? 0) >= 100) ? ('"I\'m so close! Just a little longer!"') : ('"Just hold out a little longer!"')));
    } else {
      if (((s as any).sex_ev ?? 0)?.['speed'] === 3) {
        scene.text('"Not yet!" you cry. ' + ((((s as any).orgasm_buildup ?? 0) >= 100) ? ('"I\'m so close! Just a little longer!"') : ('"Just hold out a little longer!"')));
      }
    }
  }
  if (((s as any).sex_ev ?? 0)?.['sex_stamina'] > (Math.floor(Math.random() * 10) + 1)  &&  ((s as any).npc_two_pump ?? 0)?.[String((s as any).npcID ?? 0)] < 1  &&  ((s as any).sex_ev ?? 0)?.['cant_hold_cum'] < 1) {
    ...
    if (((s as any).npc_diligent ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  ((s as any).npc_two_pump ?? 0)?.[String((s as any).npcID ?? 0)] < 1  &&  ((s as any).sex_ev ?? 0)?.['cant_hold_cum'] < 1) {
      ...
      if (((s as any).sex_ev ?? 0)?.['cum_choice'] === 'creampie'  ||  ((s as any).sex_ev ?? 0)?.['cum_choice'] === 'creampie_surprise') {
        ...
        scene.text('And then he yanks his throbbing cock from your ' + ((((s as any).sex_ev ?? 0)?.['position'] !== 'anal') ? ('pussy.') : ('ass.')));
        scene.actions([
          { label: 'Continue', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_cum', '');
  } },
...
function enterCumCondom(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
    ...
    if (((st as any).condom_break ?? 0) > 0) {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBrokenCondom0(st, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
  ...
  scene.actions([
    ...
    if (((st as any).sex_ev ?? 0)?.['cum_choice'] === 'creampie_surprise'  ||  ((st as any).sex_ev ?? 0)?.['cum_choice'] === 'creampie'  ||  ((st as any).sex_ev ?? 0)?.['condom'] === 1) {
      ...
      if (((st as any).sex_ev ?? 0)?.['condom'] === 1) {
        ...
        if (((st as any).condom_break ?? 0) > 0) {
          { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBrokenCondom1(st, scene); (st as any).locArgs = __savedLocArgs; }
        } else {
          scene.actions([
        ...
        { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enter2pumpchumpCreampie(st, scene); (st as any).locArgs = __savedLocArgs; }
      }
    } else {
...
function enterHypnoCreampieOrgasmFail(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
    ...
    if (((st as any).sex_ev ?? 0)?.['creampie_surprise'] === 1) {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCreampieSurpriseCumTogether(st, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCumInsidePullAway(st, scene); (st as any).locArgs = __savedLocArgs; }
      qspCall(st, 'sex_ev_reactions', 'react_menu');
    }

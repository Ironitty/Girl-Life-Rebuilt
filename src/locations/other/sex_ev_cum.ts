...
function enterGirlCum(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['girl_orgasm'] === 1) {
    ...
    if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
      qspGoto(s, 'sex_ev_cum', 'miss_cum');
    } else {
      if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
        qspGoto(s, 'sex_ev_cum', 'doggy_cum');
      } else {
        if (((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
          qspGoto(s, 'sex_ev_cum', 'cowgirl_cum');
        } else {
          if (((s as any).sex_ev ?? 0)?.['position'] === 'anal') {
            qspGoto(s, 'sex_ev_cum', 'anal_doggy_cum');
          }
        }
      }
    }
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterFuckCum(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
  }
...
function enterMissCum(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['boy_cum'] > 0) {
    ...
    if (((s as any).sex_ev ?? 0)?.['cum_choice'] === 'creampie_surprise') {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSurpriseCumTogether(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterFuckCum2(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
  } },
    ]);
  } else {
...
function enterFuckCum2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['cum_warn'] === 1  &&  ((s as any).sex_ev ?? 0)?.['his_choice'] === 0) {
    ...
    if (((s as any).sex_ev ?? 0)?.['cum_where'] === 1) {
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['facial_ask'] = 1;
    }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumFacial(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
      ]);
              ...
              if (((s as any).sex_ev ?? 0)?.['speed'] === 3) {
                if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
                  ...
                  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
                    ...
                    scene.text(`"Come wherever you want!" you scream as ${((s as any).npcdesc || '')}'s cock keeps pounding into you.`);
                  }
                }
              }
            }
...
function enterFacialWipeEyes(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You carefully wipe the cum away from your eyes and open them. The edges of your vision are still blurry with sticky liquid, but you can still see ${((s as any).npcdesc || '')}, his cock hanging above you.`);
    qspCall(s, 'sex_ev_sex', 'sex_end');
  } },
  ]);
  scene.build();
...
function enterFacialCloseEyes(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_describe1'] = 'Thanks,';
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_describe2'] = 'wiping the cum from your eyes';
    qspCall(s, 'stat', '');
...
function enterFacialTongueCum(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_describe1'] = 'Thanks,';
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_describe2'] = 'licking your lips';
    ...
    if (((s as any).orgasm ?? 0) > ((s as any).sex_ev ?? 0)?.['orgasm']) {
      ...
      scene.text(`A few seconds go by and no more spurts of cum land on you so you close your mouth and swallow, gulping down the entire load. You pant heavily in the aftershocks of your orgasm, looking up at ${((s as any).npcdesc || '')} through cum-glazed eyes.`);
    } else {
      // TODO-QSP: dynamic text: A few seconds go by and no more spurts of cum land on you so you close your mout...
      scene.text(`A few seconds go by and no more spurts of cum land on you so you close your mouth and swallow, gulping down the entire load. You open your mouth again afterwards to pick up any stray shots, but it seems ${((s as any).npcdesc || '')} is finished so you open your eyes to look at him.`);
    }
    if (((s as any).npc_seen_swallow ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] === 'mouth'  &&  ((s as any).sex_ev ?? 0)?.['swallow_comment'] !== ((s as any).daystart ?? 0)) {
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['swallow_comment'] = ((s as any).daystart ?? 0);
    ...
    ((s as any).npc_seen_swallow = (s as any).npc_seen_swallow ?? {})[String((s as any).npcID ?? 0)] = 1;
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterFacialWipeEyes(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'sex_ev_reactions', 'cum_react');
  } },
    ...
    scene.text(`You can't take it anymore and close your mouth, continuing to look up at ${((s as any).npcdesc || '')} as he releases the rest of his load all over your lips and the revulsion and nausea wells up in your throat. Your eyes water with the effort but you manage to gulp, forcing the vile liquid down, and give ${((s as any).npcdesc || '')} what feels like one of the fakest smiles you've ever put on.`);
...
function enterFacialTongueSpit(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['next_act1'] = 'sex_ev_after';
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['next_act2'] = 'pre';
    qspCall(s, 'sex_ev_stats', 'cum_mouth_facial', 'spit');
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_describe1'] = 'Thanks,';
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_describe2'] = 'letting the rest of his cum dribble from your lips';
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['bj_cum'] = 2;
    qspCall(s, 'stat', '');
...
function enterFacialBrace(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Carefully wiping the cum from your eyes, you blink them open, vision ringed with blurry white edges, and the first sight you're greeted with is ${((s as any).npcdesc || '')} wearing a shit eating grin, looking at your plastered face.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} just laughs at your reaction.`);
    qspCall(s, 'sex_ev_sex', 'sex_end');
  } },
      ]);
    } else {
    ...
    scene.text(`"Thanks ${((s as any).pcs_nickname || '')}," he smiles back, patting you on the head. "I appreciate it. You look great by the way."`);
    ...
    qspCall(s, 'sex_ev_sex', 'sex_end');
        ...
        if (((s as any).sex_ev ?? 0)?.['he_ask'] === 1) {
          ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_describe2'] = 'blinking the cum away from your eyes';
          scene.text('"You asked me to do it."');
          if (((s as any).sex_ev ?? 0)?.['he_ask_creampie'] === 1) {
            ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_describe1'] = 'Because,';
    ...
    scene.text(`"Why do boys even like this?" you grimace, while ${((s as any).npcdesc || '')} keeps leering at you. "What on earth is so hot about plastering a girl's face with <i>this</i>?"`);
    qspCall(s, 'sex_ev_sex', 'sex_end');
  } },
    ...
    scene.text(`"I hate you," you grumble, spitting the disgusting fluid away from your lips as ${((s as any).npcdesc || '')} laughs out loud.`);
    qspCall(s, 'sex_ev_sex', 'sex_end');
  } },
    ]);
  } },
...
function enterCumMouth2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['last_cum'] === 'mouth') {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_describe1'] = 'Thanks,';
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_describe2'] = 'wiping your mouth';
  ...
  if (((s as any).npc_like_cum_taste ?? 0)?.[String((s as any).npcID ?? 0)] < 1) {
    ...
    scene.text(`Still holding onto ${((s as any).npcdesc || '')}'s cock with one hand, you clamp your other hand over your mouth, throat convulsing. It smears the cum on your lips all over your face, but you somehow manage to stop yourself from throwing up all over the bed.`);
    ...
    scene.text(`"Now you tell me!" you say, sticking your tongue out in disgust. ${((s as any).npcdesc || '')} bursts into laughter and you scowl at him. "It's not funny!" you protest, but that just makes him laugh even more.`);
    qspCall(s, 'sex_ev_sex', 'sex_end');
  } },
    ...
    scene.text(`"Well, just don't get sick, okay?" ${((s as any).npcdesc || '')} says, looking at you with concern.`);
    qspCall(s, 'sex_ev_sex', 'sex_end');
  } },
          ]);
        } else {
          // TODO-QSP: dynamic text: "Come on, is it really that hard to just swallow?" <<$npcdesc>> says, looking at...
          scene.text(`"Come on, is it really that hard to just swallow?" ${((s as any).npcdesc || '')} says, looking at you with disgust.`);
          scene.actions([
  ...
  scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['last_cum'] === 'face_mouth') {
      ...
      scene.text(`A few seconds go by and no more spurts of cum land on you so you open your eyes to look up at ${((s as any).npcdesc || '')} with his load still filling your mouth. Seeing him looking down at you, you playfully use your tongue to gather it between your lips.`);
    } else {
      // TODO-QSP: dynamic text: You keep your lips wrapped tight around the tip of <<$npcdesc>>'s cock while he ...
      scene.text(`You keep your lips wrapped tight around the tip of ${((s as any).npcdesc || '')}'s cock while he comes, sucking every last drop of spunk from it until it stops twitching and you think his orgasm if finished. Looking up at him, you stick out your tongue, showing him the entire load you gathered in your mouth.`);
    }
    scene.actions([
    ...
    scene.text(`Taking a step back, you open your mouth again to show ${((s as any).npcdesc || '')} how much cum is still inside before taking a deep breath and swallowing his entire load in one gulp. Afterwards, you stick your tongue back out to show him a clean mouth that swallowed every last drop.`);
    qspCall(s, 'sex_ev_reactions', 'cum_react');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_sex', 'sex_end');
    ...
    if (((s as any).sex_ev ?? 0)?.['last_cum'] === 'mouth') {
      ...
      scene.text(`You draw yourself back up ${((s as any).npcdesc || '')}'s cock, keeping your lips tightly sealed, allowing the cum to pool at the front of your mouth. You hold it there for a few moments and then unpurse your lips, and letting all his cum dribble out of your mouth and down your chin.`);
    } else {
      scene.img('images/shared/sex/cum/mouth/spit1.mp4');
      scene.text('Pulling back you play with the cum in your mouth a little, giggling as you show it off until you spit it out, letting it dribble over the edge of your lips.');
    }
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['last_cum'] = 'spit';
    qspCall(s, 'sex_ev_sex', 'sex_end');
  } },
  ]);
  scene.build();
...
function enterCreampieMenu(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['creampie_restrict'] === 0  &&  ((s as any).sex_ev ?? 0)?.['prostitution'] === 1  &&  ((s as any).npc_rule_no_creampies ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).sex_ev ?? 0)?.['p_creampie_bonus'] === 0  &&  ((s as any).sex_ev ?? 0)?.['creampie_count'] === 0) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['p_creampie_bonus'] = 1;
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['prostitution_bonus'] = ((s as any).sex_ev['prostitution_bonus'] ?? 0) + (1000);
    ...
    scene.text(`${((s as any).npcdesc || '')} doesn't even hesitate and thrusts balls deep into you with a loud groan.`);
    scene.actions([
  ...
  scene.actions([
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['he_ask_creampie_yes'] = 1;
  } },
        ]);
      } else {
        scene.actions([
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['reluctant_creampie'] = 1;
    if (((s as any).sex_ev ?? 0)?.['speed'] !== 3) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['unhappy_creampie'] = 1;
    if (((s as any).sex_ev ?? 0)?.['speed'] !== 3) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['creampie_ask'] = 1;
    if (((s as any).sex_ev ?? 0)?.['he_ask_creampie'] === 1) {
      if (((s as any).sex_ev ?? 0)?.['speed'] !== 3) {
...
function enterMissCreampie(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You lay there patiently, letting ${((s as any).npcdesc || '')} empty himself into your womb, waiting until you no longer feel him twitching inside you.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'sex_ev_reactions', 'cum_react');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    ...
    if (((s as any).trait_vars ?? 0)?.['sensitivity'] >= 0  ||  ((s as any).trait_vars ?? 0)?.['sensitivity_override'] === 1) {
      ...
      scene.text(`${((s as any).npcdesc || '')}'s cum pours into you and you gasp as you get sent over the edge and trigger your own climax. The two of come together, each of your orgasms fueling the other's until eventually they've run their course and both of you lay there panting.`);
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
      qspCall(s, 'sex_ev_reactions', 'react_menu');
    } else {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHypnoCreampieOrgasmFail(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
  } },
    ...
    scene.text(`You lay there, trying not to squirm as ${((s as any).npcdesc || '')} orgasm pumps load after load into your womb. Despite your disgust, you don't move, waiting until you no longer feel him twitching inside you.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'sex_ev_reactions', 'cum_react');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
...
function enterDoggyCreampie(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You stay there patiently, letting ${((s as any).npcdesc || '')} empty himself into your womb, waiting until you no longer feel him twitching inside you.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'sex_ev_reactions', 'react_menu');
  } },
    ...
    if (((s as any).trait_vars ?? 0)?.['sensitivity'] >= 0  ||  ((s as any).trait_vars ?? 0)?.['sensitivity_override'] === 1) {
      ...
      scene.text(`${((s as any).npcdesc || '')}'s cum pours into you and you gasp as you get sent over the edge yourself and trigger your own climax. The two of come together, each of your orgasms fueling the other's until eventually they've run their course and both of you collapse.`);
    } else {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHypnoCreampieOrgasmFail(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    ...
    scene.text(`You stay there, trying not to squirm in discomfort, feeling ${((s as any).npcdesc || '')}'s spunk fill your womb. Despite your disgust, you don't move, waiting until you no longer feel him twitching inside you.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'sex_ev_reactions', 'react_menu');
  } },
  ]);
...
function enterCowgirlCreampie(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You ride out his orgasm, gently rock your hips and squeezing ${((s as any).npcdesc || '')}'s cock with your pussy as he empties himself into your womb until eventually, you no longer feel him twitching inside you.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'sex_ev_reactions', 'react_menu');
  } },
    { label: 'Come with him', handler: (st: GameState) => {
    if (((s as any).trait_vars ?? 0)?.['sensitivity'] >= 0  ||  ((s as any).trait_vars ?? 0)?.['sensitivity_override'] === 1) {
      ...
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['simultaneous_orgasm_count'] = ((s as any).sex_ev['simultaneous_orgasm_count'] ?? 0) + (1);
      // TODO-QSP: dynamic text: <<$npcdesc>>'s cum pours into you and you gasp as you get sent over the edge and...
      scene.text(`${((s as any).npcdesc || '')}'s cum pours into you and you gasp as you get sent over the edge and trigger your own climax. Your body convulses as electric shocks of orgasm rock through you and you come together, each of your orgasms fueling the other's until eventually they've run their course and both of you lay there panting.`);
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
      qspCall(s, 'sex_ev_reactions', 'react_menu');
    } else {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHypnoCreampieOrgasmFail(s, scene); (s as any).locArgs = __savedLocArgs; }
...
function enterAnalDoggyCreampie(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You stay there patiently, letting ${((s as any).npcdesc || '')} empty himself into your ass, waiting until you no longer feel him twitching between your cheeks.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'sex_ev_reactions', 'react_menu');
  } },
    { label: 'Come with him', handler: (st: GameState) => {
    if (((s as any).trait_vars ?? 0)?.['sensitivity'] >= 0  ||  ((s as any).trait_vars ?? 0)?.['sensitivity_override'] === 1) {
      ...
      scene.text(`${((s as any).npcdesc || '')}'s cum pours into you and you choke up, every muscle in your body going taut as you get sent over the edge into orgasm yourself. The two of come together, each of your climaxes fueling the other's until eventually they've run their course and both of you collapse.`);
    } else {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHypnoCreampieOrgasmFail(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    ...
    scene.text(`You stay there, trying not to squirm in discomfort at the feeling of ${((s as any).npcdesc || '')}'s spunk filling your intestines. Despite your disgust, you don't move, waiting until you no longer feel him twitching between your cheeks.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'sex_ev_reactions', 'react_menu');
  } },
  ]);
...
function enterCumInsidePullAway(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['cock_inserted'] === 1) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['cock_inserted'] = 0;
    if (((s as any).sex_ev ?? 0)?.['position'] === 'anal') {
      qspGoto(s, 'sex_ev_cum', 'cum_inside_pull_away_anal');
    } else {
      if (((s as any).sex_ev ?? 0)?.['last_cum'] === 'creampie') {
        if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
          ...
          if (((s as any).sex_ev ?? 0)?.['surprise_cum_together'] === 1) {
            ...
            scene.text(`You carefully scooch backwards and ${((s as any).npcdesc || '')}'s cock <i>pops</i> from your pussy. A second later, a stream of milky liquid streams out of your snatch, running down your ass and into the bedsheets.`);
          } else {
            // TODO-QSP: dynamic text: You carefully scooch backwards, allowing <<$npcdesc>> to remove his cock from yo...
            scene.text(`You carefully scooch backwards, allowing ${((s as any).npcdesc || '')} to remove his cock from your pussy. It slips from your snatch with a <i>pop</i>, a slurry of cum streaming out after it, running down your ass and into the bedsheets.`);
          }
        } else {
          if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
            scene.img('images/shared/sex/cum/vagcreampie/doggy1.mp4');
            if (((s as any).sex_ev ?? 0)?.['surprise_cum_together'] === 1) {
              ...
              scene.text(`You lean forward, letting and ${((s as any).npcdesc || '')}'s cock <i>pops</i> from your pussy. A second later, you feel a thick stream of liquid dribble from your snatch and trickle down your thigh.`);
            } else {
              // TODO-QSP: dynamic text: You lean forward, letting <<$npcdesc>>'s cock slip from your snatch and roll ont...
              scene.text(`You lean forward, letting ${((s as any).npcdesc || '')}'s cock slip from your snatch and roll onto your back breathing hard. As you do, you feel a slurry of liquid stream from your pussy, running down your ass and into the bedsheets.`);
            }
          } else {
            if (((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
              scene.img('images/shared/sex/cum/vagcreampie/cowgirl3.mp4');
              if (((s as any).sex_ev ?? 0)?.['surprise_cum_together'] === 1) {
                ...
                scene.text(`You raise your hips a bit and pull back, causing ${((s as any).npcdesc || '')}'s cock to suddenly flop from your pussy as it slips out. As you look down, you can see a milky white fluid leaking from your snatch.`);
              } else {
                // TODO-QSP: dynamic text: Raising your hips up, you pull yourself off <<$npcdesc>>'s cock. It flops from y...
                scene.text(`Raising your hips up, you pull yourself off ${((s as any).npcdesc || '')}'s cock. It flops from your pussy and you feel a thick glob of cum immediately begin to leak from your snatch.`);
              }
            }
          }
        }
        if (((s as any).sex_ev ?? 0)?.['surprise_cum_together'] === 1  &&  ((s as any).sex_ev ?? 0)?.['came_together'] < 3) {
          ...
          scene.text(`${((s as any).npcdesc || '')}'s cum.`);
        ...
        if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
          ...
          scene.text(`You spread your legs a little wider as ${((s as any).npcdesc || '')} pulls his hips back, vacating his manhood from your pussy. As you look down, you can see a milky white fluid filling the rubber casing around his cock.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
            scene.img('images/shared/sex/cum/condom1.jpg');
            // TODO-QSP: dynamic text: You lean forward as <<$npcdesc>> pulls his hips back, feeling his manhood slip f...
            scene.text(`You lean forward as ${((s as any).npcdesc || '')} pulls his hips back, feeling his manhood slip from your pussy. As you lay down on the bed and look back, you can see a milky white fluid filling the rubber casing around his cock.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
              scene.img('images/shared/sex/cum/cum81.jpg');
              // TODO-QSP: dynamic text: You raise your hips a bit and pull back, causing <<$npcdesc>>'s cock to suddenly...
              scene.text(`You raise your hips a bit and pull back, causing ${((s as any).npcdesc || '')}'s cock to suddenly flop from your pussy as it slips out. As you look down, you can see a milky white fluid filling the rubber casing around his cock.`);
            }
          }
        }
        // TODO-QSP: dynamic text: <<$npcdesc>>'s cum.
...
function enterCumTogether(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).trait_vars ?? 0)?.['sensitivity'] >= 0  ||  ((s as any).trait_vars ?? 0)?.['sensitivity_override'] === 1) {
      ...
      scene.text(`${((s as any).npcdesc || '')}'s cock pulses inside you and something warm spills into your pussy. His hot cum filling you up is the last thing you need to get off and suddenly you're right there with him, muscles going taut and quivering uncontrollably as the two of you come together.`);
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
      qspCall(s, 'sex_ev_reactions', 'react_menu');
    } else {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHypnoCreampieOrgasmFail(s, scene); (s as any).locArgs = __savedLocArgs; }
...
function enterAnalCumTogether(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).trait_vars ?? 0)?.['sensitivity'] >= 0  ||  ((s as any).trait_vars ?? 0)?.['sensitivity_override'] === 1) {
      ...
      scene.text(`${((s as any).npcdesc || '')}'s cock pulses inside you and something warm spills into your intestines. His hot cum filling you up is the last thing you need to get off and suddenly you're right there with him, quivering uncontrollably, and clenching your ass around him as the two of you come together.`);
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
      qspCall(s, 'sex_ev_reactions', 'react_menu');
    } else {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHypnoCreampieOrgasmFail(s, scene); (s as any).locArgs = __savedLocArgs; }
...
function enterCumTogetherFake(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['position'] !== 'anal') {
      // TODO-QSP: dynamic text: <<$npcdesc>>'s cock pulses inside you and something warm spills into your pussy ...
      scene.text(`${((s as any).npcdesc || '')}'s cock pulses inside you and something warm spills into your pussy and you moan loudly. You clench your pussy as hard as you can and shake your body, pretending that his cum is making you orgasm, keeping up the performance until you no longer feel his cock twitching inside your pussy.`);
    } else {
      // TODO-QSP: dynamic text: <<$npcdesc>>'s cock pulses inside you and something warm spills into your ass an...
      scene.text(`${((s as any).npcdesc || '')}'s cock pulses inside you and something warm spills into your ass and you moan loudly. You clench your sphincter as hard as you can and shake your body, pretending that his cum is making you orgasm, keeping up the performance until you no longer feel his cock twitching inside your ass.`);
    }
    qspGoto(s, 'sex_ev_sex', 'sex_end');
  } },
  ]);
  scene.build();
}
...
function enterCumForce(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['condom'] === 1  &&  ((s as any).sex_ev ?? 0)?.['no_condom'] === 0) {
    ...
    scene.text(`Without hesitation, you lock your legs behind ${((s as any).npcdesc || '')} and pull him even tighter, giving him no choice but to empty his balls into you.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumForce2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
      ]);
    } else {
    ...
    if (((s as any).sex_ev ?? 0)?.['condom'] === 1  &&  ((s as any).sex_ev ?? 0)?.['no_condom'] === 0) {
      ...
      if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
        ...
        if (((s as any).sex_ev ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
          ...
          scene.text(`Your orgasms finally fade and you give a tired smile as you unlock your legs from behind his back, allowing ${((s as any).npcdesc || '')} to pull out. As his cock pops free of your pussy, you see that the rubber encasing it is filled with a thick white liquid.`);
        } else {
          // TODO-QSP: dynamic text: When his orgasm finally ends, you unlock your legs from behind his back, unable ...
          scene.text(`When his orgasm finally ends, you unlock your legs from behind his back, unable to keep from grinning as ${((s as any).npcdesc || '')} pulls out. As his cock pops free of your pussy, you see that the rubber encasing it is filled with a thick white liquid.`);
        }
      } else {
        scene.img('images/shared/sex/cum/cum81.jpg');
        if (((s as any).sex_ev ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
          // TODO-QSP: dynamic text: With a tired smile, you carefully pull yourself off of <<$npcdesc>>, removing hi...
          scene.text(`With a tired smile, you carefully pull yourself off of ${((s as any).npcdesc || '')}, removing his dick from your pussy. As it slides out, you see that the rubber encasing it is filled with a thick white liquid. Seeing as he still seems quite exhausted by what you put him through, you take the liberty of pulling it off, coming free with a wet slapping sound, and tossing it aside.`);
        } else {
          // TODO-QSP: dynamic text: You can't help but grin at his state and carefully pull yourself off of <<$npcde...
          scene.text(`You can't help but grin at his state and carefully pull yourself off of ${((s as any).npcdesc || '')}, removing his dick from your pussy. As it slides out, you see that the rubber encasing it is filled with a thick white liquid. Seeing as he still seems quite exhausted by what you put him through, you take the liberty of pulling it off, coming free with a wet slapping sound, and tossing it aside.`);
        }
      }
      qspCall(s, 'sex_ev_sex', 'sex_end');
    } else {
      if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
        ...
        if (((s as any).sex_ev ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
          ...
          scene.text(`Finally, your orgasms end and your legs fall aside limply, releasing ${((s as any).npcdesc || '')} from your grip. You stare up into his eyes as you pant hard, both of you catching your breath after such tremendous orgasms.`);
        } else {
          // TODO-QSP: dynamic text: When it seems <<$npcdesc>>'s orgasm is finished, only then do you unlock your le...
          scene.text(`When it seems ${((s as any).npcdesc || '')}'s orgasm is finished, only then do you unlock your legs and allow him to pull free. He pants breathlessly as he recovers from what you did to him.`);
        }
      } else {
...
function enterCreampieSurprise2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).orgasm ?? 0) === ((s as any).sex_ev ?? 0)?.['orgasm']) {
    ...
    scene.text(`As ${((s as any).npcdesc || '')} unloads inside you, sending cum and warmth through your pussy.`);
    ...
    scene.text(`As ${((s as any).npcdesc || '')} comes inside you, you come too. Cum and warmth floods through your pussy, driving you over the edge.`);
    if (((s as any).start_type ?? 0)?.['magic'] !== 'nomagic'  &&  ((s as any).sex_ev ?? 0)?.['magik'] < ((s as any).pcs_magik ?? 0)) {
      // TODO-QSP: dynamic text: Magic floods your system, ramping your senses into overdrive. Energy courses fro...
      scene.text(`Magic floods your system, ramping your senses into overdrive. Energy courses from its origin in your womb to the tips of your nipples. You can feel every hair on your body, every bead of sweat on your skin, every single vein and contour of ${((s as any).npcdesc || '')}'s cock inside you. Somehow you can even feel each individual of the hundreds of millions of sperm pouring into your uterus.`);
      // TODO-QSP: dynamic text: That same energy splashes off of <<$npcdesc>> and back onto you, forcing you to ...
      scene.text(`That same energy splashes off of ${((s as any).npcdesc || '')} and back onto you, forcing you to share in his experiences. You can <i>feel</i> his orgasm pouring into you, <i>his</i> pleasure erupting from his manhood, as if it were <i>you</i> ejaculating into your own orgasming pussy. Caught in a feedback loop between your orgasm and his, your entire body locks up, screaming a silent open-mouthed scream of ecstasy, unable to do anything but shudder uncontrollably around the cock pulsing inside you.`);
    } else {
...
function enterWhatNow(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['accidental_creampie'] === 2  ||  (((s as any).sex_ev ?? 0)?.['last_cum'] !== 'creampie'  &&  ((s as any).sex_ev ?? 0)?.['last_cum'] !== 'broken_condom')  ||  ((s as any).sex_ev ?? 0)?.['he_ask_creampie_yes'] > 0  ||  ((s as any).npc_know_bc ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    scene.text(`${((s as any).npcdesc || '')}'s brow furrows as he shakes his head.`);
    ...
    if (((s as any).npc_condom_conscious ?? 0)?.[String((s as any).npcID ?? 0)] === 2) {
      ...
      scene.text(`"No reason to increase the risk either," ${((s as any).npcdesc || '')} frowns and keeps more condoms within arm's reach.`);
    } else {
      ...
      scene.text(`${((s as any).npcdesc || '')} grins back at you and his cock immediately starts to stiffen again, apparently getting hard just at the thought of fucking you bareback.`);
    }
    ...
    if (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] === 2) {
      ...
      scene.text(`"No reason to increase the risk either," ${((s as any).npcdesc || '')} frowns. "I'm going to try to keep pulling out anyways."`);
      ...
      scene.text(`${((s as any).npcdesc || '')} grins back at you seeming to be excited he has permission.`);
    }
    qspCall(s, 'sex_ev_sex', 'reset');
    qspCall(s, 'sex_ev_sex', 'sex_menu');
  } },
    ...
    scene.text(`"${((s as any).sex_ev ?? 0)?.['more_creampies_dialogue'] ?? ''}" you grin back at ${((s as any).npcdesc || '')}. "Might as well make the most of the situation."`);
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['creampie_allowance'] = 1;
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['no_condom'] = 1;
    qspCall(s, 'sex_ev_sex', 'reset');
    qspCall(s, 'sex_ev_sex', 'sex_menu');
    ...
    if (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).sex_ev ?? 0)?.['cum_count'] < ((s as any).npc_sexdrive ?? 0)?.[String((s as any).npcID ?? 0)]/3) {
      ...
      scene.text(`${((s as any).npcdesc || '')} sighs in disappointment.`);
    } else {
      // TODO-QSP: dynamic text: <<$npcdesc>> nods in somber agreement.
      scene.text(`${((s as any).npcdesc || '')} nods in somber agreement.`);
    }
    qspCall(s, 'sex_ev_after', 'after_sex1');
  } },
      ]);
...
function enterAnalCreampieSurprise2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).orgasm ?? 0) === ((s as any).sex_ev ?? 0)?.['orgasm']) {
    ...
    scene.text(`As ${((s as any).npcdesc || '')} unloads inside you, sending cum and warmth into your large intestine.`);
    ...
    scene.text(`As ${((s as any).npcdesc || '')} comes inside you, you come too. Cum and warmth floods into your asshole and drives you over the edge.`);
    if (((s as any).start_type ?? 0)?.['magic'] !== 'nomagic'  &&  ((s as any).sex_ev ?? 0)?.['magik'] < ((s as any).pcs_magik ?? 0)) {
      // TODO-QSP: dynamic text: Magic floods your system, ramping your senses into overdrive. Energy courses fro...
  ...
  scene.actions([
    { label: 'Ride it out', handler: (st: GameState) => {
    // TODO-QSP: dynamic text: You stay there patiently, letting <<$npcdesc>> empty himself into your ass, wait...
    scene.text(`You stay there patiently, letting ${((s as any).npcdesc || '')} empty himself into your ass, waiting until you no longer feel him twitching inside you.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'sex_ev_reactions', 'react_menu');
  } },
    { label: 'Tolerate it (disgust)', handler: (st: GameState) => {
    // TODO-QSP: dynamic text: You stay there, trying not to squirm in discomfort, feeling <<$npcdesc>>'s spunk...
    scene.text(`You stay there, trying not to squirm in discomfort, feeling ${((s as any).npcdesc || '')}'s spunk fill your ass. Despite your disgust, you don't move, waiting until you no longer feel him twitching inside you.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'sex_ev_reactions', 'react_menu');
  } },
  ]);
...
function enterCumCondom(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
    ...
    scene.text(`${((s as any).npcdesc || '')}'s pulsing cock is the final straw and a dam breaks inside you as your climax erupts. The two of come together, each of your orgasms fueling the other's until eventually they've run their course and both of you lay there panting.`);
    if (((s as any).condom_break ?? 0) > 0) {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBrokenCondom0(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_condom'] = ((s as any).sex_ev['cum_condom'] ?? 0) + (1);
    ...
    scene.text(`You wait patiently, letting ${((s as any).npcdesc || '')} empty himself into the condom, until you no longer feel him twitching inside you.`);
    if (((s as any).condom_break ?? 0) > 0) {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBrokenCondom0(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_condom'] = ((s as any).sex_ev['cum_condom'] ?? 0) + (1);
      ...
      { label: 'Tolerate it (disgust)', handler: (st: GameState) => {
    // TODO-QSP: dynamic text: You lay there, trying not to squirm as <<$npcdesc>> orgasm pumps load after load...
    scene.text(`You lay there, trying not to squirm as ${((s as any).npcdesc || '')} orgasm pumps load after load into your womb. Despite the condom safely encasing his cock, the idea of him filling you up is enough to fill you with disgust and you don't move, waiting until you no longer feel him twitching inside you.`);
    if (((s as any).condom_break ?? 0) > 0) {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBrokenCondom0(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['cum_condom'] = ((s as any).sex_ev['cum_condom'] ?? 0) + (1);
...
function enterBrokenCondom1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Right as it seems like ${((s as any).npcdesc || '')}'s finished, you feel a <i>pop</i> inside you and a sudden rush of warmth <i>floods</i> through your hips.`);
    scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
      ...
      if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
        ...
        scene.text(`You blink in surprise but wait patiently without making a fuss until ${((s as any).npcdesc || '')} withdraws his cock from you. The moment it slips free, cum gushes from your pussy and you visually confirm what you suspected: the condom broke.`);
      } else {
        scene.img('images/shared/sex/cum/vagcreampie/doggy1.jpg');
        // TODO-QSP: dynamic text: You blink in surprise but wait patiently without making a fuss until <<$npcdesc>...
        scene.text(`You blink in surprise but wait patiently without making a fuss until ${((s as any).npcdesc || '')} withdraws his cock from you. The moment it slips free, something wet gushes from your pussy and you turn around to visually confirm what you suspected: the condom broke.`);
      }
    }
    qspCall(s, 'sex_ev_reactions_creampie', 'oh_shit_options');
    ...
    (s as any).orgasm_or = 'yes';
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['broken_condom_creampie_cum'] = 1;
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['simultaneous_orgasm_count'] = ((s as any).sex_ev['simultaneous_orgasm_count'] ?? 0) + (1);
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['came_together'] = 1;
    // TODO-QSP: gs 'arousal', 'vaginal', -1, 'no_orgasm_msg', $sex_ev['prostitution_flag']
    if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
    ...
    scene.text(`The sudden explosion of warmth inside you overwhelms your senses and you gasp. It causes you to orgasm and your whole body shudders around ${((s as any).npcdesc || '')}'s cock as heat fills you to the brim.`);
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
      scene.img('images/shared/sex/vag/miss/2.jpg');
      // TODO-QSP: dynamic text: Eventually your orgasm comes down and you look up at <<$npcdesc>>, still quiveri...
      scene.text(`Eventually your orgasm comes down and you look up at ${((s as any).npcdesc || '')}, still quivering with his cock inside you.`);
      ...
      if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
        ...
        scene.text(`Eventually your orgasm comes down and your knees give out underneath you, falling down to the bed with ${((s as any).npcdesc || '')} on top of you.`);
        ...
        if (((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
          ...
          scene.text(`Eventually your orgasm comes down and you let yourself collapse on top of ${((s as any).npcdesc || '')}, feeling your breasts pressed against his chest, which rises and falls with the same laboured breathing as your own.`);
...
function enterBrokenCondom2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
      ...
      scene.text(`${((s as any).npcdesc || '')} slips his cock out from behind you and something wet trickles out after him.`);
      ...
      scene.text(`${((s as any).npcdesc || '')} slips his cock out from inside you and something wet trickles out after it.`);
...
function enter2pumpchump(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['cum_choice'] === 'creampie_surprise'  ||  ((s as any).sex_ev ?? 0)?.['cum_choice'] === 'creampie'  ||  ((s as any).sex_ev ?? 0)?.['condom'] === 1) {
      ...
      if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
        scene.img('images/shared/sex/cum/vagcreampie/creampie1.mp4');
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter2pumpEnjoymentDesc(s, scene); (s as any).locArgs = __savedLocArgs; }
      ...
      if (((s as any).sex_ev ?? 0)?.['condom'] === 1) {
        ...
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter2pumpchumpCreampie(s, scene); (s as any).locArgs = __savedLocArgs; }
      }
    } else {
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['last_cum'] = 'pullout';
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['cock_inserted'] = 0;
...
function enter2pumpchumpCreampie(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
      ...
      scene.text(`As ${((s as any).npcdesc || '')} withdraws his cock from your pussy, feel a <i>pop</i> inside you and milky white fluid spills out from your snatch.`);
    } else {
      if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
        scene.img('images/shared/sex/cum/vagcreampie/doggy2.mp4');
        // TODO-QSP: dynamic text: As <<$npcdesc>> withdraws his cock from your pussy, feel a <i>pop</i> inside you...
        scene.text(`As ${((s as any).npcdesc || '')} withdraws his cock from your pussy, feel a <i>pop</i> inside you and something thick dribble out of your snatch.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
          scene.img('images/shared/sex/cum/vagcreampie/cowgirl3.mp4');
          // TODO-QSP: dynamic text: As you pull yourself off of <<$npcdesc>>, his cock flops from your pussy you can...
...
function enterHypnoCreampieOrgasmFail(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
    ...
    if (((s as any).sex_ev ?? 0)?.['creampie_surprise'] === 1) {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCreampieSurpriseCumTogether(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumInsidePullAway(s, scene); (s as any).locArgs = __savedLocArgs; }
      qspCall(s, 'sex_ev_reactions', 'react_menu');
    }

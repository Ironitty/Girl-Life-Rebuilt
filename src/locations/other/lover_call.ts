...
function enterScheduler(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).tempLCVars ?? 0)?.['maxi'] > 0) {
    ...
    } while (((s as any).tempLCVars ?? 0)?.['i'] < ((s as any).tempLCVars ?? 0)?.['maxi']);
  }
  (s as any).tempLCVars = undefined;
  scene.build();
}
...
function enterSetBaseSchedule(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).tempLCVars2 = undefined;
  scene.build();
}
...
function enterInitCall4DateLover(s: GameState, scene: SceneBuilder): void {
  ((s as any).call4Date = (s as any).call4Date ?? {})['NPC'] = ((s as any).locArgs?.[1] ?? 0);
  qspCall(s, 'npcStat', '', (((s as any).call4Date ?? 0)?.['NPC']));
  ((s as any).call4Date = (s as any).call4Date ?? {})['CallerName'] = (((s as any).npc_usedname ?? 0)?.[(((s as any).call4Date ?? 0)?.['NPC'])] ?? 0);
...
function enterCallingTheLoverF(s: GameState, scene: SceneBuilder): void {
  ((s as any).call4Date = (s as any).call4Date ?? {})['willAgree'] = ((Math.floor(Math.random() * 11) + 0) > 3);
  scene.text('"Yes, I\'m listening," says a voice from the speaker.');
  if (((s as any).month ?? 0) > 5  &&  ((s as any).temper ?? 0) > 20  &&  ((s as any).sunWeather ?? 0) === 1) {
    scene.actions([
      { label: 'Invite to the park', handler: (st: GameState) => {
...
function enterLoverM(s: GameState, scene: SceneBuilder): void {
  ((s as any).DateNickName = (s as any).DateNickName ?? {})[0] = 'cutie';
  ((s as any).DateNickName = (s as any).DateNickName ?? {})[1] = 'honey';
  ((s as any).DateNickName = (s as any).DateNickName ?? {})[2] = 'sweetie';
  ((s as any).DateNickName = (s as any).DateNickName ?? {})[3] = 'baby';
  ((s as any).DateNickName = (s as any).DateNickName ?? {})[4] = 'hot stuff';
  ((s as any).DateNickName = (s as any).DateNickName ?? {})[5] = '' + ((s as any).pcs_nickname ?? 0) + '';
  ((s as any).call4Date = (s as any).call4Date ?? {})['SvetaName'] = (((s as any).DateNickName ?? 0)?.[(Math.floor(Math.random() * (0 - 0 + 1)) + (0))] ?? 0);
  (s as any).DateNickName = undefined;
  ...
  scene.actions([
    ...
    ((st as any).npc_rel = (st as any).npc_rel ?? {})[(((st as any).call4Date ?? 0)?.['NPC'])] = 0;
    ...
    if (((st as any).npc_gentle ?? 0)[((st as any).call4Date ?? 0)?.['NPC']] === 1) {
      if (((st as any).npc_rel ?? 0)[((st as any).call4Date ?? 0)?.['NPC']] < 85) {
        ...
        ((st as any).npc_love = (st as any).npc_love ?? {})[(((st as any).call4Date ?? 0)?.['NPC'])] = 1;
    ...
    ((st as any).npc_meetday = (st as any).npc_meetday ?? {})[(((st as any).call4Date ?? 0)?.['NPC'])] = ((st as any).daystart ?? 0);
    ((st as any).npc_meethour = (st as any).npc_meethour ?? {})[(((st as any).call4Date ?? 0)?.['NPC'])] = window.prompt("When do you want to be picked up? It is now " + (qspFunc(s, 'time', 'get_time_string', ((st as any).hour ?? 0), ((st as any).minut ?? 0))) + ". [Enter the hour only 0 - 20]") ?? '';
    if (((st as any).npc_meethour ?? 0)[((st as any).call4Date ?? 0)?.['NPC']] <= ((st as any).hour ?? 0)  ||  ((st as any).npc_meethour ?? 0)[((st as any).call4Date ?? 0)?.['NPC']] > 23) {
      ((st as any).npc_meethour = (st as any).npc_meethour ?? {})[(((st as any).call4Date ?? 0)?.['NPC'])] = 20;
    }
...
function enterInitCall4Date(s: GameState, scene: SceneBuilder): void {
  ((s as any).call4Date = (s as any).call4Date ?? {})['ContactIndex'] = ((s as any).locArgs?.[1] ?? 0);
  ((s as any).call4Date = (s as any).call4Date ?? {})['NPC'] = qspUntranslated(s, "contact[call4Date['ContactIndex']]", { location: "lover_call" });
  ((s as any).call4Date = (s as any).call4Date ?? {})['CallerName'] = (((s as any).npc_nickname ?? 0)?.[(((s as any).call4Date ?? 0)?.['NPC'])] ?? 0);
  if (((s as any).npc_gender ?? 0)[((s as any).call4Date ?? 0)?.['NPC']] === 0) {
    ((s as any).call4Date = (s as any).call4Date ?? {})['NPC-he'] = 'he';
    ((s as any).call4Date = (s as any).call4Date ?? {})['NPC-He'] = 'He';
    ((s as any).call4Date = (s as any).call4Date ?? {})['NPC-his'] = 'his';
    ((s as any).call4Date = (s as any).call4Date ?? {})['NPC-His'] = 'His';
  } else {
    ((s as any).call4Date = (s as any).call4Date ?? {})['NPC-he'] = 'her';
    ((s as any).call4Date = (s as any).call4Date ?? {})['NPC-He'] = 'Her';
    ((s as any).call4Date = (s as any).call4Date ?? {})['NPC-his'] = 'hers';
    ((s as any).call4Date = (s as any).call4Date ?? {})['NPC-His'] = 'Hers';
  }
  (s as any).caller = (((s as any).call4Date ?? 0)?.['CallerName']);
...
function enterNPCDate(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).call4Date = (s as any).call4Date ?? {})['Location'] = ((s as any).locArgs?.[2] ?? 0);
  qspCall(s, 'npcStat', '', (((s as any).call4Date ?? 0)?.['NPC']));
...
function enterSvetaCallsNPC(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_rel ?? 0)[((s as any).call4Date ?? 0)?.['NPC']] <= 50) {
    ((s as any).call4Date = (s as any).call4Date ?? {})['loverResist'] = 'easy';
  } else {
    if (((s as any).npc_rel ?? 0)[((s as any).call4Date ?? 0)?.['NPC']] <= 65) {
      ((s as any).call4Date = (s as any).call4Date ?? {})['loverResist'] = 'medium';
    } else {
      ((s as any).call4Date = (s as any).call4Date ?? {})['loverResist'] = 'hard';
    }
  }
...
function enterNPCCallsForDate(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).npc_rel ?? 0)[((st as any).call4Date ?? 0)?.['NPC']] <= 50) {
      ((st as any).call4Date = (st as any).call4Date ?? {})['loverResist'] = 'easy';
    } else {
      if (((st as any).npc_rel ?? 0)[((st as any).call4Date ?? 0)?.['NPC']] <= 65) {
        ((st as any).call4Date = (st as any).call4Date ?? {})['loverResist'] = 'medium';
      } else {
        ((st as any).call4Date = (st as any).call4Date ?? {})['loverResist'] = 'hard';
      }
    }

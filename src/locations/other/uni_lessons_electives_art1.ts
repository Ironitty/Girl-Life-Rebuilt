...
function enterArt_101(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).university ?? 0)?.['first_visit_art_101']) {
    ...
    if (!(s as any).university) (s as any).university = {}; (s as any).university['first_visit_art_101'] = 1;
        ...
        if (((s as any).temprand ?? 0) === 3) {
          ...
          if (((s as any).temprand ?? 0) === 4) {
            ...
            if (((s as any).temprand ?? 0) === 5) {
              if (!(s as any).university) (s as any).university = {}; (s as any).university['alb_art_model'] = 1;
...
function enterArt_101Events(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temprand ?? 0) === 1  &&  ((s as any).university ?? 0)?.['alb_art_model'] === 1  &&  ((s as any).year ?? 0) > 2017  ||  (((s as any).year ?? 0) === 2017  &&  ((s as any).month ?? 0) > 9)) {
    if (!(s as any).university) (s as any).university = {}; (s as any).university['alb_art_model'] = 0;
    scene.img('images/locations/city/island/university/classroom/electives/art/class.jpg');
...
function enterAlbinaArt(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Your curiosity gets the better of you and you peek in further for a better view as Albina gets on her back and grins as she spreads her legs. ${((s as any).temp_name ?? 0)} steps between her legs and grinds the thick head of his cock between her wet pussy lips before he starts pushing it against her slit.`);
    ...
    scene.text(`${((s as any).temp_name ?? 0)} grins. "You like how my black cock stretches your tight little white pussy? Beg me to fuck you, slut!"`);
    ...
    scene.text(`You're waiting for quite some time before she finally leaves the classroom with ${((s as any).temp_name_lower ?? 0)} in tow. She's clutching her stomach and winces a little in pain; you can guess why…`);
    if (((s as any).AlbinaQW ?? 0)?.['Friends'] === 2  ||  ((s as any).npc_rel ?? 0)?.['A23'] >= 70) {
      ...
      scene.text(`She seems surprised to see you. "Oh, ${((s as any).pcs_nickname ?? 0)}. What are you doing here?" she asks, looking a little flustered as ${((s as any).temp_name_lower ?? 0)} grins.`);
      ...
      if (((s as any).ErmiasQW ?? 0)?.['meet'] === 1) {
        ...
        scene.text(`"Hello ${((s as any).pcs_nickname ?? 0)}," he replies with a smile.`);
      ...
      if (((s as any).npc_rel ?? 0)?.['A23'] > 20) {
        ...
        scene.text(`She seems surprised to see you. "${((s as any).pcs_nickname ?? 0)}? What are you doing here?"`);
        ...
        scene.text(`${((s as any).temp_name ?? 0)} sends her on her way with a firm smack on the ass, causing Albina to whip around and shake her head, but you see a small smile creep onto her lips before she turns and walks away. ${((s as any).temp_name ?? 0)} then heads off in the opposite direction, leaving you alone in the hallway.`);
      } else {
        ...
        scene.text(`"Friend of yours?" ${((s as any).temp_name_lower ?? 0)} asks.`);

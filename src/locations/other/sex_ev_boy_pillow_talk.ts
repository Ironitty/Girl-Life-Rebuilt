...
function enterBoyTalk(s: GameState, scene: SceneBuilder): void {
  if (Math.floor(Math.random() * 2) + 0 === 1) {
    ...
    // TODO-QSP: "
    if (((s as any).sex_ev ?? 0)?.['drink_fluid'] === 0  &&  (((s as any).sex_ev ?? 0)?.['loc'] === 'npc_home'  ||  (((s as any).sex_ev ?? 0)?.['loc'] === 'hotel_room'))  &&  ((s as any).npc_selfish ?? 0) === 0) {
    ...
    if (((s as any).sex_ev ?? 0)?.['first_date_fuck_talk'] === 0  &&  ((s as any).date_ev ?? 0) > 0  &&  ((s as any).sex_ev ?? 0)?.['date_before_sex'] === 1  &&  ((s as any).npc_date_count ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).sex_ev ?? 0)?.['virgin'] !== 1  &&  ((s as any).arrpos ?? 0)('body_count', ((s as any).npcID ?? 0)) < 0  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] > 0) {
    ...
    if (((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'hookup'  &&  ((s as any).npc_finance ?? 0)?.[String((s as any).npcID ?? 0)] >= 2  &&  ((s as any).sex_ev ?? 0)?.['sugar_baby_offer'] === 0  &&  ((((s as any).rand ?? 0)(-1,2) - ((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)]) > 0  ||  ((s as any).sex_ev ?? 0)?.['prostitution'] === 1  ||  ((s as any).npc_womanizer ?? 0)?.[String((s as any).npcID ?? 0)] === 1)) {
    ...
    if ((((s as any).arrpos ?? 0)('pcs_appearance', 'innocent') >= 0  ||  ((s as any).arrpos ?? 0)('pcs_appearance', 'nerdy') >= 0)  &&  (((s as any).arrpos ?? 0)('body_count', ((s as any).npcID ?? 0)) < 0  &&  ((s as any).sex_ev ?? 0)?.['fucked_out'] > 0  &&  ((s as any).sex_ev ?? 0)?.['cum_count'] > 2  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] > 0  &&  ((s as any).sex_ev ?? 0)?.['tap_out'] === 0  &&  ((s as any).sex_ev ?? 0)?.['boy_nerdy_slut_talk'] === 0)) {
      // TODO-QSP: $sex_ev_boy_topics[] = "xgt 'sex_ev_boy_pillow_talk', 'boy_nerdy_slut_talk1'"
    }
    if (((s as any).arrsize ?? 0)('sex_ev_boy_topics') > 0) {

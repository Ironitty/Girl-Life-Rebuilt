...
function enterChecker(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['boy_asleep'] === 0) {
    if (((s as any).sex_ev ?? 0)?.['boy_pillow_talk'] > 0) {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBoyTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['boy_pillow_talk'] = ((s as any).sex_ev['boy_pillow_talk'] ?? 0) + (1);
    }
  }
  scene.build();
}
...
function enterBoyTalk(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 2) + 0) === 1) {
    (s as any).sex_ev_boy_topics = undefined;
    if (((s as any).sex_ev ?? 0)?.['good_for_you'] === 0  &&  ((s as any).sex_ev ?? 0)?.['sex_over'] === 1) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_favorite_part\', \'boy_good_for_you\''];
    }
    if (((s as any).sex_ev ?? 0)?.['boob_fondle'] === 0) {
      ...
      if (((s as any).ngpPrefResult ?? 0)?.['HasPos'] !== '') {
        (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_body_talk\', \'boob_fondle\''];
      } else {
        (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_body_talk\', \'tits_admire\''];
      }
    }
    ...
    if (((s as any).sex_ev ?? 0)?.['boy_shower'] === 0  &&  ((s as any).sex_ev ?? 0)?.['action_restricted'] === 0  &&  ((s as any).sex_ev ?? 0)?.['sex_over'] > 0) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_boy_pillow_talk\', \'boy_take_shower\''];
    }
    if (((s as any).sex_ev ?? 0)?.['broken_condom'] >= 1  &&  ((s as any).sex_ev ?? 0)?.['broken_condom_talk'] !== 1  &&  (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] !== 1  &&  (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] === 1  ||  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] === 1))) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_boy_pillow_talk\', \'boy_broken_condom\''];
    }
    if (((s as any).npc_thinkage ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).sex_ev ?? 0)?.['age_ask_talk'] === 0  &&  ((s as any).sex_ev ?? 0)?.['angry_after'] < 1  &&  ((s as any).sex_ev ?? 0)?.['mad'] < 1) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'gt \'sex_ev_boy_pillow_talk\', \'age_ask_talk\''];
    }
    if (((s as any).sex_ev ?? 0)?.['accidental_creampie_count'] > 0  &&  ((s as any).sex_ev ?? 0)?.['cant_believe_creampie_talk'] !== 1) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_boy_pillow_talk\', \'boy_accidental_creampie_talk2\''];
    }
    if (((s as any).sex_ev ?? 0)?.['no_condom'] === 0  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] > 0  &&  ((s as any).npc_no_condoms ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  ((s as any).sex_ev ?? 0)?.['wish_no_condoms_talk'] === 0) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_boy_pillow_talk\', \'boy_hates_condoms\''];
    }
    if (((s as any).sex_ev ?? 0)?.['first_date_fuck_talk'] === 0  &&  ((s as any).date_ev ?? 0) > 0  &&  ((s as any).sex_ev ?? 0)?.['date_before_sex'] === 1  &&  ((s as any).npc_date_count ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).sex_ev ?? 0)?.['virgin'] !== 1  &&  (Array.isArray((s as any).body_count) ? ((s as any).body_count as any[]).indexOf(((s as any).npcID ?? 0)) : -1) < 0  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] > 0) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_boy_pillow_talk\', \'boy_first_date_fuck\''];
    }
    if ((((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted'  ||  ((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'childish')  &&  ((s as any).sex_ev ?? 0)?.['lesbian_ask'] === 0) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_boy_pillow_talk\', \'boy_lesbian_ask1\''];
    }
    if (((s as any).sex_ev ?? 0)?.['buy_virginity'] > 0  &&  ((s as any).sex_ev ?? 0)?.['deflowered'] > 0  &&  ((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] < 1  &&  ((s as any).sex_ev ?? 0)?.['virginity_paid_talk'] === 0) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_sugardaddy_talk\', \'virginity_paid_talk\''];
    } else {
    ...
    if (((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'hookup'  &&  ((s as any).npc_finance ?? 0)?.[String((s as any).npcID ?? 0)] >= 2  &&  ((s as any).sex_ev ?? 0)?.['sugar_baby_offer'] === 0  &&  (((Math.floor(Math.random() * (2 - -1 + 1)) + (-1)) - ((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)]) > 0  ||  ((s as any).sex_ev ?? 0)?.['prostitution'] === 1  ||  ((s as any).npc_womanizer ?? 0)?.[String((s as any).npcID ?? 0)] === 1)) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_sugardaddy_talk\', \'sugar_baby_offer\''];
    } else {
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['sugar_baby_offer'] = (-1);
    }
    if (((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'sugar_daddy') {
      if (((s as any).npc_wife ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).sex_ev ?? 0)?.['wife_problem_talk'] === 0) {
        (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_sugardaddy_talk\', \'wife_problems\''];
      }
      if (((s as any).sex_ev ?? 0)?.['work_complaints'] === 0) {
        (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_sugardaddy_talk\', \'work_complaints\''];
      }
    }
    if (((s as any).sex_ev ?? 0)?.['boy_pube_talk'] < 1) {
      if (((s as any).npc_know_pubeshape ?? 0)?.[String((s as any).npcID ?? 0)] !== ((s as any).pube_style ?? 0)?.['shape']) {
        (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_body_talk\', \'boy_pube_talk_start\''];
      } else {
        if (((s as any).npc_know_pubeshape ?? 0)?.[String((s as any).npcID ?? 0)] !== ''  &&  ((s as any).pube_style ?? 0)?.['shape'] === 'bush'  &&  ((String(((s as any).npc_likes ?? 0)).indexOf(String(';pubes;'))) + 1)) {
          (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_boy_pillow_talk\', \'pubes_soft_talk\''];
        }
      }
    }
    if (((s as any).sex_ev ?? 0)?.['boy_likes_hair'] === 1  &&  ((s as any).sex_ev ?? 0)?.['boy_like_hair_talk'] === 0) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_body_talk\', \'boy_like_hair_talk\''];
    }
    if (((Array.isArray((s as any).pcs_appearance) ? ((s as any).pcs_appearance as any[]).indexOf('innocent') : -1) >= 0  ||  (Array.isArray((s as any).pcs_appearance) ? ((s as any).pcs_appearance as any[]).indexOf('nerdy') : -1) >= 0)  &&  ((Array.isArray((s as any).body_count) ? ((s as any).body_count as any[]).indexOf(((s as any).npcID ?? 0)) : -1) < 0  &&  ((s as any).sex_ev ?? 0)?.['fucked_out'] > 0  &&  ((s as any).sex_ev ?? 0)?.['cum_count'] > 2  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] > 0  &&  ((s as any).sex_ev ?? 0)?.['tap_out'] === 0  &&  ((s as any).sex_ev ?? 0)?.['boy_nerdy_slut_talk'] === 0)) {
      (s as any).sex_ev_boy_topics = [...((s as any).sex_ev_boy_topics ?? []), 'xgt \'sex_ev_boy_pillow_talk\', \'boy_nerdy_slut_talk1\''];
    }
    if (Object.keys((s as any).sex_ev_boy_topics ?? {}).length > 0) {
      ((s as any).sex_ev = (s as any).sex_ev ?? {})['boy_pillow_talk'] = 0;
    }
  }
  scene.build();
}
...
function enterTemplate(s: GameState, scene: SceneBuilder): void {
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['template'] = 1;
...
function enterLikeCumTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_know_like_cum ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLikeCumTalk2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ...
    scene.text(`${(((st as any).npc_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')} blinks and you give him a knowing look.`);
    ...
    if (((s as any).npc_know_like_cum ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      scene.text(`"So you really like the taste of my cum?" ${((s as any).npcdesc ?? '')} asks, an oddly eager smile on his face.`);
    } else {
      if (((s as any).npc_know_like_cum ?? 0)?.[String((s as any).npcID ?? 0)] === -1) {
      }
    }
...
function enterLikeCumTalk2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).trait_vars ?? 0)?.['cumeater'] === 1) {
    ...
    if (((st as any).npc_caretaker ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDontHaveToSwallowTalk(st, scene); (st as any).locArgs = __savedLocArgs; }
    } else {
      scene.text(`"That's fucking hot," ${(((st as any).npc_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')} grins back.`);
  ...
  if (((s as any).stat ?? 0)?.['swallow'] === ((s as any).sex_ev ?? 0)?.['swallow_count']) {
    ...
    scene.text(`"Actually... I've never swallowed before," you admit. A smile creeps across your face as you see ${(((st as any).npc_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')}'s jaw drop. "You're my first time."`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ]);
  }
  scene.actions([
    ...
    ((st as any).npc_know_like_cum = (st as any).npc_know_like_cum ?? {})[String((st as any).npcID ?? 0)] = (-1);
    if (((st as any).sex_ev ?? 0)?.['tasty_cum'] === 1) {
...
function enterDontHaveToSwallowTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).npc_know_like_cum ?? 0)?.[String((st as any).npcID ?? 0)] === 1) {
...
function enterBoyDrinkOffer(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] > 0  ||  ((s as any).npc_generous ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
    scene.text(`${((s as any).npcdesc ?? '')} gets up for a moment to pull a bottle of clear liquid off a nearby table.`);
    scene.text(`"Care for a drink?" ${((s as any).npcdesc ?? '')} asks as he slides back into bed with you, offering you the bottle. The sharp smell wafting from the mouth of it lets you know it's vodka.`);
  } else {
    scene.text(`${((s as any).npcdesc ?? '')} gets up for a moment to pull a bottle of clear liquid off a nearby table and takes a swig.`);
  ...
  scene.actions([
    ...
    scene.text(`"Oh, sure." ${((st as any).npcdesc ?? '')} gets up for a minute and comes back with another bottle that seems cleaner. You take a drink and the filtered taste of tap water hits your tongue, refreshing you in your post-sex cooldown.`);
...
function enterBoyBrokenCondom(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['broken_condom_talk'] === 0  &&  ((s as any).sex_ev ?? 0)?.['broken_condom'] >= 1) {
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['broken_condom_talk'] = 1;
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['boy_topics'] = ((s as any).sex_ev['boy_topics'] ?? 0) - (1);
    qspCall(s, 'sex_ev_pillow_talk', 'talk_time_add');
    if (((s as any).npc_pay_for_ma_pill ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      if (((s as any).sex_ev ?? 0)?.['ma_pill_money'] === 0) {
        scene.img('images/shared/sex/after/pillow_talk1.jpg');
        scene.text(`"Oh, before I forget. Since the condom broke, I think I owe you this," ${((s as any).npcdesc ?? '')} says, reaching over to his wallet and handing you a ${qspFunc(s, 'money', 'string_profit', 1000)} note. "For the morning after pill."`);
        ...
        if (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
          scene.img('images/shared/sex/after/pillow_talk1.jpg');
          scene.text(`"Don't forget to buy the pill later," ${((s as any).npcdesc ?? '')} reminds you.`);
          scene.actions([
    ...
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
      ...
      if (((s as any).sex_ev ?? 0)?.['ma_pill'] > 0) {
        ...
        if (((s as any).sex_ev ?? 0)?.['ma_pill'] === 1) {
          scene.text(`"Really unlucky about that broken condom," ${((s as any).npcdesc ?? '')} says. "But at least you have that morning after pill."`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['ma_pill'] === 2) {
            scene.text(`"Really unlucky about that broken condom," ${((s as any).npcdesc ?? '')} says. "Good thing you had that morning after pill."`);
          }
        }
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBoyTakePillNow(s, scene); (s as any).locArgs = __savedLocArgs; }
        scene.actions([
          { label: 'Yeah', handler: (st: GameState) => {
    ...
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
        ...
        if (((s as any).npc_know_bc ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).sex_ev ?? 0)?.['ma_pill'] === 0  &&  (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] !== 1  &&  (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] === 1  ||  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] === 1))) {
          ...
          if (((s as any).cum_loc ?? 0)?.['vagina'] > 0) {
            scene.text(`"Are you going to be okay?" ${((s as any).npcdesc ?? '')} asks, looking worriedly at your pussy still leaking his cum. "You know, with the... broken condom and everything...?"`);
          } else {
            scene.text(`"Are you going to be okay?" ${((s as any).npcdesc ?? '')} asks, looking worriedly at your pussy. "You know, with the... broken condom and everything...?"`);
          }
...
function enterBoyTakePillNow(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['ma_pill'] < 2  &&  ((s as any).mc_inventory ?? 0)?.['morning_after_pill'] > 0) {
    ...
    scene.text(`${((st as any).npcdesc ?? '')} watches you reach into your purse and pull out your morning after pill and you can't help but blush beneath his gaze.`);
    ...
    scene.text(`As ${((st as any).npcdesc ?? '')} watches you pull your morning after pill from your purse, you give him a smouldering look. Sticking out your tongue at him, you pop the pill onto your mouth, swallowing with a wide grin.`);
    if (((st as any).sex_ev ?? 0)?.['last_cum'] === 'swallow') {
      ...
      if (((st as any).LudaQW ?? 0)?.['free_condoms'] === 1  &&  ((st as any).LudaQW ?? 0)?.['luda_ma_pill'] === 0) {
        ...
        scene.text(`"She sounds like a good aunt," ${((st as any).npcdesc ?? '')} smirks back. "Or a slutty one."`);
...
function enterBoyMorningPillTalk1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['ma_pill'] < 1) {
    ...
    if (((st as any).sex_ev ?? 0)?.['cant_believe_creampie_talk'] === 0) {
      scene.text('He nods back, somehow looking worried and relieved at the same time.');
      qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
    } else {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBoyAccidentalCreampieTalk2(st, scene); (st as any).locArgs = __savedLocArgs; }
    }
  } },
        ]);
      } else {
    ...
    scene.text(`iif(cum_loc['vagina'] > 0, '${((s as any).npcdesc ?? '')} glances between your legs with a concerned look, watching his cum seep from your pussy.', '${((s as any).npcdesc ?? '')} glances between your legs with a concerned look, as if he can see his sperm swimming up your pussy right now.')`);
  } else {
    scene.text(`"It's a good thing you had that morning after pill," ${((s as any).npcdesc ?? '')} says, ` + ((((s as any).cum_loc ?? 0)?.['vagina'] > 0) ? ('glancing at your pussy and the cum seeping from it.') : ('glancing at your pussy where he deposited his load earlier.')));
    if (((s as any).LudaQW ?? 0)?.['free_condoms'] === 1  &&  ((s as any).LudaQW ?? 0)?.['luda_ma_pill'] === 0) {
      scene.actions([
        { label: 'Thank my aunt', handler: (st: GameState) => {
    scene.text('iif(sex_ev[\'aunt_pill\'] = 0, \'"You can thank my aunt for that," you say with a wry smirk. "She gave it to me for emergencies."\', \'"Thank my aunt instead," you say with a wry smirk.\')');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBoyAccidentalCreampieTalk2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
...
function enterBoyAccidentalCreampieTalk1(s: GameState, scene: SceneBuilder): void {
  scene.img('images/shared/sex/after/pillow_talk1.jpg');
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBoyAccidentalCreampieTalk2(s, scene); (s as any).locArgs = __savedLocArgs; }
  scene.build();
}
...
function enterBoyAccidentalCreampieTalk2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['cant_believe_creampie_talk'] === 1) {
    ...
    qspCall(s, 'sex_ev_pillow_talk', 'talk_time_add');
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['cant_believe_creampie_talk'] = 1;
    ...
    if (((st as any).npc_pullout_failure ?? 0)?.[String((st as any).npcID ?? 0)] > 5) {
    ...
    if (((st as any).npc_childfree ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
      if (((st as any).sex_ev ?? 0)?.['preg_risk'] === ''  ||  ((st as any).sex_ev ?? 0)?.['preg_risk'] === 'danger') {
        scene.text('"That doesn\'t make it any less dangerous. What if you get pregnant?"');
        qspCall(st, 'sex_ev_talk', 'childfree_accidental_creampie1');
        qspCall(st, 'sex_ev_talk', 'pc_have_morning_after');
      } else {
    ...
    scene.text(`${((st as any).npcdesc ?? '')} takes a deep breath and lets it out slowly, giving you a small smile in return, seeming to relax, if only a little.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ...
    scene.text(`${((st as any).npcdesc ?? '')} looks like he's feeling a little better.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
        ]);
      }
    } else {
      scene.text(`${((st as any).npcdesc ?? '')} visibly relaxes, seeming reassured that you aren't mad about his mistake.`);
      qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
    }
  } },
...
function enterBoyTakeShower(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sweat ?? 0) >= 20  ||  (Math.floor(Math.random() * 2) + 1) === 1) {
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['join_shower_offer'] = 1;
    if (((s as any).pcs_sweat ?? 0) >= 20) {
      scene.text(`"I could really use a shower after that," ${((s as any).npcdesc ?? '')} says. "Want to join me?"`);
    } else {
      scene.text(`"I think I'm gonna take a shower," ${((s as any).npcdesc ?? '')} says. "Want to join me?"`);
    }
    scene.actions([
      { label: 'No thanks', handler: (st: GameState) => {
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['boy_in_shower'] = 1;
    scene.text('"That\'s okay, I think I\'m just going to keep chilling here for a while," you reply.');
    scene.text(`"Suit yourself," ${((st as any).npcdesc ?? '')} shrugs and gets up, leaving you alone in the sheets.`);
    scene.actions([
    ...
    scene.text(`You let ${((st as any).npcdesc ?? '')} lead you out of bed and into the bathroom.`);
    scene.actions([
    ...
    scene.text(`"I think I'm gonna take a shower," ${((s as any).npcdesc ?? '')} says.`);
    scene.actions([
      { label: 'Have fun', handler: (st: GameState) => {
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['boy_in_shower'] = 1;
    scene.text(`"Okay. Have fun in there," you reply and ${((st as any).npcdesc ?? '')} gets up, leaving you alone in the sheets.`);
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_after', '');
  } },
...
function enterBoyHatesCondomsStartDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_rough ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    scene.text(`"Ugh, I fucking hate using condoms," ${((s as any).npcdesc ?? '')} sighs. "I can barely feel anything."`);
  } else {
    scene.text(`"Ugh, condoms are the worst," ${((s as any).npcdesc ?? '')} sighs. "I can barely feel anything."`);
  }
  scene.build();
}
...
function enterBoyHatesCondoms(s: GameState, scene: SceneBuilder): void {
  ...
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBoyHatesCondomsStartDesc(s, scene); (s as any).locArgs = __savedLocArgs; }
  scene.actions([
    ...
    scene.img('images/shared/sex/after/pillow_talk1.jpg');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBoyHatesCondomsStartDesc(st, scene); (st as any).locArgs = __savedLocArgs; }
    if (((st as any).sex_ev ?? 0)?.['preg_risk'] === 'danger') {
      scene.text(`"I know ${(((st as any).npc_lovername ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')}. I want to go bareback too," you coo sympathetically. "But you know it's a danger day for me. I could get pregnant if we do it raw."`);
      if (((st as any).npc_childfree ?? 0)?.[String((st as any).npcID ?? 0)] === 1) {
        scene.text('"I know, I know. I don\'t want you to get pregnant either. But it doesn\'t mean I have to like using condoms either."');
        scene.text('He gives you a rueful smile.');
        qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
      } else {
        if ((((st as any).npc_selfish ?? 0)?.[String((st as any).npcID ?? 0)] > 0  ||  ((st as any).npc_arrogant ?? 0)?.[String((st as any).npcID ?? 0)] > 0)  &&  ((st as any).npc_argumentative ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
          scene.text('"I\'d pull out in time," he mutters quietly.');
          if (((st as any).npc_pullout_failure_last_time ?? 0)?.[String((st as any).npcID ?? 0)] === 0) {
            scene.actions([
              { label: 'You mean like you "pulled out" last time? (annoyed)', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 3);
    scene.text(`"You mean like you 'pulled out' the last time?" you sneer pointedly, remembering how the very last time ${((st as any).npcdesc ?? '')} said that, he blew a fat load in your pussy.`);
    if (((st as any).npc_argumentative ?? 0)?.[String((st as any).npcID ?? 0)] === 2  ||  ((st as any).npc_risktaker ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
      scene.text(`"That was a one time thing," ${((st as any).npcdesc ?? '')} says, dismissing your memory with a wave of his hand. "I wouldn't make that mistake twice."`);
    } else {
      scene.text(`At least ${((st as any).npcdesc ?? '')} has the decency to look embarrassed at the reminder.`);
    }
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
              { label: 'You mean like you "pulled out" last time? (amused)', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 2);
    scene.text(`"You mean like you 'pulled out' the last time?" you snicker, remembering how the very last time ${((st as any).npcdesc ?? '')} said that, he blew a fat load in your pussy.`);
    if (((st as any).npc_argumentative ?? 0)?.[String((st as any).npcID ?? 0)] === 2  ||  ((st as any).npc_risktaker ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
      scene.text(`"That was a one time thing," ${((st as any).npcdesc ?? '')} says, dismissing your memory with a wave of his hand. "I wouldn't make that mistake twice."`);
    ...
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
          ...
          scene.actions([
            { label: 'Keep talking', goto: ['sex_ev_pillow_talk', 'topic_route'] },
          ]);
        } else {
          qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
        }
      ...
      scene.text(`"I know ${(((st as any).npc_lovername ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')}. I wanted to go bareback too," you coo sympathetically. "But it's a danger day for me. I could've gotten pregnant if we did it raw."`);
      if (((st as any).npc_childfree ?? 0)?.[String((st as any).npcID ?? 0)] === 1) {
        scene.text('"I know, I know. I don\'t want you to get pregnant either. But it doesn\'t mean I have to like using condoms either."');
        scene.text('He gives you a rueful smile.');
      }
    ...
    if (((st as any).birth_control ?? 0)?.['think_safe'] === 0) {
      if (((st as any).npc_know_not_bc ?? 0)?.[String((st as any).npcID ?? 0)] === 1) {
        scene.text(`"I know ${(((st as any).npc_lovername ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')}," you reply sympathetically. "I hate using them too. But you know I'm not on birth control. I can't afford to get pregnant."`);
        if (((st as any).npc_childfree ?? 0)?.[String((st as any).npcID ?? 0)] === 1) {
          scene.text('"I know, I know. I don\'t want you to get pregnant either. But it doesn\'t mean I have to like using condoms either."');
          scene.text('He gives you a rueful smile.');
        }
        ...
        qspCall(st, 'sex_ev_stats', 'no_birth_control_know');
        scene.text(`"I know ${(((st as any).npc_lovername ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')}," you reply sympathetically. "I hate using them too. But I'm not on birth control. It would be really bad if I got pregnant."`);
        if (((st as any).npc_childfree ?? 0)?.[String((st as any).npcID ?? 0)] === 1) {
          scene.text('"Well on that we agree. But it doesn\'t mean I have to like condoms too."');
          scene.text('He gives you a rueful smile.');
        }
      ...
      scene.text(`"I know ${(((st as any).npc_lovername ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')}," you say. "I hate using them too. But I can't afford to get pregnant."`);
      if (((st as any).npc_know_bc ?? 0)?.[String((st as any).npcID ?? 0)] === 1) {
        scene.text('"Aren\'t you already on birth control?" he asks. "What do we need condoms for?"');
...
function enterAgeAskTalk(s: GameState, scene: SceneBuilder): void {
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['age_ask_talk'] = 1;
  qspCall(s, 'sex_ev_pillow_talk', 'talk_time_add');
  qspCall(s, 'sex_ev_pillow_talk', 'pillow_picture1');
  if (((s as any).vidage ?? 0) < 20) {
    scene.text(`"How old did you say you were again?" ${((s as any).npcdesc ?? '')} asks, looking sidelong at you and letting his eyes run up and down your nubile body.`);
  } else {
    scene.text(`"How old did you say you were again?" ${((s as any).npcdesc ?? '')} asks, looking sidelong at you and letting his eyes run up and down your nubile body.`);
  }
  if (((s as any).age ?? 0) < 18) {
    ...
    ((st as any).npc_thinkage = (st as any).npc_thinkage ?? {})[String((st as any).npcID ?? 0)] = 18;
    scene.text('"I\'m 18," you lie with a bright smile.');
    qspGoto(st, 'sex_ev_boy_pillow_talk', 'age_ask_respond');
  } },
    ]);
  }
  scene.actions([
    { label: 'Tell him', handler: (st: GameState) => {
    ((st as any).npc_thinkage = (st as any).npc_thinkage ?? {})[String((st as any).npcID ?? 0)] = ((st as any).age ?? 0);
    if (((st as any).age ?? 0) < 18) {
      scene.text(`"I'm ${((st as any).age ?? '')}," you say. "Is that a problem?"`);
    } else {
      scene.text(`"I'm ${((st as any).age ?? '')}," you say. "Is that a problem?"`);
    }
    qspGoto(st, 'sex_ev_boy_pillow_talk', 'age_ask_respond');
    ...
    ((st as any).npc_thinkage = (st as any).npc_thinkage ?? {})[String((st as any).npcID ?? 0)] = ((st as any).age ?? 0);
    if (((st as any).age ?? 0) < 18) {
      scene.text(`"I'm ${((st as any).age ?? '')}," you smirk. "So it's legal for us to fuck as long as you don't pour me a drink."`);
      scene.text('"I guess I better give you something to concentrate on so you don\'t start drinking," he grins back.');
    } else {
      scene.text(`"I'm ${((st as any).age ?? '')}," you smirk. "Is that a problem?"`);
...
function enterPubesSoftTalk(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'sex_ev_pillow_talk', 'talk_time_add');
  qspCall(s, 'sex_ev_pillow_talk', 'pillow_picture1');
  scene.text(`"Your bush is so soft," ${((s as any).npcdesc ?? '')} murmurs, running his fingers through the smooth fur of your mound.`);
  scene.actions([
    ...
    if (((st as any).npc_argumentative ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
      qspCall(st, 'npc_relationship', '$npcID', 'modify', 'dislike');
...
function enterBodycountAsk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['bodycount_ask'] === 0) {
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['bodycount_ask'] = 1;
    ((s as any).sex_ev = (s as any).sex_ev ?? {})[((s as any).locArgs?.[1] ?? 0)] = 1;
    qspCall(s, 'sex_ev_pillow_talk', 'talk_time_add');
    qspCall(s, 'sex_ev_pillow_talk', 'pillow_picture1');
    scene.text(`"Tell me honestly," ${((s as any).npcdesc ?? '')} says. "How many guys have you fucked?"`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBodycountAnswers(s, scene); (s as any).locArgs = __savedLocArgs; }
    scene.actions([
...
function enterBodycountAnswers(s: GameState, scene: SceneBuilder): void {
  if (qspFunc(s, 'shortgs', 'guy') >= 30  &&  ((s as any).sex_ev ?? 0)?.['body_count_recent'] === 0) {
    scene.actions([
      { label: 'Recently or total?', goto: ['sex_ev_boy_pillow_talk', 'bodycount_recent'] },
    ]);
  }
  scene.actions([
    { label: 'Answer honestly', goto: ['sex_ev_boy_pillow_talk', 'bodycount_honest'] },
  ]);
  scene.build();
}
...
function enterBodycountHonest(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['men_fucked'] === 0) {
    if (((s as any).sex_ev ?? 0)?.['deflowered'] === 1) {
      scene.text('"I\'d never had sex before ' + ((((s as any).daystage ?? 0) >= 4) ? ('tonight,"') : ('today,"')) + 'you tell him somewhat abashedly.');
    } else {
    ...
    if (((s as any).stat ?? 0)?.['men_fucked'] === 1) {
      ...
      if (((s as any).stat ?? 0)?.['men_fucked'] < 5) {
        scene.text('"Just a few," you tell him. "About ' + ((((s as any).npc_fuck_times ?? 0)?.[String((s as any).npcID ?? 0)] > 0) ? ('' + qspFunc(s, 'string', 'parse_number', (((s as any).stat ?? 0)?.['men_fucked'] ?? '')) + '. Including you."') : ('' + qspFunc(s, 'string', 'parse_number', (((s as any).stat ?? 0)?.['men_fucked'] ?? '')) + '. Not including you."')));
        qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
        qspCall(s, 'sex_ev_pillow_talk2', 'dont_hookup');
      } else {
        if (((s as any).stat ?? 0)?.['men_fucked'] < 10) {
          scene.text('"I\'ve been around the block a few times," you tell him. "About ' + ((((s as any).npc_fuck_times ?? 0)?.[String((s as any).npcID ?? 0)] > 0) ? ('' + qspFunc(s, 'string', 'parse_number', (((s as any).stat ?? 0)?.['men_fucked'] ?? '')) + '. Including you."') : ('' + qspFunc(s, 'string', 'parse_number', (((s as any).stat ?? 0)?.['men_fucked'] ?? '')) + '. Not including you."')));
          qspCall(s, 'sex_ev_pillow_talk', 'topic_route');
          qspCall(s, 'sex_ev_pillow_talk2', 'dont_hookup');
        } else {
          if (((s as any).stat ?? 0)?.['men_fucked'] < 25) {
            scene.text('"I\'ve been around the block a few times," you tell him. "I think my body count is up to ' + ((((s as any).npc_fuck_times ?? 0)?.[String((s as any).npcID ?? 0)] > 0) ? ('' + qspFunc(s, 'string', 'parse_number', (((s as any).stat ?? 0)?.['men_fucked'] ?? '')) + '."') : ('' + qspFunc(s, 'string', 'parse_number', (((s as any).stat ?? 0)?.['men_fucked'] ?? '')) + '. ' + (((s as any).stat ?? {})?.['men_fucked'] ?? 0) + 1 + ' if I\'m including you."')));
            qspGoto(s, 'sex_ev_pillow_talk', 'topic_route');
          } else {
            if (((s as any).stat ?? 0)?.['men_fucked'] < 30) {
              scene.text('"A couple dozen or so," you tell him. "I think my body count is up to ' + ((((s as any).npc_fuck_times ?? 0)?.[String((s as any).npcID ?? 0)] > 0) ? ('' + qspFunc(s, 'string', 'parse_number', (((s as any).stat ?? 0)?.['men_fucked'] ?? '')) + '."') : ('' + qspFunc(s, 'string', 'parse_number', (((s as any).stat ?? 0)?.['men_fucked'] ?? '')) + '. ' + (((s as any).stat ?? {})?.['men_fucked'] ?? 0) + 1 + ' if I\'m including you."')));
              qspGoto(s, 'sex_ev_pillow_talk', 'topic_route');
            } else {
              if (((s as any).stat ?? 0)?.['men_fucked'] < 50) {
                scene.text('"A few dozen at this point," you tell him. "I\'m starting to lose count."');
                { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBodycountSlut(s, scene); (s as any).locArgs = __savedLocArgs; }
              } else {
...
function enterBodycountRecent(s: GameState, scene: SceneBuilder): void {
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['body_count_recent'] = qspFunc(s, 'shortgs', 'count_func', 'npc_last_sex', (((s as any).daystart ?? 0) - 30));
  ...
  if (((s as any).npc_rel_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 'sex') {
    ...
    if (((st as any).sex_ev ?? 0)?.['body_count_recent'] === 1) {
      ...
      scene.text(`"Just me?" ${((st as any).npcdesc ?? '')} blinks as you nod ruefully. "So what's the total then?"`);
    } else {
      scene.text('"... guys in the last month."');
      if (((st as any).npc_humor ?? 0)?.[String((st as any).npcID ?? 0)] !== 'intellectual') {
        scene.text(`"13 year old me would have been stoked by those numbers," ${((st as any).npcdesc ?? '')} grins. "If that's a dry spell, then what's the total?"`);
      } else {
        scene.text(`"If that's a dry spell for you then I can't wait to hear the total," ${((st as any).npcdesc ?? '')} grins.`);
      }
    }
    qspGoto(st, 'sex_ev_boy_pillow_talk', 'bodycount_answers');
  } },
      ]);
    } else {
      scene.actions([
    ...
    if (((st as any).sex_ev ?? 0)?.['body_count_recent'] >= 30) {
      ...
      qspGoto(st, 'sex_ev_boy_pillow_talk', 'bodycount_slut_responses');
    } else {
    ...
    qspGoto(s, 'sex_ev_boy_pillow_talk', 'bodycount_answers');
  }
  scene.build();
}
...
function enterBodycountSlut(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_indiscreet ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
    qspCall(s, 'fame', '$region', 'slut', 'medium');
  }
  if (((s as any).npc_bodycount_know ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
    if (((s as any).npc_bodycount_know ?? 0)?.[String((s as any).npcID ?? 0)] < 5) {
      scene.text(`"Wow. You've turned into a real slut, haven't you?" ${((s as any).npcdesc ?? '')} laughs. "You like having sex that much?"`);
    } else {
      if (((s as any).npc_bodycount_know ?? 0)?.[String((s as any).npcID ?? 0)] < 25) {
        scene.text(`"You've been slutting it up around town, huh?" ${((s as any).npcdesc ?? '')} laughs. "You like having sex that much?"`);
      } else {
        if (((s as any).npc_bodycount_know ?? 0)?.[String((s as any).npcID ?? 0)] < 30) {
          scene.text(`"You've turned yourself into a proper slut, I see," ${((s as any).npcdesc ?? '')} laughs. "You like having sex that much?"`);
        } else {
          scene.text(`"Still slutting it up around town, huh?" ${((s as any).npcdesc ?? '')} laughs. "You like having sex that much?"`);
        }
      }
    }
  } else {
...
function enterBodycountSlutResponses(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    if (((st as any).npc_rel_goal ?? 0)?.[String((st as any).npcID ?? 0)] === 'serious') {
      scene.text(`"So you aren't looking for anything more... serious?" ${((st as any).npcdesc ?? '')} asks.`);
      qspGoto(st, 'sex_ev_boy_pillow_talk', 'bodycount_serious');
    } else {
      scene.text(`"No complaints here as long as you keep fucking me," ${((st as any).npcdesc ?? '')} grins back.`);
    }
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ...
    if (((st as any).npc_caretaker ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
      qspCall(st, 'npc_relationship', 'modify', ((st as any).npcID ?? 0), 'like');
      scene.text(`"I know what you mean," ${((st as any).npcdesc ?? '')} smiles. "My partner cumming is important to my own experience too."`);
    } else {
    ...
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 5);
    scene.text(`"Well, it's not <i>just</i> about the sex," you say slowly. "Though I like that part too. The thing is, I like men." You smirk at ${((st as any).npcdesc ?? '')}. "I know what I want and I want what I like. So I'm going to do whatever I want and <i>who</i>ever I want. So I'll go out, meet a guy. Decide if I like him. Maybe fuck him, maybe not. If I enjoy his company I'll hang a round a while until I get bored. Find someone new to have fun with. If that makes me a slut, then so be it."`);
    if (((st as any).npc_rel_goal ?? 0)?.[String((st as any).npcID ?? 0)] === 'serious') {
      scene.text(`"So you aren't looking for anything more... serious?" ${((st as any).npcdesc ?? '')} asks.`);
      qspGoto(st, 'sex_ev_boy_pillow_talk', 'bodycount_serious');
    } else {
      if (((st as any).npc_rel_goal ?? 0)?.[String((st as any).npcID ?? 0)] === 'casual') {
        scene.text(`"I don't think it does," ${((st as any).npcdesc ?? '')} shakes his head. "People are allowed to have their fun.`);
        qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
      } else {
    ...
    if (((st as any).npc_rel_goal ?? 0)?.[String((st as any).npcID ?? 0)] === 'serious') {
      ...
      if (((st as any).npc_insecure ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
        qspCall(st, 'npc_relationship', 'modify', ((st as any).npcID ?? 0), 'dislike');
        scene.text(`"I don't know how I feel about that," ${((st as any).npcdesc ?? '')} frowns. "Kind of makes it feel like you're using me..."`);
      } else {
        scene.text(`"There's something really sexy about a woman who knows she's sexy," ${((st as any).npcdesc ?? '')} murmurs, running his hand along your thigh enticingly.`);
      }
    }
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ...
    if (((st as any).npc_humor ?? 0)?.[String((st as any).npcID ?? 0)] === 'intellectual') {
      qspCall(st, 'npc_relationship', 'modify', ((st as any).npcID ?? 0), 'like');
      scene.text(`"You've got a point," ${((st as any).npcdesc ?? '')} nods. "But I like that you're slut. It has... benefits..."`);
      scene.text(`${((st as any).npcdesc ?? '')} grins at you.`);
    } else {
      scene.text(`"Hey, I'm all for equal treatment long as it means I get to fuck girls like you," ${((st as any).npcdesc ?? '')} snickers.`);
    }
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ...
    if (((st as any).npc_rel_goal ?? 0)?.[String((st as any).npcID ?? 0)] === 'serious') {
      scene.text(`"So... it's basically a fetish?" ${((st as any).npcdesc ?? '')} asks.`);
      scene.text('"I guess?"');
      qspGoto(st, 'sex_ev_boy_pillow_talk', 'bodycount_serious');
    } else {
      scene.text(`"No complaints here as long as you keep fucking me," ${((st as any).npcdesc ?? '')} grins back.`);
...
function enterBodycountSerious(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 'laugh');
    qspCall(st, 'npc_relationship', 'modify', ((st as any).npcID ?? 0), 'love');
    scene.text(`"So you aren't looking for anything more... serious?" ${((st as any).npcdesc ?? '')} asks.`);
...
function enterHowManyFb(s: GameState, scene: SceneBuilder): void {
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['how_many_fb_talk'] = 1;
  qspCall(s, 'sex_ev_pillow_talk', 'talk_time_add');
  scene.img('images/shared/sex/after/pillow_talk1.jpg');
...
function enterBoyfriendAsk(s: GameState, scene: SceneBuilder): void {
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['boyfriend_ask'] = 1;
  qspCall(s, 'sex_ev_pillow_talk', 'pillow_picture1', 1);
  scene.text(`"So... You got a boyfriend?" ${((s as any).npcdesc ?? '')} asks.`);
  if (((s as any).stat ?? 0)?.['boyfriends_current'] === 0) {
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNoDatingReact1(s, scene); (s as any).locArgs = __savedLocArgs; }
    scene.actions([
      { label: 'No', handler: (st: GameState) => {
    scene.text('"No, I don\'t."');
    qspGoto(st, 'sex_ev_boy_pillow_talk', 'single_react1');
  } },
    ...
    qspGoto(st, 'sex_ev_boy_pillow_talk', 'cheating_react1');
  } },
    ...
    ((st as any).sex_ev = (st as any).sex_ev ?? {})['cheating_admission'] = 'guilty';
  ...
  if (((s as any).stat ?? 0)?.['boyfriends_current'] > 1) {
    ...
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 'mp4', 'pillow_talk1');
    scene.text('"Yeah," you say, eyes sparkling mischievously. "Several actually."');
    qspGoto(st, 'sex_ev_boy_pillow_talk', 'cheating_slut_react1');
  } },
    ]);
  }
  if (((s as any).stat ?? 0)?.['girlfriends_current'] > 0) {
    ...
    qspGoto(st, 'sex_ev_boy_pillow_talk', 'girlfriend_react1');
  } },
    ]);
  }
  scene.build();
...
function enterNoDatingReact1(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    scene.text('"How come?"');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDisposableMen1(st, scene); (st as any).locArgs = __savedLocArgs; }
    scene.actions([
...
function enterDisposableMen1(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 5);
    scene.text(`"Guys should be like tissue paper," you smirk devilishly at ${((st as any).npcdesc ?? '')}. "Strong, soft, and disposable."`);
    qspGoto(st, 'sex_ev_boy_pillow_talk', 'disposable_men2');
  } },
    { label: 'Guys should be like condoms (disposable)', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 5);
    scene.text(`"Guys should be like condoms," you smirk devilishly at ${((st as any).npcdesc ?? '')}. "Used intensely for one experience of pleasure and then thrown away."`);
    qspGoto(st, 'sex_ev_boy_pillow_talk', 'disposable_men2');
  } },
  ]);
  scene.build();
...
function enterCheatingReact1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_fidelity_label ?? 0)?.[String((s as any).npcID ?? 0)] === 'cheater'  &&  (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted'  ||  ((s as any).npc_womanizer ?? 0)?.[String((s as any).npcID ?? 0)] === 1)) {
    scene.text(((((s as any).age ?? 0) < 20) ? ('"Teen sluts are the best," he grins. ') : ('"I love young little sluts like you," he grins. ')) + '"Can always count on you to spread your legs whether you\'re taken or not."');
  } else {
  ...
  if (((s as any).npc_fidelity_label ?? 0)?.[String((s as any).npcID ?? 0)] === 'cheater') {
    scene.text(`${((s as any).npcdesc ?? '')} suddenly grins at you.`);
    scene.text('"<i>Hot.</i>"');
    if (((s as any).sex_ev ?? 0)?.['cheating_admission'] === 'guilty') {
    ...
    qspGoto(s, 'sex_ev_pillow_talk', 'cheating_break_ask');
  }
  scene.build();
}
...
function enterCheatingBreakAsk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['cheating_admission'] === 'guilty') {
    qspGoto(s, 'sex_ev_pillow_talk', 'cheating_break_ask_guilty');
  }
  scene.actions([
    ...
    if (((st as any).npc_fidelity ?? 0) === 'open') {
      { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCheatingOpenSuggestion(st, scene); (st as any).locArgs = __savedLocArgs; }
      scene.actions([
    ...
    scene.text(`"Your life, I guess," ${((st as any).npcdesc ?? '')} says, giving you a look.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ...
    scene.text(`"Glad I could help," ${((st as any).npcdesc ?? '')} says, looking amused.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ...
    scene.text('"Yup, pretty much," you reply flatly' + ((((st as any).sex_ev ?? 0)?.['smoke_time'] + 5 > ((st as any).totminut ?? 0)) ? (' taking another drag on your cigarette.') : ('.')));
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
      ]);
    } else {
      scene.text(`${((st as any).npcdesc ?? '')} says nothing, but gives you a look.`);
      qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
    }
  } },
    ...
    scene.text(`${((st as any).npcdesc ?? '')} gives you a look, though he has nothing to say in response.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
  ]);
  scene.build();
...
function enterCheatingBreakAskGuilty(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    { label: 'You <i>like</i> cheating', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 8);
...
function enterCheatingOpenSuggestion(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_girlfriend ?? 0) > 0) {
    scene.text(`"You ever try proposing an open relationship?" ${((s as any).npcdesc ?? '')} suggests. "It's what I do with my girlfriend. Fuck who you want, but without any of the guilt."`);
  } else {
    if (((s as any).npc_wife ?? 0) > 0) {
      scene.text(`"You ever try proposing an open relationship?" ${((s as any).npcdesc ?? '')} suggests. "It's what I do with my wife. Fuck who you want, but without any of the guilt."`);
    } else {
      scene.text(`"You ever try proposing an open relationship?" ${((s as any).npcdesc ?? '')} suggests. "I'm not dating anybody, but if it were me, I wouldn't mind so long as we established an open relationship."`);
    }
  }
  scene.build();
}
...
function enterCheatingSlutReact1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted'  ||  ((s as any).npc_womanizer ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    scene.text(`${((s as any).npcdesc ?? '')} blinks with momentary surprise.`);
  }
  scene.actions([
    ...
    if (((st as any).npc_humor ?? 0)?.[String((st as any).npcID ?? 0)] === 'perverted'  ||  ((st as any).npc_womanizer ?? 0)?.[String((st as any).npcID ?? 0)] === 1) {
...
function enterGirlfriendReact1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted'  ||  ((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'childish') {
    ((s as any).npc_know_bi = (s as any).npc_know_bi ?? {})[String((s as any).npcID ?? 0)] = 1;
...
function enterBoyFirstDateFuck(s: GameState, scene: SceneBuilder): void {
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['first_date_fuck_talk'] = 1;
  qspCall(s, 'sex_ev_pillow_talk', 'pillow_picture1');
  ...
  if (((s as any).sex_ev ?? 0)?.['deflowered'] === 0) {
    ...
    scene.text(`You stare into ${(((st as any).npc_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')}'s eyes and find him staring back.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ]);
  } },
    ...
    scene.text(`"Well, glad you felt like it," ${(((st as any).npc_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')} chuckles in return.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
      { label: 'Always', handler: (st: GameState) => {
    if (((st as any).npc_indiscreet ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
      qspCall(st, 'fame', 'sex', ((st as any).region ?? 0), 5);
      ((st as any).trait_vars = (st as any).trait_vars ?? {})['first_date_fucker_exp'] = ((st as any).trait_vars['first_date_fucker_exp'] ?? 0) + ((Math.floor(Math.random() * 5) + 1));
    }
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 4);
    scene.text('"Always," you grin back.');
    if (((st as any).npc_last_date_paid ?? 0)?.[String((st as any).npcID ?? 0)] === ((st as any).daystart ?? 0)) {
      scene.actions([
    ...
    if (((st as any).npc_romantic ?? 0)?.[String((st as any).npcID ?? 0)] > 0) {
      scene.text(`"Just sex?" ${((st as any).npcdesc ?? '')} looks surprised. "You didn't just let me in close, you let me <i>inside</i> you."`);
    } else {
      scene.text('stuff');
    }
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
...
function enterBoyLesbianAsk1(s: GameState, scene: SceneBuilder): void {
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['lesbian_ask'] = 1;
  qspCall(s, 'sex_ev_pillow_talk', 'pillow_picture1');
  if (((s as any).npc_know_bi ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    ...
    ((st as any).npc_know_bi = (st as any).npc_know_bi ?? {})[String((st as any).npcID ?? 0)] = 1;
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 5);
    scene.text(`"I was wondering... have you ever done it with another girl before?" ${(((st as any).npc_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')} asks with a goofy smirk on his face.`);
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBoyLesbianAsk2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
        ]);
      }
      scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterBoyLesbianAsk2(s, scene); (s as any).locArgs = __savedLocArgs; }
  }
  scene.build();
}
...
function enterBoyNerdySlutTalk1(s: GameState, scene: SceneBuilder): void {
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['boy_topics'] = ((s as any).sex_ev['boy_topics'] ?? 0) - (1);
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['boy_nerdy_slut_talk'] = 1;
  qspCall(s, 'sex_ev_pillow_talk', 'talk_time_add');
  qspCall(s, 'sex_ev_pillow_talk', 'pillow_picture1', 1);
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBoyNerdySlutTalk2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ...
    scene.text(`${(((st as any).npc_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')} listens to you as you tell him about some of the troubles growing up without your biological father.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
      ]);
    }
    ...
    if (((st as any).npc_humor ?? 0)?.[String((st as any).npcID ?? 0)] === 'perverted') {
      ...
      scene.text('"Yeah?" he asks inquisitively.');
      if (((st as any).mother ?? 0)?.['slava_fuck'] + ((st as any).mother ?? 0)?.['sergey_fuck'] + ((st as any).mother ?? 0)?.['misha_fuck'] > 0) {
        scene.actions([
    ...
    scene.text(`"Wow." ${(((st as any).npc_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')} blinks. "I guess that might cause some psychological damage."`);
    ...
    scene.text(`${(((st as any).npc_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')} listens to you as you rant about the hypocrisies and frustrations of Natasha ${((st as any).pcs_lastname ?? '')}.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
        ]);
      }
    ...
    scene.text(`${(((st as any).npc_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')} listens to you as you tell him about some of the troubles growing up as the daughter of Natasha ${((st as any).pcs_lastname ?? '')}.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
      ]);
    }
...
function enterBoyNoKids(s: GameState, scene: SceneBuilder): void {
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['boy_topics'] = ((s as any).sex_ev['boy_topics'] ?? 0) - (1);
  ((s as any).sex_ev = (s as any).sex_ev ?? {})['no_kids_talk'] = 1;
  qspCall(s, 'sex_ev_pillow_talk', 'talk_time_add');
  scene.img('images/shared/sex/after/pillow_talk1.jpg');
  scene.text(`"So you don't want kids?" ${((s as any).npcdesc ?? '')} asks, looking over at you.`);
  scene.actions([
    { label: 'Not right now', handler: (st: GameState) => {
    ...
    { label: 'Never', handler: (st: GameState) => {
    ((st as any).npc_know_no_kids = (st as any).npc_know_no_kids ?? {})[String((st as any).npcID ?? 0)] = 1;
    ...
    if (((st as any).npc_childfree ?? 0)?.[String((st as any).npcID ?? 0)] === 1) {
      ...
      scene.text(`"Don't you think you'd get lonely?" ${((st as any).npcdesc ?? '')} asks. "Knowing that you wouldn't have anything to live for except yourself when you get old?"`);
      scene.actions([
    ...
    scene.text(`${((st as any).npcdesc ?? '')} can tell you just sidestepped the question, but doesn't press the topic any further.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
      ]);
    }
...
function enterBunnyNickname1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_rel ?? 0)?.[String((s as any).npcID ?? 0)] >= 85) {
    qspCall(s, 'sex_ev_pillow_talk', 'pillow_picture1', 2);
    scene.text(`You catch ${((s as any).npcdesc ?? '')} watching you intently out of the corner of your eye. Turning to meet his gaze, you find yourself being drawn in by its intensity.`);
    scene.actions([
      { label: 'Get nervous', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 2);
    scene.text(`"What?" you ask, suddenly nervous. ${((st as any).npcdesc ?? '')} doesn't say anything for a moment and you can't help but squirm a little beneath his stare.`);
    scene.text('"I was just thinking how beautiful you are, <i>Zaychyk</i>."');
    scene.actions([
      { label: 'Did he just call me a \'bunny?\' ', goto: ['sex_ev_boy_pillow_talk', 'bunny_nickname2'] },
    ]);
  } },
      { label: 'Laugh', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 2);
    scene.text(`"What?" you ask, suddenly laughing at how weird he's being. ${((st as any).npcdesc ?? '')} doesn't say anything for a moment and you can't help but squirm a little beneath his stare.`);
    scene.text('"I was just thinking how beautiful you are, <i>Zaychyk</i>."');
    scene.actions([
      { label: 'Did he just call me a \'bunny?\' ', goto: ['sex_ev_boy_pillow_talk', 'bunny_nickname2'] },
    ]);
    ...
    if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted') {
      scene.text(`${((s as any).npcdesc ?? '')} catches your eye with a grin.`);
      scene.text('"You are the most perfect little <i>zaychyk</i> I\'ve ever met, you know that?"');
    } else {
      scene.text(`${((s as any).npcdesc ?? '')} catches your eye with a smile.`);
...
function enterBunnyNickname2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted') {
    ...
    if ((((st as any).npc_selfish ?? 0)?.[String((st as any).npcID ?? 0)] > 0  ||  ((st as any).npc_abusive ?? 0)?.[String((st as any).npcID ?? 0)] > 0  ||  ((st as any).npc_pushy ?? 0)?.[String((st as any).npcID ?? 0)] > 0)  &&  ((st as any).npc_caretaker ?? 0)?.[String((st as any).npcID ?? 0)] < 1) {
      ((st as any).npc_dislikepcspetname = (st as any).npc_dislikepcspetname ?? {})[String((st as any).npcID ?? 0)] = 1;
      qspCall(st, 'sex_ev_stats', 'petname_add', '<i>Zaychyk</i>');
      scene.text(`"But you're such a cute little ${(((st as any).pcs_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')}," he smirks, running his thumb along your cheek, causing you to jerk away from him.`);
    ...
    scene.text(`"You're the best, ${(((st as any).pcs_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')}," he lights up and moves to kiss you.`);
    scene.actions([
      { label: 'Let him', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 'kiss');
    scene.text(`You let ${((st as any).npcdesc ?? '')} have a quick peck on the lips.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ...
    scene.text(`${((st as any).npcdesc ?? '')} pecks you on the cheek anyways.`);
    ...
    qspCall(st, 'sex_ev_stats', 'petname_add', '<i>Zaychyk</i>');
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 'pillow_talk1', 'mp4');
    ...
    if (((st as any).npc_fav_body_part ?? 0)?.[String((st as any).npcID ?? 0)] === 'tits') {
      ...
      if (((st as any).npc_fav_body_part ?? 0)?.[String((st as any).npcID ?? 0)] === 'ass') {
        ...
        if (((st as any).npc_fav_body_part ?? 0)?.[String((st as any).npcID ?? 0)] === 'pussy') {
          ...
          if (((st as any).npc_fav_body_part ?? 0)?.[String((st as any).npcID ?? 0)] === 'thighs') {
            qspCall(st, 'arousal', 'foreplay', 2);
    ...
    qspCall(st, 'sex_ev_stats', 'petname_add', '<i>Zaychyk</i>');
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 'pillow_talk2', 'mp4');
    scene.text(`"Well, if the boot fits," you smirk wryly at ${((st as any).npcdesc ?? '')}. "I'd complain but it's hard to do that when you call me something so spot on."`);
    scene.text(`${((st as any).npcdesc ?? '')} grins back at you.`);
    qspGoto(st, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ]);
  } else {
    ...
    scene.text(`"Every day, ${(((st as any).pcs_usedname ?? 0)?.[String((st as any).npcID ?? 0)] ?? '')}," he grins back and moves to kiss you.`);
    scene.actions([
      { label: 'Let him', handler: (st: GameState) => {
    qspCall(st, 'sex_ev_pillow_talk', 'pillow_picture1', 'kiss');
    scene.text(`You let ${((st as any).npcdesc ?? '')} have a quick peck on the lips.`);

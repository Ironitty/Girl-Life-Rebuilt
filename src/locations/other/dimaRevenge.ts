...
function enterDimaRevengeEventCheck(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[0] ?? 0) === 3) {
    ...
    if (((s as any).grupTipe ?? 0) === 1) {
      // TODO-QSP: dynamic text: "<<$pcs_firstname>> thinks she's so great. What I wouldn't give to watch her fal...
      scene.text(`"${((s as any).pcs_firstname ?? 0)} thinks she's so great. What I wouldn't give to watch her fall."`);
    ...
    scene.text(`Lizaveta is the one to go to for all things gossip. You find her standing by a classroom door, looking inside. She is startled when you greet her. "Oh, you scared me, ${((s as any).pcs_nickname ?? 0)}."`);
    ...
    scene.actions([
      ...
      if (((s as any).grupTipe ?? 0) === 2) {
        ...
        scene.text(`"I heard ${((s as any).pcs_firstname ?? 0)} is on steroids."`);
        ...
        scene.text(`"Oh, ${((s as any).pcs_nickname ?? 0)}, I didn't know you were in here," says one of the girls, nervously. "Don't want to hear it," you tell her. "Just get lost before I change my mind."`);
    ...
    scene.text(`You see Ivan and Erast talking and decide to get them to take care of Dimka. You make your saddest face and walk by. They immediately notice you and your gloomy expression. Ivan speaks up first. "Hey, ${((s as any).pcs_nickname ?? 0)}, what's wrong?"`);
    ...
    scene.text(`"${((s as any).pcs_firstname ?? 0)} is a hopeless cumslut," Dimka tells the other boys. "I was just minding my own business at home and she starts knocking frantically on my door. When I answered, she got on her knees and begged for permission to blow me."`);
    ...
    scene.actions([
      { label: 'Continue', goto: ['gschool_lessons', 'short_break'] },
        ...
        if (((s as any).grupTipe ?? 0) === 3) {
          ...
          scene.text(`"So, did you hear about that nerd girl, ${((s as any).pcs_firstname ?? 0)}? They say she is secretly a slut who gives it up to all the nerds."`);
          ...
          if (((s as any).grupvalue ?? 0)[3] > 50) {
            (s as any).dimaRevChoice = 3;
            scene.actions([
    ...
    // TODO-QSP: dynamic text: After class you sit next to Gerasim and try to convince him to hack Dimka's comp...
    scene.text(`After class you sit next to Gerasim and try to convince him to hack Dimka's computer. "I wish I could help, ${((s as any).pcs_nickname ?? 0)}, but that isn't really something I know how to do. Have you tried asking Artem?"`);
    ...
    scene.text(`Without looking away from her screen she says, "You're lying, trying to be nice to me, so you must want something out of me, so what do you want, ${((s as any).pcs_nickname ?? 0)}?"`);
    ...
    scene.text(`You turn to face the door and see Dimka staring at you. "What are you up to, ${((s as any).pcs_nickname ?? 0)}?" he asks you as he slowly walks towards you.`);
    ...
    qspCall(s, 'npc_relationship', 'modify', 'A1', (-10));
    ...
    scene.actions([
      { label: 'Continue', goto: ['gschool_lessons', 'short_break'] },
          ...
          if (((s as any).grupTipe ?? 0) === 4) {
            ...
            scene.text(`"You know that ${((s as any).pcs_firstname ?? 0)} girl who is always hanging out with the gopniks. Well, I heard she has to suck them off everyday to be allowed to hang out with them."`);
    ...
    scene.text(`"Of course she was," answers Lera. "${((s as any).pcs_nickname ?? 0)} loves it when we play with her, don't you, ${((s as any).pcs_nickname ?? 0)}?"`);
    ...
    if (((s as any).pcs_stren ?? 0) > 80) {
      ...
      scene.text(`He falls to the ground, unconscious. Lena and Lera look at you with surprised looks on their faces. "Damn, ${((s as any).pcs_nickname ?? 0)}! You knocked him out! How are you so strong?"`);
    ...
    scene.actions([
      { label: 'Continue', goto: ['gschool_lessons', 'short_break'] },
            ...
            (s as any).dimaTrain = 0;
            // TODO-QSP: dynamic text: "I heard that weird girl, <<$pcs_firstname>>, lets boys do what ever they want t...
            scene.text(`"I heard that weird girl, ${((s as any).pcs_firstname ?? 0)}, lets boys do what ever they want to her no matter how degrading. She has no self respect."`);
    ...
    scene.text(`Miss. Volkov looks at you. "Hitting girls is not an appropriate behaviour miss ${((s as any).pcs_lastname ?? 0)} it's better you think on what you have done"`);
    ...
    // TODO-QSP: dynamic text: "Hey there, <<$pcs_nickname>>," he says while looking at your breasts, "You're l...
    scene.text(`"Hey there, ${((s as any).pcs_nickname ?? 0)}," he says while looking at your breasts, "You're looking nice today."`);
    // TODO-QSP: dynamic text: Uggh. He just creeps you out so much. "It's <<$pcs_firstname>>," you tell him, n...
    scene.text(`Uggh. He just creeps you out so much. "It's ${((s as any).pcs_firstname ?? 0)}," you tell him, not even trying to hide the contempt in your voice, "or better yet, don't talk to me at all.`);
    ...
    scene.text(`You are upset to hear this, but you remember how understanding he was when you went to him for help before and can't be too mad at him now. Before you can say anything, he says, "I'll fix this, ${((s as any).pcs_nickname ?? 0)}."`);
  ...
  if (((s as any).dimaRevChoice ?? 0) === 1) {
    if (((s as any).locArgs?.[0] ?? 0) === 4) {
      ...
      scene.text(`"I heard ${((s as any).pcs_firstname ?? 0)} gave Lesco a blowjob just because he told her she's pretty. She is so self conscious that she'll have sex with anyone if they tell her she's pretty." You turn red. None of that is true! Not a bit! So that's how it's going to be. You change your mind and go for Lizaveta.`);
      scene.actions([
    ...
    if (((s as any).locArgs?.[0] ?? 0) === 5) {
      if (((s as any).locArgs?.[1] ?? 0) === 'before') {
        qspCall(s, 'fame', 'pav', 'sex', 60);
        ...
        scene.text(`"I heard ${((s as any).pcs_firstname ?? 0)} gets passed around by everyone in her apartment building." The rumors only get worse. You head to class.`);
        scene.actions([
          { label: 'Continue', goto: ['gschool_lessons', 'short_break'] },
        ]);
      }
      if (((s as any).locArgs?.[1] ?? 0) === 'lunch') {
        (s as any).dimaRevenge = ((s as any).dimaRevenge ?? 0) + (1);
    ...
    if (((s as any).locArgs?.[0] ?? 0) === 6) {
      if (((s as any).locArgs?.[1] ?? 0) === 'before') {
        qspCall(s, 'fame', 'pav', 'sex', (-60));
        if (!(s as any).grupvalue) (s as any).grupvalue = {}; (s as any).grupvalue[1] = ((s as any).grupvalue[1] ?? 0) - (15);
      ...
      if (((s as any).locArgs?.[1] ?? 0) === 'lunch') {
        ...
        scene.text(`Soon the two of you get into an argument, which turns into a screaming match. You are both screaming at the top of your lungs when the principal comes to break things up. "Miss ${((s as any).pcs_lastname ?? 0)}, Mr. Nosov, in my office now!"`);
        scene.actions([
  ...
  if (((s as any).dimaRevChoice ?? 0) === 2) {
    if (((s as any).fedorKozlovQW ?? 0) >= 0) {
      if (!(s as any).dimaRevenge) (s as any).dimaRevenge = {}; (s as any).dimaRevenge['Fedor Involved'] = ' and Fedor ';
    } else {
      if (!(s as any).dimaRevenge) (s as any).dimaRevenge = {}; (s as any).dimaRevenge['Fedor Involved'] = ' ';
    }
    if (((s as any).fedorKozlovQW ?? 0) >= 0) {
      if (!(s as any).dimaRevenge) (s as any).dimaRevenge = {}; (s as any).dimaRevenge['Fedor Involved 2'] = 'Fedor';
    } else {
      if (!(s as any).dimaRevenge) (s as any).dimaRevenge = {}; (s as any).dimaRevenge['Fedor Involved 2'] = 'Svyatoslav';
    }
    if (((s as any).locArgs?.[0] ?? 0) === 4) {
      if (((s as any).locArgs?.[1] ?? 0) === 'day4jockbefore') {
        qspCall(s, 'fame', 'pav', 'sex', 60);
    ...
    // TODO-QSP: dynamic text: "Because I'm not a fucking idiot. Dimka spread those rumors because <<$pcs_first...
    scene.text(`"Because I'm not a fucking idiot. Dimka spread those rumors because ${((s as any).pcs_firstname ?? 0)} here had him beat up for spreading shit about her." You sink in your seat. She is very perceptive.`);
    ...
    if (((s as any).locArgs?.[0] ?? 0) === 5) {
      if (((s as any).locArgs?.[1] ?? 0) === 'day5jockbefore') {
        (s as any).dimaRevenge = ((s as any).dimaRevenge ?? 0) + (1);
        qspCall(s, 'fame', 'pav', 'sex', (-60));
      ...
      if (((s as any).locArgs?.[1] ?? 0) === 'day5jockafter') {
        (s as any).dimaRevenge = ((s as any).dimaRevenge ?? 0) + (1);
  ...
  if (((s as any).dimaRevChoice ?? 0) === 3) {
    if (((s as any).locArgs?.[0] ?? 0) === 4) {
      ...
      // TODO-QSP: dynamic text: "Hey <<$pcs_nickname>>. I don't know how you did it but Zin agreed to go on a da...
      scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}. I don't know how you did it but Zin agreed to go on a date with me."`);
  ...
  if (((s as any).dimaRevChoice ?? 0) === 4) {
    if (((s as any).locArgs?.[0] ?? 0) === 4) {
      ...
      scene.text(`As you head to your locker you hear kids talking about you behind your back. "I heard ${((s as any).pcs_firstname ?? 0)} plays bitch to Lena and Lera."`);
    ...
    scene.actions([
      ...
      if (((s as any).locArgs?.[1] ?? 0) === 'after') {
        ...
        scene.text(`"I heard ${((s as any).pcs_firstname ?? 0)} gave Lavrenti a blowjob in the boy's locker room."`);
    ...
    // TODO-QSP: dynamic text: Alyona checks to make sure he's breathing and, more importantly, to see what's i...
    ...
    if (((s as any).locArgs?.[0] ?? 0) === 6) {
      if (((s as any).dimaDisco ?? 0) === 1) {
        ...
        // TODO-QSP: dynamic text: "Bottles of Zhiguljovskoje. <<$func('money', 'string_profit', 10000)>> buys fort...
  ...
  if (((s as any).dimaRevChoice ?? 0) === 5) {
    ...
    // TODO-QSP: dynamic text: "Fine, but from now on it's <<$func('money', 'string_profit', 4000)>>. Non negot...
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'npc_relationship', 'modify', 'A159', (-20));
    ...
    // TODO-QSP: dynamic text: "You fucking pig!!" you scream as you punch and kick Petia until he can't take a...
    ...
    dynamicGoto(st, 'loc', 'loc_arg');
        ...
        if (((s as any).locArgs?.[1] ?? 0) === 'afterlunch') {
          if (!(s as any).grupvalue) (s as any).grupvalue = {}; (s as any).grupvalue[4] = ((s as any).grupvalue[4] ?? 0) + (5);
          (s as any).dimaRevenge = ((s as any).dimaRevenge ?? 0) + (1);
          scene.text('<center><b>School Hallway</b></center>');
          scene.img('images/locations/pavlovsk/school/lunch/hall.jpg');
    ...
    (s as any).demerit = ((s as any).demerit ?? 0) + (40);
    scene.img('images/characters/shared/headshots_main/big134.jpg');
    // TODO-QSP: dynamic text: Miss. Volkov looks at you. "I don't know what's on your mind miss <<$pcs_lastnam...
    scene.text(`Miss. Volkov looks at you. "I don't know what's on your mind miss ${((s as any).pcs_lastname ?? 0)} but what have you done will have serious consequences… now go"`);
    scene.actions([
  ...
  if (((s as any).dimaRevChoice ?? 0) === 6) {
    if (((s as any).locArgs?.[0] ?? 0) === 4) {
      ...
      scene.text('<center><b>School Hallway</b></center>');
      scene.img(`images/locations/pavlovsk/school/building/gschool_hall0${Math.floor(Math.random() * 3) + 0}.jpg`);
      // TODO-QSP: dynamic text: You see Artem in the hall talking with Ivan. When you greet him he says "Don't w...
      scene.text(`You see Artem in the hall talking with Ivan. When you greet him he says "Don't worry, ${((s as any).pcs_nickname ?? 0)}. I have a plan. I can't talk about it now, though." Saying that he rushes off. What is he up to?`);
      scene.actions([
        { label: 'Continue', goto: ['gschool_lessons', 'short_break'] },
      ]);
    }
    ...
    // TODO-QSP: dynamic text: "Come out, <<$pcs_nickname>>. You can't stay in there forever." It's Dimka, that...
    scene.text(`"Come out, ${((s as any).pcs_nickname ?? 0)}. You can't stay in there forever." It's Dimka, that fucking asshole.`);
    ...
    // TODO-QSP: dynamic text: "I can't believe Dimka said all those awful things about <<$pcs_firstname>> just...
    scene.text(`"I can't believe Dimka said all those awful things about ${((s as any).pcs_firstname ?? 0)} just because she broke up with him. What a creep. I can't believe everyone bought his lies."`);
    // TODO-QSP: dynamic text: "I know, right. Their is something seriously wrong with that guy. Why else would...
    scene.text(`"I know, right. Their is something seriously wrong with that guy. Why else would ${((s as any).pcs_firstname ?? 0)} leave the most popular boy in school for a geek like Artem."`);
    ...
    qspCall(s, 'arousal', 'striptease', 15);
    qspCall(s, 'stat', '');
    ...
    qspCall(s, 'arousal', 'vaginal', 25, 'no_orgasm_msg');

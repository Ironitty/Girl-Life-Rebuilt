...
function enterAlbina1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Who the fuck are you? Oh, right. ${((s as any).pcs_firstname || '')}. So you've taken up dancing, have you?" You nod, confirming the obvious, but she just laughs dismissively. "Well, how's that going for you?"`);
...
function enterAlbina2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Oh hello ${((s as any).pcs_nickname || '')}. I didn't know you started dancing. Are you any good?" she asks with interest.`);
...
function enterAlbina3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}!! Please tell me you don't practice with those bow-legged cows who call themselves dancers?" she asks with a smirk.`);
  ...
  if (((s as any).pregtime ?? 0) >= 90) {
    ...
    if (((s as any).pcs_hotcat ?? 0) < 6) {
      ...
      if (((s as any).stat ?? 0)?.['think_virgin'] === 1  &&  ((s as any).stat ?? 0)?.['vaginal'] === 0) {
        ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['starlets_virgin'] = 1;
        scene.text('"Well? Am I good enough to join?" you ask.');
...
function enterAlbina5(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pregtime ?? 0) >= 90) {
    ...
    scene.text(`"Your turn now ${((s as any).pcs_nickname || '')}. Show me that you're as passionate as I am and we might come to an agreement…" she says as she sits down to catch her breath.`);
    scene.actions([
    ...
    scene.text(`"I had no doubts about you ${((s as any).pcs_nickname || '')}, but the others wanted to see you in action first. They didn't believe me when I said you were <i>almost</i> as good as me."`);
    scene.actions([
  ...
  if (((s as any).AlbinaQW ?? 0)?.['ShowTriggerCount'] >= 6) {
    ...
    if (((s as any).pcs_hotcat ?? 0) >= 6  &&  ((s as any).AlbinaQW ?? 0)?.['starlets_virgin'] === 0) {
      if (((s as any).pcs_hotcat ?? 0) < 8) {
        ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletCustomer'] = Math.floor(Math.random() * 16) + 1;
      } else {
        if (((s as any).pcs_hotcat ?? 0) < 9) {
          ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletCustomer'] = Math.floor(Math.random() * 13) + 1;
        } else {
          ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletCustomer'] = Math.floor(Math.random() * 11) + 1;
        }
      }
      if (((s as any).AlbinaQW ?? 0)?.['StarletCustomer'] === 1) {
        ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletsCustomerCount'] = 1;
        ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletPay'] = Math.floor(Math.random() * 4) + 3;
        ...
        if (((s as any).AlbinaQW ?? 0)?.['StarletCustomer'] === 2) {
          ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletsCustomerCount'] = 2;
          ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletPay'] = Math.floor(Math.random() * 4) + 6;
              ...
              if (((s as any).AlbinaQW ?? 0)?.['StarletCustomer'] === 5) {
                ...
                if (((s as any).AlbinaQW ?? 0)?.['StarletCustomer'] === 6) {
                  ...
                  if (((s as any).AlbinaQW ?? 0)?.['StarletCustomer'] === 7) {
                    ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletCustomerCount'] = 12;
                    ...
                    if (((s as any).AlbinaQW ?? 0)?.['StarletCustomer'] === 8) {
                      ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletCustomerCount'] = 1;
                      ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletPay'] = Math.floor(Math.random() * 4) + 3;
      ...
      if (((s as any).AlbinaQW ?? 0)?.['StarletCustomer'] <= 9) {
        ...
        scene.text(`Albina walks up to you. "${((s as any).pcs_nickname || '')}, we… We need to… to talk…" she quietly stammers.`);
        scene.actions([
    ...
    if (((s as any).AlbinaQW ?? 0)?.['StarletsCustomerCount'] === 1) {
      ...
      scene.text(`Albina avoids eye contact. "Nothing, it's just… If you go with this person and be… 'affectionate'," she says hesitantly, "you'll get ${qspFunc(s, 'money', 'string_profit', (((s as any).AlbinaQW ?? {})?.['StarletPay'] ?? 0)*1000, 1)}."`);
      // TODO-QSP: dynamic text: She looks you in the eye, the fear within her apparently growing. "Please <<$pcs...
      scene.text(`She looks you in the eye, the fear within her apparently growing. "Please ${((s as any).pcs_nickname || '')}, I need you to do this for me. Just… please."`);
    } else {
      // TODO-QSP: dynamic text: Albina avoids eye contact. "Nothing, it's just… See those guys?" she asks hesita...
      scene.text(`Albina avoids eye contact. "Nothing, it's just… See those guys?" she asks hesitantly. "If you go with them and be…'affectionate', you'll get ${qspFunc(s, 'money', 'string_profit', (((s as any).AlbinaQW ?? {})?.['StarletPay'] ?? 0)*1000, 1)}."`);
      // TODO-QSP: dynamic text: She looks you in the eye, the fear within her apparently growing. "Please <<$pcs...
      scene.text(`She looks you in the eye, the fear within her apparently growing. "Please ${((s as any).pcs_nickname || '')}, I need you to do this for me. Just… please."`);
    }
    ...
    ((s as any).AlbinaQW = (s as any).AlbinaQW ?? {})['StarletsWhore'] = ((s as any).AlbinaQW['StarletsWhore'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    ...
    if (((s as any).AlbinaQW ?? 0)?.['StarletCustomer'] === 1) {
      ...
      if (((s as any).AlbinaQW ?? 0)?.['StarletCustomer'] === 2) {
        ...
        qspGoto(s, 'albina_starlets', 'after_show');
      }
    } else {
      qspGoto(s, 'albina_starlets', 'after_show');
    }

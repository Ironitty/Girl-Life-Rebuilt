...
function enterMansionAdventureStart(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'npc_relationship', 'modify', 'A142', 'dislike');
    qspCall(st, 'stat', '');
    scene.img('images/locations/pavlovsk/community/library/events/nerd_game/playing.jpg');
...
function enterMansionInterior3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(((((s as any).nerd_game ?? 0)?.['lust_curse'] === 1) ? ('"' + ((s as any).pcs_nickname ?? '') + '\'s rogue') : ('"Julia\'s cleric')) + ' suddenly hears the strange voice compelling her to follow the sound of the voice until she finds what she seeks," Feofan explains.');
  ...
  scene.actions([
    ...
    qspCall(st, 'nerd_game_night', 'set_end_acts');
  } },
    ]);
  } },
      ]);
...
function enterSuccubusFight1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).nerd_game ?? 0)?.['lust_curse'] === 1) {
    ...
    ((st as any).nerd_game = (st as any).nerd_game ?? {})['succubus_dead'] = 1;
    qspCall(st, 'stat', '');
    scene.img('images/locations/pavlovsk/community/library/events/nerd_game/playing.jpg');
...
function enterCursedVillage1a(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).nerd_game = (st as any).nerd_game ?? {})['group_forge_gear'] = 1;
    scene.img('images/locations/pavlovsk/community/library/events/nerd_game/playing.jpg');
    ...
    ((st as any).nerd_game = (st as any).nerd_game ?? {})['sveta_modest_armor'] = 1;
    scene.img('images/locations/pavlovsk/community/library/events/nerd_game/playing.jpg');
    ...
    ((st as any).nerd_game = (st as any).nerd_game ?? {})['sveta_skimpy_armor'] = 1;
    scene.img('images/locations/pavlovsk/community/library/events/nerd_game/playing.jpg');

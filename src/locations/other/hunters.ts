...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hunterVars ?? 0)?.['were_met'] === 0) {
    ...
    if (((st as any).GadBoy ?? 0)?.['river_gang'] <= 0) {
      ...
      scene.text(`"Could your surname be ${((st as any).pcs_lastname ?? '')}?" he asked. You look at him nodding.`);
      // TODO-QSP: dynamic text: "Don''t act surprised <<$pcs_nickname>>, you look a lot like your mother when sh...
      scene.text(`"Don't act surprised ${((st as any).pcs_nickname ?? '')}, you look a lot like your mother when she was younger. I… Hmmm… that's good to know, I'm also from Gadukino." said Andrei.`);
      scene.text('"Don\'t be shy, have a seat, we won\'t hurt you." said Sergei, freeing up some space for you to sit on.');
    } else {
      // TODO-QSP: dynamic text: "Well well, look what the cat dragged in. If it isn''t <<$pcs_nickname>> <<$pcs_...
      scene.text(`"Well well, look what the cat dragged in. If it isn't ${((st as any).pcs_nickname ?? '')} ${((st as any).pcs_lastname ?? '')}, the local slut." said Andrei.`);
      ...
      ((st as any).hunterVars = (st as any).hunterVars ?? {})['KnowSlut'] = 1;
      ((st as any).hunterVars = (st as any).hunterVars ?? {})['Rape'] = 1;
    }
    ((st as any).npc_usedname = (st as any).npc_usedname ?? {})['A172'] = 'Andrei';
    ((st as any).npc_usedname = (st as any).npc_usedname ?? {})['A173'] = 'Igor';
    ((st as any).npc_usedname = (st as any).npc_usedname ?? {})['A174'] = 'Sergei';
    scene.actions([
    ...
    qspCall(st, 'boyStat', 'A172', '1');
    qspCall(st, 'boyStat', 'A173', '2');
    qspCall(st, 'boyStat', 'A174', '3');
    ...
    scene.text(`"We know you find us irresistible ${((st as any).pcs_nickname ?? '')}." Andrei said smiling.`);
    ...
    (st as any).huntsexb = (Math.floor(Math.random() * 3) + 1);
    (st as any).huntslutsex = ((st as any).huntslutsex ?? 0) + ((Math.floor(Math.random() * 4) + 9));
    ...
    qspCall(st, 'arousal', 'foreplay', 1, 'sub', 'gangbang');
    qspCall(st, 'stat', '');
    ...
    if (((st as any).huntsexa ?? 0) === 3  &&  ((st as any).huntsexb ?? 0) === 1) {
      scene.actions([
        { label: 'Suck', goto: ['hunters', 'huntersgroupORALsi'] },
      ]);
    }
    if (((st as any).huntsexa ?? 0) === 3  &&  ((st as any).huntsexb ?? 0) === 2) {
      scene.actions([
        { label: 'Suck', goto: ['hunters', 'huntersgroupORALai'] },
      ]);
    }
    if (((st as any).huntsexa ?? 0) === 3  &&  ((st as any).huntsexb ?? 0) === 3) {
      scene.actions([
        { label: 'Suck', goto: ['hunters', 'huntersgroupORALas'] },
      ]);
    }
  } },
    ]);
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    (st as any).shootingday = ((st as any).daystart ?? 0);
    qspCall(st, 'stat', '');
    ...
    scene.text(`"You're a girl, why would you want to learn something like that ${((st as any).pcs_nickname ?? '')}?" Andrei said smiling. "You should pursue sewing or maybe a girly sport instead. Shooting is for boys."`);
    scene.text('"Pretty please." you look at them while making puppy eyes.');
    if (((st as any).pcs_apprnc ?? 0) >= 60) {
      (st as any).shooting = 1;
      if (((st as any).hunterVars ?? 0)?.['AndreiQw'] < 20) {
        ((st as any).hunterVars = (st as any).hunterVars ?? {})['AndreiQw'] = ((st as any).hunterVars['AndreiQw'] ?? 0) + (1);
      }
      if (((st as any).hunterVars ?? 0)?.['IgorQW'] < 20) {
        ((st as any).hunterVars = (st as any).hunterVars ?? {})['IgorQW'] = ((st as any).hunterVars['IgorQW'] ?? 0) + (1);
      }
      if (((st as any).hunterVars ?? 0)?.['SergeiQw'] < 20) {
        ((st as any).hunterVars = (st as any).hunterVars ?? {})['SergeiQw'] = ((st as any).hunterVars['SergeiQw'] ?? 0) + (1);
      }
      // TODO-QSP: dynamic text: "Okay <<$pcs_nickname>>, we give up", they say smiling. "You''ve persuaded us, w...
      scene.text(`"Okay ${((st as any).pcs_nickname ?? '')}, we give up", they say smiling. "You've persuaded us, we'll teach you how to shoot…`);
    } else {
      ((st as any).hunterVars = (st as any).hunterVars ?? {})['AndreiQw'] = ((st as any).hunterVars['AndreiQw'] ?? 0) - (1);
      ((st as any).hunterVars = (st as any).hunterVars ?? {})['IgorQW'] = ((st as any).hunterVars['IgorQW'] ?? 0) - (1);
      ((st as any).hunterVars = (st as any).hunterVars ?? {})['SergeiQw'] = ((st as any).hunterVars['SergeiQw'] ?? 0) - (1);
      // TODO-QSP: dynamic text: "No, <<$pcs_nickname>>, that will not work." they answer. "And don''t assume tha...
      scene.text(`"No, ${((st as any).pcs_nickname ?? '')}, that will not work." they answer. "And don't assume that those puppy eyes will work on us.`);
    ...
    (st as any).fingal = ((st as any).fingal ?? 0) + ((Math.floor(Math.random() * 3) + 1));
    ...
    if ((!((st as any).fingal ?? 0))) {
      ...
      if (((st as any).shooting ?? 0) === 1) {
        (st as any).shooting = 2;
        // TODO-QSP: dynamic text: "Okay, <<$pcs_nickname>>, just don''t end up like the first time," Andrei said j...
        scene.text(`"Okay, ${((st as any).pcs_nickname ?? '')}, just don't end up like the first time," Andrei said jokingly.`);
      } else {
        if (((st as any).pcs_shoot ?? 0) <= 10) {
          // TODO-QSP: dynamic text: "Sure, <<$pcs_nickname>>, just be careful." Andrei said smiling.
          scene.text(`"Sure, ${((st as any).pcs_nickname ?? '')}, just be careful." Andrei said smiling.`);
        } else {
          // TODO-QSP: dynamic text: "Here, <<$pcs_nickname>>, just don''t shoot too much, the bullets are expensive....
          scene.text(`"Here, ${((st as any).pcs_nickname ?? '')}, just don't shoot too much, the bullets are expensive." Andrei said smiling.`);
        }
      }
      if (((st as any).pcs_shoot ?? 0) >= 1  &&  ((st as any).pcs_shoot ?? 0) <= 10) {
        scene.actions([
          { label: 'Go shooting (1:00)', handler: (st: GameState) => {
    if ((((st as any).pcs_stren ?? 0) + ((st as any).pcs_shoot ?? 0) > 20)  ||  (((st as any).pcs_stren ?? 0) + ((st as any).pcs_shoot ?? 0) < 20  &&  (Math.floor(Math.random() * 2) + 1) === 1)) {
      ...
      scene.text(`"${((st as any).pcs_nickname ?? '')}, are you still alive?" Igor asked you with some concern in his voice.`);
      ...
      scene.actions([
        { label: 'Further', goto: ['gad_swamp_yard', 'start'] },
          ...
          if ((!((s as any).huntslutsex ?? 0))) {
            ...
            scene.text(`"${((s as any).pcs_nickname ?? '')}, come closer," replied Andrei. "If you want to shoot you need to repay us somehow."`);
            scene.actions([
            ...
            scene.text(`"Don't you worry ${((s as any).pcs_nickname ?? '')}, you have other talents that are more needed." Andrei replied.`);
    ...
    (st as any).minut = ((st as any).minut ?? 0) + (0);
    qspCall(st, 'mood', 'raise', (Math.floor(Math.random() * 11) + 10));
    ...
    qspCall(st, 'stat', '');
    if (((st as any).PCloSkirt ?? 0) > 0  &&  ((st as any).pantyworntype ?? 0) === 'none') {
    ...
    scene.actions([
      ...
      if (((s as any).hunterVars ?? 0)?.['evening'] === 0) {
        scene.actions([
          { label: 'Talk to Andrei', goto: ['andreihunter', ''] },
        ]);
      }
      scene.actions([
  ...
  if (((s as any).hunterVars ?? 0)?.['Rape'] === 3) {
    ...
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['Rape'] = 5;
    qspCall(st, 'stat', '');
    scene.img('images/locations/gadukino/sex/hunter/hantersgroupundress.jpg');
    ...
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
    (st as any).dirty_dickA = 0;
    (st as any).dirty_dickB = 0;
    (st as any).dirty_dickC = 0;
    (st as any).huntsexa = (Math.floor(Math.random() * 3) + 1);
    (st as any).huntsexb = (Math.floor(Math.random() * 3) + 1);
    (st as any).huntslutsex = ((st as any).huntslutsex ?? 0) + ((Math.floor(Math.random() * 4) + 9));
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['sexnude'] = 1;
    qspCall(st, 'stat', '');
    scene.img('images/locations/gadukino/sex/hunter/hantersgrouptanga.jpg');
    ...
    qspCall(st, 'arousal', 'foreplay', 2, 'sub', 'gangbang');
    qspCall(st, 'stat', '');
    if (((st as any).huntsexa ?? 0) < 3) {
      scene.actions([
        { label: 'Suck', goto: ['hunters', 'huntersgroupORALasi'] },
    ...
    scene.text(`"${((st as any).pcs_nickname ?? '')}, don't fuck around with us. Deep inside you know you need to repay us." said Andrei, grabbing you by the hair.`);
    scene.actions([
      { label: 'Agree', handler: (st: GameState) => {
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).stat = (st as any).stat ?? {})['gangbang_count'] = ((st as any).stat['gangbang_count'] ?? 0) + (1);
    ...
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['Rape'] = 4;
    qspCall(st, 'stat', '');
    ...
    scene.text(`"Now that we're past the foreplay ${((st as any).pcs_nickname ?? '')}, let's have some real fun," said Andrei.`);
    scene.actions([
      { label: 'Suck', goto: ['hunters', 'huntersgroupORALasi'] },
    ]);
  } },
  ...
  if (((s as any).huntdanceslut ?? 0) === 2) {
    ...
    qspCall(st, 'arousal', 'bj', 15, 'sub', 'gangbang');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    if ((((st as any).clothingworntype ?? 0) !== 'nude'  &&  ((st as any).PSwim ?? 0) === 0)) {
    ...
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['KnowSlut'] = 2;
    (st as any).huntslutsex = ((st as any).huntslutsex ?? 0) + ((Math.floor(Math.random() * 4) + 9));
    qspCall(st, 'stat', '');
    ...
    scene.text(`"Not bad, ${((st as any).pcs_nickname ?? '')}," you hear Andrei saying. "Now we know that you are really good at this."`);
    // TODO-QSP: dynamic text: "We''ll be seeing you again, <<$pcs_nickname>>. And don''t worry, you should be ...
    scene.text(`"We'll be seeing you again, ${((st as any).pcs_nickname ?? '')}. And don't worry, you should be proud of how good you are at pleasuring men."`);
  ...
  if (((s as any).huntdanceslut ?? 0) === 3) {
    ...
    qspCall(st, 'arousal', 'bj', 5, 'sub', 'gangbang', 'rough', 'deepthroat');
    qspCall(st, 'boyStat', 'A172');
  ...
  if (((s as any).hunterVars ?? 0)?.['sexnude'] === 1  ||  ((s as any).hunterVars ?? 0)?.['forest_sex'] === 3  ||  ((s as any).forest_gopsex ?? 0) === 3) {
    ...
    if (((s as any).hunterVars ?? 0)?.['sexnude'] === 1  ||  ((s as any).hunterVars ?? 0)?.['forest_sex'] === 3) {
      ...
      scene.text(`<center><img ${((s as any).set_imgh ?? '')} src="images/locations/gadukino/hunters/hanters1.jpg"></center>`);
    }
    if (((s as any).forest_gopsex ?? 0) === 3) {
      // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/locations/gadukino/forest/3boys.1.jpg"></...
      scene.text(`<center><img ${((s as any).set_imgh ?? '')} src="images/locations/gadukino/forest/3boys.1.jpg"></center>`);
    }
    if (((s as any).hunterVars ?? 0)?.['sexnude'] === 1  ||  ((s as any).hunterVars ?? 0)?.['forest_sex'] === 3) {
    ...
    scene.text(`"You know what to do ${((s as any).pcs_nickname ?? '')}," said one of the men smiling. "Come here, show us how much you want it."`);
  ...
  if (((s as any).slutgosex ?? 0) === 1  ||  ((s as any).hunterVars ?? 0)?.['forest_sex'] === 1  ||  ((s as any).forest_gopsex ?? 0) === 1) {
    ...
    scene.text(`${((s as any).boydesc ?? '')} takes you by the hand and leads you to a clearing next to some trees. He immediately begins to undress you.`);
    // TODO-QSP: dynamic text: "You know why I''ve brought you here <<$pcs_nickname>>," said the guy smiling.
    scene.text(`"You know why I've brought you here ${((s as any).pcs_nickname ?? '')}," said the guy smiling.`);
...
function enterHuntersgroupORALsi(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: You hear <<$boydesc>> groaning more intensely, indicating he''s ready to cum. Yo...
  scene.text(`You hear ${((s as any).boydesc ?? '')} groaning more intensely, indicating he's ready to cum. You look up at him, smiling with your eyes and speed up you head motion. You keep on pleasuring him until he finishes on your face. He walks away, blissfuly smiling.`);
...
function enterHuntersgroupORALs(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You hear ${((s as any).boydesc ?? '')} groaning more intensely, indicating they're ready to cum. You look at them, smiling with your eyes and speed up you head motion. You keep on pleasuring them until they finish on your face. They walks away, blissfuly smiling.`);
  qspCall(s, 'stat', '');
...
function enterHuntersgroupORALs1end(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} finishes in your mouth and walks away with a satisfied smiles on their faces, leaving you alone sitting on the blanket…`);
  qspCall(s, 'cum_call', 'mouth_swallow', ((s as any).boy ?? 0), 1);
...
function enterHuntersgroupORALi1end(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'cum_call', 'mouth_swallow', ((s as any).boy ?? 0), 1);
  qspCall(s, 'arousal', 'bj', 2, 'sub');
  // TODO-QSP: dynamic text: You lick <<$boydesc>>''s penis head until he finishes and walks away satisfied. ...
  scene.text(`You lick ${((s as any).boydesc ?? '')}'s penis head until he finishes and walks away satisfied. He leaves you sitting alone on the blanket…`);
  qspCall(s, 'arousal', 'end');
  ...
  if (((s as any).hunterVars ?? 0)?.['forest_sex'] > 0) {
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['forest_sex'] = 0;
    (st as any).minut = ((st as any).minut ?? 0) + 60;
...
function enterHuntersgroupORALi(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} cums in your mouth and walks away with a satisfied smile on their faces.`);
...
function enterHuntersgroupORALend1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hunterVars ?? 0)?.['forest_sex'] === 0) {
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['sexnude'] = 0;
...
function enterHuntersgroupORALai(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} finish and walk away with a blissful smile on their face.`);
  qspCall(s, 'arousal', 'bj', 2, 'sub', 'gangbang');
  qspCall(s, 'stat', '');
  (s as any).huntsexa = (Math.floor(Math.random() * 5) + 1);
...
function enterHuntersgroupORALi1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} groans loudly while cumming. He zips his pants and walks away.`);
  qspCall(s, 'arousal', 'bj', 5, 'sub', 'gangbang');
  qspCall(s, 'stat', '');
  (s as any).huntsexa = (Math.floor(Math.random() * 4) + 1);
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterRng_3(s, scene); (s as any).locArgs = __savedLocArgs; }
...
function enterHuntersgroupVa(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} came in your mouth…`);
  qspCall(s, 'arousal', 'bj', 5, 'sub', 'gangbang');
  qspCall(s, 'arousal', 'vaginal', (-5), 'sub');
  qspCall(s, 'stat', '');
  (s as any).huntsexa = (Math.floor(Math.random() * 4) + 1);
...
function enterHuntersgroupVs(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} cums and lies down exhausted next to you…`);
  qspCall(s, 'arousal', 'bj', 5, 'sub', 'gangbang');
  qspCall(s, 'arousal', 'vaginal', (-5), 'sub');
  qspCall(s, 'stat', '');
...
function enterHuntersgroupVi1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} finish and search for a spot where they could rest in the shade…`);
  qspCall(s, 'arousal', 'bj', 5, 'sub', 'gangbang');
  qspCall(s, 'arousal', 'vaginal', (-5), 'sub');
  qspCall(s, 'stat', '');
  (s as any).huntsexa = (Math.floor(Math.random() * 3) + 2);
...
function enterHuntersgroupDPsi(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} cums and walks away…`);
  qspCall(s, 'stat', '');
  (s as any).huntsexa = (Math.floor(Math.random() * 4) + 2);
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterRng_8(s, scene); (s as any).locArgs = __savedLocArgs; }
  // TODO-QSP: end
...
function enterHuntersgroupDPas(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`After a while ${((s as any).boydesc2 ?? '')} grunts and you feel your ass filling up with sprem. He finishes and walks away.`);
  qspCall(s, 'arousal', 'bj', (-5), 'sub', 'gangbang');
  qspCall(s, 'stat', '');
...
function enterHuntersgroupDPai(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hunterVars ?? 0)?.['sexnude'] === 1  ||  ((s as any).hunterVars ?? 0)?.['forest_sex'] === 3) {
    ...
    scene.text(`Satisfied ${((s as any).boydesc ?? '')} steps away while Andrei and Igor continue to fuck you relentlessly… `);
  }
  if (((s as any).hunterVars ?? 0)?.['sexnude'] === 1  ||  ((s as any).hunterVars ?? 0)?.['forest_sex'] === 3) {
    // TODO-QSP: dynamic text: Satisfied <<$boydesc>> steps away while Mitka and Vasyan continue to fuck you re...
    scene.text(`Satisfied ${((s as any).boydesc ?? '')} steps away while Mitka and Vasyan continue to fuck you relentlessly… `);
  }
  qspCall(s, 'arousal', 'bj', 5, 'sub', 'gangbang');
  qspCall(s, 'arousal', 'anal', 5, 'sub', 'gangbang');
  qspCall(s, 'arousal', 'vaginal', (-5), 'sub', 'gangbang');
...
function enterHuntersgroupViO(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`A satisfied ${((s as any).boydesc ?? '')} steps aside, the other guy keeps going on…`);
  qspCall(s, 'arousal', 'bj', 5, 'sub', 'gangbang');
  qspCall(s, 'arousal', 'vaginal', (-5), 'sub', 'gangbang');
  qspCall(s, 'stat', '');
  (s as any).huntsexa = (Math.floor(Math.random() * 3) + 2);
...
function enterHuntersgroupAa(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You hear ${((s as any).boydesc ?? '')} grunting from behind, his cock getting stiffer and stiffer. He should be reaching his limit soon you think to yourself. All of a sudden you hear a loud moan and you feel something warm inside your ass…`);
...
function enterHuntersgroupAaEnd1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} starts ravaging your anus, determinedly not slowing down…`);
  // TODO-QSP: dynamic text: You hear <<$boydesc>> grunting from behind, his cock getting stiffer and stiffer...
  scene.text(`You hear ${((s as any).boydesc ?? '')} grunting from behind, his cock getting stiffer and stiffer. He should be reaching his limit soon you think to yourself. All of a sudden you hear a loud moan and you feel something warm inside your ass…`);
  qspCall(s, 'cum_call', 'butt', ((s as any).boy ?? 0), 1);
  qspCall(s, 'arousal', 'anal', 5, 'sub', 'rough');
...
function enterHuntersgroupAaEnd2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} whispers that he'll enjoy this and starts pummeling your anus. You let out a whimper, clearly enjoying yourself…`);
  // TODO-QSP: dynamic text: You hear <<$boydesc>> grunting from behind, his cock getting stiffer and stiffer...
  scene.text(`You hear ${((s as any).boydesc ?? '')} grunting from behind, his cock getting stiffer and stiffer. He should be reaching his limit soon you think to yourself. All of a sudden you hear a loud moan and you feel something warm inside your ass…`);
  qspCall(s, 'cum_call', 'butt', ((s as any).boy ?? 0), 1);
  qspCall(s, 'arousal', 'anal', 5, 'sub', 'rough');
...
function enterHuntersgroupAsEnd1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`Without any lube ${((s as any).boydesc ?? '')} shoves his cock in your anus making you scream out with pain…`);
  // TODO-QSP: dynamic text: You hear <<$boydesc>> grunting from behind, his cock getting stiffer and stiffer...
  scene.text(`You hear ${((s as any).boydesc ?? '')} grunting from behind, his cock getting stiffer and stiffer. It should be over soon you think to yourself. All of a sudden you hear a loud moan and you feel something warm inside your ass…`);
  qspCall(s, 'cum_call', 'butt', ((s as any).boy ?? 0), 1);
  qspCall(s, 'arousal', 'anal', 5, 'sub', 'rough');
  qspCall(s, 'arousal', 'end');
  if (((s as any).hunterVars ?? 0)?.['forest_sex'] === 0) {
...
function enterHuntersgroupAsEnd2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`While on all fours ${((s as any).boydesc ?? '')} comes in from behind and starts fucking you…`);
  // TODO-QSP: dynamic text: You hear <<$boydesc>> grunting from behind, his cock getting stiffer and stiffer...
  scene.text(`You hear ${((s as any).boydesc ?? '')} grunting from behind, his cock getting stiffer and stiffer. He should be reaching his limit soon you think to yourself. All of a sudden you hear a loud moan and you feel something warm all over your back…`);
  qspCall(s, 'cum_call', 'butt', ((s as any).boy ?? 0), 1);
  qspCall(s, 'arousal', 'anal', 5, 'sub', 'rough');
  qspCall(s, 'arousal', 'end');
  if (((s as any).hunterVars ?? 0)?.['forest_sex'] === 0) {
...
function enterHuntersgroupAiEnd1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} orders you on all fours, he steps behind you loudly proclaiming you're going to get a real pounding now. With a sly look he guides his unlubed penis inside your anus, telling you he wants to stretch it out…`);
  // TODO-QSP: dynamic text: You hear <<$boydesc>> grunting from behind, his cock getting stiffer and stiffer...
  scene.text(`You hear ${((s as any).boydesc ?? '')} grunting from behind, his cock getting stiffer and stiffer. It should be over soon you think to yourself. All of a sudden you hear a loud moan and you feel something warm inside your ass…`);
  qspCall(s, 'cum_call', 'butt', ((s as any).boy ?? 0), 1);
  qspCall(s, 'arousal', 'anal', 5, 'sub', 'rough');
...
function enterHuntersgroupAiEnd2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} starts fucking you in the ass, both of you are enjoying yourselves…`);
  // TODO-QSP: dynamic text: You hear <<$boydesc>> grunting from behind, his cock getting stiffer and stiffer...
  scene.text(`You hear ${((s as any).boydesc ?? '')} grunting from behind, his cock getting stiffer and stiffer. He should be reaching his limit soon you think to yourself. All of a sudden you hear a loud moan and you feel something warm all over your back…`);
  qspCall(s, 'cum_call', 'butt', ((s as any).boy ?? 0), 1);
  qspCall(s, 'arousal', 'anal', 5, 'sub');
...
function enterHuntersgroupVa2end(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} pulls you on top of him, spreads your pussy lips and enters you…`);
  // TODO-QSP: dynamic text: After a while, you see that <<$boydesc>> is at the edge and will be cumming soon...
  scene.text(`After a while, you see that ${((s as any).boydesc ?? '')} is at the edge and will be cumming soon. You feel his cock throbbing and him cumming…`);
  qspCall(s, 'arousal', 'vaginal', 5, 'sub');
  qspCall(s, 'arousal', 'end');
  if (((s as any).hunterVars ?? 0)?.['forest_sex'] === 0) {
    scene.actions([
...
function enterHuntersgroupVs2end(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} pulls you on top of him, spreads your pussy lips so he can more easily enter you…`);
  // TODO-QSP: dynamic text: After a while, you see that <<$boydesc>> is at the edge and will be cumming soon...
  scene.text(`After a while, you see that ${((s as any).boydesc ?? '')} is at the edge and will be cumming soon. You feel his cock throbbing and him soon thereafter cumming…`);
  qspCall(s, 'arousal', 'vaginal', 5, 'sub');
  qspCall(s, 'arousal', 'end');
  if (((s as any).hunterVars ?? 0)?.['forest_sex'] === 0) {
    scene.actions([
...
function enterHuntersgroupVi3end(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} pulls you on top of him and starts fucking you relentlessly…`);
  // TODO-QSP: dynamic text: After a while, you see that <<$boydesc>> is at the edge and will be cumming soon...
  scene.text(`After a while, you see that ${((s as any).boydesc ?? '')} is at the edge and will be cumming soon. You feel his cock throbbing and him cumming…`);
  qspCall(s, 'arousal', 'vaginal', 5, 'sub', 'rough');
  qspCall(s, 'arousal', 'end');
...
function enterHuntersgroupOsend(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You watch as ${((s as any).boydesc ?? '')} is trying hard to finish. All of a sudden he screams out that he's edging and you should get ready to get covered in this spunk. Hot sperm hits your face, most of it hitting your face and chin. The sperm drips down on your chest…`);
  qspCall(s, 'arousal', 'end');
  if (((s as any).hunterVars ?? 0)?.['forest_sex'] === 0) {
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
...
function enterHuntersgroupOaend(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? '')} tells you he's edging and that you should get ready. He lets out a grunt and a hot jet of sperm hits you in the face. It runs down your chin, dripping down on your chest…`);
  qspCall(s, 'arousal', 'end');
  if (((s as any).hunterVars ?? 0)?.['forest_sex'] === 0) {
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
...
function enterHuntersgroupOiend(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You noticed ${((s as any).boydesc ?? '')}'s facial expression getting tense, nearing the edge. A stream of hot sperm hits you in the face, then another stream and it keeps on going not letting up. It runs down your chin, dripping down on your chest…`);
  qspCall(s, 'arousal', 'end');
  if (((s as any).hunterVars ?? 0)?.['forest_sex'] === 0) {
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
...
function enterHunterslutEND(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).protect ?? 0) === 1) {
    ...
    scene.text(`After disposing of the used condom, ${((s as any).boydesc ?? '')} puts you in front of him. Kneeling down, you licked the head of the cock while masturbating him… `);
  }
  if ((!((s as any).protect ?? 0))) {
    // TODO-QSP: dynamic text: You went down on your knees. Took the cock in hand and began masturbating <<$boy...
    scene.text(`You went down on your knees. Took the cock in hand and began masturbating ${((s as any).boydesc ?? '')}, licking the penis head at the same time…`);
  }
  ...
  scene.actions([
    ...
    if (((st as any).hunterVars ?? 0)?.['forest_sex'] === 1) {
      scene.actions([
    ...
    if (((st as any).forest_gopsex ?? 0) === 1) {
...
function enterHunterslutORAL(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) > 7) {
    ...
    scene.text(`All of a sudden ${((s as any).boydesc ?? '')} begins moving faster, making sounds, you quickly realize he's edging and would be cumming soon.`);
  }
...
function enterHunterslutCOW(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) <= 7) {
    ...
    scene.text(`You can see that ${((s as any).boydesc ?? '')} enjoys fucking you in this position…`);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) > 7) {
    // TODO-QSP: dynamic text: Suddenly <<$boydesc>> began moving faster, grunting, you quickly realize he was ...
    scene.text(`Suddenly ${((s as any).boydesc ?? '')} began moving faster, grunting, you quickly realize he was edging and would be cumming soon.`);
  }
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterRng_9(s, scene); (s as any).locArgs = __savedLocArgs; }
  // TODO-QSP: end
  scene.build();
...
function enterHunterslutHANDS(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) <= 7) {
    ...
    scene.text(`${((s as any).boydesc ?? '')} lets out some grunts, he really enjoys fucking you in this position…`);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) > 7) {
    // TODO-QSP: dynamic text: <<$boydesc>> starts breathing heavily and grunting loudly, you realize he''s edg...
    scene.text(`${((s as any).boydesc ?? '')} starts breathing heavily and grunting loudly, you realize he's edging and is going to finish soon.`);
  }
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterRng_9(s, scene); (s as any).locArgs = __savedLocArgs; }
  // TODO-QSP: end
  scene.build();
...
function enterHunterslutTREE(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) <= 7) {
    ...
    scene.text(`${((s as any).boydesc ?? '')} tells you that he enjoys fucking you in this position…`);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) > 7) {
    // TODO-QSP: dynamic text: Suddenly <<$boydesc>> began moving faster, grunting, you quickly realize he was ...
    scene.text(`Suddenly ${((s as any).boydesc ?? '')} began moving faster, grunting, you quickly realize he was edging and would be cumming soon.`);
...
function enterHunterslutTREELEG(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) <= 7) {
    ...
    scene.text(`${((s as any).boydesc ?? '')} tells you that he could fuck you forever in this position…`);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) > 7) {
    // TODO-QSP: dynamic text: Suddenly <<$boydesc>> starts breathing heavily and grunting loudly, you realize ...
    scene.text(`Suddenly ${((s as any).boydesc ?? '')} starts breathing heavily and grunting loudly, you realize he's edging and is going to finish soon.`);
  }
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterRng_9(s, scene); (s as any).locArgs = __savedLocArgs; }
  // TODO-QSP: end
  scene.build();
...
function enterHunterslutLEG1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) <= 7) {
    ...
    scene.text(`${((s as any).boydesc ?? '')} whispers in your ear that he really enjoys fucking you in this position…`);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) > 7) {
    // TODO-QSP: dynamic text: All of a sudden <<$boydesc>> begins moving faster, making sounds, you quickly re...
    scene.text(`All of a sudden ${((s as any).boydesc ?? '')} begins moving faster, making sounds, you quickly realize he's edging and would be cumming soon.`);
...
function enterHuntersgroupfaint(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hunterVars ?? 0)?.['Rape'] === 4  ||  ((s as any).huntdanceslut ?? 0) === 4  ||  ((s as any).forest_gopsex ?? 0) === 1) {
    ...
    scene.text(`"${((st as any).pcs_nickname ?? '')}, are you still alive?" You hear ${((st as any).boydesc ?? '')} asking while making sure that you've come around.`);
...
function enterRng_1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) < 6) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALsi1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) === 6) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALs'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) === 7) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) === 8) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALend1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) <= 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupVis1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) > 6) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupVi1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) === 6) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupVs1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) <= 5) {
    scene.actions([
      { label: 'Sideways', goto: ['hunters', 'huntersgroupVsOi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) > 6) {
    scene.actions([
      { label: 'Sideways', goto: ['hunters', 'huntersgroupVOi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) === 6) {
    scene.actions([
      { label: 'Sideways', goto: ['hunters', 'huntersgroupVsO'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupDPis'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 5) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupOis'] },
    ]);
  }
...
function enterRng_2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) <= 4) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALs1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) > 4) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALs1end'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) === 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAs'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) < 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAsEnd1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) > 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAsEnd2'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) <= 3) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVs2'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) > 3) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVs2end'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupOsend'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) < 10) {
    scene.actions([
...
function enterRng_3(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALi1end'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) === 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) < 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAiEnd1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) > 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAiEnd2'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) <= 3) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVi3'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) > 3) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVi3end'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupOiend'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) < 10) {
    scene.actions([
...
function enterRng_4(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) <= 6) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALai1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) > 6) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALi1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) < 6) {
    scene.actions([
      { label: 'Doggy style', goto: ['hunters', 'huntersgroupVia1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) === 6) {
    scene.actions([
      { label: 'Doggy style', goto: ['hunters', 'huntersgroupVi2'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) > 6) {
    scene.actions([
      { label: 'Doggy style', goto: ['hunters', 'huntersgroupVa1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) <= 6) {
    scene.actions([
      { label: 'Sideways', goto: ['hunters', 'huntersgroupViOa'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) > 6) {
    scene.actions([
      { label: 'Sideways', goto: ['hunters', 'huntersgroupViO'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupDPia'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 5) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupOia'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) < 10) {
    scene.actions([
...
function enterRng_5(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) < 6) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupVas1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) === 6) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupVa'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1  &&  ((s as any).huntsexb ?? 0) > 6) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupVs'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) < 6) {
    scene.actions([
      { label: 'Lie on your stomach', goto: ['hunters', 'huntersgroupVaOs'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) > 6) {
    scene.actions([
      { label: 'Lie on your stomach', goto: ['hunters', 'huntersgroupVOs'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) === 6) {
    scene.actions([
      { label: 'Lie on your stomach', goto: ['hunters', 'huntersgroupVaO'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) < 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAsOa'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) === 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAsO'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) > 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAOa'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupOsa'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) < 10) {
    scene.actions([
...
function enterRng_6(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALasi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) > 5) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVias'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) === 3) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVia'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) === 4) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVis'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) === 5) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) < 3) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVas'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) > 5) {
    scene.actions([
      { label: 'Doggy style', goto: ['hunters', 'huntersgroupVaOsHi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) === 5) {
    scene.actions([
      { label: 'Doggy style', goto: ['hunters', 'huntersgroupVaOHi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) < 5) {
    scene.actions([
      { label: 'Doggy style', goto: ['hunters', 'huntersgroupVOsHi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4  &&  ((s as any).huntsexb ?? 0) < 5) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupDPasi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4  &&  ((s as any).huntsexb ?? 0) > 6) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupDPas'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4  &&  ((s as any).huntsexb ?? 0) === 6) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupDPsi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4  &&  ((s as any).huntsexb ?? 0) === 5) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupDPai'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 5  &&  ((s as any).huntsexb ?? 0) > 5) {
    scene.actions([
      { label: 'Sideways', goto: ['hunters', 'huntersgroupVsOaHi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 5  &&  ((s as any).huntsexb ?? 0) === 5) {
    scene.actions([
      { label: 'Sideways', goto: ['hunters', 'huntersgroupVsOHi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 5  &&  ((s as any).huntsexb ?? 0) < 5) {
    scene.actions([
      { label: 'Sideways', goto: ['hunters', 'huntersgroupVOaHi'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) < 10) {
    scene.actions([
...
function enterRng_7(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'huntersgroupORALa1end'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) === 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAa'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) < 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAaEnd1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2  &&  ((s as any).huntsexb ?? 0) > 5) {
    scene.actions([
      { label: 'Get down on all fours', goto: ['hunters', 'huntersgroupAaEnd2'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) <= 3) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVa2'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3  &&  ((s as any).huntsexb ?? 0) > 3) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'huntersgroupVa2end'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4) {
    scene.actions([
      { label: 'Kneel down', goto: ['hunters', 'huntersgroupOaend'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) < 10) {
    scene.actions([
...
function enterRng_8(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 5) {
    scene.actions([
      { label: 'Kneel down', goto: ['hunters', 'huntersgroupOis'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) < 10) {
    scene.actions([
...
function enterRng_9(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 1) {
    scene.actions([
      { label: 'Keep sucking', goto: ['hunters', 'hunterslutORAL'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 2) {
    scene.actions([
      { label: 'Straddle', goto: ['hunters', 'hunterslutCOW'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 3) {
    scene.actions([
      { label: 'Jump on the hands', goto: ['hunters', 'hunterslutHANDS'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 4) {
    scene.actions([
      { label: 'Lean on a tree', goto: ['hunters', 'hunterslutTREE'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 5) {
    scene.actions([
      { label: 'Lean on a tree and lift your leg', goto: ['hunters', 'hunterslutTREELEG'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 6) {
    scene.actions([
      { label: 'Turn your back', goto: ['hunters', 'hunterslutLEG1'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) === 7) {
    scene.actions([
      { label: 'Face him', goto: ['hunters', 'hunterslutLEG2'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) >= 10  &&  ((s as any).huntsexa ?? 0) > 7) {
    scene.actions([
      { label: 'Kneel down', goto: ['hunters', 'hunterslutEND'] },
    ]);
  }
  if (((s as any).pcs_sleep ?? 0) < 10) {
    scene.actions([

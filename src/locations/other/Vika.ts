...
function enterBrothelQuestions(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_rel ?? 0)?.['A220'] > 80) {
    ...
    // TODO-QSP: dynamic text: "I can ask the manager, but I can''t guarantee anything. Come by' + iif(hour < 2...

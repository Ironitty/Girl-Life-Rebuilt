...
function enterCollectEventsForWeek(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_d ?? 0) <= 7) {
    ...
    ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', date'] = ((s as any).temp_daystart ?? 0);
    ...
    if (((s as any).temp_i ?? 0) < Object.keys((s as any).query_events_for_day ?? {}).length) {
      ...
      if (((s as any).event_vars ?? 0)?.['all_day'] === 1) {
        ...
        if (((s as any).event_vars ?? 0)?.['flex_type'] === 1) {
          ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', orig_start'] = ((s as any).event_vars ?? 0)?.['window_start_ts'];
          ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', orig_end'] = ((s as any).event_vars ?? 0)?.['window_end_ts'];
          ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', duration'] = ((s as any).event_vars ?? 0)?.['duration_ts'];
          ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', priority'] = ((s as any).event_vars ?? 0)?.['priority'];
          ...
          ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', start'] = ((s as any).temp_start ?? 0);
          ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', end'] = ((s as any).temp_end ?? 0);
          ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', duration'] = ((s as any).temp_end ?? 0) - ((s as any).temp_start ?? 0) + 1;
          ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', priority'] = ((s as any).event_vars ?? 0)?.['priority'];
...
function enterPlaceAlldayEvents(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_i ?? 0) < ((s as any).temp_allday_count ?? 0)) {
    ...
    ((s as any).allday_spans = (s as any).allday_spans ?? {})['' + String((s as any).temp_i || '') + ', first'] = Math.max(((s as any).temp_first_day ?? 0), 1);
    ((s as any).allday_spans = (s as any).allday_spans ?? {})['' + String((s as any).temp_i || '') + ', last'] = Math.min(((s as any).temp_last_day ?? 0), 7);
    ((s as any).allday_spans = (s as any).allday_spans ?? {})['' + String((s as any).temp_i || '') + ', length'] = ((s as any).temp_last_day ?? 0) - ((s as any).temp_first_day ?? 0) + 1;
    (s as any).temp_i = ((s as any).temp_i ?? 0) + (1);
  ...
  if (((s as any).temp_swapped ?? 0) === 1) {
    ...
    if (((s as any).temp_i ?? 0) < ((s as any).temp_allday_count ?? 0) - 1) {
      if (((s as any).allday_spans ?? 0)[((s as any).temp_i ?? 0) + ', length'] < ((s as any).allday_spans ?? 0)[((s as any).temp_i ?? 0)+1 + ', length']) {
        ...
        ((s as any).allday_spans = (s as any).allday_spans ?? {})['' + String((s as any).temp_i || '') + ', first'] = ((s as any).allday_spans ?? 0)?.[String(((s as any).temp_i ?? 0)+1) + ', first'];
        ((s as any).allday_spans = (s as any).allday_spans ?? {})['' + String((s as any).temp_i || '') + ', last'] = ((s as any).allday_spans ?? 0)?.[String(((s as any).temp_i ?? 0)+1) + ', last'];
        ((s as any).allday_spans = (s as any).allday_spans ?? {})['' + String((s as any).temp_i || '') + ', length'] = ((s as any).allday_spans ?? 0)?.[String(((s as any).temp_i ?? 0)+1) + ', length'];
        ((s as any).allday_spans = (s as any).allday_spans ?? {})['' + String((s as any).temp_i+1 || '') + ', first'] = ((s as any).temp_swap_first ?? 0);
        ((s as any).allday_spans = (s as any).allday_spans ?? {})['' + String((s as any).temp_i+1 || '') + ', last'] = ((s as any).temp_swap_last ?? 0);
        ((s as any).allday_spans = (s as any).allday_spans ?? {})['' + String((s as any).temp_i+1 || '') + ', length'] = ((s as any).temp_swap_len ?? 0);
        (s as any).temp_swapped = 1;
      }
      (s as any).temp_i = ((s as any).temp_i ?? 0) + (1);
      ...
      if (((s as any).temp_last_day ?? 0) < ((s as any).row_first_occupied ?? 0)?.[String((s as any).temp_r ?? 0)]  ||  ((s as any).temp_first_day ?? 0) > ((s as any).row_last_occupied ?? 0)?.[String((s as any).temp_r ?? 0)]) {
        ...
        if (((s as any).temp_d ?? 0) <= ((s as any).temp_last_day ?? 0)) {
          if (((s as any).temp_d ?? 0) === ((s as any).temp_first_day ?? 0)) {
            ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', allday=' + String((s as any).temp_r || '') + ', id'] = ((s as any).temp_evt_id ?? 0);
            ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', allday=' + String((s as any).temp_r || '') + ', title'] = ((s as any).event_vars ?? 0)?.['title'];
            ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', allday=' + String((s as any).temp_r || '') + ', color'] = ((s as any).event_vars ?? 0)?.['color'];
            ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', allday=' + String((s as any).temp_r || '') + ', colspan'] = ((s as any).temp_span_days ?? 0);
          } else {
            ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', allday=' + String((s as any).temp_r || '') + ', id'] = '';
            ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', allday=' + String((s as any).temp_r || '') + ', continued'] = 1;
          }
          (s as any).temp_d = ((s as any).temp_d ?? 0) + (1);
  ...
  if (((s as any).temp_d ?? 0) <= 7) {
    ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', max_allday_rows'] = ((s as any).temp_max_rows ?? 0);
    (s as any).temp_d = ((s as any).temp_d ?? 0) + (1);
              ...
              if (((s as any).temp_other_id ?? 0) !== ((s as any).temp_evt_id ?? 0)) {
                ...
                if (((s as any).temp_overlaps ?? 0) === 1) {
                  ...
                  if (((s as any).temp_other_priority ?? 0) > ((s as any).temp_evt_priority ?? 0)) {
                    ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_start_ts || '') + ', events=' + String((s as any).temp_this_event_index || '') + ', is_hidden'] = 1;
                    ...
                    if (((s as any).temp_other_priority ?? 0) < ((s as any).temp_evt_priority ?? 0)) {
                      ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_check_t || '') + ', events=' + String((s as any).temp_check_e || '') + ', is_hidden'] = 1;
    ...
    if (((s as any).temp_i ?? 0) < ((s as any).temp_flex_count ?? 0)) {
      ...
      if (((s as any).temp_evt_priority ?? 0) === ((s as any).temp_priority ?? 0)) {
        ...
        if (((s as any).placement_found ?? 0) === 1) {
          ...
          ((s as any).placement_state = (s as any).placement_state ?? {})['' + String((s as any).$temp_evt_id || '') + ', attempt'] = 1;
        ...
        if (((s as any).placement_found ?? 0) === 1) {
          ...
          ((s as any).placement_state = (s as any).placement_state ?? {})['' + String((s as any).$temp_evt_id || '') + ', attempt'] = 2;
          // TODO-QSP: jump 'next_flex_event'
        }
        ...
        if (((s as any).placement_found ?? 0) === 1) {
          { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ((s as any).temp_d ?? 0), ((s as any).temp_evt_id ?? 0)]; enterApplyPlacement(s, scene); (s as any).locArgs = __savedLocArgs; }
          ((s as any).placement_state = (s as any).placement_state ?? {})['' + String((s as any).$temp_evt_id || '') + ', attempt'] = 3;
          // TODO-QSP: jump 'next_flex_event'
        }
        ((s as any).placement_state = (s as any).placement_state ?? {})['' + String((s as any).$temp_evt_id || '') + ', attempt'] = 0;
...
function enterApplyPlacement(s: GameState, scene: SceneBuilder): void {
  (s as any).temp_d = ((s as any).locArgs?.[1] ?? 0);
  (s as any).temp_evt_id = ((s as any).locArgs?.[2] ?? 0);
  ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', start'] = ((s as any).placement_start ?? 0);
  ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', end'] = ((s as any).placement_start ?? 0) + ((s as any).event_range_cache ?? 0)['' + ((s as any).temp_evt_id ?? 0) + ', duration'] - 1;
  ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', window_start'] = ((s as any).placement_window_start ?? 0);
  ((s as any).event_range_cache = (s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', window_end'] = ((s as any).placement_window_end ?? 0);
  ...
  ((s as any).placement_state = (s as any).placement_state ?? {})['' + String((s as any).$temp_evt_id || '') + ', placed'] = 1;
  return;
  // TODO-QSP: end
  scene.build();
}
      ...
      if (((s as any).temp_e ?? 0) < ((s as any).temp_count ?? 0)) {
        ...
        if (((s as any).temp_other_id ?? 0) !== ((s as any).temp_evt_id ?? 0)) {
          ...
          if (((s as any).temp_other_priority ?? 0) < ((s as any).temp_evt_priority ?? 0)) {
            (s as any).temp_overlaps = qspFunc(s, 'calendar_schedule', 'check_overlap', ((s as any).temp_evt_id ?? 0), ((s as any).temp_other_id ?? 0));
            if (((s as any).temp_overlaps ?? 0) === 1) {
              ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', is_hidden'] = 1;
...
function enterAddEventToSchedule(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'calendar_events', 'get_event', ((s as any).temp_evt_id ?? 0));
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', id'] = ((s as any).temp_evt_id ?? 0);
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', title'] = ((s as any).event_vars ?? 0)?.['title'];
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', location'] = ((s as any).event_vars ?? 0)?.['loc'];
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', description'] = ((s as any).event_vars ?? 0)?.['desc'];
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', color'] = ((s as any).event_vars ?? 0)?.['color'];
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', priority'] = ((s as any).event_vars ?? 0)?.['priority'];
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', is_flex'] = ((s as any).event_vars ?? 0)?.['flex_type'];
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', start_ts'] = ((s as any).event_range_cache ?? 0)?.[String(((s as any).temp_evt_id ?? 0)) + ', start'];
  if (((s as any).event_vars ?? 0)?.['flex_type'] === 1) {
    ...
    ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', span'] = ((s as any).temp_total_span ?? 0);
    ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', window_slots'] = ((s as any).temp_window_slots ?? 0);
    ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', event_slots'] = ((s as any).temp_event_slots ?? 0);
  } else {
    ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', span'] = ((s as any).event_range_cache ?? 0)?.[String(((s as any).temp_evt_id ?? 0)) + ', duration'];
  }
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', is_hidden'] = 0;
  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ((s as any).temp_d ?? 0), ((s as any).temp_t ?? 0), ((s as any).temp_e ?? 0), 1]; enterChangeBusyTimeslots(s, scene); (s as any).locArgs = __savedLocArgs; }
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', event_count'] = ((s as any).temp_e ?? 0) + 1;
  return;
  // TODO-QSP: end
  scene.build();
}
...
function enterChangeBusyTimeslots(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_mb_ts ?? 0) <= ((s as any).temp_mb_end ?? 0)  &&  ((s as any).temp_mb_ts ?? 0) < 96) {
    ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).ARGS[1] || '') + ', timeslots=' + String((s as any).temp_mb_ts || '') + ', busy_count'] = ((s as any).week_schedule['days=' + String((s as any).ARGS[1] || '') + ', timeslots=' + String((s as any).temp_mb_ts || '') + ', busy_count'] ?? 0) + (((s as any).locArgs?.[4] ?? 0));
...
function enterAssignDayColumns(s: GameState, scene: SceneBuilder): void {
      ...
      if (((s as any).temp_e ?? 0) < ((s as any).temp_event_count ?? 0)) {
        ...
        if ((!((s as any).temp_is_hidden ?? 0))) {
          ...
          if (((s as any).column_end_slot ?? 0)?.[String((s as any).temp_col ?? 0)] < ((s as any).temp_t ?? 0)) {
            ...
            ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', column'] = ((s as any).temp_col ?? 0);
            ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', colspan'] = 1;
  ...
  ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', max_columns'] = ((s as any).temp_max_col_used ?? 0) + 1;
  return;
  // TODO-QSP: end
  scene.build();
}
    ...
    if (((s as any).temp_event_count ?? 0) > 0) {
      ...
      if (((s as any).temp_e ?? 0) < ((s as any).temp_event_count ?? 0)) {
        ...
        if ((!((s as any).temp_is_hidden ?? 0))) {
          ...
          ((s as any).week_schedule = (s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', colspan'] = ((s as any).temp_colspan ?? 0);
        }
        (s as any).temp_e = ((s as any).temp_e ?? 0) + (1);

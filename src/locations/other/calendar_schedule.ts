...
function enterPlaceAlldayEvents(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_r ?? 0) < 5) {
    ((s as any).row_last_occupied ?? {})[String((s as any).temp_r ?? 0)] = 0;
    ((s as any).row_first_occupied ?? {})[String((s as any).temp_r ?? 0)] = 8;
  ...
  if (((s as any).temp_i ?? 0) < ((s as any).temp_allday_count ?? 0)) {
    ...
    if (((s as any).temp_r ?? 0) < 5) {
      if (((s as any).temp_last_day ?? 0) < ((s as any).row_first_occupied ?? 0)?.[String((s as any).temp_r ?? 0)]  ||  ((s as any).temp_first_day ?? 0) > ((s as any).row_last_occupied ?? 0)?.[String((s as any).temp_r ?? 0)]) {
        ...
        ((s as any).row_first_occupied ?? {})[String((s as any).temp_r ?? 0)] = 0;
        ((s as any).row_last_occupied ?? {})[String((s as any).temp_r ?? 0)] = 0;
...
function enterApplyPlacement(s: GameState, scene: SceneBuilder): void {
  (s as any).temp_d = qspUntranslated(s, "ARGS[1]", { location: "calendar_schedule" });
  ((s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', start'] = ((s as any).placement_start ?? 0);
  ((s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', end'] = ((s as any).placement_start ?? 0) + ((s as any).event_range_cache ?? 0)['' + ((s as any).temp_evt_id ?? 0) + ', duration'] - 1;
  ((s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', window_start'] = ((s as any).placement_window_start ?? 0);
  ((s as any).event_range_cache ?? {})['' + String((s as any).$temp_evt_id || '') + ', window_end'] = ((s as any).placement_window_end ?? 0);
      ...
      if (((s as any).temp_e ?? 0) < ((s as any).temp_count ?? 0)) {
        if (((s as any).temp_other_id ?? 0) !== ((s as any).temp_evt_id ?? 0)) {
          ...
          if (((s as any).temp_other_priority ?? 0) < ((s as any).temp_evt_priority ?? 0)) {
            (s as any).temp_overlaps = qspFunc(s, 'calendar_schedule', 'check_overlap', ((s as any).temp_evt_id ?? 0), ((s as any).temp_other_id ?? 0));
            if (((s as any).temp_overlaps ?? 0) === 1) {
              ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', is_hidden'] = 1;
...
function enterAddEventToSchedule(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'calendar_events', 'get_event', ((s as any).temp_evt_id ?? 0));
  ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', id'] = ((s as any).temp_evt_id ?? 0);
  ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', title'] = ((s as any).event_vars ?? 0)?.['title'];
  ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', location'] = ((s as any).event_vars ?? 0)?.['loc'];
  ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', description'] = ((s as any).event_vars ?? 0)?.['desc'];
  ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', color'] = ((s as any).event_vars ?? 0)?.['color'];
  ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', priority'] = ((s as any).event_vars ?? 0)?.['priority'];
  ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', is_flex'] = ((s as any).event_vars ?? 0)?.['flex_type'];
  ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', start_ts'] = ((s as any).event_range_cache ?? 0)?.[String(((s as any).temp_evt_id ?? 0)) + ', start'];
  if (((s as any).event_vars ?? 0)?.['flex_type'] === 1) {
    ...
    ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', span'] = ((s as any).temp_total_span ?? 0);
    ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', window_slots'] = ((s as any).temp_window_slots ?? 0);
    ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', event_slots'] = ((s as any).temp_event_slots ?? 0);
  } else {
    ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', span'] = ((s as any).event_range_cache ?? 0)?.[String(((s as any).temp_evt_id ?? 0)) + ', duration'];
  }
  ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', is_hidden'] = 0;
  qspCall(s, 'calendar_schedule', 'change_busy_timeslots', ((s as any).temp_d ?? 0), ((s as any).temp_t ?? 0), ((s as any).temp_e ?? 0), 1);
...
function enterAssignDayColumns(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_init_c ?? 0) < 4) {
    ((s as any).column_end_slot ?? {})[String((s as any).temp_init_c ?? 0)] = (-1);
      ...
      if (((s as any).temp_e ?? 0) < ((s as any).temp_event_count ?? 0)) {
        ...
        if ((!((s as any).temp_is_hidden ?? 0))) {
          ...
          if (((s as any).column_end_slot ?? 0)?.[String((s as any).temp_col ?? 0)] < ((s as any).temp_t ?? 0)) {
            ...
            ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', column'] = ((s as any).temp_col ?? 0);
            ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', colspan'] = 1;
            ((s as any).column_end_slot ?? {})[String((s as any).temp_col ?? 0)] = ((s as any).temp_event_end_slot ?? 0);
    ...
    if (((s as any).temp_event_count ?? 0) > 0) {
      ...
      if (((s as any).temp_e ?? 0) < ((s as any).temp_event_count ?? 0)) {
        ...
        if ((!((s as any).temp_is_hidden ?? 0))) {
          ...
          ((s as any).week_schedule ?? {})['days=' + String((s as any).temp_d || '') + ', timeslots=' + String((s as any).temp_t || '') + ', events=' + String((s as any).temp_e || '') + ', colspan'] = ((s as any).temp_colspan ?? 0);
        }
        (s as any).temp_e = ((s as any).temp_e ?? 0) + (1);

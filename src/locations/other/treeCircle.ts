...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).treeCircName = (s as any).treeCircName ?? {})['PavlovskPark'] = 'Pavlovsk Park';
  ((s as any).treeCircLoc = (s as any).treeCircLoc ?? {})['PavlovskPark'] = 'pav_parkev';
  ((s as any).treeCircArg = (s as any).treeCircArg ?? {})['PavlovskPark'] = 'go_for_walk2';
  ((s as any).treeCircName = (s as any).treeCircName ?? {})['gad_forest'] = 'Gadukino Forest';
  ((s as any).treeCircLoc = (s as any).treeCircLoc ?? {})['gad_forest'] = 'gad_forest';
  ((s as any).treeCircArg = (s as any).treeCircArg ?? {})['gad_forest'] = 'forest_edge';
  ((s as any).treeCircName = (s as any).treeCircName ?? {})['PushkinPark'] = 'Pushkin Park';
  ((s as any).treeCircLoc = (s as any).treeCircLoc ?? {})['PushkinPark'] = 'pushkin_parks';
  ((s as any).treeCircArg = (s as any).treeCircArg ?? {})['PushkinPark'] = 'prut2';
  ((s as any).treeCircName = (s as any).treeCircName ?? {})['Village'] = 'Communal Village Spring';

...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).treeCircName) (s as any).treeCircName = {}; (s as any).treeCircName['CentralPark'] = 'Central Park';
  if (!(s as any).treeCircLoc) (s as any).treeCircLoc = {}; (s as any).treeCircLoc['CentralPark'] = 'city_park';
  if (!(s as any).treeCircArg) (s as any).treeCircArg = {}; (s as any).treeCircArg['CentralPark'] = 'start';
  if (!(s as any).treeCircName) (s as any).treeCircName = {}; (s as any).treeCircName['PavlovskPark'] = 'Pavlovsk Park';
  if (!(s as any).treeCircLoc) (s as any).treeCircLoc = {}; (s as any).treeCircLoc['PavlovskPark'] = 'pav_parkev';
  if (!(s as any).treeCircArg) (s as any).treeCircArg = {}; (s as any).treeCircArg['PavlovskPark'] = 'go_for_walk2';
  if (!(s as any).treeCircName) (s as any).treeCircName = {}; (s as any).treeCircName['gad_forest'] = 'Gadukino Forest';
  if (!(s as any).treeCircLoc) (s as any).treeCircLoc = {}; (s as any).treeCircLoc['gad_forest'] = 'gad_forest';
  if (!(s as any).treeCircArg) (s as any).treeCircArg = {}; (s as any).treeCircArg['gad_forest'] = 'forest_edge';
  if (!(s as any).treeCircName) (s as any).treeCircName = {}; (s as any).treeCircName['PushkinPark'] = 'Pushkin Park';
  if (!(s as any).treeCircLoc) (s as any).treeCircLoc = {}; (s as any).treeCircLoc['PushkinPark'] = 'pushkin_parks';
  if (!(s as any).treeCircArg) (s as any).treeCircArg = {}; (s as any).treeCircArg['PushkinPark'] = 'prut2';
  if (!(s as any).treeCircName) (s as any).treeCircName = {}; (s as any).treeCircName['Village'] = 'Communal Village Spring';
  if (!(s as any).treeCircLoc) (s as any).treeCircLoc = {}; (s as any).treeCircLoc['Village'] = 'ETO_village';
  if (!(s as any).treeCircArg) (s as any).treeCircArg = {}; (s as any).treeCircArg['Village'] = 'spring_water';
  ...
  if (((s as any).spellKnown ?? 0)?.['teleport'] === 1) {
    if (((s as any).tpKnown ?? 0)?.[String((s as any).EntryPoint ?? 0)] === 0) {
      ...
      if (!(s as any).tpKnown) (s as any).tpKnown = {}; (s as any).tpKnown[String((s as any).EntryPoint ?? 0)] = 1;
    }

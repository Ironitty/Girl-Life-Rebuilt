...
function enterStation(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).DjibrilQW ?? 0)?.['taxi'] === 1) {
    ((s as any).DjibrilQW = (s as any).DjibrilQW ?? {})['taxi'] = 0;
...
function enterDjibrilTaxiSex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You feel the tip of his huge cock rubbing against your wet slit before he slowly pushes it in. You feel your pussy stretching and filling as he pushes his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick inside you, moaning loudly as he pushes himself deep. He wastes no time before he starts fucking you.`);
...
function enterDjibrilSelfieAnal(s: GameState, scene: SceneBuilder): void {
  ((s as any).djibrilphoto = (s as any).djibrilphoto ?? {})[1] = 1;
  qspCall(s, 'stat', '');
...
function enterOluTaxiSexVaginal(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You just lay there letting him rub the tip of his dick against your asshole before he gently pushes his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock up your ass. It stretches you wide as he slowly starts fucking your ass.`);

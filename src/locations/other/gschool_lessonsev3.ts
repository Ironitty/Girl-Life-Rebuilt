...
function enterReading(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`"Very nice, Miss ${((s as any).pcs_lastname ?? 0)}," Ms. Braakman says with a small smile before continuing on with the lesson.`);
  ...
  if (((s as any).scooltiperand ?? 0) === 1) {
    ...
    scene.text(`"Screw reading! ${((s as any).pcs_nickname ?? 0)}'s mouth is better suited for sucking cock!" you overhear someone say behind you and turn around to see Petia staring back at you. Unashamed, a perverted smile spreads across his face and you get the feeling he's undressing you with his eyes.`);
    qspCall(s, 'willpower', 'bj', 'self', 'easy');
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Tell him he\'s right [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
    ...
    scene.text(`"Damn, ${((s as any).pcs_nickname ?? 0)} isn't fucking around!" Anushka marvels while giving you a nod of approval.`);
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Insult him [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
    ...
    scene.text(`"Miss ${((s as any).pcs_lastname ?? 0)}! I don't want to hear that kind of language in my class!" Ms. Braakman shouts, barely managing to speak above the noise of the class.`);
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
    ]);
  } },
    ...
    if (((s as any).scooltiperand ?? 0) === 2) {
      ...
      if (((s as any).scooltiperand ?? 0) === 3) {
        // TODO-QSP: dynamic text: "Very nice work, Miss <<$pcs_lastname>>," Arkadi says mockingly, his voice a poo...
        scene.text(`"Very nice work, Miss ${((s as any).pcs_lastname ?? 0)}," Arkadi says mockingly, his voice a poor imitation of Ms. Braakman. You turn around to see him and Roman snickering.`);
        scene.actions([
          { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
        ]);
      } else {
...
function enterGetphone(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).scooltiperand ?? 0) === 1) {
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Roll your eyes [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
    ...
    scene.text(`"I think that answers my question," she says, her voice low and oddly calm. "Turn around, ${((s as any).pcs_lastname ?? 0)}."`);
    scene.actions([
...
function enterEnglish(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 6) + 0) > 0) {
    ...
    if (((s as any).scooltiperand ?? 0) === 1) {
      ...
      if (((s as any).scooltiperand ?? 0) === 2) {
        ...
        if (((s as any).scooltiperand ?? 0) === 3) {
          ...
          if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
            scene.actions([
              { label: 'Trick them [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
            ]);
          } else {
    ...
    scene.text(`"S-screw you, ${((s as any).pcs_nickname ?? 0)}!" one of the girls stutters as she and her group quickly retreat with their tails between their legs.`);
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
    ]);
  } },
...
function enterWorking(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).scooltiperand ?? 0) === 1) {
  ...
  }, goto: ['gschool_lessonsev3', 'help_radomir'] },
    ]);
  } else {
    if (((s as any).scooltiperand ?? 0) === 2) {
      scene.img('images/locations/pavlovsk/school/classroom/literature/work.jpg');
      ...
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Give them the wrong answers [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
        ]);
      } else {
    ...
    if (((s as any).class ?? 0)?.['school_eng_grade'] >= 60) {
      ...
      scene.text(`"Thanks ${((s as any).pcs_nickname ?? 0)}. If it weren't for you, Lera would have never gotten this stuff right," Lena teases.`);
    ...
    scene.actions([
      ...
      if (((s as any).scooltiperand ?? 0) === 3) {
        ...
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          scene.actions([
            { label: 'Make up an excuse [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
          ]);
        } else {
...
function enterHelpRadomir(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).scooltiperand ?? 0) === 1) {
    ...
    scene.text(`Fed up, you take your paper back. He doesn't notice at first, but when he finally turns back around and sees it's missing, he starts to look for it. "Hey ${((s as any).pcs_nickname ?? 0)}, I think I lost your work."`);
    ...
    if (!(s as any).class) (s as any).class = {}; (s as any).class['school_eng_weekly_grade_gain'] = ((s as any).class['school_eng_weekly_grade_gain'] ?? 0) - (10);
    qspCall(s, 'npc_relationship', 'modify', 'A154', 1);
  ...
  if ((Math.floor(Math.random() * 6) + 0) > 0) {
    ...
    if (((s as any).scooltiperand ?? 0) === 1) {
      if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] >= 5  &&  ((s as any).pantyworntype ?? 0) !== 'none') {
        ...
        qspCall(s, 'gschool_lessonsev3', 'music');
      }
    } else {
      if (((s as any).scooltiperand ?? 0) === 2) {
        scene.img('images/locations/pavlovsk/school/events/scoolrand_2.jpg');
          ...
          if (((s as any).scooltiperand ?? 0) === 4) {
            ...
            if (((s as any).scooltiperand ?? 0) === 5) {
              ...
              if (((s as any).scooltiperand ?? 0) === 6) {
                ...
                scene.text(`"Is there a problem, Miss ${((s as any).pcs_lastname ?? 0)}?" Mr. Vasilyev asks and you glance around and notice everyone is staring at you as Radomir snickers behind you. Mr. Vasilyev looks at you curiously.`);
                qspCall(s, 'willpower', 'misc', 'self', 'medium');
                if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
                  scene.actions([
    ...
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
                ...
                if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
                  scene.actions([
                    { label: 'Slap Radomir [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
                  ]);
                } else {
    ...
    scene.text(`Mr. Vasilyev's voice cuts through the noise. "That's enough of that, Miss ${((s as any).pcs_lastname ?? 0)}! Go to the principal's office!"`);
    scene.actions([
    ...
    // TODO-QSP: dynamic text: "Is there a problem, Miss <<$pcs_lastname>>?" Mr. Vasilyev asks and you glance a...
    scene.text(`"Is there a problem, Miss ${((s as any).pcs_lastname ?? 0)}?" Mr. Vasilyev asks and you glance around and notice everyone is staring at you as Radomir snickers behind you.`);
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
    ]);
  } },
    ...
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
                ...
                if (((s as any).scooltiperand ?? 0) === 7  &&  ((s as any).braworntype ?? 0) !== 'none') {
                  ...
                  // TODO-QSP: dynamic text: "Is there a problem, Miss <<$pcs_lastname>>?" Mr. Vasilyev asks and you glance a...
                  scene.text(`"Is there a problem, Miss ${((s as any).pcs_lastname ?? 0)}?" Mr. Vasilyev asks and you glance around and notice everyone is staring at you as Lavrenti snickers behind you. Mr. Vasilyev looks at you accusingly.`);
                  qspCall(s, 'willpower', 'misc', 'self', 'medium');
                  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
                    scene.actions([
                      { label: 'Tell on him [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    ...
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['gschool_lessons', 'short_break'] },
                  ...
                  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
                    scene.actions([
                      { label: 'Slap Lavrenti [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
                    ]);
                  } else {
    ...
    if (((s as any).fame ?? 0)?.['pav_slut'] >= 150) {
      ...
      if (((s as any).grupTipe ?? 0) === 1) {
        ...
        if (((s as any).grupTipe ?? 0) === 5) {
          ...
          scene.text(`You sit next to Bella and she rolls her eyes. "What do you want, ${((s as any).pcs_nickname ?? 0)}? I don't have time to sit here and talk to kids."`);
        }
      }
    }
    qspCall(s, 'stat', '');
  ...
  if ((Math.floor(Math.random() * 6) + 0) > 0) {
    ...
    if (((s as any).scooltiperand ?? 0) === 1) {
      if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] >= 5  &&  ((s as any).pantyworntype ?? 0) !== 'none') {
        ...
        // TODO-QSP: jump 'art_event_once_more'
      }
    } else {
      if (((s as any).scooltiperand ?? 0) === 2) {
        scene.img('images/locations/pavlovsk/school/events/scoolrand_2.jpg');
    ...
    if (((s as any).pcs_hotcat ?? 0) >= 6) {
      ...
      scene.text(`Before you can look away, you hear Mr. Vasilyev clear his throat. When you glance at him, he gives you a stern look. "Please pay attention, Miss ${((s as any).pcs_lastname ?? 0)}. I know art history is a bit dry and boring, but this will be in your test."`);

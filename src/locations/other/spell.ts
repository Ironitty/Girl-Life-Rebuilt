...
function enterPenisenvy(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).spellArrIdx ?? 0) >= 0) {
    ((s as any).spellComplete ?? {})[String((s as any).spellArrIdx ?? 0)] = ((s as any).totminut ?? 0) + 30;
  } else {
...
function enterFog(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A Fog materializes around, obscuring ${0} from enemies.</font></b>`);
  } else {
...
function enterClone(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>${((s as any).SuccessValue ?? 0)} clone${((((s as any).SuccessValue ?? 0)>1) ? ('s') : (''))} springs from ${0} confusing enemies.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0  &&  (0 as any) > 0) {
      ...
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! A ${0} clone disappears.</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterStun(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>${0} is stunned.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterWind(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) === 2) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A wind blows through the area, eliminating the fog around ${0} from the battlefield.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) === 1) {
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColGood>>>A wind blows through the area, eliminating a...
      scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A wind blows through the area, eliminating all fog on the battlefield.</font></b>`);
    } else {
      if (((s as any).SuccessValue ?? 0) === -1) {
        // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColBad>>>A wind blows through the area, eliminating th...
        scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>A wind blows through the area, eliminating the fog around ${0} from the battlefield.</font></b>`);
      } else {
        scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
      }
    }
...
function enterMulticlone(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>${((s as any).SuccessValue ?? 0) * 3} clones of ${0} spring forth, confusing the enemy.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0  &&  ((s as any).klon ?? 0) > 0) {
      ...
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! Some clones of ${0} disappear.</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterEnergo(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>An energy shield materializes around ${0}, granting protection from enemies.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterHaste(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColGood>>><<dyneval($spellFunc["GetCombatantName"], $T...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>${0} feel mind and body race though a sluggish world.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterHeal(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    if ((!((s as any).menu_off ?? 0))) {
      ...
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColGood>>><<dyneval($spellFunc["GetCombatantName"], $T...
      scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>${0} surge with life, feeling much stronger.</font></b>`);
    }
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
...
function enterHand(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Power flows from the hands of ${0}.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterScaldingtouch(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Flames spring from your hands.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterBurninghands(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A torrent of flames jets from your hands.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterFirebarrier(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A flaming barrier springs up between you and your opponents.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterFirestorm(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Uncountable glowing embers streak down upon the foes of ${0}.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0) {
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColBad>>>The spell backfires! Uncountable glowing embe...
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! Uncountable glowing embers streak down upon the battlefield, burning everyone.</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterFlameshield(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A Shield made of flames interposes itself between ${0} and the enemy.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterShock(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>You build a static electric charge in your hand and zap your opponent.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0) {
      ...
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! You manage to zap yourself with a static charge.</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterLightning(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>You shoot a lightning bolt from your hand, zapping your opponent.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0) {
      qspCall(s, 'fight', 'applyDamage', ((s as any).CasterType ?? 0), ((s as any).CasterNumber ?? 0), 100);
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColBad>>>The spell backfires! You manage to zap yourse...
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! You manage to zap yourself with lightning.</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterElectricbarrier(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A wall of dancing lightning springs up around yourself.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enter1000birds(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>You shoot hundreds of small lightning bolts toward your enemy.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0) {
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColBad>>>The spell backfires! Hundreds of small lightn...
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! Hundreds of small lightning bolts curl toward the battlefield, shocking everyone.</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterDancingsphere(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A large field of lightning dances around you, blocking attacks.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterQuicksand(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>You trap your opponent in quicksand.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0) {
      ...
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! You are both trapped in quicksand.</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterEarthshield(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Tendrils of earth rise to defend you.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterAbyss(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>The Earth opens up beneath your opponent's feet, slamming shut damaging him and depriving him of the ability to move.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0) {
      ...
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! The Earth opens up beneath your opponent's feet, slamming shut damaging him and depriving him of the ability to move. You are also caught.</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterEarthguardian(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>The Earth itself comes alive defending you from attacks. It draws from the power of the land to regenerate itself every round. You now have ${((s as any).defence ?? 0)} protection units.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterSando(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Two huge plates of earth collapse together, crushing the enemy and depriving him of the ability to move.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0) {
      qspCall(s, 'fight', 'applyDamage', ((s as any).CasterType ?? 0), ((s as any).CasterNumber ?? 0), 50);
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColBad>>>The spell backfires! Two huge plates of earth...
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! Two huge plates of earth collapse together with crushing force, but the enemy is missed and you are instead caught.</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterWindgust(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>You create a gust of wind.</font></b>`);
    if ((0 as any) > 0) {
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColGood>>>Enemy clones are vaporized.</font></b>
      scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Enemy clones are vaporized.</font></b>`);
    }
    if ((0 as any) > 0) {
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColGood>>>Enemy fog is torn to shreds by the wind.</fo...
      scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Enemy fog is torn to shreds by the wind.</font></b>`);
    }
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
...
function enterPressure(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>You dramatically raise the air pressure.</font></b>`);
    if ((0 as any) > 0) {
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColGood>>>Enemy clones are vaporized.</font></b>
      scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Enemy clones are vaporized.</font></b>`);
    }
...
function enterVacuum(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A turbulent sphere of vacuum surrounds you, blocking incoming attacks. You now have ${((s as any).defence ?? 0)} protection units.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterVacuumshells(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Turbulent spheres of vacuum bombard your enemy. The air is full of whistling sounds as the spheres fly by at high speeds over the battlefield.</font></b>`);
    if ((0 as any) > 0) {
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColGood>>>Enemy clones are vaporized.</font></b>
      scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Enemy clones are vaporized.</font></b>`);
    }
...
function enterDevouringvacuum(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A devouring vacuum sucks away your enemy's defenses.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterLeechmana(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>You leech mana from your enemy.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0) {
      qspCall(s, 'fight', 'applyDamage', ((s as any).CasterType ?? 0), ((s as any).CasterNumber ?? 0), 50);
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColBad>>>The spell backfires! Ouch!</font></b>
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! Ouch!</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterFlood(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A surge of water rises towards your enemy.</font></b>`);
  } else {
    if (((s as any).SuccessValue ?? 0) < 0) {
      qspCall(s, 'fight', 'applyDamage', ((s as any).CasterType ?? 0), ((s as any).CasterNumber ?? 0), 100);
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColBad>>>The spell backfires! A surge of water rises t...
      scene.text(`<b><font color = ${((s as any).SplTxtColBad ?? 0)}>The spell backfires! A surge of water rises towards your enemy, but misses and hits you.</font></b>`);
    } else {
      scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
    }
  }
...
function enterBlister(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>A protective sphere of water surrounds you.</font></b>`);
  } else {
    scene.text('<b>The spell fizzles. Nothing seems to happen.</b>');
  }
  scene.build();
...
function enterSharkrockets(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Blobs of water shaped like sharks fly towards your enemy, striking them.</font></b>`);
    if ((0 as any) > 0) {
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColGood>>>Enemy clones are vaporized.</font></b>
      scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Enemy clones are vaporized.</font></b>`);
    }
...
function enterGreatflood(s: GameState, scene: SceneBuilder): void {
  if (((s as any).SuccessValue ?? 0) > 0) {
    ...
    scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>You have filled the whole neighborhood with water, protecting you and devouring enemy mana.</font></b>`);
    if ((0 as any) > 0) {
      // TODO-QSP: dynamic text: <b><font color = <<$SplTxtColGood>>>Enemy clones are vaporized.</font></b>
      scene.text(`<b><font color = ${((s as any).SplTxtColGood ?? 0)}>Enemy clones are vaporized.</font></b>`);
    }

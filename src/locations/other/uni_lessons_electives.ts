...
function enterAfricanStudies101(s: GameState, scene: SceneBuilder): void {
  qspGoto(s, 'uni_lessons_electives_african_studies1', 'african_studies_101');
  scene.build();
}
...
function enterArt101(s: GameState, scene: SceneBuilder): void {
  qspGoto(s, 'uni_lessons_electives_art1', 'art_101');
  scene.build();
}
...
function enterAsianStudies101(s: GameState, scene: SceneBuilder): void {
  qspGoto(s, 'uni_lessons_electives_asian_studies1', 'asian_studies_101');
  scene.build();
}
...
function enterComputers101(s: GameState, scene: SceneBuilder): void {
  qspGoto(s, 'uni_lessons_electives_computers1', 'computers_101');
  scene.build();
}
...
function enterPsychology101(s: GameState, scene: SceneBuilder): void {
  qspGoto(s, 'uni_lessons_electives_psychology1', 'psychology_101');
  scene.build();
}

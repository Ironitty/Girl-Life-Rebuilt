...
function enterCowgirlSwitch(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['initiative'] === 'girl') {
    if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
      ...
      scene.text(`You push ${((s as any).npcdesc ?? 0)} backwards, letting his cock slip from your pussy as he falls onto his back. You raise yourself up as he falls, taking hold of his shaft, slick with your juices, in your hand, and positioning it beneath you again.`);
    } else {
      if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy'  ||  ((s as any).sex_ev ?? 0)?.['position'] === 'anal') {
        ...
        scene.text(`You push ${((s as any).npcdesc ?? 0)} backwards, throwing him onto his back before swiftly turning around and mounting him.`);
      }
    }
    ...
    if (((s as any).sex_ev ?? 0)?.['initiative'] === 'boy') {
      if (((s as any).sex_ev ?? 0)?.['cock_inserted'] === 1) {
        if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
          ...
          scene.text(`${((s as any).npcdesc ?? 0)} slips his cock from between your legs for a moment, pulling you backwards as he does. He falls onto his back and you end up on top with your thighs over his.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
            ...
            scene.text(`${((s as any).npcdesc ?? 0)} slips his cock from your pussy. As you turn around to see what happened, he lays down on his back and beckons you forward. Getting the message, you climb aboard to get his cock between your thighs.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['position'] === 'anal') {
              ...
              scene.text(`${((s as any).npcdesc ?? 0)} slips his cock from your ass. As you turn around to see what happened, he lays down on his back and beckons you forward. Getting the message, you climb aboard to get his cock between your thighs.`);
            }
          }
        }
      } else {
        // TODO-QSP: dynamic text: <<$npcdesc>> pulls you on top of him as he falls onto his back and you end up on...
        scene.text(`${((s as any).npcdesc ?? 0)} pulls you on top of him as he falls onto his back and you end up on top with your thighs over his.`);
      }
      ...
      if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
        ...
        scene.text(`${((s as any).npcdesc ?? 0)} pulls his cock from your pussy and the two of you quickly reposition so that you're on top.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
          // TODO-QSP: dynamic text: <<$npcdesc>> pulls his cock from your pussy and the two of you quickly repositio...
          scene.text(`${((s as any).npcdesc ?? 0)} pulls his cock from your pussy and the two of you quickly reposition so that you're on top.`);
          ...
          if (((s as any).sex_ev ?? 0)?.['position'] === 'anal') {
            ...
            scene.text(`${((s as any).npcdesc ?? 0)} pulls his cock from your ass and the two of you quickly reposition so that you're on top.`);
          }
        }
      }
    }
  ...
  if (((s as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
    ...
    if (((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
      ...
      if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy'  ||  ((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
        ...
        scene.text(`"I want to be on top this time," you say, giving ${((s as any).npcdesc ?? 0)} a smouldering look as you mount his cock.`);
      } else {
        // TODO-QSP: dynamic text: "I'm not done with you yet," you say, giving <<$npcdesc>> a smouldering look as ...
        scene.text(`"I'm not done with you yet," you say, giving ${((s as any).npcdesc ?? 0)} a smouldering look as you mount his cock.`);
      }
    }
  }
  if (((s as any).sex_ev ?? 0)?.['first_insertion'] !== 0) {
...
function enterCowgirlFirstInsertion(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).npcdesc ?? 0)} lays back on the bed and you clamber on top of him, straddling his hips with yours, his ${((s as any).dick_desc ?? 0)} cock thrust upward between your thighs.`);
...
function enterCowgirlInsertSlow(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['first_insertion'] === 1) {
    ...
    qspCall(s, 'sex_ev_cowgirl', 'cowgirl_pain1');
    ...
    scene.text(`You gasp as the feeling of ${((s as any).npcdesc ?? 0)} inside you as you rest your weight on him sends heat washing through your hips and electric tingles racing across your skin.`);
    qspCall(s, 'sex_ev_cowgirl', 'cowgirl_menu');
  } },
    ...
    if (((s as any).npc_last_sex ?? 0)?.[String((s as any).npcID ?? 0)] > ((s as any).daystart ?? 0) - 7) {
      if (((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'big'  ||  ((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'extra_big') {
        ...
        scene.text(`"Ah~!" you moan, your pussy lips kissing the base of his ${((s as any).dick_desc ?? 0)} shaft as you finish lowering yourself onto him, and give him a lascivious smile. "<i>There's</i> my favorite big boy..."`);
      } else {
        // TODO-QSP: dynamic text: "Ah~!" you moan, your pussy lips kissing the base of his <<$dick_desc>> shaft as...
        scene.text(`"Ah~!" you moan, your pussy lips kissing the base of his ${((s as any).dick_desc ?? 0)} shaft as you finish lowering yourself onto him, and give him a lascivious smile. "<i>There's</i> my favorite boy's toy..."`);
      }
    } else {
      if (((s as any).npc_last_sex ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        if (((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'big'  ||  ((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'extra_big') {
          // TODO-QSP: dynamic text: "Ah~!" you moan, your pussy lips kissing the base of his <<$dick_desc>> shaft as...
          scene.text(`"Ah~!" you moan, your pussy lips kissing the base of his ${((s as any).dick_desc ?? 0)} shaft as you finish lowering yourself onto him, and give him a lascivious smile. "I've missed having this big boy inside me..."`);
        } else {
          // TODO-QSP: dynamic text: "Ah~!" you moan, your pussy lips kissing the base of his <<$dick_desc>> shaft as...
          scene.text(`"Ah~!" you moan, your pussy lips kissing the base of his ${((s as any).dick_desc ?? 0)} shaft as you finish lowering yourself onto him, and give him a lascivious smile. "I've missed having your cock inside me..."`);
        }
      } else {
        if (((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'big'  ||  ((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'extra_big') {
          if (((s as any).stat ?? 0)?.['biggest_cock'] < ((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]) {
            // TODO-QSP: dynamic text: "Ah~!" you moan, your pussy lips kissing the base of his <<$dick_desc>> shaft as...
            scene.text(`"Ah~!" you moan, your pussy lips kissing the base of his ${((s as any).dick_desc ?? 0)} shaft as you finish lowering yourself onto him, and give him a lascivious smile. "I've never had a cock this big inside me before..."`);
          } else {
            // TODO-QSP: dynamic text: "Ah~!" you moan, your pussy lips kissing the base of his <<$dick_desc>> shaft as...
            scene.text(`"Ah~!" you moan, your pussy lips kissing the base of his ${((s as any).dick_desc ?? 0)} shaft as you finish lowering yourself onto him, and give him a lascivious smile. "I love big cocks..."`);
          }
        } else {
          // TODO-QSP: dynamic text: "Ah~!" you moan, your pussy lips kissing the base of his <<$dick_desc>> shaft as...
          scene.text(`"Ah~!" you moan, your pussy lips kissing the base of his ${((s as any).dick_desc ?? 0)} shaft as you finish lowering yourself onto him, and give him a lascivious smile. "You're a perfect fit for my pussy..."`);
        }
      }
    }
    qspCall(s, 'sex_ev_cowgirl', 'cowgirl_menu');
    ...
    // TODO-QSP: dynamic text: You let out a painful groan as you settle down fully onto <<$npcdesc>>'s <<$dick...
    scene.text(`You let out a painful groan as you settle down fully onto ${((s as any).npcdesc ?? 0)}'s ${((s as any).dick_desc ?? 0)} cock. Your insides <i>ache</i> as if you had been punched in the gut. Which in some ways, you have been...`);
    qspCall(s, 'sex_ev_cowgirl', 'cowgirl_menu');
  } },
        { label: 'He\'s big!', handler: (st: GameState) => {
    if (((s as any).npc_fuck_times ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
        ...
        scene.text(`"Nngh~! <i>Fuck~!</i>" you groan loudly as ${((s as any).npcdesc ?? 0)}'s cock overstuffs your poor pussy. "I can never get used to how <i>big</i> you are."`);
      } else {
...
function enterCowgirlInsertOrgasm(s: GameState, scene: SceneBuilder): void {
  if (((s as any).trait_vars ?? 0)?.['sensitivity'] > 0  ||  (((s as any).orgasm_buildup ?? 0) >= 100  &&  (((s as any).trait_vars ?? 0)?.['sensitivity'] >= 0  ||  ((s as any).trait_vars ?? 0)?.['sensitivity_override'] === 1))) {
    ...
    if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short'  ||  ((s as any).dick_desc ?? 0) === 'chode'  ||  ((s as any).dick_desc ?? 0) === 'skinny'  ||  ((s as any).dick_desc ?? 0) === 'normal') {
      ...
      scene.text(`${((s as any).npcdesc ?? 0)}'s cock <i>fills</i> you to the brim and you gasp aloud as it starts. Muscles tighten. Heat blossoms. Electric tingles race across your body from your toes to the tips of your nipples that quiver in the air as you convulse in orgasm. You groan a wordless cry of ecstasy.`);
      scene.actions([
...
function enterCowgirlGirlOrgasmContinue(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'Ride him hard', handler: (st: GameState) => {
    // TODO-QSP: gt 'sex_ev_cowgirl', 'cowgirl3' !}
  } },
  ]);
  scene.build();
}
...
function enterCowgirlPain2(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    scene.text(`As much as you want the pain to stop, the idea of speaking up and ruining the mood makes you cringe. Instead, you grit your teeth and start riding ${((s as any).npcdesc ?? 0)}, hoping that the pain is not too audible in your voice.`);
    qspCall(s, 'sex_ev_cowgirl', 'cowgirl_menu2');
  } },
    ...
    if (((((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).npc_fav_pos ?? 0)?.[String((s as any).npcID ?? 0)] === 'miss')  ||  ((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] === 1)  &&  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] !== 1) {
      ...
      // TODO-QSP: dynamic text: "Come on, you're already there," <<$npcdesc>> grunts back. "Just start moving al...
      scene.text(`"Come on, you're already there," ${((s as any).npcdesc ?? 0)} grunts back. "Just start moving already."`);
      ...
      scene.text(`"What did you have in mind?" ${((s as any).npcdesc ?? 0)} asks and you sigh in relief as you already start pulling yourself off his cock.`);
...
function enterCowgirlPain3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`The motion leaves you off balance and you accidentally end up stabbing your pussy with ${((s as any).npcdesc ?? 0)}'s cock again, causing you sit up sharply and nearly fall off the bed.`);
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} seems to be a little ticked off by your attitude as you start moving your hips again.`);
    qspCall(s, 'sex_ev_cowgirl', 'cowgirl_menu2');
  } },
    ...
    if (((s as any).sex_ev ?? 0)?.['dick_too_big'] === 1) {
      ...
      // TODO-QSP: dynamic text: You spend a couple minutes with your hips flat against <<$npcdesc>>'s, sat on hi...
      scene.text(`You spend a couple minutes with your hips flat against ${((s as any).npcdesc ?? 0)}'s, sat on his cock with its entire length inside you and taking deep breaths as you slowly let it stretch your pussy. Eventually the pain fades to nothing more than a dull ache.`);
...
function enterCowgirl1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).mesec ?? 0) > 0) {
    qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_start_period_desc');
  } else {
  ...
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 75) {
    ...
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
      ...
      if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'average') {
        // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips on the next bounce as <<$npcdesc>>'s hi...
        scene.text(`An uncontrollable gasp escapes your lips on the next bounce as ${((s as any).npcdesc ?? 0)}'s hips meet yours in a thrust from underneath. He's not just proactive, he's attentive too. You can feel how his movements react to yours, each thrust feeling better than the last. <i>Damn</i>, does he know how to use his dick!`);
      } else {
        if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'big') {
          // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips on the next bounce as <<$npcdesc>>'s hi...
          scene.text(`An uncontrollable gasp escapes your lips on the next bounce as ${((s as any).npcdesc ?? 0)}'s hips meet yours in a thrust from underneath. He doesn't just have a big cock, he knows how to use it too. You can feel how his movements react to yours, each thrust feeling better than the last. If it hits an awkward spot, you feel him adjust. If it hits you just right, he responds to the squeeze of your pussy.`);
          scene.text('Oh <i>fuck</i>. He\'s good at this.');
        } else {
          if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'extra_big') {
            // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips on the next bounce as <<$npcdesc>>'s hi...
            scene.text(`An uncontrollable gasp escapes your lips on the next bounce as ${((s as any).npcdesc ?? 0)}'s hips meet yours in a thrust from underneath. He doesn't just have a gigantic cock, he knows how to use it too. You would think that being fucked with such a giant dick would hurt, and it occasionally does, but not as often as you expected. His movements react to yours, each thrust feeling better than the last. If it hits an awkward spot, you feel him adjust his angle beneath you. If it hits you just right, he responds to the squeeze of your pussy, minimizing pain and maximizing pleasure.`);
            scene.text('Oh <i>fuck</i>. He\'s good at this.');
          }
        }
      }
    ...
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
      ...
      if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'average') {
        // TODO-QSP: dynamic text: Proactive, but not amazing. You can't exactly put your finger on it, but the tim...
        ...
        if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'big') {
          ...
          if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'extra_big') {
            ...
            scene.text(`Proactive, but not amazing. Half the problem is his cock is just <i>too damn big!</i> His movements just aren't syncing up with yours' + iif(npc_fuck_times[$npcID] > 0, ' today ', ' ') + 'and you find yourself stifling yelps of discomfort as his ${((s as any).dick_desc ?? 0)} cock keeps hitting awkward and painful spots inside your pussy. Maybe this would get another girl off, but certainly not you...`);
          }
        }
      }
    }
    ...
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
      ...
      if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 25) {
        // TODO-QSP: dynamic text: A grunt of surprise escapes your lips as <<$npcdesc>>'s hips meet yours in a thr...
    ...
    scene.text(`You roll your hips gently on top of his ${((s as any).dick_desc ?? 0)} cock, encouraging the movements you want from him. It takes a few minutes of trying, but eventually he starts to get the hang of it.`);
    // TODO-QSP: dynamic text: "<i>"Yes~!"</i> you moan, grinning at <<$npcdesc>>. "Just like that."
    scene.text(`"<i>"Yes~!"</i> you moan, grinning at ${((s as any).npcdesc ?? 0)}. "Just like that."`);
    ...
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
      ...
      if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'average') {
        ...
        if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'big') {
          ...
          if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'extra_big') {
            // TODO-QSP: dynamic text: Proactive, but not amazing. Half the problem is his cock is just <i>too damn big...
            scene.text(`Proactive, but not amazing. Half the problem is his cock is just <i>too damn big!</i> His movements aren't syncing up with yours and you find yourself stifling yelps of discomfort as his ${((s as any).dick_desc ?? 0)} cock keeps hitting awkward and painful spots inside your pussy. Maybe this would get another girl off, but certainly not you...`);
          }
        }
      }
    }
  ...
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        scene.text(`You take deep breaths as you keep forcing yourself to gently ride ${((s as any).npcdesc ?? 0)}. After a while, you realize you're starting to slide up and down his shaft a little more easily and without any pain. It seems your virgin pussy is starting to adjust to having a cock inside it.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          ...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips each time your virgin pussy slowly descends on ${((s as any).npcdesc ?? 0)}'s cock. It still hurts, but you're determined not to let a little pain cause you to pussy out of your first time.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            ...
            scene.text(`You whimper softly, clenching your teeth as hard as you can as you keep forcing yourself to slowly work your virgin pussy up and down ${((s as any).npcdesc ?? 0)}'s shaft. It hurts <i>so much</i>, but you can't bring yourself to face the embarrassment of stopping.`);
          }
        }
      }
    } else {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk2');
        // TODO-QSP: dynamic text: You take deep breaths as you keep forcing yourself to gently ride <<$npcdesc>>. ...
        scene.text(`You take deep breaths as you keep forcing yourself to gently ride ${((s as any).npcdesc ?? 0)}. After a while, you realize you're starting to slide up and down his shaft a little more easily and without any pain. It seems like you're getting better at this.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          scene.text('"<i>Nn-! Nngh-! Ngh-!</i>"');
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk1');
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk2');
          // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips each time ...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips each time your pussy bounces on ${((s as any).npcdesc ?? 0)}'s cock. It hurts like hell, but you don't say anything, trying your best not to let it show and keep on riding.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk1');
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk2');
            // TODO-QSP: dynamic text: You whimper softly, clenching your teeth as hard as you can as you keep forcing ...
            scene.text(`You whimper softly, clenching your teeth as hard as you can as you keep forcing yourself to slowly work your pussy up and down ${((s as any).npcdesc ?? 0)}'s shaft. It hurts <i>so much</i>, but you can't bring yourself to face the embarrassment of stopping.`);
          }
        }
      }
    }
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          ...
          scene.text(`You keep rolling your hips, focusing on the motions and tightening your pussy around ${((s as any).npcdesc ?? 0)}'s cock. It seems to throb in response inside of you and you think he'll come soon if you keep this up.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            scene.text('"<i>Mm-! Mmm-! Mm-! Mmm-!</i>"');
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk1');
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk2');
            // TODO-QSP: dynamic text: You grunt in effort as you keep bouncing slowly on <<$npcdesc>>'s cock. His manh...
            scene.text(`You grunt in effort as you keep bouncing slowly on ${((s as any).npcdesc ?? 0)}'s cock. His manhood drives deep inside you, filling you with this weird sort of "pressure." This doesn't feel "good" exactly, but it doesn't feel bad either so you keep on keeping on.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              scene.text('"<i>Ah~! Ahh~! Ahhh~!</i>"');
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk1');
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk2');
              // TODO-QSP: dynamic text: You moan softly as you continue bouncing on <<$npcdesc>>'s cock. It still basica...
              scene.text(`You moan softly as you continue bouncing on ${((s as any).npcdesc ?? 0)}'s cock. It still basically feels numb to your pussy other than the occasional bump, but you don't want him to feel bad about it either so you play along, trying to pretend and rolling your hips in a way you hope at least feels good for him.`);
            } else {
              if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl1.2_dirty_talk');
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk1');
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk2');
                // TODO-QSP: dynamic text: All your dirty talk is just that: talk. Your pussy still barely feels anything o...
                scene.text(`All your dirty talk is just that: talk. Your pussy still barely feels anything other than the occasional bump, but you don't want ${((s as any).npcdesc ?? 0)} to feel bad about it either so you play along, pretending it feels good, and continue on rolling your hips over his.`);
              }
            }
          }
        }
      ...
      if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
        ...
        scene.text(`You pant hard as you keep rolling your hips, focusing on the motions and how good it feels and your pussy almost instinctively tightens around ${((s as any).npcdesc ?? 0)}'s cock. It seems to throb in response inside of you and you think he'll come soon if you keep this up.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk1');
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk2');
          // TODO-QSP: dynamic text: You moan softly into <<$npcdesc>>'s ear as you gently work your hips up and down...
          scene.text(`You moan softly into ${((s as any).npcdesc ?? 0)}'s ear as you gently work your hips up and down his cock.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
            ...
            scene.text(`You moan loudly, letting your voice fill the room as you gently work your pussy up and down ${((s as any).npcdesc ?? 0)}'s cock.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl1.2_dirty_talk');
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl1_boy_talk1');
...
function enterCowgirl2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 75) {
    ...
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
      ...
      if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 25) {
        // TODO-QSP: dynamic text: An grunt of surprise escapes your lips as <<$npcdesc>>'s hips meet yours in a th...
    ...
    scene.text(`You adjust the angle of your hips as you slap them down on top of his ${((s as any).dick_desc ?? 0)} cock, encouraging the movements you want from him. It takes a few minutes of trying, but eventually he starts to get the hang of it.`);
    // TODO-QSP: dynamic text: "<i>"Yes~!"</i> you moan, grinning at <<$npcdesc>>. "Just like that."
    scene.text(`"<i>"Yes~!"</i> you moan, grinning at ${((s as any).npcdesc ?? 0)}. "Just like that."`);
    scene.text('It pays to communicate...');
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    ...
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
        ...
        // TODO-QSP: dynamic text: A pant of exertion escapes your lips, as <<$npcdesc>> isn't doing anything at al...
    ...
    if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          ...
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk2');
          // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips each time ...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips each time your virgin pussy claps against the base of ${((s as any).npcdesc ?? 0)}'s cock. It still hurts, but you're determined not to let a little pain cause you to pussy out of your first time.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk1');
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk2');
            // TODO-QSP: dynamic text: You whimper softly, clenching your teeth as hard as you can as you keep forcing ...
            scene.text(`You whimper softly, clenching your teeth as hard as you can as you keep forcing yourself to work your virgin pussy all the way up and down ${((s as any).npcdesc ?? 0)}'s shaft, bringing your hips down with enough force that the sound of clapping fills the room. It hurts <i>so much</i>, but you can't bring yourself to face the embarrassment of stopping.`);
          }
        }
      }
    } else {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          ...
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk2');
          // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips each time ...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips each time your virgin pussy claps against the base of ${((s as any).npcdesc ?? 0)}'s cock. It hurts like hell, but you don't say anything, trying your best not to let it show and keep on riding.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk1');
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk2');
            // TODO-QSP: dynamic text: You whimper softly, clenching your teeth as hard as you can as you keep forcing ...
            scene.text(`You whimper softly, clenching your teeth as hard as you can as you keep forcing yourself to ride ${((s as any).npcdesc ?? 0)} at a steady pace. The sound of clapping fills the room and it hurts <i>so much</i>, but you can't bring yourself to face the embarrassment of stopping.`);
          }
        }
      }
    }
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          ...
          scene.text(`You keep bouncing up and down on ${((s as any).npcdesc ?? 0)}, focusing on the motions and tightening your pussy around his cock. It seems to throb in response inside of you and you think he'll come soon if you keep this up.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            scene.text('"<i>Mm-! Mmm-! Mm-! Mmm-!</i>"');
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk1');
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk2');
            // TODO-QSP: dynamic text: You grunt in effort as you keep steadily bouncing up and down <<$npcdesc>>'s coc...
            scene.text(`You grunt in effort as you keep steadily bouncing up and down ${((s as any).npcdesc ?? 0)}'s cock. His manhood drives deep inside you, filling you with this weird sort of "pressure." This doesn't feel "good" exactly, but it doesn't feel bad either so you keep on keeping on.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              scene.text('"<i>Ah~! Ahh~! Ahhh~!</i>"');
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk1');
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk2');
              // TODO-QSP: dynamic text: You moan softly as you steadily bounce up and down <<$npcdesc>>'s cock. It still...
              scene.text(`You moan softly as you steadily bounce up and down ${((s as any).npcdesc ?? 0)}'s cock. It still basically feels numb to your pussy other than the occasional bump, but you don't want him to feel bad about it either so you play along, trying to pretend and hoping that this at least feels good for him.`);
            } else {
              if (((s as any).sex_ev ?? 0)?.['dirty_talk_count'] === 1) {
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl2.2_dirty_talk');
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk1');
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk2');
                // TODO-QSP: dynamic text: All your dirty talk is just that: talk. Your pussy still barely feels anything o...
                scene.text(`All your dirty talk is just that: talk. Your pussy still barely feels anything other than the occasional bump, but you don't want ${((s as any).npcdesc ?? 0)} to feel bad about it either so you play along, pretending it feels good, and continue bouncing up and down his cock.`);
              }
            }
          }
        }
      ...
      if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
        ...
        qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk1');
        qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk2');
        // TODO-QSP: dynamic text: You pant hard as you keep bouncing on <<$npcdesc>>'s cock, focusing on the motio...
        scene.text(`You pant hard as you keep bouncing on ${((s as any).npcdesc ?? 0)}'s cock, focusing on the motions and how good it feels and your pussy almost instinctively tightens around him. He seems to throb in response inside of you and you think you'll both come soon if you keep this up.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk1');
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk2');
          // TODO-QSP: dynamic text: You keep bouncing up and down on <<$npcdesc>>'s cock, your own heavy panting fil...
          scene.text(`You keep bouncing up and down on ${((s as any).npcdesc ?? 0)}'s cock, your own heavy panting filling your ears.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
            scene.text('"<i>Ah~! Yes~! Mmm~!</i>"');
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk1');
            ...
            scene.text(`You moan loudly, letting your voice fill the room as you bounce up and down ${((s as any).npcdesc ?? 0)}'s cock.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl1.2_dirty_talk');
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk1');
              ...
              if (((s as any).sex_ev ?? 0)?.['casual_talk'] > 0) {
                ...
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk1');
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl2_boy_talk2');
                // TODO-QSP: dynamic text: You bounce up and down on <<$npcdesc>>'s cock, focusing on the hammering you fee...
                scene.text(`You bounce up and down on ${((s as any).npcdesc ?? 0)}'s cock, focusing on the hammering you feel deep inside you, letting the reverberations of your hips and his course through your body from your sex to the tips of your nipples.`);
              }
            }
          }
        }
...
function enterCowgirl3(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 75) {
    ...
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
      ...
      if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'average') {
        // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips on the next bounce as <<$npcdesc>>'s hi...
        scene.text(`An uncontrollable gasp escapes your lips on the next bounce as ${((s as any).npcdesc ?? 0)}'s hips meet yours in a thrust from underneath that sends shocks of pleasure racing through your body. He's not just proactive, he's attentive too. You can feel how his movements react to yours, each thrust feeling better than the last. <i>Damn</i>, does he know how to use his dick!`);
      } else {
        if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'big') {
          // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips on the next bounce as <<$npcdesc>>'s hi...
          scene.text(`An uncontrollable gasp escapes your lips on the next bounce as ${((s as any).npcdesc ?? 0)}'s hips meet yours in a thrust from underneath that sends shocks of pleasure racing through your body. He doesn't just have a big cock, he knows how to use it too. You can feel how his movements react to yours, each thrust feeling better than the last. If it hits an awkward spot, you feel him adjust. If it hits you just right, he responds to the squeeze of your pussy.`);
          scene.text('Oh <i>fuck</i>. He\'s good at this.');
        } else {
          if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'extra_big') {
            // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips on the next bounce as <<$npcdesc>>'s hi...
            scene.text(`An uncontrollable gasp escapes your lips on the next bounce as ${((s as any).npcdesc ?? 0)}'s hips meet yours in a thrust from underneath that sends shocks of pleasure racing through your body. He doesn't just have a gigantic cock, he knows how to use it too. You would think that being fucked with such a giant dick would hurt, and it occasionally does, but not as often as you expected. His movements react to yours, each thrust feeling better than the last. If it hits an awkward spot, you feel him adjust his angle beneath you. If it hits you just right, he responds to the squeeze of your pussy, minimizing pain and maximizing pleasure.`);
            scene.text('Oh <i>fuck</i>. He\'s good at this.');
          }
        }
      }
    ...
    scene.text(`You adjust the angle of your hips as you smash them down on top of his ${((s as any).dick_desc ?? 0)} cock, encouraging the movements you want from him. It takes a few minutes of trying, but eventually he starts to get the hang of it.`);
    // TODO-QSP: dynamic text: "<i>Y-e-e-e-e-s-s-s-s-s~!</i> you moan, grinning at <<$npcdesc>>. Just like that...
    scene.text(`"<i>Y-e-e-e-e-s-s-s-s-s~!</i> you moan, grinning at ${((s as any).npcdesc ?? 0)}. Just like that!"`);
    scene.text('It pays to communicate...');
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
  ...
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        scene.text(`You furiously work your hips up and down as you continue forcing yourself to ride ${((s as any).npcdesc ?? 0)} as hard as you can. You don't give yourself any time to think, focusing only on slamming down on ${((s as any).npcdesc ?? 0)}'s cock as fast as you can. Because of this, it's not for a while that you realize with a start that the pain has gone away. Seems like your virgin pussy is getting used to riding hard.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          scene.text('"<i>Nn-! Nngh-! Ngh-!</i>"');
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk1');
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk2');
          // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips each time ...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips each time your virgin pussy slams to the base of ${((s as any).npcdesc ?? 0)}'s cock. The agony induced by your rough riding is nearly unbearable, but you're pridefully determined not to give up and try to give ${((s as any).npcdesc ?? 0)} the ride of his life with your virgin pussy.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk1');
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk2');
            // TODO-QSP: dynamic text: You clench your teeth as hard as you can and squeeze your eyes shut, trying to k...
            scene.text(`You clench your teeth as hard as you can and squeeze your eyes shut, trying to keep yourself from crying as you force yourself to slam your virgin pussy down on ${((s as any).npcdesc ?? 0)}'s shaft over and over. Part of you wonders why you're doing this and your insides feel battered and bruised, but you can't bring yourself to face the embarrassment of stopping.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 4) {
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk1');
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk2');
              // TODO-QSP: dynamic text: You sob openly as you smash your pussy down onto <<$npcdesc>>'s cock. It hurts s...
              scene.text(`You sob openly as you smash your pussy down onto ${((s as any).npcdesc ?? 0)}'s cock. It hurts so much you think you're going to die, but for some reason your hips won't stop moving. A wordless cry leaves your lips and you keep riding ${((s as any).npcdesc ?? 0)} like you're trying to impale yourself as a virgin sacrifice on his shaft.`);
            }
          }
        }
      }
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk2');
        // TODO-QSP: dynamic text: You furiously work your hips up and down as you continue forcing yourself to rid...
        scene.text(`You furiously work your hips up and down as you continue forcing yourself to ride ${((s as any).npcdesc ?? 0)} as hard as you can. You don't give yourself any time to think, focusing only on slamming down on ${((s as any).npcdesc ?? 0)}'s cock as fast as you can. Because of this, it's not for a while that you realize with a start that the pain has gone away. Seems like your pussy is getting used to riding hard.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          scene.text('"<i>Nn-! Nngh-! Ngh-!</i>"');
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk1');
          qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk2');
          // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips each time ...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips each time your virgin pussy slams to the base of ${((s as any).npcdesc ?? 0)}'s cock. The agony induced by your rough riding is nearly unbearable, but you're pridefully determined not to give up and try to give ${((s as any).npcdesc ?? 0)} the ride of his life.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk1');
            qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk2');
            // TODO-QSP: dynamic text: You clench your teeth as hard as you can and squeeze your eyes shut, trying to k...
            scene.text(`You clench your teeth as hard as you can and squeeze your eyes shut, trying to keep yourself from crying as you force yourself to slam yourself down on ${((s as any).npcdesc ?? 0)}'s shaft over and over. Part of you wonders why you're doing this and your insides feel battered and bruised, but you can't bring yourself to face the embarrassment of stopping.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 4) {
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk1');
              qspCall(s, 'sex_ev_cowgirl', 'cowgirl3_boy_talk2');
              // TODO-QSP: dynamic text: You sob openly as you smash your pussy down onto <<$npcdesc>>'s cock. It hurts s...
              scene.text(`You sob openly as you smash your pussy down onto ${((s as any).npcdesc ?? 0)}'s cock. It hurts so much you think you're going to die, but for some reason your hips won't stop moving. A wordless cry leaves your lips and you keep riding ${((s as any).npcdesc ?? 0)} like you're trying to impale yourself on his shaft.`);
            }
          }
        }
      }
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          ...
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            scene.text('"<i>Mm-! Mmm-! Mm-! Mmm-!</i>"');
            // TODO-QSP: dynamic text: You grunt in effort as you keep furiously bouncing up and down <<$npcdesc>>'s co...
            scene.text(`You grunt in effort as you keep furiously bouncing up and down ${((s as any).npcdesc ?? 0)}'s cock. His manhood hammers deep inside you, slamming into you in a way that doesn't exactly feel "good", but it doesn't feel bad either so you keep on keeping on.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              scene.text('"<i>Ah~! Ahh~! Ahhh~!</i>"');
              // TODO-QSP: dynamic text: You let out ragged moans as you furiously bounce up and down <<$npcdesc>>'s cock...
              scene.text(`You let out ragged moans as you furiously bounce up and down ${((s as any).npcdesc ?? 0)}'s cock. It still basically feels numb to your pussy other than the occasional bump, but you feel like it's important for you to try your best and pretend like this feels good so you keep tiredly riding ${((s as any).npcdesc ?? 0)} as hard as you can.`);
            } else {
              if (((s as any).sex_ev ?? 0)?.['dirty_talk_count'] === 1) {
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl1.2_dirty_talk');
                // TODO-QSP: dynamic text: All your dirty talk is just that: talk. Your pussy still barely feels anything o...
                scene.text(`All your dirty talk is just that: talk. Your pussy still barely feels anything other than the occasional bump, but this is about making ${((s as any).npcdesc ?? 0)} feel good, so you keep violently riding ${((s as any).npcdesc ?? 0)}'s cock like there's no tomorrow.`);
              }
            }
          }
        }
      ...
      if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['cowgirl_rand'] === 2) {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            ...
            scene.text(`You groan in pleasure as you violently bounce your hips up and down on ${((s as any).npcdesc ?? 0)}'s cock.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              scene.text('"<i>Ah~! Yes~! Mmm~!</i>"');
              // TODO-QSP: dynamic text: You moan loudly, letting your voice fill the room as you slam your pussy down <<...
              scene.text(`You moan loudly, letting your voice fill the room as you slam your pussy down ${((s as any).npcdesc ?? 0)}'s cock over and over again.`);
            } else {
              if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl1.2_dirty_talk');
              } else {
                // TODO-QSP: dynamic text: You pant loudly, breasts bouncing in the air while you bounce on <<$npcdesc>>'s ...
                scene.text(`You pant loudly, breasts bouncing in the air while you bounce on ${((s as any).npcdesc ?? 0)}'s dick, loving every thrust and every second.`);
              }
            }
          }
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            ...
            // TODO-QSP: dynamic text: You pant desperately as <<$npcdesc>> thrusts into you from below, so hard it's l...
            scene.text(`You pant desperately as ${((s as any).npcdesc ?? 0)} thrusts into you from below, so hard it's like he's fucking the breath from your lungs. It's <i>amazing.</i>`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              scene.text('"<i>AH~! AH~! YES~! YES~! AHH~!</i>"');
              // TODO-QSP: dynamic text: Your voice echoes off the walls mixing with the sound of <<$npcdesc>>'s hips sla...
              scene.text(`Your voice echoes off the walls mixing with the sound of ${((s as any).npcdesc ?? 0)}'s hips slamming into yours from below over and over again.`);
            } else {
              if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
                qspCall(s, 'sex_ev_cowgirl', 'cowgirl1.2_dirty_talk');
              } else {
                // TODO-QSP: dynamic text: You groan wordlessly, letting your eyes roll back in your skull while <<$npcdesc...
                scene.text(`You groan wordlessly, letting your eyes roll back in your skull while ${((s as any).npcdesc ?? 0)} does all the work, violently thrusting up into you over and over and over, sending earthquakes of pleasure coursing through your entire body.`);
              }
            }
          }
        }
              ...
              if (((s as any).dick_desc ?? 0) === 'huge') {
                ...
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  ...
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    if (((s as any).pcs_vag ?? 0) <= 15) {
                      // TODO-QSP: dynamic text: You gently roll your hips over his, unable to fit the full length of <<$npcdesc>...
                      scene.text(`You gently roll your hips over his, unable to fit the full length of ${((s as any).npcdesc ?? 0)}'s ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock inside your pussy as it painfully bumps up against your cervix.`);
                    } else {
                      // TODO-QSP: dynamic text: You gently roll your hips over his, barely to fit the full length of <<$npcdesc>...
                      scene.text(`You gently roll your hips over his, barely to fit the full length of ${((s as any).npcdesc ?? 0)}'s ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock inside your pussy as it presses hard against your cervix.`);
                    }
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      if (((s as any).pcs_vag ?? 0) <= 15) {
                        // TODO-QSP: dynamic text: You gently roll your hips over his, unable to fit the full length of <<$npcdesc>...
                        scene.text(`You gently roll your hips over his, unable to fit the full length of ${((s as any).npcdesc ?? 0)}'s ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock inside your pussy as it fills you all the way to your cervix, bumping up hard against it.`);
                      } else {
                        // TODO-QSP: dynamic text: You gently roll your hips over his, barely able to fit the full length of <<$npc...
                        scene.text(`You gently roll your hips over his, barely able to fit the full length of ${((s as any).npcdesc ?? 0)}'s ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock inside your pussy as it fills you all the way to your cervix, pressing hard against it.`);
                      }
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        if (((s as any).pcs_vag ?? 0) <= 10) {
                          // TODO-QSP: dynamic text: You gently roll your hips over his, unable to fit the full length of <<$npcdesc>...
                          scene.text(`You gently roll your hips over his, unable to fit the full length of ${((s as any).npcdesc ?? 0)}'s monstrous ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock inside your bleeding snatch. Too long and too wide for your tight pussy, it feels like being impaled in every sense of the word.`);
                        } else {
                          if (((s as any).pcs_vag ?? 0) <= 25) {
                            // TODO-QSP: dynamic text: You gently roll your hips over his, barely to fit the full length of <<$npcdesc>...
                            scene.text(`You gently roll your hips over his, barely to fit the full length of ${((s as any).npcdesc ?? 0)}'s monstrous ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock inside your bleeding snatch. You're no virgin, but even for your experienced pussy it feels like fucking a telephone pole.`);
                          } else {
                            // TODO-QSP: dynamic text: You gently roll your hips over his, barely to fit the full length of <<$npcdesc>...
                            scene.text(`You gently roll your hips over his, barely to fit the full length of ${((s as any).npcdesc ?? 0)}'s monstrous ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock inside your bleeding snatch. It fills you completely, and even for your experienced pussy, you feel barely able to contain it.`);
                          }
                        }
                      }
                    }
  ...
  if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    ...
    if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 2) {
        ...
        scene.text(`${((s as any).npcdesc ?? 0)} murmurs his words softly as he thrusts into you from on top.`);
      } else {
        if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 3) {
...
function enterCowgirl1EnjoyDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    // TODO-QSP: dynamic text: You focus on <<$npcdesc>>'s tiny dick inside you, getting the angle just right t...
    scene.text(`You focus on ${((s as any).npcdesc ?? 0)}'s tiny dick inside you, getting the angle just right to rub against your g-spot. His hips move with yours, spreading warmth and pleasure through your entire body.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You focus on <<$npcdesc>>'s dick inside you, its fat girth stretching you in a p...
      scene.text(`You focus on ${((s as any).npcdesc ?? 0)}'s dick inside you, its fat girth stretching you in a pleasant way while you angle it so its meager length rubs right against your g-spot. His hips move with yours, spreading warmth and pleasure through your entire body.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You focus on <<$npcdesc>>'s skinny dick inside you. Its thin girth makes it easy...
        scene.text(`You focus on ${((s as any).npcdesc ?? 0)}'s skinny dick inside you. Its thin girth makes it easy to get the angle just right to rub against your g-spot. His hips move with yours, spreading warmth and pleasure through your entire body.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You focus on <<$npcdesc>>'s dick inside you. It fills you nicely, meaning it isn...
          scene.text(`You focus on ${((s as any).npcdesc ?? 0)}'s dick inside you. It fills you nicely, meaning it isn't hard to get it to rub against your g-spot. His hips move with yours, spreading warmth and pleasure through your entire body.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You focus on <<$npcdesc>>'s cock inside you. Its thick shaft stretches you out, ...
            scene.text(`You focus on ${((s as any).npcdesc ?? 0)}'s cock inside you. Its thick shaft stretches you out, filling you u p so much that it's constantly rubbing against your g-spot. His hips move with yours, spreading warmth and pleasure through your entire body.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
...
function enterCowgirl1_1Desc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    // TODO-QSP: dynamic text: You slow down to a to a crawl, gently rolling your hips over <<$npcdesc>>'s, foc...
    scene.text(`You slow down to a to a crawl, gently rolling your hips over ${((s as any).npcdesc ?? 0)}'s, focusing hard on making sure the feel of his tiny dick isn't lost in the pounding of your bodies.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You slow down to a to a crawl, gently rolling your hips over <<$npcdesc>>'s, foc...
      scene.text(`You slow down to a to a crawl, gently rolling your hips over ${((s as any).npcdesc ?? 0)}'s, focusing hard on making sure the feel of his thick chode isn't lost in the pounding of your bodies.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You slow down to a to a crawl, gently rolling your hips over <<$npcdesc>>'s, foc...
        scene.text(`You slow down to a to a crawl, gently rolling your hips over ${((s as any).npcdesc ?? 0)}'s, focusing hard on making sure the feel of his skinny dick isn't lost in the pounding of your bodies.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You slow down to a to a crawl, gently rolling your hips over <<$npcdesc>>'s, foc...
          scene.text(`You slow down to a to a crawl, gently rolling your hips over ${((s as any).npcdesc ?? 0)}'s, focusing on feeling the full shape of his dick inside you.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).pcs_vag ?? 0) <= 10) {
              // TODO-QSP: dynamic text: You slow down to a to a crawl, gently rolling your hips over <<$npcdesc>>'s, fee...
              scene.text(`You slow down to a to a crawl, gently rolling your hips over ${((s as any).npcdesc ?? 0)}'s, feeling every contour and vein of his thick cock inside your tight pussy.`);
            } else {
              // TODO-QSP: dynamic text: You slow down to a to a crawl, gently rolling your hips over <<$npcdesc>>'s, foc...
              scene.text(`You slow down to a to a crawl, gently rolling your hips over ${((s as any).npcdesc ?? 0)}'s, focusing on feeling every contour and vein of his thick cock inside your pussy.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You slow down to a to a crawl, gently rolling your hips over <<$npcdesc>>'s, foc...
              scene.text(`You slow down to a to a crawl, gently rolling your hips over ${((s as any).npcdesc ?? 0)}'s, focusing depth of his cock inside you, grinding its length up against your cervix.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You slow down to a to a crawl, gently rolling your hips over <<$npcdesc>>'s, gri...
                scene.text(`You slow down to a to a crawl, gently rolling your hips over ${((s as any).npcdesc ?? 0)}'s, grinding yourself against the huge cock that fills you.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You slow down to a to a crawl, gently rolling your hips over <<$npcdesc>>'s, gri...
                  scene.text(`You slow down to a to a crawl, gently rolling your hips over ${((s as any).npcdesc ?? 0)}'s, grinding yourself against the enormous cock that stretches your pussy in both width and length.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You slow down to a to a crawl, carefully bouncing your hips up and down on <<$np...
                    scene.text(`You slow down to a to a crawl, carefully bouncing your hips up and down on ${((s as any).npcdesc ?? 0)}'s cock, so lengthy that you feel it bounce off your cervix without ever being able to reach its base.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You slow down to a to a crawl, carefully bouncing your hips up and down on <<$np...
                      scene.text(`You slow down to a to a crawl, carefully bouncing your hips up and down on ${((s as any).npcdesc ?? 0)}'s gigantic cock, so big that you feel it bounce off your cervix without ever being able to reach its base.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: You slow down to a to a crawl, carefully bouncing your hips up and down on <<$np...
                        scene.text(`You slow down to a to a crawl, carefully bouncing your hips up and down on ${((s as any).npcdesc ?? 0)}'s monstrous cock, so big that you feel it bounce off your cervix without ever being able to reach the bottom of its thick trunk.`);
                      }
                    }
                  }
                }
...
function enterCowgirl1_2MoanDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
    ...
    if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
      ...
      scene.text(`You mew softly as you keep grinding against ${((s as any).npcdesc ?? 0)}'s tiny dick inside you, unable to keep your voice contained as it rubs up against your g-spot <i>just</i> right.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'chode') {
        // TODO-QSP: dynamic text: You mew softly as you keep grinding against <<$npcdesc>>'s thick chode inside yo...
        scene.text(`You mew softly as you keep grinding against ${((s as any).npcdesc ?? 0)}'s thick chode inside you, unable to keep your voice contained as it stretches your pussy <i>just</i> right.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          // TODO-QSP: dynamic text: You mew softly as you keep grinding against <<$npcdesc>>'s skinny dick inside yo...
          scene.text(`You mew softly as you keep grinding against ${((s as any).npcdesc ?? 0)}'s skinny dick inside you, unable to keep your voice contained as it rubs up against your g-spot <i>just</i> right.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'normal') {
            // TODO-QSP: dynamic text: You mew softly as you keep grinding against <<$npcdesc>>'s dick inside you, unab...
            scene.text(`You mew softly as you keep grinding against ${((s as any).npcdesc ?? 0)}'s dick inside you, unable to keep your voice contained as it rubs up against your g-spot <i>just</i> right.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'thick') {
              // TODO-QSP: dynamic text: You mew softly as you keep grinding against <<$npcdesc>>'s thick cock inside you...
              scene.text(`You mew softly as you keep grinding against ${((s as any).npcdesc ?? 0)}'s thick cock inside you, unable to keep your voice contained as it rubs up against your g-spot and stretches you out in the most satisfying way.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'long') {
                // TODO-QSP: dynamic text: You mew softly as you keep grinding against <<$npcdesc>>'s cock inside you, unab...
                scene.text(`You mew softly as you keep grinding against ${((s as any).npcdesc ?? 0)}'s cock inside you, unable to keep your voice contained as it rubs up against your cervix in the most satisfying way.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'huge') {
  ...
  if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'cock') {
    if ((Math.floor(Math.random() * 2) + 1) === 1) {
      if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
        ...
        scene.text(`"Ahh~! Your cock feels so good~!" you moan, your voice a hoarse with arousal as you roll your hips over ${((s as any).npcdesc ?? 0)}. "Your tiny dick is gonna make me come~!"`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'chode') {
          // TODO-QSP: dynamic text: "Ahh~! Your cock feels so good~!" you moan, your voice a hoarse with arousal as ...
          scene.text(`"Ahh~! Your cock feels so good~!" you moan, your voice a hoarse with arousal as you roll your hips over ${((s as any).npcdesc ?? 0)}. "Your fat chode is gonna make me come~!"`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'skinny') {
            // TODO-QSP: dynamic text: "Ahh~! Your cock feels so good~!" you moan, your voice a hoarse with arousal as ...
            scene.text(`"Ahh~! Your cock feels so good~!" you moan, your voice a hoarse with arousal as you roll your hips over ${((s as any).npcdesc ?? 0)}. "I can feel you moving inside me~! It's so good~!"`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'normal') {
              // TODO-QSP: dynamic text: "Ahh~! Your cock feels so good~!" you moan, your voice a hoarse with arousal as ...
              scene.text(`"Ahh~! Your cock feels so good~!" you moan, your voice a hoarse with arousal as you roll your hips over ${((s as any).npcdesc ?? 0)}. "You're filling me up just right~! It's like your cock was made for my pussy~!"`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'thick') {
                if (((s as any).pcs_vag ?? 0) <= 10) {
                    ...
                    if (((s as any).dick_desc ?? 0) === 'enormous') {
                      ...
                      if (((s as any).dick_desc ?? 0) === 'lengthy') {
                        ...
                        if (((s as any).dick_desc ?? 0) === 'gigantic') {
                          ...
                          if (((s as any).dick_desc ?? 0) === 'monstrous') {
                            // TODO-QSP: dynamic text: "<i>Ungh~! Fuck~!</i>" you groan, struggling to ride <<$npcdesc>>'s massive cock...
                            scene.text(`"<i>Ungh~! Fuck~!</i>" you groan, struggling to ride ${((s as any).npcdesc ?? 0)}'s massive cock. "Your cock is so <i>fucking big~!</i> It's like a baseball bat in my pussy~! I can feel you in my stomach~! Nngh~! I feel like I'm gonna throw up~! But I can't stop moving~! Oh god it's gonna rip me in half~!"`);
                          }
                        }
                      }
                    }
      ...
      if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'technique') {
        ...
        if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'dirty_girl') {
          if (((s as any).npc_dirty_lover ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
            // TODO-QSP: dynamic text: "Who's pussy is this?" <<$npcdesc>> growls as he moves his cock inside you unexp...
            scene.text(`"Who's pussy is this?" ${((s as any).npcdesc ?? 0)} growls as he moves his cock inside you unexpectedly, guiding your hips with his hands.`);
      ...
      if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'technique') {
        ...
        if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'dirty_girl') {
          if (((s as any).npc_dirty_lover ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
            ...
            scene.text(`"Who's pussy is this?" ${((s as any).npcdesc ?? 0)} growls as he yanks your hips down, slamming your pussy onto his cock.`);
            scene.text('"Yours~!" you whimper atop him.');
          } else {
            if (((s as any).pcs_horny ?? 0) >= 70) {
              if ((Math.floor(Math.random() * 1) + 1) === 1) {
  ...
  if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    ...
    if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 2) {
        ...
        scene.text(`${((s as any).npcdesc ?? 0)} growls as he smashes your pussy from above.`);
      } else {
        if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 3) {
      ...
      if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'technique') {
        ...
        if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'dirty_girl') {
          if (((s as any).npc_dirty_lover ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
            ...
            scene.text(`"Who's pussy is this?" ${((s as any).npcdesc ?? 0)} growls as he thrusts his cock into you from below like an inverted jackhammer.`);

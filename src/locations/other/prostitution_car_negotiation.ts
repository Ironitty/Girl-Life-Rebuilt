...
function enterGeneralDescription(s: GameState, scene: SceneBuilder): void {
  if (((s as any).prostitute ?? 0)?.['customer_total'] > 9) {
    scene.text('A blowjob, anal oder vaginal scene can consist of up to three or only one small scene. Currently there can be ' + ((((s as any).prostitute ?? 0)?.['scene_reduction'] === 0) ? ('up to <a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute ??= {})\u0027scene_reduction\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">three</a>') : ('only <a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute ??= {})\u0027scene_reduction\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">one</a>')) + ' small scene' + ((((s as any).prostitute ?? 0)?.['scene_reduction'] === 0) ? ('s.') : ('.')));
    ...
    scene.text(' - End scene will be ' + ((((s as any).prostitute ?? 0)?.['skip_end'] === 0) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute ??= {})\u0027skip_end\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">shown</a>.') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute ??= {})\u0027skip_end\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">skipped</a>.')));
    scene.text(' - Start scene will be ' + ((((s as any).prostitute ?? 0)?.['skip_start'] === 0) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute ??= {})\u0027skip_start\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">shown</a>.') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute ??= {})\u0027skip_start\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">skipped</a>.')));
    ...
    scene.text('Negotiation: ' + ((((s as any).prostitute_auto ?? 0)?.['normal'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027normal\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Automatic</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027normal\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Manual</a>')));
    if (((s as any).prostitute_auto ?? 0)?.['normal'] === 1) {
      scene.text('Which acts do you automatically accept/decline?');
      scene.text('Blowjob: ' + ((((s as any).prostitute_auto ?? 0)?.['norm_bj'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_bj\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Accept</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_bj\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Decline</a>')));
      scene.text('Vaginal: ' + ((((s as any).prostitute_auto ?? 0)?.['norm_vag'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_vag\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Accept</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_vag\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Decline</a>')));
      scene.text('Anal: ' + ((((s as any).prostitute_auto ?? 0)?.['norm_anal'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_anal\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Accept</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_anal\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Decline</a>')));
      if (((s as any).prostitute_auto ?? 0)?.['norm_bj'] + ((s as any).prostitute_auto ?? 0)?.['norm_vag'] + ((s as any).prostitute_auto ?? 0)?.['norm_anal'] > 0) {
        ...
        if (((s as any).prostitute_auto ?? 0)?.['norm_bj'] === 1) {
          scene.text('- Blowjob: ' + ((((s as any).prostitute_auto ?? 0)?.['norm_bj_condom'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_bj_condom\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Yes</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_bj_condom\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">No</a>')));
        }
        if (((s as any).prostitute_auto ?? 0)?.['norm_vag'] === 1) {
          scene.text('- Vaginal: ' + ((((s as any).prostitute_auto ?? 0)?.['norm_vag_condom'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_vag_condom\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Yes</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_vag_condom\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">No</a>')));
        }
        if (((s as any).prostitute_auto ?? 0)?.['norm_anal'] === 1) {
          scene.text('- Anal: ' + ((((s as any).prostitute_auto ?? 0)?.['norm_anal_condom'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_anal_condom\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Yes</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_anal_condom\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">No</a>')));
        }
        if (((s as any).prostitute_auto ?? 0)?.['norm_bj_condom'] === 0  ||  ((s as any).prostitute_auto ?? 0)?.['norm_vag_condom'] === 0  ||  ((s as any).prostitute_auto ?? 0)?.['norm_anal_condom'] === 0) {
          ...
          if (((s as any).prostitute_auto ?? 0)?.['norm_bj_condom'] === 0  &&  ((s as any).prostitute_auto ?? 0)?.['norm_bj'] === 1) {
            scene.text('- Blowjob: ' + ((((s as any).prostitute_auto ?? 0)?.['norm_bj_creampie'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_bj_creampie\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Yes</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_bj_creampie\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">No</a>')));
          }
          if (((s as any).prostitute_auto ?? 0)?.['norm_vag_condom'] === 0  &&  ((s as any).prostitute_auto ?? 0)?.['norm_vag'] === 1) {
            scene.text('- Vaginal: ' + ((((s as any).prostitute_auto ?? 0)?.['norm_vag_creampie'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_vag_creampie\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Yes</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_vag_creampie\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">No</a>')));
          }
          if (((s as any).prostitute_auto ?? 0)?.['norm_anal_condom'] === 0  &&  ((s as any).prostitute_auto ?? 0)?.['norm_anal'] === 1) {
            scene.text('- Anal: ' + ((((s as any).prostitute_auto ?? 0)?.['norm_anal_creampie'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_anal_creampie\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Yes</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027norm_anal_creampie\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">No</a>')));
          }
        }
      }
    }
    scene.text('</td><td></td><td valign="top"><b>Behavior towards regular clients:</b>');
    scene.text('Negotiation: ' + ((((s as any).prostitute_auto ?? 0)?.['regular'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027regular\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Automatic</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027regular\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Manual</a>')));
    if (((s as any).prostitute_auto ?? 0)?.['regular'] === 1) {
      scene.text('Do you insist on a condom?');
      scene.text('- Vaginal: ' + ((((s as any).prostitute_auto ?? 0)?.['reg_vag_condom'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027reg_vag_condom\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Yes</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027reg_vag_condom\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">No</a>')));
      scene.text('- Anal: ' + ((((s as any).prostitute_auto ?? 0)?.['reg_anal_condom'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027reg_anal_condom\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Yes</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027reg_anal_condom\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">No</a>')));
      if (((s as any).prostitute_auto ?? 0)?.['reg_anal_condom'] === 0  ||  ((s as any).prostitute_auto ?? 0)?.['reg_vag_condom'] === 0) {
        ...
        if (((s as any).prostitute_auto ?? 0)?.['reg_vag_condom'] === 0) {
          scene.text('- Vaginal: ' + ((((s as any).prostitute_auto ?? 0)?.['reg_vag_creampie'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027reg_vag_creampie\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Yes</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027reg_vag_creampie\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">No</a>')));
        }
        if (((s as any).prostitute_auto ?? 0)?.['reg_anal_condom'] === 0) {
          scene.text('- Anal: ' + ((((s as any).prostitute_auto ?? 0)?.['reg_anal_creampie'] === 1) ? ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027reg_anal_creampie\u0027 = 0; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">Yes</a>') : ('<a href="#" onclick="window.__gameStore.setState((s) => { (s.prostitute_auto ??= {})\u0027reg_anal_creampie\u0027 = 1; return s; }); window.__gameStore.getState().doGoto(String((s as any).loc ?? \u0027\u0027), \u0027work\u0027); return false;">No</a>')));
        }
      }
    }
...
function enterLookClient(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).prostitute ?? 0)?.['regular'] === 1) {
    qspGoto(s, 'prostitution_car_negotiation', 'client_regular', 'look_client');
  } else {
        ...
        if (((s as any).prostitute ?? 0)?.['propose'] === 0  &&  ((s as any).prostitute_auto ?? 0)?.['normal'] === 0) {
          ...
          if (((s as any).prostitute_auto ?? 0)?.['normal'] === 1) {
            ...
            if (((s as any).klismaday ?? 0) !== ((s as any).daystart ?? 0)) {
              scene.text(((((s as any).prostitute ?? 0)?.['dirty_anal_mod'] === 0) ? ('He hates') : ('He admits that he loves')) + ' anal sex with a girl that didn\'t clean herself and he will pay significantly ' + ((((s as any).prostitute ?? 0)?.['dirty_anal_mod'] === 0) ? ('less') : ('more')) + ' for it.');
            }
            if (((s as any).mesec ?? 0) > 0) {
              scene.text(((((s as any).prostitute ?? 0)?.['mesec_mod'] === 0) ? ('He really doesn\'t like') : ('He tells you that he likes')) + ' to fuck girls that have their period.');
            }
            scene.text('You offer him…');
            if ((Math.floor(Math.random() * 10) + 1) < 10) {
              scene.actions([
                { label: 'A blowjob', handler: (st: GameState) => {
    (st as any).prostitute[client_scene] = 'Blowjob';
  }, goto: ['prostitution_car_negotiation', 'negotiation_start'] },
                { label: 'Your pussy', handler: (st: GameState) => {
    (st as any).prostitute[client_scene] = 'Vaginal';
  }, goto: ['prostitution_car_negotiation', 'negotiation_start'] },
                { label: 'Your ass', handler: (st: GameState) => {
    (st as any).prostitute[client_scene] = 'Anal';
  }, goto: ['prostitution_car_negotiation', 'negotiation_start'] },
              ]);
            } else {
              scene.actions([
                { label: 'A blowjob', handler: (st: GameState) => {
    if (((st as any).prostitute ?? 0)?.['client_scene'] !== 'Blowjob') {
      ((st as any).prostitute = (st as any).prostitute ?? {})['propose'] = 2;
    }
    qspGoto(st, 'prostitution_car_negotiation', 'negotiation_start');
  } },
                { label: 'Your pussy', handler: (st: GameState) => {
    ...
    qspGoto(st, 'prostitution_car_negotiation', 'negotiation_start');
        ...
        qspGoto(s, 'prostitution_car_negotiation', 'rough');
      }
    } else {
      ((s as any).prostitute = (s as any).prostitute ?? {})['pity_counter'] = ((s as any).prostitute['pity_counter'] ?? 0) + ((Math.floor(Math.random() * 5) + 4));
...
function enterClientRegular(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Hi ${(((st as any).prostitute_names ?? 0)?.[String((st as any).prostitution_location ?? 0)] ?? '')}. I was looking for you." He says in a good mood clearly happy to see you.`);
    ...
    scene.text('"I was hoping that you would work today," he tells you and you give him a smile. You remember that he ' + ((((st as any).prostitute ?? 0)?.['client_scene'] === 'Vaginal') ? ('never asked to fuck your ass and always preferred your pussy.') : ('always preferred to fuck your ass.')));
    ...
    qspGoto(st, 'prostitution_car_negotiation', 'client_regular_fail');
  } },
        ]);
      }
      scene.actions([
        { label: '', labelFn: (s: GameState) => String('… you guess he wants to fuck your ' + ((((st as any).prostitute ?? 0)?.['client_scene'] === 'Vaginal') ? ('pussy') : ('ass')) + '' ?? ''), handler: (st: GameState) => {
    ...
    if (((st as any).prostitute ?? 0)?.['std_mod'] === 0  &&  ((st as any).prostitute_auto ?? 0)?.['regular'] === 0) {
      scene.actions([
        { label: 'Always use a condom', handler: (st: GameState) => {
    scene.text('… always use a condom.' + (((((st as any).mc_inventory ?? 0)?.['normal_condoms'] < 1  &&  ((st as any).mc_inventory ?? 0)?.['equipped_condoms'] <1)) ? (' But you don\'t have any with you') : ('')));
    scene.actions([
      { label: 'Don\'t make an exception', handler: (st: GameState) => {
    (st as any).prostitute_client_condom = 'Yes';
    ...
    if (((st as any).mc_inventory ?? 0)?.['normal_condoms'] > 0  ||  ((st as any).mc_inventory ?? 0)?.['equipped_condoms'] > 0) {
      ...
      if (qspFunc(s, 'money', 'can_afford', 60)) {
        ...
        ((st as any).mc_inventory = (st as any).mc_inventory ?? {})['normal_condoms'] = 1;
        qspCall(st, 'stat', '');
        scene.actions([
          { label: 'Continue', goto: ['prostitution_car_negotiation', 'client_regular_success'] },
        ]);
      } else {
        scene.text(`He sighs and after a second he shrugs. "Fine," he looks at you and reassures you. "Don't worry about it ${(((st as any).prostitute_names ?? 0)?.[String((st as any).prostitution_location ?? 0)] ?? '')}, you're always worth waiting for."`);
        scene.actions([
    ...
    (st as any).prostitute_client_condom = 'No';
    ...
    (st as any).prostitute_client_cumshot = 'Outside';
    qspCall(st, 'prostitution_functions', 'payment', 'condom_no', 'inside_no');
    ...
    (st as any).prostitute_client_cumshot = 'Inside';
    qspCall(st, 'prostitution_functions', 'payment', 'condom_no', 'inside_yes');
    scene.text('… can cum inside you. "And don\'t be afraid to cum inside me if you want and pay for it."');
    scene.text(`"Of course I'll pay for it. You're the best, ${(((st as any).prostitute_names ?? 0)?.[String((st as any).prostitution_location ?? 0)] ?? '')}."`);
    scene.actions([
      { label: 'Continue', goto: ['prostitution_car_negotiation', 'client_regular_success'] },
    ]);
  } },
    ...
    scene.text(`He nods. "Of course, it just isn't the same with a condom. It's really great that you do that, ${(((st as any).prostitute_names ?? 0)?.[String((st as any).prostitution_location ?? 0)] ?? '')}. You know that, right? There aren't many girls your age that do it raw."`);
    scene.text('You smile and tell him that he…');
    scene.actions([
      { label: 'Can\'t cum inside you', handler: (st: GameState) => {
    (st as any).prostitute_client_cumshot = 'Outside';
    ...
    scene.text(`"You're the best whore in the whole area, ${(((st as any).prostitute_names ?? 0)?.[String((st as any).prostitution_location ?? 0)] ?? '')}."`);
    scene.actions([
      { label: 'Continue', goto: ['prostitution_car_negotiation', 'client_regular_success'] },
    ]);
  } },
      ...
      if (((st as any).prostitute ?? 0)?.['std_mod'] === 0  &&  ((st as any).prostitute_auto ?? 0)?.['regular'] === 1) {
        if ((((st as any).prostitute_auto ?? 0)?.['reg_vag_condom'] === 1  &&  ((st as any).prostitute ?? 0)?.['client_scene'] === 'Vaginal')  ||  (((st as any).prostitute_auto ?? 0)?.['reg_anal_condom'] === 1  &&  ((st as any).prostitute ?? 0)?.['client_scene'] === 'Anal')) {
          (st as any).prostitute_client_condom = 'Yes';
          (st as any).prostitute_client_cumshot = 'Outside or Condom';
          ...
          (st as any).prostitute_client_condom = 'No';
          if ((((st as any).prostitute_auto ?? 0)?.['reg_vag_creampie'] === 1  &&  ((st as any).prostitute ?? 0)?.['client_scene'] === 'Vaginal')  ||  (((st as any).prostitute_auto ?? 0)?.['reg_anal_creampie'] === 1  &&  ((st as any).prostitute ?? 0)?.['client_scene'] === 'Anal')) {
            (st as any).prostitute_client_cumshot = 'Inside';
          } else {
            (st as any).prostitute_client_cumshot = 'Outside';
          }
        }
        qspCall(st, 'prostitution_functions', 'payment', ((((st as any).prostitute_client_condom ?? 0) === 'Yes') ? ('condom_yes') : ('condom_no')), ((((st as any).prostitute_client_cumshot ?? 0) === 'Inside') ? ('inside_yes') : ('inside_no')));
        qspGoto(st, 'prostitution_car_negotiation', 'client_regular_success');
      } else {
        (st as any).prostitute_client_condom = 'Yes';
        (st as any).prostitute_client_cumshot = 'Outside or Condom';
        qspCall(st, 'prostitution_functions', 'payment', 'condom_yes', 'inside_no');
...
function enterClientRegularFail(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('"Thanks," you say and step away from the car.' + ((((s as any).prostitute ?? 0)?.['std_mod'] === 1  &&  ((s as any).mc_inventory ?? 0)?.['normal_condoms'] < 1  &&  ((s as any).mc_inventory ?? 0)?.['equipped_condoms'] < 1) ? (' As you walk away you think about your decision for a moment. In the end it was the right choice, he was always nice to you and without a condom he surely would catch your STD.') : ('')));
  scene.actions([
    { label: 'Continue', handler: (st: GameState) => {
    dynamicGoto(st, 'prevLoc', 'work');
  } },
...
function enterClientRegularSuccess(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  ((s as any).prostitute = (s as any).prostitute ?? {})['regular_timer'] = ((s as any).daystart ?? 0);
  qspCall(s, 'stat', '');
  ...
  scene.actions([
    { label: 'Continue', handler: (st: GameState) => {
    if ((Math.floor(Math.random() * 10) + 1) < 4  &&  ((st as any).prostitute ?? 0)?.['skip_start'] === 0) {
    ...
    scene.text(`"Happy?" He asks as you take the ${qspFunc(s, 'money', 'string_profit', (((st as any).prostitute ?? 0)?.['payment'] ?? ''))}.`);
    ...
    scene.actions([
      ...
      scene.text(`"Thanks," you say and take the ${qspFunc(s, 'money', 'string_profit', (((st as any).prostitute ?? 0)?.['payment'] ?? ''))}.`);
      ...
      ((st as any).prostitute = (st as any).prostitute ?? {})['payment'] = 0;
      qspCall(st, 'stat', '');
      if (((st as any).prostitute ?? 0)?.['skip_start'] === 1) {
        qspGoto(st, 'prostitution_car_sex', 'regular_start');
      } else {
        scene.actions([
...
function enterNegotiationStart(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`<center><video autoplay loop ${((s as any).set_imgh ?? '')} src="images/shared/prostitution/car/normal/negotiation/chat` + (Math.floor(Math.random() * 2) + 0) + '.mp4"></video></center>');
  scene.text(((((s as any).prostitute ?? 0)?.['propose'] === 0) ? ('You lean into his car and chat with him about the price and what he likes and dislikes.') : (((((s as any).prostitute ?? 0)?.['propose'] === 2) ? ('He doesn\'t like your suggestion and instead offers something else.') : ('You chat with him about the price.')))) + ' At the end of your conversation he takes a good look at you and ' + ((((s as any).prostitute ?? 0)?.['std_mod'] === 0) ? ('asks you if you do it with or without a condom.') : ('tells you that you don\'t look healthy and he won\'t do it without a condom')));
  ...
  if (((s as any).prostitute ?? 0)?.['propose'] === 0) {
    ...
    if (((s as any).mesec ?? 0) > 0) {
      scene.text(((((s as any).prostitute ?? 0)?.['mesec_mod'] === 0) ? ('He doesn\'t like') : ('He tells you that he likes')) + ' to fuck girls that have their period.');
    }
  }
  ...
  if (((s as any).prostitute ?? 0)?.['std_mod'] === 0) {
    ...
    if ((Math.floor(Math.random() * 10) + 1) < 9) {
      qspGoto(st, 'prostitution_car_negotiation', 'negotiation_fail');
    } else {
      ((st as any).prostitute = (st as any).prostitute ?? {})['client_scene'] = 'Blowjob';
      scene.text('After a moment he reluctantly accepts doing it without a condom' + ((((st as any).prostitute ?? 0)?.['client_scene'] === 'Blowjob') ? ('.') : (', but he changed his mind and doesn\'t want more than a blowjob.')));
      scene.text(`Sex: ${(((st as any).prostitute ?? 0)?.['client_scene'] ?? '')}`);
      qspCall(st, 'prostitution_functions', 'payment', 'condom_no', 'not_discussed');
      scene.text(`New payment: ${qspFunc(s, 'money', 'string_profit', (((st as any).prostitute ?? 0)?.['payment'] ?? ''))}`);
      qspCall(st, 'prostitution_functions', 'will_unprotected', 'resist');
      if (((st as any).pcs_willpwr ?? 0) < ((st as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Decline and move away', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
...
function enterNegotiationCondomYes(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).prostitute ?? 0)?.['std_mod'] === 1  ||  (Math.floor(Math.random() * 10) + 1) < 7  ||  (((s as any).prostitute ?? 0)?.['client_scene'] === 'Vaginal'  &&  ((s as any).mesec ?? 0) > 0  &&  ((s as any).prostitute ?? 0)?.['mesec_mod'] === 0)  ||  (((s as any).prostitute ?? 0)?.['client_scene'] === 'Anal'  &&  ((s as any).klismaday ?? 0) !== ((s as any).daystart ?? 0)  &&  ((s as any).prostitute ?? 0)?.['dirty_anal_mod'] === 0)) {
    ...
    (st as any).prostitute_client_cumshot = 'Outside or Condom';
    qspCall(st, 'prostitution_functions', 'payment', 'condom_yes', 'Outside or Condom');
    qspGoto(st, 'prostitution_car_negotiation', 'negotiation_success');
  } },
    ]);
  } else {
    qspCall(s, 'prostitution_functions', 'payment', 'condom_no', 'not_discussed');
    scene.text(`He asks you to forgo the condom. He would pay at least ${qspFunc(s, 'money', 'string_profit', (((s as any).prostitute ?? 0)?.['payment'] ?? ''))} and even more if you ` + ((((s as any).prostitute ?? 0)?.['client_scene'] === 'Blowjob') ? ('swallow his cum.') : ('let him cum inside you.')));
    ...
    if ((Math.floor(Math.random() * 10) + 1) < 7) {
      ...
      (st as any).prostitute_client_cumshot = 'Outside or Condom';
      ((st as any).prostitute = (st as any).prostitute ?? {})['client_satisfaction'] = ((st as any).prostitute['client_satisfaction'] ?? 0) - (10);
      qspCall(st, 'prostitution_functions', 'payment', 'condom_yes', 'inside_no');
      scene.actions([
        { label: 'Get into his car', goto: ['prostitution_car_negotiation', 'negotiation_success'] },
      ]);
    } else {
      ((st as any).prostitute = (st as any).prostitute ?? {})['fail_condom'] = 1;
      qspGoto(st, 'prostitution_car_negotiation', 'negotiation_fail');
    }
  } },
      ]);
...
function enterNegotiationCondomNo(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('He asks you if you would ' + ((((s as any).prostitute ?? 0)?.['client_scene'] === 'Blowjob') ? ('swallow his cum.') : ('let him cum inside you.')) + ` He offers to pay you ${qspFunc(s, 'money', 'string_profit', (((s as any).prostitute ?? 0)?.['payment'] ?? ''))} if you do.`);
  if (((s as any).prostitute ?? 0)?.['client_scene'] === 'Anal') {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    scene.actions([
      { label: 'Decline', handler: (st: GameState) => {
    qspCall(st, 'willpower', 'pay', 'resist');
    if ((Math.floor(Math.random() * 10) + 1) < 10  ||  ((st as any).prostitute ?? 0)?.['client_creampie'] === 1) {
      ...
      ((st as any).prostitute = (st as any).prostitute ?? {})['fail_creampie'] = 1;
      qspGoto(st, 'prostitution_car_negotiation', 'negotiation_fail');
    }
  } },
    ]);
...
function enterNegotiationAutomatic(s: GameState, scene: SceneBuilder): void {
  ((s as any).prostitute_auto = (s as any).prostitute_auto ?? {})['negotiation'] = 1;
  qspCall(s, 'willpower', 'prostitution', 'resist');
  if (((((s as any).prostitute_auto ?? 0)?.['norm_bj'] === 0  &&  ((s as any).prostitute ?? 0)?.['client_scene'] === 'Blowjob')  ||  (((s as any).prostitute_auto ?? 0)?.['norm_vag'] === 0  &&  ((s as any).prostitute ?? 0)?.['client_scene'] === 'Vaginal')  ||  (((s as any).prostitute_auto ?? 0)?.['norm_anal'] === 0  &&  ((s as any).prostitute ?? 0)?.['client_scene'] === 'Anal'))) {
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      ((s as any).prostitute_auto = (s as any).prostitute_auto ?? {})['willpower'] = 1;
    } else {
      qspCall(s, 'willpower', 'pay', 'resist');
      qspGoto(s, 'prostitution_car_negotiation', 'negotiation_fail');
    }
  ...
  if (((((s as any).prostitute_auto ?? 0)?.['norm_bj_condom'] === 1  &&  ((s as any).prostitute ?? 0)?.['client_scene'] === 'Blowjob')  ||  (((s as any).prostitute_auto ?? 0)?.['norm_vag_condom'] === 1  &&  ((s as any).prostitute ?? 0)?.['client_scene'] === 'Vaginal')  ||  (((s as any).prostitute_auto ?? 0)?.['norm_anal_condom'] === 1  &&  ((s as any).prostitute ?? 0)?.['client_scene'] === 'Anal'))  &&  (((s as any).mc_inventory ?? 0)?.['normal_condoms'] > 0  ||  ((s as any).mc_inventory ?? 0)?.['equipped_condoms'] > 0)) {
    qspCall(s, 'prostitution_functions', 'will_unprotected', 'resist');
    if (((s as any).prostitute ?? 0)?.['std_mod'] === 1  ||  (Math.floor(Math.random() * 10) + 1) < 7  ||  (((s as any).prostitute ?? 0)?.['client_scene'] === 'Vaginal'  &&  ((s as any).mesec ?? 0) > 0  &&  ((s as any).prostitute ?? 0)?.['mesec_mod'] === 0)  ||  (((s as any).prostitute ?? 0)?.['client_scene'] === 'Anal'  &&  ((s as any).klismaday ?? 0) !== ((s as any).daystart ?? 0)  &&  ((s as any).prostitute ?? 0)?.['dirty_anal_mod'] === 0)) {
      (s as any).prostitute_client_condom = 'Yes';
      (s as any).prostitute_client_cumshot = 'Outside or Condom';
      ...
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        ...
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          ((s as any).prostitute_auto = (s as any).prostitute_auto ?? {})['willpower'] = 1;
          (s as any).prostitute_client_condom = 'No';
          (s as any).prostitute_client_cumshot = 'Inside';
          qspCall(s, 'prostitution_functions', 'payment', 'condom_no', 'inside_yes');
        } else {
          (s as any).prostitute_client_condom = 'No';
          (s as any).prostitute_client_cumshot = 'Outside';
          ((s as any).prostitute = (s as any).prostitute ?? {})['client_satisfaction'] = ((s as any).prostitute['client_satisfaction'] ?? 0) - (10);
          qspCall(s, 'willpower', 'pay', 'resist');
        ...
        if ((Math.floor(Math.random() * 10) + 1) < 4) {
          ((s as any).prostitute = (s as any).prostitute ?? {})['fail_condom'] = 1;
          qspGoto(s, 'prostitution_car_negotiation', 'negotiation_fail');
        }
      }
    }
    qspGoto(s, 'prostitution_car_negotiation', 'negotiation_success');
  } else {
    if ((Math.floor(Math.random() * 10) + 1) < 9  &&  ((s as any).prostitute ?? 0)?.['std_mod'] === 1) {
      ...
      if (((((s as any).prostitute_auto ?? 0)?.['norm_bj_creampie'] === 1  &&  ((s as any).prostitute ?? 0)?.['client_scene'] === 'Blowjob')  ||  (((s as any).prostitute_auto ?? 0)?.['norm_vag_creampie'] === 1  &&  ((s as any).prostitute ?? 0)?.['client_scene'] === 'Vaginal')  ||  (((s as any).prostitute_auto ?? 0)?.['norm_anal_creampie'] === 1  &&  ((s as any).prostitute ?? 0)?.['client_scene'] === 'Anal'))) {
        ...
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          ...
          qspCall(s, 'prostitution_functions', 'payment', 'condom_no', 'inside_no');
          if ((Math.floor(Math.random() * 10) + 1) === 10  &&  ((s as any).prostitute ?? 0)?.['client_creampie'] === 0) {
            ((s as any).prostitute = (s as any).prostitute ?? {})['fail_creampie'] = 1;
            qspGoto(s, 'prostitution_car_negotiation', 'negotiation_fail');
          }
        }
      }
...
function enterNegotiationFail(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).prostitute ?? 0)?.['fail_condom'] === 1) {
    ...
    if (((s as any).prostitute ?? 0)?.['fail_creampie'] === 1) {
      ((s as any).prostitute = (s as any).prostitute ?? {})['fail_creampie'] = 0;
      scene.actions([
  ...
  scene.actions([
    ...
    ((st as any).prostitute = (st as any).prostitute ?? {})['fail_pay'] = 0;
    ((st as any).prostitute = (st as any).prostitute ?? {})['client_satisfaction'] = 0;
    dynamicGoto(st, 'prevLoc');
  } },
  ]);
  scene.build();
...
function enterNegotiationSuccess(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).prostitute_auto ?? 0)?.['negotiation'] === 1) {
    scene.text('You have negotiated the following' + ((((s as any).prostitute_auto ?? 0)?.['willpower'] === 1) ? (', but you didn\'t have enough willpower to resist all of his demands:') : (':')));
    scene.text(`Sex: ${(((s as any).prostitute ?? 0)?.['client_scene'] ?? '')}`);
    scene.text(`Payment: ${qspFunc(s, 'money', 'string_profit', (((s as any).prostitute ?? 0)?.['payment'] ?? ''))}`);
    scene.text(`Condom: ${((s as any).prostitute_client_condom ?? '')}`);
    scene.text('Cumshot: ' + ((((s as any).prostitute_client_cumshot ?? 0) === 'Outside  ||  Condom') ? ('Outside') : ('' + ((s as any).prostitute_client_cumshot ?? '') + '')));
    ((s as any).prostitute_auto = (s as any).prostitute_auto ?? {})['willpower'] = 0;
    ((s as any).prostitute_auto = (s as any).prostitute_auto ?? {})['negotiation'] = 0;
  }
  scene.text('You get inside the car and tell him to drive to a more secluded part of the parking lot.' + (((Math.floor(Math.random() * 10) + 1) < 4) ? ('His right hand immediately moves onto your thigh and he slowly strokes it and he is clearly distracted as he slowly drives the car to the end of the parking space.') : ('')));
  if (((s as any).prostitute_client_condom ?? 0) === '!') {
    ((s as any).prostitute_stat = (s as any).prostitute_stat ?? {})['unprotected'] = ((s as any).prostitute_stat['unprotected'] ?? 0) + (1);
  }
  if (((s as any).prostitute ?? 0)?.['client_satisfaction'] < 0  &&  ((s as any).prostitute ?? 0)?.['fail_pay'] === 0) {
    ...
    if ((Math.floor(Math.random() * 10) + 1) === 10) {
      ((st as any).prostitute = (st as any).prostitute ?? {})['fail_pay'] = 1;
      qspGoto(st, 'prostitution_car_negotiation', 'negotiation_fail');
    }
    ((st as any).prostitute = (st as any).prostitute ?? {})['payment'] = (((st as any).prostitute ?? 0)?.['payment_backup']);
    qspCall(st, 'stat', '');
    scene.text(`He grudgingly accepts and agrees to pay you ${qspFunc(s, 'money', 'string_profit', (((st as any).prostitute ?? 0)?.['payment'] ?? ''))} instead.`);
    scene.actions([
...
function enterMoney(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 2;
  ((s as any).prostitute = (s as any).prostitute ?? {})['client_satisfaction'] = 0;
  ...
  if (((s as any).prostitute ?? 0)?.['skip_start'] === 1) {
    qspGoto(s, 'prostitution_car_sex', 'start');
  } else {
    scene.actions([

...
function enterBlowjobTalk1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBlowjobTalk2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterMissionary(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMissionary2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterDoggystyle(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDoggystyle2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterCowgirl(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).grupTipe ?? 0) === 2) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCowgirl2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterBjFav(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat ?? 0)?.['boyfriends_current'] > 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSpitOrSwallow(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterSpitOrSwallow(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterSwallowWhy(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterBirthControlTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).birth_control ?? 0)?.['think_safe'] === 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBirthControlPillHassleCondomVer(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBirthControlHormones(st, scene); (st as any).locArgs = __savedLocArgs; }
    scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBirthControlPillHassleNoCondoms(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBirthControlHormones(st, scene); (st as any).locArgs = __savedLocArgs; }
    scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBirthControlPillProblem(st, scene); (st as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterCalendarMethodWorking(st, scene); (st as any).locArgs = __savedLocArgs; }
    scene.actions([
...
function enterLesbianTalk1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_had_sex ?? 0)?.['A23']) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterLesbianTalk2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
...
function enterSexualFantasies1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterAlbinasFantasy(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterAnalQuestionsShy(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['anal'] === 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterAnalEnd2(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  // TODO-QSP: end

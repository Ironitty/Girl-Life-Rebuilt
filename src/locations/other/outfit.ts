...
function enterDress(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).lastwornclothingtype ?? 0)[String((s as any).locArgs?.[1] ?? '')] !== ''  &&  ((s as any).lastwornclothingtype ?? 0)[String((s as any).locArgs?.[1] ?? '')] !== 'nude') {
    ...
    if (((s as any).pcs_heels ?? 0) < ((s as any).PShoPain ?? 0)?.['medium']) {
      ...
      if (((s as any).pcs_heels ?? 0) < ((s as any).PShoPain ?? 0)?.['mild']) {
        ...
        if (((s as any).pcs_heels ?? 0) < ((s as any).PShoPain ?? 0)?.['mild'] + 10) {
          ((s as any).temp_outfitVars = (s as any).temp_outfitVars ?? {})['heels_time'] = (Math.floor(Math.random() * (0 - (-3) + 1)) + ((-3)));
        } else {
          if (((s as any).pcs_heels ?? 0) < ((s as any).PShoPain ?? 0)?.['mild'] + 20) {
            ((s as any).temp_outfitVars = (s as any).temp_outfitVars ?? {})['heels_time'] = (Math.floor(Math.random() * (0 - (-5) + 1)) + ((-5)));
          } else {
            ((s as any).temp_outfitVars = (s as any).temp_outfitVars ?? {})['heels_time'] = (Math.floor(Math.random() * (0 - (-7) + 1)) + ((-7)));
          }
        }
      }
    }

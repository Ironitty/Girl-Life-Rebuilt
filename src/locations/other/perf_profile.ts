...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['gameover'] = 1;
  ...
  if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['gameover'] = ((s as any).prof_saved_gameover ?? 0);
  if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['hunger'] = ((s as any).prof_saved_hunger ?? 0);
  if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['thirst'] = ((s as any).prof_saved_thirst ?? 0);
  if (!(s as any).cheatVars) (s as any).cheatVars = {}; (s as any).cheatVars['inf_willpower'] = ((s as any).prof_saved_inf_willpower ?? 0);

...
function enterInit(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'set_exceptions') {
    if (!(s as any).shop_display_exceptions) (s as any).shop_display_exceptions = {}; (s as any).shop_display_exceptions['gm_panties-7'] = 1;
    if (!(s as any).shop_display_exceptions) (s as any).shop_display_exceptions = {}; (s as any).shop_display_exceptions['gm_panties-9'] = 1;
    if (!(s as any).shop_display_exceptions) (s as any).shop_display_exceptions = {}; (s as any).shop_display_exceptions['gm_panties-21'] = 1;
    if (!(s as any).shop_display_exceptions) (s as any).shop_display_exceptions = {}; (s as any).shop_display_exceptions['gm_panties-37'] = 1;
    return;
  }
  return;
  // TODO-QSP: end
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'grid_shop') {
    ...
    if (((s as any).locArgs?.[2] ?? 0) === 'main') {
      ...
      if (qspFunc(s, 'shop_utils', 'filter', 'apply')) {
        scene.img(`${qspFunc(s, '$panty_image', '$ARGS[4]', qspUntranslated(s, "ARGS[5]", { location: "panty_view" }))}`);
      }
      return;
    }
...
function enterViewItem(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).shop_utils_view) (s as any).shop_utils_view = {}; (s as any).shop_utils_view['number'] = qspUntranslated(s, "ARGS[3]", { location: "panty_view" });
  if (!(s as any).shop_utils_view) (s as any).shop_utils_view = {}; (s as any).shop_utils_view['discount'] = qspUntranslated(s, "ARGS[4]", { location: "panty_view" });
  qspCall(s, 'stat', '');
...
function enterViewItemShop(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).shop_utils_view) (s as any).shop_utils_view = {}; (s as any).shop_utils_view['price'] = (((s as any).shop_utils_view ?? {})?.['pan_price'] ?? 0) * Math.max(0, 100 - (((s as any).shop_utils_view ?? {})?.['pan_discount'] ?? 0)) / 100;
  ...
  if (((s as any).shop_utils_view ?? 0)?.['price'] === ((s as any).shop_utils_view ?? 0)?.['pan_price']) {
    ...
    if (!(s as any).shop_utils_view) (s as any).shop_utils_view = {}; (s as any).shop_utils_view['price_string'] = qspFunc(s, 'wrap', 'neg s', qspFunc(s, 'money', 'string_price', ((s as any).shop_utils_view ?? 0)?.['pan_price'])) + ' <b>' +  qspFunc(s, 'money', 'string_price', ((s as any).shop_utils_view ?? 0)?.['price']) + '</b>';
  ...
  if (((s as any).underwear ?? 0)?.['pair'] > 0) {
    if (qspFunc(s, 'bras', 'is_owned', ((s as any).shop_utils_view ?? 0)?.['type'], ((s as any).underwear ?? 0)?.['pair'])) {
      ...
      if (!(s as any).shop_utils_view) (s as any).shop_utils_view = {}; (s as any).shop_utils_view['price_string'] = qspFunc(s, 'money', 'string_price', ((s as any).shop_utils_view ?? 0)?.['set_price']);

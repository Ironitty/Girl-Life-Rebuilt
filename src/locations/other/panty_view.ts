...
function enterViewItem(s: GameState, scene: SceneBuilder): void {
  ...
  if (qspFunc(s, 'panties', 'is_wearing', qspUntranslated(s, "\u00000\u0000", { location: "panty_view" }), qspUntranslated(s, "\u00001\u0000", { location: "panty_view" }))) {
...
function enterViewItemShop(s: GameState, scene: SceneBuilder): void {
  if (qspFunc(s, 'panties', 'is_owned', qspUntranslated(s, "\u00000\u0000", { location: "panty_view" }), qspUntranslated(s, "\u00001\u0000", { location: "panty_view" })) === 1) {
    scene.text('You already own this item.');
    return;
  }
  (s as any).shop_utils_view['pan_discount'] = ((s as any).min ?? 0)(((s as any).max ?? 0)(0, ((s as any).shop_utils_view ?? 0)?.['discount'] + qspFunc(s, 'shop_utils', 'get_discount', ((s as any).shop_utils_view ?? 0)?.['type'], ((s as any).shop_utils_view ?? 0)?.['number'])), 100);
  (s as any).shop_utils_view['pan_price'] = ((s as any).PanPrice ?? 0);
  (s as any).shop_utils_view['price'] = ((s as any).shop_utils_view ?? 0)?.['pan_price'] * ((s as any).max ?? 0)(0, 100 - ((s as any).shop_utils_view ?? 0)?.['pan_discount']) / 100;
  ...
  if (((s as any).shop_utils_view ?? 0)?.['price'] === ((s as any).shop_utils_view ?? 0)?.['pan_price']) {
    ...
    (s as any).shop_utils_view['price_string'] = qspFunc(s, 'wrap', 'neg s', qspFunc(s, 'money', 'string_price', ((s as any).shop_utils_view ?? 0)?.['pan_price'])) + ' <((s as any).b ?? 0)>' +  qspFunc(s, 'money', 'string_price', ((s as any).shop_utils_view ?? 0)?.['price']) + '</((s as any).b ?? 0)>';
  ...
  if (qspFunc(s, 'money', 'can_afford', qspUntranslated(s, "\u00000\u0000", { location: "panty_view" })) === 0) {
  ...
  if (((s as any).underwear ?? 0)?.['pair'] > 0) {
    if (qspFunc(s, 'bras', 'is_owned', qspUntranslated(s, "\u00000\u0000", { location: "panty_view" }), qspUntranslated(s, "\u00001\u0000", { location: "panty_view" }))) {
      ...
      (s as any).shop_utils_view['bra_discount'] = ((s as any).min ?? 0)(((s as any).max ?? 0)(0, ((s as any).shop_utils_view ?? 0)?.['discount'] + qspFunc(s, 'shop_utils', 'get_discount', ((s as any).shop_utils_view ?? 0)?.['type'], ((s as any).underwear ?? 0)?.['pair'])), 100);
...
function enterViewItemWardrobe(s: GameState, scene: SceneBuilder): void {
  if (((s as any).underwear ?? 0)?.['pair'] > 0) {
    if (qspFunc(s, 'bras', 'is_owned', qspUntranslated(s, "\u00000\u0000", { location: "panty_view" }), qspUntranslated(s, "\u00001\u0000", { location: "panty_view" })) === 0) {

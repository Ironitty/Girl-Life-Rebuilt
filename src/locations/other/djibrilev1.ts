...
function enterSvetaSex1BjCum(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He laughs a little. "Fuck, that was amazing. You're truly an amazing girl, ${((s as any).pcs_nickname || '')}."`);
    ...
    scene.text(`"Fuck, that was so hot ${((s as any).pcs_nickname || '')}." He pulls up his pants before pulling you up to your feet and giving you a quick kiss. "I'd love to hang out more, but I've got some homework I need to get done."`);
...
function enterSvetaSex1Anal(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`The pressure builds until his cock finally pops in, causing you to cry out and hiss a little in pain as his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick stretches your asshole. He starts slowly fucking you, but as you start to relax and moan in pleasure, he starts going faster and deeper.`);
    ...
    scene.text(`He then pulls out and collapses down beside you on the couch as you roll over on your side next to him. "Fuck, that was amazing ${((s as any).pcs_nickname || '')}."`);
...
function enterDjibrilSvetaAnya1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You roll over and get on all fours on the couch as he moves up behind you and slides his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick into your pussy. He strips off the rest of his clothes before he starts slowly fucking you and Anya undresses before she climbs up onto the couch and starts making out with him.`);
    ...
    scene.text(`Once he's worked the lube in, he moves up between your legs and slides his slick ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock into your asshole. You cry out in a mix of pain and pleasure as he stretches you out.`);
    ...
    scene.text(`Anya gets up and grabs a tissue to clean his cum off her face. "It was. Call me when you want to do this again, ${((s as any).pcs_nickname || '')}."`);
    ...
    scene.text(`"I'd love to hang out more, but I've got to get back home. Don't stay out too late, ${((s as any).pcs_nickname || '')}. You know how Mom gets."`);
...
function enterDjibrilSvetaAnyaGangbang1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Anya stands up. "This was fun. Maybe we can do this again some time? Call me, ${((s as any).pcs_nickname || '')}." She turns to the guys and waves at them as she walks to the door, sauntering as she goes. "Later, boys…"`);
    ...
    scene.text(`Anya stops at the door. "I'd love to hang out more, but I've got to get back home. Don't stay out too late, ${((s as any).pcs_nickname || '')}. You know how Mom gets."`);
    scene.text('You roll your eyes slightly before turning to Djibril. "I guess I should get going."');
    scene.text('He nods. "I understand. You two stay safe getting back home."');
    scene.text('With that, you turn and head for the door.');
...
function enterDjibrilSvetaNush1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'voyeur_sex', 3, 'group', 'dom');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'foreplay', 2, ((s as any).npcID ?? 0), 'group', 'dom');
    ...
    qspCall(s, 'arousal', 'cuni_give', 3, ((s as any).npcID1 ?? 0), 'group', 'lesbian', 'sub');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Get eaten out', handler: (st: GameState) => {
    qspCall(s, 'stat', '');
    ...
    scene.text(`As you get up and Anushka slides off the couch, he looks at her and says "Strip ${((s as any).pcs_nickname || '')} for me."`);
    ...
    scene.text(`You feel the tip of his dick sliding against your wet clit before he pushes his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock inside you.`);
    ...
    qspCall(s, 'arousal', 'foreplay', 3, ((s as any).npcID ?? 0), 'group');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'anal', 3, ((s as any).npcID ?? 0), 'group', 'lube', 'rough');
    qspCall(s, 'arousal', 'foreplay', (-3), ((s as any).npcID ?? 0), 'group');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'foreplay', 2, ((s as any).npcID ?? 0), 'group', 'sub', 'humiliation');
...
function enterDjibrilNush1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He grabs her by the hair and pulls her up before leading her back over to the couch, where he pushes her onto her knees and moves in behind her to slide his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick into her wet pussy.`);
    ...
    // TODO-QSP: dynamic text: Once she's fully dressed, she smiles at the two of you. "Thanks for the fun, but...
    scene.text(`Once she's fully dressed, she smiles at the two of you. "Thanks for the fun, but I should get going. See you later, ${((s as any).pcs_nickname || '')}."`);
...
function enterDjibrilSvetaNushGangbang1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'bj', 3, ((s as any).npcID2 ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'hj', (-3), ((s as any).npcID3 ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'foreplay', (-3), ((s as any).npcID4 ?? 0), 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'bj', 3, ((s as any).npcID3 ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'bj', 3, ((s as any).npcID4 ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'hj', (-3), ((s as any).npcID2 ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'hj', (-3), ((s as any).npcID5 ?? 0), 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'anal', 3, ((s as any).npcID4 ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'clit_finger', (-3), 'self', 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'anal', 3, ((s as any).npcID6 ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'clit_finger', (-3), 'self', 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Doggy style', handler: (st: GameState) => {
    ...
    qspCall(s, 'arousal', 'anal', 3, ((s as any).npcID2 ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'anal', 3, ((s as any).npcID3 ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'anal', 3, ((s as any).npcID4 ?? 0), 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'anal', 3, ((s as any).npcID ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'anal', 3, ((s as any).npcID5 ?? 0), 'gangbang');
    qspCall(s, 'arousal', 'anal', 3, ((s as any).npcID6 ?? 0), 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Facial', handler: (st: GameState) => {
    ...
    // TODO-QSP: dynamic text: Once she's dressed, she smiles at you. "Thanks for the fun, but I should get goi...
    scene.text(`Once she's dressed, she smiles at you. "Thanks for the fun, but I should get going. See you later, ${((s as any).pcs_nickname || '')}." Just before walking out, she puts her hand on her ass and you hear her mutter "Fuck, my ass is going to be sore tomorrow…"`);
    scene.text('She walks out the door as Djibril glances over at you. "I don\'t want to be rude, but I\'ve got some homework I need to do."');
    scene.text('You get up and nod. "It\'s okay, I should get going too," you tell him and head for the door.');
    qspCall(s, 'arousal', 'foreplay', 5, ((s as any).npcID ?? 0), 'gangbang');
    qspCall(s, 'cum_call', 'face', ((s as any).npcID6 ?? 0), 1);
    (s as any).cumspclnt = 12;
    qspCall(s, 'cum_cleanup', '');
    qspCall(s, 'arousal', 'end');
    scene.actions([
...
function enterDjibrilNushGangbang1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'voyeur', 2, 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'voyeur_sex', 3, 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`Lebogang and Djibril pull her up by her hands and carry her to the couch, placing her in Ermias' lap. As they lower her down, Ermias lines his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick up so it slides into her pussy. She moans loudly for a moment, but then Djibril shoves his dick back in her mouth as Lebogang grabs one of her hands and pulls it up to his dick, which she starts stroking.`);
    qspCall(s, 'arousal', 'voyeur_sex', 5, 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`"Wait…" she starts, but she never finishes her sentence as he shoves his hips forward and his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock pops into her ass. "AAAAH! FUCK!" She places a hand on his chest to try and stop him from going deeper.`);
    ...
    scene.text(`Lebogang lubes up his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock before sliding it into her ass. He takes it slow as Ermias watches and jerks off. As Anushka starts moaning louder, Lebogang starts fucking her harder and faster until her body is wracked by another orgasm.`);

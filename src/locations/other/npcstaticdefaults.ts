...
function enterBody(s: GameState, scene: SceneBuilder): void {
  if (Number((s as any).locArgs?.[1] ?? 0) === 'model') {
    ...
    if (Number((s as any).locArgs?.[1] ?? 0) === 'actor') {
...
function enterGroup(s: GameState, scene: SceneBuilder): void {
  ...
  if (Number((s as any).locArgs?.[1] ?? 0) === 'friends'  ||  Number((s as any).locArgs?.[1] ?? 0) === 8) {
    ((s as any).npc_grupTipe = (s as any).npc_grupTipe ?? {})['A' + String(((s as any).npctemp ?? 0))] = 8;
  } else {
    if (Number((s as any).locArgs?.[1] ?? 0) === 'family'  ||  Number((s as any).locArgs?.[1] ?? 0) === 7) {
      ...
      if (Number((s as any).locArgs?.[1] ?? 0) === 'teacher'  ||  Number((s as any).locArgs?.[1] ?? 0) === 6) {
        ((s as any).npc_grupTipe = (s as any).npc_grupTipe ?? {})['A' + String(((s as any).npctemp ?? 0))] = 6;
      } else {
        if (Number((s as any).locArgs?.[1] ?? 0) === 'outcast'  ||  Number((s as any).locArgs?.[1] ?? 0) === 5) {
          ...
          if (Number((s as any).locArgs?.[1] ?? 0) === 'gopnik'  ||  Number((s as any).locArgs?.[1] ?? 0) === 4) {
            ...
            if (Number((s as any).locArgs?.[1] ?? 0) === 'nerd'  ||  Number((s as any).locArgs?.[1] ?? 0) === 3) {
              ...
              if (Number((s as any).locArgs?.[1] ?? 0) === 'jock'  ||  Number((s as any).locArgs?.[1] ?? 0) === 2) {
                ...
                if (Number((s as any).locArgs?.[1] ?? 0) === 'coolkid'  ||  Number((s as any).locArgs?.[1] ?? 0) === 1) {

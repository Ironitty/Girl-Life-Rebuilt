...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_rel ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] >= 20  &&  ((s as any).npc_rel ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] < 40) {
    scene.text('They are fairly indifferent to you.');
  }
  if (((s as any).npc_rel ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] >= 40  &&  ((s as any).npc_rel ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] < 60) {
    scene.text('The two of you get along together fairly well, like casual friends.');
  }
  if (((s as any).npc_rel ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] >= 60  &&  ((s as any).npc_rel ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] < 80) {

...
function enterPartyalone(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).alko ?? 0) < 10) {
    ...
    if (((s as any).GadBoy ?? 0)?.['first_drink'] === 1) {
      if (!(s as any).GadBoy) (s as any).GadBoy = {}; (s as any).GadBoy['first_drink'] = 2;
...
function enterPartywithMira(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['follow_time'] = 3;
  if (((s as any).MiraVars ?? 0)?.['QW'] === 0) {
    if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['QW'] = 1;
  }
  scene.img('images/locations/gadukino/village/drunk.jpg');
...
function enterSolo_10(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).npc_QW) (s as any).npc_QW = {}; (s as any).npc_QW['A63'] = 11;
    qspCall(s, 'boyStat', 'A63');
    if (!(s as any).npc_had_sex) (s as any).npc_had_sex = {}; (s as any).npc_had_sex['A63'] = 1;
    if ((!((s as any).mesec ?? 0))) {
      qspCall(s, 'cum_call', '', '', 'A63', 1);
    ...
    if (!(s as any).npc_had_sex) (s as any).npc_had_sex = {}; (s as any).npc_had_sex['A61'] = 1;
    if ((!((s as any).mesec ?? 0))) {
...
function enterSolo_11andup_3boys(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).npc_had_sex) (s as any).npc_had_sex = {}; (s as any).npc_had_sex['A62'] = 1;
    qspCall(s, 'boyStat', 'A61');
    if (!(s as any).npc_had_sex) (s as any).npc_had_sex = {}; (s as any).npc_had_sex['A61'] = 1;
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['gangbang_count'] = ((s as any).stat['gangbang_count'] ?? 0) + (1);
...
function enterMira_5(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['QW'] = 6;
  qspCall(s, 'stat', '');
  ...
  scene.actions([
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['QW'] = 7;
    qspCall(s, 'stat', '');
    qspCall(s, 'miroslava', 'miraclothes');
...
function enterMira_7(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['QW'] = 8;
  qspCall(s, 'stat', '');
  qspCall(s, 'miroslava', 'miraclothes');
...
function enterMira_8(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['QW'] = 9;
  qspCall(s, 'stat', '');
  qspCall(s, 'miroslava', 'miraclothes');
  scene.text('"I\'m bored!" Mitka yells. "Mira get your ass down and give us a show to remember!" he snorts like a pig. "Show us how how loose your holes are whore…"');
...
function enterMira_9(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['QW'] = 10;
  qspCall(s, 'stat', '');
  qspCall(s, 'miroslava', 'miraclothes');
  ...
  scene.actions([
    ...
    scene.actions([
      { label: 'Talk to Mira', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['QW'] = 11;
    qspCall(s, 'stat', '');
    qspCall(s, 'miroslava', 'miraclothes');

...
function enterBoyAccidentalCreampie(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['accidental_creampie_convo'] = 1;
...
function enterStartBcTalk1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).birth_control ?? 0)?.['think_safe'] === 0  &&  ((s as any).npc_know_bc ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] !== 'hookup') {
    ...
    if (!(s as any).npc_bc_promise) (s as any).npc_bc_promise = {}; (s as any).npc_bc_promise[String((s as any).npcID ?? 0)] = ((s as any).daystart ?? 0);
...
function enterMorningAfterMoney(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).take_morning_after) (s as any).take_morning_after = {}; (s as any).take_morning_after[String((s as any).npcID ?? 0)] = ((s as any).daystart ?? 0);
    // TODO-QSP: $sex_ev['bed_room']
...
function enterFreeCreampies(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_free_creampies_count ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).sex_ev ?? 0)?.['he_ask_creampie'] > 0) {
    if (((s as any).sex_ev ?? 0)?.['cock_inserted'] === 0) {
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['temp_pic'] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_talk" }) + ' src="images/shared/sex/after/pillow_talk2.jpg"></center>';
    } else {
      if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
        if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['temp_pic'] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_talk" }) + ' src="images/shared/sex/vag/miss/2.jpg"></center>';
      } else {
        if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
          if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['temp_pic'] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_talk" }) + ' src="images/shared/sex/vag/doggy/1.jpg"></center>';
        } else {
          if (((s as any).sex_ev ?? 0)?.['position'] === 'cowgirl') {
            if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['temp_pic'] = '<center><img ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_talk" }) + ' src="images/shared/sex/vag/cowgirl/1.jpg"></center>';
          }
        }
      }
    }
...
function enterFreeCreampies2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] !== 1) {
    ...
    if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] === 'creampie') {
      ...
      scene.text(`${((s as any).npcdesc ?? 0)} gives you a predatory grin, so full of desire that it makes you involuntarily swallow.`);
...
function enterCreampiePermissionCode(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).npc_creampie_permission) (s as any).npc_creampie_permission = {}; (s as any).npc_creampie_permission[String((s as any).npcID ?? 0)] = 1;
...
function enterCreampiePermission1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_free_creampies ?? 0)?.[String((s as any).npcID ?? 0)] === ''  &&  ((s as any).npc_creampie_permission ?? 0)?.[String((s as any).npcID ?? 0)] < 1  &&  ((s as any).sex_ev ?? 0)?.['creampie_allowance'] === 0  &&  ((s as any).sex_ev ?? 0)?.['no_condom'] === 1  &&  (((s as any).sex_ev ?? 0)?.['pullout_thank'] + ((s as any).sex_ev ?? 0)?.['promise_no_creampie'] + ((s as any).sex_ev ?? 0)?.['not_inside'] === 0)) {
    ...
    scene.text(`"You don't have to pull out, you know that right?" you tell ${((s as any).npcdesc ?? 0)}.`);
    ...
    qspCall(s, 'sex_ev_talk', 'creampie_permission2');
          ...
          qspCall(s, 'sex_ev_talk', 'creampie_permission3');
          scene.actions([
    ...
    if (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      if (((s as any).npc_risktaker ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        if (!(s as any).npc_creampie_permission) (s as any).npc_creampie_permission = {}; (s as any).npc_creampie_permission[String((s as any).npcID ?? 0)] = 2;
        if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['creampie_allowance'] = 1;
        // TODO-QSP: dynamic text: "Well, if you want to roll the dice..." <<$npcdesc>> grins back.
        scene.text(`"Well, if you want to roll the dice..." ${((s as any).npcdesc ?? 0)} grins back.`);
        qspCall(s, 'sex_ev_talk', 'topic_exit');
      } else {
        // TODO-QSP: dynamic text: "I don't know..." <<$npcdesc>> says, hesitating. "I don't think it's a good idea...
        scene.text(`"I don't know..." ${((s as any).npcdesc ?? 0)} says, hesitating. "I don't think it's a good idea...`);
    ...
    qspCall(s, 'sex_ev_talk', 'creampie_permission2');
          ...
          if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] === 'creampie') {
            ...
            scene.text(`${((s as any).npcdesc ?? 0)} is visibly excited by the prospect.`);
          }
          qspCall(s, 'sex_ev_talk', 'creampie_permission2');
        }
      }
...
function enterCreampiePermission3(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['preg_risk'] === 'safe') {
    ...
    if (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  (Math.floor(Math.random() * 100) + 1) > ((s as any).npc_rel ?? 0)?.[String((s as any).npcID ?? 0)]) {
      ...
      scene.text(`${((s as any).npcdesc ?? 0)} hesitates for a moment and then shakes his head.`);
      ...
      scene.text(`"Well if it's safe..." ${((s as any).npcdesc ?? 0)} smiles.`);
      qspCall(s, 'sex_ev_talk', 'topic_exit');
    }
  } },
    ]);
  ...
  if (((s as any).stat ?? 0)?.['preg_risk'] === 'prob_safe') {
    ...
    if (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      scene.text(`"<i>Should</i> be?" ${((s as any).npcdesc ?? 0)} asks pointedly.`);
  ...
  scene.actions([
    ...
    if (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      scene.text(`"That doesn't matter," ${((s as any).npcdesc ?? 0)} scowls. "I don't want kids."`);
      scene.text('"Ugh, boo. You\'re no fun."');
      qspCall(s, 'sex_ev_talk', 'topic_exit');
    } else {
      if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npcID ?? 0)] === 'creampie') {
        ...
        scene.text(`"You make a good point," ${((s as any).npcdesc ?? 0)} grins back.`);
        qspCall(s, 'sex_ev_talk', 'topic_exit');
      } else {
        // TODO-QSP: dynamic text: "I don't know..." <<$npcdesc>> says, hesitating. "I don't think it's a good idea...
        scene.text(`"I don't know..." ${((s as any).npcdesc ?? 0)} says, hesitating. "I don't think it's a good idea...`);
...
function enterForgotBcTalk(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['forgot_bc_chat'] = 1;
  if (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  (((s as any).npc_argumentative ?? 0)?.[String((s as any).npcID ?? 0)] > 0  ||  ((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] > 0)  &&  ((s as any).sex_ev ?? 0)?.['creampie_count'] > 0) {
    ...
    scene.text(`"What the fuck?!" ${((s as any).npcdesc ?? 0)} exclaims. "Are you fucking kidding me? How could you forget? You better not get pregnant on me. I am <i>not</i> having your fucking kids."`);
    if (((s as any).mc_inventory ?? 0)?.['morning_after_pill'] > 0) {
      scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['creampie_count'] === 0) {
      ...
      scene.text(`"So what? I didn't come inside you last night," ${((s as any).npcdesc ?? 0)} says, looking confused.`);
      ...
      qspCall(s, 'sex_ev_talk', 'forgot_bc_exit');
    } else {
      // TODO-QSP: dynamic text: "Shit," <<$npcdesc>> says, looking concerned. "What are you gonna do?"
      scene.text(`"Shit," ${((s as any).npcdesc ?? 0)} says, looking concerned. "What are you gonna do?"`);
      if (((s as any).mc_inventory ?? 0)?.['morning_after_pill'] > 0) {
        scene.actions([
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} shrugs back. Great help.`);
    qspCall(s, 'sex_ev_talk', 'forgot_bc_exit');
  } },
        ]);
      }
...
function enterBarebackThink(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['bareback_thinking'] = 1;
  ...
  scene.actions([
    ...
    if (((s as any).npc_no_condoms ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      if (((s as any).npc_bareback_risk ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
        ...
        scene.text(`"You said that last time too," ${((s as any).npcdesc ?? 0)} snickers.`);
      } else {
        if (((s as any).npc_argumentative ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
          ...
          scene.text(`"I don't see why," ${((s as any).npcdesc ?? 0)} grumbles. "We both hate using them. We're only making things worse for ourselves."`);
        } else {
          if (((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
            ...
            scene.text(`"Maybe that was asking a bit too much," ${((s as any).npcdesc ?? 0)} replies sheepishly.`);
          } else {
            // TODO-QSP: dynamic text: <<$npcdesc>> sighs deeply.
            scene.text(`${((s as any).npcdesc ?? 0)} sighs deeply.`);
      ...
      if (((s as any).npc_bareback_risk ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
        ...
        scene.text(`"But didn't you say that the last time after we went bareback?" ${((s as any).npcdesc ?? 0)} says with a puzzled look.`);
      } else {
        if (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
          // TODO-QSP: dynamic text: "Yeah, better safe than sorry I guess," <<$npcdesc>> nods. "Using condoms sucks ...
          scene.text(`"Yeah, better safe than sorry I guess," ${((s as any).npcdesc ?? 0)} nods. "Using condoms sucks a lot less than you getting pregnant."`);
        } else {
          // TODO-QSP: dynamic text: "Yeah, better safe than sorry," <<$npcdesc>> nods. "Sorry. Don't know what I was...
          scene.text(`"Yeah, better safe than sorry," ${((s as any).npcdesc ?? 0)} nods. "Sorry. Don't know what I was thinking asking that."`);
        }
      }
    }
...
function enterBarebackAgree(s: GameState, scene: SceneBuilder): void {
  if (((s as any).birth_control ?? 0)?.['think_safe'] === 0) {
    ...
    scene.text(`"What are you saying?" ${((s as any).npcdesc ?? 0)} asks. He seems to be trying not to get his hopes up before you say it out loud.`);
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} looks back at you shocked.`);
    ...
    if (((s as any).sex_ev ?? 0)?.['boy_pill_suggest'] === 1) {
      ...
      scene.text(`${((s as any).npcdesc ?? 0)} seems very excited.`);
    }
  }, goto: ['sex_ev_pillow_talk', 'topic_route'] },
...
function enterBarebackPillExpense(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).npc_finance ?? 0)?.[String((s as any).npcID ?? 0)] >= 1  &&  ((((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] < 1  &&  (Math.floor(Math.random() * 3) + 1) === 3)  ||  (((s as any).npc_finance ?? 0)?.[String((s as any).npcID ?? 0)] === 2  &&  ((s as any).npc_no_condoms ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  ((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1))) {
      ...
      scene.text(`"How about I pay for it then?" ${((s as any).npcdesc ?? 0)} asks. "Any time you need a morning after pill because of me, I'll give you money to pay for it."`);
      ...
      qspCall(s, 'sex_ev_talk', 'ma_pill_deal_accept');
      scene.actions([
        { label: 'Refuse', handler: (st: GameState) => {
    scene.actions([
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} sighs in disappointment but does as you ask and puts the cash away.`);
    scene.text('"Let me know if you ever change your mind," he says. "Offer will still stand."');
    if (!(s as any).npc_pay_for_ma_pill_offer) (s as any).npc_pay_for_ma_pill_offer = {}; (s as any).npc_pay_for_ma_pill_offer[String((s as any).npcID ?? 0)] = 1;
  }, goto: ['sex_ev_pillow_talk', 'topic_route'] },
      ]);
    }
    qspCall(s, 'sex_ev_talk', 'ma_pill_deal_accept');
    ...
    scene.text(`"Fair enough I suppose," ${((s as any).npcdesc ?? 0)} replies ruefully and puts the money away. "Offer's always on the table if you change your mind."`);
    if (!(s as any).npc_pay_for_ma_pill_offer) (s as any).npc_pay_for_ma_pill_offer = {}; (s as any).npc_pay_for_ma_pill_offer[String((s as any).npcID ?? 0)] = 1;
  }, goto: ['sex_ev_pillow_talk', 'topic_route'] },
    ...
    scene.text(`"Just let me know if you ever change your mind," ${((s as any).npcdesc ?? 0)} shrugs, putting the money away. "Offer is here any time you want it."`);
    if (!(s as any).npc_pay_for_ma_pill_offer) (s as any).npc_pay_for_ma_pill_offer = {}; (s as any).npc_pay_for_ma_pill_offer[String((s as any).npcID ?? 0)] = 1;
  }, goto: ['sex_ev_pillow_talk', 'topic_route'] },
    ]);
  } },
      ...
      scene.text(`"I guess you have a point there," ${((s as any).npcdesc ?? 0)} chuckles. "It could really add up quickly if things went wrong."`);
      scene.actions([{ label: 'Continue', goto: ['sex_ev_pillow_talk', 'topic_route'] }]);
    }
  } },
  ]);
...
function enterMaPillDealAccept(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'sex_ev_talk', 'boy_pays_for_ma_pills');
  } },
...
function enterBoyPaysForMaPills(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    scene.text(`"Well it would cost me a lot more money if you got pregnant and I had to pay child support," ${((s as any).npcdesc ?? 0)} chuckles jokingly. "But I make plenty of money. The cost of a few pills is hardly going to make a dent. So you ready to stop using condoms?"`);
  } else {
    // TODO-QSP: dynamic text: "I make enough money to be able to afford the nicer things in life," <<$npcdesc>...
    scene.text(`"I make enough money to be able to afford the nicer things in life," ${((s as any).npcdesc ?? 0)} shrugs somewhat smugly. "What's a few pills here and there? So you ready to stop using condoms?"`);
  }
...
function enterMaPillMoney(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['ma_pill_money'] === 0  &&  ((s as any).npc_pay_for_ma_pill ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).sex_ev ?? 0)?.['creampie_count'] > 0) {
    ...
    if (((s as any).cum_loc ?? 0)?.['vagina'] > 0) {
      ...
      scene.text(`"Think I could get that money for the pill now?" you ask, rubbing your thighs together as you remember the feeling of ${((s as any).npcdesc ?? 0)}'s cum oozing from your pussy.`);
    }
  ...
  if (((s as any).birth_control ?? 0)?.['using_bc'] === 0) {
    ...
    if (((s as any).birth_control ?? 0)?.['think_safe'] === 0) {
      ...
      if (((s as any).npc_no_condoms ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        ...
        scene.text(`"Seriously?" ${((s as any).npcdesc ?? 0)} says, giving you an exasperated look. "You've been on birth control this whole time and we're still using condoms? What the hell!"`);
    ...
    scene.text(`"This is fucking dumb," ${((s as any).npcdesc ?? 0)} grumbles.`);
  }, goto: ['sex_ev_pillow_talk', 'topic_route'] },
        ]);
      } else {
        // TODO-QSP: dynamic text: "Seems a little excessive, don't you think?" <<$npcdesc>> says giving you an odd...
        scene.text(`"Seems a little excessive, don't you think?" ${((s as any).npcdesc ?? 0)} says giving you an odd look.`);
...
function enterBorrowMoney(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['borrow_$$'] === 0) {
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['borrow_$$'] = 1;
    qspCall(s, 'sex_ev_talk', 'borrow_planb');
    scene.actions([
...
function enterBorrowPlanb(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['creampie_count'] > 0) {
    ...
    scene.text(`"Hey, can I borrow some money?" you ask ${((s as any).npcdesc ?? 0)}. "I need it for the morning after pill."`);
    if (((s as any).npc_finance ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 4) + 1) > 1) {
      ...
      scene.text(`"Are you kidding? I barely have any money myself," ${((s as any).npcdesc ?? 0)} scowls. "I got nothing to give to you."`);
      ...
      if ((Math.floor(Math.random() * 4) + 1) === 1  &&  ((s as any).npc_finance ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
        ...
        if (((s as any).npc_know_bc ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
          ...
          if (((s as any).birth_control ?? 0)?.['think_safe'] === 1) {
            ...
            scene.text(`You give ${((s as any).npcdesc ?? 0)} an embarrassed smile.`);
          }
          if (((s as any).birth_control ?? 0)?.['think_safe'] === 1  &&  ((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
            ...
            if (((s as any).npc_childfree ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
              if (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
                ...
                scene.text(`"Ugh, how much do you need?" ${((s as any).npcdesc ?? 0)} grumbles reaching for his wallet.`);
              } else {
...
function enterCheatingRules(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_no_kiss ?? 0)?.[String((s as any).npcID ?? 0)] !== 1) {
    ...
    scene.text(`"That's fine," ${((s as any).npcdesc ?? 0)} nods.`);
  ...
  if (((s as any).npc_boyfriend_creampie_rule ?? 0)?.[String((s as any).npcID ?? 0)] !== 2) {
    ...
    if (((s as any).npc_condom_conscious ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      scene.text(`"We always use condoms anyways," ${((s as any).npcdesc ?? 0)} shrugs.`);
    } else {
      if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npclastgenerated ?? 0)] === 'creampie') {
        ...
        scene.text(`"But that's the best part about fucking you," ${((s as any).npcdesc ?? 0)} grins.`);
        ...
        if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npclastgenerated ?? 0)] === 'mouth') {
          ...
          scene.text(`"So long as I can watch you swallow," ${((s as any).npcdesc ?? 0)} grins.`);
        } else {
          if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npclastgenerated ?? 0)] === 'facial') {
            ...
            scene.text(`"So long as I can come all over your pretty face," ${((s as any).npcdesc ?? 0)} grins.`);
          } else {
            if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npclastgenerated ?? 0)] === 'tits') {
              ...
              scene.text(`"So long as I can come all over your beautiful tits," ${((s as any).npcdesc ?? 0)} grins.`);
            } else {
              if (((s as any).npc_cum_pref ?? 0)?.[String((s as any).npclastgenerated ?? 0)] === 'pullout') {
                ...
                scene.text(`"I prefer the pullout method anyways," ${((s as any).npcdesc ?? 0)} grins.`);
              }
            }
          }
        }
  ...
  if (((s as any).npc_condom_rule ?? 0)?.[String((s as any).npcID ?? 0)] !== 1) {
    ...
    if (!(s as any).npc_condom_rule) (s as any).npc_condom_rule = {}; (s as any).npc_condom_rule[String((s as any).npcID ?? 0)] = 1;
    // TODO-QSP: $sex_ev['bed_room']
    ...
    if (((s as any).npc_no_condoms ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      if (((s as any).npc_condom_conscious ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        ...
        scene.text(`"We already do," ${((s as any).npcdesc ?? 0)} smiles.`);
      } else {
        if (((s as any).npc_boyfriend_creampie_rule ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
          ...
          scene.text(`"A little redundant, don't you think?" ${((s as any).npcdesc ?? 0)} smirks.`);
        } else {
          // TODO-QSP: dynamic text: "I guess that's fair," <<$npcdesc>> says.
          scene.text(`"I guess that's fair," ${((s as any).npcdesc ?? 0)} says.`);
        }
      }
    }
    qspCall(s, 'sex_ev_talk', 'cheating_rules');
  ...
  scene.actions([
    ...
    scene.text(`"I can agree to that," ${((s as any).npcdesc ?? 0)} smiles.`);
...
function enterBoyDateAsk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`"We've been having fun, right?" ${((s as any).npcdesc ?? 0)} asks slowly.`);
  if (((s as any).sex_ev ?? 0)?.['simultaneous_orgasm_count'] > 0) {
    ...
    scene.text(`"They're called simultaneous orgasms, ${((s as any).npcdesc ?? 0)}," you grin back. `);
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterRapeExplain(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat ?? 0)?.['rape_count'] === 1) {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} stops in shock wondering what has just come over you as your body convulses in uncontrollable sobs. The images and sensations of that time come flooding back to you, invading your mind. It's as if you're back in that moment, being violated all over again.`);
  } else {
    if (((s as any).stat ?? 0)?.['rape_count'] < 5) {
      // TODO-QSP: dynamic text: <<$npcdesc>> stops in shock wondering what has just come over you as your body c...
      scene.text(`${((s as any).npcdesc ?? 0)} stops in shock wondering what has just come over you as your body convulses in uncontrollable sobs. The images and sensations come flooding back to you, invading your mind. The memories of your various attackers won't stop flashing before your eyes, memories of your body being violated like a montage you can't escape.`);
    } else {
      if (((s as any).stat ?? 0)?.['rape_count'] < 10) {
        // TODO-QSP: dynamic text: <<$npcdesc>> stops in shock wondering what has just come over you as your body c...
        scene.text(`${((s as any).npcdesc ?? 0)} stops in shock wondering what has just come over you as your body convulses in uncontrollable sobs. Images and sensations flood through you, invading your mind. The memories of your attackers all blur together, combining into one horrible sensation like they're all violating you at once.`);
      } else {
        // TODO-QSP: dynamic text: <<$npcdesc>> stops in shock wondering what has just come over you as your body c...
        scene.text(`${((s as any).npcdesc ?? 0)} stops in shock wondering what has just come over you as your body convulses in uncontrollable sobs. Images and sensations flood through you, invading your mind. Your countless rapes leave you a shuddering mess as the trauma threatens to overwhelm you.`);
      }
    }
  }
  // TODO-QSP: dynamic text: "What just...?" <<$npcdesc>> stammers confusedly.
  scene.text(`"What just...?" ${((s as any).npcdesc ?? 0)} stammers confusedly.`);
  // TODO-QSP: end
  scene.actions([
    ...
    if (!(s as any).npc_knows_rape_victim) (s as any).npc_knows_rape_victim = {}; (s as any).npc_knows_rape_victim[String((s as any).npcID ?? 0)] = 1;
    scene.img('images/shared/sex/after/pillow_talk1.jpg');
    // TODO-QSP: dynamic text: You crawl up beside <<$npcdesc>>, still shivering as you wipe the tears from you...
    scene.text(`You crawl up beside ${((s as any).npcdesc ?? 0)}, still shivering as you wipe the tears from your eyes that won't stop flowing.`);
    if (((s as any).stat ?? 0)?.['rape_count'] === 1) {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} is taken aback and goes quiet. Its several minutes before he finally speaks again.`);
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    scene.img('images/shared/sex/after/pillow_talk1.jpg');
    ...
    scene.text(`"So... I should lay off the rough sex in the future?" ${((s as any).npcdesc ?? 0)} asks hesitantly.`);
    scene.actions([
...
function enterProstitutionPayment(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'sugar_daddy'  &&  ((s as any).sex_ev ?? 0)?.['sugar_daddy_paid'] === 0  &&  ((s as any).sex_ev ?? 0)?.['sex_over'] === 1) {
    ...
    scene.text(`You pout cutely, making doe eyes at ${((s as any).npcdesc ?? 0)} who smiles back and reaches over to his wallet.`);
  ...
  }, goto: ['sex_ev_talk', 'prostitution_payment_thank'] },
      { label: 'Transactionally', handler: (st: GameState) => {
    if (!(s as any).npc_dislike) (s as any).npc_dislike = {}; (s as any).npc_dislike[String((s as any).npcID ?? 0)] = ((s as any).npc_dislike[String((s as any).npcID ?? 0)] ?? 0) + (1);
    scene.img('images/shared/sex/after/pillow_talk3.jpg');
    if (((s as any).sex_ev ?? 0)?.['fuck_count'] > 0) {
      ...
      scene.text(`"Okay, we've fucked. Can I get paid now?" you ask bluntly. ${((s as any).npcdesc ?? 0)} gives you a look but reaches over to his wallet and pulls out ${qspFunc(s, 'money', 'string_profit', ((s as any).sex_ev ?? 0)?.['prostitution_owed'])}.`);
    } else {
      // TODO-QSP: dynamic text: "Okay, I got you off. Can I get paid now?" you ask bluntly. <<$npcdesc>> gives y...
      scene.text(`"Okay, I got you off. Can I get paid now?" you ask bluntly. ${((s as any).npcdesc ?? 0)} gives you a look but reaches over to his wallet and pulls out ${qspFunc(s, 'money', 'string_profit', ((s as any).sex_ev ?? 0)?.['prostitution_owed'])}.`);
    }
    if (((s as any).npc_prostitution_tab ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      scene.text('You see he even paid you the money he owed you from last time.');
    }
    ...
    if (((s as any).sex_ev ?? 0)?.['prostituation_paid'] > 0) {
      ...
      if (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        ...
        scene.text(`"Fuck, I was hoping you'd forget about that," ${((s as any).npcdesc ?? 0)} scowls as he reaches for his money and pulls out some notes. "That's what I get for thinking with my dick."`);
      } else {
        // TODO-QSP: dynamic text: "A deal's a deal, I guess," <<$npcdesc>> says, reaching for his money to pull ou...
        scene.text(`"A deal's a deal, I guess," ${((s as any).npcdesc ?? 0)} says, reaching for his money to pull out some notes.`);
      }
      ...
      scene.text(`"Now that we've had our fun..." you say, smiling sweetly at ${((s as any).npcdesc ?? 0)}. "And I did something for you... Don't you have something for me...?"`);
      // TODO-QSP: dynamic text: You pout cutely, making doe eyes at <<$npcdesc>> who smiles back and reaches ove...
      scene.text(`You pout cutely, making doe eyes at ${((s as any).npcdesc ?? 0)} who smiles back and reaches over to his wallet.`);
    ...
    if (((s as any).sex_ev ?? 0)?.['prostituation_paid'] > 0) {
      ...
      if (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        ...
        scene.text(`"Fuck's sake, ${qspFunc(s, 'money', 'string_profit', ((s as any).sex_ev ?? 0)?.['prostitution_owed'])}?" ${((s as any).npcdesc ?? 0)} scowls as he reaches for his money and pulls out some notes. "That's what I get for thinking with my dick."`);

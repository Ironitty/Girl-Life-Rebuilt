...
function enterMorning(s: GameState, scene: SceneBuilder): void {
  if (((s as any).soniafall ?? 0)?.['gossip'] !== ((s as any).soniaQW ?? 0)?.['soniafall']  &&  ((s as any).soniaQW ?? 0)?.['soniafall'] > 0  &&  ((s as any).soniaQW ?? 0)?.['soniafall'] < 8) {
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterSoniaDiscoGossip(s, scene); (s as any).locArgs = __savedLocArgs; }
  }
  if (((s as any).sveta_dyke_rumor ?? 0) === 30  ||  ((s as any).sveta_dyke_rumor ?? 0) === 24  ||  ((s as any).sveta_dyke_rumor ?? 0) === 18  ||  ((s as any).sveta_dyke_rumor ?? 0) === 12  ||  ((s as any).sveta_dyke_rumor ?? 0) === 6  ||  ((s as any).sveta_dyke_rumor ?? 0) === 1) {
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', 'picture']; enterSvetaDykeRumors(s, scene); (s as any).locArgs = __savedLocArgs; }
  } else {
  ...
  if (((s as any).soniaQW ?? 0)?.['slut'] > 0  &&  ((s as any).soniaQW ?? 0)?.['slut'] < 4  &&  (Math.floor(Math.random() * (1+((s as any).soniaQW ?? 0)?.['slut'] - 0 + 1)) + (0))=== 0) {
    if (((s as any).soniaQW ?? 0)?.['slut'] === 1) {
      if ((((s as any).soniaQW ?? 0)?.['slutdays']+7) < ((s as any).daystart ?? 0)) {
        ((s as any).soniaQW = (s as any).soniaQW ?? {})['slut'] = 2;
        ...
        if (((s as any).hotornot ?? 0) === 0  &&  ((s as any).fuckornot_day ?? 0) < ((s as any).daystart ?? 0) - 9) {
          ...
          if (((s as any).hotornot ?? 0) === 1  &&  ((s as any).fuckornot_day ?? 0) < ((s as any).daystart ?? 0) - 11) {
            ...
            if (((s as any).cheerleadingQW ?? 0)?.['gossip'] === 0  &&  ((((s as any).month ?? 0) === 9  &&  ((s as any).day ?? 0) >= 19)  ||  ((s as any).month ?? 0) !== 9)) {
              ((s as any).cheerleadingQW = (s as any).cheerleadingQW ?? {})['gossip'] = 1;
              ((s as any).cheerleadingQW = (s as any).cheerleadingQW ?? {})['gossip_day'] = ((s as any).daystart ?? 0);
              ...
              if (((s as any).cheerleadingQW ?? 0)?.['gossip_day'] < ((s as any).daystart ?? 0)  &&  ((s as any).cheerleadingQW ?? 0)?.['gossip'] === 1) {
                ((s as any).cheerleadingQW = (s as any).cheerleadingQW ?? {})['gossip'] = 2;
                ((s as any).cheerleadingQW = (s as any).cheerleadingQW ?? {})['gossip_day'] = ((s as any).daystart ?? 0) + (7-((s as any).week ?? 0));
                ...
                if (((s as any).cheerleadingQW ?? 0)?.['gossip_day'] < ((s as any).daystart ?? 0)  &&  ((s as any).cheerleadingQW ?? 0)?.['gossip'] === 2) {
                  ((s as any).cheerleadingQW = (s as any).cheerleadingQW ?? {})['gossip'] = 3;
                  ((s as any).cheerleadingQW = (s as any).cheerleadingQW ?? {})['gossip_day'] = ((s as any).daystart ?? 0);
                  ...
                  if (((s as any).cheerleadingQW ?? 0)?.['gossip_day'] <= ((s as any).daystart ?? 0)  &&  ((s as any).cheerleadingQW ?? 0)?.['gossip'] === 3) {
                    ((s as any).cheerleadingQW = (s as any).cheerleadingQW ?? {})['gossip'] = 4;
                    ((s as any).cheerleadingQW = (s as any).cheerleadingQW ?? {})['gossip_day'] = ((s as any).daystart ?? 0);
                    ...
                    if ((!(Math.floor(Math.random() * 2) + 0))) {
                      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ((s as any).locArgs?.[1] ?? 0)]; enterMixed(s, scene); (s as any).locArgs = __savedLocArgs; }
                    } else {
                      if ((!(Math.floor(Math.random() * 2) + 0))) {
                        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ((s as any).locArgs?.[1] ?? 0)]; enterBoys(s, scene); (s as any).locArgs = __savedLocArgs; }
                      } else {
                        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ((s as any).locArgs?.[1] ?? 0)]; enterGirls(s, scene); (s as any).locArgs = __savedLocArgs; }
                      }
                    }
                  }
                }
                                                                                            ...
                                                                                            if (((s as any).chat_rand ?? 0) === 46) {
                                                                                              ...
                                                                                              if (((s as any).chat_rand ?? 0) === 47) {
                                                                                                ...
                                                                                                if (((s as any).chat_rand ?? 0) === 48) {
                                                                                                  ...
                                                                                                  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ((s as any).locArgs?.[1] ?? 0)]; enterLizaveta(s, scene); (s as any).locArgs = __savedLocArgs; }
                                                                                                }
                                                                                              }
                                                                                            }
                                                                                          }

...
function enterWhore1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).AlbinaQW ?? 0)?.['client1'] === 0) {
    ...
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['client1'] = 1;
    qspCall(st, 'stat', '');
    ...
    ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['client1_like'] = 1;
    qspCall(st, 'stat', '');
    ...
    if (((st as any).AlbinaQW ?? 0)?.['client1_like'] === 1) {
...
function enterWhore2(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'npcStat', '$AlbinaQW[\'Cust1\']', 'a');
  qspCall(s, 'stat', '');
  if (((s as any).AlbinaQW ?? 0)?.['client2'] === 0) {
    ...
    qspCall(st, 'arousal', 'hj', 3, ((st as any).npcID ?? 0), 'group', 'sub', 'prostitution');
    qspCall(st, 'arousal', 'bj', 6, ((st as any).npcID ?? 0), 'group', 'sub', 'rough', 'humiliation', 'prostitution');
    qspCall(st, 'pain', '1', 'throat', 'choke');
    qspCall(st, 'arousal', 'hj', 3, ((st as any).npcID1 ?? 0), 'group', 'sub', 'prostitution');
    qspCall(st, 'arousal', 'bj', 3, ((st as any).npcID1 ?? 0), 'group', 'sub', 'prostitution');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'anal', 30, ((st as any).npcID ?? 0), 'group', 'sub', 'rough', 'prostitution');
    qspCall(st, 'arousal', 'bj', (-1), ((st as any).npcID1 ?? 0), 'group', 'sub', 'rough', 'prostitution');
    qspCall(st, 'pain', '1', 'cheeks', 'slap');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'bj', (-1), ((st as any).npcID ?? 0), 'group', 'sub', 'rough', 'prostitution');
...
function enterWhore3(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).AlbinaQW ?? 0)?.['client3'] === 0) {
    ...
    qspCall(st, 'arousal', 'bj', 5, ((st as any).npcID ?? 0), 'sub', 'prostitution');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'bj', 10, ((st as any).npcID1 ?? 0), 'sub', 'group', 'prostitution');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterWhore4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'bj', (-2), 'prostitution');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Get fucked', handler: (st: GameState) => {
    ...
    qspCall(st, 'arousal', 'vaginal', (-2), 'prostitution');
    qspCall(st, 'arousal', 'foreplay', (-2), 'prostitution');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'vaginal', (-2), 'prostitution');
    qspCall(st, 'arousal', 'clit_finger', (-2), 'prostitution');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterWhore6(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'cuni', (-2), 'sub', 'prostitution');
    qspCall(st, 'arousal', 'vaginal_finger', (-1), 'sub', 'humiliation', 'prostitution');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterWhore7(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'outfit', 'strip_all', 'HotelRoom');
    qspCall(st, 'drugs', 'alcohol', 'vodka', (-3));
    qspCall(st, 'arousal', 'striptease', (-3), 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterWhore7_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'outfit', 'recover_lost_outfit', 'HotelRoom', 1);
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterWhore8(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).AlbinaQW ?? 0)?.['client8'] === 0) {
    ...
    qspCall(st, 'arousal', 'cuni_give', 10, 'lesbian', 'prostitution');
    qspCall(st, 'arousal', 'end');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    ...
    qspCall(st, 'stat', '');
    if (((st as any).AlbinaQW ?? 0)?.['client8'] === 0) {
      ((st as any).AlbinaQW = (st as any).AlbinaQW ?? {})['client8'] = 1;
...
function enterWhore9(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(st, 'arousal', 'vaginal', (-2), 'exhibitionism', 'prostitution');
    qspCall(st, 'stat', '');
    ...
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(st, 'arousal', 'bj', (-2), 'rough', 'prostitution');
    qspCall(st, 'stat', '');
    scene.img('images/locations/pavlovsk/resident/apartment/shulginhome/smroom/event/rought/oral1.mp4');

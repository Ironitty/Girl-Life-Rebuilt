...
function enterOldman(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He keeps this up for a while, and it is almost starting to feel okay when he pulls out and pauses. Again, you briefly think that he is done and only have a second to realize that, actually, he is rubbing the tip of his cock against your anus. Before you can even protest, his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock has already painfully penetrated your ass. You instinctively want to flinch away, but he grabs your hips with surprising strength and forces his cock as far into your ass as he can… before he starts hammering your ass. "My wife loved anal," he informs you between slaps of flesh against flesh, "I hope you don't mind."`);
...
function enterFit(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`As much as you would have liked to feel his heavenly fingers some more, you drop to your knees and waste no time in taking his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock deep into your mouth, immediately feeling his hand on back of your head. You wrap your lips tightly around the shaft of his cock and bob your head, sucking hard on him to give him an idea of the intense stimulation he gave you. Occasionally, he uses his hand to force you deeper down on him so you would gag a bit on his cock, but he seems mostly content with letting you pleasure him at your own pace.`);
    ...
    scene.text(`He pulls you up, back on your feet, and turns you around. You expect him to bend you over the next moment, but instead, he lifts one of your legs off the ground, and you feel him rubbing the head of his cock against your pussy lips, teasing you and himself and getting you all worked up again. Once his tip is nice and wet, he slides his ${((s as any).dick || '')}cm cock into you, filling your pussy with his ${((s as any).dick_girth || '')} cock.`);
...
function enterYoung(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Your need seems to explode at the sight, and you urgently pull your clothes aside enough to reveal your pussy and tits, squat down on his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock and guide him inside. You can feel it filling you up as you impale yourself on his hard shaft.`);
    ...
    scene.text(`"I'm glad that we've met today, ${((s as any).pcs_nickname || '')}. This has been one of the best days of my life; I'm not exaggerating. You are an amazing girl… and I hope to see you again someday." Honestly, you are a bit overwhelmed by this, but in a good way… in a great way, actually.`);
...
function enterBreastfeed1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    dynamicGoto(st, 'prevLoc', 'prevArg');
      ...
      scene.text(`The baby drinks from you for at least ${((s as any).temp_var || '')} minutes before you look up at the father.`);
...
function enterWeed(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He's barely even touched the ground when you straddle him and lower yourself down until you feel his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock stretch out your wet cunt. You moan out loud as you impale yourself on his shaft.`);
...
function enterPrivate(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Unfazed by his boldness, you kneel down in front of him and lick up and down his length a few times before you take his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock into your mouth, noticing that even it smells of that nice cologne.`);
    ...
    scene.text(`Once he has you lying on your back, bedded on dusty seat cushions with your nether parts fully exposed to him and anybody who might enter, he moves up and slips his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock into your ass without warning. It enters surprisingly easily, and even though you are unprepared, you manage to relax enough to avoid any pain.`);
...
function enterGopnik(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He meets no resistance when he turns you around and bends you over up against the side of the walkway railings; by the time he's lined his cock up with your pussy, you're looking back at him with eager anticipation. Impatient as you expected him to be, he slides his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock into your wet pussy.`);
    ...
    scene.text(`As you clean yourself up, he breaks into a chuckle as he realizes something: "By the way, I'm ${((s as any).boydesc || '')}."`);
    // TODO-QSP: dynamic text: You can't help but laugh. "<<$pcs_nickname>>, pleasure to meet you," you say in ...
    scene.text(`You can't help but laugh. "${((s as any).pcs_nickname || '')}, pleasure to meet you," you say in mock formality and even offer him your hand. "A real pleasure…" you add with a suggestive smile.`);
    ...
    scene.text(`"It was nice meeting you as well, ${((s as any).pcs_nickname || '')}. Maybe I can call you sometime?" he asks hopefully.`);
    qspCall(s, 'arousal', 'end');
    ...
    scene.text(`You shake your head. "Look, ${((s as any).boydesc || '')}. I had fun, but I'm not looking for anything more than that right now. Maybe we'll run into each other on the train again or something sometime?"`);

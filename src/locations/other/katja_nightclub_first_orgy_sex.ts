...
function enterFirstOrgyObserve1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).katjaQW = (s as any).katjaQW ?? {})['first_orgy'] = 'joining_in';
    ...
    scene.text(`You decide to return the favor and put your hands down ${((s as any).katja_first_orgy_temp ?? 0)?.['first_orgy_name_tatoo_guy'] ?? ''}'s pants to play with his ${((s as any).dick_girth1 || '')} cock.`);
    ...
    scene.actions([
      { label: '', labelFn: (s: GameState) => 'Join ' + String(((s as any).katja_first_orgy_temp ?? 0)?.['first_orgy_name_brown_dress'] ?? '' ?? '') + ' in sucking his cock', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    ...
    scene.text(`She then shares ${((s as any).katja_first_orgy_temp ?? 0)?.['first_orgy_name_tatoo_guy'] ?? ''}'s ${((s as any).dick1 || '')} cm long and ${((s as any).dick_girth1 || '')} cock with you, and you take turns blowing him.`);
    ...
    scene.actions([
      { label: '', labelFn: (s: GameState) => 'Play with ' + String(((s as any).katja_first_orgy_temp ?? 0)?.['first_orgy_name_brown_dress'] ?? '' ?? ''), handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    ...
    ((s as any).katjaQW = (s as any).katjaQW ?? {})['first_orgy'] = 'observing';
    ...
    scene.text(`In front of him is ${((s as any).katja_first_orgy_temp ?? 0)?.['first_orgy_name_brown_dress'] ?? ''}, who gets down on her knees and pulls out his ${((s as any).dick_girth1 || '')} cock before taking it into her mouth.`);
    scene.actions([
    ...
    scene.text(`He wastes no time and drives his ${((s as any).dick1 || '')} cm long ${((s as any).dick_girth1 || '')} cock into her waiting slit, causing her to let out a huge moan.`);
    ...
    scene.text(`"Come ${((s as any).pcs_nickname || '')}, don't be such a bore," you hear ${((s as any).katja_first_orgy_temp ?? 0)?.['first_orgy_name_curly'] ?? ''} say. "Get rid of your '+iif(PCloDress = 0, 'shirt', 'dress')+'."`);
    ...
    if (((s as any).pantyworntype ?? 0) !== 'naked'  ||  (!((s as any).PCloDress ?? 0))) {
      ...
      scene.text(`"${((s as any).pcs_nickname || '')}, get rid of '+iif(PCloSkirt > 0, 'that skirt and your panties', 'those '+iif(PCloPants > 0,'pants and panties', 'panties'))+' and be free like the rest of us," you hear from behind.`);
...
function enterFirstOrgyObserveDance2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    if (((s as any).anushkaQW ?? 0)?.['sex'] > 0) {
      ...
      scene.text(`"What happened to you, ${((s as any).pcs_nickname || '')}? You used to be fun! Whatever, I'll find somebody else," she says and moves on.`);
    } else {
  ...
  scene.actions([
    ...
    ((s as any).katjaQW = (s as any).katjaQW ?? {})['horny'] = ((s as any).katjaQW['horny'] ?? 0) + (Math.floor(Math.random() * 11) + 10);
    ((s as any).katjaQW = (s as any).katjaQW ?? {})['first_orgy'] = 'observing+nush_lick';
    ...
    scene.text(`"I need some of that juicy pussy if you don't mind," he laughs as he lines his ${((s as any).dick3 || '')} cm long ${((s as any).dick_girth3 || '')} cock up with your pussy.`);
    scene.actions([
      { label: 'Allow him to enter you', handler: (st: GameState) => {
    qspCall(s, 'arousal', 'vaginal', 2, ((s as any).npcID3 ?? 0), 'orgy');
    ((s as any).katjaQW = (s as any).katjaQW ?? {})['first_orgy'] = 'observing+dick';
    qspCall(s, 'stat', '');
...
function enterFirstOrgyJoin5(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You then feel ${((s as any).katja_first_orgy_temp ?? 0)?.['first_orgy_name_tatoo_guy'] ?? ''}'s ${((s as any).dick1 || '')} cm cock slam into your pussy before he starts fucking you hard.`);
...
function enterFirstOrgyJoin10(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Thanks ${((s as any).pcs_nickname || '')}, that was just what I needed. You're a champion pussy eater!" she laughs after she has stopped panting.`);
    ...
    scene.text(`"Come here, ${((s as any).pcs_nickname || '')}. It's time that I return the favor and do a little pussy licking of my own..." she says as she starts to drag you away.`);
...
function enterFirstOrgyPlayerTakesInitiative(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You then open his pants and pull them down so his ${((s as any).dick1 || '')} cm ${((s as any).dick_girth1 || '')} cock pops out.`);
    scene.actions([
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}, what are you doing?!" she asks, clearly not sure what to do with the situation.`);
    ...
    scene.text(`"Lick my pussy, ${((s as any).pcs_nickname || '')}!" she commands, and you do as you're told and start licking her pussy with all the skill you can muster.`);
    scene.actions([
...
function enterFirstOrgyInitiativeContinuedDance2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You get down on your knees, take his ${((s as any).dick_girth1 || '')} into your mouth, and start sucking it.`);
    ...
    scene.text(`You lay back and he soon has his ${((s as any).dick1 || '')} cm cock inside your pussy as he starts pounding you hard.`);
    scene.actions([
      { label: 'See what Katja is doing', handler: (st: GameState) => {
    qspCall(s, 'arousal', 'vaginal', 3, ((s as any).npcID1 ?? 0), 'orgy');
    qspCall(s, 'stat', '');

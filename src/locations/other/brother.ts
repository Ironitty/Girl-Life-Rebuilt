...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['Age'] = ((s as any).year ?? 0) - ((((s as any).npc_dob ?? {})?.['A34'] - (((s as any).npc_dob ?? {})?.['A34'] % 10000)) / 10000);
  (s as any).BrotherHappy = 1;
  qspCall(s, 'family_schedule', '');
  if ((((s as any).npc_dob ?? 0)?.['A34'] % 10000) / 100 > ((s as any).month ?? 0)) {
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['Age'] = ((s as any).brotherQW['Age'] ?? 0) - (1);
  }
  ...
  if (((s as any).npc_QW ?? 0)?.['A34'] > 20  &&  ((s as any).npc_QW ?? 0)?.['A34'] < 25) {
    if (!(s as any).npc_QW) (s as any).npc_QW = {}; (s as any).npc_QW['A34'] = 20;
  }
...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locat ?? 0)?.['Kolka'] === 7  ||  ((s as any).locat ?? 0)?.['Kolka'] === 11) {
    ...
    if (((s as any).clothingworntype ?? 0) === 'nude'  &&  ((s as any).towel ?? 0) === 1  &&  ((s as any).pantyworntype ?? 0) === 'none') {
      ...
      if (((s as any).clothingworntype ?? 0) === 'nude'  &&  ((s as any).pcs_pubes ?? 0) > 10  &&  ((s as any).pantyworntype ?? 0) === 'none') {
        ...
        if (((s as any).brotherQW ?? 0)?.['Sex'] < 2) {
          if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['Sex'] = 2;
        }
      } else {
  ...
  if (((s as any).loc ?? 0) === 'sitrPar') {
    ...
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day_night'] = ((s as any).daystart ?? 0);
...
function enterBroSchoolField(s: GameState, scene: SceneBuilder): void {
  if (((s as any).loc ?? 0) === 'gschool_grounds') {
    if (((s as any).week ?? 0) === 5  &&  ((s as any).locat ?? 0)?.['Kolka'] === 6) {
      scene.text('You wonder if your <a href="exec:gt \'brother\', \'start\'">brother</a> is one of the kids yelling.');
    } else {
      if ((((s as any).week ?? 0) < 6  &&  ((s as any).locat ?? 0)?.['Kolka'] === 6)  ||  ((((s as any).week ?? 0) >= 6  ||  ((s as any).kanikuli ?? 0) > 0)  &&  ((s as any).locat ?? 0)?.['Kolka'] === 9)) {
        scene.text('You see your <a href="exec:gt \'brother\', \'start\'">brother</a> play football by the field near the school.');
      }
    }
  }
  // TODO-QSP: end
...
function enterPlayfootball(s: GameState, scene: SceneBuilder): void {
  if ((!((s as any).playfootball ?? 0))) {
    ...
    if (((s as any).month ?? 0) === 1  ||  ((s as any).month ?? 0) === 2  ||  ((s as any).month ?? 0) === 12) {
      ...
      scene.img(`images/locations/pavlovsk/school/grounds/football${((s as any).picrand ?? 0)}.jpg`);
    }
    scene.text('You spend an hour sitting on the bench, watching the guys play football.');
    scene.actions([
      { label: 'Leave', handler: (st: GameState) => {
    if (((s as any).marisha_day ?? 0) !== ((s as any).daystart ?? 0)  &&  ((s as any).MarishaQW ?? 0)?.['Event'] < 3  &&  (!(Math.floor(Math.random() * 3) + 0))) {
      scene.actions([{ label: 'Continue', goto: ['marisha_ev', 'marisha_event'] }]);
    } else {
  ...
  if ((Math.floor(Math.random() * 2) + 0) === 0  &&  (!((s as any).seepornofut ?? 0))) {
    ...
    if (((s as any).kolkaseepornday ?? 0) === ((s as any).daystart ?? 0)) {
      scene.actions([
        { label: 'Leave', handler: (st: GameState) => {
    dynamicGoto(st, 'loc', 'loc_arg');
  } },
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Prove them wrong [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    ...
    dynamicGoto(st, 'loc', 'loc_arg');
        ...
        scene.text(`Kolka hesitates for a moment before giving you a funny look, "Actually, ${((s as any).pcs_nickname ?? 0)}, we want to go watch some porn but we weren't sure with having you around… But I think a girl like you could handle it."`);
        scene.actions([
          { label: 'Leave', handler: (st: GameState) => {
    dynamicGoto(st, 'loc', 'loc_arg');
  } },
  ...
  if (((s as any).seepornofut ?? 0) >= 1  &&  ((s as any).kolkaseepornday ?? 0) !== ((s as any).daystart ?? 0)) {
    ...
    scene.text(`The guys gather together and ask you, "${((s as any).pcs_nickname ?? 0)}, want to watch some porn?"`);
    scene.actions([
      { label: 'Leave', handler: (st: GameState) => {
    dynamicGoto(st, 'loc', 'loc_arg');
  } },
...
function enterKissTalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Kolka breaks the silence, "It's okay, ${((s as any).pcs_nickname ?? 0)}."`);
    ...
    // TODO-QSP: dynamic text: "It's okay, <<$pcs_nickname>>," he repeats as he turns back towards you. "Really...
    scene.text(`"It's okay, ${((s as any).pcs_nickname ?? 0)}," he repeats as he turns back towards you. "Really, it is. You're a beautiful girl," he says, causing you to blush even harder. "Anyone would be made happy if you kissed them like that. Even your brother. And if that's wrong…"`);
  ...
  if (((s as any).protect ?? 0) !== 1) {
    if ((Math.floor(Math.random() * 101) + 0) < ((s as any).pcs_horny ?? 0)) {
      ...
      if ((!((s as any).pose ?? 0))) {
        if ((!(Math.floor(Math.random() * 2) + 0))) {
          ...
          scene.text(`${((s as any).boydesc ?? 0)} groans and you quickly pull yourself off of his dick. His hot sperm squirts on your stomach.`);
        } else {
          qspCall(s, 'cum_call', 'labia', 'A34', 1);
          // TODO-QSP: dynamic text: <<$boydesc>> groans and you quickly pull yourself off of his dick. His hot sperm...
          scene.text(`${((s as any).boydesc ?? 0)} groans and you quickly pull yourself off of his dick. His hot sperm squirts on your exposed pussy.`);
        }
      } else {
        if (((s as any).pose ?? 0) === 1) {
          if ((!(Math.floor(Math.random() * 2) + 0))) {
            ...
            // TODO-QSP: dynamic text: <<$boydesc>> groans and you quickly pull yourself off of his dick. His hot sperm...
            scene.text(`${((s as any).boydesc ?? 0)} groans and you quickly pull yourself off of his dick. His hot sperm squirts on your back.`);
          } else {
            qspCall(s, 'cum_call', 'butt', 'A34', 1);
            // TODO-QSP: dynamic text: <<$boydesc>> groans and you quickly pull yourself off of his dick. His hot sperm...
            scene.text(`${((s as any).boydesc ?? 0)} groans and you quickly pull yourself off of his dick. His hot sperm squirts on your ass.`);
          }
        }
      }
    }
    ...
    if (((s as any).protect ?? 0) === 1) {
      ...
      if (((s as any).sexcontra ?? 0) === 4) {
        ...
        scene.text(`You pull off of ${((s as any).boydesc ?? 0)}, look at his dick and think, <i>Oh shit! The condom ripped.</i>`);
      } else {
        if (((s as any).sexcontra ?? 0) === 5) {
          // TODO-QSP: dynamic text: You pull off of <<$boydesc>>, look at his dick and think, <i>Oh shit! The condom...
          scene.text(`You pull off of ${((s as any).boydesc ?? 0)}, look at his dick and think, <i>Oh shit! The condom is missing!</i>.`);
        } else {
  ...
  if (((s as any).textrand ?? 0) === 1) {
    ...
    if (((s as any).textrand ?? 0) === 2) {
      ...
      if (((s as any).textrand ?? 0) === 3) {
        ...
        scene.text(`You brother looks up at you appreciatively, "Yes, ${((s as any).pcs_nickname ?? 0)}! Please help."`);
      } else {
          ...
          if (((s as any).textrand ?? 0) === 5) {
            ...
            if (((s as any).textrand ?? 0) === 6) {
              ...
              if (((s as any).textrand ?? 0) === 7) {
                ...
                scene.text(`He says, "Yes ${((s as any).pcs_nickname ?? 0)}, that would be fantastic."`);
              } else {
...
function enterBrotherSexStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).brotherQW ?? 0)?.['Sex'] >= 5) {
    ...
    // TODO-QSP: dynamic text: It isn't long before you hear your brother moan, "I'm gonna cum, <<$pcs_nickname...
    scene.text(`It isn't long before you hear your brother moan, "I'm gonna cum, ${((s as any).pcs_nickname ?? 0)}!"`);
    if (((s as any).brotherQW ?? 0)?.['Sex'] >= 6) {
      scene.actions([
  ...
  scene.actions([
    ...
    scene.text(`You take his hard ${((s as any).npc_dick ?? 0)?.['A34']} cm cock in your hand and begin masturbating him. It only takes a few minutes of gliding your hand up and down his shaft for him to cum. Kolka quietly groans as jets of hot cum erupt from his throbbing member all over your hand.`);
...
function enterFuckanal(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).brotherQW ?? 0)?.['Sex'] < 8) {
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['Sex'] = 8;
  }
  qspCall(s, 'boyStat', 'A34');
...
function enterBrotherSexEnd(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).loc ?? 0) === 'sitrPar'  &&  ((s as any).locat ?? 0)?.['Stepdad'] !== 10  &&  ((s as any).locat ?? 0)?.['Kolka'] === 11) {
    ...
    scene.text(`With a wide grin on his face, Kolka tells you, "Many thanks, ${((s as any).pcs_nickname ?? 0)}, you've helped me a lot." He resumes his prior business.`);
    scene.actions([
      { label: 'Leave', goto: ['sitrPar', ''] },
    ]);
  } else {
    if (((s as any).loc ?? 0) === 'sitrPar'  &&  ((s as any).npc_rel ?? 0)?.['A34'] >= 80) {
      (s as any).minut = ((s as any).minut ?? 0) + 15;
      qspCall(s, 'stat', '');
      // TODO-QSP: dynamic text: Completely sated, Kolka mumbles to you, "Thanks <<$pcs_nickname>>, you're the be...
      scene.text(`Completely sated, Kolka mumbles to you, "Thanks ${((s as any).pcs_nickname ?? 0)}, you're the best…" In just a few seconds, he's already dozing off into a blissfull sleep.`);
      scene.actions([
        { label: 'Leave', goto: ['sitrPar', ''] },
      ]);
    } else {
      if (((s as any).loc ?? 0) === 'sitrPar') {
        ...
        scene.text(`Kolka gives his deflating member a quick shake, "Thanks, ${((s as any).pcs_nickname ?? 0)}, you saved me. Now I can finally sleep…" He slides under his covers and promptly falls asleep.`);
        scene.actions([
          { label: 'Leave', goto: ['sitrPar', ''] },
        ]);
      } else {
        ...
        scene.text(`Kolka lets out a very satisfied sigh, "Ah, thanks so much for that, ${((s as any).pcs_nickname ?? 0)}. I gotta go." He puts his drained cock back into his pants and leaves.`);
        scene.actions([
          { label: 'Continue', handler: (st: GameState) => {
    dynamicGoto(st, 'loc', 'loc_arg');
  } },
...
function enterBrotherSexCount(s: GameState, scene: SceneBuilder): void {
  if (((s as any).brotherQW ?? 0)?.['last_sex_day'] <= ((s as any).daystart ?? 0) - 1  &&  ((s as any).brotherQW ?? 0)?.['sex_count_today'] > 0) {
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['sex_count_today'] = 5;
  }
  if (((s as any).brotherQW ?? 0)?.['last_sex_day_morning'] !== ((s as any).daystart ?? 0)) {
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day_morning'] = ((s as any).daystart ?? 0) - 1;
  }
  if (((s as any).brotherQW ?? 0)?.['last_sex_day_evening'] !== ((s as any).daystart ?? 0)) {
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day_evening'] = ((s as any).daystart ?? 0) - 1;
  }
  if (((s as any).brotherQW ?? 0)?.['last_sex_day_night'] !== ((s as any).daystart ?? 0)) {
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day_night'] = ((s as any).daystart ?? 0) - 1;
  }
  if (((s as any).brotherQW ?? 0)?.['sex_count_today'] < 1) {
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day'] = ((s as any).daystart ?? 0) + 1;
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['sex_count_today'] = 5;
  } else {
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day'] = ((s as any).daystart ?? 0);
  }
  if (((s as any).brotherQW ?? 0)?.['last_sex_day'] === 0) {
    if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['last_sex_day'] = 1;
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterAnusCheck(s: GameState, scene: SceneBuilder): void {
  if (((s as any).analPlugIn ?? 0) === 1) {
    if (((s as any).brotherQW ?? 0)?.['saw_analplug'] === 0) {
      if (!(s as any).brotherQW) (s as any).brotherQW = {}; (s as any).brotherQW['saw_analplug'] = 1;
      ...
      scene.text(`His voice drops a bit, "Er… No, thank you." He clears his throat, "${((s as any).pcs_nickname ?? 0)}, do all girls like it?"`);
      ...
      if (((s as any).brotherQW ?? 0)?.['saw_analplug'] === 1) {
        ...
        if (((s as any).brotherQW ?? 0)?.['Sex'] > 4) {
          ...
          scene.text(`Your brother jokes, "${((s as any).pcs_nickname ?? 0)}, you're such a pervert!"`);
        }
      }
    }
  } else {
    if (((s as any).brother_anus_mem ?? 0) < ((s as any).anpic ?? 0)) {
      ...
      scene.text(`Kolka spends a moment looking at your ass, "${((s as any).pcs_nickname ?? 0)}, I think your butthole is larger?"`);
      ...
      scene.text(`"It has changed!" he responds. "Before it was smaller! ${((s as any).pcs_nickname ?? 0)}, did you let a guy fuck you in the ass?"`);
...
function enterPregreact(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).knowpreg ?? 0) === 1  &&  ((s as any).kid ?? 0) === 0  &&  qspFunc(s, 'body_din', 'pregnancyVisibility') === 1) {
    if (((s as any).clothingworntype ?? 0) === 'nude'  &&  ((s as any).brotherQW ?? 0)?.['Sex'] < 7) {
      ...
      scene.text(`Surprised, your brother looks at your stomach. "${((s as any).pcs_nickname ?? 0)}, are you pregnant? ${((s as any).npc_nickname ?? 0)?.['A29']} and dad are going to be pissed!" After a moments pause he adds, "You do still look good, though."`);
      if (!(s as any).npc_pregtalk) (s as any).npc_pregtalk = {}; (s as any).npc_pregtalk['A34'] = 1;
      return;
      scene.actions([
      ...
      if (((s as any).clothingworntype ?? 0) !== 'nude'  &&  ((s as any).brotherQW ?? 0)?.['Sex'] < 7) {
        // TODO-QSP: dynamic text: Surprised, your brother looks at your stomach, "<<$pcs_nickname>>, why didn't yo...
        scene.text(`Surprised, your brother looks at your stomach, "${((s as any).pcs_nickname ?? 0)}, why didn't you tell me I'm going to be an uncle?"`);
        if (!(s as any).npc_pregtalk) (s as any).npc_pregtalk = {}; (s as any).npc_pregtalk['A34'] = 1;
        return;
        scene.actions([
          { label: 'Continue', goto: ['sitrPar', ''] },
    ...
    if (((s as any).brotherQW ?? 0)?.['Sex'] < 7  &&  ((s as any).kid ?? 0) > 0  &&  qspFunc(s, 'body_din', 'pregnancyVisibility') === 1) {
      ...
      // TODO-QSP: dynamic text: Kolka takes a serious tone, "<<$pcs_nickname>>, I am always proud of you. You're...
      scene.text(`Kolka takes a serious tone, "${((s as any).pcs_nickname ?? 0)}, I am always proud of you. You're my sister and I'll love you no matter what."`);
...
function enterBrotherknows2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You glare at Kolka, "Fuck off! Can you think about anything other than yourself for one second? I'm not protecting you. ${((s as any).npc_nickname ?? 0)?.['A29']} is going to find out, and you'll just have to deal with that!"`);
    scene.text('You storm away from Kolka, leaving him to squirm in discomfort.');
    scene.actions([
      { label: 'Continue', goto: ['sitrPar', ''] },
    ]);
...
function enterBrotherknows6(s: GameState, scene: SceneBuilder): void {
  ...
  if ((Array.isArray((s as any).ChildThFath) ? ((s as any).ChildThFath as any[]).indexOf('A34') : -1) >= 0  &&  ((s as any).BrotherHappy ?? 0) === 1) {
    ...
    scene.text(`Kolka stares into your ${((s as any).pcs_eyecolor ?? 0)} eyes, his face bright red and a bulge growing in his pants.`);
    ...
    if (((s as any).momKnowsKolka ?? 0) === 1  &&  qspFunc(s, 'homes_properties', 'has_access', 'parents_home')) {
      // TODO-QSP: dynamic text: Kolka chuckles, "Since <<$npc_nickname['A29']>> already knows I've gotten you pr...
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 10;
      ...
      if (((s as any).momKnowsKolka ?? 0) === 1  &&  qspFunc(s, 'homes_properties', 'has_access', 'parents_home') === 0) {
        // TODO-QSP: dynamic text: "Since <<$npc_nickname['A29']>> already knows I've gotten you pregnant before, w...
        ...
        // TODO-QSP: dynamic text: You scowl, "I don't give a fuck what <<$npc_nickname['A29']>> knows. She's not s...
        ...
        // TODO-QSP: dynamic text: Once you're finished speaking, your brother covers your <<$pc_desc['lips']>> lip...
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 10;
        ...
        if (((s as any).momKnowsKolka ?? 0) === 0  &&  (!((s as any).brotherBlackmail ?? 0))) {
          // TODO-QSP: dynamic text: Kolka looks at you, somewhat uneasily, "Since <<$npc_nickname['A29']>> still doe...
    ...
    if ((Array.isArray((s as any).ChildThFath) ? ((s as any).ChildThFath as any[]).indexOf('A34') : -1) >= 0  &&  ((s as any).BrotherAngry ?? 0) === 1) {
      ...
      if (((s as any).momKnowsKolka ?? 0) === 1  &&  qspFunc(s, 'homes_properties', 'has_access', 'parents_home')) {
        // TODO-QSP: dynamic text: "<<$npc_nickname['A29']>> already knows you got me pregnant before." You breath ...
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 10;
      ...
      if (((s as any).wombthfathID ?? 0) === 'A34'  &&  ((s as any).BrotherHappy ?? 0) === 1) {
        ...
        scene.text(`momKnowsKolka = ${((s as any).momKnowsKolka ?? 0)}`);
        // TODO-QSP: dynamic text: brotherBlackmail = <<brotherBlackmail>>
        scene.text(`brotherBlackmail = ${((s as any).brotherBlackmail ?? 0)}`);
        // TODO-QSP: dynamic text: BrotherHappy = <<BrotherHappy>>
        scene.text(`BrotherHappy = ${((s as any).BrotherHappy ?? 0)}`);
        scene.actions([
          { label: 'Happy', goto: ['brother', 'brotherknows1'] },
          { label: 'Angry', goto: ['brother', 'brotherknows2'] },
        ]);
...
function enterBrotherknows8(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).wombthfathID ?? 0) !== 'A34'  &&  (Array.isArray((s as any).ChildThFath) ? ((s as any).ChildThFath as any[]).indexOf('A34') : -1) >= 0  &&  ((s as any).wombthfathID ?? 0) !== 'unknown'  &&  ((s as any).wombthfathID ?? 0) !== '') {
    // TODO-QSP: dynamic text: "Not this time. It's actually <<$wombthfath>>'s. Why, were you hoping you'd give...
    scene.text(`"Not this time. It's actually ${((s as any).wombthfath ?? 0)}'s. Why, were you hoping you'd give me more children? Sorry, but this body is just too good to limit myself to one man, even if that man is my cute younger brother," you giggle.`);
    ...
    if (((s as any).wombthfathID ?? 0) !== 'A34'  &&  (Array.isArray((s as any).ChildThFath) ? ((s as any).ChildThFath as any[]).indexOf('A34') : -1) < 0  &&  ((s as any).wombthfathID ?? 0) !== 'unknown'  &&  ((s as any).wombthfathID ?? 0) !== '') {
      // TODO-QSP: dynamic text: You shake your head, "No, not this time either. It's actually <<$wombthfath>>'s....
      scene.text(`You shake your head, "No, not this time either. It's actually ${((s as any).wombthfath ?? 0)}'s."`);

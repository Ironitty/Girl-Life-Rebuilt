...
function enterKolkabj(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['KolkaFuckDay'] = ((s as any).daystart ?? 0);
  if (((s as any).NatbelQW ?? 0)?.['QWstage'] === 8) {
    if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['QWstage'] = 9;
  }
  qspCall(s, 'stat', '');
  ...
  scene.actions([
    ...
    if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['bj'] = ((s as any).NatbelQW['bj'] ?? 0) + (1);
...
function enterSoftsex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).NatbelQW ?? 0)?.['KolkaFootjob'] === 0) {
      if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['KolkaFootjob'] = 1;
...
function enterPenetration(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['vaginal'] = ((s as any).NatbelQW['vaginal'] ?? 0) + (1);
...
function enterKolkacum(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 1) {
    ...
    if (!(s as any).NatbelQW) (s as any).NatbelQW = {}; (s as any).NatbelQW['KolkaCP'] = ((s as any).NatbelQW['KolkaCP'] ?? 0) + (1);

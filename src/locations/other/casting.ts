...
function enterAuditionSchedule(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).month ?? 0) === 2  &&  (((s as any).audition ?? 0)?.['week'] + ((s as any).day ?? 0)) > 28) {
    ...
    (s as any).audition['calendar_day'] = ((s as any).day ?? 0) - 28 + ((s as any).audition ?? {})?.['week'];
  } else {
    if ((((s as any).month ?? 0) === 4  ||  ((s as any).month ?? 0) === 6  ||  ((s as any).month ?? 0) === 9  ||  ((s as any).month ?? 0) === 11)  &&  (((s as any).audition ?? 0)?.['week'] + ((s as any).day ?? 0)) > 30) {
      (s as any).audition['month'] = ((s as any).next_month_name ?? 0);
      (s as any).audition['calendar_day'] = ((s as any).day ?? 0) - 30 + ((s as any).audition ?? {})?.['week'];
    } else {
      if ((((s as any).month ?? 0) === 1  ||  ((s as any).month ?? 0) === 3  ||  ((s as any).month ?? 0) === 5  ||  ((s as any).month ?? 0) === 7  ||  ((s as any).month ?? 0) === 8  ||  ((s as any).month ?? 0) === 10  ||  ((s as any).month ?? 0) === 12)  &&  (((s as any).audition ?? 0)?.['week'] + ((s as any).day ?? 0)) > 31) {
        (s as any).audition['month'] = ((s as any).next_month_name ?? 0);
        (s as any).audition['calendar_day'] = ((s as any).day ?? 0) - 31 + ((s as any).audition ?? {})?.['week'];
      } else {
        (s as any).audition['calendar_day'] = ((s as any).day ?? 0) + ((s as any).audition ?? {})?.['week'];
        (s as any).audition['month'] = ((s as any).monthName ?? 0);
      }
    }
  }
  (s as any).audition['day'] = ((s as any).daystart ?? 0) + ((s as any).audition ?? {})?.['week'];
  (s as any).acting['shoot_day'] = ((s as any).daystart ?? 0) + ((s as any).rand ?? 0)(((s as any).audition ?? {})?.['day'] + ((s as any).rand ?? 0)(2, 7));
...
function enterBackShowerGirl(s: GameState, scene: SceneBuilder): void {
  (s as any).audition['roletype'] = 3;
  (s as any).audition['type'] = 'titty';
  (s as any).costuming['outfit'] = 'nude';
  (s as any).acting['pay'] = (((s as any).audition ?? {})?.['roletype'] + 1) * 800 + (15 * ((s as any).rand ?? 0)(0, ((s as any).roletype ?? 0)));
  ...
  scene.actions([
    ...
    (s as any).audition['role'] = 'Background Shower Girl';
...
function enterSpringBreakFlasher(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'Talk to the receptionist', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Spring Break Flasher';
  }, goto: ['casting', 'general_tryout'] },
  ]);
  scene.build();
}
...
function enterCadaver(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'Talk to the receptionist', handler: (st: GameState) => {
    (s as any).audition['role'] = 'cadaver';
  }, goto: ['casting', 'general_tryout'] },
  ]);
  scene.build();
}
...
function enterDildoGirl(s: GameState, scene: SceneBuilder): void {
  (s as any).audition['roletype'] = 3;
  (s as any).audition['type'] = 'titty';
  (s as any).costuming['type'] = 'panties';
  (s as any).costuming['panties'] = 'gm';
  (s as any).costuming['pantynumber'] = 31;
  (s as any).acting['pay'] = (((s as any).audition ?? {})?.['roletype'] + 1) * 800 + (15*((s as any).rand ?? 0)(0, ((s as any).roletype ?? 0)));
  ...
  scene.actions([
    ...
    { label: 'Talk to the receptionist', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Dildo Girl';
  }, goto: ['casting', 'general_tryout'] },
  ]);
  scene.build();
}
...
function enterNakedLockerGirl(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'Talk to the receptionist', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Naked Locker Girl';
  }, goto: ['casting', 'general_tryout'] },
  ]);
  scene.build();
}
...
function enterUndressingLockerGirl(s: GameState, scene: SceneBuilder): void {
  (s as any).audition['roletype'] = 3;
  (s as any).audition['type'] = 'titty';
  (s as any).costuming['type'] = 'normal';
  (s as any).costuming['outfit'] = 'panties';
  (s as any).costuming['panties'] = 'fashionista';
  (s as any).costuming['pantynumber'] = 13;
  (s as any).costuming['pantytype'] = 'thong';
  (s as any).costuming['pantydrawer'] = 'filled with thongs. She picks one out and';
  (s as any).acting['pay'] = (((s as any).audition ?? {})?.['roletype'] + 1) * 800 + (15 * ((s as any).rand ?? 0)(0, ((s as any).roletype ?? 0)));
  ...
  scene.actions([
    ...
    { label: 'Talk to the receptionist', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Undressing Locker Girl';
  }, goto: ['casting', 'general_tryout'] },
  ]);
  scene.build();
}
...
function enterModestCheerleader(s: GameState, scene: SceneBuilder): void {
  (s as any).audition['roletype'] = 1;
  (s as any).audition['type'] = 'face_check';
  (s as any).costuming['type'] = 'normal';
  (s as any).costuming['outfit'] = 'cheerleader';
  (s as any).acting['pay'] = (((s as any).audition ?? {})?.['roletype'] + 1) * 800 + (15 * ((s as any).rand ?? 0)(0, ((s as any).roletype ?? 0)));
  ...
  scene.actions([
    ...
    { label: 'Talk to the receptionist', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Modest Cheerleader';
  }, goto: ['casting', 'general_tryout'] },
  ]);
  scene.build();
}
...
function enterUnderwearCheerleader(s: GameState, scene: SceneBuilder): void {
  (s as any).audition['roletype'] = 2;
  (s as any).audition['type'] = 'body_check';
  (s as any).costuming['type'] = 'normal';
  (s as any).costuming['outfit'] = 'underwear';
  (s as any).costuming['underwear'] = 'cats';
  (s as any).acting['pay'] = (((s as any).audition ?? {})?.['roletype'] + 1) * 800 + (15 * ((s as any).rand ?? 0)(0, ((s as any).roletype ?? 0)));
  ...
  scene.actions([
    ...
    { label: 'Talk to the receptionist', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Underwear Cheerleader';
  }, goto: ['casting', 'general_tryout'] },
  ]);
  scene.build();
}
...
function enterToplessCheerleader(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).audition['type'] = 'titty';
  (s as any).costuming['outfit'] = 'panties';
  (s as any).costuming['panties'] = 'cats';
  (s as any).costuming['pantytype'] = 'normal';
  (s as any).costuming['pantydrawer'] = 'to pull out a random pair of panties';
  (s as any).acting['pay'] = (((s as any).audition ?? {})?.['roletype'] + 1) * 800 + (15*((s as any).rand ?? 0)(0, ((s as any).roletype ?? 0)));
  ...
  scene.actions([
    ...
    { label: 'Talk to the receptionist', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Topless Cheerleader 3';
  }, goto: ['casting', 'general_tryout'] },
  ]);
  scene.build();
}
...
function enterHotShowerGirl(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'Talk to the receptionist', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Hot Shower Girl';
  }, goto: ['casting', 'general_tryout'] },
  ]);
  scene.build();
}
...
function enterWerewolfGirl(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { label: 'Talk to the receptionist', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Werewolf Victim';
  }, goto: ['casting', 'general_tryout'] },
  ]);
  scene.build();
}
...
function enterDinerWaitress(s: GameState, scene: SceneBuilder): void {
  (s as any).audition['roletype'] = 5;
  (s as any).audition['room'] = Math.floor(Math.random() * 5) + 1;
  (s as any).audition['requirement'] = 50;
  (s as any).acting['pay'] = (((s as any).audition ?? {})?.['roletype'] + 1) * 800 + (15*((s as any).rand ?? 0)(0, ((s as any).roletype ?? 0)));
  (s as any).acting['scenecount'] = 2;
  qspCall(s, 'casting', 'audition_schedule');
  ...
  scene.actions([
    ...
    (s as any).audition['role'] = 'Diner Waitress';
...
function enterSluttyClubGirl(s: GameState, scene: SceneBuilder): void {
  (s as any).audition['roletype'] = 5;
  (s as any).audition['room'] = Math.floor(Math.random() * 5) + 1;
  (s as any).audition['requirement'] = 60;
  (s as any).audition['unique'] = 1;
  (s as any).acting['pay'] = (((s as any).audition ?? {})?.['roletype'] + 1) * 800 + (15*((s as any).rand ?? 0)(0, ((s as any).roletype ?? 0)));
  (s as any).acting['scenecount'] = 1;
  qspCall(s, 'casting', 'audition_schedule');
  ...
  scene.actions([
    ...
    { label: 'Try out for this role', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Slutty Club Girl';
    qspCall(s, 'casting', 'tryout');
  } },
  ]);
  scene.build();
...
function enterYulyaGavrikov(s: GameState, scene: SceneBuilder): void {
  (s as any).audition['roletype'] = 9;
  (s as any).audition['role'] = 'YulyaGavrikov';
  (s as any).audition['number'] = 1;
  (s as any).audition['room'] = Math.floor(Math.random() * 5) + 1;
  (s as any).acting['filmdays'] = 40;
  (s as any).acting['pay'] = (((s as any).audition ?? {})?.['roletype'] + 1) * 800 + (15*((s as any).rand ?? 0)(0, ((s as any).roletype ?? 0)));
  qspCall(s, 'casting', 'audition_schedule');
  ...
  scene.actions([
    ...
    { label: 'Try out for this role', handler: (st: GameState) => {
    (s as any).audition['role'] = 'Yulya Gavrikov';
    qspCall(s, 'casting', 'tryout');
  } },
  ]);
  scene.build();

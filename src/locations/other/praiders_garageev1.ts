...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'anal', 3);
    qspCall(s, 'cum_call', 'anus', 'A154', 1);
...
export const praiders_garageev1: LocationDef = {
  ...
  region: 'other',
  description: ['Once the two of you are alone, he turns the radio back on and sits on an up turned box next to it. "Come on, give me a little show."'],
  enter: enter,
};

...
function enterLakeActivities(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hour ?? 0) >= 20) {
    ...
    if (((s as any).katjaQW ?? 0)?.['slut'] >= 20  &&  ((s as any).katjaQW ?? 0)?.['horny'] >= 20) {
      ...
      scene.text(`"You know ${((s as any).pcs_nickname || '')}, the sun feels nice and there aren't people around here. So what do you think?"`);
      ...
      scene.text(`"Think ${((s as any).pcs_nickname || '')}. The water dripping over our naked skin, the wind in our hair, and the two of us... All alone..."`);
    ...
    qspGoto(s, 'katja_lake', 'walk');
  } },
    ]);
  } },
      ]);
    } else {
      qspGoto(s, 'katja_lake', 'beach_in_swimwear1');
    }
  } },
          ]);
        }
    ...
    qspCall(s, 'outfit', 'strip_all');
    qspGoto(s, 'katja_lake', 'beach_nude');
  } },
          ]);
        } else {
...
function enterSaunaTime(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sauna_daystart ?? 0) === ((s as any).daystart ?? 0)) {
    ...
    if (((s as any).katjaQW ?? 0)?.['slut'] >= 20  &&  ((s as any).katjaQW ?? 0)?.['horny'] >= 20) {
      ...
      scene.text(`"I... was thinking, ${((s as any).pcs_nickname || '')}... Maybe it's better if we go naked, I mean, the hot steam will make us sweat and my bikini will feel uncomfortable. What do you think? All that sweat all over my skin. It gives you ideas, doesn't it?"`);
      qspCall(s, 'willpower', 'exhib', 'resist', 'hard');
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Resist', handler: (st: GameState) => {
    ...
    qspGoto(s, 'katja_lake', 'saune_time');
      ...
      qspGoto(s, 'katja_lake', 'sauna_in_swimmwear1');
    }
    if (((s as any).pcs_inhib ?? 0) > 20) {
      scene.actions([
        { label: 'Go in the nude', handler: (st: GameState) => {
...
function enterWinterActivities(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).dummy ?? 0) === 1) {
    ...
    if (((s as any).dummy ?? 0) > ((s as any).pcs_icesktng ?? 0)  &&  ((s as any).dummy ?? 0) < 51) {
      ...
      scene.text(`"${((s as any).pcs_nickname || '')}! You're- " she says while trying to contain her laughter.`);
      ...
      scene.text(`"I - I'm sorry, ${((s as any).pcs_nickname || '')}!" she manages to say while laughing heartily.`);
      scene.actions([
    ...
    if (((s as any).dummy ?? 0) <= 3) {
      ...
      scene.text(`"Sorry ${((s as any).pcs_nickname || '')}, it's just that you're one of the worst skaters I've seen!"`);
    ...
    qspCall(st, 'mood', 'lower', 'small');
      ...
      if (((s as any).dummy ?? 0) > ((s as any).pcs_icesktng ?? 0)  &&  ((s as any).dummy ?? 0) > 50) {
        ...
        scene.text(`"Oh god! ${((s as any).pcs_nickname || '')}! What are you doing to me?!"`);
        ...
        scene.text(`Ouch! Who had the bright idea to give you skates, ${((s as any).pcs_nickname || '')}?"`);
        qspCall(s, 'stat', '');
        scene.actions([
          { label: '…?', handler: (st: GameState) => {
    ...
    if (((s as any).dummy ?? 0) <= 2) {
      ...
      scene.text(`"Come on, ${((s as any).pcs_nickname || '')}! What are you waiting for? Help me!"`);
    ...
    // TODO-QSP: katjaQW['horny'] += 5
        ...
        scene.text(`"Good question. This is by far your worst performance, ${((s as any).pcs_nickname || '')}!"`);
    ...
    qspCall(st, 'npc_relationship', 'modify', 'A14', (-1));
        ...
        if (((s as any).dummy ?? 0) < ((s as any).pcs_icesktng ?? 0)) {
          if (((s as any).dummy ?? 0) > 75) {
            ...
            scene.text(`"You've improved, ${((s as any).pcs_nickname || '')}."`);
            ...
            scene.text(`"Come on, ${((s as any).pcs_nickname || '')}! Showtime!" Katja screams at you excitedly as you rush towards the "Ice Queen", following her lead around the lake and imitating her movements.`);
            ...
            scene.text(`"Hmm. Not bad, ${((s as any).pcs_nickname || '')}."`);
            ...
            scene.text(`"That was so cool, ${((s as any).pcs_nickname || '')}! You are good!"`);
    ...
    qspCall(s, 'exp_gain', 'react', 1);
    qspCall(s, 'exp_gain', 'icesktng', 1);
    qspGoto(s, 'katjaEv', 'kathan');
  } },
            ]);
          } else {
            if (((s as any).dummy ?? 0) > 50) {
    ...
    qspCall(st, 'npc_relationship', 'modify', 'A14', 1);
              ...
              scene.text(`"${((s as any).pcs_nickname || '')}! Don't let me go!" Katja squeals.`);
...
function enterHockeyMatch(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}! What are you doing?!"`);
    ...
    (s as any).boydesc = 'The bitch squad';
    (s as any).npcdesc = 'The bitch squad';
    scene.img('images/characters/pavlovsk/school/girl/katja/KWT14.jpg');
    qspCall(s, 'fight', 'initFight');
    qspCall(s, 'fight_npcdata', 'bitch squad');
...
function enterIvanAppeared(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).clothingworntype ?? 0) === 'nude'  &&  ((s as any).katjaQW ?? 0)?.['slut'] <= 40) {
    ...
    // TODO-QSP: dynamic text: Katja's face contorts between disbelief and embarrassment. "Talk with him?! <<$p...
    scene.text(`Katja's face contorts between disbelief and embarrassment. "Talk with him?! ${((s as any).pcs_nickname || '')}! We're <i>naked</i>!"`);
    ...
    scene.text(`"Please ${((s as any).pcs_nickname || '')}! Don't do anything stupid!"`);
...
function enterIvanInteraction(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).IvanShowerQW ?? 0) === 11  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 250  &&  ((s as any).katjaQW ?? 0)?.['horny'] > 60  &&  ((s as any).katjaQW ?? 0)?.['anal_quest'] >= 2  &&  ((s as any).npc_had_sex ?? 0)?.['A14']  &&  ((s as any).katjaQW ?? 0)?.['sex_clossedness'] === 0) {
      scene.actions([
    ...
    if ((Math.floor(Math.random() * 2) + 0) === 1) {
      ...
      if (((s as any).npc_throat ?? 0)?.['A14'] < 1) {
        // TODO-QSP: dynamic text: Katja looks transfixed by Ivan's <<dick>>cm <<$dick_girth>> cock. This must be t...
        scene.text(`Katja looks transfixed by Ivan's ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock. This must be the first time she's seen something like this and seems unsure about what to do. Ivan extends his hand and tries to grab Katja's head, but before he reaches her, you slap his hand.`);
        ...
        // TODO-QSP: dynamic text: You and Katja caress Ivan's <<dick>>cm <<$dick_girth>> cock, causing him to grun...
        scene.text(`You and Katja caress Ivan's ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock, causing him to grunt in pleasure as he let you take control. Katja licks her lips and looks at you with questioning eyes. She seems to want to do this.`);
    ...
    if (((s as any).dick ?? 0) > ((s as any).npc_throat ?? 0)?.['A14']) {
      ...
      scene.text(`Ivan makes Katja sit and he stands to put his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock before her face, frightening her with the length before her. In the meantime, you sit by her side and caress her back.`);
      ...
      scene.text(`Ivan makes Katja sit as he stands to put his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock before her face, Katja looking intensely at the length before her. In the meantime, you sit by her side and caress her back.`);
      scene.text('"Don\'t worry Katja, he isn\'t going to hurt you. Are you, Ivan?"');
    ...
    if (((s as any).npc_ass ?? 0)?.['A14'] === 0) {
      ...
      scene.text(`"Ivan, that's... You're going to- ${((s as any).pcs_nickname || '')}!"`);
      // TODO-QSP: dynamic text: Fear and nervousness cross Katja's pretty face as she realizes where he's guidin...
      scene.text(`Fear and nervousness cross Katja's pretty face as she realizes where he's guiding his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock. You caress her face and give her a quick kiss.`);
      ...
      if (((s as any).dick1 ?? 0) < ((s as any).npc_ass ?? 0)?.['A14']) {
        ...
        scene.text(`Katja bites her lips as she looks transfixed at Ivan's ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock. "I can't believe I'm letting you put that in me!"`);
        ...
        scene.text(`"Shut up ${((s as any).pcs_nickname || '')}! I want... Your fingers in my cunt!"`);
        ...
        scene.text(`"Ivan, please... I'm not exactly... experienced back there..." Katja blushes as she takes a long look at his ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock.`);
    ...
    if (((s as any).katjaQW ?? 0)?.['ivan_anal'] === 0) {
      ...
      scene.text(`"You've done this with him before, ${((s as any).pcs_nickname || '')}. That made us..."`);
    ...
    qspGoto(s, 'pav_residential', '');
      ...
      // TODO-QSP: dynamic text: You and Katja caress Ivan's <<dick>>cm <<$dick_girth>> cock, causing him to grun...
      scene.text(`You and Katja caress Ivan's ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock, causing him to grunt in pleasure as he lets you take control. You slowly grow bold in your competition and start licking his dick.`);
      ...
      scene.text(`"Open your mouth, ${((s as any).pcs_nickname || '')}," he quietly moans.`);
      scene.actions([
    ...
    if (((s as any).pcs_throat ?? 0) < 15) {
      // TODO-QSP: dynamic text: You're so engrossed in the act that your brain is unable to discern who has spok...
      scene.text(`You're so engrossed in the act that your brain is unable to discern who has spoken, only that a pair of hands close over your head and push, causing Ivan's ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} cock to fill your mouth.`);
      ...
      scene.text(`"Yeah ${((s as any).pcs_nickname || '')}! Show him!"`);
    ...
    ((s as any).npc_had_sex = (s as any).npc_had_sex ?? {})['A3'] = 1;
    qspCall(s, 'cum_call', 'mouth', 'A3', 1);
...
function enterSauneTime(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).clothingworntype ?? 0) === 'nude') {
    ...
    // TODO-QSP: msg $noWillpower
        ...
        scene.actions([
          { label: 'Give in', handler: (st: GameState) => {
    qspCall(s, 'willpower', 'pay', 'sel');
    qspCall(s, 'stat', '');
    qspGoto(s, 'katja_lake', 'sauna_sex1');
  } },
        ]);
      }
    ...
    qspCall(s, 'willpower', 'pay', 'force');
    qspCall(s, 'stat', '');
    qspGoto(s, 'katja_lake', 'ice_dipping');
  } },
          ]);
        }
      }
...
function enterSaunaSex1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['dom'] > 30) {
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}! Please!"`);

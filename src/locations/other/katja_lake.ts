...
function enterHockeyMatch(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`"Katja! ${((s as any).pcs_nickname ?? 0)}! Over here!"`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    scene.actions([
      { label: 'Teach the bitch squad a lesson: [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    // TODO-QSP: msg $noWillpower
  } },
    ]);
  } else {
    ...
    scene.text(`"${((s as any).pcs_nickname ?? 0)}! What are you doing?!"`);
...
function enterBeachNude(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['slut'] >= 20) {
    ...
    scene.text(`"So, what now ${((s as any).pcs_nickname ?? 0)}?"`);
  } else {
    scene.img('images/characters/pavlovsk/school/girl/katja/KL3.jpg');
    ...
    scene.text(`"${((s as any).pcs_nickname ?? 0)}, aren't you going to put your swimsuit on?"`);
    ...
    scene.text(`"The things that you make me do ${((s as any).pcs_nickname ?? 0)}..."`);
  ...
  if (((s as any).hour ?? 0) >= 20) {
    ...
    if ((Math.floor(Math.random() * 20) + 1) === 1) {
      ...
      if (((s as any).clothingworntype ?? 0) === 'nude') {
        ...
        scene.text(`"I think it's time, ${((s as any).pcs_nickname ?? 0)}."`);
...
function enterIvanAppeared(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).clothingworntype ?? 0) === 'nude'  &&  ((s as any).katjaQW ?? 0)?.['slut'] <= 40) {
    ...
    scene.text(`"Oh shit! ${((s as any).pcs_nickname ?? 0)}!"`);
    ...
    scene.text(`"What are you waiting for, ${((s as any).pcs_nickname ?? 0)}?! Come over here!"`);
    qspCall(s, 'willpower', 'exhib', 'force', 'hard');
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Go and talk with him [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    // TODO-QSP: msg $noWillpower
  } },
      ]);
    } else {
    ...
    scene.text(`Katja's face contorts between disbelief and embarrassment. "Talk with him?! ${((s as any).pcs_nickname ?? 0)}! We're <i>naked</i>!"`);
    ...
    scene.text(`"Please ${((s as any).pcs_nickname ?? 0)}! Don't do anything stupid!"`);
    ...
    scene.text(`"${((s as any).pcs_nickname ?? 0)}, look who it is!"`);
  ...
  scene.actions([
    ...
    if ((Math.floor(Math.random() * 2) + 0) === 1) {
      ...
      if (((s as any).npc_throat ?? 0)?.['A14'] < 1) {
        ...
        scene.text(`Katja looks transfixed by Ivan's ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock. This must be the first time she's seen something like this and seems unsure about what to do. Ivan extends his hand and tries to grab Katja's head, but before he reaches her, you slap his hand.`);
        ...
        scene.text(`You and Katja caress Ivan's ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock, causing him to grunt in pleasure as he let you take control. Katja licks her lips and looks at you with questioning eyes. She seems to want to do this.`);
    ...
    if (((s as any).dick ?? 0) > ((s as any).npc_throat ?? 0)?.['A14']) {
      ...
      scene.text(`Ivan makes Katja sit and he stands to put his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock before her face, frightening her with the length before her. In the meantime, you sit by her side and caress her back.`);
      ...
      scene.text(`Ivan makes Katja sit as he stands to put his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock before her face, Katja looking intensely at the length before her. In the meantime, you sit by her side and caress her back.`);
      scene.text('"Don\'t worry Katja, he isn\'t going to hurt you. Are you, Ivan?"');
    ...
    if (((s as any).npc_ass ?? 0)?.['A14'] === 0) {
      ...
      scene.text(`Fear and nervousness cross Katja's pretty face as she realizes where he's guiding his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock. You caress her face and give her a quick kiss.`);
      ...
      if (((s as any).dick1 ?? 0) < ((s as any).npc_ass ?? 0)?.['A14']) {
        ...
        scene.text(`"Shut up ${((s as any).pcs_nickname ?? 0)}! I want... Your fingers in my cunt!"`);
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 10;
      ...
      // TODO-QSP: dynamic text: You and Katja caress Ivan's <<dick>>cm <<$dick_girth>> cock, causing him to grun...
      scene.text(`You and Katja caress Ivan's ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock, causing him to grunt in pleasure as he lets you take control. You slowly grow bold in your competition and start licking his dick.`);
      ...
      scene.text(`"Open your mouth, ${((s as any).pcs_nickname ?? 0)}," he quietly moans.`);
      scene.actions([
    ...
    if (((s as any).pcs_throat ?? 0) < 15) {
      ...
      scene.text(`You're so engrossed in the act that your brain is unable to discern who has spoken, only that a pair of hands close over your head and push, causing Ivan's ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock to fill your mouth.`);
      ...
      scene.text(`"Yeah ${((s as any).pcs_nickname ?? 0)}! Show him!"`);
...
function enterSauneTime(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).clothingworntype ?? 0) === 'nude') {
    ...
    if (((s as any).katjaQW ?? 0)?.['slut'] >= 20  &&  ((s as any).katjaQW ?? 0)?.['horny'] >= 20  &&  ((s as any).katjaQW ?? 0)?.['QWstage'] > 2  &&  ((s as any).npc_had_sex ?? 0)?.['A14']  &&  ((s as any).katjaQW ?? 0)?.['sex_clossedness'] < 2) {
      ...
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Give in [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    // TODO-QSP: msg $noWillpower
  } },
        ]);
      } else {
    ...
    qspCall(s, 'stat', '');
      ...
      if (((s as any).month ?? 0) === 12  ||  ((s as any).month ?? 0) < 3) {
        ...
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          scene.actions([
            { label: 'Go ice dipping [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    // TODO-QSP: msg $noWillpower
  } },
          ]);
        } else {
    ...
    qspCall(s, 'stat', '');
        ...
        scene.text(`"Okay ${((s as any).pcs_nickname ?? 0)}. I think this is enough," she eventually says.`);
    ...
    scene.text(`"Oh yes ${((s as any).pcs_nickname ?? 0)} this hits the spot!"`);
    ...
    scene.text(`"Okay ${((s as any).pcs_nickname ?? 0)}. I think that this is enough," she eventually says.`);
    scene.text('You look at the time. Half an hour has passed, more than enough for your skin treatment.');
    if (((s as any).month ?? 0) === 12  ||  ((s as any).month ?? 0) < 3) {
      qspCall(s, 'willpower', 'misc', 'force', 'easy');
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
...
function enterSaunaSex1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).katjaQW ?? 0)?.['dom'] > 30) {
    ...
    scene.text(`"Come on ${((s as any).pcs_nickname ?? 0)}. What are you waiting for?"`);
    ...
    scene.text(`"Oh ${((s as any).pcs_nickname ?? 0)}... I want more!" she huskily whispers into your ear, her hands gripping your shoulders as she tries to make you kneel.`);
    qspCall(s, 'willpower', 'cuni', 'force', 'easy');
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Make her eat you [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    // TODO-QSP: msg $noWillpower
  } },
      ]);
    } else {
    ...
    scene.text(`"${((s as any).pcs_nickname ?? 0)}! Please!"`);

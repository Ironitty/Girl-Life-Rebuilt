...
function enterKrystal1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).krystal = (st as any).krystal ?? {})['status'] = 2;
    scene.actions([
...
function enterKrystalPornCard(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).krystal ?? 0)?.['porn_card_day'] === ((st as any).daystart ?? 0)) {
      ...
      if (((st as any).krystal ?? 0)?.['porn_card_day'] === ((st as any).daystart ?? 0) - 1) {
...
function enterKrystal3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).krystal = (st as any).krystal ?? {})['status'] = 4;
    scene.actions([
      { label: 'Leave', goto: ['foto', 'studio'] },
    ]);
  } },
...
function enterKrystalChat(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).krystal ?? 0)?.['model_exp'] !== ((s as any).daystart ?? 0)) {
    ...
    ((st as any).krystal = (st as any).krystal ?? {})['model_exp'] = ((st as any).daystart ?? 0);
  ...
  scene.actions([
    ...
    if (((st as any).krystal_convo ?? 0) === 2) {
    ...
    if (((st as any).krystal_convo ?? 0) === 4) {
      scene.img('images/locations/city/citycenter/photo/portraits/krystal_b/talking/6.jpg');
    ...
    if (((st as any).anastasia_exercise ?? 0) === 1) {
      scene.actions([
    ...
    ((st as any).krystal = (st as any).krystal ?? {})['movie'] = (Math.floor(Math.random() * 4) + 1);
    if (((st as any).krystal ?? 0)?.['movie'] === 1) {
      scene.img('images/locations/city/citycenter/photo/portraits/krystal_b/talking/6.jpg');
    ...
    if (((st as any).krystal ?? 0)?.['movie'] === 2) {
      scene.img('images/locations/city/citycenter/photo/portraits/krystal_b/talking/6.jpg');
      scene.text('"See any good movies lately Krystal?"');
    ...
    if (((st as any).krystal ?? 0)?.['movie'] === 3) {
      scene.img('images/locations/city/citycenter/photo/portraits/krystal_b/talking/11.jpg');
      scene.text('"See any good movies lately Krystal?"');
    ...
    if (((st as any).krystal ?? 0)?.['movie'] === 4) {
...
function enterKrystalSextalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).krystal ?? 0)?.['sex_life'] === 0) {
      ((st as any).krystal = (st as any).krystal ?? {})['sex_life'] = 1;
    }
...
function enterKrystalshower(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).mc_inventory ?? 0)?.['shampoo'] > 0) {
    ...
    if (((st as any).trait_vars ?? 0)?.['exhibitionist'] < 2) {
      ...
      (st as any).orgasm_txt = 'You feel a warm wave spreading over your entire body and orgasm, biting your lip hard to suppress the scream that wants to come out. You can\'t believe that you just masturbated in the studio showers to Krystal having shower sex with her boyfriend…';
      qspCall(st, 'arousal', 'clit_vibe', 5, 'masturbate', 'exhibitionism');
    ...
    scene.actions([
      ...
      qspCall(st, 'arousal', 'clit_vibe', (-5), 'masturbate', 'exhibitionism');
      (st as any).orgasm_or = 'yes';
      (st as any).orgasm_txt = 'You loudly groan as you shudder in orgasm, relishing the beautiful image of Krystal\'s boyfriend\'s cum all over her.';
      qspCall(st, 'arousal', 'clit_vibe', 5, 'masturbate', 'exhibitionism');
      qspCall(st, 'arousal', 'end');
      scene.actions([
        { label: 'Dry off', handler: (st: GameState) => {

...
function enterKrystal1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['status'] = 2;
    scene.actions([
...
function enterKrystal2(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['status'] = 3;
...
function enterKrystal2Sure1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['porn_card_hour'] = ((s as any).hour ?? 0) + 2;
    if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['porn_card_day'] = ((s as any).daystart ?? 0);
...
function enterKrystal3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['status'] = 4;
    scene.actions([
      { label: 'Leave', goto: ['foto', 'studio'] },
    ]);
  } },
...
function enterKrystal4(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['status'] = Math.floor(Math.random() * 2) + 4;
  scene.img('images/locations/city/citycenter/photo/portraits/krystal_b/talking/1.jpg');
  scene.text('"Hey babe!"');
...
function enterKrystal5(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['busy_cooldown_day'] = ((s as any).daystart ?? 0);
  if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['busy_cooldown'] = ((s as any).hour ?? 0) + 2;
  if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['status'] = Math.floor(Math.random() * 2) + 4;
...
function enterKrystalChat(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).krystal ?? 0)?.['model_exp'] !== ((s as any).daystart ?? 0)) {
    ...
    if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['model_exp'] = ((s as any).daystart ?? 0);
  ...
  scene.actions([
    ...
    if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['movie'] = Math.floor(Math.random() * 4) + 1;
...
function enterKrystalSextalk(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).krystal ?? 0)?.['sex_life'] === 0) {
      if (!(s as any).krystal) (s as any).krystal = {}; (s as any).krystal['sex_life'] = 1;
    }

...
function enter1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).shultextrand3 ?? 0)} ${((s as any).shultextrand6 ?? 0)} says: "Hey ${((s as any).shultextrand2 ?? 0)}, ${((s as any).shultextrand ?? 0)}" ${((s as any).shultextrand4 ?? 0)}`);
  // TODO-QSP: dynamic text: <<$shultextrand5>>
  scene.text(`${((s as any).shultextrand5 ?? 0)}`);
  // TODO-QSP: dynamic text: You just want a nice, cold beer and decide to take the initiative. You ask them:...
  scene.text(`You just want a nice, cold beer and decide to take the initiative. You ask them: "Come on boys, why so rude? Surely you'll give a nice lady a beer?" in a playful tone, taking a seductive pose and giving them your most ${((s as any).text_sveta_obol ?? 0)} smile. The guys look and whisper some things, but ${((s as any).shultextrand33 ?? 0)} quickly grins and beckons you to come closer.`);
  ...
  scene.text(`${((s as any).shultextrand33 ?? 0)} says ${((s as any).shultextrand6 ?? 0)}: "${((s as any).shul_text_byh ?? 0)}"`);
...
function enter2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).beer_text ?? 0)}`);
  scene.text('');
  // TODO-QSP: dynamic text: <<$beer_text_bazar>>
  scene.text(`${((s as any).beer_text_bazar ?? 0)}`);
  scene.text('');
  if (((s as any).alko ?? 0)<6) {
  ...
  if (((s as any).temp_rand ?? 0) <= 15  &&  ((s as any).alko ?? 0) < 6) {
    ...
    scene.text(`The guys suggest: "Hey ${((s as any).pcs_nickname ?? 0)}, show us your tits!" (<a href="exec:gt 'zsoft_gopskverGorSlut','siski'">Show them.</a>)`);
  }
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).poza_text ?? 0)}`);
    // TODO-QSP: dynamic text: <<$shultextrand3>> <<$shultextrand6>> says "<<$poza_gop_text2>>"
    scene.text(`${((s as any).shultextrand3 ?? 0)} ${((s as any).shultextrand6 ?? 0)} says "${((s as any).poza_gop_text2 ?? 0)}"`);
    // TODO-QSP: dynamic text: <<$shultextrand4>>.
    scene.text(`${((s as any).shultextrand4 ?? 0)}.`);
    ...
    scene.text(`${((s as any).oral_den_text ?? 0)}`);
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumface');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cummouth');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumbody');
    qspCall(s, 'zsoft_gopskverGorSlut', 'vaginalsex');
    ...
    scene.text(`${((s as any).gop_grup_eba ?? 0)}`);
    qspCall(s, 'zsoft_gopskverGorSlut', 'hornyparksex');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumface_group');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cummouth_group');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumass_group');
  } },
      ]);
    }
  } },
...
function enterPiss(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Persuade the policemen with a blowjob [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
...
function enterSiski(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).shultextrand3 ?? 0)} says ${((s as any).shultextrand6 ?? 0)}: "${((s as any).sis_gop_text ?? 0)}"`);
  ...
  if (((s as any).pcs_horny ?? 0) >= 50) {
    ...
    scene.text(`${((s as any).rnd_droch_text ?? 0)}`);
...
function enterHornyparksex(s: GameState, scene: SceneBuilder): void {
  if (((s as any).horand ?? 0) > ((s as any).pcs_horny ?? 0)) {
    ...
    scene.text(`${((s as any).horny_orgazm_text2 ?? 0)} ${((s as any).horny_orgazm_text3 ?? 0)}.`);
  }
  if (((s as any).horand ?? 0) <= ((s as any).pcs_horny ?? 0)) {
...
function enterCumface(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    if (((s as any).temp_rand ?? 0) > 20) {
      ...
      scene.text(`<center><img ${((s as any).set_imgh ?? 0)} src="images/locations/pavlovsk/park/gop/sex/oral/cum/cumf'+rand(1, 22)+'.jpg"></center>`);
    }
    if (((s as any).temp_rand ?? 0) <= 20) {
      // TODO-QSP: dynamic text: <center><video autoplay loop <<$set_imgh>> src="images/locations/pavlovsk/park/g...
      scene.text(`<center><video autoplay loop ${((s as any).set_imgh ?? 0)} src="images/locations/pavlovsk/park/gop/sex/oral/cum/gif/cumf'+rand(1, 6)+'.mp4"></video></center>`);
    }
    (s as any).temp_rand = Math.floor(Math.random() * 3) + 0;
    if ((!((s as any).temp_rand ?? 0))) {
    }
    ...
    scene.text(`${((s as any).cum_face_text ?? 0)}`);
    scene.actions([
      { label: 'Leave', goto: ['pav_park', 'start'] },
...
function enterCumfaceGroup(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    if (((s as any).temp_rand ?? 0) > 20) {
      ...
      scene.text(`<center><img ${((s as any).set_imgh ?? 0)} src="images/locations/pavlovsk/park/gop/sex/group/cum/cumf'+rand(1, 14)+'.jpg"></center>`);
    }
    if (((s as any).temp_rand ?? 0) <= 20) {
      // TODO-QSP: dynamic text: <center><video autoplay loop <<$set_imgh>> src="images/locations/pavlovsk/park/g...
      scene.text(`<center><video autoplay loop ${((s as any).set_imgh ?? 0)} src="images/locations/pavlovsk/park/gop/sex/oral/cum/gif/cumf'+rand(1, 6)+'.mp4"></video></center>`);
    ...
    scene.text(`${((s as any).cum_face_textgr ?? 0)}`);
    scene.actions([
      { label: 'Leave', goto: ['pav_park', 'start'] },
      { label: 'Return to the guys', goto: ['zsoft_gopskverGorSlut', '2'] },
    ]);
...
function enterCummouth(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    if (((s as any).temp_rand ?? 0) > 40) {
      // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/locations/pavlovsk/park/gop/sex/oral/cum/...
      scene.text(`<center><img ${((s as any).set_imgh ?? 0)} src="images/locations/pavlovsk/park/gop/sex/oral/cum/cumm'+rand(1, 12)+'.jpg"></center>`);
    }
    if (((s as any).temp_rand ?? 0) <= 40) {
      // TODO-QSP: dynamic text: <center><video autoplay loop <<$set_imgh>> src="images/locations/pavlovsk/park/g...
      scene.text(`<center><video autoplay loop ${((s as any).set_imgh ?? 0)} src="images/locations/pavlovsk/park/gop/sex/oral/cum/gif/cumm'+rand(1, 8)+'.mp4"></video></center>`);
    }
    (s as any).temp_rand = Math.floor(Math.random() * 6) + 0;
    if ((!((s as any).temp_rand ?? 0))) {
    }
    ...
    scene.text(`${((s as any).cum_mouth_text ?? 0)}`);
    scene.actions([
      { label: 'Leave', goto: ['pav_park', 'start'] },
      { label: 'Return to the guys', goto: ['zsoft_gopskverGorSlut', '2'] },
    ]);
...
function enterCummouthGroup(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    if (((s as any).temp_rand ?? 0) > 40) {
      // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/locations/pavlovsk/park/gop/sex/group/cum...
      scene.text(`<center><img ${((s as any).set_imgh ?? 0)} src="images/locations/pavlovsk/park/gop/sex/group/cum/cumm'+rand(1, 4)+'.jpg"></center>`);
    }
    if (((s as any).temp_rand ?? 0) <= 40) {
      // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/locations/pavlovsk/park/gop/sex/oral/cum/...
      scene.text(`<center><img ${((s as any).set_imgh ?? 0)} src="images/locations/pavlovsk/park/gop/sex/oral/cum/cumm'+rand(6, 10)+'.jpg"></center>`);
    }
    (s as any).temp_rand = Math.floor(Math.random() * 4) + 0;
    if ((!((s as any).temp_rand ?? 0))) {
    }
    ...
    scene.text(`${((s as any).cum_mouth_textgr ?? 0)}`);
    scene.actions([
      { label: 'Leave', goto: ['pav_park', 'start'] },
      { label: 'Return to the guys', goto: ['zsoft_gopskverGorSlut', '2'] },
    ]);
...
function enterCumbody(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    if (((s as any).temp_rand ?? 0) > 50) {
      // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/locations/pavlovsk/park/gop/sex/oral/cum/...
      scene.text(`<center><img ${((s as any).set_imgh ?? 0)} src="images/locations/pavlovsk/park/gop/sex/oral/cum/cumb'+rand(1, 9)+'.jpg"></center>`);
    }
    if (((s as any).temp_rand ?? 0) <= 50) {
      // TODO-QSP: dynamic text: <center><video autoplay loop <<$set_imgh>> src="images/locations/pavlovsk/park/g...
      scene.text(`<center><video autoplay loop ${((s as any).set_imgh ?? 0)} src="images/locations/pavlovsk/park/gop/sex/oral/cum/gif/cumb'+rand(1, 2)+'.mp4"></video></center>`);
    }
...
function enterCumass(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    scene.text(`${((s as any).cumass_text ?? 0)}`);
...
function enterCumassGroup(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    scene.text(`When all the guys are satisfied, you tiredly lie down on the grass for a moment. One of the guys comes over with a grin on his face and asks: "Well, ${((s as any).pcs_nickname ?? 0)}, would you say you know how to get fucked in the ass now?"`);
...
function enterVaginalsex(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    scene.text(`${((s as any).vag_gop_text ?? 0)}`);
    qspCall(s, 'zsoft_gopskverGorSlut', 'hornyparksex');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumface');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cummouth');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumbody');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumpussywanted');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumpussyunwanted');
  } },
  ]);
  scene.build();
}
...
function enterAnalsex(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    if ((!((s as any).temp_rand ?? 0))) {
      ...
      scene.text(`He slaps your ass cheeks playfully and reminds you: "You should really relax, ${((s as any).pcs_nickname ?? 0)}. This will hurt a lot more if you resist."`);
      ...
      if (((s as any).temp_rand ?? 0) === 1) {
        ...
        if (((s as any).temp_rand ?? 0) === 2) {
          ...
          scene.text(`He silently slides his cock inside your ass, and asks with a lewd grin on his face: "You want this… don't you, ${((s as any).pcs_nickname ?? 0)}?"`);
    ...
    qspCall(s, 'zsoft_gopskverGorSlut', 'hornyparksexanal');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumface');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cummouth');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumbody');
    qspCall(s, 'zsoft_gopskverGorSlut', 'cumass');
  } },
  ]);
  scene.build();
}

...
function enterArtemChaseNush(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.actions([
      { label: 'Keep watching', handler: (st: GameState) => {
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['artem_dom'] = ((s as any).artemQW['artem_dom'] ?? 0) + (1);
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['nush_bully_payback'] = 1;
    if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['artem_dom'] = ((s as any).anushkaQW['artem_dom'] ?? 0) + (1);
    ...
    scene.actions([
      { label: 'Keep watching', handler: (st: GameState) => {
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['artem_dom'] = ((s as any).artemQW['artem_dom'] ?? 0) + (1);
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['nush_bully_payback'] = 2;
    if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['artem_dom'] = ((s as any).anushkaQW['artem_dom'] ?? 0) + (1);
...
function enterNushBullyPayback2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['artem_dom'] = ((s as any).artemQW['artem_dom'] ?? 0) + (1);
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['nush_bully_payback'] = 3;
    if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['artem_dom'] = ((s as any).anushkaQW['artem_dom'] ?? 0) + (1);
...
function enterNushBullyPayback3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['artem_dom'] = ((s as any).artemQW['artem_dom'] ?? 0) + (1);
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['nush_bully_payback'] = 4;
    if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['artem_dom'] = ((s as any).anushkaQW['artem_dom'] ?? 0) + (1);
    scene.img('images/characters/pavlovsk/school/girl/anushka/school/sex/artem_nush_payback24.jpg');
...
function enterNushBullyPayback4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.actions([
      { label: 'Watch Artem cum', handler: (st: GameState) => {
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['artem_dom'] = ((s as any).artemQW['artem_dom'] ?? 0) + (1);
    if (!(s as any).artemQW) (s as any).artemQW = {}; (s as any).artemQW['nush_bully_payback'] = 5;
    if (!(s as any).anushkaQW) (s as any).anushkaQW = {}; (s as any).anushkaQW['artem_dom'] = ((s as any).anushkaQW['artem_dom'] ?? 0) + (1);

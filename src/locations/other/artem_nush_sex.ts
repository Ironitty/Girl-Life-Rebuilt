...
function enterAnushka_3some2DomStrapon(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'vaginal_strap_give', 2);
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Watch', handler: (st: GameState) => {
    scene.img('images/locations/pavlovsk/resident/apartment/artemhome/artemroom/sex/nush3some_dom_anal1.jpg');
...
function enterArtemChaseNush(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).artemQW ?? 0)?.['nush_bully_payback'] === 2) {
      ...
      if (((st as any).artemQW ?? 0)?.['nush_bully_payback'] === 3) {
        ...
        if (((st as any).artemQW ?? 0)?.['nush_bully_payback'] >= 4) {
          ...
          if (((st as any).artemQW ?? 0)?.['nush_bully_payback'] === 0) {
            scene.actions([
    ...
    scene.actions([
      { label: 'Keep watching', handler: (st: GameState) => {
    ((st as any).artemQW = (st as any).artemQW ?? {})['artem_dom'] = ((st as any).artemQW['artem_dom'] ?? 0) + (1);
    ((st as any).artemQW = (st as any).artemQW ?? {})['nush_bully_payback'] = 1;
    ((st as any).anushkaQW = (st as any).anushkaQW ?? {})['artem_dom'] = ((st as any).anushkaQW['artem_dom'] ?? 0) + (1);
    ...
    scene.actions([
      { label: 'Time for the next class', goto: ['gschool_lessons', 'short_break'] },
            ...
            if (((st as any).artemQW ?? 0)?.['nush_bully_payback'] === 1) {
              scene.actions([
                { label: 'Do what you want', handler: (st: GameState) => {
    qspCall(st, 'stat', '');
    ...
    scene.actions([
      { label: 'Keep watching', handler: (st: GameState) => {
    ((st as any).artemQW = (st as any).artemQW ?? {})['artem_dom'] = ((st as any).artemQW['artem_dom'] ?? 0) + (1);
    ((st as any).artemQW = (st as any).artemQW ?? {})['nush_bully_payback'] = 2;
    ((st as any).anushkaQW = (st as any).anushkaQW ?? {})['artem_dom'] = ((st as any).anushkaQW['artem_dom'] ?? 0) + (1);
...
function enterNushBullyPayback2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).artemQW = (st as any).artemQW ?? {})['artem_dom'] = ((st as any).artemQW['artem_dom'] ?? 0) + (1);
    ((st as any).artemQW = (st as any).artemQW ?? {})['nush_bully_payback'] = 3;
    ((st as any).anushkaQW = (st as any).anushkaQW ?? {})['artem_dom'] = ((st as any).anushkaQW['artem_dom'] ?? 0) + (1);
...
function enterNushBullyPayback3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).artemQW = (st as any).artemQW ?? {})['artem_dom'] = ((st as any).artemQW['artem_dom'] ?? 0) + (1);
    ((st as any).artemQW = (st as any).artemQW ?? {})['nush_bully_payback'] = 4;
    ((st as any).anushkaQW = (st as any).anushkaQW ?? {})['artem_dom'] = ((st as any).anushkaQW['artem_dom'] ?? 0) + (1);
    scene.img('images/characters/pavlovsk/school/girl/anushka/school/sex/artem_nush_payback24.jpg');
...
function enterNushBullyPayback4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.actions([
      { label: 'Watch Artem cum', handler: (st: GameState) => {
    ((st as any).artemQW = (st as any).artemQW ?? {})['artem_dom'] = ((st as any).artemQW['artem_dom'] ?? 0) + (1);
    ((st as any).artemQW = (st as any).artemQW ?? {})['nush_bully_payback'] = 5;
    ((st as any).anushkaQW = (st as any).anushkaQW ?? {})['artem_dom'] = ((st as any).anushkaQW['artem_dom'] ?? 0) + (1);

...
function enterDoggyStart(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['think_virgin'] === 1  &&  ((s as any).sex_ev ?? 0)?.['virgin_fuck'] === 0  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
    qspCall(s, 'sex_ev_doggy', 'doggy_virgin_pre');
  } else {
...
function enterDoggySwitch(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['last_position'] === 'miss') {
    ...
    if (((s as any).sex_ev ?? 0)?.['last_position'] === 'cowgirl') {
      ...
      scene.text(`You lift your hips, letting ${((s as any).npcdesc ?? 0)}'s cock slip from your pussy. Then, you turn around, getting on hands and knees, presenting your ass towards him.`);
    }
  }
...
function enterDoggySwitch2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['last_position'] === 'miss') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} pulls himself from between your thighs and rolls you onto your knees.`);
  } else {
    if (((s as any).sex_ev ?? 0)?.['last_position'] === 'cowgirl') {
      // TODO-QSP: dynamic text: <<$npcdesc>> lifts you by the hips, pulling you from his cock and flips you arou...
      scene.text(`${((s as any).npcdesc ?? 0)} lifts you by the hips, pulling you from his cock and flips you around onto your knees.`);
    }
  }
...
function enterDoggySpitLube(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You take it in stride as ${((s as any).npcdesc ?? 0)} pushes his finger in and spreads his spit wad around inside you.`);
    ...
    // TODO-QSP: dynamic text: You flinch in surprise but otherwise don't say anything as <<$npcdesc>> pushes a...
    scene.text(`You flinch in surprise but otherwise don't say anything as ${((s as any).npcdesc ?? 0)} pushes a finger inside, spreading his spit wad around inside your pussy.`);
    scene.text('"Just making sure you\'re nice and wet," he says, lining himself up with you. You can hear the smile in his voice.');
    qspCall(s, 'sex_ev_doggy', 'doggy_insert_slow');
  } },
...
function enterDoggyInsertSlow(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['first_insertion'] === 1) {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} carefully positions himself behind you, lining up the head of his cock with your entrance, and gently forces it into the folds of your pussy.`);
  ...
  scene.actions([
    ...
    if (((s as any).npc_last_sex ?? 0)?.[String((s as any).npcID ?? 0)] > ((s as any).daystart ?? 0) - 7) {
      if (((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'big'  ||  ((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'extra_big') {
        ...
        scene.text(`"Ah~!" you moan, toes curling as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile, squeezing yourself around his shaft. "<i>There's</i> my favorite big boy..."`);
      } else {
        // TODO-QSP: dynamic text: "Ah~!" you moan, toes curling as he finishes inserting his <<$dick_desc>> cock i...
        scene.text(`"Ah~!" you moan, toes curling as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile, squeezing yourself around his shaft. "<i>There's</i> my favorite boy's toy..."`);
      }
    } else {
      if (((s as any).npc_last_sex ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        if (((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'big'  ||  ((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'extra_big') {
          // TODO-QSP: dynamic text: "Ah~!" you moan, toes curling as he finishes inserting his <<$dick_desc>> cock i...
          scene.text(`"Ah~!" you moan, toes curling as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile. "I've missed having this big boy inside me..."`);
        } else {
          // TODO-QSP: dynamic text: "Ah~!" you moan, toes curling as he finishes inserting his <<$dick_desc>> cock i...
          scene.text(`"Ah~!" you moan, toes curling as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile. "I've missed having your cock inside me..."`);
        }
      } else {
        if (((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'big'  ||  ((s as any).npc_dick_class ?? 0)[((s as any).locArgs?.[1] ?? 0)] === 'extra_big') {
          if (((s as any).stat ?? 0)?.['biggest_cock'] < ((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]) {
            // TODO-QSP: dynamic text: "Ah~!" you moan, toes curling as he finishes inserting his <<$dick_desc>> cock i...
            scene.text(`"Ah~!" you moan, toes curling as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile. "I've never had a cock this big inside me before..."`);
          } else {
            // TODO-QSP: dynamic text: "Ah~!" you moan, toes curling as he finishes inserting his <<$dick_desc>> cock i...
            scene.text(`"Ah~!" you moan, toes curling as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile. "I love big cocks..."`);
          }
        } else {
          // TODO-QSP: dynamic text: "Ah~!" you moan, toes curling as he finishes inserting his <<$dick_desc>> cock i...
          scene.text(`"Ah~!" you moan, toes curling as he finishes inserting his ${((s as any).dick_desc ?? 0)} cock into your pussy, and give him a lascivious smile. "You're a perfect fit for my pussy..."`);
        }
      }
    }
  }, goto: ['sex_ev_doggy', 'doggy_goto2'] },
    ...
    if (((s as any).npc_fuck_times ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
      if (((s as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
        ...
        if (((s as any).npc_arrogant ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
          ...
          if (((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
            ...
            scene.text(`"Your pussy is so tight," ${((s as any).npcdesc ?? 0)} grins back.`);
          }
        }
      } else {
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_count'] === 0) {
        ...
        scene.text(`"Nngh~! <i>Fuck~!</i>" you groan loudly as ${((s as any).npcdesc ?? 0)}'s cock overstuffs your poor pussy and you're already starting to ache. "I can never get used to how <i>big</i> you are."`);
      } else {
...
function enterDoggyGirlOrgasmContinue(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
    ...
    if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
      ...
      scene.text(`${((s as any).npcdesc ?? 0)} doesn't give you a moment to rest, continuing to fuck you all the way through your orgasm. You quiver, your sensitive pussy spasming around his cock, driving you insane as he doesn't stop even after you've finished.`);
    } else {
...
function enterDoggyChangePosition(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"I'm not really feeling doggy right now," you say, looking at ${((s as any).npcdesc ?? 0)} over your shoulder. "Could we try another position for now?"`);
...
function enterDoggyPain1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'long'  ||  ((s as any).dick_desc ?? 0) === 'huge'  ||  ((s as any).dick_desc ?? 0) === 'enormous'  ||  ((s as any).dick_desc ?? 0) === 'lengthy'  ||  ((s as any).dick_desc ?? 0) === 'gigantic'  ||  ((s as any).dick_desc ?? 0) === 'monstrous') {
    ...
    scene.text(`That first thrust of ${((s as any).npcdesc ?? 0)}'s hips elicits a gasp of pain from your lips and makes your knees want to buckle in agony. His cock is too much for your poor pussy and even just having it inside you is pure torture.`);
    qspCall(s, 'sex_ev_doggy', 'doggy_pain2');
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterDoggyPain3(s: GameState, scene: SceneBuilder): void {
  if ((((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] > 0  ||  (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 3) + 1) >= 2))  &&  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] !== 1) {
    ...
    qspCall(s, 'sex_ev_doggy', 'doggy_goto2');
  } else {
    scene.img('images/shared/sex/vag/doggy/dog1.jpg');
    ...
    if (((s as any).npc_argumentative ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      scene.text(`"Well sorry that your pussy doesn't exactly come with an instruction manual!" ${((s as any).npcdesc ?? 0)} growls back.`);
    } else {
    ...
    if (((s as any).sex_ev ?? 0)?.['dick_too_big'] === 1) {
      ...
      scene.text(`You spend a couple minutes with ${((s as any).npcdesc ?? 0)}'s entire length inside you, taking deep breaths as you slowly let it stretch your pussy. Eventually the pain fades to nothing more than a dull ache.`);
...
function enterDoggy1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).mesec ?? 0) > 0) {
    qspCall(s, 'sex_ev_doggy', 'doggy1_start_period_desc');
  } else {
    qspCall(s, 'sex_ev_doggy', 'doggy1_start_desc');
  }
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 75) {
    ...
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
      ...
      if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'average') {
        ...
        if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'big') {
          ...
          scene.text(`He's good, but not good enough for you. Something about his timing is just <i>off</i>. His movements just aren't syncing up with yours' + iif(npc_fuck_times[$npcID] > 0, ' today ', ' ') + 'and you find yourself stifling yelps of discomfort as his ${((s as any).dick_desc ?? 0)} cock keeps hitting awkward and painful spots inside your pussy. Every time you think it's getting good, he hits another awkward spot and deflates your pleasure like a balloon. Maybe this would get another girl off, but certainly not you...`);
        } else {
          if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'extra_big') {
            // TODO-QSP: dynamic text: He's good, but not good enough for you. Half the problem is his cock is just <i>...
            scene.text(`He's good, but not good enough for you. Half the problem is his cock is just <i>too damn big!</i> His movements just aren't syncing up with yours' + iif(npc_fuck_times[$npcID] > 0, ' today ', ' ') + 'and you find yourself stifling yelps of discomfort as his ${((s as any).dick_desc ?? 0)} cock keeps hitting awkward and painful spots inside your pussy. Maybe this would get another girl off, but certainly not you...`);
          }
        }
      }
    }
    ...
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
      ...
      if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 25) {
        // TODO-QSP: dynamic text: An grunt of surprise escapes your lips as <<$npcdesc>>'s hips press into your as...
        scene.text(`An grunt of surprise escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips press into your ass in a clumsy thrust. That last one was a little bit awkward. <i>Oof.</i> And that one too. Oh, that one wasn't too bad- And we're back to awkward again.`);
        // TODO-QSP: dynamic text: In a word, <<$npcdesc>> is... uncoordinated? Every few thrusts of his <<$dick_de...
        scene.text(`In a word, ${((s as any).npcdesc ?? 0)} is... uncoordinated? Every few thrusts of his ${((s as any).dick_desc ?? 0)} dick inevitably result in an uncomfortable spot getting hit and a sharp prick of pain inside your pussy.`);
        scene.actions([
    ...
    scene.text(`"<i>Hnn~!</i> Not like that, ${((s as any).npcdesc ?? 0)}," you coo, smiling at him over your shoulder. "Like <i>this</i>."`);
    // TODO-QSP: dynamic text: You spread your knees a little wider and let your ass slap back against <<$npcde...
    scene.text(`You spread your knees a little wider and let your ass slap back against ${((s as any).npcdesc ?? 0)} as he pushes his ${((s as any).dick_desc ?? 0)} cock into you again, encouraging the movements you want from him. It takes a few minutes of trying, but eventually he starts to get the hang of it.`);
    ...
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
      ...
      if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'average') {
        ...
        if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'big') {
          ...
          scene.text(`Well he certainly has enthusiasm. But not much skill. Something about his timing is just <i>off</i>. His movements aren't syncing up with yours and you find yourself stifling yelps of discomfort as his ${((s as any).dick_desc ?? 0)} cock keeps hitting awkward and painful spots inside your pussy. Every time you think it's getting good, he hits another awkward spot and deflates your pleasure like a balloon. Maybe this would get another girl off, but certainly not you...`);
        } else {
          if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'extra_big') {
            // TODO-QSP: dynamic text: Well he certainly has enthusiasm. But not much skill. Half the problem is his co...
            scene.text(`Well he certainly has enthusiasm. But not much skill. Half the problem is his cock is just <i>too damn big!</i> His movements aren't syncing up with yours and every time you think it's about to get good, you find yourself stifling yelps of discomfort as his ${((s as any).dick_desc ?? 0)} cock hits another painful spots inside your pussy and your pleasure deflating like a balloon. Maybe this would get another girl off, but certainly not you...`);
          }
        }
      }
    }
    ...
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
        ...
        // TODO-QSP: dynamic text: A stifled gasp of discomfort escapes your lips as <<$npcdesc>>'s hips press into...
        scene.text(`A stifled gasp of discomfort escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips press into your ass in clumsy thrust, sending a sharp jab of pain into your pussy. He keeps moving in weird ways, making nearly every pump of his ${((s as any).dick_desc ?? 0)} dick into your pussy inevitably result in an awkward spot getting hit and a sharp prick of pain. What on earth is he doing?!`);
        scene.actions([
          { label: 'Coach him to do better', handler: (st: GameState) => {
    ((s as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
    // TODO-QSP: dynamic text: "<i>Hnn~!</i> Not like that, <<$npcdesc>>," you coo, smiling at him over your sh...
  ...
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] < 75  &&  (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short'  ||  ((s as any).dick_desc ?? 0) === 'thin')) {
    ...
    scene.text(`It takes all of your willpower not to audibly sigh as you keep letting ${((s as any).npc_usedname ?? 0)?.[String((s as any).npcID ?? 0)]} bump into you from behind with his amazingly <i>disappointing</i> cock, glad he can't see you roll your eyes in boredom.`);
  ...
  scene.actions([
    ...
    scene.text(`Closing your eyes, you try to focus on the sensations, ${((s as any).npcdesc ?? 0)} on top of you, his cock stretching your pussy, going in and out... in and out... in and ou-`);
...
function enterDoggy1_2(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'sex_ev_stats', 'position_tracker', 'doggy', 1);
  qspCall(s, 'sex_ev_doggy', 'doggy_vid');
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        ((s as any).sex_ev ?? {})['fuck_enjoyment'] = 'unsatisfying';
        qspCall(s, 'sex_ev_doggy', 'doggy1_boy_talk1');
        ...
        scene.text(`You take deep breaths as ${((s as any).npcdesc ?? 0)} keeps slowly fucking you from behind. Finally, the stabbing pain between your legs is starting to go away. It seems your virgin pussy is starting to adjust to having a cock inside it.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          ...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips in time with ${((s as any).npcdesc ?? 0)}'s thrusts. It still hurts, but you're determined not to let a little pain cause you to pussy out of your first time.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            ...
            scene.text(`You whimper softly, clenching your teeth as hard as you can as ${((s as any).npcdesc ?? 0)} continues to thrust into you from behind, trying with all your might to prevent yourself from bursting into tears. It hurts <i>so much</i>, but you can't bring yourself to tell him to stop.`);
          }
        }
      }
    } else {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        scene.text(`You take deep breaths as ${((s as any).npcdesc ?? 0)} keeps slowly fucking you from behind. Closing your eyes, you focus, adjusting your knees and the spread of your thighs, your arms and the angle of penetration, your timing, trying move your hips with his. After some minor adjustments, the pain ${((s as any).npcdesc ?? 0)}'s cock was causing inside you fades. After a few minutes, it's little more than a dull throb and you feel much more comfortable, if not all that good.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          scene.text('"<i>Nn-! Nngh-! Ngh-!</i>"');
          qspCall(s, 'sex_ev_doggy', 'doggy1_boy_talk1');
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ...
        scene.text(`Your breath hitches as ${((s as any).npcdesc ?? 0)} continues to slowly thrust into your pussy from behind. You aren't sure what changed, but it's like your body is waking up from a deep sleep. His cock stretches your walls, every thrust <i>fills</i> you in a way you didn't know you needed to be, and even now you can feel yourself get wetter and wetter, slicking up his cock and making it easier to reach the deepest parts of your pussy.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          ((s as any).sex_ev ?? {})['cum_speed_up'] = 0;
          qspCall(s, 'sex_ev_doggy', 'doggy1_boy_talk1');
          ...
          scene.text(`You focus on ${((s as any).npcdesc ?? 0)}'s cock inside of you, clenching your abdomen and throwing your hips back in time with his, trying to squeeze your pussy tight around him to make him come faster.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            ...
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              ...
              scene.text(`You moan softly as ${((s as any).npcdesc ?? 0)} continues to pump his cock into you from behind. It still basically feels numb to your pussy other than the occasional bump, but you don't want him to feel bad about it either so you play along, trying to pretend it feels good.`);
            } else {
              if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
                qspCall(s, 'sex_ev_doggy', 'doggy1.2_dirty_talk');
                qspCall(s, 'sex_ev_doggy', 'doggy1_boy_talk1');
                qspCall(s, 'sex_ev_doggy', 'doggy1_boy_talk2');
      ...
      if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
        ...
        scene.text(`You pant like a bitch in heat as your pussy tightens up and you start throwing your hips back to meet ${((s as any).npcdesc ?? 0)}'s thrusts. By the way his breathing changes, you think you're doing as good a job of pleasing him as he is for you.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['moan'] <= 2  &&  ((s as any).sex_ev ?? 0)?.['moan'] > 0) {
          qspCall(s, 'sex_ev_doggy', 'doggy1.2_moan_desc');
        } else {
          if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
            qspCall(s, 'sex_ev_doggy', 'doggy1.2_dirty_talk');
            qspCall(s, 'sex_ev_doggy', 'doggy1_boy_talk1');
            ...
            if (((s as any).sex_ev ?? 0)?.['casual_talk'] > 0) {
              ...
              qspCall(s, 'sex_ev_doggy', 'doggy1.2_sensation_desc');
            }
          }
        }
      }
...
function enterDoggy2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).mesec ?? 0) > 0) {
    qspCall(s, 'sex_ev_doggy', 'doggy2_start_period_desc');
  } else {
    qspCall(s, 'sex_ev_doggy', 'doggy2_start_desc');
  }
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 75) {
    ((s as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
      // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips as <<$npcdesc>>'s hips slap into your a...
      scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips slap into your ass in the next thrust. You can feel how his movements react to yours, paying attention to your body's nonverbal signals, and making each thrust feeling better than the last. His dick may be small but <i>damn</i>, does he know how to use it.`);
    } else {
      if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'average') {
        // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips as <<$npcdesc>>'s hips slap into your a...
        scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips slap into your ass in the next thrust. You can feel how his movements react to yours, paying attention to your body's nonverbal signals, and making each thrust feeling better than the last. <i>Damn</i>, does he know how to use his dick!`);
      } else {
        if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'big') {
          // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips as <<$npcdesc>>'s hips slap into your a...
          scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips slap into your ass in the next thrust. He doesn't just have a big cock, he knows how to use it too. You can feel how his movements react to yours, paying attention to your body's nonverbal signals, and making each thrust feeling better than the last. If it hits an awkward spot, you feel him adjust. If it hits you just right, he makes sure to thrust it again just like that when your pussy can't help but squeeze him.`);
          scene.text('Oh <i>fuck</i>. He\'s good at this.');
        } else {
          if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'extra_big') {
            // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips as <<$npcdesc>>'s hips slap into your a...
            scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips slap into your ass in the next thrust. He doesn't just have a gigantic cock, he knows how to use it too. You would think that being fucked with such a giant dick would hurt, and it occasionally does, but not as often as you expected. You can feel how his movements react to yours, paying attention to your body's nonverbal signals, and making each thrust feeling better than the last. If it hits an awkward spot, you feel him adjust his angle on top of you. If it hits you just right, he makes sure to thrust it again just like that when your pussy can't help but squeeze him, minimizing pain and maximizing pleasure.`);
            scene.text('Oh <i>fuck</i>. He\'s good at this.');
          }
        }
      }
    ...
    if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 50) {
      // TODO-QSP: dynamic text: An uncontrollable gasp escapes your lips as <<$npcdesc>>'s hips slap into your a...
      scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips slap into your ass in the next thrust. <i>That one felt pretty good!</i> And of course, right as you think that, the next one hits a little awkward inside you, rubbing the wrong way. He's still good for the most part, but about one in ten thrusts can't help but hit wrong.`);
      scene.actions([
        { label: 'You\'re going to enjoy this', handler: (st: GameState) => {
    ((s as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
    // TODO-QSP: dynamic text: Still, that's good enough and you don't mind the awkward hit now and then. You s...
    scene.text(`Still, that's good enough and you don't mind the awkward hit now and then. You smile back at ${((s as any).npcdesc ?? 0)}, determined to enjoy fucking him today.`);
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
        { label: 'Fake enjoyment', handler: (st: GameState) => {
    ...
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
      ...
      if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] > 25) {
        // TODO-QSP: dynamic text: An grunt of surprise escapes your lips as <<$npcdesc>>'s hips slap into your ass...
        scene.text(`An grunt of surprise escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips slap into your ass in a clumsy thrust. That last one was a little bit awkward. <i>Oof.</i> And that one too. Oh, that one wasn't too bad- And we're back to awkward again.`);
        // TODO-QSP: dynamic text: In a word, <<$npcdesc>> is... uncoordinated? Every few thrusts of his <<$dick_de...
        scene.text(`In a word, ${((s as any).npcdesc ?? 0)} is... uncoordinated? Every few thrusts of his ${((s as any).dick_desc ?? 0)} dick inevitably result in an uncomfortable spot getting hit and a sharp prick of pain inside your pussy.`);
        scene.actions([
          { label: 'Coach him to do better', handler: (st: GameState) => {
    ...
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
        ...
        scene.text(`A stifled gasp of discomfort escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips slap into your ass in clumsy thrust, sending a sharp jab of pain into your pussy. He keeps moving in weird ways, making nearly every pump of his ${((s as any).dick_desc ?? 0)} dick into your pussy inevitably result in an awkward spot getting hit and a sharp prick of pain. What on earth is he doing?!`);
        scene.actions([
          { label: 'Coach him to do better', handler: (st: GameState) => {
    ((s as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
    // TODO-QSP: dynamic text: "<i>Hnn~!</i> Not like that, <<$npcdesc>>," you coo, smiling at him over your sh...
  ...
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] < 75  &&  (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short'  ||  ((s as any).dick_desc ?? 0) === 'thin')) {
    ...
    scene.text('<i>Holy shit,</i> you think to yourself. <i>How\'s a girl supposed to get off with a dick this small?</i>');
    // TODO-QSP: dynamic text: It takes all of your willpower not to audibly sigh as you keep letting <<$npc_us...
    scene.text(`It takes all of your willpower not to audibly sigh as you keep letting ${((s as any).npc_usedname ?? 0)?.[String((s as any).npcID ?? 0)]} plow you from behind with his amazingly <i>disappointing</i> cock, glad he can't see you roll your eyes in boredom.`);
    if (((s as any).sex_ev ?? 0)?.['prostitution'] === 1) {
      scene.text('<i>At least I\'m getting paid for this...</i>');
    }
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
  ...
  scene.actions([
    ...
    scene.text(`You sigh internally, but decide not to ruin the mood. ${((s as any).npcdesc ?? 0)} continues to enthusiastically clap your cheeks and you let your expression lapse into boredom, grateful that at least you don't have to act like you're having a good time.`);
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
...
function enterDoggy2_1(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'sex_ev_stats', 'position_tracker', 'doggy', 2);
  qspCall(s, 'sex_ev_doggy', 'doggy_vid');
  qspCall(s, 'sex_ev_doggy', 'doggy2.1_desc');
  ...
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ((s as any).sex_ev ?? {})['fuck_pain'] = 0;
        ((s as any).sex_ev ?? {})['fuck_enjoyment'] = 'unsatisfying';
        qspCall(s, 'sex_ev_doggy', 'doggy2_boy_talk1');
        ...
        scene.text(`You take deep breaths as ${((s as any).npcdesc ?? 0)} keeps steadily fucking you from behind. Finally, the stabbing pain between your legs is starting to go away. It seems your virgin pussy is starting to adjust to having a cock inside it.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          scene.text('"<i>Nn-! Nngh-! Ngh-!</i>"');
          qspCall(s, 'sex_ev_doggy', 'doggy2_boy_talk1');
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          ...
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            ...
            scene.text(`You whimper softly, clenching your teeth as hard as you can as ${((s as any).npcdesc ?? 0)}'s hips loudly clap into your ass and pain lances through your pussy. It hurts <i>so much</i>, but you can't bring yourself to tell him to stop.`);
          }
        }
      }
    }
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ...
        scene.text(`Your breath hitches as ${((s as any).npcdesc ?? 0)} continues to steadily fuck you from behind. You aren't sure what changed, but it's like your body is waking up from a deep sleep. His cock stretches your walls, every thrust <i>fills</i> you in a way you didn't know you needed to be, and even now you can feel yourself get wetter and wetter, slicking up his cock and making it slide in and out of you with much greater, and pleasurable, force.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          ((s as any).sex_ev ?? {})['cum_speed_up'] = 0;
          qspCall(s, 'sex_ev_doggy', 'doggy2_boy_talk1');
          ...
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            ...
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              ...
              scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to pump his cock into you from behind. It still basically feels numb to your pussy other than the slapping of his hips against yours, but you don't want him to feel bad about it either so you play along, trying to pretend it feels good.`);
            } else {
              if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
                qspCall(s, 'sex_ev_doggy', 'doggy2.2_dirty_talk');
                qspCall(s, 'sex_ev_doggy', 'doggy2_boy_talk1');
                qspCall(s, 'sex_ev_doggy', 'doggy2_boy_talk2');
      ...
      if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
        ...
        if (((s as any).sex_ev ?? 0)?.['moan'] <= 2  &&  ((s as any).sex_ev ?? 0)?.['moan'] > 0) {
          ...
          qspCall(s, 'sex_ev_doggy', 'doggy2_boy_talk1');
          qspCall(s, 'sex_ev_doggy', 'doggy2_boy_talk2');
          qspCall(s, 'sex_ev_doggy', 'doggy2.2_moan_desc');
        } else {
          if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
            qspCall(s, 'sex_ev_doggy', 'doggy2.2_dirty_talk');
            qspCall(s, 'sex_ev_doggy', 'doggy2_boy_talk1');
            ...
            if (((s as any).sex_ev ?? 0)?.['casual_talk'] > 0) {
              ...
              qspCall(s, 'sex_ev_doggy', 'doggy2_boy_talk1');
              qspCall(s, 'sex_ev_doggy', 'doggy2_boy_talk2');
              qspCall(s, 'sex_ev_doggy', 'doggy2.2_sensation_desc');
            }
          }
        }
      }
...
function enterDoggy3(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).mesec ?? 0) > 0) {
    qspCall(s, 'sex_ev_doggy', 'doggy3_start_period_desc');
  } else {
    qspCall(s, 'sex_ev_doggy', 'doggy3_start_desc');
  }
  if (((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)] < 75) {
    scene.actions([
    ...
    scene.text(`An uncontrollable gasp escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips pound into your ass over and over again. He's incessant, smashing into your pussy over.`);
    ...
    scene.text(`Your eyes roll back in your head as ${((s as any).npcdesc ?? 0)} incessantly pounds into you with his ${((s as any).dick_desc ?? 0)} cock. Not every thrust is clean and every once in a while he bangs into you in a way that causes a sharp jab of pain inside you. But that's just part of going rough and you take it in stride, letting it fuel the rough-play mood.`);
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
        { label: 'Fake enjoyment', handler: (st: GameState) => {
    ...
    scene.text(`<i>Do people really enjoy this?</i> you think to yourself as ${((s as any).npcdesc ?? 0)} keeps pounding himself into your pussy. But for all the effort he's putting in, it's not bringing any pleasure. It doesn't <i>hurt</i> exactly, but it's definitely not getting you off.`);
    scene.text('Oh well. Not everyone can be a winner. But there\'s no need to make him feel bad about it and start voicing moans of pleasure. You\'ll probably have to fake an orgasm for him later too...');
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
    ...
    ((s as any).sex_ev ?? {})['moan'] = 2;
    // TODO-QSP: dynamic text: <i>Do people really enjoy this?</i> you think to yourself as <<$npcdesc>> keeps ...
    scene.text(`<i>Do people really enjoy this?</i> you think to yourself as ${((s as any).npcdesc ?? 0)} keeps pounding himself into your pussy. But for all the effort he's putting in, it's not bringing any pleasure. He's not paying any attention to your body's response, just thrusting wildly as fast as he can.`);
    scene.text('Oh well. Not everyone can be a winner. But there\'s no need to make him feel bad about it and start voicing moans of pleasure. You\'ll probably have to fake an orgasm for him later too...');
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
    ...
    if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'short') {
      ...
      if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'average') {
        ...
        scene.text(`You've no idea how, but he's somehow managing to find every bad spot inside your pussy. He's just thrusting wildly, smashing his ${((s as any).dick_desc ?? 0)} cock into you without any care or attention. Does he think your reactions of pain are pleasure? This is going to be the longest fuck of your life...`);
      } else {
        if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'big') {
          // TODO-QSP: dynamic text: You've no idea how, but his big stupid cock is somehow managing to find every ba...
          scene.text(`You've no idea how, but his big stupid cock is somehow managing to find every bad spot inside your pussy. He's just thrusting wildly, smashing his ${((s as any).dick_desc ?? 0)} cock into you without any care or attention. Does he think your reactions of pain are pleasure? This is going to be the longest fuck of your life...`);
        } else {
          if (((s as any).npc_dick_class ?? 0)?.[String((s as any).npcID ?? 0)] === 'extra_big') {
            // TODO-QSP: dynamic text: Not only is his oversized cock straining your pussy to the limits, its also some...
            scene.text(`Not only is his oversized cock straining your pussy to the limits, its also somehow managing to find every bad spot inside your pussy. He's just thrusting wildly, smashing his ${((s as any).dick_desc ?? 0)} cock into you without any care or attention Does he think your reactions of pain are pleasure? This is going to be the longest fuck of your life...`);
          }
        }
      }
    }
    ...
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
        ...
        scene.text(`A stifled gasp of discomfort escapes your lips as ${((s as any).npcdesc ?? 0)}'s hips meet yours in clumsy thrust, sending a sharp jab of pain into your pussy. He keeps moving in weird ways, making nearly every pump of his ${((s as any).dick_desc ?? 0)} dick into your pussy inevitably result in an awkward spot getting hit and a sharp prick of pain. What on earth is he doing?!`);
        scene.actions([
          { label: 'Fake enjoyment', handler: (st: GameState) => {
    ((s as any).sex_ev ?? {})['fuck_enjoyment'] = 'unsatisfying';
    ((s as any).sex_ev ?? {})['fake_enjoy'] = 1;
  ...
  if (((s as any).sex_ev ?? 0)?.['rough_enjoy'] !== 1) {
    ...
    ((s as any).sex_ev ?? {})['orgasm'] = ((s as any).orgasm ?? 0);
    qspCall(s, 'sex_ev_doggy', 'doggy3_too_rough');
    ...
    qspCall(s, 'sex_ev_doggy', 'miss3_enjoy_desc');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    // TODO-QSP: xgt 'sex_ev_sex', 'fuck_continue'
  } },
    ...
    scene.text(`In response, ${((s as any).npcdesc ?? 0)} yanks you back by the hair even harder than before, slamming his cock into you to fulfil your request.`);
    scene.actions([
      { label: 'Continue', goto: ['sex_ev_doggy', 'doggy3.1'] },
    ]);
  } },
    ...
    scene.text(`You moan loudly despite the distinct <i>lack</i> of pleasure you feel right now before crying out and clenching down on ${((s as any).npcdesc ?? 0)}'s cock with your pussy as hard as you can, dramatically shaking your shoulders, faking climax.`);
...
function enterDoggy3_1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    ((s as any).sex_ev ?? {})['rough_enjoy'] = 1;
    ((s as any).sex_ev ?? {})['fuck_enjoyment'] = 'enjoy';
    qspCall(s, 'sex_ev_doggy', 'doggy3.1_desc');
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
  ...
  if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'painful') {
    if (((s as any).sex_ev ?? 0)?.['virgin'] === 1) {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ((s as any).sex_ev ?? {})['fuck_pain'] = 0;
        ((s as any).sex_ev ?? {})['fuck_enjoyment'] = 'unsatisfying';
        qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk1');
        qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk2');
        // TODO-QSP: dynamic text: You take gasping breaths as <<$npcdesc>> keeps pounding his cock into you from b...
        scene.text(`You take gasping breaths as ${((s as any).npcdesc ?? 0)} keeps pounding his cock into you from behind. Somehow, the stabbing pain between your legs is starting to go away. It seems your virgin pussy is starting to adjust to getting jackhammered.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          scene.text('"<i>Nn-! Nngh-! Ngh-!</i>"');
          qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk1');
          qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk2');
          // TODO-QSP: dynamic text: You squeeze your eyes tight as small squeaks of pain escape your lips in time wi...
          scene.text(`You squeeze your eyes tight as small squeaks of pain escape your lips in time with ${((s as any).npcdesc ?? 0)}'s hips colliding with your ass. The agony induced by his rough fucking is nearly unbearable, but you're pridefully determined not to let a little pain cause you to pussy out of your first time and clench the bedsheets tight with both hands.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 3) {
            qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk1');
            qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk2');
            ...
            if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 4) {
              ...
              scene.text(`You sob openly as ${((s as any).npcdesc ?? 0)} smashes his cock into you from behind. It hurts so much you think you're going to die, but you can't manage to tell him to stop. The only thing you can do is cry wordlessly as he drives you straight into the bed with his thrusts.`);
            }
          }
        }
      }
      ...
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 1) {
        ...
        qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk2');
        // TODO-QSP: dynamic text: You take gasping breaths as <<$npcdesc>> keeps pounding his cock into you from b...
        scene.text(`You take gasping breaths as ${((s as any).npcdesc ?? 0)} keeps pounding his cock into you from behind. You focus hard, trying with all your might to squeeze <i>some</i> kind of pleasure from this. Anything to make the pain go away. And somehow, after several minutes, it does. ${((s as any).npcdesc ?? 0)} continues to pound your ass, but suddenly you feel able to tolerate it, even if it doesn't feel very good either.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === 2) {
          scene.text('"<i>Nn-! Nngh-! Ngh-!</i>"');
          qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk1');
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_enjoyment'] === 'unsatisfying') {
      if (((s as any).sex_ev ?? 0)?.['fuck_pain'] === -1) {
        ...
        scene.text(`Your breath hitches as ${((s as any).npcdesc ?? 0)} continues to pound your pussy from behind. You aren't sure what changed, but it's like your body is coming alive. His cock stretches your walls, it's so <i>deep</i> inside you, and even now you can feel yourself get wetter and wetter, slicking up his cock and making it hammer you harder and harder with greater satisfaction every time.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
          ((s as any).sex_ev ?? {})['cum_speed_up'] = 0;
          qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk1');
          ...
          scene.text(`You focus on ${((s as any).npcdesc ?? 0)}'s cock as he pounds you, clenching your abdomen and throwing your hips back in time with his, trying to squeeze your pussy tight around him to make him come faster.`);
        } else {
          if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
            scene.text('"<i>Mm-! Mmm-! Mm-! Mmm-!</i>"');
            qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk1');
            ...
            scene.text(`You grunt in time with ${((s as any).npcdesc ?? 0)}'s thrusts as he continues to pound his cock into you from behind. His manhood hammers deep inside you in a way that doesn't exactly feel "good", but it doesn't feel bad either.`);
          } else {
            if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
              scene.text('"<i>Ah~! Ahh~! Ahhh~!</i>"');
              qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk1');
              ...
              scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to pound his cock between your legs. It still basically feels numb to your pussy other than the slamming of his hips against yours, but you don't want him to feel bad about it either so you play along, trying to pretend it feels good.`);
            } else {
              if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
                qspCall(s, 'sex_ev_doggy', 'doggy3.2_dirty_talk');
                qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk1');
                qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk2');
                // TODO-QSP: dynamic text: All your dirty talk is just that: talk. <<$npcdesc>> continues to relentlessly s...
                scene.text(`All your dirty talk is just that: talk. ${((s as any).npcdesc ?? 0)} continues to relentlessly smash your pussy with his cock and you honestly can't say it feels very good. But you don't want ${((s as any).npcdesc ?? 0)} to feel bad about it either so you play along, pretending otherwise.`);
              }
            }
          }
        }
      ...
      if (((s as any).sex_ev ?? 0)?.['cum_speed_up'] === 1) {
        ...
        scene.text(`You pant like a bitch in heat as ${((s as any).npcdesc ?? 0)} pounds you from behind. Your pussy almost involuntarily tighten up, desperately throwing your hips back to meet ${((s as any).npcdesc ?? 0)}'s thrusts. By the way his breathing changes, you think you're giving just as good as you're getting as you feel arousal dribble down your thighs.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['moan'] >= 1) {
          qspCall(s, 'sex_ev_doggy', 'doggy3.2_moan_desc');
          qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk1');
          qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk2');
        } else {
          if (((s as any).sex_ev ?? 0)?.['dirty_talk'] !== '') {
            ...
            qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk1');
            qspCall(s, 'sex_ev_doggy', 'doggy3_boy_talk2');
            qspCall(s, 'sex_ev_doggy', 'doggy3.2_sensation_desc');
          }
        }
      }
    }
...
function enterDoggy1StartPeriodDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His dick is wet with your period, red liquid streaming out of your pussy with every thrust. But it doesn't stop him from continuing to drive balls deep with his tiny dick every time.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His shaft is wet with your period, r...
      scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His shaft is wet with your period, red liquid streaming out of your pussy with every thrust. But it doesn't stop him from continuing to drive balls deep with his fat chode every time.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His shaft is wet with your period, r...
        scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His shaft is wet with your period, red liquid streaming out of your pussy with every thrust. But it doesn't stop him from continuing to drive balls deep with his skinny dick every time.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His shaft is wet with your period, r...
          scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His shaft is wet with your period, red liquid streaming out of your pussy with every thrust. But it doesn't stop him from continuing to drive balls deep with his dick every time.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).pcs_vag ?? 0) <= 10) {
              // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His shaft is wet with your period, m...
              scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His shaft is wet with your period, making it easier for his thick cock to slide into your tight snatch. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep with every thrust.`);
            } else {
              // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His shaft is wet with your period, m...
              scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His shaft is wet with your period, making it easier for his thick cock to slide into your waiting snatch. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep with every thrust.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His shaft is wet with your period, m...
              scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His shaft is wet with your period, making it easier for his long cock to reach all the way inside you to kiss your cervix with its tip. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep with every thrust.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                if (((s as any).pcs_vag ?? 0) <= 10) {
                  // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His shaft is wet with your period, m...
                  scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His shaft is wet with your period, making it easier for his huge cock to ease into your tight snatch and reach all the way inside you to kiss your cervix with its tip. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep with every thrust.`);
                } else {
                  // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His shaft is wet with your period, p...
                  scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His shaft is wet with your period, paving the way for him to fill you with his huge cock, penetrating deep inside you to kiss your cervix with its tip. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep with every thrust.`);
                }
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  if (((s as any).pcs_vag ?? 0) <= 15) {
                    // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His thick shaft is wet with your per...
                    scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His thick shaft is wet with your period, making it possible for his enormous cock to fit its girth into your tight snatch and reach all the way inside you to kiss your cervix with its tip. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep, straining against your walls, with every thrust.`);
                  } else {
                    // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His thick shaft is wet with your per...
                    scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His thick shaft is wet with your period, allowing him to slide his huge cock into you with ease and kiss your cervix with its tip. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep with every thrust.`);
                  }
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    if (((s as any).pcs_vag ?? 0) <= 15) {
                      // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His shaft is wet with your period, m...
                      scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His shaft is wet with your period, making it possible for him to somehow fit his entire ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock into your tight snatch. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep, pressing hard against your cervix, with every thrust.`);
                    } else {
                    ...
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      ...
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        if (((s as any).pcs_vag ?? 0) <= 10) {
                          // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His thick shaft is wet with your per...
                          scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His thick shaft is wet with your period, making it possible for him to somehow fit his monstrous ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock into your tight snatch. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep, pressing hard against your cervix and threatening to rip you in half, with every thrust.`);
                        } else {
                          if (((s as any).pcs_vag ?? 0) <= 25) {
                            // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His thick shaft is wet with your per...
                            scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His thick shaft is wet with your period, making it possible for him to somehow fit his monstrous ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock into your snatch. You're no virgin, but calling this a tight squeeze would be a severe under-exaggeration at best. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep, pressing hard against your cervix and threatening to rip you in half with every thrust.`);
                          } else {
                            // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily. His thick shaft is wet with your per...
                            scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily. His thick shaft is wet with your period, making it possible for him to easily slide his monstrous ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock into your snatch. The red liquid streams from your pussy and ${((s as any).npcdesc ?? 0)} drives balls deep, pressing hard against your cervix and threatening to rip you in half with every thrust.`);
                          }
                        }
                      }
                    }
...
function enterDoggy1StartDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before driving his tiny dick balls deep inside you.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
      scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before driving his fat chode balls deep inside you.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
        scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before driving his skinny dick balls deep inside you.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
          scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before driving his dick balls deep inside you.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).pcs_vag ?? 0) <= 10) {
              // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
              scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before stretching you out with his thick cock until he drives it balls deep inside you again.`);
            } else {
              // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
              scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out just long enough to feel the empty absence of his thick cock until he drives it balls deep inside you again.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
              scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before driving his long dick back in, barely able to fit its generous length inside you`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out just long enough for your pussy to feel the absence of his huge cock before driving back in to fill you up, barely able to fit its entirety inside you.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  if (((s as any).pcs_vag ?? 0) <= 15) {
                    // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                    scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before splitting your tight pussy again, barely able to fit the entirety of his enormous cock inside you.`);
                  } else {
                    // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                    scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before stretching your welcoming pussy again, barely able to fit the entirety of his enormous cock inside you.`);
                  }
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                    scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before plunging back in, forcing as much of his ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock as he can fit inside you, and still leaving shaft to spare.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      if (((s as any).pcs_vag ?? 0) <= 20) {
                        // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                        scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before plunging back in, stretching your tight pussy to the limits as he's unable to fit the entire length of his gigantic cock inside you.`);
                      } else {
                        // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                        scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before plunging as much of his gigantic cock back in, just <i>barely</i> able to fit it inside you.`);
                      }
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        if (((s as any).pcs_vag ?? 0) <= 10) {
                          ...
                          if (((s as any).pcs_vag ?? 0) <= 25) {
                            // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                            scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before forcing the monstrous size of his ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm into your pussy. You're obviously no virgin, but this is ridiculous, and ${((s as any).npcdesc ?? 0)}'s cock threatens to split you in half each time he fails to fit its length inside you.`);
                          } else {
                            // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                            scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before forcing the monstrous size of his ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm into your pussy. ${((s as any).npcdesc ?? 0)}'s cock is so thick that your pussy strains to accommodate its girth even as he fails to fit its length inside you.`);
                          }
                        }
                      }
                    }
...
function enterDoggy1BoyTalk2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} barely makes a sound as he thrusts into you. You can't even hear his breathing over the slap of your bodies colliding.`);
  } else {
    if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      // TODO-QSP: dynamic text: <<$npcdesc>> grunts softly, panting as he thrusts into you.
      scene.text(`${((s as any).npcdesc ?? 0)} grunts softly, panting as he thrusts into you.`);
    } else {
      if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 2) {
        // TODO-QSP: dynamic text: <<$npcdesc>> murmurs his words softly as he thrusts into you from behind.
        scene.text(`${((s as any).npcdesc ?? 0)} murmurs his words softly as he thrusts into you from behind.`);
      } else {
        if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 3) {
          // TODO-QSP: dynamic text: Despite the slow pace being maintained, <<$npcdesc>> is braying erratically like...
          scene.text(`Despite the slow pace being maintained, ${((s as any).npcdesc ?? 0)} is braying erratically like a donkey.`);
        }
      }
    }
  }
...
function enterDoggy1EnjoyDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his dick thrusting inside you. There's something about doggy style, a <i>depth</i> that you don't get in any other position, even with a dick as small as ${((s as any).npcdesc ?? 0)}'s.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You moan as <<$npcdesc>> takes you from behind, his dick thrusting inside you. T...
      scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his dick thrusting inside you. There's something about doggy style, a <i>depth</i> that you don't get in any other position. ${((s as any).npcdesc ?? 0)} doesn't have much length to him, but doggy style more than makes up for that as he plunges his fat chode into you again and again.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        ...
        if (((s as any).dick_desc ?? 0) === 'normal') {
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).pcs_vag ?? 0) <= 10) {
              ...
              // TODO-QSP: dynamic text: You moan as <<$npcdesc>> takes you from behind, his cock thrusting inside you. T...
              scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his cock thrusting inside you. There's something about doggy style, a <i>depth</i> that you don't get in any other position. And his cock is so thick, it <i>fills</i> you completely each time he pushes into you down to the base.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You moan as <<$npcdesc>> takes you from behind, his cock thrusting inside you. T...
              scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his cock thrusting inside you. There's something about doggy style, a <i>depth</i> that you don't get in any other position. Plus with a nice long cock like ${((s as any).npcdesc ?? 0)}'s, it goes deep inside you, gently bumping against your cervix in the most delightfully painful way.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You moan as <<$npcdesc>> takes you from behind, his cock thrusting inside you. T...
                scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his cock thrusting inside you. There's something about doggy style, a <i>depth</i> that you don't get in any other position. Plus, ${((s as any).npcdesc ?? 0)}'s cock is huge. Not only does it fill you completely but it's long enough to reach all the way to your cervix, sending shocks of blissful soreness through your uterus.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You moan as <<$npcdesc>> takes you from behind, his cock thrusting inside you. T...
                  scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his cock thrusting inside you. There's something about doggy style, a <i>depth</i> that you don't get in any other position. Plus, ${((s as any).npcdesc ?? 0)}'s cock is <i>enormous</i>. Your pussy struggles to accommodate its massive girth and its length reaches all the way to your cervix, sending shocks of blissful soreness through your uterus.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You moan as <<$npcdesc>> takes you from behind, his cock thrusting inside you. T...
                    scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his cock thrusting inside you. There's something about doggy style, a <i>depth</i> that you don't get in any other position. And with a dick as long as ${((s as any).npcdesc ?? 0)}'s, it reaches the deepest part of you.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      if (((s as any).pcs_vag ?? 0) <= 25) {
                        // TODO-QSP: dynamic text: You groan beneath <<$npcdesc>>, getting wetter with every thrust. His gigantic c...
                        scene.text(`You groan beneath ${((s as any).npcdesc ?? 0)}, getting wetter with every thrust. His gigantic cock fills you to the brim and then some, pummelling your insides with his sheer size in the most pleasurably painful way possible.`);
                      } else {
                        // TODO-QSP: dynamic text: You groan beneath <<$npcdesc>>, getting wetter with every thrust. His gigantic c...
                        scene.text(`You groan beneath ${((s as any).npcdesc ?? 0)}, getting wetter with every thrust. His gigantic cock fills you to the brim, pummelling your insides with his sheer size in the most pleasurably painful way possible.`);
                      }
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        if (((s as any).pcs_vag ?? 0) <= 25) {
                          // TODO-QSP: dynamic text: You groan beneath <<$npcdesc>>, getting wetter with every thrust. His monster co...
                          scene.text(`You groan beneath ${((s as any).npcdesc ?? 0)}, getting wetter with every thrust. His monster cock is way too big for you in both girth and length, pummelling your insides and stretching your pussy to the point of pain, and you are <i><b>loving every second of it.</b></i>`);
                        } else {
                          // TODO-QSP: dynamic text: You groan beneath <<$npcdesc>>, getting wetter with every thrust. His monster co...
                          scene.text(`You groan beneath ${((s as any).npcdesc ?? 0)}, getting wetter with every thrust. His monster cock is destroying your pussy with size alone, smashing into your cunt with the gentle weight of a sledgehammer. But it doesn't feel bad. Far from it. The pain is euphoric and you can't get enough of his cock.`);
                        }
                      }
                    }
                  }
...
function enterDoggy1_1Desc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only the tip of his tiny dick is still inside of you before smoothly pushing himself back into your pussy, pressing his hips against your ass.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
      scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his thick chode back into your pussy, pressing his hips against your ass.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
        scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his skinny dick back into your pussy, pressing his hips against your ass.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
          scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into your pussy, pressing his hips against your ass.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).pcs_vag ?? 0) <= 10) {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his cock back into your tight pussy, his thick girth forcing gasps from your mouth.`);
            } else {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his cock back into your pussy, his thick girth <i>filling</i> you from wall to wall.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into your pussy, filling you from end to end with his long shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
                scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into your pussy, eliciting mews of pleasure as his huge shaft <i>fills</i> you from end to end.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  if (((s as any).pcs_vag ?? 0) <= 15) {
                    // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
                    scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into you, eliciting groans of pleasure as the length and girth of his enormous shaft <i>fills</i> you up, stretching your tight pussy in every conceivable manner.`);
                  } else {
                    // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
                    scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into you, eliciting moans of pleasure as the length and girth of his enormous shaft <i>fills</i> you.`);
                  }
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
                    scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into you. His manhood is so insanely long that the time between those two moments is measured in seconds and goosebumps wash over your skin as you feel each centimeter of his magnificent length slide in until he bumps against your cervix.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
                      scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into you. His manhood is so insanely long that the time between those two moments is measured in seconds and goosebumps wash over your skin as you feel each centimeter of his gigantic cock slide in until he bumps against your cervix and you feel full of dick.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
                        scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into you. His manhood is so insanely huge that the time between those two moments is measured in seconds and goosebumps wash over your skin as you feel each centimeter of his monstrous cock slide in, forcing your walls to stretch to accommodate it, until he bumps against your cervix and you feel <i>stuffed</i> with dick.`);
                      }
                    }
                  }
                }
...
function enterDoggy1_2MoanDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
    ...
    if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
      ...
      scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His tiny dick driving as deep as it can inside you, finding the hidden secrets of your pussy that make you wetter and wetter with every thrust.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'chode') {
        // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His fat ch...
        scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His fat chode driving as deep as it can inside you, forcing you to feel his girth, making you wetter and wetter with every thrust.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His skinny...
          scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His skinny dick driving as deep as it can inside you, finding the hidden secrets of your pussy that make you wetter and wetter with every thrust.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'normal') {
            // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His cock d...
            scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His cock driving deep inside you, <i>filling</i> you, making you wetter and wetter with every thrust.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'thick') {
              if (((s as any).pcs_vag ?? 0) <= 10) {
                // TODO-QSP: dynamic text: Tiny mews escape your lips as <<$npcdesc>> continues to fuck you with his thick ...
                scene.text(`Tiny mews escape your lips as ${((s as any).npcdesc ?? 0)} continues to fuck you with his thick cock. Slowly. Gently. He drives it deep inside you, <i>stretching</i> your tight pussy with its exceptional girth, making you wetter and wetter with every thrust.`);
              } else {
                // TODO-QSP: dynamic text: Soft moans escape your lips as <<$npcdesc>> continues to fuck you with his thick...
                scene.text(`Soft moans escape your lips as ${((s as any).npcdesc ?? 0)} continues to fuck you with his thick cock. Slowly. Gently. He drives it deep inside you, <i>filling</i> you with its exceptional girth, making you wetter and wetter with every thrust.`);
              }
            } else {
              if (((s as any).dick_desc ?? 0) === 'long') {
                // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His long c...
                scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His long cock driving deep inside you until it's plunged to the hilt, its presence felt even in the deepest parts of your pussy, making you wetter and wetter with every thrust.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'huge') {
                  // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His huge c...
                  scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His huge cock driving deep inside you until it's plunged to the hilt, its presence felt even in the deepest parts of your pussy, <i>filling</i> you, making you wetter and wetter with every thrust.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'enormous') {
                    if (((s as any).pcs_vag ?? 0) <= 15) {
                      // TODO-QSP: dynamic text: Tiny mews escape your lips as <<$npcdesc>> continues to fuck you with his enormo...
                      scene.text(`Tiny mews escape your lips as ${((s as any).npcdesc ?? 0)} continues to fuck you with his enormous cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, making its presence felt in the deepest parts of your tight pussy even as it <i>stretches</i> you to accommodate its exceptional girth. But you love it, becoming wetter and wetter with every thrust.`);
                    } else {
                      // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to fuck you with his enormous cock. Slo...
                      scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his enormous cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, making its presence felt in the deepest parts of your tight pussy even as it <i>stretches</i> you to accommodate its exceptional girth. But you love it, becoming wetter and wetter with every thrust.`);
                    }
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'lengthy') {
                      // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to fuck you with his exceptionally leng...
                      scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his exceptionally lengthy cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, forcing groans from your lips as it knocks against your cervix. It hurts, but it's a good hurt, like a gentle hammering, and the pain just makes you wetter and wetter with every thrust.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'gigantic') {
                        // TODO-QSP: dynamic text: You groan softly as <<$npcdesc>> continues to fuck you with his gigantic cock. S...
                        scene.text(`You groan softly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his gigantic cock. Slowly. Gently. He drives it deep inside you, <i>filling</i> you until it's plunged to the hilt, forcing groans from your lips as it knocks against your cervix. It hurts, but it's a good hurt, like a gentle hammering, and you get wetter and wetter with every thrust.`);
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'monstrous') {
                          // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to fuck you with his gigantic cock. Slo...
                          scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his gigantic cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, forcing whimpers from your lips as it knocks against your cervix with its insane length and threatens to tear you in half with its absurd girth. It hurts, but it's a good hurt, like a gentle hammering, and you get wetter and wetter with every thrust.`);
                        }
                      }
                    }
                  }
    ...
    if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
      ...
      if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
        ...
        scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His tiny dick driving as deep as it can inside you, finding the hidden secrets of your pussy that make you wetter and wetter with every thrust.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'chode') {
          // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His fat c...
          scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His fat chode driving as deep as it can inside you, forcing you to feel his girth, making you wetter and wetter with every thrust.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'skinny') {
            // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His skinn...
            scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His skinny dick driving as deep as it can inside you, finding the hidden secrets of your pussy that make you wetter and wetter with every thrust.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'normal') {
              // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His cock ...
              scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His cock driving deep inside you, <i>filling</i> you, making you wetter and wetter with every thrust.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'thick') {
                if (((s as any).pcs_vag ?? 0) <= 10) {
                  // TODO-QSP: dynamic text: Loud groans escape your lips as <<$npcdesc>> continues to fuck you with his thic...
                  scene.text(`Loud groans escape your lips as ${((s as any).npcdesc ?? 0)} continues to fuck you with his thick cock. Slowly. Gently. He drives it deep inside you, <i>stretching</i> your tight pussy with its exceptional girth, making you wetter and wetter with every thrust.`);
                } else {
                  // TODO-QSP: dynamic text: Loud moans escape your lips as <<$npcdesc>> continues to fuck you with his thick...
                  scene.text(`Loud moans escape your lips as ${((s as any).npcdesc ?? 0)} continues to fuck you with his thick cock. Slowly. Gently. He drives it deep inside you, <i>filling</i> you with its exceptional girth, making you wetter and wetter with every thrust.`);
                }
              } else {
                if (((s as any).dick_desc ?? 0) === 'long') {
                  // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His long ...
                  scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His long cock driving deep inside you until it's plunged to the hilt, its presence felt even in the deepest parts of your pussy, making you wetter and wetter with every thrust.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'huge') {
                    // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His huge ...
                    scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His huge cock driving deep inside you until it's plunged to the hilt, its presence felt even in the deepest parts of your pussy, <i>filling</i> you, making you wetter and wetter with every thrust.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'enormous') {
                      if (((s as any).pcs_vag ?? 0) <= 15) {
                        // TODO-QSP: dynamic text: Loud groans escape your lips as <<$npcdesc>> continues to fuck you with his enor...
                        scene.text(`Loud groans escape your lips as ${((s as any).npcdesc ?? 0)} continues to fuck you with his enormous cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, making its presence felt in the deepest parts of your tight pussy even as it <i>stretches</i> you to accommodate its exceptional girth. But you love it, becoming wetter and wetter with every thrust.`);
                      } else {
                        // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you with his enormous cock. Sl...
                        scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his enormous cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, making its presence felt in the deepest parts of your tight pussy even as it <i>stretches</i> you to accommodate its exceptional girth. But you love it, becoming wetter and wetter with every thrust.`);
                      }
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'lengthy') {
                        // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you with his exceptionally len...
                        scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his exceptionally lengthy cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, forcing groans from your lips as it knocks against your cervix. It hurts, but it's a good hurt, like a gentle hammering, and the pain just makes you wetter and wetter with every thrust.`);
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'gigantic') {
                          // TODO-QSP: dynamic text: You groan loudly as <<$npcdesc>> continues to fuck you with his gigantic cock. S...
                          scene.text(`You groan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his gigantic cock. Slowly. Gently. He drives it deep inside you, <i>filling</i> you until it's plunged to the hilt, forcing whimpers from your lips as it knocks against your cervix. It hurts, but it's a good hurt, like a gentle hammering, and you get wetter and wetter with every thrust.`);
                        } else {
                          if (((s as any).dick_desc ?? 0) === 'monstrous') {
                            // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you with his gigantic cock. Sl...
                            scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his gigantic cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, forcing whimpers from your lips as it knocks against your cervix with its insane length and threatens to tear you in half with its absurd girth. It hurts, but it's a good hurt, and you get wetter and wetter with every thrust.`);
                          }
                        }
                      }
                    }
  ...
  if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'cock') {
    if ((Math.floor(Math.random() * 3) + 1) === 1) {
      ...
      if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
        ...
        scene.text(`"Ah~! Yes~! Just like that~!" you moan, your voice a hoarse with arousal as ${((s as any).npcdesc ?? 0)} does an amazing job fucking you with his tiny cock. "You're so good! Right there~! Right there!"`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'chode') {
          // TODO-QSP: dynamic text: "Ah~! Yes~! Just like that~!" you moan, your voice a hoarse with arousal as <<$n...
          scene.text(`"Ah~! Yes~! Just like that~!" you moan, your voice a hoarse with arousal as ${((s as any).npcdesc ?? 0)} does an amazing job fucking you with his stubby cock. "Fuck me with your fat chode!"`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'skinny') {
            // TODO-QSP: dynamic text: "Ah~! Yes~! Just like that~!" you moan, your voice a hoarse with arousal as <<$n...
            scene.text(`"Ah~! Yes~! Just like that~!" you moan, your voice a hoarse with arousal as ${((s as any).npcdesc ?? 0)} does an amazing job fucking you with his skinny dick. "You're so good! Right there! Right there~!"`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'normal') {
      ...
      if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'technique') {
        ...
        if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'dirty_girl') {
          if (((s as any).npc_dirty_lover ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
            ...
            scene.text(`"Who's pussy is this?" ${((s as any).npcdesc ?? 0)} growls as he moves his cock inside you with tantalizing slowness.`);
...
function enterDoggy2StartPeriodDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with your ass, the sloppy sounds of your period leaking around his tiny dick.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
      scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with your ass, the sloppy sounds of your period squelching around his thick chode.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
        scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with your ass, the sloppy sounds of your period leaking from your pussy around his skinny dick.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            ...
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
              scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his long dick hammers deep inside you. Wet slaps echo around the room as his hips collide with your ass, the sloppy sounds of your period squelching around his long shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his dick hammers deep inside you. Wet slaps echo around the room as his hips collide with your ass, the huge size of his cock forcing squelches from your bleeding cunt.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                  scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his dick fills you to the brim. Wet slaps echo around the room as his hips collide with your ass, his enormous cock leaving room for nothing else, forcing the blood from your menstruating snatch.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                    scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his dick batters your insides with its exceptional length. Wet slaps echo around the room as his hips collide with your ass, the sloppy sounds of your period squelching around his lengthy shaft.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                      scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his dick fills you to the brim. Sloppy wet slaps echo around the room as ${((s as any).npcdesc ?? 0)} batters your bleeding pussy with his gigantic cock.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                        scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust. His dick fills you completely and then some, forcing your pussy to strain and stretch around his long, girthy shaft. Sloppy wet slaps echo around the room as ${((s as any).npcdesc ?? 0)} repeatedly batters your bleeding pussy with his monstrous cock.`);
                      }
                    }
                  }
                }
...
function enterDoggy2StartDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
    scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with your ass, unceasingly thrusting into you with his tiny dick.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
      scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with your ass, unceasingly thrusting into you with his thick chode.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
        scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with your ass, unceasingly thrusting into you with his skinny dick.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
          scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room with every thrust and he drives his cock deep as deep as he can every time.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
            scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with your ass, the sloppy squelching sounds of your pussy fucked by his thick shaft.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
              scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his long dick hammers deep inside you. Wet slaps echo around the room as his hips collide with your ass, the sloppy sounds of your pussy squelching around his long shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his dick hammers deep inside you. Wet slaps echo around the room as his hips collide with your ass, the huge size of his cock forcing squelches from your cunt.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                  scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his enormous dick fills you to the brim. Wet slaps echo around the room as his hips collide with your ass, forcing loud squelches from your snatch with his long girthy cock.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                    ...
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                      scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his gigantic dick fills you to the brim. Sloppy wet slaps echo around the room as ${((s as any).npcdesc ?? 0)} batters your pussy with his long hard cock.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                        scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust. His dick fills you completely and then some, forcing your pussy to strain and stretch around his long, girthy shaft. Sloppy wet slaps echo around the room as ${((s as any).npcdesc ?? 0)} repeatedly batters your pussy with his monstrous cock.`);
                      }
                    }
                  }
                }
    ...
    if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 2) {
        ...
        if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 3) {
          ...
          scene.text(`${((s as any).npcdesc ?? 0)} is braying erratically like a donkey.`);
        }
      }
    }
  }
...
function enterDoggy2EnjoyDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, his tiny dick wiggling around inside you but more than made up for by his enthusiasm. Waves of pleasure reverberate through your body every time his hips collide with your ass.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You groan in pleasure as <<$npcdesc>> fucks you, his thick chode stretching the ...
      scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, his thick chode stretching the opening of your pussy with his balls deep thrusts. Waves of pleasure reverberate through your body every time his hips collide with your ass.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You groan in pleasure as <<$npcdesc>> fucks you, his skinny dick slipping in and...
        scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, his skinny dick slipping in and out of you with speed. Waves of pleasure reverberate through your body every time his hips collide with your ass.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You groan in pleasure as <<$npcdesc>> fucks you, thrusting his dick balls deep i...
          scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, thrusting his dick balls deep into you from behind over and over again. Waves of pleasure reverberate through your body every time his hips collide with your ass.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You groan in pleasure as <<$npcdesc>> fucks you, plunging his thick cock balls d...
            scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, plunging his thick cock balls deep into you from behind over and over again. Your pussy stretches with every thrust and waves of pleasure reverberate through your body every time his hips collide with your ass.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You groan in pleasure as <<$npcdesc>> fucks you, plunging his lengthy cock balls...
              scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, plunging his lengthy cock balls deep into you from behind over and over again. He's so <i>deep</i> inside you and waves of pleasure reverberate through your body every time his hips collide with your ass.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You groan in pleasure as <<$npcdesc>> fucks you, plunging his huge cock balls de...
                scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, plunging his huge cock balls deep into you from behind over and over again. He's so <i>deep</i> inside you, filling you from end to end with cock, and waves of pleasure reverberate through your body every time his hips collide with your ass.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You groan in pleasure as <<$npcdesc>> fucks you, plunging his huge cock balls de...
                  scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, plunging his huge cock balls deep into you from behind over and over again. He's so <i>deep</i>, so <i>big</i> inside you, filling you from end to end with his length and stretching you to your limits with his magnificent girth. Waves of pleasure reverberate through your body every time his hips collide with your ass.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
...
function enterDoggy2_1Desc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'doggy1') {
    if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
      ...
      scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. ${((s as any).npcdesc ?? 0)}'s hips crash into yours, unceasingly thrusting into you with his tiny dick. Wet slapping noises sound alongside the clapping of your cheeks and you sigh in deep satisfaction.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'chode') {
        // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
        ...
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
          scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slapping noises sound alongside the clapping of your cheeks as ${((s as any).npcdesc ?? 0)} thrusts unceasingly into you with his skinny dick.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'normal') {
            // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
            scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slapping noises sound alongside the clapping of your cheeks as ${((s as any).npcdesc ?? 0)} drives his cock deep as deep as he can every time.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'thick') {
              // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
              scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, accompanied by the sloppy squelching of your pussy getting reamed by his thick shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'long') {
                // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, accompanied by the sloppy wet squelching of your dripping cunt getting repeatedly impaled by his long shaft.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'huge') {
                  // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                  scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust and ${((s as any).npcdesc ?? 0)}'s dick hammers deep inside you. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, the huge size of his cock forcing sloppy wet squelching from your dripping cunt.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'enormous') {
                    // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                    scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust and ${((s as any).npcdesc ?? 0)}'s enormous dick stretches you to the limit. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, the enormous size of his cock forcing sloppy wet squelching from your dripping cunt.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'lengthy') {
                      // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                      scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust and his dick batters your insides with its exceptional length. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, accompanied by the sloppy wet squelching of your dripping cunt getting repeatedly impaled by his lengthy shaft.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'gigantic') {
                        // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                        scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust and his gigantic dick fills you to your absolute limit. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, pummelling your insides and forcing sloppy wet squelching from your dripping cunt.`);
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'monstrous') {
                          // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                          scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust. His dick fills you completely and then some, forcing your pussy to strain and stretch around his monstrously long and girthy shaft. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, pummelling your insides and forcing sloppy wet squelching from your dripping cunt.`);
                        }
                      }
                    }
                  }
    ...
    if (((s as any).sex_ev ?? 0)?.['pos_speed'] === 'doggy3') {
      if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
        ...
        scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. ${((s as any).npcdesc ?? 0)}'s hips crash into yours, unceasingly thrusting into you with his tiny dick. Wet slapping noises sound alongside the clapping of your cheeks and you sigh in deep satisfaction.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'chode') {
          // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
          scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. ${((s as any).npcdesc ?? 0)}'s hips crash into yours, unceasingly thrusting into you with his thick chode. Wet slapping noises sound alongside the clapping of your cheeks and you sigh in deep satisfaction.`);
          ...
          if (((s as any).dick_desc ?? 0) === 'skinny') {
            // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
            scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slapping noises sound alongside the clapping of your cheeks as ${((s as any).npcdesc ?? 0)} thrusts unceasingly into you with his skinny dick.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'normal') {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slapping noises sound alongside the clapping of your cheeks as ${((s as any).npcdesc ?? 0)} drives his cock deep as deep as he can every time.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'thick') {
                // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, accompanied by the sloppy squelching of your pussy getting reamed by his thick shaft.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'long') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                  scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, accompanied by the sloppy wet squelching of your dripping cunt getting repeatedly impaled by his long shaft.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'huge') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                    scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust and ${((s as any).npcdesc ?? 0)}'s dick hammers deep inside you. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, the huge size of his cock forcing sloppy wet squelching from your dripping cunt.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'enormous') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                      scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust and ${((s as any).npcdesc ?? 0)}'s enormous dick stretches you to the limit. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, the enormous size of his cock forcing sloppy wet squelching from your dripping cunt.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'lengthy') {
                        // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                        scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust and his dick batters your insides with its exceptional length. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, accompanied by the sloppy wet squelching of your dripping cunt getting repeatedly impaled by his lengthy shaft.`);
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'gigantic') {
                          // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
                          scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace and you breathe a sigh of relief. With your pussy no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust and his gigantic dick fills you to your absolute limit. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, pummelling your insides and forcing sloppy wet squelching from your dripping cunt.`);
                        } else {
                          if (((s as any).dick_desc ?? 0) === 'monstrous') {
                            // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace and you breathe a sigh of reli...
...
function enterDoggy2_2MoanDesc(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you. He poun...
    scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you. He pounds into you from behind, giving you the strangest satisfaction of pleasure that has very little to do with the tiny dick inside you.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you. His thi...
      scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you. His thick chode pounds into you from behind, wonderfully stretching your pussy like a good three-finger fucking, but better.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
        scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind. He pounds your ass, rubbing right up against your g-spot with his skinny dick.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
          scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind. He pounds your ass, rubbing right up against your g-spot with his dick.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
            scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind, pounding you with his <i>thick</i> cock that stretches your walls, squeezing pleasure from your pussy with every thrust.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
              scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind, pounding you with his long-ass cock that reaches the very depths of your pussy without even trying.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
                scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind, pounding you with his huge cock that fills you wonderfully and reaches the very depths of your pussy without even trying.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
                  scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind, pounding you with his enormous cock that penetrates you to the depths of your pussy and stretches your walls, squeezing pleasure from your pussy with every thrust.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
                    scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind with his amazingly lengthy cock, literally pounding pleasure from your cervix with every thrust. Soreness is quickly building up inside you and <i>it feels so good.</i>`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
                      scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind with his gigantic cock, literally pounding pleasure from your cervix with every thrust. Soreness is quickly building up between your legs and <i>it feels so good.</i>`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
                        scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind with his monstrous cock. It's stupidly huge, stretching you to breaking with every thrust and literally pounding your cervix with every thrust. Your pussy is so sore and <i>it feels so good.</i>`);
                      }
                    }
                  }
                }
      ...
      if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'technique') {
        ...
        if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'dirty_girl') {
          if (((s as any).npc_dirty_lover ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
            ...
            scene.text(`"Who's pussy is this?" ${((s as any).npcdesc ?? 0)} growls as he slowly withdraws his cock before ramming it back into your cunt.`);
...
function enterDoggy2_2SensationDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s cock inside you, le...
    scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s cock inside you, letting the pressure build inside you as he literally pounds pleasure into you from behind with his tiny dick.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s cock inside you, le...
      scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s cock inside you, letting the pressure build inside you as he literally pounds pleasure into you from behind with his thick chode.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s cock inside you, le...
        scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s cock inside you, letting the pressure build inside you as he literally pounds pleasure into you from behind with his skinny dick.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s cock filling your p...
          scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s cock filling your pussy, letting the pressure build inside you as he literally pounds pleasure into you from behind with his dick.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s thick cock stretchi...
            scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s thick cock stretching the walls of your pussy, letting the pressure build inside you as he literally pounds pleasure into you from behind.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s long cock reaching ...
              scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s long cock reaching deep inside your pussy, letting the pressure build inside you as he literally pounds pleasure into you from behind.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s huge cock filling y...
                scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s huge cock filling you up and reaching deep inside your pussy, letting the pressure build inside you as he literally pounds pleasure into you from behind.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s enormous cock that ...
                  scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s enormous cock that stretches you to your limits and fills you up from base to tip, letting the pressure build inside you as he literally pounds pleasure into you from behind.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s lengthy cock that b...
                    scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s lengthy cock that batters your cervix, a feeling that you sense in your stomach, letting him literally pound pain and pleasure into you from behind.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s gigantic cock that ...
                      scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s gigantic cock that fills you past your limits as it batters your cervix, a feeling that you sense in your stomach, letting him literally pound pain and pleasure into you from behind.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
  ...
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      ...
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        ...
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
          scene.text(`${((s as any).npcdesc ?? 0)} drives himself in and out of your pussy with tremendous strength and the sound of your cheeks getting clapped echoes off the walls. His dick slams into you with such power that you can feel it force the menstrual blood from your uterus, sending it running down your thighs.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
            ...
            if (((s as any).dick_desc ?? 0) === 'long') {
              ...
              if (((s as any).dick_desc ?? 0) === 'huge') {
                ...
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  ...
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
                    scene.text(`${((s as any).npcdesc ?? 0)} drives himself in and out of your pussy with tremendous strength and the sound of your cheeks getting clapped echoes off the walls. His lengthy cock is so long that it slams into your cervix, battering the blood from your uterus and streams of blood run down your thighs.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> drives himself in and out of your pussy with tremendous strength an...
...
function enterDoggy3StartDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his tiny dick.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force fucking you as hard as he ca...
      scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his fat chode.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force fucking you as hard as he ca...
        scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his skinny dick.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force fucking you as hard as he ca...
          scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his cock.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force fucking you as hard as he ca...
            scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his thick cock.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force fucking you as hard as he ca...
              scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his long cock.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force fucking you as hard as he ca...
                scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his huge cock.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force fucking you as hard as he ca...
                  scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his enormous cock.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force fucking you as hard as he ca...
                    scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his lengthy cock.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force fucking you as hard as he ca...
                      scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his gigantic cock.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force fucking you as hard as he ca...
                        scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force fucking you as hard as he can with his monstrous cock.`);
                      }
                    }
                  }
                }
...
function enterDoggy3BoyTalk2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    // TODO-QSP: dynamic text: <<$npcdesc>> barely makes a sound as he thrusts into you. You can't even hear hi...
    scene.text(`${((s as any).npcdesc ?? 0)} barely makes a sound as he thrusts into you. You can't even hear his breathing over the slap of his hips smashing into yours.`);
  } else {
    if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      // TODO-QSP: dynamic text: <<$npcdesc>> grunts softly, panting as he pounds you from behind.
      scene.text(`${((s as any).npcdesc ?? 0)} grunts softly, panting as he pounds you from behind.`);
    } else {
      if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 2) {
        // TODO-QSP: dynamic text: <<$npcdesc>> growls as he smashes your pussy from behind.
        scene.text(`${((s as any).npcdesc ?? 0)} growls as he smashes your pussy from behind.`);
      } else {
        if (((s as any).npc_sex_volume ?? 0)?.[String((s as any).npcID ?? 0)] === 3) {
          // TODO-QSP: dynamic text: <<$npcdesc>> is braying erratically like a donkey as he thrusts equally as errat...
          scene.text(`${((s as any).npcdesc ?? 0)} is braying erratically like a donkey as he thrusts equally as erratically into your pussy.`);
        }
      }
    }
  }
...
function enterDoggy3EnjoyDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
      scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, forcing the girth of his fat chode into you, making it somehow feel longer than it is.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
        scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, slamming his skinny dick into you.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
          scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, slamming his cock into you.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
            scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, splitting your pussy in half with his thick cock.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
              scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, slamming every centimeter of his long cock deep inside you.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
                scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, forcing every centimeter of his huge cock deep inside you.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
                  scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, splitting your pussy in half and forcing every centimeter of his enormous cock deep inside you.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
                    scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, smashing into your cervix with his lengthy cock on every thrust.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
                      scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, filling you up and smashing into your cervix with his gigantic cock on every thrust.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
                        scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, splitting your pussy in half and smashing into your cervix with his monster cock on every thrust.`);
                      }
                    }
                  }
                }
...
function enterDoggy3TooRough(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s tiny dick does nothing for you, but your hips ache from the repeated clapping of your ass and you can even feel your cheeks turning red and sore from the punishment. It's agonizing and unpleasant, you can't get any satisfaction out of this at all.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
      scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s fat chode is uncomfortable in its girth, splitting your pussy with painful force and your hips ache from the repeated clapping of your ass. You can even feel your cheeks turning red and sore from the punishment. It's agonizing and unpleasant, you can't get any satisfaction out of this at all.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
        scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s skinny dick does nothing for you, but your hips ache from the repeated clapping of your ass and you can even feel your cheeks turning red and sore from the punishment. It's agonizing and unpleasant, you can't get any satisfaction out of this at all.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
            scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s thick cock is uncomfortable in its girth, splitting your pussy with painful force and your hips ache from the repeated clapping of your ass. You can even feel your cheeks turning red and sore from the punishment. It's agonizing and unpleasant, you can't get any satisfaction out of this at all.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
              scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s long cock keeps painfully bumping against your cervix and your hips ache from the repeated clapping of your ass. The thought of a bruised uterus passes through your head as you groan again. It's agonizing and unpleasant, you can't get any satisfaction out of this at all.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
                scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s huge cock keeps painfully bumping against your cervix and your hips ache from the repeated clapping of your ass. The thought of a bruised uterus passes through your head as you groan again. It's agonizing and unpleasant, you can't get any satisfaction out of this at all.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
                  scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s enormous cock keeps painfully bumping against your cervix, your pussy aches from being stretched to fit its girth, and your ass is sore from being repeatedly clapped with sledgehammer force. The thought of a bruised uterus passes through your head as you groan again. It's agonizing and unpleasant, you can't get any satisfaction out of this at all.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
                    scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s cock keeps smashing into your cervix, your pussy unable to accommodate its unnatural length, and your hips ache from the repeated clapping of your ass. You're sure your uterus is going to be bruised tomorrow and you groan again, wondering if it's possible to be fucked to death.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
                      scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s huge cock keeps smashing into your cervix, your pussy unable to accommodate its unnatural length, and your hips ache from the repeated clapping of your ass. You're sure your uterus is going to be bruised tomorrow and you groan again, wondering if it's possible to be fucked to death.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
                        scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s monster cock keeps smashing into your cervix, your pussy unable to accommodate its unnatural length, aching from being stretched to fit its girth. Not to mention your ass is already sore from being repeatedly clapped with sledgehammer force. You're sure your uterus is going to be bruised tomorrow and you groan again, wondering if it's possible to be fucked to death.`);
                      }
                    }
                  }
                }
  ...
  if (((s as any).pcs_makeup ?? 0) > ((s as any).makeup ?? 0)?.['base']) {
    ...
    scene.text(`Black tears run down your face and sweat covers your body, destroying your makeup as ${((s as any).npcdesc ?? 0)} pummels you into the bed.`);
  } else {
    if ((!((s as any).pcs_makeup ?? 0))) {
      // TODO-QSP: dynamic text: Your already ruined makeup gets worse with every passing moment, getting smeared...
      scene.text(`Your already ruined makeup gets worse with every passing moment, getting smeared across the sheets as ${((s as any).npcdesc ?? 0)} pummels you into the bed.`);
    } else {
...
function enterDoggy3_1Desc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
      ...
      scene.text(`Tears begin to well up in your eyes as you half whimper and half moan in half pain and half pleasure. ${((s as any).npcdesc ?? 0)} keeps a firm hold on your hair and pulls hard with every thrust, somehow managing to make his tiny dick hurt you in all the <i>best</i> ways.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'chode') {
        // TODO-QSP: dynamic text: Tears begin to well up in your eyes as you half whimper and half moan in half pa...
...
function enterDoggy3_2MoanDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
    ...
    if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
      ...
      scene.text(`You pant like a bitch in heat as ${((s as any).npcdesc ?? 0)} continues to pound you with his tiny dick. Sloppy wet squelches combine with the loud clapping of your ass cheeks as the rough doggy fucking sends pleasure rocking through your body.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'chode') {
        // TODO-QSP: dynamic text: You pant like a bitch in heat as <<$npcdesc>> continues to pound you with his fa...
        scene.text(`You pant like a bitch in heat as ${((s as any).npcdesc ?? 0)} continues to pound you with his fat chode. Sloppy wet squelches combine with the loud clapping of your ass cheeks as the rough doggy fucking sends pleasure rocking through your body.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          // TODO-QSP: dynamic text: You pant like a bitch in heat as <<$npcdesc>> continues to pound you with his sk...
          scene.text(`You pant like a bitch in heat as ${((s as any).npcdesc ?? 0)} continues to pound you with his skinny dick. Sloppy wet squelches combine with the loud clapping of your ass cheeks as the rough doggy fucking sends pleasure rocking through your body.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'normal') {
            // TODO-QSP: dynamic text: You pant like a bitch in heat as <<$npcdesc>> continues to pound you with his di...
            scene.text(`You pant like a bitch in heat as ${((s as any).npcdesc ?? 0)} continues to pound you with his dick. Sloppy wet sounds squelch from your pussy around his cock, combining with the loud clapping of your ass cheeks that fill the room as the rough doggy fucking sends pleasure rocking through your body.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'thick') {
              // TODO-QSP: dynamic text: You pant like a bitch in heat as <<$npcdesc>> continues to pound you from behind...
              scene.text(`You pant like a bitch in heat as ${((s as any).npcdesc ?? 0)} continues to pound you from behind. Sloppy wet sounds squelch from your pussy around his thick cock, combining with the loud clapping of your ass cheeks that fill the room as the rough doggy fucking sends pleasure rocking through your body.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'long') {
                // TODO-QSP: dynamic text: You pant like a bitch in heat as <<$npcdesc>> continues to pound you from behind...
                scene.text(`You pant like a bitch in heat as ${((s as any).npcdesc ?? 0)} continues to pound you from behind. Sloppy wet sounds squelch from your pussy around the long cock that hammers deep inside you, combining with the loud clapping of your ass cheeks that fill the room as the rough doggy fucking sends pleasure rocking through your body.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'huge') {
                  // TODO-QSP: dynamic text: You pant like a bitch in heat as <<$npcdesc>> continues to pound you from behind...
    ...
    if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
      ...
      if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
        ...
        scene.text(`You groan loudly, barely able to think as ${((s as any).npcdesc ?? 0)} continues pounding you with his tiny dick. Sloppy wet squelches combine with the loud clapping of your ass cheeks as the rough doggy fucking sends pleasure rocking through your body.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'chode') {
          // TODO-QSP: dynamic text: You groan loudly, barely able to think as <<$npcdesc>> continues pounding you wi...
          scene.text(`You groan loudly, barely able to think as ${((s as any).npcdesc ?? 0)} continues pounding you with his fat chode. Sloppy wet squelches combine with the loud clapping of your ass cheeks as the rough doggy fucking sends pleasure rocking through your body.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'skinny') {
            // TODO-QSP: dynamic text: You groan loudly, barely able to think as <<$npcdesc>> continues pounding you wi...
            scene.text(`You groan loudly, barely able to think as ${((s as any).npcdesc ?? 0)} continues pounding you with his skinny dick. Sloppy wet squelches combine with the loud clapping of your ass cheeks as the rough doggy fucking sends pleasure rocking through your body.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'normal') {
              // TODO-QSP: dynamic text: You groan loudly, barely able to think as <<$npcdesc>> continues pounding you wi...
              scene.text(`You groan loudly, barely able to think as ${((s as any).npcdesc ?? 0)} continues pounding you with his dick. Sloppy wet sounds squelch from your pussy around his cock, combining with the loud clapping of your ass cheeks that fill the room as the rough doggy fucking sends pleasure rocking through your body.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'thick') {
                // TODO-QSP: dynamic text: You groan loudly, barely able to think as <<$npcdesc>> continues pounding you fr...
                scene.text(`You groan loudly, barely able to think as ${((s as any).npcdesc ?? 0)} continues pounding you from behind. Sloppy wet sounds squelch from your pussy around his thick cock, combining with the loud clapping of your ass cheeks that fill the room as the rough doggy fucking sends pleasure rocking through your body.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'long') {
                  // TODO-QSP: dynamic text: You pant like a bitch in heat as <<$npcdesc>> continues to pound you from behind...
                  scene.text(`You pant like a bitch in heat as ${((s as any).npcdesc ?? 0)} continues to pound you from behind. Sloppy wet sounds squelch from your pussy around the long cock that hammers deep inside you, combining with the loud clapping of your ass cheeks that fill the room as the rough doggy fucking sends pleasure rocking through your body.`);
...
function enterDoggy3_2SensationDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his tiny dick violently violating your pussy.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
      scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his fat chode violently violating your pussy.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
        scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his skinny dick violently violating your pussy.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: Youpant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll b...
          scene.text(`Youpant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his dick violently violating your pussy.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
            scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his thick cock violently stretching out your pussy.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
              scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his long cock repeatedly knocking on your cervix as it violently penetrates you over and over again.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
                scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the sensation of the huge cock inside you repeatedly knocking on your cervix as it violently violates your pussy.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
                  scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his enormous cock knock against your cervix while it threatens to tear you in half.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
                    scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his insanely long cock smash into your cervix over and over and over again in the most blissful agony you've ever experienced.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...

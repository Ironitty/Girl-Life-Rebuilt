...
function enterWork(s: GameState, scene: SceneBuilder): void {
  ...
  if ((((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 12)  ||  (((s as any).hour ?? 0) >= 13  &&  ((s as any).hour ?? 0) < 17)) {
    ...
    if (((st as any).temp ?? 0) === 1) {
      scene.img('images/locations/city/citycenter/office/work/answeringphone' + (Math.floor(Math.random() * 3) + 1) + '.jpg');
      ...
      if (((st as any).temp ?? 0) === 2) {
        scene.img('images/locations/city/citycenter/office/work/getbinders' + (Math.floor(Math.random() * 2) + 1) + '.jpg');
        ...
        if (((st as any).temp ?? 0) === 3) {
          scene.img('images/locations/city/citycenter/office/work/getcoffee' + (Math.floor(Math.random() * 2) + 1) + '.jpg');
          ...
          if (((st as any).temp ?? 0) === 4) {
            scene.img('images/locations/city/citycenter/office/work/getfiles' + (Math.floor(Math.random() * 5) + 1) + '.jpg');
            ...
            if (((st as any).temp ?? 0) === 5) {
              ...
              if (((st as any).temp ?? 0) === 6) {
                scene.img('images/locations/city/citycenter/office/work/makecopies' + (Math.floor(Math.random() * 4) + 1) + '.jpg');
                ...
                if (((st as any).temp ?? 0) === 7) {
                  scene.img('images/locations/city/citycenter/office/work/takenotes' + (Math.floor(Math.random() * 2) + 1) + '.jpg');
                  ...
                  if (((st as any).temp ?? 0) === 8) {
                    scene.img('images/locations/city/citycenter/office/work/workatdesk' + (Math.floor(Math.random() * 7) + 1) + '.jpg');
      ...
      { label: 'Go back to work', goto: ['office', 'secretary_office'] },
                                          ...
                                          if (((st as any).temp ?? 0) === 20) {
                                            ...
                                            if (((st as any).temp ?? 0) === 21) {
                                              qspCall(st, 'mood', 'raise', 'tiny');
                                              scene.img('images/locations/city/citycenter/office/events/office_race' + (Math.floor(Math.random() * 2) + 1) + '.jpg');
                                              ...
                                              if (((st as any).temp ?? 0) === 22) {
                                                scene.img('images/locations/city/citycenter/office/events/shoulder' + (Math.floor(Math.random() * 3) + 1) + '.jpg');
...
function enterInterview(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (qspFunc(s, 'jobs', 'check_employment_possible', 'city_office_secretary') === 1) {
      ...
      // TODO-QSP: dynamic text: "Excellent! Here''s your welcome packet. Make sure to come to work wearing the a...

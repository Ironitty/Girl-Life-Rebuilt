...
function enterWork(s: GameState, scene: SceneBuilder): void {
  ...
  if ((((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 12)  ||  (((s as any).hour ?? 0) >= 13  &&  ((s as any).hour ?? 0) < 17)) {
    ...
    if (((s as any).hour ?? 0) === 12) {
      (s as any).minut = ((s as any).minut ?? 0) + (60 - ((s as any).minut ?? 0) + 240);
    }
    if (((s as any).hour ?? 0) === 8  ||  ((s as any).hour ?? 0) === 13) {
      (s as any).minut = ((s as any).minut ?? 0) + (60 - ((s as any).minut ?? 0) + 180);
    }
    if (((s as any).hour ?? 0) === 9) {
      (s as any).minut = ((s as any).minut ?? 0) + (60 - ((s as any).minut ?? 0) + 120);
    }
    if (((s as any).sound_settings ?? 0)?.['environment_off'] === 0  &&  ((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 17) {
    }
    qspCall(s, 'stat', '');
    (s as any).temp = Math.floor(Math.random() * 27) + 1;
    if (((s as any).temp ?? 0) === 1) {
      scene.img('images/locations/city/citycenter/office/work/answeringphone\' + rand(1, 3) + \'.jpg');
      ...
      if (((s as any).temp ?? 0) === 2) {
        scene.img('images/locations/city/citycenter/office/work/getbinders\' + rand(1, 2) + \'.jpg');
        ...
        if (((s as any).temp ?? 0) === 3) {
          scene.img('images/locations/city/citycenter/office/work/getcoffee\' + rand(1, 2) + \'.jpg');
          ...
          if (((s as any).temp ?? 0) === 4) {
            scene.img('images/locations/city/citycenter/office/work/getfiles\' + rand(1, 5) + \'.jpg');
            ...
            if (((s as any).temp ?? 0) === 5) {
              ...
              if (((s as any).temp ?? 0) === 6) {
                scene.img('images/locations/city/citycenter/office/work/makecopies\' + rand(1, 4) + \'.jpg');
    ...
    (s as any).office_slut = ((s as any).office_slut ?? 0) + (1);
    qspCall(s, 'stat', '');
      ...
      { label: 'Go back to work', goto: ['office', 'secretary_office'] },
                                          ...
                                          if (((s as any).temp ?? 0) === 20) {
                                            ...
                                            if (((s as any).temp ?? 0) === 21) {
                                              qspCall(s, 'mood', 'raise', 'tiny');
                                              scene.img('images/locations/city/citycenter/office/events/office_race\' + rand(1, 2) + \'.jpg');
                                              ...
                                              if (((s as any).temp ?? 0) === 22) {
                                                scene.img('images/locations/city/citycenter/office/events/shoulder\' + rand(1, 3) + \'.jpg');
                                                ...
                                                qspCall(s, 'arousal', 'massage', 2);
                                                qspCall(s, 'stat', '');
                                                scene.actions([
                                                  { label: 'Let him', handler: (st: GameState) => {
    (s as any).office_slut = ((s as any).office_slut ?? 0) + (1);
    qspCall(s, 'mood', 'raise', 'small');
    qspCall(s, 'fame', 'city', 'sex', 'tiny');
    qspCall(s, 'stat', '');
    ...
    qspCall(s, 'arousal', 'massage', 5, 'inhibition');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Ignore it', handler: (st: GameState) => {
    (s as any).office_slut = ((s as any).office_slut ?? 0) + (2);
    qspCall(s, 'stat', '');
    ...
    qspCall(s, 'arousal', 'foreplay', 2, 'inhibition');
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Go back to work', goto: ['office', 'secretary_office'] },
    ]);
    ...
    scene.text('You turn your body away from him as best as you can and push his hands away from you. "Please stop that."');
    scene.text('He growls. "Fine! I try and do something nice and this is the thanks I get… Fucking bitch…" he mumbles before storming off. You notice all the other secretaries looking at you and get the feeling you just made a mistake. You put your head down and do your best to focus on your work.');
    qspCall(s, 'arousal', 'massage', 2, 'inhibition');
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Go back to work', goto: ['office', 'secretary_office'] },
    ]);
...
function enterInterview(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).pcs_hotcat ?? 0) < 6) {
      if (((s as any).PCloStyle2 ?? 0) !== 5  ||  (!((s as any).PCLoSkirt ?? 0))) {
...
function enterResign(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'jobs', 'set_terminated', 'city_office_secretary');
    scene.img('images/locations/city/citycenter/office/npc/torbica_office.jpg');

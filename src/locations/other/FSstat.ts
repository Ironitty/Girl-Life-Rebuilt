      ...
      if (((s as any).FSface ?? 0) <= 0) {
        ...
        if (((s as any).FSface ?? 0) === 2) {
          ...
          if (((s as any).FSskin ?? 0) <= 0) {
            ...
            (s as any).FSskin['text'] = '<<$FSsherst[\'text\']>> fur on the body';
            ...
            if (((s as any).FShvost ?? 0) === 2) {
              ...
              if (((s as any).dicktipe ?? 0) <= 0) {
                ...
                if (((s as any).FSdick ?? 0) > 0) {
                  (s as any).FSdick['text'] = '<<$dicktipe[\'text\']>> long dick <<FSdick>>';
                } else {
                      ...
                      if (((s as any).FStits ?? 0) <= 0) {
                        ...
                        if ((!((s as any).FStitsLine ?? 0))) {
                          ...
                          if (((s as any).FStitsLine ?? 0) >= 2) {
                            (s as any).FStits['text'] = 'Three pairs of nipples <<$FStitrazm[\'text\']>>';
                          }
                        }
                        if (((s as any).FSpers ?? 0) <= 0) {
                          (s as any).FSpers['text'] = 'You have no character';
                        } else {
                          (s as any).FSpers['text'] = '<<$FSname[\'text\']>>. <<$FSfemin[\'text\']>> <<$FSface[\'text\']>> <<$FScolor[\'text\']>> <<$FSfigur[\'text\']>> <<$FStits[\'text\']>> <<$FSskin[\'text\']>> <<$FShvost[\'text\']>> <<$FSdick[\'text\']>> <<$FSvagina[\'text\']>>';
                        }

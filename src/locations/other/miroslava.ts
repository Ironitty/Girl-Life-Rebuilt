...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).MiraVars ?? 0)?.['QW'] === 11) {
    ...
    qspCall(st, 'npc_relationship', 'modify', 'A60', 2);
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['meadow'] = 1;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['follower'] = 1;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['follow_time'] = 1;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['guest'] = 0;
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterWearStrippedClothes(st, scene); (st as any).locArgs = __savedLocArgs; }
    qspCall(st, 'stat', '');
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterWearStrippedClothes(st, scene); (st as any).locArgs = __savedLocArgs; }
    qspCall(st, 'stat', '');
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterMiraclothes(st, scene); (st as any).locArgs = __savedLocArgs; }
    ...
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['follower'] = 1;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['follow_time'] = 24 - ((st as any).hour ?? 0);
    scene.actions([
    ...
    qspCall(st, 'outfit', 'strip_all', 'forest_edge');
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['strip_loc'] = 'forest_edge';
    qspCall(st, 'stat', '');
    ...
    dynamicGoto(st, (((st as any).locat ?? {})['A60_loc']), (((st as any).locat ?? {})['A60_arg']));
        ...
        if ((! qspFunc(s, 'miroslava_schedule', 'is_here', ((s as any).locat ?? 0)?.['A60_loc_prev'], ((s as any).locat ?? 0)?.['A60_arg_prev']))  &&  ((s as any).MiraVars ?? 0)?.['meadow'] > 1) {
          ...
          if (((s as any).locat ?? 0)?.['A60_loc_prev'] === 'gad_miroslava_home') {
            ...
            // TODO-QSP: dynamic text: "<<$pcs_nickname>>, you''re fun to be with, but I gotta get home. My dad has cho...
        ...
        if (((s as any).npc_rel ?? 0)?.['A60'] >= 15  &&  ((s as any).daystart ?? 0) >= ((s as any).MiraVars ?? 0)?.['emb_day']  &&  (((s as any).npc_QW ?? 0)?.['A63'] < 11  ||  ((s as any).MiraVars ?? 0)?.['QW'] >= 11  ||  ((s as any).MiraVars ?? 0)?.['had_sex'] > 1)) {
          ...
          if ((((s as any).temp_rand ?? 0) === 1  ||  ((s as any).temp_rand ?? 0) === 2)  &&  ((s as any).MiraVars ?? 0)?.['guest'] === 0  &&  ((s as any).MiraVars ?? 0)?.['follow_time'] === 0  &&  ((s as any).locat ?? 0)?.['A60_loc'] !== 'gad_forest'  &&  ((s as any).grandmaQW ?? 0)?.['block'] === 0  &&  ((s as any).start_type ?? 0)?.['loc'] === 'sg') {
            ...
            // TODO-QSP: dynamic text: "<<$pcs_nickname>>, it''s so boring here," Mira pouts, "I know! Let''s go to you...
    ...
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['follow_time'] = 1;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['guest'] = 1;
    ...
    if (((st as any).npc_rel ?? 0)?.['A60'] < 20) {
      qspCall(st, 'npc_relationship', 'modify', 'A60', 1);
    }
    qspCall(st, 'mood', 'raise', 'tiny');
    qspCall(st, 'stat', '');
    // TODO-QSP: dynamic text: '<center><img <<$set_imgh>> src="images/characters/gadukino/mira/mira_tv'+rand(1...
    scene.text(`<center><img ${((st as any).set_imgh ?? '')} src="images/characters/gadukino/mira/mira_tv` + (Math.floor(Math.random() * 12) + 1) + '.jpg"></center>');
    ...
    scene.actions([
      { label: 'Continue', goto: ['miroslava', 'leave'] },
              ...
              if (((s as any).temp_rand ?? 0) === 5  &&  (! qspFunc(s, 'miroslava_schedule', 'is_here', 'forest'))  &&  (((s as any).MiraVars ?? 0)?.['meadow'] === 2  ||  ((s as any).MiraVars ?? 0)?.['meadow'] === 5)  &&  ((s as any).MiraVars ?? 0)?.['follow_time'] === 0  &&  ((s as any).hour ?? 0) < 19  &&  ((s as any).sunWeather ?? 0) === 1) {
                ...
                qspCall(s, 'stat', '');
                { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMiraclothes(s, scene); (s as any).locArgs = __savedLocArgs; }
                // TODO-QSP: dynamic text: "<<$pcs_nickname>>, can we go to the meadow?" Mira asked you. "Let''s take a wal...
                scene.text(`"${((s as any).pcs_nickname ?? '')}, can we go to the meadow?" Mira asked you. "Let's take a walk and get some fresh air."`);
                scene.actions([
                  { label: 'Agree', handler: (st: GameState) => {
    (st as any).minut = ((st as any).minut ?? 0) + 15;
    if (((st as any).npc_rel ?? 0)?.['A60'] < 50) {
      qspCall(st, 'npc_relationship', 'modify', 'A60', 1);
    }
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['follower'] = 1;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['follow_time'] = 2;
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterWearStrippedClothes(st, scene); (st as any).locArgs = __savedLocArgs; }
    qspCall(st, 'stat', '');
    scene.img('images/characters/gadukino/mira/girls_go.jpg');
    ...
    scene.actions([
      { label: 'Continue', goto: ['miroslava', 'start'] },
                ...
                if ((((s as any).temp_rand ?? 0) === 6  ||  ((s as any).temp_rand ?? 0) === 7)  &&  (! qspFunc(s, 'miroslava_schedule', 'is_here', 'forest'))  &&  ((s as any).sunWeather ?? 0) === 1  &&  ((s as any).temper ?? 0) >= 15  &&  ((s as any).month ?? 0) >= 5  &&  ((s as any).month ?? 0) <= 9  &&  ((s as any).MiraVars ?? 0)?.['follow_time'] === 0  &&  ((s as any).hour ?? 0) < 18) {
                  ...
                  qspCall(s, 'stat', '');
                  { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMiraclothes(s, scene); (s as any).locArgs = __savedLocArgs; }
                  // TODO-QSP: dynamic text: "<<$pcs_nickname>>, do you want to go to the river?" - Mira asks. "Let''s go swi...
    ...
    scene.actions([
      { label: 'Continue', goto: ['miroslava', 'start'] },
                    ...
                    if (((s as any).temp_rand ?? 0) > 10  &&  ((s as any).locat ?? 0)?.['A60_loc'] !== 'gad_forest'  &&  ((s as any).hour ?? 0) >= 20  &&  ((s as any).sunWeather ?? 0) === 1  &&  ((s as any).MiraVars ?? 0)?.['follow_time'] === 0  &&  ((s as any).MiraVars ?? 0)?.['QW'] > 0) {
                      ...
                      qspCall(s, 'stat', '');
                      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMiraclothes(s, scene); (s as any).locArgs = __savedLocArgs; }
                      // TODO-QSP: dynamic text: "<<$pcs_nickname>>, let''s hang out with those guys and drink a little?" Mira as...
                      ...
                      scene.actions([
                        { label: 'Agree', handler: (st: GameState) => {
    (st as any).minut = ((st as any).minut ?? 0) + 15;
    if (((st as any).MiraVars ?? 0)?.['QW'] >= 16  &&  ((st as any).GadBoy ?? 0)?.['river_gang'] === 2) {
      qspGoto(st, 'mitkabuh_group', '');
    } else {
      qspGoto(st, 'mitkabuh', '');
    }
  } },
      ...
      { label: 'Continue', goto: ['miroslava', 'start'] },
        ...
        if (((s as any).hour ?? 0) === 23) {
          ...
          if (((s as any).locat ?? 0)?.['A60_loc'] === 'gad_miroslava_home') {
            { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMiraclothes(s, scene); (s as any).locArgs = __savedLocArgs; }
            // TODO-QSP: dynamic text: "<<$pcs_nickname>>, you''re fun to be with, but it''s late. I gotta get to bed. ...
...
function enterCattleChoreActs(s: GameState, scene: SceneBuilder): void {
  if (((s as any).hour ?? 0) < 13  ||  ((s as any).hour ?? 0) >= 16) {
    ...
    qspCall(st, 'exp_gain', 'run', 1);
    qspCall(st, 'sweat', 'add', 10);
    qspCall(st, 'mood', 'raise', 'tiny');
    if (((st as any).temper ?? 0) >= 25  &&  ((st as any).sunWeather ?? 0) === 1) {
      (st as any).pcs_hydra = ((st as any).pcs_hydra ?? 0) - (24);
    }
    qspCall(st, 'stat', '');
    ...
    qspCall(st, 'exercise', 'tier1', 15, 'stren', 'stren');
...
function enterWalkTogether(s: GameState, scene: SceneBuilder): void {
  if (((s as any).daystart ?? 0) < ((s as any).MiraVars ?? 0)?.['emb_day']) {
    ...
    if (((s as any).npc_QW ?? 0)?.['A63'] >= 13  &&  ((s as any).MiraVars ?? 0)?.['QW'] < 10  &&  ((s as any).MiraVars ?? 0)?.['had_sex'] <= 1) {
      ...
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterWearStrippedClothes(s, scene); (s as any).locArgs = __savedLocArgs; }
      qspCall(s, 'stat', '');
      // TODO-QSP: dynamic text: '<center><img <<$set_imgh>> src="images/characters/gadukino/mira/girls_walking'+...
      scene.text(`<center><img ${((s as any).set_imgh ?? '')} src="images/characters/gadukino/mira/girls_walking` + (Math.floor(Math.random() * 3) + 1) + '.jpg"></center>');
...
function enterWearStrippedClothes(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).MiraVars = (s as any).MiraVars ?? {})['strip_loc'] = '';
  // TODO-QSP: end
  scene.build();
}
...
function enterGuestActs(s: GameState, scene: SceneBuilder): void {
  if (((s as any).MiraVars ?? 0)?.['guest'] === 0) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 60;
    if (((st as any).npc_rel ?? 0)?.['A60'] < 20) {
      qspCall(st, 'npc_relationship', 'modify', 'A60', (Math.floor(Math.random() * 2) + 1));
    }
    qspCall(st, 'stat', '');
    // TODO-QSP: dynamic text: '<center><img <<$set_imgh>> src="images/characters/gadukino/mira/mira_tv'+rand(1...
    scene.text(`<center><img ${((st as any).set_imgh ?? '')} src="images/characters/gadukino/mira/mira_tv` + (Math.floor(Math.random() * 12) + 1) + '.jpg"></center>');
    ...
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['guest'] = 0;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['follow_time'] = 0;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['follower'] = 0;
    if (((st as any).MiraVars ?? 0)?.['guestday'] <= ((st as any).daystart ?? 0)) {
      ((st as any).MiraVars = (st as any).MiraVars ?? {})['guestday'] = ((st as any).daystart ?? 0) + 1;
    }
    scene.actions([
...
function enterThirdWish(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: "<<$pcs_nickname>>, please don''t make this your wish. I will die of embarrassme...
    scene.text(`"${((st as any).pcs_nickname ?? '')}, please don't make this your wish. I will die of embarrassment!" - Mira plaintively begs, hoping it will change your mind.`);
    scene.actions([
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 15;
    (st as any).pcs_horny = ((st as any).pcs_horny ?? 0) + ((Math.floor(Math.random() * 6) + 5));
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['emb_day'] = ((st as any).daystart ?? 0) + 7;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['event_day'] = ((st as any).daystart ?? 0);
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['QW'] = 21;
    qspCall(st, 'npc_relationship', 'set', 'A60', 1);
    qspCall(st, 'stat', '');
    ...
    scene.text(`"${((st as any).pcs_nickname ?? '')}, we're even!" Mira states and looks at you imploringly.`);
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    qspCall(st, 'npc_relationship', 'modify', 'A60', 5);
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['QW'] = 22;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['guest'] = 0;
    qspCall(st, 'stat', '');
    ...
    scene.text(`"Thank you, ${((st as any).pcs_nickname ?? '')}, I… I…, "- she stammers before running home.`);
    scene.actions([
      { label: 'Finish', goto: ['gadukino', ''] },
    ]);
  } },
...
function enterMiratalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).MiraVars ?? 0)?.['QW'] === 0) {
    ...
    qspCall(st, 'npc_relationship', 'modify', 'A60', 1);
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['QW'] = 2;
    ...
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['QW'] = 4;
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['event_day'] = ((st as any).daystart ?? 0);
    qspCall(st, 'stat', '');
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    (st as any).pcs_horny = ((st as any).pcs_horny ?? 0) + (10);
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['QW'] = 5;
    qspCall(st, 'npc_relationship', 'modify', 'A60', (-1));
    qspCall(st, 'stat', '');
    scene.img('images/characters/gadukino/mira/mira3.jpg');
    ...
    scene.text(` - Well, ${((st as any).pcs_nickname ?? '')}, - after a couple of seconds until you hear a hysterical scream from Mira, I'll think of something!`);
    scene.actions([
      { label: 'Leave', goto: ['miroslava', 'leave'] },
    ]);
  } },
    ...
    scene.text(`"Fine, ${((st as any).pcs_nickname ?? '')}, you win," Mira states loud enough for you to hear. She is on the verge of hysteria, eyes watering and nose running. Mira nearly screams, "I, I'll figure something out!"`);
    scene.actions([
      { label: 'Leave', goto: ['miroslava', 'leave'] },
    ]);
  } },
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 10;
    (st as any).pcs_horny = ((st as any).pcs_horny ?? 0) + (15);
    ((st as any).MiraVars = (st as any).MiraVars ?? {})['QW'] = 7;
    qspCall(st, 'stat', '');
    scene.img('images/characters/gadukino/mira/mira3.jpg');
    ...
    scene.actions([
      { label: 'Leave', goto: ['miroslava', 'leave'] },
            ...
            if (((s as any).daystart ?? 0) < ((s as any).MiraVars ?? 0)?.['emb_day']  &&  ((s as any).MiraVars ?? 0)?.['event_day'] !== ((s as any).daystart ?? 0)) {
              ...
              ((s as any).MiraVars = (s as any).MiraVars ?? {})['emb_day'] = ((s as any).MiraVars['emb_day'] ?? 0) - (1);
            }
            if (((s as any).locat ?? 0)?.['A60_loc'] === 'gad_beach') {
              { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMiraRiver(s, scene); (s as any).locArgs = __savedLocArgs; }
            } else {
  ...
  if (((s as any).MiraVars ?? 0)?.['QW'] === 0) {
    ...
    if (((s as any).MiraVars ?? 0)?.['QW'] > 0  &&  ((s as any).MiraVars ?? 0)?.['QW'] < 4) {
      ...
      if (((s as any).MiraVars ?? 0)?.['QW'] >= 4  &&  ((s as any).MiraVars ?? 0)?.['QW'] < 8) {
        // TODO-QSP: dynamic text: '<center><img <<$set_imgh>> src="images/characters/gadukino/mira/mira0,'+rand(0,...
        scene.text(`<center><img ${((s as any).set_imgh ?? '')} src="images/characters/gadukino/mira/mira0,` + (Math.floor(Math.random() * 6) + 0) + '.jpg"></center>');
      } else {
        if (((s as any).MiraVars ?? 0)?.['QW'] >= 8  &&  ((s as any).MiraVars ?? 0)?.['QW'] < 12) {
          // TODO-QSP: dynamic text: '<center><img <<$set_imgh>> src="images/characters/gadukino/mira/mira1,'+rand(0,...
          scene.text(`<center><img ${((s as any).set_imgh ?? '')} src="images/characters/gadukino/mira/mira1,` + (Math.floor(Math.random() * 3) + 0) + '.jpg"></center>');
        } else {
          if (((s as any).MiraVars ?? 0)?.['QW'] >= 12  &&  ((s as any).MiraVars ?? 0)?.['QW'] < 20) {
            // TODO-QSP: dynamic text: '<center><img <<$set_imgh>> src="images/characters/gadukino/mira/mira2,'+rand(0,...
            scene.text(`<center><img ${((s as any).set_imgh ?? '')} src="images/characters/gadukino/mira/mira2,` + (Math.floor(Math.random() * 6) + 0) + '.jpg"></center>');
          } else {
            if (((s as any).MiraVars ?? 0)?.['QW'] >= 20) {
              // TODO-QSP: dynamic text: '<center><img <<$set_imgh>> src="images/characters/gadukino/mira/mira3,'+rand(0,...
              scene.text(`<center><img ${((s as any).set_imgh ?? '')} src="images/characters/gadukino/mira/mira3,` + (Math.floor(Math.random() * 4) + 0) + '.jpg"></center>');
            }
          }
        }
      }

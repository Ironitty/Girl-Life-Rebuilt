    ...
    if (((s as any).fame ?? 0)?.['pav_slut'] < 100) {
      ...
      if (((s as any).fame ?? 0)?.['pav_slut'] < 150) {
        ...
        if (((s as any).fame ?? 0)?.['pav_slut'] < 200) {
          ...
          scene.text(`Lizaveta and Stasya are standing in the hallway talking. You overhear Stasya as you walk past. "Look it doesn't taste that bad and you can just spit it out if you want." Lizaveta frowns a little. "I guess…" Stasya then looks over at you as she replies to Lizaveta. "You could always ask ${((s as any).pcs_nickname ?? 0)}. I hear she swallows cum all the time, and loves it too." They both giggle before returning to their conversation. You just sigh and continue on. It seems like people are talking about your reputation, which is only getting worse. You should be more discreet if you want people to stop talking about you.`);
        } else {
          if (((s as any).fame ?? 0)?.['pav_slut'] < 250) {
            scene.img('images/locations/pavlovsk/school/events/girls_gossip1.jpg');

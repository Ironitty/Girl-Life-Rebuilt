...
function enterComplex(s: GameState, scene: SceneBuilder): void {
  if (String((s as any).locArgs?.[1] ?? '') === 'old_women_slutrep') {
    ...
    if (((s as any).fame ?? 0)?.['pav_slut'] < 100) {
      ...
      scene.text(`<center><img ${((s as any).set_imgh ?? '')} src="images/locations/pavlovsk/resident/apartment/events/grandmothers_gossip` + (Math.floor(Math.random() * 3) + 1) + '.jpg"></center>');
  ...
  if (String((s as any).locArgs?.[1] ?? '') === 'boys_slutrep') {
    (s as any).minut = ((s as any).minut ?? 0) + 3;
    qspCall(s, 'stat', '');
    if (((s as any).fame ?? 0)?.['pav_slut'] < 100) {
  ...
  if (String((s as any).locArgs?.[1] ?? '') === 'girls_slutrep') {
    (s as any).minut = ((s as any).minut ?? 0) + 3;
    qspCall(s, 'stat', '');
    if (((s as any).fame ?? 0)?.['pav_slut'] < 150) {
...
function enterSchool(s: GameState, scene: SceneBuilder): void {
  if (String((s as any).locArgs?.[1] ?? '') === 'boys_slutrep') {
    ...
    scene.text('Two boys are standing in the hallway talking.');
    if (((s as any).fame ?? 0)?.['pav_slut'] < 100) {
      scene.text('"Hey isn\'t that the girl the gopniks were talking about?" one of them asks as you walk past.');
      scene.text('"Yeah, but she\'s just a tease." his friend replies. They seem to lose interest in you, but you can\'t help but notice people are talking about your reputation. You should be more discreet if you want them to stop talking about you.');
    } else {
      if (((s as any).fame ?? 0)?.['pav_slut'] < 150) {
        scene.text('"Hey isn\'t that the girl that gave one of the gopniks a handjob in the restroom?" one of them asks as you walk past. The other one looks at you before replying.');
        scene.text('"No, I think she just likes to tease guys and flash her panties at them." They seem to lose interest in you, but you can\'t help but notice people are talking about your reputation. You should be more discreet if you want them to stop talking about you.');
      } else {
        if (((s as any).fame ?? 0)?.['pav_slut'] < 200) {
          scene.text('"Hey isn\'t that the slut the gopniks said was giving them blowjobs in the old school building?" one of them says loudly, pointing at you.');
          scene.text('"Yeah that\'s her. I hear she\'s a world class cock sucker." They keep watching and talking about you before the sound of the school drowns out their voices. It seems everyone is aware of your tarnished reputation. You should be more discreet if you want people to stop talking about you.');
        } else {
          if (((s as any).fame ?? 0)?.['pav_slut'] < 250) {
            scene.text('"Look who it is, one of the school sluts," one of them taunts.');
            scene.text('"She looks sad. Maybe she needs a cock or two to cheer her up?" They laugh and keep talking about you until the sounds of the school drown out their voices as you walk down the hall. It seems everyone is aware of your tarnished reputation. You should be more discreet if you want people to stop talking about you.');
          } else {
            if (((s as any).fame ?? 0)?.['pav_slut'] < 300) {
              scene.text('"Hey whore, come over here. We\'ve got something for you!" one of them laughs.');
  ...
  if (String((s as any).locArgs?.[1] ?? '') === 'girls_slutrep') {
    ...
    if (((s as any).fame ?? 0)?.['pav_slut'] < 100) {
      ...
      if (((s as any).fame ?? 0)?.['pav_slut'] < 150) {
        ...
        scene.text('Irina, Bella and Stasya are standing in the hallway. You can\'t help but notice them looking in your direction as they whisper and giggle with each other, followed by pointed looks in your direction. Irina speaks up when they see you. "Don\'t you have some boy to go make out with?" They all start giggling and whispering even more. You just sigh and continue on. It seems people are talking about your growing reputation. You should be more discreet if you want them to stop talking about you.');
      } else {
        if (((s as any).fame ?? 0)?.['pav_slut'] < 200) {
          scene.img('images/locations/pavlovsk/school/events/girls_gossip2.jpg');
          // TODO-QSP: dynamic text: Lizaveta and Stasya are standing in the hallway talking. You overhear Stasya as ...
          scene.text(`Lizaveta and Stasya are standing in the hallway talking. You overhear Stasya as you walk past. "Look it doesn't taste that bad and you can just spit it out if you want." Lizaveta frowns a little. "I guess…" Stasya then looks over at you as she replies to Lizaveta. "You could always ask ${((s as any).pcs_nickname ?? '')}. I hear she swallows cum all the time, and loves it too." They both giggle before returning to their conversation. You just sigh and continue on. It seems like people are talking about your reputation, which is only getting worse. You should be more discreet if you want people to stop talking about you.`);
        } else {
          if (((s as any).fame ?? 0)?.['pav_slut'] < 250) {
            scene.img('images/locations/pavlovsk/school/events/girls_gossip1.jpg');
            scene.text('Irina, Bella and Stasya are standing in the hallway. You can\'t help but notice them looking your direction. Then they start whispering back and forth between each other and giggling, followed by pointed looks your direction. Bella speaks up when they see you. "What are you looking at slut? Mind your own business!" They all laugh mockingly as you just sigh and continue on. It seems like everyone is aware of your tarnished reputation. You should be more discreet if you want people to stop talking about you.');
          } else {
            if (((s as any).fame ?? 0)?.['pav_slut'] < 300) {
              scene.img('images/locations/pavlovsk/school/events/girls_gossip2.jpg');
              scene.text('Lizaveta and Stasya are standing in the hallway. They start whispering and giggling as soon as they see you, followed by pointed looks in your direction. Stasya notices you staring. "What are you looking at whore? Don\'t you have a bunch of boys waiting to gangbang you somewhere?" They give you looks of utter disgust and go back to talking quietly to each other. You just sigh and continue on. Your reputation is in tatters, but maybe it isn\'t too late to redeem yourself.');
            } else {
              if (((s as any).fame ?? 0)?.['pav_slut'] >= 300) {
                scene.img('images/locations/pavlovsk/school/events/girls_gossip1.jpg');
                scene.text('Irina, Bella and Stasya are standing in the hallway and you can\'t help but notice them staring at you as you walk closer to them. They start talking out loud, apparently not caring who hears them. "Look girls, it\'s the town bicycle!" Irina says mockingly. "Yeah anyone can ride her as much as they want. And for free!" Stasya replies as you skirt around them as they almost block your way. You glance at them and Bella frowns. "Watch where you\'re going you dirty whore! We don\'t want any of your filthy diseases!" They give you looks of utter disgust and go back to talking to each other and ignoring you. You just sigh and continue on. There is little you can say in your defense.');
              }
            }
          }
        }

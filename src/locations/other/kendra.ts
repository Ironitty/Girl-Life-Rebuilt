...
function enterKendraRoomStart(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).kendraQW = (st as any).kendraQW ?? {})['sub'] = ((st as any).kendraQW['sub'] ?? 0) + (1);
    qspCall(st, 'stat', '');
    qspGoto(st, 'kendra', 'kendra_room_routing');
  } },
  ]);
  scene.build();
}
...
function enterKendraCouch(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'cuni_give', 3, 'lesbian', 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'cuni_give', 5, 'lesbian', 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'rimming_give', 5, 'lesbian', 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterKendraBed(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'kiss', 3, 'lesbian', 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'foreplay_give', 3, 'lesbian', 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'trib', 5, 'lesbian', 'sub');
    qspCall(st, 'arousal', 'end');
    scene.actions([
...
function enterKendraCouchStrap(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'rimming_give', 3, 'lesbian', 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'clit_finger', 10, 'lesbian', 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    if (qspFunc(s, 'pcs_has_attr', 'sex_virgin')) {
      ...
      qspCall(st, 'arousal', 'bj', 3, 'lesbian', 'sub');
      qspCall(st, 'arousal', 'clit_finger', (-3), 'lesbian', 'sub');
      qspCall(st, 'stat', '');
      scene.actions([
...
function enterKendraCouchStrapVag(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'vaginal_strap', 5, ((st as any).npcID ?? 0), ((st as any).npcID1 ?? 0), 'lesbian', 'sub', 'rough');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterKendraCouchStrapAnal(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'anal_strap', 5, ((st as any).npcID ?? 0), ((st as any).npcID1 ?? 0), 'lesbian', 'sub', 'rough');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'kiss', 1, 'lesbian', 'sub');
    qspCall(st, 'arousal', 'end');
    scene.actions([
      { label: 'Leave', goto: ['uni_dorm', 'eighth_floor'] },
    ]);
...
function enterKendraBedStrap(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (qspFunc(s, 'pcs_has_attr', 'sex_virgin')) {
      ...
      qspCall(st, 'arousal', 'bj', 3, 'lesbian', 'sub');
      qspCall(st, 'arousal', 'BDSM', (-3), 'lesbian', 'sub');
      qspCall(st, 'stat', '');
      scene.actions([
...
function enterKendraGloryhole(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'BDSM', 2, 'lesbian', 'sub');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'flashlite', 2, 'lesbian', 'sub', 'humiliation');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'flashlite', 5, 'lesbian', 'sub', 'humiliation');
    qspCall(st, 'stat', '');
    if (((st as any).kendraQW ?? 0)?.['dom'] < 17  ||  qspFunc(s, 'pcs_has_attr', 'sex_virgin')) {
      scene.actions([
...
function enterKendraPetka(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).petkaQW ?? 0)?.['pegged_kendra'] >= 1) {
...
function enterKendraPetka1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).petkaQW ?? 0)?.['pegged_kendra'] < 10) {
    ...
    ((st as any).petkaQW = (st as any).petkaQW ?? {})['pegged_kendra'] = ((st as any).petkaQW['pegged_kendra'] ?? 0) + (1);
    qspCall(st, 'arousal', 'voyeur_sex', 2);

...
function enterQueueAlert(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sd_qa) (s as any).sd_qa = {}; (s as any).sd_qa['text'] = ((((s as any).locArgs?.[2] ?? 0) !== ''  &&  ((s as any).locArgs?.[2] ?? 0) !== 'none') ? (qspFunc(s, 'wrap', '$ARGS[2]', ((s as any).locArgs?.[1] ?? 0))) : (((s as any).locArgs?.[1] ?? 0)));
...
function enterQueueMsg(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[3] ?? 0) === 'pos'  ||  ((s as any).locArgs?.[3] ?? 0) === 'const') {
    if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['icon_arg'] = '';
    if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['row_arg'] = 0;
    if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['action_arg'] = '';
    if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['gate'] = ((s as any).locArgs?.[3] ?? 0);
  } else {
    if (((s as any).locArgs?.[5] ?? 0) === 'pos'  ||  ((s as any).locArgs?.[5] ?? 0) === 'const') {
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['icon_arg'] = ((s as any).locArgs?.[3] ?? 0);
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['row_arg'] = qspUntranslated(s, "ARGS[4]", { location: "stat_display_compute" });
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['action_arg'] = '';
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['gate'] = ((s as any).locArgs?.[5] ?? 0);
    } else {
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['icon_arg'] = ((s as any).locArgs?.[3] ?? 0);
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['row_arg'] = qspUntranslated(s, "ARGS[4]", { location: "stat_display_compute" });
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['action_arg'] = ((s as any).locArgs?.[5] ?? 0);
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['gate'] = ((s as any).locArgs?.[6] ?? 0);
    }
  }
  if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['title'] = ((((s as any).stat_texts ?? 0)[((s as any).locArgs?.[1] ?? 0) + '_tooltip'] !== '') ? (((s as any).stat_texts ?? 0)?.[((s as any).locArgs?.[1] ?? 0) + '_tooltip']) : (((s as any).stat_texts ?? 0)?.[((s as any).locArgs?.[1] ?? 0)]));
  if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['display'] = ((s as any).stat_texts ?? 0)?.[((s as any).locArgs?.[1] ?? 0)];
  if (((s as any).sd_qm ?? 0)?.['action_arg'] !== '') {
    if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['action'] = ((s as any).sd_qm ?? 0)?.['action_arg'];
  } else {
    if (((s as any).sd_qm ?? 0)?.['display'] !== '') {
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['action'] = 'msg $stat_texts[\'\' + $ARGS[1] + \'\']';
    } else {
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['action'] = 'msg $stat_texts[\'\' + $ARGS[1] + \'_tooltip\']';
    }
  }
  ...
  if (((s as any).sd_qm ?? 0)?.['gate'] === 'pos') {
    if (((s as any).stat_cfg ?? 0)?.['show_positive_icons'] === 0) {
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['icon'] = '';
    }
    if (((s as any).stat_cfg ?? 0)?.['show_positive_texts'] === 0) {
      if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['display'] = '';
    }
  } else {
  ...
  if (((s as any).sd_qm ?? 0)?.['display'] !== ''  &&  (((s as any).stat_cfg ?? 0)?.['msg_display_mode'] === 0  ||  ((s as any).stat_cfg ?? 0)?.['msg_display_mode'] === 2  ||  ((s as any).sd_qm ?? 0)?.['icon'] === '')) {
    if (!(s as any).sd_qm) (s as any).sd_qm = {}; (s as any).sd_qm['final_text'] = ((((s as any).locArgs?.[2] ?? 0) !== '') ? (qspFunc(s, 'wrap', '$ARGS[2]', ((s as any).sd_qm ?? 0)?.['display'])) : (((s as any).sd_qm ?? 0)?.['display']));
...
function enterComputeAttributesProse(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cnt'] = 0;
  if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['sum'] = 0;
  if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['ai'] = 0;
  if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['amax'] = 0;
  // TODO-QSP: :sd_ap_collect
  if (((s as any).sd_ap ?? 0)?.['ai'] < ((s as any).sd_ap ?? 0)?.['amax']) {
    if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['ck'] = qspUntranslated(s, "attr_bar_order[sd_ap['ai']]", { location: "stat_display_compute" });
    if (((s as any).stat_hide_bar ?? 0)[((s as any).sd_ap ?? 0)?.['ck']] === 0) {
      if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = (-1);
      if (((s as any).sd_ap ?? 0)?.['ck'] === 'inhib') {
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = 100 - ((s as any).pcs_inhib ?? 0);
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Inhibition';
      } else {
        if (((s as any).sd_ap ?? 0)?.['ck'] === 'stren') {
          if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).pcs_stren ?? 0);
          if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Strength';
        } else {
          if (((s as any).sd_ap ?? 0)?.['ck'] === 'agil') {
            if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).pcs_agil ?? 0);
            if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Agility';
          } else {
            if (((s as any).sd_ap ?? 0)?.['ck'] === 'vital') {
              if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).pcs_vital ?? 0);
              if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Endurance';
            } else {
              if (((s as any).sd_ap ?? 0)?.['ck'] === 'intel') {
                if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).pcs_intel ?? 0);
                if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Intelligence';
              } else {
                if (((s as any).sd_ap ?? 0)?.['ck'] === 'sprt') {
                  if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).pcs_sprt ?? 0);
                  if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Spirit';
                } else {
                  if (((s as any).sd_ap ?? 0)?.['ck'] === 'react') {
                    if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).pcs_react ?? 0);
                    if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Reaction';
                  } else {
                    if (((s as any).sd_ap ?? 0)?.['ck'] === 'chrsm') {
                      if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).pcs_chrsm ?? 0);
                      if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Charisma';
                    } else {
                      if (((s as any).sd_ap ?? 0)?.['ck'] === 'prcptn') {
                        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).pcs_prcptn ?? 0);
                        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Perception';
                      } else {
                        if (((s as any).sd_ap ?? 0)?.['ck'] === 'apprnc') {
                          if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).pcs_apprnc ?? 0) * 100 / 200;
                          if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Attractiveness';
                        } else {
                          if (((s as any).sd_ap ?? 0)?.['ck'] === 'magik') {
                            if (((s as any).start_type ?? 0)?.['magic'] !== 'nomagic') {
                              if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).pcs_magik ?? 0);
                              if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Magic';
                            }
                          } else {
                            if (((s as any).sd_ap ?? 0)?.['ck'] === 'sucexcess') {
                              if (((s as any).start_type ?? 0)?.['magic'] !== 'nomagic'  &&  ((s as any).succubusflag ?? 0) === 1) {
                                if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cv'] = ((s as any).sucexcess ?? 0);
                                if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cn'] = 'Succubus Energy';
                              }
                            }
                          }
                        }
      ...
      if (((s as any).sd_ap ?? 0)?.['cv'] >= 0) {
        ...
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['sum'] = ((s as any).sd_ap['sum'] ?? 0) + (((s as any).sd_ap ?? 0)?.['cv']);
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['cnt'] = ((s as any).sd_ap['cnt'] ?? 0) + (1);
      }
    }
    if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['ai'] = ((s as any).sd_ap['ai'] ?? 0) + (1);
  ...
  if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['n_high'] = 0;
  if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['n_low'] = 0;
  if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['bi'] = 0;
  ...
  if (((s as any).sd_ap ?? 0)?.['bi'] < ((s as any).sd_ap ?? 0)?.['cnt']) {
    ...
    if (((s as any).sd_ap ?? 0)?.['bv'] >= 80  ||  ((s as any).sd_ap ?? 0)?.['dev'] >= 15) {
      ...
      if (((s as any).sd_ap ?? 0)?.['bv'] <= 15  ||  ((s as any).sd_ap ?? 0)?.['dev'] <= -15) {
        ...
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['n_low'] = ((s as any).sd_ap['n_low'] ?? 0) + (1);
      }
    }
    if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['bi'] = ((s as any).sd_ap['bi'] ?? 0) + (1);
  ...
  if (((s as any).sd_ap ?? 0)?.['n_high'] > 0) {
    if (((s as any).sd_ap ?? 0)?.['n_high'] === 1) {
      ...
      if (((s as any).sd_ap ?? 0)?.['n_high'] === 2) {
        ...
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['ji'] = 1;
        ...
        if (((s as any).sd_ap ?? 0)?.['ji'] < (((s as any).sd_ap ?? 0)?.['n_high'] - 1)) {
          ...
          if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['ji'] = ((s as any).sd_ap['ji'] ?? 0) + (1);
  ...
  if (((s as any).sd_ap ?? 0)?.['n_low'] > 0) {
    if (((s as any).sd_ap ?? 0)?.['n_low'] === 1) {
      if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['low_list'] = qspFunc(s, 'wrap', 'neg', ((s as any).sd_ap ?? 0)?.['low_0']);
      if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['low_verb'] = 'is lacking';
    } else {
      if (((s as any).sd_ap ?? 0)?.['n_low'] === 2) {
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['low_list'] = qspFunc(s, 'wrap', 'neg', ((s as any).sd_ap ?? 0)?.['low_0']) + '  &&  ' + qspFunc(s, 'wrap', 'neg', ((s as any).sd_ap ?? 0)?.['low_1']);
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['low_verb'] = 'are lacking';
      } else {
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['low_list'] = qspFunc(s, 'wrap', 'neg', ((s as any).sd_ap ?? 0)?.['low_0']);
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['ji'] = 1;
        // TODO-QSP: :sd_ap_join_low
        if (((s as any).sd_ap ?? 0)?.['ji'] < (((s as any).sd_ap ?? 0)?.['n_low'] - 1)) {
          if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['low_list'] = ((s as any).sd_ap['low_list'] ?? 0) + (', ' + qspFunc(s, 'wrap', 'neg', ((s as any).sd_ap ?? 0)?.['low_' + String(((s as any).sd_ap ?? 0)?.['ji'])]));
          if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['ji'] = ((s as any).sd_ap['ji'] ?? 0) + (1);
          // TODO-QSP: jump 'sd_ap_join_low'
        }
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['low_list'] = ((s as any).sd_ap['low_list'] ?? 0) + (',  &&  ' + qspFunc(s, 'wrap', 'neg', ((s as any).sd_ap ?? 0)?.['low_' + String(((s as any).sd_ap ?? 0)?.['n_low'] - 1)]));
        if (!(s as any).sd_ap) (s as any).sd_ap = {}; (s as any).sd_ap['low_verb'] = 'are lacking';
      }
    }
...
function enterComputeStats(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).Gerpes ?? 0) >= 3  ||  ((s as any).Sifilis ?? 0) >= 21  ||  ((s as any).Triper ?? 0) > 2) {
    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['mood'] = ((s as any).stat_texts['mood'] ?? 0) + (' Your mood is reduced due to an STD.');
  }
  ...
  if (((s as any).pcs_energy ?? 0) <= 5) {
    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['energy'] = 'You are about to collapse from hunger.';
    if (((s as any).stat_cfg ?? 0)?.['render_mode_status'] === 3) {
      // TODO-QSP: $sd_pr_urgent[] = 'starving'
    }
  } else {
    if (((s as any).pcs_energy ?? 0) <= 25) {
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['energy'] = 'You are nearly starving.';
      if (((s as any).stat_cfg ?? 0)?.['render_mode_status'] === 3) {
        // TODO-QSP: $sd_pr_warning[] = 'very hungry'
      }
    } else {
      if (((s as any).pcs_energy ?? 0) <= 50) {
        if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['energy'] = 'Hunger tugs at your focus.';
        if (((s as any).stat_cfg ?? 0)?.['render_mode_status'] === 3) {
          // TODO-QSP: $sd_pr_mild[] = 'getting hungry'
        }
      } else {
        if (((s as any).pcs_energy ?? 0) <= 75) {
          if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['energy'] = 'A soft pang reminds you of food.';
        } else {
          if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['energy'] = 'You couldn\'t eat one more bite.';
        }
      }
    }
  }
  ...
  if (((s as any).pcs_hydra ?? 0) <= 5) {
    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['thirst'] = 'You burn with unrelenting thirst.';
    if (((s as any).stat_cfg ?? 0)?.['render_mode_status'] === 3) {
      // TODO-QSP: $sd_pr_urgent[] = 'parched dry'
    }
  } else {
    if (((s as any).pcs_hydra ?? 0) <= 25) {
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['thirst'] = 'You\'re so thirsty you could faint.';
      if (((s as any).stat_cfg ?? 0)?.['render_mode_status'] === 3) {
        // TODO-QSP: $sd_pr_warning[] = 'parched'
      }
    } else {
      if (((s as any).pcs_hydra ?? 0) <= 50) {
        if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['thirst'] = 'Your throat tightens with thirst.';
        if (((s as any).stat_cfg ?? 0)?.['render_mode_status'] === 3) {
          // TODO-QSP: $sd_pr_mild[] = 'thirsty'
        }
      } else {
        if (((s as any).pcs_hydra ?? 0) <= 75) {
          if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['thirst'] = 'A mild dryness lingers on your lips.';
        } else {
          if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['thirst'] = 'Your throat feels quenched.';
        }
      }
    }
  }
  ...
  if (((s as any).stat_cfg ?? 0)?.['render_mode_status'] === 3  &&  ((s as any).cheatVars ?? 0)?.['sleep'] === 0) {
    if (((s as any).drugVars ?? 0)?.['caffeine_dose'] > 0  &&  ((s as any).drugVars ?? 0)?.['sleep_actual'] < 100) {
      if (!(s as any).sd_pr) (s as any).sd_pr = {}; (s as any).sd_pr['sl'] = ((s as any).drugVars ?? 0)?.['sleep_actual'];
    } else {
      if (!(s as any).sd_pr) (s as any).sd_pr = {}; (s as any).sd_pr['sl'] = ((s as any).pcs_sleep ?? 0);
    }
  ...
  if (((s as any).stat_cfg ?? 0)?.['render_mode_status'] === 3) {
    if (!(s as any).sd_pr) (s as any).sd_pr = {}; (s as any).sd_pr['i'] = 0;
    ...
    if (((s as any).sd_pr ?? 0)?.['i'] < Object.keys((s as any).sd_pr_urgent ?? {}).length) {
      ...
      if (!(s as any).sd_pr) (s as any).sd_pr = {}; (s as any).sd_pr['i'] = ((s as any).sd_pr['i'] ?? 0) + (1);
    ...
    if (!(s as any).sd_pr) (s as any).sd_pr = {}; (s as any).sd_pr['total'] = 0;
    if (((s as any).sd_pr ?? 0)?.['total'] === 0) {
      ...
      if (((s as any).sd_pr ?? 0)?.['total'] === 1) {
        ...
        if (((s as any).sd_pr ?? 0)?.['total'] === 2) {
          ...
          if (!(s as any).sd_pr) (s as any).sd_pr = {}; (s as any).sd_pr['i'] = 1;
...
function enterComputeBody(s: GameState, scene: SceneBuilder): void {
  ...
  if ((!((s as any).opPRE ?? 0))) {
    if (((s as any).pcs_makeup ?? 0) === 1  &&  ((s as any).mc_inventory ?? 0)?.['travel_mirror'] > 0  &&  ((s as any).mc_inventory ?? 0)?.['travel_makeup'] > 0) {
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['makeup_icon_tooltip'] = '' + qspUntranslated(s, "pcs_makeup_tooltip>", { location: "stat_display_compute" }) + ' Click to put on light makeup.';
      // TODO-QSP: gs 'stat_display_compute', 'queue_msg', 'makeup_icon', '', 'status/makeup_' + $str(pcs_makeup), 1, '...
    } else {
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['makeup_icon_tooltip'] = ((s as any).pcs_makeup_tooltip ?? 0);
...
function enterComputeAppearance(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_shoes ?? 0) !== '') {
    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['clothes_style'] = 'You are wearing' + qspUntranslated(s, "temp_shoes>", { location: "stat_display_compute" }) + ' shoes';
    if (((s as any).temp_mu ?? 0) !== '') {
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['clothes_style'] = ((s as any).stat_texts['clothes_style'] ?? 0) + (' and' + qspUntranslated(s, "temp_mu>", { location: "stat_display_compute" }) + ' make up');
    }
    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['clothes_style'] = ((s as any).stat_texts['clothes_style'] ?? 0) + ('.');
...
function enterComputeMisc(s: GameState, scene: SceneBuilder): void {
  ...
  if (Object.keys((s as any).spellComplete ?? {}).length > 0) {
    ...
    if (!(s as any).sd_cm) (s as any).sd_cm = {}; (s as any).sd_cm['si'] = 0;
    // TODO-QSP: :sd_spell_loop
    if (((s as any).sd_cm ?? 0)?.['si'] < Object.keys((s as any).spellComplete ?? {}).length) {
      if (!(s as any).sd_cm) (s as any).sd_cm = {}; (s as any).sd_cm['spell_text'] = ((s as any).sd_cm['spell_text'] ?? 0) + (qspFunc(s, 'wrap', 'bimbo', '<br>' + qspUntranslated(s, "spellName[spellTimeName[sd_cm['si']]]>", { location: "stat_display_compute" }) + ''));
      if (!(s as any).sd_cm) (s as any).sd_cm = {}; (s as any).sd_cm['si'] = ((s as any).sd_cm['si'] ?? 0) + (1);
  ...
  if (((s as any).npc_QW ?? 0)?.['A113'] === 1  &&  ((s as any).belgangPay ?? 0) > 0) {
    ...
    if (((s as any).daybelisex ?? 0) < ((s as any).daystart ?? 0)) {
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['bely_debt'] = ((s as any).stat_texts['bely_debt'] ?? 0) + (', and you need to pay him ' + qspUntranslated(s, "func('money', 'string_debt', belgangpayweek)>", { location: "stat_display_compute" }) + ' this week.');
    } else {
      if (((s as any).daybelisex ?? 0) === ((s as any).daystart ?? 0)) {
  ...
  if (((s as any).region ?? 0) === 'gad') {
    if (((s as any).boletus ?? 0) + ((s as any).boletus_cooked ?? 0) + ((s as any).bilberry ?? 0) > 0) {
      if (((s as any).boletus ?? 0) + ((s as any).boletus_cooked ?? 0) + ((s as any).bilberry ?? 0) >= 5) {
        if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['gadukino'] = 'Your basket is full and you cannot carry more.';
      } else {
        if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['gadukino'] = 'Your basket is partially full.';
      }
      if (((s as any).boletus ?? 0) > 0) {
        if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['gadukino'] = ((s as any).stat_texts['gadukino'] ?? 0) + ('<br>Mushrooms: <a href="exec: boletus -= 1 & gs \'stat\'"><b>' + qspUntranslated(s, "boletus>", { location: "stat_display_compute" }) + '</b></a> kg.');
      }
      if (((s as any).boletus_cooked ?? 0) > 0) {
        if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['gadukino'] = ((s as any).stat_texts['gadukino'] ?? 0) + ('<br>Cooked Mushrooms: <a href="exec: boletus_cooked -= 1 & gs \'stat\'"><b>' + qspUntranslated(s, "boletus_cooked>", { location: "stat_display_compute" }) + '</b></a> kg.');
      }
      if (((s as any).bilberry ?? 0) > 0) {
        if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['gadukino'] = ((s as any).stat_texts['gadukino'] ?? 0) + ('<br>Berries: <a href="exec: bilberry -= 1 & gs \'stat\'"><b>' + qspUntranslated(s, "bilberry>", { location: "stat_display_compute" }) + '</b></a> kg.');
      }
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['gadukino'] = ((s as any).stat_texts['gadukino'] ?? 0) + ('<br>(Click numbers to throw away one a time)');
    }
  ...
  if (((s as any).sd_cm ?? 0)?.['lover_max'] > 0) {
    if (!(s as any).sd_cm) (s as any).sd_cm = {}; (s as any).sd_cm['li'] = 0;
    ...
    if (!(s as any).sd_cm) (s as any).sd_cm = {}; (s as any).sd_cm['li'] = ((s as any).sd_cm['li'] ?? 0) + (1);
  ...
  if (Object.keys((s as any).events_list ?? {}).length > 0) {
    if (((s as any).cal_upcoming_dirty ?? 0) === 1  ||  ((s as any).cal_day_cache_key ?? 0) !== ((s as any).daystart ?? 0)) {
      ...
      if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['ci'] = 0;
      ...
      if (((s as any).cal_r ?? 0)?.['ci'] < ((s as any).upcoming_count ?? 0)) {
        ...
        if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['ci'] = ((s as any).cal_r['ci'] ?? 0) + (1);
    ...
    if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['now_ts'] = ((s as any).hour ?? 0) * 4 + ((s as any).minut ?? 0) / 15;
    if (((s as any).stat_cfg ?? 0)?.['cal_count'] === 6) {
      if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['max'] = ((s as any).cal_upc_cache_cnt ?? 0);
      if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['today_only'] = 1;
    } else {
      if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['max'] = ((s as any).stat_cfg ?? 0)?.['cal_count'];
      if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['today_only'] = ((((s as any).stat_cfg ?? 0)?.['cal_today_only'] === 1) ? (0) : (1));
    }
    if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['shown'] = 0;
    if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['i'] = 0;
    ...
    if (((s as any).cal_r ?? 0)?.['i'] < ((s as any).cal_upc_cache_cnt ?? 0)  &&  ((s as any).cal_r ?? 0)?.['shown'] < ((s as any).cal_r ?? 0)?.['max']) {
      if (((s as any).cal_r ?? 0)?.['today_only'] === 1  &&  ((s as any).cal_upc_days ?? 0)[((s as any).cal_r ?? 0)?.['i']] !== ((s as any).daystart ?? 0)) {
        if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['i'] = ((s as any).cal_r['i'] ?? 0) + (1);
      ...
      if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['rgb'] = qspFunc(s, 'calendar_render', 'get_event_color', ((s as any).event_vars ?? 0)?.['color']);
      if (((s as any).cal_upc_days ?? 0)[((s as any).cal_r ?? 0)?.['i']] === ((s as any).daystart ?? 0)) {
        if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['day_lbl'] = 'Today';
      } else {
        if (((s as any).cal_upc_days ?? 0)[((s as any).cal_r ?? 0)?.['i']] === ((s as any).daystart ?? 0) + 1) {
          if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['day_lbl'] = 'Tomorrow';
        } else {
          if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['day_lbl'] = qspUntranslated(s, "weekName[func('time', 'get_week_from_daystart', cal_upc_days[cal_r['i']])]", { location: "stat_display_compute" });
        }
      }
      ...
      if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['shown'] = ((s as any).cal_r['shown'] ?? 0) + (1);
      if (!(s as any).cal_r) (s as any).cal_r = {}; (s as any).cal_r['i'] = ((s as any).cal_r['i'] ?? 0) + (1);
      // TODO-QSP: jump 'cal_render_loop'
    }
  }
...
function enterCondString(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['out'] = '';
  if (((s as any).locArgs?.[2] ?? 0) === 1) {
    if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['dirt_pct'] = Math.min(Math.max(0, ((s as any).ARGS ?? 0)[1] / 24), 100);
    if (((s as any).sd_cs ?? 0)?.['dirt_pct'] <= 20) {
      if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['dirt_col'] = 'v_pos';
    } else {
      if (((s as any).sd_cs ?? 0)?.['dirt_pct'] <= 60) {
        if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['dirt_col'] = 'neutral';
      } else {
        if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['dirt_col'] = 'neg';
      }
    }
    if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['out'] = qspFunc(s, 'wrap', '$sd_cs[\'dirt_col\']', '[\' + $str(sd_cs[\'dirt_pct\']) + \'% dirt]');
  }
  if (((s as any).locArgs?.[4] ?? 0) === 1) {
    if (((s as any).sd_cs ?? 0)?.['out'] !== '') {
      if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['out'] = ((s as any).sd_cs['out'] ?? 0) + (' ');
    }
    if (((s as any).locArgs?.[3] ?? 0) <= 5) {
      if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['wear_col'] = 'v_neg';
    } else {
      if (((s as any).locArgs?.[3] ?? 0) <= 15) {
        if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['wear_col'] = 'neg';
      } else {
        if (((s as any).locArgs?.[3] ?? 0) <= 25) {
          if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['wear_col'] = 'neutral';
        } else {
          if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['wear_col'] = 'v_pos';
        }
      }
    }
    if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['out'] = ((s as any).sd_cs['out'] ?? 0) + (qspFunc(s, 'wrap', '$sd_cs[\'wear_col\']', '[wear \' + $str(ARGS[3]) + \']'));
  }
  return;
  // TODO-QSP: end
  scene.build();
...
function enterCondCoatTemp(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sd_cs) (s as any).sd_cs = {}; (s as any).sd_cs['min_temp'] = ((((s as any).PCoatWarm ?? 0) === 3) ? ((-30)) : (((((s as any).PCoatWarm ?? 0) === 2) ? ((-20)) : ((-10)))));
...
function enterComputeImages(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['count'] = 0;
  if (!(s as any).sd_ci) (s as any).sd_ci = {}; (s as any).sd_ci['max'] = 0;
  if (!(s as any).sd_ci) (s as any).sd_ci = {}; (s as any).sd_ci['i'] = 0;
  // TODO-QSP: :sd_compute_images_loop
  if (!(s as any).sd_ci) (s as any).sd_ci = {}; (s as any).sd_ci['key'] = qspUntranslated(s, "image_order[sd_ci['i']]", { location: "stat_display_compute" });
  if (((s as any).stat_hide ?? 0)[((s as any).sd_ci ?? 0)?.['key']] === 1) {
    // TODO-QSP: jump 'sd_compute_images_next'
  }
  if (((s as any).sd_ci ?? 0)?.['key'] === 'face') {
    if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['url_face'] = qspFunc(s, '$face_image', '');
    if (((s as any).face_style ?? 0)?.['type'] !== 2) {
      if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_face'] = 'Face';
    } else {
      ...
      if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_face'] = ((((s as any).pcs_makeup ?? 0) >= 1  &&  ((s as any).pcs_makeup ?? 0) <= 7) ? (((s as any).sd_mu_lbl ?? 0)?.[String((s as any).pcs_makeup ?? 0)]) : (((((s as any).pcs_makeup ?? 0) <= 0) ? ('Smeared makeup') : ('Face'))));
    }
    if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_face'] = ((s as any).sd_img ?? 0)?.['label_face'];
    if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['cond_face'] = qspFunc(s, 'stat_display_compute', 'cond_face');
  } else {
    if (((s as any).sd_ci ?? 0)?.['key'] === 'body') {
      if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['url_body'] = qspFunc(s, '$body_image', 'body');
      if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_body'] = 'Body';
      if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_body'] = 'Body';
      ...
      if (((s as any).sd_ci ?? 0)?.['key'] === 'coat') {
        ...
        if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['url_coat'] = qspFunc(s, '$body_image', 'coat');
        if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_coat'] = 'Coat';
        if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_coat'] = qspFunc(s, '$item_description', 'coat', ((s as any).coatworntype ?? 0), ((s as any).coatwornnumber ?? 0));
        if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['cond_coat'] = qspFunc(s, 'stat_display_compute', 'cond_coat_temp');
      } else {
        if (((s as any).sd_ci ?? 0)?.['key'] === 'clothes') {
          if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['url_clothes'] = qspFunc(s, '$body_image', 'clothes');
          if (((s as any).clothingworntype ?? 0) === 'nude') {
            if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_clothes'] = ((((s as any).towel ?? 0) === 1) ? ('Towel') : (((((s as any).robe ?? 0) === 1) ? ('Robe') : ('Naked'))));
            if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_clothes'] = ((s as any).sd_img ?? 0)?.['label_clothes'];
          } else {
            if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_clothes'] = 'Clothes';
            if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_clothes'] = qspFunc(s, '$short_description', '$clothingworntype', ((s as any).clothingwornnumber ?? 0));
          ...
          if (((s as any).sd_ci ?? 0)?.['key'] === 'bra') {
            if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['url_bra'] = qspFunc(s, '$body_image', 'bra');
            if (((s as any).braworntype ?? 0) === 'none'  ||  ((s as any).braworntype ?? 0) === '') {
              if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_bra'] = 'Breasts';
              if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_bra'] = 'Breasts';
            } else {
              if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_bra'] = 'Bra';
              if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_bra'] = qspFunc(s, '$item_description', 'bra', ((s as any).braworntype ?? 0), ((s as any).brawornnumber ?? 0));
              if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['cond_bra'] = qspFunc(s, 'stat_display_compute', 'cond_string', ((s as any).PBraDirt ?? 0), 1, 0, 0);
            }
          } else {
            if (((s as any).sd_ci ?? 0)?.['key'] === 'panties') {
              if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['url_panties'] = qspFunc(s, '$body_image', 'panties');
              if (((s as any).pantyworntype ?? 0) === 'none'  ||  ((s as any).pantyworntype ?? 0) === '') {
                if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_panties'] = 'Pussy';
                if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_panties'] = 'Pussy';
              } else {
                if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_panties'] = 'Panties';
                if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_panties'] = qspFunc(s, '$item_description', 'panty', ((s as any).pantyworntype ?? 0), ((s as any).pantywornnumber ?? 0));
                if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['cond_panties'] = qspFunc(s, 'stat_display_compute', 'cond_string', ((s as any).PPanDirt ?? 0), 1, 0, 0);
              }
            } else {
              if (((s as any).sd_ci ?? 0)?.['key'] === 'shoes') {
                if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['url_shoes'] = qspFunc(s, '$body_image', 'shoes');
                if (((s as any).shoeworntype ?? 0) === 'none'  ||  ((s as any).shoeworntype ?? 0) === '') {
                  if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_shoes'] = 'Feet';
                  if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_shoes'] = 'Feet';
                } else {
                  if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_shoes'] = 'Shoes';
                  if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_shoes'] = qspFunc(s, '$shoe_description', '$shoeworntype', ((s as any).shoewornnumber ?? 0));
                }
                if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['cond_shoes'] = qspFunc(s, 'stat_display_compute', 'cond_heel_skill');
              } else {
                if (((s as any).sd_ci ?? 0)?.['key'] === 'bodysuit') {
                  ...
                  if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['url_bodysuit'] = qspFunc(s, '$body_image', 'bodysuit');
                  if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['label_bodysuit'] = 'Bodysuit';
                  if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['short_bodysuit'] = qspFunc(s, '$item_description', 'bodysuit', ((s as any).bodysuitworntype ?? 0), ((s as any).bodysuitwornnumber ?? 0));
                  if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['cond_bodysuit'] = qspFunc(s, 'stat_display_compute', 'cond_string', ((s as any).PPanDirt ?? 0), 1, 0, 0);
                }
              }
            }
          }
  ...
  if (!(s as any).sd_img) (s as any).sd_img = {}; (s as any).sd_img['count'] = ((s as any).sd_img['count'] ?? 0) + (1);
  // TODO-QSP: :sd_compute_images_next
  if (!(s as any).sd_ci) (s as any).sd_ci = {}; (s as any).sd_ci['i'] = ((s as any).sd_ci['i'] ?? 0) + (1);

...
function enterSisboytrioQWBedroom(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'foreplay', 2, 'lesbian', 'incest', 'group');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    if (((s as any).braworntype ?? 0) !== 'none') {
      ...
      qspCall(s, 'arousal', 'flashlite', 1, 'lesbian', 'incest', 'group');
      qspCall(s, 'stat', '');
      scene.actions([
...
function enterFlashBoobs(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'arousal', 'kiss', 3, ((s as any).npcID1 ?? 0), 'lesbian', 'incest', 'group');
    ...
    qspCall(s, 'arousal', 'foreplay', 5, ((s as any).npcID ?? 0), 'group');
    ...
    qspCall(s, 'arousal', 'voyeur_sex', 5, 'lesbian', 'incest', 'group');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    qspCall(s, 'arousal', 'cuni_give', (-5), ((s as any).npcID1 ?? 0), 'lesbian', 'incest', 'group');
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterFirstCumShot(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).roma_cherry ?? 0) === 1) {
    ...
    qspCall(s, 'arousal', 'foreplay', 3, ((s as any).npcID1 ?? 0), 'lesbian', 'incest', 'group');

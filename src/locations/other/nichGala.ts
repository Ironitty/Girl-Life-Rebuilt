...
function enter(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[0] ?? 0) === 'start'  ||  ((s as any).locArgs?.[0] ?? 0) === '') {
      ...
      if (((s as any).nichTemp ?? 0) === 'prepareClub') {
        ...
        if (((s as any).nichTemp ?? 0) === 'bathMorning'  ||  ((s as any).nichTemp ?? 0) === 'bathEvening') {
          ...
          if (((s as any).nichTemp ?? 0) === 'living') {
            ...
            scene.actions([
              { label: 'Approach', goto: ['nichGala', 'approach'] },
            ]);
          } else {
            ...
            if (((s as any).nichTemp ?? 0) === 'returnSpa'  ||  ((s as any).nichTemp ?? 0) === 'returnFriend'  ||  ((s as any).nichTemp ?? 0) === 'returnClub') {
              ...
              if (((s as any).locArgs?.[0] ?? 0) === 'approach') {
                ...
                scene.text(`"${((s as any).pcs_nickname ?? 0)}, what is it?"`);
                if (((s as any).nichGalaTraining ?? 0) === 1  &&  ((s as any).nichGalaContract ?? 0) === 0  &&  ((s as any).nichGalaTrainCounter ?? 0) >= 5) {
                  scene.actions([{ label: 'Continue', goto: ['nichGala', 'contractOffer'] }]);
                }
                if (((s as any).nichGalaContractActive ?? 0) === 1) {
                  scene.actions([
                    { label: 'Slave entertainment', goto: ['nichGala', 'slaveGeneric'] },
                  ]);
                } else {
    ...
    dynamicGoto(st, 'loc', 'return');
                  ...
                  scene.text(`"Thank you, ${((s as any).pcs_nickname ?? 0)}. You really did me a favor here. I will tell Nicholas men to take care of our Taras-problem."`);
    ...
    dynamicGoto(st, 'loc', 'return');
                ...
                if (((s as any).locArgs?.[0] ?? 0) === 'contractOffer') {
                  scene.img('images/characters/city/gala/02.jpg');
                  // TODO-QSP: dynamic text: "<<$pcs_nickname>>, I have been thinking. I really enjoy our little training ses...
                  scene.text(`"${((s as any).pcs_nickname ?? 0)}, I have been thinking. I really enjoy our little training sessions. And I believe you do as well. What would you say if we took them a little further?"`);
                  scene.actions([
    ...
    // TODO-QSP: xgt 'nichGala', 'contractOfferAccept'
                  ...
                  if (((s as any).locArgs?.[0] ?? 0) === 'contractOfferRead') {
                    ...
                    if ((!((s as any).nichGalaContractRead ?? 0))) {
                      ...
                      scene.text(`Contract between ${((s as any).pcs_firstname ?? 0)} ${((s as any).pcs_lastname ?? 0)} (the slave) and Gala Polyakov (the owner).`);
                    } else {
  ...
  }, goto: ['nichGala', 'contractOfferRead'] },
                            ]);
                          }
                          if (((s as any).locArgs?.[0] ?? 0) === 'contractOfferReject') {
    ...
    dynamicGoto(st, 'loc');
                            ...
                            if (((s as any).locArgs?.[0] ?? 0) === 'slaveIntro') {
    ...
    // TODO-QSP: gt 'nichGala', 'slaveIntro', 20
                                ...
                                if (((s as any).locArgs?.[0] ?? 0) === 'slaveDoc') {
                                  if (((s as any).ARGS ?? 0)[1] <= 1) {
                                            ...
                                            if (((s as any).ARGS ?? 0)[1] === 0) {
                                              if ((!((s as any).nichGalaImplantLevel ?? 0))) {
                                                ...
                                                if (((s as any).nichTempDayDifference ?? 0) <= 4) {
                                                  ...
                                                  (s as any).nichGalaImplantLevel = ((s as any).min ?? 0)(((s as any).nichGalaImplantLevel ?? 0)+1, 3);
                                                } else {
                                                  ...
                                                  (s as any).nichGalaImplantLevel = ((s as any).max ?? 0)(((s as any).nichGalaImplantLevel ?? 0)-1, 1);
                                                }
                                                ...
                                                if (((s as any).ARGS ?? 0)[1] === 1) {
                                                  ...
                                                  scene.text(`${((s as any).nichGalaTxt ?? 0)}`);
    ...
    // TODO-QSP: gt 'nichGala', 'slaveImplant', 121
                                                          ...
                                                          if (((s as any).ARGS ?? 0)[1] === 122) {
                                                            ...
                                                            scene.actions([
                                                              { label: 'Continue', handler: (st: GameState) => {
    // TODO-QSP: gt 'nichGala', 'slaveImplant', 122 + rand(1, 2)
  } },
                                                            ]);
                                                          } else {
                                                            qspCall(s, 'npcgeneratec', '', 0, 'Some biker', 0, Math.floor(Math.random() * 2) + 3, 1);
                                                            ...
                                                            if (((s as any).ARGS ?? 0)[1] === 124) {
                                                              ...
                                                              scene.actions([
                                                                { label: 'Continue', handler: (st: GameState) => {
    // TODO-QSP: gt 'nichGala', 'slaveImplant', 124 + rand(1, 2)
  } },
                                                              ]);
                                                            } else {
                                                              ...
                                                              if (((s as any).ARGS ?? 0)[1] === 126) {
                                                                ...
                                                                scene.actions([
                                                                  { label: 'Continue', handler: (st: GameState) => {
    // TODO-QSP: gt 'nichGala', 'slaveImplant', 126 + rand(1, 2)
  } },
                                                                ]);
                                                              } else {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 30;
                                                                ...
                                                                if (((s as any).locArgs?.[0] ?? 0) === 'slaveGeneric') {
                                                                  if (((s as any).nichGalaContractTaras ?? 0) === 0  &&  ((s as any).nichGalaContractDay ?? 0) + 14 <= ((s as any).daystart ?? 0)) {
                                                                    scene.actions([{ label: 'Continue', goto: ['nichGala', 'slaveTarasIntro'] }]);
                                                                  }
                                                                  ...
                                                                  if (((s as any).nichRand ?? 0) === 1  &&  ((s as any).pcs_cupsize ?? 0) > 15) {
                                                                    ...
                                                                    if (((s as any).locArgs?.[0] ?? 0) === 'slaveTarasIntro') {
                                                                      if (((s as any).ARGS ?? 0)[1] === 0) {
    ...
    (s as any).nichGalaTrainStage = 74;
                                                                                                          ...
                                                                                                          qspCall(s, 'stat', '');
                                                                                                          if (((s as any).locArgs?.[0] ?? 0) === 'trainingEnd') {
    ...
    (s as any).nichGalaTrainStage = 62;
                                                                                            ...
                                                                                            scene.actions([
                                                                                              { label: 'Further', goto: ['nichGala', 'training'] },
                                                                                            ]);
                                                                                          }
                                                                                        }
                                                                                      }
    ...
    // TODO-QSP: gt 'nichGala', 'slaveTarasIntro', 2
                                                                ...
                                                                scene.actions([
                                                                  { label: 'Continue', handler: (st: GameState) => {
    // TODO-QSP: gt 'nichGala', 'slaveImplant', 127 + rand(1, 2)
  } },
                                                                ]);
                                                              }
                                                              scene.actions([
                                                                { label: 'Continue', handler: (st: GameState) => {
    // TODO-QSP: gt 'nichGala', 'slaveImplant', 125 + rand(1, 2)
  } },
                                                              ]);
                                                            }
                                                            scene.actions([
                                                              { label: 'Continue', handler: (st: GameState) => {
    // TODO-QSP: gt 'nichGala', 'slaveImplant', 123 + rand(1, 2)
  } },
                                                            ]);
                                                          }
                                                          scene.actions([
                                                            { label: 'Continue', handler: (st: GameState) => {
    // TODO-QSP: gt 'nichGala', 'slaveImplant', 121 + rand(1, 2)
  } },
                                                          ]);
                                                        }
                                                        scene.actions([
    ...
    // TODO-QSP: gt 'nichGala', 'slaveIntro', 2
                          ...
                          scene.actions([
                            { label: 'Sign', goto: ['nichGala', 'contractOfferSign'] },
    ...
    dynamicGoto(st, 'loc');
                  ...
                  scene.actions([
                    { label: 'Sign without reading', goto: ['nichGala', 'contractOfferSign'] },

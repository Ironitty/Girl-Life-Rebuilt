...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('There is a shower, toilet, sink, <a href="#" onclick="window.__gameStore.getState().doGoto(\u0027mirror\u0027, \u0027start\u0027); return false;">mirror</a> where you can ' + (((!((s as any).pcs_hairbsh ?? 0))) ? ('<a href="#" onclick="window.__gameStore.getState().doGoto(\u0027mirror\u0027, \u0027brush\u0027); return false;">brush</a>') : ('brush')) + ' your hair, and even a bathtub.');
...
function enterPeek(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locat ?? 0)?.['sdad_athome'] === 1  &&  ((s as any).locat ?? 0)?.['Mom_athome'] === 0  &&  ((s as any).locat ?? 0)?.['Fam_inGad'] === 0  &&  ((s as any).stepdadqw_day ?? 0) !== ((s as any).daystart ?? 0)  &&  ((s as any).iif ?? 0)(((s as any).stepdadqw ?? 0)>0, 1, (Math.floor(Math.random() * 2) + 0)) === 1) {
    ...
    if (((s as any).locat ?? 0)?.['Kolka_athome'] === 1  &&  ((s as any).brotherQW ?? 0)?.['bath_voyeur_day'] !== ((s as any).daystart ?? 0)  &&  (Math.floor(Math.random() * 5) + 0) < 2  &&  ((s as any).locat ?? 0)?.['Fam_inGad'] === 0) {
      ((s as any).brotherQW = (s as any).brotherQW ?? {})['bath_voyeur_day'] = ((s as any).daystart ?? 0);
      qspCall(s, 'stat', '');
...
function enterStepdadSexVag(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).tempcpchance = ((s as any).locArgs?.[1] ?? 0);
  ...
  scene.actions([
    ...
    if ((Math.floor(Math.random() * 6) + 0) < ((st as any).tempcpchance ?? 0)) {
      (st as any).tempcpchance = undefined;

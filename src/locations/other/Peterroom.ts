...
function enterEnd(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"You're a breath of fresh air, ${((s as any).pcs_nickname ?? 0)}. You never fail to brighten my day," he says while gently stroking your cheek. "I hope I can see you again soon."`);
    ...
    scene.text(`You spend the journey talking about the sex you just had and you eventually reach your apartment building. Peter leans over and gives your ass a firm squeeze as you climb out of the car. "Until next time, ${((s as any).pcs_nickname ?? 0)}." You smile at him and close the door before he drives off.`);
    ...
    scene.text(`You spend the journey talking about the sex you just had and you reach the city center a few minutes later. Peter leans over and gives your ass a firm squeeze as you climb out of the car. "Until next time, ${((s as any).pcs_nickname ?? 0)}." You smile at him and close the door before he drives off.`);
  }, goto: ['city_center', ''] },
    ]);
  } },
  ]);

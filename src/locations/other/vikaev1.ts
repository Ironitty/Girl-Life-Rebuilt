...
function enterBVikaPresentBlow(s: GameState, scene: SceneBuilder): void {
  ...
  scene.img(`images/characters/city/university/girl/vika/sex/b_present_blow${((s as any).picrand ?? 0)}.jpg`);
...
function enterBVikaPresentSex2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.img(`images/characters/city/university/girl/vika/sex/b_present_dp${((s as any).picrand ?? 0)}.jpg`);

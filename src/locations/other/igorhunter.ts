...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).npc_pervert) (s as any).npc_pervert = {}; (s as any).npc_pervert[String((s as any).boy ?? 0)] = 0;
  (s as any).boyage = ((s as any).year ?? 0) - (((s as any).npc_dob ?? {})?.['A173'] / 10000);
  (s as any).boy_birth_month = (((s as any).npc_dob ?? {})?.['A173'] / 100) % 100;
  (s as any).boy_birth_date = ((s as any).npc_dob ?? {})?.['A173'] % 100;
  if (((s as any).hunterVars ?? 0)?.['IgorQW'] < 10  &&  ((s as any).hunterVars ?? 0)?.['IgorLove'] > 0) {
    ...
    // TODO-QSP: dynamic text: "<<$pcs_nickname>>, I realized that our love wasn't real, and we need to break u...
    scene.text(`"${((s as any).pcs_nickname ?? 0)}, I realized that our love wasn't real, and we need to break up," he says. As you try to find words to answer, he turns and resolutely walks away.`);
    ...
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['IgorQW'] = ((s as any).hunterVars['IgorQW'] ?? 0) - (10);
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    if (((s as any).hunterVars ?? 0)?.['IgorLove'] > 0  &&  ((s as any).pcs_horny ?? 0) <= 60  &&  ((s as any).hunterVars ?? 0)?.['IgorQW'] >= 10  &&  (Math.floor(Math.random() * 5) + 1) === 1  &&  ((s as any).hunterVars ?? 0)?.['Igorsex'] === 0) {
      ...
      scene.text(`"${((s as any).pcs_nickname ?? 0)}, let's make love."`);
    ...
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['IgorLove'] = 2;
    ...
    scene.img('images/pc/reactions/speak_to_the_hand.jpg');
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['IgorQW'] = ((s as any).hunterVars['IgorQW'] ?? 0) - (50);
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    dynamicGoto(st, 'loc', 'loc_arg');
        ...
        scene.text(`Igor is a hunter along with Sergei and Andrei and is here visiting Andrei. He's ${((s as any).boyage ?? 0)} years old. He is not married and lives in the City Center…`);
                    ...
                    if (((s as any).hunterVars ?? 0)?.['IgorLove'] === 0) {
                      ...
                      if (((s as any).hunterVars ?? 0)?.['IgorLove'] === 1) {
                        ...
                        if (((s as any).hunterVars ?? 0)?.['IgorLove'] === 2) {
                          ...
                          scene.text(`${((s as any).boydesc ?? 0)} is your boyfriend.`);
                        } else {
                          // TODO-QSP: dynamic text: <<$boydesc>> is your husband.
                          scene.text(`${((s as any).boydesc ?? 0)} is your husband.`);
                        }
                      }
                    }
                  }
    ...
    if (((s as any).hunterVars ?? 0)?.['IgorQW'] <= 35  &&  ((s as any).hunterVars ?? 0)?.['KnowSlut'] === 0) {
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['IgorQW'] = ((s as any).hunterVars['IgorQW'] ?? 0) + (1);
    }
    ...
    qspCall(s, 'stat', '');
    if (((s as any).hunterVars ?? 0)?.['IgorLove'] === 0  &&  ((s as any).hunterVars ?? 0)?.['IgorQW'] >= 35  &&  ((s as any).hunterVars ?? 0)?.['KnowSlut'] === 0  &&  ((s as any).bfA ?? 0) === 1  &&  ((s as any).pcs_apprnc ?? 0) >= 60) {
      scene.actions([
    ...
    scene.img('images/locations/gadukino/hunters/hanterkiss2.jpg');
    qspCall(s, 'mood', 'raise', 'small');
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['IgorLove'] = 1;
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['IgorQW'] = ((s as any).hunterVars['IgorQW'] ?? 0) + (1);
    qspCall(s, 'arousal', 'kiss', 5);
    qspCall(s, 'stat', '');
    if (((s as any).pcs_horny ?? 0) >= 40) {
    ...
    qspCall(s, 'mood', 'raise', 'small');
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['IgorQW'] = ((s as any).hunterVars['IgorQW'] ?? 0) + (1);
    if (((s as any).hunterVars ?? 0)?.['SergeiLove'] > 0  ||  ((s as any).hunterVars ?? 0)?.['AndreiLove'] > 0) {

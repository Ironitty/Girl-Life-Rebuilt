...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['cum_count'] = ((s as any).stat['cum_count'] ?? 0) + (1);
  ...
  if (((s as any).cumprecheck ?? 0) === 1  &&  (!((s as any).cumnostd ?? 0))) {
    if (!(s as any).cumarrkno) (s as any).cumarrkno = {}; (s as any).cumarrkno[String((s as any).cumarrtemp ?? 0)] = (-1);
    qspCall(s, 'dinSex', 'std_trigger');
  } else {
    if (((s as any).sexunaware ?? 0) > 0) {
      if (!(s as any).cumarrkno) (s as any).cumarrkno = {}; (s as any).cumarrkno[String((s as any).cumarrtemp ?? 0)] = (-2);
    } else {
      if (((s as any).sexpartkno ?? 0) === 1) {
        if (!(s as any).cumarrkno) (s as any).cumarrkno = {}; (s as any).cumarrkno[String((s as any).cumarrtemp ?? 0)] = 1;
      } else {
        if (!(s as any).cumarrkno) (s as any).cumarrkno = {}; (s as any).cumarrkno[String((s as any).cumarrtemp ?? 0)] = 0;
      }
    }
  }
  ...
  if (((s as any).cumprecheck ?? 0) === 1) {
    if (((s as any).sexcontra ?? 0) < 3  &&  (!((s as any).spafinloc ?? 0))) {
      ...
      if (!(s as any).cumarrcnt) (s as any).cumarrcnt = {}; (s as any).cumarrcnt[String((s as any).cumarrtemp ?? 0)] = ((s as any).stat ?? 0)?.['cum_count'];
      if (!(s as any).cumarrppt) (s as any).cumarrppt = {}; (s as any).cumarrppt[String((s as any).cumarrtemp ?? 0)] = ((s as any).sexspecpot ?? 0);
      if (!(s as any).cumarrage) (s as any).cumarrage = {}; (s as any).cumarrage[String((s as any).cumarrtemp ?? 0)] = 0;
      if (!(s as any).cumarrdel) (s as any).cumarrdel = {}; (s as any).cumarrdel[String((s as any).cumarrtemp ?? 0)] = 0;
      if (!(s as any).cumarrcon) (s as any).cumarrcon = {}; (s as any).cumarrcon[String((s as any).cumarrtemp ?? 0)] = ((s as any).sexcontra ?? 0);
      if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] ?? 0) + (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)]/12);
      if (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)] < ((s as any).cumarrcpt ?? 0)?.[String((s as any).cumarrtemp ?? 0)]) {
        if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)];
      }
    }
  } else {
    ...
    if (((s as any).spafinloc ?? 0) <= 0) {
      ...
      if (((s as any).sexcontra ?? 0) > 2) {
        ...
        if (((s as any).sexcontra ?? 0) === 3) {
          ...
          if ((!((s as any).temprand ?? 0))) {
            if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] ?? 0) + (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)]/4);
            if (!(s as any).cumarrcon) (s as any).cumarrcon = {}; (s as any).cumarrcon[String((s as any).cumarrtemp ?? 0)] = 3;
          } else {
            if (((s as any).temprand ?? 0) <= ((s as any).break_thresh ?? 0)) {
              if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] ?? 0) + (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)]/2);
              if (!(s as any).cumarrcon) (s as any).cumarrcon = {}; (s as any).cumarrcon[String((s as any).cumarrtemp ?? 0)] = 4;
              (s as any).sexcontra = 4;
              if (!(s as any).sparrage) (s as any).sparrage = {}; (s as any).sparrage[String((s as any).sparrtemp ?? 0)] = 0;
              if (!(s as any).sparrloc) (s as any).sparrloc = {}; (s as any).sparrloc[String((s as any).sparrtemp ?? 0)] = 0;
              // TODO-QSP: $sparrnam[sparrtemp] = $npcID
              if (!(s as any).sparrcnt) (s as any).sparrcnt = {}; (s as any).sparrcnt[String((s as any).sparrtemp ?? 0)] = ((s as any).stat ?? 0)?.['cum_count'];
              if (!(s as any).sparrppt) (s as any).sparrppt = {}; (s as any).sparrppt[String((s as any).sparrtemp ?? 0)] = ((s as any).sexspecpot ?? 0);
              if (!(s as any).sparrvol) (s as any).sparrvol = {}; (s as any).sparrvol[String((s as any).sparrtemp ?? 0)] = ((s as any).sparrvol[String((s as any).sparrtemp ?? 0)] ?? 0) + (((s as any).sexvolume ?? 0));
              ...
              if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['broken_condoms'] = ((s as any).stat['broken_condoms'] ?? 0) + (1);
              if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_broken_condom'] = ((s as any).daystart ?? 0);
              if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['cum_vagina_ml'] = ((s as any).stat['cum_vagina_ml'] ?? 0) + (((s as any).sexvolume ?? 0));
              if (!(s as any).sparridt) (s as any).sparridt = {}; (s as any).sparridt[String((s as any).sparrtemp ?? 0)] = ((s as any).cumarrkno ?? 0)?.[String((s as any).cumarrtemp ?? 0)];
              if (!(s as any).sparrslc) (s as any).sparrslc = {}; (s as any).sparrslc[String((s as any).sparrtemp ?? 0)] = 0;
              qspCall(s, 'dina', 'ferteggfather');
            } else {
              if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] ?? 0) + (5);
              if (!(s as any).cumarrcon) (s as any).cumarrcon = {}; (s as any).cumarrcon[String((s as any).cumarrtemp ?? 0)] = 3;
              if (((s as any).npcCondom ?? 0) !== '') {
              }
            }
          ...
          if (((s as any).sexcontra ?? 0) === 4) {
            ...
            if (((s as any).sexcontra ?? 0) === 5) {
              if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] ?? 0) + (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)]/200);
              if (!(s as any).cumarrcon) (s as any).cumarrcon = {}; (s as any).cumarrcon[String((s as any).cumarrtemp ?? 0)] = 5;
              (s as any).cumcondslip = 1;
              (s as any).cumcondsanb = ((s as any).cumarrtemp ?? 0);
              if (!(s as any).sparrage) (s as any).sparrage = {}; (s as any).sparrage[String((s as any).sparrtemp ?? 0)] = 0;
              if (!(s as any).sparrloc) (s as any).sparrloc = {}; (s as any).sparrloc[String((s as any).sparrtemp ?? 0)] = 17;
              // TODO-QSP: $sparrnam[sparrtemp] = $npcID
              if (!(s as any).sparrcnt) (s as any).sparrcnt = {}; (s as any).sparrcnt[String((s as any).sparrtemp ?? 0)] = ((s as any).stat ?? 0)?.['cum_count'];
              if (!(s as any).sparrppt) (s as any).sparrppt = {}; (s as any).sparrppt[String((s as any).sparrtemp ?? 0)] = ((s as any).sexspecpot ?? 0);
              if (!(s as any).sparrvol) (s as any).sparrvol = {}; (s as any).sparrvol[String((s as any).sparrtemp ?? 0)] = ((s as any).sparrvol[String((s as any).sparrtemp ?? 0)] ?? 0) + (((s as any).sexvolume ?? 0));
              ...
              if (((s as any).sexcontra ?? 0) === 6) {
                ...
                if (((s as any).sexcontra ?? 0) === 6  ||  ((s as any).npcCondom ?? 0) === 'sabotaged') {
                  ...
                  if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] ?? 0) + (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)]/3);
                  if (!(s as any).cumarrcon) (s as any).cumarrcon = {}; (s as any).cumarrcon[String((s as any).cumarrtemp ?? 0)] = 6;
                  if (((s as any).temprand ?? 0) <= ((s as any).break_thresh ?? 0)) {
                    if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] ?? 0) + (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)]/2);
                    if (!(s as any).cumarrcon) (s as any).cumarrcon = {}; (s as any).cumarrcon[String((s as any).cumarrtemp ?? 0)] = 4;
                    (s as any).sexcontra = 4;
                  ...
                  if (((s as any).sexcontra ?? 0) === 7) {
                    // TODO-QSP: break_thresh * 3
                    if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] ?? 0) + (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)]/3);
                    if (!(s as any).cumarrcon) (s as any).cumarrcon = {}; (s as any).cumarrcon[String((s as any).cumarrtemp ?? 0)] = 7;
                    if (((s as any).temprand ?? 0) <= ((s as any).break_thresh ?? 0)) {
                      if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] ?? 0) + (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)]/2);
                      if (!(s as any).cumarrcon) (s as any).cumarrcon = {}; (s as any).cumarrcon[String((s as any).cumarrtemp ?? 0)] = 4;
                      (s as any).sexcontra = 4;
        ...
        if (!(s as any).sparridt) (s as any).sparridt = {}; (s as any).sparridt[String((s as any).sparrtemp ?? 0)] = ((s as any).cumarrkno ?? 0)?.[String((s as any).cumarrtemp ?? 0)];
        if (!(s as any).sparrslc) (s as any).sparrslc = {}; (s as any).sparrslc[String((s as any).sparrtemp ?? 0)] = 0;
        if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] ?? 0) + (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)] / 5 * 4);
        if (!(s as any).cumarrcon) (s as any).cumarrcon = {}; (s as any).cumarrcon[String((s as any).cumarrtemp ?? 0)] = ((s as any).sexcontra ?? 0);
        qspCall(s, 'dina', 'ferteggfather');
      }
      ...
      if (((s as any).spafinloc ?? 0) === 0  &&  ((s as any).sexcontra ?? 0) !== 3) {
        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_creampie'] = ((s as any).daystart ?? 0);
        if (((s as any).sexunaware ?? 0) === 1  ||  ((s as any).sexcontra ?? 0) === 6) {
          if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_creampie_hidden'] = ((s as any).daystart ?? 0);
        } else {
          if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['last_creampie_known'] = ((s as any).daystart ?? 0);
        }
        ...
        if (((s as any).cycle ?? 0) > 3  ||  ((s as any).birth_control ?? 0)?.['safe'] === 1  ||  ((s as any).succubusflag ?? 0) === 1) {
          if (((s as any).sexunaware ?? 0) === 1  ||  ((s as any).sexcontra ?? 0) === 6) {
            if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['creampies_safe_unknown'] = ((s as any).stat['creampies_safe_unknown'] ?? 0) + (1);
          } else {
            if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['creampies_safe_known'] = ((s as any).stat['creampies_safe_known'] ?? 0) + (1);
          }
        } else {
          if (((s as any).cycle ?? 0) === 0  ||  ((s as any).cycle ?? 0) === 3) {
            if (((s as any).sexunaware ?? 0) === 1  ||  ((s as any).sexcontra ?? 0) === 6) {
              if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['creampies_notsafe_unknown'] = ((s as any).stat['creampies_notsafe_unknown'] ?? 0) + (1);
            } else {
              if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['creampies_notsafe_known'] = ((s as any).stat['creampies_notsafe_known'] ?? 0) + (1);
            }
          } else {
            if (((s as any).sexunaware ?? 0) === 1  ||  ((s as any).sexcontra ?? 0) === 6) {
              if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['creampies_risky_unknown'] = ((s as any).stat['creampies_risky_unknown'] ?? 0) + (1);
            } else {
              if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['creampies_risky_known'] = ((s as any).stat['creampies_risky_known'] ?? 0) + (1);
            }
          }
        }
      ...
      if (((s as any).sexcontra ?? 0) < 3) {
        ...
        if (!(s as any).sparrloc) (s as any).sparrloc = {}; (s as any).sparrloc[String((s as any).sparrtemp ?? 0)] = ((s as any).spafinloc ?? 0);
        ...
        if (!(s as any).sparridt) (s as any).sparridt = {}; (s as any).sparridt[String((s as any).sparrtemp ?? 0)] = ((s as any).cumarrkno ?? 0)?.[String((s as any).cumarrtemp ?? 0)];
        if (!(s as any).sparrslc) (s as any).sparrslc = {}; (s as any).sparrslc[String((s as any).sparrtemp ?? 0)] = 0;
        if (!(s as any).cumloc) (s as any).cumloc = {}; (s as any).cumloc[String((s as any).spafinloc ?? 0)] = 1;
      }
    }
    if (((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)] < ((s as any).cumarrcpt ?? 0)?.[String((s as any).cumarrtemp ?? 0)]) {
      if (!(s as any).cumarrcpt) (s as any).cumarrcpt = {}; (s as any).cumarrcpt[String((s as any).cumarrtemp ?? 0)] = ((s as any).cumarrppt ?? 0)?.[String((s as any).cumarrtemp ?? 0)];
  ...
  if (((s as any).cumsumass ?? 0) >= 60) {
    ...
    if (((s as any).sparrslc ?? 0)?.[String((s as any).arrmodtmp ?? 0)] <= 0) {
      if (!(s as any).sparrslc) (s as any).sparrslc = {}; (s as any).sparrslc[String((s as any).arrmodtmp ?? 0)] = ((s as any).sparrslc[String((s as any).arrmodtmp ?? 0)] ?? 0) + (1);
    }
  }
...
function enterCumCompute(s: GameState, scene: SceneBuilder): void {
  ...
  if (Object.keys((s as any).sparrvol ?? {}).length > 0) {
    ...
    if (!(s as any).cumvolume) (s as any).cumvolume = {}; (s as any).cumvolume['' + String((s as any).temp_cum_manage_i || '') + ':' + String((s as any).temp_cum_manage_j || '') + ''] = ((s as any).cumvolume['' + String((s as any).temp_cum_manage_i || '') + ':' + String((s as any).temp_cum_manage_j || '') + ''] ?? 0) + (((s as any).sparrvol ?? 0)?.[String((s as any).idx ?? 0)]);
    if (((s as any).sparrvol ?? 0)?.[String((s as any).idx ?? 0)] > 0) {
      if (((s as any).sparridt ?? 0)?.[String((s as any).idx ?? 0)] === 0) {
        if (!(s as any).cumcount) (s as any).cumcount = {}; (s as any).cumcount['' + String((s as any).temp_cum_manage_i || '') + ':' + String((s as any).temp_cum_manage_j || '') + ''] = ((s as any).cumcount['' + String((s as any).temp_cum_manage_i || '') + ':' + String((s as any).temp_cum_manage_j || '') + ''] ?? 0) + (1);
      } else {
        if (((s as any).sparridt ?? 0)?.[String((s as any).idx ?? 0)] === 1) {
          if (((s as any).knownguy ?? 0)[((s as any).temp_cum_manage_i ?? 0) + ':' + ((s as any).temp_cum_manage_j ?? 0)] > 0) {
            ...
            if (((s as any).gchk ?? 0) > ((s as any).knownguy ?? 0)[((s as any).temp_cum_manage_i ?? 0) + ':' + ((s as any).temp_cum_manage_j ?? 0)]) {
              ...
              if (!(s as any).knownguy) (s as any).knownguy = {}; (s as any).knownguy['' + String((s as any).temp_cum_manage_i || '') + ':' + String((s as any).temp_cum_manage_j || '') + ''] = ((s as any).knownguy['' + String((s as any).temp_cum_manage_i || '') + ':' + String((s as any).temp_cum_manage_j || '') + ''] ?? 0) + (1);
              if (!(s as any).cumcount) (s as any).cumcount = {}; (s as any).cumcount['' + String((s as any).temp_cum_manage_i || '') + ':' + String((s as any).temp_cum_manage_j || '') + ''] = ((s as any).cumcount['' + String((s as any).temp_cum_manage_i || '') + ':' + String((s as any).temp_cum_manage_j || '') + ''] ?? 0) + (1);
            }
          } else {
            // TODO-QSP: $cumowner['<<temp_cum_manage_i>>:<<temp_cum_manage_j>>:<<knownguy[''<<temp_cum_manage_i>>:<<temp_cum...
  ...
  if (((s as any).cumvolume ?? 0)[((s as any).temp_cum_manage_i ?? 0) + ':' + ((s as any).temp_cum_manage_j ?? 0)] > 0) {
    if (!(s as any).cumloc) (s as any).cumloc = {}; (s as any).cumloc[String((s as any).temp_cum_manage_i ?? 0)] = 1;
    if (!(s as any).cumvol) (s as any).cumvol = {}; (s as any).cumvol[String((s as any).temp_cum_manage_i ?? 0)] = ((s as any).cumvolume ?? 0)?.[String(((s as any).temp_cum_manage_i ?? 0)) + ':' + String(((s as any).temp_cum_manage_j ?? 0))];
...
function enterComputeStatDisplay(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_check'] = 0;
  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['i'] = 0;
  // TODO-QSP: :cum_locloop
  if (((s as any).sd_cum ?? 0)?.['i'] === 0) {
    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'your pussy';
    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your <a href="exec:view\'images/pc/body/cum/creampie/cumpussy\' + rand(1, 14) + \'.jpg\'">pussy</a>';
  } else {
    if (((s as any).sd_cum ?? 0)?.['i'] === 1) {
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'all over ';
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'your labia';
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your <a href="exec:view\'images/pc/body/cum/cumpussy/cumpus\' + rand(1, 4) + \'.jpg\'">labia</a>';
    } else {
      if (((s as any).sd_cum ?? 0)?.['i'] === 2  &&  ((s as any).PCloPanties ?? 0) === 1) {
        if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'across ';
        if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'the front of your panties';
        if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = ((s as any).sd_cum ?? 0)?.['loc'];
      } else {
        if (((s as any).sd_cum ?? 0)?.['i'] === 3) {
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'across ';
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'your ass';
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your <a href="exec:view\'images/pc/body/cum/cumanal/cumanal\' + rand(1, 11) + \'.jpg\'">ass</a>';
        } else {
          if (((s as any).sd_cum ?? 0)?.['i'] === 4) {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'all over ';
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'your butt';
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your <a href="exec:view\'images/pc/body/cum/cumass/cumass\' + rand(1, 6) + \'.jpg\'">butt</a>';
          } else {
            if (((s as any).sd_cum ?? 0)?.['i'] === 5  &&  ((s as any).PCloPanties ?? 0) === 1) {
              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'painting ';
              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'the back of your panties';
              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = ((s as any).sd_cum ?? 0)?.['loc'];
            } else {
              if (((s as any).sd_cum ?? 0)?.['i'] === 6) {
                if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'on ';
                if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'your clothes near your groin';
                if (((s as any).PCloPants ?? 0) > 0) {
                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your <a href="exec:view\'images/pc/body/cum/cumclothes/\' + rand(1, 3) + \'.jpg\'">clothes near your groin</a>';
                } else {
                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your <a href="exec:view\'images/pc/body/cum/cumclothes/cumclothes1.jpg\'">clothes near your groin</a>';
                }
              } else {
                if (((s as any).sd_cum ?? 0)?.['i'] === 7  &&  ((s as any).clothingworntype ?? 0) !== 'nude') {
                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'on ';
                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'your clothes';
                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your <a href="exec:view\'images/pc/body/cum/cumclothes/cumclothes\' + rand(1, 21) + \'.jpg\'">clothes</a>';
                } else {
                  if (((s as any).sd_cum ?? 0)?.['i'] === 8) {
                    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'down ';
                    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your back';
                    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = ((s as any).sd_cum ?? 0)?.['loc'];
                  } else {
                    if (((s as any).sd_cum ?? 0)?.['i'] === 9) {
                      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'on ';
                      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your legs';
                      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = ((s as any).sd_cum ?? 0)?.['loc'];
                    } else {
                      if (((s as any).sd_cum ?? 0)?.['i'] === 10) {
                        if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'on ';
                        if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your arms';
                        if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = ((s as any).sd_cum ?? 0)?.['loc'];
                      } else {
                        if (((s as any).sd_cum ?? 0)?.['i'] === 11) {
                          if ((!((s as any).pcs_haircol ?? 0))) {
                            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['face_img'] = 'brown/' + qspUntranslated(s, "rand(1,31)>", { location: "cum_manage" }) + '';
                          } else {
                            if (((s as any).pcs_haircol ?? 0) === 1) {
                              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['face_img'] = 'black/' + qspUntranslated(s, "rand(1,23)>", { location: "cum_manage" }) + '';
                            } else {
                              if (((s as any).pcs_haircol ?? 0) === 2) {
                                if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['face_img'] = 'red/' + qspUntranslated(s, "rand(1,19)>", { location: "cum_manage" }) + '';
                              } else {
                                if (((s as any).pcs_haircol ?? 0) === 3) {
                                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['face_img'] = 'blonde/' + qspUntranslated(s, "rand(1,25)>", { location: "cum_manage" }) + '';
                                } else {
                                  if (((s as any).pcs_haircol ?? 0) > 3) {
                                    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['face_img'] = 'custom/' + qspUntranslated(s, "rand(1,20)>", { location: "cum_manage" }) + '';
                                  }
                                }
                              }
                            }
                          ...
                          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'across ';
                          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'your face';
                          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your <a href="exec:view\'images/pc/body/cum/cumface/' + qspUntranslated(s, "sd_cum['face_img']>", { location: "cum_manage" }) + '.jpg\'">face</a>';
                        } else {
                          if (((s as any).sd_cum ?? 0)?.['i'] === 13) {
                            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'over ';
                            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your hands';
                            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = ((s as any).sd_cum ?? 0)?.['loc'];
                          } else {
                            if (((s as any).sd_cum ?? 0)?.['i'] === 14) {
                              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'across ';
                              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'across your stomach';
                              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'across your <a href="exec:view\'images/pc/body/cum/cumbelly/cumbelly\' + rand(1, 12) + \'.jpg\'">stomach</a>';
                            } else {
                              if (((s as any).sd_cum ?? 0)?.['i'] === 15) {
                                if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'on ';
                                if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'on your breasts';
                                if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your <a href="exec:view\'images/pc/body/cum/cumtits/cumtits\' + rand(1, 19) + \'.jpg\'">breasts</a>';
                              } else {
                                if (((s as any).sd_cum ?? 0)?.['i'] === 16) {
                                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'in ';
                                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'your hair';
                                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'your hair';
                                } else {
                                  if (((s as any).sd_cum ?? 0)?.['i'] === 17) {
                                    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'in your vagina in a slipped condom';
                                    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = ((s as any).sd_cum ?? 0)?.['loc'];
                                  } else {
                                    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_adj'] = 'on ';
                                    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_loc'] = 'the gusset of your panties';
                                    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc'] = 'the gusset of your panties';
                                  }
                                }
                              }
                            }
  ...
  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['j'] = 0;
  ...
  if (((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] > 0) {
    if (((s as any).sd_cum ?? 0)?.['loc_check'] !== 1  &&  ((s as any).sd_cum ?? 0)?.['i'] !== 12) {
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['loc_check'] = 1;
    }
    if (((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] > 250) {
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['amount'] = 'Enormous ';
    } else {
      if (((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] > 100) {
        if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['amount'] = 'Huge ';
      } else {
        if (((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] >= 20) {
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['amount'] = 'Decent ';
        } else {
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['amount'] = 'Small ';
        }
      }
    }
    if (((s as any).sd_cum ?? 0)?.['j'] === 4) {
      if (((((s as any).vibratorIN ?? 0) === 1  ||  ((s as any).isprok ?? 0) === 1)  &&  ((s as any).sd_cum ?? 0)?.['i'] === 0)  ||  (((s as any).analPlugIn ?? 0) === 1  &&  ((s as any).sd_cum ?? 0)?.['i'] === 3)) {
        if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'being plugged in ';
      } else {
        if (((s as any).sd_cum ?? 0)?.['i'] === 0  &&  ((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] < qspFunc(s, 'cum_manage', 'get_inner_capacity', 0)) {
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'staying inside ';
        } else {
          if (((s as any).sd_cum ?? 0)?.['i'] === 3  &&  ((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] < qspFunc(s, 'cum_manage', 'get_inner_capacity', 3)) {
            ...
            if (((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] > 250) {
              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'gushing out of ';
            } else {
              if (((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] > 100) {
                if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'flowing out of ';
              } else {
                if (((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] >= 40) {
                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'seeping out of ';
                } else {
                  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'staying inside ';
                }
              }
      ...
      if (((s as any).sd_cum ?? 0)?.['j'] >= 5) {
        if (((s as any).sd_cum ?? 0)?.['j'] === 5) {
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'buried ';
        } else {
          if (((s as any).sd_cum ?? 0)?.['j'] === 6) {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'marinating ';
          } else {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'rotting ';
          }
        }
        if (((s as any).cumcondslip_deep ?? 0) > (((s as any).vagina ?? 0) / 2)) {
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = ((s as any).sd_cum['proxy'] ?? 0) + ('deep ');
        }
      } else {
        if (((s as any).sd_cum ?? 0)?.['j'] < 4  &&  ((s as any).sd_cum ?? 0)?.['j'] > 0) {
          if (((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] > 160) {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'coating ';
          } else {
            if (((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] > 40) {
              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'covering ';
            } else {
              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = 'spattered ';
            }
          }
          if (((s as any).sd_cum ?? 0)?.['j'] === 1) {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = ((s as any).sd_cum['proxy'] ?? 0) + ('wetly ');
          } else {
            if (((s as any).sd_cum ?? 0)?.['j'] === 2) {
              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = ((s as any).sd_cum['proxy'] ?? 0) + ('dryly ');
            } else {
              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = ((s as any).sd_cum['proxy'] ?? 0) + ('powderly ');
            }
          }
          if (((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] < 40) {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['proxy'] = ((s as any).sd_cum['proxy'] ?? 0) + (((s as any).sd_cum ?? 0)?.['loc_adj']);
          }
        }
      }
    }
    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['person'] = '';
    if (((s as any).cumcount ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] === 0) {
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['iscum'] = 'some whitish substance ';
    } else {
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['iscum'] = 'cum';
      if (((s as any).cumcount ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] === ((s as any).knownguy ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']]) {
        if (((s as any).knownguy ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] === 1) {
          ...
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['kmax'] = 0;
          // TODO-QSP: :cum_nullocator1
          if (((s as any).cumowner ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j'] + ':' + ((s as any).sd_cum ?? 0)?.['kmax']] !== '') {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['kmax'] = ((s as any).sd_cum['kmax'] ?? 0) + (1);
            // TODO-QSP: jump 'cum_nullocator1'
          }
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['kmax'] = ((s as any).sd_cum['kmax'] ?? 0) - (1);
          if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['k'] = 0;
          ...
          if (((s as any).sd_cum ?? 0)?.['k'] < ((s as any).sd_cum ?? 0)?.['kmax'] - 1) {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['person'] = ((s as any).sd_cum['person'] ?? 0) + (', ');
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['k'] = ((s as any).sd_cum['k'] ?? 0) + (1);
        ...
        if (((s as any).knownguy ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] === 0) {
          if (((s as any).cumcount ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] === 1) {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['person'] = ((s as any).sd_cum['person'] ?? 0) + ('some guy ');
          } else {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['person'] = ((s as any).sd_cum['person'] ?? 0) + ('some guys ');
          }
        } else {
          if (((s as any).knownguy ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] === 1) {
            if (((s as any).npc_usedname ?? 0)[((s as any).cumowner ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j'] + ':' + ((s as any).sd_cum ?? 0)?.['k']]] === 'stranger') {
              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['person'] = ((s as any).npc_firstname ?? 0)[((s as any).cumowner ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j'] + ':0']] + '  &&  some guy';
            } else {
              if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['person'] = ((s as any).npc_usedname ?? 0)[((s as any).cumowner ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j'] + ':0']] + '  &&  some guy';
            }
          } else {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['kmax'] = 0;
            ...
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['person'] = ((s as any).sd_cum['person'] ?? 0) + ('and some guy');
          }
          if (((s as any).cumcount ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] - ((s as any).knownguy ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] > 1) {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['person'] = ((s as any).sd_cum['person'] ?? 0) + ('s ');
          } else {
            if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['person'] = ((s as any).sd_cum['person'] ?? 0) + (' ');
          }
        }
    ...
    if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['icon_iscum'] = ((s as any).sd_cum ?? 0)?.['iscum'];
    ...
    if (((s as any).sd_cum ?? 0)?.['person'] !== '') {
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['person'] = ' from ' + qspUntranslated(s, "sd_cum['person']>", { location: "cum_manage" }) + '';
    }
    if (((s as any).sd_cum ?? 0)?.['j'] === 0) {
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['display'] = 'Your mouth has the tangy aftertaste of sperm.';
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['tooltip'] = ((s as any).sd_cum ?? 0)?.['display'];
    } else {
      if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['tail'] = '.';
      if (((s as any).sd_cum ?? 0)?.['i'] === 0  &&  ((s as any).sd_cum ?? 0)?.['j'] === 4  &&  ((s as any).vibratorIN ?? 0) === 0  &&  ((s as any).pcs_vag ?? 0) * 10 < ((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']]  &&  ((s as any).cumvolume ?? 0)[((s as any).sd_cum ?? 0)?.['i'] + ':' + ((s as any).sd_cum ?? 0)?.['j']] >= 20) {
        if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['tail'] = ((((s as any).pantyworntype ?? 0) !== 'none') ? (' into your panties.') : (' down your legs.'));
      }
      ...
      if (((s as any).sd_cum ?? 0)?.['j'] >= 5  &&  (!((s as any).cumcondslip_aware ?? 0))) {
        if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['display'] = '';
      } else {
    ...
    if (((s as any).sd_cum ?? 0)?.['display'] !== '') {
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['cum'] = ((s as any).stat_texts['cum'] ?? 0) + (((((s as any).stat_texts ?? 0)?.['cum'] === '') ? ('') : ('<br>')));
    }
    // TODO-QSP: $stat_cum_msg += $iif($stat_cum_msg <> '', '<br>', '') + '''<<$sd_cum[''tooltip'']>>'''
  }
  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['j'] = ((s as any).sd_cum['j'] ?? 0) + (1);
  ...
  if (!(s as any).sd_cum) (s as any).sd_cum = {}; (s as any).sd_cum['i'] = ((s as any).sd_cum['i'] ?? 0) + (1);
  ...
  if (((s as any).stat_texts ?? 0)?.['cum'] !== '') {
    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['cum_tooltip'] = ((s as any).stat_cum_msg ?? 0);
  ...
  if (((s as any).stat_visible_cum_msg ?? 0) !== '') {
    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['visible_cum'] = ((s as any).stat_visible_cum_msg ?? 0);
  ...
  if (((s as any).trait_vars ?? 0)?.['cumeater'] === 1  &&  qspFunc(s, 'cum_manage', 'check_removeable_cum')) {
    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['cumeater_icon_tooltip'] = 'Click to lick up all that delicious cum.';
    if (qspFunc(s, 'cum_manage', 'check_removeable_cum_actionable')) {
      ...
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['cumeater_icon_tooltip'] = 'Need a private place.';
  ...
  if (((s as any).mc_inventory ?? 0)?.['makeup_wipes'] > 0  &&  qspFunc(s, 'cum_manage', 'check_removeable_cum')) {
    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['wipes_icon_tooltip'] = 'Click to use your wipes.';
    if (qspFunc(s, 'cum_manage', 'check_removeable_cum_actionable')) {
      qspCall(s, 'stat_display_compute', 'queue_msg', 'wipes_icon', '', 'status/wipes', 3, 'gs \'din_bad\', \'d_salf\'');
    } else {
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['wipes_icon_tooltip'] = 'Need a private place.';
                  ...
                  if (((s as any).locArgs?.[1] ?? 0) === 9) {
                    ...
                    if (((s as any).locArgs?.[1] ?? 0) === 10) {
                      ...
                      if (((s as any).locArgs?.[1] ?? 0) === 11) {
                        if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['cum_facial'] = ((s as any).stat['cum_facial'] ?? 0) + (1);
                      } else {
...
function enterCumeater(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_cum_cleanup_cumeater_pos ?? 0) >= 0  &&  ((s as any).temp_cum_cleanup_cumeater_pos ?? 0) < Object.keys((s as any).sparrloc ?? {}).length) {
    if (!(s as any).cumloc) (s as any).cumloc = {}; (s as any).cumloc[12] = 1;
...
function enterCumDecay(s: GameState, scene: SceneBuilder): void {
  ...
  if (Object.keys((s as any).sparrvol ?? {}).length > 0) {
    ...
    if (((s as any).sparrvol ?? 0)?.[String((s as any).idx ?? 0)] <= 0) {
      ...
      if (((s as any).sparrvol ?? 0)?.[String((s as any).idx ?? 0)] <= 0) {
        if (!(s as any).cumloc) (s as any).cumloc = {}; (s as any).cumloc[String((s as any).temp_cum_manage_i ?? 0)] = 0;
        if (!(s as any).cumvol) (s as any).cumvol = {}; (s as any).cumvol[String((s as any).idx ?? 0)] = 0;
      } else {
        if (!(s as any).cumloc) (s as any).cumloc = {}; (s as any).cumloc[String((s as any).temp_cum_manage_i ?? 0)] = 1;
        if (!(s as any).cumvol) (s as any).cumvol = {}; (s as any).cumvol[String((s as any).idx ?? 0)] = ((s as any).cumvol[String((s as any).idx ?? 0)] ?? 0) + (((s as any).sparrvol ?? 0)?.[String((s as any).idx ?? 0)]);
      }
    }
    (s as any).sexvolume = 0;
    (s as any).cumnostd = 0;
    ...
    if (((s as any).cumsumvag ?? 0) <= 0) {
      (s as any).cumsumvag = 0;
      if (!(s as any).cumvol) (s as any).cumvol = {}; (s as any).cumvol[0] = 0;
      if (!(s as any).cumloc) (s as any).cumloc = {}; (s as any).cumloc[0] = 0;
    }
    if (((s as any).cumsumass ?? 0) <= 0) {
      (s as any).cumsumass = 0;
      if (!(s as any).cumvol) (s as any).cumvol = {}; (s as any).cumvol[3] = 0;
      if (!(s as any).cumloc) (s as any).cumloc = {}; (s as any).cumloc[3] = 0;
    }
    (s as any).temp_cum_manage_i = 0;
...
function enterCumDecayVagina(s: GameState, scene: SceneBuilder): void {
  ...
  if ((!((s as any).succubusflag ?? 0))) {
    (s as any).cumamount = (((s as any).totminut ?? 0)-((s as any).cumdectime ?? 0))/15 * Math.max(Math.floor(Math.random() * 2) + 0, (Math.floor(Math.random() * (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/30 - ((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/60 + 1)) + (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/60)) + (Math.floor(Math.random() * (0, ((s as any).inSleep ?? 0)*(Math.floor(Math.random() * 3) + 1) + 1))) + ((s as any).isprok ?? 0)*(Math.floor(Math.random() * 6) + 5) + (Math.floor(Math.random() * ((Math.floor(Math.random() * (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/30 - ((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/60 + 1)) + (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/60)) - 0 + 1)) + (0)) + (Math.floor(Math.random() * ((Math.floor(Math.random() * 3) + 1) - 0 + 1)) + (0)));
  ...
  if (((s as any).sparrvol ?? 0)[((s as any).locArgs?.[1] ?? 0)] > 0) {
    ...
    if (qspFunc(s, 'cum_manage', 'check_inner_overflow', 0) === 1  ||  ((s as any).locArgs?.[2] ?? 0) / (Math.floor(Math.random() * 2) + 2) > ((s as any).sparrvol ?? 0)[((s as any).locArgs?.[1] ?? 0)]) {
      (s as any).cumamount = Math.min(((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]*3/2, (((s as any).totminut ?? 0)-((s as any).cumdectime ?? 0))/15 * Math.max(Math.floor(Math.random() * 3) + 1, (Math.floor(Math.random() * (((s as any).vgape ?? 0)*40 - ((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]] / Math.max(1, ((s as any).pcs_vag ?? 0)) + 1)) + (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]] / Math.max(1, ((s as any).pcs_vag ?? 0)))) - ((s as any).inSleep ?? 0)*(Math.floor(Math.random() * 4) + 2) + Math.max(1, ((s as any).pcs_vag ?? 0))) + ((s as any).cumforced ?? 0) / (Math.floor(Math.random() * 6) + 5));
      // TODO-QSP: sparrvol[ARGS[1]] -= cumamount & cumsumvag -= cumamount
      if (!(s as any).cumvol) (s as any).cumvol = {}; (s as any).cumvol[0] = ((s as any).cumvol[0] ?? 0) - (((s as any).cumamount ?? 0));
...
function enterCumDecayAnus(s: GameState, scene: SceneBuilder): void {
  ...
  if ((!((s as any).succubusflag ?? 0))) {
    (s as any).cumamount = (((s as any).totminut ?? 0)-((s as any).cumdectime ?? 0))/15 * Math.max(Math.floor(Math.random() * 3) + 0, (Math.floor(Math.random() * (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/20 - ((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/40 + 1)) + (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/40)) + (Math.floor(Math.random() * (0, ((s as any).inSleep ?? 0)*(Math.floor(Math.random() * 4) + 3) + 1))) + (Math.floor(Math.random() * ((Math.floor(Math.random() * (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/20 - ((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/40 + 1)) + (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/40)) - 0 + 1)) + (0)));
    // TODO-QSP: sparrvol[ARGS[1]] -= cumamount
  }
  if (((s as any).sparrvol ?? 0)[((s as any).locArgs?.[1] ?? 0)] > 0) {
    ...
    if (qspFunc(s, 'cum_manage', 'check_inner_overflow', 3) === 1  ||  ((s as any).locArgs?.[2] ?? 0) / (Math.floor(Math.random() * 3) + 2) > ((s as any).sparrvol ?? 0)[((s as any).locArgs?.[1] ?? 0)]) {
      ...
      if (!(s as any).cumvol) (s as any).cumvol = {}; (s as any).cumvol[3] = ((s as any).cumvol[3] ?? 0) - (((s as any).cumamount ?? 0));
...
function enterCumDecayLabia(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pantyworntype ?? 0) !== 'none'  ||  ((s as any).PCloPanties ?? 0) === 1) {
    (s as any).sexvolume = (Math.floor(Math.random() * (qspUntranslated(s, "sparrvol[ARGS[1]]", { location: "cum_manage" }) - ((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/2 + 1)) + (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]]/2)) - ((s as any).isprokp ?? 0) * (Math.floor(Math.random() * 16) + 15);
    if (((s as any).sexvolume ?? 0) > 0) {
    ...
    if (((s as any).PCloPants ?? 0) > 0) {
      (s as any).sexvolume = (Math.floor(Math.random() * (qspUntranslated(s, "sparrvol[ARGS[1]]", { location: "cum_manage" }) - ((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]] / 2 + 1)) + (((s as any).sparrvol ?? 0)[((s as any).ARGS ?? 0)[1]] / 2));
      if (((s as any).sexvolume ?? 0) > 0) {
        (s as any).spafinloc = 6;
        (s as any).sexunaware = (((Math.floor(Math.random() * 5) + 0) === 1  ||  ((s as any).sparridt ?? 0)[((s as any).locArgs?.[1] ?? 0)] === -2) ? (1) : (0));
        (s as any).sexspecpot = (-1);

...
function enterComputer(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locat ?? 0)?.['A144'] === 2  &&  ((s as any).anushkaQW ?? 0)?.['computer_use'] === 0) {
    ...
    scene.actions([
      { label: 'Thanks', goto: ['anush_bedroom_city', 'anushroom'] },
    ]);
  } },
        ]);
      }
    ...
    if (((s as any).anushkaQW ?? 0)?.['computer_use'] > 0  &&  ((s as any).locat ?? 0)?.['A144'] === 2) {
    ...
    scene.actions([
      ...
      if (((s as any).anushkaQW ?? 0)?.['computer_use'] > 0  &&  ((s as any).locat ?? 0)?.['A144'] !== 2) {
        ...
        scene.actions([
          { label: 'Turn the computer off', goto: ['anush_bedroom_city', 'anushroom'] },
    ...
    scene.actions([
      { label: 'Turn the computer off', goto: ['anush_bedroom_city', 'anushroom'] },
        ...
        scene.actions([
          { label: 'Return', goto: ['anush_bedroom_city', 'anushroom'] },
        ]);
      }
    }
  }
...
function enterGuitar(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locat ?? 0)?.['A144'] === 2) {
    ...
    scene.actions([
      { label: 'Wait for her', goto: ['anush_bedroom_city', 'nush_guitar'] },
    ]);
  } },
      ]);
    } else {
      if (((s as any).anushkaQW ?? 0)?.['guitar_play'] >= 1) {
        if (((s as any).instrmusic_lvl ?? 0) < 75) {
          scene.actions([
            { label: 'Would you teach me how to play?', goto: ['anush_bedroom_city', 'nush_guitar_teach'] },
          ]);
        }
        scene.actions([
    ...
    if (((s as any).ml_guitar ?? 0)?.['hasguitar'] === 1  &&  (((s as any).ml_guitar ?? 0)?.['carried'] === 1  ||  ((s as any).ml_guitar ?? 0)?.['location'] === ((s as any).loc ?? 0))) {
      scene.actions([
        { label: 'Can we play together?', goto: ['anush_bedroom_city', 'nush_guitar_play_together'] },
      ]);
    }
    scene.actions([
      { label: 'Look at something else', goto: ['anush_bedroom_city', 'anushroom'] },
    ...
    scene.actions([
      { label: 'Look at something else', goto: ['anush_bedroom_city', 'anushroom'] },
      { label: 'Keep checking out the guitars', goto: ['anush_bedroom_city', 'guitar'] },
    ]);
  } },
    ...
    scene.actions([
      { label: 'Put the guitar back', goto: ['anush_bedroom_city', 'anushroom'] },
    ]);
  } },
      ]);
    }
    ...
    if (((s as any).instrmusic_lvl ?? 0) < 20) {
      ...
      if (((s as any).instrmusic_lvl ?? 0) < 40) {
        ...
        if (((s as any).instrmusic_lvl ?? 0) < 60) {
...
function enterBed(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locat ?? 0)?.['A144'] === 2) {
    ...
    scene.actions([
      { label: 'Get out of the bed', goto: ['anush_bedroom_city', 'anushroom'] },
      { label: 'Chat', goto: ['anushkachat_city', 'chat'] },
    ]);
  } else {
    scene.img('images/locations/pavlovsk/resident/apartment/anushapt/anushroom.jpg');
...
function enterNushGuitar(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).anushkaQW ?? 0)?.['guitar_day'] === ((s as any).daystart ?? 0)) {
    ...
    if (((s as any).anushkaQW ?? 0)?.['guitar_play'] === 0) {
      ...
      scene.text('You smile at her. "So, that\'s your dad\'s favorite song? He taught you?"');
      ...
      scene.actions([
        { label: 'Continue', goto: ['anush_bedroom_city', 'anushroom'] },
      ]);
    } else {
      if (((s as any).anushkaQW ?? 0)?.['guitar_play'] === 1) {
        if (((s as any).sound_settings ?? 0)?.['music_off'] === 0) {
        ...
        if (((s as any).anushkaQW ?? 0)?.['guitar_play'] === 2) {
          ...
          scene.actions([
            { label: 'Say nothing as she puts the guitar back', goto: ['anush_bedroom_city', 'anushroom'] },
    ...
    scene.actions([
      { label: 'Let it go', goto: ['anush_bedroom_city', 'anushroom'] },
...
function enterNushGuitarTeach(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).anushkaQW ?? 0)?.['knows_guitar'] === 1) {
    ...
    if (((s as any).instrmusic_lvl ?? 0) < 20) {
      ...
      scene.actions([
        { label: 'Get a lesson', goto: ['anush_bedroom_city', 'guitar_lesson'] },
      ]);
    } else {
      if (((s as any).instrmusic_lvl ?? 0) < 40) {
...
function enterGuitarLesson(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).instrmusic_lvl ?? 0) < 20) {
    qspCall(s, 'exp_gain', 'instrmusic', Math.floor(Math.random() * 3) + 2);
    ...
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Get off the bed', goto: ['anush_bedroom_city', 'anushroom'] },
      { label: 'Chat to her', goto: ['anushkachat_city', 'chat'] },
    ]);
  } else {
    if (((s as any).instrmusic_lvl ?? 0) < 40) {
      qspCall(s, 'exp_gain', 'instrmusic', Math.floor(Math.random() * 3) + 3);
      ...
      qspCall(s, 'exp_gain', 'instrmusic', Math.floor(Math.random() * 3) + 4);
  ...
  if (((s as any).instrmusic_lvl ?? 0) < 20) {
    ...
    if (((s as any).instrmusic_lvl ?? 0) < 40) {
      ...
      if (((s as any).instrmusic_lvl ?? 0) < 60) {
        ...
        if (((s as any).instrmusic_lvl ?? 0) < 80) {
          (s as any).minut = ((s as any).minut ?? 0) + 30;
          qspCall(s, 'exp_gain', 'instrmusic', Math.floor(Math.random() * 3) + 3);

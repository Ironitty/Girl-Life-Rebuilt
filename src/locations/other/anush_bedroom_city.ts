...
function enterComputer(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locat ?? 0)?.['A144'] === 2  &&  ((s as any).anushkaQW ?? 0)?.['computer_use'] === 0) {
    ((s as any).anushkaQW ?? {})['computer_use'] = 1;
    scene.text('<center><b>Anushka\'s Room</b></center>');
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Agree to watch porn [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
...
function enterAgreeporn(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    scene.actions([
      { label: 'Masturbate as well [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
    ]);
  } else {
  ...
  if (((s as any).locat ?? 0)?.['A144'] === 2) {
    ...
    if (((s as any).instrmusic_lvl ?? 0) < 20) {
      ...
      if (((s as any).instrmusic_lvl ?? 0) < 40) {
        ...
        scene.text(`${((s as any).OpenInnerThought ?? 0)}"Maybe Anushka will be willing to help me out and teach me how to play?"${((s as any).CloseInnerThought ?? 0)} you muse as you place the instrument back on its stand.`);
        scene.actions([
          { label: 'Put the guitar back', goto: ['anush_bedroom_city', 'anushroom'] },
        ]);
      } else {
        if (((s as any).instrmusic_lvl ?? 0) < 60) {
          ...
          if (((s as any).ml_guitar ?? 0)?.['hasguitar'] >= 1) {
            ...
            scene.text(`${((s as any).OpenInnerThought ?? 0)}"Maybe I should come over with my guitar someday and see if Nush wants to play together?"${((s as any).CloseInnerThought ?? 0)} you muse as you place the instrument back on its stand.`);
          }
          scene.actions([
            { label: 'Put the guitar back', goto: ['anush_bedroom_city', 'anushroom'] },
          ]);
...
function enterNushGuitar(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).anushkaQW ?? 0)?.['guitar_day'] === ((s as any).daystart ?? 0)) {
    ...
    ((s as any).anushkaQW ?? {})['guitar_day'] = ((s as any).daystart ?? 0);
    ...
    if (((s as any).anushkaQW ?? 0)?.['guitar_play'] === 0) {
      ...
      ((s as any).anushkaQW ?? {})['guitar_play'] = (((s as any).anushkaQW ?? {})['guitar_play'] ?? 0) + (1);
      qspCall(s, 'stat', '');
...
function enterGuitarLesson(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 30;
  ((s as any).anushkaQW ?? {})['knows_guitar'] = 1;
    ...
    if (((s as any).instrmusic_lvl ?? 0) < 40) {
      ...
      if (((s as any).instrmusic_lvl ?? 0) < 60) {
        ...
        if (((s as any).instrmusic_lvl ?? 0) < 80) {
          ...
          scene.text(`You don't make any mistakes and don't have any trouble keeping up with her. In fact, you feel confident that you outplayed her. You play together for about an hour before she stops. "Damn ${((s as any).pcs_nickname ?? 0)}, I think you're better than I am!" she says with a smile.`);

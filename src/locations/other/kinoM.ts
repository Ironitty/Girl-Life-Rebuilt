...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You go to the cinema with ${((s as any).npcdesc ?? 0)}, who buys two tickets for the back row.`);
  // TODO-QSP: dynamic text: While you wait for the movie to start, <<$npcdesc>> tells you an anecdote as he ...
  scene.text(`While you wait for the movie to start, ${((s as any).npcdesc ?? 0)} tells you an anecdote as he buys popcorn and drinks.<br>`);
  qspCall(s, 'anekdot', '');
...
function enterA(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You and ${((s as any).npcdesc ?? 0)} quickly find your seats and ${((s as any).npcdesc ?? 0)} puts the big cup of popcorn on your lap.`);
  if (((s as any).npc_rough ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    scene.actions([
...
function enterSex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You reach over and undo his pants, opening his fly and pulling the front of his boxers just far enough down for his dick to spring free - he was already rock-hard. Looking around to make sure no one is watching, ${((s as any).npcdesc ?? 0)} takes out a condom and puts it on his penis; while he does that, you adjust your clothes so that you can pull your panties down to allow access to your pussy. With a final look around you lift up slightly and slide across his lap, reaching between your legs to take his dick in your hand and guide it inside your moist cunt. You bite your lip as his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock enters your pussy, to keep from moaning out loud. Then you begin to slowly move, sneakily fucking your lover in the dark theatre behind the rest of the audience.`);
...
function enterHj(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: You reach over and undo his pants, opening the fly and pulling the front of his ...
  scene.text(`You reach over and undo his pants, opening the fly and pulling the front of his underwear down just enough. His dick springs free, already rock-hard. You look around to make sure no one is watching, while ${((s as any).npcdesc ?? 0)} takes out a condom and puts it on his penis. You begin to stroke his cock while watching the movie.`);

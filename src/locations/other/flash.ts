          ...
          if (((s as any).locArgs?.[1] ?? 0) === 'butt'  ||  ((s as any).locArgs?.[1] ?? 0) === 'butt_plug') {
            ...
            if (((s as any).locArgs?.[1] ?? 0) === 'pussy') {
              ...
              if (((s as any).locArgs?.[1] ?? 0) === 'full') {
                ...
                if (((s as any).locArgs?.[1] ?? 0) === ''  ||  ((s as any).locArgs?.[1] ?? 0) === 'any') {
...
function enterGetImage(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_ind_bra'] = 3;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_ind_tits'] = 12;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_ind_panty'] = 4;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_ind_pantyrear'] = 12;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_ind_pussy'] = 8;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_ind_pussy_hairy'] = 9;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_ind_butt'] = 7;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_ind_butt_plug'] = 0;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_ind_full'] = 5;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_ind_full_hairy'] = 7;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_out_bra'] = 4;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_out_tits'] = 20;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_out_panty'] = 18;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_out_pantyrear'] = 8;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_out_pussy'] = 19;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_out_pussy_hairy'] = 9;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_out_butt'] = 9;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_out_butt_plug'] = 8;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_out_full'] = 13;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['dress_out_full_hairy'] = 11;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_ind_bra'] = 6;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_ind_tits'] = 19;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_ind_panty'] = 1;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_ind_pantyrear'] = 3;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_ind_pussy'] = 4;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_ind_pussy_hairy'] = 3;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_ind_butt'] = 6;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_ind_butt_plug'] = 0;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_ind_full'] = 1;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_ind_full_hairy'] = 1;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_out_bra'] = 5;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_out_tits'] = 19;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_out_panty'] = 6;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_out_pantyrear'] = 10;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_out_pussy'] = 11;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_out_pussy_hairy'] = 8;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_out_butt'] = 19;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_out_butt_plug'] = 6;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_out_full'] = 9;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['pants_out_full_hairy'] = 6;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['image'] = 'images/pc/activities/flashing/';
  if (((s as any).PCloSkirt ?? 0) > 0) {
    // TODO-QSP: $temp_id_text += 'dress_'
    if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['image'] = ((s as any).flashVars['image'] ?? 0) + ('dress/');
  } else {
    // TODO-QSP: $temp_id_text += 'pants_'
    if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['image'] = ((s as any).flashVars['image'] ?? 0) + ('pants/');
  }
  if (((s as any).locArgs?.[2] ?? 0) === 'inside'  ||  ((s as any).locArgs?.[2] ?? 0) === 'indoors') {
    // TODO-QSP: $temp_id_text += 'ind_'
    if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['image'] = ((s as any).flashVars['image'] ?? 0) + ('inside/');
    if (((s as any).locArgs?.[1] ?? 0) === 'butt_plug') {
      if (!(s as any).ARGS) (s as any).ARGS = {}; (s as any).ARGS[1] = 'butt';
    }
  } else {
    // TODO-QSP: $temp_id_text += 'out_'
    if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['image'] = ((s as any).flashVars['image'] ?? 0) + ('outside/');
  }
  // TODO-QSP: $temp_id_text += $ARGS[1]
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['image'] = ((s as any).flashVars['image'] ?? 0) + (((s as any).locArgs?.[1] ?? 0));
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['image'] = ((s as any).flashVars['image'] ?? 0) + ('/');
  if ((((s as any).locArgs?.[1] ?? 0) === 'pussy'  ||  ((s as any).locArgs?.[1] ?? 0) === 'full')  &&  ((s as any).pcs_pubes ?? 0) > 20) {
    // TODO-QSP: $temp_id_text += '_hairy'
    if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['image'] = ((s as any).flashVars['image'] ?? 0) + ('hairy');
  }
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['rand'] = 0;
  if (!(s as any).flashVars) (s as any).flashVars = {}; (s as any).flashVars['image'] = ((s as any).flashVars['image'] ?? 0) + (String(((s as any).flashVars ?? 0)?.['rand']) + '.jpg');
  // TODO-QSP: end
  scene.build();
}
...
function enterExhibitionism(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'tits') {
    ...
    if ((String(';panties;pantyrear;butt;butt_plug').indexOf(String(';\' + $ARGS[1] + \';'))) + 1) {
      ...
      if (((s as any).locArgs?.[1] ?? 0) === 'pussy'  ||  ((s as any).locArgs?.[1] ?? 0) === 'full') {
        if (!(s as any).ARGS) (s as any).ARGS = {}; (s as any).ARGS[1] = 3;
      }
    }
  }
  ...
  if (((s as any).locArgs?.[3] ?? 0) < 0) {
    if (!(s as any).ARGS) (s as any).ARGS = {}; (s as any).ARGS[3] = -((s as any).ARGS ?? 0)[3];
  }
  if ((!((s as any).locArgs?.[3] ?? 0))) {
    if (!(s as any).ARGS) (s as any).ARGS = {}; (s as any).ARGS[3] = 1;
  }
  if (!(s as any).temp_rand) (s as any).temp_rand = {}; (s as any).temp_rand[1] = 1 + ((((s as any).ARGS ?? 0)[3] - 1) / 5);
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 1) {
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 2) {
      if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['exhibitionist_exp'] = ((s as any).trait_vars['exhibitionist_exp'] ?? 0) + (2);
      if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 1) {
        (s as any).pcs_horny = ((s as any).pcs_horny ?? 0) + (10);
      }
      if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 2) {
      ...
      if (((s as any).locArgs?.[1] ?? 0) === 3) {
        if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['exhibitionist_exp'] = ((s as any).trait_vars['exhibitionist_exp'] ?? 0) + (3);
        if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 1) {
          (s as any).pcs_horny = ((s as any).pcs_horny ?? 0) + (15);
        }
        if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 2) {
        ...
        if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['exhibitionist_exp'] = ((s as any).trait_vars['exhibitionist_exp'] ?? 0) + (4);
        if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 1) {
          (s as any).pcs_horny = ((s as any).pcs_horny ?? 0) + (20);
        }
        if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 2) {
...
function enterParkDoFlash(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'bra'  ||  ((s as any).locArgs?.[1] ?? 0) === 'panties'  ||  ((s as any).locArgs?.[1] ?? 0) === 'pantyrear') {
    (s as any).flash_heat = ((s as any).flash_heat ?? 0) + (Math.min(90, ((s as any).flash_heat ?? 0) + 8));
  } else {
    if (((s as any).locArgs?.[1] ?? 0) === 'tits'  ||  ((s as any).locArgs?.[1] ?? 0) === 'butt') {
...
function enterParkBadScenario(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'comment') {
  } else {
    if (((s as any).locArgs?.[1] ?? 0) === 'grope') {
    } else {
      if (((s as any).locArgs?.[1] ?? 0) === 'police') {
      } else {
        if (((s as any).locArgs?.[1] ?? 0) === 'rapist') {
        } else {
          if (((s as any).locArgs?.[1] ?? 0) === 'gangrape') {
          }
        }
      }
    }

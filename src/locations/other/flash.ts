...
function enterGetImage(s: GameState, scene: SceneBuilder): void {
  ((s as any).flashVars ?? {})['dress_ind_bra'] = 3;
  ((s as any).flashVars ?? {})['dress_ind_tits'] = 12;
  ((s as any).flashVars ?? {})['dress_ind_panty'] = 4;
  ((s as any).flashVars ?? {})['dress_ind_pantyrear'] = 12;
  ((s as any).flashVars ?? {})['dress_ind_pussy'] = 8;
  ((s as any).flashVars ?? {})['dress_ind_pussy_hairy'] = 9;
  ((s as any).flashVars ?? {})['dress_ind_butt'] = 7;
  ((s as any).flashVars ?? {})['dress_ind_butt_plug'] = 0;
  ((s as any).flashVars ?? {})['dress_ind_full'] = 5;
  ((s as any).flashVars ?? {})['dress_ind_full_hairy'] = 7;
  ((s as any).flashVars ?? {})['dress_out_bra'] = 4;
  ((s as any).flashVars ?? {})['dress_out_tits'] = 20;
  ((s as any).flashVars ?? {})['dress_out_panty'] = 18;
  ((s as any).flashVars ?? {})['dress_out_pantyrear'] = 8;
  ((s as any).flashVars ?? {})['dress_out_pussy'] = 19;
  ((s as any).flashVars ?? {})['dress_out_pussy_hairy'] = 9;
  ((s as any).flashVars ?? {})['dress_out_butt'] = 9;
  ((s as any).flashVars ?? {})['dress_out_butt_plug'] = 8;
  ((s as any).flashVars ?? {})['dress_out_full'] = 13;
  ((s as any).flashVars ?? {})['dress_out_full_hairy'] = 11;
  ((s as any).flashVars ?? {})['pants_ind_bra'] = 6;
  ((s as any).flashVars ?? {})['pants_ind_tits'] = 19;
  ((s as any).flashVars ?? {})['pants_ind_panty'] = 1;
  ((s as any).flashVars ?? {})['pants_ind_pantyrear'] = 3;
  ((s as any).flashVars ?? {})['pants_ind_pussy'] = 4;
  ((s as any).flashVars ?? {})['pants_ind_pussy_hairy'] = 3;
  ((s as any).flashVars ?? {})['pants_ind_butt'] = 6;
  ((s as any).flashVars ?? {})['pants_ind_butt_plug'] = 0;
  ((s as any).flashVars ?? {})['pants_ind_full'] = 1;
  ((s as any).flashVars ?? {})['pants_ind_full_hairy'] = 1;
  ((s as any).flashVars ?? {})['pants_out_bra'] = 5;
  ((s as any).flashVars ?? {})['pants_out_tits'] = 19;
  ((s as any).flashVars ?? {})['pants_out_panty'] = 6;
  ((s as any).flashVars ?? {})['pants_out_pantyrear'] = 10;
  ((s as any).flashVars ?? {})['pants_out_pussy'] = 11;
  ((s as any).flashVars ?? {})['pants_out_pussy_hairy'] = 8;
  ((s as any).flashVars ?? {})['pants_out_butt'] = 19;
  ((s as any).flashVars ?? {})['pants_out_butt_plug'] = 6;
  ((s as any).flashVars ?? {})['pants_out_full'] = 9;
  ((s as any).flashVars ?? {})['pants_out_full_hairy'] = 6;
  ((s as any).flashVars ?? {})['image'] = 'images/pc/activities/flashing/';
  if (((s as any).PCloSkirt ?? 0) > 0) {
    // TODO-QSP: $temp_id_text += 'dress_'
    ((s as any).flashVars ?? {})['image'] = (((s as any).flashVars ?? {})['image'] ?? 0) + ('dress/');
  } else {
    // TODO-QSP: $temp_id_text += 'pants_'
    ((s as any).flashVars ?? {})['image'] = (((s as any).flashVars ?? {})['image'] ?? 0) + ('pants/');
  }
  if (((s as any).locArgs?.[2] ?? 0) === 'inside'  ||  ((s as any).locArgs?.[2] ?? 0) === 'indoors') {
    // TODO-QSP: $temp_id_text += 'ind_'
    ((s as any).flashVars ?? {})['image'] = (((s as any).flashVars ?? {})['image'] ?? 0) + ('inside/');
    if (((s as any).locArgs?.[1] ?? 0) === 'butt_plug') {
      ((s as any).ARGS ?? {})[1] = 'butt';
    }
  } else {
    // TODO-QSP: $temp_id_text += 'out_'
    ((s as any).flashVars ?? {})['image'] = (((s as any).flashVars ?? {})['image'] ?? 0) + ('outside/');
  }
  // TODO-QSP: $temp_id_text += $ARGS[1]
  ((s as any).flashVars ?? {})['image'] = (((s as any).flashVars ?? {})['image'] ?? 0) + (((s as any).locArgs?.[1] ?? 0));
  ((s as any).flashVars ?? {})['image'] = (((s as any).flashVars ?? {})['image'] ?? 0) + ('/');
  if ((((s as any).locArgs?.[1] ?? 0) === 'pussy'  ||  ((s as any).locArgs?.[1] ?? 0) === 'full')  &&  ((s as any).pcs_pubes ?? 0) > 20) {
    // TODO-QSP: $temp_id_text += '_hairy'
    ((s as any).flashVars ?? {})['image'] = (((s as any).flashVars ?? {})['image'] ?? 0) + ('hairy');
  }
  ((s as any).flashVars ?? {})['rand'] = 0;
  ((s as any).flashVars ?? {})['image'] = (((s as any).flashVars ?? {})['image'] ?? 0) + (String(((s as any).flashVars ?? 0)?.['rand']) + '.jpg');
  // TODO-QSP: end
  scene.build();
}
...
function enterBra(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).flashVars ?? {})['text_before'] = 'You glance around to see who is in the area, then you \' + iif(PCloSkirt > 0, \'pull down\', \'lift up\') + \' your top and expose your bra clad breasts to the world. Most people don\'t notice but a few do, some smile, others frown or shake their head in disgust.';
  ((s as any).flashVars ?? {})['text_after'] = 'You \' + iif(PCloSkirt > 0, \'lift your top back up\', \'pull your top back down\') + \', feeling the thrill of excitement running down your spine.';
...
function enterTits(s: GameState, scene: SceneBuilder): void {
  // TODO-QSP: gs 'flash', 'exhibitionism', 1, $ARGS[1], ARGS[2]
  ((s as any).flashVars ?? {})['text_before'] = 'You glance around to see who is in the area, then you \' + iif(PCloSkirt > 0, \'pull down\', \'lift up\') + \' your top and expose your bare breasts to the world. Most people don\'t notice but a few do, some smile, others frown or shake their head in disgust.';
  ((s as any).flashVars ?? {})['text_after'] = 'You \' + iif(PCloSkirt > 0, \'lift your top back up\', \'pull your top back down\') + \', feeling the thrill of excitement running down your spine.';
...
function enterPanties(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).flashVars ?? {})['text_before'] = 'You glance around to see who is in the area, then you \' + iif(PCloSkirt > 0, \'lift the front of your skirt\', \'pull down the front of your pants\') + \' to show off your panties. Most people don\'t notice but a few do, some smile, others frown or shake their head in disgust.';
...
function enterPantyrear(s: GameState, scene: SceneBuilder): void {
  // TODO-QSP: gs 'flash', 'exhibitionism', 2, $ARGS[1], ARGS[2]
  ((s as any).flashVars ?? {})['text_before'] = 'You glance around to see who is in the area, then you pull \' + iif(PCloSkirt > 0, \'up your skirt\', \'down the back of your pants\') + \' to show off your panty-clad butt. Most people don\'t notice but a few do, some smile, others frown or shake their head in disgust.';
  ((s as any).flashVars ?? {})['text_after'] = 'You \' + iif(PCloSkirt > 0, \'lower the skirt back in place\', \'pull your pants back up\') + \', feeling the thrill of excitement running down your spine.';
...
function enterFull(s: GameState, scene: SceneBuilder): void {
  // TODO-QSP: gs 'flash', 'exhibitionism', 3, $ARGS[1], ARGS[2]
  ((s as any).flashVars ?? {})['text_before'] = 'Making sure there are no children around and it\'s not too busy you \' + iif(PCloSkirt > 0, \'lift your skirt and top\', \'lower your pants and lift your top\') + \' to expose both your pussy and breasts. Most people who see you are shocked but some look at you admiringly.';
  ((s as any).flashVars ?? {})['text_after'] = 'You quickly cover up again enjoying a buzz of excitement.';
...
function enterExhibitionism(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[3] ?? 0) < 0) {
    ((s as any).ARGS ?? {})[3] = -((s as any).ARGS ?? 0)[3];
  }
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 1) {
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 2) {
      ((s as any).trait_vars ?? {})['exhibitionist_exp'] = (((s as any).trait_vars ?? {})['exhibitionist_exp'] ?? 0) + (2);
      if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 1) {
        (s as any).pcs_horny = ((s as any).pcs_horny ?? 0) + (10);
      }
      if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 2) {
      ...
      if (((s as any).locArgs?.[1] ?? 0) === 3) {
        ((s as any).trait_vars ?? {})['exhibitionist_exp'] = (((s as any).trait_vars ?? {})['exhibitionist_exp'] ?? 0) + (3);
        if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 1) {
          (s as any).pcs_horny = ((s as any).pcs_horny ?? 0) + (15);
        }
        if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 2) {
        ...
        ((s as any).trait_vars ?? {})['exhibitionist_exp'] = (((s as any).trait_vars ?? {})['exhibitionist_exp'] ?? 0) + (4);
        if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 1) {
          (s as any).pcs_horny = ((s as any).pcs_horny ?? 0) + (20);
        }
        if (((s as any).trait_vars ?? 0)?.['exhibitionist'] === 2) {

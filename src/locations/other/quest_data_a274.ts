...
function enterInit(s: GameState, scene: SceneBuilder): void {
  (s as any).loc_id = 'quest_data_a274';
...
function enterQuestBody(s: GameState, scene: SceneBuilder): void {
  if (String((s as any).locArgs?.[1] ?? '') === 'stage_1') {
    ...
    if (((s as any).mayaqw ?? 0)?.['path'] >= 1) {
      ...
      ((s as any).npc_quest = (s as any).npc_quest ?? {})['q_next'] = 'null';
    }
  ...
  if (String((s as any).locArgs?.[1] ?? '') === 'stage_2') {
    ...
    ((s as any).npc_quest = (s as any).npc_quest ?? {})['q_next'] = 'null';
    ((s as any).npc_quest = (s as any).npc_quest ?? {})['hints'] = 'Accept Maya\'s invitation.';
    if (((s as any).mayaqw ?? 0)?.['grave'] === 0) {
      ((s as any).npc_quest = (s as any).npc_quest ?? {})['body'] = 'Build Maya\'s trust: Continue to meet and talk to Maya.';
    } else {
      if (((s as any).mayaqw ?? 0)?.['grave'] === -1) {
        ((s as any).npc_quest = (s as any).npc_quest ?? {})['body'] = 'You spent the evening dedicated to studying ballet and ignored Maya\'s visit to your room.';
      } else {
        if (((s as any).mayaqw ?? 0)?.['grave'] === 1) {
          ((s as any).npc_quest = (s as any).npc_quest ?? {})['body'] = 'You ignored Maya\'s first knock when she came to visit.';
        } else {
          if (((s as any).mayaqw ?? 0)?.['grave'] === 3) {
            ((s as any).npc_quest = (s as any).npc_quest ?? {})['body'] = 'You invited Maya into your room and had a brief heartfelt conversation about her past.';
          } else {
            if (((s as any).mayaqw ?? 0)?.['grave'] === 4) {
              ((s as any).npc_quest = (s as any).npc_quest ?? {})['body'] = 'You went to graveyard and supported Maya in her grief, and had a hearftelt conversation with her afterwards in your room.';
            }
          }
        }
      }

...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: 5: 1850
  // TODO-QSP: 6: 1900
  // TODO-QSP: CloQuality ranges from 4 to 6, please avoid adding too many 6s.
...
export const _attributes_eroto_outfits: LocationDef = {
  name: '_attributes_eroto_outfits',
  region: 'other',
  enter: enter,
};

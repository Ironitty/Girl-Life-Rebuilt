...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hunterVars ?? 0)?.['SergeiLove'] === 0  ||  (((s as any).hunterVars ?? 0)?.['SergeiQw'] >= 10  &&  ((s as any).hunterVars ?? 0)?.['SergeiQw'] <= 50)) {
    ...
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['SergeiLove'] = 1;
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['SergeiQw'] = ((s as any).hunterVars['SergeiQw'] ?? 0) + (1);
    ...
    scene.img('images/pc/reactions/speak_to_the_hand.jpg');
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['SergeiQw'] = ((s as any).hunterVars['SergeiQw'] ?? 0) - (50);
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    if (((s as any).hunterVars ?? 0)?.['SergeiQw'] < 10) {
      ...
      if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['SergeiQw'] = ((s as any).hunterVars['SergeiQw'] ?? 0) - (10);
    } else {

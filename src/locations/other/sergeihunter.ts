...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hunterVars ?? 0)?.['SergeiLove'] === 0  ||  (((s as any).hunterVars ?? 0)?.['SergeiQw'] >= 10  &&  ((s as any).hunterVars ?? 0)?.['SergeiQw'] <= 50)) {
    ...
    qspCall(st, 'stat', '');
    if (((st as any).hunterVars ?? 0)?.['SergeiQw'] >= 30  &&  ((st as any).hunterVars ?? 0)?.['KnowSlut'] === 0  &&  ((st as any).pcs_apprnc ?? 0) >= 60) {
      scene.actions([
    ...
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['SergeiLove'] = 1;
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['SergeiQw'] = ((st as any).hunterVars['SergeiQw'] ?? 0) + (1);
    ...
    scene.img('images/pc/reactions/speak_to_the_hand.jpg');
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['SergeiQw'] = ((st as any).hunterVars['SergeiQw'] ?? 0) - (50);
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    (st as any).pcs_horny = ((st as any).pcs_horny ?? 0) + (10);
    ((st as any).hunterVars = (st as any).hunterVars ?? {})['SergeiQw'] = ((st as any).hunterVars['SergeiQw'] ?? 0) + (1);
    if (((st as any).hunterVars ?? 0)?.['IgorLove'] > 0  ||  ((st as any).hunterVars ?? 0)?.['AndreiLove'] > 0) {

  ...
  scene.actions([
    ...
    qspCall(st, 'sex_ev_pillow_talk2', 'small_talk');
                                ...
                                if (((st as any).npc_occupation ?? 0)?.[String((st as any).npcID ?? 0)] === 'programmer') {
                                  ...
                                  if (((st as any).npc_occupation ?? 0)?.[String((st as any).npcID ?? 0)] === 'criminal') {
    ...
    ((st as any).npc_criminal_discomfort = (st as any).npc_criminal_discomfort ?? {})[String((st as any).npcID ?? 0)] = 1;

...
function enterWhatsYourJob(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'cashier_supermarket') {
      ...
      scene.text(`"Nothing special, just a cashier at a generic supermarket," ${((s as any).npcdesc || '')} shrugs.`);
      ...
      if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'cashier_liquor') {
        ...
        scene.text(`"Cashier at a liquor store," ${((s as any).npcdesc || '')} shrugs. "Pretty boring."`);
        qspCall(s, 'sex_ev_pillow_talk2', 'small_talk');
      } else {
        if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'cashier_coffee') {
          ...
          scene.text(`"I work the register at a coffee shop," ${((s as any).npcdesc || '')} says. "It gets pretty hectic in there sometimes. Especially mornings."`);
          ...
          if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'barista') {
            ...
            scene.text(`"I work as a barista at a coffee shop," ${((s as any).npcdesc || '')} says. "It gets pretty hectic in there sometimes. Especially mornings.`);
            scene.text('"That\'s cool. Is the coffee any good?"');
            ...
            if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'fast_food') {
              ...
              scene.text(`"I flip burgers at this chain fast food joint," ${((s as any).npcdesc || '')} says. " Pay sucks and customers are all assholes. Service industry is shit."`);
            } else {
              if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'taxi_driver') {
                ...
                scene.text(`"I drive a cab in the city," ${((s as any).npcdesc || '')} says. "Not much, but it pays the bills.`);
                qspCall(s, 'sex_ev_pillow_talk2', 'small_talk');
              } else {
                if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'masseuse') {
                  ...
                  scene.text(`"I work as a masseuse in the city," ${((s as any).npcdesc || '')} says.`);
                  scene.actions([
    ...
    if (((s as any).npc_insecure ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      scene.text(`"What the fuck?" ${((s as any).npcdesc || '')} gives you a deep frown of disgust. "What do you think I am, some kind of faggot?"`);
    ...
    qspCall(s, 'sex_ev_pillow_talk2', 'small_talk');
                    ...
                    if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'factory') {
                      if (((s as any).region ?? 0) === 'pav') {
                        ...
                        scene.text(`"I work at the textile factory," ${((s as any).npcdesc || '')} says.`);
                      } else {
                        // TODO-QSP: dynamic text: "I work at the textile factory in the next town over," <<$npcdesc>> says.
                        scene.text(`"I work at the textile factory in the next town over," ${((s as any).npcdesc || '')} says.`);
                      ...
                      if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'bartender') {
                        ...
                        scene.text(`"Bartender," ${((s as any).npcdesc || '')} says.`);
                        ...
                        if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'mechanic') {
                          ...
                          scene.text(`"I work on cars," ${((s as any).npcdesc || '')} says.`);
                          ...
                          if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'line_cook') {
                            ...
                            scene.text(`"I work in a kitchen," ${((s as any).npcdesc || '')} says.`);
                            ...
                            if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'waiter') {
                              ...
                              scene.text(`"I wait tables," ${((s as any).npcdesc || '')} says.`);
                              qspCall(s, 'sex_ev_pillow_talk2', 'small_talk');
                            } else {
                              if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'personal_trainer') {
                                ...
                                scene.text(`"I work at a gym as a personal trainer," ${((s as any).npcdesc || '')} says.`);
                                scene.actions([
                                  { label: 'That\'s cool', handler: (st: GameState) => {
    ...
    qspCall(s, 'sex_ev_pillow_talk2', 'small_talk');
                                ...
                                if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'programmer') {
                                  ...
                                  scene.text(`"I work in tech," ${((s as any).npcdesc || '')} says. "Do the programming for an IT company in the city."`);
                                  ...
                                  if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'criminal') {
                                    if (((s as any).npc_criminal_open ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
                                      ((s as any).npc_criminal_known = (s as any).npc_criminal_known ?? {})[String((s as any).npcID ?? 0)] = 1;
                                      if (((s as any).npc_crime_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'drug_dealer') {
                                        ...
                                        scene.text(`"I sell drugs," ${((s as any).npcdesc || '')} says blatantly.`);
                                        scene.actions([
                                          { label: 'Uncomfortable', handler: (st: GameState) => {
    ((s as any).npc_criminal_discomfort = (s as any).npc_criminal_discomfort ?? {})[String((s as any).npcID ?? 0)] = 1;
    ...
    qspCall(s, 'sex_ev_pillow_talk2', 'small_talk');
                                        ...
                                        if (((s as any).npc_crime_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'enforcer') {
                                          ...
                                          scene.text(`"I'm an enforcer for a gang," ${((s as any).npcdesc || '')} says blatantly.`);
                                          scene.actions([
                                            { label: 'Uncomfortable', handler: (st: GameState) => {
    ((s as any).npc_criminal_discomfort = (s as any).npc_criminal_discomfort ?? {})[String((s as any).npcID ?? 0)] = 1;
    scene.text('"Oh." You gulp uncomfortably, unsure of what else to say.');
    ...
    qspCall(s, 'sex_ev_pillow_talk2', 'small_talk');
                                          ...
                                          scene.text(`"I steal things," ${((s as any).npcdesc || '')} says blatantly.`);
                                          scene.actions([
                                            { label: 'Uncomfortable', handler: (st: GameState) => {
    ((s as any).npc_criminal_discomfort = (s as any).npc_criminal_discomfort ?? {})[String((s as any).npcID ?? 0)] = 1;
    scene.text('"Oh." You gulp uncomfortably, unsure of what else to say.');
    ...
    qspCall(s, 'sex_ev_pillow_talk2', 'small_talk');
                                      ...
                                      if (((s as any).npc_crime_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'drug_dealer') {
                                        ...
                                        scene.text(`"I work in pharmaceuticals," ${((s as any).npcdesc || '')} says.`);
                                        if (((s as any).start_type ?? 0)?.['loc'] === 'sg') {
                                        ...
                                        if (((s as any).npc_crime_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'enforcer') {
                                          ...
                                          scene.text(`"I'm a sort of fixer," ${((s as any).npcdesc || '')} says.`);
                                          ...
                                          scene.text(`"I work in acquisitions and sales," ${((s as any).npcdesc || '')} says.`);
                                    ...
                                    if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'businessman') {
                                      ...
                                      scene.text(`"I run a company I founded," ${((s as any).npcdesc || '')} says casually.`);
                                      ...
                                      if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'lawyer') {
                                        ...
                                        scene.text(`"I'm the partner at a law firm here in the city," ${((s as any).npcdesc || '')} says.`);
                                        ...
                                        if (((s as any).npc_occupation ?? 0)?.[String((s as any).npcID ?? 0)] === 'investment_banker') {
                                          if (((s as any).sex_ev ?? 0)?.['loc'] !== 'pc_home') {
                                            ...
                                            scene.text(`"I work for one of the big banks here in the city," ${((s as any).npcdesc || '')} says.`);
                                            ...
                                            if (((s as any).sex_ev ?? 0)?.['loc'] === 'pc_home') {
                                              ...
                                              if (((s as any).sex_ev ?? 0)?.['loc'] === 'hotel_room') {
                                                if (((s as any).region ?? 0) === 'pav') {
                                                  ...
                                                  scene.text(`"I work for one of the big banks in the city," ${((s as any).npcdesc || '')} says.`);

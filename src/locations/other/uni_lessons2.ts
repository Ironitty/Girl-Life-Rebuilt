...
function enterGeneralEducation_102(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_teaching_studies_semester_2', 'general education 102');
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_2', 'general education 102', ((st as any).pcs_intel ?? 0));
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_2', 'general education 102', ((st as any).pcs_chrsm ?? 0));
    ...
    scene.text('Professor Kovalyov nods approvingly, happy to see his students and trying their best. He happily spends some extra time explaining the topic again, and answers any extra questions you might have. You feel smarter, thoroughly understanding today\'s lesson now.');
    scene.actions([
  ...
  scene.actions([
    ...
    if (((st as any).fame ?? 0)?.['city_slut'] >= 150  ||  ((st as any).fame ?? 0)?.['pav_slut'] >= 150) {
      ...
      if (((st as any).npc_rel ?? 0)?.['A14'] >= 60) {
        scene.text('You sit next to Katja and spend most of the class quietly talking with her. You often get shushed by your fellow students when you get a bit too loud.');
      } else {
        if (((st as any).npc_rel ?? 0)?.['A14'] <= 20) {
...
function enterTeachingMethods_102(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_teaching_studies_semester_2', 'teaching methods 102');
  qspCall(s, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
  qspCall(s, 'stat', '');
  scene.img(`images/locations/city/island/university/classroom/lecture${(Math.floor(Math.random() * 5) + 1)}.jpg`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_2', 'teaching methods 102', ((st as any).pcs_intel ?? 0));
    ((st as any).trait_vars = (st as any).trait_vars ?? {})['academic_lessons'] = ((st as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(st, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${(Math.floor(Math.random() * 4) + 1)}.jpg`);
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_2', 'teaching methods', ((st as any).pcs_intel ?? 0));
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
    ...
    scene.actions([
      ...
      { label: 'Wait for the end of the lesson', goto: ['uni_lessonsev1', 'teaching methods 102'] },
    ]);
  } },
    ]);
  }
  scene.actions([
    ...
    if (((st as any).fame ?? 0)?.['city_slut'] >= 150  ||  ((st as any).fame ?? 0)?.['pav_slut'] >= 150) {
      ...
      if (((st as any).npc_rel ?? 0)?.['A14'] >= 60) {
        scene.text('You sit next to Katja and spend most of the class quietly talking with each other. You often get shushed by your fellow students when you get a bit too loud.');
      } else {
        if (((st as any).npc_rel ?? 0)?.['A14'] <= 20) {
          scene.text('You sit next to Katja, but she dismisses all of your attempts to speak with her and spends the lesson ignoring you and paying attention to the class instead.');
        } else {
    ...
    if (((st as any).fame ?? 0)?.['city_slut'] >= 300) {
      ...
      if (((st as any).npc_rel ?? 0)?.['A242'] >= 60) {
        ...
        if (((st as any).npc_rel ?? 0)?.['A242'] <= 20) {
          scene.text('You sit next to Lebogang, he frowns as you sit down and then proceeds to ignore you. Despite how hard you try to talk to him he keeps ignoring you until you give up.');
        } else {
          scene.text('You sit next to Lebogang and start talking to him. He\'s more interested in the lesson than you, but slowly starts to respond to you as he takes notes.');
        }
      }
...
function enterPsychologyOfAStudent_101(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_teaching_studies_semester_2', 'psychology of a student 101');
  qspCall(s, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
  qspCall(s, 'stat', '');
  scene.img(`images/locations/city/island/university/classroom/lecture${(Math.floor(Math.random() * 5) + 1)}.jpg`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_2', 'psychology of a student 101', ((st as any).pcs_intel ?? 0));
    ((st as any).trait_vars = (st as any).trait_vars ?? {})['academic_lessons'] = ((st as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(st, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${(Math.floor(Math.random() * 4) + 1)}.jpg`);
    ...
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['uni_lessonsev1', 'psychology_of_a_student_101'] },
    ]);
  } },
      { label: 'Wait for the end of the lesson', goto: ['uni_lessonsev1', 'psychology_of_a_student_101'] },
    ]);
  ...
  scene.actions([
    { label: 'Don\'t pay attention', handler: (st: GameState) => {
    scene.img('images/locations/city/island/university/classroom/bored.jpg');
    scene.text('Professor Kovalchuk\'s lecture has fallen into a droning rhythm that has brought you, and most of your classmates, into something of a trance as you slowly approach the end of the class.');
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['uni_lessonsev1', 'psychology_of_a_student_101'] },
      { label: 'Draw dick in margin', handler: (st: GameState) => {
    scene.img('images/locations/city/island/university/classroom/bored.jpg');
...
function enterPatientCare_102(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_nursing_semester_2', 'patient care 102');
  qspCall(s, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'patient care 102', ((st as any).pcs_intel ?? 0));
    qspCall(st, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
    ((st as any).trait_vars = (st as any).trait_vars ?? {})['academic_lessons'] = ((st as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(st, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${(Math.floor(Math.random() * 4) + 1)}.jpg`);
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'patient care 102', ((st as any).pcs_chrsm ?? 0));
    qspCall(st, 'exp_gain', 'chrsm', (Math.floor(Math.random() * 2) + 1));
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
  ...
  scene.actions([
    ...
    if (((st as any).fame ?? 0)?.['city_slut'] >= 150) {
      ...
      if (((st as any).npc_rel ?? 0)?.['A267'] >= 60  &&  ((st as any).npc_rel ?? 0)?.['A268'] >= 60) {
        ...
        if (((st as any).npc_rel ?? 0)?.['A267'] <= 20  &&  ((st as any).npc_rel ?? 0)?.['A268'] <= 20) {
          scene.text('You sit next to Mia and Yana and try to talk to them, but they just ignore you and chat and giggle amongst themselves, trying to think of a prank they can pull on Ms Kudelina instead.');
        } else {
          if ((((st as any).npc_rel ?? 0)?.['A267'] > 20  &&  ((st as any).npc_rel ?? 0)?.['A267'] < 60)  &&  (((st as any).npc_rel ?? 0)?.['A268'] > 20  &&  ((st as any).npc_rel ?? 0)?.['A268'] < 60)) {
...
function enterAnatomyAndPhysiology_102(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_nursing_semester_2', 'anatomy and physiology 102');
  qspCall(s, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
  qspCall(s, 'exp_gain', 'medcn', 5);
  qspCall(s, 'stat', '');
  scene.img(`images/locations/city/island/university/classroom/lecture${(Math.floor(Math.random() * 5) + 1)}.jpg`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'anatomy and physiology 102', ((st as any).pcs_intel ?? 0));
    qspCall(st, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
    ((st as any).trait_vars = (st as any).trait_vars ?? {})['academic_lessons'] = ((st as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(st, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${(Math.floor(Math.random() * 4) + 1)}.jpg`);
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'anatomy and physiology 102', ((st as any).pcs_chrsm ?? 0));
    qspCall(st, 'exp_gain', 'chrsm', (Math.floor(Math.random() * 2) + 1));
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
...
function enterExaminationAndTreatment_102(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'grades', 'attend_class', 'uni_nursing_semester_2', 'examination and treatment 102');
  qspCall(s, 'exp_gain', 'intel', (Math.floor(Math.random() * 2) + 0), 'no_bonus');
  qspCall(s, 'exp_gain', 'medcn', 5);
  qspCall(s, 'stat', '');
  scene.img(`images/locations/city/island/university/classroom/lecture${(Math.floor(Math.random() * 5) + 1)}.jpg`);
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'examination and treatment 102', ((st as any).pcs_intel ?? 0));
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(st, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'examination and treatment 102', ((st as any).pcs_chrsm ?? 0));
    qspCall(st, 'exp_gain', 'chrsm', (Math.floor(Math.random() * 2) + 1));
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
  ...
  scene.actions([
    { label: 'Don\'t pay attention', handler: (st: GameState) => {
    scene.img('images/locations/city/island/university/classroom/bored.jpg');
    scene.text('As per usual, Professor Borisov\'s lecture is very dry and boring. You\'re having a hard time paying attention as he slowly describes things in painfully excessive detail.');
    scene.actions([
      { label: 'Wait for the end of the lesson', goto: ['uni_lessonsev1', 'examination_and_treatment'] },
    ]);
  } },
...
export const uni_lessons2: LocationDef = {
  name: 'uni_lessons2',

...
function enterGeneralEducation_102(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_2', 'general education 102', ((s as any).pcs_intel ?? 0));
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_2', 'general education 102', ((s as any).pcs_chrsm ?? 0));
...
function enterTeachingMethods_102(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_2', 'teaching methods 102', ((s as any).pcs_intel ?? 0));
    if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['academic_lessons'] = ((s as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${Math.floor(Math.random() * 4) + 1}.jpg`);
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_2', 'teaching methods', ((s as any).pcs_intel ?? 0));
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
...
function enterPsychologyOfAStudent_101(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_2', 'psychology of a student 101', ((s as any).pcs_intel ?? 0));
    if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['academic_lessons'] = ((s as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${Math.floor(Math.random() * 4) + 1}.jpg`);
...
function enterPatientCare_102(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'patient care 102', ((s as any).pcs_intel ?? 0));
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['academic_lessons'] = ((s as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${Math.floor(Math.random() * 4) + 1}.jpg`);
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'patient care 102', ((s as any).pcs_chrsm ?? 0));
    qspCall(s, 'exp_gain', 'chrsm', Math.floor(Math.random() * 2) + 1);
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
...
function enterAnatomyAndPhysiology_102(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'anatomy and physiology 102', ((s as any).pcs_intel ?? 0));
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    if (!(s as any).trait_vars) (s as any).trait_vars = {}; (s as any).trait_vars['academic_lessons'] = ((s as any).trait_vars['academic_lessons'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${Math.floor(Math.random() * 4) + 1}.jpg`);
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'anatomy and physiology 102', ((s as any).pcs_chrsm ?? 0));
    qspCall(s, 'exp_gain', 'chrsm', Math.floor(Math.random() * 2) + 1);
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
...
function enterExaminationAndTreatment_102(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'examination and treatment 102', ((s as any).pcs_intel ?? 0));
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_2', 'examination and treatment 102', ((s as any).pcs_chrsm ?? 0));
    qspCall(s, 'exp_gain', 'chrsm', Math.floor(Math.random() * 2) + 1);
    scene.img('images/locations/city/island/university/classroom/question1.jpg');

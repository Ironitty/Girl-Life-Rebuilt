...
function enterDefault2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).placerParameter ?? 0)?.['friend_index'] === 14) {
    ...
    ((s as any).katjaQW ?? {})['sex_in_the_park_comment'] = 3;
  ...
  scene.actions([
    ...
    if (((s as any).ciklkm ?? 0) > 0) {
      ...
      scene.text(`All of the guys want to fuck you or ${((s as any).ev_name ?? 0)} at least once. You see one of them impatiently stroking his cock, keeping it erect while he is waiting for the Gopnik that is currently fucking you to finish. There might be more beyond your vision range though, you're not quite sure.`);
    }
    // TODO-QSP: dynamic text: Once the Gopnik finishes, his friend quickly takes his place and offers you his ...
    scene.text(`Once the Gopnik finishes, his friend quickly takes his place and offers you his dick. You quietly close your fingers around it, and glance to your right to see how ${((s as any).ev_name ?? 0)} is holding up. She seems to be having a blast! One of the Gopniks is fucking her roughly from behind, while she's enthusiastically sucking another guy's cock.`);
    ...
    scene.text(`The guys are finally done with the two of you, and you feel a tad embarrassed when you look at ${((s as any).ev_name ?? 0)}. You can see she feels the same way, but at the same time… that was so hot! She loved getting treated like a piece of meat, and you certainly enjoyed watching her while they did the same to you. The two of you quickly get dressed and leave the house, exchanging glances.`);

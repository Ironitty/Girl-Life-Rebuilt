...
function enterGetEventColor(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_color_idx = undefined;
  return;
  scene.build();
}
...
function enterIsTodayBusyAtTimeslot(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_check_ts = undefined;
  (s as any).temp_week_start = undefined;
  (s as any).temp_days_from_monday = undefined;
  return;
  scene.build();
}
...
function enterRenderCalendar(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'calendar_render', 'render_header'));
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'calendar_render', 'render_allday_section'));
  ...
  do {
    (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'calendar_render', 'render_timeslot_row', ((s as any).temp_cal_ts ?? 0)));
    (s as any).temp_cal_ts = ((s as any).temp_cal_ts ?? 0) + (1);
    (s as any).result = ((s as any).result ?? 0) + ('</table></div>');
    (s as any).result = ((s as any).result ?? 0) + ('<center><small>❀ = Current timeslot, ⚘ = Busy timeslot today, Timeslot = 15 minute period.<br>Hatched area = Flexible arrival time. The calendar may shift flexible events to fit in as many as possible.</small></center>');
    (s as any).temp_cal_ts = undefined;
    (s as any).temp_cal_first_slot = undefined;
    (s as any).temp_rtr_ts = undefined;
    (s as any).temp_rtr_hours = undefined;
    (s as any).temp_rtr_minutes = undefined;
    (s as any).temp_rtr_d = undefined;
    (s as any).temp_current_ts = undefined;
    (s as any).temp_d = undefined;
    (s as any).temp_t = undefined;
    (s as any).temp_max_cols = undefined;
    (s as any).temp_event_count = undefined;
    (s as any).temp_column_filled = undefined;
    (s as any).temp_e = undefined;
    (s as any).temp_col = undefined;
    (s as any).temp_colspan = undefined;
    (s as any).temp_rowspan = undefined;
    (s as any).temp_c = undefined;
    (s as any).temp_scan_ts = undefined;
    (s as any).temp_scan_count = undefined;
    (s as any).temp_scan_e = undefined;
    (s as any).temp_scan_span = undefined;
    (s as any).temp_scan_end = undefined;
    (s as any).temp_scan_col = undefined;
    (s as any).temp_scan_colspan = undefined;
    (s as any).temp_event_id = undefined;
    (s as any).temp_title = undefined;
    (s as any).temp_location = undefined;
    (s as any).temp_desc = undefined;
    (s as any).temp_color = undefined;
    (s as any).temp_is_flex = undefined;
    (s as any).temp_window_slots = undefined;
    (s as any).temp_event_slots = undefined;
    (s as any).temp_window_height = undefined;
    (s as any).temp_event_height = undefined;
    (s as any).temp_window_start = undefined;
    (s as any).temp_window_end = undefined;
    (s as any).temp_window_start_hours = undefined;
    (s as any).temp_window_start_minutes = undefined;
    (s as any).temp_window_end_hours = undefined;
    (s as any).temp_window_end_minutes = undefined;
    (s as any).temp_window_time = undefined;
    return;
  } while (((s as any).temp_cal_ts ?? 0) < 96);
  scene.build();
}
...
function enterRenderHeader(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).result = ((s as any).result ?? 0) + ('<th style="width: 80px;">Time</th>');
  (s as any).result = ((s as any).result ?? 0) + ('<th style="width: 20px; text-align: center;">❀</th>');
  ...
  do {
    ...
    (s as any).result = ((s as any).result ?? 0) + ('<th style="width: 13%;' + ((s as any).temp_hdr_style ?? 0) + '" colspan="' + String(((s as any).temp_hdr_max_cols ?? 0)) + '">');
    (s as any).result = ((s as any).result ?? 0) + (((s as any).temp_hdr_day_name ?? 0) + '<br>' + ((s as any).temp_hdr_date_str ?? 0) + '</th>');
    (s as any).temp_hdr_d = ((s as any).temp_hdr_d ?? 0) + (1);
    (s as any).result = ((s as any).result ?? 0) + ('</tr>');
    (s as any).temp_hdr_first_slot = undefined;
    (s as any).temp_hdr_bg = undefined;
    (s as any).temp_hdr_d = undefined;
    (s as any).temp_hdr_day_date = undefined;
    (s as any).temp_hdr_day_name = undefined;
    (s as any).temp_hdr_month = undefined;
    (s as any).temp_hdr_day = undefined;
    (s as any).temp_hdr_month_name = undefined;
    (s as any).temp_hdr_suffix = undefined;
    (s as any).temp_hdr_date_str = undefined;
    (s as any).temp_hdr_max_cols = undefined;
    (s as any).temp_hdr_style = undefined;
    return;
  } while (((s as any).temp_hdr_d ?? 0) <= 7);
  scene.build();
}
...
function enterRenderAlldaySection(s: GameState, scene: SceneBuilder): void {
  ...
  if ((!((s as any).temp_ad_max_rows ?? 0))) {
    (s as any).temp_ad_max_rows = undefined;
    return;
  }
    ...
    do {
      ...
      if (((s as any).temp_ad_event_id ?? 0) !== '') {
        ...
        do {
          ...
          (s as any).result = ((s as any).result ?? 0) + ('<td class="allday-event" colspan="' + String(((s as any).temp_ad_html_colspan ?? 0)) + '" ');
          (s as any).result = ((s as any).result ?? 0) + ('style="background-color: rgb(' + ((s as any).temp_ad_color_rgb ?? 0) + '); text-align: center; vertical-align: middle;">');
          (s as any).result = ((s as any).result ?? 0) + ('<div class="event-title" style="word-wrap: break-word; overflow-wrap: break-word;">' + ((s as any).temp_ad_title ?? 0) + '</div>');
          (s as any).result = ((s as any).result ?? 0) + ('</td>');
          (s as any).temp_ad_d = ((s as any).temp_ad_d ?? 0) + ((((s as any).temp_ad_event_colspan ?? 0) - 1));
        } while (((s as any).temp_ad_span_day ?? 0) < ((s as any).temp_ad_d ?? 0) + ((s as any).temp_ad_event_colspan ?? 0));
      } else {
        if (((s as any).week_schedule ?? 0)['days=' + (((s as any).temp_ad_d ?? 0)) + ', allday=' + (((s as any).temp_ad_row ?? 0)) + ', continued'] === 1) {
          ...
          while (true) {
            ...
            if (((s as any).temp_ad_empty_colspan ?? 0) > 0) {
              (s as any).result = ((s as any).result ?? 0) + ('<td class="allday-empty" colspan="' + String(((s as any).temp_ad_empty_colspan ?? 0)) + '" style="background-color: ' + ((s as any).temp_ad_empty_bg ?? 0) + ';"></td>');
      ...
      (s as any).temp_ad_first_slot = undefined;
      (s as any).temp_ad_empty_bg = undefined;
      (s as any).temp_ad_max_rows = undefined;
      (s as any).temp_ad_row = undefined;
      (s as any).temp_ad_d = undefined;
      (s as any).temp_ad_event_id = undefined;
      (s as any).temp_ad_event_colspan = undefined;
      (s as any).temp_ad_html_colspan = undefined;
      (s as any).temp_ad_title = undefined;
      (s as any).temp_ad_color = undefined;
      (s as any).temp_ad_max_cols = undefined;
      (s as any).temp_ad_col = undefined;
      (s as any).temp_ad_span_day = undefined;
      (s as any).temp_ad_span_max_cols = undefined;
      (s as any).temp_ad_empty_colspan = undefined;
      (s as any).temp_ad_check_day = undefined;
      (s as any).temp_ad_check_id = undefined;
      (s as any).temp_ad_check_continued = undefined;
      (s as any).temp_ad_check_cols = undefined;
      (s as any).temp_ad_color_rgb = undefined;
      return;
    } while (((s as any).temp_ad_d ?? 0) <= 7);
  } while (((s as any).temp_ad_row ?? 0) < ((s as any).temp_ad_max_rows ?? 0));
  scene.build();
}
...
function enterGetFirstTimeslot(s: GameState, scene: SceneBuilder): void {
  ...
  do {
    ...
    do {
      ...
      (s as any).temp_gfs_first = undefined;
      (s as any).temp_gfs_d = undefined;
      (s as any).temp_gfs_t = undefined;
      (s as any).temp_gfs_count = undefined;
      (s as any).temp_gfs_event_hour = undefined;
      return;
    } while (((s as any).temp_gfs_t ?? 0) < 96);
  } while (((s as any).temp_gfs_d ?? 0) <= 7);
  scene.build();
}
...
function enterRenderTimeslotRow(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_rtr_ts ?? 0) % 4 === 0) {
    ...
    (s as any).result = ((s as any).result ?? 0) + ('<td class="time-cell" rowspan="4" style="' + ((s as any).temp_rtr_time_style ?? 0) + '">');
    (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'time', 'get_time_string', ((s as any).temp_rtr_hours ?? 0), 0, 0));
    (s as any).result = ((s as any).result ?? 0) + ('</td>');
  }
  ...
  if (((s as any).temp_is_current ?? 0) === 1) {
    ...
    (s as any).result = ((s as any).result ?? 0) + ('<td style="width: 20px; padding: 2px; border: 1; text-align: center; background-color: ' + (((s as any).theme_hex ?? 0)?.['neg']) + '; color: white; min-height: 1.2em; line-height: 1.2;">' + ((s as any).temp_indicator_char ?? 0) + '</td>');
  } else {
    ...
    (s as any).result = ((s as any).result ?? 0) + ('<td style="width: 20px; padding: 2px; border: 1; text-align: center; background-color: ' + ((s as any).temp_indicator_bg ?? 0) + '; min-height: 1.2em; line-height: 1.2;">' + ((s as any).temp_indicator_char ?? 0) + '</td>');
  }
  (s as any).temp_rtr_d = 1;
  do {
    (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'calendar_render', 'render_day_cell', ((s as any).temp_rtr_d ?? 0), ((s as any).temp_rtr_ts ?? 0)));
    (s as any).temp_rtr_d = ((s as any).temp_rtr_d ?? 0) + (1);
    (s as any).result = ((s as any).result ?? 0) + ('</tr>');
    return;
  } while (((s as any).temp_rtr_d ?? 0) <= 7);
  scene.build();
}
...
function enterRenderDayCell(s: GameState, scene: SceneBuilder): void {
  while (true) {
    ...
    (s as any).temp_column_filled = undefined;
    (s as any).temp_column_event_index = undefined;
        ...
        do {
          ...
          if ((!((s as any).temp_scan_hidden ?? 0))) {
            ...
            if (((s as any).temp_scan_end ?? 0) >= ((s as any).temp_t ?? 0)) {
              ...
              } while (((s as any).temp_c ?? 0) < ((s as any).temp_scan_col ?? 0) + ((s as any).temp_scan_colspan ?? 0));
            }
          }
          (s as any).temp_scan_e = ((s as any).temp_scan_e ?? 0) + (1);
        } while (((s as any).temp_scan_e ?? 0) < ((s as any).temp_scan_count ?? 0));
      }
  ...
  do {
      ...
      do {
        ...
        if ((!((s as any).temp_is_hidden ?? 0))) {
          ...
          do {
            ((s as any).temp_column_filled = (s as any).temp_column_filled ?? {})[String((s as any).temp_c ?? 0)] = 1;
            (s as any).temp_c = ((s as any).temp_c ?? 0) + (1);
          } while (((s as any).temp_c ?? 0) < ((s as any).temp_col ?? 0) + ((s as any).temp_colspan ?? 0));
        }
        (s as any).temp_e = ((s as any).temp_e ?? 0) + (1);
      } while (((s as any).temp_e ?? 0) < ((s as any).temp_event_count ?? 0));
    }
    if (((s as any).temp_max_cols ?? 0) > 1) {
      (s as any).temp_col = 0;
      do {
        if (((s as any).temp_column_filled ?? 0)?.[String((s as any).temp_col ?? 0)] === 1) {
          if (((s as any).temp_column_event_index ?? 0)?.[String((s as any).temp_col ?? 0)] >= 0) {
            ...
            (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'calendar_render', 'render_event_cell', ((s as any).temp_d ?? 0), ((s as any).temp_t ?? 0), ((s as any).temp_e ?? 0), ((s as any).temp_rowspan ?? 0), ((s as any).temp_colspan ?? 0)));
          ...
          do {
            ...
            (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'calendar_render', 'render_empty_cell', 1, ((s as any).temp_empty_colspan ?? 0), ((s as any).temp_t ?? 0), ((s as any).temp_d ?? 0)));
            (s as any).temp_col = ((s as any).temp_col ?? 0) + (((s as any).temp_empty_colspan ?? 0) - 1);
          } while (((s as any).temp_check_col ?? 0) < ((s as any).temp_max_cols ?? 0)  &&  ((s as any).temp_column_filled ?? 0)?.[String((s as any).temp_check_col ?? 0)] === 0);
        }
        (s as any).temp_col = ((s as any).temp_col ?? 0) + (1);
      } while (((s as any).temp_col ?? 0) < ((s as any).temp_max_cols ?? 0));
    } else {
      if (((s as any).temp_event_count ?? 0) > 0) {
        ...
        if ((!((s as any).temp_is_hidden ?? 0))) {
          ...
          (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'calendar_render', 'render_event_cell', ((s as any).temp_d ?? 0), ((s as any).temp_t ?? 0), 0, ((s as any).temp_rowspan ?? 0), 1));
        } else {
          if (((s as any).temp_column_filled ?? 0)[0] === 0) {
            (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'calendar_render', 'render_empty_cell', 1, 1, ((s as any).temp_t ?? 0), ((s as any).temp_d ?? 0)));
          }
        }
      } else {
        if (((s as any).temp_column_filled ?? 0)[0] === 0) {
    ...
    return;
  } while (((s as any).temp_init_col ?? 0) < ((s as any).temp_max_cols ?? 0));
  scene.build();
}
...
function enterRenderEventCell(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_is_flex ?? 0) === 1) {
    ...
    (s as any).result = ((s as any).result ?? 0) + ('class="event-cell" style="padding: 0 !important; position: relative;">');
    (s as any).result = ((s as any).result ?? 0) + ('<div class="event-window" style="position: absolute; top: 0; left: 0; right: 0; height: ' + ((s as any).temp_window_percent ?? 0) + '%; ');
    (s as any).result = ((s as any).result ?? 0) + ('margin: 0; padding: 0; box-sizing: border-box; overflow: hidden; ');
    (s as any).result = ((s as any).result ?? 0) + ('display: flex; flex-direction: column; justify-content: center; ');
    (s as any).result = ((s as any).result ?? 0) + ('background: repeating-linear-gradient(45deg, rgba(' + ((s as any).temp_color_rgb ?? 0) + ', 0.9), rgba(' + ((s as any).temp_color_rgb ?? 0) + ', 0.9) 10px, ');
    (s as any).result = ((s as any).result ?? 0) + ('rgba(' + ((s as any).temp_color_rgb ?? 0) + ', 0.7) 10px, rgba(' + ((s as any).temp_color_rgb ?? 0) + ', 0.7) 20px);">');
    if (((s as any).temp_window_slots ?? 0) >= 6) {
      ...
      (s as any).result = ((s as any).result ?? 0) + ('<div class="event-time" style="font-size: 0.9em; opacity: 0.8; word-wrap: break-word; overflow-wrap: break-word;">' + ((s as any).temp_window_time ?? 0) + '</div>');
    }
    (s as any).result = ((s as any).result ?? 0) + ('</div>');
    (s as any).temp_event_space = ((s as any).temp_colspan ?? 0) * ((s as any).temp_event_slots ?? 0);
    (s as any).result = ((s as any).result ?? 0) + ('<div class="event-main" style="position: absolute; top: ' + ((s as any).temp_window_percent ?? 0) + '%; left: 0; right: 0; bottom: 0; ');
    (s as any).result = ((s as any).result ?? 0) + ('margin: 0; padding: 0; box-sizing: border-box; overflow: hidden; ');
    (s as any).result = ((s as any).result ?? 0) + ('display: flex; flex-direction: column; justify-content: center; ');
    (s as any).result = ((s as any).result ?? 0) + ('background-color: rgb(' + ((s as any).temp_color_rgb ?? 0) + ');">');
    (s as any).result = ((s as any).result ?? 0) + ('<div class="event-title" style="word-wrap: break-word; overflow-wrap: break-word;">' + ((s as any).temp_title ?? 0) + '</div>');
    if (((s as any).temp_event_space ?? 0) >= 5) {
      if (((s as any).temp_location ?? 0) !== '') {
        (s as any).result = ((s as any).result ?? 0) + ('<div class="event-location" style="font-size: 0.85em; opacity: 0.7; word-wrap: break-word; overflow-wrap: break-word;">' + ((s as any).temp_location ?? 0) + '</div>');
      }
      if (((s as any).temp_desc ?? 0) !== '') {
        (s as any).result = ((s as any).result ?? 0) + ('<div class="event-desc" style="font-size: 0.8em; opacity: 0.6; word-wrap: break-word; overflow-wrap: break-word;">' + ((s as any).temp_desc ?? 0) + '</div>');
      }
    }
    (s as any).result = ((s as any).result ?? 0) + ('</div>');
    (s as any).result = ((s as any).result ?? 0) + ('</td>');
    ...
    (s as any).result = '<td rowspan="' + String(((s as any).temp_rowspan ?? 0)) + '" colspan="' + String(((s as any).temp_colspan ?? 0)) + '" ';
    (s as any).result = ((s as any).result ?? 0) + ('class="event-cell" style="background-color: rgb(' + ((s as any).temp_color_rgb ?? 0) + '); padding: 2px;">');
    (s as any).result = ((s as any).result ?? 0) + ('<div class="event-title" style="word-wrap: break-word; overflow-wrap: break-word;">' + ((s as any).temp_title ?? 0) + '</div>');
    if (((s as any).temp_event_space ?? 0) >= 5) {
      if (((s as any).temp_location ?? 0) !== '') {
        (s as any).result = ((s as any).result ?? 0) + ('<div class="event-location" style="font-size: 0.85em; opacity: 0.7; word-wrap: break-word; overflow-wrap: break-word;">' + ((s as any).temp_location ?? 0) + '</div>');
...
function enterRenderEmptyCell(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).result = ((s as any).result ?? 0) + ('class="empty-cell" style="background-color: ' + ((s as any).temp_ec_bg ?? 0) + ';">&nbsp;</td>');
  (s as any).temp_ec_rowspan = undefined;
  (s as any).temp_ec_colspan = undefined;
  (s as any).temp_ec_timeslot = undefined;
  (s as any).temp_ec_day = undefined;
  (s as any).temp_ec_bg = undefined;
  return;
  scene.build();
}

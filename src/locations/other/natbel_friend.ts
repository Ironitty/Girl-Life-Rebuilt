...
function enterSetupShoppingSpree(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Natasha's eyes light up for a moment before dimming and she frowns. "I'd really love that, ${((s as any).pcs_nickname || '')}. But you know I don't have a lot of money. Maybe we could window shop instead or I could help you pick something out for yourself?"`);
    ...
    scene.text(`"You really don't have to do this, ${((s as any).pcs_nickname || '')}. You want to be my friend and you've helped me with my debts, I'm grateful for that," Natasha says with a genuine smile.`);
    ...
    scene.text(`Her smile turns into a grin, "Yes, ${((s as any).pcs_nickname || '')}. Thank you, for all of this."`);
...
function enterShoppingSpree(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You approach Natasha, who is admiring herself in the mirror. "So, what do you think, ${((s as any).pcs_nickname || '')}?" she asks, taking a slow heel turn. "Do you like it?"`);
    ...
    scene.text(`Natasha has difficulty choosing between three outfits and asks you to make the final choice. Finally, you decide on a lovely party dress. "Okay, ${((s as any).pcs_nickname || '')}," she says, smiling. "Then that's the one. It'll look much nicer than what I currently have at home."`);
    ...
    scene.text(`Natasha meets you at the front of the store and takes you by hand. "Come on, ${((s as any).pcs_nickname || '')}," she says. "Let's go."`);
    ...
    scene.text(`She reaches across the table and squeezes your hand, "I really have, ${((s as any).pcs_nickname || '')}. My life was a complete mess until you came along. You've given me hope and happiness in our short time together."`);
    ...
    scene.text(`Natasha looks at you and smiles, "Yes, ${((s as any).pcs_nickname || '')}, I know."`);
...
function enterLoveJct(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"I know, ${((s as any).pcs_nickname || '')}," she replies.`);
    ...
    scene.text(`A small amount of relief starts to return to Natasha's face. "Your friendship means the world to me, too, ${((s as any).pcs_nickname || '')}. You're right. I wouldn't want to lose that either."`);
...
function enterDisco_2Cont(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).NatbelQW ?? 0)?.['FriendLover'] >= 7) {
    ...
    scene.text(`You both sit down as she turns towards you, smiling, "I just want to say thank you, ${((s as any).pcs_nickname || '')}, for taking me to the disco tonight and again for my wonderful day out with you."`);
    scene.text('You\'ve decided that you want Natasha as your girlfriend. Her face is not far from yours, so you lean in to kiss her.');
    scene.text('Pushing yourself forward, your lips meet with Natasha\'s. There\'s a sudden jolt coursing through you, and it must be the same for her as you feel her tense for a brief moment before relaxing into your kiss.');
    scene.text('You both hesitantly pull back. You slowly open your eyes and see her doing the same.');
    scene.text('You stare at each other for a brief moment before speaking.');
  ...
  scene.actions([
    ...
    scene.text(`Natasha looks slightly disappointed but smiles at you, "Yes, I know, ${((s as any).pcs_nickname || '')}. But, we need to take it slow and think about what we want from our relationship."`);
...
function enterShoppingTrip(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`She replies, "Yes, you're right, ${((s as any).pcs_nickname || '')}. No harm in a bit of looking, though."`);
    ...
    scene.text(`"Okay, ${((s as any).pcs_nickname || '')}," she says, smiling. "Then I'll go for that one. It's much nicer than what I've currently got at home, which was from last year."`);
    ...
    scene.text(`She meets you at the front of the store and takes you by the hand, before heading off to Del Parco. "Thank you, that was so nice of you. So now my treat, I'm just sorry it's not more. Come on, ${((s as any).pcs_nickname || '')}," she says. "Let's go."`);
    ...
    // TODO-QSP: dynamic text: She reaches across the table and squeezes your hand, "I really have, <<$pcs_nick...
    scene.text(`She reaches across the table and squeezes your hand, "I really have, ${((s as any).pcs_nickname || '')}. I love spending time with you. Plus, I loved the chance to try on dresses with you, let alone my wonderful present."`);
    ...
    scene.text(`Natasha looks at you, smiling, "Oh, yes, ${((s as any).pcs_nickname || '')}. I'm so looking forward to doing that. Thank you again for this wonderful present!"`);
    ...
    scene.text(`She looks deflated but nods. "I guess you're right, ${((s as any).pcs_nickname || '')}. It's just that I love fashion and that's what they're into."`);
    ...
    scene.text(`Natasha looks happier when you say this. "Oh, yes, ${((s as any).pcs_nickname || '')}. I want to do a course in Fashion Design."`);
    ...
    scene.text(`Smiling, Natasha looks at you and nods. "Actually, deep down, I know they won't accept me, ${((s as any).pcs_nickname || '')}. It's just frustrating."`);
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}, if you want to get there, you can do it. You aren't stupid and I'll help as much as I can with homework, revision and so on."`);
    ...
    scene.text(`"Yes, of course, ${((s as any).pcs_nickname || '')}. If you need any help with your studies in the meantime, just ask me. I'll always be happy to help where I can."`);
    scene.actions([
      { label: 'Return to her room', goto: ['natbelapt', 'natroom'] },
    ]);
  } },
...
function enterShoppingTrip2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Yes, ${((s as any).pcs_nickname || '')}," she replies. "There are a couple but they're really expensive!"`);
    ...
    scene.text(`"Sorry, ${((s as any).pcs_nickname || '')}," she says in a lowered voice. "I just don't want to lose you but I feel like I'm taking advantage of your kindness."`);
    ...
    scene.text(`"Okay, ${((s as any).pcs_nickname || '')}," she says, smiling. "Then that's the one. It's <i>sooo</i> much nicer than anything I have."`);
    ...
    scene.text(`"Well, I got some extra money so thought I'd treat us to a meal at Limael Cafe. I still wish I could do more. Anyway. Come on, ${((s as any).pcs_nickname || '')}," she says. "Let's go."`);
    ...
    scene.text(`She reaches across the table and squeezes your hand, "Oh yes, ${((s as any).pcs_nickname || '')}. I love our time together and our days out. I also love the opportunity to try on outfits and dresses with you, especially since I can actually end up with one that's not second hand."`);
    ...
    scene.text(`Natasha's mother, ${((s as any).npc_usedname ?? 0)?.['A191'] ?? ''}, suddenly enters the room unannounced. "${((s as any).pcs_nickname || '')}, I just wanted to say thank-" she stops when she sees the two of you partially undressed on the bed.`);
    ...
    scene.text(`"I'm sorry, ${((s as any).pcs_nickname || '')}. I'm sure you weren't expecting this." She turns to her daughter. "Natasha, why on Earth didn't you say something to me when things started to get serious between the two of you? Haven't I always been here to support you?"`);
    scene.actions([
    ...
    scene.text(`She gives you a warm hug afterwards. "Thank you, ${((s as any).pcs_nickname || '')}. I appreciate you speaking up for Natasha and for your generosity as well." Then she turns and hugs her daughter. "I want both of you to know that you can talk to me. I don't judge people by anything other than their actions."`);
    // TODO-QSP: dynamic text: She gets up and starts to leave the room, but stops at the door. "Would you like...
    scene.text(`She gets up and starts to leave the room, but stops at the door. "Would you like to stay for dinner, ${((s as any).pcs_nickname || '')}"`);
    ...
    scene.text(`You sit next to Natasha on the floor and she looks at you. "I'm sorry, ${((s as any).pcs_nickname || '')}. Guess that was a bit awkward."`);
    ...
    scene.text(`Natasha gives you a gentle hug. "Okay, ${((s as any).pcs_nickname || '')}. I won't press you on it for now, but if we stay together, we'll need to do something eventually."`);
...
function enterCityDate1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"I know ${((s as any).pcs_nickname || '')} and don't worry I gave her a big thank you for it. Do you need to let your parents know you won't be back tonight?"`);
    ...
    scene.text(`Natasha nods at you "Yes ${((s as any).pcs_nickname || '')} shall we go and explore for a while?"`);
    ...
    scene.text(`Natasha looks at you and asks, "So ${((s as any).pcs_nickname || '')} aren't you going to go to university then? Only I thought we might both need to come here for research?"`);
    ...
    scene.text(`"I could spend all day in there ${((s as any).pcs_nickname || '')}, there's so many interesting books and such a wonderful building too."`);
    ...
    scene.text(`Natasha looks a bit unsure. "Well yes ${((s as any).pcs_nickname || '')} maybe but I guess that the park might not be very safe after dark."`);
    ...
    scene.text(`"Well okay then ${((s as any).pcs_nickname || '')} let's do that. We'll just need to make sure we keep our wits about us."`);
    ...
    if (((s as any).kickbox ?? 0)?.['amateurWin'] + ((s as any).kickbox ?? 0)?.['amateurLoss'] + ((s as any).kickbox ?? 0)?.['amateurDraw'] > 0) {
      ...
      scene.text(`Natasha is stunned. "Oh ${((s as any).pcs_nickname || '')}! What? You might get badly hurt!"`);
      ...
      scene.text(`A still worried looking Natasha gives you a hug. "Okay ${((s as any).pcs_nickname || '')}, good luck and please try to be careful in the fight."`);
      ...
      if (((s as any).christinaQW ?? 0)?.['fight'] === 1) {
        ...
        scene.text(`Natasha returns your kiss, "Well I can't complain about you stopping that bully. Just be careful ${((s as any).pcs_nickname || '')}."`);
      ...
      scene.text(`"Oh no ${((s as any).pcs_nickname || '')} I wouldn't miss your race for the world! Let's go."`);
...
function enterCityDate1Aftersport(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).runnerQW ?? 0)?.['gold_medals'] > ((s as any).temp_gold_medals ?? 0)) {
      ...
      scene.text(`Natasha is positively gushing as she rushes up to you and hugs you tightly "${((s as any).pcs_nickname || '')} that was something else ${((s as any).pcs_nickname || '')}! Well done! That was super fast. I looked it up and you're very close to the National championships times and not far off Olympic qualification."`);
      ...
      scene.text(`That brings a smile "A bit of window shopping sounds like a good plan to me; we can get to try on some stuff too. Come on ${((s as any).pcs_nickname || '')} let's go."`);
      ...
      scene.text(`Natasha looks happy and smiles at you as she comes up to you and hugs you "${((s as any).pcs_nickname || '')} that was close ${((s as any).pcs_nickname || '')}! Well done!"`);
...
function enterCityDate1Mall(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`She opens the bag and takes a look inside. "Oh ${((s as any).pcs_nickname || '')} they're lovely. Thank you so much." She gives you a hug and excitedly replaces her existing underwear with her new set.`);
    ...
    scene.text(`"Yes ${((s as any).pcs_nickname || '')}, of course. I know how difficult things are for her." She replies with a tinge of sadness in her voice.`);
    scene.actions([
    ...
    if (Object.keys((s as any).temp_city_work ?? {}).length === 0) {
      ...
      scene.text(`"Yes ${((s as any).pcs_nickname || '')}. I was just curious and interested in you." She gives you a friendly smile before returning her attention to her meal.`);
      ...
      scene.text(`"Oh yes ${((s as any).pcs_nickname || '')}. It's already great. I can't remember ever coming here before. This is so nice of you."`);
      scene.actions([
      ...
      if (Object.keys((s as any).temp_city_work ?? {}).length === 1  &&  ((s as any).temp_city_work ?? 0)[0] === 'runner') {
        if (((s as any).runnerQW ?? 0)?.['gold_medals'] > ((s as any).temp_gold_medals ?? 0)) {
          ...
          scene.text(`"Yes ${((s as any).pcs_nickname || '')}. I was just curious and interested in you and I got to see you win your race. Well done!" She gets up and comes over to give you a big hug before getting a bit embarrassed and sitting down again and giving your hand a squeeze. "Sorry, I guess I got a bit carried away."`);
          ...
          scene.text(`"Stop it ${((s as any).pcs_nickname || '')}." She says blushing even more. After gathering herself she continues. "It's already been a great weekend. I can't remember ever coming to Saint Petersburg before. This is so nice of you."`);
        } else {
          scene.text('"So are you happy <i>girlfriend</i>?" You enquire.');
          // TODO-QSP: dynamic text: "Yes <<$pcs_nickname>>. I was just curious and interested in you and I got to se...
          scene.text(`"Yes ${((s as any).pcs_nickname || '')}. I was just curious and interested in you and I got to see you race. That was very fast, well done, it was close! Maybe next time." She gets up and comes over to give you a big hug before getting a bit embarrassed and sitting down again and giving your hand a squeeze. "Sorry, I guess I got a bit carried away."`);
          scene.text('"That\'s fine Natasha, just maybe save it until a bit later." You tell her and wink.');
          scene.text('She immediately blushes and looks down.');
          scene.text('"Getting hot in here Natasha?" You continue to tease her. "Shall I get you a glass of ice water?"');
          // TODO-QSP: dynamic text: "Stop it <<$pcs_nickname>>." She says blushing more. After gathering herself she...
          scene.text(`"Stop it ${((s as any).pcs_nickname || '')}." She says blushing more. After gathering herself she continues. "It's already been a great weekend. I can't remember ever coming to Saint Petersburg before. This is so nice of you."`);
        }
        scene.actions([
          { label: 'Discuss the fashion blog', goto: ['natbel_friend', 'city_date1_fashionblog'] },
        ]);
...
function enterCityDate1Jobshub(s: GameState, scene: SceneBuilder): void {
  ...
  if (Object.keys((s as any).temp_city_work ?? {}).length === 0  ||  Object.keys((s as any).temp_city_work ?? {}).length === 1  &&  ((s as any).temp_city_work ?? 0)[0] === 'runner') {
    ...
    scene.text(`Natasha smiles at you and replies "Thank you ${((s as any).pcs_nickname || '')}."`);
    scene.text('"So are you happy <i>girlfriend</i>?" You enquire.');
  ...
  if ((Array.isArray((s as any).temp_city_work) ? ((s as any).temp_city_work as any[]).indexOf('masseuse') : -1) >= 0) {
    ...
    scene.text(`Natasha blushes at your remark "${((s as any).pcs_nickname || '')}! Not so loud!"`);
  ...
  if ((Array.isArray((s as any).temp_city_work) ? ((s as any).temp_city_work as any[]).indexOf('model') : -1) >= 0) {
    ...
    scene.text(`"No! No! Of course you're pretty. It's not that ${((s as any).pcs_nickname || '')}! It's just a surprise."`);
    ...
    scene.text(`Natasha slowly recovers her poise. "Yes please ${((s as any).pcs_nickname || '')}, that'd be great. You never know if I do well with fashion I might get to a point where I can ask you to model some of my stuff."`);
    ...
    scene.text(`"Don't worry ${((s as any).pcs_nickname || '')} I won't say anything so if someone finds out it won't be from me and yes I completely agree, Anushka is none of my business."`);
    ...
    scene.text(`"I'm trying ${((s as any).pcs_nickname || '')}, I just lack self confidence but you've already helped me a lot." She plays with her hair and beams at you.`);
    if (((s as any).firstkasting ?? 0) === 0  &&  ((s as any).modelfoto ?? 0)?.['erotic'] === 0) {
      scene.actions([
        { label: 'Continue', goto: ['natbel_friend', 'city_date1_jobshub'] },
      ]);
...
function enterCityDate1JobsModel2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Unfortunately for you she doesn't. "Well she really looks like you ${((s as any).pcs_nickname || '')}." She looks sad as she pauses then continues. "Sorry ${((s as any).pcs_nickname || '')} I shouldn't have brought it up. I didn't mean to embarrass you."`);
    ...
    if ((Array.isArray((s as any).temp_city_work) ? ((s as any).temp_city_work as any[]).indexOf('runner') : -1) < 0) {
      ...
      scene.text(`Natasha gives you a hug. "Don't worry ${((s as any).pcs_nickname || '')} I'd never say anything whatever happens between us. I'm already grateful for all you've done for me and I'll support you in whatever you decide. I'm also starting to be able to help out money wise so if you're doing this for me you can stop if you want as I'm just happy spending time with you."`);
...
function enterCityDate1Fashionblog(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Okay ${((s as any).pcs_nickname || '')}, I'll go and pay then I guess we should head out." Natasha gets up and pays for the meal.`);
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}! Shhh!" She responds going bright red as she gets up and starts walking towards the exit where she stops and buys you an ice pop each. She hands one to you and grinning says "Maybe this will keep you quiet."`);
    ...
    scene.text(`"Well ${((s as any).pcs_nickname || '')} I guess that'll be a long process as I'm just not used to someone who looks out for me as you've done."`);
...
function enterCityDate2Start(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Natasha slides over to you and wraps her arm around you. "Umm, this is a nice way to wake up ${((s as any).pcs_nickname || '')}" she says as she starts playing with your breast`);
...
function enterCityDate2Morningsex(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).NatbelQW ?? 0)?.['horny'] >= 10000) {
    ...
    scene.text(`After you've both recovered from your early morning exertions Natasha leans over and says, "Okay ${((s as any).pcs_nickname || '')} I'll order us some breakfast in bed, my treat."`);
...
function enterCityDate2Palace(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`After a while a smiling Natasha looks at you. "You're full of surprises ${((s as any).pcs_nickname || '')}; I didn't think you'd be interested in something like this."`);
    ...
    scene.text(`As you're nearing your station she turns to you and smiles. "Thank you for this weekend ${((s as any).pcs_nickname || '')}. I've really enjoyed it."`);
    ...
    scene.text(`On arriving back at Natasha's ${((s as any).npc_usedname ?? 0)?.['A191'] ?? ''} greets you and leads you and Natasha to the lounge. "Hello ${((s as any).pcs_nickname || '')}, I hope you both had a good weekend." You both nod in confirmation but don't say anything as it's clear that she has something she wants to say.`);
    ...
    if (((s as any).grupTipe ?? 0) === 4  ||  ((s as any).start_type ?? 0)?.['group'] === 'gopnik') {
      ...
      if (((s as any).start_type ?? 0)?.['cat'] === 'slut'  ||  ((s as any).grupTipe ?? 0) === 5  &&  ((s as any).fame ?? 0)?.['pav_slut'] > 300) {
        ...
        if (((s as any).start_type ?? 0)?.['cat'] === 'goth'  ||  ((s as any).PCloStyle ?? 0) === 2) {
          ...
          scene.text(`That's fine ${((s as any).pcs_nickname || '')} and, in fact I like what you wear most of the time but I guess what I'm trying to say is that I have no clue what attracted you to each other."`);
        } else {
    ...
    scene.text(`${((s as any).npc_usedname ?? 0)?.['A191'] ?? ''} looks at her daughter. "What?! I just wanted to acknowledge that and say that ${((s as any).pcs_nickname || '')} is welcome here while you two are together and to say I don't care about any other stuff; I just care how you two behave towards each other. Anyway Natasha, did you speak to ${((s as any).pcs_nickname || '')} following our discussion?"`);
    ...
    scene.text(`A relieved Natasha looks at you, nods and smiles. "Sorry ${((s as any).pcs_nickname || '')} I'm just not used to all this. Please be patient with me."`);
    ...
    scene.img('images/characters/pavlovsk/school/girl/natasha/events/bullied/natasha1.jpg');
    // TODO-QSP: dynamic text: A now distraught Natasha replies. "NO <<$pcs_nickname>>! No! I love being your g...
    scene.text(`A now distraught Natasha replies. "NO ${((s as any).pcs_nickname || '')}! No! I love being your girlfriend! Fuck! I knew I'd mess this up!"`);
    ...
    scene.text(`"Well ${((s as any).pcs_nickname || '')}, you said you wanted to take things slowly but I feel that I sort of pressured you into asking me and I'm not comfortable with having done that."`);
    ...
    scene.text(`"You've just made my day ${((s as any).pcs_nickname || '')}; I simply couldn't be happier right now!"`);
    // TODO-QSP: dynamic text: Remembering that <<$npc_usedname['A191']>> is in the room you look over to her a...
...
function enterCityDate2AfterRelTalk(s: GameState, scene: SceneBuilder): void {
  ...
  if (qspFunc(s, 'homes_properties', 'is_current_home', 'parents_home')) {
    ...
    scene.text(`${((s as any).npc_usedname ?? 0)?.['A191'] ?? ''} gives you a hug. "Well ${((s as any).pcs_nickname || '')} I can only hope that goes better than you are imagining."`);
...
function enterIsabellaEnters(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`She hugs you back. "Thank you ${((s as any).pcs_nickname || '')} for being there when I needed you."`);
...
function enterEndOfGschool(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`She clears her throat and begins. "${((s as any).pcs_nickname || '')}, I need to ask you what you will do after school. As you know I'm going to go to university."`);
    ...
    scene.text(`Natasha breaks into a grin. "Oh ${((s as any).pcs_nickname || '')} that's wonderful and I'm sure we can help and support each other there and make sure we pass our courses. That should be a great benefit for us in our future careers."`);
    ...
    scene.text(`A little surprisingly she shakes her head. "No ${((s as any).pcs_nickname || '')}. I've thought about this long and hard and if I go to university and you don't I simply don't think it'll work out as I'd need to concentrarte on my studies and you'll need to do likewise with your career."`);
    scene.actions([
      { label: 'Break up', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', 14, 'uni']; enterBreakup(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'npc_relationship', 'set', 'A16', 50);
    qspCall(s, 'stat', '');
    scene.img('images/characters/pavlovsk/school/girl/natasha/events/bullied/natasha3.jpg');
    ...
    scene.text(`"I respect your decision ${((s as any).pcs_nickname || '')} and wish you well. I've had a great time with you and this period of being your girlfriend has been one of the happiest for me but we need to call it a day on our relationship. I simply need to give 100% to my university education and I can't see it would work if you aren't at university too. I'm so sorry…"`);
    scene.text('You\'re unsure of what to do for the best but feel it would only make it worse if you tried to persuade her to change her mind.');
    scene.text('So with a long sigh and after a final look at her you get up and leave without responding.');
    scene.actions([
      { label: 'Leave', goto: ['pod_ezd', 'etaj_4'] },
...
function enterBirthdayInvitation(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (qspFunc(s, 'money', 'can_afford', 1000) === 0) {
      ...
      scene.text(`While looking at some magazines with Natasha she asks you, "So ${((s as any).pcs_nickname || '')}, my birthday is coming up shortly and I wondered if you'd like to join my mother and I for a meal at Del Parco the Saturday after? I know it's not much but I'd love it if you could join us."`);
    ...
    scene.text(`A beaming Natasha looks at you. "Anyway ${((s as any).pcs_nickname || '')} when is yours? I hope I haven't missed it?"`);
    ...
    if (((s as any).month ?? 0) > ((s as any).birthmonth ?? 0)  ||  ((s as any).month ?? 0) === ((s as any).birthmonth ?? 0)  &&  ((s as any).day ?? 0) > ((s as any).birthday ?? 0)) {
      ...
      scene.text(`"Oh I'm sorry ${((s as any).pcs_nickname || '')} I should probably have asked you earlier."`);
    } else {
      ...
      scene.text(`Natasha nods. "Oh! Okay ${((s as any).pcs_nickname || '')}, let me know if you change your mind."`);
    }
    scene.actions([
      { label: 'Return to her room', goto: ['natbelapt', 'natroom'] },
    ]);
    ...
    scene.text(`Natasha looks a little sad but gives you a brief hug anyway. "Not to worry ${((s as any).pcs_nickname || '')} I know it's a bit short notice."`);
...
function enterBdayDelParco(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"No promises ${((s as any).pcs_nickname || '')}…" She replies grinning.`);
    scene.actions([
    ...
    scene.text(`"Thank you ${((s as any).pcs_nickname || '')} but that won't be necessary. Anyway, you've already done so much for my daughter and I can't thank you enough so this is a small thank you from me.`);
    ...
    scene.text(`As you approach the apartment ${((s as any).npc_usedname ?? 0)?.['A191'] ?? ''} turns to you. "Please stay over tonight if you'd like ${((s as any).pcs_nickname || '')}. I'm sure you don't want to be out on your own and I'm 100% sure Natasha would like you to stay over."`);

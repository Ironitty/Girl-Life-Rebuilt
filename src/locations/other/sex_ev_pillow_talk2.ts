...
function enterWeatherTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['weather_pillow_talk'] === 0) {
    ...
    scene.text(`"Yeah," ${((s as any).npcdesc || '')} nods. "I need a shower..."`);
    ...
    scene.text(`"Brrr," you shiver, cuddling up closer against ${((s as any).npcdesc || '')}'s body. "It's so chilly today."`);
    // TODO-QSP: dynamic text: "You get cold easily?" <<$npcdesc>> asks, seemingly pleased by your naked body p...
    scene.text(`"You get cold easily?" ${((s as any).npcdesc || '')} asks, seemingly pleased by your naked body pressed up against his.`);
    scene.actions([
      { label: 'Not really', handler: (st: GameState) => {
    ((s as any).pc_gets_chilly = (s as any).pc_gets_chilly ?? {})[String((s as any).npcID ?? 0)] = (-1);
    ...
    scene.text(`You smile softly at ${((s as any).npcdesc || '')} who grins back confidently, wrapping his arm around you.`);
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
    ...
    scene.text(`You grin at ${((s as any).npcdesc || '')} who grins back just as wide as he wraps his arm around you.`);
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
    ...
    scene.text(`You snuggle in closer to ${((s as any).npcdesc || '')} without further comment, letting the implication of your words speak for itself. You figure he got the message when he grins as he wraps his arm around you.`);
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
    ]);
  } },
    ...
    scene.text(`"Sometimes yes, sometimes no. I think I'm just like anybody else," you shrug, snuggling closer into ${((s as any).npcdesc || '')}'s warmth.`);
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
    ...
    scene.text(`"I'm always cold," you shiver, snuggling as far as you can into ${((s as any).npcdesc || '')}'s warmth. "I would wear a jacket in the summer."`);
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
    ]);
  } },
...
function enterFavBodyPart(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['body_talk'] === 0) {
    ...
    scene.text(`"Aww! Thanks," you smile fondly at ${((s as any).npcdesc || '')}. "Means a lot to me that you think so."`);
    ...
    if (((s as any).npc_pussyeater ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (((s as any).sex_ev ?? 0)?.['kuni'] > 0  ||  ((s as any).npc_kuni_times ?? 0)?.[String((s as any).npcID ?? 0)])) {
      ...
      if (((s as any).npc_misogynist ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
        ...
        scene.text(`${((s as any).npcdesc || '')} grins shamelessly.`);
      }
    }
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
    ...
    scene.text(`Your next words are interrupted by a gasp as ${((s as any).npcdesc || '')} drives a finger knuckle deep into your just-fucked pussy. Soft squelching sounds emanate from between your legs as he gently caresses your insides, forcing whimpers from your lips while he stares into your eyes.`);
    ...
    if (((s as any).sex_ev ?? 0)?.['fuck_count'] > 0  ||  ((s as any).npc_fuck_times ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      scene.text(`"Glad you think so," you smile at ${((s as any).npcdesc || '')}. "I'd hate to find out you don't appreciate the pussy you're fucking."`);
    } else {
      // TODO-QSP: dynamic text: "Glad you think so," you smile at <<$npcdesc>>. "Always nice to get compliments....
      scene.text(`"Glad you think so," you smile at ${((s as any).npcdesc || '')}. "Always nice to get compliments."`);
    }
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
            { label: 'I like it too', handler: (st: GameState) => {
    if (((s as any).sex_ev ?? 0)?.['fuck_count'] > 0  ||  ((s as any).npc_fuck_times ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      scene.text(`"Me too," you grin at ${((s as any).npcdesc || '')}. "I like the way it lets me fuck you."`);
    } else {
      // TODO-QSP: dynamic text: "Me too," you grin at <<$npcdesc>>. "I've always thought my pussy was cute."
      scene.text(`"Me too," you grin at ${((s as any).npcdesc || '')}. "I've always thought my pussy was cute."`);
    }
...
function enterFavoritePosition(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['fav_pos_talk'] === 0) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['fav_pos_talk'] = 1;
    ...
    if (((s as any).sex_ev ?? 0)?.['mouth_cum_gross'] === 1) {
      ...
      scene.text(`"You didn't seem to like the taste when I came in your mouth," ${((s as any).npcdesc || '')} smirks.`);
      ...
      scene.text(`"Explains why you're so good at it," ${((s as any).npcdesc || '')} smirks, running his thumb across your lips. "You were gobbling it up like it was your last meal."`);
    }
    qspGoto(s, 'sex_ev_pillow_talk', 'topic_route');
  } },
    ]);
...
function enterDontHookup(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['type'] === 'hookup'  &&  ((s as any).sex_ev ?? 0)?.['virgin'] === 0  &&  ((s as any).stat ?? 0)?.['think_virgin'] === 0) {
    ...
    if ((Math.floor(Math.random() * 1000) + 1) < ((s as any).fame ?? 0)[((s as any).region ?? 0) + '_sex']  &&  ((s as any).fame ?? 0)[((s as any).region ?? 0) + '_sex'] > 200) {
      ...
      scene.text(`${((s as any).npcdesc || '')} snorts loudly.`);
      // TODO-QSP: dynamic text: "Oh come on. I know who you are. Don't you know about how many rumors there are ...
      scene.text(`"Oh come on. I know who you are. Don't you know about how many rumors there are around town about a girl named ${((s as any).pcs_nickname || '')} who will spread their legs for anyone?"`);
      scene.actions([
    ...
    if (((s as any).npc_rel_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 'sex') {
      ...
      scene.text(`"Damn!" ${((s as any).npcdesc || '')} exclaims. "I can't go a week without busting my nut! I don't know how you lasted this long!"`);
    } else {
      // TODO-QSP: dynamic text: "Glad I could be of help then," <<$npcdesc>> grins back.
      scene.text(`"Glad I could be of help then," ${((s as any).npcdesc || '')} grins back.`);
    }
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
        ]);
  ...
  if (((s as any).know_npc_girlfriend ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).know_npc_wife ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).know_npc_single ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    ...
    if (((s as any).npc_wife ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      ...
      if (((s as any).npc_fidelity ?? 0)?.[String((s as any).npcID ?? 0)] === 'open') {
        ((s as any).npc_open_marriage = (s as any).npc_open_marriage ?? {})[String((s as any).npcID ?? 0)] = 1;
        // TODO-QSP: dynamic text: "Wife actually," <<$npcdesc>> replies. "But she knows I'm sticking it in other g...
        scene.text(`"Wife actually," ${((s as any).npcdesc || '')} replies. "But she knows I'm sticking it in other girls. We're in an open marriage She's probably getting stuck by a few guys herself right now."`);
      } else {
        if (((s as any).npc_rel_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 'sex') {
          // TODO-QSP: dynamic text: "Wife actually," <<$npcdesc>> replies. "But don't worry about her. You're much b...
          scene.text(`"Wife actually," ${((s as any).npcdesc || '')} replies. "But don't worry about her. You're much better in bed."`);
        } else {
          if (((s as any).npc_rel_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 'casual') {
            ...
            scene.text(`"Wife actually," ${((s as any).npcdesc || '')} replies. "But I don't think this is ."`);
          } else {
            if (((s as any).npc_rel_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 'serious') {
              if (((s as any).npc_fidelity ?? 0)?.[String((s as any).npcID ?? 0)] === 'open') {
                ((s as any).npc_open_marriage = (s as any).npc_open_marriage ?? {})[String((s as any).npcID ?? 0)] = 1;
                // TODO-QSP: dynamic text: "Wife actually," <<$npcdesc>> replies. "But she knows I'm sticking it in other g...
                scene.text(`"Wife actually," ${((s as any).npcdesc || '')} replies. "But she knows I'm sticking it in other girls. She's probably getting stuck by a few guys herself right now."`);
              } else {
                // TODO-QSP: dynamic text: "Wife actually," <<$npcdesc>> replies. "But don't worry about her. You're much b...
                scene.text(`"Wife actually," ${((s as any).npcdesc || '')} replies. "But don't worry about her. You're much better in bed."`);
              }
      ...
      if (((s as any).npc_girlfriend ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
        ...
        if (((s as any).npc_rel_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 'sex') {
          ...
          scene.text(`"Nah," ${((s as any).npcdesc || '')} replies. "I don't want to be tied down. I like to keep things loose."`);
        } else {
          if (((s as any).npc_rel_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 'casual') {
            scene.text('');
          } else {
        ...
        if (((s as any).npc_rel_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 'sex') {
          // TODO-QSP: dynamic text: "Nah," <<$npcdesc>> replies. "I don't want to be tied down. I like to keep thing...
          scene.text(`"Nah," ${((s as any).npcdesc || '')} replies. "I don't want to be tied down. I like to keep things casual. Too many girls out there to enjoy."`);
          scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} eyes you curiously.`);
...
function enterMadeMeLate1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).gschoolVars ?? 0)?.['absence_count'] > 0  &&  ((s as any).npc_school_absences ?? 0)?.[String((s as any).npcID ?? 0)] < ((s as any).gschoolVars ?? 0)?.['absence_count']  &&  ((s as any).npc_school_absences ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  ((s as any).npc_fuck_times ?? 0)?.[String((s as any).npcID ?? 0)] > 1) {
    ...
    if (((s as any).npc_last_sex ?? 0)?.[String((s as any).npcID ?? 0)] === ((s as any).daystart ?? 0)) {
      ...
      scene.text(`"You made me late for school this morning," you grumble, eyeballing ${((s as any).npcdesc || '')}. "Again."`);
    } else {
      // TODO-QSP: dynamic text: "You made me late for school the last time I came over," you grumble, eyeballing...
      scene.text(`"You made me late for school the last time I came over," you grumble, eyeballing ${((s as any).npcdesc || '')}.`);
    }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMadeMeLate2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ...
    if (((s as any).npc_last_sex ?? 0)?.[String((s as any).npcID ?? 0)] === ((s as any).daystart ?? 0)) {
      // TODO-QSP: dynamic text: "You made me late for school this morning," you grumble, eyeballing <<$npcdesc>>...
      scene.text(`"You made me late for school this morning," you grumble, eyeballing ${((s as any).npcdesc || '')}.`);
    } else {
      // TODO-QSP: dynamic text: "You made me late for school the last time I came over," you grumble, eyeballing...
      scene.text(`"You made me late for school the last time I came over," you grumble, eyeballing ${((s as any).npcdesc || '')}.`);
    }
...
function enterPlansLater(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['plans_later_talk'] === 0  &&  ((s as any).sex_ev ?? 0)?.['what_do_today'] === 0) {
    ...
    if (((s as any).sex_ev ?? 0)?.['unique_npc'] === 1) {
      ...
      if (((s as any).npc_day_off ?? 0)?.[String((s as any).npcID ?? 0)] === ((s as any).week ?? 0)) {
        ...
        if (((s as any).npc_end_free_time ?? 0)?.[String((s as any).npcID ?? 0)] >= ((s as any).hour ?? 0)  &&  ((s as any).hour ?? 0) > 0) {
          ...
          scene.text(`${((s as any).npcdesc || '')} hauls himself out of bed and you guess you should do the same.`);
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['what_do_today'] = 1;
    qspCall(s, 'sex_ev_pillow_talk', 'pillow_picture1');
    scene.text('"So, what\'d you get up to today?" you ask.');
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDayEvents(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        ]);
      } else {
        scene.actions([
    ...
    scene.text(`"So, what else have you done today? Besides me I mean," you smirk at ${((s as any).npcdesc || '')}.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDayEvents(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        ]);
      }
...
function enterPcPlansLater(s: GameState, scene: SceneBuilder): void {
  if (((s as any).kanikuli ?? 0) === 0  &&  ((s as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((s as any).gschoolVars ?? 0)?.['school_diploma'] === 0  &&  ((s as any).gschoolVars ?? 0)?.['block'] === 0  &&  ((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) < 8) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['school_after'] = 1;
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['late_for_school'] = 1;
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterTalkLateForSchool2(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ]);
  } },
    ]);
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['homework_after'] = 1;
  ...
  if ((((s as any).AlbinaQW ?? 0)?.['StarletsJoined'] > 0  &&  ((s as any).AlbinaQW ?? 0)?.['StarletsShutDown'] === 0  &&  ((s as any).npc_pregtalk ?? 0)?.['A23'] === 0  &&  ((s as any).starlets_on ?? 0) === 1)  ||  ((s as any).gsAboDance ?? 0) > 0  ||  (((s as any).AlbinaQW ?? 0)?.['StarletsJoined'] > 0  &&  ((s as any).AlbinaQW ?? 0)?.['StarletsShutDown'] !== 0)) {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDanceTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  if (((s as any).hour ?? 0) > 16) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['disco_after'] = 1;
    scene.text('"Thinking about going to the disco later," you reply.');
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDiscoClubDancing(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        { label: 'Go clubbing', handler: (st: GameState) => {
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['club_after'] = 1;
    scene.text('"Thinking about going clubbing later," you reply.');
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDiscoClubDancing(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumDripTease(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
      ]);
    } else {
    ...
    scene.text('"Thinking about going clubbing later," you reply.');
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDiscoClubDancing(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterClubWasted(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterCumDripTease(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        ]);
      }
...
function enterCumDripTease(s: GameState, scene: SceneBuilder): void {
  if (((s as any).cum_loc ?? 0)?.['vagina'] > 0) {
    ...
    scene.text(`You give ${((s as any).npcdesc || '')} a mischievous smirk, rubbing your legs together where his cum still leaks from your snatch.`);
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
    ]);
  }
...
function enterPcDayEvents(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((s as any).gschoolVars ?? 0)?.['school_diploma'] === 0  &&  ((s as any).gschoolVars ?? 0)?.['block'] === 0  &&  ((s as any).lernHome ?? 0) === 0  &&  (!((s as any).kanikuli ?? 0))) {
    ...
    scene.text(`You give ${((s as any).npcdesc || '')} an affectionate smile.`);
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
    ]);
  }
...
function enterDanceTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_know_dance ?? 0)?.[String((s as any).npcID ?? 0)] === 0) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['dance_type'] = 'starlet';
    // TODO-QSP: dynamic text: "I'm part of a dance troupe in Pavlovsk. The Starlets, ever heard of us?" <<$npc...
    scene.text(`"I'm part of a dance troupe in Pavlovsk. The Starlets, ever heard of us?" ${((s as any).npcdesc || '')} shakes his head. "Oh, well we do performances every few weeks. That's my practice later."`);
    ...
    scene.text(`"I used to dance as part of a troupe in Pavlovsk. The Starlets, ever heard of them?" ${((s as any).npcdesc || '')} shakes his head. "Oh, well we did performances every few weeks. But we had to shut down because of some stuff."`);
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['dance_type'] = 'modern';
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['dance_type'] = 'sexy';
    ...
    scene.text(`"Sorry, I can't right now. My legs are still a little wobbly," you say, giving ${((s as any).npcdesc || '')} a suggestive look as you rub your wet thighs together.`);
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
    ...
    if (((s as any).cum_loc ?? 0)?.['face'] > 0  &&  ((s as any).cum_loc ?? 0)?.['vagina'] > 0) {
      ...
      scene.text(`You grab your shoes from the hallway and come back, counting off time before jumping into an energetic Starlets routine, ${((s as any).npcdesc || '')}'s cum still painting your face and running down your legs.`);
    } else {
      if (((s as any).cum_loc ?? 0)?.['face'] > 0) {
        // TODO-QSP: dynamic text: You grab your shoes from the hallway and come back, counting off time before jum...
        scene.text(`You grab your shoes from the hallway and come back, counting off time before jumping into an energetic Starlets routine, ${((s as any).npcdesc || '')}'s cum still painting your face.`);
      } else {
        if (((s as any).cum_loc ?? 0)?.['vagina'] > 0) {
          // TODO-QSP: dynamic text: You grab your shoes from the hallway and come back, counting off time before jum...
          scene.text(`You grab your shoes from the hallway and come back, counting off time before jumping into an energetic Starlets routine, ${((s as any).npcdesc || '')}'s cum still running down your legs.`);
        } else {
    ...
    scene.text(`${((s as any).npcdesc || '')} just nods back, too busy enjoying the show.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShowDanceEnd(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
    scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['sex_over'] === 1) {
      ...
      scene.text(`As you finish the twirl and come back around, ${((s as any).npcdesc || '')} already has his hands on you and is dragging you back into the bed.`);
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShowDanceEnd2(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
  } },
    ...
    if (((s as any).cum_loc ?? 0)?.['face'] > 0  &&  ((s as any).cum_loc ?? 0)?.['vagina'] > 0) {
      ...
      scene.text(`You start swaying your hips, shaking your ass at ${((s as any).npcdesc || '')} with rolling, sensual movements, eye-fucking him as his cum drips down your face and legs.`);
    } else {
      if (((s as any).cum_loc ?? 0)?.['face'] > 0) {
        // TODO-QSP: dynamic text: You start swaying your hips, shaking your ass at <<$npcdesc>> with rolling, sens...
        scene.text(`You start swaying your hips, shaking your ass at ${((s as any).npcdesc || '')} with rolling, sensual movements, eye-fucking him as his cum drips down your face.`);
      } else {
        if (((s as any).cum_loc ?? 0)?.['vagina'] > 0) {
          // TODO-QSP: dynamic text: You start swaying your hips, shaking your ass at <<$npcdesc>> with rolling, sens...
          scene.text(`You start swaying your hips, shaking your ass at ${((s as any).npcdesc || '')} with rolling, sensual movements, eye-fucking him as his cum drips down your legs.`);
        } else {
          // TODO-QSP: dynamic text: You hop out of bed and start swaying your hips, shaking your ass at <<$npcdesc>>...
          scene.text(`You hop out of bed and start swaying your hips, shaking your ass at ${((s as any).npcdesc || '')} with rolling, sensual movements, not dissimilar to the movements you were making minutes ago when you were fucking him.`);
        }
      }
    }
...
function enterShowDance(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).npc_seen_dance = (s as any).npc_seen_dance ?? {})[String((s as any).npcID ?? 0)] = 1;
    qspCall(s, 'npc_relationship', 'modify', ((s as any).npcID ?? 0), 'love');
    ...
    if (((s as any).sex_ev ?? 0)?.['dance_type'] !== 'sexy'  &&  ((s as any).sex_ev ?? 0)?.['dance_type'] !== 'starlet') {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShowShuffle(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
    if (((s as any).sex_ev ?? 0)?.['dance_type'] !== 'modern'  &&  ((s as any).sex_ev ?? 0)?.['dance_type'] !== 'starlet') {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShowSexy(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
    if (((s as any).sex_ev ?? 0)?.['dance_type'] !== 'modern'  &&  ((s as any).sex_ev ?? 0)?.['dance_type'] !== 'sexy') {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShowStarlets(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
  } },
  ]);
  scene.build();
...
function enterShowShuffle(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Picking a favorite song of yours in your head, you skip your way into the middle of ${((s as any).npcdesc || '')}'s floor and show him how you shuffle. With every step, your ass cheeks jiggle and your breasts bounce wildly, and the silliness of it spreads an uncontrollable grin across your lips.`);
    if (((s as any).cum_loc ?? 0)?.['face'] > 0  &&  ((s as any).cum_loc ?? 0)?.['vagina'] > 0) {
      // TODO-QSP: dynamic text: You're sure you must be quite a sight, shuffling naked in the middle of <<$npcde...
      scene.text(`You're sure you must be quite a sight, shuffling naked in the middle of ${((s as any).npcdesc || '')}'s apartment, his cum all over your face and running down your legs.`);
    } else {
      if (((s as any).cum_loc ?? 0)?.['face'] > 0) {
        // TODO-QSP: dynamic text: You're sure you must be quite a sight, shuffling naked in the middle of <<$npcde...
        scene.text(`You're sure you must be quite a sight, shuffling naked in the middle of ${((s as any).npcdesc || '')}'s apartment, his cum all over your face.`);
      } else {
        if (((s as any).cum_loc ?? 0)?.['vagina'] > 0) {
          // TODO-QSP: dynamic text: You're sure you must be quite a sight, shuffling naked in the middle of <<$npcde...
          scene.text(`You're sure you must be quite a sight, shuffling naked in the middle of ${((s as any).npcdesc || '')}'s apartment, his cum dripping from your snatch and running down your legs.`);
        } else {
          // TODO-QSP: dynamic text: You're sure you must be quite a sight, shuffling in the middle of <<$npcdesc>>'s...
          scene.text(`You're sure you must be quite a sight, shuffling in the middle of ${((s as any).npcdesc || '')}'s apartment with nothing covering you but your sneakers.`);
        }
      }
    }
    ...
    scene.text(`"Oh yeah. <i>Really</i> good," ${((s as any).npcdesc || '')} replies. Though the look on his face says he's not really talking about your dance moves.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShowDanceEnd(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ]);
  } },
...
function enterShowSexy(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} doesn't say anything more. He's too busy drooling as until you finish dancing.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShowDanceEnd(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
...
function enterShowStarlets(s: GameState, scene: SceneBuilder): void {
  if (((s as any).AlbinaQW ?? 0)?.['StarletsJoined'] > 0) {
    ...
    if (((s as any).AlbinaQW ?? 0)?.['StarletsShutDown'] === 0) {
      ...
      scene.text(`"Ready?" you ask and ${((s as any).npcdesc || '')} nods. "This is one of our routines our troupe uses for performances."`);
    } else {
      // TODO-QSP: dynamic text: "Ready?" you ask and <<$npcdesc>> nods. "This is one of the dances my old troupe...
      scene.text(`"Ready?" you ask and ${((s as any).npcdesc || '')} nods. "This is one of the dances my old troupe used to do."`);
    }
    scene.actions([
      { label: 'Dance for him', handler: (st: GameState) => {
    qspCall(s, 'stat', '');
    ...
    scene.text(`The look on ${((s as any).npcdesc || '')}'s face as you dance almost makes you burst into giggles but you somehow manage to contain it to a wide grin instead.`);
    scene.actions([
    ...
    scene.text(`"I think that was the sexiest dance I've ever seen," ${((s as any).npcdesc || '')} grins.`);
    scene.actions([
...
function enterShowDanceEnd(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['dance_type'] === 'modern'  ||  ((s as any).sex_ev ?? 0)?.['dance_type'] === 'starlet') {
      ...
      scene.text(`Your little performance finished, you kick off your shoes and snuggle back into the bed with ${((s as any).npcdesc || '')}, picking up your pillow talk from where you left off.`);
    } else {
      // TODO-QSP: dynamic text: Your little performance finished, you snuggle back into the bed with <<$npcdesc>...
      scene.text(`Your little performance finished, you snuggle back into the bed with ${((s as any).npcdesc || '')}, picking up your pillow talk from where you left off.`);
    }
    qspGoto(s, 'sex_ev_pillow_talk2', 'small_talk');
  } },
    ...
    scene.text(`Since you've already gotten out of ${((s as any).npcdesc || '')}'s bed, you figure you ought to do something other than crawl back in.`);
    qspCall(s, 'sex_ev_after', 'after_sex2');
  } },
  ]);
  scene.build();
...
function enterShowDanceEnd2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You giggle as ${((s as any).npcdesc || '')} pulls you down, kicking off your shoes along the way as you let him pull you back into sexy times.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShowDanceEnd3(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ...
    scene.text(`"Wait! Shoes on the bed! Shoes on the bed!" you yelp, nearly losing your balance frantically kicking off your shoes as ${((s as any).npcdesc || '')} pulls you down back into sexy times.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterShowDanceEnd3(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
...
function enterShowDanceEnd3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).sex_ev ?? 0)?.['position_rand'] === 1  ||  ((s as any).npc_fav_pos ?? 0)?.[String((s as any).npcID ?? 0)] === 'miss'  ||  (((s as any).stat ?? 0)?.['think_virgin'] === 1  &&  ((s as any).sex_ev ?? 0)?.['virgin_fuck'] === 0  &&  ((s as any).sex_ev ?? 0)?.['position_rand'] <= 3)) {
      ...
      scene.text(`${((s as any).npcdesc || '')} forces your legs open and lines his cock up with your pussy.`);
      ...
      if (((s as any).sex_ev ?? 0)?.['position_rand'] === 2  ||  ((s as any).npc_fav_pos ?? 0)?.[String((s as any).npcID ?? 0)] === 'doggy') {
        ...
        scene.text(`${((s as any).npcdesc || '')} flips you onto your stomach, pulls you up by the hips, and lines his cock up with your pussy.`);
        ...
        if (((s as any).sex_ev ?? 0)?.['position_rand'] === 3) {
          ...
          scene.text(`${((s as any).npcdesc || '')} positions your head between his legs, pushing his manhood towards your face.`);
          ...
          if (((s as any).sex_ev ?? 0)?.['position_rand'] === 4  &&  (((s as any).cum_loc ?? 0)?.['vagina'] === 0  ||  ((s as any).npc_pussyeater ?? 0)?.[String((s as any).npcID ?? 0)] === 1)) {
            ...
            scene.text(`${((s as any).npcdesc || '')} throws you on your back and starts lightly kissing your stomach, sending shivers across your skin, as each kiss goes lower than the last, slowly heading down to your pussy.`);
...
function enterWhatsItLikeDick(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['whats_it_like_dick_talk'] === 0) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['whats_it_like_dick_talk'] = 1;
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickGrabImage(s, scene); (s as any).locArgs = __savedLocArgs; }
    if (((s as any).sex_ev ?? 0)?.['cum_count'] >= 5 + ((s as any).sex_ev ?? 0)?.['extra_cum']  ||  ((s as any).sex_ev ?? 0)?.['fucked_out'] === 1) {
      ...
      scene.text(`"What's it like having a dick?" you ask, giving ${((s as any).npcdesc || '')}'s floppy meat a funny look as you fondle it.`);
    } else {
      // TODO-QSP: dynamic text: "What's it like having a dick?" you ask, giving <<$npcdesc>>'s stiff meat a funn...
      scene.text(`"What's it like having a dick?" you ask, giving ${((s as any).npcdesc || '')}'s stiff meat a funny look as you jerk it experimentally.`);
    }
    if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'childish') {
      ...
      if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted') {
        ...
        scene.text(`"That's cause all guys want is sex," you giggle but ${((s as any).npcdesc || '')} shakes his head.`);
...
function enterDickCompliment(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['dick_compliment'] === 0) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['dick_compliment'] = 1;
    ...
    scene.text(`"How the hell are you still hard?" you say, gripping ${((s as any).npcdesc || '')}'s stiff cock in bewilderment. "You came so many times but you're still..."`);
    if ((Math.floor(Math.random() * 2) + 1) === 1) {
    ...
    scene.text(`"You're <i>way</i> bigger," you say, staring hungrily at his ${((s as any).dick_desc || '')} manhood. "His dick feels like a <i>finger</i> by comparison..."`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickTalkTopics(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        ]);
      }
    ...
    scene.text(`"Now when we sleep together, all I can think about is how much I want this cock inside me," you say, staring hungrily at his ${((s as any).dick_desc || '')} manhood. "Lesbian sex has never been so unsatisfying..."`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickTalkTopics(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        ]);
      }
    ...
    scene.text(`"This thing is ruining sex with other guys for me," you say, hungrily staring at ${((s as any).npcdesc || '')}'s ${((s as any).dick_desc || '')} manhood.`);
    // TODO-QSP: iif(npc_arrogant[$npcID] > 0, '"I bet," <<$npcdesc>> says with a smug grin.', '"Yeah?" he says with ...
    ...
    if (((s as any).sex_ev ?? 0)?.['cum_count'] >= 5 + ((s as any).sex_ev ?? 0)?.['extra_cum']  ||  ((s as any).sex_ev ?? 0)?.['fucked_out'] === 1) {
      ...
      scene.text(`"You have a great dick, you know that?" you say while giving ${((s as any).npcdesc || '')}'s soft floppy manhood an appreciative fondle.`);
    } else {
      // TODO-QSP: dynamic text: "You have a great dick, you know that?" you say while giving <<$npcdesc>>'s stif...
      scene.text(`"You have a great dick, you know that?" you say while giving ${((s as any).npcdesc || '')}'s stiff manhood an appreciative jerk.`);
    }
    if (((s as any).npc_insecure ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  ((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)] < 15  &&  ((s as any).dick_desc ?? 0) !== 'thick') {
      ...
      scene.text(`"Really?" ${((s as any).npcdesc || '')} asks. He looks away, seeming embarrassed. "You don't wish it were... bigger?"`);
    ...
    scene.text(`${((s as any).npcdesc || '')} swells at your words, looking like you just gave him a big confidence boost.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickTalkTopics(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickTalkTopics(s, scene); (s as any).locArgs = __savedLocArgs; }
      ...
      scene.text(`"Yeah?" ${((s as any).npcdesc || '')} grins.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} looks more than a little smug after your compliment.`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickTalkTopics(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        ]);
      }
    ...
    scene.text(`"Yeah. I mean, look at this thing," you say, running your fingers along his ${((s as any).dick_desc || '')} shaft. "It's <i>gigantic!</i> How could I <i>not</i> be impressed by a cock like this?"`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickTalkTopics(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ...
    scene.text(`"Size matters," you smirk, running your fingers along his ${((s as any).dick_desc || '')} shaft. "Any girl who tells you otherwise is lying. Bigger is better."`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickTalkTopics(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        ]);
      }
...
function enterWhatsItLikeFuckGirl(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['whats_it_like_fuck_talk'] === 0) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['whats_it_like_fuck_talk'] = 1;
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickGrabImage(s, scene); (s as any).locArgs = __savedLocArgs; }
    ...
    if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'childish') {
      ...
      if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted') {
        ...
        scene.text(`"Hot and wet," ${((s as any).npcdesc || '')} smiles affectionately. "Like having my dick wrapped in warm silk that squeezes me tight and pulls me in. That's what your pussy feels like."`);
      } else {
        // TODO-QSP: dynamic text: "It's... hot," <<$npcdesc>> says.
        scene.text(`"It's... hot," ${((s as any).npcdesc || '')} says.`);
...
function enterHowStayHard(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['sex_stamina'] > 5  &&  ((s as any).sex_ev ?? 0)?.['how_stay_hard_talk'] === 0) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['how_stay_hard_talk'] = 1;
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickGrabImage(s, scene); (s as any).locArgs = __savedLocArgs; }
    if (((s as any).sex_ev ?? 0)?.['cum_count'] <= 5 + ((s as any).sex_ev ?? 0)?.['extra_cum']  &&  ((s as any).sex_ev ?? 0)?.['fucked_out'] === 0) {
      ...
      scene.text(`"I don't understand how you can stay hard without coming for so long," you murmur, marveling at how hard ${((s as any).npcdesc || '')}'s member is inside your grip even now.`);
    } else {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterDickTalkTopics(s, scene); (s as any).locArgs = __savedLocArgs; }
      ...
      if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'perverted') {
        ...
        if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'intellectual') {
          ...
          scene.text(`"I find that if I concentrate on doing multiplication problems, then I don't focus so much on the pleasure and won't come," ${((s as any).npcdesc || '')} says.`);
...
function enterMorningStartDay(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['start_the_day'] === 0  &&  ((s as any).sex_ev ?? 0)?.['wake_fuck'] === 1) {
    ...
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['start_the_day'] = 1;
    scene.img('images/shared/sex/after/pillow_talk1.jpg');
    if (((s as any).npc_sleep_sex_okay ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
      ...
      if (((s as any).npc_humor ?? 0)?.[String((s as any).npcID ?? 0)] === 'intellectual') {
        ...
        scene.text(`"As requested Ms. ${((s as any).pcs_lastname || '')}, your ${((s as any).hour || '')}AM wake up call," ${((s as any).npcdesc || '')} says, doing a mock half-bow.`);
      } else {
        // TODO-QSP: dynamic text: "You really like it when I fuck you while you're sleeping don't you?" <<$npcdesc...
        scene.text(`"You really like it when I fuck you while you're sleeping don't you?" ${((s as any).npcdesc || '')} grins.`);
      }
      scene.actions([
    ...
    ((s as any).npc_sleep_sex_okay = (s as any).npc_sleep_sex_okay ?? {})[String((s as any).npcID ?? 0)] = 2;
    ...
    scene.text(`"Really?" ${((s as any).npcdesc || '')} looks surprised. "You mean I can do that whenever I want?"`);
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMorningSleepFuckOkay(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
...
function enterMorningSorePussy(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['morning_sore_pussy'] === 0  &&  (((s as any).sex_ev ?? 0)?.['morning_fuck'] === 1  ||  ((s as any).sex_ev ?? 0)?.['wake_fuck'] === 1)) {
    ...
    qspCall(s, 'sex_ev_pillow_talk', 'talk_time_add');
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['morning_sore_pussy'] = 1;
    scene.img('images/shared/sex/after/pillow_talk1.jpg');
    if (((s as any).kanikuli ?? 0) === 0  &&  ((s as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((s as any).gschoolVars ?? 0)?.['school_diploma'] === 0  &&  ((s as any).gschoolVars ?? 0)?.['block'] === 0  &&  ((s as any).week ?? 0) < 6) {
    ...
    if (((s as any).kanikuli ?? 0) === 0  &&  ((s as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((s as any).gschoolVars ?? 0)?.['school_diploma'] === 0  &&  ((s as any).gschoolVars ?? 0)?.['block'] === 0  &&  ((s as any).week ?? 0) < 6) {
      ...
      scene.text(`"How am I going to get through my classes today?" you say, giving ${((s as any).npcdesc || '')} a loopy smile. "If I fall asleep in school today, it's your fault."`);
      // TODO-QSP: dynamic text: "I'll take credit for that," <<$npcdesc>> grins.
      scene.text(`"I'll take credit for that," ${((s as any).npcdesc || '')} grins.`);
    } else {
      // TODO-QSP: dynamic text: "We might have overdone it," you say, giving <<$npcdesc>> a loopy smile. "I alre...
      scene.text(`"We might have overdone it," you say, giving ${((s as any).npcdesc || '')} a loopy smile. "I already want to go back to bed."`);
      if (((s as any).npc_day_off ?? 0)?.[String((s as any).npcID ?? 0)] === ((s as any).week ?? 0)) {
...
function enterTalkLateForSchool2(s: GameState, scene: SceneBuilder): void {
  if (((s as any).hour ?? 0) === 7  &&  ((s as any).minut ?? 0) >= 30) {
    ...
    scene.text(`It's only <b>${(String(100 + ((s as any).hour ?? '')).slice((2)-1, ((2)-1)+(2)))}:${(String(100 + ((s as any).minut ?? '')).slice((2)-1, ((2)-1)+(2)))}</b>. Plenty of time to get to school. No need to hurry.`);
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterMorningSexTalk(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
        ]);
      }
    }
...
function enterShareLifeSingle(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pcs_lover ?? 0) + ((s as any).pcs_girlfriends ?? 0) === 0) {
    ...
    scene.text(`"I broke up with my boyfriend," you tell ${((s as any).npcdesc || '')}. "So I guess I'm single now."`);

...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[0] ?? 0) === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A186') : -1) >= 0) {
    if (((s as any).hour ?? 0) >= 6  &&  (((s as any).hour ?? 0) < 18  ||  ((s as any).week ?? 0) === 4  &&  ((s as any).hour ?? 0) < 19)) {
      ((s as any).locat ?? {})['A186'] = 1;
    } else {
      ((s as any).locat ?? {})['A186'] = 2;
    }
  }
  ((s as any).scheduleVars ?? {})['maxi'] = 0;
  if (((s as any).scheduleVars ?? 0)?.['maxi'] > 0) {
    ((s as any).scheduleVars ?? {})['i'] = 0;
    ((s as any).scheduleVars ?? {})['all'] = (((s as any).locArgs?.[0] ?? 0) === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('lover') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('lovers') : -1) >= 0);
    if (((s as any).scheduleVars ?? 0)?.['all']  ||  ((s as any).scheduleVars ?? 0)?.['maxi'] < Object.keys((s as any).ARGS ?? {}).length) {
      // TODO-QSP: :lover_schedules1
      ((s as any).scheduleVars ?? {})['ID'] = qspUntranslated(s, "lover[scheduleVars['i']]", { location: "schedule" });
      ...
      ((s as any).scheduleVars ?? {})['i'] = (((s as any).scheduleVars ?? {})['i'] ?? 0) + (1);
      ...
      ((s as any).scheduleVars ?? {})['index'] = qspUntranslated(s, "arrpos('lover', ARGS[scheduleVars['i']])", { location: "schedule" });

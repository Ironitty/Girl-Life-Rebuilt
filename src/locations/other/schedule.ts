...
function enterCikl(s: GameState, scene: SceneBuilder): void {
  ...
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A4') : -1) >= 0) {
    qspCall(s, 'igor_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A13') : -1) >= 0) {
    qspCall(s, 'lariska_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A14') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('katja') : -1) >= 0) {
    qspCall(s, 'katja_meynold_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A15') : -1) >= 0) {
    qspCall(s, 'vicky_meynold_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A16') : -1) >= 0) {
    qspCall(s, 'natbelEv', 'nat_schedule');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Zvereva') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A18') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Silvestr') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A248') : -1) >= 0) {
    qspCall(s, 'Zvereva_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A23') : -1) >= 0) {
    qspCall(s, 'albina_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A31') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Elene') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('grandparents') : -1) >= 0) {
    qspCall(s, 'gp_elene_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A32') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Zlatek') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('grandparents') : -1) >= 0) {
    qspCall(s, 'gp_zlatek_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Family') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Anya') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A33') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Kolka') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A34') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Mother') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A29') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Stepdad') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A28') : -1) >= 0) {
    qspCall(s, 'family_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A60') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Mira') : -1) >= 0) {
    qspCall(s, 'miroslava_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A84') : -1) >= 0) {
    qspCall(s, 'kendra_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A144') : -1) >= 0) {
    qspCall(s, 'anushka_konstantinov_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A154') : -1) >= 0) {
    qspCall(s, 'radomir_popov_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A156') : -1) >= 0) {
    qspCall(s, 'arkadi_fyodorov_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A158') : -1) >= 0) {
    qspCall(s, 'valentin_bogdanov_schedule', '');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('Hunters') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A172') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A173') : -1) >= 0  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A174') : -1) >= 0) {
    qspCall(s, 'hunter_ambient', 'schedule');
  }
  if (String((s as any).locArgs?.[0] ?? '') === ''  ||  (Array.isArray((s as any).ARGS) ? ((s as any).ARGS as any[]).indexOf('A186') : -1) >= 0) {

  ...
  if (((s as any).pfactor ?? 0) !== 50) {
    ...
    do {
      ...
      if (((s as any).akrand ?? 0) === 1) {
        ((s as any).pactor = (s as any).pactor ?? {})[String((s as any).num ?? 0)] = 'Alexei Radimov';
        ((s as any).pactorID = (s as any).pactorID ?? {})[String((s as any).num ?? 0)] = 'A193';
      } else {
        if (((s as any).akrand ?? 0) === 2) {
          ((s as any).pactor = (s as any).pactor ?? {})[String((s as any).num ?? 0)] = 'Sergei Tatarov';
          ((s as any).pactorID = (s as any).pactorID ?? {})[String((s as any).num ?? 0)] = 'A194';
        } else {
          if (((s as any).akrand ?? 0) === 3) {
            ((s as any).pactor = (s as any).pactor ?? {})[String((s as any).num ?? 0)] = 'Egor Klyuyev';
            ((s as any).pactorID = (s as any).pactorID ?? {})[String((s as any).num ?? 0)] = 'A195';
          } else {
            if (((s as any).akrand ?? 0) === 4) {
              ((s as any).pactor = (s as any).pactor ?? {})[String((s as any).num ?? 0)] = 'Ignat Vedenin';
              ((s as any).pactorID = (s as any).pactorID ?? {})[String((s as any).num ?? 0)] = 'A196';
            } else {
              if (((s as any).akrand ?? 0) === 5) {
                ((s as any).pactor = (s as any).pactor ?? {})[String((s as any).num ?? 0)] = 'Syoma Rodionov';
                ((s as any).pactorID = (s as any).pactorID ?? {})[String((s as any).num ?? 0)] = 'A197';
              } else {
                if (((s as any).akrand ?? 0) === 6) {
                  ((s as any).pactor = (s as any).pactor ?? {})[String((s as any).num ?? 0)] = 'Vasya Harkov';
                  ((s as any).pactorID = (s as any).pactorID ?? {})[String((s as any).num ?? 0)] = 'A198';
                } else {
                  if (((s as any).akrand ?? 0) === 7) {
                    ((s as any).pactor = (s as any).pactor ?? {})[String((s as any).num ?? 0)] = 'Boris Tabrov';
                    ((s as any).pactorID = (s as any).pactorID ?? {})[String((s as any).num ?? 0)] = 'A199';
                  } else {
                    if (((s as any).akrand ?? 0) === 8) {
                      ((s as any).pactor = (s as any).pactor ?? {})[String((s as any).num ?? 0)] = 'Daniel Rasnik';
                      ((s as any).pactorID = (s as any).pactorID ?? {})[String((s as any).num ?? 0)] = 'A200';
                    } else {
                      if (((s as any).akrand ?? 0) === 9) {
                        ((s as any).pactor = (s as any).pactor ?? {})[String((s as any).num ?? 0)] = 'Peter Izratam';
                        ((s as any).pactorID = (s as any).pactorID ?? {})[String((s as any).num ?? 0)] = 'A201';
                      } else {
                        if (((s as any).akrand ?? 0) === 10) {
                          ((s as any).pactor = (s as any).pactor ?? {})[String((s as any).num ?? 0)] = 'Oleg Taburov';
                          ((s as any).pactorID = (s as any).pactorID ?? {})[String((s as any).num ?? 0)] = 'A202';
                        }
                      }
                    }
                  }
...
function enterPornactress(s: GameState, scene: SceneBuilder): void {
  if (((s as any).pfactor ?? 0) !== 50) {
    ...
    do {
      (s as any).akrand = (Math.floor(Math.random() * 10) + 1);
      if (((s as any).akrand ?? 0) === 1) {
        ((s as any).pactress = (s as any).pactress ?? {})[String((s as any).num ?? 0)] = 'Krystal';
        ((s as any).pactressID = (s as any).pactressID ?? {})[String((s as any).num ?? 0)] = 'A207';
      } else {
        if (((s as any).akrand ?? 0) === 2) {
          ((s as any).pactress = (s as any).pactress ?? {})[String((s as any).num ?? 0)] = 'Ash Lee';
          ((s as any).pactressID = (s as any).pactressID ?? {})[String((s as any).num ?? 0)] = 'A234';
        } else {
          if (((s as any).akrand ?? 0) === 3) {
            ((s as any).pactress = (s as any).pactress ?? {})[String((s as any).num ?? 0)] = 'Juliana Slavenka';
            ((s as any).pactressID = (s as any).pactressID ?? {})[String((s as any).num ?? 0)] = 'A235';
          } else {
            if (((s as any).akrand ?? 0) === 4) {
              ((s as any).pactress = (s as any).pactress ?? {})[String((s as any).num ?? 0)] = 'Katrina Valentine';
              ((s as any).pactressID = (s as any).pactressID ?? {})[String((s as any).num ?? 0)] = 'A236';
            } else {
              if (((s as any).akrand ?? 0) === 5) {
                ((s as any).pactress = (s as any).pactress ?? {})[String((s as any).num ?? 0)] = 'Alli Smirnova';
                ((s as any).pactressID = (s as any).pactressID ?? {})[String((s as any).num ?? 0)] = 'A237';
              } else {
                if (((s as any).akrand ?? 0) === 6) {
                  ((s as any).pactress = (s as any).pactress ?? {})[String((s as any).num ?? 0)] = 'Scarlett Rose';
                  ((s as any).pactressID = (s as any).pactressID ?? {})[String((s as any).num ?? 0)] = 'A203';
                }
              }
            }
          }
...
{ label: 'Undress and kneel', handler: (st: GameState) => {
    ...
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
        ...
        scene.actions([
          { label: '', labelFn: (s: GameState) => String(((((st as any).orgasm_buildup ?? 0) < 300 - ((st as any).pcs_inhib ?? 0)) ? ('Block out everything but the pleasure and let yourself orgasm' + qspFunc(s, 'willpower', 'get_willcost_string')) : ('Orgasm')) ?? ''), handler: (st: GameState) => {
    if (((st as any).orgasm_buildup ?? 0) < 300 - ((st as any).pcs_inhib ?? 0)) {
...
{ label: 'Start filming', handler: (st: GameState) => {
    ...
    do {
      ...
      (st as any).gb_bj_count = undefined;
      (st as any).gb_hj_count = undefined;
      (st as any).gb_lip_count = undefined;
      (st as any).gb_anal_count = undefined;
      (st as any).gb_bukk_count = undefined;
      (st as any).gb_sex_count = undefined;
      ...
      if (((st as any).gangOrg ?? 0) > 0) {
        scene.text('During the shoot you managed to ' + ((((st as any).gangOrg ?? 0) === 1) ? ('have one orgasm.') : ('orgasm ' + ((st as any).gangOrg ?? '') + ' times.')));
      }
    ...
    } while (((st as any).gb_counter ?? 0) < 50);
  } },
]);
  return;
  scene.build();

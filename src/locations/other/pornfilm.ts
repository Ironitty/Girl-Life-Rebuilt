...
function enter2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} sits on the bed as the camera starts rolling. You kneel in front of him, take his dick in your hand and start stroking it.`);
    qspCall(s, 'arousal', 'hj', 30, 'exhibitionism');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} grabs your hair in his fists and starts fucking your mouth, driving his cock down your throat with every thrust.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} gives you a nod to let you know he's close, so you start quickly jerking him and stick your tongue out for him to shoot his load.`);
    (s as any).cumnostd = 1;
...
function enter3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} then walks over and sits on the bed. You kneel before him, take his dick in your hand and start stroking it.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} grabs your hair in his fists. He starts intensely fucking your mouth, occasionally withdrawing completely to allow you to catch your breath before returning more vigorously.`);
    ...
    scene.text(`You stand and get on all fours on the edge of the bed. ${((s as any).npcdesc || '')} guides his dick into your pussy and begins to fuck you hard from behind.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} pounds you hard in the missionary position, your legs spread high and wide as you talk dirty for the camera. You hear him panting loudly and feel him pulling out of you, so you slide off the bed and onto your knees in front of him as he shoots his load across your face with a loud grunt.`);
    scene.actions([
      { label: 'Clean his cock', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    qspCall(s, 'arousal', 'end');
...
function enter4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} relaxes as you take control, trying to take the entire length of his cock down your throat.`);
    qspCall(s, 'arousal', 'bj', 5, 'exhibitionism', 'deepthroat');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`You straddle ${((s as any).npcdesc || '')} and guide his dick into your pussy. You begin to ride him hard and really get into it. After a few minutes, he lifts you off his dick, throws you on your back and spreads your legs so he can fuck you missionary-style.`);
    // TODO-QSP: dynamic text: After pounding your pussy in various poses, <<$npcdesc>> pulls his cock out of y...
    scene.text(`After pounding your pussy in various poses, ${((s as any).npcdesc || '')} pulls his cock out of you and gets you on all fours, your ass high in the air. You feel him pressing against your anus.`);
    (s as any).cumnostd = 1;
    qspCall(s, 'cum_call', 'precum', ((s as any).npcID ?? 0), 1, 0, 10000, 1);
    ...
    scene.text(`You try your best to relax as ${((s as any).npcdesc || '')} pushes into your ass and immediately goes at it like a jackhammer. He pulls out a few times to let you recover, the camera coming in for shots of your stretched hole each time before he plunges his dick back inside you.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} grabs you by the hips and really starts pounding your ass. Just as it's starting to hurt, he pulls out of your ass and you quickly turn and kneel before him. He vigorously jerks his dick, and his cum soon splatters your face and your tongue.`);
    (s as any).cumnostd = 1;
    qspCall(s, 'cum_call', 'mouth_swallow', ((s as any).npcID ?? 0), 1, 0, 0, 36);
    qspCall(s, 'cum_call', 'face', ((s as any).npcID ?? 0), 1, 0, 0, 4);
    scene.actions([
...
function enter5(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You get into position kneeling before ${((s as any).npcdesc || '')} and ${((s as any).npcdesc1 || '')}. When the camera starts rolling, they slap their fully erect cocks against your face.`);
    ...
    scene.text(`The men get you on all fours, and ${((s as any).npcdesc || '')} slides his dick into your pussy. At the same time, you continue to suck ${((s as any).npcdesc1 || '')}'s dick.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} takes his cock out of your pussy and plunges it into your ass. The extra tightness quickly overwhelms him. After a few minutes in your ass, you feel him unloading inside you with a loud grunt.`);
    // TODO-QSP: dynamic text: You keep sucking <<$npcdesc1>>, who sounds like he is also close to climax.
    scene.text(`You keep sucking ${((s as any).npcdesc1 || '')}, who sounds like he is also close to climax.`);
    (s as any).cumnostd = 1;
    ...
    scene.text(`You're about to move around to clean up ${((s as any).npcdesc || '')} when ${((s as any).npcdesc1 || '')} grabs your head and shoots his load across your face. The two men say the most depraved things as cum slowly trickles down your face and out of your asshole.`);
...
function enter6(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You get on all fours and ${((s as any).npcdesc || '')} fucks you from behind while you suck ${((s as any).npcdesc1 || '')}'s dick.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} switches it up and sticks his cock into your ass while you keep sucking ${((s as any).npcdesc1 || '')}.`);
    // TODO-QSP: dynamic text: <<$npcdesc>> is really getting into it and is vigorously pounding your asshole.
    scene.text(`${((s as any).npcdesc || '')} is really getting into it and is vigorously pounding your asshole.`);
    qspCall(s, 'arousal', 'bj', (-15), ((s as any).npcID1 ?? 0), 'exhibitionism', 'group');
    ...
    scene.text(`${((s as any).npcdesc || '')} takes his dick out of your ass and lies down. Then, knowing ${((s as any).npcdesc || '')} wants more, you straddle his cock.`);
    // TODO-QSP: dynamic text: You feel his cock fill your pussy while <<$npcdesc1>> moves in behind you and pu...
    scene.text(`You feel his cock fill your pussy while ${((s as any).npcdesc1 || '')} moves in behind you and pushes his dick into your ass.`);
    ...
    scene.text(`The guys tell you they're close and both pull out. You grab ${((s as any).npcdesc || '')}'s dick and start sucking it.`);
    // TODO-QSP: dynamic text: As you suck his dick, your head is suddenly grabbed and you're turned around. <<...
    scene.text(`As you suck his dick, your head is suddenly grabbed and you're turned around. ${((s as any).npcdesc1 || '')} shoots his load across your face and into your mouth, ${((s as any).npcdesc || '')} following him close behind.`);
...
function enter7(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You start by teasing the camera. You play with your tits and show off your pussy before ${((s as any).npcdesc || '')} walks up. You kneel between his legs, take his shaft into your mouth and start passionately sucking his dick.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} grabs your hips, throws you on the couch and climbs on top of you. You feel him slide into your pussy, and he begins to fuck you hard.`);
    ...
    scene.text(`You're really getting into it and your pussy tightens around ${((s as any).npcdesc || '')}, which sends him over the edge. You soon feel yourself being filled with a considerable amount of cum.`);
    // TODO-QSP: dynamic text: He climbs off you, but you stay on the couch while the camera comes forward to f...
    scene.text(`He climbs off you, but you stay on the couch while the camera comes forward to film your pussy as you squeeze ${((s as any).npcdesc || '')}'s load out. Finally, after a few minutes, the director nods and you get up.`);
    qspCall(s, 'arousal', 'vaginal', 5, 'exhibitionism');
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Take a shower', goto: ['pornstudio', 'shower'] },
...
function enter8(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((!(Math.floor(Math.random() * 2) + 0))) {
      ...
      scene.text(`${((s as any).npcdesc || '')} lays on the bed, and you climb on top of him, sliding his cock into your pussy and waiting until ${((s as any).npcdesc1 || '')} pushes into your ass. ${((s as any).npcdesc1 || '')} starts enthusiastically fucking your ass, making you ride ${((s as any).npcdesc || '')}'s dick. They fuck you like this for a while before spending time repositioning you into various poses and fucking both your holes. Finally, after getting fucked in multiple positions, the director signals to the guys that they should cum inside you.`);
      ...
      scene.text(`${((s as any).npcdesc1 || '')} lays on the bed, and you climb on top of him, sliding his cock into your pussy and waiting until ${((s as any).npcdesc || '')} pushes into your ass. ${((s as any).npcdesc || '')} starts enthusiastically fucking your ass, making you ride ${((s as any).npcdesc1 || '')}'s dick. They fuck you like this for a while before spending time repositioning you into various poses and fucking both your holes. Finally, after getting fucked in multiple positions, the director signals to the guys that they should cum inside you.`);
...
function enter9(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You're sucking ${((s as any).npcdesc1 || '')}'s dick when he grabs your hair for leverage and starts face fucking you. After a while, the director gestures for you to move on to the next scene, so he releases you and urges you to push your ass out.`);
    ...
    if ((!(Math.floor(Math.random() * 2) + 0))) {
      ...
      scene.text(`You get in position before ${((s as any).npcdesc1 || '')} and start sucking him while ${((s as any).npcdesc || '')} fucks your pussy. He fucks you enthusiastically, making you swallow ${((s as any).npcdesc1 || '')}'s dick. They fuck you like this and in several other poses and take turns switching between your mouth and pussy before the director signals that it's time for the finale.`);
      qspCall(s, 'arousal', 'vaginal', 25, ((s as any).npcID ?? 0), 'exhibitionism', 'group');
      ...
      scene.text(`You get in position before ${((s as any).npcdesc || '')} and start sucking him while ${((s as any).npcdesc1 || '')} fucks your pussy. He fucks you enthusiastically, making you swallow ${((s as any).npcdesc || '')}'s dick. They fuck you like this and in several other poses and take turns switching between your mouth and pussy before the director signals that it's time for the finale.`);
      qspCall(s, 'arousal', 'vaginal', 25, ((s as any).npcID1 ?? 0), 'exhibitionism', 'group');
...
function enter10(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter4GuyBlowJerkBreastCuni(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Fuck them', handler: (st: GameState) => {
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter4GuyBlowJerkVaginal(s, scene); (s as any).locArgs = __savedLocArgs; }
    (s as any).cumnostd = 1;
    qspCall(s, 'cum_call', 'precum', ((s as any).npcID ?? 0), 1, 0, 10000, 1);
    (s as any).cumnostd = 1;
    qspCall(s, 'cum_call', 'precum', ((s as any).npcID1 ?? 0), 1, 0, 10000, 1);
    ...
    if ((Math.floor(Math.random() * 6) + 0) > 0) {
      ...
      scene.text(`${((s as any).npcdesc || '')} is fucking you when he suddenly groans and pulls out, coating your labia with his load of cum. You look up at him seductively while biting your lip, a look of satisfied pleasure on his face.`);
      ...
      scene.text(`${((s as any).npcdesc || '')} is fucking you when he suddenly groans and pulls his dick out of your pussy, but messes up when his first shot of cum shoots straight into your open pussy. He quickly corrects his aim, and the others coat your labia.`);
      (s as any).cumnostd = 1;
    ...
    scene.text(`Once he's done, he's replaced by ${((s as any).npcdesc1 || '')}, who quickly penetrates you and starts thrusting.`);
    if ((Math.floor(Math.random() * 6) + 0) > 0) {
      ...
      scene.text(`Reaching climax, ${((s as any).npcdesc1 || '')} groans and pulls out, aiming his dick at your tits. He jerks his dick, and you look down to see hot cum splattering over your tits. You giggle and smile as you squeeze your cum covered tits in your hands.`);
      ...
      scene.text(`Reaching climax, ${((s as any).npcdesc1 || '')} groans and pulls out. He aims at your tits, but his first shot hits you straight in the face. He quickly corrects his aim, and the rest of his cum coats your tits.`);
      (s as any).cumnostd = 1;
    ...
    scene.text(`Once he's done, he's replaced by ${((s as any).npcdesc2 || '')}, who moves in and starts pounding your pussy hard.`);
    if ((Math.floor(Math.random() * 6) + 0) > 0) {
      ...
      scene.text(`${((s as any).npcdesc2 || '')} is pounding you hard. He reaches climax rather quickly but doesn't pull out fast enough. His first shot of cum shoots straight into your open pussy, and the rest splatters over your already-covered labia.`);
      (s as any).cumnostd = 1;
    ...
    scene.text(`Once he's done, he's replaced by ${((s as any).npcdesc3 || '')}, the last of the men.`);
    if ((Math.floor(Math.random() * 6) + 0) > 0) {
      ...
      scene.text(`${((s as any).npcdesc3 || '')} fucks you for only a few minutes before he groans and pulls out, coating your belly with his cum.`);
      ...
      scene.text(`${((s as any).npcdesc3 || '')} fucks you for a few minutes before he pulls out but messes up when his first shot of cum shoots straight into your open pussy. He quickly corrects his aim, and the rest splatter across your stomach.`);
      (s as any).cumnostd = 1;
...
function enter12(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter4GuyBlowJerkAnal(s, scene); (s as any).locArgs = __savedLocArgs; }
    qspCall(s, 'stat', '');
    scene.actions([
...
function enter13(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).orgasm_buildup ?? 0) < 200 - ((s as any).pcs_inhib ?? 0)) {
      ...
      scene.text(`${((s as any).npcdesc || '')} lies on the bed, and you slide down onto his dick, moaning as it stretches your pussy. ${((s as any).npcdesc1 || '')} steps behind you and pushes his dick inside your already-occupied vagina. The two guys start fucking you in tandem. When the director signals, they start fucking you more forcefully, and thanks to their timing, they cum inside you at the same time.`);
      ...
      scene.img('images/locations/city/redlight/studio_porn/sex/porgasm.mp4');
      // TODO-QSP: dynamic text: <<$npcdesc>> lies on the bed, and you slide down onto his dick, moaning as it st...
      scene.text(`${((s as any).npcdesc || '')} lies on the bed, and you slide down onto his dick, moaning as it stretches your pussy. Then, ${((s as any).npcdesc1 || '')} steps behind you and pushes his dick inside your already-occupied vagina. The two guys start fucking you in tandem. When the director signals, they start fucking you more forcefully, and thanks to their timing, they cum inside you at the same time.`);
    ...
    scene.text(`Cum leaks from your pussy as ${((s as any).npcdesc || '')} and ${((s as any).npcdesc1 || '')} pull out and let ${((s as any).npcdesc2 || '')} and ${((s as any).npcdesc3 || '')} replace them. You give them a quick blowjob before ${((s as any).npcdesc2 || '')} lies on the bed and pulls you on top of him, sliding his cock into your ass. ${((s as any).npcdesc3 || '')} moves in behind and inserts his dick into your already stretched hole. Despite the tightness, the guys quickly find a rhythm.`);
    if (((s as any).orgasm_buildup ?? 0) < 200 - ((s as any).pcs_inhib ?? 0)) {
      scene.actions([
        { label: 'Fake orgasm', handler: (st: GameState) => {
    scene.img('images/locations/city/redlight/studio_porn/sex/porgasm.mp4');
...
function enter14(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).gb_roll ?? 0) === 1) {
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter14GbBj(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      if (((s as any).gb_roll ?? 0) === 2) {
        { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter14GbHj(s, scene); (s as any).locArgs = __savedLocArgs; }
      } else {
        if (((s as any).gb_roll ?? 0) === 3) {
          { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter14GbLip(s, scene); (s as any).locArgs = __savedLocArgs; }
        } else {
          if (((s as any).gb_roll ?? 0) === 4) {
            { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter14GbAnal(s, scene); (s as any).locArgs = __savedLocArgs; }
          } else {
            if (((s as any).gb_roll ?? 0) === 5) {
              { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter14GbBukk(s, scene); (s as any).locArgs = __savedLocArgs; }
            } else {
              { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enter14GbSex(s, scene); (s as any).locArgs = __savedLocArgs; }
            }
          }
        }
      }
...
function enter15(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`The scene starts with you giving a camera a striptease and bending over to provide a close-up view of your asshole. You then finger your ass and use a dildo to fuck yourself before ${((s as any).npcdesc || '')} walks over.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} grabs your hair in his fists and begins to fuck your mouth, driving his cock down your throat with every thrust.`);
    scene.text('After a few minutes, he takes his cock out, and you wipe the saliva from your mouth.');
    qspCall(s, 'arousal', 'bj', 15, 'exhibitionism');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} sits on the bed, and you turn around, presenting your ass to him. He slaps and squeezes your ass a few times before you start grinding his cock between your ass cheeks, your saliva coating your asshole. ${((s as any).npcdesc || '')} then guides his cock to your now wet hole and slowly penetrates you, both of you groaning as he slides inside you.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} enjoys the tightness as you ride his dick, occasionally sliding it out to show both ${((s as any).npcdesc || '')} and the camera your stretched hole. This continues for a while before it starts hurting, and you pull out to suck his dick for a few minutes to let your ass recover.`);
    // TODO-QSP: dynamic text: You then get on all fours, and <<$npcdesc>> slides back inside you and resumes f...
    scene.text(`You then get on all fours, and ${((s as any).npcdesc || '')} slides back inside you and resumes fucking your ass. You get ass fucked in various positions, with breaks being called to let you rest or ${((s as any).npcdesc || '')} get hard again.`);
    qspCall(s, 'arousal', 'anal', 15, 'exhibitionism');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`You're really getting into it and let out a pleasured moan as your ass tightens around ${((s as any).npcdesc || '')}'s cock, which sends him over the edge. You suddenly feel his cock twitching inside you as your bowels are flooded with warm cum.`);
    // TODO-QSP: dynamic text: You climb off <<$npcdesc>> and bend over on all fours as the camera moves in beh...
    scene.text(`You climb off ${((s as any).npcdesc || '')} and bend over on all fours as the camera moves in behind you. Your well fucked hole lets out a loud squelch as you squeeze the cum from your ass. The director seems satisfied with the scene and ends the shoot.`);
    qspCall(s, 'arousal', 'anal', 5, 'exhibitionism');
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Take a shower', goto: ['pornstudio', 'shower'] },
...
function enter16(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`The scene starts with you giving a camera a striptease and getting on all fours on a sofa to provide it with a close-up view of your pussy and asshole. You then finger your ass before ${((s as any).npcdesc || '')} walks over.`);
    // TODO-QSP: dynamic text: <<$npcdesc>> sits on the sofa next to you. You kneel beside him, take his dick i...
    scene.text(`${((s as any).npcdesc || '')} sits on the sofa next to you. You kneel beside him, take his dick in your hand and start jerking it while making out with him.`);
    qspCall(s, 'arousal', 'striptease', 5);
    qspCall(s, 'arousal', 'hj', 25, 'exhibitionism');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`${((s as any).npcdesc || '')} is now rock-hard in your hand, so you bend over and start passionately sucking his dick while he leans over and plays with your ass.`);
    qspCall(s, 'arousal', 'bj', 5, 'exhibitionism');
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`After sucking his dick for a few minutes, you get up and seductively walk over to a nearby table. You lie down on the table and spread your ass for ${((s as any).npcdesc || '')}, who walks over and starts rimming you, expertly flicking his tongue over your hole.`);
    ...
    scene.text(`Your asshole now wet and ready, ${((s as any).npcdesc || '')} fingers you before standing and inserting his dick. He starts fucking you hard, occasionally pulling out to show your gaping asshole to the camera.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} starts fucking your ass fast and hard as you talk dirty to him and the camera. Finally, he starts panting, and just as he's about to cum, he pulls out and shoots his load over your ass.`);
    scene.actions([
      { label: 'Clean his cock', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
...
function enter17(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`The scene starts with you playing with ${((s as any).npcdesc || '')}'s ass. You give her a firm slap on the rear and tease the camera by slowly pulling her panties halfway down before pulling them up again. You then quickly pull them down again, this time to her ankles. She gives the camera a view of her pussy and asshole before you push her onto the bed in front of you.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} stops her movements and reaches over to grab a sizeable, doubled-headed dildo. She sucks on one end and slides it into your pussy. The toy is buried firmly in your hole, and she slides down onto the other end. She then starts to ride the dildo, her movements pushing it deeper into your pussy.`);
    ...
    scene.text(`${((s as any).npcdesc || '')} reaches her climax as she slams down on the dildo, sending it deep into her pussy. Her body is pleased as her juices run down the shaft of the dildo and onto your pussy. Finally, she withdraws the dildo from her pussy and pulls it out of you. You both suck the ends of it clean.`);
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Take a shower', goto: ['pornstudio', 'shower'] },
    ]);
...
function enter18(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.img('images/locations/city/redlight/studio_porn/sex/lesbo0.mp4');
    // TODO-QSP: dynamic text: The scene starts with you playing with <<$npcdesc>>'s ass. You give her a firm s...
    scene.text(`The scene starts with you playing with ${((s as any).npcdesc || '')}'s ass. You give her a firm slap on the rear and tease the camera by slowly pulling her panties halfway down before pulling them up again. You then quickly pull them down, this time to her ankles. She gives the camera a view of her pussy and asshole before you push her onto the bed in front of you.`);
    qspCall(s, 'arousal', 'foreplay_give', 5, 'exhibitionism');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Eat her pussy', handler: (st: GameState) => {
    ...
    scene.text(`You are lying on the bed as ${((s as any).npcdesc || '')} moves off to the side and slips on a strap-on dildo. She moves over to you as you slide down, take the plastic cock in your mouth and give her a blowjob before she pushes you down onto the bed and climbs on top of you. She slides inside your pussy and begins to fuck you hard.`);
    ...
    scene.text(`The relentless ass fucking you give ${((s as any).npcdesc || '')} is enough to bring her to orgasm. Her juices spray from her twitching pussy as her ass tightens around your fake cock. You pull out of her and the camera comes in for a shot of her stretched hole. The scene ends with you locking tongues with ${((s as any).npcdesc || '')}.`);
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Take a shower', goto: ['pornstudio', 'shower'] },
    ]);
...
function enter19(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`The camera starts rolling and comes for a close-up of you and ${((s as any).npcdesc1 || '')}. As it does, she grabs your ass and gives it a jiggle for the camera. Then, ${((s as any).npcdesc || '')} moves into the scene, and you both kneel before him.`);
    scene.actions([
    ...
    scene.text(`You take ${((s as any).npcdesc || '')}'s cock into your mouth and begin sucking on his tip as ${((s as any).npcdesc1 || '')}t runs her tongue along his shaft. You then take him deeper into your throat as ${((s as any).npcdesc1 || '')} playfully sucks on his balls.`);
    ...
    scene.text(`${((s as any).npcdesc1 || '')} remains on her knees as you move up and guide ${((s as any).npcdesc || '')}'s cock into your pussy. You start riding him as ${((s as any).npcdesc1 || '')} buries her face in your pussy and quickly starts flicking her tongue over your clit, causing waves of pleasure to overwhelm you.`);
    ...
    scene.text(`${((s as any).npcdesc1 || '')} gets up from the floor and lies down on the bed. You straddle her, your pussy sitting before her face as ${((s as any).npcdesc || '')} moves in behind and slowly pushes his cock into your ass. ${((s as any).npcdesc1 || '')} playfully licks your swollen clit as he starts fucking your ass hard.`);
    ...
    scene.text(`You eventually feel ${((s as any).npcdesc || '')} starting to twitch and feel a sudden warmth flood your ass. When he pulls out, a stream of cum soon follows, running down your pussy and into ${((s as any).npcdesc1 || '')}'s awaiting mouth.`);
    (s as any).cumnostd = 1;
    ...
    scene.text(`You quickly climb off ${((s as any).npcdesc1 || '')} and kneel before her as she opens her mouth, and ${((s as any).npcdesc || '')}'s load drools from her tongue and into your mouth. You show the camera your cum filled mouth before swallowing the cum and finishing the scene making out with ${((s as any).npcdesc1 || '')}.`);
    (s as any).cumnostd = 1;
...
function enter20(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`The camera starts rolling and comes for a close-up of you and ${((s as any).npcdesc1 || '')}. You grab her ass and give it a jiggle for the camera as it does. Then, ${((s as any).npcdesc || '')} moves into the scene, and you both kneel before him.`);
    scene.actions([
      { label: 'Suck', handler: (st: GameState) => {
    scene.img('images/locations/city/redlight/studio_porn/sex/mff1.mp4');
    // TODO-QSP: dynamic text: <<$npcdesc1>> wastes no time and takes <<$npcdesc>>'s cock down her throat as yo...
    scene.text(`${((s as any).npcdesc1 || '')} wastes no time and takes ${((s as any).npcdesc || '')}'s cock down her throat as you get down low and suck his balls.`);
    qspCall(s, 'arousal', 'bj', 15, ((s as any).npcID ?? 0), 'exhibitionism', 'group');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Fuck', handler: (st: GameState) => {
    ...
    scene.text(`You remain on your knees as ${((s as any).npcdesc1 || '')} straddles ${((s as any).npcdesc || '')}, slides down onto his cock and starts riding him as you take your place and bury your face into her pussy, running your tongue over her clit as she takes ${((s as any).npcdesc || '')} deep inside her. She shrieks in pleasure, and you're sure she orgasms at least once.`);
    ...
    scene.text(`You lie down on the bed, ${((s as any).npcdesc1 || '')} straddling you, her glistening pussy begging you to please it. ${((s as any).npcdesc || '')} moves in behind, inserts himself into her ass, and starts to pound her, ${((s as any).npcdesc1 || '')} begging him to go harder. You start flicking your tongue over ${((s as any).npcdesc1 || '')}'s now massively engorged clit.`);
    qspCall(s, 'arousal', 'cuni_give', 15, ((s as any).npcID1 ?? 0), 'exhibitionism', 'group', 'lesbian');
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Creampie', handler: (st: GameState) => {
    ...
    scene.text(`You pull your face out of ${((s as any).npcdesc1 || '')}'s crotch in time to see ${((s as any).npcdesc || '')}'s balls twitching as he unloads inside her ass. At the same time, you see her pussy convulsing, and she screams in pleasure as they reach orgasm together. You open your mouth as he pulls out of her, and a stream of cum runs from her hole down onto your tongue.`);
    (s as any).cumnostd = 1;
    ...
    scene.text(`${((s as any).npcdesc1 || '')} climbs off and kneels in front of you as you open your mouth and allow ${((s as any).npcdesc || '')}'s load to drool from your tongue and into her mouth. She then shows her cum filled mouth to the camera and makes a somewhat perverted show of swallowing it. The scene ends with the two of you making out.`);

...
function enterSorted(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'main') {
    if (! ((s as any).loc ?? 0)(((s as any).shop_display ?? 0)?.['func_file'])) {
      return;
    }
    if (! ((s as any).loc ?? 0)(((s as any).shop_display ?? 0)?.['view_file'])) {
      return;
    }
    ((s as any).shop_display ?? {})['type_i'] = 0;
    // TODO-QSP: :type_loop_sorted
    if (((s as any).shop_display ?? 0)?.['type_i'] < Object.keys((s as any).shop_display_types ?? {}).length) {
      ((s as any).shop_display ?? {})['type'] = qspUntranslated(s, "shop_display_types[shop_display['type_i']]", { location: "shop_utils" });
      // TODO-QSP: gs $shop_display['func_file'], 'totals', $shop_display['type']
      ((s as any).shop_display ?? {})['number'] = 1 + ((s as any).shop_display ?? {})?.['offset'];
      ...
      if (((s as any).shop_display ?? 0)?.['number'] <= ((s as any).total ?? 0)) {
        if (((s as any).shop_display_exceptions ?? 0)[((s as any).shop_display ?? 0)?.['type'] + ((s as any).shop_display ?? 0)?.['type_suffix'] + '-' + ((s as any).shop_display ?? 0)?.['number']] === 0) {
          if ((0 as any)) {
            ((s as any).shop_display ?? {})['shop'] = ((((s as any).shop_display ?? 0)?.['type']).slice((1)-1, ((1)-1)+(((((s as any).shop_display ?? {})?.['type'] + '_').indexOf(('_'))) + 1 - 1)));
        ...
        ((s as any).shop_display ?? {})['number'] = (((s as any).shop_display ?? {})['number'] ?? 0) + (((s as any).shop_display ?? 0)?.['step']);
        // TODO-QSP: jump 'main_loop_sorted'
      }
      ((s as any).shop_display ?? {})['type_i'] = (((s as any).shop_display ?? {})['type_i'] ?? 0) + (1);
      // TODO-QSP: jump 'type_loop_sorted'
    }
    ((s as any).shop_display ?? {})['unused_type_i'] = ((s as any).shop_display ?? 0)?.['type_i'];
    ((s as any).shop_display ?? {})['item_i'] = 0;
    // TODO-QSP: :item_loop_sorted
    if (((s as any).shop_display ?? 0)?.['item_i'] < Object.keys((s as any).shop_display_items ?? {}).length) {
      ((s as any).shop_display ?? {})['item_entry'] = qspUntranslated(s, "shop_display_items[shop_display['item_i']]", { location: "shop_utils" });
      ((s as any).shop_display ?? {})['sep_index'] = ((((s as any).shop_display ?? 0)?.['item_entry']).indexOf(('-'))) + 1;
      ((s as any).shop_display ?? {})['type'] = ((((s as any).shop_display ?? 0)?.['item_entry']).slice((1)-1, ((1)-1)+(((s as any).shop_display ?? {})?.['sep_index'] - 1)));
      ((s as any).shop_display ?? {})['number'] = parseFloat(((((s as any).shop_display ?? 0)?.['item_entry']).slice((((s as any).shop_display ?? {})?.['sep_index'] + 1)-1)));
      if ((0 as any)) {
        ((s as any).shop_display ?? {})['shop'] = ((((s as any).shop_display ?? {})?.['type'] + '_').slice((1)-1, ((1)-1)+(((((s as any).shop_display ?? 0)?.['type']).indexOf(('_'))) + 1 - 1)));
        if ((Array.isArray((s as any).shop_display_sorted_titles) ? ((s as any).shop_display_sorted_titles as any[]).indexOf(((s as any).shop_display ?? 0)?.['shop']) : -1) < 0) {
          // TODO-QSP: $shop_display_sorted_titles[] = $shop_display['shop']
          // TODO-QSP: $shop_display_sorted['number_' + shop_display['unused_type_i'] + '_title'] = $shop_display['shop']
          ((s as any).shop_display ?? {})['type_i'] = ((s as any).shop_display ?? 0)?.['unused_type_i'];
          ((s as any).shop_display ?? {})['unused_type_i'] = (((s as any).shop_display ?? {})['unused_type_i'] ?? 0) + (1);
        } else {
          ((s as any).shop_display ?? {})['type_i'] = qspUntranslated(s, "arrpos('shop_display_types', shop_display['type'])", { location: "shop_utils" });
      ...
      ((s as any).shop_display ?? {})['item_i'] = (((s as any).shop_display ?? {})['item_i'] ?? 0) + (1);
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'add_to_number') {
    ...
    ((s as any).shop_display_sorted ?? {})['number_' + String((s as any).ARGS[4] || '') + '_index'] = (((s as any).shop_display_sorted ?? {})['number_' + String((s as any).ARGS[4] || '') + '_index'] ?? 0) + (1);
    ((s as any).shop_display_sorted ?? {})['max_number'] = qspUntranslated(s, "max(shop_display_sorted['max_number'], ARGS[4])", { location: "shop_utils" });
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'add_to_quality') {
    ...
    ((s as any).shop_display_sorted ?? {})['quality_' + String((s as any).ARGS[4] || '') + '_index'] = (((s as any).shop_display_sorted ?? {})['quality_' + String((s as any).ARGS[4] || '') + '_index'] ?? 0) + (1);
    ((s as any).shop_display_sorted ?? {})['max_quality'] = qspUntranslated(s, "max(shop_display_sorted['max_quality'], ARGS[4])", { location: "shop_utils" });
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'add_to_inhibition') {
    ...
    ((s as any).shop_display_sorted ?? {})['inhibition_' + String((s as any).ARGS[4] || '') + '_index'] = (((s as any).shop_display_sorted ?? {})['inhibition_' + String((s as any).ARGS[4] || '') + '_index'] ?? 0) + (1);
    ((s as any).shop_display_sorted ?? {})['max_inhibition'] = qspUntranslated(s, "max(shop_display_sorted['max_inhibition'], ARGS[4])", { location: "shop_utils" });
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'add_to_heelsize') {
    ...
    ((s as any).shop_display_sorted ?? {})['heelsize_' + String((s as any).ARGS[4] || '') + '_index'] = (((s as any).shop_display_sorted ?? {})['heelsize_' + String((s as any).ARGS[4] || '') + '_index'] ?? 0) + (1);
    ((s as any).shop_display_sorted ?? {})['max_heelsize'] = qspUntranslated(s, "max(shop_display_sorted['max_heelsize'], ARGS[4])", { location: "shop_utils" });
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'add_to_price') {
    ((s as any).ARGS ?? {})[5] = qspFunc(s, 'shop_utils', 'get_discount', ((s as any).locArgs?.[2] ?? 0), qspUntranslated(s, "ARGS[3]", { location: "shop_utils" }));
    ((s as any).ARGS ?? {})[4] = ((s as any).ARGS ?? 0)[4] * (100 - ((s as any).ARGS ?? 0)[5]) / 5000 * 50;
    ...
    ((s as any).shop_display_sorted ?? {})['price_' + String((s as any).ARGS[4] || '') + '_index'] = (((s as any).shop_display_sorted ?? {})['price_' + String((s as any).ARGS[4] || '') + '_index'] ?? 0) + (1);
    ((s as any).shop_display_sorted ?? {})['discount_' + String((s as any).ARGS[5] || '') + '_index'] = (((s as any).shop_display_sorted ?? {})['discount_' + String((s as any).ARGS[5] || '') + '_index'] ?? 0) + (1);
    ((s as any).shop_display_sorted ?? {})['max_price'] = qspUntranslated(s, "max(shop_display_sorted['max_price'], ARGS[4])", { location: "shop_utils" });
    ((s as any).shop_display_sorted ?? {})['max_discount'] = qspUntranslated(s, "max(shop_display_sorted['max_discount'], ARGS[5])", { location: "shop_utils" });
    return;
  }
  return;
  // TODO-QSP: end
...
function enterDisplay(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'init') {
    ((s as any).shop_display ?? {})['display_func'] = ((s as any).locArgs?.[2] ?? 0);
    ((s as any).shop_display ?? {})['do_shop_title'] = qspUntranslated(s, "ARGS[3]", { location: "shop_utils" });
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'main') {
    if (((s as any).outfitfilter ?? 0)?.['number_sort']) {
      ((s as any).shop_display ?? {})['sort_type'] = 'number';
    } else {
      if (((s as any).outfitfilter ?? 0)?.['quality_sort']) {
        ((s as any).shop_display ?? {})['sort_type'] = 'quality';
      } else {
        if (((s as any).outfitfilter ?? 0)?.['inhibition_sort']) {
          ((s as any).shop_display ?? {})['sort_type'] = 'inhibition';
        } else {
          if (((s as any).outfitfilter ?? 0)?.['heelsize_sort']) {
            ((s as any).shop_display ?? {})['sort_type'] = 'heelsize';
          } else {
            if (((s as any).outfitfilter ?? 0)?.['price_sort']) {
              ((s as any).shop_display ?? {})['sort_type'] = 'price';
            } else {
              if (((s as any).outfitfilter ?? 0)?.['discount_sort']) {
                ((s as any).shop_display ?? {})['sort_type'] = 'discount';
              } else {
                ((s as any).outfitfilter ?? {})['number_sort'] = 1;
                ((s as any).shop_display ?? {})['sort_type'] = 'number';
              }
    ...
    if (((s as any).outfitfilter ?? 0)?.['sort_direction'] === 0) {
      ((s as any).shop_display ?? {})['j'] = 0;
      ((s as any).shop_display ?? {})['j_inc'] = 1;
      ((s as any).shop_display ?? {})['j_max'] = ((s as any).shop_display_sorted ?? 0)?.['max_' + ((s as any).shop_display ?? {})?.['sort_type']];
    } else {
      ((s as any).shop_display ?? {})['j'] = ((s as any).shop_display_sorted ?? 0)?.['max_' + ((s as any).shop_display ?? {})?.['sort_type']];
      ((s as any).shop_display ?? {})['j_inc'] = (-1);
      ((s as any).shop_display ?? {})['j_max'] = 0;
    }
    // TODO-QSP: :display_filter_loop
    if (((s as any).shop_display ?? 0)?.['do_shop_title']  &&  ((s as any).shop_display ?? 0)?.['sort_type'] === 'number') {
      ((s as any).shop_display ?? {})['shop_header'] = ((s as any).shop_display_sorted ?? 0)?.['number_\' + shop_display[\'j\'] + \'_title'];
      if (((s as any).shop_display ?? 0)?.['shop_header'] !== '') {
      }
    }
    ((s as any).shop_display ?? {})['i'] = 0;
    // TODO-QSP: :main_display_loop
    ((s as any).shop_display ?? {})['type'] = ((s as any).shop_display_sorted ?? 0)?.[((s as any).shop_display ?? {})?.['sort_type'] + '_' + ((s as any).shop_display ?? {})?.['j'] + '_type_' + ((s as any).shop_display ?? {})?.['i']];
    ((s as any).shop_display ?? {})['number'] = ((s as any).shop_display_sorted ?? 0)?.[((s as any).shop_display ?? {})?.['sort_type'] + '_' + ((s as any).shop_display ?? {})?.['j'] + '_number_' + ((s as any).shop_display ?? {})?.['i']];
    if (((s as any).shop_display ?? 0)?.['type'] !== ''  &&  ((s as any).shop_display ?? 0)?.['number'] !== 0) {
      ...
      ((s as any).shop_display ?? {})['i'] = (((s as any).shop_display ?? {})['i'] ?? 0) + (1);
      // TODO-QSP: jump 'main_display_loop'
    }
    ((s as any).shop_display ?? {})['j'] = (((s as any).shop_display ?? {})['j'] ?? 0) + (((s as any).shop_display ?? 0)?.['j_inc']);
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'grid_shop') {
    qspCall(s, 'shop_utils', 'display', 'init', 'grid_shop', 0);
    qspCall(s, 'shop_utils', 'display', 'main');
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'grid_wardrobe') {
    qspCall(s, 'shop_utils', 'display', 'init', 'grid_wardrobe', 1);
    qspCall(s, 'shop_utils', 'display', 'main');
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'list_wardrobe') {
    qspCall(s, 'shop_utils', 'display', 'init', 'list_wardrobe', 0);
    qspCall(s, 'shop_utils', 'display', 'main');
    return;
  }
  return;
...
function enterGetDiscount(s: GameState, scene: SceneBuilder): void {
  ((s as any).ARGS ?? {})[1] = qspFunc(s, 'string', 'hash', ((s as any).locArgs?.[1] ?? 0));
  ((s as any).ARGS ?? {})[3] = ((s as any).Clothingstock ?? 0)?.[1 + (293 + (((s as any).ARGS ?? 0)[1] + ((s as any).ARGS ?? 0)[2]) % 293) % 293];
...
function enterFilter(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'reset_sorting') {
    ((s as any).outfitfilter ?? {})['number_sort'] = 0;
    ((s as any).outfitfilter ?? {})['quality_sort'] = 0;
    ((s as any).outfitfilter ?? {})['inhibition_sort'] = 0;
    ((s as any).outfitfilter ?? {})['heelsize_sort'] = 0;
    ((s as any).outfitfilter ?? {})['price_sort'] = 0;
    ((s as any).outfitfilter ?? {})['discount_sort'] = 0;
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'set_pass') {
    ((s as any).outfitfilter ?? {})['include'] = 1;
    ((s as any).clothingfilter ?? {})['inc'] = 1;
    ((s as any).clothingfilter ?? {})['only'] = 1;
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'set_block') {
    ((s as any).outfitfilter ?? {})['include'] = 0;
    ((s as any).clothingfilter ?? {})['inc'] = 0;
    ((s as any).clothingfilter ?? {})['only'] = 0;
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'apply') {
    (s as any).result = 0;
    ((s as any).outfitfilter ?? {})['i'] = 0;
    ((s as any).outfitfilter ?? {})['i_max'] = 0;
    // TODO-QSP: :apply_filter_loop
    if (((s as any).outfitfilter ?? 0)?.['i'] < ((s as any).outfitfilter ?? 0)?.['i_max']) {
      if ((!(0 as any))) {
        // TODO-QSP: exit
      }
      ((s as any).outfitfilter ?? {})['i'] = (((s as any).outfitfilter ?? {})['i'] ?? 0) + (1);
...
function enterFilterBuilder(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'init') {
    ((s as any).Headerstring ?? {})['return_loc'] = ((s as any).locArgs?.[2] ?? 0);
    ((s as any).Headerstring ?? {})['return_arg0'] = ((s as any).locArgs?.[3] ?? 0);
    ((s as any).Headerstring ?? {})['return_arg1'] = ((s as any).locArgs?.[4] ?? 0);
    ((s as any).Headerstring ?? {})['sorting_count'] = 0;
    ((s as any).Headerstring ?? {})['filter_count'] = 0;
    ((s as any).Headerstring ?? {})['sorting'] = '<td>';
    ((s as any).Headerstring ?? {})['filter'] = '<td>';
    if (((s as any).cheatVars ?? 0)?.['shop_alt_color']) {
      ((s as any).Headerstring ?? {})['inc_alt'] = '_alt';
      ((s as any).Headerstring ?? {})['inc_color'] = 'blue';
    } else {
      ((s as any).Headerstring ?? {})['inc_alt'] = '';
      ((s as any).Headerstring ?? {})['inc_color'] = 'green';
    }
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'finish') {
    ((s as any).Headerstring ?? {})['sorting'] = (((s as any).Headerstring ?? {})['sorting'] ?? 0) + ('</td>');
    ((s as any).Headerstring ?? {})['filter'] = (((s as any).Headerstring ?? {})['filter'] ?? 0) + ('</td>');
    ...
    qspCall(s, 'shop_utils', 'filter_builder', '_set_headerstring_split_widths', 'sorting');
    qspCall(s, 'shop_utils', 'filter_builder', '_set_headerstring_split_widths', 'filter');
    ((s as any).Headerstring ?? {})['max_width'] = qspUntranslated(s, "max(Headerstring['sorting_width'], Headerstring['filter_width'])", { location: "shop_utils" });
    ((s as any).Headerstring ?? {})['sorting_indent'] = '';
    if (((s as any).Headerstring ?? 0)?.['sorting_width'] / 2 < ((s as any).Headerstring ?? 0)?.['max_width'] / 2) {
      ((s as any).Headerstring ?? {})['i'] = 0;
      // TODO-QSP: :headerstring_sort_loop
      ((s as any).Headerstring ?? {})['sorting_indent'] = (((s as any).Headerstring ?? {})['sorting_indent'] ?? 0) + ('<td></td>');
      ((s as any).Headerstring ?? {})['i'] = (((s as any).Headerstring ?? {})['i'] ?? 0) + (1);
    ...
    ((s as any).Headerstring ?? {})['filter_indent'] = '';
    if (((s as any).Headerstring ?? 0)?.['filter_width'] / 2 < ((s as any).Headerstring ?? 0)?.['max_width'] / 2) {
      ((s as any).Headerstring ?? {})['i'] = 0;
      // TODO-QSP: :headerstring_filter_loop
      ((s as any).Headerstring ?? {})['filter_indent'] = (((s as any).Headerstring ?? {})['filter_indent'] ?? 0) + ('<td></td>');
      ((s as any).Headerstring ?? {})['i'] = (((s as any).Headerstring ?? {})['i'] ?? 0) + (1);
  ...
  if (((s as any).locArgs?.[1] ?? 0) === '_set_headerstring_split_widths') {
    ...
    ((s as any).temp_sh_hs_vars ?? {})['count'] = ((s as any).Headerstring ?? 0)?.[((s as any).locArgs?.[2] ?? 0) + '_count'];
    ((s as any).temp_sh_hs_vars ?? {})['cols'] = 2;
    // TODO-QSP: :split_headerstring_loop_1
    if (((s as any).temp_sh_hs_vars ?? 0)?.['count'] > ((s as any).temp_sh_hs_vars ?? 0)?.['cols'] * 10) {
      ((s as any).temp_sh_hs_vars ?? {})['cols'] = (((s as any).temp_sh_hs_vars ?? {})['cols'] ?? 0) + (1);
      // TODO-QSP: jump 'split_headerstring_loop_1'
    }
    ((s as any).temp_sh_hs_vars ?? {})['width'] = ((s as any).temp_sh_hs_vars ?? {})?.['count'] / ((s as any).temp_sh_hs_vars ?? {})?.['cols'];
    ((s as any).temp_sh_hs_vars ?? {})['cols_overshoot'] = ((s as any).temp_sh_hs_vars ?? {})?.['count'] % ((s as any).temp_sh_hs_vars ?? {})?.['cols'];
    ((s as any).temp_sh_hs_vars ?? {})['new_width'] = ((s as any).temp_sh_hs_vars ?? {})?.['width'] + ((((s as any).temp_sh_hs_vars ?? 0)?.['cols_overshoot'] > 0) ? (1) : (0));
  ...
  if (((s as any).locArgs?.[1] ?? 0) === '_split_headerstring') {
    ...
    ((s as any).temp_sh_hs_vars ?? {})['cur_string'] = ((s as any).Headerstring ?? 0)?.[((s as any).locArgs?.[2] ?? 0)];
    ((s as any).temp_sh_hs_vars ?? {})['new_string'] = '<tr>' + ((s as any).Headerstring ?? 0)[((s as any).locArgs?.[2] ?? 0) + '_indent'];
    ((s as any).temp_sh_hs_vars ?? {})['i'] = 0;
    ...
    if (((s as any).temp_sh_hs_vars ?? 0)?.['i'] < ((s as any).Headerstring ?? 0)[((s as any).locArgs?.[2] ?? 0) + '_cols'] - 1) {
      ((s as any).temp_sh_hs_vars ?? {})['temp_width'] = ((s as any).Headerstring ?? 0)[((s as any).locArgs?.[2] ?? 0) + '_width'] - ((s as any).iif ?? 0)(((s as any).Headerstring ?? 0)[((s as any).locArgs?.[2] ?? 0) + '_col_overshoot'] > 0  &&  ((s as any).temp_sh_hs_vars ?? 0)?.['i'] >= ((s as any).Headerstring ?? 0)[((s as any).locArgs?.[2] ?? 0) + '_col_overshoot'], 1, 0);
      ((s as any).temp_sh_hs_vars ?? {})['j'] = 0;
      ((s as any).temp_sh_hs_vars ?? {})['new_string'] = (((s as any).temp_sh_hs_vars ?? {})['new_string'] ?? 0) + (((s as any).Headerstring ?? 0)?.[((s as any).locArgs?.[2] ?? 0) + '_indent']);
      // TODO-QSP: :split_headerstring_loop_2_inner
      if (((s as any).temp_sh_hs_vars ?? 0)?.['j'] < ((s as any).temp_sh_hs_vars ?? 0)?.['temp_width']) {
        ((s as any).temp_sh_hs_vars ?? {})['td_index'] = 5 + ((((s as any).temp_sh_hs_vars ?? 0)?.['cur_string']).indexOf(('</td><td>'))) + 1;
        ((s as any).temp_sh_hs_vars ?? {})['head'] = ((((s as any).temp_sh_hs_vars ?? 0)?.['cur_string']).slice((1)-1, ((1)-1)+(((s as any).temp_sh_hs_vars ?? {})?.['td_index'] - 1)));
        ((s as any).temp_sh_hs_vars ?? {})['tail'] = qspUntranslated(s, "mid(temp_sh_hs_vars['cur_string'], temp_sh_hs_vars['td_index'])", { location: "shop_utils" });
        ((s as any).temp_sh_hs_vars ?? {})['new_string'] = (((s as any).temp_sh_hs_vars ?? {})['new_string'] ?? 0) + (((s as any).temp_sh_hs_vars ?? 0)?.['head']);
        ((s as any).temp_sh_hs_vars ?? {})['cur_string'] = ((s as any).temp_sh_hs_vars ?? 0)?.['tail'];
        ((s as any).temp_sh_hs_vars ?? {})['j'] = (((s as any).temp_sh_hs_vars ?? {})['j'] ?? 0) + (1);
        // TODO-QSP: jump 'split_headerstring_loop_2_inner'
      }
      ((s as any).temp_sh_hs_vars ?? {})['new_string'] = (((s as any).temp_sh_hs_vars ?? {})['new_string'] ?? 0) + ('</tr><tr>' + ((s as any).Headerstring ?? 0)[((s as any).locArgs?.[2] ?? 0) + '_indent']);
      ((s as any).temp_sh_hs_vars ?? {})['i'] = (((s as any).temp_sh_hs_vars ?? {})['i'] ?? 0) + (1);
      // TODO-QSP: jump 'split_headerstring_loop_2_outer'
    }
    ((s as any).temp_sh_hs_vars ?? {})['new_string'] = (((s as any).temp_sh_hs_vars ?? {})['new_string'] ?? 0) + (((s as any).temp_sh_hs_vars ?? {})?.['cur_string'] + '</tr>');
    // TODO-QSP: $Headerstring[$ARGS[2]] = $temp_sh_hs_vars['new_string']
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'setup_number_sort') {
    if (Object.keys((s as any).ARGS ?? {}).length === 2) {
      ((s as any).ARGS ?? {})[2] = ((s as any).Headerstring ?? 0)?.['return_loc'];
    }
    if (Object.keys((s as any).ARGS ?? {}).length === 3) {
      ((s as any).ARGS ?? {})[3] = ((s as any).Headerstring ?? 0)?.['return_arg0'];
    }
    if (Object.keys((s as any).ARGS ?? {}).length === 4) {
      ((s as any).ARGS ?? {})[4] = ((s as any).Headerstring ?? 0)?.['return_arg1'];
    }
    ((s as any).Headerstring ?? {})['sorting_count'] = (((s as any).Headerstring ?? {})['sorting_count'] ?? 0) + (1);
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'setup_prostitution_filter') {
    ...
    if (Object.keys((s as any).ARGS ?? {}).length === 3) {
      ((s as any).ARGS ?? {})[3] = ((s as any).Headerstring ?? 0)?.['return_loc'];
    }
    if (Object.keys((s as any).ARGS ?? {}).length === 4) {
      ((s as any).ARGS ?? {})[4] = ((s as any).Headerstring ?? 0)?.['return_arg0'];
    }
    if (Object.keys((s as any).ARGS ?? {}).length === 5) {
      ((s as any).ARGS ?? {})[5] = ((s as any).Headerstring ?? 0)?.['return_arg1'];
    }
    ((s as any).Headerstring ?? {})['filter_count'] = (((s as any).Headerstring ?? {})['filter_count'] ?? 0) + (1);
...
function enterInitDisplay(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'shop_utils', 'init', 'add_type', ((s as any).locArgs?.[1] ?? 0));
  qspCall(s, 'shop_utils', 'init', 'set_link', ((s as any).locArgs?.[2] ?? 0));
...
function enterInitDisplayMultiple(s: GameState, scene: SceneBuilder): void {
  ((s as any).shop_display ?? {})['type_max'] = 0;
  qspCall(s, 'shop_utils', 'init', 'start');
  qspCall(s, 'shop_utils', 'init', 'set_link', ((s as any).locArgs?.[1] ?? 0));

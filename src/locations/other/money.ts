...
function enterPay(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['amount'] = qspFunc(s, 'money', '_apply_modifiers', qspUntranslated(s, "ARGS[1]", { location: "money" }), 'price');
...
function enterEarn(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['amount'] = qspFunc(s, 'money', '_apply_modifiers', qspUntranslated(s, "ARGS[1]", { location: "money" }), 'profit');
  if (((s as any).locArgs?.[2] ?? 0) === 'cash') {
...
function enterGetCostString(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[2] ?? 0) === '') {
    if (!(s as any).ARGS) (s as any).ARGS = {}; (s as any).ARGS[2] = 'both';
  }
  if (((s as any).locArgs?.[2] ?? 0) === 'cash') {
  } else {
    if (((s as any).locArgs?.[2] ?? 0) === 'bank') {
...
function enterFormatBalance(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'cash') {
    if (!(s as any).format_balance_temp) (s as any).format_balance_temp = {}; (s as any).format_balance_temp['base'] = ((s as any).money ?? 0);
    if (!(s as any).format_balance_temp) (s as any).format_balance_temp = {}; (s as any).format_balance_temp['overflow'] = ((s as any).money_overflow ?? 0);
  } else {
    if (((s as any).locArgs?.[1] ?? 0) === 'bank') {
      if (!(s as any).format_balance_temp) (s as any).format_balance_temp = {}; (s as any).format_balance_temp['base'] = ((s as any).karta ?? 0) - ((s as any).bankDebtLimit ?? 0);
      if (!(s as any).format_balance_temp) (s as any).format_balance_temp = {}; (s as any).format_balance_temp['overflow'] = ((s as any).karta_overflow ?? 0);
    } else {
      if (((s as any).locArgs?.[1] ?? 0) === 'desk') {
        if (!(s as any).format_balance_temp) (s as any).format_balance_temp = {}; (s as any).format_balance_temp['base'] = ((s as any).stolmoney ?? 0);
        if (!(s as any).format_balance_temp) (s as any).format_balance_temp = {}; (s as any).format_balance_temp['overflow'] = ((s as any).stolmoney_overflow ?? 0);
      }
    }
  }
  if (((s as any).format_balance_temp ?? 0)?.['overflow'] > 0) {
    ...
    if (((s as any).format_balance_temp ?? 0)?.['pad'] > 0) {
      if (!(s as any).format_balance_temp) (s as any).format_balance_temp = {}; (s as any).format_balance_temp['padding'] = ((s as any).format_balance_temp['padding'] ?? 0) + ('0');
      if (!(s as any).format_balance_temp) (s as any).format_balance_temp = {}; (s as any).format_balance_temp['pad'] = ((s as any).format_balance_temp['pad'] ?? 0) - (1);
...
function enterFormatPriceString(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).shortgsVars) (s as any).shortgsVars = {}; (s as any).shortgsVars['num'] = qspUntranslated(s, "str(ARGS[1])", { location: "money" });
...
function enterRemoveModifiers(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[2] ?? 0) === 'price') {
    if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['fwd'] = qspFunc(s, '_difficulty', 'get_multiplied', ((s as any).cfg_vars ?? 0)?.['neg_mult_opt'], 100, ((s as any).cfg_vars ?? 0)?.['neg_mult']);
  } else {
...
function enterChoosePaymentMethod(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['input_msg'] = 'How would you like to \' + iif($ARGS[2] = \'pay\', \'pay\', \'get paid\') + \'?<br>';
  if (((s as any).locArgs?.[2] ?? 0) === 'pay') {
    if (qspFunc(s, 'money', '_can_afford_inner', qspUntranslated(s, "ARGS[1]", { location: "money" }), 'cash') === 1) {
      if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['cash'] = 1;
      if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['input_msg'] = ((s as any).cpm_temp_moneyVars['input_msg'] ?? 0) + ('Cash [Enter \'1\', Default]<br>');
    } else {
      if (qspFunc(s, 'money', '_can_afford_inner', ((s as any).ARGS ?? 0)[1] - ((s as any).money ?? 0), 'bank') === 1) {
        if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['both'] = 1;
        if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['input_msg'] = ((s as any).cpm_temp_moneyVars['input_msg'] ?? 0) + ('Hybrid Payment [Enter \'3\']<br>');
      }
    }
    if (qspFunc(s, 'money', '_can_afford_inner', qspUntranslated(s, "ARGS[1]", { location: "money" }), 'bank') === 1) {
      if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['bank'] = 1;
      if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['input_msg'] = ((s as any).cpm_temp_moneyVars['input_msg'] ?? 0) + ('Bank [Enter \'2\']<br>');
    }
  ...
  if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['input_result'] = 0;
  if (((s as any).cpm_temp_moneyVars ?? 0)?.['input_result'] !== ''  &&  !isNaN(((s as any).cpm_temp_moneyVars ?? 0)?.['input_result']) && ((s as any).cpm_temp_moneyVars ?? 0)?.['input_result'] !== '') {
    if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['choice'] = qspUntranslated(s, "val(cpm_temp_moneyVars['input_result'])", { location: "money" });
  }
  if (((s as any).cpm_temp_moneyVars ?? 0)?.['choice'] < 1  ||  ((s as any).cpm_temp_moneyVars ?? 0)?.['choice'] >= 4) {
    if (((s as any).cpm_temp_moneyVars ?? 0)?.['cash'] === 1  ||  ((s as any).locArgs?.[2] ?? 0) === 'earn') {
      if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['choice'] = 1;
    } else {
      if (((s as any).cpm_temp_moneyVars ?? 0)?.['bank'] === 1) {
        if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['choice'] = 2;
      } else {
        if (((s as any).cpm_temp_moneyVars ?? 0)?.['both'] === 1) {
          if (!(s as any).cpm_temp_moneyVars) (s as any).cpm_temp_moneyVars = {}; (s as any).cpm_temp_moneyVars['choice'] = 3;
        }
      }
    }
  }
...
function enterDebtAdd(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['amount'] = qspFunc(s, 'money', 'price', qspUntranslated(s, "ARGS[2]", { location: "money" }));
...
function enterDebtPay(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[2] ?? 0) > 0) {
    if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['target'] = qspUntranslated(s, "min(ARGS[2], temp_moneyVars['debt'])", { location: "money" });
  } else {
    if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['target'] = ((s as any).temp_moneyVars ?? 0)?.['debt'];
  }
  if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['paid'] = 0;
  ...
  if (((s as any).money ?? 0) > 0) {
    if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['from_cash'] = qspUntranslated(s, "min(money, temp_moneyVars['target'])", { location: "money" });
    (s as any).money = ((s as any).money ?? 0) - (((s as any).temp_moneyVars ?? 0)?.['from_cash']);
    if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['paid'] = ((s as any).temp_moneyVars['paid'] ?? 0) + (((s as any).temp_moneyVars ?? 0)?.['from_cash']);
    if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['target'] = ((s as any).temp_moneyVars['target'] ?? 0) - (((s as any).temp_moneyVars ?? 0)?.['from_cash']);
  }
  if (((s as any).temp_moneyVars ?? 0)?.['target'] > 0  &&  (((s as any).locArgs?.[3] ?? 0) === 'desk'  ||  ((s as any).locArgs?.[3] ?? 0) === 'all')) {
    if (((s as any).stolmoney ?? 0) > 0) {
      if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['from_desk'] = qspUntranslated(s, "min(stolmoney, temp_moneyVars['target'])", { location: "money" });
      (s as any).stolmoney = ((s as any).stolmoney ?? 0) - (((s as any).temp_moneyVars ?? 0)?.['from_desk']);
      if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['paid'] = ((s as any).temp_moneyVars['paid'] ?? 0) + (((s as any).temp_moneyVars ?? 0)?.['from_desk']);
      if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['target'] = ((s as any).temp_moneyVars['target'] ?? 0) - (((s as any).temp_moneyVars ?? 0)?.['from_desk']);
    }
  }
  if (((s as any).temp_moneyVars ?? 0)?.['target'] > 0  &&  (((s as any).locArgs?.[3] ?? 0) === 'all'  ||  ((s as any).locArgs?.[3] ?? 0) === '')) {
    if ((((s as any).karta ?? 0) > 0  &&  (((s as any).cfg_vars ?? 0)?.['allow_overdraft'] === 1)  ||  Math.max(((s as any).karta ?? 0) - ((s as any).bankDebtLimit ?? 0), 0) >= ((s as any).temp_moneyVars ?? 0)?.['target'])) {
      if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['from_bank'] = qspUntranslated(s, "min(karta, temp_moneyVars['target'])", { location: "money" });
      (s as any).karta = ((s as any).karta ?? 0) - (((s as any).temp_moneyVars ?? 0)?.['from_bank']);
      if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['paid'] = ((s as any).temp_moneyVars['paid'] ?? 0) + (((s as any).temp_moneyVars ?? 0)?.['from_bank']);
      if (!(s as any).temp_moneyVars) (s as any).temp_moneyVars = {}; (s as any).temp_moneyVars['target'] = ((s as any).temp_moneyVars['target'] ?? 0) - (((s as any).temp_moneyVars ?? 0)?.['from_bank']);
    }
  }

...
function enterFirstChat(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).grupTipe ?? 0) === 1) {
    ...
    // TODO-QSP: dynamic text: You smile back at her. "Hey Natalia. I thought I''d come and say hello. I''m <<$...
...
function enterLibrary(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_rel ?? 0)?.['A240'] < 60) {
    ...
    // TODO-QSP: dynamic text: Clearly realizing you''re finding this difficult, she cuts you off to save you f...

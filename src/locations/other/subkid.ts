...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).kid ?? 0) > 0) {
    (s as any).kidI = 0;
    // TODO-QSP: :loop
    (s as any).kidSelected[kidLoops] = ((s as any).kidI ?? 0);
    if (((s as any).kidage ?? 0)?.[String((s as any).kidI ?? 0)] < 1  &&  (((s as any).locclass ?? 0) === 'bedr'  ||  ((s as any).locclass ?? 0) === 'bedroom'  ||  ((s as any).locclass ?? 0) === 'singleroom')  &&  ( ((s as any).hour ?? 0) < 12  ||  ((s as any).hour ?? 0) > 18 )) {
      ...
      scene.text(`<a href="exec:gt 'kid','start' ">On a blanket lies ${((s as any).kidname ?? 0)?.[String((s as any).kidI ?? 0)]}.</a>`);
      if (((s as any).kidage ?? 0)?.[String((s as any).kidI ?? 0)] >= 1  &&  ((s as any).kidage ?? 0)?.[String((s as any).kidI ?? 0)] < 7  &&  (((s as any).locclass ?? 0) === 'bedr'  ||  ((s as any).locclass ?? 0) === 'bedroom'  ||  ((s as any).locclass ?? 0) === 'singleroom')  &&  ( ((s as any).hour ?? 0) < 7  ||  ((s as any).hour ?? 0) > 21)) {
        ...
        scene.text(`<a href="exec:gt 'kid','start' ">Asleep in bed lies ${((s as any).kidname ?? 0)?.[String((s as any).kidI ?? 0)]}.</a>`);
      } else {
        // TODO-QSP: dynamic text: <a href="exec:gt 'kid','start' "><<$kidname[kidI]>> is playing with toys on the ...
        scene.text(`<a href="exec:gt 'kid','start' ">${((s as any).kidname ?? 0)?.[String((s as any).kidI ?? 0)]} is playing with toys on the floor.</a>`);
        if (((s as any).kidage ?? 0)?.[String((s as any).kidI ?? 0)] >= 1  &&  ((s as any).kidage ?? 0)?.[String((s as any).kidI ?? 0)] < 7  &&  (((s as any).locclass ?? 0) === 'livingr'  ||  ((s as any).locclass ?? 0) === 'livingroom'  ||  ((s as any).locclass ?? 0) === 'singleroom')  &&  ( ((s as any).hour ?? 0) >= 7  &&  ((s as any).hour ?? 0) <= 21)  &&  ((s as any).rkidloc ?? 0) >= 8) {
          ...
          scene.text(`<a href="exec:gt 'kid','start' ">${((s as any).kidname ?? 0)?.[String((s as any).kidI ?? 0)]} is watching TV.</a>`);
        } else {
          // TODO-QSP: dynamic text: <a href="exec:gt 'kid','start' "><<$kidname[kidI]>> is getting ready for school....
          scene.text(`<a href="exec:gt 'kid','start' ">${((s as any).kidname ?? 0)?.[String((s as any).kidI ?? 0)]} is getting ready for school.</a>`);
          if (((s as any).kidage ?? 0)?.[String((s as any).kidI ?? 0)] >= 7  &&  ((s as any).kidage ?? 0)?.[String((s as any).kidI ?? 0)] < 18  &&  (((s as any).locclass ?? 0) === 'livingr'  ||  ((s as any).locclass ?? 0) === 'livingroom'  ||  ((s as any).locclass ?? 0) === 'singleroom'  ||  ((s as any).locclass ?? 0) === 'bedr'  ||  ((s as any).locclass ?? 0) === 'bedroom')  &&  ( ((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) <= 16)) {
            ...
            scene.text(`<a href="exec:gt 'kid', 'start'">${((s as any).kidname ?? 0)?.[String((s as any).kidi ?? 0)]} is working on homework.</a>`);

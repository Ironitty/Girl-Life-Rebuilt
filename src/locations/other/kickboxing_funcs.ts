...
function enterInitFightVars(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['pcs_points'] = 0;
  if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_points'] = 0;
  if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['round'] = 1;
  if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['time'] = 0;
  if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['max_rounds'] = 3;
  // TODO-QSP: end
  scene.build();
}
...
function enterGenerateOpponent(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'spar') {
    ...
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_stren'] = Math.floor(Math.random() * 11) + 10;
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_speed'] = Math.floor(Math.random() * 11) + 10;
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_agil'] = Math.floor(Math.random() * 11) + 10;
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_react'] = Math.floor(Math.random() * 11) + 10;
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_vital'] = Math.floor(Math.random() * 11) + 10;
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_intel'] = 10;
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_will'] = 10;
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_jab'] = Math.floor(Math.random() * 16) + 5;
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_punch'] = Math.floor(Math.random() * 16) + 5;
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_kick'] = Math.floor(Math.random() * 16) + 5;
    if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_def'] = Math.floor(Math.random() * 16) + 5;
  } else {
    if (((s as any).locArgs?.[1] ?? 0) === 'amateur_fight') {
      if (((s as any).locArgs?.[2] ?? 0) <= 0) {
        ...
        if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_intel'] = 10;
        if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_will'] = 10;
        if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_jab'] = Math.floor(Math.random() * 21) + 10;
        if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_punch'] = Math.floor(Math.random() * 21) + 10;
        if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_kick'] = Math.floor(Math.random() * 21) + 10;
        if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_def'] = Math.floor(Math.random() * 21) + 10;
      } else {
        if (((s as any).locArgs?.[2] ?? 0) === 1) {
          qspCall(s, 'npcgeneratec', '', 1, '3rd class rival', Math.floor(Math.random() * 27) + 19);
          qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_stren'] = Math.floor(Math.random() * 11) + 15;
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_speed'] = Math.floor(Math.random() * 11) + 15;
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_agil'] = Math.floor(Math.random() * 11) + 15;
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_react'] = Math.floor(Math.random() * 11) + 15;
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_vital'] = Math.floor(Math.random() * 11) + 15;
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_intel'] = 10;
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_will'] = 10;
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_jab'] = Math.floor(Math.random() * 21) + 15;
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_punch'] = Math.floor(Math.random() * 21) + 15;
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_kick'] = Math.floor(Math.random() * 21) + 15;
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_def'] = Math.floor(Math.random() * 21) + 15;
        } else {
          if (((s as any).locArgs?.[2] ?? 0) === 2) {
            qspCall(s, 'npcgeneratec', '', 1, '2rd class rival', Math.floor(Math.random() * 27) + 19);
            qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_stren'] = Math.floor(Math.random() * 11) + 20;
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_speed'] = Math.floor(Math.random() * 11) + 20;
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_agil'] = Math.floor(Math.random() * 11) + 20;
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_react'] = Math.floor(Math.random() * 11) + 20;
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_vital'] = Math.floor(Math.random() * 11) + 20;
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_intel'] = 10;
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_will'] = 10;
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_jab'] = Math.floor(Math.random() * 21) + 30;
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_punch'] = Math.floor(Math.random() * 21) + 30;
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_kick'] = Math.floor(Math.random() * 21) + 30;
            if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_def'] = Math.floor(Math.random() * 21) + 30;
          } else {
            if (((s as any).locArgs?.[2] ?? 0) === 3) {
              qspCall(s, 'npcgeneratec', '', 1, '1st class rival', Math.floor(Math.random() * 27) + 19);
              qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_stren'] = Math.floor(Math.random() * 11) + 30;
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_speed'] = Math.floor(Math.random() * 11) + 30;
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_agil'] = Math.floor(Math.random() * 11) + 30;
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_react'] = Math.floor(Math.random() * 11) + 30;
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_vital'] = Math.floor(Math.random() * 11) + 30;
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_intel'] = 10;
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_will'] = 10;
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_jab'] = Math.floor(Math.random() * 21) + 40;
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_punch'] = Math.floor(Math.random() * 21) + 40;
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_kick'] = Math.floor(Math.random() * 21) + 40;
              if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_def'] = Math.floor(Math.random() * 21) + 40;
            } else {
              if (((s as any).locArgs?.[2] ?? 0) === 4) {
                qspCall(s, 'npcgeneratec', '', 1, 'Excellent rival', Math.floor(Math.random() * 27) + 19);
                qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_stren'] = Math.floor(Math.random() * 21) + 40;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_speed'] = Math.floor(Math.random() * 21) + 40;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_agil'] = Math.floor(Math.random() * 21) + 40;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_react'] = Math.floor(Math.random() * 21) + 40;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_vital'] = Math.floor(Math.random() * 21) + 40;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_intel'] = 10;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_will'] = 10;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_jab'] = Math.floor(Math.random() * 21) + 60;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_punch'] = Math.floor(Math.random() * 21) + 60;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_kick'] = Math.floor(Math.random() * 21) + 60;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_def'] = Math.floor(Math.random() * 21) + 60;
              } else {
                qspCall(s, 'npcgeneratec', '', 1, 'Best rival in the gym', Math.floor(Math.random() * 27) + 19);
                qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_stren'] = Math.floor(Math.random() * 41) + 60;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_speed'] = Math.floor(Math.random() * 41) + 60;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_agil'] = Math.floor(Math.random() * 41) + 60;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_react'] = Math.floor(Math.random() * 41) + 60;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_vital'] = Math.floor(Math.random() * 41) + 60;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_intel'] = 10;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_will'] = 10;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_jab'] = Math.floor(Math.random() * 31) + 80;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_punch'] = Math.floor(Math.random() * 31) + 80;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_kick'] = Math.floor(Math.random() * 31) + 80;
                if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_def'] = Math.floor(Math.random() * 31) + 80;
              }
            }
          }
        }
...
function enterSetInitiative(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_kickboxVars ?? 0)?.['set_init'] === 0) {
    ...
    if (((s as any).temp_kickboxVars ?? 0)?.['pcs_init_true'] > ((s as any).temp_kickboxVars ?? 0)?.['npc_init_true']  &&  ((s as any).temp_kickboxVars ?? 0)?.['pcs_inittime'] < 3  ||  ((s as any).temp_kickboxVars ?? 0)?.['npc_inittime'] >= 3) {
      ...
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['pcs_inittime'] = ((s as any).temp_kickboxVars['pcs_inittime'] ?? 0) + (1);
      if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['npc_inittime'] = 0;
    ...
    if (((s as any).locArgs?.[2] ?? 0) === 'jab') {
      ...
      if (((s as any).locArgs?.[2] ?? 0) === 'punch') {
        ...
        if (((s as any).locArgs?.[2] ?? 0) === 'kick') {
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['damage'] = 3 * ((s as any).pcs_stren ?? 0) + ((s as any).rand ?? 0)(-3 * (((s as any).pcs_stren ?? 0) / 5), 3 * (((s as any).pcs_stren ?? 0) / 5));
          if (!(s as any).temp_kickboxVars) (s as any).temp_kickboxVars = {}; (s as any).temp_kickboxVars['hit_mod'] = (((s as any).pcs_agil ?? 0) + ((s as any).pcs_react ?? 0) + ((s as any).pcs_kick ?? 0)) / 2;
        }
      }
    }
...
function enterSashAdvancement(s: GameState, scene: SceneBuilder): void {
  if (((s as any).kickbox ?? 0)?.['sash'] === 0) {
    if (((s as any).kickbox ?? 0)?.['advancement'] >= 5) {
      if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['sash'] = 1;
      if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['advancement'] = 0;
      if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['money'] = 200;
    ...
    if (((s as any).kickbox ?? 0)?.['sash'] === 1) {
      if (((s as any).kickbox ?? 0)?.['advancement'] >= 10) {
        if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['sash'] = 2;
        if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['advancement'] = 0;
        if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['money'] = 500;
        scene.text('You have been awarded purple sash(rank 5).');
      }
    } else {
      if (((s as any).kickbox ?? 0)?.['sash'] === 2) {
        if (((s as any).kickbox ?? 0)?.['advancement'] >= 15) {
          if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['sash'] = 3;
          if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['advancement'] = 0;
          if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['money'] = 1500;
          scene.text('You have been awarded blue sash(rank 6).');
        }
      } else {
        if (((s as any).kickbox ?? 0)?.['sash'] === 3) {
          if (((s as any).kickbox ?? 0)?.['advancement'] >= 20) {
            if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['sash'] = 4;
            if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['advancement'] = 0;
            if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['money'] = 3500;
            scene.text('You have been awarded brown sash(rank 7).');
          }
        } else {
          if (((s as any).kickbox ?? 0)?.['sash'] === 4) {
            if (((s as any).kickbox ?? 0)?.['advancement'] >= 25) {
              if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['sash'] = 5;
              if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['advancement'] = 0;
              if (!(s as any).kickbox) (s as any).kickbox = {}; (s as any).kickbox['money'] = 7500;

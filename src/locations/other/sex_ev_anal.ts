...
function enterAnalAsk(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_ask'] = 1;
  if ((!((s as any).pcs_ass ?? 0))) {
    scene.actions([
      { label: 'Tell him you\'re an anal virgin', handler: (st: GameState) => {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_virgin'] = 1;
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['no_anal'] = 1;
  ...
  if (((s as any).sex_ev ?? 0)?.['no_anal'] > 0) {
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['not_anal'] = 1;
...
function enterNoAssToPussy1(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['anal_count'] > 0) {
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['no_vag'] = 1;
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_dirt'] = 0;
...
function enterAnalNoAsk(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['no_vag'] < 1  &&  ((s as any).sex_ev ?? 0)?.['anal_count'] === 0  &&  ((s as any).sex_ev ?? 0)?.['anal_allowed'] < 1) {
    ...
    if (((s as any).npc_fav_pos ?? 0)?.[String((s as any).npcID ?? 0)] === 'anal'  &&  (((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] > 0  ||  ((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] > 0)) {
      if (((s as any).stat ?? 0)?.['anal'] === 0) {
        if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['surprise_anal'] = 1;
      }
...
function enterAnalDoggyInsertSlow(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['first_anal_insertion'] = 1;
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc1'] = '' + qspUntranslated(s, "npcdesc>", { location: "sex_ev_anal" }) + ' carefully positions himself behind you, lining up the head of his cock with your backdoor, and gently squeezes it into the hole between your cheeks.';
  if (((s as any).dick_desc ?? 0) === 'tiny') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'Not that he needed to be careful. His hips come flush with your ass, and you still feel plenty of wiggle room inside you. He might as well have put his finger in...';
  } else {
    if (((s as any).dick_desc ?? 0) === 'short') {
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'He pushes into your sphincter, and you feel his cock start to fill you up before abruptly stopping short as his hips collide with your ass.';
    } else {
      if (((s as any).dick_desc ?? 0) === 'chode') {
        if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'He pushes into your sphincter, and you feel his cock stretching you out as he pushes in, before stopping short as his hips collide with your ass...';
      } else {
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'He slips into your sphincter, comfortably sliding his cock all the way in, though it isn\'t a very tight fit...';
        } else {
          if (((s as any).dick_desc ?? 0) === 'normal') {
            if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'He pushes into your sphincter and fills your ass with his perfectly average length and girth...';
          } else {
            if (((s as any).dick_desc ?? 0) === 'thick') {
              if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'You immediately feel your sphincter stretch out as he pushes in, your ass straining to accommodate his thick girth...';
            } else {
              if (((s as any).dick_desc ?? 0) === 'long') {
                if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'He pushes into your sphincter, comfortable at first, before you realize that it\'s not stopping. His length keeps going all the way up your ass until you feel like it\'s <i>bulging</i> inside you. Though it isn\'t a very tight fit width-wise...';
              } else {
                if (((s as any).dick_desc ?? 0) === 'huge') {
                  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'He pushes into your sphincter, comfortable at first, before you realize that it\'s not stopping. His length keeps going all the way up your ass until you feel like it\'s <i>bulging</i> inside you...';
                } else {
                  if (((s as any).dick_desc ?? 0) === 'enormous') {
                    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'You immediately feel your sphincter stretch out as he pushes in, your walls straining to accommodate his thick girth. Even as you struggle with his width, his length quickly makes its presence known as well when his cock hits deep inside you that you feel as if your stomach is <i>bulging</i>. It seems to barely fit inside you...';
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'lengthy') {
                      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'He pushes into your sphincter, comfortable at first, before you realize that it\'s not stopping. His length keeps going all the way up your ass until you feel like it <i>bulging</i> inside your stomach. And from the way it pokes your innards, you can tell he hasn\'t even managed to get his full length inside you. Although it isn\'t a very tight fit width-wise...';
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'gigantic') {
                        if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_insert_desc2'] = 'He pushes into your sphincter, filling your ass with so much cock that it feels as if it\'s bulging inside your stomach. And from the way it pokes your innards, you can tell he hasn\'t even managed to get his full length inside you...';
                      } else {
...
function enterAnalGirlOrgasmContinue(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['position'] = 'anal';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'anal' + qspUntranslated(s, "sex_ev['speed']>", { location: "sex_ev_anal" }) + '';
...
function enterAnal2_1(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'anal2';
  qspCall(s, 'sex_ev_cum', 'fuck_cum');
  qspCall(s, 'sex_ev_sex', 'fuck_continue');
  // TODO-QSP: end
  scene.build();
...
function enterAnal3(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_virgin_fuck'] = 1;
...
function enterAnalCreampieMenu(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['safe_day'] = 1;
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['probably_safe_day'] = 1;
...
function enterAnal1StartDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} fucks your ass slowly but steadily, each time methodically drawing himself all the way out before driving his tiny dick balls deep inside you.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> fucks your ass slowly but steadily, each time methodically drawing ...
      scene.text(`${((s as any).npcdesc ?? 0)} fucks your ass slowly but steadily, each time methodically drawing himself all the way out before driving his fat choke balls deep inside you.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> fucks your ass slowly but steadily, each time methodically drawing ...
        scene.text(`${((s as any).npcdesc ?? 0)} fucks your ass slowly but steadily, each time methodically drawing himself all the way out before driving his skinny dick balls deep inside you.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> fucks your ass slowly but steadily, each time methodically drawing ...
          scene.text(`${((s as any).npcdesc ?? 0)} fucks your ass slowly but steadily, each time methodically drawing himself all the way out before driving his dick balls deep inside you.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).agape ?? 0) < 2) {
              // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
              scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before stretching your ass out with his thick cock when he drives it balls deep inside you again.`);
            } else {
              // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
              scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out just long enough for your ass to feel the empty absence of his thick cock before he drives it balls deep inside you again.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> fucks your ass slowly but steadily, each time methodically drawing ...
              scene.text(`${((s as any).npcdesc ?? 0)} fucks your ass slowly but steadily, each time methodically drawing himself all the way out before driving his long dick back in, barely able to fit its generous length inside you.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out just long enough for your ass to feel the absence of his huge cock before driving back in to fill you up, barely able to fit its entirety inside you.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  if (((s as any).agape ?? 0) < 2) {
                    // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                    scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before splitting your tight asshole again, barely able to fit the entirety of his enormous cock inside you.`);
                  } else {
                    // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                    scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before stretching your well-used asshole again, barely able to fit the entirety of his enormous cock inside you.`);
                  }
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                    scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out of your puckering asshole before forcing as much of his ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock as he can fit inside you, and still leaving shaft to spare.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      if (((s as any).agape ?? 0) < 2) {
                        // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                        scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before plunging back in, stretching your tight asshole to the limits as he's unable to fit the entire length of his gigantic cock inside you.`);
                      } else {
                        // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                        scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out of your puckering asshole before plunging his gigantic cock back in, just barely able to fit it inside you.`);
                      }
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        if (((s as any).agape ?? 0) < 2) {
                          ...
                          // TODO-QSP: dynamic text: <<$npcdesc>> fucks you slowly but steadily, each time methodically drawing himse...
                          scene.text(`${((s as any).npcdesc ?? 0)} fucks you slowly but steadily, each time methodically drawing himself all the way out before forcing the monstrous size of his ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm back into your ass. You're no anal virgin, but this is ridiculous! And ${((s as any).npcdesc ?? 0)} 's cock threatens to split you in half each time he fails to fit its length inside you.`);
                        }
                      }
                    }
                  }
      ...
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        ...
        if (((s as any).dick_desc ?? 0) === 'normal') {
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            ...
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You moan as <<$npcdesc>> takes you from behind, his cock thrusting into your ass...
              scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his cock thrusting into your ass. There's something about anal that tightens your throat in the most delicious way. The feeling of <i>pushed</i> and <i>pulled</i> inside out makes your entire body flush with heat. Plus, with a nice long cock like ${((s as any).npcdesc ?? 0)}'s, it goes deep inside you, massaging the back of your pussy from the other side of the wall.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You moan as <<$npcdesc>> takes you from behind, his cock thrusting into your ass...
                scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his cock thrusting into your ass. There's something about anal that tightens your throat in the most delicious way. The feeling of <i>pushed</i> and <i>pulled</i> inside out makes your entire body flush with heat. Plus, ${((s as any).npcdesc ?? 0)}'s cock is huge. Not only does it fill you completely, but it hits deep inside you, massaging the back of your pussy from the other side of the wall.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You moan as <<$npcdesc>> takes you from behind, his cock thrusting into your ass...
                  scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his cock thrusting into your ass. There's something about anal that tightens your throat in the most delicious way. The feeling of <i>pushed</i> and <i>pulled</i> inside out makes your entire body flush with heat. Plus, ${((s as any).npcdesc ?? 0)}'s cock is enormous. Your ass struggles to accommodate its massive girth, and its length hits deep inside you, massaging the back of your pussy from the other side of the wall.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You moan as <<$npcdesc>> takes you from behind, his cock thrusting into your ass...
                    scene.text(`You moan as ${((s as any).npcdesc ?? 0)} takes you from behind, his cock thrusting into your ass. There's something about anal that tightens your throat in the most delicious way. The feeling of <i>pushed</i> and <i>pulled</i> inside out makes your entire body flush with heat. And with a dick as long as ${((s as any).npcdesc ?? 0)}'s, it reaches the deepest part of you, massaging the back of your pussy from the other side of the wall.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      if (((s as any).agape ?? 0) < 2) {
                        // TODO-QSP: dynamic text: You groan beneath <<$npcdesc>>, getting wetter with every thrust of his gigantic...
                        scene.text(`You groan beneath ${((s as any).npcdesc ?? 0)}, getting wetter with every thrust of his gigantic cock into your ass. It fills you to the brim and then some, forcing the breath from your lungs and turning your asshole inside out with his sheer size in the most pleasurably painful way possible.`);
                      } else {
                        // TODO-QSP: dynamic text: You groan beneath <<$npcdesc>>, getting wetter with every thrust of his gigantic...
                        scene.text(`You groan beneath ${((s as any).npcdesc ?? 0)}, getting wetter with every thrust of his gigantic cock into your ass. It fills you to the brim, forcing the breath from your lungs and turning your asshole inside out with his sheer size in the most pleasurably painful way possible.`);
                      }
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        if (((s as any).agape ?? 0) < 2) {
                          // TODO-QSP: dynamic text: You groan beneath <<$npcdesc>> as his monstrous cock splits your asscheeks in tw...
                          scene.text(`You groan beneath ${((s as any).npcdesc ?? 0)} as his monstrous cock splits your asscheeks in two. He's way too big for you in both girth and length, pummeling your insides, turning them inside out. The pain makes your eyes water, and you are <i><b>loving every second of it. </b></i>`);
                        } else {
                          // TODO-QSP: dynamic text: You groan beneath <<$npcdesc>> as his monstrous cock splits your asscheeks in tw...
                          scene.text(`You groan beneath ${((s as any).npcdesc ?? 0)} as his monstrous cock splits your asscheeks in two. He's destroying your ass with size alone, pummeling your insides, turning them inside out. The pain makes your eyes water, and you are <i><b>loving every second of it. </b></i>`);
                        }
                      }
                    }
                  }
...
function enterAnal1_1Desc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only the tip of his tiny dick is still inside of you before smoothly pushing himself back into your ass, pressing his hips against your cheeks.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
      scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his thick chode back into your ass, pressing his hips against your cheeks.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
        scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his skinny dick back into your ass, pressing his hips against your cheeks.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
          scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into your ass, pressing his hips against your cheeks.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            if (((s as any).agape ?? 0) < 2) {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his cock back into your tight ass, his thick girth forcing gasps from your mouth.`);
            } else {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his cock back into your ass, his thick girth filling you from wall to wall.`);
            }
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
              scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into your ass, filling you from end to end with his long shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
                scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into your ass, eliciting mews of pleasure as his huge shaft fills you from end to end.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  if (((s as any).pcs_ass ?? 0) <= 15) {
                    ...
                    // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
                    scene.text(`${((s as any).npcdesc ?? 0)} slows down, fucking you more gently, pulling out of you until only his tip is still inside of you before smoothly pushing his dick back into your ass, eliciting moans of pleasure as the length and girth of his enormous shaft fills you.`);
                  }
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> slows down, fucking you more gently, pulling out of you until only ...
...
function enterAnal1_2MoanDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['moan'] === 1) {
    ...
    if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
      ...
      scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to assfuck you. Slowly. Gently. His tiny dick is driving as deep as it can inside you, finding the hidden secrets of your anus that make your pussy weep with every thrust.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'chode') {
        // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to assfuck you. Slowly. Gently. His fat...
        scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to assfuck you. Slowly. Gently. His fat chode driving as deep as it can inside you, stretching your anus and making your pussy weep with every thrust.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to assfuck you. Slowly. Gently. His ski...
          scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to assfuck you. Slowly. Gently. His skinny dick is driving as deep as it can inside you, finding the hidden secrets of your anus that make your pussy weep with every thrust.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'normal') {
            // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to assfuck you. Slowly. Gently. His coc...
            scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to assfuck you. Slowly. Gently. His cock is driving deep inside you, filling your anus and making your pussy weep with every thrust.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'thick') {
              if (((s as any).agape ?? 0) < 2) {
                // TODO-QSP: dynamic text: Tiny mews escape your lips as <<$npcdesc>> continues to assfuck you with his thi...
                scene.text(`Tiny mews escape your lips as ${((s as any).npcdesc ?? 0)} continues to assfuck you with his thick cock. Slowly. Gently. He drives it deep inside you, stretching your tight anus with its exceptional girth, making you wetter and wetter with every thrust.`);
              } else {
                // TODO-QSP: dynamic text: Soft moans escape your lips as <<$npcdesc>> continues to assfuck you with his th...
                scene.text(`Soft moans escape your lips as ${((s as any).npcdesc ?? 0)} continues to assfuck you with his thick cock. Slowly. Gently. He drives it deep inside you, filling you with its exceptional girth, making you wetter and wetter with every thrust.`);
              }
            } else {
              if (((s as any).dick_desc ?? 0) === 'long') {
                // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to assfuck you. Slowly. Gently. His lon...
                scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to assfuck you. Slowly. Gently. His long cock driving deep inside you until it's plunged to the hilt; its presence felt even in the deepest parts of your anus, making you wetter and wetter with every thrust.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'huge') {
                  // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to assfuck you. Slowly. Gently. His hug...
                  scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to assfuck you. Slowly. Gently. His huge cock driving deep inside you until it's plunged to the hilt; its presence felt even in the deepest parts of your intestines, filling you, making you wetter and wetter with every thrust.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'enormous') {
                    if (((s as any).pcs_ass ?? 0) <= 15) {
                      // TODO-QSP: dynamic text: Tiny mews escape your lips as <<$npcdesc>> continues to assfuck you with his eno...
                      scene.text(`Tiny mews escape your lips as ${((s as any).npcdesc ?? 0)} continues to assfuck you with his enormous cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, making its presence felt in the deepest parts of your intestines even as it <i>stretches</i> your tight anus to accommodate his exceptional girth. But you love it, becoming wetter and wetter with every thrust.`);
                    } else {
                      // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to assfuck you with his enormous cock. ...
                      scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to assfuck you with his enormous cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, making its presence felt in the deepest parts of your intestines even as it <i>stretches</i> your anus to accommodate its exceptional girth. But you love it, becoming wetter and wetter with every thrust.`);
                    }
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'lengthy') {
                      // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to assfuck you with his exceptionally l...
                      scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to assfuck you with his exceptionally lengthy cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, forcing groans from your lips as your innards feel like they're being turned inside out. Pain never hurt so good.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'gigantic') {
                        // TODO-QSP: dynamic text: You groan softly as <<$npcdesc>> continues to assfuck you with his gigantic cock...
                        scene.text(`You groan softly as ${((s as any).npcdesc ?? 0)} continues to assfuck you with his gigantic cock. Slowly. Gently. He drives it deep inside you, <i>filling</i> you until it's plunged to the hilt, forcing groans from your lips as your insides feel like they're being turned inside out. Pain never hurt so good.`);
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'monstrous') {
                          // TODO-QSP: dynamic text: You mew softly as <<$npcdesc>> continues to assfuck you with his gigantic cock. ...
                          scene.text(`You mew softly as ${((s as any).npcdesc ?? 0)} continues to assfuck you with his gigantic cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, forcing whimpers from your lips as his insane length makes your innards feel like they're being turned inside out and his absurd girth threatens to tear you in half. Pain never hurt so good.`);
                        }
                      }
                    }
                  }
    ...
    if (((s as any).sex_ev ?? 0)?.['moan'] === 2) {
      ...
      if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
        ...
        scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His tiny dick is driving as deep as it can inside you, finding the hidden secrets of your anus that make your pussy weep with every thrust.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'chode') {
          // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His fat c...
          scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His fat chode driving as deep as it can inside you, stretching your anus and making your pussy weep with every thrust.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'skinny') {
            // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His skinn...
            scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His skinny dick is driving as deep as it can inside you, finding the hidden secrets of your anus that make your pussy weep with every thrust.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'normal') {
              // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His cock ...
              scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His cock is driving deep inside you, filling your anus and making your pussy weep with every thrust.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'thick') {
                if (((s as any).agape ?? 0) < 2) {
                  // TODO-QSP: dynamic text: Loud groans escape your lips as <<$npcdesc>> continues to fuck you with his thic...
                  scene.text(`Loud groans escape your lips as ${((s as any).npcdesc ?? 0)} continues to fuck you with his thick cock. Slowly. Gently. He drives it deep inside you, stretching your tight anus with its exceptional girth, making you wetter and wetter with every thrust.`);
                } else {
                  // TODO-QSP: dynamic text: Loud moans escape your lips as <<$npcdesc>> continues to fuck you with his thick...
                  scene.text(`Loud moans escape your lips as ${((s as any).npcdesc ?? 0)} continues to fuck you with his thick cock. Slowly. Gently. He drives it deep inside you, filling you with its exceptional girth, making you wetter and wetter with every thrust.`);
                }
              } else {
                if (((s as any).dick_desc ?? 0) === 'long') {
                  // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His long ...
                  scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His long cock driving deep inside you until it's plunged to the hilt; its presence felt even in the deepest parts of your anus, making you wetter and wetter with every thrust.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'huge') {
                    // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you. Slowly. Gently. His huge ...
                    scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you. Slowly. Gently. His huge cock driving deep inside you until it's plunged to the hilt; its presence felt even in the deepest parts of your intestines, filling you, making you wetter and wetter with every thrust.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'enormous') {
                      if (((s as any).pcs_ass ?? 0) <= 15) {
                        // TODO-QSP: dynamic text: Loud groans escape your lips as <<$npcdesc>> continues to fuck you with his enor...
                        scene.text(`Loud groans escape your lips as ${((s as any).npcdesc ?? 0)} continues to fuck you with his enormous cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, making its presence felt in the deepest parts of your intestines even as it <i>stretches</i> your tight anus to accommodate his exceptional girth. But you love it, becoming wetter and wetter with every thrust.`);
                      } else {
                        // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you with his enormous cock. Sl...
                        scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his enormous cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, making its presence felt in the deepest parts of your intestines even as it <i>stretches</i> your anus to accommodate its exceptional girth. But you love it, becoming wetter and wetter with every thrust.`);
                      }
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'lengthy') {
                        // TODO-QSP: dynamic text: You moan loudly as <<$npcdesc>> continues to fuck you with his exceptionally len...
                        scene.text(`You moan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his exceptionally lengthy cock. Slowly. Gently. He drives it deep inside you until it's plunged to the hilt, forcing groans from your lips as your innards feel like they're being turned inside out. Pain never hurt so good.`);
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'gigantic') {
                          // TODO-QSP: dynamic text: You groan loudly as <<$npcdesc>> continues to fuck you with his gigantic cock.Sl...
                          scene.text(`You groan loudly as ${((s as any).npcdesc ?? 0)} continues to fuck you with his gigantic cock.Slowly. Gently. He drives it deep inside you, <i>filling</i> you until it's plunged to the hilt, forcing groans from your lips as your insides feel like they're being turned inside out. Pain never hurt so good.`);
                        } else {
                          if (((s as any).dick_desc ?? 0) === 'monstrous') {
...
function enterAnal1_2DirtyTalk(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'cock') {
    if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
      ...
      if (((s as any).dick_desc ?? 0) === 'chode') {
        // TODO-QSP: dynamic text: "Ah~! Yes~! Just like that~!" You moan, your voice a hoarse with arousal as <<$n...
        scene.text(`"Ah~! Yes~! Just like that~!" You moan, your voice a hoarse with arousal as ${((s as any).npcdesc ?? 0)} does an amazing job fucking you with his stubby cock. "Fuck me with your fat chop!"`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          // TODO-QSP: dynamic text: "Ah~! Yes~! Just like that~!" You moan, your voice a hoarse with arousal as <<$n...
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      ...
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        ...
        if (((s as any).dick_desc ?? 0) === 'normal') {
          ...
          scene.text(`The angle is perfect</i>, and ${((s as any).npcdesc ?? 0)} fills you up just right with his dick, reaching deep inside you with his dick. You can feel your wetness spreading, running down your thighs, and heat radiating from your sex and from his. You pant softly as you sink further and further into the feelings of your own arousal.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      ...
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        ...
        if (((s as any).dick_desc ?? 0) === 'normal') {
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
            scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Wet slaps echo around the room as his hips collide with your ass, the sloppy squelching sounds of your ass fucked by his thick shaft.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
              scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his long, dick hammers deep inside you. Wet slaps echo around the room as his hips collide with your ass, the sloppy sounds of your ass squelching around his long shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust and his dick hammers deep inside you. Wet slaps echo around the room as his hips collide with your ass, the huge size of his cock forcing squelches from your chest.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                  scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, and his enormous dick fills you to the brim. Wet slaps echo around the room as his hips collide with your ass, forcing loud squelches from your sphincter with his long girthy cock.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                    ...
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                      scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust, and his gigantic dick fills you to the brim. Sloppy wet slaps echo around the room as ${((s as any).npcdesc ?? 0)} batters your ass with his long, hard cock.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: <<$npcdesc>> drives into you at a steady pace, hard enough that your breasts jig...
                        scene.text(`${((s as any).npcdesc ?? 0)} drives into you at a steady pace, hard enough that your breasts jiggle with every thrust. His dick fills you completely and then some, forcing your asshole to strain and stretch around his long, girthy shaft. Sloppy wet slaps echo around the room as ${((s as any).npcdesc ?? 0)} repeatedly batters your ass with his monstrous cock.`);
                      }
                    }
                  }
                }
...
function enterAnal2EnjoyDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      ...
      scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, his thick chode stretching the opening of your asshole with his balls deep thrusts. Waves of pleasure reverberate through your body every time his hips collide with your ass.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        ...
        if (((s as any).dick_desc ?? 0) === 'normal') {
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            ...
            scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, plunging his thick cock balls deep into you from behind over and over again. Your asshole stretches with every thrust, and waves of pleasure reverberate through your body every time his hips collide with your ass.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You groan in pleasure as <<$npcdesc>> fucks you, plunging his lengthy cock balls...
              scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, plunging his lengthy cock balls deep into you from behind over and over again. He's so deep inside you, and waves of pleasure reverberate through your body every time his hips collide with your ass.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You groan in pleasure as <<$npcdesc>> fucks you, plunging his huge cock balls de...
                scene.text(`You groan in pleasure as ${((s as any).npcdesc ?? 0)} fucks you, plunging his huge cock balls deep into you from behind over and over again. He's so <i>deep inside you, filling you from end to end with cock, and waves of pleasure reverberate through your body every time his hips collide with your ass.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You groan in pleasure as <<$npcdesc>> fucks you, plunging his huge cock balls de...
      ...
      if (((s as any).dick_desc ?? 0) === 'chode') {
        ...
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          ...
          if (((s as any).dick_desc ?? 0) === 'normal') {
            ...
            if (((s as any).dick_desc ?? 0) === 'thick') {
              // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
              scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, accompanied by the sloppy squelching of your asshole getting reamed by his thick shaft.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'long') {
                // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                ...
                if (((s as any).dick_desc ?? 0) === 'huge') {
                  ...
                  if (((s as any).dick_desc ?? 0) === 'enormous') {
                    // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                    scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust and ${((s as any).npcdesc ?? 0)}'s enormous dick stretches you to the limit. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)} His hips crash into your ass, the enormous size of his cock forcing sloppy wet squelching from your dripping cunt.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'lengthy') {
                      // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                      ...
                      if (((s as any).dick_desc ?? 0) === 'gigantic') {
                        // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                        scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust, and his gigantic dick fills you to your absolute limit. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, pummeling your insides and forcing sloppy wet squelching from your dripping cunt.`);
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'monstrous') {
                          // TODO-QSP: dynamic text: With the new and improved pace, you find yourself enjoying it a lot more. It's h...
                          scene.text(`With the new and improved pace, you find yourself enjoying it a lot more. It's hard enough that your breasts jiggle with every thrust. His dick fills you completely and then some, forcing your asshole to strain and stretch around his monstrously long and girthy shaft. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, pummeling your insides and forcing sloppy wet squelching from your dripping cunt.`);
                        }
                      }
                    }
                  }
        ...
        if (((s as any).dick_desc ?? 0) === 'chode') {
          ...
          if (((s as any).dick_desc ?? 0) === 'skinny') {
            ...
            if (((s as any).dick_desc ?? 0) === 'normal') {
              ...
              if (((s as any).dick_desc ?? 0) === 'thick') {
                // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace, and you breathe a sigh of rel...
                scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace, and you breathe a sigh of relief. With your ass no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, but not so hard that he's jackhammering you. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, accompanied by the sloppy squelching of your asshole getting reamed by his thick shaft.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'long') {
                  // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace, and you breathe a sigh of rel...
                  ...
                  if (((s as any).dick_desc ?? 0) === 'huge') {
                    ...
                    if (((s as any).dick_desc ?? 0) === 'enormous') {
                      // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace, and you breathe a sigh of rel...
                      scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace, and you breathe a sigh of relief. With your ass no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust and ${((s as any).npcdesc ?? 0)}'s enormous dick stretches you to the limit. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)} His hips crash into your ass, the enormous size of his cock forcing sloppy wet squelching from your dripping cunt.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'lengthy') {
                        // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace, and you breathe a sigh of rel...
                        ...
                        if (((s as any).dick_desc ?? 0) === 'gigantic') {
                          // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace, and you breathe a sigh of rel...
                          scene.text(`${((s as any).npcdesc ?? 0)} slows down to a more manageable pace, and you breathe a sigh of relief. With your ass no longer feeling like it's being hammered numb, you start to enjoy this a lot more. It's hard enough that your breasts jiggle with every thrust, and his gigantic dick fills you to your absolute limit. Loud clapping echoes around the room as ${((s as any).npcdesc ?? 0)}'s hips crash into your ass, pummeling your insides and forcing sloppy wet squelching from your dripping cunt.`);
                        } else {
                          if (((s as any).dick_desc ?? 0) === 'monstrous') {
                            // TODO-QSP: dynamic text: <<$npcdesc>> slows down to a more manageable pace, and you breathe a sigh of rel...
...
function enterAnal2_2MoanDesc(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      ...
      scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you. His thick chode pounds into you from behind, wonderfully stretching your asshole like a good three-finger fucking, but better.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
        scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind. He pounds your ass, rubbing your g-spot through your intestines with his skinny dick.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
          scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind. He pounds your ass, rubbing your g-spot through your intestines with his dick.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
            scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind, pounding you with his <i>thick</i> cock that stretches your walls, squeezing pleasure from your ass with every thrust.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
              scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind, pounding you with his long-ass cock that reaches the very depths of your ass without even trying.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
                scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind, pounding you with his huge cock that fills you wonderfully and reaches the very depths of your ass without even trying.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
                  scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind, pounding you with his enormous cock that penetrates you to the depths of your ass and stretches your walls, squeezing pleasure from your ass with every thrust.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
                    scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind with his amazingly lengthy cock, literally pounding pleasure from your intestines with every thrust. Soreness is quickly building up inside you, and it feels so good. </i>`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
                      scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind with his gigantic cock, literally pounding pleasure from your intestines with every thrust. Soreness is quickly building up between your legs, and it feels so good. </i>`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: You moan <<$sex_ev['moan_describe']>> as <<$npcdesc>> keeps fucking you from beh...
                        scene.text(`You moan ${((s as any).sex_ev ?? 0)?.['moan_describe']} as ${((s as any).npcdesc ?? 0)} keeps fucking you from behind with his monstrous cock. It's stupidly huge, stretching you to breaking with every thrust and literally pounding your intestines with every thrust. Your asshole is so sore, and <i>it feels so good.</i>`);
                      }
                    }
                  }
                }
  ...
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      ...
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        ...
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s cock filling your a...
          scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s cock filling your ass, letting the pressure build inside you as he literally pounds pleasure into you from behind with his dick.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s thick cock stretchi...
            scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s thick cock stretching the walls of your ass, letting the pressure build inside you as he literally pounds pleasure into you from behind.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s long cock reaching ...
              scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s long cock reaching deep inside your ass, letting the pressure build inside you as he literally pounds pleasure into you from behind.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s huge cock filling y...
                scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s huge cock filling you up and reaching deep inside your ass, letting the pressure build inside you as he literally pounds pleasure into you from behind.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  ...
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    ...
                    scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s lengthy cock that batters your intestines, a feeling that you sense in your stomach, letting him literally pound pain and pleasure into you from behind.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: You let out sighs of contentment, focusing on <<$npcdesc>>'s gigantic cock that ...
                      scene.text(`You let out sighs of contentment, focusing on ${((s as any).npcdesc ?? 0)}'s gigantic cock that fills you past your limits as it batters your intestines, a feeling that you sense in your stomach, letting him literally pound pain and pleasure into you from behind.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
...
function enterAnal3StartDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force, fucking you as hard as he c...
      scene.text(`${((s as any).npcdesc ?? 0)} smashes into you with tremendous force, fucking you as hard as he can with his fat choke.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: <<$npcdesc>> smashes into you with tremendous force, fucking you as hard as he c...
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      ...
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        ...
        if (((s as any).dick_desc ?? 0) === 'normal') {
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
            scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, splitting your ass in half with his thick cock.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
              ...
              if (((s as any).dick_desc ?? 0) === 'huge') {
                ...
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
                  scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, splitting your ass in half and forcing every centimeter of his enormous cock deep inside you.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
                    scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, smashing into your intestines with his lengthy cock on every thrust.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'gigantic') {
                      // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
                      scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, filling you up and smashing into your intestines with his gigantic cock on every thrust.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'monstrous') {
                        // TODO-QSP: dynamic text: Your eyes roll back into your head as <<$npcdesc>> pummels you from behind. Loud...
                        scene.text(`Your eyes roll back into your head as ${((s as any).npcdesc ?? 0)} pummels you from behind. Loud slapping echoes off the walls as ${((s as any).npcdesc ?? 0)} claps your ass over and over again, splitting your ass in half and smashing into your intestines with his monstrous cock on every thrust.`);
                      }
                    }
                  }
                }
...
function enterAnal3TooRough(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
      scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s fat chode is uncomfortable in its girth, splitting your ass with painful force and your hips ache from the repeated clapping of your ass. You can even feel your cheeks turning red and sore from the punishment. It's agonizing and unpleasant, you can't get any satisfaction out of this at all.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
        ...
        if (((s as any).dick_desc ?? 0) === 'normal') {
          ...
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
            scene.text(`You scream as he pulls harder on your hair and you try to pull away, but you're unable to escape. ${((s as any).npcdesc ?? 0)}'s thick cock is uncomfortable in its girth, splitting your ass with painful force and your hips ache from the repeated clapping of your ass. You can even feel your cheeks turning red and sore from the punishment. It's agonizing and unpleasant, you can't get any satisfaction out of this at all.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You scream as he pulls harder on your hair and you try to pull away, but you're ...
...
function enterAnal3_1Desc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
      ...
      if (((s as any).dick_desc ?? 0) === 'chode') {
        // TODO-QSP: dynamic text: Tears begin to well up in your eyes as you half whimper and half moan in half pa...
        scene.text(`Tears begin to well up in your eyes as you half whimper and half moan in half pain and half pleasure. ${((s as any).npcdesc ?? 0)} keeps a firm hold on your hair and pulls hard with every thrust, forcing his fat chode into your ass to hurt you in all the <i>best</i> ways.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          // TODO-QSP: dynamic text: Tears begin to well up in your eyes as you half whimper and half moan in half pa...
          ...
          if (((s as any).dick_desc ?? 0) === 'normal') {
            ...
            if (((s as any).dick_desc ?? 0) === 'thick') {
              // TODO-QSP: dynamic text: Tears begin to well up in your eyes as you half whimper and half moan in half pa...
              scene.text(`Tears begin to well up in your eyes as you half whimper and half moan in half pain and half pleasure. ${((s as any).npcdesc ?? 0)} keeps a firm hold on your hair and pulls hard with every thrust, splitting your ass with his thick cock and hurting you in all the <i>best</i> ways.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'long') {
                // TODO-QSP: dynamic text: Tears begin to well up in your eyes as you half whimper and half moan in half pa...
                scene.text(`Tears begin to well up in your eyes as you half whimper and half moan in half pain and half pleasure. ${((s as any).npcdesc ?? 0)} keeps a firm hold on your hair and pulls hard with every thrust, hammering your intestines with his long cock and hurting you in all the <i>best</i> ways.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'huge') {
                  // TODO-QSP: dynamic text: Tears begin to well up in your eyes as you half whimper and half moan in half pa...
                  scene.text(`Tears begin to well up in your eyes as you half whimper and half moan in half pain and half pleasure. ${((s as any).npcdesc ?? 0)} keeps a firm hold on your hair and pulls hard with every thrust, hammering your intestines with his huge cock and hurting you in all the <i>best</i> ways.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'enormous') {
                    // TODO-QSP: dynamic text: Tears begin to well up in your eyes as you half whimper and half moan in half pa...
                    scene.text(`Tears begin to well up in your eyes as you half whimper and half moan in half pain and half pleasure. ${((s as any).npcdesc ?? 0)} keeps a firm hold on your hair and pulls hard with every thrust, hammering your intestines and threatening to rip your asshole in half with his enormous cock and hurting you in all the <i>best</i> ways.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'lengthy') {
                      // TODO-QSP: dynamic text: Tears begin to well up in your eyes as you half whimper and half moan in half pa...
                      scene.text(`Tears begin to well up in your eyes as you half whimper and half moan in half pain and half pleasure. ${((s as any).npcdesc ?? 0)} keeps a firm hold on your hair and pulls hard with every thrust, hammering your intestines with the entire length of his ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm cock and hurting you in all the <i>best</i> ways.`);
                    } else {
                      if (((s as any).dick_desc ?? 0) === 'gigantic') {
                        // TODO-QSP: dynamic text: Tears begin to well up in your eyes as you half whimper and half moan in half pa...
                        scene.text(`Tears begin to well up in your eyes as you half whimper and half moan in half pain and half pleasure. ${((s as any).npcdesc ?? 0)} keeps a firm hold on your hair and pulls hard with every thrust, hammering your intestines with his gigantic cock, forcing its entire ${((s as any).npc_dick ?? 0)?.[String((s as any).npcID ?? 0)]}cm length inside and hurting you in all the <i>best</i> ways.`);
                      } else {
                        if (((s as any).dick_desc ?? 0) === 'monstrous') {
                          // TODO-QSP: dynamic text: Tears begin to well up in your eyes as you half whimper and half moan in half pa...
        ...
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          ...
          if (((s as any).dick_desc ?? 0) === 'normal') {
            ...
            if (((s as any).dick_desc ?? 0) === 'thick') {
              ...
              if (((s as any).dick_desc ?? 0) === 'long') {
                // TODO-QSP: dynamic text: The bed creaks underneath you and your breasts jiggle violently with every thrus...
                scene.text(`The bed creaks underneath you and your breasts jiggle violently with every thrust. ${((s as any).npcdesc ?? 0)}'s hips slam against your thighs and you break out in a sweat, his long cock bashes against your intestines with every thrust.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'huge') {
                  // TODO-QSP: dynamic text: The bed creaks underneath you and your breasts jiggle violently with every thrus...
                  scene.text(`The bed creaks underneath you and your breasts jiggle violently with every thrust. ${((s as any).npcdesc ?? 0)}'s hips slam against your thighs and you break out in a sweat, his huge cock fills your entire pussy and bashes against your intestines with every thrust.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'enormous') {
                    // TODO-QSP: dynamic text: The bed creaks underneath you and your breasts jiggle violently with every thrus...
                    scene.text(`The bed creaks underneath you and your breasts jiggle violently with every thrust. ${((s as any).npcdesc ?? 0)}'s hips slam against your thighs and you break out in a sweat, his enormous cock batters your intestines, threatening to tear you in half with every thrust.`);
                  } else {
                    if (((s as any).dick_desc ?? 0) === 'lengthy') {
                      // TODO-QSP: dynamic text: The bed creaks underneath you and your breasts jiggle violently with every thrus...
      ...
      if (((s as any).dick_desc ?? 0) === 'chode') {
        ...
        if (((s as any).dick_desc ?? 0) === 'skinny') {
          ...
          if (((s as any).dick_desc ?? 0) === 'normal') {
            ...
            scene.text(`You pant like a bitch in heat as ${((s as any).npcdesc ?? 0)} continues to pound you with his dick. Sloppy wet sounds squelch from your asshole around his cock, combining with the loud clapping of your ass cheeks that fill the room as the rough doggy fucking sends pleasure rocking through your body.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'thick') {
  ...
  if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'cock') {
    ...
    if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'arousal') {
      ...
      if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'technique') {
        ...
        if (((s as any).sex_ev ?? 0)?.['dirty_talk'] === 'dirty_girl') {
          if (((s as any).npc_dirty_lover ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 2) + 1) === 1) {
            // TODO-QSP: dynamic text: "Who's ass is this?" <<$npcdesc>> growls as he pounds his cock into you like a b...
            scene.text(`"Who's ass is this?" ${((s as any).npcdesc ?? 0)} growls as he pounds his cock into you like a battering ram.`);
            scene.text('"Yours~!" you whimper into the bedsheets.');
          } else {
            if (((s as any).pcs_horny ?? 0) >= 70) {
              if ((Math.floor(Math.random() * 1) + 1) === 1) {
...
function enterAnal3_2SensationDesc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).dick_desc ?? 0) === 'tiny'  ||  ((s as any).dick_desc ?? 0) === 'short') {
    ...
    scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his tiny dick violently violating your asshole.`);
  } else {
    if (((s as any).dick_desc ?? 0) === 'chode') {
      // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
      scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his fat chode violently violating your asshole.`);
    } else {
      if (((s as any).dick_desc ?? 0) === 'skinny') {
        // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
        scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his skinny dick violently violating your asshole.`);
      } else {
        if (((s as any).dick_desc ?? 0) === 'normal') {
          // TODO-QSP: dynamic text: Youpant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll b...
          scene.text(`Youpant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his dick violently violating your asshole.`);
        } else {
          if (((s as any).dick_desc ?? 0) === 'thick') {
            // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
            scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his thick cock violently stretching out your asshole.`);
          } else {
            if (((s as any).dick_desc ?? 0) === 'long') {
              // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
              scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his long cock repeatedly knocking on your intestines as it violently penetrates you over and over again.`);
            } else {
              if (((s as any).dick_desc ?? 0) === 'huge') {
                // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
                scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the sensation of the huge cock inside you repeatedly knocking on your intestines as it violently violates your asshole.`);
              } else {
                if (((s as any).dick_desc ?? 0) === 'enormous') {
                  // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
                  scene.text(`You pant heavily as ${((s as any).npcdesc ?? 0)} keeps pounding you from behind. Your eyes roll back in your head and all you can do is gasp for breath and lose yourself in the feeling of his enormous cock knock against your intestines while it threatens to tear you in half.`);
                } else {
                  if (((s as any).dick_desc ?? 0) === 'lengthy') {
                    // TODO-QSP: dynamic text: You pant heavily as <<$npcdesc>> keeps pounding you from behind. Your eyes roll ...
...
function enterWantTo(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((Math.floor(Math.random() * 2) + 0) === 1  ||  ((s as any).npc_generous ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
      scene.actions([{ label: 'Continue', goto: ['sex_ev_anal', 'anal_virg_norm1'] }]);
    } else {
      scene.actions([{ label: 'Continue', goto: ['sex_ev_anal', 'anal_virg_hard1'] }]);
    }
  } },
    ]);
  } },
...
function enterBjInstead(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`Unable to summon the will to say no, you nod and turn around. You bite your lip in apprehension as you feel ${((s as any).npcdesc ?? 0)} push his cock inside your ass.`);
    scene.actions([
...
function enterAnalVirgNorm1(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['position'] = 'anal';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'anal1';
  scene.img('images/shared/sex/anal/doggy/insert_shock1.mp4');
  ...
  scene.actions([
    { label: 'It hurts', handler: (st: GameState) => {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_react'] = 'hurt';
  }, goto: ['sex_ev_anal', 'anal_virg_norm1.1'] },
    { label: 'I\'m fine', handler: (st: GameState) => {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_react'] = 'fine';
  }, goto: ['sex_ev_anal', 'anal_virg_norm1.1'] },
    { label: 'Just hum', handler: (st: GameState) => {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_react'] = 'mmm';
  }, goto: ['sex_ev_anal', 'anal_virg_norm1.1'] },
  ]);
  scene.build();
}
...
function enterAnalVirgNorm1_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'sex_ev_anal', '', '' + qspUntranslated(s, "sex_ev['virgin_react']>", { location: "sex_ev_anal" }) + '_react2');
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'anal1';
    qspCall(s, 'stat', '');
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_media'] = '<center><video autoplay loop ' + qspUntranslated(s, "set_imgh>", { location: "sex_ev_anal" }) + ' src="images/shared/sex/anal/doggy/slow2.mp4"></video></center>';
    ...
    scene.text(`As promised, ${((s as any).npcdesc ?? 0)} fucks you very gently, slowly pumping his cock in and out of you. He displays what you can only imagine is incredible resilience, as he maintains this slow and gentle pace for several minutes, at which point you think...`);
  }, goto: ['sex_ev_anal', 'virgin_enjoyment'] },
    ]);
  } },
  ]);
  scene.build();
...
function enterAnalVirgHard1(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['position'] = 'anal';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pos_speed'] = 'anal3';
  ...
  if (((s as any).know_virgin ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    ...
    // TODO-QSP: dynamic text: Without warning, <<$npcdesc>> plunges his entire cock all the way inside you. He...
    scene.text(`Without warning, ${((s as any).npcdesc ?? 0)} plunges his entire cock all the way inside you. He tears straight through your unprepared pucker ring, eliciting a uncontainable shriek of pain from your lips and tears immediately filling your eyes. If he understood how much saving your virginity meant to you, then he doesn't show it as he throws his full weight against you and bears you down onto the bed. Your arms and legs buckle beneath you, and his cock drives all the way inside you.`);
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc ?? 0)} fucks you roughly and without mercy or restraint. It hurts so much. Every time his cock slams back in to you, you feel like you're going to die. It's like your ass is being torn in half and you wonder if you're going to bleed after this. He lets all of his weight rest on top of you, driving the breath out from your lungs. You can't even scream. All you can do is squirm beneath ${((s as any).npcdesc ?? 0)} as he pounds your virgin ass over and over again.`);
    scene.actions([
    ...
    // TODO-QSP: dynamic text: "Can we-! Slow down-! A little-?" you manage to gasp under <<$npcdesc>>'s relent...
    scene.text(`"Can we-! Slow down-! A little-?" you manage to gasp under ${((s as any).npcdesc ?? 0)}'s relentless hard pounding. "This is-! Too-! Rough-!"`);
    if (((Math.floor(Math.random() * 10) + 1) >= 7  ||  ((s as any).npc_selfish ?? 0)?.[String((s as any).npcID ?? 0)] === 1  ||  ((s as any).npc_abusive ?? 0) === 1)  &&  ((s as any).npc_generous ?? 0)?.[String((s as any).npcID ?? 0)] !== 1) {
      ...
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['speed_change'] = 1;
      ...
      scene.text(`He stops and pulls back for a moment. You take a breath of relief, pulling yourself back up to your arms and knees again and ${((s as any).npcdesc ?? 0)} re-enters you. Slowly this time, and much more gently.`);
      scene.actions([
...
function enterAnalVirgHard2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).npcdesc ?? 0)} picks up the pace as you command and you start to push your hips back in times with his. The sound of your ass being clapped echoes off the walls. The heightened pace feels even better than it did when he was being gentle and you moan loudly with intense pleasure.`);
  if (((s as any).sex_ev ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
    // TODO-QSP: dynamic text: You're so caught up in the enjoyment of it that your orgasm catches you by surpr...
    scene.text(`You're so caught up in the enjoyment of it that your orgasm catches you by surprise. The pressure inside you builds and builds with each time ${((s as any).npcdesc ?? 0)}'s cock fills you up. One moment you're thinking, <i>More! More! More!</i> and the next, every muscle in your body goes taut and you realize you're about to cum.`);
  } else {
...
function enterAnalVirgHard2_2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).npcdesc ?? 0)} picks up the pace as you command and you groan loudly, face contorting in a mixture of pain and pleasure. Maybe sensing something within you, he reaches up and grabs a fistful of your hair, using it to pull himself into you even harder.`);
...
function enterVirginEnjoyment(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['speed_change'] === 1) {
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['fuck_enjoyment'] = 'painful';
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_hurt'] = 1;
    qspCall(s, 'sex_ev_sex', 'fuck_arousal_code');
    (s as any).pcs_horny = ((s as any).pcs_horny ?? 0) - (50);
    qspCall(s, 'stat', '');
    scene.text('... still find it really painful.');
    // TODO-QSP: dynamic text: Maybe it's just the after effect of being too rough with you before carrying ove...
    scene.text(`Maybe it's just the after effect of being too rough with you before carrying over, but this <i>really fucking hurts!</i> Every time ${((s as any).npcdesc ?? 0)} thrusts into you, it feels like your ass is going to split in half. Everything about it hurts. Your insides hurt, your sphincter hurts, your rectum hurts, it feels like someone is literally stabbing your asshole with a knife. You keep expecting it to get better, for the pain to go away and the enjoyment to start, but it never does. All you can do is clench your teeth, squeeze your eyes shut, and keep enduring until it's over.`);
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    qspCall(s, 'sex_ev_sex', 'fuck_continue');
  } },
      { label: '... aren\'t really enjoying it', handler: (st: GameState) => {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['fuck_enjoyment'] = 'unsatisfying';
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_numb'] = 1;
    // TODO-QSP: gs 'arousal', 'anal', 1, 'no_orgasm_msg', $sex_ev['prostitution_flag']
    (s as any).minut = ((s as any).minut ?? 0) + (Math.floor(Math.random() * 2) + 3);
    qspCall(s, 'stat', '');
    ...
    if (((s as any).sex_ev ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
      // TODO-QSP: dynamic text: You're so caught up in the enjoyment of it, you almost don't realize when you're...
      scene.text(`You're so caught up in the enjoyment of it, you almost don't realize when you're about to come. The pressure inside you building and building with each time ${((s as any).npcdesc ?? 0)}'s cock fills you up. One moment you're thinking, <i>More! More! More!</i> and the next, every muscle in your body goes taut as you cum hard on ${((s as any).npcdesc ?? 0)}'s dick.`);
    } else {
    ...
    if (((s as any).sex_ev ?? 0)?.['virgin_react'] === 'hurt') {
      ...
      if (((s as any).sex_ev ?? 0)?.['virgin_react'] === 'fine') {
        ...
        scene.text(`That "fullness" you remarked upon earlier has somehow become even more full as ${((s as any).npcdesc ?? 0)} has continued to fuck your ass. Arousal flows like water from your pussy, dripping down your thighs. His cock reaches deep inside you and it feels <i>so good</i>, causing you to openly moan.`);
      } else {
        if (((s as any).sex_ev ?? 0)?.['virgin_react'] === 'mmm') {
          // TODO-QSP: dynamic text: That "fullness" you remarked upon earlier has somehow become even more full as <...
          scene.text(`That "fullness" you remarked upon earlier has somehow become even more full as ${((s as any).npcdesc ?? 0)} has continued to fuck your ass. Arousal flows like water from your pussy, dripping down your thighs. His cock reaches deep inside you and it feels <i>so good</i>, causing you to openly moan.`);
    ...
    if (((s as any).sex_ev ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
      // TODO-QSP: dynamic text: You're so caught up in the enjoyment of it that your orgasm catches you by surpr...
      scene.text(`You're so caught up in the enjoyment of it that your orgasm catches you by surprise. The pressure inside you builds and builds with each time ${((s as any).npcdesc ?? 0)}'s cock fills you up. One moment you're thinking, <i>More! More! More!</i> and the next, every muscle in your body goes taut and you realize you're about to come.`);
    } else {
      scene.text('You spend the next several minutes fucking joyously, wondering why you waited so long to feel this good!');
    }
    qspCall(s, 'sex_ev_cum', 'fuck_cum');
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['fuck_enjoyment'] = 'enjoy';
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['virgin_pain_good'] = 1;
    qspCall(s, 'sex_ev_sex', 'fuck_arousal_code');
    // TODO-QSP: gs 'arousal', 'anal', -15, 'no_orgasm_msg', $sex_ev['prostitution_flag']
    qspCall(s, 'stat', '');
    // TODO-QSP: dynamic text: The initial pain you felt is still there, but somehhow it's evolved. <<$npcdesc>...
    scene.text(`The initial pain you felt is still there, but somehhow it's evolved. ${((s as any).npcdesc ?? 0)}'s cock is slick with your blood cock and every time moves inside you, it feels like your vagina is going to split in half. It reaches deep inside you, like a knife stabbing into your intestines. And it feels <i>so good</i>.`);
    ...
    scene.text(`"${((s as any).npcdesc ?? 0)}," you say, tears now streaming down your face. "I want you to fuck me harder."`);
    ...
    scene.text(`"${((s as any).npcdesc ?? 0)}," you say. "I want you to fuck me harder."`);
...
function enterVirgContinueHarder(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['virgin_pain_good'] !== 1) {
    scene.actions([{ label: 'Continue', goto: ['sex_ev_anal', 'anal_virg_hard2'] }]);
  } else {

...
function enterPregnancyVisibility(s: GameState, scene: SceneBuilder): void {
  (s as any).RESULT = 0;
  (s as any).pregchemTemp = ((String((s as any).locArgs?.[1] ?? '') === 0) ? (((s as any).pregChem ?? 0)) : (((s as any).locArgs?.[1] ?? 0)));
  (s as any).clothingworntypeTemp = ((String((s as any).locArgs?.[2] ?? '') === '') ? (((s as any).clothingworntype ?? 0)) : (((s as any).locArgs?.[2] ?? 0)));
  (s as any).clothingwornnumberTemp = ((String((s as any).locArgs?.[3] ?? '') === 0) ? (((s as any).clothingwornnumber ?? 0)) : (((s as any).locArgs?.[3] ?? 0)));
  qspCall(s, 'clothing_attributes', '$clothingworntypeTemp', ((s as any).clothingwornnumberTemp ?? 0));

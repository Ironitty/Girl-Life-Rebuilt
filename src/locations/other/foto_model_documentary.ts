...
function enter1stDocumentary(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).modelfoto ?? 0)?.['nip'] < 1) {
    ...
    if (((st as any).pcs_inhib ?? 0) < 30) {
      qspCall(st, 'willpower', 'skill', 'inhib', 'resist', 'easy');
    } else {
      if (((st as any).pcs_inhib ?? 0) < 45) {
        qspCall(st, 'willpower', 'skill', 'inhib', 'resist', 'medium');
      } else {
...
function enterDocumentary_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).foto_documentary ?? 0)?.['question_1'] === 'artistic nude'  ||  ((st as any).foto_documentary ?? 0)?.['question_1'] === 'erotic') {
      ...
      // TODO-QSP: dynamic text: "My name is <<$model[''firstname'']>>. I''m <<model[''age'']>> years old, and I'...
      scene.text('"My name is ' + ((st as any).model ?? 0)?.['firstname'] ?? '' + '. I\'m ' + ((st as any).model ?? 0)?.['age'] ?? '' + ' years old, and I\'m a \' + iif($foto_documentary[\'question_1\'] = \', \', \'' + ((st as any).foto_documentary ?? 0)?.['question_1'] ?? '' + ' \') + \'model at Aphrodite photography."');
    }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ...
    if (((st as any).foto_documentary ?? 0)?.['question_1'] === 'artistic nude'  ||  ((st as any).foto_documentary ?? 0)?.['question_1'] === 'erotic') {
      ...
      // TODO-QSP: dynamic text: "My name is <<$model[''firstname'']>>, but my friends call me <<$model[''nicknam...
      scene.text('"My name is ' + ((st as any).model ?? 0)?.['firstname'] ?? '' + ', but my friends call me ' + ((st as any).model ?? 0)?.['nickname'] ?? '' + '. I\'m ' + ((st as any).model ?? 0)?.['age'] ?? '' + ' years old, and I\'m a \' + iif($foto_documentary[\'question_1\'] = \', \', \'' + ((st as any).foto_documentary ?? 0)?.['question_1'] ?? '' + ' \') + \'model at Aphrodite photography."');
    }
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_2(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
...
function enterDocumentary_2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_inhib ?? 0) < 20  ||  ((s as any).studio_inhib ?? 0) > 0) {
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_2'] = 'build_confidence';
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_3(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  if (((s as any).trait_vars ?? 0)?.['exhibitionist'] > 0) {
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_2'] = 'exhibitionism';
  ...
  scene.actions([
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_2'] = 'career';
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_2'] = 'extra_cash';
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_2'] = 'desperation';
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_2'] = 'attention';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
...
function enterDocumentary_3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_4(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    { label: 'I want to be the number one model in the city', handler: (st: GameState) => {
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_3'] = 'number_one_model';
    scene.img('images/locations/city/citycenter/photo/special/interview/1.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_3.2'] = 'prestige';
    scene.img('images/locations/city/citycenter/photo/special/interview/1.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_3.2'] = 'personal_reasons';
    scene.img('images/locations/city/citycenter/photo/special/interview/10.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_3'] = 'hate_diet';
    scene.img('images/locations/city/citycenter/photo/special/interview/8.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_3'] = 'pays_the_bills';
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_3'] = 'love_modelling';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_3'] = 'not_sure';
...
function enterDocumentary_4(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_inhib ?? 0) < 40) {
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_4'] = 'shy';
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_5(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  // TODO-QSP: end
  scene.actions([
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_4'] = 'formerly_shy';
    scene.img('images/locations/city/citycenter/photo/special/interview/8.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_4'] = 'childhood_shy';
    scene.img('images/locations/city/citycenter/photo/special/interview/3.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_4'] = 'never_shy';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_4'] = 'fucking_hot';
    scene.img('images/locations/city/citycenter/photo/special/interview/10.mp4');
...
function enterDocumentary_5(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).studio_inhib ?? 0) > 0) {
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_5'] = 'got_used_to_dresscode';
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_6(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      { label: 'I think it really helped me', handler: (st: GameState) => {
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_5'] = 'helpful_dresscode';
    scene.img('images/locations/city/citycenter/photo/special/interview/8.mp4');
  ...
  scene.actions([
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_5'] = 'embarrassing_dresscode';
    scene.img('images/locations/city/citycenter/photo/special/interview/8.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_5'] = 'not_comfortable_dresscode';
    scene.img('images/locations/city/citycenter/photo/special/interview/8.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_5'] = 'dont_mind_dresscode';
    scene.img('images/locations/city/citycenter/photo/special/interview/1.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_5'] = 'love_dresscode';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_5'] = 'comrade_dresscode';
    scene.img('images/locations/city/citycenter/photo/special/interview/12.mp4');
...
function enterDocumentary_6(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_7(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    { label: 'Sports', handler: (st: GameState) => {
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_6'] = 'sports';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_6'] = 'dancing';
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_6'] = 'martial_arts';
    scene.img('images/locations/city/citycenter/photo/special/interview/1.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_6'] = 'foodie';
    scene.img('images/locations/city/citycenter/photo/special/interview/12.mp4');
    ...
    if (((st as any).foto_documentary ?? 0)?.['question_3'] === 'hate_diet') {
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_6'] = 'clubbing';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_6'] = 'sex_clean';
    scene.img('images/locations/city/citycenter/photo/special/interview/12.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_6'] = 'sex_slutty';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_6'] = 'masturbation_hobby';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_6'] = 'no_hobbies';
    scene.img('images/locations/city/citycenter/photo/special/interview/12.mp4');
...
function enterDocumentary_7(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_8(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    { label: 'Something fun with lots of activities', handler: (st: GameState) => {
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_7'] = 'activity_based';
    scene.img('images/locations/city/citycenter/photo/special/interview/10.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_7'] = 'dinner_and_movie';
    scene.img('images/locations/city/citycenter/photo/special/interview/9.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_7'] = 'long_walk';
    scene.img('images/locations/city/citycenter/photo/special/interview/12.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_7'] = 'thrilling_date';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_7'] = 'romantic_sex';
    scene.img('images/locations/city/citycenter/photo/special/interview/12.mp4');
...
function enterDocumentary_8(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_9(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    { label: 'Day drinking', handler: (st: GameState) => {
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_8'] = 'day_drinking';
    scene.img('images/locations/city/citycenter/photo/special/interview/12.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_8'] = 'binge_watching';
    scene.img('images/locations/city/citycenter/photo/special/interview/5.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_8'] = 'romance_novels';
    scene.actions([
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_8'] = 'bad_romcoms';
    scene.img('images/locations/city/citycenter/photo/special/interview/4.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_8'] = 'social_media';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
...
function enterDocumentary_9(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_10(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    { label: 'Panties', handler: (st: GameState) => {
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_9'] = 'panties_bed';
    scene.img('images/locations/city/citycenter/photo/special/interview/1.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_9'] = 'naked_bed';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_9'] = 'negligee_bed';
    scene.img('images/locations/city/citycenter/photo/special/interview/12.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_9'] = 'shirt_panties_bed';
    scene.img('images/locations/city/citycenter/photo/special/interview/8.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_9'] = 'big_shirt_bed';
    scene.img('images/locations/city/citycenter/photo/special/interview/1.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_9'] = 'pajamas';
    scene.img('images/locations/city/citycenter/photo/special/interview/1.mp4');
...
function enterDocumentary_10(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_11(s, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    { label: 'Early morning to do chores', handler: (st: GameState) => {
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_10'] = 'chores_morning';
    scene.img('images/locations/city/citycenter/photo/special/interview/12.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_10'] = 'breakfast_morning';
    scene.img('images/locations/city/citycenter/photo/special/interview/1.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_10'] = 'coffee_morning';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_10'] = 'crude_coffee_morning';
    scene.img('images/locations/city/citycenter/photo/special/interview/6.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_10'] = 'brunch_morning';
    scene.img('images/locations/city/citycenter/photo/special/interview/3.mp4');
    ...
    ((st as any).foto_documentary = (st as any).foto_documentary ?? {})['question_10'] = 'wakeup_sex_morning';
    scene.img('images/locations/city/citycenter/photo/special/interview/1.mp4');

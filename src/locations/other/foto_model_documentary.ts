...
function enterDocumentary_2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_inhib ?? 0) < 20  ||  ((s as any).studio_inhib ?? 0) > 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_3(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
...
function enterDocumentary_3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_4(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterDocumentary_4(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_inhib ?? 0) < 40) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_5(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
  scene.actions([
...
function enterDocumentary_5(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).studio_inhib ?? 0) > 0) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_6(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterDocumentary_7(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_8(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterDocumentary_9(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_10(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
...
function enterDocumentary_10(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterDocumentary_11(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },

...
function enterDormFloor(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).uni_dorm) (s as any).uni_dorm = {}; (s as any).uni_dorm['event_minut'] = ((s as any).totminut ?? 0) + 60;
  if ((!((s as any).temp ?? 0))) {
                                                          ...
                                                          if (((s as any).temp ?? 0) === 28) {
                                                            ...
                                                            if (((s as any).temp ?? 0) === 29  &&  ((s as any).locat ?? 0)?.['A23'] === 26) {
                                                              ...
                                                              if (((s as any).temp ?? 0) === 30) {
                                                                ...
                                                                if (!(s as any).harunaQW) (s as any).harunaQW = {}; (s as any).harunaQW['meet'] = 1;

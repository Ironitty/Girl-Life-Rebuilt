    ...
    if (((s as any).IgorQW ?? 0)?.['with'] === 1) {
      if (((s as any).PCloBimbo ?? 0) === 1) {
        ...
        if (((s as any).grupTipe ?? 0) === 4) {
          if (((s as any).IgorQW ?? 0)?.['Lover'] > 0) {
            scene.actions([{ label: 'Continue', goto: ['igorhome', 'kitchen6'] }]);
          } else {
            scene.actions([{ label: 'Continue', goto: ['igorhome', 'kitchen5'] }]);
          }
        } else {
          scene.actions([{ label: 'Continue', goto: ['igorhome', 'kitchen3'] }]);
        }
      }
    } else {
      if (((s as any).PCloBimbo ?? 0) === 1) {
        scene.actions([{ label: 'Continue', goto: ['igorhome', 'kitchen2'] }]);
      } else {
        if (((s as any).grupTipe ?? 0) === 4) {
          scene.actions([{ label: 'Continue', goto: ['igorhome', 'kitchen7'] }]);
        } else {
          scene.actions([{ label: 'Continue', goto: ['igorhome', 'kitchen4'] }]);
        }
      }
    }
  } },
...
function enterHome(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locat ?? 0)?.['igor'] === 7  &&  ((s as any).hour ?? 0) < 18) {
    if ((!(Math.floor(Math.random() * 4) + 0))) {
      scene.actions([{ label: 'Continue', goto: ['igorhome', 'home2'] }]);
    }

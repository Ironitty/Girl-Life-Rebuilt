...
function enter(s: GameState, scene: SceneBuilder): void {
  if ((((s as any).locArgs?.[0] ?? 0) === ''  &&  ((s as any).locArgs?.[0] ?? 0) > 0)  ||  ((s as any).locArgs?.[0] ?? 0) !== ''  &&  !isNaN(((s as any).locArgs?.[0] ?? 0)) && ((s as any).locArgs?.[0] ?? 0) !== '') {
    ...
    (s as any).npcStatVars['tempID'] = 'A' + ((s as any).npclastcalledn ?? 0);
  } else {
  ...
  if (((s as any).npcStatVars ?? 0)?.['inanimate']) {
    (s as any).npcStatVars['sexskill'] = ((s as any).stat ?? {})?.['mast'] / 3;
  ...
  if (((s as any).npcStatVars ?? 0)?.['dob'] !== 0) {
    (s as any).npcStatVars['bday'] = (((s as any).npcStatVars ?? {})?.['dob'] % 100);
    (s as any).npcStatVars['bmonth'] = (((s as any).npcStatVars ?? {})?.['dob'] / 100) % 100;
    (s as any).npcStatVars['byear'] = ((s as any).npcStatVars ?? {})?.['dob'] / 10000;
    (s as any).npcStatVars['age'] = ((s as any).npcStatVars ?? {})?.['byear'] - ((s as any).year ?? 0);
  ...
  if (((s as any).npcStatVars ?? 0)?.['outfit'] === '') {
    ...
    if ((!((s as any).temp_rand ?? 0))) {
      ...
      if (((s as any).temp_rand ?? 0) === 1) {
        ...
        (s as any).npcStatVars['outfit'] = 'an expensive ' + ((((s as any).npcStatVars ?? 0)?.['gender'] === 0) ? ('suit') : ('dress'));
      }
    }
  }
  ...
  if (((s as any).npcStatVars ?? 0)?.['height'] === 0) {
    ...
    (s as any).npcStatVars['bmi'] = 100000 * ((s as any).npcStatVars ?? {})?.['weight'] / (((s as any).npcStatVars ?? {})?.['height'] * ((s as any).npcStatVars ?? {})?.['height']);
  }
  if (((s as any).npcStatVars ?? 0)?.['gender'] === 0) {
  ...
  if (((s as any).locArgs?.[1] ?? 0) !== ''  &&  ((s as any).npcStat_i ?? 0) > 0) {
    ...
    if (((s as any).npcSexskill ?? 0)?.[String((s as any).npcStat_i ?? 0)] > 2) {
      (s as any).silavag[String((s as any).npcStat_i ?? 0)] = Math.max(0, Math.min(((s as any).npcSexskill ?? 0)?.[String((s as any).npcStat_i ?? 0)] / 34, 2));
    } else {

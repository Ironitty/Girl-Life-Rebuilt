...
function enterBandGarage(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).gopnikbandQW ?? {})['radomirblocked'] = 0;
  if (((s as any).gopnikbandQW ?? 0)?.['beer_daystart'] < ((s as any).daystart ?? 0)) {
    ((s as any).gopnikbandQW ?? {})['beer_count'] = 0;
  }
  ...
  if (((s as any).locat ?? 0)?.['A144'] === 24  &&  ((s as any).locat ?? 0)?.['A154'] === 24  &&  ((s as any).locat ?? 0)?.['A156'] === 24  &&  ((s as any).locat ?? 0)?.['A158'] === 24  &&  ((s as any).hour ?? 0) < 23) {
    ...
    ((s as any).gopnikbandQW ?? {})['beer_daystart'] = ((s as any).daystart ?? 0);
    ((s as any).gopnikbandQW ?? {})['beer_count'] = (((s as any).gopnikbandQW ?? {})['beer_count'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterHangout1(s: GameState, scene: SceneBuilder): void {
  ...
  qspCall(s, 'stat', '');
  ((s as any).gopnikbandQW ?? {})['alyona_present'] = 1;
  ((s as any).gopnikbandQW ?? {})['lena_lara_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['lavrenti_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['roman_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['niko_present'] = 0;
...
function enterHangout2(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 15;
  qspCall(s, 'stat', '');
  ((s as any).gopnikbandQW ?? {})['alyona_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['lena_lara_present'] = 1;
  ((s as any).gopnikbandQW ?? {})['lavrenti_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['roman_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['niko_present'] = 0;
  scene.img('images/locations/pavlovsk/resident/apartment/garage/band/hangout\' + rand(1, 4) + \'.jpg');
...
function enterHangout3(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).gopnikbandQW ?? {})['alyona_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['lena_lara_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['lavrenti_present'] = 1;
  ((s as any).gopnikbandQW ?? {})['roman_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['niko_present'] = 0;
  scene.img('images/locations/pavlovsk/resident/apartment/garage/band/hangout\' + rand(1, 4) + \'.jpg');
...
function enterHangout6(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).gopnikbandQW ?? {})['lavrenti_present'] = 1;
  ((s as any).gopnikbandQW ?? {})['roman_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['niko_present'] = 1;
  scene.img('images/locations/pavlovsk/resident/apartment/garage/band/hangout\' + rand(1, 4) + \'.jpg');
...
function enterHangout7(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).gopnikbandQW ?? {})['lena_lara_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['lavrenti_present'] = 0;
  ((s as any).gopnikbandQW ?? {})['roman_present'] = 1;
  ((s as any).gopnikbandQW ?? {})['niko_present'] = 1;
  scene.img('images/locations/pavlovsk/resident/apartment/garage/band/hangout\' + rand(1, 4) + \'.jpg');

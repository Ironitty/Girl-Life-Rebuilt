...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).placerParameter ?? 0)?.['player_act'] === 0) {
    ...
    ((s as any).npc_usedname = (s as any).npc_usedname ?? {})[String((s as any).boy ?? 0)] = (((s as any).npc_nickname ?? 0)?.[String((s as any).boy ?? 0)] ?? 0);
    ...
    if (((s as any).placerParameter ?? 0)?.['recognize_status'] === 2) {
      ...
      scene.text(`'You smile as you reply: "I'm ${((s as any).pcs_nickname ?? '')}."'+$text_mod`);
    ...
    ((st as any).placerParameter = (st as any).placerParameter ?? {})['player_act'] = 1;
  ...
  if (((s as any).placerParameter ?? 0)?.['player_act'] === 1) {
    ...
    do {
      ...
      (st as any).temp_time_elapsed = undefined;
      qspCall(st, 'stat', '');
      scene.actions([
    ...
    } while (((st as any).i ?? 0) < ((st as any).placerParameter ?? 0)?.['number_of_man']);
  } },
    ]);
  } },
            ]);

...
{ label: 'Leave ', handler: (st: GameState) => {
  ...
  if ((Math.floor(Math.random() * 2) + 0) === 0  ||  ((s as any).tookmomdildo ?? 0) === 1) {
    ...
    ((s as any).failwords = (s as any).failwords ?? {})[0] = 'You don\'t find anything interesting.';
    ((s as any).failwords = (s as any).failwords ?? {})[1] = 'You find some clothes and underwear.';
    ((s as any).failwords = (s as any).failwords ?? {})[2] = 'You dig through your mother\'s closet, but find nothing interesting except underwear.';
    (s as any).failwords = undefined;
  } else {
    scene.img('images/locations/pavlovsk/resident/apartment/home/wardrobetoy.jpg');
    ((s as any).findmomtoy = (s as any).findmomtoy ?? {})[0] = 'Digging through the closet, you find a <a href="#" onclick="window.__gameStore.getState().doGoto(\u0027bedrPar2\u0027, \u0027momtoy_play\u0027); return false;">dildo</a>.';
    ((s as any).findmomtoy = (s as any).findmomtoy ?? {})[1] = 'Rummaging through your mother\'s lingerie, you find a small <a href="#" onclick="window.__gameStore.getState().doGoto(\u0027bedrPar2\u0027, \u0027momtoy_play\u0027); return false;">dildo</a>.';
    ((s as any).findmomtoy = (s as any).findmomtoy ?? {})[2] = 'You find your mother\'s <a href="#" onclick="window.__gameStore.getState().doGoto(\u0027bedrPar2\u0027, \u0027momtoy_play\u0027); return false;">toy</a>.';
    (s as any).findmomtoy = undefined;
  }
  scene.actions([
...
function enterMomtoyPlay(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`$OpenInnerThought + 'Maybe I should put the dildo back? ${(((s as any).npc_nickname ?? 0)?.['A29'] ?? '')} will probably notice that it's missing.' + $CloseInnerThought`);
  scene.actions([

...
function enterKitchen(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['kitchen_day'] = ((s as any).daystart ?? 0);
  ...
  if ((((s as any).katjaQW ?? 0)?.['pantiesQWstage'] < 3  ||  (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] === 3  &&  ((s as any).katjaQW ?? 0)?.['slut'] < 65))  &&  ((s as any).katjaQW ?? 0)?.['take_of_panties_day'] !== ((s as any).daystart ?? 0)) {
    ...
    scene.text(`You find Katja sitting alone in a chair. "Hi, ' + iif( katjaQW['couple'] = 0, '${((s as any).pcs_nickname || '')}', 'my love') + '! What are you doing here?" Katja asks when she sees you.`);
    ...
    if (((s as any).katjaQW ?? 0)?.['slut'] < 30  &&  ((s as any).katjaQW ?? 0)?.['pantiesQWstage'] === 0) {
      ...
      scene.text(`"${((s as any).pcs_nickname || '')}! You can't just go around flashing your pu… You aren't wearing panties! What are you doing?! Put some on!" Katja exclaims in shock.`);
      ...
      if (((s as any).katjaQW ?? 0)?.['slut'] < 50  &&  ((s as any).katjaQW ?? 0)?.['pantiesQWstage'] < 2) {
        ...
        scene.text(`"${((s as any).pcs_nickname || '')}! You can't just go around flashing your pussy. Put some panties on!" Katja says, though she's clearly not really angry.`);
        scene.text('"I flash who I want to, and I don\'t wear panties since it\'s much nicer not to. Now, show me if you\'re wearing panties or not," you respond as you cover your pussy again.');
      } else {
        if (((s as any).katjaQW ?? 0)?.['slut'] < 100  &&  ((s as any).katjaQW ?? 0)?.['pantiesQWstage'] < 4) {
          ...
          scene.text(`"Stop it, ${((s as any).pcs_nickname || '')}! You should really put some panties on," Katja says, but she can't seem to keep her eyes from staring at your pussy.`);
    ...
    if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] > 0) {
      ...
      if (((s as any).katjaQW ?? 0)?.['slut'] < 30) {
        ...
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['pantiesQWstage'] = 1;
        qspCall(s, 'arousal', 'erotic', (-2));
        qspCall(s, 'arousal', 'end');
        if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = ((s as any).katjaQW['horny'] ?? 0) + (Math.floor(Math.random() * 6) + 5);
    ...
    if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] < 5  &&  ((s as any).katjaQW ?? 0)?.['take_of_panties_day'] !== ((s as any).daystart ?? 0)) {
      ...
      scene.text(`You find Katja sitting alone at the dinner table. "Hi, ' + iif( katjaQW['couple'] = 0, '${((s as any).pcs_nickname || '')}', 'my love') + '! What are you doing here?" she asks when she sees you.`);
      // TODO-QSP: dynamic text: "I ' + iif($ARGS[1] = 'from_room', 'came looking for you', 'was just looking aro...
    ...
    if (((s as any).katjaQW ?? 0)?.['slut'] < 80) {
      ...
      if (((s as any).lazarQW ?? 0)?.['your_prize_panties_katja'] === 0) {
        if (!(s as any).lazarQW) (s as any).lazarQW = {}; (s as any).lazarQW['your_prize_panties_katja'] = 1;
      }
    }
    scene.actions([
      { label: 'Leave', goto: ['uni_dorm', 'dorm_kitchen', '\'second_floor\''] },
    ...
    qspCall(s, 'arousal', 'erotic', 2);
    qspCall(s, 'arousal', 'end');
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['pantiesQWstage'] = 4;
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = ((s as any).katjaQW['horny'] ?? 0) + (Math.floor(Math.random() * 6) + 5);
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['slut'] = ((s as any).katjaQW['slut'] ?? 0) + (4);
    scene.img('images/characters/pavlovsk/school/girl/katja/pantyquest/kitchen_sitting_taking_of_panties.jpg');
    scene.text('She gets up, turns her butt towards you, and slowly takes off her panties, pausing to look back at you just before her pussy is visible.');
    ...
    scene.actions([
      ...
      if (((s as any).week ?? 0) < 4  &&  (((s as any).katjaQW ?? 0)?.['slut'] < 100  ||  ((s as any).hour ?? 0) < 18)) {
        ...
        scene.text(`You find Katja standing at the kitchen table. "Hi, ' + iif( katjaQW['couple'] = 0, '${((s as any).pcs_nickname || '')}', 'my love') + '! What are you doing here?" Katja asks when she sees you.`);
        // TODO-QSP: dynamic text: "I ' + iif($ARGS[1] = 'from_room', 'came looking for you', 'was just looking aro...
        scene.text('"I \' + iif($ARGS[1] = \'from_room\', \'came looking for you\', \'was just looking around\') + \'. What are you doing?" you ask back.');
        ...
        scene.text(`You find Katja standing at the kitchen table drinking a glass of white wine. "Hi, ' + iif( katjaQW['couple'] = 0, '${((s as any).pcs_nickname || '')}', 'my love') + '. What are you doing here?" Katja asks when she sees you.`);
        // TODO-QSP: dynamic text: "I ' + iif($ARGS[1] = 'from_room', 'came looking for you', 'was just looking aro...
        scene.text('"I \' + iif($ARGS[1] = \'from_room\', \'came looking for you\', \'was just looking around\') + \'. What are you doing?" you ask back.');
...
function enterKitchenShowPussy(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: "Really, <<$pcs_nickname>>! This again? It's like you don't trust me," Katja say...
...
function enterUniHallway(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['uni_hallway_day'] = ((s as any).daystart ?? 0);
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  ...
  if (((s as any).trait_vars ?? 0)?.['panty_preference'] > 0  &&  ((s as any).pantyworntype ?? 0) === 'none'  &&  ((s as any).npc_had_sex ?? 0)?.['A14']  &&  ((s as any).katjaQW ?? 0)?.['no_panties_day'] !== ((s as any).daystart ?? 0)) {
      ...
      if (((s as any).katjaQW ?? 0)?.['slut'] < 50  &&  ((s as any).katjaQW ?? 0)?.['pantiesQWstage'] < 2) {
        ...
        if (((s as any).katjaQW ?? 0)?.['slut'] < 100  &&  ((s as any).katjaQW ?? 0)?.['pantiesQWstage'] < 4) {
          ...
          if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] >= 5) {
            ...
            scene.text(`"Very nice, ${((s as any).pcs_nickname || '')}. ' + iif( pcs_pubes > 3 , 'But you really need to shave that bush off', 'Perfectly smooth, how a pussy should be') + '," Katja says as her eyes devour your exposed pussy.`);
          } else {
            // TODO-QSP: dynamic text: "<<$pcs_nickname>>, you naughty girl! You should put some panties on," Katja say...
            scene.text(`"${((s as any).pcs_nickname || '')}, you naughty girl! You should put some panties on," Katja says, not at all convincingly, while her eyes devour your exposed pussy.`);
    ...
    if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] > 0) {
      if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] >= 5) {
        ...
        // TODO-QSP: dynamic text: "See? It's perfectly smooth, ' + iif( pcs_pubes > 3, 'like yours should be as we...
        scene.text('"See? It\'s perfectly smooth, \' + iif( pcs_pubes > 3, \'like yours should be as well\', \'like yours\') + \', and not hidden by any unnecessary layers of clothing," Katja says with a wink before closing her legs again.');
    ...
    // TODO-QSP: dynamic text: "Yes! This is going to be so much fun! Think about how thrilling it will be, kno...
    scene.text('"Yes! This is going to be so much fun! Think about how thrilling it will be, knowing if you\'re not careful that you might give \' + iif(katjaQW[\'boy_block\'] = 1, \'other girls\', \'boys\') + \' a peek at your pussy!" you say enthusiastically.');
    scene.text('"I\'m already regretting this…" Katja groans. But she doesn\'t look upset, nor does she make any move to put her panties back on.');
    qspCall(s, 'uni_lessons', 'schedule');
    scene.actions([
      { label: 'Say goodbye and move on', goto: ['uni_grounds', ''] },
    ...
    scene.actions([
      { label: 'Say goodbye and move on', goto: ['uni_grounds', ''] },
            ...
            if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] === 2  &&  ((s as any).katjaQW ?? 0)?.['slut'] >= 50) {
    ...
    qspCall(s, 'arousal', 'erotic', 2);
    qspCall(s, 'arousal', 'end');
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['pantiesQWstage'] = 3;
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = ((s as any).katjaQW['horny'] ?? 0) + (Math.floor(Math.random() * 6) + 5);
    if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['slut'] = ((s as any).katjaQW['slut'] ?? 0) + (4);
    scene.img('images/characters/pavlovsk/school/girl/katja/pantyquest/uni_hallway_showing_pussy.jpg');
...
function enterUniExit(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).trait_vars ?? 0)?.['panty_preference'] > 0  &&  ((s as any).pantyworntype ?? 0) === 'none'  &&  ((s as any).npc_had_sex ?? 0)?.['A14']  &&  ((s as any).katjaQW ?? 0)?.['no_panties_day'] !== ((s as any).daystart ?? 0)) {
    ...
    if (((s as any).katjaQW ?? 0)?.['slut'] < 50  &&  ((s as any).katjaQW ?? 0)?.['pantiesQWstage'] === 1) {
      // TODO-QSP: dynamic text: "<<$pcs_nickname>>! You can't just go around flashing your pussy; put some panti...
      scene.text(`"${((s as any).pcs_nickname || '')}! You can't just go around flashing your pussy; put some panties on!" Katja scolds, not really angry.`);
    ...
    if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] === 1) {
      ...
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['slut'] = ((s as any).katjaQW['slut'] ?? 0) + (4);
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['pantiesQWstage'] = 2;
    } else {
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['horny'] = ((s as any).katjaQW['horny'] ?? 0) + (Math.floor(Math.random() * 6) + 0);
      if (!(s as any).katjaQW) (s as any).katjaQW = {}; (s as any).katjaQW['slut'] = ((s as any).katjaQW['slut'] ?? 0) + (Math.floor(Math.random() * 2) + 0);
    }
...
function enterUni(s: GameState, scene: SceneBuilder): void {
  if (((s as any).katjaQW ?? 0)?.['uni_hallway_day'] !== ((s as any).daystart ?? 0)  &&  ((s as any).katjaQW ?? 0)?.['QWstage'] > 0  &&  ((s as any).katjaQW ?? 0)?.['know_katja_uni'] === 1) {
    if ((((s as any).katjaQW ?? 0)?.['pantiesQWstage'] === 2  &&  ((s as any).katjaQW ?? 0)?.['slut'] < 50)  ||  (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] === 1  &&  ((s as any).katjaQW ?? 0)?.['slut'] >= 40)) {
      scene.text('You see <a href="exec:gt \'katja_pantyquest\', \'uni_exit\'">Katja</a> standing next to one of the doors to the outside.');
    } else {
  ...
  scene.actions([
    ...
    if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] > 0) {
      if (((s as any).katjaQW ?? 0)?.['pantiesQWstage'] >= 5) {
        ...
        // TODO-QSP: dynamic text: "See? It's perfectly smooth, ' + iif( pcs_pubes > 3, 'like yours should be as we...
        scene.text('"See? It\'s perfectly smooth, \' + iif( pcs_pubes > 3, \'like yours should be as well\', \'like yours\') + \', and not hidden by any unnecessary layers of clothing," Katja says while looking back at you. She lets her skirt fall back down and sit downs, taking a sip of her tea.');
        scene.actions([
    ...
    // TODO-QSP: dynamic text: "Yes! This is going to be so much fun. Think about how thrilling it will be bein...
    scene.text('"Yes! This is going to be so much fun. Think about how thrilling it will be being careful so you don\'t give \' + iif(katjaQW[\'boy_block\'] = 1, \'other girls\', \'boys\') + \' a peek of your pussy!" you say enthusiastically.');
    ...
    scene.text('"Very nice!" you exclaim.');
    scene.text('"Ah, the sacrifices I have to make so a pervert like you is happy," she says jokingly.');
    // TODO-QSP: dynamic text: She then lets go of her panties, takes her leg down from the table before ' + ii...
    scene.text('She then lets go of her panties, takes her leg down from the table before \' + iif(locat[\'A144\'] = 9, \'Anushka\', \'the waitress\') + \' sees it and adjusts her skirt so that she\'s again a proper lady.');
    scene.actions([
      { label: 'Continue to chat', goto: ['katja_pantyquest', 'coffee_hole_after'] },
    ]);
  } },

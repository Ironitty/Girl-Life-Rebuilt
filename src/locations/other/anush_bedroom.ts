...
function enterMoreClothes(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'stat', '');
  }, goto: ['anush_bedroom', 'chase_naked'] },
        ]);
      }
    }
    scene.actions([

      ...
      if (((s as any).grupTipe ?? 0) === 0) {
        ...
        if (((s as any).grupTipe ?? 0) === 2) {
          ...
          if (((s as any).nerd_game ?? 0)?.['game_day'] > ((s as any).daystart ?? 0)) {
            ...
            scene.text(`You have been invited to a games night on ${((s as any).weekName ?? 0)?.[(((s as any).week ?? 0) + (((s as any).nerd_game ?? 0)?.['game_day'] - ((s as any).daystart ?? 0)))]} at '+func('time', 'get_time_string', 20, 0)+' in the community center library.`);
          }
          if (((s as any).nerd_game ?? 0)?.['game_day'] === ((s as any).daystart ?? 0)) {

...
function enterOther(s: GameState, scene: SceneBuilder): void {
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_mansion_entrance', '') === 0) {
    ...
    scene.actions([
      { label: 'Park and get out', goto: ['city_mansion_entrance', ''] },
        ...
        ((s as any).temptime ?? {})[2] = ((s as any).temptime ?? 0)[0] + 5 + (((s as any).nroad ?? 0) - 1)/2;
    ...
    ((s as any).car ?? {})['fuel'] = (((s as any).car ?? {})['fuel'] ?? 0) - (1);
    ((s as any).car ?? {})['current_condition'] = (((s as any).car ?? {})['current_condition'] ?? 0) - ((Math.floor(Math.random() * (temptime[2]/12 - 0 + 1)) + (0)));
    scene.text('You drive to your mansion.');
    qspCall(s, 'car_funcs', 'setloc', 'city_mansion_entrance', '', 'city');
    scene.actions([
      { label: 'Park and get out', goto: ['city_mansion_entrance', ''] },
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_suburbs', 'start') === 0) {
    ...
    scene.actions([
      ...
      ((s as any).temptime ?? {})[3] = ((s as any).temptime ?? 0)[0] + 5 + (((s as any).nroad ?? 0) - 1)/2;
    ...
    ((s as any).car ?? {})['fuel'] = (((s as any).car ?? {})['fuel'] ?? 0) - (1);
    ((s as any).car ?? {})['current_condition'] = (((s as any).car ?? {})['current_condition'] ?? 0) - ((Math.floor(Math.random() * (temptime[3]/12 - 0 + 1)) + (0)));
    scene.text('You drive to St. Petersburg\'s suburbs.');
    qspCall(s, 'car_funcs', 'setloc', 'city_suburbs', 'start', 'city');
    scene.actions([
      { label: 'Park and get out', goto: ['city_suburbs', 'start'] },
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'obekt', '') === 0) {
    ((s as any).temptime ?? {})[4] = ((s as any).temptime ?? 0)[0] + 5;
    if (((s as any).nroad ?? 0) < 16) {
      ((s as any).temptime ?? {})[4] = (((s as any).temptime ?? {})[4] ?? 0) + ((16 - ((s as any).nroad ?? 0))/2);
    } else {
      if (((s as any).nroad ?? 0) > 16) {
        ((s as any).temptime ?? {})[4] = (((s as any).temptime ?? {})[4] ?? 0) + ((((s as any).nroad ?? 0) -16)/2);
      }
    }
    ...
    ((s as any).car ?? {})['fuel'] = (((s as any).car ?? {})['fuel'] ?? 0) - (1);
    ((s as any).car ?? {})['current_condition'] = (((s as any).car ?? {})['current_condition'] ?? 0) - ((Math.floor(Math.random() * (temptime[4]/12 - 0 + 1)) + (0)));
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'dachi', '') === 0) {
    ((s as any).temptime ?? {})[5] = ((s as any).temptime ?? 0)[0] + 5;
    if (((s as any).nroad ?? 0) < 5) {
      ((s as any).temptime ?? {})[5] = (((s as any).temptime ?? {})[5] ?? 0) + ((5 - ((s as any).nroad ?? 0))/2);
    } else {
      if (((s as any).nroad ?? 0) > 5) {
        ((s as any).temptime ?? {})[5] = (((s as any).temptime ?? {})[5] ?? 0) + ((((s as any).nroad ?? 0) -5)/2);
      }
    }
    ...
    ((s as any).car ?? {})['fuel'] = (((s as any).car ?? {})['fuel'] ?? 0) - (1);
    ((s as any).car ?? {})['current_condition'] = (((s as any).car ?? {})['current_condition'] ?? 0) - ((Math.floor(Math.random() * (temptime[5]/12 - 0 + 1)) + (0)));
    // TODO-QSP: dynamic text: <<temptime>> minutes later, you arrive at your destination.
    scene.text(`${((s as any).temptime ?? 0)} minutes later, you arrive at your destination.`);
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'gadukino', '') === 0) {
    ((s as any).temptime ?? {})[6] = ((s as any).temptime ?? 0)[0] + 5;
    if (((s as any).nroad ?? 0) < 10) {
      ((s as any).temptime ?? {})[6] = (((s as any).temptime ?? {})[6] ?? 0) + ((10 - ((s as any).nroad ?? 0))/2);
    } else {
      if (((s as any).nroad ?? 0) > 10) {
        ((s as any).temptime ?? {})[6] = (((s as any).temptime ?? {})[6] ?? 0) + ((((s as any).nroad ?? 0) -10)/2);
      }
    }
    ...
    ((s as any).car ?? {})['fuel'] = (((s as any).car ?? {})['fuel'] ?? 0) - (1);
    ((s as any).car ?? {})['current_condition'] = (((s as any).car ?? {})['current_condition'] ?? 0) - ((Math.floor(Math.random() * (temptime[6]/12 - 0 + 1)) + (0)));
    // TODO-QSP: dynamic text: <<temptime>> minutes later, you arrive at your destination.
    scene.text(`${((s as any).temptime ?? 0)} minutes later, you arrive at your destination.`);
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'gas_station_gp_117', 'outside') === 0) {
    if (((s as any).prostitute ?? 0)?.['gas_station'] === 1) {
      ((s as any).temptime ?? {})[7] = ((s as any).temptime ?? 0)[0] + 5;
      if (((s as any).nroad ?? 0) < 12) {
        ((s as any).temptime ?? {})[7] = (((s as any).temptime ?? {})[7] ?? 0) + ((12 - ((s as any).nroad ?? 0))/2);
      } else {
        if (((s as any).nroad ?? 0) > 12) {
          ((s as any).temptime ?? {})[7] = (((s as any).temptime ?? {})[7] ?? 0) + ((((s as any).nroad ?? 0) -12)/2);
        }
      }
    ...
    ((s as any).car ?? {})['fuel'] = (((s as any).car ?? {})['fuel'] ?? 0) - (1);
    ((s as any).car ?? {})['current_condition'] = (((s as any).car ?? {})['current_condition'] ?? 0) - ((Math.floor(Math.random() * (temptime[7]/12 - 0 + 1)) + (0)));
    // TODO-QSP: dynamic text: <<temptime>> minutes later, you arrive at your destination.
    scene.text(`${((s as any).temptime ?? 0)} minutes later, you arrive at your destination.`);
  ...
  scene.actions([
    ...
    ((s as any).car ?? {})['fuel'] = (((s as any).car ?? {})['fuel'] ?? 0) - (4);
    ((s as any).car ?? {})['current_condition'] = (((s as any).car ?? {})['current_condition'] ?? 0) - (Math.floor(Math.random() * 5) + 2);
...
function enterCity(s: GameState, scene: SceneBuilder): void {
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_house_res_misc', 'fronty') === 0) {
    if (qspFunc(s, 'homes_properties', 'is_property_of_status', 'owned', 'city_house')) {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'a'  ||  ((s as any).car ?? 0)?.['city_sup_region'] === 'd') {
        ((s as any).temptime ?? {})[1] = 0;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
          ((s as any).temptime ?? {})[1] = 0;
        } else {
          if (((s as any).car ?? 0)?.['city_sup_region'] === 'c') {
            ((s as any).temptime ?? {})[1] = 5;
          } else {
            ((s as any).temptime ?? {})[1] = 5;
          }
        }
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_industrial', '') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a') {
      ((s as any).temptime ?? {})[2] = 10;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[2] = 5;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'c') {
          ((s as any).temptime ?? {})[2] = 0;
        } else {
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_residential', '') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a'  ||  ((s as any).car ?? 0)?.['city_sup_region'] === 'd') {
      ((s as any).temptime ?? {})[3] = 0;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[3] = 0;
      } else {
        ((s as any).temptime ?? {})[3] = 5;
      }
    }
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_center', '') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a') {
      ((s as any).temptime ?? {})[4] = 0;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[4] = 0;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'd') {
          ((s as any).temptime ?? {})[4] = 5;
        } else {
          ((s as any).temptime ?? {})[4] = 10;
        }
      }
    }
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_industrial_train', 'outside') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a') {
      ((s as any).temptime ?? {})[5] = 10;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[5] = 5;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'd') {
          ((s as any).temptime ?? {})[5] = 5;
        } else {
          ((s as any).temptime ?? {})[5] = 0;
        }
      }
    }
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_lake', 'start') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a') {
      ((s as any).temptime ?? {})[6] = 5;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[6] = 0;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'c') {
          ((s as any).temptime ?? {})[6] = 5;
        } else {
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_park', 'start') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a') {
      ((s as any).temptime ?? {})[7] = 0;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[7] = 0;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'd') {
          ((s as any).temptime ?? {})[7] = 5;
        } else {
          ((s as any).temptime ?? {})[7] = 5;
        }
      }
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'fuelstation', 'start', 'city') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a') {
      ((s as any).temptime ?? {})[8] = 10;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[8] = 5;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'd') {
          ((s as any).temptime ?? {})[8] = 5;
        } else {
          ((s as any).temptime ?? {})[8] = 0;
        }
      }
    }
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'autoservisF', 'start') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a') {
      ((s as any).temptime ?? {})[9] = 10;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[9] = 5;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'd') {
          ((s as any).temptime ?? {})[9] = 5;
        } else {
          ((s as any).temptime ?? {})[9] = 0;
        }
      }
    }
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'autotraidF', 'start') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a') {
      ((s as any).temptime ?? {})[10] = 10;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[10] = 5;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'd') {
          ((s as any).temptime ?? {})[10] = 5;
        } else {
          ((s as any).temptime ?? {})[10] = 0;
        }
      }
    }
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_island', '') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a') {
      ((s as any).temptime ?? {})[11] = 0;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[11] = 0;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'd') {
          ((s as any).temptime ?? {})[11] = 5;
        } else {
          ((s as any).temptime ?? {})[11] = 10;
        }
      }
    }
  ...
  if (qspFunc(s, 'car_funcs', 'is_here', 'city_redlight', 'start') === 0) {
    if (((s as any).car ?? 0)?.['city_sup_region'] === 'a') {
      ((s as any).temptime ?? {})[12] = 10;
    } else {
      if (((s as any).car ?? 0)?.['city_sup_region'] === 'b') {
        ((s as any).temptime ?? {})[12] = 5;
      } else {
        if (((s as any).car ?? 0)?.['city_sup_region'] === 'd') {
          ((s as any).temptime ?? {})[12] = 5;
        } else {
          ((s as any).temptime ?? {})[12] = 0;
        }
      }
    }
...
function enterNearby(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).car ?? {})['fuel'] = (((s as any).car ?? {})['fuel'] ?? 0) - (1);
  ((s as any).car ?? {})['current_condition'] = (((s as any).car ?? {})['current_condition'] ?? 0) - (Math.floor(Math.random() * 3) + 1);
...
function enterCarCondition(s: GameState, scene: SceneBuilder): void {
  if (((s as any).car ?? 0)?.['current_condition'] <= 0) {
    ((s as any).car ?? {})['current_condition'] = 0;
    ((s as any).car ?? {})['wreck'] = 1;
  }

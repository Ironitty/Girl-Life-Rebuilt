...
function enterChangeForWork(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['uniform'] = 1;
  (s as any).robe = 1;
  qspCall(s, 'stat', '');
...
function enterChangeForWorkStress(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    scene.actions([
      { label: 'Get changed [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
...
function enterShiftStart(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'stat', '');
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['break'] = 0;
  if (((s as any).masseuse ?? 0)?.['multiple_shifts'] === 1) {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['multiple_shifts'] = 0;
  }
  ...
  if (((s as any).masseuse ?? 0)?.['late'] === 1) {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['late'] = 0;
...
function enterShiftEnd(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['shift_finished'] = 0;
  if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['work_minutes'] = 0;
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['worked_' + String((s as any).daystart || '') + '_' + String((s as any).masseuse_shift || '') + ''] = 1;
  qspCall(s, 'jobs', 'clock_out', 'city_salon_masseuse');
  if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['work_minutes'] = 0;
  // TODO-QSP: gs 'money', 'earn', massage['shift_tips']
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['money_earned'] = ((s as any).masseuse['money_earned'] ?? 0) + (((s as any).massage ?? 0)?.['shift_tips']);
  if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['shift_tips_total'] = ((s as any).massage['shift_tips_total'] ?? 0) + (((s as any).massage ?? 0)?.['shift_tips']);
  if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['shift_tips'] = 0;
  // TODO-QSP: gs 'money', 'earn', massage['sex_tips']
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['money_earned'] = ((s as any).masseuse['money_earned'] ?? 0) + (((s as any).massage ?? 0)?.['sex_tips']);
  if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['sex_tips_total'] = ((s as any).massage['sex_tips_total'] ?? 0) + (((s as any).massage ?? 0)?.['sex_tips']);
  if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['sex_tips'] = 0;
  if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] === 3) {
...
function enterLastClient(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['work_minutes'] = 0;
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['shift_finished'] = 1;
  (s as any).robe = 1;
  if ((((s as any).job_booking ?? 0)['city_salon_masseuse, ' + String(((s as any).daystart ?? 0)) + ', 1'] !== ''  &&  ((s as any).masseuse_shift ?? 0) === 1)  ||  (((s as any).job_booking ?? 0)['city_salon_masseuse, ' + String(((s as any).daystart ?? 0)) + ', 2'] !== ''  &&  ((s as any).masseuse_shift ?? 0) === 2)) {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['multiple_shifts'] = 1;
    // TODO-QSP: dynamic text: <b><<hour>>:0<<minut>>.</b> Looks like this shift is just about over, but you sc...
    scene.text(`<b>${((s as any).hour ?? 0)}:0${((s as any).minut ?? 0)}.</b> Looks like this shift is just about over, but you scheduled yourself for the next shift too. Better prepare for that then.`);
    qspCall(s, 'masseuse_work', 'final_cleanup');
  } else {
    if (((s as any).minut ?? 0) < 10) {
      // TODO-QSP: dynamic text: <b><<hour>>:0<<minut>>.</b> Looks like your shift is just about over. Time to wr...
      scene.text(`<b>${((s as any).hour ?? 0)}:0${((s as any).minut ?? 0)}.</b> Looks like your shift is just about over. Time to wrap up for the day.`);
    } else {
      // TODO-QSP: dynamic text: <b><<hour>>:<<minut>>.</b> Looks like your shift is just about over. Time to wra...
      scene.text(`<b>${((s as any).hour ?? 0)}:${((s as any).minut ?? 0)}.</b> Looks like your shift is just about over. Time to wrap up for the day.`);
    }
...
function enterFinalCleanup(s: GameState, scene: SceneBuilder): void {
  if (((s as any).cum_loc ?? 0)?.['face'] > 0) {
    ...
    qspCall(s, 'masseuse_work', 'final_cleanup_menu');
  } else {
    if (((s as any).cum_loc ?? 0)?.['vagina'] > 0  &&  ((s as any).cum_loc ?? 0)?.['face'] === 0) {
...
function enterStretchOut(s: GameState, scene: SceneBuilder): void {
  if (((s as any).masseuse ?? 0)?.['stretch'] === 0  &&  ((s as any).job_rank ?? 0)?.['city_salon_masseuse'] >= 2) {
    ...
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['stretch'] = 1;
    ...
    if (((s as any).masseuse ?? 0)?.['shift_finished'] === 1) {
      qspCall(s, 'masseuse_work', 'final_cleanup');
    } else {
...
function enterBreakQuestion(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'arousal', 'end');
  if (((s as any).minut ?? 0) < 10) {
    // TODO-QSP: dynamic text: <b><<hour>>:0<<minut>>.</b> Looks like you have about <<240 - salon['work_minute...
    scene.text(`<b>${((s as any).hour ?? 0)}:0${((s as any).minut ?? 0)}.</b> Looks like you have about ${240 - ((s as any).salon ?? {})?.['work_minutes']} minutes left in your shift. Should you take a break? Or just wait for the next client?`);
  } else {
...
function enterPrepareNext(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).minut ?? 0) < 10) {
    // TODO-QSP: dynamic text: <b><<hour>>:0<<minut>>.</b> Looks like you have about <<240 - salon['work_minute...
    scene.text(`<b>${((s as any).hour ?? 0)}:0${((s as any).minut ?? 0)}.</b> Looks like you have about ${240 - ((s as any).salon ?? {})?.['work_minutes']} minutes left in your shift. You should prepare for another client.`);
  } else {
    // TODO-QSP: dynamic text: <b><<hour>>:<<minut>>.</b> Looks like you have about <<240 - salon['work_minutes...
    scene.text(`<b>${((s as any).hour ?? 0)}:${((s as any).minut ?? 0)}.</b> Looks like you have about ${240 - ((s as any).salon ?? {})?.['work_minutes']} minutes left in your shift. You should prepare for another client.`);
  }
...
function enterCustomerGenerate(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['client_type'] = Math.floor(Math.random() * 3) + 0;
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['client_request'] = Math.floor(Math.random() * 13) + 0;
  // TODO-QSP: end
  scene.build();
}

function enterBegin(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['stretch'] = 0;
  (s as any).robe = 1;
  qspCall(s, 'masseuse_work', 'customer_generate');
  if (((s as any).masseuse ?? 0)?.['fast_foward'] === 1) {
    qspCall(s, 'masseuse_work', 'fast_shift');
  } else {
    if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] === 1) {
      scene.actions([{ label: 'Continue', goto: ['masseuse_work', '1_pre'] }]);
    } else {
      if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] === 2) {
        if (((s as any).masseuse ?? 0)?.['client_request'] >= 8) {
          scene.actions([{ label: 'Continue', goto: ['masseuse_work', '1_pre'] }]);
        } else {
          scene.actions([{ label: 'Continue', goto: ['masseuse_work', '2_pre'] }]);
        }
      } else {
        if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] === 3) {
          if (((s as any).masseuse ?? 0)?.['client_request'] >= 11) {
            ...
            if (((s as any).masseuse ?? 0)?.['client_request'] >= 7) {
              ...
              scene.actions([{ label: 'Continue', goto: ['masseuse_work', '3_pre'] }]);
            }
          }
        } else {
          if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] === 4) {
            if (((s as any).masseuse ?? 0)?.['client_request'] >= 12) {
              ...
              if (((s as any).masseuse ?? 0)?.['client_request'] >= 10) {
                ...
                if (((s as any).masseuse ?? 0)?.['client_request'] >= 8) {
                  ...
                  scene.actions([{ label: 'Continue', goto: ['masseuse_work', '4_pre'] }]);
                }
              }
            }
          } else {
              ...
              if (((s as any).masseuse ?? 0)?.['client_request'] === 12) {
                ...
                if (((s as any).masseuse ?? 0)?.['client_request'] === 11) {
                  ...
                  if (((s as any).masseuse ?? 0)?.['client_request'] === 10) {
                    ...
                    scene.actions([{ label: 'Continue', goto: ['masseuse_work', '5_pre'] }]);
                  }
                }
              }
            } else {
...
function enterFastShift(s: GameState, scene: SceneBuilder): void {
  if (((s as any).salon ?? 0)?.['work_minutes'] >= 235) {
    qspCall(s, 'masseuse_work', 'last_client');
    if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] === 1) {
      if (!(s as any).masseuse_shift) (s as any).masseuse_shift = {}; (s as any).masseuse_shift['mass_count'] = ((s as any).masseuse_shift['mass_count'] ?? 0) + (1);
      qspCall(s, 'masseuse_work', '1_stats');
    } else {
      if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] === 2) {
        if (((s as any).masseuse ?? 0)?.['client_request'] <= 7) {
          if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['nude_mass_count'] = ((s as any).salon['nude_mass_count'] ?? 0) + (1);
        }
        qspCall(s, 'masseuse_work', '1_stats');
      } else {
        if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] === 3) {
          if (((s as any).masseuse ?? 0)?.['client_request'] >= 11) {
            if (!(s as any).masseuse_shift) (s as any).masseuse_shift = {}; (s as any).masseuse_shift['mass_count'] = ((s as any).masseuse_shift['mass_count'] ?? 0) + (1);
            scene.actions([{ label: 'Continue', goto: ['masseuse_work', '1_stats'] }]);
          } else {
            if (((s as any).masseuse ?? 0)?.['client_request'] >= 7) {
              if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['nude_mass_count'] = ((s as any).salon['nude_mass_count'] ?? 0) + (1);
              scene.actions([{ label: 'Continue', goto: ['masseuse_work', '1_stats'] }]);
...
function enter1Stats(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['work_minutes'] = ((s as any).salon['work_minutes'] ?? 0) + (30);
  if ((Math.floor(Math.random() * 3) + 0) === 2) {
    if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['client_tip'] = Math.floor(Math.random() * 201) + 0;
    if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['shift_tips'] = ((s as any).massage['shift_tips'] ?? 0) + (((s as any).massage ?? 0)?.['client_tip']);
  }
  // TODO-QSP: end
  scene.build();
}
...
function enter1Pre(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`"${((s as any).pcs_firstname ?? 0)}, you have a customer who has requested a <b>body massage</b>, maximum of 30 minutes."`);
...
function enter1(s: GameState, scene: SceneBuilder): void {
  ...
  if ((Math.floor(Math.random() * 3) + 1) === 3) {
    ...
    if ((Math.floor(Math.random() * 3) + 0) === 2) {
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['client_tip'] = Math.floor(Math.random() * 201) + 0;
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['shift_tips'] = ((s as any).massage['shift_tips'] ?? 0) + (((s as any).massage ?? 0)?.['client_tip']);
      // TODO-QSP: dynamic text: Looking back to the table, you see he left a tip of <<$func('money', 'string_pro...
      scene.text(`Looking back to the table, you see he left a tip of ${qspFunc(s, 'money', 'string_profit', ((s as any).massage ?? 0)?.['client_tip'])} for you on the table.`);
    }
    ...
    // TODO-QSP: dynamic text: "Okay, how about you just give me a peek of what's underneath that robe of yours...
    ...
    scene.img('images/locations/city/citycenter/mall/salon/work/normalchest.jpg');
    // TODO-QSP: dynamic text: "<<$func('money', 'string_profit', 200)>>?" You chew on your lip for a moment co...
...
function enter1_handjob1(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['hj_count'] = ((s as any).salon['hj_count'] ?? 0) + (1);
  qspCall(s, 'arousal_oneline', 'hj', ((s as any).masseuse_time_temp ?? 0), '', 'prostitution');
  if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['work_minutes'] = ((s as any).salon['work_minutes'] ?? 0) + (((s as any).masseuse_time_temp ?? 0));
  qspCall(s, 'stat', '');
  ...
  scene.actions([
    ...
    qspCall(s, 'cum_cleanup', '');
    if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['sex_tips'] = ((s as any).massage['sex_tips'] ?? 0) + (300);
    qspCall(s, 'stat', '');
    scene.img('images/locations/city/citycenter/mall/salon/work/room.jpg');
    ...
    // TODO-QSP: dynamic text: "Here's a little something extra," he says, handing you <<$func('money', 'string...
...
function enter1_naked(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['sex_tips'] = ((s as any).massage['sex_tips'] ?? 0) + (200);
  if (((s as any).salon ?? 0)?.['work_minutes'] >= 235) {
    qspCall(s, 'masseuse_work', 'last_client');
  } else {
    qspCall(s, 'masseuse_work', 'prepare_next');
...
function enter2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((Math.floor(Math.random() * 3) + 0) === 2) {
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['client_tip'] = Math.floor(Math.random() * 301) + 0;
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['shift_tips'] = ((s as any).massage['shift_tips'] ?? 0) + (((s as any).massage ?? 0)?.['client_tip']);
      // TODO-QSP: dynamic text: Looking back to the table, you see he left a tip of <<$func('money', 'string_pro...
      scene.text(`Looking back to the table, you see he left a tip of ${qspFunc(s, 'money', 'string_profit', ((s as any).massage ?? 0)?.['client_tip'])} for you on the table.`);
    }
...
function enter3_1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((Math.floor(Math.random() * 3) + 0) === 2) {
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['client_tip'] = Math.floor(Math.random() * 301) + 0;
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['sex_tips'] = ((s as any).massage['sex_tips'] ?? 0) + (((s as any).massage ?? 0)?.['client_tip']);
      // TODO-QSP: dynamic text: Looking back to the table, you see he left a tip of <<$func('money', 'string_pro...
      scene.text(`Looking back to the table, you see he left a tip of ${qspFunc(s, 'money', 'string_profit', ((s as any).massage ?? 0)?.['client_tip'])} for you on the table.`);
    }
...
function enter3_2(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['work_minutes'] = ((s as any).salon['work_minutes'] ?? 0) + ((30 - ((s as any).masseuse_time_temp ?? 0)));
  ...
  scene.actions([
    ...
    scene.text(`After ${30 - ((s as any).masseuse_time_temp ?? 0)} minutes, you announce his time is up and quickly wipe him down, cleaning his body of leftover oils. You wait for him to put his clothes back on before giving a short bow, saying, "Thank you for your patronage sir," as he exits the room.`);
    (s as any).robe = 1;
    if ((Math.floor(Math.random() * 3) + 0) === 2) {
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['client_tip'] = Math.floor(Math.random() * 301) + 0;
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['sex_tips'] = ((s as any).massage['sex_tips'] ?? 0) + (((s as any).massage ?? 0)?.['client_tip']);
...
function enter4Pre(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).masseuse ?? 0)?.['client_type'] === 0) {
      ...
      if (((s as any).masseuse ?? 0)?.['client_type'] === 1) {
        scene.text('"Yeah, let\'s do that," the client grins as he drops his pants, revealing an impressive erection."');
        scene.text('"Whatever you like sir," you say, shrugging out of the robe completely and waiting by the table while he removes the rest of his clothing.');
        scene.actions([
...
function enter4(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'arousal_oneline', 'massage_give', 15, 'no_orgasm_msg', '', 'prostitution');
  if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['work_minutes'] = ((s as any).salon['work_minutes'] ?? 0) + (15);
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['massage_first'] = 1;
  qspCall(s, 'stat', '');
  scene.img(`images/locations/city/citycenter/mall/salon/work/nude_massage/${Math.floor(Math.random() * 5) + 1}.jpg`);
  scene.text('You oil up the client and begin kneading it with your hands, working through his muscles and loosening them up. He stares appreciatively at your body throughout the whole process. Occasionally, you lean down to get the right angles to work his body and your breasts brush up against him, though you\'re fairly certain he doesn\'t mind.');
...
function enter4_1(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['bj_count'] = ((s as any).salon['bj_count'] ?? 0) + (1);
  if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['work_minutes'] = ((s as any).salon['work_minutes'] ?? 0) + (((s as any).masseuse_time_temp ?? 0));
  ...
  scene.actions([
    ...
    if (((s as any).masseuse ?? 0)?.['massage_first'] === 1) {
      if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['massage_first'] = 0;
    ...
    (s as any).robe = 1;
    if ((Math.floor(Math.random() * 3) + 0) === 2) {
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['client_tip'] = Math.floor(Math.random() * 401) + 0;
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['sex_tips'] = ((s as any).massage['sex_tips'] ?? 0) + (((s as any).massage ?? 0)?.['client_tip']);
      // TODO-QSP: dynamic text: Looking back to the table, you see he left a tip of <<$func('money', 'string_pro...
      scene.text(`Looking back to the table, you see he left a tip of ${qspFunc(s, 'money', 'string_profit', ((s as any).massage ?? 0)?.['client_tip'])} for you on the table.`);
    }
...
function enter5Pre(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`"${((s as any).pcs_firstname ?? 0)}, you have a customer who has requested a <b>full body massage</b>, maximum of 30 minutes."`);
  scene.text('As soon as she\'s done speaking, the door opens and a man walks in.');
  if (((s as any).pcs_inhib ?? 0) < 40) {
  ...
  scene.actions([
    ...
    if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['fuck_count'] = ((s as any).salon['fuck_count'] ?? 0) + (1);
    qspCall(s, 'cum_call', 'precum', ((s as any).npcID ?? 0));
    // TODO-QSP: gs 'arousal_oneline', 'vaginal', (masseuse_time_temp+15), '', 'prostitution', 'rough'
    if (!(s as any).salon) (s as any).salon = {}; (s as any).salon['work_minutes'] = ((s as any).salon['work_minutes'] ?? 0) + ((((s as any).masseuse_time_temp ?? 0)+15));
    qspCall(s, 'stat', '');
  }, goto: ['masseuse_work', '5'] },
  ]);
  scene.build();
}
...
function enter5(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_rand ?? 0) <= 7) {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['position'] = 'miss';
    scene.img(`images/shared/sex/massage/miss${((s as any).temp_rand ?? 0)}.mp4`);
  } else {
    if (((s as any).temp_rand ?? 0) <= 13) {
      if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['position'] = 'doggy';
      scene.img(`images/shared/sex/massage/doggy${((s as any).temp_rand ?? 0)-7}.mp4`);
    } else {
      if (((s as any).temp_rand ?? 0) === 14) {
        if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['position'] = 'doggy';
        scene.img('images/shared/sex/massage/fuck1.mp4');
      } else {
        if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['position'] = 'cowgirl';
        scene.img(`images/shared/sex/massage/cowgirl${((s as any).temp_rand ?? 0)-14}.mp4`);
      }
    }
  }
...
function enter5_1(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 2) + 0) === 1) {
    ...
    if ((Math.floor(Math.random() * 3) + 0) === 2) {
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['client_tip'] = Math.floor(Math.random() * 501) + 0;
      if (!(s as any).massage) (s as any).massage = {}; (s as any).massage['sex_tips'] = ((s as any).massage['sex_tips'] ?? 0) + (((s as any).massage ?? 0)?.['client_tip']);
      // TODO-QSP: dynamic text: Looking back to the table, you see he left a tip of <<$func('money', 'string_pro...
      scene.text(`Looking back to the table, you see he left a tip of ${qspFunc(s, 'money', 'string_profit', ((s as any).massage ?? 0)?.['client_tip'])} for you on the table.`);
    }
...
function enterJobInterview1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'masseuse_work', 'job_offer');
  } },
    ]);
  } },
...
function enterJobOffer(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text('"Well..."');
    qspCall(s, 'masseuse_work', 'whore_offer');
  } },
    ]);
  } },
    ...
    if (((s as any).license ?? 0)?.['masseuse'] === 1) {
      if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['pending_rank'] = 1;
    ...
    qspCall(s, 'masseuse_work', 'whore_only_offer');
  } },
      ]);
    }
  } },
...
function enterWhoreOnlyOffer(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.img('images/locations/city/citycenter/mall/salon/xian.jpg');
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['pending_rank'] = 6;
...
function enterWhoreOffer(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'masseuse_work', 'whore_offer2');
  } },
    ]);
  } },
...
function enterWhoreOffer2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_inhib ?? 0) >= 35) {
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'I wouldn\'t mind being a naked masseuse [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
  ...
  if (((s as any).pcs_inhib ?? 0) >= 40  ||  ((s as any).stat ?? 0)?.['prostitute_times'] > 20) {
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'I can give handjobs [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
  ...
  if (((s as any).pcs_inhib ?? 0) >= 50  ||  ((s as any).stat ?? 0)?.['prostitute_times'] > 35) {
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'I can give blowjobs [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
  ...
  if (((s as any).pcs_inhib ?? 0) >= 60  ||  ((s as any).stat ?? 0)?.['prostitute_times'] > 50) {
    ...
    if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
      scene.actions([
        { label: 'Sure, I\'ll be a whore [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
      ]);
    } else {
...
function enterNakedMasseuseAccept(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).license ?? 0)?.['masseuse'] === 1) {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['pending_rank'] = 2;
...
function enterHandjobMasseuseAccept(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('"Alright, that\'s fine." she says. "And are you a certified massage therapist?"');
  if (((s as any).license ?? 0)?.['masseuse'] === 1) {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['pending_rank'] = 3;
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hourly'] = 150;
    scene.text('"Yes I am."');
    scene.text('"Okay, can I see your certificate?" You pull out the paper that certifies you as a massage therapist."');
    scene.text('"Great. I\'ll just get your contract set up for you," she says, typing something out on her computer.');
...
function enterBlowjobMasseuseAccept(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('"Great!" she says. "And are you a certified massage therapist?"');
  if (((s as any).license ?? 0)?.['masseuse'] === 1) {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['pending_rank'] = 4;
...
function enterWhoreMasseuseAccept(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).license ?? 0)?.['masseuse'] === 1) {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['pending_rank'] = 5;
...
function enterPartTimeFullTime(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['shifts_required'] = 5;
    scene.img('images/locations/city/citycenter/mall/salon/xian.jpg');
    ...
    if (((s as any).masseuse ?? 0)?.['pending_rank'] === 1) {
      scene.actions([{ label: 'Continue', goto: ['masseuse_work', 'masseuse_orientation'] }]);
    } else {
      scene.actions([{ label: 'Continue', goto: ['masseuse_work', 'whore_orientation'] }]);
    }
  } },
    ]);
  } },
    { label: 'Full time', handler: (st: GameState) => {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['shifts_required'] = 10;
    scene.img('images/locations/city/citycenter/mall/salon/xian.jpg');
...
function enterMasseuseOrientation(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hired_day'] = ((s as any).daystart ?? 0);
  ...
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['pending_rank'] = 0;
...
function enterQuestions(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] === 1) {
    ...
    qspCall(s, 'masseuse_work', 'questions');
    scene.img('images/locations/city/citycenter/mall/salon/xian.jpg');
...
function enterJobChange(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).license ?? 0)?.['masseuse'] === 1) {
    ...
    qspCall(s, 'jobs', 'set_rank', 'city_salon_masseuse', 1);
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hourly'] = 100;
  } },
      ]);
    }
    if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] !== 2) {
      if (((s as any).pcs_inhib ?? 0) >= 35) {
        ...
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          scene.actions([
            { label: 'Change jobtype to nude masseuse [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
          ]);
        } else {
    ...
    if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] !== 3) {
      if (((s as any).pcs_inhib ?? 0) >= 40  ||  ((s as any).stat ?? 0)?.['prostitute_times'] > 20) {
        ...
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          scene.actions([
            { label: 'Change jobtype to handjob masseuse [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
          ]);
        } else {
    ...
    if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] !== 4) {
      if (((s as any).pcs_inhib ?? 0) >= 50  ||  ((s as any).stat ?? 0)?.['prostitute_times'] > 35) {
        ...
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          scene.actions([
            { label: 'Change jobtype to oral masseuse [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
          ]);
        } else {
    ...
    if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] !== 5) {
      if (((s as any).pcs_inhib ?? 0) >= 60  ||  ((s as any).stat ?? 0)?.['prostitute_times'] > 50) {
        ...
        if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
          scene.actions([
            { label: 'Change jobtype to whore [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
          ]);
        } else {
...
function enterPayday(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['paycheck'] = qspFunc(s, 'jobs', 'paycheck', 'city_salon_masseuse', 'cash');
  scene.img('images/locations/city/citycenter/mall/salon/xian.jpg');
...
function enterPaydayEnd(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] === 2) {
    ...
    if (((s as any).job_rank ?? 0)?.['city_salon_masseuse'] > 2) {
      if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['sex_money_earned'] = ((s as any).masseuse['sex_money_earned'] ?? 0) + (((s as any).masseuse ?? 0)?.['paycheck']);
    }
  }
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['paycheck'] = 0;
  // TODO-QSP: end
  scene.build();
}
...
function enterResignation(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['last_rank'] = ((s as any).job_rank ?? 0)?.['city_salon_masseuse'];
...
function enterRehire1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).masseuse ?? 0)?.['last_rank'] === 1) {
    ...
    scene.text(`"Of course ${((s as any).pcs_firstname ?? 0)}, you know we always need more masseuses. Did you want your old job back or did you want to become a specialty masseuse?"`);
    scene.actions([
    ...
    scene.text(`"Of course ${((s as any).pcs_firstname ?? 0)}, you know we always need more girls. Did you want your old job back or did you want to change to a different one?"`);
    scene.actions([
      { label: 'My old job', handler: (st: GameState) => {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['pending_rank'] = ((s as any).masseuse ?? 0)?.['last_rank'];
      ...
      if (((s as any).masseuse ?? 0)?.['last_rank'] === 3) {
        ...
        if (((s as any).masseuse ?? 0)?.['last_rank'] === 4) {
          ...
          if (((s as any).masseuse ?? 0)?.['last_rank'] === 5) {
            ...
            if (((s as any).masseuse ?? 0)?.['last_rank'] === 6) {
              if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hourly'] = 150;
            } else {
              if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['hourly'] = 100;
            }
    ...
    scene.text('"My old job is fine."');
    // TODO-QSP: dynamic text: "Okay." She clacks a few times on a laptop in front of her. "There. Like you nev...
    scene.text(`"Okay." She clacks a few times on a laptop in front of her. "There. Like you never left. Payment at ${qspFunc(s, 'money', 'string_profit', ((s as any).masseuse ?? {})?.['hourly']*4)} per shift."`);
    scene.actions([
      { label: 'Next', goto: ['masseuse_work', 'rehire2'] },
    ]);
  } },
  ...
  if (((s as any).license ?? 0)?.['masseuse'] === 1) {
    if (((s as any).pcs_inhib ?? 0) >= 35) {
      ...
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Nude masseuse [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
        ]);
      } else {
    ...
    if (((s as any).pcs_inhib ?? 0) >= 40  ||  ((s as any).stat ?? 0)?.['prostitute_times'] > 20) {
      ...
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Handjob masseuse [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
        ]);
      } else {
    ...
    if (((s as any).pcs_inhib ?? 0) >= 50  ||  ((s as any).stat ?? 0)?.['prostitute_times'] > 35) {
      ...
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Oral masseuse [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
        ]);
      } else {
    ...
    if (((s as any).pcs_inhib ?? 0) >= 60  ||  ((s as any).stat ?? 0)?.['prostitute_times'] > 50) {
      ...
      if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
        scene.actions([
          { label: 'Whore [+$func(\'willpower\', \'get_willcost_string\'...]', handler: (st: GameState) => {
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
  } },
        ]);
      } else {
...
function enterFired(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['warning'] = (-1);
  ...
  scene.text(`"${((s as any).pcs_firstname ?? 0)}, you missed another shift this week."`);
  scene.text('"Oh yeah, I\'m sorry about tha-"');
  // TODO-QSP: dynamic text: She shakes her head and cuts you off. "That's three missed shifts <<$pcs_firstna...
  scene.text(`She shakes her head and cuts you off. "That's three missed shifts ${((s as any).pcs_firstname ?? 0)}. You're fired."`);
  if (((s as any).job_bonus_pay ?? 0)?.['city_salon_masseuse'] > 0) {
    if (!(s as any).masseuse) (s as any).masseuse = {}; (s as any).masseuse['paycheck'] = qspFunc(s, 'jobs', 'paycheck', 'city_salon_masseuse', 'cash');

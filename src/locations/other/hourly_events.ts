...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).inSleep ?? 0) === 1) {
    ...
    if (((s as any).sleepVars ?? 0)?.['no_sleep_loss'] === 0) {
      ...
      if (!(s as any).sleepVars) (s as any).sleepVars = {}; (s as any).sleepVars['no_sleep_loss'] = 0;
    }
    if (((s as any).pcs_sleep ?? 0) <= 0  &&  (!((s as any).succublvl ?? 0))) {
      if (!(s as any).pcs_condition) (s as any).pcs_condition = {}; (s as any).pcs_condition['lack_of_sleep'] = ((s as any).pcs_condition['lack_of_sleep'] ?? 0) + (2);
      if (((s as any).pcs_mood_effects ?? 0)?.['slpredcheck'] === 1) {
        qspCall(s, 'mood', 'lower', 'tiny');
      }
      if (!(s as any).pcs_mood_effects) (s as any).pcs_mood_effects = {}; (s as any).pcs_mood_effects['slpredcheck'] = 1;
    } else {
      if (!(s as any).pcs_mood_effects) (s as any).pcs_mood_effects = {}; (s as any).pcs_mood_effects['slpredcheck'] = 0;
    }
    if (((s as any).pcs_energy ?? 0) <= 0) {
      if (((s as any).pcs_mood_effects ?? 0)?.['nrgredcheck'] === 1) {
        qspCall(s, 'mood', 'lower', 'tiny');
      }
      if (!(s as any).pcs_mood_effects) (s as any).pcs_mood_effects = {}; (s as any).pcs_mood_effects['nrgredcheck'] = 1;
    } else {
      if (!(s as any).pcs_mood_effects) (s as any).pcs_mood_effects = {}; (s as any).pcs_mood_effects['nrgredcheck'] = 0;
    }
    if (((s as any).pcs_hydra ?? 0) <= 0) {
      if (((s as any).pcs_mood_effects ?? 0)?.['hydredcheck'] === 1) {
        qspCall(s, 'mood', 'lower', 'tiny');
      }
      if (!(s as any).pcs_mood_effects) (s as any).pcs_mood_effects = {}; (s as any).pcs_mood_effects['hydredcheck'] = 1;
    } else {
      if (!(s as any).pcs_mood_effects) (s as any).pcs_mood_effects = {}; (s as any).pcs_mood_effects['hydredcheck'] = 0;
    }
    if (((s as any).arch_vars ?? 0)?.['main_active'] === 'prude'  &&  ((s as any).pcs_faith ?? 0) <= 25) {
      if (((s as any).pcs_mood_effects ?? 0)?.['faithredcheck'] === 1) {
        qspCall(s, 'mood', 'lower', 'tiny');
      }
      if (!(s as any).pcs_mood_effects) (s as any).pcs_mood_effects = {}; (s as any).pcs_mood_effects['faithredcheck'] = 1;
    } else {
      if (!(s as any).pcs_mood_effects) (s as any).pcs_mood_effects = {}; (s as any).pcs_mood_effects['faithredcheck'] = 0;
    }
  ...
  if (((s as any).inSleep ?? 0) === 1) {
    if (!(s as any).pcs_period) (s as any).pcs_period = {}; (s as any).pcs_period['period_warning'] = 0;
  } else {
    if (((s as any).pcs_period ?? 0)?.['period_warning'] === 0  &&  ((s as any).placebopart ?? 0) > 0  &&  ((s as any).lutH ?? 0) > 0  &&  (!((s as any).knowpreg ?? 0))) {
      if (!(s as any).pcs_period) (s as any).pcs_period = {}; (s as any).pcs_period['period_warning'] = 1;
    } else {
      if (((s as any).pcs_period ?? 0)?.['period_warning'] === 1  &&  ((s as any).lutH_max ?? 0) - ((s as any).lutH ?? 0) <= 2) {
        if (!(s as any).pcs_period) (s as any).pcs_period = {}; (s as any).pcs_period['period_warning'] = 2;
  ...
  if ((!((s as any).inSleep ?? 0))) {
    if (!(s as any).vomit) (s as any).vomit = {}; (s as any).vomit['daily_check'] = 0;
  } else {
  ...
  if (((s as any).hunterVars ?? 0)?.['Andreisex'] > 0) {
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['Andreisex'] = ((s as any).hunterVars['Andreisex'] ?? 0) - (1);
  }
  if (((s as any).hunterVars ?? 0)?.['Sergeisex'] > 0) {
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['Sergeisex'] = ((s as any).hunterVars['Sergeisex'] ?? 0) - (1);
  }
  if (((s as any).hunterVars ?? 0)?.['Igorsex'] > 0) {
    if (!(s as any).hunterVars) (s as any).hunterVars = {}; (s as any).hunterVars['Igorsex'] = ((s as any).hunterVars['Igorsex'] ?? 0) - (1);
  }
  if (((s as any).huntslutsex ?? 0) > 0) {
    (s as any).huntslutsex = ((s as any).huntslutsex ?? 0) - (1);
  }
  if (((s as any).MiraVars ?? 0)?.['follow_time'] > 0) {
    if (!(s as any).MiraVars) (s as any).MiraVars = {}; (s as any).MiraVars['follow_time'] = ((s as any).MiraVars['follow_time'] ?? 0) - (1);
  }
  if (((s as any).npc_drunk ?? 0)?.['A60'] > 0  &&  ((s as any).locat ?? 0)?.['A60_loc'] !== 'mitkabuh_group') {
    if (!(s as any).npc_drunk) (s as any).npc_drunk = {}; (s as any).npc_drunk['A60'] = ((s as any).npc_drunk['A60'] ?? 0) - (1);
  }
  ...
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 14  &&  ((s as any).week ?? 0) < 6  &&  ((s as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((s as any).gschoolVars ?? 0)?.['school_diploma'] === 0  &&  ((s as any).kanikuli ?? 0) === 0  &&  ((s as any).gschoolVars ?? 0)?.['last_absence'] !== ((s as any).daystart ?? 0)) {
    ...
    if (!(s as any).gschoolVars) (s as any).gschoolVars = {}; (s as any).gschoolVars['last_absence'] = ((s as any).daystart ?? 0);
  }
  scene.build();
}

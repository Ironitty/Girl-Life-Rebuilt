...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).inSleep ?? 0) === 1) {
    ...
    if (((s as any).pcs_energy ?? 0) > 20) {
      (s as any).pcs_stam = ((s as any).pcs_stam ?? 0) + (((s as any).stammax ?? 0) / ((s as any).max ?? 0)(5, 110-((s as any).pcs_energy ?? 0)));
    }
        ...
        if (((s as any).inSleep ?? 0) === 0) {
          ...
          if (((s as any).trait_vars ?? 0)?.['panty_preference'] >= 2) {
            ...
            if (((s as any).pantyworntype ?? 0) === 'none'  &&  ((s as any).PCloPants ?? 0) > 0  &&  ((s as any).PCloPanties ?? 0) === 0  &&  ((s as any).clothingworntype ?? 0) !== 'nude') {
              (s as any).mosol = ((s as any).mosol ?? 0) + (((s as any).max ?? 0)(0, 2 - ((s as any).trait_vars ?? 0)?.['panty_preference']));

...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[0] ?? 0) === 'nerdinfo') {
    // TODO-QSP: gt 'intro_character_creation', 'group_desc', 'nerd'
  }
  if (((s as any).locArgs?.[0] ?? 0) === 'jockinfo') {
    // TODO-QSP: gt 'intro_character_creation', 'group_desc', 'jock'
  }
  if (((s as any).locArgs?.[0] ?? 0) === 'popularinfo') {
    // TODO-QSP: gt 'intro_character_creation', 'group_desc', 'cool'
  }
  if (((s as any).locArgs?.[0] ?? 0) === 'gopnikinfo') {
    // TODO-QSP: gt 'intro_character_creation', 'group_desc', 'gopnik'
  }
  if (((s as any).locArgs?.[0] ?? 0) === 'outcastinfo') {
    // TODO-QSP: gt 'intro_character_creation', 'group_desc', 'outcast'
  }

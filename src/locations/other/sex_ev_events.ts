...
function enterRandEvCheck(s: GameState, scene: SceneBuilder): void {
  ...
  if ((Math.floor(Math.random() * 20) + 1) <= ((s as any).sex_ev ?? 0)?.['rand_ev']) {
    ...
    (s as any).sex_ev_sex_events = undefined;
    if ((Math.floor(Math.random() * 100) + 1) > ((s as any).npc_sexskill ?? 0)?.[String((s as any).npcID ?? 0)]) {
      (s as any).sex_ev_sex_events = [...((s as any).sex_ev_sex_events ?? []), 'gt \'sex_ev_events\', \'bad_thrust_start\''];
    }
    if (((s as any).sex_ev ?? 0)?.['position'] === 'miss'  &&  ((s as any).sex_ev ?? 0)?.['phone_film'] === 0  &&  ((s as any).npc_sex_filmer ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  (Math.floor(Math.random() * 20) + 1) < ((s as any).npc_sexdrive ?? 0)?.[String((s as any).npcID ?? 0)]) {
      (s as any).sex_ev_sex_events = [...((s as any).sex_ev_sex_events ?? []), 'gt \'sex_ev_events\', \'sex_film1\''];
    }
...
function enterWhosePussy(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['position'] === 'miss') {
    ...
    if (((s as any).sex_ev ?? 0)?.['position'] === 'doggy') {
      ...
      alert('Error: position neither \'miss\' nor \'doggy\' ');
...
function enterSexFilmEnd(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['phone_film'] !== -1) {
    (s as any).i = 0;
    ((s as any).sex_video = (s as any).sex_video ?? {})[String((s as any).i ?? 0)] = (((s as any).sex_ev ?? 0)?.['video_media']);
    ((s as any).sex_video_author = (s as any).sex_video_author ?? {})[String((s as any).i ?? 0)] = (((s as any).sex_ev ?? 0)?.['video_author']);
    ((s as any).sex_video_dialogue = (s as any).sex_video_dialogue ?? {})[String((s as any).i ?? 0)] = (((s as any).sex_ev ?? 0)?.['video_dialogue']);
  }
...
function enterCreampieAskEv(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stat ?? 0)?.['preg_risk'] === 'danger') {
    ...
    scene.actions([
      { label: 'Refuse', goto: ['sex_ev_events', 'creampie_ask_ev_ma_pill_deny'] },
    ]);
  } },
    ]);
  }
  if (((s as any).sex_ev ?? 0)?.['promise_no_creampie'] === 1) {
    ...
    scene.actions([
      { label: 'Firmly deny him', goto: ['sex_ev_events', 'creampie_ask_ev_annoyed_deny'] },
      { label: 'Acquiesce', goto: ['sex_ev_events', 'creampie_ask_ev_annoyed_allow'] },
    ]);
  } },
    ]);
  }
...
function enterSneakPhone(s: GameState, scene: SceneBuilder): void {
  alert('Placeholder - Event is WIP');
  scene.build();
}
...
function enterBoyGottaGo(s: GameState, scene: SceneBuilder): void {
  scene.actions([
    ...
    if (((st as any).sex_ev ?? 0)?.['boy_shower'] === 1) {
      scene.text('"Shit, I gotta go," he says, dropping his towel and reaching for his clothes. ' + ((((st as any).hour ?? 0) >= ((st as any).npc_work_start ?? 0)?.[String((st as any).npcID ?? 0)]) ? ('"I\'m late for work."') : ('"I\'m gonna be late for work."')));
    } else {
      scene.text('"Shit, I gotta go," he says, hauling himself out of bed. ' + ((((st as any).hour ?? 0) >= ((st as any).npc_work_start ?? 0)?.[String((st as any).npcID ?? 0)]) ? ('"I\'m late for work."') : ('"I\'m gonna be late for work."')));
    }
...
function enterBoyGottaGo2(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['loc'] === 'hotel_room') {
    ...
    if (((s as any).sex_ev ?? 0)?.['hotel_days'] === 1) {
      scene.text(`"No need to rush. The room is booked until tomorrow," ${((s as any).npcdesc ?? '')} grins. "Feel free to order room service. Just make sure to be gone by checkout.` + ((((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'sugar_daddy'  &&  ((s as any).sex_ev ?? 0)?.['sugar_daddy_paid'] === 0) ? (' Your money\'s on the dresser."') : ('"')));
    } else {
      scene.text(`"No need to rush. The room is booked for a few more days," ${((s as any).npcdesc ?? '')} grins. "Feel free to order room service. Just make sure to be gone by checkout.` + ((((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'sugar_daddy'  &&  ((s as any).sex_ev ?? 0)?.['sugar_daddy_paid'] === 0) ? (' Your money\'s on the dresser."') : ('"')));
    }
...
function enterSugarDaddyGiftCheck(s: GameState, scene: SceneBuilder): void {
  ...
  if ((Math.floor(Math.random() * 5) + 1) === 1) {
    ...
    if (((s as any).moncheri_dress ?? 0)?.[String((s as any).newdress_id ?? 0)] === 0) {
      ...
      scene.img(`images/pc/items/moncheri/dress/${((s as any).newdress_id ?? '')}.jpg`);
    } else {
    ...
    if ((Math.floor(Math.random() * 4) + 1) === 1) {
      ...
      if ((Math.floor(Math.random() * 3) + 1) === 1) {
        ...
        if (((s as any).moncheri_purses ?? 0)?.[String((s as any).newdress_id ?? 0)] === 0) {
          ...
          scene.img(`images/pc/items/moncheri/purses/${((s as any).newdress_id ?? '')}.jpg`);
        } else {
          (s as any).newdress_loop = ((s as any).newdress_loop ?? 0) + (1);
          if (((s as any).newdress_loop ?? 0) > 1000) {
            alert('ERROR: formal cloth loop > 1000');
        ...
        if ((Math.floor(Math.random() * 2) + 1) === 1) {
          ...
          if (((s as any).coco_dress ?? 0)?.[String((s as any).newdress_id ?? 0)] === 0) {
            ...
            scene.img(`images/pc/items/coco/dress/${((s as any).newdress_id ?? '')}.jpg`);
          } else {
            (s as any).newdress_loop = ((s as any).newdress_loop ?? 0) + (1);
            if (((s as any).newdress_loop ?? 0) > 1000) {
              alert('ERROR: formal cloth loop > 1000');
          ...
          if (((s as any).lusso_bras ?? 0)?.[String((s as any).newdress_id ?? 0)] === 0  &&  ((s as any).lusso_panties ?? 0)?.[String((s as any).newdress_id ?? 0)] === 0) {
            ...
            scene.img(`images/pc/items/lusso/bras/${((s as any).newdress_id ?? '')}.jpg`);
          } else {
            (s as any).newdress_loop = ((s as any).newdress_loop ?? 0) + (1);
            if (((s as any).newdress_loop ?? 0) > 1000) {
              alert('ERROR: formal cloth loop > 1000');

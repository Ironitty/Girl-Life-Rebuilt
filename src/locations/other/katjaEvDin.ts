...
function enterStraponMain(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).loc ?? 0) === 'katja_dorm') {
    ...
    (st as any).katja_throat_check = undefined;
    (st as any).katja_vag_check = undefined;
    (st as any).katja_ass_check = undefined;
    qspCall(st, 'arousal', 'end');
    ...
    if (((s as any).npc_ass ?? 0)?.['A14'] < ((s as any).dick1 ?? 0) - 5) {
      ...
      if (((s as any).npc_ass ?? 0)?.['A14'] < ((s as any).dick1 ?? 0) - 3  ||  ((s as any).katjaQW ?? 0)?.['horny'] < 10) {
        ...
        if (((s as any).npc_ass ?? 0)?.['A14'] < ((s as any).dick1 ?? 0)) {
          ...
          ((s as any).katjaQW = (s as any).katjaQW ?? {})['horny'] = ((s as any).katjaQW['horny'] ?? 0) + (10);
          if (((s as any).katja_ass_check ?? 0) > 0) {
            scene.text('Your work on Katja\'s ass has born fruit and the strap-on easily slides into Katja\'s ass all the way to the hilt. Her moans of pleasure becomes even louder as you roughly fuck her ass.' + ((((s as any).strapNumber ?? 0) < 7) ? ('You wonder if you should try a larger dildo the next time.') : ('You have completely ruined her ass, making this ridiculously large dildo slide in with ease.')));
          } else {

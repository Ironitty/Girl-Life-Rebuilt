...
function enter(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['Type'] = ((s as any).locArgs?.[0] ?? 0);
  if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['Array'] = ((s as any).locArgs?.[1] ?? 0);
  if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['ActionCode'] = ((s as any).locArgs?.[2] ?? 0);
  if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['CodeAfterSpell'] = ((s as any).locArgs?.[3] ?? 0);
  if (((s as any).spellBookVar ?? 0)?.['ActionCode'] === '') {
    if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['ActionCode'] = 'gt $loc, $loc_arg';
  }
  if (((s as any).spellBookVar ?? 0)?.['CodeAfterSpell'] === '') {
    if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['CodeAfterSpell'] = 'gt $loc, $loc_arg';
  }
  // TODO-QSP: dynamic "act 'Never mind': <<$spellBookVar['ActionCode']>>"
  qspCall(s, 'spellList', '');
  if (((s as any).spellBookVar ?? 0)?.['Type'] === 'learn') {
    if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['TableText'] = '';
    // TODO-QSP: <center>
    ...
    // TODO-QSP: </tr>"
    if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['RowCode'] = qspUntranslated(s, "{", { location: "spellBook" });
    if (((s as any).spellLearn ?? 0)?.[String((s as any).ThisSpellName ?? 0)] > 0  &&  ((s as any).spellKnown ?? 0)?.[String((s as any).ThisSpellName ?? 0)] !== 1) {
      ...
      // TODO-QSP: <td align='right'><<spellLearn[$ThisSpellName]>>%</td>
      // TODO-QSP: </tr>"
      if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['Counter'] = ((s as any).spellBookVar['Counter'] ?? 0) + (1);
    }
  } else {
    if (((s as any).spellBookVar ?? 0)?.['Type'] === 'cast') {
      ...
      if (((s as any).spellKnown ?? 0)?.[String((s as any).ThisSpellName ?? 0)] === 1) {
        if (((s as any).spellOptDesc ?? 0)?.[String((s as any).ThisSpellName ?? 0)] === '') {
          ...
          if (((s as any).n ?? 0) < Object.keys((s as any)['' + qspUntranslated(s, "spellOptDesc[ThisSpellName]>", { location: "spellBook" }) + ''] ?? {}).length) {
            if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['tmpVal'] = 0;
            if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['tmpName'] = 0;
  ...
  (s as any).i = 0;
  if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['ArraySize'] = 0;
  if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['Counter'] = 0;
  // TODO-QSP: :SpellListLoop
  if (((s as any).i ?? 0) < ((s as any).spellBookVar ?? 0)?.['ArraySize']) {
    if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['TableText'] = ((s as any).spellBookVar['TableText'] ?? 0) + (0);
    (s as any).i = ((s as any).i ?? 0) + (1);
    // TODO-QSP: jump 'SpellListLoop'
  }
  if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['TableText'] = ((s as any).spellBookVar['TableText'] ?? 0) + ('');
  // TODO-QSP: </table>
  // TODO-QSP: </center>"
  if (((s as any).spellBookVar ?? 0)?.['Counter'] === 0) {
    if (!(s as any).spellBookVar) (s as any).spellBookVar = {}; (s as any).spellBookVar['TableText'] = '<center>You have no spells in this list.</center>';
  }
  scene.build();
}

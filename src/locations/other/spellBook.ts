...
function enter(s: GameState, scene: SceneBuilder): void {
  (s as any).spellBookVar['Type'] = ((s as any).locArgs?.[0] ?? 0);
  (s as any).spellBookVar['Array'] = ((s as any).locArgs?.[1] ?? 0);
  (s as any).spellBookVar['ActionCode'] = ((s as any).locArgs?.[2] ?? 0);
  (s as any).spellBookVar['CodeAfterSpell'] = ((s as any).locArgs?.[3] ?? 0);
  if (((s as any).spellBookVar ?? 0)?.['ActionCode'] === '') {
    (s as any).spellBookVar['ActionCode'] = 'gt $loc, $loc_arg';
  }
  if (((s as any).spellBookVar ?? 0)?.['CodeAfterSpell'] === '') {
    (s as any).spellBookVar['CodeAfterSpell'] = 'gt $loc, $loc_arg';
  }

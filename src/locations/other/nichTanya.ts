...
function enterDate(s: GameState, scene: SceneBuilder): void {
  if (((s as any).nichTanya ?? 0)?.['Date'] === 1) {
    ...
    qspGoto(st, 'nichTanya', 'date');
          ...
          (s as any).nichDateState = undefined;
    ...
    (st as any).nichDateState = undefined;
    qspGoto(st, 'nichBedroomTanja', '');
  } },
                  ]);
                }
...
function enterDesc(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).month ?? 0) > ((s as any).nichTanyaBdM ?? 0)  ||  (((s as any).month ?? 0) === ((s as any).nichTanyaBdM ?? 0)  &&  ((s as any).day ?? 0) > ((s as any).nichTanyaBdD ?? 0))) {
    scene.text('She is ' + (((s as any).year ?? '') - ((s as any).nichTanyaBdY ?? '')) + ' years old.');
  } else {
    if (((s as any).month ?? 0) === ((s as any).nichTanyaBdM ?? 0)  &&  ((s as any).day ?? 0) === ((s as any).nichTanyaBdD ?? 0)) {
      if (parseFloat((String(((s as any).year ?? 0) - ((s as any).nichTanyaBdY ?? 0)).slice((4)-1, ((4)-1)+(1)))) === 1) {
        scene.text('Today is her ' + (((s as any).year ?? '') - ((s as any).nichTanyaBdY ?? '')) + 'st birthday.');
      } else {
        if (parseFloat((String(((s as any).year ?? 0) - ((s as any).nichTanyaBdY ?? 0)).slice((4)-1, ((4)-1)+(1)))) === 2) {
          scene.text('Today is her ' + (((s as any).year ?? '') - ((s as any).nichTanyaBdY ?? '')) + 'nd birthday.');
        } else {
          if (parseFloat((String(((s as any).year ?? 0) - ((s as any).nichTanyaBdY ?? 0)).slice((4)-1, ((4)-1)+(1)))) === 3) {
            scene.text('Today is her ' + (((s as any).year ?? '') - ((s as any).nichTanyaBdY ?? '')) + 'rd birthday.');
          } else {
            scene.text('Today is her ' + (((s as any).year ?? '') - ((s as any).nichTanyaBdY ?? '')) + 'th birthday.');
          }
        }
      }
    } else {
      scene.text('She is ' + (((s as any).year ?? '') - ((s as any).nichTanyaBdY ?? '') - 1) + ' years old.');
    }
  }
  if (((s as any).nichTanya ?? 0)?.['Relationship'] === 0) {
  ...
  (s as any).nichTempAct = undefined;
  scene.actions([

...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`${((s as any).boydesc ?? 0)} leads you to his house, and gallantly opens the door for you. He invites you to take a seat on the couch and then sits down next to you, putting his arm around you. After you cuddle for a while, he puts his hand on your chin as he guides your face towards his.`);
  scene.actions([
    ...
    scene.text(`After a few minutes you begin to feel sorry for ${((s as any).boydesc ?? 0)}. You can tell he wants you badly, but he's too nervous to ask you to take off your clothes. You tell him: "Just sit back and relax, baby… I'll make you feel good", and slowly make your way down to his groin. He nods and shifts his hips a bit so you can pull his pants down, and moans your name softly when you close your lips around his ${((s as any).dick ?? 0)}cm dick. You do your best to make him feel good, and tease him a little with your tongue before focusing on giving him your best blowjob.`);
    // TODO-QSP: dynamic text: Your eagerness to please him seems to have inspired <<$boydesc>>, and after a fe...
    scene.text(`Your eagerness to please him seems to have inspired ${((s as any).boydesc ?? 0)}, and after a few minutes he's no longer the nervous guy you went home with. He gently but firmly pulls his hips away from your mouth, and looks at you eagerly.`);
    ...
    if ((!((s as any).tiprand ?? 0))) {
      ...
      (s as any).pose = 0;
      // TODO-QSP: dynamic text: <<$boydesc>> gets up and helps you take off your clothes, before he puts his han...
      scene.text(`${((s as any).boydesc ?? 0)} gets up and helps you take off your clothes, before he puts his hands on your shoulders and pushes you back against the couch, telling you to lie down on your back and spread your legs for him.`);
    }
    scene.actions([
    ...
    if (((s as any).tiprand ?? 0) === 1) {
      ...
      scene.text(`<center><img ${((s as any).set_imgh ?? 0)} src="images/shared/sex/vag/miss/fbhmiss.jpg"></center>`);
    }
    ...
    scene.text(`Once you're finished, you quickly brush up and begin to put your clothes back on. ${((s as any).boydesc ?? 0)} smiles at you, already dressed again in a clean fancy dress shirt and pants. You see him think for a few seconds, as if he's not sure how to bring it up. Then he says: "Thanks ${((s as any).pcs_nickname ?? 0)}, I really needed that! I'd love to spend more time with you, but I'm afraid I have to get back to work now. You should go."`);

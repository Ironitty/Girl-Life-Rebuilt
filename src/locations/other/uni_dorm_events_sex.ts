...
function enter8floorAnalGangbang(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You feel the pressure build up until it suddenly pops into your ass and you gasp as Haruna's ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} dick starts sliding up your ass.`);

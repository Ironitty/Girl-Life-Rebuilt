...
function enterHj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: Several minutes go by and you're starting to think this will take a while when c...
    scene.text(`Several minutes go by and you're starting to think this will take a while when cum suddenly starts shooting out of his cock. It flies up, narrowly missing your face, and lands on his pants, the bed and your hands. "Wow, that was amazing, ${((s as any).pcs_nickname || '')}! You're the best!"`);
    ...
    scene.actions([
      ...
      { label: 'Wander around his room', goto: ['artem_dorm', 'start'] },
    ]);
  } },
...
function enterArtemBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You remove your hand and wrap your lips as tightly as you can around his shaft before bobbing your head back and forth, taking as much of him into your mouth as you can. You spend several minutes like this before he finally says "I'm cumming! I want to cum on your face, ${((s as any).pcs_nickname || '')}!"`);
    qspCall(s, 'arousal', 'bj', 5);
    qspCall(s, 'stat', '');
    scene.actions([
    ...
    scene.text(`"You're the best girlfriend a guy could hope for, ${((s as any).pcs_nickname || '')}," he says as he grabs a tissue to clean up.`);
    qspCall(s, 'arousal', 'bj', 5);
    qspCall(s, 'arousal', 'end');
    qspCall(s, 'cum_call', 'face', 'A2', 1);
    qspCall(s, 'stat', '');
...
function enterSex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You stop and climb off him. Then, standing on his bed, you start stripping in front of him, giving him a little show as you remove your clothes. You revel in his undivided attention. "You're so beautiful, ${((s as any).pcs_nickname || '')}," he mutters.`);
    ...
    scene.text(`After a few minutes, you hear him muttering "${((s as any).pcs_nickname || '')}, I want you…"`);
    ...
    scene.text(`Artem looks at the floor. "I'm sorry, ${((s as any).pcs_nickname || '')}… I shouldn't have tried to talk you into it."`);
    ...
    scene.actions([
      { label: 'Just keep sucking', goto: ['artem_sex_uni', 'bj'] },
    ]);
  } },
      ]);
    }
    scene.actions([
      { label: 'Agree to have anal sex instead', goto: ['artem_sex_uni', 'anal'] },
    ]);
  } },
        ]);
      } else {
    ...
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Continue', goto: ['artem_sex_uni', 'cum_surprise'] },
    ]);
  } },
    ]);
  } },
    ...
    if (((s as any).artemQW ?? 0)?.['anal'] > 0) {
      ...
      scene.actions([
        { label: 'Get butt fucked', goto: ['artem_sex_uni', 'anal'] },
      ]);
    } else {
...
function enterCumSurprise(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 10) + 1) === 1  &&  ((s as any).noprotect ?? 0) === 1) {
    ...
    scene.text('You smile at him as you get off him. "It\'s okay, don\'t worry about it." He looks relieved, obviously thinking you\'re on birth control.');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(st, 'artem_sex_uni', 'after_sex', 'cp');
  } },
    ]);
  } else {
    ...
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(st, 'artem_sex_uni', 'after_sex', 'facial');
  } },
    ]);
  }
  // TODO-QSP: end
...
function enterAfterSex(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'cp') {
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 'facial') {
      qspCall(s, 'cum_call', 'face', 'A2', 1);
    }
  }
...
function enterBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He happily nods. "It was great! Thanks ${((s as any).pcs_nickname || '')}, you're the best!"`);
...
function enterAnal(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`It doesn't seem like any time has passed when your thoughts are interrupted as he pulls out of you. "I'm going to cum, ${((s as any).pcs_nickname || '')}."`);
...
function enterAnushka_3some(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('You talk about how things will go before there\'s a knock on the door. Hearing this, Artem gets up and answers it, and you see Anushka standing in the hallway. He stands aside to let her in before he closes the door and locks it. "Not a bad looking dorm room," she says.');
...
function enterAnushka_3someOral2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('You look at her inviting ass and pussy and can\'t help yourself. You move in behind Anushka, bury your face in her pussy and start licking. She starts quickly getting wet as she moans loudly.');
...
function enterAnushka_3someBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('Youall strip down before you push Artem onto his back on the ottoman. His dick is already hard from watching what happened or at the thought of what will come. You get on your hands and knees on the couch between his legs and start stroking his cock with your hand before you take it into your mouth, bobbing your head up and down on his shaft. As you do, you feel a warm wet tongue starts lapping at your clit as Anushka starts eating you out.');
  qspCall(s, 'arousal', 'bj', 2);
  ...
  scene.actions([
    ...
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Hand Artem the lube', handler: (st: GameState) => {
    ...
    qspCall(s, 'stat', '');
    qspGoto(s, 'artem_sex_uni', 'anushka_3some_rough1');
  } },
      ]);
    }
    scene.actions([
...
function enterAnushka_3someDoggy(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    scene.text('Instead of Artem responding to you, Anushka does. "Save your breath. This pussy boyfriend of yours doesn\'t know how to fuck me like a man." You can tell by her teasing tone that she\'s also encouraging him to get rougher.');
    ...
    scene.text('"OH… OH… I\'m… the pussy… assed bitch." She struggles to get out from the hard fucking Artem is giving her but her ever-increasing soaking pussy tells you she is loving it.');
    scene.text('"That\'s right you are. Now I own your ass and I\'m going to tear it up because there\'s nothing you can do about it!" You have to admit you wasn\'t expecting him to be this assertive, seems he has grown up a bit since the Pavlovsk days.');
    scene.text('She grips your leg tightly. "Oh fuck… Oh fuck… Not… So hard." She\'s starting to resist, but is still enjoying being used.');
    scene.text('"Shut that slut mouth up! I\'ll show you the same mercy, you showed me back in Pavlovsk. None!" You can tell by his deep breathing, grunts and tensing body that he\'s trying really hard not to cum so he can keep fucking her, but it\'s too much and he jerks out of her. "I\'m cumming, bitch!" he cries out.');
    qspCall(s, 'arousal', 'cuni_give', 2, 'lesbian', 'dom');
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Get on your knees', goto: ['artem_sex_uni', 'anushka_3some_facial'] },
    ]);
  } },
    ]);
  } },
  ...
  scene.actions([
    { label: 'Let him finish', handler: (st: GameState) => {
    scene.img('images/locations/pavlovsk/resident/apartment/artemhome/artemroom/sex/nush3some15.jpg');
    scene.text('You decide not to encourage him further. If he doesn\'t have what it takes to fuck a girl roughly, then that\'s on him. You know he\'ll be a little disappointed in himself for not taking full advantage of his opportunity as you keep licking Anushka while Artem fucks her ass. It doesn\'t take much longer before he starts to grunt, and you can tell he\'s about to cum. In fact, he soon pulls out of Anushka\'s asshole and starts stroking his cock.');
...
function enterAnushka_3someCleanup(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).artemQW ?? 0)?.['rough_anal_nush'] === 1) {
    ...
    scene.text('She just laughs. "Don\'t fill his head with lies. He was okay. You eating my pussy is what put me over the edge. He still has a lot to learn. Later losers." As she starts walking out of his room, he glances at you briefly before looking back at her.');
    scene.text('"That might be true, but I know that today I tore your ass up and from now on when we see each other around…" He pauses a moment while she stops and looks at him to let him finish. "We\'ll both know my dick was buried deep in your ass." She lifts her eyebrows briefly in surprise, then grins in amusement.');
    scene.text('"The little tiger has a bit of a roar. I like it." She then glances at you. "I might even be tempted to try this again. Maybe…" She walks out of his dorm room.');
    scene.text('Artem gives you a side fist pump. "Fuck yeah, I stood up to her." Looking at him, he seems happy, but you can tell her words bothered him. Just as you\'re about to say something, he interrupts you. "My roommate should be home soon, and I need to still study tonight."');
    scene.actions([
      { label: 'He had fun', goto: ['artem_sex_uni', 'nush3some_had_fun'] },
      { label: 'Ask how he feels', goto: ['artem_sex_uni', 'nush3some_how_he_feels'] },
    ]);
  } },
    ...
    qspCall(s, 'stat', '');
    scene.img('images/characters/shared/headshots_main/big144.jpg');
    scene.text('You look at her. "Nush, come on. I\'m working on it. It takes a while to train boys. Even you admitted he wasn\'t bad, and you did get off. Don\'t worry, I promise he\'ll be even better next time."');
    ...
    scene.text('You and Artem sit in silence, but just as you\'re about to say something, he interrupts you. "My roommate should be home soon, and I need to still study tonight."');
    ...
    scene.text('You sigh and nod before he gives you a tight-lipped smile and watches you leave his dorm room.');
    scene.actions([
      { label: 'Leave', goto: ['uni_dorm', 'second_floor'] },
    ]);
  } },
    ...
    scene.text('She rolls her eyes slightly and shakes her head a little. You know she dislikes it when people won\'t stand up for themselves. "What… ever… Later losers." She walks out of his dorm room.');
    scene.text('Artem still seems happy, but you can tell her words bothered him. Just as you\'re about to say something, he interrupts you. "My roommate should be home soon, and I need to still study tonight."');
    ...
    scene.text('You smile at him and give him a reassuring look. "Hell yes, how you were pounding her ass there at the end. I bet her ass will be sore tomorrow too." He glances at you, then laughs, and you laugh with him.');
    ...
    scene.text('He starts to say something. "No… I\'m an adult, and I should\'ve stood up to her. My girlfriend shouldn\'t have to defend me, but I\'m just so used to her and the other gopniks picking on me for years, that she intimidates me."');
    ...
    scene.text('He nods and smiles at your comment. "Yeah. Yeah, you\'re right. Not only did I get to fuck her, but I tore her ass up, something I never dreamed would ever happen, so yeah, I think I\'m good." He kisses you and thanks you for a great time before walking you to the door. Hoping this didn\'t bother him, you head on your way.');
    scene.actions([
      { label: 'Leave', goto: ['uni_dorm', 'second_floor'] },
    ]);
  } },
    ...
    if (((s as any).artemQW ?? 0)?.['rough_anal_nush'] === 2) {
      ...
      scene.text('She just laughs. "Maybe, he is a great \'lover\'." She makes it sound like it\'s a bad thing. "But he\'s still not a great fuck, at least not yet." You are pretty sure she is teasing him on purpose, just to yank his chain and not because she really means it, but you doubt Artem will understand that.');
      scene.actions([
        { label: 'Defend Artem', handler: (st: GameState) => {
    ((s as any).artemQW = (s as any).artemQW ?? {})['nush3some_again'] = 1;
    qspCall(s, 'npc_relationship', 'modify', 'A2', 'love');
    ...
    qspCall(s, 'stat', '');
    scene.img('images/characters/shared/headshots_main/big2.jpg');
    scene.text('"Ha!" you say in a scolding tone. "He did great. He tore your slutty ass up." You turn to Artem "You were great. Nush is just being a bitch."');
    ...
    scene.text('As she starts to walk out of his room, he glances at you for a moment before looking back to her, then straightens up his shoulders and something changes. He seems more confident all of a sudden. "That might be true. I might not be, as you put it, a great fuck, but what\'s also true is that I bent you over and tore your ass up, showing you no mercy, and you couldn\'t do anything about it. You just meekly and submissively took it, from a lowly nerd like me, while I made you my bitch." She lifts her eyebrows in surprise at what he says. She starts to retort, but before she can, he finishes. "When we see each other around from now on, we will both know that tonight I totally made you my bitch and nothing will ever change that."');
    scene.actions([
    ...
    scene.text('"I don\'t think so. I like this new Artem. He\'s sexy, but I don\'t buy that it\'s you." She then walks out, stopping at the door to glance back one last time. "At least not yet," she says with a grin.');
    scene.text('He doesn\'t back down from her. "You\'re wrong and next time you will know it too."');
    scene.text('She gives a slight snort. "Who says their will be a next time."');
    scene.text('He steps up right to her crowding her until he bumps into her forcing her to take a step back as he says in a firm voice. "I do." Then quickly glances at you, before looking back to her. You don\'t know if he was looking from encouragement from you or to check if he crossed a line, either way he seems to believe he is good to go as, he crowds her even more forcing her to take a step back again. "See I finally figured you out, deep down you like guys that bully, dominate, and humiliate you." He keeps crowding her and making her back up more and more until he finally corners her in the corner of the dorm room next to the door.');
    scene.actions([
      { label: 'Just watch', handler: (st: GameState) => {
    ((s as any).artemQW = (s as any).artemQW ?? {})['nush3some_again'] = 2;
    scene.img('images/characters/shared/headshots_main/big2.jpg');
    scene.text('She smiles at him when her back bumps into the corner and is unable to back up more. "Is that so?" She tries to act tough and defiant, but her breathless tone confirms what he is saying, she sounds and looks really turned on now.');
    scene.text('You can\'t see his face but his tone says he is in command of what is going on and knows it, while he places his hands on the wall on each side of her giving her no where to go. "Yeah it is, I also know you loved getting fucked and dominated by a nerd, just like you are loving this." He pulls his right hand off the wall and slides it between her thighs and up her skirt, a moment later you hear her gasp a little. "Your wet pussy agrees with me, the idea of getting owned and humiliated by a nerd like me makes it even better. Doesn\'t it?"');
    scene.text('You can just barely see her face past his shoulder and she looks very turned on and also in as much shock as you are by how Artem is acting, you have never seen him like this and Anushka\'s pussy isn\'t the only one soaking wet from this. When she doesn\'t respond he places his right hand back on the wall to block any escape and says forcefully and loudly. "Say it!"');
    scene.text('Breathlessly and quietly so quiet you can barely hear her words. "Yes." There is a pause, as she looks up at him, you never really noticed before how much taller Artem is over Anushka, you know she is fairly short at about 160cm tall but he towers over her at nearly 180cm tall. His face must have encouraged her as she then continues a bit louder so you can more easily hear her. "Yes… I love the idea of a nerd making me his bitch… and humiliating me."');
    scene.actions([
      { label: 'Keep watching', handler: (st: GameState) => {
    ((s as any).artemQW = (s as any).artemQW ?? {})['nush3some_again'] = 3;
    ((s as any).anushkaQW = (s as any).anushkaQW ?? {})['artem_dom'] = ((s as any).anushkaQW['artem_dom'] ?? 0) + (1);
    scene.img('images/characters/shared/headshots_main/big144.jpg');
    scene.text('You see his shoulders relax as his hands slide down from the wall as he steps back to make space for her. "So like I said, there will be another time, we will let you know where and when, got it?"');
    scene.text('She casts her eyes down and bites her lower lip as she nods. "Yes." She says softly.');
    scene.text('He crosses his arms and looks down at her. "Good, now get your little ass out of here." He says, then she moves past him to the door and opens up the door. As she does Artem reaches out and gives her ass a hard slap, hard enough it makes her jump a little and yelp, while the sound of the smack on the ass carries across the room. As Artem turns toward you, you can see her eyes wide and a huge grin on her face, you can tell she loved ever moment of that, just as you did. Then she mouths the word wow to you and gives you a wink as she leaves closing the door.');
    scene.actions([
      { label: 'Ask how he feels', handler: (st: GameState) => {
    scene.img('images/characters/shared/headshots_main/big2.jpg');
    scene.text('He walks back over and sits down next to you. You smile to him and kiss him. "I won\'t lie, I was impressed by how you handled her, I am proud of you." You say to him and kiss him again. "So, how did that make you feel?"');
    scene.text('He looks thoughtful for a second. "You know what? I feel great, I really do." He pauses, as if he\'s considering what to say next, you give him time to collect his thoughts. "I don\'t know… I just suddenly had enough and I was like hell with this I am going to push back for once." Then he grins. "As I told her what I thought and realized she was backing down from me… from ME!" He shakes his head a bit. "That\'s when I had a real surge of confidence, so I pushed back even more. That\'s… that\'s when it suddenly hit me, she liked it and… I don\'t know it is like so many things suddenly clicked in my head and just seemed so much better."');
    scene.text('You give his hand a reassuring squeeze. "I\'m glad you had this moment, confidence looks good on you."');
    scene.text('He turns his head and looks at you. "Thanks, I mean it, it was your encouragement that helped me get here, with out you…" He trails off.');
    scene.text('You shake your head. "No while I might have helped get you here a little faster this is who you always were, who I always saw you to be, you would have got here on your own, I am just glad I could help."');
    scene.text('He smiles to you. "Thanks… I still can\'t really believe I fucked Nush like a slut and then made her my bitch afterward, forcing her to agree." He sounds elated beyond words, he looks like the weight of the world has lifted off him. Apparently all the bullying has bothered him more than he said and now it seems to have lifted at least for now.');
    scene.actions([
    ...
    scene.img('images/characters/shared/headshots_main/big2.jpg');
    scene.text('"So does that mean you want to do this again?" You ask him.');
    scene.text('He nods. "Hell yes and next time I am going to totally own her." Then he looks at you and blushes a bit. "I mean I would like to if you want to, of course."');
    scene.text('You can\'t help but grin at how he can be so dominate one moment but still blush and care about your feelings the next. "Well let me think about it, but I think maybe we can, you made sure she would say yes already, so why waste that. I will let you know when I am ready to invite her again." You also want to talk to Anushka about this now.');
    scene.text('He nods. "Of course, just let me know." The two of you talk for a bit more before he finally says. "My roommate should be home soon, and I need to still study tonight."');
    scene.actions([
      { label: 'Leave', goto: ['uni_dorm', 'second_floor'] },
    ]);
  } },
    ...
    scene.text(`She snorts. "Oh, I'll give it to you that for the last few minutes, you started to actually fucked me like a man, but that was only after ${((s as any).pcs_nickname || '')} and I encouraged you several times." She steps up close to him and taps him on the chest. "Which means you have it in you, but where was that earlier, hmm? The last few minutes don't make up for the rest."`);
    scene.text('His grin fades and he sighs. "Sorry I wasn\'t very good."');
    scene.text('She rolls her eyes and shakes her head. You know she dislikes it when people won\'t stand up for themselves. "What… ever… Later losers." She walks out of his dorm room.');
    scene.text('As she leaves, you can see he still seems happy, but tell her words bothered him. Just as you\'re about to say something, he interrupts you. "My roommate should be home soon, and I need to still study tonight."');
    scene.text('You smile and kiss him again. "Don\'t listen to her. You were great as always."');
    scene.text('He snorts softly. "Sure… Thanks for standing up for me then."');
    scene.actions([
      { label: 'You need to stand up for yourself', handler: (st: GameState) => {
    ...
    scene.text('You smile at him and give him a reassuring look. "Hell yeah, with how you were pounding her ass there at the end? You felt her trying to pull away! I bet her asshole feels like it\'s on fire right now and will be really sore tomorrow."');
    scene.text('He looks at you and laughs even more, and you laugh with him. "Thanks, I needed that." Looking at him, he seems happy, but you can tell her words bothered him. Just as you\'re about to say something, he interrupts you. "My roommate should be home soon, and I need to still study tonight."');
    scene.actions([
      { label: 'He had fun', goto: ['artem_sex_uni', 'nush3some_had_fun'] },
      { label: 'Ask how he feels', goto: ['artem_sex_uni', 'nush3some_how_he_feels'] },
    ]);
    ...
    scene.text('He looks at you and laughs while shaking his head. "You\'re right… you\'re right. I just wish…"');
    scene.text('You look at him. "Wish what?"');
    scene.text('He sighs. "I wish I had taken better advantage of the situation, maybe really paid her back some for all the teasing she\'s put me through over the years."');
    ...
    scene.img('images/characters/shared/headshots_main/big2.jpg');
    scene.text('You smile and kiss him again. "Don\'t listen to her. You were great as always."');
    scene.text('He laughs and shakes his head. "It\'s okay. Not sure what I expected from her; she is who she is. I\'m good, honestly." He kisses you and thanks you for a great time before walking you to the door. It seems it didn\'t bother him too much, so you head on your way.');
    scene.actions([
      { label: 'Leave', goto: ['uni_dorm', 'second_floor'] },
    ]);
  } },
    ...
    scene.text('"What… ever… Later losers." She walks out of his dorm room.');
    scene.text('Once she leaves, you can tell her words bothered him a lot, but just as you\'re about to say something, he interrupts you. "My roommate should be home soon, and I need to still study tonight."');
    scene.text('You smile and kiss him again. "Don\'t listen to her. You were great as always."');
    scene.text('He snorts softly. "Sure… Thanks for standing up for me then."');
    scene.actions([
...
function enterNush3someHowHeFeels(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text('He laughs and hugs you. "You\'re right. Thank you for everything. I had a great time. I really needed that." He kisses you before walking you to the door. As you leave, you think about what just happened. Not only do Anushka\'s words seem to not have bothered him anymore, but there\'s something about his stance, tone of voice and how he acted. He seems to have gotten a little more confident from today\'s events.');
    scene.actions([
      { label: 'Leave', goto: ['uni_dorm', 'second_floor'] },
    ]);
  } },
...
function enterStraponFirst(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).spellKnown ?? 0)?.['penisenvy'] === 1) {
    ...
    if (((s as any).spellSuccess ?? 0) > 0) {
      scene.actions([
        { label: 'Get a blowjob', goto: ['artem_sex_uni', 'strapon_first_magic'] },
      ]);
    } else {
      scene.actions([
...
function enterStraponFirstBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You slowly slide the entire length of the ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dildo into his ass, causing him to moan as you climb on top of him, laying on his back as you slowly start fucking him. "Sounds like you like that."`);
    ...
    scene.text(`His moans quickly turn to pained grunts. "Stop! That hurts!" he cries out and shoves you off before sitting up and glaring at you. "What the hell, ${((s as any).pcs_nickname || '')}?! That hurt!"`);
    ...
    qspCall(s, 'arousal', 'anal_strap_give', 3);
    qspCall(s, 'arousal', 'end');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    ...
    scene.text('You nod and he kisses you before leaving his room and going to the dorm floor bathroom. Placing the strap-on back in your purse, you leave his apartment with a massive grin on your face.');
    scene.actions([
      { label: 'Leave', goto: ['uni_dorm', 'second_floor'] },
    ]);
  } },
...
function enterStraponFirstMagic(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You slowly slide the entire length of your ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick into his ass, causing him to groan as you climb on top of him, laying on his back as you slowly start fucking him. "Sounds like you like that."`);
    scene.text('He glances back over his shoulder at you. "It feels weird, but yeah, I kind of like it."');
    scene.text('You give him a reassuring smile. "Great, because I love this. Now take a deep breath."');
    scene.text('You push it in as far as it will go and start steadily fucking him, picking up the pace as he starts moaning louder. By the sound of it, he\'s starting to enjoy it.');
    qspCall(s, 'arousal', 'magicd_anal', 2);
...
function enterStraponSecond(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).spellKnown ?? 0)?.['penisenvy'] === 1) {
    ...
    if (((s as any).spellSuccess ?? 0) > 0) {
      scene.actions([
        { label: 'Get a blowjob', goto: ['artem_sex_uni', 'strapon_second_magic'] },
      ]);
    } else {
      scene.actions([
...
function enterStraponSecondMagic(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text('You give him a reassuring smile. "You\'ll get used to it, now take a deep breath and relax." Which he does and visibly relaxes more.');
    scene.text('Once he and the dildo are lubed up, you cap the bottle of lube and toss it aside. "You ready?"');
    scene.text('He nods in response as he says "Yeah." and you line the dildo up and slowly push it into his asshole, causing him to have a slight hiss in pain, which turns into a loud groan as his tight little asshole grips your cock tightly, causing you to moan in pleasure.');
    ...
    scene.text('He doesn\'t answer at first. "Better than last time, it didn\'t hurt as much and stopped hurting sooner."');
    // TODO-QSP: dynamic text: You slowly slide the entire length of your <<dick>>cm <<$dick_girth>> dick into ...
    scene.text(`You slowly slide the entire length of your ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick into his ass, it feels amazing to feel the full length of your shaft inside of him. It causes him to moan as well, as you climb on top of him, laying on his back as you slowly start fucking him. "Sounds like you are starting to like my cock in your ass." You say to him in a slightly teasing tone.`);
    scene.text('He glances back over his shoulder at you. "It still feels weird, but yeah, I kind of like it."');
    scene.text('You give him a reassuring smile. "Great, because I love this. Now just relax and take my cock."');
    scene.text('You push it in as far as it will go and start steadily fucking him, picking up the pace as he starts moaning louder. By the sound of it, he\'s starting to enjoy it.');
    qspCall(s, 'arousal', 'magicd_anal', 2);
...
function enterStraponAgain(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).spellKnown ?? 0)?.['penisenvy'] === 1) {
    ...
    if (((s as any).spellSuccess ?? 0) > 0) {
      scene.actions([
        { label: 'Get a blowjob', goto: ['artem_sex_uni', 'strapon_again_magic'] },
      ]);
    } else {
      scene.actions([
        { label: 'Get a blowjob', goto: ['artem_sex_uni', 'strapon_again_bj'] },
      ]);
    }
  } },
      ]);
...
function enterStraponAgainBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text('You give him a smile. "I see your getting use to it, now take a deep breath and relax." Which he does and visibly relaxes more.');
    scene.text('Once he and the dildo are lubed up, you cap the bottle of lube and toss it aside. "You ready?"');
    scene.text('He nods in response as he says "Yeah." sounding a little eager this time, as you line the dildo up and slowly push it into his asshole, causing him to grunt a little as the tip slides in, that quickly turns into a moan from him. Seeing that he seems to not mind this time or maybe is even enjoying it, you slide the dildo further into his ass as you start to fuck him.');
    qspCall(s, 'arousal', 'anal_strap_give', 2);
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    ...
    // TODO-QSP: dynamic text: You slowly slide the entire length of the <<dick>>cm <<$dick_girth>> dildo into ...
    scene.text(`You slowly slide the entire length of the ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dildo into his ass, causing him to moan loudly as you climb on top of him, laying on his back as you slowly start fucking him. "Sounds like you are enjoying my cock in your ass." You say to him in a slightly teasing tone.`);
...
function enterStraponAgainMagic(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text('You give him a smile. "I see your getting use to it, now take a deep breath and relax." Which he does and visibly relaxes more.');
    scene.text('Once he and the dildo are lubed up, you cap the bottle of lube and toss it aside. "You ready?"');
    scene.text('He nods in response as he says "Yeah." sounding a little eager this time, as you line your cock up and slowly push it into his asshole, causing him to grunt a little as the tip slides in, that quickly turns into a moan from him. Seeing that he seems to not mind this time or maybe is even enjoying it, you slide your dick further into his ass as you start to fuck him.');
    qspCall(s, 'arousal', 'magicd_anal', 2);
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    ...
    scene.text('He doesn\'t answer at first. "Better than last time, it kinda feels good… but don\'t tell anyone I said that."');
    // TODO-QSP: dynamic text: You slowly slide the entire length of your <<dick>>cm <<$dick_girth>> dick into ...
    scene.text(`You slowly slide the entire length of your ${((s as any).dick || '')}cm ${((s as any).dick_girth || '')} dick into his ass, causing him to moan loudly as you climb on top of him, laying on his back as you slowly start fucking him. "Sounds like you are enjoying my cock in your ass." You say to him in a slightly teasing tone.`);
    scene.text('He moans loudly then glances back over his shoulder at you, you can\'t help but notice the turned on expression on his face. "OOOhhh yeah… just not to rough."');
    scene.text('You give him a reassuring smile. "Great, because I love this. Now just take my cock like the little slut you are."');
    scene.text('You push it in as far as it will go and start steadily fucking him, picking up the pace as he starts moaning louder. By the sound of it, he\'s starting to really get off on it.');
    qspCall(s, 'arousal', 'magicd_anal', 2);
...
export const artem_sex_uni: LocationDef = {
  name: 'artem_sex_uni',

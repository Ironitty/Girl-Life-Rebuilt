                                  ...
                                  if (((s as any).locArgs?.[1] ?? 0) === 'hotel_therapist') {
                                    ...
                                    if (((s as any).locArgs?.[1] ?? 0) === 'pushkin_ballet_dorm') {
                                      ...
                                      if (Object.keys((s as any).home_property_attr_calls ?? {}).length > 0) {
                                        ...
                                        (s as any).temp_app_loc = ((String(0).indexOf(String('\''))) + 1);
                                        (s as any).temp_loc_name = 0;
...
function enterGetPropertyAttribute(s: GameState, scene: SceneBuilder): void {
  (s as any).name = ((((s as any).locArgs?.[2] ?? 0) === '') ? (((s as any).home_name ?? 0)?.[String((s as any).loc ?? 0)]) : (((s as any).home_name ?? 0)?.[((s as any).locArgs?.[2] ?? 0)]));
  ...
  if ((String(((s as any).locArgs?.[1] ?? 0)).slice((1)-1, ((1)-1)+(1))) === '$') {
    (s as any).result = ((s as any).property ?? 0)?.[0];
  } else {
...
function enterRegisterModGetPropertyAttributeCall(s: GameState, scene: SceneBuilder): void {
  (s as any).temp_hpac = qspUntranslated(s, "trim(ARGS[1])", { location: "homes_properties_attr" });
...
function enterRemoveModGetPropertyAttributeCall(s: GameState, scene: SceneBuilder): void {
  ((s as any).temp_hpacVars = (s as any).temp_hpacVars ?? {})['call'] = qspUntranslated(s, "trim(ARGS[1])", { location: "homes_properties_attr" });
  ...
  if (((s as any).temp_hpacVars ?? 0)?.['pos'] >= 0) {
    ((s as any).temp_hpacVars = (s as any).temp_hpacVars ?? {})['loc'] = ((String(qspUntranslated(s, "mid(temp_hpacVars['call'], 3)", { location: "homes_properties_attr" })).indexOf(String('\''))) + 1);
    ((s as any).temp_hpacVars = (s as any).temp_hpacVars ?? {})['name'] = qspUntranslated(s, "mid(temp_hpacVars['call'], 2, temp_hpacVars['loc'])", { location: "homes_properties_attr" });

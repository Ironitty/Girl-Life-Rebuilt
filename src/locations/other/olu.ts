...
function enterOlusex(s: GameState, scene: SceneBuilder): void {
  ((s as any).OluQW = (s as any).OluQW ?? {})['sex'] = 1;
  ((s as any).npc_had_sex = (s as any).npc_had_sex ?? {})['A55'] = 1;
  ...
  scene.actions([
    ...
    ((st as any).OluQW = (st as any).OluQW ?? {})['vaginal'] = ((st as any).OluQW['vaginal'] ?? 0) + (1);
    ...
    ((st as any).OluQW = (st as any).OluQW ?? {})['anal'] = ((st as any).OluQW['anal'] ?? 0) + (1);
    ...
    qspCall(st, 'cum_call', 'mouth', 'A55', 1);
    qspCall(st, 'cum_call', 'face', 'A55', 1);
    ...
    ((st as any).OluQW = (st as any).OluQW ?? {})['think_virgin'] = 1;
    ((st as any).OluQW = (st as any).OluQW ?? {})['anal'] = ((st as any).OluQW['anal'] ?? 0) + (1);
    if (((st as any).pcs_ass ?? 0) < ((st as any).dick ?? 0)) {
      qspCall(st, 'arousal_funcs', 'stretch', 'anal', 2);
    }
...
function enterSeductionStrip(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).OluQW = (st as any).OluQW ?? {})['sex'] = 1;
    ((st as any).npc_had_sex = (st as any).npc_had_sex ?? {})['A55'] = 1;
    qspCall(st, 'boyStat', 'A55');
    ...
    ((st as any).OluQW = (st as any).OluQW ?? {})['think_virgin'] = 0;
    ((st as any).OluQW = (st as any).OluQW ?? {})['vaginal'] = ((st as any).OluQW['vaginal'] ?? 0) + (1);
    qspCall(st, 'stat', '');
...
function enterOlusex1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'bj', 5, 'deepthroat');
    qspCall(st, 'stat', '');
    if (((st as any).stat ?? 0)?.['think_virgin'] === 0) {
      scene.actions([
        { label: 'Okay', handler: (st: GameState) => {
...
function enterOluanya(s: GameState, scene: SceneBuilder): void {
  ((s as any).OluQW = (s as any).OluQW ?? {})['anya_count'] = ((s as any).OluQW['anya_count'] ?? 0) + (1);
  (s as any).minut = ((s as any).minut ?? 0) + 10;
...
function enterAnyaolusvet(s: GameState, scene: SceneBuilder): void {
  ((s as any).OluQW = (s as any).OluQW ?? {})['threesome'] = ((s as any).OluQW['threesome'] ?? 0) + (1);
  ((s as any).npc_had_sex = (s as any).npc_had_sex ?? {})['A55'] = 1;
...
function enterOlunush(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).anushkaQW ?? 0)?.['radspy'] === 1) {
...
function enterNusholusvet(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'npc_relationship', 'modify', 'A144', 'love');
    qspCall(st, 'stat', '');
    scene.img('images/characters/pavlovsk/school/girl/anushka/sex/facial.jpg');
...
function enterOlunat(s: GameState, scene: SceneBuilder): void {
  ((s as any).OluQW = (s as any).OluQW ?? {})['nat_count'] = ((s as any).OluQW['nat_count'] ?? 0) + (1);
...
function enterNatolusvet(s: GameState, scene: SceneBuilder): void {
  ((s as any).OluQW = (s as any).OluQW ?? {})['threesome'] = ((s as any).OluQW['threesome'] ?? 0) + (1);
  ((s as any).npc_had_sex = (s as any).npc_had_sex ?? {})['A55'] = 1;
  ((s as any).OluQW = (s as any).OluQW ?? {})['vaginal'] = ((s as any).OluQW['vaginal'] ?? 0) + (1);
  qspCall(s, 'npcStat', 'A55');

...
function enterOlusex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He pulls out of your pussy and rolls you over. Before you can do anything, he lifts you up and place you on all fours before pulling you back towards the edge of the bed. Within seconds, you feel his huge cock slide back into your pussy, causing you to moan in pleasure. He slides his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock all the way into you, his balls slapping against your clit as he fucks you.`);
    ...
    scene.text(`He pulls his dick out of you and wraps one of his hands around your hips to hold you in place. You then feel his thick cock pressing against your asshole. You're not sure it's going to fit and are about to say something when he suddenly shoves his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock into your ass, the sudden sharp pain making you cry out. Your ass feels like it's on fire and you try to scoot away, but he grabs you by the hip and uses both of his powerful hands to firmly hold you in place.`);
...
function enterSeductionStrip(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He lifts you up suddenly until he pulls out of your twat and then rolls you over onto your back on the couch. He pushes your legs up and apart as he positions himself between your legs and then he slips his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock all the way into you, until you can feel his balls slapping against your butt cheeks as he fucks you. Just as it starts to really feel good, he leans forward and whispers in your ear. "I'm going to fuck your ass now."`);
    qspCall(s, 'arousal', 'vaginal', 5);
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Anal', handler: (st: GameState) => {
    ...
    if (((s as any).OluQW ?? 0)?.['anal'] === 0) {
      ...
      scene.text(`He pushes your legs up and apart before he guides his cock against your asshole. You're not sure it's going to fit and you're about to say something when he suddenly shoves his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock up your ass, the sudden sharp pain causing you to cry out.`);
...
function enterOlusex1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`He pushes his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock all the way into you. Just as it starts to really feel good, he leans forward and whispers in your ear. "I'm going to fuck your ass now."`);
    qspCall(s, 'arousal', 'vaginal', 5);
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Anal', handler: (st: GameState) => {
    ...
    scene.text(`He grabs one of your hands and places it on your ass cheek, encouraging you to spread your ass as he guides his cock against your asshole. The pressure builds until he suddenly shoves his ${((s as any).dick ?? 0)}cm ${((s as any).dick_girth ?? 0)} cock up your ass, the sudden sharp pain causing you to cry out.`);
    qspCall(s, 'arousal', 'anal', 5);
    qspCall(s, 'stat', '');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
...
function enterOlunush(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).OluQW ?? 0)?.['nush_count'] === 0) {
    ...
    scene.text(`She walks over to him and starts stripping. "You're not so bad yourself. ${((s as any).pcs_nickname ?? 0)} told me you have a big cock?" she practically purrs.`);

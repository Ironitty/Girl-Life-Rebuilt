...
function enterDFbdStart(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).fbde ?? 0) <= 1) {
      ...
      scene.text(`When you enter the room, you see it's crowded with boys! It seems that some of ${((s as any).npcdesc || '')}'s friends were having a party in the hostel. One of them walks up to greet you and says to ${((s as any).npcdesc || '')}: "Hey man, what's up? How about you introduce us to your girlfriend?"`);
      // TODO-QSP: dynamic text: <<$npcdesc>> happily shakes his hand and introduces you to his friends one by on...
      scene.text(`${((s as any).npcdesc || '')} happily shakes his hand and introduces you to his friends one by one, after which you look for a place to sit. There aren't enough chairs in the room, so you sit down on a bed next to ${((s as any).npcdesc || '')}. One of his friends is on the other side, but you already forgot his name again. Not important, anyway. You cuddle up against ${((s as any).npcdesc || '')}, not caring much for the other guy. Without even asking, one of the guys pours some vodka in a glass and hands it to you.`);
      scene.actions([
      ...
      if (((s as any).fbde ?? 0) === 2) {
        ...
        scene.text(`You expected there to be other people in the room, but to your surprise it's empty. ${((s as any).npcdesc || '')} closes the door behind you and pulls you towards him, kissing you roughly.`);
        scene.actions([
        ...
        if (((s as any).fbde ?? 0) === 3) {
          ...
          scene.text(`When you enter the room, you see an unfamiliar guy sitting on one of the beds, reading a book. ${((s as any).npcdesc || '')} greets him and walks up to him, whispering something in his ear.`);
          (s as any).tiprand = Math.floor(Math.random() * 100) + 1;
          if (((s as any).tiprand ?? 0) < 90) {
            // TODO-QSP: dynamic text: The guy quickly puts on his shoes and says goodbye as he leaves the room with hi...
            scene.text(`The guy quickly puts on his shoes and says goodbye as he leaves the room with his book, giving you and ${((s as any).npcdesc || '')} some privacy.`);
            scene.actions([
              { label: 'Kiss him', goto: ['fbDormD', 'd_fbd_regular'] },
            ]);
          } else {
            if (((s as any).tiprand ?? 0) >= 90) {
              ...
              scene.text(`The guy grins as he puts his book away and introduces himself to you. Then he reaches for his bag, pulling out a bottle of vodka and some snacks. You hesitantly sit down on ${((s as any).npcdesc || '')}'s bed. ${((s as any).npcdesc || '')} immediately sits down next to you and wraps one arm around you, while his friend pours some vodka into glasses. He hands out the glasses before sitting down on your other side.`);
              scene.actions([
    ...
    scene.text(`While you take sips of the vodka, you chat with the guys. They're quite interesting, having many stories to share about where they're from. While you drink and chat, more and more of ${((s as any).npcdesc || '')}'s friends return from what they were doing in Pavlovsk, and the room fills up slowly but surely. It's turning into quite a large group, and the room sounds like a disturbed bee hive while you continue to take sips of your drink, mostly chatting with ${((s as any).npcdesc || '')}. When your glass is almost empty, ${((s as any).npcdesc || '')} takes it from you and quickly refills it, offering it to you again.`);
    scene.actions([
...
function enterDFbdRegular(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).tiprand ?? 0) >= 80) {
      ...
      scene.text(`${((s as any).npcdesc || '')} gently but firmly puts his hand behind your neck and pushes your face down towards his groin, where his already exposed and erect cock greets you.`);
      scene.actions([
        { label: 'Take his cock in your mouth', goto: ['fbDormD', 'd_fbd_blowhim'] },
      ]);
    } else {
...
function enterDFbdMass(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`${((s as any).npcdesc1 || '')} begins to kiss you before he takes your hand and guides you to another nearby room, where he pulls you down onto a mattress. Even though you said you wanted to be alone with ${((s as any).npcdesc1 || '')}, his friend enters the room a few seconds later.`);
    // TODO-QSP: dynamic text: <<$npcdesc1>> sees your startled look and reassures you: "Relax, babe… he's not ...
    scene.text(`${((s as any).npcdesc1 || '')} sees your startled look and reassures you: "Relax, babe… he's not going to do anything, he just likes to watch. Just focus on me, you do want to make me feel good, right?"`);
    // TODO-QSP: dynamic text: You nod meekly and close your eyes, enjoying <<$npcdesc1>>'s ministrations while...
    scene.text(`You nod meekly and close your eyes, enjoying ${((s as any).npcdesc1 || '')}'s ministrations while he kisses you and slowly takes your clothes off. When you open your eyes again and turn your head, you see that his friend also got naked, and is slowly jerking himself off in the corner while ${((s as any).npcdesc1 || '')} moves in to fuck you. Weird… You close your eyes again, trying to forget about the friend while you focus on ${((s as any).npcdesc1 || '')} and his cock.`);
    qspCall(s, 'dinsex', 'boy_puts_condom');
    qspCall(s, 'dinsex', 'vaginal_sex', 10);
    qspCall(s, 'arousal', 'foreplay', 5);
    qspCall(s, 'stat', '');
    // TODO-QSP: dynamic text: While <<$npcdesc1>> fucks you, you open your mouth to moan. When you do, you sud...
    scene.text(`While ${((s as any).npcdesc1 || '')} fucks you, you open your mouth to moan. When you do, you suddenly feel something hard against your lips.`);
    ...
    scene.text(`You open your mouth instinctively, feeling something warm and solid pressing against your lips. You immediately feel it slip inside your mouth, and when you open your eyes you see little more than curly pubic hair. ${((s as any).npcdesc1 || '')}'s friend obviously decided to join you anyway, and put his erect prick in your mouth while you were not paying attention. You try to object, but can't say much with his cock still in your mouth. ${((s as any).npcdesc1 || '')} doesn't seem to mind sharing you anyway, and the guys ignore your muffled groans while they continue to fuck your pussy and your mouth at the same time.`);
    qspCall(s, 'arousal', 'vaginal', 5, ((s as any).npcID1 ?? 0), 'group');
    ...
    scene.text(`You don't have the energy to do much about what the guys did… it's over anyway, what's the point? You sigh and just relax on the mattress for a moment, to regain your focus. Then suddenly ${((s as any).npcdesc1 || '')} gently takes you by the shoulders and lifts you up, putting you down on your knees. Another erect cock is pointing straight at your face… wait, where did that come from? Whose dick is that?`);
    ...
    scene.text(`${((s as any).npcdesc1 || '')} grins at you, interpreting that as a go sign that he and his friend can fuck you any way they want… it's not like you can tell them otherwise. He gently pulls you up and guides you to a nearby empty room, with his friend following the two of you. When they enter the room, his friend quickly locks the door while ${((s as any).npcdesc || '')} helps you get down on your knees. Both the guys drop their trousers, and ${((s as any).npcdesc || '')}'s friend impatiently moves his cock towards your face, spreading his precum on your lips while he waits for you to open your mouth.`);
    scene.actions([
      { label: 'Open your mouth', goto: ['fbDormD', 'd_fbd_threesome'] },
    ]);
  } },
...
function enterDFbdThreesome(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`You part your lips obediently without giving it any thought, knowing what's expected of you in this position. You close your lips around his friend's cock, while ${((s as any).npcdesc1 || '')} takes your hand and rests it on his dick, expecting you to service him as well. You service both the cocks as best as you can, even though you're still not sure who this other guy even is.`);
    ...
    scene.text(`You keep sucking on the cock in front of you, as you figure the guys want you to do. You focus for a moment and realize that ${((s as any).npcdesc1 || '')} is behind you. The dick that's rubbing against your pussy lips is probably his… right? It must be.`);
    qspCall(s, 'dinsex', 'boy_puts_condom');
    qspCall(s, 'dinsex', 'vaginal_sex', 10);
    qspCall(s, 'arousal', 'bj', 5, ((s as any).npcID2 ?? 0), 'group', 'sub');
    ...
    scene.text(`After a while, ${((s as any).npcdesc1 || '')} pulls his cock out of your cunt and lightly caresses your puckered asshole with his fingers.`);
    ...
    scene.text(`You moan around his friend's cock, while ${((s as any).npcdesc1 || '')} keeps caressing your asshole and slowly pushes two fingers in. After a minute or so he decides you're ready, and pulls his hand away.`);
    qspCall(s, 'dinSex', 'boy_wants_anal', '', 'lubri\' & gs \'dinsex', 'analsex');
    qspCall(s, 'arousal', 'bj', 5, ((s as any).npcID2 ?? 0), 'group', 'sub');
    qspCall(s, 'arousal', 'anal_finger', (-5), ((s as any).npcID1 ?? 0), 'group', 'sub');
    qspCall(s, 'stat', '');
    // TODO-QSP: dynamic text: <<$npcdesc1>> then pulls his cock out of your ass, and slides down next to you o...
    scene.text(`${((s as any).npcdesc1 || '')} then pulls his cock out of your ass, and slides down next to you onto the bed. He's on his back, and motions for you to straddle him. You smile and swing your leg over his body, slowly positioning your pussy over his cock.`);
    scene.actions([
    ...
    scene.text(`Teasingly slowly you lower your body, feeling ${((s as any).npcdesc || '')}'s dick sinking further and further into you. You lean forward and kiss him, and suddenly ${((s as any).npcdesc || '')} stops moving his hips. When you try to ask him why, you suddenly feel something warm and hard press against your sphincter. Damn, they're both going to fuck you at the same time!? You were not expecting this…`);
    ...
    scene.text(`After a few minutes the guys are close to cumming, and ${((s as any).npcdesc || '')} hoarsely says he wants to see your face covered in sperm. The guys pull their cocks out of you, and ${((s as any).npcdesc || '')} tells you to get down on your knees in front of them so you can finish them off.`);
    scene.actions([

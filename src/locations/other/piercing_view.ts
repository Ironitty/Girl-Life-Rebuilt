...
function enterViewItem(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).shop_utils_view ?? 0)?.['link'] === 'shop') {
    // TODO-QSP: xgt 'piercing_view', 'view_item_shop'
  }
  return;
  scene.actions([
...
function enterViewItemShop(s: GameState, scene: SceneBuilder): void {
  if (qspFunc(s, 'piercing_management', 'is_owned', qspUntranslated(s, "\u00000\u0000", { location: "piercing_view" }), qspUntranslated(s, "\u00001\u0000", { location: "piercing_view" }))) {
  ...
  if (qspFunc(s, 'piercing_management', 'is_pierced', qspUntranslated(s, "\u00000\u0000", { location: "piercing_view" })) === 0) {
    ...
    if (qspFunc(s, 'money', 'can_afford', qspUntranslated(s, "\u00000\u0000", { location: "piercing_view" })) === 0) {

...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspGoto(st, 'shop_erotomaniac', 'podval');
  } },
    ]);
  } },
    { label: 'Leave', handler: (st: GameState) => {
...
function enterMasha(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'cuni', 10, 'lesbian', 'dom');
    qspCall(st, 'arousal', 'cuni_give', (-10), 'lesbian', 'dom');
    qspCall(st, 'arousal', 'end');
    scene.actions([
      { label: 'Finish', goto: ['masharoom', 'start'] },
    ]);
    ...
    qspCall(st, 'arousal', 'vaginal_finger', 10, 'lesbian', 'dom');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Let continues', handler: (st: GameState) => {
    ...
    (st as any).orgasm_or = 'yes';
    qspCall(st, 'arousal', 'vaginal_dildo', 10, 'lesbian', 'dom');
    qspCall(st, 'arousal', 'end');
    scene.actions([
      { label: 'Finish', goto: ['masharoom', 'start'] },
    ]);
...
function enter1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'clit_finger', 10, 'exhibitionism');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    ...
    (st as any).orgasm_or = 'yes';
    qspCall(st, 'arousal', 'clit_finger', 10, 'exhibitionism', 'masturbate');
    qspCall(st, 'arousal', 'end');
    scene.actions([
      { label: 'Finish', goto: ['masharoom', 'start'] },
    ]);
    ...
    qspCall(st, 'arousal', 'end');
    qspCall(st, 'cum_call', 'mouth', 'Unknown peeper');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Finish', goto: ['masharoom', 'start'] },
    ]);
    ...
    qspCall(st, 'arousal', 'hj', 10, 'dom');
    qspCall(st, 'arousal', 'end');
    qspCall(st, 'cum_call', 'hands', 'Unknown peeper');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Finish', goto: ['masharoom', 'start'] },
    ]);
    ...
    qspCall(st, 'arousal', 'titjob', 10, 'dom');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Further', handler: (st: GameState) => {
    ...
    qspCall(st, 'arousal', 'end');
    qspCall(st, 'cum_call', 'breasts', 'Unknown peeper');
    qspCall(st, 'cum_call', 'face', 'Unknown peeper');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Finish', goto: ['masharoom', 'start'] },
    ]);
...
function enter2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(st, 'arousal', 'anal', 10, 'sub', 'bound', 'rough');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'anal', 10, 'sub', 'bound', 'rough');
    qspCall(st, 'arousal', 'end');
    qspCall(st, 'cum_call', 'anus', 'Unknown dom');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Finish', goto: ['masharoom', 'start'] },
    ]);
    ...
    qspCall(st, 'arousal', 'end');
    qspCall(st, 'cum_call', 'face', 'Unknown dom');
    qspCall(st, 'cum_call', 'mouth_swallow', 'Unknown dom');
    qspCall(st, 'stat', '');
    scene.actions([
      { label: 'Finish', goto: ['masharoom', 'start'] },
    ]);

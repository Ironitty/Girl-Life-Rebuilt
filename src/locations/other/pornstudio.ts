...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).job_hiring_step ?? 0)?.['city_pornstudio_delivery'] === 1  &&  (((s as any).age ?? 0) >= 18  ||  ((s as any).fakepassport ?? 0) === 1)) {
    ...
    ((st as any).job_hiring_step = (st as any).job_hiring_step ?? {})['city_pornstudio_delivery'] = 0;
  ...
  if ((!((s as any).workDolg ?? 0))) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    (st as any).workDisk = 4;
    qspCall(st, 'stat', '');
    if ((!((st as any).konvert ?? 0))) {
      qspCall(st, 'money', 'debt_add', 'workDolg', 200000);
      (st as any).workDolgDay = 7;
      ((st as any).job_termination_reason = (st as any).job_termination_reason ?? {})['city_pornstudio_delivery'] = 'blacklisted';
      ...
      scene.text('You give the envelope to the manager and he gives you ' + qspFunc(s, 'money', 'string_profit', 5000) + '.');
    }
    scene.actions([
      { label: 'Leave', goto: ['city_redlight', 'start'] },
    ]);
  ...
  if (((s as any).pfilmNO ?? 0) === 1  &&  ((s as any).pfilmNoVenera ?? 0) === 1  &&  (!((s as any).Venera ?? 0))) {
    ...
    (st as any).minut = ((st as any).minut ?? 0) + 5;
    (st as any).pfilmNoVenera = 0;
    (st as any).pfilmNO = 0;
    qspCall(st, 'jobs', 'resume_job', 'city_pornstudio_actress');
    qspCall(st, 'stat', '');
...
function enterPa(s: GameState, scene: SceneBuilder): void {
  (s as any).minut = ((s as any).minut ?? 0) + 5;
  (s as any).menu_loc = 'pornstudio';
  (s as any).menu_arg = 'pa';
  qspCall(s, 'stat', '');
  ...
  if ((!((s as any).film ?? 0))) {
    ...
    if (((st as any).porn_fame ?? 0) >= 20) {
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[0] = ((st as any).pornvag ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[0] = 'vaginal';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[1] = ((st as any).pornanal ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[1] = 'anal';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[2] = ((st as any).porngasm ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[2] = 'orgasm';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[3] = ((st as any).porngang ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[3] = 'group sex';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[4] = ((st as any).porncream ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[4] = 'creampie';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[5] = ((st as any).pornhole ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[5] = 'gloryhole';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[6] = ((st as any).pornbdsm ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[6] = 'bdsm';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[7] = ((st as any).pornlesbo ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[7] = 'lesbian';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[8] = ((st as any).pornpreg ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[8] = 'pregnant';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[9] = ((st as any).pornexhib ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[9] = 'public';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[10] = ((st as any).pornmast ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[10] = 'masturbation';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[11] = ((st as any).pornbukk ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[11] = 'cumshot';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[12] = ((st as any).pornbj ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[12] = 'blowjob';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[13] = ((st as any).pornhj ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[13] = 'handjob';
      ((st as any).ftypecount = (st as any).ftypecount ?? {})[14] = ((st as any).pornswall ?? 0);
      ((st as any).ftypecount_text = (st as any).ftypecount_text ?? {})[14] = 'cum swallowing';
      ((st as any).temp = (st as any).temp ?? {})['max0'] = Math.max('ftypecount');
      ((st as any).temp = (st as any).temp ?? {})['pos0'] = qspUntranslated(s, "arrpos('ftypecount', temp['max0'])", { location: "pornstudio" });
      ((st as any).temp = (st as any).temp ?? {})['type0'] = qspUntranslated(s, "ftypecount_text[temp['pos0']]", { location: "pornstudio" });
      (st as any).ftypecount = undefined;
      (st as any).ftypecount_text = undefined;
      ((st as any).temp = (st as any).temp ?? {})['max1'] = Math.max('ftypecount');
      ((st as any).temp = (st as any).temp ?? {})['pos1'] = qspUntranslated(s, "arrpos('ftypecount', temp['max1'])", { location: "pornstudio" });
    ...
    if (((st as any).film ?? 0) < 10  &&  ((st as any).porn_fame ?? 0) < 10) {
    ...
    if (qspFunc(s, 'money', 'can_afford', ((st as any).films_stop_payment ?? 0)) === 0) {
      s.scene = { ...s.scene, mainText: String((st as any).noMoney || ''), curActs: [] };
    } else {
      (st as any).minut = ((st as any).minut ?? 0) + 5;
      qspCall(st, 'money', 'pay', ((st as any).films_stop_payment ?? 0));
      (st as any).pfilmSTOP = 1;
      ((st as any).job_termination_reason = (st as any).job_termination_reason ?? {})['city_pornstudio_actress'] = 'retired';
      qspCall(st, 'jobs', 'set_terminated', 'city_pornstudio_actress');
      (st as any).pfilmday = undefined;
      (st as any).pornplan = undefined;
      (st as any).porntaken = undefined;
...
function enterDelivery(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('"Upon delivery of the envolope, you get ' + qspFunc(s, 'money', 'string_profit', 5000) + '. Deliveries are available every Friday, after the studio has opened. If you agree, then visit any Friday, and choose a safe mode of transport."');
  scene.actions([
...
function enterManager(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pfilmNoVenera ?? 0) === 1) {
      ...
      if (((s as any).pfilmSTOP ?? 0) === 1) {
        ...
        if (((qspFunc(s, 'jobs', 'is_work_time', 'city_pornstudio_actress') === 1  &&  qspFunc(s, 'jobs', 'is_arrival_time', 'city_pornstudio_actress') === 0)  ||  ((s as any).pornmiss ?? 0) === 1)  &&  ((s as any).job_booking_debt ?? 0)?.['city_pornstudio_actress'] <= ((s as any).job_penalty_max_debt ?? 0)?.['city_pornstudio_actress']  &&  (!((s as any).missedshoot ?? 0))) {
          ...
          if (qspFunc(s, 'jobs', 'has_booking_for_day', 'city_pornstudio_actress', ((s as any).daystart ?? 0) + 1) === 0) {
            ...
            ((s as any).porntaken = (s as any).porntaken ?? {})['1,' + String(((s as any).missday ?? 0))] = 0;
    ...
    (st as any).pfilmNO = 1;
    ((st as any).job_termination_reason = (st as any).job_termination_reason ?? {})['city_pornstudio_actress'] = 'quit';
    qspCall(st, 'jobs', 'set_fired', 'city_pornstudio_actress');
    ((st as any).job_booking_debt = (st as any).job_booking_debt ?? {})['city_pornstudio_actress'] = 0;
    ((st as any).job_last_miss_cost = (st as any).job_last_miss_cost ?? {})['city_pornstudio_actress'] = 0;
    (st as any).pfilmday = undefined;
    (st as any).pornplan = undefined;
...
{ label: 'Accept your debt', goto: ['pornstudio', ''] },
          ...
          if (((s as any).job_booking_debt ?? 0)?.['city_pornstudio_actress'] > ((s as any).job_penalty_max_debt ?? 0)?.['city_pornstudio_actress']  &&  ((s as any).pornmiss ?? 0) === 1) {
            ...
            ((s as any).job_booking_debt = (s as any).job_booking_debt ?? {})['city_pornstudio_actress'] = 0;
            ((s as any).job_last_miss_cost = (s as any).job_last_miss_cost ?? {})['city_pornstudio_actress'] = 0;
            (s as any).pfilmday = undefined;
            (s as any).pornplan = undefined;
            (s as any).porntaken = undefined;
...
function enterOptions(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (st as any).ppnum = undefined;
    (st as any).displaynum = undefined;
    (st as any).displaytext = undefined;
    (st as any).displayimage = undefined;
    (st as any).pp1 = undefined;
    (st as any).pp2 = undefined;
    (st as any).pp3 = undefined;
    (st as any).pp4 = undefined;
    (st as any).pp5 = undefined;
    (st as any).displaytag = undefined;
    (st as any).flag_tag = undefined;
    (st as any).selection = undefined;
    (st as any).datefilter = undefined;
    (st as any).selected = undefined;
    (st as any).option = undefined;
    (st as any).tagfilter = undefined;
    (st as any).contracting = undefined;
    (st as any).pcount = undefined;
    (st as any).weekdayfilter = undefined;
    (st as any).weekendfilter = undefined;
    (st as any).weekdayfilter_link = undefined;
    (st as any).weekendfilter_link = undefined;
    qspGoto(st, 'pornstudio', '');
  } },
  ]);
  scene.build();
...
{ label: 'Leave', goto: ['pornstudio', ''] },
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    if (qspFunc(s, 'pcs_has_attr', 'body_ass_bubble')) {
      ...
      if (((st as any).tits ?? 0) >= 4  &&  ((st as any).age ?? 0) < 20) {
    ...
    qspCall(st, 'arousal', 'titjob', (-2), 'exhibitionism');
...
function enterMedical(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (st as any).minut = ((st as any).minut ?? 0) + ((Math.floor(Math.random() * 11) + 25));
    qspCall(st, 'stat', '');
    scene.text('…');
    scene.text('…');
    if (((st as any).Venera ?? 0) > 0) {
      (st as any).pfilmNO = 1;
      (st as any).pfilmNoVenera = 1;
      qspCall(st, 'jobs', 'suspend_job', 'city_pornstudio_actress');
      ((st as any).job_last_miss_cost = (st as any).job_last_miss_cost ?? {})['city_pornstudio_actress'] = 0;
      (st as any).pfilmday = undefined;
    ...
    (st as any).pf = ((st as any).locArgs?.[1] ?? 0);
    qspFunc(s, 'pornfilmdesc', ((st as any).pf ?? 0));
    qspCall(st, 'pornfilm', 'pornactor');
    qspCall(st, 'pornfilm', 'pornactress');
    ...
    qspCall(st, 'jobs', 'clock', 'city_pornstudio_actress');
    qspGoto(st, 'pornfilm', '' + ((st as any).pf ?? 0) + '');
  } },
    ]);
  } },
      ]);
...
function enterPostvideo(s: GameState, scene: SceneBuilder): void {
  while (true) {
    ...
    (s as any).pf = parseFloat(qspFunc(s, 'jobs', 'get_booking_data_for_day', 'city_pornstudio_actress', ((s as any).daystart ?? 0)));
    ((s as any).job_clocked_in = (s as any).job_clocked_in ?? {})['city_pornstudio_actress'] = 0;
  ...
  // LABEL: pv_clear_done
  (s as any).temp_pv_slot = undefined;
  if (((s as any).film ?? 0) < 5) {
    (s as any).fmulti = 25;
  } else {
    if (((s as any).film ?? 0) < 10) {
  ...
  if (((s as any).film ?? 0) === 1) {
    ...
    if (((s as any).pstory ?? 0) === ''  &&  ((s as any).cheatVars ?? 0)?.['rename_porn'] === 1) {
      ((s as any).pornfilmstory = (s as any).pornfilmstory ?? {})[String((s as any).film ?? 0)] = window.prompt("You can enter the story for the film. This action can only be done once, but you can choose to do it later! (Just hit Enter/Esc when blank)<br>Tags of the current movie: <font color=#541717 size=2>" + (((s as any).pfilmtags ?? 0)) + "</font>") ?? '';
    } else {
      ((s as any).pornfilmstory = (s as any).pornfilmstory ?? {})[String((s as any).film ?? 0)] = ((s as any).pstory ?? 0);
    }
    if (((s as any).cheatVars ?? 0)?.['rename_porn'] === 1) {
      ((s as any).porntitle = (s as any).porntitle ?? {})[String((s as any).film ?? 0)] = window.prompt("Enter the name of the film. <i>This action can only be done once, but you can choose to do it later! (Just hit Enter/Esc when blank)</i>") ?? '';
    }
  }
  if ((!((s as any).pfilmNOPAY ?? 0))) {
    ...
    scene.text('Dimitri counts ' + qspFunc(s, 'money', 'string_profit', ((s as any).pfcash ?? '')) + ' out for your film and wishes you good luck.');
  } else {
    (s as any).pfilmNOPAY = 0;
    (s as any).pfcash = 0;
    scene.text('You have fulfilled your obligation and made the film for free.');
    ((s as any).job_worked_count = (s as any).job_worked_count ?? {})['city_pornstudio_actress'] = 0;
  }
  ((s as any).pornfilmYear = (s as any).pornfilmYear ?? {})[String((s as any).film ?? 0)] = ((s as any).year ?? 0);
  ((s as any).pornfilmMonth = (s as any).pornfilmMonth ?? {})[String((s as any).film ?? 0)] = ((s as any).month ?? 0);
  ((s as any).pornfilmDay = (s as any).pornfilmDay ?? {})[String((s as any).film ?? 0)] = ((s as any).day ?? 0);
  ((s as any).porndaystart = (s as any).porndaystart ?? {})[String((s as any).film ?? 0)] = ((s as any).daystart ?? 0);
  ((s as any).pornfilmType = (s as any).pornfilmType ?? {})[String((s as any).film ?? 0)] = ((s as any).pf ?? 0);
  ((s as any).pornfilmCash = (s as any).pornfilmCash ?? {})[String((s as any).film ?? 0)] = ((s as any).pfcash ?? 0);
  ((s as any).pornfilmActAge = (s as any).pornfilmActAge ?? {})[String((s as any).film ?? 0)] = ((s as any).age ?? 0);
  ((s as any).pornfilmAppAge = (s as any).pornfilmAppAge ?? {})[String((s as any).film ?? 0)] = ((s as any).vidage ?? 0);
  ((s as any).pornfilmpregchem = (s as any).pornfilmpregchem ?? {})[String((s as any).film ?? 0)] = ((s as any).pregChem ?? 0);
  ((s as any).pornfilmacting = (s as any).pornfilmacting ?? {})[String((s as any).film ?? 0)] = ((s as any).cumulativeactbonus ?? 0) + ((s as any).orgasmbonus ?? 0) + ((s as any).pcs_intel ?? 0) / 10;
  qspFunc(s, 'pornfilmdesc', ((s as any).pf ?? 0));
  (s as any).orgasmbonus = undefined;
  ...
  ((s as any).pornfilmvnesh = (s as any).pornfilmvnesh ?? {})[String((s as any).film ?? 0)] = ((s as any).pcs_hotcat ?? 0);
  ...
  if (((s as any).pfType ?? 0) !== 0) {
    ...
    if (((s as any).succubusflag ?? 0) === 1) {
      if (((s as any).pfcash ?? 0) > 0) {
        (s as any).tmp = '"I almost can\'t believe they paid me ' + qspFunc(s, 'money', 'string_profit', ((s as any).pfcash ?? 0)) + ' for such a wonderful meal!"';
      } else {
      ...
      if (((s as any).knowpreg ?? 0) === 0  &&  ((s as any).thinkpreg ?? 0) === 0  &&  ((s as any).pillcon2 ?? 0) < 1000) {
        ...
        if ((!((s as any).ppreg ?? 0))) {
          if (((s as any).pfcash ?? 0) > 0) {
            (s as any).tmp = 'Was ' + qspFunc(s, 'money', 'string_profit', ((s as any).pfcash ?? 0)) + ' worth the risk of getting impregnated by a seedy porn actor you\'ll probably never see again?';
          } else {
          ...
          if (((s as any).pfcash ?? 0) > 0) {
            ...
            (s as any).tmp = 'The fact that you weren\'t even paid to take this risk excites you more than you\'d like to admit.';
          }
  ...
  if (((s as any).pfactor ?? 0) === 50) {
    ((s as any).pornfilmActor = (s as any).pornfilmActor ?? {})[String((s as any).film ?? 0)] = 'Fifty fans of';
  } else {
    ((s as any).pornfilmActor = (s as any).pornfilmActor ?? {})[String((s as any).film ?? 0)] = '';
    (s as any).pact = ((s as any).pfactor ?? 0);
    do {
      if (((s as any).pact ?? 0) > 1) {
        ((s as any).pornfilmActor = (s as any).pornfilmActor ?? {})[String((s as any).film ?? 0)] = ((s as any).pornfilmActor[String((s as any).film ?? 0)] ?? 0) + ((((s as any).pactor ?? 0)?.[String((s as any).pact ?? 0)] ?? 0) + ', ');
      } else {
        ((s as any).pornfilmActor = (s as any).pornfilmActor ?? {})[String((s as any).film ?? 0)] = ((s as any).pornfilmActor[String((s as any).film ?? 0)] ?? 0) + ((((s as any).pactor ?? 0)?.[String((s as any).pact ?? 0)] ?? 0));
      }
      (s as any).pact = ((s as any).pact ?? 0) - (1);
    } while (((s as any).pact ?? 0) > 0);
  }
  if (((s as any).film ?? 0) < 10) {

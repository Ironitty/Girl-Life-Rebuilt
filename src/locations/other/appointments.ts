...
function enterStateFromEvent(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_apptState = undefined;
  return;
  scene.build();
}
  ...
  while (true) {
    ...
    while (true) {
      if (((s as any).temp_apptOffer ?? 0)?.['i'] < String((s as any).locArgs?.[1] ?? '')) {
        ((s as any).appointment_offer_day = (s as any).appointment_offer_day ?? {})[(((s as any).temp_apptOffer ?? 0)?.['i'])] = (-1);
      ...
      (s as any).temp_apptOffer = undefined;
  ...
  while (true) {
    if (((s as any).temp_apptTry ?? 0)?.['done'] === 0  &&  ((s as any).temp_apptTry ?? 0)?.['attempt'] < 3) {
      ...
      if (qspFunc(s, 'appointments', 'check_conflict', ((s as any).temp_apptTry ?? 0)?.['daystart'], ((s as any).temp_apptTry ?? 0)?.['end']) === 0) {
        ((s as any).appointment_offer_day = (s as any).appointment_offer_day ?? {})[(((s as any).temp_apptOffer ?? 0)?.['found'])] = (((s as any).temp_apptTry ?? 0)?.['daystart']);
        ((s as any).appointment_offer_window_end = (s as any).appointment_offer_window_end ?? {})[(((s as any).temp_apptOffer ?? 0)?.['found'])] = (((s as any).temp_apptTry ?? 0)?.['end']);
    ...
    (s as any).temp_apptTry = undefined;
    return;
  }
  scene.build();
}
  ...
  while (true) {
    if (((s as any).temp_apptDesc ?? 0)?.['i'] < ((s as any).appointment_offer_count ?? 0)) {
      if (((s as any).appointment_offer_day ?? 0)[((s as any).temp_apptDesc ?? 0)?.['i']] >= 0) {
        ...
        ((s as any).appointment_offer_desc = (s as any).appointment_offer_desc ?? {})[(((s as any).temp_apptDesc ?? 0)?.['i'])] = '' + (((s as any).temp_apptDesc ?? 0)?.['day']) + ' from ' + (((s as any).temp_apptDesc ?? 0)?.['h1']) + ' till ' + (((s as any).temp_apptDesc ?? 0)?.['h2']) + '';
        ...
        if (((s as any).temp_apptDesc ?? 0)?.['note'] !== '') {
          ((s as any).appointment_offer_desc = (s as any).appointment_offer_desc ?? {})[(((s as any).temp_apptDesc ?? 0)?.['i'])] = '' + qspUntranslated(s, "appointment_offer_desc[temp_apptDesc['i']]", { location: "appointments" }) + ' ' + (((s as any).temp_apptDesc ?? 0)?.['note']) + '';
        }
      }
      ((s as any).temp_apptDesc = (s as any).temp_apptDesc ?? {})['i'] = ((s as any).temp_apptDesc['i'] ?? 0) + (1);
      break;
    }
    (s as any).temp_apptDesc = undefined;
    return;
  }
  scene.build();
}
...
function enterBook(s: GameState, scene: SceneBuilder): void {
  ...
  if ((Array.isArray((s as any).appointment_categories) ? ((s as any).appointment_categories as any[]).indexOf(String((s as any).locArgs?.[1] ?? '')) : -1) === -1) {
    (s as any).appointment_categories = [...((s as any).appointment_categories ?? []), ((s as any).locArgs?.[1] ?? 0)];
  }
  ((s as any).appointment_active = (s as any).appointment_active ?? {})[((s as any).locArgs?.[1] ?? 0)] = (((s as any).event_vars ?? 0)?.['id']);
  ((s as any).appointment_late_limit = (s as any).appointment_late_limit ?? {})[((s as any).locArgs?.[1] ?? 0)] = ((s as any).appointment_offer_late_limit ?? 0);
  (s as any).result = 1;
  (s as any).event_vars = undefined;
  return;
  scene.build();
...
function enterResolve(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).appointment_active = (s as any).appointment_active ?? {})[((s as any).locArgs?.[1] ?? 0)] = '';
  ((s as any).appointment_late_limit = (s as any).appointment_late_limit ?? {})[((s as any).locArgs?.[1] ?? 0)] = 0;
  return;
  scene.build();
}
...
function enterDailyCheck(s: GameState, scene: SceneBuilder): void {
  ...
  while (true) {
    ...
    (s as any).temp_apptDaily = undefined;
    return;
  }
  scene.build();
}
...
function enterCheckIn(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_apptCheckin ?? 0)?.['state'] !== 'late') {
    ...
    (s as any).temp_apptCheckin = undefined;
    return;
  }
  if (String((s as any).locArgs?.[2] ?? '') !== '') {
    (s as any).result = 'ok';
...
function enterRenderActs(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_apptRender ?? 0)?.['state'] === 'none') {
    ...
    (st as any).appt_pending_loc = undefined;
    (st as any).appt_pending_none_func = undefined;
    (st as any).appt_pending_func = undefined;
    (st as any).appt_pending_category = undefined;
    (st as any).appt_pending_wait = undefined;
    (st as any).appt_pending_recur = undefined;
  } },
        ]);
      }
      scene.actions([

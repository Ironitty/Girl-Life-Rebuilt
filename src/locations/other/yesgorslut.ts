...
function enter(s: GameState, scene: SceneBuilder): void {
  if (((s as any).fame ?? 0)?.['pav_slut'] >= 250) {
    if (((s as any).npc_grupTipe ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] === 5) {
      (s as any).bonusotnG = ((s as any).pcs_apprnc ?? 0) / 8;
      if (((s as any).bonusotnG ?? 0) <= 0) {
        (s as any).bonusotnG = 1;
      }
      qspCall(s, 'npc_relationship', 'modify_exact', 'A<<numnpc>>', ((s as any).bonusotnG ?? 0));
      ...
      if (((s as any).npc_gender ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] === 0) {
      ...
      if (((s as any).npc_grupTipe ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] === 3) {
        if (((s as any).npc_gender ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] === 0) {
          // TODO-QSP: dynamic text: You're doing your best to engage in conversation with the guy, but <<$npc_firstn...
        ...
        if (((s as any).npc_grupTipe ?? 0)?.['A' + String(((s as any).numnpc ?? 0))] === 1) {

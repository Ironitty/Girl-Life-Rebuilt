  ...
  scene.actions([
    ...
    do {
      ...
      if (((st as any).martinpos ?? 0) === 'cowgirl'  ||  ((st as any).martinpos ?? 0) === 'rev_cowgirl') {
        ...
        (st as any).orgasm_txt = 'Your sense of ' + ((((st as any).dominance ?? 0) > 20) ? ('control over') : ('submission to')) + ' Martin and the intense feeling of him moving inside your ' + (((st as any).pc_desc ?? 0)?.['pussy']) + ' pussy drive you ever closer to the edge until you can no longer take it. You cum loudly, shivering all over, your pussy massaging Martin\'s cock with its contractions as if it wanted to squeeze the cum out of him. The orgasm lasts for what feels like an eternity, but when it has passed' + ((((st as any).martinpos ?? 0) === 'rev_cowgirl') ? (' and you look back at him') : ('')) + ', Martin gives you a smug, self-satisfied look that makes you chuckle. You\'re not done with each other yet, though, and before long, you\'ve resumed your fast, hard rhythm.';

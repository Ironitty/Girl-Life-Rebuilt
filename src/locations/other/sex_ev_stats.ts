...
function enterNpcUpdate(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_usedname ?? 0)?.[String((s as any).npcID ?? 0)] === '') {
    if (!(s as any).npc_usedname) (s as any).npc_usedname = {}; (s as any).npc_usedname[String((s as any).npcID ?? 0)] = ((s as any).npc_firstname ?? 0)?.[String((s as any).npcID ?? 0)];
  }
...
function enterStartingStats(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['starting_makeup'] = ((s as any).pcs_makeup ?? 0);
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_vagina'] = ((s as any).cum_loc ?? 0)?.['vagina'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_labia'] = ((s as any).cum_loc ?? 0)?.['labia'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_panty_front'] = ((s as any).cum_loc ?? 0)?.['panty_front'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_anus'] = ((s as any).cum_loc ?? 0)?.['anus'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_butt'] = ((s as any).cum_loc ?? 0)?.['butt'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_panty_back'] = ((s as any).cum_loc ?? 0)?.['panty_back'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_clothes_groin'] = ((s as any).cum_loc ?? 0)?.['clothes_groin'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_clothes'] = ((s as any).cum_loc ?? 0)?.['clothes'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_back'] = ((s as any).cum_loc ?? 0)?.['back'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_legs '] = ((s as any).cum_loc ?? 0)?.['legs '];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_arms'] = ((s as any).cum_loc ?? 0)?.['arms'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_face'] = ((s as any).cum_loc ?? 0)?.['face'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_mouth'] = ((s as any).cum_loc ?? 0)?.['mouth'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_hands'] = ((s as any).cum_loc ?? 0)?.['hands'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_stomach'] = ((s as any).cum_loc ?? 0)?.['stomach'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_tits'] = ((s as any).cum_loc ?? 0)?.['tits'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_hair'] = ((s as any).cum_loc ?? 0)?.['hair'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['starting_sweat'] = ((s as any).pcs_sweat ?? 0);
  if ((!((s as any).orgasm ?? 0))) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['never_orgasmed'] = 1;
  }
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['orgasm'] = ((s as any).orgasm ?? 0);
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['orgasm_limit'] = ((s as any).orgasm ?? 0) + 6;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pc_condom_count'] = ((s as any).mc_inventory ?? 0)?.['normal_condoms'];
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['start_time'] = ((s as any).totminut ?? 0);
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['start_hour'] = ((s as any).hour ?? 0);
...
function enterSexEndStats(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['finish_time'] = ((s as any).totminut ?? 0);
  // TODO-QSP: $npc_last_sex_enjoyment[$npcID] = $sex_ev['fuck_enjoyment']
  if (!(s as any).npc_last_orgasm_count) (s as any).npc_last_orgasm_count = {}; (s as any).npc_last_orgasm_count[String((s as any).npcID ?? 0)] = ((s as any).sex_ev ?? 0)?.['orgasm_count'];
...
function enterStartingMood(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'reluctant') {
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 'consensual') {
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['starting_mood'] = 'consensual';
    } else {
...
function enterSaveStats(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['loc'] === 'pc_home') {
    if (((s as any).sex_ev ?? 0)?.['bed_choice'] !== 'anya_bed') {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['bed_cum'] = ((s as any).totminut ?? 0);
      // TODO-QSP: $cum_sheets[] = $npcID
    } else {
      if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['anya_bed_cum'] = ((s as any).daystart ?? 0);
    }
  }
  ...
  if (((s as any).sex_ev ?? 0)?.['sleep_fuck'] > 0) {
    if (!(s as any).npc_sleep_fuck) (s as any).npc_sleep_fuck = {}; (s as any).npc_sleep_fuck[String((s as any).npcID ?? 0)] = ((s as any).npc_sleep_fuck[String((s as any).npcID ?? 0)] ?? 0) + (1);
  }
  if (!(s as any).npc_bareback_times) (s as any).npc_bareback_times = {}; (s as any).npc_bareback_times[String((s as any).npcID ?? 0)] = ((s as any).npc_bareback_times[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['no_condom']);
  if (!(s as any).npc_condom_times) (s as any).npc_condom_times = {}; (s as any).npc_condom_times[String((s as any).npcID ?? 0)] = ((s as any).npc_condom_times[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['condom']);
  if (!(s as any).npc_kuni_times) (s as any).npc_kuni_times = {}; (s as any).npc_kuni_times[String((s as any).npcID ?? 0)] = ((s as any).npc_kuni_times[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['kuni']);
  if (!(s as any).npc_cum_count) (s as any).npc_cum_count = {}; (s as any).npc_cum_count[String((s as any).npcID ?? 0)] = ((s as any).npc_cum_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['cum_count']);
  if (!(s as any).npc_orgasm_count) (s as any).npc_orgasm_count = {}; (s as any).npc_orgasm_count[String((s as any).npcID ?? 0)] = ((s as any).npc_orgasm_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['orgasm_count']);
  if (!(s as any).npc_fake_orgasm_count) (s as any).npc_fake_orgasm_count = {}; (s as any).npc_fake_orgasm_count[String((s as any).npcID ?? 0)] = ((s as any).npc_fake_orgasm_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['fake_orgasm_count']);
  if (!(s as any).npc_creampie_count) (s as any).npc_creampie_count = {}; (s as any).npc_creampie_count[String((s as any).npcID ?? 0)] = ((s as any).npc_creampie_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['creampie_count']);
  if (!(s as any).npc_accidental_creampie_count) (s as any).npc_accidental_creampie_count = {}; (s as any).npc_accidental_creampie_count[String((s as any).npcID ?? 0)] = ((s as any).npc_accidental_creampie_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['accidental_creampie_count']);
  if (!(s as any).npc_cum_together_count) (s as any).npc_cum_together_count = {}; (s as any).npc_cum_together_count[String((s as any).npcID ?? 0)] = ((s as any).npc_cum_together_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['creampie_orgasm']);
  if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['simultaneous_orgasm_count'] = ((s as any).stat['simultaneous_orgasm_count'] ?? 0) + (((s as any).sex_ev ?? 0)?.['simultaneous_orgasm_count']);
  if (!(s as any).npc_facial_count) (s as any).npc_facial_count = {}; (s as any).npc_facial_count[String((s as any).npcID ?? 0)] = ((s as any).npc_facial_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['facial_count']);
  if (!(s as any).npc_cum_tits_count) (s as any).npc_cum_tits_count = {}; (s as any).npc_cum_tits_count[String((s as any).npcID ?? 0)] = ((s as any).npc_cum_tits_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['cum_tits']);
  if (!(s as any).npc_pullout_count) (s as any).npc_pullout_count = {}; (s as any).npc_pullout_count[String((s as any).npcID ?? 0)] = ((s as any).npc_pullout_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['pullout_count']);
  if (!(s as any).npc_mouth_cum_count) (s as any).npc_mouth_cum_count = {}; (s as any).npc_mouth_cum_count[String((s as any).npcID ?? 0)] = ((s as any).npc_mouth_cum_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['mouth_cum_count']);
  if (!(s as any).npc_cum_hand_count) (s as any).npc_cum_hand_count = {}; (s as any).npc_cum_hand_count[String((s as any).npcID ?? 0)] = ((s as any).npc_cum_hand_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['cum_hand']);
  if (!(s as any).npc_swallow_count) (s as any).npc_swallow_count = {}; (s as any).npc_swallow_count[String((s as any).npcID ?? 0)] = ((s as any).npc_swallow_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['swallow_count']);
  if (!(s as any).npc_spit_count) (s as any).npc_spit_count = {}; (s as any).npc_spit_count[String((s as any).npcID ?? 0)] = ((s as any).npc_spit_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['spit_count']);
  if (!(s as any).npc_shower_sex_count) (s as any).npc_shower_sex_count = {}; (s as any).npc_shower_sex_count[String((s as any).npcID ?? 0)] = ((s as any).npc_shower_sex_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['shower_sex']);
  if (!(s as any).npc_mouth_cum_count) (s as any).npc_mouth_cum_count = {}; (s as any).npc_mouth_cum_count[String((s as any).npcID ?? 0)] = ((s as any).npc_mouth_cum_count[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['mouth_cum_count']);
  if (!(s as any).npc_virgin_deny) (s as any).npc_virgin_deny = {}; (s as any).npc_virgin_deny[String((s as any).npcID ?? 0)] = ((s as any).npc_virgin_deny[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['virgin_deny']);
  if (!(s as any).npc_virgin_rapist) (s as any).npc_virgin_rapist = {}; (s as any).npc_virgin_rapist[String((s as any).npcID ?? 0)] = ((s as any).npc_virgin_rapist[String((s as any).npcID ?? 0)] ?? 0) + (((s as any).sex_ev ?? 0)?.['virgin_rape']);
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 14  &&  ((s as any).week ?? 0) < 6  &&  ((s as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((s as any).gschoolVars ?? 0)?.['school_diploma'] === 0  &&  ((s as any).kanikuli ?? 0) === 0  &&  ((s as any).gschoolVars ?? 0)?.['last_absence'] !== ((s as any).daystart ?? 0)) {
    if (!(s as any).npc_school_absences) (s as any).npc_school_absences = {}; (s as any).npc_school_absences[String((s as any).npcID ?? 0)] = ((s as any).gschoolVars ?? 0)?.['absence_count'];
  }
  if (((s as any).sex_ev ?? 0)?.['pullout_game'] === 1  &&  ((s as any).sex_ev ?? 0)?.['no_condom'] === 1  &&  ((s as any).sex_ev ?? 0)?.['creampie_count'] === 0) {
    if (!(s as any).npc_no_creampie_mistakes) (s as any).npc_no_creampie_mistakes = {}; (s as any).npc_no_creampie_mistakes[String((s as any).npcID ?? 0)] = ((s as any).npc_no_creampie_mistakes[String((s as any).npcID ?? 0)] ?? 0) + (1);
    if (!(s as any).npc_no_creampie_mistakes_last_time) (s as any).npc_no_creampie_mistakes_last_time = {}; (s as any).npc_no_creampie_mistakes_last_time[String((s as any).npcID ?? 0)] = 1;
    if (!(s as any).npc_pullout_failure_last_time) (s as any).npc_pullout_failure_last_time = {}; (s as any).npc_pullout_failure_last_time[String((s as any).npcID ?? 0)] = 0;
  } else {
    if (((s as any).sex_ev ?? 0)?.['pullout_game'] === 1  &&  ((s as any).sex_ev ?? 0)?.['no_condom'] === 1  &&  ((s as any).sex_ev ?? 0)?.['creampie_count'] > 0  &&  ((s as any).sex_ev ?? 0)?.['broken_condom'] === 0) {
      if (!(s as any).npc_pullout_failure) (s as any).npc_pullout_failure = {}; (s as any).npc_pullout_failure[String((s as any).npcID ?? 0)] = ((s as any).npc_pullout_failure[String((s as any).npcID ?? 0)] ?? 0) + (1);
      if (!(s as any).npc_pullout_failure_last_time) (s as any).npc_pullout_failure_last_time = {}; (s as any).npc_pullout_failure_last_time[String((s as any).npcID ?? 0)] = 1;
      if (!(s as any).npc_no_creampie_mistakes_last_time) (s as any).npc_no_creampie_mistakes_last_time = {}; (s as any).npc_no_creampie_mistakes_last_time[String((s as any).npcID ?? 0)] = 0;
    }
  }
  if (((s as any).sex_ev ?? 0)?.['prostitution_freebie'] === 1) {
    if (!(s as any).stat) (s as any).stat = {}; (s as any).stat['prostitution_freebies'] = ((s as any).stat['prostitution_freebies'] ?? 0) + (1);
  } else {
    if (((s as any).sex_ev ?? 0)?.['prostitution_flag'] !== ''  &&  ((s as any).npc_rel_type ?? 0) !== 'sugar_daddy') {
      if (!(s as any).npc_prost_count) (s as any).npc_prost_count = {}; (s as any).npc_prost_count[String((s as any).npcID ?? 0)] = ((s as any).npc_prost_count[String((s as any).npcID ?? 0)] ?? 0) + (1);
    }
  }
  if (((s as any).sex_ev ?? 0)?.['phone_film'] === 2  ||  (((s as any).sex_ev ?? 0)?.['phone_film'] === 1  &&  ((s as any).npc_abusive ?? 0)?.[String((s as any).npcID ?? 0)] > 0)) {
    if (!(s as any).npc_sex_video_count) (s as any).npc_sex_video_count = {}; (s as any).npc_sex_video_count[String((s as any).npcID ?? 0)] = ((s as any).npc_sex_video_count[String((s as any).npcID ?? 0)] ?? 0) + (1);
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterBirthControlKnow(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['bc_tell'] = 1;
  if (((s as any).npc_pay_for_ma_pill ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {
    if (!(s as any).npc_pay_for_ma_pill) (s as any).npc_pay_for_ma_pill = {}; (s as any).npc_pay_for_ma_pill[String((s as any).npcID ?? 0)] = (-1);
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterNoBirthControlKnow(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).npc_know_not_bc) (s as any).npc_know_not_bc = {}; (s as any).npc_know_not_bc[String((s as any).npcID ?? 0)] = 1;
...
function enterBarebackRiskActive(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).npc_bareback_risk) (s as any).npc_bareback_risk = {}; (s as any).npc_bareback_risk[String((s as any).npcID ?? 0)] = 1;
  // TODO-QSP: end
  scene.build();
}

function enterBarebackRiskDeactive(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).npc_bareback_risk) (s as any).npc_bareback_risk = {}; (s as any).npc_bareback_risk[String((s as any).npcID ?? 0)] = 0;
  // TODO-QSP: end
  scene.build();
}

function enterProstitutionInit(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['prostitution_flag'] = 'prostitution';
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['prostitution'] = 1;
...
function enterProstitutionPayCode(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_rel_type ?? 0)?.[String((s as any).npcID ?? 0)] === 'sugar_daddy'  &&  ((s as any).sex_ev ?? 0)?.['sugar_daddy_paid'] === 0) {
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['prostitution_paid'] = ((s as any).sex_ev['prostitution_paid'] ?? 0) + (((s as any).sex_ev ?? 0)?.['prostitution_owed']);
  ...
  if (((s as any).npc_prostitution_tab ?? 0)?.[String((s as any).npcID ?? 0)] > 0) {
    if (!(s as any).npc_prostitution_tab) (s as any).npc_prostitution_tab = {}; (s as any).npc_prostitution_tab[String((s as any).npcID ?? 0)] = 0;
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterSingleKnow(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).npc_know_have_boyfriend) (s as any).npc_know_have_boyfriend = {}; (s as any).npc_know_have_boyfriend[String((s as any).npcID ?? 0)] = 0;
  if (!(s as any).npc_know_have_girlfriend) (s as any).npc_know_have_girlfriend = {}; (s as any).npc_know_have_girlfriend[String((s as any).npcID ?? 0)] = 0;
  // TODO-QSP: end
  scene.build();
}
...
function enterDatingGirlKnow(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).npc_know_have_girlfriend) (s as any).npc_know_have_girlfriend = {}; (s as any).npc_know_have_girlfriend[String((s as any).npcID ?? 0)] = 1;
  // TODO-QSP: end
  scene.build();
}

function enterNpcIsSingle(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).know_npc_girlfriend) (s as any).know_npc_girlfriend = {}; (s as any).know_npc_girlfriend[String((s as any).npcID ?? 0)] = 0;
  if (!(s as any).know_npc_single) (s as any).know_npc_single = {}; (s as any).know_npc_single[String((s as any).npcID ?? 0)] = 1;
  // TODO-QSP: end
  scene.build();
}

function enterNpcIsDating(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).know_npc_girlfriend) (s as any).know_npc_girlfriend = {}; (s as any).know_npc_girlfriend[String((s as any).npcID ?? 0)] = 1;
  if (!(s as any).know_npc_single) (s as any).know_npc_single = {}; (s as any).know_npc_single[String((s as any).npcID ?? 0)] = 0;
  // TODO-QSP: end
  scene.build();
}

function enterNpcIsMarried(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).know_npc_wife) (s as any).know_npc_wife = {}; (s as any).know_npc_wife[String((s as any).npcID ?? 0)] = 1;
  if (!(s as any).know_npc_single) (s as any).know_npc_single = {}; (s as any).know_npc_single[String((s as any).npcID ?? 0)] = 0;
  // TODO-QSP: end
  scene.build();
}
...
function enterPcCondomStats(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pc_condoms_used'] = ((s as any).sex_ev['pc_condoms_used'] ?? 0) + (1);
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['must_fuck'] = 1;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['condom_check'] = 1;
...
function enterNpcCondomStats(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['condoms_used'] = ((s as any).sex_ev['condoms_used'] ?? 0) + (1);
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['must_fuck'] = 1;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['condom'] = 1;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['condom_check'] = 1;
...
function enterRestrictFunc(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 'creampie') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['creampie_restrict'] = 1;
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterPositionTracker(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['position'] = ((s as any).locArgs?.[1] ?? 0);
  if (((s as any).sex_ev ?? 0)[((s as any).locArgs?.[1] ?? 0) + '_fuck'] === 0) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['' + String((s as any).$ARGS[1] || '') + '_fuck'] = 1;
  }
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['speed'] = qspUntranslated(s, "ARGS[2]", { location: "sex_ev_stats" });
  // TODO-QSP: $sex_ev['pos_speed'] = '<<$ARGS[1]>><<ARGS[2]>>'
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['kiss'] = ((((s as any).locArgs?.[3] ?? 0) === 'kiss') ? (1) : (0));
  // TODO-QSP: end
  scene.build();
}
...
function enterCumFacial(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_face'] = ((s as any).sex_ev['cum_face'] ?? 0) + (1);
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'pc_jerk') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pc_facial_jerk'] = ((s as any).sex_ev['pc_facial_jerk'] ?? 0) + (1);
  }
  // TODO-QSP: end
  scene.build();
}
...
function enterCumMouth(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_mouth'] = ((s as any).sex_ev['cum_mouth'] ?? 0) + (1);
  if (((s as any).locArgs?.[1] ?? 0) === 'swallow') {
    ...
    if (((s as any).locArgs?.[2] ?? 0) === 'spit') {
      ...
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['spit_count'] = ((s as any).sex_ev['spit_count'] ?? 0) + (1);
    }
  }
  // TODO-QSP: end
  scene.build();
...
function enterCumSwallow(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['last_cum'] === 'face_mouth') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['facial_swallow'] = ((s as any).sex_ev['facial_swallow'] ?? 0) + (1);
  }
  if (((s as any).locArgs?.[1] ?? 0) === 'disgust') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['hide_swallow_disgust'] = 1;
  }
...
function enterCumTits(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'pc_jerk') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['pc_titcum_jerk'] = 1;
  } else {
...
function enterCreampieCode(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['total_creampies'] === 0) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['first_creampie'] = 1;
  }
  ...
  if (((s as any).sex_ev ?? 0)?.['creampie_surprise'] === 1) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['surprise_creampie_count'] = ((s as any).sex_ev['surprise_creampie_count'] ?? 0) + (1);
  }
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['cum_pussy'] = ((s as any).sex_ev['cum_pussy'] ?? 0) + (1);
  ...
  if (((s as any).birth_control ?? 0)?.['think_safe'] === 0) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['unsafe_creampie'] = ((s as any).sex_ev['unsafe_creampie'] ?? 0) + (1);
  ...
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['last_cum'] = 'creampie';
...
function enterAnalCreampieCode(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['anal_creampie_surprise'] === 1) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['anal_surprise_creampie_count'] = ((s as any).sex_ev['anal_surprise_creampie_count'] ?? 0) + (1);
  }
...
function enterSugarDaddyHaggleLimit(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = 25;
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = ((s as any).sex_ev['haggle_limit'] ?? 0) + ((((s as any).pcs_hotcat ?? 0) - 5) * 2);
  ...
  if (((s as any).ngpPrefResult ?? 0)?.['HasPos'] !== '') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = ((s as any).sex_ev['haggle_limit'] ?? 0) + (Math.floor(Math.random() * 4) + 2);
  }
  if (((s as any).ngpPrefResult ?? 0)?.['HasNeg'] !== '') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = ((s as any).sex_ev['haggle_limit'] ?? 0) - (Math.floor(Math.random() * 4) + 3);
  }
  qspCall(s, 'npc_get_preference', '', ((s as any).npcID ?? 0), 'randomPosIndNeg', 'clothes_quality', 'clothes_cleavage', 'shoes_heels');
  if (((s as any).ngpPrefResult ?? 0)?.['HasPos'] !== '') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = ((s as any).sex_ev['haggle_limit'] ?? 0) + (Math.floor(Math.random() * 3) + 1);
  }
  if (((s as any).ngpPrefResult ?? 0)?.['HasNeg'] !== '') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = ((s as any).sex_ev['haggle_limit'] ?? 0) - (Math.floor(Math.random() * 3) + 2);
  }
  ...
  if (((s as any).ngpPrefResult ?? 0)?.['HasPos'] !== '') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = ((s as any).sex_ev['haggle_limit'] ?? 0) + (Math.floor(Math.random() * 2) + 1);
  }
  if (((s as any).ngpPrefResult ?? 0)?.['HasNeg'] !== '') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = ((s as any).sex_ev['haggle_limit'] ?? 0) - (Math.floor(Math.random() * 2) + 1);
  }
  ...
  if (((s as any).sex_ev ?? 0)?.['haggle_limit'] < 10) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = 10;
  }
  if (((s as any).sex_ev ?? 0)?.['haggle_limit'] > 50) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = 50;
  }

...
function enterDogItems(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).home ?? 0)?.['current'] === 'parents_home') {
    ...
    scene.text(`The store sells dog food for 600₽. Inside each pack is enough food for 20 meals. You have ${((s as any).objects ?? 0)?.['dog_food'] ?? ''}.`);
    scene.actions([
    ...
    if (qspFunc(s, 'money', 'can_afford', 600) === 0) {
      ...
      ((s as any).objects = (s as any).objects ?? {})['dog_food'] = ((s as any).objects['dog_food'] ?? 0) + (20);
      qspGoto(s, 'shop', 'dog_items');
    }
  } },
    ...
    if (qspFunc(s, 'money', 'can_afford', 1200) === 0) {
      ...
      ((s as any).objects = (s as any).objects ?? {})['dog_food'] = ((s as any).objects['dog_food'] ?? 0) + (40);
      qspGoto(s, 'shop', 'dog_items');
    }
  } },
    ...
    if (qspFunc(s, 'money', 'can_afford', 2400) === 0) {
      ...
      ((s as any).objects = (s as any).objects ?? {})['dog_food'] = ((s as any).objects['dog_food'] ?? 0) + (80);
      qspGoto(s, 'shop', 'dog_items');
    }
  } },
    ]);
  ...
  if (((s as any).objects ?? 0)?.['toys'] === 0) {
    ...
    if (qspFunc(s, 'money', 'can_afford', 900) === 0) {
      ...
      ((s as any).objects = (s as any).objects ?? {})['toys'] = 1;
      qspGoto(s, 'shop', 'dog_items');
    }
  } },
    ]);
  ...
  scene.actions([
    ...
    scene.text(`The store sells dog treats for 300₽. Inside each pack are 20 treats. You have ${((s as any).objects ?? 0)?.['treats'] ?? ''}.`);
    scene.actions([
      { label: 'Go back', goto: ['shop', 'dog_items'] },
    ...
    if (qspFunc(s, 'money', 'can_afford', 300) === 0) {
      ...
      ((s as any).objects = (s as any).objects ?? {})['treats'] = ((s as any).objects['treats'] ?? 0) + (20);
      qspGoto(s, 'shop', 'dog_items');
    }
  } },
    ]);
    ...
    if (qspFunc(s, 'money', 'can_afford', 800) === 0) {
      ...
      ((s as any).objects = (s as any).objects ?? {})['chew'] = ((s as any).objects['chew'] ?? 0) + (10);
      qspGoto(s, 'shop', 'dog_items');
    }
  } },
    ]);
...
function enterClothing(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).mc_inventory ?? 0)?.['ice_skates'] !== 1) {
    ...
    if (qspFunc(s, 'money', 'can_afford', 3000) === 0) {
      ...
      ((s as any).mc_inventory = (s as any).mc_inventory ?? {})['ice_skates'] = 1;
  ...
  if (((s as any).mc_inventory ?? 0)?.['ski'] !== 1) {
    ...
    if (qspFunc(s, 'money', 'can_afford', 4000) === 0) {
      ...
      ((s as any).mc_inventory = (s as any).mc_inventory ?? {})['ski'] = 1;

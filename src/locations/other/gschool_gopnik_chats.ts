        ...
        if (((s as any).npc_rel ?? 0)?.['A154'] >= 50) {
          if (((s as any).pcs_hotcat ?? 0) >= 6) {
            ...
            if (((s as any).npc_rel ?? 0)?.['A154'] >= 50  &&  ((s as any).radomirQW ?? 0)?.['first_visit'] === 0) {
              ...
              scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}, you should come over to my place today and hang out. What do you say?"`);
              scene.actions([
...
function enterValentin(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).grupTipe ?? 0) === 4  &&  ((s as any).gopnik_slut ?? 0) === 1) {
    ...
    scene.text(`He smiles as you approach. "What's up, ${((s as any).pcs_nickname ?? 0)}?"`);
    ...
    if (((s as any).fame ?? 0)?.['pav_slut'] > 300) {
      ...
      if (((s as any).grupTipe ?? 0) === 1) {
        if (((s as any).npc_rel ?? 0)?.['A158'] >= 50) {
          ...
          scene.text(`Valentin calls out to you as you approach. "Hey ${((s as any).pcs_nickname ?? 0)}, coming over to slum it with us or did you realize you miss good music and some good fun?"`);
    ...
    scene.text(`Valentin gives you a big smile. "Sure thing, ${((s as any).pcs_nickname ?? 0)}. I'll send you a text as soon as I've finished repairing her and I'll take you on a ride."`);
    scene.actions([
      { label: 'Time for the next class', goto: ['gschool_lessons', 'short_break'] },
    ]);
  } },
          ...
          if (((s as any).npc_rel ?? 0)?.['A158'] <= 20) {
            ...
            scene.text(`He gives you a slight chin up greeting. "Hey ${((s as any).pcs_nickname ?? 0)}. What do you need?"`);
            scene.text('"I just wanted to talk is all," you reply.');
        ...
        if (((s as any).grupTipe ?? 0) === 2) {
          if (((s as any).npc_rel ?? 0)?.['A158'] >= 50) {
            ...
            scene.text(`Valentin calls out to you as you approach. "Hey ${((s as any).pcs_nickname ?? 0)}."`);
      ...
      { label: 'Time for the next class', goto: ['gschool_lessons', 'short_break'] },
          ...
          if (((s as any).grupTipe ?? 0) === 3) {
            if (((s as any).npc_rel ?? 0)?.['A158'] >= 60) {
              ...
              scene.text(`Valentin calls out to you as you approach. "Hey ${((s as any).pcs_nickname ?? 0)}, get lost? Or just wanting to take a peek at the wild side?"`);
    ...
    scene.actions([
      { label: 'Time for the next class', goto: ['gschool_lessons', 'short_break'] },
              ...
              if (((s as any).npc_rel ?? 0)?.['A158'] <= 20) {
                ...
                scene.text(`He gives you a slight chin-up greeting. "Hey ${((s as any).pcs_nickname ?? 0)}. You get lost little nerd?"`);
            ...
            if (((s as any).grupTipe ?? 0) === 4) {
              if (((s as any).npc_rel ?? 0)?.['A158'] >= 50) {
                ...
                scene.text(`Valentin calls out to you as you approach. "Hey ${((s as any).pcs_nickname ?? 0)}, do anything fun lately?"`);
...
function enterShulga(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).grupTipe ?? 0) === 4  &&  ((s as any).gopnik_slut ?? 0) === 1) {
    // TODO-QSP: dynamic text: "I'm surprised you don't walk bow-legged the number of times you've been fucked,...
    ...
    if (((s as any).npc_rel ?? 0)?.['A11'] >= 50  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 300) {
      if (((s as any).grupTipe ?? 0) === 4) {
        ...
        scene.text(`Vasily calls out to you as you approach. "Hey ${((s as any).pcs_nickname ?? 0)}, what's up?"`);
      ...
      if (((s as any).npc_rel ?? 0)?.['A11'] <= 20  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 300) {
        if (((s as any).grupTipe ?? 0) === 4) {
          ...
          scene.text(`He frowns at you. "What do you want, ${((s as any).pcs_nickname ?? 0)}?"`);
          scene.text('"I just wanted to talk is all," you reply.');
          ...
          scene.text(`He frowns at you. "Stop bothering me, ${((s as any).pcs_nickname ?? 0)}!"`);
          scene.text('"I just wanted to talk is all," you reply.');
...
function enterNiko(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).NikoBreakup ?? 0) === 1) {
    scene.actions([{ label: 'Continue', goto: ['NikoEv', 'Lunch Breakup'] }]);
  } else {
    ...
    scene.actions([
      ...
      if ((!((s as any).NikoIntro ?? 0))) {
        scene.actions([{ label: 'Continue', goto: ['NikoEv', 'Lunch Intro'] }]);
      } else {
        if (((s as any).NikoIntro ?? 0) === 1  ||  ((s as any).NikoIntro ?? 0) === -1) {
          scene.actions([{ label: 'Continue', goto: ['NikoEv', 'Lunch Chat'] }]);
        }
      }
    }
  }
  ...
  if (((s as any).grupTipe ?? 0) === 4  &&  ((s as any).gopnik_slut ?? 0) === 1) {
    ...
    if (((s as any).npc_rel ?? 0)?.['A21'] >= 50) {
      if (((s as any).grupTipe ?? 0) === 4) {
        ...
        scene.text(`"What's up, ${((s as any).pcs_nickname ?? 0)}?" Lera inquires.`);
        ...
        scene.text(`She looks back at you and shrugs her shoulders. "Hi ${((s as any).pcs_nickname ?? 0)}, nothing much. Just waiting for Lena."`);
        // TODO-QSP: $func('npc_reactions', 'general', 'A21')
  ...
  if (((s as any).fame ?? 0)?.['pav_slut'] > 250) {
    if (((s as any).npc_rel ?? 0)?.['A143'] >= 50) {
      ...
      if (((s as any).npc_rel ?? 0)?.['A143'] <= 20) {
        ...
        scene.text(`Alyona is sitting on the stairs listening to music. When she sees you approaching, she takes out her earbuds. "Hey ${((s as any).pcs_nickname ?? 0)}, what's up?" she asks as she moves a little so you can sit down next to her.`);
    ...
    if (((s as any).grupTipe ?? 0) === 1) {
      if (((s as any).npc_rel ?? 0)?.['A143'] >= 50) {
        // TODO-QSP: dynamic text: "Hi <<$pcs_nickname>>, what's up?" Alyona greets you as you make your way up the...
        scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}, what's up?" Alyona greets you as you make your way up the stairs.`);
        ...
        if (((s as any).npc_rel ?? 0)?.['A143'] <= 20) {
          ...
          // TODO-QSP: dynamic text: Alyona looks at you as you approach. "Hi <<$pcs_nickname>>. Sorry, but I'm in th...
          scene.text(`Alyona looks at you as you approach. "Hi ${((s as any).pcs_nickname ?? 0)}. Sorry, but I'm in the middle of a conversation." She then turns back to the others, visibly upset about what she missed while she wasn't listening.`);
          ...
          scene.text(`For the next few minutes, you tell her what you want her opinion on. However, she gets tired of listening and stands up. "Okay ${((s as any).pcs_nickname ?? 0)}, you could have asked someone else, actually. I'm going back to the others now…"`);
      ...
      if (((s as any).grupTipe ?? 0) === 2) {
        if (((s as any).npc_rel ?? 0)?.['A143'] >= 50) {
          ...
          scene.text(`"Hi ${((s as any).pcs_nickname ?? 0)}," Alyona greets you as soon as she sees you approaching.`);
          ...
          // TODO-QSP: dynamic text: "Oh <<$pcs_nickname>>, you know I'm not interested in sports at all. However, so...
          scene.text(`"Oh ${((s as any).pcs_nickname ?? 0)}, you know I'm not interested in sports at all. However, some jock guys have a good, sexy body, I gotta admit it. Or jock girls." she adds while biting her lip.`);
          // TODO-QSP: $func('npc_reactions', 'general', 'A143')
        ...
        if (((s as any).grupTipe ?? 0) === 3) {
          if (((s as any).npc_rel ?? 0)?.['A143'] >= 50) {
            ...
            scene.text(`Y"ou know me ${((s as any).pcs_nickname ?? 0)}, just trying to get through the day," she replies. She's clearly not having the best of days. She looks tired as she leans against the wall and can barely keep her eyes open.`);
            ...
            if (((s as any).npc_rel ?? 0)?.['A143'] <= 20) {
              ...
              scene.text(`"What's up, ${((s as any).pcs_nickname ?? 0)}? came to do my homework?" she asks mockingly.`);
          ...
          if (((s as any).grupTipe ?? 0) === 4) {
            if (((s as any).npc_rel ?? 0)?.['A143'] >= 50) {
              // TODO-QSP: dynamic text: As you reach the stairway, your eyes meet Alyona's and she beckons you over. "He...
              scene.text(`As you reach the stairway, your eyes meet Alyona's and she beckons you over. "Hey ${((s as any).pcs_nickname ?? 0)}, what's new?" she asks as you sit next to her on the stairs.`);
              ...
              if (((s as any).npc_rel ?? 0)?.['A143'] <= 20) {
                ...
                // TODO-QSP: dynamic text: When she sees that you don't want to drink, she takes another sip. "Listen <<$pc...
                scene.text(`When she sees that you don't want to drink, she takes another sip. "Listen ${((s as any).pcs_nickname ?? 0)}, just because we're in the same group doesn't mean we're friends. I don't care if you leave or stay, but I'm in no mood to talk."`);
                ...
                scene.text(`Alyona looks at you. "Oh hey ${((s as any).pcs_nickname ?? 0)}! Sorry, I didn't even notice you were there. I'm totally immersed in these new songs."`);
            ...
            if (((s as any).npc_rel ?? 0)?.['A143'] >= 50) {
              ...
              // TODO-QSP: dynamic text: You can tell by her expression that she doesn't know what to do. "<<$pcs_nicknam...
              scene.text(`You can tell by her expression that she doesn't know what to do. "${((s as any).pcs_nickname ?? 0)}, you know very well that most of them aren't on good terms with you. I'll see what I can do, but no promises. Besides, I have my own problems."`);
  ...
  if (((s as any).temp ?? 0)?.['tampon_ask'] === '"Alyona," you whisper. "My period just started  &&  I don\'t have a tampon. Can I borrow one?"'  ||  ((s as any).temp ?? 0)?.['tampon_ask'] === '"Alyona," you whisper. "My period is starting soon  &&  I don\'t have a tampon. Can I borrow one?"') {
    if (((s as any).npc_rel ?? 0)?.['A143'] >= 60) {
      if ((Math.floor(Math.random() * 2) + 1) === 1) {
        ...
        scene.text(`"Ah fuck," she mumbles, fumbling around in her bag. "I think I got drunk during my last period and forgot to pack new ones. Sorry ${((s as any).pcs_nickname ?? 0)}."`);
    ...
    if (((s as any).npc_rel ?? 0)?.['A143'] >= 60) {
      if ((Math.floor(Math.random() * 2) + 1) === 1) {
        ...
        scene.text(`"Ah fuck," she mumbles, fumbling around in her bag. "I only use tampons but I think I got drunk during my last period and forgot to pack new ones. Sorry ${((s as any).pcs_nickname ?? 0)}."`);
        scene.text('She shrugs apologetically, seeming a little embarrassed too.');
      }
    } else {
      scene.text('"Just take one," she waves dismissively at her bag on the floor before taking another drink from her flask.');
...
function enterAnushka(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).npc_rel ?? 0)?.['A144'] > 60  &&  (((s as any).anushkaQW ?? 0)?.['sex'] > 0  &&  ((s as any).pcs_hotcat ?? 0) >= 7)  &&  (Math.floor(Math.random() * 6) + 0) === 0  &&  ((s as any).nush_daycheck ?? 0) !== ((s as any).daystart ?? 0)) {
    ...
    qspCall(s, 'stat', '');
    (s as any).nush_daycheck = ((s as any).daystart ?? 0);
    scene.img('images/characters/shared/headshots_main/big144.jpg');
        ...
        if (((s as any).grupTipe ?? 0) === 1) {
          ...
          if (((s as any).grupTipe ?? 0) === 2) {
            if (((s as any).npc_rel ?? 0)?.['A144'] >= 50) {
              ...
              scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}, just finishing it up." She closes the computer and puts it away in her pack before flexing at you. She has decent muscle tone, but nothing like you or the other jock girls.`);
            ...
            if (((s as any).grupTipe ?? 0) === 3) {
              if (((s as any).npc_rel ?? 0)?.['A144'] >= 50) {
                ...
                scene.text(`"Hey ${((s as any).pcs_nickname ?? 0)}. No, I was looking at porn," she replies, cauisng you to blush even more, which makes her grin in amusement.`);
  ...
  if (((s as any).grupTipe ?? 0) === 4  &&  ((s as any).gopnik_slut ?? 0) === 1) {
    ...
    if (((s as any).npc_rel ?? 0)?.['A20'] >= 50  &&  ((s as any).fame ?? 0)?.['pav_slut'] < 300) {
      ...
      if (((s as any).grupTipe ?? 0) === 4) {
        ...
        scene.text(`She looks back at you and arches a brow. "Nothing much. You lost, ${((s as any).pcs_nickname ?? 0)}?"`);
    ...
    if (((s as any).fame ?? 0)?.['pav_slut'] > 250) {
      ...
      if (((s as any).grupTipe ?? 0) === 1  ||  ((s as any).grupTipe ?? 0) === 2) {
        if (((s as any).npc_rel ?? 0)?.['A24'] >= 60) {
          ...
          scene.text(`She looks back at you. "What do you want, ${((s as any).pcs_nickname ?? 0)}?"`);
          ...
          if (((s as any).npc_rel ?? 0)?.['A24'] <= 20) {
            ...
            scene.text(`She looks back at you and asks "You lost, ${((s as any).pcs_nickname ?? 0)}? Shouldn't you be with your own kind?"`);
            scene.text('You shake your head. "Don\'t be like that. I just came over to see how you were doing."');

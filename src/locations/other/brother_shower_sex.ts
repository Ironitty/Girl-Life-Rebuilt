...
function enterBrotherShowerBj(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((!(Math.floor(Math.random() * 2) + 0))) {
      ...
      (st as any).brotherbjcomment = (Math.floor(Math.random() * 2) + 1);
      qspCall(st, 'stat', '');
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterEndingRouteRoutine(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
      ]);
    }
    scene.actions([
...
function enterBrotherShowerFuckFirst(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).brotherQW ?? 0)?.['know_not_virgin'] === 1) {
    ...
    qspCall(st, 'npc_relationship', 'modify', 'A34', 20);
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_lie'] = 0;
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_truth'] = 1;
    ...
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_lie'] = 1;
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_truth'] = 0;
    ...
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_lie'] = 2;
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_truth'] = 0;
    ...
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_lie'] = 0;
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_truth'] = 2;
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['know_not_virgin'] = 1;
    scene.text('"Nope!" You smile at him. "Sorry to disappoint, but I lost my virginity a while back little brother."');
    ...
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_lie'] = 0;
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_truth'] = 3;
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['know_not_virgin'] = 1;
    scene.text('"Nope!" You smile at him. "Sorry to disappoint, but yours is just going to be one more of many different dicks that have been inside my pussy little brother."');
    ...
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_lie'] = 3;
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['virgin_truth'] = 0;
    scene.text('"Yeah. I am." You smile at him. "You\'re my first time little brother."');
    if (((st as any).stat ?? 0)?.['men_fucked'] < 10) {
...
function enterBrotherShowerFuckFirst2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (qspFunc(s, 'pcs_has_attr', 'sex_virgin')) {
      ...
      if (((st as any).stat ?? 0)?.['hidden_vaginal'] > 0  &&  ((st as any).stat ?? 0)?.['vaginal'] === 0) {
    ...
    if (((st as any).pcs_horny ?? 0) < 90) {
      ...
      if ((!((st as any).succubusflag ?? 0))) {
        if (((st as any).birth_control ?? 0)?.['think_safe'] === 1  ||  ((st as any).tabletkishot ?? 0) >= 1) {
          // TODO-QSP: dynamic text: '<i>Well,</i> you think to yourself, <i>It''s a good thing '+iif(birth_control['...
          scene.text('<i>Well,</i> you think to yourself, <i>It\'s a good thing ' + ((((st as any).birth_control ?? 0)?.['implant_status'] > 1) ? ('I have a birth control implant.') : ('I\'m on birth control.')) + '</i>');
        } else {
...
function enterBrotherShowerAnalVagvAnalv(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (st as any).guy = ((st as any).guy ?? 0) + (1);
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['anal'] = ((st as any).brotherQW['anal'] ?? 0) + (1);
    (st as any).anal_slip = ((st as any).anal_slip ?? 0) + ((Math.floor(Math.random() * 3) + 4));
    (st as any).orgasm_or = 'no';
    qspCall(st, 'arousal', 'anal', 2, 'incest');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'arousal', 'clit_finger', 2, 'incest');
    qspCall(st, 'stat', '');
    scene.actions([
    ...
    qspCall(st, 'cum_call', 'anal', 'A34', 1);
    qspCall(st, 'arousal', 'clit_finger', 2, 'incest');
    qspCall(st, 'arousal', 'breasts', (-1), 'incest');
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBrotherShowerFinish(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  } },
    ]);
...
function enterBrotherShowerAnalVagnvAnalv(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((st as any).brotherQW = (st as any).brotherQW ?? {})['anal'] = ((st as any).brotherQW['anal'] ?? 0) + (1);
    (st as any).orgasm_or = 'no';
    qspCall(st, 'arousal', 'vaginal', 2, 'incest');
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterBrotherShowerAnalVagvAnalnv(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: dynamic text: '"Kolka, ' + iif (brotherQW['anal'] > 0, 'I still can''t let you have my pussy, ...
  scene.text('"Kolka, ' + qspUntranslated(s, "iif (brotherQW['anal'] > 0, 'I still can't let you have my pussy, but would you be okay with doing me in the ass again?\"', 'I can't let you have my pussy, but would you be okay with anal?\"')", { location: "brother_shower_sex" }) + ' You ask and Kolka\'s eyes light up.');
  // TODO-QSP: end
  scene.actions([
    { label: 'Prepare yourself', handler: (st: GameState) => {
    scene.img('images/shared/sex/shower/anal2.mp4');
    ...
    qspCall(st, 'arousal', 'breast', (-3), 'incest');
    qspCall(st, 'arousal', 'anal', 3, 'incest');
    qspCall(st, 'cum_call', 'anal', 'A34', 1);
    qspCall(st, 'stat', '');
    scene.actions([
...
function enterBrotherFuckCum(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).brothercumchoice ?? 0) === 1) {
    ...
    qspCall(st, 'cum_call', 'stomach', 'A34', 1);
    ...
    if (((st as any).birth_control ?? 0)?.['think_safe'] === 0) {
      ...
      if (((st as any).birth_control ?? 0)?.['kolka_knows'] === 1) {
        ((st as any).birth_control = (st as any).birth_control ?? {})['kolka_knows'] = 2;
    ...
    if (((st as any).pcs_horny ?? 0) >= 95) {
      ...
      (st as any).orgasm_or = 'custom';
      (st as any).orgasm_txt = 'The sensation sends you over the edge and you clench down on him hard, your orgasm rocking you in waves, and leaving your legs wobbly when it finally subsides.';
      qspCall(st, 'arousal', 'vaginal', 1);
    }
    ...
    scene.img(`images/shared/sex/cum/vagcreampie/doggy${(Math.floor(Math.random() * 4) + 1)}.mp4`);
    if (((st as any).brotherQW ?? 0)?.['shower_fuck_day'] === ((st as any).daystart ?? 0)) {
    ...
    scene.img(`images/shared/sex/cum/vagcreampie/doggy${(Math.floor(Math.random() * 4) + 1)}.mp4`);
    ((st as any).brother = (st as any).brother ?? {})['cp_accident'] = ((st as any).brother['cp_accident'] ?? 0) + (1);
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBrotherShowerFinish(st, scene); (st as any).locArgs = __savedLocArgs; }
          ...
          if (((st as any).brother ?? 0)?.['cp_accident'] >= 5) {
            scene.actions([
...
function enterShowerSwallow(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).brotherbjcomment ?? 0) === 1) {
      ...
      if (((st as any).brotherbjcomment ?? 0) === 2) {
...
function enterShowerForcedCreampie(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((!((st as any).succubusflag ?? 0))) {
      if (((st as any).knowpreg ?? 0) === 1  ||  ((st as any).thinkpreg ?? 0) === 1) {
        scene.text('You chuckle to yourself. "Well, at least I can\'t get any more pregnant than I already am!"');
      } else {
        if (((st as any).birth_control ?? 0)?.['think_safe'] === 1  ||  ((st as any).tabletkishot ?? 0) >= 1) {
          ...
          // TODO-QSP: dynamic text: '<i>At least '+iif(birth_control['implant_status'] > 1, 'I have a birth control ...
          scene.text('<i>At least ' + ((((st as any).birth_control ?? 0)?.['implant_status'] > 1) ? ('I have a birth control implant') : ('I\'m on birth control')) + '…</i>');
        } else {
          if (((st as any).mesec ?? 0) > 0) {
            scene.text('<i>Goddamn it,</i> you think, looking down to watch another glob of cum drips from your snatch. <i>Only my idiot brother could ruin a perfectly good creampie like this.</i>');
    ...
    if (((st as any).brothercumchoice ?? 0) === 3) {
      ...
      if (((st as any).brothercumchoice ?? 0) === 4) {
    ...
    if (((st as any).birth_control ?? 0)?.['think_safe'] === 1  ||  ((st as any).tabletkishot ?? 0) >= 1) {
      ...
      // TODO-QSP: dynamic text: '<i>It''s a good thing '+iif(birth_control['implant_status'] > 1, 'I have a birt...
      scene.text('<i>It\'s a good thing ' + ((((st as any).birth_control ?? 0)?.['implant_status'] > 1) ? ('I have a birth control implant') : ('I\'m on birth control')) + '…</i>');
    } else {
      if (((st as any).mesec ?? 0) > 0) {
...
function enterBrotherShowerFuckEnd(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).brotherQW ?? 0)?.['club'] === 1  &&  ((s as any).brotherQW ?? 0)?.['virgin_talk'] === 0) {
    ...
    qspCall(st, 'npc_relationship', 'modify', 'A34', 25);
    scene.img('images/locations/pavlovsk/resident/apartment/home/vanrpar.jpg');
    if (((st as any).brotherQW ?? 0)?.['virgin_lie'] === 1) {
      ...
      if (((st as any).brotherQW ?? 0)?.['virgin_lie'] === 2) {
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBrotherShowerFinishdryoff(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
    ]);
  } },
    ]);
    ...
    scene.img('images/locations/pavlovsk/resident/apartment/home/vanrpar.jpg');
    if (((st as any).brotherQW ?? 0)?.['virgin_lie'] !== 2  ||  ((st as any).brotherQW ?? 0)?.['fuck'] >= 2) {
    ...
    if (((st as any).pcs_horny ?? 0) > 70  &&  (((st as any).brotherQW ?? 0)?.['virgin_lie'] !== 2  ||  ((st as any).brotherQW ?? 0)?.['fuck'] >= 2)) {
...
function enterBrotherShowerFinish(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    { const __savedLocArgs = (st as any).locArgs; (st as any).locArgs = ['', ]; enterBrotherShowerFinishEnd(st, scene); (st as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
}

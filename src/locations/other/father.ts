...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).stepfatherQW ?? 0)?.['piercing_talkday'] !== ((s as any).daystart ?? 0)) {
    ...
    if ((!((s as any).TouchedByFather ?? 0))) {
      ...
      scene.text(`Your stepfather shakes his head: "${((s as any).pcs_nickname || '')}, tongue piercings are only for lewd women who use their mouth to please men."`);
    }
  ...
  if ((((s as any).hour ?? 0) > 10  &&  ((s as any).week ?? 0) < 6)  ||  ((s as any).week ?? 0) >= 6) {
    ...
    if (((s as any).fatherPayDay ?? 0) === ((s as any).daystart ?? 0)) {
      ...
      scene.text(`Trying your cutest face on your stepfather, you ask him for some money. He just shakes his head wearily: "No, ${((s as any).pcs_nickname || '')}. I've already given you some money today, don't be greedy."`);
    } else {
    ...
    if (((s as any).pcs_apprnc ?? 0) + (((s as any).npc_rel ?? 0)?.['A28'] / 10) >= 200) {
      ...
      if (((s as any).pcs_apprnc ?? 0) + (((s as any).npc_rel ?? 0)?.['A28'] / 10) >= 120) {
    ...
    if (((s as any).fatherLust ?? 0) >= 2) {
      ...
      scene.text(`"Sorry ${((s as any).pcs_nickname || '')}, like I said, I have no money. Go ask your mother."`);
    } else {
    ...
    dynamicGoto(st, 'prevLoc', 'prevArg');
        ...
        if (((s as any).FatherMolest ?? 0) > 1) {
          ...
          scene.text(`"${((s as any).pcs_nickname || '')}, I already said no."`);
        }
      }
    }
    scene.actions([
    ...
    if (((s as any).npc_rel ?? 0)?.['A28'] >= 60  ||  ((s as any).TouchedByFather ?? 0) === 1) {
      ...
      scene.text(`Your stepfather shook his head and said "Sorry ${((s as any).pcs_nickname || '')}. The garage already has more stuff in it than I would like, there's simply no room."`);
    }
    scene.actions([
      { label: 'Move away', goto: ['father', ''] },
    ]);
    ...
    if (((s as any).npc_rel ?? 0)?.['A28'] <= 40  ||  (((s as any).pcs_apprnc ?? 0) + (((s as any).npc_rel ?? 0)?.['A28'] / 10)) <= 60) {
      ...
      scene.text(`You ask your stepfather what he thinks of your outfit. It looks like he's not in the mood to indulge you, and impatiently waves you away with his hand: "Don't bother me ${((s as any).pcs_nickname || '')}, I'm busy."`);
    } else {
    ...
    if (((s as any).fatherLust ?? 0) >= 2) {
      ...
      if (((s as any).pantyworntype ?? 0) !== 'none') {
        ...
        scene.text(`<center><img ${((s as any).set_imgh || '')} src="images/characters/pavlovsk/resident/vladimir/sex/fatherim47.jpg"></center>`);
    ...
    if (((s as any).fatherLust ?? 0) >= 2) {
      ...
      if (((s as any).pantyworntype ?? 0) !== 'none') {
        // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/characters/pavlovsk/resident/vladimir/sex...
        scene.text(`<center><img ${((s as any).set_imgh || '')} src="images/characters/pavlovsk/resident/vladimir/sex/fatherim45.jpg"></center>`);
      ...
      if (((s as any).pantyworntype ?? 0) === 'none') {
        // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/characters/pavlovsk/resident/vladimir/sex...
        scene.text(`<center><img ${((s as any).set_imgh || '')} src="images/characters/pavlovsk/resident/vladimir/sex/fatherim46.jpg"></center>`);
        // TODO-QSP: dynamic text: Deciding to take your teasing to the next level, you pull your clothes to the si...
        scene.text(`Deciding to take your teasing to the next level, you pull your clothes to the side and show him your bare pussy. Your stepfather realizes you're taking it too far, and sends you off: "${((s as any).pcs_nickname || '')}, stop that. And go put on some underwear, that's no way for a lady to behave."`);
      }
    }
    if (((s as any).fatherLust ?? 0) === 1) {
      if (((s as any).pantyworntype ?? 0) !== 'none') {
        // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/characters/pavlovsk/resident/vladimir/sex...
        scene.text(`<center><img ${((s as any).set_imgh || '')} src="images/characters/pavlovsk/resident/vladimir/sex/fatherim43.jpg"></center>`);
      ...
      if (((s as any).pantyworntype ?? 0) === 'none'  &&  ((s as any).daystage ?? 0) < 5) {
        // TODO-QSP: dynamic text: <center><img <<$set_imgh>> src="images/characters/pavlovsk/resident/vladimir/sex...
        scene.text(`<center><img ${((s as any).set_imgh || '')} src="images/characters/pavlovsk/resident/vladimir/sex/fatherim44.jpg"></center>`);

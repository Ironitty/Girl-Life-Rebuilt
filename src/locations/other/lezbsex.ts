...
function enterStartloverhome(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`You spend some time with ${((s as any).npcdesc ?? 0)} in the kitchen when she gets impatient and caresses you.`);
...
function enterUkuni(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/ukuni${((s as any).picrand ?? 0)}.jpg`);
...
function enterKuni(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/kuni${((s as any).picrand ?? 0)}.jpg`);
...
function enterAnuli(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/anuli${((s as any).picrand ?? 0)}.jpg`);
...
function enterUanuli(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/uanuli${((s as any).picrand ?? 0)}.jpg`);
...
function enterSvag(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/svag${((s as any).picrand ?? 0)}.jpg`);
...
function enterSanal(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/sanal${((s as any).picrand ?? 0)}.jpg`);
...
function enterUsvag(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/usvag${((s as any).picrand ?? 0)}.jpg`);
...
function enterUsanal(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/usanal${((s as any).picrand ?? 0)}.jpg`);
...
function enterDvag(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/dvag${((s as any).picrand ?? 0)}.jpg`);
...
function enterDanal(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/danal${((s as any).picrand ?? 0)}.jpg`);
...
function enterUdvag(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/udvag${((s as any).picrand ?? 0)}.jpg`);
...
function enterUdanal(s: GameState, scene: SceneBuilder): void {
  scene.img(`images/shared/sex/lesbian/udanal${((s as any).picrand ?? 0)}.jpg`);

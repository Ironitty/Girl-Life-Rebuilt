...
function enterComputeStatDisplay(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).totminut ?? 0) <= ((s as any).drugVars ?? 0)?.['cigarettes_minute']) {
    ...
    if (((s as any).mc_inventory ?? 0)?.['cigarettes'] > 0) {
      ((s as any).stat_texts ?? {})['drug_cig_inv_tooltip'] = 'You have ' + qspUntranslated(s, "mc_inventory['cigarettes']>", { location: "drugs" }) + ' cigarettes. Click to smoke.';
  ...
  if (((s as any).drugVars ?? 0)?.['cigarettes_need'] > 0  &&  ((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ...
    if (((s as any).mc_inventory ?? 0)?.['cigarettes'] > 0) {
      ((s as any).stat_texts ?? {})['drug_cig_withdraw'] = (((s as any).stat_texts ?? {})['drug_cig_withdraw'] ?? 0) + (' You have ' + qspUntranslated(s, "mc_inventory['cigarettes']>", { location: "drugs" }) + ' cigarettes.');
      ((s as any).stat_texts ?? {})['drug_cig_withdraw_tooltip'] = ((s as any).stat_texts ?? {})?.['drug_cig_withdraw'] + ' Click to smoke.';
  ...
  if (((s as any).drugVars ?? 0)?.['heroin_need'] > 0  &&  ((s as any).drugVars ?? 0)?.['heroin_high'] === 0) {
    ...
    if (((s as any).drugVars ?? 0)?.['heroin_used'] >= 3  &&  ((s as any).drugVars ?? 0)?.['heroin_high'] > 0) {
      if (((s as any).drugVars ?? 0)?.['heroin_high'] === 1) {
        ...
        ((s as any).stat_texts ?? {})['drug_heroin_addict_tooltip'] = 'You are addicted to heroin. Withdrawal will begin in ' + qspUntranslated(s, "drugVars['heroin_high']>", { location: "drugs" }) + ' hours when the high wears off.';
      }
  ...
  if (((s as any).drugVars ?? 0)?.['cocaine_addict'] === 1  &&  ((s as any).drugVars ?? 0)?.['cocaine_day'] !== ((s as any).daystart ?? 0)) {
    ...
    if (((s as any).mc_inventory ?? 0)?.['cocaine'] > 0) {
      ((s as any).stat_texts ?? {})['drug_cocaine_withdraw'] = (((s as any).stat_texts ?? {})['drug_cocaine_withdraw'] ?? 0) + (' You have ' + qspUntranslated(s, "mc_inventory['cocaine']>", { location: "drugs" }) + ' doses.');
      ((s as any).stat_texts ?? {})['drug_cocaine_withdraw_tooltip'] = ((s as any).stat_texts ?? {})?.['drug_cocaine_withdraw'] + ' Click to use.';
  ...
  if (((s as any).drugVars ?? 0)?.['amphetamine_withdrawl'] >= 5  &&  ((s as any).drugVars ?? 0)?.['amphetamine_high'] <= 0) {
    ...
    if (((s as any).mc_inventory ?? 0)?.['amphetamine'] > 0) {
      ((s as any).stat_texts ?? {})['drug_amphet_withdraw'] = (((s as any).stat_texts ?? {})['drug_amphet_withdraw'] ?? 0) + (' You have ' + qspUntranslated(s, "mc_inventory['amphetamine']>", { location: "drugs" }) + ' pills.');
      ((s as any).stat_texts ?? {})['drug_amphet_withdraw_tooltip'] = ((s as any).stat_texts ?? {})?.['drug_amphet_withdraw'] + ' Click to take one.';
  ...
  if (((s as any).drugVars ?? 0)?.['painkiller_weak'] === 1) {
    ...
    if (((s as any).mc_inventory ?? 0)?.['painkillers'] > 0) {
      ((s as any).stat_texts ?? {})['drug_pk_withdraw'] = (((s as any).stat_texts ?? {})['drug_pk_withdraw'] ?? 0) + (' You have ' + qspUntranslated(s, "mc_inventory['painkillers']>", { location: "drugs" }) + '.');
      ((s as any).stat_texts ?? {})['drug_pk_withdraw_tooltip'] = ((s as any).stat_texts ?? {})?.['drug_pk_withdraw'] + ' Click to take one.';
    ...
    if (((s as any).drugVars ?? 0)?.['painkiller_addict'] === 1  &&  ((s as any).drugVars ?? 0)?.['painkiller_points'] >= 10) {
      ...
      if (((s as any).sd_tmp_pk_hrs ?? 0) < 1) {
        ...
        ((s as any).stat_texts ?? {})['drug_pk_addict_tooltip'] = 'You are addicted to painkillers. Withdrawal will set in within ' + qspUntranslated(s, "sd_tmp_pk_hrs>", { location: "drugs" }) + ' hours.';
      }
...
function enterPainRelief(s: GameState, scene: SceneBuilder): void {
  ((s as any).pain ?? {})['relief'] = 0;
  if (((s as any).alko ?? 0) <= 3) {
  } else {
    if (((s as any).alko ?? 0) <= 6) {
      ((s as any).pain ?? {})['relief'] = (((s as any).pain ?? {})['relief'] ?? 0) + (15);
    } else {
      if (((s as any).alko ?? 0) <= 9) {
        ((s as any).pain ?? {})['relief'] = (((s as any).pain ?? {})['relief'] ?? 0) + (30);
      } else {
        ((s as any).pain ?? {})['relief'] = (((s as any).pain ?? {})['relief'] ?? 0) + (60);
      }
    }
  }
  if (((s as any).drugVars ?? 0)?.['heroin_high'] > 0) {
    ((s as any).pain ?? {})['relief'] = (((s as any).pain ?? {})['relief'] ?? 0) + (90);
  } else {
    if (((s as any).drugVars ?? 0)?.['cocaine_high'] > 0) {
      ((s as any).pain ?? {})['relief'] = (((s as any).pain ?? {})['relief'] ?? 0) + (50);
    } else {
      if (((s as any).drugVars ?? 0)?.['painkiller_points'] > 0) {
        ...
        ((s as any).pain ?? {})['relief'] = (((s as any).pain ?? {})['relief'] ?? 0) + ((((s as any).painkiller_ceiling ?? 0) * ((s as any).drugVars ?? {})?.['painkiller_points']) / (((s as any).drugVars ?? {})?.['painkiller_points'] + ((s as any).painkiller_saturation ?? 0)));
      }
    }
  }
...
function enterAlcohol(s: GameState, scene: SceneBuilder): void {
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ((s as any).drugVars ?? {})['alcohol_used'] = (((s as any).drugVars ?? {})['alcohol_used'] ?? 0) + (1);
    if (((s as any).drugVars ?? 0)?.['alcohol_used'] > 15  &&  ((s as any).drugVars ?? 0)?.['alcohol_exp'] === 0) {
      ((s as any).drugVars ?? {})['alcohol_exp'] = 1;
    }
  }
  // TODO-QSP: $ARGS[1] = $lcase($ARGS[1])
  ((s as any).ARGS ?? {})[2] = ((((s as any).locArgs?.[2] ?? 0) <= 1) ? (1) : (qspUntranslated(s, "ARGS[2]", { location: "drugs" })));
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 'beer') {
    ...
    ((s as any).trait_vars ?? {})['alko_today'] = (((s as any).trait_vars ?? {})['alko_today'] ?? 0) + (1);
    ...
    if (((s as any).locArgs?.[1] ?? 0) === 'wine'  ||  ((s as any).locArgs?.[1] ?? 0) === 'champagne') {
      ...
      ((s as any).trait_vars ?? {})['alko_today'] = (((s as any).trait_vars ?? {})['alko_today'] ?? 0) + (2);
      ...
      if (((s as any).locArgs?.[1] ?? 0) === 'vodka'  ||  ((s as any).locArgs?.[1] ?? 0) === 'whiskey'  ||  ((s as any).locArgs?.[1] ?? 0) === 'scotch'  ||  ((s as any).locArgs?.[1] ?? 0) === 'rum') {
        ...
        ((s as any).trait_vars ?? {})['alko_today'] = (((s as any).trait_vars ?? {})['alko_today'] ?? 0) + (3);
        ...
        if (((s as any).locArgs?.[1] ?? 0) === 'moonshine') {
          ...
          ((s as any).trait_vars ?? {})['alko_today'] = (((s as any).trait_vars ?? {})['alko_today'] ?? 0) + (5);
...
function enterCaffeine(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).drugVars ?? {})['caffeine_dose'] = qspUntranslated(s, "ARGS[2]", { location: "drugs" });
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
  ...
  if (((s as any).drugVars ?? 0)?.['caffeine_addict'] === 0) {
    ...
    ((s as any).drugVars ?? {})['sleep_displayed'] = (102 * ((s as any).drugVars ?? {})?.['caffeine_dose'] + ((s as any).pcs_sleep ?? 0) * (((s as any).drugVars ?? {})?.['caffeine_dose'] + 2)) / (2 * ((s as any).drugVars ?? {})?.['caffeine_dose'] + 2);
  }
  qspCall(s, 'stat', '');
  return;
  scene.build();
...
function enterCaffeineCikl(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['caffeine_system'] <= 0) {
    ((s as any).drugVars ?? {})['caffeine_system'] = 0;
  } else {
    if (((s as any).drugVars ?? 0)?.['caffeine_system'] < 20) {
      ((s as any).drugVars ?? {})['caffeine_system'] = (((s as any).drugVars ?? {})['caffeine_system'] ?? 0) - (1);
    } else {
      if (((s as any).drugVars ?? 0)?.['caffeine_system'] < 40) {
        ((s as any).drugVars ?? {})['caffeine_system'] = (((s as any).drugVars ?? {})['caffeine_system'] ?? 0) - (2);
      } else {
        if (((s as any).drugVars ?? 0)?.['caffeine_system'] < 60) {
          ((s as any).drugVars ?? {})['caffeine_system'] = (((s as any).drugVars ?? {})['caffeine_system'] ?? 0) - (3);
        } else {
          ((s as any).drugVars ?? {})['caffeine_system'] = 60;
        }
      }
    }
  }
...
function enterCaffeineHourlyEvents(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['caffeine_addict'] === 1  &&  ((s as any).drugVars ?? 0)?.['caffeine_dose'] === 0) {
    ((s as any).drugVars ?? {})['caffeine_need'] = (((s as any).drugVars ?? {})['caffeine_need'] ?? 0) + (1);
  }
  if (((s as any).drugVars ?? 0)?.['caffeine_need'] > 0) {
...
function enterCaffeineStat(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['caffeine_system'] >= 60) {
    ((s as any).drugVars ?? {})['caffeine_addict'] = 1;
  } else {
    if (((s as any).drugVars ?? 0)?.['caffeine_system'] <= 0) {
      ((s as any).drugVars ?? {})['caffeine_addict'] = 0;
    }
  }
  if (((s as any).drugVars ?? 0)?.['caffeine_dose'] > 0) {
    ((s as any).drugVars ?? {})['caffeine_need'] = 0;
    if (((s as any).pcs_sleep ?? 0) < ((s as any).drugVars ?? 0)?.['sleep_displayed']) {
      ((s as any).drugVars ?? {})['sleep_actual'] = (((s as any).drugVars ?? {})['sleep_actual'] ?? 0) - ((((s as any).drugVars ?? {})?.['sleep_displayed'] - ((s as any).pcs_sleep ?? 0)));
    }
  ...
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    if (((s as any).drugVars ?? 0)?.['cigarettes_used'] >= 20  ||  (((s as any).drugVars ?? 0)?.['cigarettes_ever'] >= 150  &&  ((s as any).drugVars ?? 0)?.['cigarettes_used'] >= 5)) {
      if ((Math.floor(Math.random() * 100) + 1) <= 40 + Math.min(((s as any).drugVars ?? 0)?.['cigarettes_used'] - 20, 240) / 4) {
        ((s as any).drugVars ?? {})['cigarettes_need'] = (((s as any).drugVars ?? {})['cigarettes_need'] ?? 0) + (1);
      }
    ...
    if ((!((s as any).inSleep ?? 0))) {
      if (((s as any).drugVars ?? 0)?.['cigarettes_need'] > 50) {
        ...
        if (((s as any).drugVars ?? 0)?.['disp_day_smoke'] < ((s as any).daystart ?? 0)) {
          ((s as any).drugVars ?? {})['disp_day_smoke'] = ((s as any).daystart ?? 0);
...
function enterWeedHourlyEvents(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['weed_high'] > 0) {
    ((s as any).drugVars ?? {})['weed_high'] = (((s as any).drugVars ?? {})['weed_high'] ?? 0) - (1);
...
function enterAmphetamine(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 0  &&  ((s as any).locArgs?.[1] ?? 0) === '') {
    ((s as any).mc_inventory ?? {})['amphetamine'] = (((s as any).mc_inventory ?? {})['amphetamine'] ?? 0) - (1);
    if (((s as any).mc_inventory ?? 0)?.['amphetamine'] <= 0) {
      ((s as any).mc_inventory ?? {})['amphetamine'] = 0;
      // TODO-QSP: msg 'That was your last amphetamine pill.'
    }
  }
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ((s as any).drugVars ?? {})['amphetamine_used'] = (((s as any).drugVars ?? {})['amphetamine_used'] ?? 0) + (1);
    if (((s as any).drugVars ?? 0)?.['amphetamine_used'] > 5  &&  ((s as any).drugVars ?? 0)?.['amphetamine_exp'] === 0) {
      ((s as any).drugVars ?? {})['amphetamine_exp'] = 1;
    }
  }
  ((s as any).drugVars ?? {})['amphetamine_intake'] = (((s as any).drugVars ?? {})['amphetamine_intake'] ?? 0) + (1);
...
function enterAmphetamineHourlyEvents(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['amphetamine_withdrawl'] >= 5) {
    ((s as any).drugVars ?? {})['amphetamine_withdrawl'] = (((s as any).drugVars ?? {})['amphetamine_withdrawl'] ?? 0) + (1);
  ...
  if (((s as any).drugVars ?? 0)?.['amphetamine_high'] > 0) {
    ...
    ((s as any).drugVars ?? {})['amphetamine_bonus'] = 2;
    ((s as any).drugVars ?? {})['amphetamine_high'] = (((s as any).drugVars ?? {})['amphetamine_high'] ?? 0) - (4);
    ...
    if (((s as any).drugVars ?? 0)?.['amphetamine_withdrawl'] === 2) {
      if (((s as any).drugVars ?? 0)?.['amphetamine_intake'] > 0) {
        ...
        ((s as any).drugVars ?? {})['amphetamine_withdrawl'] = 0;
      }
      ((s as any).drugVars ?? {})['amphetamine_high'] = 0;
      ((s as any).drugVars ?? {})['amphetamine_bonus'] = 1;
      qspCall(s, 'mood', 'lower', 'small');
    } else {
      if (((s as any).drugVars ?? 0)?.['amphetamine_intake'] > 0) {
        ((s as any).drugVars ?? {})['amphetamine_withdrawl'] = (((s as any).drugVars ?? {})['amphetamine_withdrawl'] ?? 0) + (1);
        ...
        if (((s as any).drugVars ?? 0)?.['amphetamine_withdrawl'] === 0) {
          ((s as any).drugVars ?? {})['amphetamine_bonus'] = 0;
        }
      }
    }
  }
  if (((s as any).drugVars ?? 0)?.['amphetamine_withdrawl'] > 169) {
    ((s as any).drugVars ?? {})['amphetamine_withdrawl'] = 1;
    ((s as any).drugVars ?? {})['amphetamine_bonus'] = 0;
...
function enterCocaine(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 0  &&  ((s as any).locArgs?.[1] ?? 0) === '') {
    ...
    if (((s as any).mc_inventory ?? 0)?.['cocaine'] <= 0) {
      ((s as any).mc_inventory ?? {})['cocaine'] = 0;
      // TODO-QSP: msg 'That was your last line of cocaine.'
    }
  }
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ((s as any).drugVars ?? {})['cocaine_used'] = (((s as any).drugVars ?? {})['cocaine_used'] ?? 0) + (1);
    if (((s as any).drugVars ?? 0)?.['cocaine_used'] > 3  &&  ((s as any).drugVars ?? 0)?.['cocaine_exp'] === 0) {
      ((s as any).drugVars ?? {})['cocaine_exp'] = 1;
    }
  }
  ((s as any).drugVars ?? {})['cocaine_high'] = Math.min(200, ((s as any).drugVars ?? {})?.['cocaine_high'] + 100);
  ((s as any).drugVars ?? {})['cocaine_system'] = Math.min(60, ((s as any).drugVars ?? {})?.['cocaine_system'] + 8);
  ((s as any).drugVars ?? {})['cocaine_day'] = ((s as any).daystart ?? 0);
  ((s as any).drugVars ?? {})['cocaine_crash'] = 0;
  ((s as any).drugVars ?? {})['cocaine_need'] = 0;
  if (((s as any).drugVars ?? 0)?.['cocaine_willday'] !== ((s as any).daystart ?? 0)) {
    ((s as any).drugVars ?? {})['cocaine_willday'] = ((s as any).daystart ?? 0);
...
function enterCocaineCikl(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['cocaine_system'] < 20) {
    ((s as any).drugVars ?? {})['cocaine_system'] = Math.max(0, ((s as any).drugVars ?? {})?.['cocaine_system'] - 1);
  } else {
    if (((s as any).drugVars ?? 0)?.['cocaine_system'] < 40) {
      ((s as any).drugVars ?? {})['cocaine_system'] = (((s as any).drugVars ?? {})['cocaine_system'] ?? 0) - (2);
    } else {
      if (((s as any).drugVars ?? 0)?.['cocaine_system'] < 60) {
        ((s as any).drugVars ?? {})['cocaine_system'] = (((s as any).drugVars ?? {})['cocaine_system'] ?? 0) - (3);
      } else {
        ((s as any).drugVars ?? {})['cocaine_system'] = 60;
      }
    }
  }
  return;
...
function enterCocaineHourlyEvents(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['cocaine_high'] > 0) {
    ((s as any).drugVars ?? {})['cocaine_high'] = Math.max(0, ((s as any).drugVars ?? {})?.['cocaine_high'] - 20);
    if (((s as any).drugVars ?? 0)?.['cocaine_high'] === 0) {
      ((s as any).drugVars ?? {})['cocaine_crash'] = 60;
    }
  }
  if (((s as any).drugVars ?? 0)?.['cocaine_crash'] > 0  &&  ((s as any).drugVars ?? 0)?.['cocaine_high'] === 0) {
    ((s as any).drugVars ?? {})['cocaine_crash'] = Math.max(0, ((s as any).drugVars ?? {})?.['cocaine_crash'] - 10);
    qspCall(s, 'mood', 'lower', 'tiny');
  ...
  ((s as any).drugVars ?? {})['cocaine_need'] = (((s as any).drugVars ?? {})['cocaine_need'] ?? 0) + (1);
  ...
  if (((s as any).drugVars ?? 0)?.['cocaine_need'] > 144) {
    ...
    if (((s as any).drugVars ?? 0)?.['disp_day_cocaine'] < ((s as any).daystart ?? 0)) {
      ((s as any).drugVars ?? {})['disp_day_cocaine'] = ((s as any).daystart ?? 0);
      qspCall(s, 'mood', 'lower_disposition', 'tiny');
    }
  } else {
    if (((s as any).drugVars ?? 0)?.['cocaine_need'] > 72) {
...
function enterCocaineStat(s: GameState, scene: SceneBuilder): void {
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 1) {
    ...
    if (((s as any).drugVars ?? 0)?.['cocaine_system'] >= 25) {
      ((s as any).drugVars ?? {})['cocaine_addict'] = 1;
    } else {
...
function enterHeroin(s: GameState, scene: SceneBuilder): void {
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ((s as any).drugVars ?? {})['heroin_used'] = (((s as any).drugVars ?? {})['heroin_used'] ?? 0) + (1);
    if (((s as any).drugVars ?? 0)?.['heroin_used'] > 1  &&  ((s as any).drugVars ?? 0)?.['heroin_exp'] === 0) {
      ((s as any).drugVars ?? {})['heroin_exp'] = 1;
    }
  }
  qspCall(s, 'mood', 'raise', 'max');
  qspCall(s, 'mood', 'hold', 180);
  ((s as any).drugVars ?? {})['heroin_high'] = (((s as any).drugVars ?? {})['heroin_high'] ?? 0) + (25);
  ((s as any).drugVars ?? {})['heroin_day'] = ((s as any).daystart ?? 0);
...
function enterHeroinHourlyEvents(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['heroin_used'] >= 3) {
    ((s as any).drugVars ?? {})['heroin_hours_addicted'] = (((s as any).drugVars ?? {})['heroin_hours_addicted'] ?? 0) + (1);
  }
  if (((s as any).drugVars ?? 0)?.['heroin_high'] > 0) {
    // TODO-QSP: gs 'mood', 'lower', 40 / drugVars['heroin_high']
    ((s as any).drugVars ?? {})['heroin_high'] = (((s as any).drugVars ?? {})['heroin_high'] ?? 0) - (1);
  } else {
    if (((s as any).drugVars ?? 0)?.['heroin_taper'] > 0) {
      qspCall(s, 'mood', 'lower', 'small');
      ((s as any).drugVars ?? {})['heroin_taper'] = (((s as any).drugVars ?? {})['heroin_taper'] ?? 0) - (1);
      if (((s as any).drugVars ?? 0)?.['heroin_taper'] <= 0) {
        ((s as any).drugVars ?? {})['heroin_need'] = 0;
        ((s as any).drugVars ?? {})['heroin_used'] = 0;
        ((s as any).drugVars ?? {})['heroin_hours_addicted'] = 0;
      }
    } else {
      if (((s as any).drugVars ?? 0)?.['heroin_need'] > 0) {
        ((s as any).drugVars ?? {})['heroin_need'] = (((s as any).drugVars ?? {})['heroin_need'] ?? 0) + (1);
        if (((s as any).drugVars ?? 0)?.['heroin_need'] > 48) {
          qspCall(s, 'mood', 'lower', 'large');
          if (((s as any).drugVars ?? 0)?.['disp_day_heroin'] < ((s as any).daystart ?? 0)) {
            ((s as any).drugVars ?? {})['disp_day_heroin'] = ((s as any).daystart ?? 0);
        ...
        if (((s as any).drugVars ?? 0)?.['heroin_need'] >= Math.min(120, 24 + ((s as any).drugVars ?? 0)?.['heroin_used'] * 2)) {
          ((s as any).drugVars ?? {})['heroin_taper'] = Math.min(1200, 24 + ((s as any).drugVars ?? {})?.['heroin_hours_addicted'] * 2);
        }
      }
    }
  }
...
function enterHeroinStat(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['heroin_high'] > 0) {
    ...
    ((s as any).drugVars ?? {})['heroin_need'] = 0;
    ((s as any).drugVars ?? {})['heroin_taper'] = 0;
    qspCall(s, 'mood', 'raise', 'large');
  } else {
    if (((s as any).drugVars ?? 0)?.['heroin_used'] >= 3) {
      ((s as any).drugVars ?? {})['heroin_need'] = qspUntranslated(s, "max(1, drugVars['heroin_need'])", { location: "drugs" });
    }
  }
...
function enterPainkiller(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 0  &&  ((s as any).locArgs?.[1] ?? 0) === '') {
    ((s as any).mc_inventory ?? {})['painkillers'] = (((s as any).mc_inventory ?? {})['painkillers'] ?? 0) - (1);
    qspCall(s, 'drugs', 'add_painkiller_timer');
    if (((s as any).mc_inventory ?? 0)?.['painkillers'] <= 0) {
      ((s as any).mc_inventory ?? {})['painkillers'] = 0;
    }
  }
  ((s as any).drugVars ?? {})['painkiller_points'] = (((s as any).drugVars ?? {})['painkiller_points'] ?? 0) + (100);
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0  &&  ((s as any).locArgs?.[1] ?? 0) !== 'spell') {
    ((s as any).drugVars ?? {})['painkiller_tolerance'] = (((s as any).drugVars ?? {})['painkiller_tolerance'] ?? 0) + (2);
    if (((s as any).drugVars ?? 0)?.['painkiller_tolerance'] > 60) {
      ((s as any).drugVars ?? {})['painkiller_tolerance'] = 60;
    }
  }
...
function enterRefreshPainkillerTimer(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).drugVars ?? {})['painkiller_timer_refresh'] = ((s as any).totminut ?? 0);
  if (Object.keys((s as any).painkiller_timer ?? {}).length > 0) {
    (s as any).temp_pk_index = 0;
    // TODO-QSP: :painkiller_refresh_loop
    ((s as any).painkiller_timer ?? {})[String((s as any).temp_pk_index ?? 0)] = (((s as any).painkiller_timer ?? {})[String((s as any).temp_pk_index ?? 0)] ?? 0) - (((s as any).temp_pk_gap ?? 0));
...
function enterPainkillerCikl(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['painkiller_tolerance'] > 40) {
    ((s as any).drugVars ?? {})['painkiller_tolerance'] = (((s as any).drugVars ?? {})['painkiller_tolerance'] ?? 0) - (3);
  } else {
    if (((s as any).drugVars ?? 0)?.['painkiller_tolerance'] > 20) {
      ((s as any).drugVars ?? {})['painkiller_tolerance'] = (((s as any).drugVars ?? {})['painkiller_tolerance'] ?? 0) - (2);
    } else {
      if (((s as any).drugVars ?? 0)?.['painkiller_tolerance'] > 0) {
        ((s as any).drugVars ?? {})['painkiller_tolerance'] = (((s as any).drugVars ?? {})['painkiller_tolerance'] ?? 0) - (1);
      } else {
        ((s as any).drugVars ?? {})['painkiller_tolerance'] = 0;
        ((s as any).drugVars ?? {})['painkiller_addict'] = 0;
        ((s as any).drugVars ?? {})['painkiller_need'] = 0;
      }
    }
  }
  if (((s as any).drugVars ?? 0)?.['painkiller_tolerance'] >= 30) {
    ((s as any).drugVars ?? {})['painkiller_addict'] = 1;
    if (((s as any).drugVars ?? 0)?.['painkiller_exp'] === 0) {
      ((s as any).drugVars ?? {})['painkiller_exp'] = 1;
    }
  }
  return;
  scene.build();
...
function enterPainkillerHourlyEvents(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['painkiller_points'] > 0) {
    ((s as any).drugVars ?? {})['painkiller_points'] = (((s as any).drugVars ?? {})['painkiller_points'] ?? 0) - (20);
    if (((s as any).drugVars ?? 0)?.['painkiller_points'] < 0) {
      ((s as any).drugVars ?? {})['painkiller_points'] = 0;
    }
  }
  ...
  if (((s as any).drugVars ?? 0)?.['painkiller_points'] < 10) {
    ((s as any).drugVars ?? {})['painkiller_need'] = (((s as any).drugVars ?? {})['painkiller_need'] ?? 0) + (1);
    if (((s as any).drugVars ?? 0)?.['painkiller_need'] > 24) {
      ((s as any).drugVars ?? {})['painkiller_need'] = 24;
    }
    qspCall(s, 'mood', 'lower', 'tiny');
    if (((s as any).drugVars ?? 0)?.['painkiller_need'] >= 12) {
      qspCall(s, 'mood', 'lower', 'tiny');
    }
    ((s as any).pain ?? {})['head'] = (((s as any).pain ?? {})['head'] ?? 0) + (((s as any).drugVars ?? {})?.['painkiller_need'] / 6);
    ((s as any).pain ?? {})['tummy'] = (((s as any).pain ?? {})['tummy'] ?? 0) + (((s as any).drugVars ?? {})?.['painkiller_need'] / 6);
  } else {
    if (((s as any).drugVars ?? 0)?.['painkiller_need'] > 0) {
      ((s as any).drugVars ?? {})['painkiller_need'] = (((s as any).drugVars ?? {})['painkiller_need'] ?? 0) - (2);
      if (((s as any).drugVars ?? 0)?.['painkiller_need'] < 0) {
        ((s as any).drugVars ?? {})['painkiller_need'] = 0;
      }
    }
...
function enterPainkillerStat(s: GameState, scene: SceneBuilder): void {
  ((s as any).drugVars ?? {})['painkiller_weak'] = 0;
  if (((s as any).drugVars ?? 0)?.['painkiller_addict'] === 1  &&  ((s as any).drugVars ?? 0)?.['painkiller_points'] < 10) {
...
function enterAphrodisiac(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['aphrodisiac_overdose'] === 1) {
    ((s as any).drugVars ?? {})['aphrodisiac_msg'] = '<br>You\'ve had enough aphrodisiac for today.';
    return;
  }
  if (((s as any).locArgs?.[1] ?? 0) === 0  &&  ((s as any).locArgs?.[1] ?? 0) === '') {
    ((s as any).mc_inventory ?? {})['aphrodisiac'] = (((s as any).mc_inventory ?? {})['aphrodisiac'] ?? 0) - (1);
    if (((s as any).mc_inventory ?? 0)?.['aphrodisiac'] <= 0) {
      ((s as any).mc_inventory ?? {})['aphrodisiac'] = 0;
      // TODO-QSP: msg 'That was your last aphrodisiac pill.'
    }
  }
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ((s as any).drugVars ?? {})['aphrodisiac_used'] = (((s as any).drugVars ?? {})['aphrodisiac_used'] ?? 0) + (1);
  }
  if (((s as any).drugVars ?? 0)?.['aphrodisiac_timer'] <= 0) {
    ((s as any).drugVars ?? {})['aphrodisiac_msg'] = qspFunc(s, 'wrap', 'bimbo', '<br>You take a gum  &&  chew it. It tastes like strawberry, but is also kind of spicy.');
    ((s as any).drugVars ?? {})['aphrodisiac_timer'] = 8;
    (s as any).pcs_horny = 0;
  } else {
    if (((s as any).drugVars ?? 0)?.['aphrodisiac_timer'] >= 1  &&  ((s as any).drugVars ?? 0)?.['aphrodisiac_timer'] < 9) {
      ((s as any).drugVars ?? {})['aphrodisiac_msg'] = qspFunc(s, 'wrap', 'bimbo', '<br>You take another gum  &&  chew it. It makes your mouth feel kinda tingly.');
      ((s as any).drugVars ?? {})['aphrodisiac_timer'] = (((s as any).drugVars ?? {})['aphrodisiac_timer'] ?? 0) + (8);
      (s as any).pcs_horny = 0;
    } else {
      if (((s as any).min_arousal ?? 0) < 60) {
        ((s as any).drugVars ?? {})['aphrodisiac_msg'] = qspFunc(s, 'wrap', 'v_neg b', '<br>You take yet another gum  &&  start chewing it. Suddenly you find yourself in grip of an intense orgasm!<br>It goes on  &&  on  &&  you sink to the ground  &&  do your best to endure it.');
        ((s as any).drugVars ?? {})['aphrodisiac_overdose'] = 1;
        ...
        ((s as any).drugVars ?? {})['aphrodisiac_msg'] = qspFunc(s, 'wrap', 'bimbo', 'You chew another gum with trepidation, looking forward to more orgasms but nothing happens. Huh. Have you become immune?');
      }
    }
  }
  qspCall(s, 'stat', '');
...
function enterAphrodisiacCikl(s: GameState, scene: SceneBuilder): void {
  if (((s as any).drugVars ?? 0)?.['aphrodisiac_overdose'] === 1) {
    ((s as any).drugVars ?? {})['aphrodisiac_overdose'] = 0;
  }
...
function enterAphrodisiacHourlyEvents(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).drugVars ?? {})['aphrodisiac_timer'] = (((s as any).drugVars ?? {})['aphrodisiac_timer'] ?? 0) - (1);
...
function enterMentats(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === 0  &&  ((s as any).locArgs?.[1] ?? 0) === '') {
    ((s as any).mc_inventory ?? {})['mentats'] = (((s as any).mc_inventory ?? {})['mentats'] ?? 0) - (1);
    if (((s as any).mc_inventory ?? 0)?.['mentats'] <= 0) {
      ((s as any).mc_inventory ?? {})['mentats'] = 0;
      // TODO-QSP: msg 'That was your last neurobooster pill.'
    }
  }
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ((s as any).drugVars ?? {})['mentats_used'] = (((s as any).drugVars ?? {})['mentats_used'] ?? 0) + (1);
  }
...
function enterMentatsCikl(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).drugVars ?? 0)?.['mentats_dose'] === 1) {
    ((s as any).drugVars ?? {})['mentats_dose'] = 0;
  } else {
    if (((s as any).drugVars ?? 0)?.['mentats_dose'] > 1) {
      ((s as any).pain ?? {})['head'] = (((s as any).pain ?? {})['head'] ?? 0) + (20 * ((s as any).drugVars ?? {})?.['mentats_dose']);
      ((s as any).drugVars ?? {})['mentats_dose'] = 0;
    }
  }
  return;
...
function enterSteroids(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 0  &&  ((s as any).locArgs?.[1] ?? 0) === '') {
    ((s as any).mc_inventory ?? {})['steroids'] = (((s as any).mc_inventory ?? {})['steroids'] ?? 0) - (1);
    if (((s as any).mc_inventory ?? 0)?.['steroids'] <= 0) {
      ((s as any).mc_inventory ?? {})['steroids'] = 0;
      // TODO-QSP: msg 'That was your last steroid pill.'
    }
  }
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ((s as any).drugVars ?? {})['steroids_used'] = (((s as any).drugVars ?? {})['steroids_used'] ?? 0) + (1);
  }
...
function enterBreastcream(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 0  &&  ((s as any).locArgs?.[1] ?? 0) === '') {
    ((s as any).mc_inventory ?? {})['breastcream'] = (((s as any).mc_inventory ?? {})['breastcream'] ?? 0) - (1);
    if (((s as any).mc_inventory ?? 0)?.['breastcream'] <= 0) {
      ((s as any).mc_inventory ?? {})['breastcream'] = 0;
      // TODO-QSP: msg 'That was your last bit of breast cream.'
    }
  }
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ((s as any).drugVars ?? {})['breastcream_used'] = (((s as any).drugVars ?? {})['breastcream_used'] ?? 0) + (1);
  }
...
function enterHairExtensioncream(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 0  &&  ((s as any).locArgs?.[1] ?? 0) === '') {
    ((s as any).mc_inventory ?? {})['hair_extensioncream'] = (((s as any).mc_inventory ?? {})['hair_extensioncream'] ?? 0) - (1);
    if (((s as any).mc_inventory ?? 0)?.['hair_extensioncream'] <= 0) {
      ((s as any).mc_inventory ?? {})['hair_extensioncream'] = 0;
      // TODO-QSP: msg 'That was your last bit of hair extension shampoo.'
    }
  }
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ((s as any).drugVars ?? {})['hair_extensioncream_used'] = (((s as any).drugVars ?? {})['hair_extensioncream_used'] ?? 0) + (1);
  }
...
function enterHairExtensioncreamCikl(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).drugVars ?? {})['hair_extensioncream_dose'] = 0;
...
function enterButtInjection(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[1] ?? 0) === 0  &&  ((s as any).locArgs?.[1] ?? 0) === '') {
    ((s as any).mc_inventory ?? {})['butt_injection'] = (((s as any).mc_inventory ?? {})['butt_injection'] ?? 0) - (1);
    if (((s as any).mc_inventory ?? 0)?.['butt_injection'] <= 0) {
      ((s as any).mc_inventory ?? {})['butt_injection'] = 0;
      // TODO-QSP: msg 'That was your last KBI shot.'
    }
  }
  if (((s as any).cheatVars ?? 0)?.['drugs_immune'] === 0) {
    ((s as any).drugVars ?? {})['butt_injection_used'] = (((s as any).drugVars ?? {})['butt_injection_used'] ?? 0) + (1);
  }

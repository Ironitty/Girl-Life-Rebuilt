...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  // TODO-QSP: Thiness:      1-Thick    2-not particularly thick  3-thin      4-slightly transparent      5-semi-tr...
  ...
  // TODO-QSP: BraPrice ~ 2000 * (20 + BraQuality) / 20
...
export const _attributes_moncheri_bodysuits: LocationDef = {
  name: '_attributes_moncheri_bodysuits',
  region: 'other',
  enter: enter,
};

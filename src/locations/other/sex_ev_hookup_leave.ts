...
function enterIShouldGo(s: GameState, scene: SceneBuilder): void {
  if ((Math.floor(Math.random() * 20) + 1) < ((s as any).sex_ev ?? 0)?.['cum_count'] + ((s as any).sex_ev ?? 0)?.['extra_cum']) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['continuation'] = 1;
  }
...
function enterThanksForFun(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['sleepover'] === 1) {
    // TODO-QSP: dynamic text: "Thanks for the <<$sex_ev['fun']>> last night," you say, <<$sex_ev['dress_descri...
...
function enterKickedOutMenu(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat_cum_msg ?? 0) !== '') {
    ...
    if (((s as any).cum_loc ?? 0)?.['vagina'] > 0  ||  ((s as any).sex_ev ?? 0)?.['cum_choice'] === 'creampie') {
      if (((s as any).trait_vars ?? 0)?.['cum_addict'] > 0) {
        // TODO-QSP: dynamic text: <center><b><font color="maroon"><<$npcdesc>>'s Bedroom</font></b></center>
        scene.text(`<center><b><font color="maroon">${((s as any).npcdesc || '')}'s Bedroom</font></b></center>`);
        // TODO-QSP: $sex_ev['bed_room']
      ...
      if (((s as any).cum_loc ?? 0)?.['face'] > 0  ||  ((s as any).sex_ev ?? 0)?.['cum_choice'] === 'face') {
        // TODO-QSP: dynamic text: <center><b><font color="maroon"><<$npcdesc>>'s Bedroom</font></b></center>
        scene.text(`<center><b><font color="maroon">${((s as any).npcdesc || '')}'s Bedroom</font></b></center>`);
        // TODO-QSP: $sex_ev['bed_room']
        if (((s as any).mc_inventory ?? 0)?.['makeup_wipes'] > 0) {
          ...
          if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['wipes'] = 2;
        }
        if (((s as any).sex_ev ?? 0)?.['wipes'] === 2) {
        ...
        if (((s as any).cum_loc ?? 0)?.['stomach'] > 0  ||  ((s as any).sex_ev ?? 0)?.['cum_choice'] === 'stomach') {
          // TODO-QSP: dynamic text: <center><b><font color="maroon"><<$npcdesc>>'s Bedroom</font></b></center>
          scene.text(`<center><b><font color="maroon">${((s as any).npcdesc || '')}'s Bedroom</font></b></center>`);
          // TODO-QSP: $sex_ev['bed_room']
          if (((s as any).sex_ev ?? 0)?.['wipes'] === 2) {
          ...
          if (((s as any).cum_loc ?? 0)?.['butt'] > 0  ||  ((s as any).sex_ev ?? 0)?.['cum_choice'] === 'ass'  ||  ((s as any).sex_ev ?? 0)?.['cum_choice'] === 'back') {
            // TODO-QSP: dynamic text: <center><b><font color="maroon"><<$npcdesc>>'s Bedroom</font></b></center>
            scene.text(`<center><b><font color="maroon">${((s as any).npcdesc || '')}'s Bedroom</font></b></center>`);
            // TODO-QSP: $sex_ev['bed_room']
            if (((s as any).sex_ev ?? 0)?.['wipes'] === 2) {
    ...
    if (((s as any).sex_ev ?? 0)?.['get_out'] === 1) {
...
function enterHookupContinuation(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['type'] === 'hookup') {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['continuation'] = (Math.floor(Math.random() * (1 - (-1) + 1)) + ((-1)));
    if ((Math.floor(Math.random() * 10) + 1) > 5  &&  (((s as any).hour ?? 0) > 20  ||  ((s as any).hour ?? 0) < 4)  &&  ((s as any).npc_caretaker ?? 0)?.[String((s as any).npcID ?? 0)] > 0  &&  ((s as any).npc_girlfriend ?? 0)?.[String((s as any).npcID ?? 0)] === 0  &&  ((s as any).sex_ev ?? 0)?.['cant_stay'] === 0  &&  ((s as any).sex_ev ?? 0)?.['sleepover'] !== 1) {
      ...
      if (((s as any).sex_ev ?? 0)?.['continuation'] > 0  &&  ((s as any).sex_ev ?? 0)?.['mad'] < 1  &&  ((s as any).sex_ev ?? 0)?.['angry_after'] < 1) {
        if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['hookup_continuation_check'] = 1;
        ...
        if (((s as any).sex_ev ?? 0)?.['thank_for_fun'] === 1) {
          if (((s as any).sex_ev ?? 0)?.['bj_count'] > 0  &&  ((s as any).sex_ev ?? 0)?.['fuck_count'] < 1) {
            ...
            if (((s as any).sex_ev ?? 0)?.['fuck_count'] > 0) {
              // TODO-QSP: dynamic text: "Right back at you," he smirks in return while you're <<$sex_ev['dress_describe'...
          ...
          if (((s as any).sex_ev ?? 0)?.['hookup_continuation_first_pass'] === 0) {
            ...
            if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['hookup_continuation_first_pass'] = 1;
          }
          scene.actions([{ label: 'Continue', goto: ['sex_ev_leave', 'dressing2'] }]);
        }
      }
...
function enterSpendTheNight(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "Thanks but no thanks," you say, wistfully <<$sex_ev['dress_describe']>>. "I rea...
    scene.text(`"Thanks but no thanks," you say, wistfully ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "I really need to get home tonight."`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHookupContinuation(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ...
    scene.text(`You slip back into bed and cuddle up with ${((s as any).npcdesc || '')}, resting your naked body on top of his. He wraps his arms around you in return and the two of your relax, listening to the sound of each other's breathing.`);
    qspCall(s, 'sex_ev_after', 'sleep');
  } },
    ]);
  } },
    ]);
    ...
    scene.text(`"I wish I could but I really have to go," you say, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "Just not an option for me tonight."`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterHookupContinuation(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
  ]);
  scene.build();
...
function enterPcFuckbuddyRequest(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).sex_ev ?? 0)?.['cant_stay'] === 1) {
    // TODO-QSP: dynamic text: "Maybe we could hook up again some other time?" you ask, <<$sex_ev['dress_descri...
  ...
  scene.actions([
    ...
    if ((Math.floor(Math.random() * 3) + 1) === 1) {
      ...
      scene.text(`"Nah, this was a one time thing," ${((s as any).npcdesc || '')} replies. "I never fuck the same girl twice."`);
      ...
      scene.text(`<i>Free access to pussy and you're just gonna turn it down? Whatever...</i> you think to yourself, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}.`);
      // TODO-QSP: dynamic text: Once you're finished dressing, you grab your things and leave. <<$npcdesc>> does...
      scene.text(`Once you're finished dressing, you grab your things and leave. ${((s as any).npcdesc || '')} doesn't say a word as you close the door behind you.`);
    } else {
      ...
      scene.text(`"Why not?" you say, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}.`);
...
function enterPcDateRequest(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((Math.floor(Math.random() * 3) + 1) === 1) {
      ...
      scene.text(`<i>Wow... You can really pick em, huh ${((s as any).pcs_nickname || '')}?</i> you think to yourself ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. <i>Ugh. Whatever...</i>`);
      ...
      // TODO-QSP: dynamic text: For a moment you feel intensely awkward, <<$sex_ev['dress_describe']>> as you wa...
      scene.text(`For a moment you feel intensely awkward, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''} as you wait for his response, but when you turn to look at him he's smiling.`);
      ...
      scene.text('You tell him your number while you finished getting dressed and he taps it into his phone. A few moments later, a notification pings in your messages:');
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['text_message'] = Math.floor(Math.random() * 2) + 1;
...
function enterNpcFuckbuddyRequest(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "Like what?" you ask back, <<$sex_ev['dress_describe']>>. "Friends with benefits...
    scene.text(`"Like what?" you ask back, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "Friends with benefits? Fuckbuddies? Booty callers? No strings attached?"`);
    ...
    scene.text(`"Sure, sounds fun," you smile, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}.`);
...
function enterNpcDateRequest(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "I'm not looking for anything serious right now," you say, more than a little aw...
    scene.text(`"I'm not looking for anything serious right now," you say, more than a little awkwardly as you're ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}.`);
    scene.actions([
    ...
    scene.text(`"Oh. Uhh, well, it's fine I guess..." ${((s as any).npcdesc || '')} trails off and you're left in an extremely uncomfortable silence while you ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}.`);
    ...
    scene.text(`"If it were something purely physical, like fuckbuddies or something," you say, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "I wouldn't mind getting together for some fun, but I'm not interested in a boyfriend."`);
    ...
    qspCall(s, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: You nod to yourself, continuing <<$sex_ev['dress_describe']>>. It's to be expect...
    scene.text(`You nod to yourself, continuing ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. It's to be expected from a guy like him. But if he wants something more, you just can't give it to him. You're only after pleasure, you don't want to get tangled up in a relationship.`);
    ...
    qspCall(s, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: You blink in surprise, stopping halfway through <<$sex_ev['dress_describe']>>. T...
    scene.text(`You blink in surprise, stopping halfway through ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. That response really wasn't what you saw coming. After all, what guy just gives up free access to sex?`);
...
function enterNpcSugarDaddyOffer(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['sugar_daddy_offer'] = Math.floor(Math.random() * 11) + 10;
  if (((s as any).sex_ev ?? 0)?.['thank_for_fun'] === 1) {
    ...
    qspCall(s, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "Just saying it," you shrug, <<$sex_ev['dress_describe']>>. "If I'm being honest...
    scene.text(`"Just saying it," you shrug, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "If I'm being honest, this wasn't anything special. But I thought I'd try to be polite."`);
    qspCall(s, 'sex_ev_hookup_leave', 'npc_sugar_daddy_offer2');
  } },
      { label: 'Just saying (teasing)', handler: (st: GameState) => {
    qspCall(s, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "Just saying," you say, <<$sex_ev['dress_describe']>> with a teasing smirk. "I w...
    scene.text(`"Just saying," you say, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''} with a teasing smirk. "I was trying to be nice."`);
    qspCall(s, 'sex_ev_hookup_leave', 'npc_sugar_daddy_offer2');
  } },
      { label: 'You mean it', handler: (st: GameState) => {
    qspCall(s, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "No really," you smirk, <<$sex_ev['dress_describe']>>. "It was a good time."
    scene.text(`"No really," you smirk, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "It was a good time."`);
    qspCall(s, 'sex_ev_hookup_leave', 'npc_sugar_daddy_offer2');
  } },
    ]);
  } else {
    ...
    scene.text(`"I'm not a hooker," you say, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}.`);
    // TODO-QSP: dynamic text: "I didn't say you were," <<$npcdesc>> snickers back. "Don't think of it that way...
    scene.text(`"I didn't say you were," ${((s as any).npcdesc || '')} snickers back. "Don't think of it that way. Think of it more like... a sugar daddy relationship. Will you let me be your daddy?"`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNpcSugarDaddyRefuse(s, scene); (s as any).locArgs = __savedLocArgs; }
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNpcSugarDaddyHowMuch(s, scene); (s as any).locArgs = __savedLocArgs; }
  } },
    ]);
  }
...
function enterNpcSugarDaddyRefuse(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Please," you scoff, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "You can't afford me."`);
...
function enterNpcSugarDaddyHowMuch(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Depends," you muse, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "How much are we talking?"`);
    // TODO-QSP: dynamic text: "How about... <<$func('money', 'string_profit', sex_ev['sugar_daddy_offer'] * 10...
    scene.text(`"How about... ${qspFunc(s, 'money', 'string_profit', (((s as any).sex_ev ?? {})?.['sugar_daddy_offer'] ?? 0) * 100, 1)} a date?"`);
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNpcSugarDaddyRefuse(s, scene); (s as any).locArgs = __savedLocArgs; }
...
function enterNpcSugarDaddyAccept(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"I'll look forward to the next time you come over then," ${((s as any).npcdesc || '')} smirks. "Give me your number so I can tell you when to come over.`);
...
function enterNpcSugarDaddyHaggle(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['sugar_daddy_input'] = 0;
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['sugar_daddy_counteroffer'] = qspFunc(s, 'money', 'base_profit', ((s as any).sex_ev ?? 0)?.['sugar_daddy_input']) / 100;
    if (((s as any).sex_ev ?? 0)?.['sugar_daddy_counteroffer'] > 50  ||  ((s as any).sex_ev ?? 0)?.['sugar_daddy_counteroffer'] < 10) {
      ...
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNpcSugarDaddyHaggle2(s, scene); (s as any).locArgs = __savedLocArgs; }
    }
  } },
  ]);
  scene.build();
...
function enterNpcSugarDaddyHaggle2(s: GameState, scene: SceneBuilder): void {
  qspCall(s, 'sex_ev_clothing', 'dress_loop');
  if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_limit'] = qspFunc(s, 'sex_ev_stats', 'sugar_daddy_haggle_limit');
  if (((s as any).sex_ev ?? 0)?.['sugar_daddy_counteroffer'] === ((s as any).sex_ev ?? 0)?.['sugar_daddy_offer']) {
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNpcSugarDaddyAccept(s, scene); (s as any).locArgs = __savedLocArgs; }
  } else {
    if (((s as any).sex_ev ?? 0)?.['sugar_daddy_counteroffer'] < ((s as any).sex_ev ?? 0)?.['sugar_daddy_offer']) {
      if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['sugar_daddy_offer'] = ((s as any).sex_ev ?? 0)?.['sugar_daddy_counteroffer'];
      qspCall(s, 'sex_ev_stats', 'sugar_daddy_add');
      // TODO-QSP: dynamic text: "Why don't we say <<$func('money', 'string_profit', sex_ev['sugar_daddy_countero...
      ...
      if (((s as any).sex_ev ?? 0)?.['sugar_daddy_counteroffer'] > ((s as any).sex_ev ?? 0)?.['haggle_limit']) {
        if (((s as any).sex_ev ?? 0)?.['haggle_fail'] === 1) {
          ...
          // TODO-QSP: dynamic text: "How about <<$func('money', 'string_profit', sex_ev['sugar_daddy_counteroffer'] ...
          ...
          if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['haggle_fail'] = 1;
          { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNpcSugarDaddyHaggle(s, scene); (s as any).locArgs = __savedLocArgs; }
        }
      } else {
        if ((Math.floor(Math.random() * (((s as any).pcs_persuas ?? 0) - 1 + 1)) + (1)) > ((s as any).npc_willpower ?? 0)?.[String((s as any).npcID ?? 0)]  ||  ((s as any).sex_ev ?? 0)?.['sugar_daddy_counteroffer'] < ((s as any).sex_ev ?? 0)?.['sugar_daddy_offer'] + 2) {
          if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['sugar_daddy_offer'] = ((s as any).sex_ev ?? 0)?.['sugar_daddy_counteroffer'];
          qspCall(s, 'sex_ev_stats', 'sugar_daddy_add');
          // TODO-QSP: dynamic text: "Why don't we say... <<$func('money', 'string_profit', sex_ev['sugar_daddy_count...
          ...
          if (((s as any).sex_ev ?? 0)?.['haggle_fail'] === 1) {
            ...
            if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['sugar_daddy_offer'] = ((s as any).sex_ev['sugar_daddy_offer'] ?? 0) + (Math.floor(Math.random() * 2) + 1);
            // TODO-QSP: dynamic text: "How about... <<$func('money', 'string_profit', sex_ev['sugar_daddy_counteroffer...
...
function enterJustAHookup(s: GameState, scene: SceneBuilder): void {
  if (((s as any).hour ?? 0) >= 20  ||  ((s as any).hour ?? 0) <= 9) {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['just_a'] = 'one night stand';
  } else {
    if (!(s as any).sex_ev) (s as any).sex_ev = {}; (s as any).sex_ev['just_a'] = 'random hookup';
  }
  // TODO-QSP: end
  scene.actions([
    { label: 'This was a <<$sex_ev[\'just_a\']>>', handler: (st: GameState) => {
    qspCall(s, 'sex_ev_clothing', 'dress_loop');
    // TODO-QSP: dynamic text: "No," you shake your head, <<$sex_ev['dress_describe']>>. "This was just a <<$se...
    scene.text(`"No," you shake your head, ${((s as any).sex_ev ?? 0)?.['dress_describe'] ?? ''}. "This was just a ${((s as any).sex_ev ?? 0)?.['just_a'] ?? ''}. I'm not looking for anything lasting."`);
    if (((s as any).sex_ev ?? 0)?.['continuation'] === 1) {
      ...
      if (((s as any).sex_ev ?? 0)?.['continuation'] === 2) {
...
function enterHaveABoyfriend(s: GameState, scene: SceneBuilder): void {
  if (((s as any).stat ?? 0)?.['boyfriends_current'] > 0) {
    ...
    if (((s as any).sex_ev ?? 0)?.['sugar_daddy_offer'] > 0) {
      ...
      scene.text(`"So?" ${((s as any).npcdesc || '')} grins shamelessly. "Does that change the value of the money?"`);
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNpcSugarDaddyRefuse(s, scene); (s as any).locArgs = __savedLocArgs; }
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNpcSugarDaddyHowMuch(s, scene); (s as any).locArgs = __savedLocArgs; }
      scene.actions([
    ...
    { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', ]; enterNpcSugarDaddyAccept(s, scene); (s as any).locArgs = __savedLocArgs; }
      ...
      if (((s as any).npc_fidelity_num ?? 0)?.[String((s as any).npcID ?? 0)] <= 5) {
        if (((s as any).npc_girlfriend ?? 0)?.[String((s as any).npcID ?? 0)] === 1  &&  ((s as any).npc_goal ?? 0)?.[String((s as any).npcID ?? 0)] === 1) {

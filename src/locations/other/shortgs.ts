...
function enterSqrt(s: GameState, scene: SceneBuilder): void {
  (s as any).result = qspFunc(s, 'math', 'int_sqrt', qspUntranslated(s, "ARGS[1]", { location: "shortgs" }));
  // TODO-QSP: end
  scene.build();
}

function enterModul(s: GameState, scene: SceneBuilder): void {
  (s as any).modul_sum = ((s as any).ARGS ?? 0)[1]*((s as any).ARGS ?? 0)[1] + ((s as any).ARGS ?? 0)[2]*((s as any).ARGS ?? 0)[2] + ((s as any).ARGS ?? 0)[3]*((s as any).ARGS ?? 0)[3] + ((s as any).ARGS ?? 0)[4]*((s as any).ARGS ?? 0)[4] + ((s as any).ARGS ?? 0)[5]*((s as any).ARGS ?? 0)[5] + ((s as any).ARGS ?? 0)[6]*((s as any).ARGS ?? 0)[6] + ((s as any).ARGS ?? 0)[7]*((s as any).ARGS ?? 0)[7] + ((s as any).ARGS ?? 0)[8]*((s as any).ARGS ?? 0)[8];
...
function enterDow(s: GameState, scene: SceneBuilder): void {
  (s as any).Y_dow = qspUntranslated(s, "ARGS[1]", { location: "shortgs" });
  (s as any).M_dow = qspUntranslated(s, "ARGS[2]", { location: "shortgs" });
  (s as any).D_dow = qspUntranslated(s, "ARGS[3]", { location: "shortgs" });
  if ((!((s as any).Y_dow ?? 0))) {
...
function enterDoy(s: GameState, scene: SceneBuilder): void {
  (s as any).Y_doy = qspUntranslated(s, "ARGS[1]", { location: "shortgs" });
  (s as any).M_doy = qspUntranslated(s, "ARGS[2]", { location: "shortgs" });
  (s as any).D_doy = qspUntranslated(s, "ARGS[3]", { location: "shortgs" });
  if ((!((s as any).Y_doy ?? 0))) {
...
function enterReplaceHeader(s: GameState, scene: SceneBuilder): void {
  (s as any).RH_Count = qspUntranslated(s, "ARGS[2]", { location: "shortgs" });
  // TODO-QSP: :RH_label
  (s as any).RH_temp_lenght = qspUntranslated(s, "len(RH_temp)", { location: "shortgs" });
  (s as any).RH_temp_LFpos = qspUntranslated(s, "instr(RH_temp, '\\n')", { location: "shortgs" });
...
function enterRoundDivide(s: GameState, scene: SceneBuilder): void {
  (s as any).result = qspFunc(s, 'math', 'int_divide', qspUntranslated(s, "ARGS[1]", { location: "shortgs" }), qspUntranslated(s, "ARGS[2]", { location: "shortgs" }));
  return;
  // TODO-QSP: end
  scene.build();
}
...
function enterRoundTool(s: GameState, scene: SceneBuilder): void {
  (s as any).result = qspFunc(s, 'math', 'int_round', qspUntranslated(s, "ARGS[1]", { location: "shortgs" }), qspUntranslated(s, "ARGS[2]", { location: "shortgs" }));
  return;
  // TODO-QSP: end
  scene.build();
}
...
function enterPayments(s: GameState, scene: SceneBuilder): void {
  ...
  if ((((s as any).epayments ?? 0)?.['method'] !== 'cash'  &&  ((s as any).epayments ?? 0)?.['method'] !== 'card')  &&  (((s as any).epayments ?? 0)?.['value'] <= ((s as any).money ?? 0)  &&  ((s as any).epayments ?? 0)?.['value'] <= ((s as any).karta ?? 0))) {
    ...
    scene.text(`How do you want to pay for the ${((s as any).epayments ?? 0)?.['description']}? ${((s as any).construct_cash ?? 0)} or ${((s as any).construct_card ?? 0)}`);
  } else {
    if ((((s as any).epayments ?? 0)?.['method'] === 'cash'  ||  ((s as any).epayments ?? 0)?.['method'] === '')  &&  ((s as any).epayments ?? 0)?.['value'] <= ((s as any).money ?? 0)) {
      ...
      scene.text(`Pay for the ${((s as any).epayments ?? 0)?.['description']} with ${((s as any).construct_cash ?? 0)}?`);
    } else {
      if ((((s as any).epayments ?? 0)?.['method'] === 'card'  ||  ((s as any).epayments ?? 0)?.['method'] === '')  &&  ((s as any).epayments ?? 0)?.['value'] <= ((s as any).karta ?? 0)) {
        ...
        scene.text(`Pay for the ${((s as any).epayments ?? 0)?.['description']} with your ${((s as any).construct_card ?? 0)}?`);
      } else {
...
function enterCalendarDisplay(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text(`<b>${((s as any).monthName ?? 0)} ${((s as any).day ?? 0)}</b>`);
  // TODO-QSP: dynamic text: <b><<$weekName>></b>
  scene.text(`<b>${((s as any).weekName ?? 0)}</b>`);
...
function enterRoll(s: GameState, scene: SceneBuilder): void {
  (s as any).result = qspFunc(s, 'random', 'roll', ((s as any).locArgs?.[1] ?? 0), qspUntranslated(s, "ARGS[2]", { location: "shortgs" }), qspUntranslated(s, "ARGS[3]", { location: "shortgs" }));
  return;
  // TODO-QSP: end
  scene.build();
}
...
function enterClamp(s: GameState, scene: SceneBuilder): void {
  (s as any).result = qspFunc(s, 'math', 'int_clamp', qspUntranslated(s, "ARGS[1]", { location: "shortgs" }), qspUntranslated(s, "ARGS[2]", { location: "shortgs" }), qspUntranslated(s, "ARGS[3]", { location: "shortgs" }));
  return;
  // TODO-QSP: end
  scene.build();
}
...
function enterSetStat(s: GameState, scene: SceneBuilder): void {
  (s as any).temp_input = qspFunc(s, 'shortgs', 'clamp', qspUntranslated(s, "ARGS[2]", { location: "shortgs" }), 0, 100);
...
function enterRgbToHex(s: GameState, scene: SceneBuilder): void {
  (s as any).temp_input = qspUntranslated(s, "ARGS[1]", { location: "shortgs" });
...
function enterInvertColor(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[2] ?? 0) === 'bw') {
    ...
    (s as any).shortgs_r_int = 255 - qspFunc(s, 'shortgs', 'hex_str_to_int', 0);
    (s as any).shortgs_g_int = 255 - qspFunc(s, 'shortgs', 'hex_str_to_int', 0);
    (s as any).shortgs_b_int = 255 - qspFunc(s, 'shortgs', 'hex_str_to_int', 0);
  }
  return;
  // TODO-QSP: end
  scene.build();
...
function enterColorIsDark(s: GameState, scene: SceneBuilder): void {
  // TODO-QSP: $ARGS[1] = ucase(replace(trim($ARGS[1]), '#'))
  (s as any).shortgs_cid_r = qspFunc(s, 'shortgs', 'hex_str_to_int', 0);
  (s as any).shortgs_cid_g = qspFunc(s, 'shortgs', 'hex_str_to_int', 0);
  (s as any).shortgs_cid_b = qspFunc(s, 'shortgs', 'hex_str_to_int', 0);
...
function enterGetNumberSuffix(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) < 0) {
    (s as any).query_number = (-((s as any).ARGS ?? 0)[1]) % 100;
  } else {
    (s as any).query_number = ((s as any).ARGS ?? 0)[1] % 100;
  }
...
function enterUnitString(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[2] ?? 0) === 1) {
    (s as any).metric_value = qspUntranslated(s, "ARGS[1]", { location: "shortgs" });
    ...
    if (((s as any).locArgs?.[1] ?? 0) < 100) {
      ...
      if (((s as any).locArgs?.[1] ?? 0) % 100 === 0) {
        ...
        (s as any).metervalue = ((s as any).ARGS ?? 0)[1] / 100;
        (s as any).meterdecimal = ((s as any).ARGS ?? 0)[1] % 100;
      }
    }
  }
  return;
...
function enterNum2txt(s: GameState, scene: SceneBuilder): void {
  if (((s as any).locArgs?.[1] ?? 0) === '') {
    (s as any).num = qspUntranslated(s, "ARGS[1]", { location: "shortgs" });
  } else {
    if (!isNaN(((s as any).locArgs?.[1] ?? 0)) && ((s as any).locArgs?.[1] ?? 0) !== '') {
      (s as any).num = qspUntranslated(s, "val(ARGS[1])", { location: "shortgs" });
    } else {
      return;
    }
  }

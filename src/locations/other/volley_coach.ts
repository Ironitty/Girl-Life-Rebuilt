...
function enterMassageRoom(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).clothingworntype ?? 0) === 'nude') {
    scene.text('Your <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027volley_coach\\u0027, \\u0027massage_redress\\u0027); return false;">clothes</a> are in a pile on the floor next to the massage table.');
  }
  // TODO-QSP: end
  scene.actions([
...
function enterCoachTalkMenu(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).daystart ?? 0) > ((s as any).vballVars ?? 0)?.['last_lovetalk']) {
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['last_lovetalk'] = ((s as any).daystart ?? 0);
    scene.img('images/characters/pavlovsk/school/teacher/mikhail/volleytrener6.jpg');
    if (((s as any).vballVars ?? 0)?.['coach_speak'] < 1) {
      ((s as any).vballVars = (s as any).vballVars ?? {})['coach_speak'] = 1;
    }
  ...
  if (((s as any).npc_rel ?? 0)?.['A69'] >= 60) {
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['trainer_home'] = 1;
    scene.img('images/characters/pavlovsk/school/teacher/mikhail/volleytrener6.jpg');
    ...
    scene.img('images/characters/pavlovsk/school/teacher/mikhail/volleytrener6.jpg');
    ((s as any).vballVars = (s as any).vballVars ?? {})['coach_wife'] = 1;
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['ask_coach_wife'] = ((s as any).daystart ?? 0);
    scene.img('images/characters/pavlovsk/school/teacher/mikhail/volleytrener6.jpg');
    if (((s as any).vballVars ?? 0)?.['coach_speak'] < 2) {
      ((s as any).vballVars = (s as any).vballVars ?? {})['coach_speak'] = 2;
    }
    ((s as any).vballVars = (s as any).vballVars ?? {})['coach_wife'] = 2;
    ...
    if (((s as any).vballVars ?? 0)?.['coach_speak'] < 3) {
      ((s as any).vballVars = (s as any).vballVars ?? {})['coach_speak'] = 3;
    }
  ...
  if (((s as any).vballVars ?? 0)?.['coach_speak'] >= 3  &&  ((s as any).daystart ?? 0) > ((s as any).vballVars ?? 0)?.['last_flirt']) {
    ...
    scene.img('images/characters/pavlovsk/school/teacher/mikhail/volleytrener6.jpg');
    ((s as any).vballVars = (s as any).vballVars ?? {})['last_flirt'] = ((s as any).daystart ?? 0);
    ((s as any).vballVars = (s as any).vballVars ?? {})['coach_lust'] = ((s as any).vballVars['coach_lust'] ?? 0) + (Math.floor(Math.random() * 3) + 1);
    if (((s as any).vballVars ?? 0)?.['coach_speak'] < 4) {
      ((s as any).vballVars = (s as any).vballVars ?? {})['coach_speak'] = 4;
    }
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['coach_tanga'] = 1;
    scene.actions([
  ...
  if (((s as any).vballVars ?? 0)?.['coach_speak'] >= 4  &&  ((s as any).ShowerIvan ?? 0) >= 3  &&  ((s as any).centr ?? 0) === 0  &&  ((s as any).daystart ?? 0) > ((s as any).vballVars ?? 0)?.['last_seduce']) {
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['last_seduce'] = ((s as any).daystart ?? 0);
  ...
  if (((s as any).daystart ?? 0) > ((s as any).vballVars ?? 0)?.['last_ask_massage']) {
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['last_ask_massage'] = ((s as any).daystart ?? 0);
    ((s as any).vballVars = (s as any).vballVars ?? {})['coach_lust'] = ((s as any).vballVars['coach_lust'] ?? 0) + (Math.floor(Math.random() * 3) + 1);
    scene.img('images/characters/pavlovsk/school/teacher/mikhail/volleytrener6.jpg');
    if (((s as any).vballVars ?? 0)?.['coachsex'] < 1) {
...
function enterJoinTeam1(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).vballVars ?? 0)?.['on_team'] === 0) {
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['ask_join_team'] = ((s as any).daystart ?? 0);
    ...
    qspCall(s, 'stat', '');
    if (((s as any).npc_rel ?? 0)?.['A69'] >= 60) {
      ((s as any).vballVars = (s as any).vballVars ?? {})['on_team'] = 1;
      ((s as any).vballVars = (s as any).vballVars ?? {})['sub_player'] = 1;
...
function enterLariskaJoin(s: GameState, scene: SceneBuilder): void {
  if (((s as any).vballVars ?? 0)?.['lariska_team'] === 0  &&  ((s as any).lariskaQW ?? 0)?.['join_team'] > 0) {
    ...
    // TODO-QSP: $func('wrap', 'neg', '<br>You and Lariska tried to persuade ...
          ...
          scene.actions([
            { label: 'Convince Mikhail to let Lariska play', handler: (st: GameState) => {
    ((s as any).vballVars = (s as any).vballVars ?? {})['lariska_team'] = 1;
    ...
    ((s as any).lariskaQW = (s as any).lariskaQW ?? {})['join_team'] = 0;
    scene.actions([
      { label: 'Leave', goto: ['gdksport', 'start'] },
    ]);
  } },
...
function enterNormalMassage1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['coach_massage'] = ((s as any).vballVars['coach_massage'] ?? 0) + (1);
    ...
    if (((s as any).vballVars ?? 0)?.['coach_massage'] === 1) {
      ...
      if (((s as any).vballVars ?? 0)?.['orgasm'] < ((s as any).orgasm ?? 0)) {
        ((s as any).vballVars = (s as any).vballVars ?? {})['coach_mass_orgasm'] = ((s as any).vballVars['coach_mass_orgasm'] ?? 0) + (1);
      ...
      if (((s as any).vballVars ?? 0)?.['coach_massage'] <= 4) {
        ...
        if (((s as any).vballVars ?? 0)?.['coach_massage'] === 5) {
          ...
          scene.text('You allow your eyes to roll back as you relax into sensual bliss.');
          (s as any).orgasm_txt = 'Under ' + ((s as any).npc_nickname ?? 0)?.['A69'] + '\'s magic touch, you find yourself gasping in orgasm in no time at all.';
          qspCall(s, 'arousal', 'foreplay', (-15));
          scene.actions([
            { label: 'Finish', goto: ['volley_coach', 'cloth_massage_end'] },
          ]);
...
function enterNudeMassageStart1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['massage_react'] = 'relaxed';
...
function enterPussyTouch(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    (s as any).orgasm_txt = 'A loud groan erupts from your mouth as your body shudders in climax, hips bucking up into the air, legs spasming uncontrollably. Coach is relentless, not pausing for a single moment, continuing to rub, tease, and finger your pussy through your entire orgasm.';
    (s as any).orgasm_or = 'custom';
    qspCall(s, 'arousal', 'clit_finger', 1);
    qspCall(s, 'stat', '');
...
function enterAfterMassageBj2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['sex_pos'] = 'blowjob';
...
function enterReliefOffer(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).vballVars = (s as any).vballVars ?? {})['last_relief'] = ((s as any).daystart ?? 0);
    scene.img('images/locations/pavlovsk/community/gym/volley_coach/massage_room.jpg');
    ...
    scene.img('images/locations/pavlovsk/community/gym/volley_coach/massage_room.jpg');
    ((s as any).vballVars = (s as any).vballVars ?? {})['coach_lust'] = ((s as any).vballVars['coach_lust'] ?? 0) + (20);
...
function enterReliefHandjob1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).vballVars ?? 0)?.['coachsex'] < 3) {
      ((s as any).vballVars = (s as any).vballVars ?? {})['coachsex'] = 3;
    }
    qspCall(s, 'arousal', 'kiss', 3);
    qspCall(s, 'arousal', 'hj', Math.floor(Math.random() * 3) + 3);
    ((s as any).vballVars = (s as any).vballVars ?? {})['sex_pos'] = 'handjob';
...
function enterReliefBlowjob1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).vballVars ?? 0)?.['coachsex'] < 4) {
      ((s as any).vballVars = (s as any).vballVars ?? {})['coachsex'] = 4;
    }
    ((s as any).vballVars = (s as any).vballVars ?? {})['sex_pos'] = 'blowjob';
...
function enterSeduceCoach1(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    ((s as any).npc_rel = (s as any).npc_rel ?? {})['A69'] = ((s as any).npc_rel['A69'] ?? 0) + (3);
...
function enterMassageFuckEnd(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((s as any).vballVars ?? 0)?.['coachsex'] < 6) {
      ((s as any).vballVars = (s as any).vballVars ?? {})['coachsex'] = 6;
    }
    scene.img('images/locations/pavlovsk/community/gym/volley_coach/massage_room.jpg');
...
function enterGetSoGood(s: GameState, scene: SceneBuilder): void {
  if (((s as any).sex_ev ?? 0)?.['get_so_good'] === 0) {
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    ((s as any).sex_ev = (s as any).sex_ev ?? {})['get_so_good'] = 1;
    qspCall(s, 'stat', '');
    scene.img('images/shared/sex/massage/after2.jpg');
    if (((s as any).vballVars ?? 0)?.['orgasm'] === ((s as any).orgasm ?? 0)) {

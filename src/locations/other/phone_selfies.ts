...
function enterPhoneSelfieTotals(s: GameState, scene: SceneBuilder): void {
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[0] = 'misc';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[0] = 'Me';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[0] = 'phone_selfie';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[1] = 'bathroom';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[1] = 'Bathroom';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[1] = '';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[2] = 'bedroom';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[2] = 'Bedroom';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[2] = '';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[3] = 'kitchen';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[3] = 'Kitchen';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[3] = '';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[4] = 'livingroom';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[4] = 'Livingroom';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[4] = '';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[5] = 'changingroom';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[5] = 'Changingroom';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[5] = '';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[6] = 'park';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[6] = 'Park';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[6] = '';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[7] = 'locker';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[7] = 'locker';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[7] = '';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[8] = 'beach';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[8] = 'Beach';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[8] = '';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[9] = 'school_classroom';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[9] = 'School Classroom';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[9] = '';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[10] = 'school_bathroom';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[10] = 'School Bathroom';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[10] = '';
  ...
  ((s as any).selfieLoc = (s as any).selfieLoc ?? {})[11] = 'restroom';
  ((s as any).selfieLocDesc = (s as any).selfieLocDesc ?? {})[11] = 'Restroom';
  ((s as any).selfieFilePrefix = (s as any).selfieFilePrefix ?? {})[11] = '';
...
function enterOpenCamera(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).result = ((s as any).result ?? 0) + ('<a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027camera_take_selfie\u0027, (((s as any).phone_loc ?? 0)?.[\u0027class\u0027] ?? \u0027\u0027)); return false;"><b>Take a selfie</b></a><br>');
  if (((s as any).clothingworntype ?? 0) !== 'nude'  &&  ((s as any).phone_loc ?? 0)?.['class'] !== ''  &&  ((s as any).phone_loc ?? 0)?.['class'] !== 'misc') {
    if (((s as any).pcs_inhib ?? 0) >= 35  ||  ((s as any).trait_vars ?? 0)?.['exhibitionist'] > 0  ||  ((s as any).phone_loc ?? 0)?.['type'] === 'private') {
      if (((s as any).selfieTitFlashTot ?? 0)?.[String((s as any).locIndex ?? 0)] > 0) {
        (s as any).result = ((s as any).result ?? 0) + ('<a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027camera_take_selfie\u0027, (((s as any).phone_loc ?? 0)?.[\u0027class\u0027] ?? \u0027\u0027)); return false;"><b>Flash your tits for a selfie</b></a><br>');
      }
      if (((s as any).trait_vars ?? 0)?.['exhibitionist'] > 0  &&  ((s as any).selfieAssFlashTot ?? 0)?.[String((s as any).locIndex ?? 0)] > 0) {
        (s as any).result = ((s as any).result ?? 0) + ('<a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027camera_take_selfie\u0027, (((s as any).phone_loc ?? 0)?.[\u0027class\u0027] ?? \u0027\u0027)); return false;"><b>Flash your ass for a selfie</b></a><br>');
      }
      if (((s as any).trait_vars ?? 0)?.['exhibitionist'] > 1  &&  ((s as any).selfiePussyFlashTot ?? 0)?.[String((s as any).locIndex ?? 0)] > 0) {
        (s as any).result = ((s as any).result ?? 0) + ('<a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027camera_take_selfie\u0027, (((s as any).phone_loc ?? 0)?.[\u0027class\u0027] ?? \u0027\u0027)); return false;"><b>Flash your pussy for a selfie</b></a><br>');
      }
    }
  }
  (s as any).locIndex = undefined;
  return;
  scene.build();
}
...
function enterCameraTakeSelfie(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).cfg_vars ?? 0)?.['use_popups'] === 1) {
    alert('<img src="' + ((s as any).temp_phone_img ?? 0) + '">');
  } else {
    s.viewImage = (s as any).temp_phone_img;
  }
  (s as any).temp_phone_img = undefined;
  return;
  scene.build();
}
...
function enterGetSelfieLayout(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).result = ((s as any).result ?? 0) + ('<table><tr><th>Selfies</th></tr>');
  (s as any).temp_locationCnt = 0;
  do {
    (s as any).result = ((s as any).result ?? 0) + ('<tr><td><a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027showlocation\u0027, String((s as any).temp_locationCnt ?? \u0027\u0027)); return false;">' + (((s as any).selfieLocDesc ?? 0)?.[String((s as any).temp_locationCnt ?? 0)] ?? 0) + ' selfies</a></td></tr>');
    (s as any).temp_locationCnt = ((s as any).temp_locationCnt ?? 0) + (1);
    if ((!((s as any).temp_suppress_other_selfies ?? 0))) {
      (s as any).result = ((s as any).result ?? 0) + ('<tr></tr><tr><th>Family and friends</th></tr>');
      (s as any).result = ((s as any).result ?? 0) + ('<tr><td><a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027family\u0027); return false;">Family</a></td></tr>');
      (s as any).result = ((s as any).result ?? 0) + ('<tr><td><a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027school\u0027); return false;">School friends</a></td></tr>');
      (s as any).result = ((s as any).result ?? 0) + ('<tr><td><a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027teacher\u0027); return false;">Teachers</a></td></tr>');
      (s as any).result = ((s as any).result ?? 0) + ('<tr><td><a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027pavlovsk\u0027); return false;">Pavlovsk friends</a></td></tr>');
      (s as any).result = ((s as any).result ?? 0) + ('<tr><td><a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027city\u0027); return false;">City friends</a></td></tr>');
    }
    (s as any).temp_locationCnt = undefined;
...
function enterListretrieve(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'phone_selfies', 'retrieve_clothed_selfies', ((s as any).locArgs?.[1] ?? 0), ((s as any).locArgs?.[2] ?? 0)));
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'phone_selfies', 'retrieve_swim_selfies', ((s as any).locArgs?.[1] ?? 0), ((s as any).locArgs?.[2] ?? 0)));
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'phone_selfies', 'retrieve_underwear_selfies', ((s as any).locArgs?.[1] ?? 0), ((s as any).locArgs?.[2] ?? 0)));
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'phone_selfies', 'retrieve_nude_selfies', ((s as any).locArgs?.[1] ?? 0), ((s as any).locArgs?.[2] ?? 0)));
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'phone_selfies', 'retrieve_bath_selfies', ((s as any).locArgs?.[1] ?? 0), ((s as any).locArgs?.[2] ?? 0)));
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'phone_selfies', 'retrieve_shower_selfies', ((s as any).locArgs?.[1] ?? 0), ((s as any).locArgs?.[2] ?? 0)));
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'phone_selfies', 'retrieve_titflash_selfies', ((s as any).locArgs?.[1] ?? 0), ((s as any).locArgs?.[2] ?? 0)));
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'phone_selfies', 'retrieve_assflash_selfies', ((s as any).locArgs?.[1] ?? 0), ((s as any).locArgs?.[2] ?? 0)));
  (s as any).result = ((s as any).result ?? 0) + (qspFunc(s, 'phone_selfies', 'retrieve_pussyflash_selfies', ((s as any).locArgs?.[1] ?? 0), ((s as any).locArgs?.[2] ?? 0)));
  (s as any).result = ((s as any).result ?? 0) + ('</table></center>');
  return;
  scene.build();
}
...
function enterRetrieveClothedSelfies(s: GameState, scene: SceneBuilder): void {
  if (((s as any).selfieCloTot ?? 0)[String((s as any).locArgs?.[1] ?? '')] > 0) {
    (s as any).result = ((s as any).result ?? 0) + ('<tr><th colspan=5>Clothed selfies</th></tr>');
    ...
    do {
      ...
      (s as any).result = ((s as any).result ?? 0) + ('</tr><tr></tr>');
      (s as any).temp_cnum = undefined;
      (s as any).temp_clocnt = undefined;
...
function enterRetrieveSwimSelfies(s: GameState, scene: SceneBuilder): void {
  if (((s as any).selfieSwimTot ?? 0)[String((s as any).locArgs?.[1] ?? '')] > 0) {
    (s as any).result = ((s as any).result ?? 0) + ('<tr><th colspan=5>Swimwear selfies</th></tr>');
    (s as any).result = ((s as any).result ?? 0) + ('<tr></tr><tr>');
    (s as any).temp_cnum = 0;
    ...
    do {
      ...
      if (((s as any).phone_locval ?? 0) === 1) {
        ...
        (s as any).result = ((s as any).result ?? 0) + ('<td width="20%">' + qspFunc(s, 'phone_selfies_popup', 'set_selfie', ((s as any).locArgs?.[2] ?? 0), 'bikini', ((s as any).locArgs?.[1] ?? 0), ((s as any).temp_swicnt ?? 0)) + '</td>');
        (s as any).temp_cnum = ((s as any).temp_cnum ?? 0) + (1);
      }
      ...
      (s as any).result = ((s as any).result ?? 0) + ('</tr><tr></tr>');
      (s as any).temp_cnum = undefined;
      (s as any).temp_swicnt = undefined;
...
function enterRetrieveUnderwearSelfies(s: GameState, scene: SceneBuilder): void {
  if (((s as any).selfieUndTot ?? 0)[String((s as any).locArgs?.[1] ?? '')] > 0) {
    (s as any).result = ((s as any).result ?? 0) + ('<tr><th colspan=5>Underwear selfies</th></tr>');
    (s as any).result = ((s as any).result ?? 0) + ('<tr></tr><tr>');
    (s as any).temp_cnum = 0;
    ...
    do {
      ...
      if (((s as any).phone_locval ?? 0) === 1) {
        ...
        (s as any).result = ((s as any).result ?? 0) + ('<td width="20%">' + qspFunc(s, 'phone_selfies_popup', 'set_selfie', ((s as any).locArgs?.[2] ?? 0), 'underwear', ((s as any).locArgs?.[1] ?? 0), ((s as any).temp_undcnt ?? 0)) + '</td>');
        (s as any).temp_cnum = ((s as any).temp_cnum ?? 0) + (1);
      }
      ...
      (s as any).result = ((s as any).result ?? 0) + ('</tr><tr></tr>');
      (s as any).temp_cnum = undefined;
      (s as any).temp_undcnt = undefined;
    } while (((s as any).temp_undcnt ?? 0) <= ((s as any).selfieUndTot ?? 0)[String((s as any).locArgs?.[1] ?? '')]);
  }
  return;
  scene.build();
}
...
function enterRetrieveNudeSelfies(s: GameState, scene: SceneBuilder): void {
  if (((s as any).selfieNudTot ?? 0)[String((s as any).locArgs?.[1] ?? '')] > 0) {
    (s as any).result = ((s as any).result ?? 0) + ('<tr><th colspan=5>Nude selfies</th></tr>');
    (s as any).result = ((s as any).result ?? 0) + ('<tr></tr><tr>');
    (s as any).temp_cnum = 0;
    ...
    do {
      ...
      if (((s as any).phone_locval ?? 0) === 1) {
        ...
        (s as any).result = ((s as any).result ?? 0) + ('<td width="20%">' + qspFunc(s, 'phone_selfies_popup', 'set_selfie', ((s as any).locArgs?.[2] ?? 0), 'nude', ((s as any).locArgs?.[1] ?? 0), ((s as any).temp_nudcnt ?? 0)) + '</td>');
        (s as any).temp_cnum = ((s as any).temp_cnum ?? 0) + (1);
      }
      ...
      (s as any).result = ((s as any).result ?? 0) + ('</tr><tr></tr>');
      (s as any).temp_cnum = undefined;
      (s as any).temp_nudcnt = undefined;
    } while (((s as any).temp_nudcnt ?? 0) <= ((s as any).selfieNudTot ?? 0)[String((s as any).locArgs?.[1] ?? '')]);
  }
  return;
  scene.build();
}
...
function enterRetrieveBathSelfies(s: GameState, scene: SceneBuilder): void {
  if (((s as any).selfieBathTot ?? 0)[String((s as any).locArgs?.[1] ?? '')] > 0) {
    (s as any).result = ((s as any).result ?? 0) + ('<tr><th colspan=5>Bath selfies</th></tr>');
    (s as any).result = ((s as any).result ?? 0) + ('<tr></tr><tr>');
    (s as any).temp_cnum = 0;
    ...
    do {
      ...
      if (((s as any).phone_locval ?? 0) === 1) {
        ...
        (s as any).result = ((s as any).result ?? 0) + ('<td width="20%">' + qspFunc(s, 'phone_selfies_popup', 'set_selfie', ((s as any).locArgs?.[2] ?? 0), 'bath', ((s as any).locArgs?.[1] ?? 0), ((s as any).temp_bathcnt ?? 0)) + '</td>');
        (s as any).temp_cnum = ((s as any).temp_cnum ?? 0) + (1);
      }
      ...
      (s as any).result = ((s as any).result ?? 0) + ('</tr><tr></tr>');
      (s as any).temp_cnum = undefined;
      (s as any).temp_bathcnt = undefined;
    } while (((s as any).temp_bathcnt ?? 0) <= ((s as any).selfieBathTot ?? 0)[String((s as any).locArgs?.[1] ?? '')]);
  }
  return;
  scene.build();
}
...
function enterRetrieveShowerSelfies(s: GameState, scene: SceneBuilder): void {
  if (((s as any).selfieShowerTot ?? 0)[String((s as any).locArgs?.[1] ?? '')] > 0) {
    (s as any).result = ((s as any).result ?? 0) + ('<tr><th colspan=5>Shower selfies</th></tr>');
    (s as any).result = ((s as any).result ?? 0) + ('<tr></tr><tr>');
    (s as any).temp_cnum = 0;
    ...
    do {
      ...
      if (((s as any).phone_locval ?? 0) === 1) {
        ...
        (s as any).result = ((s as any).result ?? 0) + ('<td width="20%">' + qspFunc(s, 'phone_selfies_popup', 'set_selfie', ((s as any).locArgs?.[2] ?? 0), 'shower', ((s as any).locArgs?.[1] ?? 0), ((s as any).temp_showercnt ?? 0)) + '</td>');
        (s as any).temp_cnum = ((s as any).temp_cnum ?? 0) + (1);
      }
      ...
      (s as any).result = ((s as any).result ?? 0) + ('</tr><tr></tr>');
      (s as any).temp_cnum = undefined;
      (s as any).temp_showercnt = undefined;
    } while (((s as any).temp_showercnt ?? 0) <= ((s as any).selfieShowerTot ?? 0)[String((s as any).locArgs?.[1] ?? '')]);
  }
  return;
  scene.build();
}
...
function enterRetrieveTitflashSelfies(s: GameState, scene: SceneBuilder): void {
  if (((s as any).selfieTitFlashTot ?? 0)[String((s as any).locArgs?.[1] ?? '')] > 0) {
    (s as any).result = ((s as any).result ?? 0) + ('<tr><th colspan=5>Flashing tits selfies</th></tr>');
    (s as any).result = ((s as any).result ?? 0) + ('<tr></tr><tr>');
    (s as any).temp_cnum = 0;
    ...
    do {
      ...
      if (((s as any).phone_locval ?? 0) === 1) {
        ...
        (s as any).result = ((s as any).result ?? 0) + ('<td width="20%">' + qspFunc(s, 'phone_selfies_popup', 'set_selfie', ((s as any).locArgs?.[2] ?? 0), 'titflash', ((s as any).locArgs?.[1] ?? 0), ((s as any).temp_flashtitscnt ?? 0)) + '</td>');
        (s as any).temp_cnum = ((s as any).temp_cnum ?? 0) + (1);
      }
      ...
      (s as any).result = ((s as any).result ?? 0) + ('</tr><tr></tr>');
      (s as any).temp_cnum = undefined;
      (s as any).temp_flashtitscnt = undefined;
    } while (((s as any).temp_flashtitscnt ?? 0) <= ((s as any).selfieTitFlashTot ?? 0)[String((s as any).locArgs?.[1] ?? '')]);
  }
  return;
  scene.build();
}
...
function enterRetrieveAssflashSelfies(s: GameState, scene: SceneBuilder): void {
  if (((s as any).selfieAssFlashTot ?? 0)[String((s as any).locArgs?.[1] ?? '')] > 0) {
    (s as any).result = ((s as any).result ?? 0) + ('<tr><th colspan=5>Flashing ass selfies</th></tr>');
    (s as any).result = ((s as any).result ?? 0) + ('<tr></tr><tr>');
    (s as any).temp_cnum = 0;
    ...
    do {
      ...
      if (((s as any).phone_locval ?? 0) === 1) {
        ...
        (s as any).result = ((s as any).result ?? 0) + ('<td width="20%">' + qspFunc(s, 'phone_selfies_popup', 'set_selfie', ((s as any).locArgs?.[2] ?? 0), 'assflash', ((s as any).locArgs?.[1] ?? 0), ((s as any).temp_flashasscnt ?? 0)) + '</td>');
        (s as any).temp_cnum = ((s as any).temp_cnum ?? 0) + (1);
      }
      ...
      (s as any).result = ((s as any).result ?? 0) + ('</tr><tr></tr>');
      (s as any).temp_cnum = undefined;
      (s as any).temp_flashasscnt = undefined;
    } while (((s as any).temp_flashasscnt ?? 0) <= ((s as any).selfieAssFlashTot ?? 0)[String((s as any).locArgs?.[1] ?? '')]);
  }
  return;
  scene.build();
}
...
function enterRetrievePussyflashSelfies(s: GameState, scene: SceneBuilder): void {
  if (((s as any).selfiePussyFlashTot ?? 0)[String((s as any).locArgs?.[1] ?? '')] > 0) {
    (s as any).result = ((s as any).result ?? 0) + ('<tr><th colspan=5>Flashing pussy selfies</th></tr>');
    (s as any).result = ((s as any).result ?? 0) + ('<tr></tr><tr>');
    (s as any).temp_cnum = 0;
    ...
    do {
      ...
      if (((s as any).phone_locval ?? 0) === 1) {
        ...
        (s as any).result = ((s as any).result ?? 0) + ('<td width="20%">' + qspFunc(s, 'phone_selfies_popup', 'set_selfie', ((s as any).locArgs?.[2] ?? 0), 'pussyflash', ((s as any).locArgs?.[1] ?? 0), ((s as any).temp_flashpussycnt ?? 0)) + '</td>');
        (s as any).temp_cnum = ((s as any).temp_cnum ?? 0) + (1);
      }
      ...
      (s as any).result = ((s as any).result ?? 0) + ('</tr><tr></tr>');
      (s as any).temp_cnum = undefined;
      (s as any).temp_flashpussycnt = undefined;
    } while (((s as any).temp_flashpussycnt ?? 0) <= ((s as any).selfiePussyFlashTot ?? 0)[String((s as any).locArgs?.[1] ?? '')]);
  }
  return;
  scene.build();
}
...
function enterGetNpcSelfie(s: GameState, scene: SceneBuilder): void {
  if (((s as any).npc_lastname ?? 0)['A' + (String((s as any).locArgs?.[1] ?? ''))] !== '') {
    (s as any).result = '<a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027listretrieve2\u0027, ((s as any).locArgs?.[1] ?? \u0027\u0027)); return false;">' + (((s as any).npc_firstname ?? 0)?.[String(((s as any).locArgs?.[1] ?? 0))]) + ' ' + (((s as any).npc_lastname ?? 0)?.[String(((s as any).locArgs?.[1] ?? 0))]) + '</a>';
  } else {
    (s as any).result = '<a href="#" onclick="window.__gameStore.getState().doGoto(\u0027phone_selfies\u0027, \u0027listretrieve2\u0027, ((s as any).locArgs?.[1] ?? \u0027\u0027)); return false;">' + (((s as any).npc_firstname ?? 0)?.[String(((s as any).locArgs?.[1] ?? 0))]) + '</a>';
  }
  return;
  scene.build();
}
...
function enterPopulateSelfiesList(s: GameState, scene: SceneBuilder): void {
  (s as any).selfieTakenClo = undefined;
  (s as any).selfieTakenUnd = undefined;
  (s as any).selfieTakenNud = undefined;
  (s as any).selfieTakenTitflash = undefined;
  (s as any).selfieTakenAssflash = undefined;
  (s as any).selfieTakenPussyflash = undefined;
  (s as any).selfieTakenBath = undefined;
  (s as any).selfieTakenShower = undefined;
  (s as any).selfieTakenSwim = undefined;

...
function enterDisplayPage(s: GameState, scene: SceneBuilder): void {
  ...
  do {
    ...
    ((s as any).temp_tv = (s as any).temp_tv ?? {})['html'] = ((s as any).temp_tv['html'] ?? 0) + ('<td width="' + (((s as any).stat_cfg ?? 0)?.['bar_width']) + '" valign="middle" style="padding: 4px 0; vertical-align: middle; border: 1px solid ' + (((s as any).temp_tv ?? 0)?.['border']) + ';">' + (((s as any).temp_tv ?? 0)?.['bar']) + '</td>');
...
function enterCauseCatalog(s: GameState, scene: SceneBuilder): void {
  ...
  ((s as any).cc = (s as any).cc ?? {})['b+1'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'bimbo', '<small>↑</small>') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['b+2'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'bimbo', '↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['b+4'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'bimbo b', '↑↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['b-1'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'bimbo', '<small>↓</small>') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['b-2'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'bimbo', '↓') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['b-4'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'bimbo b', '↓↓') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['p+1'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'preppy', '<small>↑</small>') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['p+2'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'preppy', '↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['p+4'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'preppy b', '↑↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['p-1'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'preppy', '<small>↓</small>') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['p-2'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'preppy', '↓') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['p-4'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'preppy b', '↓↓') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['r+1'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'prude', '<small>↑</small>') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['r+2'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'prude', '↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['r+4'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'prude b', '↑↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['r+6'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'prude b', '↑↑↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['r-1'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'prude', '<small>↓</small>') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['r-2'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'prude', '↓') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['r-4'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'prude b', '↓↓') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['r-6'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'prude b', '↓↓↓') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['u+1'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'punk', '<small>↑</small>') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['u+2'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'punk', '↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['u+4'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'punk b', '↑↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['u-1'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'punk', '<small>↓</small>') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['u-2'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'punk', '↓') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['g+1'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'goth', '<small>↑</small>') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['g+2'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'goth', '↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['g+6'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg+_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg+']) + '">' + qspFunc(s, 'wrap', 'goth b', '↑↑↑') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['g-1'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'goth', '<small>↓</small>') + '</td>';
  ((s as any).cc = (s as any).cc ?? {})['g-2'] = '<td align="center" bgcolor="' + (((s as any).cc ?? 0)?.['bg-_hex']) + '" style="' + (((s as any).cc ?? 0)?.['bg-']) + '">' + qspFunc(s, 'wrap', 'goth', '↓') + '</td>';

...
function enterClamp(s: GameState, scene: SceneBuilder): void {
  if (((s as any).arch_const ?? 0)?.['point_cap'] > 0) {
    if (!(s as any).arch_vars) (s as any).arch_vars = {}; (s as any).arch_vars['' + String((s as any).$ARGS[1] || '') + '_points'] = qspFunc(s, 'math', 'int_clamp', ((s as any).arch_vars ?? 0)?.[String(((s as any).locArgs?.[1] ?? 0)) + '_points'], 0, ((s as any).arch_const ?? 0)?.['point_cap']);
  } else {
...
function enterGain(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).locArgs?.[4] ?? 0) > 0  &&  ((s as any).locArgs?.[3] ?? 0) !== '') {
    ...
    if (!(s as any).arch_vars) (s as any).arch_vars = {}; (s as any).arch_vars['cooldown_' + String((s as any).$ARGS[3] || '') + ''] = ((s as any).daystart ?? 0);
  }
      ...
      if (((s as any).locArgs?.[2] ?? 0) === 'medium') {
        ...
        if (((s as any).locArgs?.[2] ?? 0) === 'large') {
          ...
          if (((s as any).locArgs?.[2] ?? 0) === 'huge') {
            ...
            (s as any).temp_points = ((((s as any).locArgs?.[2] ?? 0) > 0) ? (qspUntranslated(s, "ARGS[2]", { location: "archetypes" })) : (1));
          }
        }
      }
    }
...
function enterChange(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).temp_change) (s as any).temp_change = {}; (s as any).temp_change['bimbo'] = ((s as any).temp_change['bimbo'] ?? 0) - (((s as any).temp_change ?? 0)?.['opp_bimbo']);
  if (!(s as any).temp_change) (s as any).temp_change = {}; (s as any).temp_change['preppy'] = ((s as any).temp_change['preppy'] ?? 0) - (((s as any).temp_change ?? 0)?.['opp_preppy']);
  if (!(s as any).temp_change) (s as any).temp_change = {}; (s as any).temp_change['prude'] = ((s as any).temp_change['prude'] ?? 0) - (((s as any).temp_change ?? 0)?.['opp_prude']);
  if (!(s as any).temp_change) (s as any).temp_change = {}; (s as any).temp_change['punk'] = ((s as any).temp_change['punk'] ?? 0) - (((s as any).temp_change ?? 0)?.['opp_punk']);
...
function enterSetActive(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_sa_active ?? 0) === 'prude'  &&  ((s as any).arch_vars ?? 0)?.['main_active'] !== 'prude'  &&  ((s as any).calendar_show ?? 0)?.['church'] === 0) {
    if (!(s as any).calendar_show) (s as any).calendar_show = {}; (s as any).calendar_show['church'] = 1;
    qspCall(s, 'calendar', 'pack', 'add', 'church');
  }
  if (!(s as any).arch_vars) (s as any).arch_vars = {}; (s as any).arch_vars['main_active'] = ((s as any).temp_sa_active ?? 0);
  return;
  // TODO-QSP: end
  scene.build();
}
...
function enterGetStatePoints(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).temp_gs) (s as any).temp_gs = {}; (s as any).temp_gs['mul'] = qspUntranslated(s, "ARGS[1]", { location: "archetypes" });
  if (!(s as any).temp_gs) (s as any).temp_gs = {}; (s as any).temp_gs['is_student'] = ((s as any).start_type ?? 0)?.['loc'] === 'sg'  &&  ((s as any).gschoolVars ?? 0)?.['school_diploma'] === 0  &&  (!((s as any).kanikuli ?? 0));
  if (!(s as any).temp_gs) (s as any).temp_gs = {}; (s as any).temp_gs['school_hrs'] = ((s as any).temp_gs ?? 0)?.['is_student']  &&  ((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 15  &&  ((s as any).gschoolVars ?? 0)?.['last_attendance'] === ((s as any).daystart ?? 0);
  if (!(s as any).temp_gs) (s as any).temp_gs = {}; (s as any).temp_gs['pierce_private'] = ((s as any).pcs_piercings ?? 0)?.['nipples'] > 0  ||  ((s as any).pcs_piercings ?? 0)?.['pussy'] > 0;
  if (!(s as any).temp_gs) (s as any).temp_gs = {}; (s as any).temp_gs['pierce_facial'] = ((s as any).pcs_piercings ?? 0)?.['brow'] > 0  ||  ((s as any).pcs_piercings ?? 0)?.['nose'] > 0  ||  ((s as any).pcs_piercings ?? 0)?.['lip'] > 0  ||  ((s as any).pcs_piercings ?? 0)?.['tongue'] > 0;
  if (!(s as any).temp_gs) (s as any).temp_gs = {}; (s as any).temp_gs['pierce_body'] = ((s as any).temp_gs ?? 0)?.['pierce_facial'] !== 0  ||  ((s as any).pcs_piercings ?? 0)?.['navel'] > 0;
  if (!(s as any).temp_gs) (s as any).temp_gs = {}; (s as any).temp_gs['pierce_non_ear'] = ((s as any).temp_gs ?? 0)?.['pierce_body'] !== 0  ||  ((s as any).temp_gs ?? 0)?.['pierce_private'] !== 0;
  if (!(s as any).temp_gs) (s as any).temp_gs = {}; (s as any).temp_gs['tattoo_any'] = qspUntranslated(s, "pcs_tattoos['any'] > 0", { location: "archetypes" });
  if (!(s as any).temp_gs) (s as any).temp_gs = {}; (s as any).temp_gs['tattoo_private'] = ((s as any).pcs_tattoos ?? 0)?.['breast'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['under'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['tramp'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['ass'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['pussy'] > 0;
  if (!(s as any).temp_gs) (s as any).temp_gs = {}; (s as any).temp_gs['tattoo_visible'] = ((s as any).pcs_tattoos ?? 0)?.['face'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['lip'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['neck'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['back'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['shoulder'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['chest'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['side'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['belly'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['arm'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['wrist'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['hand'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['leg'] > 0  ||  ((s as any).pcs_tattoos ?? 0)?.['ankle'] > 0;
  if (((s as any).clothingworntype ?? 0) !== 'nude'  &&  (!((s as any).PCloSwim ?? 0))) {
    if (((s as any).PCloBimbo ?? 0) === 1) {
      if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['bimbo'] = ((s as any).temp_state['bimbo'] ?? 0) + (2);
    }
    if (((s as any).PCloPrep ?? 0) === 1) {
      if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['preppy'] = ((s as any).temp_state['preppy'] ?? 0) + (2);
    }
    if (((s as any).PCloPrude ?? 0) === 1) {
      if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['prude'] = ((s as any).temp_state['prude'] ?? 0) + (2);
    }
    if (((s as any).PCloPunk ?? 0) === 1) {
      if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['punk'] = ((s as any).temp_state['punk'] ?? 0) + (2);
    }
    if (((s as any).PCloGoth ?? 0) === 1) {
      if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['goth'] = ((s as any).temp_state['goth'] ?? 0) + (3);
    }
    if (((s as any).PCloStyle ?? 0) === 2) {
      if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['punk'] = ((s as any).temp_state['punk'] ?? 0) + (1);
      if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['preppy'] = ((s as any).temp_state['preppy'] ?? 0) - (1);
    } else {
      if (((s as any).PCloStyle ?? 0) === 3) {
        if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['preppy'] = ((s as any).temp_state['preppy'] ?? 0) + (1);
      } else {
        if (((s as any).PCloStyle ?? 0) === 4) {
          if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['bimbo'] = ((s as any).temp_state['bimbo'] ?? 0) + (1);
          if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['prude'] = ((s as any).temp_state['prude'] ?? 0) - (1);
        } else {
    ...
    if (((s as any).PCloStrip ?? 0) === 1) {
      ...
      if (((s as any).PCloSchool ?? 0) === 1) {
        ...
        if ((!((s as any).PCloGoth ?? 0))) {
          if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['goth'] = ((s as any).temp_state['goth'] ?? 0) - (1);
        }
      } else {
    ...
    if (((s as any).PCloInhibit ?? 0) <= 5) {
      ...
      if (((s as any).PCloInhibit ?? 0) <= 10) {
        ...
        if (((s as any).PCloInhibit ?? 0) >= 40) {
          if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['prude'] = ((s as any).temp_state['prude'] ?? 0) - (3);
          if (!(s as any).temp_state) (s as any).temp_state = {}; (s as any).temp_state['bimbo'] = ((s as any).temp_state['bimbo'] ?? 0) + (1);
        } else {
...
function enterLoop(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).cheatVars ?? 0)?.['archetypes'] === 1  ||  ((s as any).succubusflag ?? 0) === 1) {
    if (!(s as any).arch_vars) (s as any).arch_vars = {}; (s as any).arch_vars['main_active'] = '';
...
function enterDecay(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_decay_after = Math.max(0, ((s as any).temp_decay_before ?? 0) - ((s as any).temp_decay_rate ?? 0) * ((s as any).ARGS ?? 0)[1]);
...
function enterApplyEffects(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).cheatVars ?? 0)?.['smart_bimbo']) {
    if (((s as any).arch_effects ?? 0)?.['appearance_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['appearance_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['charisma_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['charisma_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['erotic_dance_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['erotic_dance_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['pole_dance_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['pole_dance_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['heels_effect']        < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['heels_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['service_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['service_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['modeling_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['modeling_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['inhib_effect']        < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['inhib_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['chess_effect']        < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['chess_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['intelligence_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['intelligence_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['perception_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['perception_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['spirit_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['spirit_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['computer_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['computer_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['observation_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['observation_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['sewing_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['sewing_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['disposition_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['disposition_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['dancing_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['dancing_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['people_skills_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['people_skills_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['cheerleading_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['cheerleading_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['persuasion_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['persuasion_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['makeup_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['makeup_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['sports_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['sports_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['revealing_sports_effect']  < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['revealing_sports_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['combat_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['combat_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['strength_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['strength_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['artistic_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['artistic_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['music_effect']        < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['music_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['cleaning_effect']      < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['cleaning_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['songwriting_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['songwriting_effect'] = 0;
    }
    if (((s as any).arch_effects ?? 0)?.['performance_effect']    < 0) {
      if (!(s as any).arch_effects) (s as any).arch_effects = {}; (s as any).arch_effects['performance_effect'] = 0;
    }
  }
  return;
  // TODO-QSP: end
...
function enterDailySnapshot(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_ds_j ?? 0) > 0) {
    if (!(s as any).arch_vars) (s as any).arch_vars = {}; (s as any).arch_vars['' + String((s as any).$temp_ds_archetype || '') + '_history_' + String((s as any).temp_ds_j || '') + ''] = ((s as any).arch_vars ?? 0)?.[((s as any).temp_ds_archetype ?? 0) + '_history_' + (((s as any).temp_ds_j ?? 0) - 1)];
    (s as any).temp_ds_j = ((s as any).temp_ds_j ?? 0) - (1);
    // TODO-QSP: jump 'snapshot_shift_loop'
  }
  if (!(s as any).arch_vars) (s as any).arch_vars = {}; (s as any).arch_vars['' + String((s as any).$temp_ds_archetype || '') + '_history_0'] = ((s as any).arch_vars ?? 0)?.[((s as any).temp_ds_archetype ?? 0) + '_points'];
  ...
  if (!(s as any).arch_vars) (s as any).arch_vars = {}; (s as any).arch_vars['' + String((s as any).$temp_ds_archetype || '') + '_avg'] = ((s as any).temp_ds_sum ?? 0) / 7;
...
function enterSeedSnapshots(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).arch_vars) (s as any).arch_vars = {}; (s as any).arch_vars['' + String((s as any).$temp_ss_archetype || '') + '_history_' + String((s as any).temp_ss_j || '') + ''] = ((s as any).temp_ss_val ?? 0);
  (s as any).temp_ss_j = ((s as any).temp_ss_j ?? 0) + (1);
  if (((s as any).temp_ss_j ?? 0) < 7) {
    // TODO-QSP: jump 'seed_slot_loop'
  }
  if (!(s as any).arch_vars) (s as any).arch_vars = {}; (s as any).arch_vars['' + String((s as any).$temp_ss_archetype || '') + '_avg'] = ((s as any).temp_ss_val ?? 0);
...
function enterComputeStatDisplay(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).arch_vars ?? 0)?.['main_active'] === 'bimbo') {
    if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 0) {
      if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Bimbo: You\'re, like, super hawt today.';
      ...
      if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 10) {
        if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Bimbo: You feel, like, kind of lame today.';
        qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'bimbo', 'status/archetype_bimbo', 1, 'gt \'$menu_character\', \'archetypes\'');
      } else {
        if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 20) {
          if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Bimbo: You feel, like, totally lame today.';
          qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'neg', 'status/archetype_bimbo', 1, 'gt \'$menu_character\', \'archetypes\'');
        } else {
          if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 40) {
            if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Bimbo: You really feel, like, awful today.';
            qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'neg', 'status/archetype_bimbo', 1, 'gt \'$menu_character\', \'archetypes\'');
            qspCall(s, 'stat_display_compute', 'queue_alert', 'Your mood is affected by Bimbo withdrawal.', 'bimbo');
          } else {
            if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Bimbo: You feel, like, horrible today!';
    ...
    if (((s as any).arch_vars ?? 0)?.['main_active'] === 'preppy') {
      if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 0) {
        if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Preppy: You look amazing and everyone knows it. Today is <i>your</i> day.';
        if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main_tooltip'] = 'Preppy: You look amazing and everyone knows it. Today is your day.';
        ...
        if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 10) {
          if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Preppy: Is that a wrinkle? No... but you can\'t stop checking.';
          qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'preppy', 'status/archetype_preppy', 1, 'gt \'$menu_character\', \'archetypes\'');
        } else {
          if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 20) {
            if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Preppy: Your smile feels forced. Are people noticing?';
            qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'neg', 'status/archetype_preppy', 1, 'gt \'$menu_character\', \'archetypes\'');
          } else {
            if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 40) {
              if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Preppy: You can\'t fake it today. Everything\'s falling apart and everyone can tell.';
              qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'neg', 'status/archetype_preppy', 1, 'gt \'$menu_character\', \'archetypes\'');
              qspCall(s, 'stat_display_compute', 'queue_alert', 'Your mood is affected by Preppy withdrawal.', 'preppy');
            } else {
              if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Preppy: You caught a glimpse of yourself and almost didn\'t recognize her. Who <i>is</i> that?';
              if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main_tooltip'] = 'Preppy: You caught a glimpse of yourself and almost didn\'t recognize her. Who is that?';
      ...
      if (((s as any).arch_vars ?? 0)?.['main_active'] === 'prude') {
        if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 0) {
          if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Prude: A proper lady keeps her thoughts clean and her posture straight.';
          qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'prude', 'status/archetype_prude', 1, 'gt \'$menu_character\', \'archetypes\'', 'pos');
        } else {
          if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 10) {
            if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Prude: Your mind wandered somewhere it shouldn\'t have. You shake it off.';
            qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'prude', 'status/archetype_prude', 1, 'gt \'$menu_character\', \'archetypes\'');
          } else {
            if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 20) {
              if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Prude: Indecent thoughts keep creeping in. This isn\'t like you.';
              qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'neg', 'status/archetype_prude', 1, 'gt \'$menu_character\', \'archetypes\'');
            } else {
              if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 40) {
                if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Prude: You feel flushed and distracted. Why can\'t you just <i>focus</i>?';
                if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main_tooltip'] = 'Prude: You feel flushed and distracted. Why can\'t you just focus?';
                qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'neg', 'status/archetype_prude', 1, 'gt \'$menu_character\', \'archetypes\'');
                qspCall(s, 'stat_display_compute', 'queue_alert', 'Your mood is affected by Prude withdrawal.', 'prude');
              } else {
                if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Prude: Your skin feels too tight and everything is <i>too much</i>. What\'s happening to you?';
        ...
        if (((s as any).arch_vars ?? 0)?.['main_active'] === 'punk') {
          if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 0) {
            if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Punk: You feel rebellious.';
            qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'punk', 'status/archetype_punk', 1, 'gt \'$menu_character\', \'archetypes\'', 'pos');
          } else {
            if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 10) {
              if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Punk: You don\'t really feel like rebelling.';
              qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'punk', 'status/archetype_punk', 1, 'gt \'$menu_character\', \'archetypes\'');
            } else {
              if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 20) {
                if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Punk: You can\'t be bothered to rebel today.';
                qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'neg', 'status/archetype_punk', 1, 'gt \'$menu_character\', \'archetypes\'');
              } else {
                if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 40) {
                  if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Punk: Your anger against the world is mute.';
                  qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'neg', 'status/archetype_punk', 1, 'gt \'$menu_character\', \'archetypes\'');
                  qspCall(s, 'stat_display_compute', 'queue_alert', 'Your mood is affected by Punk withdrawal.', 'punk');
                } else {
                  if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Punk: The patriarchy has won this day!';
          ...
          if (((s as any).arch_vars ?? 0)?.['main_active'] === 'goth') {
            if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 0) {
              if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Goth: Baby bat is in touch with her dark side today.';
              qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'goth', 'status/archetype_goth', 1, 'gt \'$menu_character\', \'archetypes\'', 'pos');
            } else {
              if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 10) {
                if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Goth: Today\'s more of a struggle than normal!';
                qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'goth', 'status/archetype_goth', 1, 'gt \'$menu_character\', \'archetypes\'');
              } else {
                if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 20) {
                  if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Goth: You\'re not feeling creative today; when\'s today going to end?';
                  qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'neg', 'status/archetype_goth', 1, 'gt \'$menu_character\', \'archetypes\'');
                } else {
                  if (((s as any).arch_vars ?? 0)?.['withdrawal_pct'] <= 40) {
                    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Goth: This is a really depressing day!';
                    qspCall(s, 'stat_display_compute', 'queue_msg', 'archetype_main', 'neg', 'status/archetype_goth', 1, 'gt \'$menu_character\', \'archetypes\'');
                    qspCall(s, 'stat_display_compute', 'queue_alert', 'Your mood is severely affected by Goth withdrawal.', 'goth');
                  } else {
                    if (!(s as any).stat_texts) (s as any).stat_texts = {}; (s as any).stat_texts['archetype_main'] = 'Goth: Today\'s got to end! Right?!';
...
function enterInit(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).arch_vars) (s as any).arch_vars = {}; (s as any).arch_vars['last_update'] = ((((s as any).totminut ?? 0) <= 0) ? (((s as any).minut ?? 0) + ((s as any).hour ?? 0) * 60 + ((s as any).daystart ?? 0) * 1440) : (((s as any).totminut ?? 0)));
  return;
  // TODO-QSP: end
  scene.build();
}
...
function enterDisplayPage(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['labels, 0'] = 'Bimbo\'    & $temp_tv[\'grads, 0\'] = \'mono:bimbo\'  & $temp_tv[\'opp, 0\'] = \'Prude &amp; Punk';
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['labels, 1'] = 'Preppy\'  & $temp_tv[\'grads, 1\'] = \'mono:accent\'  & $temp_tv[\'opp, 1\'] = \'Punk &amp; Goth';
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['labels, 2'] = 'Prude\'    & $temp_tv[\'grads, 2\'] = \'mono:neutral\'  & $temp_tv[\'opp, 2\'] = \'Goth &amp; Bimbo';
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['labels, 3'] = 'Punk\'    & $temp_tv[\'grads, 3\'] = \'mono:punk\'  & $temp_tv[\'opp, 3\'] = \'Bimbo &amp; Preppy';
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['labels, 4'] = 'Goth\'    & $temp_tv[\'grads, 4\'] = \'mono:goth\'  & $temp_tv[\'opp, 4\'] = \'Preppy &amp; Prude';
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['colors, 0'] = ((s as any).theme_hex ?? 0)?.['bimbo'];
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['colors, 1'] = ((s as any).theme_hex ?? 0)?.['accent'];
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['colors, 2'] = ((s as any).theme_hex ?? 0)?.['neutral'];
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['colors, 3'] = ((s as any).theme_hex ?? 0)?.['punk'];
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['colors, 4'] = ((s as any).theme_hex ?? 0)?.['goth'];
  if (((s as any).arch_vars ?? 0)?.['main_active'] !== '') {
    if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['active'] = ((s as any).arch_vars ?? 0)?.['main_active'];
    if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['idx'] = 0;
    // TODO-QSP: :tv_dp_find_label
    if (qspFunc(s, 'archetypes', 'get_archetype', ((s as any).temp_tv ?? 0)?.['idx']) === ((s as any).temp_tv ?? 0)?.['active']) {
      if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['active_label'] = ((s as any).temp_tv ?? 0)?.['labels, ' + String(((s as any).temp_tv ?? 0)?.['idx'])];
      if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['active_color'] = ((s as any).temp_tv ?? 0)?.['colors, ' + String(((s as any).temp_tv ?? 0)?.['idx'])];
    } else {
      if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['idx'] = ((s as any).temp_tv['idx'] ?? 0) + (1);
  ...
  if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['bar_width'] = 740;
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['border'] = ((((s as any).theme ?? 0)?.['is_dark'] === 1) ? ('#555555') : ('#aaaaaa'));
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['html'] = '<table cellpadding="0" cellspacing="0">';
  ...
  if (((s as any).temp_tv ?? 0)?.['name'] === ((s as any).arch_vars ?? 0)?.['main_active']) {
    ...
    if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['lbl'] = '<font color="\' + $temp_tv[\'colors, \' + $str(temp_tv[\'i\'])] + \'">\' + $temp_tv[\'labels, \' + $str(temp_tv[\'i\'])] + \'</font>';
  }
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['html'] = ((s as any).temp_tv['html'] ?? 0) + ('<tr>');
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['html'] = ((s as any).temp_tv['html'] ?? 0) + ('<td width="60" align="right" valign="middle" style="padding: 4px 8px 4px 0; vertical-align: middle;">\' + $temp_tv[\'lbl\'] + \'</td>');
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['html'] = ((s as any).temp_tv['html'] ?? 0) + ('<td width="' + qspUntranslated(s, "stat_cfg['bar_width']>", { location: "archetypes" }) + '" valign="middle" style="padding: 4px 0; vertical-align: middle; border: 1px solid \' + $temp_tv[\'border\'] + \';">\' + $temp_tv[\'bar\'] + \'</td>');
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['html'] = ((s as any).temp_tv['html'] ?? 0) + ('<td width="50" align="right" valign="middle" style="padding: 4px 0 4px 8px; vertical-align: middle; white-space: nowrap;">\' + $str(temp_tv[\'pts\'] / 250) + \'</td>');
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['html'] = ((s as any).temp_tv['html'] ?? 0) + ('</tr>');
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['i'] = ((s as any).temp_tv['i'] ?? 0) + (1);
  if (((s as any).temp_tv ?? 0)?.['i'] < 5) {
    // TODO-QSP: jump 'tv_dp_bar_loop'
  }
  if (!(s as any).temp_tv) (s as any).temp_tv = {}; (s as any).temp_tv['html'] = ((s as any).temp_tv['html'] ?? 0) + ('</table>');
  // TODO-QSP: $temp_tv['html']
  if (!(s as any).stat_cfg) (s as any).stat_cfg = {}; (s as any).stat_cfg['bar_width'] = ((s as any).temp_tv ?? 0)?.['saved_bar_width'];
...
function enterHistoryPage(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['names, 1'] = 'preppy\'      & $thp[\'labels, 1\'] = \'Preppy';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['names, 2'] = 'prude\'      & $thp[\'labels, 2\'] = \'Prude';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['names, 3'] = 'punk\'      & $thp[\'labels, 3\'] = \'Punk';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['names, 4'] = 'goth\'      & $thp[\'labels, 4\'] = \'Goth';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['colors, 0'] = ((s as any).theme_hex ?? 0)?.['bimbo'];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['colors, 1'] = ((s as any).theme_hex ?? 0)?.['accent'];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['colors, 2'] = ((s as any).theme_hex ?? 0)?.['neutral'];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['colors, 3'] = ((s as any).theme_hex ?? 0)?.['punk'];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['colors, 4'] = ((s as any).theme_hex ?? 0)?.['goth'];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['cats, 0'] = 'clothing\'  & $thp[\'catlbl, 0\'] = \'Clothing';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['cats, 1'] = 'shoes\'    & $thp[\'catlbl, 1\'] = \'Shoes';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['cats, 2'] = 'makeup\'    & $thp[\'catlbl, 2\'] = \'Makeup';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['cats, 3'] = 'hair\'    & $thp[\'catlbl, 3\'] = \'Hair';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['cats, 4'] = 'body_mods\'  & $thp[\'catlbl, 4\'] = \'Body mods';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['cats, 5'] = 'body\'    & $thp[\'catlbl, 5\'] = \'Body';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['cats, 6'] = 'social\'    & $thp[\'catlbl, 6\'] = \'Social';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['cats, 7'] = 'drugs\'    & $thp[\'catlbl, 7\'] = \'Drugs';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['cats, 8'] = 'chastity\'  & $thp[\'catlbl, 8\'] = \'Chastity';
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['border'] = ((((s as any).theme ?? 0)?.['is_dark'] === 1) ? ('#444444') : ('#cccccc'));
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['ti'] = 0;
  scene.text('<center><div style="width:50%;">');
  // TODO-QSP: :thp_archetype_loop
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['tname'] = ((s as any).thp ?? 0)?.['names, ' + String(((s as any).thp ?? 0)?.['ti'])];
  ...
  scene.text('</tr>');
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['ci'] = 0;
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['tot60'] = 0;
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['tot1440'] = 0;
  // TODO-QSP: :thp_cat_loop
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['ckey'] = ((s as any).thp ?? 0)?.['cats, ' + String(((s as any).thp ?? 0)?.['ci'])];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['clabel'] = ((s as any).thp ?? 0)?.['catlbl, ' + String(((s as any).thp ?? 0)?.['ci'])];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['v60'] = ((s as any).agg ?? 0)?.['arch:\' + $thp[\'tname\'] + \', cat:\' + $thp[\'ckey\'] + \', w:60'];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['v1440'] = ((s as any).agg ?? 0)?.['arch:\' + $thp[\'tname\'] + \', cat:\' + $thp[\'ckey\'] + \', w:1440'];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['tot60'] = ((s as any).thp['tot60'] ?? 0) + (((s as any).thp ?? 0)?.['v60']);
  ...
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['v60'] = ((s as any).agg ?? 0)?.['arch:\' + $thp[\'tname\'] + \', cat:decay, w:60'];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['v1440'] = ((s as any).agg ?? 0)?.['arch:\' + $thp[\'tname\'] + \', cat:decay, w:1440'];
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['tot60'] = ((s as any).thp['tot60'] ?? 0) + (((s as any).thp ?? 0)?.['v60']);
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['tot1440'] = ((s as any).thp['tot1440'] ?? 0) + (((s as any).thp ?? 0)?.['v1440']);
  ...
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['cutoff1'] = ((s as any).totminut ?? 0) - 60;
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['si'] = 0;
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['story_count'] = 0;
    ...
    if (((s as any).arch_log_minut ?? 0)[((s as any).thp ?? 0)?.['si']] >= ((s as any).thp ?? 0)?.['cutoff24']) {
      if (((s as any).arch_log_archetype ?? 0)[((s as any).thp ?? 0)?.['si']] === ((s as any).thp ?? 0)?.['tname']) {
        if (((s as any).arch_log_cat ?? 0)[((s as any).thp ?? 0)?.['si']] === 'story') {
          if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['slbl'] = qspUntranslated(s, "arch_log_label[thp['si']]", { location: "archetypes" });
          ...
          if (((s as any).thp_story_seen ?? 0)[((s as any).thp ?? 0)?.['slbl']] === 0) {
            ...
            if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['story_count'] = ((s as any).thp['story_count'] ?? 0) + (1);
          }
        }
      }
    }
    if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['si'] = ((s as any).thp['si'] ?? 0) + (1);
  ...
  if (((s as any).thp ?? 0)?.['story_count'] === 0) {
    ...
    if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['sj'] = 0;
    if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['stot60'] = 0;
    if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['stot1440'] = 0;
    // TODO-QSP: :thp_story_render
    if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['slbl'] = qspUntranslated(s, "thp_story_labels[thp['sj']]", { location: "archetypes" });
    if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['sv60'] = ((s as any).thp_story_d60 ?? 0)?.[((s as any).thp ?? 0)?.['slbl']];
    if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['sv1440'] = ((s as any).thp_story_d1440 ?? 0)?.[((s as any).thp ?? 0)?.['slbl']];
    if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['stot60'] = ((s as any).thp['stot60'] ?? 0) + (((s as any).thp ?? 0)?.['sv60']);
  ...
  scene.text('</div>');
  if (!(s as any).thp) (s as any).thp = {}; (s as any).thp['ti'] = ((s as any).thp['ti'] ?? 0) + (1);
...
function enterCauseCatalog(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['bg+'] = 'background:\' + $theme_hex[\'v_pos\'] + \'10;';
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['bg-'] = 'background:\' + $theme_hex[\'v_neg\'] + \'10;';
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['bg+_hex'] = ((s as any).theme_hex ?? 0)?.['v_pos'];
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['bg-_hex'] = ((s as any).theme_hex ?? 0)?.['v_neg'];
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['__'] = '<td align="center" style="color:#555555;">—</td>';
  ...
  // TODO-QSP: $cc['g-1'] = '<td align="center" bgcolor="<<$cc[''bg-_hex'']>>" style="<<$cc[''bg-'']>>">' + $func('wrap', 'goth', '<small>↓</small>') + '</td>'
  // TODO-QSP: $cc['g-2'] = '<td align="center" bgcolor="<<$cc[''bg-_hex'']>>" style="<<$cc[''bg-'']>>">' + $func('wrap', 'goth', '↓') + '</td>'
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['tbl'] = '<table width="100%" cellpadding="3" cellspacing="0" style="font-size:0.88em;border-collapse:collapse;">';
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['hdr'] = '<tr style="border-bottom:1px solid #888888;font-size:0.85em;"><th align="left">Condition</th>';
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['hdr'] = ((s as any).cc['hdr'] ?? 0) + ('<th align="center" width="52"><a href="exec:archetype_catalog_view=1 & archetype_catalog_sort=1 & gt \'$menu_character\', \'archetypes\', \'catalog\'">\' + $func(\'wrap\', \'bimbo\', \'Bimbo\') + \'</a></th>');
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['hdr'] = ((s as any).cc['hdr'] ?? 0) + ('<th align="center" width="52"><a href="exec:archetype_catalog_view=2 & archetype_catalog_sort=1 & gt \'$menu_character\', \'archetypes\', \'catalog\'">\' + $func(\'wrap\', \'preppy\', \'Preppy\') + \'</a></th>');
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['hdr'] = ((s as any).cc['hdr'] ?? 0) + ('<th align="center" width="52"><a href="exec:archetype_catalog_view=3 & archetype_catalog_sort=1 & gt \'$menu_character\', \'archetypes\', \'catalog\'">\' + $func(\'wrap\', \'prude\', \'Prude\') + \'</a></th>');
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['hdr'] = ((s as any).cc['hdr'] ?? 0) + ('<th align="center" width="52"><a href="exec:archetype_catalog_view=4 & archetype_catalog_sort=1 & gt \'$menu_character\', \'archetypes\', \'catalog\'">\' + $func(\'wrap\', \'punk\', \'Punk\') + \'</a></th>');
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['hdr'] = ((s as any).cc['hdr'] ?? 0) + ('<th align="center" width="52"><a href="exec:archetype_catalog_view=5 & archetype_catalog_sort=1 & gt \'$menu_character\', \'archetypes\', \'catalog\'">\' + $func(\'wrap\', \'goth\', \'Goth\') + \'</a></th></tr>');
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['b'] = qspFunc(s, 'wrap', 'bimbo', 'Bimbo');
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['g'] = qspFunc(s, 'wrap', 'goth', 'Goth');
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['pp'] = qspFunc(s, 'wrap', 'preppy', 'Preppy');
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['pr'] = qspFunc(s, 'wrap', 'prude', 'Prude');
  if (!(s as any).cc) (s as any).cc = {}; (s as any).cc['pu'] = qspFunc(s, 'wrap', 'punk', 'Punk');
  (s as any).i = 0;
...
function enterAggregate(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).temp_agg ?? 0)?.['i'] < Object.keys((s as any).arch_log_minut ?? {}).length) {
    ...
    if (!(s as any).temp_agg) (s as any).temp_agg = {}; (s as any).temp_agg['i'] = ((s as any).temp_agg['i'] ?? 0) + (1);
...
function enterGetArchetypeMessage(s: GameState, scene: SceneBuilder): void {
  ...
  if (!(s as any).tnotif_disp) (s as any).tnotif_disp = {}; (s as any).tnotif_disp['bimbo'] = 'Bimbo';
  if (!(s as any).tnotif_disp) (s as any).tnotif_disp = {}; (s as any).tnotif_disp['preppy'] = 'Preppy';
  if (!(s as any).tnotif_disp) (s as any).tnotif_disp = {}; (s as any).tnotif_disp['prude'] = 'Prude';
  if (!(s as any).tnotif_disp) (s as any).tnotif_disp = {}; (s as any).tnotif_disp['punk'] = 'Punk';
  if (!(s as any).tnotif_disp) (s as any).tnotif_disp = {}; (s as any).tnotif_disp['goth'] = 'Goth';
  (s as any).tnotif_i = 0;
...
function enterNotifyPopup(s: GameState, scene: SceneBuilder): void {
  if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['archetype'] = ((s as any).locArgs?.[1] ?? 0);
  if (((s as any).temp_np ?? 0)?.['archetype'] === 'bimbo') {
    if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['disp'] = 'Bimbo';
  } else {
    if (((s as any).temp_np ?? 0)?.['archetype'] === 'preppy') {
      if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['disp'] = 'Preppy';
    } else {
      if (((s as any).temp_np ?? 0)?.['archetype'] === 'prude') {
        if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['disp'] = 'Prude';
      } else {
        if (((s as any).temp_np ?? 0)?.['archetype'] === 'punk') {
          if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['disp'] = 'Punk';
        } else {
          if (((s as any).temp_np ?? 0)?.['archetype'] === 'goth') {
            if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['disp'] = 'Goth';
          }
        }
      }
    }
  ...
  if (!(s as any).temp_np_cat_disp) (s as any).temp_np_cat_disp = {}; (s as any).temp_np_cat_disp['clothing'] = 'Clothing';
  if (!(s as any).temp_np_cat_disp) (s as any).temp_np_cat_disp = {}; (s as any).temp_np_cat_disp['shoes'] = 'Shoes';
  if (!(s as any).temp_np_cat_disp) (s as any).temp_np_cat_disp = {}; (s as any).temp_np_cat_disp['makeup'] = 'Makeup';
  if (!(s as any).temp_np_cat_disp) (s as any).temp_np_cat_disp = {}; (s as any).temp_np_cat_disp['hair'] = 'Hair';
  if (!(s as any).temp_np_cat_disp) (s as any).temp_np_cat_disp = {}; (s as any).temp_np_cat_disp['body_mods'] = 'Body modifications';
  if (!(s as any).temp_np_cat_disp) (s as any).temp_np_cat_disp = {}; (s as any).temp_np_cat_disp['body'] = 'Body';
  if (!(s as any).temp_np_cat_disp) (s as any).temp_np_cat_disp = {}; (s as any).temp_np_cat_disp['social'] = 'Social';
  if (!(s as any).temp_np_cat_disp) (s as any).temp_np_cat_disp = {}; (s as any).temp_np_cat_disp['drugs'] = 'Drugs & alcohol';
  if (!(s as any).temp_np_cat_disp) (s as any).temp_np_cat_disp = {}; (s as any).temp_np_cat_disp['chastity'] = 'Chastity';
  if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['i'] = 0;
  ...
  if (((s as any).temp_np ?? 0)?.['i'] < Object.keys((s as any).arch_log_minut ?? {}).length) {
    if (((s as any).arch_log_archetype ?? 0)[((s as any).temp_np ?? 0)?.['i']] === ((s as any).temp_np ?? 0)?.['archetype']) {
      if (((s as any).arch_log_minut ?? 0)[((s as any).temp_np ?? 0)?.['i']] >= ((s as any).tnotif_popup_start ?? 0)  &&  ((s as any).arch_log_minut ?? 0)[((s as any).temp_np ?? 0)?.['i']] <= ((s as any).tnotif_popup_end ?? 0)) {
        if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['cat'] = qspUntranslated(s, "arch_log_cat[temp_np['i']]", { location: "archetypes" });
        if (((s as any).temp_np ?? 0)?.['cat'] === 'story') {
          if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['lbl'] = ((((s as any).arch_log_label ?? 0)[((s as any).temp_np ?? 0)?.['i']] !== '') ? (qspUntranslated(s, "arch_log_label[temp_np['i']]", { location: "archetypes" })) : ('(unlabelled)'));
        ...
        if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['total'] = ((s as any).temp_np['total'] ?? 0) + (qspUntranslated(s, "arch_log_delta[temp_np['i']]", { location: "archetypes" }));
      }
    }
    if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['i'] = ((s as any).temp_np['i'] ?? 0) + (1);
  ...
  if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['ci'] = 0;
  // TODO-QSP: :np_cats_loop
  if (((s as any).temp_np ?? 0)?.['ci'] < 9) {
    if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['ck'] = qspUntranslated(s, "temp_np_cats[temp_np['ci']]", { location: "archetypes" });
    ...
    if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['ci'] = ((s as any).temp_np['ci'] ?? 0) + (1);
    // TODO-QSP: jump 'np_cats_loop'
  }
  if (((s as any).temp_np_cat_delta ?? 0)?.['decay'] !== 0) {
    if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['out'] = ((s as any).temp_np['out'] ?? 0) + ('&nbsp;&nbsp;Passive decay: ' + qspUntranslated(s, "func('archetypes','fmt_pts',temp_np_cat_delta['decay'],'fine')>", { location: "archetypes" }) + '<br>');
  }
  if (((s as any).temp_np_cat_delta ?? 0)?.['opposition'] !== 0) {
    if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['out'] = ((s as any).temp_np['out'] ?? 0) + ('&nbsp;&nbsp;Opposition: ' + qspUntranslated(s, "func('archetypes','fmt_pts',temp_np_cat_delta['opposition'],'fine')>", { location: "archetypes" }) + '<br>');
  }
  if (Object.keys((s as any).temp_np_labels ?? {}).length > 0) {
    if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['out'] = ((s as any).temp_np['out'] ?? 0) + ('<br>');
    if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['li'] = 0;
    // TODO-QSP: :np_lbls_loop
    if (((s as any).temp_np ?? 0)?.['li'] < Object.keys((s as any).temp_np_labels ?? {}).length) {
      if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['lbl'] = qspUntranslated(s, "temp_np_labels[temp_np['li']]", { location: "archetypes" });
      // TODO-QSP: $temp_np['out'] += '&nbsp;&nbsp;<<$temp_np[''lbl'']>>: <<$func(''archetypes'',''fmt_pts'',temp_np_lbl_delta[$temp_np[''lbl'']],''fine'')>><br>'
      if (!(s as any).temp_np) (s as any).temp_np = {}; (s as any).temp_np['li'] = ((s as any).temp_np['li'] ?? 0) + (1);

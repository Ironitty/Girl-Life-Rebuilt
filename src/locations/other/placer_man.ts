        ...
        if (((s as any).placerParameter ?? 0)?.['friend_index'] === 0) {
          if (((s as any).placerParameter ?? 0)?.['know_slut'] === 1) {
            if (((s as any).placerParameter ?? 0)?.['number_of_man'] === 1) {
              ...
              (s as any).placerStringParameter['text_start_meet'] = ' The guys whisper to one another: "Look guys, it\'s <<$pcs_nickname>>. She\'s a pretty big <<$gnikname>>, from what I heard."';
            }
          } else {

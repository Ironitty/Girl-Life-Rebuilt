...
function enterGeneralEducation_202(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_4', 'general education 202', ((s as any).pcs_intel ?? 0));
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_4', 'general education 202', ((s as any).pcs_chrsm ?? 0));
...
function enterLearningTheories_202(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_4', 'assessment 202', ((s as any).pcs_intel ?? 0));
    ((s as any).trait_vars ?? {})['academic_lessons'] = (((s as any).trait_vars ?? {})['academic_lessons'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${Math.floor(Math.random() * 4) + 1}.jpg`);
...
function enterPsychologyOfAStudent_201(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_teaching_studies_semester_4', 'psychology of a student 201', ((s as any).pcs_intel ?? 0));
    ((s as any).trait_vars ?? {})['academic_lessons'] = (((s as any).trait_vars ?? {})['academic_lessons'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${Math.floor(Math.random() * 4) + 1}.jpg`);
...
function enterPatientCare_202(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_4', 'patient care 202', ((s as any).pcs_intel ?? 0));
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    ((s as any).trait_vars ?? {})['academic_lessons'] = (((s as any).trait_vars ?? {})['academic_lessons'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${Math.floor(Math.random() * 4) + 1}.jpg`);
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_4', 'patient care 202', ((s as any).pcs_chrsm ?? 0));
    qspCall(s, 'exp_gain', 'chrsm', Math.floor(Math.random() * 2) + 1);
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
...
function enterAnatomyAndPhysiology_202(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_4', 'anatomy and physiology 202', ((s as any).pcs_intel ?? 0));
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    ((s as any).trait_vars ?? {})['academic_lessons'] = (((s as any).trait_vars ?? {})['academic_lessons'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${Math.floor(Math.random() * 4) + 1}.jpg`);
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_4', 'anatomy and physiology 202', ((s as any).pcs_chrsm ?? 0));
    qspCall(s, 'exp_gain', 'chrsm', Math.floor(Math.random() * 2) + 1);
    scene.img('images/locations/city/island/university/classroom/question1.jpg');
...
function enterDosagesAndPharmaceuticals_102(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_4', 'dosages and pharmaceuticals 102', ((s as any).pcs_intel ?? 0));
    qspCall(s, 'exp_gain', 'intel', Math.floor(Math.random() * 2) + 0, 'no_bonus');
    ((s as any).trait_vars ?? {})['academic_lessons'] = (((s as any).trait_vars ?? {})['academic_lessons'] ?? 0) + (1);
    qspCall(s, 'stat', '');
    scene.img(`images/locations/city/island/university/classroom/attentive${Math.floor(Math.random() * 4) + 1}.jpg`);
    ...
    scene.actions([
      { label: 'Ask a question about the lesson', handler: (st: GameState) => {
    qspCall(s, 'grades', 'class_activity_attributes', 'uni_nursing_semester_4', 'dosages and pharmaceuticals 102', ((s as any).pcs_chrsm ?? 0));
    qspCall(s, 'exp_gain', 'chrsm', Math.floor(Math.random() * 2) + 1);
    scene.img('images/locations/city/island/university/classroom/question1.jpg');

...
function enterMiraApologise(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}, I heard what happened," She gasped for breath. "I overheard Mitka and Kolyamba."`);
    ...
    scene.text(`"${((s as any).pcs_nickname || '')}, could you ever forgive me for acting like a fool? I treated you like shit," she continued. "I had an epiphany and realized you're my only true friend here."`);
    ...
    ((s as any).MiraVars = (s as any).MiraVars ?? {})['had_sex'] = 3;
    qspCall(s, 'stat', '');
    qspCall(s, 'miroslava', 'miraclothes');
    scene.text('You finally decide what to answer.');
...
function enterMitkaApologise(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`"Listen, ${((s as any).pcs_nickname || '')}. I beat up the other guys," he said with a smirk, seeing the fear on your face. "I told them not to touch you anymore, and if they want anything to do with you, they have to come and speak to me first."`);
...
function enterGangApologise(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: "<<$pcs_nickname>>, -uh," he began but immediately faltered. "I'm truly sorry fo...
    scene.text(`"${((s as any).pcs_nickname || '')}, -uh," he began but immediately faltered. "I'm truly sorry for what happened the other day… I don't know what came over us. It was like a demon possessed me. I got aroused by Mitka's drunken tales of you."`);
    ...
    // TODO-QSP: dynamic text: "Here," he showed the money in your hand. "It's <<$func('money', 'string_profit'...
    ...
    st.scene = { ...st.scene, mainText: String((st as any).noWillpower || ''), curActs: [] };
      ...
      scene.actions([
        { label: 'Refuse', handler: (st: GameState) => {
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    ((s as any).GadBoy = (s as any).GadBoy ?? {})['river_gang'] = 3;
    qspCall(s, 'willpower', 'prostitution', 'resist', 'hard');
    ...
    scene.text(`"One last thing ${((s as any).pcs_nickname || '')}. None of the men will try to fuck you like that anymore. Mitka warned everyone that if it happens again, their cannon would be shooting blanks for the rest of their life… So if anyone approaches you, you come to me, and I'll sort it out."`);
    ...
    (s as any).minut = ((s as any).minut ?? 0) + 5;
    ((s as any).GadBoy = (s as any).GadBoy ?? {})['river_gang'] = 2;
    ...
    scene.text(`"And yeah… ${((s as any).pcs_nickname || '')}, none of the men will fuck you like that again. So there's no need to be afraid."`);
    scene.text('"I understand…" you answer, turning away and walking away from him.');
...
function enterGadriverGang(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'drunk man', Math.floor(Math.random() * 27) + 19);
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'some country guy', Math.floor(Math.random() * 27) + 19);
    ...
    qspCall(s, 'cum_call', 'face', ((s as any).boy1 ?? 0), 1);
    qspCall(s, 'cum_call', 'stomach', ((s as any).boy2 ?? 0), 1);
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'some country man', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
    (s as any).guy = ((s as any).guy ?? 0) + (1);
...
function enterGadriverGang2(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    scene.text(`The third man was in no hurry to to start pounding your pussy, instead you felt his index finger probing and exploring your ${((s as any).anustipe || '')} anus.`);
    ...
    scene.actions([
      { label: 'Continue', handler: (st: GameState) => {
    qspCall(s, 'npcgeneratec', '', 0, 'village man', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
    (s as any).guy = ((s as any).guy ?? 0) + (1);
...
function enterGadriverGang3(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'unknown drunk guy', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
    (s as any).guy = ((s as any).guy ?? 0) + (1);
    qspCall(s, 'arousal', 'bj', 5, 'sub', 'gangbang');
    qspCall(s, 'stat', '');
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'unfamiliar guy', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
    (s as any).guy = ((s as any).guy ?? 0) + (1);
...
function enterGadriverGang4(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'a man', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
    (s as any).guy = ((s as any).guy ?? 0) + (1);
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'drunk guy', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
    (s as any).guy = ((s as any).guy ?? 0) + (1);
    ...
    scene.text(`He immediately grabs and shoves his cock in your ${((s as any).anustipe || '')} anus.`);
    qspCall(s, 'arousal', 'bj', 5, 'sub', 'gangbang', 'deepthroat');
    qspCall(s, 'arousal', 'vaginal', (-5), 'sub', 'gangbang');
    qspCall(s, 'stat', '');
    scene.actions([
...
function enterGadriverGang5(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    qspCall(s, 'npcgeneratec', '', 0, 'a villager', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0));
    qspCall(s, 'npcgeneratec', '', 0, 'a man', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0), 'b');
    ...
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0), 'b');
    qspCall(s, 'npcgeneratec', '', 0, 'stranger', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0), 'c');
    qspCall(s, 'npcgeneratec', '', 0, 'stranger', Math.floor(Math.random() * 27) + 19);
    qspCall(s, 'boyStat', '', ((s as any).npclastgenerated ?? 0), 'd');
    qspCall(s, 'cum_call', 'mouth_swallow', ((s as any).boy1 ?? 0), 1);
    qspCall(s, 'cum_call', 'face', ((s as any).boy2 ?? 0), 1);
    qspCall(s, 'stat', '');
...
function enterGadukino_2boys(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).pcs_willpwr ?? 0) < ((s as any).will_cost ?? 0)) {
    ...
    scene.actions([
      { label: 'Refuse', handler: (st: GameState) => {
    if (Math.max(parseFloat(((s as any).locArgs?.[1] ?? 0)), ((s as any).locArgs?.[1] ?? 0)) === 1) {
      qspCall(s, 'npc_relationship', 'modify', 'A63', (-3));
      qspCall(s, 'npc_relationship', 'modify', 'A61', (-3));
    } else {
      if (Math.max(parseFloat(((s as any).locArgs?.[1] ?? 0)), ((s as any).locArgs?.[1] ?? 0)) === 2) {
        qspCall(s, 'npc_relationship', 'modify', 'A63', (-3));
        qspCall(s, 'npc_relationship', 'modify', 'A62', (-3));
      } else {
        if (Math.max(parseFloat(((s as any).locArgs?.[1] ?? 0)), ((s as any).locArgs?.[1] ?? 0)) === 3) {
          qspCall(s, 'npc_relationship', 'modify', 'A61', (-3));
          qspCall(s, 'npc_relationship', 'modify', 'A62', (-3));
        }
      }

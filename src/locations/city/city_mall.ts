...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center" width="33%"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027shop_pussycats\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/pussycat.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center" width="33%"><a href="#" onclick="window.__gameStore.setState((s) => { s.torg = 1; s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027shop_gm\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/gm.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center" width="33%"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027shop_danilovich\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/sports.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('</tr><tr>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027shop_fashionista\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/fashionista.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027shop_moncheri\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/moncheri.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027shop_lusso\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/Lusso.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('</tr><tr>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027shop_materinstvo\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/mommy.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027shop_scandalicious\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/scandalicious.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027shopdacha\u0027, \u0027\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/constructiont.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('</tr><tr>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027hairsalon\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/goldencurl.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027salon\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/beautybart.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027zoomagazine\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/petstore.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('</tr><tr>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.ml_boughtamp = 0; s.ml_boughtguitar = 0; s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027city_musicstore\u0027, \u0027\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/musicstore.png"></a></td>');
  (s as any).temp_table = ((s as any).temp_table ?? 0) + ('<td align="center"><a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=3; return s; }); window.__gameStore.getState().doGoto(\u0027shop_photography\u0027, \u0027start\u0027); return false;"><img style="max-width:100%" src="images/locations/city/citycenter/mall/photoshop.png"></a></td>');

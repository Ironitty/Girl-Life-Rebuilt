...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 23) {
    scene.text('You can see the <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=1; return s; }); window.__gameStore.getState().doGoto(\u0027kiosk\u0027, \u0027start\u0027); return false;">kiosk</a> selling cigarettes and magazines.');
  } else {
  ...
  if (((s as any).week ?? 0) === 3  ||  ((s as any).hour ?? 0) < 16) {
    ...
    scene.text('The <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027qwBarPolet\u0027, \u0027\u0027); return false;">Bar "Rabotnik"</a> seems to be open.');
  }
  scene.text('There is a <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027fuelstation\u0027, \u0027start\u0027); return false;">gas station</a> near the street.');
  ...
  if (qspFunc(s, 'autotraidF', 'is_open')) {
    scene.text('A <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027autotraidF\u0027, \u0027start\u0027); return false;">car dealership</a> is nearby.');
  } else {
  ...
  if (qspFunc(s, 'autoservisF', 'is_open')) {
    scene.text('Next to the car dealership is a <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027autoservisF\u0027, \u0027start\u0027); return false;">repair shop</a>.');
  } else {
  ...
  if (((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) < 17  &&  ((s as any).week ?? 0) < 6) {
    scene.text('The <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027city_commcenter\u0027, \u0027start\u0027); return false;">community center</a> is currently open.');
  } else {
  ...
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 21) {
    scene.text('The parking lot, which is engulfed in bright lights, belongs to a <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=2; return s; }); window.__gameStore.getState().doGoto(\u0027shop\u0027, \u0027start\u0027); return false;">supermarket</a>.');
  } else {
  ...
  if (((s as any).hour ?? 0) >= 12  &&  ((s as any).hour ?? 0) < 20) {
    scene.text('Above the door to a basement room is a bright neon sign for the <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=5; return s; }); window.__gameStore.getState().doGoto(\u0027pirsingsalon\u0027, \u0027start\u0027); return false;">Black Dragon Tattoo & Piercing Parlor</a>.');
  } else {
  ...
  if (((s as any).age ?? 0) >= 18) {
    scene.text('A huge building covered in bright lights houses a <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=10; return s; }); window.__gameStore.getState().doGoto(\u0027casino\u0027, \u0027outside\u0027); return false;">casino</a>.');
  } else {
  ...
  if (((s as any).hour ?? 0) >= 14  ||  ((s as any).hour ?? 0) < 4) {
    scene.text('Located far away from the buildings is a <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=2; return s; }); window.__gameStore.getState().doGoto(\u0027lakecafe\u0027, \u0027main\u0027); return false;">barbecue</a>.');
  } else {

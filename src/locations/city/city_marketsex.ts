...
function enterTheBeginning(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((((st as any).gbrand ?? 0) < 95  &&  ((st as any).palevorin ?? 0) === 1)  ||  ((st as any).palevorin ?? 0) > 1) {
      ...
      // TODO-QSP: dynamic text: As you get dressed, he writes you a premium for <<$func(''money'', ''string_prof...
...
function enterGroup(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    // TODO-QSP: dynamic text: Once they''re done, Arthur gives you a bonus of <<$func(''money'', ''string_prof...
...
function enterSex(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if ((!((st as any).rand_act ?? 0))) {
      ...
      // TODO-QSP: dynamic text: Once he''s finished, he tucks his dick back in his pants and throws <<$func(''mo...

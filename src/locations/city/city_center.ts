...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  if (qspFunc(s, 'car_funcs', 'is_here')) {
    ...
    scene.text(`Your <a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027carF\\u0027, \\u0027start\\u0027); return false;">${((s as any).car ?? 0)?.['name'] ?? ''}</a> sits in the parking lot.`);
  }
  qspCall(s, 'taxi', '');
  ...
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 22) {
    ...
    (s as any).desc_txt1 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The Ruch kiosk is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027\\u0027 */ return s; }); return false;">kiosk</a>';
  }
  ...
  if (((s as any).hour ?? 0) === 8  &&  ((s as any).minut ?? 0) >= 30) {
    ...
    (s as any).desc_txt2 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The Havana Fitness Center is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 9, 0)+\\u0027\\u0027 */ return s; }); return false;">Havana Fitness Center</a>';
  } else {
    if (((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) <= 20) {
      ...
      (s as any).desc_txt1 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The Galeria mall is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 30)+\\u0027\\u0027 */ return s; }); return false;">The Galeria mall</a>';
      (s as any).desc_txt2 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The Havana Fitness Center is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 9, 0)+\\u0027\\u0027 */ return s; }); return false;">Havana Fitness Center</a>';
    }
  }
  ...
  if (((s as any).hour ?? 0) >= 6) {
    ...
    (s as any).desc_txt1 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027Aphrodite Photography is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 6, 0)+\\u0027\\u0027 */ return s; }); return false;">Aphrodite Photography</a>';
  }
  if (((s as any).hour ?? 0) >= 6) {
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    ...
    (s as any).desc_txt2 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027Diner Bystroeshka is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 6, 0)+\\u0027\\u0027 */ return s; }); return false;">Diner Bystroeshka</a>';
  }
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 23) {
    (s as any).desc_txt3 = '<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027restoran\\u0027, \\u0027start\\u0027); return false;">Babel</a>';
  } else {
    (s as any).desc_txt3 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027Babel is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027\\u0027 */ return s; }); return false;">Babel</a>';
  }
  ...
  if (((s as any).week ?? 0) >= 4  &&  ((s as any).hour ?? 0) >= 18  ||  (((s as any).week ?? 0) >= 5  ||  ((s as any).week ?? 0) === 1)  &&  ((s as any).hour ?? 0) < 4) {
    ...
    (s as any).desc_txt3 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The nightclub is closed and will open from Thursday to Sunday at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 18, 0)+\\u0027\\u0027 */ return s; }); return false;">The nightclub</a>';
  }
  ...
  if ((((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 17)  ||  (((s as any).week ?? 0) === 6  &&  ((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 14)) {
    ...
    if ((((s as any).week ?? 0) === 5  ||  ((s as any).week ?? 0) === 6)  &&  ((s as any).hour ?? 0) >= 17) {
      (s as any).desc_txt1 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027Titran-Express is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027 on Monday\\u0027 */ return s; }); return false;">Titran-Express</a>';
    } else {
      (s as any).desc_txt1 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027Titran-Express is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027\\u0027 */ return s; }); return false;">Titran-Express</a>';
    }
  }
  ...
  if ((!((s as any).casting ?? 0))) {
    ...
    if (((s as any).hour ?? 0) >= 7  &&  ((s as any).hour ?? 0) < 21) {
      ...
      (s as any).desc_txt1 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027Aurora talent agency is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 7, 0)+\\u0027\\u0027 */ return s; }); return false;">Aurora talent agency</a>';
    }
  }
  if (((s as any).week ?? 0) < 6) {
    if (((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) < 19) {
      ...
      (s as any).desc_txt2 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027VTB bank is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 9, 0)+\\u0027\\u0027 */ return s; }); return false;">VTB bank</a>';
    }
  } else {
    (s as any).desc_txt2 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027VTB bank is closed and will reopen on monday at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 9, 0)+\\u0027\\u0027 */ return s; }); return false;">VTB bank</a>';
  }
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 23) {
    (s as any).minut = ((s as any).minut ?? 0) + 1;
    ...
    (s as any).desc_txt3 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027Kirsanova Realty is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027\\u0027 */ return s; }); return false;">Kirsanova Realty</a>';
  }
  if ((((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) < 17)  ||  (((s as any).week ?? 0) === 6  &&  ((s as any).hour ?? 0) >= 9  &&  ((s as any).hour ?? 0) < 14)) {
    ...
    if (((s as any).week ?? 0) === 6  &&  ((s as any).hour ?? 0) > 16  ||  ((s as any).week ?? 0) === 7  &&  ((s as any).hour ?? 0) < 12) {
      (s as any).desc_txt4 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The post office is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 9, 0)+\\u0027 on Monday\\u0027 */ return s; }); return false;">post office</a>';
    } else {
      (s as any).desc_txt4 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The post office is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 9, 0)+\\u0027\\u0027 */ return s; }); return false;">post office</a>';
    }
  }
  if (((s as any).hour ?? 0) >= 8  &&  ((s as any).hour ?? 0) < 19) {
    ...
    (s as any).desc_txt5 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The National Library of Russia is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027\\u0027 */ return s; }); return false;">National Library of Russia</a> and <a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The Hermitage Museum is closed and will reopen at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 8, 0)+\\u0027\\u0027 */ return s; }); return false;">Hermitage Museum</a>';
  }
  // TODO-QSP: dynamic text: Next door is the <<$desc_txt1>> followed by a <<$desc_txt2>>, <<$desc_txt3>> and...
  scene.text(`Next door is the ${((s as any).desc_txt1 || '')} followed by a ${((s as any).desc_txt2 || '')}, ${((s as any).desc_txt3 || '')} and the 5-star <a href="#" onclick="window.__gameStore.setState((s) => { s.minut +=s.1; return s; }); window.__gameStore.getState().doGoto(\\u0027city_hotel\\u0027, \\u0027\\u0027); return false;">Hotel Indigo</a> for your housing needs. Lastly, the local ${((s as any).desc_txt4 || '')}, ${((s as any).desc_txt5 || '')} can be found at the end of the road.`);
  if (((s as any).week ?? 0) < 6  &&  ((s as any).hour ?? 0) >= 7  &&  ((s as any).hour ?? 0) < 18) {
    ...
    if (((s as any).week ?? 0) < 5  &&  ((s as any).hour ?? 0) >= 18) {
      (s as any).desc_txt6 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The City Courthouse is closed and will reopen tomorrow at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 7, 0)+\\u0027\\u0027 */ return s; }); return false;">City Courthouse</a>';
    } else {
      (s as any).desc_txt6 = '<a href="#" onclick="window.__gameStore.setState((s) => { /* TODO-QSP: msg \\u0027The City Courthouse is closed and will reopen on Monday at \\u0027+func(\\u0027time\\u0027, \\u0027get_time_string\\u0027, 7, 0)+\\u0027\\u0027 */ return s; }); return false;">City Courthouse</a>';
    }
  }
  (s as any).minut = ((s as any).minut ?? 0) + 1;
  ...
  if (((s as any).cfg_vars ?? 0)?.['tablemap'] === 0) {
    ...
    (s as any).show_table = '';
    if (((s as any).nichTanya ?? 0)?.['Relationship'] > 0  &&  ((s as any).nichTanya ?? 0)?.['Relationship'] < 4  &&  ((s as any).nichWork ?? 0) !== 2  &&  ((s as any).hour ?? 0) >= 16  &&  ((s as any).hour ?? 0) < 22  &&  ((s as any).nichTanya ?? 0)?.['FuckLast'] !== ((s as any).daystart ?? 0)) {
      qspCall(s, 'show_table', '', '<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027nichApartment\\u0027, \\u0027visitTanya\\u0027); return false;">Apartment</a> where Tanya lives', '3');
    }
    if (((s as any).nichWork ?? 0) === 2) {
      qspCall(s, 'show_table', '', '<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027nichApartment\\u0027, \\u0027\\u0027); return false;">Nicholas\'s</a> apartment', '3');
    }
    if (((s as any).izoldaQW ?? 0) >= 1) {
      qspCall(s, 'show_table', '', '<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027qwIzoldaApp\\u0027, \\u0027\\u0027); return false;">Isolde\'s</a> apartment', '3');
    }
    if (((s as any).mainQW ?? 0) >= 1) {
      qspCall(s, 'show_table', '', '<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027tatiana_lab\\u0027, \\u0027start\\u0027); return false;">You can visit Tatiana</a> at the Myrkov Investigative Agency.', '3');
    }
    if (((s as any).yaq ?? 0) === 1) {
      qspCall(s, 'show_table', '', '<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027yarik\\u0027, \\u0027start\\u0027); return false;">Yaroslav\'s</a> apartment', '3');
    }
    if (((s as any).peter ?? 0) > 0) {
      qspCall(s, 'show_table', '', '<a href="#" onclick="window.__gameStore.getState().doGoto(\\u0027peterroom\\u0027, \\u0027start_door\\u0027); return false;">Peter\'s</a> apartment', '3');
    }

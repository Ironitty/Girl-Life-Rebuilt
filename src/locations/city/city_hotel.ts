...
function enterPayTheRoom(s: GameState, scene: SceneBuilder): void {
  ...
  if (qspFunc(s, 'money', 'can_afford', ((s as any).totalCost ?? 0)) === 0) {
    ...
    ((s as any).HotelRoom = (s as any).HotelRoom ?? {})['city'] = ((s as any).hotel_room_id ?? 0);
    ((s as any).hotelRoomDays = (s as any).hotelRoomDays ?? {})['city'] = ((s as any).daystart ?? 0) + (((s as any).hotelRoomDays ?? {})?.['city'] ?? 0);
...
function enterRentARoom(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).HotelRoom ?? 0)?.['city'] > 0) {
    ...
    ((s as any).hotelRoomDays = (s as any).hotelRoomDays ?? {})['city'] = 0;
    if (((s as any).hotelRoomDays ?? 0)?.['city'] > 0) {
      (s as any).totalCost = (((s as any).hotelRoomDays ?? {})?.['city'] ?? 0) * 500;
    ...
    ((s as any).hotelRoomDays = (s as any).hotelRoomDays ?? {})['city'] = 0;
    if (((s as any).hotelRoomDays ?? 0)?.['city'] > 0) {
      (s as any).totalCost = (((s as any).hotelRoomDays ?? {})?.['city'] ?? 0) * 1500;
    ...
    ((s as any).hotelRoomDays = (s as any).hotelRoomDays ?? {})['city'] = 0;
    if (((s as any).hotelRoomDays ?? 0)?.['city'] > 0) {
      (s as any).totalCost = (((s as any).hotelRoomDays ?? {})?.['city'] ?? 0) * 10000;
      ...
      { const __savedLocArgs = (s as any).locArgs; (s as any).locArgs = ['', 3]; enterPayTheRoom(s, scene); (s as any).locArgs = __savedLocArgs; }
    } else {
      qspGoto(s, 'city_hotel', '');
    }
  } },

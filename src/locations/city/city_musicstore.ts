...
function enterDefault(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).ml_boughtguitar ?? 0) > 0  ||  ((st as any).ml_boughtamp ?? 0) > 0) {
      qspGoto(st, 'city_musicstore', 'payandtakestuff');
    }
...
function enterSetRadomirCounterText(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).daystart ?? 0) !== ((s as any).radomirQW ?? 0)?.['store_chat_day']) {
    ...
    ((st as any).radomirQW = (st as any).radomirQW ?? {})['store_chat_day'] = ((st as any).daystart ?? 0);
...
function enterCameback(s: GameState, scene: SceneBuilder): void {
  ...
  scene.actions([
    ...
    if (((st as any).pcs_instrmusic ?? 0) < 30  &&  ((st as any).pcs_perform ?? 0) < 10) {
...
function enterBuycheapacoustic(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).ml_didntbuyguitarthefirstvisit ?? 0) === 1) {
    ...
    (s as any).ml_didntbuyguitarthefirstvisit = undefined;
  } else {
...
function enterPayandtakestuff(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).ml_boughtamp = undefined;
  (s as any).ml_boughtguitar = undefined;
  (s as any).ml_gigbag = undefined;
  (s as any).ml_hardcase = undefined;
  scene.actions([
    { label: 'Leave', goto: ['city_mall', ''] },
  ]);
  scene.build();

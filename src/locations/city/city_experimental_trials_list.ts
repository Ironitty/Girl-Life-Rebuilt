...
function enterSeeTrials(s: GameState, scene: SceneBuilder): void {
  ...
  do {
    ...
    if (((s as any).trial_maxs ?? 0)?.[String((s as any).cetl_i ?? 0)] === -1  ||  ((s as any).experimentQW ?? 0)['times_participated_' + (((s as any).cetl_i ?? 0))] < ((s as any).trial_maxs ?? 0)?.[String((s as any).cetl_i ?? 0)]) {
      (s as any).temp_text = ((s as any).temp_text ?? 0) + ('<tr><td bgcolor="' + ((s as any).temp_bgcolor ?? 0) + '" align="center"><a href="#" onclick="window.__gameStore.getState().doGoto(\u0027city_experimental_trials_list\u0027, (((s as any).trial_sections ?? 0)?.[String((s as any).cetl_i ?? 0)] ?? \u0027\u0027)); return false;">' + (((s as any).trial_names ?? 0)?.[String((s as any).cetl_i ?? 0)] ?? 0) + '</a>');
    } else {
      (s as any).temp_text = ((s as any).temp_text ?? 0) + ('<tr><td bgcolor="' + ((s as any).temp_bgcolor ?? 0) + '" align="center"><font color="' + qspFunc(s, 'shortgs', 'rgb_to_hex', ((s as any).fcolor ?? 0)) + '">' + (((s as any).trial_names ?? 0)?.[String((s as any).cetl_i ?? 0)] ?? 0) + '</font>');
    }
...
function enterKillvars(s: GameState, scene: SceneBuilder): void {
  (s as any).trial_names = undefined;
  (s as any).trial_pays = undefined;
  (s as any).trial_codes = undefined;
  (s as any).exp_docs = undefined;
  (s as any).temp_doc = undefined;
  scene.build();
}

function enter(s: GameState, scene: SceneBuilder): void {
  ((s as any).exp_docs = (s as any).exp_docs ?? {})[0] = 'Doctor Sokolnikov';
  ((s as any).exp_docs = (s as any).exp_docs ?? {})[1] = 'Doctor Ivanov';
  ((s as any).trial_names = (s as any).trial_names ?? {})[0] = 'Enhancement pill';
  ((s as any).trial_pays = (s as any).trial_pays ?? {})[0] = 500;
  ((s as any).trial_sections = (s as any).trial_sections ?? {})[0] = 'enhancement_pill';
  ((s as any).trial_maxs = (s as any).trial_maxs ?? {})[0] = (-1);
  ((s as any).trial_names = (s as any).trial_names ?? {})[1] = 'Breast Cream';
  ((s as any).trial_pays = (s as any).trial_pays ?? {})[1] = 5000;
  ((s as any).trial_sections = (s as any).trial_sections ?? {})[1] = 'breast_cream';
  ((s as any).trial_maxs = (s as any).trial_maxs ?? {})[1] = 1;
  ((s as any).trial_durations = (s as any).trial_durations ?? {})[1] = 4;
  ((s as any).trial_names = (s as any).trial_names ?? {})[2] = 'Hair Extension Shampoo';
  ((s as any).trial_pays = (s as any).trial_pays ?? {})[2] = 2500;
  ((s as any).trial_sections = (s as any).trial_sections ?? {})[2] = 'hair_cream';
  ((s as any).trial_maxs = (s as any).trial_maxs ?? {})[2] = 1;
  ((s as any).trial_durations = (s as any).trial_durations ?? {})[2] = 5;
  ((s as any).trial_names = (s as any).trial_names ?? {})[3] = 'Aphrodisiac pills';
  ((s as any).trial_pays = (s as any).trial_pays ?? {})[3] = 10000;
  ((s as any).trial_sections = (s as any).trial_sections ?? {})[3] = 'aphrodisiac_pill';
  ((s as any).trial_maxs = (s as any).trial_maxs ?? {})[3] = 1;
  ((s as any).trial_durations = (s as any).trial_durations ?? {})[3] = 5;
  ((s as any).trial_names = (s as any).trial_names ?? {})[4] = 'Butt Injection';
  ((s as any).trial_pays = (s as any).trial_pays ?? {})[4] = 10000;
  ((s as any).trial_sections = (s as any).trial_sections ?? {})[4] = 'butt_injection';
  ((s as any).trial_maxs = (s as any).trial_maxs ?? {})[4] = 1;
  ((s as any).trial_durations = (s as any).trial_durations ?? {})[4] = 5;
  ((s as any).trial_names = (s as any).trial_names ?? {})[5] = 'Fertility treatment';
  ((s as any).trial_pays = (s as any).trial_pays ?? {})[5] = 10000;
  ((s as any).trial_sections = (s as any).trial_sections ?? {})[5] = 'fertility_shot';
  ...
  if (((s as any).therapistQW ?? 0)?.['breast_cream'] === 1  &&  ((s as any).experimentQW ?? 0)?.['times_participated_1'] === 0  &&  String((s as any).locArgs?.[0] ?? '') === 'see_trials') {
    ((s as any).trial_names = (s as any).trial_names ?? {})[1] = '<b>Breast Cream</b>';
    (s as any).cetl_i = 0;
    do {
      ((s as any).trial_names = (s as any).trial_names ?? {})[String((s as any).cetl_i ?? 0)] = (((s as any).trial_names ?? 0)?.[1] ?? 0);
      ((s as any).trial_pays = (s as any).trial_pays ?? {})[String((s as any).cetl_i ?? 0)] = (((s as any).trial_pays ?? 0)?.[1] ?? 0);
      ((s as any).trial_sections = (s as any).trial_sections ?? {})[String((s as any).cetl_i ?? 0)] = (((s as any).trial_sections ?? 0)?.[1] ?? 0);

...
function enterStart(s: GameState, scene: SceneBuilder): void {
  ...
  if ((((s as any).month ?? 0) === 7  &&  ((s as any).day ?? 0) === 9)  &&  (((s as any).hour ?? 0) === 6  ||  ((s as any).hour ?? 0) === 7)) {
    ...
    alert('This is the current end of the ballet content. More to come soon.');
...
function enterShower(s: GameState, scene: SceneBuilder): void {
  ...
  if (((s as any).nclass ?? 0) > 1) {
    ...
    if ((((s as any).hour ?? 0) > 5  ||  ((s as any).hour ?? 0) < 8)  &&  ((s as any).week ?? 0) !== 7) {
      scene.text(`You can check your<a href="#" onclick="window.__gameStore.getState().doGoto(String((s as any).loc ?? /u0027/u0027), /u0027grade_check/u0027); return false;">appearance</a>before leaving in the full length mirror.`);
    }
    qspCall(s, 'core_library', 'bathroom');
    scene.actions([
      { label: 'Return to the hallway', handler: (st: GameState) => {
    if (((st as any).clothingworntype ?? 0) === 'nude') {
      alert('<b><font color = "red">You need to get dressed before leaving.</font></b>');
...
function enterGradeCheck(s: GameState, scene: SceneBuilder): void {
  ...
  (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('You critically look at your appearance according to the schools assessment guidelines:');
  (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<br><br>');
  if (((s as any).pcs_makeup ?? 0) > 1) {
    (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<font color = "green">✓</font> Your make up is of an acceptable standard.</font>');
  } else {
    (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<font color = "red">✗</font> You need to apply some make up. If you do not have any you will need to speak to Ms. ' + (((s as any).npc_lastname ?? 0)?.['A286']) + '.');
  }
  (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<br>');
  if (((s as any).hbraids ?? 0) > 0  ||  ((s as any).hpingripw ?? 0) > 0  ||  ((s as any).pcs_hairlng ?? 0) <= 80) {
    (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<font color = "green">✓</font> You look at your hair whilst tidying up a few strays and is properly set for classes.');
  } else {
    (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<font color = "red">✗</font> You need to set your hair in a braid or bun, or have short hair to meet with the schools standards.');
  }
  (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<br>');
  if (((s as any).pcs_pubes ?? 0) > 3) {
    (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<font color = "red">✗</font> You need to shave your pussy to avoid any unsightly bumps or hairs sticking out from the sides of your leotard.');
  } else {
    if (((s as any).pcs_leghair ?? 0) > 3) {
      (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<font color = "red">✗</font> You run your hands of your legs and notice they are starting to feel rough, you need to shave or wax them.');
    } else {
      (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<font color = "green">✓</font> You are clean shaven.');
    }
  }
  (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<br>');
  if (((s as any).apparel ?? 0)?.['status'] === 'sport'  ||  ((s as any).apparel ?? 0)?.['status'] === 'dance') {
    (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<font color = "green">✓</font> Your sports clothing is suitable for the dance class.');
  } else {
    (s as any).popup_advise = ((s as any).popup_advise ?? 0) + ('<font color = "red">✗</font> You need to change into sports clothing that is suitable for the dance school.');
  }
  alert(((s as any).popup_advise ?? 0));
  (s as any).popup_advise = undefined;
  scene.build();
}

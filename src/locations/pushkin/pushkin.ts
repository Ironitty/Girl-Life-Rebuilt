...
function enter(s: GameState, scene: SceneBuilder): void {
  ...
  scene.text('Not far from here is the <a href="exec:minut += 5 & gt \'pushkin_sq\'">Okhlopkov Square</a> with its boutique shops.');
  scene.text('Close by is a narrow street leading to a <a href="exec:gt \'koncepod\', \'start\'">vacant house</a>.');
  scene.text('You can also see a <a href="exec:gt \'ugol\',\'start\'">passage</a> between the houses leading to a courtyard.');
  scene.text('Ahead you can see the road that leads to the Pushkin Ballet Theatre and it\'s <a href="exec:gt \'pushkin_ballet_center\',\'start\'">residential accommodation</a>.');
